...
* You can [view the statistics][1] of the mailing and get information about any problems that have arisen.

* You can [add recipients to selections and projects][2] for further processing.

* You can [check and correct the addresses of undelivered mails][2].

* You can see [who has clicked the trackable links][4] you have inserted in the message.

* You can manage email addresses that have been returned due to permanent errors or have [bounced][5] several times.

<!-- Referenced links -->
[1]: view-statistics.md
[2]: look-at-recipient-list.md
[4]: ../../tracked-links/explore-clicks.md
[5]: manage-bounces.md
