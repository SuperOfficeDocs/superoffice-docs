...
> [!NOTE]
> The name of the item will be changed wherever it is already in use in SuperOffice CRM. If you want to avoid this, delete the old item instead and create a new one (see [Delete items](Deleting-items.md)).
