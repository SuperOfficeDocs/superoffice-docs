---
uid: help-en-editing-standard-templates
title: Editing standard templates
description: Editing standard templates
...
2. Click the arrow (![icon](../media/pil_ned.bmp)) and select **Document - Template**.  
...
> [!NOTE]
> If you save a standard template with a new name, you have created a new template. You must link this template to SuperOffice CRM. For more details, see [Add a document template](Adding_a_template_web.md).
