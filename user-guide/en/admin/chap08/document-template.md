...
SuperOffice CRM is supplied with several standard templates that you can use immediately when you have installed the program (see [Use standard templates](Using_standard_templates.md)).
...
* You need to add and define the document template in Settings and maintenance. See [Add a document template](Adding_a_template_web.md).
* You need to make the document template available to the requisite user groups. See [User group filtering](User_groups.md).
...
[Use standard templates](Using_standard_templates.md)

[Create a template document](Creating_a_template_document.md)

[Add a document template](Adding_a_template_web.md)

[Look at template variables](../Template_variables.md)
