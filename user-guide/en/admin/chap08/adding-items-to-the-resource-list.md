---
uid: help-en-adding-items-to-the-resource-list
...
When you add an item to the **General - Resource** list, the **Edit List Item** dialog is not the same as described under [Add items](Adding_items.md).
