...
2. Click the arrow ( ![icon](../../../media/icons/admin/pil-ned.bmp) ) next to the **Type** field and select the required follow-up type from the list box. You can choose from **Appointment**, **Phone call** and **Task**.

3. In the **Direction** field, specify whether the follow-up will be outgoing or incoming, by clicking the arrow ( ![icon](../../../media/icons/admin/pil-ned.bmp) ) and choosing from the list box.
...
5. In the **Intention** field, click the arrow (![icon](../../../media/icons/admin/pil-ned.bmp) ) and select one of the predefined options from the list box. These items are used in connection with status monitors in SuperOffice CRM (requires a licence for [SAINT](../options/Status-monitor.md)).
