...
After you have defined a template and saved it in the template folder, you must link it to SuperOffice CRM in order to be able to use it when you create documents. For more details, see [Add a document template][2].
