...
Therefore the deletions you make in these tabs are not permanent. You can display items and headings you have deleted by checking **Show deleted items** **and headings**. The deleted elements will then be displayed in the lists, but in red with a strike-through (example).
