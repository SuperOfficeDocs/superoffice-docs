---
uid: help-en-deleting-user-defined-lists-web
title: Deleting user-defined lists web
description: Deleting user-defined lists web
...
> [!TIP]
> To quickly go to a list, click **Lists** in the navigator and start typing in the search field ( ![icon](../media/Soek.bmp) ). The search results are updated while you type.

To delete a user-defined list:

1. Click the **Lists** button in the Navigator (![icon](../media/Knapp-Lister-liten.bmp)).
2. Click the arrow (![icon](../media/pil-ned.bmp)) and select the required list from the list box at the top.
