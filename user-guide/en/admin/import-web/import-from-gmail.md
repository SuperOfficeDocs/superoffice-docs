...
2. Click the Gmail icon ( ![icon][img2] ) under **Select an import source**. What you need to do in the next step depends on whether you are already logged in to Gmail.
