...
**Note**: For every import, a selection will be created in SuperOffice CRM. This allows you to further process the imported companies/contacts, or to delete them.
