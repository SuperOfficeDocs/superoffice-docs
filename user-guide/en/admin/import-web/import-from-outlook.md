...
2. Click the Outlook icon ( ![icon](../media/import_outlook_small.bmp) ) under **Select an import source**. Outlook will open and a dialog will be displayed while the export from Outlook is in progress. <!-- Fix reuse ID=a1 -->
...
3. Click **Next** when you have finished. The **Preview** window opens.  
    <a href="javascript:BSSCPopup(&#39;import_preview_icons.md&#39;);" id="a2" class="BSSCPopup" onmouseover="if (parseInt(navigator.appVersion) &gt;= 4 &amp;&amp; typeof(BSPSPopupOnMouseOver) == &#39;function&#39;) BSPSPopupOnMouseOver(event);">What do the different icons in the table mean?</a>
