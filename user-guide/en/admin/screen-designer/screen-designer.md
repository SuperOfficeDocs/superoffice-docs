...
# ![icon](../media/Knapp_ScreenDesigner.png) Screen designer
...
**Note**: When this feature is activated, the fields in your current **More** tab for the **Company** and **Contact** screens will change to form two columns. You can edit these tabs in the screen designer (see [Edit layout](ScreenDesigner_Edit_layout.md)).
...
[Add new layout](ScreenDesigner_Add_new_layout.md)

[Edit layout](ScreenDesigner_Edit_layout.md)
