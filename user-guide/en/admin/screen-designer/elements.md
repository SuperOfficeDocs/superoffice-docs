...
5. You can also add the link name in other languages by clicking ![icon][img1] (see [Translation][2]).
...
5. You can also add the button name in other languages by clicking ![icon][img1] (see [Translation][2]).
