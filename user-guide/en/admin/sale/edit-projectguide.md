...
5. You can create individual statuses by following the procedure under [Add items to the Project - Status list](../lists/Adding-items-to-Project-Status-list.md).
