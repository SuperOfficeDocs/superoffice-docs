...
To remove a sales guide from a sale type, you can deactivate it. You do this by unchecking **This sale type is linked to a guide** for the sale type in question (see [Add items to the Sale - Sale type (for stages) list](../lists/Adding-items-to-Sale-Sales-type-(for-stages)-list.md)).
