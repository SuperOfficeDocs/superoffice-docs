---
uid: help-en-editing-the-tab-order-of-fields-web
...
4. Click one of the arrows below the list to move the field either up ( ![icon](../media/pil_flyttopp.bmp) ) or down ( ![icon](../media/pil_flyttned.bmp) ).
