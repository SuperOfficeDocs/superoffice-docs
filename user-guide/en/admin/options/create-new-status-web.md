...
4. Complete these fields:
    * **Name**: Enter a descriptive name for the status you want to add.
        Optional: Click ![icon][img2] to add translations of the status name. See [Translation](../../user/standardcrm/translate-fields.md).
