...
6. If there are several statuses in the list, you need to specify the priority you want the status you have added to have. Click the status and use the arrow buttons to the right of the status list ( ![icon](../../../media/icons/admin/pil-flyttopp.bmp) / ![icon](../../../media/icons/admin/pil-flyttned.bmp) ) to move it up or down the list.  
    ![icon](../../../media/icons/admin/question.bmp) <!-- Fix reuse ID=a6 -->
