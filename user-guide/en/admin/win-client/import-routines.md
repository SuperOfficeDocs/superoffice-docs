...
* If you have an existing SuperOffice database that you want to import data into, you must perform a backup before you start. If anything goes wrong during the import, it is best to start again with the original database file. (See the [Backup routines][8] topic.)
