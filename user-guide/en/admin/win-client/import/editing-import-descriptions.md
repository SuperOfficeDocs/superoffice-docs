...
1. Make the necessary changes in the **Import** screen. The fields that are relevant for import descriptions are explained under [Create import descriptions][1].
