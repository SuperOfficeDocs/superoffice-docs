...
5. Under **This setting will apply to**, choose which level the setting will apply to – the whole system, one database, one user group or an individual user (see [Levels for preference settings](Levels_for_preference_settings.md)).
...
For information on how to edit and delete settings, see [Edit preference settings](Editing_preference_settings.md) and [Delete preference settings](Deleting_preference_settings.md).
