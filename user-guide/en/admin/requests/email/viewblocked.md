...
In the **Blocked e-mail** tab is a list of inbound e-mails blocked by an e-mail filter. Click an e-mail to display its contents. If there is insufficient space for all the e-mails on one page, you can click ![icon][img1] to navigate to the next page. This list contains the following columns:
