...
7. Check **Queue status** if requests with this status are to be placed in the queue. See [How to set up Get next request in queue](https://help.superoffice.com/Documentation/Help/EN/CRM/10.1/UserHelp/index.md#t=Service/topics/Get-next-request-in-the-queue.md).
