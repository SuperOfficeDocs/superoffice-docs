...
7. Check **Queue status** if requests with this status are to be placed in the queue. See [How to set up Get next request in queue](../../user/service/request/get-next-request-in-the-queue.md).
