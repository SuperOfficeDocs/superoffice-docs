...
**Disambiguation:** The term "category" is also used for company categories. See [Lists](../chap08/Lists-web.md).

Users can be added as members in the categories individually or via the user group(s) they belong to (see [User groups](../chap07/User-groups.md)).
...
[How to set up Get next request in queue](https://help.superoffice.com/Documentation/Help/EN/CRM/10.1/UserHelp/index.md#t=Service/topics/Get-next-request-in-the-queue.md)
