...
**Disambiguation:** The term "category" is also used for company categories. See [Lists](../chap08/Lists_web.md).

Users can be added as members in the categories individually or via the user group(s) they belong to (see [User groups](../chap07/User_groups.md)).
...
[How to set up Get next request in queue](https://help.superoffice.com/Documentation/Help/EN/CRM/10.1/UserHelp/index.md#t=Service/topics/Get_next_request_in_the_queue.md)
