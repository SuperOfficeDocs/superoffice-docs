...
3. In the **Port** list, select the required access type.
4. In the fields next to **From**, enter the start address of the IP address range.
5. In the fields next to **To**, enter the end address of the IP address range.
