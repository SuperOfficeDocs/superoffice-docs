...
**External description in Customer Centre**: Enter the description text for this purpose to be displayed in Customer Centre. This text should contain (among other things) the following:
