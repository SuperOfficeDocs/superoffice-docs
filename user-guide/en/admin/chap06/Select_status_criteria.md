...
<a href="javascript:BSSCPopup(&#39;Example_-_status_monitors.md&#39;,800,500);" id="a10" class="BSSCPopup" onmouseover="if (parseInt(navigator.appVersion) &gt;= 4 &amp;&amp; typeof(BSPSPopupOnMouseOver) == &#39;function&#39;) BSPSPopupOnMouseOver(event);">Click here to see some examples of criteria</a>
...
5. Click the arrow button ( ![icon](../media/pil_ned.bmp) ) next to the empty field, and select the required search criterion as described under [Use search criteria](using_search_criteria.md).
...
8. Click ![icon](../media/Pil_hoeyre.bmp) **Regenerate selected status monitor** to update the status with the criteria you have added. When the status has been regenerated, no red cross will be shown by the status name.
