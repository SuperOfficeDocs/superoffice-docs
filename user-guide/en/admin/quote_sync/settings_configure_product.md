...
Click the ![icon](../media/pil_flyttned.bmp)![icon](../media/pil_flyttopp.bmp) arrows on the far right to choose the position of the field. This order is also used in the **Add/Edit product** dialog.
