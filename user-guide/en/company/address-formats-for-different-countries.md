...
When you create a company (see [Create new company][1]) and choose which country the company belongs to, the address fields in the **Company** tab change according to your choice. The address fields which change are described below.
