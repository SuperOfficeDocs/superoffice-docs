...
2. Click the ![icon][img1] **Task** button and select **Delete &lt;company name&gt;**.
3. The **Delete Company** dialog opens. Click **Yes** to confirm that you really want to delete the company.
