...
Click the **Add to favourites** button to add the report with the specified criteria to the report list in the **Favourites** tab. See [Favourite reports][1] for more information.

## Related topics

* [Search criteria for reports][2]

<!-- Referenced links -->
[1]: ../../../reports/favorites/index.md
[2]: ../../../reports/search-criteria-reports.md
