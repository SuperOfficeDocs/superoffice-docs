...
> [!NOTE]
> You can also change the time slot by opening the follow-up (see [Open follow-ups in the Diary][1]) and changing the **Start**, **End**, **Due** or **Duration** fields. These fields are described in [The Dialog for follow-ups][2].
