...
1. Delegate a follow-up to someone else by using the **Owner** field in the **Details** tab in the dialog for follow-ups (see [The Details tab][1]), or by clicking the **Task** button and select **Assign to**.
...
1. You can now click the **Reassign** button to assign the follow-up to someone else.
...
1. Link participants to follow-ups in the usual way (see [Add participants to follow-ups][2]).
2. When you have saved the follow-up, it appears in the **Invitations** dialog in SuperOffice CRM for the other person.
3. If the other person declines the invitation, it appears as declined in your own **Invitations** dialog.
...
1. You can now click the **Reschedule** button to find a new suitable time. The dialog for follow-ups appears and you can now set a new time. In practice, points 2 to 4 are repeated until you find a suitable time.
...
[2]: linking-participants-to-follow-ups.md
