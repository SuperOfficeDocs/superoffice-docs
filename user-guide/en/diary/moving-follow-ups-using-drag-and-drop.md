...
> [!NOTE]
> You can only move one follow-up at a time, and only follow-ups that are not completed. (See [Change Completed status of an activity][1].)

## What would you like to do now?

* [Move follow-ups to a different time][2]
* [Move follow-ups between the activities list and the Diary][3]

<!-- Referenced links -->
[1]: marking-activities-as-completed-not-completed.md
[2]: moving-follow-ups-to-different-time.md
[3]: moving-follow-ups-from-activities-list-to-diary.md
