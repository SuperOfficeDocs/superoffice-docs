...
1. If you want to send the order by e-mail, check **Send order confirmation via e-mail**, and choose the e-mail template and language in the lists underneath.
...
1. Click **OK** when you have finished. If you opted to send the order via e-mail, the **New e-mail** dialog appears. Here you can edit the text and send the confirmation to the customer.
