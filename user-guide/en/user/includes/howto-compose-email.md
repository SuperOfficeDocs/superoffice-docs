...
9. To include an FAQ, a reply template or a quick reply in the e-mail message, click ![icon][img4] at the bottom of the window. <!-- Fix reuse ID=a1 -->.
...
[img3]: ../standardcrm/chap07web/media/window-close.png
