...
2. Under **Action on contact**, select one of the following options:
    * Select **Move to** and choose the company you want to move the contact to. Use [FastSearcher](../chap01/Using-FastSearcher.md), [The History list](../chap01/Using-the-history-list.md) or [Find](../chap01/Find-dialog.md) ( ![icon](../../../../media/icons/globalmenu-search.png) ).
