...
1. Make sure the list is sorted by ranking.  
    ...
    If you cannot see the number column, you must first add the Rank column. See [Configure columns](../chap01/Changing_the_column_view.md).

    If the numbers are in a different order, you can click the column heading immediately above to sort the list correctly. For more information about how to sort lists, see [Sort lists](../chap01/Sorting_lists.md).
...
[Sort lists](../chap01/Sorting_lists.md)
