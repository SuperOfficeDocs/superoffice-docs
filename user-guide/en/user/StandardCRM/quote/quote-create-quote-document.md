...
3. Complete the fields with the required information. See [The Document dialog](../chap02/Document-dialog.md) for an explanation of what to enter here.
...
> [!TIP]
> There is a list of the variables you can insert into documents you create. You can find the variables in [Template variables](../chap02/Template-variables.md).
