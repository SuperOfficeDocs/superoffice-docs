...
1. Create a new sale (see [Create a sale](../sale/creating_sales.md)).  
    or  
...
You can now start adding products to the quote. See [Add/edit a product in the quote](quote_add_edit_product.md).

See also

[Edit a sent quote (versions)](quote_sent_edit.md)

[The Edit quote dialog](quote_dlg_edit_quote.md)

[Add alternatives to a quote](quote_add_alternative.md)

[Create a quote document](quote_create_quote_document.md)

[Send a quote](quote_send.md)

[Create an order](quote_create_order.md)
