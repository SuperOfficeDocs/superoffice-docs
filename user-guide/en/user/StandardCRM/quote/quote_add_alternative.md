...
1. Open an existing quote, or create a new one. See [Create a quote](quote_create.md).

2. If you haven't already done so, add any products in the **Products** tab. See [Add products to a quote](quote_add_edit_product.md).
...
If you have created several alternatives in a quote, the first one (usually the **Products** tab) is marked as the favourite ( ![icon](../media/quote_favourite_active.png)**Favourite alternative**). Estimated sales amounts for the sale (forecast) are obtained from the total amount for the favourite alternative.

If you want another alternative to be the favourite, select its tab, and click ![icon](../media/quote_favourite_inactive.png)**Favourite alternative** at the bottom.

When sending the quote, you can select to only include the favourite alternative.

## Delete alternatives

You can delete an alternative by selecting ![icon](../../media/btn_Menu.png)**Task &gt; Delete \[alternative\]** at the bottom of the tab.
