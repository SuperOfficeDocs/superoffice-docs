...
You cannot place the order if the quote has not been approved (see [Approve quote before sending](quote-approve.md)) or contains errors or warnings (see [Deal with warnings and messages when adding products to a quote](quote-product-warnings.md)).
