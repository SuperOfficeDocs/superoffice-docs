---
uid: help-en-sending-documents-from-activities-section-tab
...
1. Go to the **New e-mail** dialog in one of the following ways:
    ...
    **If the dialog is displayed, do as follows:**
    ...
    1. Choose the company to send the document to in the company field. By default the company that is active in the **Company** screen is shown. Here you can also use [FastSearcher](../key-functions/Using-FastSearcher.md) or [The History list](../key-functions/Using-history-list.md). Once you have chosen a company, their e-mail address is displayed next to the company field.
