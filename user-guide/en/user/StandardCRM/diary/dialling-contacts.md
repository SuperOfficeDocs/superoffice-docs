...
3. Click the button next to the contact field ( ![icon](../media/Dialogboksknapper-Telefon.bmp) ). A list of numbers for the selected contact is displayed.
4. Select the number you want to call. The contact is then dialled.

## Call from section tabs (to contacts, selection members, stakeholders and project participants)
