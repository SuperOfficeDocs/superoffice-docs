...
3. (optional) Click ![icon](../media/followup-notcompleted-SMALL.png) in the top-right corner to set the document to **Completed** (![icon](../media/followup-completed-SMALL.png)).

4. Complete the fields with the required information. See [The Document dialog](Document-dialog.md) for an explanation of what to enter here.
