...
![icon](../media/Chap05-diary/chap5-sales-detail.bmp)

In addition to the [Activities section tab](activities-list.md), the Diary also contains the **Sales** section tab, which shows essential information about sales.
...
* the current stage of the sale (see [Enter information in the Sale tab](../sale/CreateSale-Sale-tab.md))
