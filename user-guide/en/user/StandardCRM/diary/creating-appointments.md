...
* Choose **New** &gt; **Appointment** on the [top bar](../key-functions/Buttons-in-menu-bar.md).
...
* Drag and drop using the mouse (see [Create follow-ups from the Diary](Creating-appointments-using-Diary.md)).
