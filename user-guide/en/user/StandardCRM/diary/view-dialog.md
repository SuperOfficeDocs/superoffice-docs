...
Click **Select all** ( ![icon](../media/Merk-alle.bmp) ) if you want to select all the users/resources in the list above. Click **Unselect all** ( ![icon](../media/Velg-bort-alle.bmp) ) to unselect all the users and resources.
