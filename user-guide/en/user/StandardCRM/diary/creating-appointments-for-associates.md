...
When you have opened the diary of an associate on the screen (see [Create group views](Creating-diary-views.md)), you can create appointments for this person yourself. Do this as follows:
