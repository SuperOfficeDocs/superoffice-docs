---
uid: help-en-changing-end-time-for-follow-ups-in-diary
title: Changing the end time for follow-ups in the Diary
description: Changing the end time for follow-ups in the Diary
...
> [!NOTE]
> You can also change the time slot by opening the follow-up (see [Open follow-ups in the Diary](Opening-follow-ups-via-Diary.md)) and changing the **Start**, **End**, **Due** or **Duration** fields. These fields are described in [The Dialog for follow-ups](Dialog-for-followups.md).
