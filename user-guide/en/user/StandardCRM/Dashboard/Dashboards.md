...
Dashboards are displayed as tabs at the top of the screen. Pinned dashboards and dashboards set as favourite are displayed here, in addition to the most recently used dashboard (that is not pinned or set as favourite). To view other dashboards to which you have access, search in the navigator.
