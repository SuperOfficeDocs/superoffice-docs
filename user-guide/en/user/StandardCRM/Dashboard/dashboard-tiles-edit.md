...
6. Click ![icon](../media/Dashboard-Images/tile-icons/translate.png) to add a translation to the tile name, titles and labels. See [Translation](../Translate-fields.md).
7. Click **Save**.
