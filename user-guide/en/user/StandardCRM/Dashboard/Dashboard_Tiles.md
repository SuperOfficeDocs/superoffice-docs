...
* Click on data in a tile (for instance a sector in a pie chart) to display the underlying data. See [View tile data](Dashboard_View_and_filter.md).
...
* Click ![icon](../media/Dashboard_Images/dashboard_tile_options.png) in the header of a tile and select **View in full screen** to open the tile in full screen. This is especially useful for tiles with much content.

## Export tiles

Click ![icon](../media/Dashboard_Images/dashboard_tile_options.png) in the header of a tile to access the following options:
...
[View tile data](Dashboard_View_and_filter.md)

[Edit a tile](Dashboard_Tiles_Edit.md)

[Remove a tile](Dashboard_Tiles_Delete.md)
