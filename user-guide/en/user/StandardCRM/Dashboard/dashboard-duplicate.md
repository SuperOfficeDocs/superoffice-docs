---
uid: help-en-dashboard-duplicate
title: Dashboard duplicate
...
4. To change the name of the dashboard and adjust other settings, click the **Task** button, and select **Edit dashboard**. See [Create a new dashboard](Dashboard-Create.md).
5. To add, edit or delete tiles, and edit the dashboard layout, click the **Task** button, and select **Add tile / Edit layout**. See [Add tiles / Edit layout](Dashboard-Add-Tiles.md).
