...
Time zones are displayed in a list box in the Diary (see [Diary](Diary.md)) and in the dialog for follow-ups (see [The Dialog for follow-ups](../chap02/Dialog-for-followups.md)). The default time zone for your SuperOffice database is displayed at the top, using this icon: ![icon](../media/time-zone-local.bmp).
