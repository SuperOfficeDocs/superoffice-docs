...
You can add more search criteria to a report. If you add criteria to a standard report, you need to save it as a favourite report to keep the changes in the report (see [Add favourite reports](Adding-favourite-reports.md)).
...
1. Click **OK** at the bottom of the **Add/edit search criteria** dialog when you have finished.
