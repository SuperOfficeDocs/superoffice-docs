---
uid: help-en-example-projectguide
title: Example projectguide
description: Example projectguide
...
1. All the follow-ups and documents in the **Planned** status have been completed, and you have moved the project on using the **Project guide - move the project to the next status** dialog. This dialog is displayed when you set the last follow-up to completed. <!-- Fix reuse ID=a4 --> The follow-ups and documents for this new status are now displayed in the **Project guide** section tab.
    The **Project guide - move the project to the next status** dialog only comes up if this behaviour is defined for the project type. If it is not defined, you move the project to the next status as follows:

    1. Click the **Edit** button on the main **Project** card.

    2. Click the arrow next to the **Status** field and select **In progress** from the list.

    3. Click **Save**.

        > [!TIP]
        > You can also right-click the **In progress** button on the **Project guide** section tab and select **Move to this status**.
