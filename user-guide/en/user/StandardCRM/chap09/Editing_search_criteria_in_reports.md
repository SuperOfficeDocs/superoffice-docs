...
You can edit search criteria in favourite reports. Standard reports cannot actually be edited, but you can customise the search criteria in them and save them as your own favourite reports (see [Add favourite reports](Adding_favourite_reports.md)).
...
6. Edit the required information as described under [Use search criteria](../chap01/Using_search_criteria.md).
...
To see an example of how to edit and delete search criteria in a report, see [Edit search criteria - an example](Example_change_search_criteria.md).
