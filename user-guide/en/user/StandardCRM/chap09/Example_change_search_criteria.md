...
1. Double-click the **Sale: Date** criterion in the criteria list. The **Add/edit search criteria** dialog appears.
    ...
    ![icon](../media/Chap10_reports/121_chap10_edit-criteria.bmp)
...
4. Double-click the **Sale: Status** criterion in the criteria list. The **Add/edit search criteria** dialog appears. Now we are going to change the **Sale: Status** criterion so that the report only contains sales which do *not* have the status **Open**.
    ...
    ![icon](../media/Chap10_reports/122_chap10_edit-criteria_2.bmp)

5. Click the arrow next to the **Is one of** field and change the value to **Is not one of**.

6. Select the **Sold** criterion in the **Selected values** column and click the left-pointing arrow (![icon](../media/Pil_venstre.bmp)) between the columns. The criterion is moved over to the left-hand column.

7. Select the **Open** criterion in the left-hand column and click the right-pointing arrow (![icon](../media/Pil_hoeyre.bmp)) between the columns. The criterion is moved over to the **Selected values** column. The report will now contain sales which do *not* have the status **Open**.

8. Click **OK**.

For more information about search criteria and field types, see [Use search criteria](../chap01/Using_search_criteria.md).
