...
Click the **Add to favourites** button to add the report with the specified criteria to the report list in the **Favourites** tab. See [Favourite reports](Favourite_reports.md) for more information.

## Related topics

[Search criteria for reports](Search_criteria_reports.md)
