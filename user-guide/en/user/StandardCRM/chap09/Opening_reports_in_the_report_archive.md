...
Download the document from the **Document** dialog. The report opens in the default program for the format the report was saved in (see [Save reports as files](Saving_reports_as_files.md)).
