---
uid: help-en-adding-favourite-reports
...
Reports which you use a lot or have edited you can add to the list of favourite reports. (See [Favourite reports](Favourite_reports.md)). To do this:
...
3. Select a report from the report list and make the required changes. (See [Edit search criteria in reports](Editing_search_criteria_in_reports.md)).
...
7. Click **OK**. The report is added to the list of favourites.

> [!TIP]
> You can edit the name and description of a favourite report by double-clicking it or selecting it and clicking **Edit**. See [Edit favourite reports](Editing_favourite_reports.md).
