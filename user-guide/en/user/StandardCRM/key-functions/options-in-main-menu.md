---
uid: help-en-options-in-main-menu
...
* **Copy shortcut**: [Create shortcuts to entries in SuperOffice CRM](../company/Creating-shortcuts-to-entries-in-CRM.md)
...
* **Filter**: Click here to edit the filter settings. See [Use filters in the section tabs](Use-filters-in-section-tabs.md).
