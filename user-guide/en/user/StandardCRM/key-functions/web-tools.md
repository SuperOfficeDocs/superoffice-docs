...
You will automatically be asked to upgrade or install SuperOffice Web Tools when you log in to SuperOffice CRM through your browser for the first time on your PC. If this welcome screen does not appear or in case you need to download it again, you can start the SuperOffice Web Tools download wizard manually ( ![icon][img1]) **Main menu &gt; Download &gt; SuperOffice Web Tools**).
