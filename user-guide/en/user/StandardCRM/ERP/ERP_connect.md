...
3. Enter text to search for in the search field and click **Search**. You can also click the search button ![icon](../../media/globalmenu_search.png) to initiate an advanced search (see [Use the Find screen](../chap01/Find_dialog.md)).

> [!TIP]
> If you search with a blank search field, all records in the ERP system will be displayed.

1. Select an item in the hitlist. If you don't get any hits, you can create a new "actor" in the ERP system based on data from SuperOffice CRM. See [Create an actor in the ERP system](ERP_create_new_actor.md).
