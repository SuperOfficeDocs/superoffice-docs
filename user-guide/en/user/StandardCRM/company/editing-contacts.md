---
uid: help-en-editing-contacts
title: Editing contacts
description: Editing contacts
...
4. Click **Edit**.
5. Make the required changes. See [Create new contacts](create-new-contacts.md) for an explanation of the information you can specify here.
