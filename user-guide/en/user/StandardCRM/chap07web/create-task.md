...
This feature allows you to quickly add a task in SuperOffice CRM based on the sender and the text content in the e-mail message.
...
4. Click **Create task**. The **Task** dialog opens. See [The Dialog for follow-ups](../chap02/Dialog-for-followups.md).
