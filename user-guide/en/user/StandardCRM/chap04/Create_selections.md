...
See also [Create combined selections](Creating_combined_selections.md).
...
3. Add your search criteria in the **Criteria** tab as described in [Use search criteria](../chap01/Using_search_criteria.md).
