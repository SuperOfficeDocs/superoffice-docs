...
* click the previous/next buttons ( ![icon](../media/Pil_venstre.bmp)![icon](../media/Pil_hoeyre.bmp) ) at the top right of the screen
...
From the **Tasks** button (lower part of the screen), you can perform specific tasks on the members of a selection, e.g. send an e-mail to contacts linked to the sales in the selection. See [Perform tasks using selections](Performing_tasks_using_selections.md).
...
[Display selections as charts](Display_selections_as_charts.md)

[Edit selections](Editing_Selections.md)
