...
1. You have agreed a meeting time and want to create the **Planning meeting** appointment in the Diary and invite participants.
    ...
    2. Complete the information and invite participants. This is described under [The Dialog for follow-ups](../chap02/Dialog_for_followups.md).
    3. Click **Save**.
...
3. You now want to produce an invitation letter.
    ...
    Click **Create** next to the **Conference invitation** document and create the document. (See [Edit documents](../chap02/Editing_documents.md)).
...
[View follow-ups and documents](View_followups_and_documents.md)
