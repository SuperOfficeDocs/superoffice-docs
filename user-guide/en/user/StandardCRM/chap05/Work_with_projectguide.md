...
2. In the dialog which appears, you create the follow-up/document in the usual way. Many of the fields are prefilled, but you can change the information, or add more information. See [The Document dialog](../chap02/Document_dialog.md) or [The dialog for follow-ups](../chap02/Dialog_for_followups.md).  
...
[Click here for an example of a project guide.](Example_projectguide.md)
