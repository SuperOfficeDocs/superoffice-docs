...
1. Go to the required sale in the **Sale** screen. (See [Use the Find screen](../chap01/Find_dialog.md).)
2. Select the **Stakeholders** section tab.
3. Select one or more stakeholders, and click **Edit** ( ![icon](../../Mailing/media/btn_editor_edit.png) ) at the bottom of the section tab. The **Edit stakeholder** dialog opens.

<!-- -->

1. Select the stakeholders you want to edit.
2. Make the required changes in the **Sales role** and **Comments** fields. There is a description of the different fields under [Create stakeholders](Create_stakeholders.md).
