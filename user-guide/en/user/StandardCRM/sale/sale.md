...
You can also [create a quote](../quote/quote-create.md) in the **Quote** section tab in the **Sale** screen.
...
If you have selected a sale type for which a sales guide has been defined, the **Sales guide** section tab is displayed. For more information, see [Sales guide](sales-guide.md).
