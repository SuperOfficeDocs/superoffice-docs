...
6. Click **Save**.
    * If the sender's email address is recognised, the request is automatically linked to the correct contact and company.
...
<!-- Referenced images -->
[img1]: ../../media/web-email-archive-small.bmp
