---
uid: help-en-adding-e-mail-addresses-in-crm
title: Adding e mail addresses in CRM
description: Adding e mail addresses in CRM
...
# Add e-mail addresses in SuperOffice CRM
...
3. Click the sender's name and e-mail address in the e-mail header.
...
5. Here you have the following options:
    ...
    * **Do not add contact to SuperOffice**: If you are archiving an e-mail message or creating a task, you can click this button if you do not want to register the sender's e-mail address.
6. Fill in the relevant fields and click **Add**.

If you are archiving an e-mail message or creating a task, the **Document** or **Task** dialog opens respectively.
