...
1. Go to the **New e-mail** dialog in one of the following ways:
    ...
    * <!-- Fix reuse ID=a2 -->
    ...
    1. Choose the company to send the document to in the company field. By default the company that is active in the **Company** screen is shown. Here you can also use [FastSearcher](../chap01/Using_FastSearcher.md) or [The History list](../chap01/Using_the_history_list.md). Once you have chosen a company, their e-mail address is displayed next to the company field.
