...
If your IP phone solution is correctly configured (see [Phone preferences](../chap01/Phone_preferences.md)), you can call a contact directly from SuperOffice CRM.
...
3. Click the button next to the contact field ( ![icon](../media/Dialogboksknapper_Telefon.bmp) ). A list of numbers for the selected contact is displayed.
