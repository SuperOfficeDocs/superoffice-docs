...
Open a document and select to edit the document. The document is checked out for editing by you. Other users can only open the document in read mode. See [Edit documents](Editing_documents.md).

## Check in a document after editing

In most cases, you can save and close the document in the application, and the document will be checked in automatically. See [Edit documents](Editing_documents.md).
...
> [!NOTE]
> If you prefer to select read mode or edit mode when you open a document, do as follows: Go to ![icon](../media/globalmenu_personalsettings_small.png)**Personal settings** &gt; **Preferences** &gt; **Functions** and set **Ask to edit or read** to **Yes**.
...
* Read mode: The document is opened for reading. If you make changes to the document, they will not be saved. To save the document with your changes, you must create a new document in SuperOffice CRM and upload the file with your changes. See [Edit documents](Editing_documents.md).
...
2. Click ![icon](../../media/btn_Menu.png) and select **Revert to saved version**.
