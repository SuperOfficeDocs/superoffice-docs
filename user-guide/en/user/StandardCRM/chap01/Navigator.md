...
| ![icon](../media/Navigator-Dagbok.bmp) | **Diary**: opens the **Diary** screen, which is a kind of advanced filofax. See the main [Diary](../chap06/Diary.md) topic. |
...
| ![icon](../media/Navigator-service.png) | **Service**: opens [SuperOffice Service](../../Service/topics/index.md), a web-based system for handling customer requests. This application requires a Service User licence. |
