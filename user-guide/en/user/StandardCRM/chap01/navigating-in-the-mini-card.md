---
uid: help-en-navigating-in-the-mini-card
...
* <!-- Fix reuse ID=a8 -->
    ...
    > [!TIP]
    > If you want to view other companies, without having to switch companies in the **Company** screen, you can use the [history list](Using-the-history-list.md), which you bring up by clicking the arrow ( ![icon](../media/Dialogboksknapper-pil-ned.bmp) ) next to the company name.
* <!-- Fix reuse ID=a9 -->
...
* <!-- Fix reuse ID=a10 -->
    ...
    > [!TIP]
    > If you want to view other projects, without having to switch projects in the **Project** screen, you can use the [history list](Using-the-history-list.md), which you bring up by clicking the arrow ( ![icon](../media/Dialogboksknapper-pil-ned.bmp) ) next to the project name.
* <!-- Fix reuse ID=a11 -->
...
* <!-- Fix reuse ID=a16 -->
    ...
    > [!TIP]
    > If you want to view other sales, without having to switch sales in the **Sale** screen, you can use the [history list](Using-the-history-list.md), which you bring up by clicking the arrow ( ![icon](../media/Dialogboksknapper-pil-ned.bmp) ) next to the name of the sale.
* <!-- Fix reuse ID=a13 -->
    Shows a summary of information about the current selection in the **Selection** screen.

    > [!TIP]
    > If you want to view other selections, without having to switch selections in the **Selection** screen, you can use the [history list](Using-the-history-list.md), which you bring up by clicking the arrow ( ![icon](../media/Dialogboksknapper-pil-ned.bmp) ) next to the selection name.
* <!-- Fix reuse ID=a14 -->
