...
* To activate the grouping, click ![icon](../../media/btn_columnheaderoptions.png) on the far right of the column headers in a section tab and click **Enable grouping**. A new row is now displayed above the column headers.
