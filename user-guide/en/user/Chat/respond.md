...
* ![icon](media/chat-tab-dashbiard.png) A number icon on the **Dashboard** tab. The number indicates how many incoming chats have not been answered by an agent.
...
![icon](media/chat-status-present.png) You will be listed as a present agent and will receive warnings of unanswered chats.

![icon](media/chat-status-away.png) You will not be listed as a present agent and will not receive warnings of unanswered chats. However, you can still respond to incoming chats.
...
4. Try to locate the customer in SuperOffice, so you can see relevant information about the him/her in the side panel, to help you respond to their inquiry. See [Link chat to SuperOffice contact](link-to-person.md).

5. To chat, enter text in the lower part of the screen, and press **ENTER** or click **Send**.

6. To use emojis/stickers, click ![icon](../../../media/icons/chat-btn-emoji.png) next to the text field.

7. If you are unable to help the customer with their question, you can
    * [transfer](transfer-to-another-agent.md) the chat to another agent
    * [create a request](create-request.md) from the chat

8. If you want to send the customer additional information, you can
    * [send an FAQ, a reply template or quick reply](Send-FAQ-or-reply-template.md)
    * [send a file](send-files.md)
