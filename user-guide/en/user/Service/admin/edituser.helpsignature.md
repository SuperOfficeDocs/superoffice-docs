...
2. Click ![icon](../../media/sign-editor-variables.png) in the toolbar to add variables, or go to [template variables](../../diary/Template-variables.md#variables-for-a-selected-contact) for the complete list of available variables.
