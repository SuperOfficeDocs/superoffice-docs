...
2. Click ![icon](../../media/sign-editor-variables.png) in the toolbar to add variables, or go to [template variables](../../standardcrm/diary/Template-variables.md#Variables-for-selected-contact) for the complete list of available variables.
