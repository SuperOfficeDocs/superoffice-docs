...
* **Pop-up**: The notification button ( ![icon](../../media/globalmenu-notice-new.png) ) in the top bar will indicate that you have new notifications. See [Buttons in the Top bar](../getting-started/buttons.topbar.md).
