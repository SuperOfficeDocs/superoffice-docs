...
* Open a request by double-clicking the relevant row. See [List requests](listTicket.md).
...
* **Batch management**: If you select one or more requests in the list, you can click this button and select an action to perform on all the selected requests simultaneously. For example, you can choose to [add the same message to multiple requests](showListTickets.addMassMessage.md), [forward multiple requests](showListTickets.massForward.md) or delete several requests in a single operation.

## Preview

This section of the screen displays the contents of the request selected under **Result**. Here you have the same options as described under [Process requests](listTicket.md). <!-- Fix reuse ID=a1 -->
