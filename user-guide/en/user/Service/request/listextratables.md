---
uid: help-en-ticket-listextratables
title: ticket listExtraTables
description: ticket listExtraTables
...
> [!NOTE]
> The data structures are configured in ![icon][img1] **System settings &gt; System design &gt; Tables**, where you can display and edit data content in the tables. Only administrators have access to this screen. See [Tables](../blogic/).
...
3. Double-click the required table entry in the list. The following options are available:
    ...
    * **New entry**: Click here to create a new entry. See [Create entries](#create-entries).
    * **Copy**: Click here to copy the entry. This takes you to the same screen as for editing. See [Edit entries](#edit-entries).
