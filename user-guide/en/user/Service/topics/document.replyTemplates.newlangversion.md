...
6. **Language**: In this list, select the language for the current language body of the reply template. The list box contains the languages registered under ![icon](../media/globalmenu_settings_small.png)**System settings** &gt; **Customer languages**.
