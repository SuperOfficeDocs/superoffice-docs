...
1. Click ![icon](../media/msg_toolbar.png) to open the text editor toolbar. Here you have various options for editing text and adding additional content.
2. Click ![icon](../../media/sign_editor_variables.png) in the toolbar to add variables, or go to [template variables](../../StandardCRM/chap02/Template_variables.md#Variables_for_selected_contact) for the complete list of available variables.
