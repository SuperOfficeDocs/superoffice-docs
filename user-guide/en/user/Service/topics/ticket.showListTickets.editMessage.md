...
4. Here you have the following options:
    ...
    * **Invoicing**: Displays invoice information for this message. It is possible to edit, delete and add invoice information for the message. See [Invoice information](ticket.newTicket.md#InvoiceInformation).
