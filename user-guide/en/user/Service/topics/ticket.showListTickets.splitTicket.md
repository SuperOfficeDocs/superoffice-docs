...
2. Click the ![icon](../media/btn_Menu.png)**Actions** button and select **Split request**. This takes you to the **Split request** screen. This is where you specify information about the new request.
