...
3. Click the list button ( ![icon](../media/btn-dropdown.png) ), and select what to insert in the message. Optional: Select a language in the language list. If available, the text will be inserted in the selected language. Otherwise the default language will be used. See [Create new language version of reply template](document.replyTemplates.newlangversion.md).
