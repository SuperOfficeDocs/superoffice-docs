...
1. Select ![icon](../media/globalmenu-settings-small.png)**System settings** &gt; **System design** &gt; **Extra menus**.
2. Hold the mouse pointer over the **Navigator** folder and click ![icon](../media/btn-add.png).
...
7. Hold the mouse pointer over the navigator group you have just created and click ![icon](../media/btn-add.png). The **Menu properties** screen appears.
...
11. DO NOT check **Return to same screen**. If checked, external URLs do not work. See [Menu properties](blogic.listExtraMenus.editExtraMenu.md).
