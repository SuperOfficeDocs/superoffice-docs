...
2. Click ![icon](../media/btn-Menu.png)**Actions** and select **Edit request**. This takes you to the **Properties** tab in the **Request** screen.
...
[Use the favourites list](ticket.showListTickets.hotlist.md)
