...
* **Send e-mail notification of open requests**: Specifies whether e-mail about open requests is sent to the users. If you select **User can choose**, users can activate or deactivate e-mail notification from ![icon](../media/globalmenu_PersonalSettings_small.png)**Personal settings** &gt; **Settings** &gt; **Notification**.
