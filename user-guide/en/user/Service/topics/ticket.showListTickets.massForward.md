---
uid: help-en-ticket-showlisttickets-massforward
title: ticket showListTickets massForward
description: ticket showListTickets massForward
...
4. Under **Choose recipient**, you will find the following:
    ...
    * In the next empty field, you can enter an e-mail address if you want to forward the message to someone who has not already been registered in the system.
