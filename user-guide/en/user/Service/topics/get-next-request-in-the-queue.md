...
> [!NOTE]
> Membership in categories can also be defined at group level. In ![icon][img2] **System settings** &gt; **Users** &gt; **User groups** you can state categories for the various user groups. See [User groups](admin.listUsers.listUsergroups.md).
