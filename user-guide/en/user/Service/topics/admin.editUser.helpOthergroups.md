---
uid: help-en-admin-edituser-helpothergroups
title: admin editUser helpOthergroups
description: admin editUser helpOthergroups
...
1. Select ![icon](../media/globalmenu_PersonalSettings_small.png)**Personal Settings &gt; Settings &gt; Other groups** tab.
2. In the **Group** list, select a group.
3. Click the ![icon](../media/btn_add.png)**Add** button. The group is added to the list.
