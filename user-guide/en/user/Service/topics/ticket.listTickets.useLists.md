---
uid: help-en-ticket-listtickets-uselists
title: ticket listTickets useLists
description: ticket listTickets useLists
...
* **Last search**: Repeats the last request search you performed. See [Search for requests](ticket.listTickets.findTickets.md).
...
**Tip:** To restore the default settings, click the ![icon](../media/btn_Menu.png) menu button and select **Restore default**.
