...
| Button | Description |
|---|---|
| ![icon](../../StandardCRM/media/Navigator-Dashboard.bmp) | **Dashboard**: The dashboard provides you with an overview that can be tailored to your needs. See [Dashboard](ticket.mainMenu.md). |
| ![icon](../media/nav-request.png) | **Requests**: This is where you manage requests and enquiries that are in the system. You can also create internal and external requests, respond to incoming enquiries and obtain an overview of the statuses of all requests in the system. See [Requests](ticket.md). |
| ![icon](../media/nav-company.png) | **Customers**: Here you can search for and create companies and contacts. See [Customers](customers.md). |
| ![icon](../media/nav-selection.png) | **Selections**: You use selections to save a set of records, such as a set of requests or contacts that you want to work with later on and elsewhere in the system. See [Selections](selections.md). |
