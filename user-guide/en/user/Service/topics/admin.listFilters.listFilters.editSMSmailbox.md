...
3. In the **Category** list box, select the default category to apply to requests created from SMS messages.

4. In the **Priority** list box, select which priority to assign to requests received via SMS.

5. In the **Customer language** list box, specify which language is to be used for the customers who send messages to this mailbox. For more details about this, see [Customer language](admin.listCustLangs.md).

6. Click **OK**. The SMS mailbox is created.

## Related topics

[SMS inbox](admin.listFilters.viewSMS.inbox.md)
