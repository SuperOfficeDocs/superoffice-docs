...
* You can double-click a row under **Find contacts** in the search results screen (see [Show search results for contacts](customers.findCustomers.showResults.md)).
...
The header of the **Contact** screen contains basic information about the contact: contact name, company and priority. In addition, you can click ![icon][img2] to set the contact as a favourite ( ![icon](../media/favourite-active.png) ). The contact will then be accessible via the favourites list ( ![icon][img3] ) under **Customers** in the Navigator.
...
* **New quick request**: Click here to create a new request as fast as possible, linked to the contact in question. See [New quick request](ticket.newQuickTicket.md).
* **Send password**: Click here to send the contact's user name and password by e-mail. See [Send passwords to contacts](customers.viewCustomer.sendNewCustMail.md).
* **Invoices**: Click here to display invoice data recorded for the contact. See [View invoice data for contacts](customers.viewCustomer.listInvoices.md).
...
[Delete contacts](customers.viewCustomer.deleteCustomer.md)
