...
* **Folder: **If you have organised the screens into a folder structure, click ![icon](../media/btn_dropdown.png) and select a folder.
...
* **Use auto-save**: Activate the autosave function. See [Autosave](ticket.autosave.md).
