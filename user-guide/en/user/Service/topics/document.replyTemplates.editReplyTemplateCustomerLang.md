---
uid: help-en-document-replytemplates-editreplytemplatecustomerlang
title: document replyTemplates editReplyTemplateCustomerLang
description: document replyTemplates editReplyTemplateCustomerLang
...
* When using reply templates in connection with request handling (see [Add reply templates to messages](document.replyTemplates.addReplyTemplatesToMessages.md)), you are free to edit the content of the message before you send it to the customer.
...
5. Make the required changes to the properties. For more information about the fields in this screen, see [Create reply templates](document.replyTemplates.newReplyTemplate.md).
