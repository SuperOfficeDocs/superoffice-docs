...
2. Go to the folder you want to put the reply template in. If it does not yet exist, you can create a new folder. See [Administrate folders of reply templates](document.replyTemplates.editReplyTemplateFolder.md).
...
7. In the **Plain text** tab, enter the following information:
    ...
    * In the large field in the centre of the screen, enter the reply template content itself. It is always this text that is used when you add reply templates to messages. See [Add reply templates to messages](document.replyTemplates.addReplyTemplatesToMessages.md).
...
10. In the **Attachments** tab, you can add attachments to include in the reply template. <!-- Fix reuse ID=a1 -->
    ...
    > [!TIP]
    > You can delete an attachment by clicking **Delete** ( ![icon](../../media/btn-delete.png) ) to the right of the row.
