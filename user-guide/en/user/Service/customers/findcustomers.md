...
All searches in SuperOffice Service, regardless of what you are searching for (requests, companies, contacts, etc.), are performed from the same screen, [which is described in detail in a separate topic.](../topics/rms.search.searchTable.md)

To find contacts that are registered in the system:

1. Select **Customers** &gt; **Find contacts**.
2. Enter the required search criteria under **Criteria**. See [Search in SuperOffice Service](../topics/rms.search.md) to find out how to define search criteria.
3. Click **Search**.
...
> [!TIP]
> There is a more complete description of what you can do in the **Find contacts** screen, under [Search in SuperOffice Service](../topics/rms.search.md).
