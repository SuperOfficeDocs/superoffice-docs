...
* as a task/function in a menu point (such as in ![icon](../media/btn_Menu.png)**Actions** in the **Request** screen)
...
1. In SuperOffice Service: Select ![icon](../media/globalmenu_settings_small.png)**System settings** &gt; **System design** &gt; **CRMScript** and go to the **Macros and scripts** tab.  
...
2. Do one of the following:
    ...
    * To edit an existing macro: Click the macro name. See [View a script/macro](View_script_macro.md).
...
4. Select the **New menu** option to make the macro available from the **Actions** button (![icon](../media/btn_Menu.png)) in the **Company** screen, **Contact** screen or **Request** screen, or **Message** tab.
