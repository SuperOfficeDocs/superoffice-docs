...
You can debug a script or macro by opening it in the **Macros and scripts** tab and click ![icon](../media/btn_debug.png)**Debug script**.
...
You can also click ![icon](../media/btn_script_trace_small.png) **Trace script** to start [tracing a script](Tracing.md).
