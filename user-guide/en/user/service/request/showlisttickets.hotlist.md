...
> [!TIP]
> Before transferring responsibility for the request to someone else (see [Ask another request handler for help](showListTickets.askForHelp.md)), it is a good idea to add it to your favourites list, to remind yourself to follow it up. It will no longer be displayed under **Own open requests** when someone else is defined in the **Owner** field.
