...
8. If you want to move the column farther to the left of the table view, click the up arrow ( ![icon][img4] ) to the right of the relevant entry under **Columns**, until it is correctly positioned.
...
2. Use the up arrow ( ![icon][img5] ) to move this column until it is just below the **Created** (ticket.created\-at) column.
...
9. If you want to move the column farther to the left of the table view, click the up arrow ( ![icon][img6] ) to the right of the relevant entry under **Columns**, until it is correctly positioned.
...
2. Go to the **Profile** tab. Under **Columns** is a list of the columns already specified.
3. Use the arrow buttons ( ![icon][img7] and ![icon][img8] ) to the right of the columns to move the various columns where you want.
...
[img7]: ../../../../media/icons/service/btn-RankUp.png
[img8]: ../../../../media/icons/service/btn-RankDown.png
