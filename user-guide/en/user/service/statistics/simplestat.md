---
uid: help-en-stat-simplestat
title: stat simpleStat
description: stat simpleStat
...
1. Set the date interval:
    * **From date** and **To date**: In these fields, you must enter the date interval for which you want statistics. Set a date by clicking the calendar icon (![icon](../../../../media/icons/service/calendar.png)) or by typing the date into the field. To select today's date, click ![icon](../../../../media/icons/service/btn-clock.png).
