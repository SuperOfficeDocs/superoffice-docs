...
* You can double-click a row under **Find companies** in the search results screen (see [Show search results for companies](findContacts.showResultsContacts.md)).
...
* **Edit company**: Click here to change the details registered for the company. See [Edit companies](viewCompany.editCompany.md).
* **New contact**: Click here to create a new contact linked to the active company. See [Create contacts](newCustomer.md).
* **Invoices**: Click here to display invoice data recorded for the company. See [View invoice data for companies](viewCompany.listInvoicesContact.md).
