...
All searches in SuperOffice Service, regardless of what you are searching for (requests, companies, contacts, etc.), are performed from the same screen, [which is described in detail in a separate topic.][1]
