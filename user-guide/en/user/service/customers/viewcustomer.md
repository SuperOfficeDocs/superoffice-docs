...
* You can double-click a row under **Find contacts** in the search results screen (see [Show search results for contacts][1]).
...
* **New request**: Click here to create a new request linked to the contact in question. See [Create requests][4].
...
* **Invoices**: Click here to display invoice data recorded for the contact. See [View invoice data for contacts][7].
...
* [Edit contacts][3]
* [Delete contacts][8]
* [Send passwords to contacts][6]
* [View invoice data for contacts][7]
