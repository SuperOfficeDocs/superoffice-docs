...
* When using reply templates in connection with request handling (see [Add reply templates to messages][1]), you are free to edit the content of the message before you send it to the customer.
...
5. Make the required changes to the properties. For more information about the fields in this screen, see [Create reply templates][2].
...
<!-- Referenced links -->
[1]: addReplyTemplatesToMessages.md
[2]: newReplyTemplate.md
[3]: newlangversion.md
[4]: viewreplytemplate.md#copy-reply-templates
