...
* <!-- Fix reuse ID=a9 -->
    ...
    ![icon][img6] <!-- Fix reuse ID=a2 -->

    In a dynamic selection, you can choose to show companies only, without specifying a contact. If **Include main contact** is not checked in the dynamic selection (see [Creating dynamic selections][7]), no information will be displayed in the **Contact** view for the side panel, even if you have selected a contact.
* <!-- Fix reuse ID=a3 -->
