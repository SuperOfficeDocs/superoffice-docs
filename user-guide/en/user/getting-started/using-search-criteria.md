...
1. Go to the criteria list.
    ...
    * The **Find** screen:
        Click **Find** in the top bar (see [Use the Find screen][1]). The criteria list is in the **Criteria** tab.
...
5. Click **Add** to add a new line, or click **Or** to add a new set of criteria. (See [Use the Find screen][1].)
