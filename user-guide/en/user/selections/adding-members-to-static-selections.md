...
When you have created a static selection (see [Creating static selections][1]), you can always add additional members to that selection. This can be done from any list containing the relevant records, such as search results and section tabs.
...
> [!TIP]
> To copy members from another selection, see [Copy into selections][3].
