...
From the **Tasks** button (lower part of the screen), you can perform specific tasks on the members of a selection, e.g. send an e-mail to contacts linked to the sales in the selection. See [Perform tasks using selections][1].

## What would you like to do now?

* [Create selections][2]
* [Perform tasks using selections][1]
* [Create combined selections][3]
...
[3]: creating-combined-selections.md
[4]: display-selections-as-charts.md
[5]: editing-selections.md
[6]: deleting-selections.md
