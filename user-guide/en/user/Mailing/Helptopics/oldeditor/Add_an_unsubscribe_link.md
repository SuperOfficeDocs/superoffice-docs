---
uid: help-en-add-an-unsubscribe-link
...
1. Go to the contents of the message and edit a paragraph (see [Edit a paragraph](Edit_a_paragraph.md)) to open the editing view.  
    Or click the **Add a new paragraph** ( ![icon](../../media/btn_editor_newpara.jpg) ) button to add a paragraph at the bottom.
2. Select the **Body** tab.
3. Position the mouse pointer where you wish to insert the link.
4. Click the ![icon](../../media/btn_link.png)**Subscription links** button in the toolbar. The **Add (un)subscription link** dialog opens.
...
6. In the **Add (un)subscription link** field, select one of the following options:
    ...
    * **Unsubscribe from this type of mailing**: Inserts a link to unsubscribe to this mailing type. The recipient will still receive mailings of other types. The mailing type is selected in [Step 1: Setup](../step_1_setup_email.md).
...
> [!NOTE]
> This means that the customer no longer receives this mailing type from SuperOffice Marketing, regardless of which recipient list is used for the mailing. This may be not what you want for future marketing purposes. For more about alternative unsubscription methods, see [Examples of the use of trackable links](../Examples_of_the_use_of_trackable_links.md).  
You do, however, have the possibility to override "no consent / no subscription" settings, from **Options** in the lower part of the **Recipients** screen (see [Step 4: Recipients](../Step_4__Recipients_email.md)).
...
You do this by creating a link that removes the interest in question from recipients who click the link. The same method can be used to register interests. See [Update interest](../Define_link_actions.md#update_interest).
