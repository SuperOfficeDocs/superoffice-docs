---
uid: help-en-insert-images-in-the-message
...
2. Click the **Edit paragraph** ( ![icon](../../media/btn_editor_edit.png) ) button in the paragraph where you wish to insert the image.
...
6. Click **Resize image** ( ![icon](../../media/btn_resize.jpg) ). Here you can:
...
8. Click ![icon](../../media/btn_green_check.jpg)**Select this image** to use this image. This takes you back to the **Edit paragraph** dialog.
...
12. In the **Link for image** field, you can add a link to make the image clickable. For example, if you are inserting a picture of a product you are launching, you can add a link to an information page for the product. Here you have the following options:
    * Click ![icon](../../media/btn_folder.png) to select an existing link (tracked).
    * Click ![icon](../../media/btn_Add.png) to create a new link. See [Create tracked links](../Create_links.md).
    * Click ![icon](../../media/btn_editor_edit.png) to edit a selected link. See [Create tracked links](../Create_links.md).
