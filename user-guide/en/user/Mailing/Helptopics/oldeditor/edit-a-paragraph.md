...
2. Hover the mouse pointer over the paragraph you wish to edit, so that the paragraph menu is shown.  
    ![icon](../../media/editor-menu-para.jpg)
3. Click the **Edit paragraph** button ( ![icon](../../media/btn-editor-edit.png) ). The editing view opens next to the preview.  
...
5. Click **Spellcheck** ( ![icon](../../media/btn-spellcheck.jpg) ) on the toolbar in the **Heading** and **Body** tabs and select a language to spellcheck the message in that language.
