...
* **Data**: Here you enter the values for each radio button. Enter a value in this field and click the add button (![icon](../media/btn_Field_value_add.png)). Repeat to add additional values.

**Checkbox**: A selection field where you can select multiple values.

* **Vertical**: Display the values horizontally or vertically.
* **Data**: Here you enter the values for each checkbox. Enter a value in this field and click the add button (![icon](../media/btn_Field_value_add.png)). Repeat to add additional values.

**Drop-down**: A selection field where you can select a value from a list.

* **Data**: Here you enter the list values. Enter a value in this field and click the add button (![icon](../media/btn_Field_value_add.png)). Repeat to add additional values.
...
**Text block**: Enter a text to display in the form, such as a short introduction or detailed description. Click **Show/hide toolbar** (![icon](../media/btn_editor_toolbar_showhide.png)) to display formatting options for the text. Click **Open text editor in dialog** (![icon](../media/btn_editor_open.png)) to edit the text in a larger editor.
...
**Section**: Add a section between the fields to create a multi-page form. This is very useful if your form contains many fields and you want to avoid scrolling. See [Create multi-page forms](form_create_multi-page.md).
