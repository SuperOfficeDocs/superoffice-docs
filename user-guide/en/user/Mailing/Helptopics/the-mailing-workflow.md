...
* **Mailings** (e-mails, SMS, documents and form responses). To get started with your first mailing, go to [Create new mailing](CreateNewMailing.md).
* **Forms**. To get started on your first form, go to your first mailing, go to [Work with forms](form-work-with.md).
...
* **Mailings**: Here you can find all mailings and create new ones. See [Create new mailing](CreateNewMailing.md).
...
* **Tracked links**: Here you can find all tracked links used in your mailings. Click the ![icon](../media/btn-Add.png)**Add** button to create a new link. See [Create tracked links](Create-links.md).
* **Images**: Here you can find all available images in SuperOffice Marketing. Click the ![icon](../media/btn-Add.png)**Add** button to add new images. See [Add images](Add-images.md).
