...
8. In the **Selection** and **Project** fields, you can associate the mailing with a selection and/or a project. [!include[Start typing to search](../../includes/type-to-search.md)] <!-- Fix reuse ID=a2 -->
