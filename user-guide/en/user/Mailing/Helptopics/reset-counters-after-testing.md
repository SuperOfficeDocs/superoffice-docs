...
2. Click the menu button ( ![icon](../media/btn-Menu.png) ) next to the relevant link and select **Reset**. The **Clicks** column is set to **0**. Data about which customers have clicked the link are also removed.
