...
Click **Mobile** ( ![icon][img1] ) in the global menu to see what the appearance is like on a smart phone. You can also click a section in the message and click **Mobile** ( ![icon][img2] ) under **Content** in the side-panel.
...
[img2]: media/btn-editor-mobile.png
