...
6. In the **Our ref** field, enter the name that should appear as our reference in the document. You can use SuperOffice CRM [template variables][1] in this field. Some examples have been provided below this field.
...
9. Click **Next** to go to the next step: [Step 2: Template][2].
