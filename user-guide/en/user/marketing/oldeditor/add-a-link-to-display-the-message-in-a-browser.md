...
3. Position the mouse pointer where you wish to insert the link.  
    ![icon](../media/Loc/content-edit-toolbar-tempvar.png)
4. Click the ![icon](../media/btn-Variable.png)**Template variables** button on the toolbar. The **Add template variable** dialog opens.
