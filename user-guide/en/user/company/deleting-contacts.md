...
> [!TIP]
> Instead of deleting a contact, you can check **Former employee** in the contact card (see [Create new contacts][2]). Then this person’s name will not disappear from activities, for example, to which he or she is linked.
...
[3]: merge-contacts.md
[4]: ../standardcrm/key-functions/bulk-update.md
[5]: ../standardcrm/key-functions/deleting-elements-in-crm.md
[6]: ../standardcrm/key-functions/restore-deleted-companies-and-contacts.md
