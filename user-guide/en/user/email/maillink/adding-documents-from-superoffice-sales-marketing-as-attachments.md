---
uid: help-en-adding-documents-from-superoffice-sales-marketing-as-attachments
title: Adding documents from SuperOffice Sales Marketing as attachments
description: Adding documents from SuperOffice Sales Marketing as attachments
...
When creating an email (see [Creating emails from Microsoft Outlook][1] or [Creating emails from Lotus Notes][2]) you can add documents from SuperOffice CRM as attachments. Follow these steps:

1. In the email window, click the **Attach document** button (![icon][img1]). The **Include attachments** dialog opens.
...
4. From the **Date range** dropdown, select the period in which the document(s) you are looking for was/were created.
...
<!-- Referenced images -->
[img1]: ../../../../media/icons/maillink/add-document.png
[img2]: ../../../../media/icons/maillink/arrow.png
