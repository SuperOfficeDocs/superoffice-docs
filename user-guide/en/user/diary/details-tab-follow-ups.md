...
For notification of the follow-up, check **Alarm**.For more information about this, see [Set alarms for follow-ups][2]. If an alarm has been specified for a follow-up, an icon ( ![icon][img2] ) is displayed at the upper left of the main part of the dialog.
...
[2]: setting-alarm-for-follow-ups.md

<!-- Referenced images -->
[img1]: ../../../media/icons/recurring-booking-assignment.bmp
[img2]: ../../../media/icons/followup-details-alarm.bmp
