...
1. Go to ![icon][img1] **Personal settings &gt; Preferences**.
2. Select **Visual effects**, and then edit the **Remove completed activities** preference as described in the [Preferences][8] topic.
...
* [View activities in the activities list][3]
* [Open activities in the activities list][4]
* [Create follow-ups in the activities list][5]
* [Move between activities in the activities list][6]
* [Delete activities in the activities list][7]

<!-- Referenced links -->
[1]: marking-activities-as-completed-not-completed.md
[2]: dialog-for-followups.md
[3]: viewing-activities-in-activities-list.md
[4]: opening-activities-in-activities-list.md
