...
You can edit search criteria in favourite reports. Standard reports cannot actually be edited, but you can customise the search criteria in them and save them as your own favourite reports (see [Add favourite reports][1]).
...
To see an example of how to edit and delete search criteria in a report, see [Edit search criteria - an example][3].
