...
2. Select the required label report (see [Show report properties][1]).
...
4. In the **Choose label** dialog, select the required label format.
    ...
    > [!NOTE]
    > You can also edit an existing label format to use for printing (see [Edit label formats][2]) or add a new label format (see [Add label formats][3]).
...
[2]: editing-label-formats.md
[3]: adding-label-formats.md
