...
* A report list showing available reports. This list is always at the top left of the screen.In the **Favourites** tab, this list shows the favourite reports, while in the other tabs, it shows all published reports. See [Report list][2] for more information.
...
<!-- Referenced links -->
[1]: showing-report-properties.md#report-types
[2]: report-list.md
[3]: search-criteria-reports.md
[4]: criteria-list.md
[5]: report-archive.md
