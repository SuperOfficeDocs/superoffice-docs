...
You could create a selection containing all projects of the type "Internal" which are current. This would allow you to assess which of them can be closed/completed, and which it is worth still working on.
...
And you can create a selection containing all follow-ups you have this month, to see what appointments you have and whether you should set up more.
...
[3]: ../../sale/saint/using-status-monitors-in-dynamic-selections.md
