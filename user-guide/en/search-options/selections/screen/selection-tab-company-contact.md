---
uid: help-en-selection-tab-company-contact
title: selection tab Company contact
description: selection tab Company contact
...
The **Company/contact** tab contains companies and contacts linked to the list of members. If the selection is a selection of companies/contacts, this is the only tab with members.
...
* **Remove members**. This option is only available for static selections. See [Remove members from static selections][1]. To remove specific members of the selection, select the relevant members, right-click and select **Remove**.
...
* [Perform tasks using selections][2]
* [Use filters in the section tabs][4]
* [Create selections][3]

<!-- Referenced links -->
[1]: ../update/remove-members-from-static.md
[2]: ../howto/index.md
[3]: ../create/index.md
[4]: ../../../clients/howto/use-filters-in-section-tabs.md
