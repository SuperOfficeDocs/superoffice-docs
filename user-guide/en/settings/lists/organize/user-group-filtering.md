...
You can select several user groups for one item. Click **Select all** (![icon][img3]) to select all the groups, or **Unselect all** (![icon][img5]) to remove all selections.
