...
3. **Automatically send confirmation email to contact**: Select this option if you want to send an automatic confirmation to new contacts when this source is used as a legal basis for their consent.
...
4. If you selected the option above, you must select a template for the confirmation to be sent to the contact.
    ...
    Only document templates where the option **Privacy email template** has been activated, are available in the list. [How to dd a document template][1].
