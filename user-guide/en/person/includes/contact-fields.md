...
> [!TIP]
> In the **Country** field, enter the contact’s country. The correct address format for the address field is updated automatically. You can set your current home country from **System** in the [preferences][1].
