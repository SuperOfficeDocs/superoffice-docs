---
uid: help-en-document-replytemplates-newreplytemplate
title: document replyTemplates newReplyTemplate
description: document replyTemplates newReplyTemplate
...
10. In the **Attachments** tab, you can add attachments to include in the reply template. <!-- Fix reuse ID=a1 -->
