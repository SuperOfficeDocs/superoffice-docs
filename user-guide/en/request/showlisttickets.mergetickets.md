...
1. Open one of the requests you want to merge. (See [Process requests][1].)
...
The requests that have been overwritten (i.e. the request IDs have been overwritten) will no longer be available in favourites and history lists and regular search. If you enter an overwritten request ID in the quick search field (see [Use quick search][2]), you are redirected to the merged request.
