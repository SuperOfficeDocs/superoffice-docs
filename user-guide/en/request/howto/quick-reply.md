---
uid: help-en-request-create-quick
title:  New quick request
description:  New quick request
...
3. In the **Category** field, select a [category][4] for the request.
...
6. In the **Contact** field, add the contact for the request.
    * To search for a contact, start typing their name. The search starts automatically.
    * If the contact is not recorded in the system, click ![icon][img1] to add them as a [new contact][2].
