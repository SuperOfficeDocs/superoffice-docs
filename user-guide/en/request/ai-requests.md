...
If this function is active, incoming e-mail requests will be analyzed to determine the "mood" of the customer. An emoticon below the message will indicate the detected sentiment (happy, unhappy or neutral).
