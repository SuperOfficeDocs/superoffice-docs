...
| Option | Description |
|---|---|
| Use SuperOffice email body | You can predefine an email body that uses data from SuperOffice CRM. In order to use this template, you need to select this option. |
