...
title: Archiving emails as tasks in SuperOffice Sales Marketing
description: Archiving emails as tasks in SuperOffice Sales Marketing
...
If you receive an email requesting you to do something, you can convert the email into an activity in SuperOffice CRM. Follow these steps:
...
3. If the sender of the email is not listed in SuperOffice CRM, a warning will appear at the top of the **Create activity** dialog: **This sender's email address is not recognised. Click here to update SuperOffice with this email address**. See [Handling emails from senders not listed in SuperOffice CRM][1] for information on how to handle unlisted senders.
...
<!-- Referenced links -->
[1]: handling-emails-from-senders-not-listed-in-superoffice-sales-marketing.md
[2]: archiving-emails-on-companies-contacts-in-superoffice-sales-marketing.md
[3]: archiving-attachments-to-superoffice-sales-marketing.md
[4]: archiving-emails-as-requests.md
