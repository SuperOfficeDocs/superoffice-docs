...
* **Visible for**: Select if the document will be visible to all users, private visible only to the owner) or visible to all users in a user group to which the owner belongs.
