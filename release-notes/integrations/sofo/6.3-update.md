...
Only relevant file attachments appear when archiving documents from an email — signature images are filtered out automatically. This makes it faster to find and select the files that actually matter.
