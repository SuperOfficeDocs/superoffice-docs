---
uid: version_10.3.12.678_changes
date: 11/12/2024
---

Changes from v10.3.11.910 and v10.3.12.678
...
* New items
  * Method `CreateNewPhysicalDocumenFromEmail(Int32, Int32)`
  * Method `CreateNewPhysicalDocumenFromEmailAttachment(Int32, Int32, String)`
...
* `SuperOffice.CD.Database.ShipmentLinkRedirectKind`
* `SuperOffice.CD.DSL.Database.Steps_Mailing.Mailing_14_LinkRedirectKind`
* `SuperOffice.CD.DSL.Database.Steps_Mailing.Mailing_15_RemoveRedirectIsUrl`
* `SuperOffice.CD.DSL.Database.Steps_Mailing.Mailing_16_LinkRedirectFormId`
* `SuperOffice.CD.DSL.Database.Steps_SuperOffice.SuperOffice_115_Document_ContentSetCount`
* `SuperOffice.CD.DSL.Database.Steps_SuperOffice.SuperOffice_116_PrepareRemoveReporter`
