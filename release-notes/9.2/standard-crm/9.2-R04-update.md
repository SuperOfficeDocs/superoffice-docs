...
You can click on the Video meeting button in an Appointment dialog and instantly create a URL for where to hold your video meeting. This URL is sent in the invitation to internal and external participants, so it’s easy for everyone to meet in the correct place.
...
## Preference – Turn off creation of tentative appointments

When invitations from externals are processed by the Inbox or the MailLink, the default setting is set to create tentative bookings for all participants included in the invitation that are stored in SuperOffice CRM.
...
<!-- Referenced links-->
[1]: ../../../docs/video-meeting/connect-provider.md
