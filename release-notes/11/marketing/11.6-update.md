...
To identify where leads are coming from, publish your forms using URLs that include UTM parameters. Use either the direct link or one of the other options. . Ensure the UTM tracking script is added to your website(s) to capture source data correctly.
