...
The v11 release includes the changes since the v10.5 API release. However, there are a few notable differences between this `API changes` listing compared to previous versions.
