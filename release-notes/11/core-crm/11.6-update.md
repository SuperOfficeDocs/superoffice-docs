...
category: Core CRM
license: salesessentials, marketingessentials
audience: person
...
Get a clear overview of your companies or contacts grouped by **Lead status**, **Category**, or **Our contact**. Create a company or contact selection and open it in [Board view][3] to visualise and manage your data more effectively.
...
When [working with leads][2], the **Lead status** field is a valuable tool for organising and tracking progress. It becomes especially useful in the **Board view** of a contact selection, where you can easily drag and drop contacts between columns to update their status.
...
[2]: ../../../docs/en/lead/learn/work-with-leads.md
[3]: ../../../docs/en/search-options/selection/learn/board-view.md
