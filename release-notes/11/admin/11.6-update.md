...
Creating web panels to show in the UI is a great way to take information from the outside and into SuperOffice. You can also connect it to the content by using template variables.

To make sure the content are updated make sure to check on the option for "Always reload content on tab navigation".
