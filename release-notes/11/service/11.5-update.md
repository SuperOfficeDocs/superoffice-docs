...
When you’re working with multiple request types, it can be time-consuming to keep track of them all, especially when you have a lot of requests opened. To make this easier, the request type icon appears in front of the request ID in the tab, helping you quickly see what type of request it is.

These icons are shown in:

* Request type menu in the Properties sidebar
* The request tab

![The request type drop down shows an icon in front – screenshot][img1]

To use this feature, remember to add icons to your **Request types** in [Settings and maintenance][1].
