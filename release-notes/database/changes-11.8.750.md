---
uid: database-whats-new-11.8.750.0
title: What's new in version 11.8.750.0
description: What's new in database version 11.8.750.0.
generated: true
keywords: database
...
# Released database changes in version 11.8.750.0
...
Increase length of Credentials.Secret and login.ns_secret.
...
Add column OwnerLock on table s_shipment_addr
...
* Modify table sequence
* Modify table company
* Modify table associate
* Modify table AssociateGroupLink
* Modify table AssociateHeadingLink
* Modify table contact
* Modify table person
...
* Modify table sale
* Modify table contactinterest
* Modify table personinterest
* Modify table ziptocity
* Modify table redletterday
* Modify table text
* Modify table country
* Modify table CountryGroupLink
* Modify table CountryHeadingLink
* Modify table preference
* Modify table selection
* Modify table selectionmember
* Modify table SORPublishGroupLink
* Modify table QuoteConnection
* Modify table QuoteConnectionAccess
* Modify table activeuser
* Modify table traveltransactionlog
* Modify table travelgeneratedtransaction
* Modify table traveller
* Modify table travelcurrent
* Modify table travelgenerateddatabase
* Modify table Quote
* Modify table udcontactSmall
* Modify table udcontactLarge
* Modify table MergeMoveLog
* Modify table area
* Modify table QuoteVersion
* Modify table areauserassignment
* Modify table areauserinclusion
* Modify table satellite
* Modify table travelidmapping
* Modify table freetextstopwords
* Modify table freetextwords
* Modify table freetextindex
* Modify table QuoteAlternative
* Modify table relationdefinition
* Modify table RelDefGroupLink
* Modify table RelDefHeadingLink
* Modify table relationtarget
* Modify table relations
* Modify table History
* Modify table URL
* Modify table Email
* Modify table UserPreference
* Modify table AddressFormat
* Modify table Heading
* Modify table UserGroup
* Modify table UserGroupLink
* Modify table Business
* Modify table BusinessGroupLink
* Modify table BusinessHeadingLink
* Modify table Category
* Modify table CategoryGroupLink
* Modify table CategoryHeadingLink
* Modify table Task
* Modify table TaskGroupLink
* Modify table TaskHeadingLink
* Modify table ContInt
* Modify table ContIntGroupLink
* Modify table ContIntHeadingLink
* Modify table PersInt
* Modify table PersIntGroupLink
* Modify table PersIntHeadingLink
* Modify table PersPos
* Modify table PersPosGroupLink
* Modify table PersPosHeadingLink
* Modify table Priority
* Modify table PriorityGroupLink
* Modify table PriorityHeadingLink
* Modify table Prob
* Modify table ProbGroupLink
* Modify table ProbHeadingLink
* Modify table ProjType
* Modify table ProjTypeGroupLink
* Modify table ProjTypeHeadingLink
* Modify table ProjStatus
* Modify table ProjStatusGroupLink
* Modify table ProjStatusHeadingLink
* Modify table PMembType
* Modify table PMembTypeGroupLink
* Modify table PMembTypeHeadingLink
* Modify table MrMrs
* Modify table MrMrsGroupLink
* Modify table MrMrsHeadingLink
* Modify table Credited
* Modify table CreditedGroupLink
* Modify table CreditedHeadingLink
* Modify table Source
* Modify table SourceGroupLink
* Modify table SourceHeadingLink
* Modify table Reason
* Modify table ReasonGroupLink
* Modify table ReasonHeadingLink
* Modify table SearchCat
* Modify table SearchCatGroupLink
* Modify table SearchCatHeadingLink
* Modify table Comptr
* Modify table ComptrGroupLink
* Modify table ComptrHeadingLink
* Modify table Currency
* Modify table CurrencyGroupLink
* Modify table CurrencyHeadingLink
* Modify table ReasonSold
* Modify table ReasonSoldGroupLink
* Modify table ReasonSoldHeadingLink
* Modify table SaleTypeCat
* Modify table SaleTypeCatGroupLink
* Modify table SaleTypeCatHeadingLink
* Modify table SaleStakeholder
* Modify table StakeholderRole
* Modify table StakeholderRoleGroupLink
* Modify table StakeholderRoleHeadingLink
* Modify table SuggestedAppointment
* Modify table SuggestedDocument
* Modify table QuoteLine
* Modify table PriceList
* Modify table Product
* Modify table DocTmpl
* Modify table DocTmplGroupLink
* Modify table DocTmplHeadingLink
* Modify table ExtApp
* Modify table ExtAppGroupLink
* Modify table ExtAppHeadingLink
* Modify table UDList
* Modify table UDListGroupLink
* Modify table UDListHeadingLink
* Modify table UDListDefinition
* Modify table udpersonSmall
* Modify table udpersonLarge
* Modify table udprojectSmall
* Modify table udprojectLarge
* Modify table udtempSmall
* Modify table udtempLarge
* Modify table UDefField
* Modify table UDefFieldGL
* Modify table CacheTables
* Modify table SaleType
* Modify table SaleTypeGroupLink
* Modify table SaleTypeHeadingLink
* Modify table TabOrder
* Modify table SystemEvent
* Modify table ReasonStalled
* Modify table ReasonStalledGroupLink
* Modify table ReasonStalledHeadingLink
* Modify table SaleHist
* Modify table udsalesmall
* Modify table udsalelarge
* Modify table SaleTypeStageLink
* Modify table OLESubject
* Modify table OLESubjectText
* Modify table OLEView
* Modify table OLEViewText
* Modify table OLEField
* Modify table OLEFieldText
* Modify table OwnerContactLink
* Modify table FieldLabel
* Modify table LocaleText
* Modify table ReporterListDef
* Modify table RefCounts
* Modify table RefCountRange
* Modify table SORTemplate
* Modify table SORPublish
* Modify table SORCriteria
* Modify table SOROperators
* Modify table SORSection
* Modify table SORFCT
* Modify table SORField
* Modify table SORLabelLayout
* Modify table foreignapp
* Modify table foreigndevice
* Modify table foreignkey
* Modify table PrefDesc
* Modify table PrefDescLine
* Modify table ImportObject
* Modify table ImportField
* Modify table ImportRelation
* Modify table ImportDefault
* Modify table UsageStats
* Modify table Role
* Modify table UserRoleLink
* Modify table FunctionRight
* Modify table FunctionRightRoleLink
* Modify table DataRight
* Modify table VisibleFor
* Modify table CounterValue
* Modify table StatusDef
* Modify table StatusValue
* Modify table Publish
* Modify table SearchCriteria
* Modify table SearchCriteriaGroup
* Modify table SearchCriterion
* Modify table SearchCriterionValue
* Modify table BinaryObject
* Modify table BinaryObjectLink
* Modify table RecurrenceRule
* Modify table WinPosSize
* Modify table SuperListColumnSize
* Modify table LanguageInfo
* Modify table LanguageInfoCountry
* Modify table ModuleOwner
* Modify table ProjectTypeStatusLink
* Modify table DiaryView
* Modify table DiaryViewRow
* Modify table Intent
* Modify table IntentGroupLink
* Modify table IntentHeadingLink
* Modify table Salutation
* Modify table SalutationGroupLink
* Modify table SalutationHeadingLink
* Modify table RejectReason
* Modify table RejectReasonGroupLink
* Modify table RejectReasonHeadingLink
* Modify table AmountClass
* Modify table AmountClassGroupLink
* Modify table AmountClassHeadingLink
* Modify table udappntsmall
* Modify table udappntlarge
* Modify table uddocsmall
* Modify table uddoclarge
* Modify table AudienceVisibility
* Modify table ExternalEvent
* Modify table AudienceLayout
* Modify table AudienceLayoutLink
* Modify table AudienceConfig
* Modify table ModuleLicense
* Modify table LicenseAssocLink
* Modify table LicenseSatlLink
* Modify table ProductVersion
* Modify table MessageHandler
* Modify table Message
* Modify table BatchTask
* Modify table BatchTaskDefinition
* Modify table TZLocation
* Modify table TZStdRule
* Modify table TZDstRule
* Modify table BaseTZLocation
* Modify table WebAppUsage
* Modify table Credentials
* Modify table PhoneFormat
* Modify table TrayApp
* Modify table registry
* Modify table session\_object
* Modify table config
* Modify table ticket\_attachment
* Modify table ej\_category
* Modify table ej\_message
* Modify table message\_header
* Modify table message\_customers
* Modify table ticket\_status\_history
* Modify table ticket
* Modify table ticket\_status
* Modify table ticket\_customers
* Modify table invoice
* Modify table invoice\_sum
* Modify table ticket\_log
* Modify table ticket\_log\_change
* Modify table ticket\_log\_action
* Modify table category\_membership
* Modify table mail\_in\_filter
* Modify table mail\_in\_uidl
* Modify table mail\_alias
* Modify table ticket\_alert
* Modify table ticket\_priority
* Modify table reply\_template\_folder
* Modify table reply\_template
* Modify table reply\_template\_attachment
* Modify table reply\_template\_body
* Modify table doc\_document
* Modify table doc\_folder
* Modify table kb\_entry
* Modify table kb\_category
* Modify table kb\_attachment
* Modify table kb\_http\_link
* Modify table kb\_group
* Modify table kb\_group\_entry
* Modify table kb\_entry\_keyword
* Modify table kb\_entry\_comment
* Modify table kb\_entry\_log
* Modify table kb\_category\_log
* Modify table kb\_workflow
* Modify table kb\_workflow\_access
* Modify table kb\_solution\_finder
* Modify table kb\_solution\_finder\_entry
...
* Modify table notify
* Modify table help
* Modify table company\_domain
* Modify table extra\_fields
* Modify table extra\_tables
* Modify table hierarchy
* Modify table extra\_menus
* Modify table extra\_tables\_result
* Modify table extra\_tables\_entry
* Modify table ms\_filter
* Modify table ms\_filter\_mail
* Modify table ms\_trashbin
* Modify table ms\_substitute
* Modify table eab\_folder
* Modify table eab\_entry
* Modify table mail\_block
* Modify table ext\_datasource
* Modify table ext\_table
* Modify table ext\_field
* Modify table cust\_lang
* Modify table cust\_category
* Modify table password\_rules
* Modify table ej\_role
* Modify table role\_member
* Modify table role\_category
* Modify table role\_element
* Modify table role\_workflow
* Modify table element\_profile
* Modify table profile
...
* Modify table s\_picture\_folder
* Modify table s\_picture\_entry
* Modify table s\_washing
* Modify table s\_bounce\_shipment
* Modify table s\_washing\_list
* Modify table s\_list
* Modify table s\_list\_element
* Modify table s\_list\_customer
* Modify table s\_shipment\_addr
* Modify table s\_list\_shipment
* Modify table s\_attachment
* Modify table s\_dyn\_criteria
* Modify table outbox
* Modify table inbox
* Modify table legal\_html\_tags
* Modify table kb\_entry\_words
* Modify table word\_relations
* Modify table temporary\_words
* Modify table wsdl\_description
* Modify table dictionary
* Modify table dictionary\_base
* Modify table invoice\_entry
* Modify table invoice\_type
* Modify table soap\_access
* Modify table hotlist
* Modify table log\_events
* Modify table log\_debug
* Modify table form\_keys
* Modify table sms\_hysteria
* Modify table item\_config
* Modify table snapshot
* Modify table screen\_definition
* Modify table screen\_definition\_action
* Modify table screen\_definition\_element
* Modify table screen\_definition\_hidden
* Modify table screen\_definition\_language
* Modify table screen\_chooser
* Modify table scheduled\_task
* Modify table ejscript
* Modify table system\_script
* Modify table schedule
* Modify table locking
* Modify table dbi\_agent
* Modify table dbi\_agent\_field
* Modify table dbi\_agent\_schedule
* Modify table ejpackage
* Modify table ejpackage\_item
* Modify table message\_id
* Modify table ejscript\_debug
* Modify table sms
* Modify table user\_candidate
* Modify table s\_smtp\_servers
* Modify table ejselection
* Modify table ejsel\_ejsel
* Modify table ejsel\_source\_idlist
* Modify table ejsel\_source\_script
* Modify table ejsel\_source\_xml
* Modify table static\_list\_ref
* Modify table ejsel\_meta\_result
* Modify table ejsel\_result\_set
* Modify table tree\_explorer\_entry
* Modify table tree\_explorer\_link
* Modify table external\_document
* Modify table autosave
* Modify table user\_attribute
* Modify table notice\_frame
* Modify table s\_sent\_message
* Modify table access\_script
* Modify table outgoing\_message
* Modify table ProductCategory
* Modify table ProductCategoryGroupLink
* Modify table ProductCategoryHeadingLink
* Modify table ProductFamily
* Modify table ProductFamilyGroupLink
* Modify table ProductFamilyHeadingLink
* Modify table ProductType
* Modify table ProductTypeGroupLink
* Modify table ProductTypeHeadingLink
* Modify table ErpConnector
* Modify table ErpConnection
* Modify table ErpConnectionActorType
* Modify table ErpConnectionAccess
* Modify table ConnectionConfigField
* Modify table ErpInternalKey
* Modify table ErpExternalKey
* Modify table ErpListItemMapping
* Modify table ErpField
* Modify table ErpSyncLog
* Modify table PaymentTerms
* Modify table PaymentTermsGroupLink
* Modify table PaymentTermsHeadingLink
* Modify table PaymentType
* Modify table PaymentTypeGroupLink
* Modify table PaymentTypeHeadingLink
* Modify table DeliveryTerms
* Modify table DeliveryTermsGroupLink
* Modify table DeliveryTermsHeadingLink
* Modify table DeliveryType
* Modify table DeliveryTypeGroupLink
* Modify table DeliveryTypeHeadingLink
* Modify table PriceUnit
* Modify table PriceUnitGroupLink
* Modify table PriceUnitHeadingLink
* Modify table SubscriptionUnit
* Modify table SubscriptionUnitGroupLink
* Modify table SubscriptionUnitHeadingLink
* Modify table QuoteLineConfiguration
* Modify table SaleTypeQuoteAttachment
* Modify table QuoteVersionAttachment
* Modify table ResourceOverride
* Modify table ErpConfiguration
* Modify table EjCategoryGroupLink
* Modify table obsolete\_1
* Modify table obsolete\_2
* Modify table obsolete\_3
* Modify table obsolete\_4
* Modify table Favourite
* Modify table DatabaseModel
* Modify table SaintConfiguration
* Modify table Tags
* Modify table TagsGroupLink
* Modify table TagsHeadingLink
* Modify table ai\_chat\_turn
* Modify table quick\_reply
* Modify table ConfigurableScreenDelta
* Modify table ConfigurableScreenAppliesTo
* Modify table TaskMenu
* Modify table TaskMenuGroupLink
* Modify table TaskMenuHeadingLink
* Modify table ConsentPurpose
* Modify table LegalBase
* Modify table ConsentSource
* Modify table ConsentPerson
* Modify table CategoryFamily
* Modify table copilot
* Modify table copilot\_data\_source
* Modify table copilot\_data\_source\_setting
* Modify table script\_trace
* Modify table script\_trace\_run
* Modify table attachment\_location
* Modify table cust\_config
* Modify table cc\_template
* Modify table dashboard
* Modify table dashboard\_theme
* Modify table dashboard\_tile\_definition
* Modify table dashboard\_tile
* Modify table dashboard\_tile\_field
* Modify table quick\_filter\_info
* Modify table external\_owner
* Modify table form
...
* Modify table email\_attachment
* Modify table invitation
* Modify table s\_messageblock
* Modify table MailingDomains
* Modify table TypicalSearch
* Modify table board\_view\_settings
* Modify table time\_keeping
* Modify table OnlineApp
...
* Modify table target\_period
* Modify table target\_assignment\_info
* Modify table target\_assignment\_value
* Modify table target\_revision\_history
* Modify table target\_revision
* Modify table target\_change
* Modify table target\_dimension
* Modify table Webhook
* Modify table Webhook\_usage
* Modify table workflow
* Modify table email\_flow
* Modify table workflow\_instance
* Modify table workflow\_goal
* Modify table workflow\_step
* Modify table workflow\_trigger
* Modify table workflow\_step\_option
* Modify table workflow\_step\_option\_link
* Modify table email\_flow\_content\_link
* Modify table temp\_db\_lock
* Modify table workflow\_wait\_for\_action
* Modify table workflow\_root\_step\_link
* Modify table form\_field\_value
* Modify table AssociateHistory
* Modify table CacheInvalidation
* Modify table QuoteApprReason
* Modify table QuoteApprReasonGroupLink
* Modify table QuoteApprReasonHeadingLink
* Modify table QuoteDenyReason
* Modify table QuoteDenyReasonGroupLink
* Modify table QuoteDenyReasonHeadingLink
* Modify table EntityCounts
* Modify table utm\_parameters
* Modify table leadstatus
* Modify table AutomatedCategoryUpdate
* Modify table available\_fonts
* Modify table ticket\_type
* Modify table ticket\_type\_priority
* Modify table ticket\_type\_status
* Modify table ticket\_relation\_def
* Modify table ticket\_rel\_def\_ticket\_type
...
Make the person_id + consentPurpose_id index unique, this is an important constraint
...
Adds a fk from screen_chooser to ejscript for TypeScript triggers.
...
Add ticket_type as fields on mail_in_filter and ms_filter
...
Add ticket_type.show_in_new, ticket_type.exclude_signature, ticket_type.exclude_email_recipients, ticket_type.external_as_default columns and insert the first, default, request type
...
Add ticket_type.visible_for_groups field.
...
Add ticket_type.reply_forward_no_signature
...
Add field source_code, which will contain the source code for the script, for example in Typescript.
...
Add fields includes and last_compiled, which will be used to check if we need to just-in-time compile again.
...
Add ticket_type.reply_external_as_default
...
Add field source_maps, which will contain mappings from location in body to source_code (with includes).
...
Alter ticket_relation.ticket_relation_def_id NOT NULL. (Note, the data was truncated in previous DB step)
...
Add a foreign key to s_message from s_link, to denote that a link is a local link, belonging to that particular message
...
Move Bool redirect_is_url to a new enum field: redirect_kind
...
Delete obsolete field redirect_is_url (moved to redirect_kind)
...
Add index on appointment agenda_text_id
...
Making time_keeping table compatible with our standard generated code, easier cleanup of orphan records, and easier db merge
