...
* [Modify table CacheTables](../../docs/database/tables/cachetables.md)
subKeyId
* [Modify table ImportRelation](../../docs/database/tables/importrelation.md)
foreignKey
...
* [Modify table person](../../docs/database/tables/person.md)
* [Modify table phone](../../docs/database/tables/phone.md)

**Step 19**

Add fields and attributes to support the Soft Delete feature on person and contact tables

* [Modify table Contact](../../docs/database/tables/contact.md)
DeletedDate
* [Modify table Person](../../docs/database/tables/person.md)
DeletedDate
...
* [Add table SaintConfiguration](../../docs/database/tables/saintconfiguration.md)
* [Modify table StatusDef](../../docs/database/tables/statusdef.md)
...
* [Modify table Associate](../../docs/database/tables/associate.md)
userName
...
* [Modify table PrefDesc](../../docs/database/tables/prefdesc.md)
...
* [Add table Tags](../../docs/database/tables/tags.md)
* [Add table TagsGroupLink](../../docs/database/tables/tagsgrouplink.md)
* [Add table TagsHeadingLink](../../docs/database/tables/tagsheadinglink.md)
...
* [Modify table appointment](../../docs/database/tables/appointment.md)
do\_By, done, endDate, activeDate
* [Modify table recurrenceRule](../../docs/database/tables/recurrencerule.md)
startDate, endDate
* [Modify table email\_folder](../../docs/database/tables/email-folder.md)
name
...
* [Modify table DocTmpl](../../docs/database/tables/doctmpl.md)
...
* [Modify table SuperListColumnSize](../../docs/database/tables/superlistcolumnsize.md)
...
* [Add table AssociateHistory](../../docs/database/tables/associatehistory.md)

**Step 45**

Add a field snum to table document, and cautionWarning to appointment

* [Modify table Document](../../docs/database/tables/document.md)
snum
* [Modify table Appointment](../../docs/database/tables/appointment.md)
cautionWarning
...
* [Modify table ej\_message](../../docs/database/tables/ej-message.md)
...
* [Modify table ticket](../../docs/database/tables/ticket.md)
* [Modify table ej\_message](../../docs/database/tables/ej-message.md)
time\_spent, time\_charge
* [Modify table invoice](../../docs/database/tables/invoice.md)
time\_charged
* [Modify table ticket\_priority](../../docs/database/tables/ticket-priority.md)
deadline
* [Modify table ticket\_status\_history](../../docs/database/tables/ticket-status-history.md)
timespan, real\_timespan
* [Modify table appointment](../../docs/database/tables/appointment.md)
done, do\_by, activeDate, endDate
* [Modify table text](../../docs/database/tables/text.md)
updatedCount
...
* [Modify table freetextwords](../../docs/database/tables/freetextwords.md)
word, soundEx
* [Modify table freetextindex](../../docs/database/tables/freetextindex.md)
contact\_id
...
* [Modify table chat\_topic](../../docs/database/tables/chat-topic.md)
* [Modify table chat\_topic\_user](../../docs/database/tables/chat-topic-user.md)
can\_respond, notifications, can\_listen, manager
* [Modify table chat\_session](../../docs/database/tables/chat-session.md)
name, company\_name, email, phone, first\_message, last\_message, flags
* [Modify table chat\_message](../../docs/database/tables/chat-message.md)
created\_by
* [Modify table ejuser](../../docs/database/tables/ejuser.md)
chat\_status
...
* [Modify table chat\_topic](../../docs/database/tables/chat-topic.md)
widget\_language
* [Modify table cust\_lang](../../docs/database/tables/cust-lang.md)
iso\_code
...
* [Modify table config](../../docs/database/tables/config.md)
feature\_toggle

**Step 4**

* [Modify table login\_customer](../../docs/database/tables/login-customer.md)
created\_at
* [Add table quick\_reply](../../docs/database/tables/quick-reply.md)
...
* [Modify table category](../../docs/database/tables/category.md)
family\_id
...
* [Add table ConsentPurpose](../../docs/database/tables/consentpurpose.md)
* [Add table LegalBase](../../docs/database/tables/legalbase.md)
* [Add table ConsentSource](../../docs/database/tables/consentsource.md)
* [Add table ConsentPerson](../../docs/database/tables/consentperson.md)
* [Add table CategoryFamily](../../docs/database/tables/categoryfamily.md)
* [Modify table DocTmpl](../../docs/database/tables/doctmpl.md)
...
* [Modify table outbox](../../docs/database/tables/outbox.md)
rfc822\_content

**Step 10**

* [Modify table ConsentPerson](../../docs/database/tables/consentperson.md)

**Step 11**

* [Modify table ConsentPerson](../../docs/database/tables/consentperson.md)
* [Modify table ConsentPerson](../../docs/database/tables/consentperson.md)
* [Modify table ShipmentTypeReservation](../../docs/database/tables/shipmenttypereservation.md)
* [Modify table ConsentPurpose](../../docs/database/tables/consentpurpose.md)
* [Modify table ConsentSource](../../docs/database/tables/consentsource.md)
* [Modify table LegalBase](../../docs/database/tables/legalbase.md)
* [Modify table ShipmentType](../../docs/database/tables/shipmenttype.md)

**Step 12**

* [Modify table ErpConnection](../../docs/database/tables/erpconnection.md)
...
* [Add table script\_trace](../../docs/database/tables/script-trace.md)
* [Add table script\_trace\_run](../../docs/database/tables/script-trace-run.md)
* [Modify table screen\_chooser](../../docs/database/tables/screen-chooser.md)
description, enabled

**Step 2**

* [Modify table ejscript](../../docs/database/tables/ejscript.md)
extra\_menus\_id
...
* [Modify table screen\_definition](../../docs/database/tables/screen-definition.md)
autosave
...
* [Modify table s\_message](../../docs/database/tables/s-message.md)
long\_description

**Step 4**

* [Modify table ticket\_status](../../docs/database/tables/ticket-status.md)
status
* [Modify table ticket\_priority](../../docs/database/tables/ticket-priority.md)
status, flags, ticket\_read, changed\_owner, ticket\_newinfo, ticket\_closed, ticket\_changed\_priority, ticket\_new
* [Modify table ej\_category](../../docs/database/tables/ej-category.md)
...
* [Modify table s\_list\_element](../../docs/database/tables/s-list-element.md)
status
...
* [Add table attachment\_location](../../docs/database/tables/attachment-location.md)
* [Modify table attachment](../../docs/database/tables/attachment.md)
...
* [Modify table mail\_in\_filter](../../docs/database/tables/mail-in-filter.md)
mailgun\_dsn
...
* [Modify table ticket\_log\_action](../../docs/database/tables/ticket-log-action.md)
details
...
* [Add table cust\_config](../../docs/database/tables/cust-config.md)
...
* [Add table form](../../docs/database/tables/form.md)
* [Add table form\_submission](../../docs/database/tables/form-submission.md)

**Step 2**

* [Modify table form](../../docs/database/tables/form.md)
...
* [Modify table form\_submission](../../docs/database/tables/form-submission.md)
is\_submitted
...
* [Add table email\_account](../../docs/database/tables/email-account.md)
* [Add table email\_folder](../../docs/database/tables/email-folder.md)
* [Add table service\_auth](../../docs/database/tables/service-auth.md)
* [Add table email\_item](../../docs/database/tables/email-item.md)

**Step 2**

* [Modify table email\_item](../../docs/database/tables/email-item.md)

**Step 3**

* [Modify table email\_item](../../docs/database/tables/email-item.md)
replied\_at, in\_reply\_to, messageId
* [Modify table email\_account](../../docs/database/tables/email-account.md)
default
...
* [Modify table email\_item](../../docs/database/tables/email-item.md)
cc
* [Modify table service\_auth](../../docs/database/tables/service-auth.md)
associate\_id, auth\_status

**Step 5**

* [Modify table timestamps](../../docs/database/tables/timestamps.md)
mailsync
...
* [Modify table email\_item](../../docs/database/tables/email-item.md)
* [Add table email\_attachment](../../docs/database/tables/email-attachment.md)
...
* [Add table invitation](../../docs/database/tables/invitation.md)
* [Modify table email](../../docs/database/tables/email.md)
appointment\_id
...
* [Modify table invitation](../../docs/database/tables/invitation.md)
...
* [Modify table erpexternalkey](../../docs/database/tables/erpexternalkey.md)
...
* [Modify table s\_shipment](../../docs/database/tables/s-shipment.md)
sorting
...
* [Modify table s\_message](../../docs/database/tables/s-message.md)
design, designtype
* [Add table s\_messageblock](../../docs/database/tables/s-messageblock.md)
* [Modify table s\_message](../../docs/database/tables/s-message.md)
flags
...
* [Modify table s\_shipment](../../docs/database/tables/s-shipment.md)
status
* [Modify table s\_link\_customer](../../docs/database/tables/s-link-customer.md)
link\_type
* [Modify table s\_link\_customer\_statical](../../docs/database/tables/s-link-customer-statical.md)
link\_type
...
* [Add table TypicalSearch](../../docs/database/tables/typicalsearch.md)

**Step 4**

Cleanup 'temporary selection' marking by introducing the IsTemporary field

* [Modify table selection](../../docs/database/tables/selection.md)
SystemType
...
* [Add table OnlineApp](../../docs/database/tables/onlineapp.md)
* [Modify table userpreference](../../docs/database/tables/userpreference.md)
* [Modify table userpreference](../../docs/database/tables/userpreference.md)

## Optimization

* [Modify table TravelTransactionLog](../../docs/database/tables/traveltransactionlog.md)
* [Modify table ForeignKey](../../docs/database/tables/foreignkey.md)
...
* [Add table PushNotificationService](../../docs/database/tables/pushnotificationservice.md)

**Step 2**

* [Modify table PushNotificationService](../../docs/database/tables/pushnotificationservice.md)
Language
...
* [Modify table Favourite](../../docs/database/tables/favourite.md)
Rank
...
* [Modify table login](../../docs/database/tables/login.md)
flags
...
* [Add table TemporaryKey](../../docs/database/tables/temporarykey.md)
