...
That is very neat when you need more columns in the archives or have text that acquires more space.
...
A meeting can have an URL to a video meeting in the Location field on the Apppointment.

![Windows][img10]

Then it’s very nice to just click the link in the preview panel and open the correct app to have your video meeting.

The Location field is clickable both in the Appointment dialog and the preview in the Mini card.
...
![Windows][img18] ![Windows][img19]

It’s 2 settings to show the different entities – Use list box for entities:
