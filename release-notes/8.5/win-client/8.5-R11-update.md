...
In your **Diary**, you have access to the tabs for **Projects** and **Requests**.

![Windows][img2]

The **Projects** archive shows all the projects you are responsible for, and the **Requests** archive shows requests owned by you.
...
You can drag and drop documents into both your Project and Sales guide to add and use them.

![Windows][img3]

This way you can easily add external documents and proposals you’ve been working on to your sales and project guide.
