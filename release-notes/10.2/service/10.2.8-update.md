...
When you are working with live-update on request, other associates can add or change information or the request your are working on.

To update the request, simply click the refresh button on the right in the header.
