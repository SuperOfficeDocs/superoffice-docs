...
## SuperOffice AI Lab - Text fields with AI options

When you write a text in like a follow up (or any other place where you have ), you sometimes want to make the text better and with more "oomph", and it would have been so nice to get that help instant.

With the **AI text help** ✨ in the formatting footer, you do have that option! You can create text, fix spelling, translate, use formal style, use casual style, lengthen text or summarise text. Read more about how to use the rest of the magic of [SuperOffice AI Lab][2].
...
> [!NOTE]
> If you don't have access to AI Lab, you read more about how to give your consent and use use it in [Settings and maintenance][1].
