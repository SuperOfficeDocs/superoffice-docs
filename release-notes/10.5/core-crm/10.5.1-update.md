...
With the **AI help** in the formatting footer, you do have that option ✨! You can create text, fix spelling, translate, use formal style, use casual style, lengthen text or summarise text. Read more about how to use the rest of the magic for [SupreOffice AI Lab][2].
...
> [!NOTE]
> If you don't have access to AI Lab, you read more about how to start using and giving your consent to use it in [Settings and maintenance][1].
