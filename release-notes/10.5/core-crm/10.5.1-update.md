...
The **tabs** on the main cards are displayed below the name or title. Switching between main tabs gives a better user experience and it provides a clean and organised upper section for the title/name.
...
In Diary you have two options on how to view your checklist or to-do's for Activities and Sales:
...
It's pretty easy to drag and drop follow-ups from your to-do list and into the **sidepanel** for month, week or day view.
...
You probably have a couple of side panels you like to use, depending on the different main cards you are on and what job you are doing. With the option to **set side panels as favourites**, you can easily swop between the different side panels by clicking the pinned favourite side panels.
...
> [!NOTE]
> If you don't have access to SuperOffice Copilot (AI Lab), you read more about how to give your consent for AI Lab in [Settings and maintenance][1].
