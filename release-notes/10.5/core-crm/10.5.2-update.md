...
When the context menu (right click on a follow-up) contains just what you are after, this will help you to quickly create a new follow-up based on an existing one. Go to your **Diary**, just by mark the one follow-up you want to **duplicate**, right click and select **Create new based on this**.
