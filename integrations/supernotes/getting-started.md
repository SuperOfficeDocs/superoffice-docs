...
For details on enabling the note taker for specific meetings, see [How do I enable the note taker for a specific meeting?][5]
...
1. The phone's microphone will capture all voices.
...
1. Upload PDF or Word documents (up to 10MB).
...
For meeting duration limits, see [What are the meeting duration limits?][6]

## Related content

* [Workspaces][1] - Team collaboration and workspace management
* [Before meeting][2] - Pre-meeting features and preparation
...
[3]: settings.md
[4]: workspaces.md
[5]: before-meeting.md#enable-for-selected-meeting
