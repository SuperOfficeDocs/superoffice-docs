---
uid: sofo-shared-mailboxes
title: Work with shared mailboxes
description: Archive emails, save attachments, and send and archive emails from a shared mailbox using SuperOffice for Outlook.
keywords: SuperOffice for Outlook, Outlook, shared mailbox, archive email, send and archive, save attachment, SOFO
author: schildea
date: 06.16.2026
...
1. [Open SuperOffice for Outlook][1] (if not already [pinned][2]).
...
* [Archive email to SuperOffice][4]
* [Send and archive][5]
* [Save attachments to SuperOffice][6]
* [Archive reminder][7]
...
[4]: archive-email.md
[5]: send-and-archive.md
[6]: save-attachments.md
[7]: archive-reminder.md