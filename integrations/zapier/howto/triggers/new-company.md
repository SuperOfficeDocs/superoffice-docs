...
1. A side menu will open, in the **Trigger event** section, select **New Company**, then click the **Account** section and login using a SuperOffice account.
