---
uid: zapier-new-appointment-trigger
title: Set SuperOffice CRM new Appointment trigger
description: How to use SuperOffice new appointment trigger with Zapier
keywords: New appointment, new Zap, Zapier new trigger
...
# Create a SuperOffice CRM new Appointment trigger
...
1. A side menu will open, in the **Trigger event** section, select **New Appointment**, then click the **Account** section and log in using your SuperOffice account.
...
1. If the above steps were configured correctly, the action you chosen should be executed properly when the **Trigger event New Appointment** is executed in SuperOffice CRM.
...
<!-- Referenced links -->
[1]: ../../actions/create/create-appointment.md
[2]: ../../actions/update/update-appointment.md
...
[img4]: ../../media/triggers/new-appointment/new-appointment-action.png
[img5]: ../../media/triggers/new-appointment/new-appointment-output.png
