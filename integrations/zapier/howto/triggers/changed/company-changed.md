...
1. A side menu will open, in the **Trigger event** section, select **Company Changed**, then click the **Account** section and log in using your SuperOffice account.
...
[img4]: ../../media/triggers/company-changed/company-changed-action.png
[img5]: ../../media/triggers/company-changed/company-changed-output.png
