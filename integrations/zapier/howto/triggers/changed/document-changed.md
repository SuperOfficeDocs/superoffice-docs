...
1. A side menu will open, in the **Trigger event** section, select **Document Changed**, then click the **Account** section and log in using your SuperOffice account.
...
<!-- Referenced links -->
[1]: ../../actions/create/create-document.md
[2]: ../../actions/update/update-document.md
...
[img4]: ../../media/triggers/document-changed/document-changed-action.png
[img5]: ../../media/triggers/document-changed/document-changed-output.png
