---
uid: zapier-project-member-changed-trigger
title: Set SuperOffice CRM Project Member changed trigger
description: How to use SuperOffice project member change trigger with Zapier
