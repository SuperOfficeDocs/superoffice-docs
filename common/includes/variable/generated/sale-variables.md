---
uid: netserver-template-variables-saletags
title: NetServer template variables for SaleTags
description: List of all template variables defined in SaleTags.
so.generated: true
keywords: template variables SaleTags
so.topic: reference
