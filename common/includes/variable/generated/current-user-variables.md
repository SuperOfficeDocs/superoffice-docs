---
uid: netserver-template-variables-ownpersonvariables
title: NetServer template variables for OwnPersonVariables
description: List of all template variables defined in OwnPersonVariables.
so.generated: true
keywords: template variables OwnPersonVariables
so.topic: reference
so.envir: onsite, online
---

## Own person (current user) variables

Substitution tags for the currently logged in user/person.
...
| PersonPostalAddressLine3 | aup3 | Sender's postal address, line 3 |
...
| UserDefinedFieldInt26 | ul26 | User defined field 26 of type integer |
...
| UserDefinedFieldString3 | us03 | User defined field 3 of type string |
...
| UserDefinedFieldString40 | us40 | User defined field 40 of type string |
