...
Each [tenant][1] exposes NetServer web services for all clients, including SuperOffice Web, PocketCRM and partner application clients. The web services are bundled in your [Expander Services][2] subscription.
...
Your [application][7] is not allowed to place .net assemblies in a tenant web application and must use the web services for all interactions.
