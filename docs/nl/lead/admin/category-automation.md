...
Het automatiseren van bedrijfscategorie-updates helpt handmatig werk te verminderen en zorgt ervoor dat uw gegevens nauwkeurig blijven. Wanneer de status van een verkoop verandert of een leadstatus wordt bijgewerkt, kan het gerelateerde bedrijf automatisch worden bijgewerkt met de juiste categorie.
...
* U moet beheerdersrechten hebben om toegang te krijgen tot **Instellingen en onderhoud**.
...
|---|---|
| Categorie bijwerken wanneer een verkoop is gewonnen | Werkt automatisch de bedrijfscategorie bij wanneer een verkoop is gemarkeerd als **Gewonnen**. |
...
1. Selecteer het tabblad **Lead-categorisatie**. Dit scherm toont automatiseringsopties.
...
* **Volledig automatisch:** Het beste voor eenvoudige lead-naar-klant-workflows waarbij categoriewijzigingen voorspelbaar en consistent zijn. Bijvoorbeeld automatisch verplaatsen van een lead naar de categorie *Klant* wanneer een verkoop als gewonnen is gemarkeerd.
...
Een veelvoorkomend gebruik is om een lead automatisch bij te werken naar een klantencategorie wanneer een verkoop is gewonnen:

1. Schakel **Categorie bijwerken wanneer een verkoop is gewonnen** in.
...
Nu, wanneer een verkoop die is gekoppeld aan een bedrijf in de groep *Potentiële klant* als gewonnen wordt gemarkeerd, verandert de bedrijfscategorie automatisch naar *Klant*.
