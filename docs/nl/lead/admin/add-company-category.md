...
De lijst **Bedrijf – Categorie** definieerde de types bedrijven in uw database, zoals *Klant*, *Partner* of *Lead*.
Elke categorie had een **Categoriegroep**, die bepaald hoe deze zich gedroeg in zoekopdrachten, automatiseringen en lead-beheer.

U beheerde bedrijfscategorieën onder **Instellingen en onderhoud** onder **Lijsten** > **Bedrijf – Categorie**.

## Over categoriegroepen

Categoriegroepen boden een manier om categorieën in te delen naar doel en ongewenste automatiseringswijzigingen te voorkomen. Bijvoorbeeld: een bedrijf dat als *Klant* was gemarkeerd, mocht nooit automatisch veranderen in een *Lead* door een formulier-invoer.
...
1. Klik op **OK** om de nieuwe categorie op te slaan of **Annuleren** om uw wijzigingen te verwerpen.
...
1. Zoek de verwijderde categorie, dubbelklik deze en klik op **Herstellen**.
1. Klik **OK**.
