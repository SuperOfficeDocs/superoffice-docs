...
* **Minimum aantal tekens in wachtwoord**: Het kleinste aantal tekens dat in een wachtwoord is toegestaan.
* **Minimum aantal cijfers in wachtwoord**: Het kleinste aantal cijfers (0-9) dat in een wachtwoord is toegestaan.
