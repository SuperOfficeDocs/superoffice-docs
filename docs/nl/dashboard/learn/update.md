...
3. Als u de naam van het dashboard wilt wijzigen en andere instellingen wilt aanpassen, klikt u op de knop **Taak** en selecteert u **Dashboard bewerken**.

4. Als u tegels wilt toevoegen en de dashboardopmaak wilt bewerken, klikt u op de knop **Taak** en selecteert u **Tegel toevoegen/Opmaak bewerken**.
