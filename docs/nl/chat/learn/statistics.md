...
U kunt statistieken van chatgesprekken visualiseren in een dashboard om een informatief overzicht van de gegevens te krijgen. Nadat u [een dashboard hebt gemaakt][2], kunt u [tegels toevoegen en bewerken][3].
...
![Voorbeeld van verschillende tegels voor chatgesprekken -screenshot][img2]

## Antwoorden op een binnenkomende chat

Dubbelklik op een rij in de lijst Binnenkomende chat om [op die chat te antwoorden][1]. De chat wordt geopend in het tabblad **Chats**.
