...
# Een chat overbrengen naar een andere agent

Soms is een agent niet in staat om met de klant te blijven chatten en een lopende chatvraag op te lossen. In dergelijke situaties is het overbrengen van een chat naar een andere agent een eenvoudige manier om de communicatie met een klant naadloos voort te zetten en zonder vertraging antwoorden te geven.

U kunt chats overbrengen naar andere agenten en overgebrachte chats ontvangen van andere agenten.

> [!NOTE]
> Een manager kan de chat ook overnemen of de chat overbrengen naar een andere agent. Hierdoor kan iemand met beheerdersrechten ervoor zorgen dat de klant een agent krijgt die beschikbaar is en die de klant correct kan helpen.
...
> [!TIP]
> Als u de machtiging **Kan meeluisteren** hebt, kunt u naar het tabblad **Dashboard** gaan en dubbelklikken op een chatsessie om deze weer te geven.

## Een overgebrachte chat accepteren van een andere agent

Als een agent een chat naar u overbrengt, wordt de chat automatisch weergegeven in het chatvenster en gemarkeerd in de lijst met sessies.
