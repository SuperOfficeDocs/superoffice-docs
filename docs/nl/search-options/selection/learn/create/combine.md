...
1. Klik op de knop **Taak** en selecteer **Selectie combineren met**. Er wordt een nieuw selectiescherm geopend.
...
Na het opslaan van de selectie, kunt u [deze bewerken](../update/index.md) door het combinatietype en de selecties te wijzigen die zijn gecombineerd. Het is echter niet mogelijk de waarde in het veld **Selectie van** te wijzigen.
