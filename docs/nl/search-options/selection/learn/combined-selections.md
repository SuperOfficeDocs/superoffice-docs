---
uid: help-nl-selection-combined
title: Gecombineerde selecties
description: Gecombineerde selecties
...
Een gecombineerde selectie is een combinatie van twee bestaande selecties.

De gecombineerde selectie kan records bevatten die in de twee bestaande selecties voorkomen, records die verschillen, records die uniek zijn voor een van de selecties of alle records in de twee selecties.

Er zijn echter bepaalde beperkingen met betrekking tot wat kan worden gecombineerd:
...
De twee selecties die moeten worden gecombineerd, kunnen statisch of dynamisch zijn. Na het maken van een gecombineerde selectie, kunt u ervoor kiezen er een statische selectie van te maken.
