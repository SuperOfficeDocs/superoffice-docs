...
so.date: 03.28.2023
keywords: zoeken, criteria, zoeken
so.topic: howto
language: nl
---
...
De statussen worden gemaakt en bijgehouden in Instellingen en onderhoud.

Statusvelden zijn alleen van belang als u een licentie voor statuscontroles hebt aangeschaft en statuscontroles hebt ingeschakeld.
...
U vindt tellervelden onder **Tellers (SAINT)** in de criterialijst.

De tellers worden gemaakt en bijgehouden in Instellingen en onderhoud.
...
U kunt rechts van de velden klikken op de koppelingen als u aanvullende criteria voor de tellers wilt opgeven. De beschikbare opties zijn afhankelijk van het type record en de teller waarmee u werkt.
...
Afhankelijk van uw selectie hierboven, wordt een keuzelijst voor een datumveld of een getalveld weergegeven. Deze keuzelijsten werken op de hierboven beschreven wijze. Selecteer de gewenste optie en voer de gewenste numerieke waarde of datum in het tekstveld in.

## Zoekcriteria wijzigen

Om een zoekcriterium te wijzigen, klikt u erop en selecteert u een ander criterium in de lijst die wordt weergegeven.

## Zoekcriteria verplaatsen

Als u criteria (een regel) wilt verplaatsen, klik en sleep met ![pictogram][img2].

## Zoekcriteria verwijderen

Klik op ![pictogram][img3] als u een zoekcriterium wilt verwijderen.

## Zoekcriteria activeren of deactiveren
...
* U kunt ze verwijderen door te klikken op ![pictogram][img3]
* U kunt een of meer zoekcriteria deactiveren door geen waarde op te geven voor het veld. Een gedeactiveerd zoekcriterium blijft in de criterialijst staan en kan zo nodig opnieuw worden geactiveerd.
* U kunt alle zoekcriteria deactiveren door te klikken op **Alles deactiveren**.

## Zoekcriteria omhoog of omlaag verplaatsen

Klik en sleep als u criteria wilt verplaatsen ![pictogram][img2]. Dit is niet van invloed op de zoekopdracht, maar zo kunt u de criteria rangschikken in de volgorde die uw voorkeur heeft. Als u ongebruikte criteria wilt behouden, kunt u de inactieve criteria verplaatsen naar onder aan de lijst.

## Standaardzoekcriteria opnieuw instellen

De criterialijsten bevatten een set standaardcriteria die u zo nodig kunt bewerken of verwijderen. Om de criterialijst opnieuw in te stellen op de standaardcriteria, klikt u op **Standaardwaarde opnieuw instellen**.
