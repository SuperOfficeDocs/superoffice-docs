...
1. Bewerk zo nodig de vraag en het antwoord om deze geschikt te maken als item in Veelgestelde vragen zodat ze kunnen worden hergebruikt.
1. Als u [meerdere talen][4] hebt moet u de verschillende **talen** in de voettekst selecteren en de vraag- en antwoordtabbladen controleren.
1. Selecteer het tabblad **Eigenschappen**.
1. Publiceer het item in Veelgestelde vragen door **Gepubliceerd** te kiezen in het veld **Workflow**.
