...
| <i class="ph ph-pencil-simple" aria-label="Edit"></i> | Script bewerken | Wordt gebruikt om het [script of de macro][1] te bewerken. |
...
| | Script traceren | Wordt gebruikt om [het script of de macro te traceren][3]. |
