...
1. Schakel het selectievakje **Actief** uit om wijzigingen mogelijk te maken.

1. Pas de naam, reikwijdte of configuratie-instellingen aan zoals nodig.
...
1. Wanneer alles is geconfigureerd, klikt u opnieuw op **ERP-verbinding configureren**, schakelt u **Actief** in, klikt u op **ERP-verbinding testen** en vervolgens op **OK** om op te slaan.
