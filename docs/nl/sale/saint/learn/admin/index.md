...
Statussen en tellers kunnen worden gebruikt in zoekbewerkingen en voor het maken van dynamische selecties. Zo kunt u bijvoorbeeld zoeken naar bedrijven, personen of projecten die voldoen aan criteria voor een status of teller.[!include[Define counter](../../../learn/includes/def-counter.md)]
