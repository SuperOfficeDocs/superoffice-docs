...
1. Vul in het dialoogvenster deze velden in:
    ...
    * **Naam**: voer een beschrijvende naam in voor de status die u wilt toevoegen.
        ...
        Optioneel: Klik op ![pictogram][img2] om [vertalingen toe te voegen][8] van de statusnaam.
...
1. Als er meerdere statussen in de lijst staan, moet u een prioriteit opgeven voor de nieuwe status. Klik op de status en gebruik de (![pictogram][img5] / ![pictogram][img6]) pijltoetsen rechts van de statuslijst om de status omhoog of omlaag te verplaatsen in de lijst.
