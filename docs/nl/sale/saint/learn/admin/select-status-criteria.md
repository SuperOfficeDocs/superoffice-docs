...
1. Klik op de ![pictogram][img1] pijl-toets naast het lege veld en [selecteer het vereiste zoekcriterium][1].
...
1. Klik op ![pictogram][img2] **Geselecteerde statuscontrole opnieuw genereren** om de status bij te werken met de criteria die u hebt toegevoegd. Nadat de status opnieuw is gegenereerd, staat er geen rood kruis bij de statusnaam.
