...
Dit tabblad bevat de hoofdvelden die u moet invullen. Als eerste de titel, en dit is ook verplicht. Lees meer over het [maken van een verkoop][4].

![Het tabblad Verkoop in het scherm Verkoop -screenshot][img5]

### Het tabblad Details

Dit tabblad bevat velden met financiële informatie over de verkoop.

![Tabblad verkoopdetails -screenshot][img3]
...
* [Werken met verkoophandleidingen][6]
* [Een offerte maken][1]
