...
# Gebruikers filteren en groeperen

Als de lijst in het tabblad **Medewerkers** veel gebruikers bevat, kunt u de lijst filteren en groeperen om deze beter beheersbaar te maken.

De verschillende opties worden hieronder beschreven.

## Zoeken naar gebruikers

Gebruik deze dynamische zoekfunctie om specifieke gebruikers snel te vinden op naam of gebruikers-ID, of om alle gebruikers te vinden die behoren tot specifieke rollen, groepen of gebruikersplannen. Voer gewoon tekst in het zoekveld in om de lijst bij te werken met overeenkomende gebruikers.

## Alleen gebruikers weergeven die zich kunnen aanmelden
