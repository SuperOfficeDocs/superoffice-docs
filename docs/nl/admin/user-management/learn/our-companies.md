...
Als u een bedrijf wilt toevoegen aan het tabblad **Onze bedrijven**, moet dit eerst worden geregistreerd als bedrijf in SuperOffice.

Als u bedrijven wilt verwijderen van het tabblad **Onze bedrijven**, moet aan de volgende twee criteria zijn voldaan:
...
2. Selecteer het tabblad **Onze bedrijven**.

3. Klik op de knop **Toevoegen** onder de lijst met bedrijven.

4. Het scherm Zoeken wordt geopend. Als in dit dialoogvenster als zoekcriteria zijn ingevoerd die u niet wilt gebruiken, kunt u deze verwijderen door op de knop **Alles deactiveren** te klikken of door de vinkjes uit de selectievakjes voor de betreffende criteria te verwijderen.

5. Zoek naar een bedrijf. Zie details hieronder.

6. Zodra u het gewenste bedrijf hebt geselecteerd en op **OK** hebt geklikt, wordt het bedrijf in de lijst weergegeven.

## Bedrijf verwijderen in het tabblad Onze bedrijven

1. Controleer of aan de bovenstaande criteria is voldaan.
