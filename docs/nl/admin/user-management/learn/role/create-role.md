...
2. Selecteer een van de volgende tabbladen:
...
4. Voer in het dialoogvenster **Nieuwe rol maken** een naam in voor de rol in het veld **Rolnaam**.

5. Voer een beschrijving van de rol in het veld **Beschrijving** in.
...
8. Klik op de rolnaam in de lijst om de rechten van de rol weer te geven op het tabblad **Gegevensrechten**.

9. [Voer de gegevensrechten in op het tabblad **Gegevensrechten**][7].

10. Rollen maken voor medewerkers: Klik op het tabblad **Functionele rechten**.
