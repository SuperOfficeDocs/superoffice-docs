...
Als u belangrijke overwegingen voor de configuratie wilt bekijken, [download dan uw configuratievoorbereidingsdocument][2]. Na het beantwoorden van de vragen in het document, beschikt u over de informatie die u nodig hebt om uw systeem te configureren.

Nadat u zich hebt voorbereid op uw CRM-implementatie, is het tijd om uw [CRM-gebruikers te maken en te beheren][1].

## Uw eigen workflowhandleidingen maken

Workflowhandleidingen, zoals de [verkoopgids][4] en [projectgids][5] helpen gebruikers de controle te behouden en te werken volgens best practices.
...
![Met het projectgidsscherm in Project kunt u eenvoudig een overzicht krijgen van de voortgang van de projecten. -screenshot][img1]
