...
U kunt bepaalde [systeemgebeurtenissen][1] opstarten vanuit de lijst **Systeemmeldingen** in het tabblad **Status**.
...
4. Kies in het dialoogvenster **Gebeurtenis toevoeg** en een [Systeemgebeurtenistype][1] in de keuzelijst **Gebeurtenistype**.
