...
In deze lijst worden de statusberichten van het systeem en toegevoegde [gebeurtenissen][1] vermeld. Meldingen van actieve imports, SAINT of vrije-tekstindexering, etc. Selecteer een melding in de lijst om een beschrijving ervan weer te geven. U kunt gebeurtenissen bijhouden die actief zijn in het systeem.
