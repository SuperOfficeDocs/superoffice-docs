...
1. Voer in het dialoogvenster **Verbinden met ERP** de tekst waarop moet worden gezocht op in het zoekveld en klik op **Zoeken**. U kunt ook op het ![pictogram][img1] zoekknop klikken om een geavanceerde zoekopdracht te starten (zie [Het scherm Zoeken gebruiken][1]).
