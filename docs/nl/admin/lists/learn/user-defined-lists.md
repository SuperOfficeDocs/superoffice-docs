...
description: Door gebruikers gedefinieerde lijsten toevoegen, bewerken, en verwijderen
keywords: Lijst maken, Lijst bewerken, Lijst verwijderen, gebruikers gedefinieerde lijsten
author: digitaldiina
date: 10.29.2025
version: 10.5
content_type: howto
...
index: true
redirect_from:
  - /nl/admin/lists/learn/adding-user-defined-lists
  - /nl/admin/lists/learn/deleting-user-defined-lists
  - /nl/admin/lists/learn/editing-lists-name-and-description
language: nl
---
