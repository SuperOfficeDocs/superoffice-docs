---
uid: help-nl-using-standard-templates
title: Standaardsjablonen gebruiken
description: Standaardsjablonen gebruiken
...
SuperOffice CRM wordt geleverd met een reeks standaardsjablonen voor zowel nationaal als internationaal gebruik.

Deze sjablonen worden gebruikt voor het maken van documenten van SuperOffice CRM.
...
2. [!include[Click arrow and select](includes/expand-list.md)] **Document - Sjabloon**.
