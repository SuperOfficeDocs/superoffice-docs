...
redirect_from: /nl/admin/lists/learn/adding-items
language: nl
---
...
1. Voer in het dialoogvenster de vereiste naam van het item in het veld **Naam** in. *(Verplicht)*
