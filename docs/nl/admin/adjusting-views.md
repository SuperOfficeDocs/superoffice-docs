---
uid: help-nl-adjusting-views
title: Weergaven aanpassen
description: Verschillende weergaven in Instellingen en onderhoud wijzigen.
...
# Weergaven in Instellingen en onderhoud wijzigen

## Tabbladen verplaatsen

Veel van de schermen in Instellingen en onderhoud bestaan uit verschillende tabbladen (zoals **Opties** en **Gebruikers**). U kunt de volgorde van deze tabbladen wijzigen:

1. Klik en sleep het tabblad naar de gewenste positie.
2. Laat het tabblad los.

> [!NOTE]
> De beschrijving van de tabbladen in de Help-functie volgt de standaardvolgorde.

## Lijsten sorteren

* Klik op de kolomkop waarop u wilt sorteren of klik met de rechtermuisknop op een kolomkop en kies **Sorteren**.
* Klik nogmaals oop de kolomkop als u de sorteervolgorde wilt omdraaien.
* Klik met de rechtermuisknop op een kolomkop en selecteer **Sorteervolgorde configureren**. In het dialoogvenster dat wordt weergegeven, kunt u meer sorteerkolommen selecteren.
...
U kunt selecteren welke kolommen in de lijsten worden weergegeven, en in welke volgorde.

1. Klik met de rechtermuisknop op een kolomkop en selecteer **Kolommen configureren**. Het tabblad **Kolommen** in het dialoogvenster **Aanpassen** wordt weergegeven.
