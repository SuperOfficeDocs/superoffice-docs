...
* Als het type dat u wilt verwijderen als standaard wordt gebruikt, stel dan een andere verzoektype als standaard in. (Totdat u dat doet, is de **Verwijderen**-knop gedeactiveerd.)

* Werk eerst alle [e-mailfilters][1] en [postbussen][2] bij die deze verzoektype gebruiken. U kunt geen type verwijderen dat in gebruik is.
...
1. Klik op **Verzoeken** in de navigator en selecteer het tabblad **Verzoektypes**.
