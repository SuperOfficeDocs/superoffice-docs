...
1. Voer een korte beschrijvende **Naam** in voor het nieuwe verzoektype. U kunt meer details toevoegen in het **Beschrijving**-veld.
...
1. Optioneel, filter de lijst met beschikbare statussen en/of prioriteiten voor verzoeken van dit type.
    ...
    * Om [status][4] of [prioriteit][3] toe te staan, laat het beschikbaarheidsveld leeg.
...
1. Optioneel, selecteer een [antwoordsjabloon][5] om te gebruiken wanneer een agent antwoordt op een verzoek van dit type.
    ...
    ![Instellingen en onderhoud, Instellingen voor verzoektype -screenshot][img2]

1. Klik op **Opslaan**. Het verzoektype is gemaakt.
