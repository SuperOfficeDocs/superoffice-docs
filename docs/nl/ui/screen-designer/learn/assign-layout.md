...
* Het standaardopmaak kan niet worden toegewezen.
* Een gebruikersgroep kan slechts één opmaak per scherm toegewezen krijgen.
* Als u een opmaak verwijdert, wordt de gebruikersgroep die eraan is toegewezen, teruggezet naar het standaardopmaak.
