...
1. In het veld **Map** wordt automatisch de naam getoond van de gekozen map. Als u van gedachten verandert, klikt u op de ![pictogramknop][img1] lijst en selecteert u een andere map in de lijst die wordt weergegeven.
