---
uid: help-nl-service-mailboxes-in
title: Postvak IN voor e-mail
description: Postvak IN voor e-mail
...
Het tabblad **Postvak IN voor e-mail** bevat een lijst met e-mailberichten die in de wachtrij staan om te worden gelezen. De volgende opties zijn eveneens beschikbaar vanaf de menuknop **Acties** (![pictogram][img1]):
