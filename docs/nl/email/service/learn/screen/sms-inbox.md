...
title: SMS-postvak IN
description: SMS-postvak IN
...
Het tabblad **SMS-Postvak IN** bevat een lijst met SMS-berichten die in de wachtrij staan om te worden gelezen. De volgende opties zijn eveneens beschikbaar vanaf de ![pictogram][img1] menuknop :
