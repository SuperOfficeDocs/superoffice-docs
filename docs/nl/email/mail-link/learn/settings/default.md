---
uid: help-nl-mail-link-settings-default
title: Standaardopties
description: Standaardopties
...
Opties in het deelvenster **Archiefopties** van het dialoogvenster **SuperOffice CRM-opties**. U kunt de standaardopties overschrijven met behulp van de [knoppen in uw e-mailclient][2].

| Optie | Beschrijving |
|---|---|
| E-mail standaard archiveren wanneer | Voor elke aangevinkte optie is **Archiveren is aan** standaard ingeschakeld voor de situatie waarnaar de optie verwijst. Als u een optie uitschakelt, is **Archiveren is uit** standaard ingeschakeld. |
| Gemaakt vanuit SuperOffice CRM | Wanneer u een e-mail verzendt, wordt deze standaard gearchiveerd in SuperOffice CRM. |
| Geschreven aan medewerkers vanuit SuperOffice CRM | Als deze optie is geselecteerd, worden *alle* uitgaande e-mails die naar medewerkers zijn geschreven, gearchiveerd. Anders worden e-mails naar mensen die zijn geregistreerd als partners in SuperOffice CRM *niet* standaard gearchiveerd. Deze optie is alleen van toepassing op [e-mails die zijn opgesteld in SuperOffice CRM][4] en als het vakje **gemaakt vanuit SuperOffice CRM** is ingeschakeld. |
...
* U kunt een document als e-mail verzenden door er met de rechtermuisknop op te klikken op het sectietabblad **Activiteiten** in SuperOffice CRM en **Verzenden als e-mail** te selecteren of door te klikken op **Taak** > **Verzenden als e-mail** in het dialoogvenster Document. Er wordt dan een nieuw e-mailvenster met het document geopend in uw e-mailclient.
