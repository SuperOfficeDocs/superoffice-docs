...
2. Selecteer een bericht met een uitnodiging.

    > [!NOTE]
    > Als het bericht bijlagen bevat (naast het iCal/ics-bestand) die u wilt bewaren, moet u deze archiveren of downloaden *voordat* u de uitnodiging beantwoordt. Wanneer u de uitnodiging accepteert of weigert, wordt het bericht uit het postvak IN verwijderd en naar de map **Verwijderd** verzonden.
    >
    > Klik op de pijl naast de bijlage die u wilt opslaan en selecteer **Downloaden** of **Archiveren**.

3. Klik op de knop **Accepteren**.
