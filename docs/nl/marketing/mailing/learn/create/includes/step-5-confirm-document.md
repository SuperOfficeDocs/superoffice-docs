...
> [!NOTE]
> Mailings met documenten worden niet daadwerkelijk verzonden wanneer u op **Nu verzenden** klikt. Er wordt een PDF-document gegenereerd dat alle pagina's bevat voor alle personen/bedrijven die u in de mailing hebt geselecteerd als ontvangers. U kunt de PDF [openen en afdrukken](#open-and-print-the-document) vanaf het scherm **Mailing weergeven**.
