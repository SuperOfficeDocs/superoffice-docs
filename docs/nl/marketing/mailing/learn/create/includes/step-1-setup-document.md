...
6. Voer in het veld **Onze ref.** de naam in die als onze referentie moet worden weergegeven in het document. U kunt in dit veld [sjabloonvariabelen][1] van SuperOffice CRM gebruiken.
