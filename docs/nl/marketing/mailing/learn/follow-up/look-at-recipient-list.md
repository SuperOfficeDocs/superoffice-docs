...
De eerste paar keer dat u uw mailing hebt verzonden, krijgt u mogelijk een groot aantal teruggestuurde e-mails. Dit is goed nieuws, want het betekent dat u elk e-mailadres kunt bijwerken dat verkeerd is gespeld of niet langer in gebruik is.

Het bijwerken van teruggestuurde e-mailadressen helpt het succespercentage van toekomstige mailings te verhogen.
...
* **Geretourneerd**: Activeer dit filter om alle ontvangers weer te geven voor wie de [mailing is geretourneerd als niet-bezorgd][3]. Dit kan het gevolg zijn van e-mailadresfouten, spamfilters, problemen met internet of omdat postvakken vol zijn.
  ...
  * Permanente problemen: verkeerd adres, onbekend domein. Voeg de ontvangers toe aan een nieuwe selectie en probeer de oorzaak van het probleem te vinden.
...
**Ontvanger heeft geklaagd**: Activeer dit filter om ontvangers weer te geven die de mailing hebben gemeld als spam/ongewenste e-mail.
