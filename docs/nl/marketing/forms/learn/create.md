...
2. Als u een [map voor het formulier wilt maken][8], klikt u op **Map toevoegen**.
3. Selecteer **Formulier** onder **Nieuw maken** aan de rechterkant van het scherm. Het scherm **Formulier bewerken** wordt geopend.
4. Voer in het veld **Naam formulier** een herkenbare naam in voor de sjabloon.
5. Vul de velden in zoals hieronder wordt beschreven.
6. Vergeet niet regelmatig op **Nu toepassen** te klikken om uw werk op te slaan. Het formulier wordt niet automatisch opgeslagen.
...
1. Ga naar de categorie **Velden**. Standaard worden het veld **Persoon - naam** en de knop **OK** toegevoegd aan het nieuwe formulier.
...
2. Voer in het tabblad **Bericht** de tekst in die moet worden weergegeven nadat het formulier is ingediend. Klik op **Werkbalk weergeven/verbergen** ![pictogram][img7] om opmaaktopties voor de tekst weer te geven.
3. Maak in het tabblad **E-mail** de bevestigings-e-mail die wordt verzonden naar personen die het formulier verzenden.
    ...
    3. **Bevestigingstekst**: Voer de hoofdtekst van de e-mail in. Klik op **Werkbalk weergeven/verbergen** ![pictogram][img7] om opmaaktopties voor de tekst weer te geven. Klik op **Tekstverwerker openen in dialoogvenster** ![pictogram][img8] om de tekst te bewerken in een grotere editor.
    4. Klik op **Werkbalk weergeven/verbergen** ![pictogram][img7] en vervolgens op **Bevestigingskoppeling invoegen** ![pictogram][img9]. De bevestigingskoppeling wordt in de hoofdtekst ingevoegd. Als u de koppeling wilt bewerken, klikt u erop en selecteert u **Koppeling bewerken**![pictogram][img10].
4. Klik op **Nu toepassen** wanneer u klaar bent.

Als dubbele opt-in is geactiveerd voor een formulier, hebben alle [verzendingen voor dit formulier][5] de status **Wachten op bevestiging** tot het e-mailadres wordt bevestigd.
...
* **Dit bericht weergeven**: Voer de weer te geven tekst in. Klik op **Werkbalk weergeven/verbergen** ![pictogram][img7] om opmaaktopties voor de tekst weer te geven. Klik op **Tekstverwerker openen in dialoogvenster** ![pictogram][img8] om de tekst te bewerken in een grotere editor.
...
* **Handmatig als indiener onbekend is. Automatisch als indiener bekend is**: Als het e-mailadres dat is verzonden in het formulier, overeenkomt met een e-mailadres in SuperOffice, wordt de formulierverzending automatisch verwerkt. Anders wordt deze handmatig verwerkt. U ontvangt een melding (![pictogram][img11]). Zie [Formulierverzendingen verwerken][6].
* **Handmatig voor alle verzendingen**: U ontvangt een melding (![pictogram][img11]) voor elk verzonden formulier. Zie [Formulierverzendingen verwerken][6] om formulierverzendingen handmatig te verwerken.
...
* **CRMScript uitvoeren**: Selecteer een script of macro om uit te voeren wanneer een formulierverzending is verwerkt. Zie [CRMScript][9].
