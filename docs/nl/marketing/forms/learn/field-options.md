...
* **Persoon - toestemming**
  ...
  * **Doel**: Selecteer waarom de persoon zijn toestemming moet geven. De goedkeuringstekst en beschrijving worden gedefinieerd in Instellingen en onderhoud.
...
* **Tekstblok**: Voer een tekst in om op het formulier weer te geven, zoals een korte introductie of gedetailleerde beschrijving. Klik op **Werkbalk weergeven/verbergen** ![pictogram][img2] om opmaaktopties voor de tekst weer te geven. Klik op **Tekstverwerker openen in dialoogvenster** ![pictogram][img3] om de tekst te bewerken in een grotere editor.
