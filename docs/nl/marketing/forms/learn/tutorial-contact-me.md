...
Zet een "neem contact met mij op"-formulier op de webpagina's van uw bedrijf om een gemakkelijk communicatiekanaal te bieden voor bestaande of potentiële klanten. Gebruik dit formulier om ondersteuningsaanvragen of leads te genereren voor uw verkoopteam.

## Wat we gaan doen

In dit handleiding laten we zien hoe u een kort formulier kunt maken voor klanten die in contact willen komen met een supportmedewerker. De formulierverzending zal leiden tot een nieuwe aanvraag voor uw supportafdeling.
...
1. Klik op de **Formulier**-knop onder **Nieuw maken** aan de rechterkant van het scherm.

1. Geef in het dialoogvenster **Formulier bewerken** "Contact met mij opnemen (support)" op in het veld **Formuliernaam**.
...
![Formuliereigenschappen invullen -screenshot][img5]

## Velden

1. Selecteer **Velden** uit het linkermenu.
...
![Velden toevoegen aan het formulier -screenshot][img6]
...
1. Selecteer **Pagina Bedankt**.

1. Selecteer **Dit bericht weergeven** en voer in "Fijn dat u contact met ons hebt opgenomen. U hoort zo snel mogelijk van ons.". Dit wordt weergegeven nadat de klant het formulier verzendt.

1. Selecteer **Pagina voor inactief formulier**.

1. Selecteer **Omleiden naar externe website** en voer de koppeling naar de webpagina in. Als een klant het formulier benadert nadat het als inactief is gemarkeerd, worden ze naar deze pagina gestuurd.
...
> [!TIP]
> Misschien bent u ook geïnteresseerd in onze [nieuwsbriefaanmelding][7] handleiding. Laat uw klanten zich aanmelden voor een of meer van uw nieuwsbrieven.
