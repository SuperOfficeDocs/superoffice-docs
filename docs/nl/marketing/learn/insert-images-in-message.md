...
1. Klik op een rij in het bericht.
2. Schuif in het zijpaneel omlaag naar **Rij-eigenschappen** en **Achtergrond afbeelding**.
3. Klik op **Afbeelding uploaden**.
4. Voer in het venster **Afbeeldingsbibliotheek** een van de onderstaande procedures uit.

## Een afbeelding gebruiken uit de SuperOffice-database
...
5. Klik op **Afbeelding uploaden** in het zijpaneel.

6. Selecteer in het venster **Afbeeldingsbibliotheek** een van de beschikbare afbeeldingen of klik op **Toevoegen** om een [afbeeldingsbestand op uw pc te kiezen][1].
...
8. (optioneel) [Voeg een gevolgde koppeling toe][2] aan de afbeelding. Als u bijvoorbeeld een foto invoegt van een product dat u op de markt brengt, kunt u een link toevoegen naar een informatiepagina voor het product. U kunt een nieuwe link maken of een bestaande link toevoegen.
    ...
    Een gewone link toevoegen (niet-getraceerd): Selecteer de afbeelding en voer de link in het veld **URL** in.
...
4. Klik en sleep de afbeelding naar de desbetreffende sectie in het bericht.
...
## De afmetingen van uw afbeelding aanpassen
