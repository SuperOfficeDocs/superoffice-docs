...
1. Voer de benodigde wijzigingen door in de diverse velden (zie [Velden toevoegen][1] voor een overzicht van de gegevens die u hier opgeeft).

    > [!NOTE]
    > De keuzelijst **Type** bevat alleen de opties die u kunt wijzigen. Dat wil zeggen, waar bestaande gegevens kunnen worden geconverteerd om in het nieuwe veldtype te passen.
