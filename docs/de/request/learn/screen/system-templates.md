...
Im Bereich **Kunden** stehen folgende Optionen zur Verfügung:

| Option | Beschreibung |
|---|---|
| Antwortvorlage für neue Personen | Zeigt die an neue Personen bei Kunden zu sendende Antwortvorlage an, wenn sie erstmals erfasst werden. |
| Antwortvorlage für automatische Antworten | Zeigt die Antwortvorlage für standardmäßige, automatische Antworten an Personen nach Erhalt einer ihrer E-Mails an. Dieser Wert ist bei individuellen [Postfächern][1] außer Kraft gesetzt. |
| Antwortvorlage für das Senden des Kennworts an Personen | Zeigt die Antwortvorlage zum Senden des Kennworts an Personen an, wenn diese um die Zusendung eines Passworts bitten. |
| Antwortvorlage für das Senden von Bestätigungs-E-Mails an Personen | Verwendete die Antwortvorlage als Bestätigung für an Personen gesendete E-Mails. |
| Antwortvorlage für das Kunden-Chat-Protokoll | Zeigt die Antwortvorlage an, die zum Senden von Chatprotokollen an Kunden verwendet wird, die den Support im Chat kontaktiert haben. |
| Antwortvorlage für neuen Link | Zeigt die Antwortvorlage an, die verwendet wird, um dem Kunden einen neuen Link zu senden, wenn der alte Link abgelaufen ist. |
...
Um eine andere Vorlage auszuwählen, müssen Sie das ![Symbol][img1] der Listenschaltfläche neben dem entsprechenden Feld klicken und eine Vorlage aus der angezeigten Liste auswählen.
