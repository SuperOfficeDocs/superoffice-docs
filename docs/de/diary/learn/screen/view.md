...
title: Registerkarte anzeigen
description: Registerkarte anzeigen
...
![Ansicht Kalender, die Registerkarte Ansicht -screenshot][img1]
...
Wenn Sie die Registerkarte **Übersicht** in der Ansicht Kalender auswählen, wird die Schaltfläche ![Symbol][img2] **Aufgabe** angezeigt.
