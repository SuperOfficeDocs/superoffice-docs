...
description: "Starten Sie Videokonferenzen direkt von Ihrem Kalender, indem Sie unsere verfügbaren Integrationen mit Videokonferenzanbietern nutzen. Lernen Sie hier, wie Sie eine Videokonferenz in SuperOffice erstellen und daran teilnehmen können."
author: SuperOffice RnD
so.date: 02.10.2023
keywords: Kalender, Folgeaufgabe, Videokonferenz
so.topic: howto
language: de
---
...
2. Um die URL für Videokonferenzen zu erstellen, müssen Sie auf das ![Symbol][img1] neben dem Besprechungstyp (zum Beispiel **Geschäftsbesprechung**) klicken. Das Symbol wechselt zu ![Symbol][img2] und es wird ein Videokonferenzlink hinzugefügt. SuperOffice CRM erstellt und fügt die Videokonferenz-URL für den von Ihnen verwendeten Videoanbieter hinzu.
...
> [!TIP]
> Klicken Sie auf das ![Symbol][img4], um den Link für die Videokonferenz zu kopieren. Sie können dann den Link in die Beschreibung des Termins einfügen oder per Direktnachricht an andere senden. Verwenden Sie die Vorlagenvariable {burl}, um den Videokonferenzen-Link zu Einladungsvorlagen hinzuzufügen.

## An Videokonferenzen teilnehmen

Sie können auf verschiedene Weisen an einer Videokonferenz in SuperOffice teilnehmen:

* Klicken Sie im Dialogfeld **Folgeaufgabe** auf **An Konferenz teilnehmen** (Termin).
...
Sie können der Videokonferenz auch beitreten, indem Sie den Termin in Ihrem Kalender aufrufen und auf die Schaltfläche An Konferenz teilnehmen unten im Termin klicken.

Wenn Sie auf den Link klicken, wird die Videokonferenz automatisch gestartet.
...
Klicken Sie auf den Termin in Ihrem SuperOffice-Kalender, um dessen Details in der Ansicht Vorschau in der Seitenleiste anzuzeigen.

(Geben Sie die Vorschau frei, indem Sie sie aus dem Dropdown-Menü oben in der Seitenleiste auswählen).

Um über die Anzeige Vorschau an der Videokonferenz teilzunehmen, müssen Sie nur auf die Schaltfläche An Konferenz teilnehmen unten in der Seitenleiste klicken. Nachdem Sie sie angeklickt haben, wird die Videokonferenz automatisch gestartet.
