...
description: "In dieser Anleitung lernen Sie, wie Sie Ihre Firmen-, Personen-, Projekt-, und Anfragenkarten konfigurieren."
...
> [!NOTE]
> Wenn diese Funktion aktiviert ist, werden die Felder in Ihrer aktuellen Registerkarte **Mehr** für die Ansichten Firma, Person, Verkauf, Projekt, und Anfragen in zwei Spalten unterteilt. Sie können diese Registerkarten im Ansichtsdesigner bearbeiten (siehe [Layout bearbeiten][1]).
