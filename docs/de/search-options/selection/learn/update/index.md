...
2. Wechseln Sie zur gewünschten Selektion. Sie können zum Beispiel [suchen][1].

3. Öffnen Sie die Registerkarte **Details**.

4. Klicken Sie auf **Bearbeiten**. Die Registerkarte **Selektion** wechselt in den Bearbeitungsmodus.

5. In der Liste **Selektion ist** können Sie eine dynamische oder kombinierte Auswahl in eine statische Auswahl umwandeln.

6. Wenn Sie die erforderlichen Änderungen vorgenommen haben, klicken Sie auf **Speichern**, um die Registerkarte zu schließen und die Änderungen zu speichern. Klicken Sie auf **Abbrechen**, um Ihre Änderungen abzulehnen.
