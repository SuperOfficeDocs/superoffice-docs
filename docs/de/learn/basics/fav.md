...
language: de
redirect_from:
  - /de/marketing/learn/add-fav
  - /de/request/learn/howto/fav
---

# Favoriten in SuperOffice CRM <i class="ph ph-star" aria-hidden="true"></i>
...
Wenn Sie einen Datensatz zu den Favoriten hinzufügen möchten, klicken Sie auf das Sternsymbol (<i class="ph ph-star" aria-hidden="true"></i>) in der jeweiligen Karte bzw. Registerkarte oder im jeweiligen Dialogfeld. Der Stern wird daraufhin in Gelb angezeigt und der Datensatz wird sofort zu den Favoriten hinzugefügt. Sie brauchen nicht auf **Speichern** zu klicken.
...
Jetzt können Sie schnell auf den Datensatz zugreifen, indem Sie im Navigatormenü auf <i class="ph ph-star" aria-label="Star icon"></i> klicken. Die Favoriten sind auch in der [Seitenleiste][4] verfügbar.
...
1. Klicken Sie auf <i class="ph ph-star" aria-label="Star icon"></i>.
...
1. Klicken Sie auf <i class="ph ph-caret-down" aria-label="Chevron"></i> neben dem Namen des Seitenleiste.
...
1. Klicken Sie auf das Favoritensymbol (<i class="ph ph-star" aria-hidden="true"></i>) in der Kopfzeile. Das Symbol wechselt zurück zur Standardeinstellung, was darauf hinweist, dass der Datensatz nicht länger ein Favorit ist.
