...
Sie können SuperOffice an Ihr Geschäftsmodell und Ihre Anforderungen anpassen – mit den Optionen in **Einstellungen und Verwaltung**.
...
## <a id="tools"></a>Entwicklungstools

Development Tools ist eine **standortweite Lizenz**, die Kunden und Partnern ermöglicht, SuperOffice CRM zu erweitern, zu optimieren, zu konfigurieren und zu automatisieren. Es ist als **Abonnement** für alle SuperOffice CRM-Kunden verfügbar – egal ob in der Cloud oder vor Ort installiert. In **CRM Suite** ist Development Tools im **Core-Plan** und höher enthalten – kein separates Abonnement erforderlich.

Anwendungsentwickler können Zugang zu einer Entwicklungs- und Testumgebung erhalten, indem sie sich [im Developer Portal registrieren][13].

### Wichtige Funktionen

Mit Development Tools können Sie:
...
Diese Tools sind im Client **Einstellungen und Verwaltung** verfügbar und erfordern geringe bis mittlere technische Kenntnisse. Mithilfe der dokumentierten APIs können Sie eigene Integrationen und Anwendungen entwickeln und mit einem Sandbox-Mandanten testen.
...
Wenn Sie mehr Tabellen benötigen, können Sie bei einem Abonnement von Development Tools zusätzliche Tabellen zur Datenbank hinzufügen.
...
Mit Development Tools können Sie benutzerdefinierte Ansichten in SuperOffice Service erstellen, die speziell auf Ihre Geschäftsprozesse zugeschnitten sind.
...
Mit Development Tools erhalten Sie auch Zugriff auf alle verfügbaren SuperOffice APIs:
...
### Wofür kann Development Tools verwendet werden?
...
Kunden können sich an ihren lokalen SuperOffice-Partner oder -Vertreter wenden, um Empfehlungen für ihre spezifischen geschäftlichen Anforderungen zu erhalten.

**So funktioniert es:**

* Wenn Sie ein Abonnement für Development Tools abschließen, werden in **Einstellungen und Verwaltung** zusätzliche Optionen verfügbar.
...
* Keine [benutzerdefinierte Anwendung][16] wird für Ihre SuperOffice CRM Online-Lösung verfügbar gemacht, es sei denn, es besteht ein aktives Abonnement. Wenn der Kunde sein Abonnement kündigt, wird die Anwendung deaktiviert/nicht mehr verfügbar.
...
Development Tools ist im **Core-Plan** enthalten. Es ist kein separates Abonnement oder keine Aktivierung erforderlich – die Funktionen sind im Rahmen Ihres Plans in **Einstellungen und Verwaltung** verfügbar.
