...
index: true
redirect_from: /de/admin/lists/learn/organize/user-group-filtering
language: de
---

# Benutzergruppe filtern

SuperOffice CRM-Benutzer gehören je nach Typ der ihnen eingeräumten Zugriffsrechte zu verschiedenen Benutzergruppen. Dies wird in der Ansicht [Benutzer][2] festgelegt.
