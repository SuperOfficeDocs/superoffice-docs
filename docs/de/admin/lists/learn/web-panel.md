...
Nachdem Sie Objekte hinzugefügt haben, können Sie für jedes einzelne Objekt Details festlegen. Sie können Folgendes festlegen:

* Für welche [Benutzergruppen das Objekt sichtbar ist][2].
* Unter welcher [Überschrift][1] es angezeigt wird.

## www-Registerkarte

Auf der **www-Registerkarte** können Sie eine Verknüpfung zu einer URL-Adresse angeben, um über eine URL Informationen aus anderen Anwendungen abzurufen. Die URL-Adresse kann mithilfe einer Vorlagenvariablen angegeben werden. Je nach Festlegung in Einstellungen und Verwaltung kann die **www-Registerkarte** auch in anderen Bereichen von SuperOffice CRM angezeigt werden. Wenn Sie auf eine dieser Verknüpfungen klicken, wird die zugehörige Website geöffnet.

> [!TIP]
> Sie können in Einstellungen und Verwaltung im Fenster **Optionen** auf der Registerkarte **Bezeichnungen** einen anderen Namen als **www** für die Registerkarte festlegen. Außerdem können Sie im **GUI - Web-Bildschirm** einen anderen Ort angeben.
