...
index: true
redirect_from: 
  - /de/admin/learn/index
  - /de/admin/learn/onboard-users
  - /de/admin/getting-started/index
  - /de/admin/getting-started/onboard-users
---
...
Sie müssen Ihr [Dokument für die Konfigurationsvorbereitung herunterladen][2], um wichtige Überlegungen für die Konfiguration zu überprüfen. Nachdem Sie die Fragen im Dokument beantwortet haben, erhalten Sie die Informationen, die Sie für die Konfiguration Ihres Systems benötigen.

Nachdem Sie sich für Ihre CRM-Implementierung vorbereitet haben, können Sie Ihre [CRM-Benutzer verwalten][1] und erstellen.

## Eigene Workflow-Leitfäden erstellen

Workflow-Leitfäden, wie der [Verkaufsleitfaden][4] und der [Projektleitfaden][5], helfen den Benutzern, die Kontrolle zu behalten und nach bewährten Praktiken zu arbeiten.
...
![Über die Ansicht Projektleitfaden in Project erhalten Sie ganz einfach einen Überblick über den Projektfortschritt. -screenshot][img1]
...
* [Mehr über die Integration von E-Mails und Dokumenten lesen][13]
