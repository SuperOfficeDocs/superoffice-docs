...
| Can export selections to file | The user may export company and contact information to a file. | |
...
| Can send email to selection members | The user may emails all members of a selection. | |
...
| Edit own synchronisation settings | Grants limited access to SuperOffice Intellisync Server Maintenance. The user may change own settings only. | |
