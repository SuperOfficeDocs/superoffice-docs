...
2. Klicken Sie auf das **Symbol** der Schaltfläche ![Filter][img1].

    Das ![Symbol][img1] der Schaltfläche **Filter** befindet sich unter dem Berichtsarchiv (der Bereichsregisterkarte **Dokumente**).

3. Geben Sie im Feld **Von** an, ab welchem Datum Berichte angezeigt werden sollen.

4. Geben Sie im Feld **Bis** an, bis zu welchem Datum Berichte angezeigt werden sollen.
...
6. Wenn Sie den Zeitraum, die Gruppe(n) und den/die Mitarbeiter ausgewählt haben, klicken Sie auf **OK**. Das Berichtsarchiv enthält nun alle Berichte, die die im Dialogfeld **Filter** angegebenen Kriterien erfüllen.

## Verwandte Themen

* [Aktivitäten und Verkäufe filtern][1]
