...
* Um die Nachricht zu senden und als Dokument in SuperOffice CRM zu archivieren, klicken Sie auf **Senden und archivieren**. Das Dialogfeld **Dokument** wird geöffnet. [Wie man ein Dokument erstellt][1].
