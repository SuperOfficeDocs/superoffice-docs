...
Sie können auch eine Kampagnenliste mit Hilfe von [Online-Web-Formularen][3] erstellen. Sie können nicht nur neue Leads unter den Besuchern Ihrer Website erfassen, die ein Web-Formular ausfüllen, sondern auch Web-Formulare verwenden, um Personen einzuladen, sich für verschiedene Kampagnen anzumelden.
