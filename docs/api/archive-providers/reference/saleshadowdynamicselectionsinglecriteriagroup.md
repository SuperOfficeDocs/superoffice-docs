...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=visibleFor,person/personUdef/SuperOffice:10,contact/contactUdef/SuperOffice:4,contact/LastDoBySale,contact/LastCompletedTicket
