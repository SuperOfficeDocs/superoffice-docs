...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=contact/restrictionAddress/line2,saleUdef/SuperOffice:6,saleStakeholder/person/personAddress/wgs84latitude,saleStakeholder/person/isMailingRecipient,saleStakeholder/contact/orgnr
