...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/personUdef/SuperOffice:9,person/personUdef/SuperOffice:10,contact/contactAssociate/usergroup,contact/saintDirection,project/endDate
