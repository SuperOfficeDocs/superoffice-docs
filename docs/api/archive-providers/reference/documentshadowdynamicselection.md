...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=contact/contactDeleted,contact/restrictionAddress/city,contact/contactExtra/x_contact_hidden_integer,project/icon,project/projectAssociate/title
