...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/hasStoreConsent,project/projectUdef/SuperOffice:4,sale/saleId,sale/associate/contactDepartment
