...
```http!
GET /api/v1/archive/QuoteLineStaticSelectionV2?$select=vat,alternative/version/quote/sale/person/hasInterests,alternative/version/quote/sale/contact/searchPhone/formattedNumber
