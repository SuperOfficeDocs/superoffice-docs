...
```http!
GET /api/v1/archive/appointmentfavourites?$select=favouriteAssociateId,appointmentPublish/publishedTo,contact/stop,person/personNumber,person/personUdef/SuperOffice:6
