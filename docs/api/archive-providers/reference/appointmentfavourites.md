...
```http!
GET /api/v1/archive/appointmentfavourites?$select=contact/email/emailAddress,person/personDirectFax/description,project/LastDoBySale,sale/associate/otherGroups
