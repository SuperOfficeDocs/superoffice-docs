...
```http!
GET /api/v1/archive/appointmentfavourites?$select=invitedPersonId,contact/contactPhone/formattedNumber,contact/postAddress/line1,contact/LastTicket,person/personAddress/formattedMultiLineAddress
