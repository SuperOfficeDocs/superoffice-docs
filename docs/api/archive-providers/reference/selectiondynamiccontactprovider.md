...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=personHasInterests,request/createdBy/contactDepartment,projectMembers/projectAssociate/contactFullName
