...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=email/emailDescription,contactAssociate/ejStatus,saintTicketStatus,appointment/suggestedAppointmentId,document/isReport
