...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactAssociate/mrMrs,NumberOfActivities,targetRelation/stop,sale/associate/contactName,position
