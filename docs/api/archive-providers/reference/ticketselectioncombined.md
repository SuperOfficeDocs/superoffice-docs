---
uid: TicketSelectionCombined
title: TicketSelectionCombined
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionCombinedProvider">SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionCombinedProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=contact/contactDeleted,contact/contactExtra/x_contact_hidden_integer,contact/contactExtra/x_contact_float,contact/contactExtra/x_contact_longtext
