...
```http!
GET /api/v1/archive/ChatSession?$select=person/kanaLastName,person/email/emailId,person/personAssociate/role,contact/postAddress/zip,contact/streetAddress/wgs84latitude
