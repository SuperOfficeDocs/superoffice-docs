...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=projectId,person/personDeletedDate,contact/contactFax/formattedNumber,project/projectAssociate/role,project/projectUdef/SuperOffice:9
