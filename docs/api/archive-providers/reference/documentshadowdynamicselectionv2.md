...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=person/personAddress/addressId,contact/phone/formattedNumber,contact/contactAssociate/isActive
