...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=contact/url/URLDescription,project/endDate,project/projectUdef/SuperOffice:5,associate/contactFullName,sale/saleStatus
