...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/correspondingAssociate/fullName,person/correspondingAssociate/assocType,project/projectAssociate/ejUserId,associate/role,sale/projectId
