...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/email/emailLastBounce,person/restrictionAddress/addressId,contact/hasInterests,contact/postAddress/line1,contact/contactAssociate/credentialType
