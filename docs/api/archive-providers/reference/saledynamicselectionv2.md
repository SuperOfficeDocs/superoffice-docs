...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=competitor,contact/contactId,associate/middleName,appointment/appointmentPublish/isPublished,document/associate/assocName
