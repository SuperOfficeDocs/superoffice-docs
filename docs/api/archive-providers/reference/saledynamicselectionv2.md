...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=person/kanaFirstName,person/personUdef/SuperOffice:8,contact/NumberOfSalesInPeriod,appointment/appointmentUdef/SuperOffice:3,appointment/associate/mrMrs
