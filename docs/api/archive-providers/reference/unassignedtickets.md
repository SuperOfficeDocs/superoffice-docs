...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.UnassignedTicketsProvider">SuperOffice.CRM.ArchiveLists.UnassignedTicketsProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/UnassignedTickets?$select=slevel,person/correspondingAssociate/firstName,person/correspondingAssociate/assocName
