...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=ownedBy/assocType,person/personExtra/x_person_contact_relation,contact/contactUdef/SuperOffice:2,contact/contactUdef/SuperOffice:5,extra/x_ticket_category_relation
