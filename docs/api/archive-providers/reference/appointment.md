...
```http!
GET /api/v1/archive/Appointment?$select=contact/contactAssociate/firstName,contact/contactAssociate/title,person/personDirectPhone/formattedNumber,sale/associate/userName,associate/personId
