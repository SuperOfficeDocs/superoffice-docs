...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/contactDepartment,appointment/associate/assocType,projectMember/personInterestIds,projectMember/personUdef/SuperOffice:9,projectMember/updatedByFullName
