...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=icon,projectAssociate/isActive,appointment/visibleFor,appointment/associate/personId,projectMember/saintTicketStatus
