...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectUdef/SuperOffice:2,NumberOfNotCompletedSales,sale/contactId,sale/competitor,document/associate/assocTooltip
