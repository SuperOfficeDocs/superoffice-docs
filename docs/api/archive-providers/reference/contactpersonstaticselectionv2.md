...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=sourceRelation/associateId,appointment/type,appointment/associate/assocName,document/documentUdef/SuperOffice:4,personAssociate/otherGroups
