...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=sale/hasStakeholders,appointment/associate/contactName,document/associate/isActiveText,personEmail/emailAddress,personAppointment/updatedBy
