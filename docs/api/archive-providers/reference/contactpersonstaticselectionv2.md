...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=registeredByFullName,contactExtra/x_contact_float,sourceRelation/hasInterests,targetRelation/name,sale/associate/assocName
