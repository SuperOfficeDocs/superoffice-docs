...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=postAddress/line3,streetAddress/line2,sourceRelation/deletedDate,sale/updatedDate,request/title
