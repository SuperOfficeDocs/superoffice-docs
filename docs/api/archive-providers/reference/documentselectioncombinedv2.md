...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionCombinedProviderV2">SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionCombinedProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personAddress/wgs84latitude,person/correspondingAssociate/ejDisplayName,person/correspondingAssociate/personEmail,contact/restrictionAddress/line2,contact/contactUdef/SuperOffice:10
