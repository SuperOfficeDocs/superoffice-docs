...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/rank,contact/restrictionAddress/city,contact/restrictionAddress/wgs84latitude,contact/contactAssociate/simultaneousEjUser,sale/type
