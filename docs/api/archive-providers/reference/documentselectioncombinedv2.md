...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=contact/deletedDate,contact/contactUdef/SuperOffice:12,project/LastDoByActivity,associate/contactFullName,sale/saleId
