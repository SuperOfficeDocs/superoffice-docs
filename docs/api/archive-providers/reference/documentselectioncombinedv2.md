...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=date,person/contactId,contact/postAddress/city,project/projectAssociate/ejDisplayName,associate/contactName
