...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=credited,contact/streetAddress/line3,document/icon,saleStakeholder/person/restrictionAddress/county,saleStakeholder/contact/contactAssociate/userName
