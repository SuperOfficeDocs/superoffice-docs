...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=stage,person/personNoMail,contact/contactUdef/SuperOffice:13,document/personId,project/projectAssociate/contactCategory
