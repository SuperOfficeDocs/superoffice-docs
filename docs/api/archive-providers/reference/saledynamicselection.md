...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=visibleFor,person/personSource,person/email/emailLastBounce,contact/restrictionAddress/line3,contact/LastDoBySale
