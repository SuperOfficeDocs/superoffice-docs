...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=contact/associateId,contact/restrictionAddress/formattedAddress,saleStakeholder/person/personActiveErpLinks,saleStakeholder/person/personDirectFax/formattedNumber,saleStakeholder/person/personAddress/zip
