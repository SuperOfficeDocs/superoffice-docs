...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=createdBy/title,ownedBy/mrMrs,contact/restrictionAddress/formattedAddress,contact/url/URLDescription,contact/NumberOfNotCompletedSalesInPeriod
