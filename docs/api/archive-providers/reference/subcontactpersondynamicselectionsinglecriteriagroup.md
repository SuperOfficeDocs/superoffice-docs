...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactAssociate/fullName,sale/text,appointment/associate/ejStatus,document/icon,document/who
