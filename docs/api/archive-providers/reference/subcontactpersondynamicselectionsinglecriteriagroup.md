...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=registeredDate,restrictionAddress/state,restrictionAddress/wgs84longitude,sale/amount,appointment/appointmentId
