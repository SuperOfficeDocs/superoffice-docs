...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/NumberOfNotCompletedSales,person/retired,project/associateId,project/imageThumbnail,project/LastSale
