...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=type,contact/contactUdef/SuperOffice:8,person/restrictionAddress/formattedAddress,person/personUdef/SuperOffice:7
