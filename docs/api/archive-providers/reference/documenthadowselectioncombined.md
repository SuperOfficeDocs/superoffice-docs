...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=documentPublish/publishedTo,person/personMobilePhone/description,associate/title,sale/contactId
