...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=getNoRows,contact/contactAssociate/personId,project/nextMilestone,associate/middleName,sale/who
