...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=contactId,person/associateType,contact/restrictionAddress/wgs84latitude,project/projectAssociate/associateDbId,associate/usergroup
