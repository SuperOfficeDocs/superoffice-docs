...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/supportLanguage,contact/postAddress/line1,project/projectUdef/SuperOffice:9,associate/ejUserId,targetRecordId
