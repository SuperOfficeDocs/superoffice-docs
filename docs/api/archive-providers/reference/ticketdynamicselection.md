...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionDynamicProvider">SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionDynamicProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=createdBy/personId,person/personCountry,person/personUdef/SuperOffice:4,contact/email/emailLastBounce,contact/contactAssociate/lastName
