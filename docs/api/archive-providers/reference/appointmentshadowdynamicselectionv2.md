...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/contactAssociate/mrMrs,contact/saintActivityType,person/personUpdatedBy,project/projectAssociate/title,project/NumberOfNotCompletedActivities
