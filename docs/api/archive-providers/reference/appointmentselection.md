...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/restrictionAddress/county,contact/url/URLAddress,person/personUpdatedBy,person/personRegisteredBy,project/NumberOfNotCompletedActivitiesInPeriod
