...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/contactAssociate/isActive,contact/NumberOfNotCompletedSalesInPeriod,project/saintTicketStatus,sale/amount,sale/associate/isActiveText
