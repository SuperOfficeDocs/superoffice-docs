...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AppointmentSelection?$select=intention,person/personUdef/SuperOffice:10,person/correspondingAssociate/fullName,person/correspondingAssociate/portraitThumbnail,project/projectAssociate/contactFullName
