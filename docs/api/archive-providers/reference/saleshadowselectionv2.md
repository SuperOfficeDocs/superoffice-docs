...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/phone/formattedNumber,person/withdrawnEmarketingConsent,contact/contactId,contact/searchPhone/description,document/registeredBy
