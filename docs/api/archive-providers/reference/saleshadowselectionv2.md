...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/personAssociate/title,contact/contactAssociate/credentialDisplayValue,contact/saintTicketStatus,appointment/associate/contactFullName,document/document/textId
