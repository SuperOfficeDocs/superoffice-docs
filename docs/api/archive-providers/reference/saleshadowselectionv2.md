...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=competitor,person/personUpdatedDate,person/personAddress/line3,contact/streetAddress/zip,associate/otherGroups
