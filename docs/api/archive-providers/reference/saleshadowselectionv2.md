...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=currency,description,contact/streetAddress/formattedAddress,associate/isActiveText,document/associate/ejDisplayName
