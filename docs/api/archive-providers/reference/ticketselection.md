...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/lastName,person/personCategory,person/personPrivate/description,contact/email/emailDescription,contact/restrictionAddress/line2
