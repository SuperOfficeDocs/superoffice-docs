...
```http!
GET /api/v1/archive/TicketSelection?$select=firstReadByOwner,realTimeSpentInternally,createdBy/simultaneousEjUser,person/hasInfoText,person/consentSourceEmarketing
