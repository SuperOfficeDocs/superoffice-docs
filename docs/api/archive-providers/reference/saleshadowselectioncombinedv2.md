...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/email/emailHasBounced,contact/contactAssociate/assocType,appointment/time,appointment/recurrenceRuleId,document/ourref
