...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/birthMonth,person/email/emailLastBounce,person/consentSourceStore,contact/searchPhone/description,appointment/date
