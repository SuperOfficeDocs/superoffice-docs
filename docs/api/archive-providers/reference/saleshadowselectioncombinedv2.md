...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=reopenDate,contact/postAddress/wgs84longitude,appointment/rawStatus,appointment/associate/personId,appointment/associate/contactDepartment
