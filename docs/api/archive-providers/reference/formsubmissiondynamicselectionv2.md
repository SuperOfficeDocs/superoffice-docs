...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/useAsMailingAddress,person/personAddress/state,person/correspondingAssociate/title,contact/category,contact/saintActivityType
