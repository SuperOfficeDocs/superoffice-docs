...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personUdef/SuperOffice:6,contact/contactSource,contact/postAddress/line1,contact/postAddress/wgs84longitude,project/NumberOfNotCompletedActivities
