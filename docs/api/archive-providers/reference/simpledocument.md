...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personAddress/city,contact/restrictionAddress/wgs84longitude,project/icon,project/projectUdef/SuperOffice:10,sale/userGroup
