...
```http!
GET /api/v1/archive/SimpleDocument?$select=updatedDate,recordTypeText,person/personUdef/SuperOffice:3,contact/contactFax/description,contact/restrictionAddress/state
