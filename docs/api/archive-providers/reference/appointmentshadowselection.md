...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=person/restrictionAddress/state,project/projectAssociate/isActiveText,project/NumberOfNotCompletedActivitiesInPeriod,sale/competitor
