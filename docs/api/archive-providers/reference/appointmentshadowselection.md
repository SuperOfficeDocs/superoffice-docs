...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=cautionWarning,contact/streetAddress/wgs84longitude,person/personAddress/wgs84longitude,project/icon,project/description
