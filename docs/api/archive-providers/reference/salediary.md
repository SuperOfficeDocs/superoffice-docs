...
```http!
GET /api/v1/archive/SaleDiary?$select=person/personDirectFax/formattedNumber,person/consentSourceEmarketing,contact/postAddress/line1,contact/contactInterestIds,project/projectEvent/isExternalEvent
