...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=saleType,contact/business,document/type,project/projectUdef/SuperOffice:8,project/saintSaleStatus
