...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=contact/nameDepartment,contact/country,contact/contactPhone/formattedNumber,contact/contactAssociate/title,contact/contactUdef/SuperOffice:13
