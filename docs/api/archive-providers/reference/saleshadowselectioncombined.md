...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=updatedBy,contact/streetAddress/line3,contact/contactInterestIds,contact/NumberOfNotCompletedTicketsInPeriod,contact/SaintStatus1
