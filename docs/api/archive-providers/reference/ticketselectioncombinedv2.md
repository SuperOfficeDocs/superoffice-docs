...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionCombinedProviderV2">SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionCombinedProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=ownedBy/isActiveText,contact/postAddress/line2,contact/streetAddress/county,contact/saintActivityType
