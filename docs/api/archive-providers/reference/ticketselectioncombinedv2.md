...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=ticketId,ownedBy/middleName,person/personHasInterests,contact/hasInterests,contact/postAddress/line3
