...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectEvent/hasSignOff,sale/associate/mrMrs,document/contactId,document/personId,document/associate/ejDisplayName
