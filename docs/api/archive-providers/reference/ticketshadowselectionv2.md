...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=origin,ownedBy/title,ownedBy/associateDbId,person/personHasInterests,contact/contactAssociate/contactFullName
