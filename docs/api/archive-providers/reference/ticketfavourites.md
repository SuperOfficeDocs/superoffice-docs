...
```http!
GET /api/v1/archive/ticketfavourites?$select=createdBy/associateDbId,ownedBy/isActiveText,person/correspondingAssociate/middleName,person/correspondingAssociate/ejDisplayName,contact/email/emailLastSent
