...
```http!
GET /api/v1/archive/ticketfavourites?$select=timeSpentInternally,ownedBy/usergroup,person/isProjectMember,person/personDirectPhone/formattedNumber,contact/phone/formattedNumber
