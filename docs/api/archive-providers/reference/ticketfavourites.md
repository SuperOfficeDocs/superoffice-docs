...
```http!
GET /api/v1/archive/ticketfavourites?$select=text,person/email/emailLastSent,contact/postAddress/line1,contact/NumberOfNotCompletedTickets,contact/saintSaleStatus
