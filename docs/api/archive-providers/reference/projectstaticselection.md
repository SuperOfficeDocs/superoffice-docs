...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=registeredBy,sale/hasStakeholders,appointment/rawType,appointment/appointmentUdef/SuperOffice:1,projectMember/personMobilePhone/formattedNumber
