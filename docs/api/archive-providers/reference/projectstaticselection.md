...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/usergroup,sale/associate/role,sale/associate/ejUserId,appointment/personId,document/documentPublish/publishedBy
