...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectMember/personAddress/county,projectMember/withdrawnStoreConsent,projectMember/streetAddress/formattedMultiLineAddress
