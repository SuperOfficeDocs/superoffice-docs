...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/personId,projectAssociate/ejUserId,sale/associate/ejUserId,appointment/time,appointment/associate/assocType
