...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/updatedByFullName,projectMember/personAssociate/assocType,projectMember/correspondingAssociate/ejDisplayName,projectMember/associateId
