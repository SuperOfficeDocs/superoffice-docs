...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectAssociate/assocType,projectMember/searchPhone/formattedNumber,projectMember/saintTicketStatus
