...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=getNoRows,contact/country,contact/contactAssociate/lastName,person/personDirectPhone/formattedNumber,person/personUrl/URLDescription
