...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=time,contact/email/emailDescription,contact/contactAssociate/contactId,contact/contactAssociate/role,contact/contactUdef/SuperOffice:3
