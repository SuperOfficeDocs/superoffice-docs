...
```http!
GET /api/v1/archive/DummySelectionContact?$select=country,restrictionAddress/wgs84latitude,url/URLAddress,NumberOfActivitiesInPeriod,sale/associate/userName
