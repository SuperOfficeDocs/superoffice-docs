...
```http!
GET /api/v1/archive/DummySelectionContact?$select=targetRelation/department,sale/registeredDate,sale/reopenDate,sale/associate/otherGroups,document/projectId
