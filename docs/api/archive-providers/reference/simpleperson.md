...
```http!
GET /api/v1/archive/SimplePerson?$select=personUdef/SuperOffice:11,personContact/hasInterests,request/createdBy/middleName,projectMembers/saintTicketStatus
