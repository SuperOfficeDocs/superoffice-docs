...
```http!
GET /api/v1/archive/SimplePerson?$select=middleName,personRegisteredDate,personContact/contactSupportPerson/personCountry,personContact/saintDirection,projectMembers/projectEvent/hasSignOn
