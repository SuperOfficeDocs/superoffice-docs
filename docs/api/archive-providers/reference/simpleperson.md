...
```http!
GET /api/v1/archive/SimplePerson?$select=personBusiness,personAssociate/userName,personContact/nameDepartment,personContact/contactSource,personContact/contactAssociate/isActive
