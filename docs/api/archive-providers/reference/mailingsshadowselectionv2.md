...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=project/projectAssociate/credentialDisplayValue,associate/ejStatus,project/nextMilestone
