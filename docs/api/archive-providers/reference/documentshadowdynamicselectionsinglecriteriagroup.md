...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/personUdef/SuperOffice:11,project/hasGuide,associate/contactId,documentUdef/SuperOffice:6
