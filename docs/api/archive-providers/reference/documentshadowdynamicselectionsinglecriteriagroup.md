...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/supportAssociate,person/personExtra/x_person_time,person/personAssociate/contactId,contact/email/emailAddress,contact/LastCompletedSale
