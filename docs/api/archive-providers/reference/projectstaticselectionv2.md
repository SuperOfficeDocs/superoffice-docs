...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectPublish/publishedTo,projectAssociate/contactDepartment,appointment/associateId,appointment/associate/personId,document/snum
