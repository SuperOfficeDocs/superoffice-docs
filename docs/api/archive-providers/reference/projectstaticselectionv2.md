...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=sale/updatedBy,appointment/recurring,projectMember/personUpdatedDate,projectMember/restrictionAddress/line2,projectMember/streetAddress/city
