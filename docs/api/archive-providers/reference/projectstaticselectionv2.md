...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/title,LastSale,sale/text,appointment/appointmentUdef/SuperOffice:6,appointment/associate/ejUserId
