...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/lastName,sale/associate/simultaneousEjUser,projectMember/email/emailLastSent,projectMember/contactAssociate/associateDbId
