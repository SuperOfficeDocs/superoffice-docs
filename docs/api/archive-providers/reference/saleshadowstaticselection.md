...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/hasInfoText,person/personAddress/county,contact/contactUdef/SuperOffice:3,appointment/endTime,appointment/associate/contactName
