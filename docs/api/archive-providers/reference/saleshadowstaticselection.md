...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/lastName,person/personDirectFax/formattedNumber,person/email/emailAddress,person/personExtra/x_person_datetime,person/personAssociate/contactDepartment
