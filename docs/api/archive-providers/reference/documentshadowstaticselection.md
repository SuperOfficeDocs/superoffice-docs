...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=updatedBy,person/personUdef/SuperOffice:7,contact/contactAssociate/fullName,contact/contactAssociate/ejUserId,sale/associate/isActiveText
