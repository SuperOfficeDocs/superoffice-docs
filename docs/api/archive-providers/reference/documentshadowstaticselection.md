...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/contactId,person/hasInterests,person/email/emailBounceCount,contact/contactId,contact/email/emailId
