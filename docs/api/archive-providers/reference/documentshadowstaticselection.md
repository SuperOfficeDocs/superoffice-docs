...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionStaticProvider">SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionStaticProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/personUdef/SuperOffice:4,contact/contactAssociate/firstName,contact/contactAssociate/fullName,contact/contactExtra/x_contact_hidden_integer,contact/NumberOfTicketsInPeriod
