...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=priorityName,content,person/personAddress/wgs84longitude,person/restrictionAddress/wgs84latitude
