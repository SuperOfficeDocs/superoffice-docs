...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/searchPhone/description,person/personAssociate/title,person/correspondingAssociate/assocName,person/withdrawnEmarketingConsent,person/consentSourceEmarketing
