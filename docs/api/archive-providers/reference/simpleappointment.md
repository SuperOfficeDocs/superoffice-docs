...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/contactInterestIds,person/personAddress/wgs84longitude,project/projectUdef/SuperOffice:10,associate/credentialDisplayValue
