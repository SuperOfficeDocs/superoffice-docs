...
```http!
GET /api/v1/archive/salefavourites?$select=person/birthMonth,person/supportLanguage,contact/updatedDate,project/projectPublish/publishedFrom,saleStakeholder/person/personId
