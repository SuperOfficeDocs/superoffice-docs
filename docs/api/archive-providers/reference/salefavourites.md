...
```http!
GET /api/v1/archive/salefavourites?$select=competitor,person/personCountry,person/phone/formattedNumber,person/restrictionAddress/addressId,person/personUdef/SuperOffice:6
