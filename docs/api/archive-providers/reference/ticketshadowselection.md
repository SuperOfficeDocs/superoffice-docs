...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=readByCustomer,createdBy/personEmail,person/personMobilePhone/formattedNumber,person/restrictionAddress/city,person/withdrawnStoreConsent
