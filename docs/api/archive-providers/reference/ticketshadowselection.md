...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personAddress/formattedAddress,person/personUdef/SuperOffice:1,contact/contactNoMail,contact/contactAssociate/credentialType
