...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/contactUdef/SuperOffice:5,contact/SaintStatus2,project/projectAssociate/title,project/projectUdef/SuperOffice:2,project/SaintStatus3
