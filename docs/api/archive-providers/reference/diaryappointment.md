...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/contactUdef/SuperOffice:3,person/withdrawnStoreConsent,project/nextMilestone,project/projectAssociate/userName,sale/userGroup
