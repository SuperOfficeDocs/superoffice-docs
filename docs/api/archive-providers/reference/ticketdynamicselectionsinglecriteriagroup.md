...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=createdBy/assocTooltip,ownedBy/contactId,ownedBy/contactDepartment,person/hasInfoText,person/personAddress/state
