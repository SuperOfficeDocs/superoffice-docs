...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/personHasInterests,person/personAssociateFullName,person/restrictionAddress/state,person/personAssociate/title,contact/name
