...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/updatedBy,contact/contactAssociate/credentialType,person/personUdef/SuperOffice:3,project/projectAssociate/assocName,sale/projectId
