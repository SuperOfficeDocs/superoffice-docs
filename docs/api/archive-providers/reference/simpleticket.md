...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/simultaneousEjUser,person/personUdef/SuperOffice:11,contact/contactAssociate/contactDepartment,contact/LastActivity
