...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=timeSpentExternally,ownedBy/ejStatus,contact/email/emailId,contact/postAddress/county,contact/contactAssociate/isActive
