...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/hasCompany,contact/postAddress/county,contact/restrictionAddress/city,extra/x_ticket_project_relation
