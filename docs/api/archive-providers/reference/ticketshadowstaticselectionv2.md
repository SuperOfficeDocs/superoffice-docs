...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/personAddress/wgs84longitude,person/restrictionAddress/formattedMultiLineAddress,person/birthMonth
