...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ticketStatusName,person/personUdef/SuperOffice:6,contact/business,contact/postAddress/formattedAddress,contact/restrictionAddress/addressId
