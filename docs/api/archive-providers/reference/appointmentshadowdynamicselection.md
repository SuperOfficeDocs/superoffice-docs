...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=person/associateType,project/projectAssociate/otherGroups,sale/nextDueDate,sale/associate/personId
