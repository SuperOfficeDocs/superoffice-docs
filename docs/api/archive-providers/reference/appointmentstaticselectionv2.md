...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=recordType,person/restrictionAddress/formattedAddress,project/endDate,sale/currencyId,sale/activeErpLinks
