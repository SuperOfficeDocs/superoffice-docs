...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/country,person/personAssociate/personId,person/personAssociate/contactFullName,project/NumberOfSales,associate/otherGroups
