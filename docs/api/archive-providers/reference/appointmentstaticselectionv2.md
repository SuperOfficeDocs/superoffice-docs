...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/phone/formattedNumber,contact/contactAssociate/personEmail,project/name,project/description,project/project/infoText
