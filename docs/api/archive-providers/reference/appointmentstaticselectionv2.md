...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=person/personId,person/birthYear,person/isStakeholder,project/projectAssociate/assocName,project/projectAssociate/isActive
