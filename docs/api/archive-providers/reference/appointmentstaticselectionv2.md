...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/postAddress/line3,contact/streetAddress/county,contact/saintTicketCategory,person/personAddress/formattedMultiLineAddress,project/projectUrl/URLDescription
