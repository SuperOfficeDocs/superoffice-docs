...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=sale/associate/portraitThumbnail,appointment/who,projectMember/contactId,projectMember/personHasInterests,projectMember/personExtra/x_person_date
