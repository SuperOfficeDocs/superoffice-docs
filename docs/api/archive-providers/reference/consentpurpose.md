...
```http!
GET /api/v1/archive/ConsentPurpose?$select=consentPerson/person/personRegisteredBy,consentPerson/person/useAsMailingAddress,consentPerson/person/personDeletedDate
