...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/postAddress/wgs84longitude,person/hasInfoText,person/birthdate,person/hasStoreConsent,project/projectPublish/publishedFrom
