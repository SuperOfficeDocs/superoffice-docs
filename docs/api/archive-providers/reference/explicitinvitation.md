...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/contactAssociate/credentialDisplayValue,project/associateId,project/projectEvent/eventDate,project/projectUdef/SuperOffice:10,sale/updatedDate
