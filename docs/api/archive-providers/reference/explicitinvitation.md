...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=recurrenceRuleId,contact/LastDoByActivity,project/NumberOfNotCompletedSalesInPeriod,sale/associate/contactFullName
