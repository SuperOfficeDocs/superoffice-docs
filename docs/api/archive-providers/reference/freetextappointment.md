...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.FreetextAppointmentResultProvider">SuperOffice.CRM.ArchiveLists.FreetextAppointmentResultProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/FreetextAppointment?$select=completed,appointmentPublish/publishedFrom,contact/email/emailLastSent,contact/streetAddress/zip,contact/contactAssociate/portraitThumbnail
