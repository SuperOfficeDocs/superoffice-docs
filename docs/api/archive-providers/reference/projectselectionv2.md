...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectUrl/URLAddress,sale/stage,appointment/recurring,appointment/appointmentUdef/SuperOffice:4,projectMember/restrictionAddress/formattedAddress
