...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=status,registeredBy,sale/associate/ejStatus,document/documentUdef/SuperOffice:8,projectMember/useAsMailingAddress
