...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=sale/saleId,appointment/type,appointment/associate/firstName,projectMember/personInterestIds,projectMember/legalBaseStore
