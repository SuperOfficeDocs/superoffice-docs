...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=saintTicketStatus,sale/saleUdef/SuperOffice:5,appointment/updatedDate,appointment/associate/ejStatus,projectMember/restrictionAddress/wgs84longitude
