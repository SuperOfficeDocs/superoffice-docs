...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/assocName,sale/visibleFor,document/documentId,projectMember/personAssociateId,projectMember/restrictionAddress/state
