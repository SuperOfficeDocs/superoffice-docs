...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=icon,NumberOfActivities,sale/registeredBy,sale/salePublish/publishedTo,sale/associate/ejStatus
