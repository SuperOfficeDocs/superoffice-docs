...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectPublish/publishedBy,projectAssociate/personId,appointment/associateId,appointment/associate/lastName,projectMember/hasInfoText
