...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=streetAddress/state,document/type,withdrawnStoreConsent,request/createdBy/ejUserId,projectMembers/updatedDate
