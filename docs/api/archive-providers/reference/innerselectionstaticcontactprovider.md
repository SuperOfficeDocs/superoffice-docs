...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactAssociate/assocType,sale/probPercent,appointment/visibleInDiary,document/documentId,document/suggestedDocumentId
