...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.FindTicketProvider">SuperOffice.CRM.ArchiveLists.FindTicketProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/FindTicket?$select=person/personExtra/x_person_request_relation,person/correspondingAssociate/isActive,contact/contactAssociate/contactFullName,contact/contactAssociate/credentialDisplayValue,contact/contactExtra/x_contact_integer
