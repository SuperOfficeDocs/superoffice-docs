...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personUpdatedDate,person/restrictionAddress/wgs84latitude,contact/registeredBy,contact/contactDeleted,contact/SaintStatus2
