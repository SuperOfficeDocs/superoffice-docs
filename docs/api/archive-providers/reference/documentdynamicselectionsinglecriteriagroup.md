...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personMobilePhone/formattedNumber,project/description,contact/mainContact
