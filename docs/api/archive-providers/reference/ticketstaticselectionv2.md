...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=ownedBy/firstName,person/personAssociate/credentialType,contact/contactAssociate/lastName,contact/contactExtra/x_contact_default_integer
