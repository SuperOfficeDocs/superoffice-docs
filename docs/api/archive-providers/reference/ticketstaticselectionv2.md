...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=person/personNoMail,person/personUdef/SuperOffice:8,contact/hasInfoText,contact/orgnr,contact/contactAssociate/lastName
