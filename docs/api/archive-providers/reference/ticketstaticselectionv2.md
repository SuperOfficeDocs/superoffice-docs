...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=person/personId,person/personPager/description,person/email/emailHasBounced,contact/postAddress/wgs84longitude,contact/contactUdef/SuperOffice:3
