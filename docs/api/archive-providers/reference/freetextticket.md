...
```http!
GET /api/v1/archive/FreetextTicket?$select=ownedBy/middleName,person/email/emailDescription,person/personUdef/SuperOffice:1,person/correspondingAssociate/assocType,contact/contactUdef/SuperOffice:3
