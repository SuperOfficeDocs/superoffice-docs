...
```http!
GET /api/v1/archive/ContactActivity?$select=project/projectUdef/SuperOffice:5,lastMessage,person/personAssociate/assocName,person/personAssociate/assocType,person/correspondingAssociate/firstName
