...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=person/birthYear,project/projectAssociate/associateDbId,contact/NumberOfNotCompletedSalesInPeriod
