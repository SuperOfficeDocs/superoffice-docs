...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=endDate,contact/postAddress/county,contact/LastDoByActivity,person/legalBaseEmarketing,project/saintIntention
