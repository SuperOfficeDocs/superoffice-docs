...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=icon,contact/restrictionAddress/addressId,person/personExtra/x_person_request_relation,person/correspondingAssociate/contactCategory,project/projectPublish/publishedBy
