...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/ejStatus,NumberOfActivitiesInPeriod,sale/associate/personEmail,appointment/associate/credentialDisplayValue
