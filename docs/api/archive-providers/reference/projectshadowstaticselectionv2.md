...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=sale/hasGuide,sale/salePublish/publishedBy,sale/associate/portraitThumbnail,document/completed,projectMember/number
