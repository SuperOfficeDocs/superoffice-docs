...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=sale/saleStatus,sale/saleUdef/SuperOffice:7,appointment/associate/simultaneousEjUser,document/userGroup,document/isReport
