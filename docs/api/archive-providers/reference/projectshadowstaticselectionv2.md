...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/mrMrs,sale/who,sale/updatedDate,appointment/completedDate,appointment/associate/credentialDisplayValue
