...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/personExtra/y_rental/x_end,contact/NumberOfNotCompletedSalesInPeriod,associate/assocType,appointment/associate/associateDbId,project/projectId
