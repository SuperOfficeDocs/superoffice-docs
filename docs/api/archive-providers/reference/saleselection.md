...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleSelection?$select=person/correspondingAssociate/contactFullName,contact/contactAssociate/credentialType,appointment/userGroup,appointment/recordTypeText,project/projectAssociate/associateDbId
