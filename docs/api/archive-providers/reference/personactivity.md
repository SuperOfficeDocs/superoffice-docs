...
```http!
GET /api/v1/archive/PersonActivity?$select=icon,registeredDate,person/personUdef/SuperOffice:1,person/personUdef/SuperOffice:2,person/correspondingAssociate/userName
