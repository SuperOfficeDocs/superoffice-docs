...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/personAddress/zip,contact/hasInterests,contact/restrictionAddress/formattedMultiLineAddress,contact/saintSaleStatus
