...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/contactAssociate/credentialType,contact/LastDoBySale,person/personRegisteredDate,project/project/textId,sale/associate/contactId
