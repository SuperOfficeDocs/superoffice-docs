...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=recurrenceRuleId,contact/contactAssociate/contactFullName,contact/SaintStatus2,project/hasInfoText
