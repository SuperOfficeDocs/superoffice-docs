...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=rawType,contact/hasInfoText,contact/code,contact/activeErpLinks,contact/postAddress/formattedAddress
