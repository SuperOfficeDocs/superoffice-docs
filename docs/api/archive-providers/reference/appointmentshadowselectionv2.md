...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/streetAddress/county,project/NumberOfNotCompletedActivities,sale/salePublish/publishedTo,sale/associate/usergroup
