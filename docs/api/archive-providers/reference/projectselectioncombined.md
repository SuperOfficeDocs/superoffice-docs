...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=sale/associate/lastName,appointment/invitedPersonId,appointment/associate/ejUserId,document/associate/isActive,projectMember/personDirectPhone/formattedNumber
