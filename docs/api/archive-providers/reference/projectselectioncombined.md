...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/contactId,sale/amount,sale/associate/role,projectMember/deletedDate,projectMember/postAddress/line1
