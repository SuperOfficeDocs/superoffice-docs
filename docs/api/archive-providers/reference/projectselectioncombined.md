...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=imageThumbnail,projectAssociate/credentialDisplayValue,sale/associate/title,document/who,document/visibleFor
