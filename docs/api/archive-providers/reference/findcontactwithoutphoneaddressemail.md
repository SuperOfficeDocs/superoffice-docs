...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=searchPhone/formattedNumber,LastTicket,sourceRelation/activeErpLinks,document/updatedDate,document/documentUdef/SuperOffice:4
