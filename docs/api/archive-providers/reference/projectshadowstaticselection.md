...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=sale/updatedBy,sale/hasQuote,appointment/booking,appointment/completedDate,appointment/associate/assocName
