...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectAssociate/isActiveText,saintAmountClass,appointment/type,appointment/appointment/textId,document/type
