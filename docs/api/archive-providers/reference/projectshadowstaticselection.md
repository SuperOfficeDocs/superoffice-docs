...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=hasGuide,projectAssociate/contactName,sale/recordType,document/documentUdef/SuperOffice:7,projectMember/projectId
