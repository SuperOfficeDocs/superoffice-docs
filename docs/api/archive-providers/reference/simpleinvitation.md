...
```http!
GET /api/v1/archive/SimpleInvitation?$select=date,appointmentPublish/publishedTo,appointmentUdef/SuperOffice:1,project/saintTicketCategory,sale/sale/description
