...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/birthdate,person/withdrawnStoreConsent,contact/email/emailBounceCount,contact/contactAssociate/contactName,project/hasInfoText
