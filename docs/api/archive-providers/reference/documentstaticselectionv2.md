...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=updatedDate,recordTypeText,person/personActiveErpLinks,contact/contactFax/formattedNumber,project/projectAssociate/personId
