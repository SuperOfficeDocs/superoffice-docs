...
```http!
GET /api/v1/archive/ContactSelection?$select=email/emailLastBounce,contactAssociate/role,NumberOfActivitiesInPeriod,targetRelation/country,targetRelation/code
