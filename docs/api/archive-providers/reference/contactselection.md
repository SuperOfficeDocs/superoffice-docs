...
```http!
GET /api/v1/archive/ContactSelection?$select=department,sale/probPercent,appointment/associate/personEmail,document/associate/personId,projectMembers/text
