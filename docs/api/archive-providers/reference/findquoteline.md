...
```http!
GET /api/v1/archive/FindQuoteLine?$select=alternative/erpDiscountPercent,alternative/version/quote/sale/person/personAddress/state,alternative/version/quote/sale/person/legalBaseEmarketing
