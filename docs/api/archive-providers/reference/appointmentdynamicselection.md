...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionDynamicProvider">SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionDynamicProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/postAddress/county,contact/restrictionAddress/county,person/personDeletedDate,project/completed,sale/associate/isActive
