...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=rawStatus,person/isProjectMember,person/email/emailHasBounced,person/personAddress/line3,project/saintSaleStatus
