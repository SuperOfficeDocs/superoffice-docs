...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/assocTooltip,document/associate/isActiveText,projectMember/contactFax/description,projectMember/streetAddress/state
