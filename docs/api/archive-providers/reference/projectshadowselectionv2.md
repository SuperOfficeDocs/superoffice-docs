...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=completed,sale/currency,appointment/type,appointment/recordType,appointment/associate/credentialDisplayValue
