...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/contactFullName,saintAmountClass,sale/saleNumber,sale/associate/simultaneousEjUser,projectMember/personSource
