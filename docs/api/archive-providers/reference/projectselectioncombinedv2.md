...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=description,sale/icon,sale/associate/ejUserId,document/documentUdef/SuperOffice:6,projectMember/correspondingAssociate/personEmail
