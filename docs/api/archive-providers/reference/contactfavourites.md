...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.ContactFavouritesProvider">SuperOffice.CRM.ArchiveLists.ContactFavouritesProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/contactfavourites?$select=postAddress/formattedAddress,contactAssociate/mrMrs,contactSupportAssociate/personEmail
