...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=intention,contact/streetAddress/line2,contact/contactAssociate/contactId,person/position,person/personDirectFax/formattedNumber
