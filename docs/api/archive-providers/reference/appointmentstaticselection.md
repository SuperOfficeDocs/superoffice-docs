...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=updatedBy,contact/contactUdef/SuperOffice:2,project/description,project/projectAssociate/credentialDisplayValue,sale/stalledComment
