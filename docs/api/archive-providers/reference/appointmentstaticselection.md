...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/registeredByFullName,project/projectUdef/SuperOffice:8,sale/sale/textId,sale/associate/credentialType
