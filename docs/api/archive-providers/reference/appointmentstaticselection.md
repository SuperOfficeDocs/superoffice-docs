...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/code,project/updatedBy,project/projectAssociate/userName,sale/saleNumber,associate/isActive
