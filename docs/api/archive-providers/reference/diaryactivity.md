...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/email/emailLastSent,person/personAssociate/isActive,contact/hasInfoText,contact/contactUdef/SuperOffice:2,sale/type
