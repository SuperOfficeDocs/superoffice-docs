...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=time,competitor,person/personPrivate/formattedNumber,person/searchPhone/formattedNumber,contact/contactUdef/SuperOffice:7
