...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/subscription,contact/stop,contact/contactAssociate/contactCategory,contact/contactUdef/SuperOffice:10,document/documentPublish/publishedBy
