...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/personDirectPhone/formattedNumber,contact/postAddress/line1,contact/contactUdef/SuperOffice:13,sale/registeredByFullName
