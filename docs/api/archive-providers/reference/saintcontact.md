...
```http!
GET /api/v1/archive/SaintContact?$select=contactAssociate/otherGroups,sourceRelation/name,targetRelation/restrictionContactId,sale/who,appointment/saleId
