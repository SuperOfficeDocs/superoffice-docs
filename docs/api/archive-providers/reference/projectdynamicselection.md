...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/usergroup,sale/registeredBy,sale/associate/contactId,projectMember/email/emailDescription
