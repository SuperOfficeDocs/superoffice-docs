...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=sale/saleUdef/SuperOffice:4,projectMember/personAddress/line1,projectMember/contactAssociate/isActive
