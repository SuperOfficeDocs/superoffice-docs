...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.ProjectSelectionDynamicProvider">SuperOffice.CRM.ArchiveLists.Archive.ProjectSelectionDynamicProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/ejUserId,appointment/appointment/textId,document/registeredBy,projectMember/correspondingAssociate/title,projectMember/contactEmail/emailHasBounced
