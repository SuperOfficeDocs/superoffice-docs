...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=associateId,person/personRegisteredDate,contact/streetAddress/city,saleUdef/SuperOffice:2,appointment/recordTypeText
