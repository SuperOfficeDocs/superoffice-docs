...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=soldReason,sale/description,contact/email/emailProtocol,contact/contactAssociate/contactId,appointment/visibleFor
