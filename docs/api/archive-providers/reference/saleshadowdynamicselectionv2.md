...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=text,contact/restrictionAddress/addressId,appointment/recurrenceRuleId,quote/version/extraField4
