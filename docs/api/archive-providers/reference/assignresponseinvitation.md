...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=recurrenceRuleId,contact/registeredByFullName,contact/postAddress/wgs84latitude,person/correspondingAssociate/associateDbId,project/description
