...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=person/personPager/description,person/personAddress/county,project/NumberOfSalesInPeriod,sale/saleUdef/SuperOffice:4
