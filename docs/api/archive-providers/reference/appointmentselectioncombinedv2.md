...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=endTime,contact/postAddress/wgs84longitude,contact/contactAssociate/contactFullName,person/personSource,person/personPrivate/formattedNumber
