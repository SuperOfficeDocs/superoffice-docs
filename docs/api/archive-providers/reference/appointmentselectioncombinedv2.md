...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/postAddress/formattedMultiLineAddress,contact/contactAssociate/personId,sale/salePublish/publishedFrom
