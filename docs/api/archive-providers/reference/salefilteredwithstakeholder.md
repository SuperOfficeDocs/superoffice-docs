...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=personId,person/personUdef/SuperOffice:5,contact/category,contact/searchPhone/formattedNumber,contact/contactAssociate/firstName
