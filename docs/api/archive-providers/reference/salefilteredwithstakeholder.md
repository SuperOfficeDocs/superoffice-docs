...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=contact/contactSource,contact/postAddress/formattedMultiLineAddress,associate/contactName,saleStakeholder/person/fullName,saleStakeholder/person/personAddress/zip
