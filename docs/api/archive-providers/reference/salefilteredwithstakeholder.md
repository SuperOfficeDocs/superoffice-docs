...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=registeredBy,earningPercent,person/portraitThumbnail,person/isMailingRecipient,contact/postAddress/addressId
