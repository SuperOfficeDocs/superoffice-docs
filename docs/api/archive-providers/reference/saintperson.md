...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.SaintPersonProviderWithRestrictionGroupSupport">SuperOffice.CRM.ArchiveLists.SaintPersonProviderWithRestrictionGroupSupport</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaintPerson?$select=email/emailAddress,sourceRelation/updatedDate,sale/associate/assocTooltip,appointment/appointmentUdef/SuperOffice:4,personEmail/emailAddress
