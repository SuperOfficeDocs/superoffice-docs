...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelectionV2?$select=vatAmount,alternative/reason,alternative/version/number,alternative/version/quote/sale/person/email/emailProtocol,alternative/version/quote/sale/person/restrictionAddress/city
