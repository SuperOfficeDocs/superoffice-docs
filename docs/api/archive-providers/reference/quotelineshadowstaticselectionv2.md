...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelectionV2?$select=alternative/version/approvedText,alternative/version/quote/poNumber,alternative/version/quote/sale/project/projectAssociate/personId
