...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=NumberOfActivitiesInPeriod,sourceRelation/associateId,sale/personId,sale/currency,appointment/associate/contactName
