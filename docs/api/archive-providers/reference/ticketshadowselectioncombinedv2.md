...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionCombinedProviderV2">SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionCombinedProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=person/mrMrs,person/personBusiness,person/personAddress/formattedAddress,person/personExtra/y_rental/x_start,contact/contactAssociate/personId
