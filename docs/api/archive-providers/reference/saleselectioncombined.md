...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/personCategory,person/personUdef/SuperOffice:9,contact/phone/formattedNumber,contact/contactFax/description,contact/restrictionAddress/addressId
