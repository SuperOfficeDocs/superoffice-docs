...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=time,person/associateType,person/correspondingAssociate/ejUserId,person/consentSourceEmarketing,contact/contactAssociate/assocType
