...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=amountWeighted,person/restrictionAddress/line2,contact/restrictionAddress/line3,project/completed,saleStakeholder/person/isStakeholder
