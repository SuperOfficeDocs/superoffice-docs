...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=contact/email/emailDescription,contact/NumberOfNotCompletedTicketsInPeriod,appointment/associate/assocTooltip,document/who,document/associate/role
