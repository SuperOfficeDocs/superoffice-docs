...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=saleId,stalledComment,person/personDirectPhone/formattedNumber,person/correspondingAssociate/assocName,contact/streetAddress/wgs84latitude
