...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectPublish/publishedBy,projectUrl/URLDescription,sale/source,sale/associate/assocTooltip,projectMember/personExtra/x_person_float
