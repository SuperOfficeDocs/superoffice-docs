...
```http!
GET /api/v1/archive/Invitation?$select=alarm,contact/postAddress/county,contact/contactAssociate/associateDbId,contact/contactAssociate/assocName,person/restrictionAddress/wgs84longitude
