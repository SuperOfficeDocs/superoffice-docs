...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/ticketPriority,contact/registeredDate,contact/email/emailLastSent,contact/streetAddress/city,contact/contactAssociate/contactId
