...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personCategory,person/personAddress/zip,contact/nameDepartment,contact/number,contact/contactAssociate/otherGroups
