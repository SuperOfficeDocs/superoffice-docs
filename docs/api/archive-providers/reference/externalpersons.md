...
```http!
GET /api/v1/archive/ExternalPersons?$select=title,personSource,personMobilePhone/description,personAssociate/contactDepartment,projectMembers/projectAssociate/portraitThumbnail
