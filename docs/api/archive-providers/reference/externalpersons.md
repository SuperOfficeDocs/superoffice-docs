...
```http!
GET /api/v1/archive/ExternalPersons?$select=personTargetRelation/rank,request/contactId,request/ownedBy/simultaneousEjUser,projectMembers/saintTicketCategory,personAppointment/appointmentUdef/SuperOffice:3
