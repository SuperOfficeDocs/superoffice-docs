...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=associateId,contact/activeErpLinks,person/hasInfoText,project/projectUrl/URLDescription,project/NumberOfNotCompletedSales
