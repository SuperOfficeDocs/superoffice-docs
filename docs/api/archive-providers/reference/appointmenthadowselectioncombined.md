...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=date,priority,contact/streetAddress/zip,contact/restrictionAddress/line2,project/projectAssociate/contactCategory
