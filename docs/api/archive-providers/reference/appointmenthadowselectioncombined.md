...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=recurring,contact/searchPhone/description,contact/contactAssociate/assocType,contact/contactAssociate/simultaneousEjUser,person/searchPhone/description
