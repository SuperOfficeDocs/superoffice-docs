...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/legalBaseEmarketing,contact/contactAssociate/title,contact/LastDoByTicket,appointment/associate/personId,project/projectUdef/SuperOffice:8
