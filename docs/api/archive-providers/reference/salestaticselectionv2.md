...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=currencyId,person/personId,person/personNumber,person/phone/formattedNumber,person/email/emailHasBounced
