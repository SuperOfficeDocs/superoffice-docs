...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/salePublish/publishedTo,projectMember/birthYear,projectMember/contactUdef/SuperOffice:8,projectMember/saintTicketCategory
