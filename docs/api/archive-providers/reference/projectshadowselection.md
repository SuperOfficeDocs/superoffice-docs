...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/lastName,sale/saleUdef/SuperOffice:3,appointment/registeredDate,appointment/associate/personEmail,projectMember/personAddress/line3
