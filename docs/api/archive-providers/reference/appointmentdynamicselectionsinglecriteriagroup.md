...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=updatedDate,contact/contactUdef/SuperOffice:4,person/personSource,person/email/emailDescription
