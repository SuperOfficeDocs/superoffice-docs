...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=rowKind,getNoRows,contactAssociate/contactFullName,sale/associate/contactCategory,sale/saleUdef/SuperOffice:7
