...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/useAsMailingAddress,person/personPrivate/description,contact/contactExtra/x_contact_hidden_integer,project/projectAssociate/portraitThumbnail,project/projectUdef/SuperOffice:6
