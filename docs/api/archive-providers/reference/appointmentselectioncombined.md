...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=person/personAddress/zip,project/projectAssociate/middleName,sale/salePublish/publishedBy,associate/simultaneousEjUser
