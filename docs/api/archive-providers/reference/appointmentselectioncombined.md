---
uid: AppointmentSelectionCombined
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionCombinedProvider">SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionCombinedProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=appointmentPublish/publishedBy,person/restrictionAddress/line2,person/restrictionAddress/zip,appointmentUdef/SuperOffice:6,project/projectEvent/isExternalEvent
