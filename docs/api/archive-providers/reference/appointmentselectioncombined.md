...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=joinVideomeetUrl,contact/updatedDate,person/restrictionAddress/line1,person/correspondingAssociate/ejDisplayName,person/isMailingRecipient
