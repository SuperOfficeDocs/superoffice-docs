...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=saleId,contact/email/emailProtocol,contact/contactAssociate/role,contact/contactUdef/SuperOffice:3,contact/NumberOfActivitiesInPeriod
