...
```http!
GET /api/v1/archive/Links?$select=userGroup,contact/searchPhone/description,contact/email/emailLastBounce,contact/LastSale,person/restrictionAddress/zip
