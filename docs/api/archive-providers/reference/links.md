...
```http!
GET /api/v1/archive/Links?$select=linkDescription,contact/postAddress/wgs84longitude,contact/contactAssociate/middleName,person/personDeletedDate,person/personUdef/SuperOffice:5
