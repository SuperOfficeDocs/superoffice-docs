...
```http!
GET /api/v1/archive/Links?$select=booking,contact/registeredBy,person/personAssociateId,saleStakeholder/person/searchPhone/formattedNumber,quote/version/approvedDate
