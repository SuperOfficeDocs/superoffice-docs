...
```http!
GET /api/v1/archive/documentfavourites?$select=person/email/emailId,contact/associateId,contact/business,contact/contactExtra/x_contact_float,associate/role
