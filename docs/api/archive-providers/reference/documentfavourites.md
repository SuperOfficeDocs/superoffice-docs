...
```http!
GET /api/v1/archive/documentfavourites?$select=entityIcon,person/consentSourceStore,contact/contactUdef/SuperOffice:13,associate/ejDisplayName,sale/associate/associateDbId
