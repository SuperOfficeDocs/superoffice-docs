...
```http!
GET /api/v1/archive/documentfavourites?$select=contactId,project/projectAssociate/contactDepartment,project/projectUdef/SuperOffice:10,associate/contactName,documentUdef/SuperOffice:7
