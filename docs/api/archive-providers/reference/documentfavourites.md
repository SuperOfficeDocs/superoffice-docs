...
```http!
GET /api/v1/archive/documentfavourites?$select=snum,person/personNumber,person/supportLanguage,contact/postAddress/county,contact/streetAddress/formattedMultiLineAddress
