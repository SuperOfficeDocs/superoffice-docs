---
uid: MailingsShadowStaticSelectionV2
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.MailingsShadowSelectionStaticProviderV2">SuperOffice.CRM.ArchiveLists.Archive.MailingsShadowSelectionStaticProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=project/projectAssociate/firstName,project/projectAssociate/ejUserId,associate/ejStatus
