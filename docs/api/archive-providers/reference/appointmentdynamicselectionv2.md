...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=endDate,priority,contact/contactUdef/SuperOffice:7,person/birthdate,person/personExtra/x_person_integer
