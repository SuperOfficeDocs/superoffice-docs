...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=completed,contact/contactAssociate/contactCategory,person/personUpdatedBy,person/withdrawnStoreConsent
