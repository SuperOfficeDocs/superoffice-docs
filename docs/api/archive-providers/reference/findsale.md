...
```http!
GET /api/v1/archive/FindSale?$select=amount,person/personAssociate/simultaneousEjUser,contact/restrictionAddress/line3,document/recordTypeText,saleStakeholder/person/personAssociate/contactCategory
