...
```http!
GET /api/v1/archive/FindSale?$select=personId,person/personDirectFax/description,person/email/emailLastBounce,appointment/visibleInDiary,appointment/appointmentUdef/SuperOffice:7
