...
```http!
GET /api/v1/archive/FindSale?$select=who,contact/contactAssociate/contactFullName,contact/contactAssociate/personEmail,associate/firstName,associate/usergroup
