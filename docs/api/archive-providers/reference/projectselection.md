...
```http!
GET /api/v1/archive/ProjectSelection?$select=updatedDate,appointment/appointmentUdef/SuperOffice:6,projectMember/contactId,projectMember/email/emailProtocol,projectMember/personUdef/SuperOffice:1
