...
```http!
GET /api/v1/archive/ProjectSelection?$select=sale/personId,appointment/associateId,projectMember/withdrawnEmarketingConsent,projectMember/streetAddress/line3
