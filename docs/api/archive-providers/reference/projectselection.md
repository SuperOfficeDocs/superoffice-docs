...
```http!
GET /api/v1/archive/ProjectSelection?$select=description,appointment/appointmentPublish/publishedFrom,document/associate/middleName,document/associate/contactCategory,document/associate/otherGroups
