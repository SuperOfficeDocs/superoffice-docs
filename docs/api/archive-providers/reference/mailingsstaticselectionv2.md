...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.MailingsSelectionStaticProviderV2">SuperOffice.CRM.ArchiveLists.Archive.MailingsSelectionStaticProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=personId,project/SaintStatus3,project/saintActivityType
