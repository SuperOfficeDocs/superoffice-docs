...
```http!
GET /api/v1/archive/Mail2?$select=contact/NumberOfNotCompletedSalesInPeriod,contact/NumberOfTicketsInPeriod,accountAssociate/isActive,accountAssociate/otherGroups
