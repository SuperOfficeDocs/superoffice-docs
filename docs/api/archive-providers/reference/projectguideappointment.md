...
```http!
GET /api/v1/archive/ProjectGuideAppointment?$select=appointmentInstance/person/personInfo/infoText,appointmentInstance/person/personAddress/city,appointmentInstance/person/hasEmarketingConsent,appointmentInstance/person/withdrawnEmarketingConsent,appointmentInstance/associate/credentialDisplayValue
