...
```http!
GET /api/v1/archive/ProjectGuideAppointment?$select=appointmentInstance/person/personUdef/SuperOffice:9,appointmentInstance/sale/description,appointmentInstance/contact/NumberOfActivities
