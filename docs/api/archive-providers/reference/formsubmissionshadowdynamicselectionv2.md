...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personAddress/wgs84latitude,person/correspondingAssociate/simultaneousEjUser,contact/SaintStatus2
