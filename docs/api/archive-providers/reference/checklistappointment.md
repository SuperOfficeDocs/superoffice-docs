...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/streetAddress/addressId,contact/streetAddress/formattedMultiLineAddress,project/projectUdef/SuperOffice:6,project/SaintStatus3,sale/personId
