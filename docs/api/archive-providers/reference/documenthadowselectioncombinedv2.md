...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/rank,person/personExtra/y_rental/id,contact/contactUdef/SuperOffice:12,contact/NumberOfActivities,contact/NumberOfTickets
