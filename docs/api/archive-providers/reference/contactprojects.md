...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.ContactProjectsProvider">SuperOffice.CRM.ArchiveLists.ContactProjectsProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/ContactProjects?$select=endDate,projectPublish/publishedFrom,projectUrl/URLDescription
