...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=readStatus,createdBy/contactFullName,person/personHasInterests,person/phone/formattedNumber,person/restrictionAddress/zip
