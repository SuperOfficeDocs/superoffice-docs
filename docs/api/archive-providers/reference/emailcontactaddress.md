...
```http!
GET /api/v1/archive/emailcontactaddress?$select=contactPhone/description,contactSupportPerson/personHasInterests,contactUdef/SuperOffice:13,LastDoByTicket
