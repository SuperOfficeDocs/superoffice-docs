...
```http!
GET /api/v1/archive/ProjectActivity?$select=person/personUdef/SuperOffice:11,person/subscription,contact/registeredBy,contact/postAddress/line1,contact/restrictionAddress/formattedMultiLineAddress
