...
```http!
GET /api/v1/archive/ProjectActivity?$select=snum,person/personAddress/wgs84longitude,contact/restrictionAddress/line3,sale/associate/credentialDisplayValue
