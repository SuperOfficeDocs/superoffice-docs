...
```http!
GET /api/v1/archive/ProjectActivity?$select=recordType,person/personRegisteredByFullName,person/email/emailAddress,contact/contactAssociate/lastName,documentUdef/SuperOffice:5
