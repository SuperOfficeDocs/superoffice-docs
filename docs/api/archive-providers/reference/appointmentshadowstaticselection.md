...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=priority,contact/NumberOfActivities,contact/NumberOfActivitiesInPeriod,person/personUdef/SuperOffice:10,person/correspondingAssociate/firstName
