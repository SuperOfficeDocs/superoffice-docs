...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=NumberOfNotCompletedActivities,sourceRelation/mainContact,targetRelation/csRelation,sale/associateId,sale/stageRank
