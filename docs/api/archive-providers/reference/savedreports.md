...
<list type="bullet"><item><description>It uses the standard Filter settings, like the activity archives under Contact and Project</description></item><item><description>The 'document' entity is mandatory, not optional as it usually is</description></item><item><description>The 'isReport' restriction is automatically added, with the value 'true', so only
...
```http!
GET /api/v1/archive/SavedReports?$select=contact/contactInterestIds,contact/contactUdef/SuperOffice:7,project/projectUdef/SuperOffice:8,project/NumberOfNotCompletedActivities,sale/icon
