...
```http!
GET /api/v1/archive/SavedReports?$select=ourref,person/birthdate,person/personExtra/x_person_appointment_relation,contact/registeredByFullName,contact/streetAddress/city
