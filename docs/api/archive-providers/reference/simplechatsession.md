...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.SimpleChatSessionsProvider">SuperOffice.CRM.ArchiveLists.SimpleChatSessionsProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SimpleChatSession?$select=person/personAssociateId,person/personAssociate/title,contact/email/emailAddress,contact/contactAssociate/mrMrs,contact/NumberOfNotCompletedTicketsInPeriod
