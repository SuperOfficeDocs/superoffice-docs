...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=type,person/fullName,person/personDeletedDate,person/personAddress/formattedAddress,project/projectUdef/SuperOffice:3
