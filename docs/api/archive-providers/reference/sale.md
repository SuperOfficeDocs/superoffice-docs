...
```http!
GET /api/v1/archive/Sale?$select=currency,person/personAssociate/firstName,person/correspondingAssociate/middleName,person/correspondingAssociate/usergroup,person/isMailingRecipient
