...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/reason,alternative/version/quote/sale/associate/contactDepartment,alternative/version/number
