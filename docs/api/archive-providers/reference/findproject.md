...
```http!
GET /api/v1/archive/FindProject?$select=projectAssociate/isActive,sale/associate/ejDisplayName,sale/saleUdef/SuperOffice:1,appointment/registeredBy,appointment/associate/firstName
