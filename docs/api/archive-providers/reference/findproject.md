...
```http!
GET /api/v1/archive/FindProject?$select=sale/stage,appointment/alarm,appointment/associate/assocName,projectMember/LastCompletedTicket,projectMember/saintActivityType
