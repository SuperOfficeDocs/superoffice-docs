...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=appointment/associate/ejUserId,project/projectAssociate/personId,saleStakeholder/person/personDeletedDate,quote/version/alternative/quoteline/description
