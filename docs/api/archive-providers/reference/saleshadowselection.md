...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=appointment/associate/contactName,document/documentId,project/projectAssociate/personId,project/SaintStatus3,saleStakeholder/person/birthDay
