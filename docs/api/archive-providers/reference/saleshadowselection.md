...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/retired,person/email/emailId,contact/contactAssociate/ejUserId,project/projectAssociate/contactCategory,project/projectUdef/SuperOffice:9
