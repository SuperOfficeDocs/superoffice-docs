...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/lastName,person/portraitThumbnail,contact/streetAddress/wgs84latitude,associate/mrMrs,document/snum
