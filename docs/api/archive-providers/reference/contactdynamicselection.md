...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=streetAddress/wgs84latitude,NumberOfActivitiesInPeriod,LastCompletedActivity,NumberOfTicketsInPeriod,appointment/alarm
