...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=postAddress/wgs84longitude,contactUdef/SuperOffice:13,sale/nextDueDate,sale/salePublish/publishedFrom,personAddress/state
