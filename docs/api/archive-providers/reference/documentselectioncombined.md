...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/restrictionAddress/line1,contact/LastTicket,project/projectUrl/URLAddress,project/projectAssociate/portraitThumbnail,sale/description
