...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=contact/streetAddress/wgs84longitude,contact/contactAssociate/middleName,sale/associateId,sale/amountWeighted
