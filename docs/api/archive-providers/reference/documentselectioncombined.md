...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/restrictionAddress/line2,person/personInterestIds,person/personUdef/SuperOffice:2,person/hasStoreConsent,contact/contactAssociate/fullName
