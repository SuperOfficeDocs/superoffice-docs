...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=associateId,person/email/emailAddress,contact/LastSale,contact/LastDoBySale,project/activeErpLinks
