...
```http!
GET /api/v1/archive/Document?$select=ourref,person/personAssociate/simultaneousEjUser,person/correspondingAssociate/role,contact/department,contact/email/emailLastBounce
