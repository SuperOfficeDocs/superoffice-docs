...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personAssociate/contactDepartment,person/isMailingRecipient,contact/contactExtra/x_contact_longtext,contact/contactExtra/x_contact_datetime,contact/contactExtra/x_contact_shorttext
