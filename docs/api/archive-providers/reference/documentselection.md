...
```http!
GET /api/v1/archive/DocumentSelection?$select=documentId,person/personUrl/URLAddress,contact/hasInterests,contact/restrictionAddress/line1,contact/restrictionAddress/formattedMultiLineAddress
