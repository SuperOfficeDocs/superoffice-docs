...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/middleName,person/searchPhone/description,person/restrictionAddress/line2,person/hasEmarketingConsent,contact/deletedDate
