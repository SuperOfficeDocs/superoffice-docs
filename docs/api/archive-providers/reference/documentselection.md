...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/birthMonth,contact/restrictionAddress/wgs84longitude,contact/contactAssociate/firstName,contact/saintDirection,project/projectAssociate/ejUserId
