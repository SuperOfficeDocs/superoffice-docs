...
```http!
GET /api/v1/archive/SimpleContact?$select=contactNoMail,postAddress/formattedMultiLineAddress,restrictionPostalAddress/city,contactAssociate/usergroup,contactAssociate/personEmail
