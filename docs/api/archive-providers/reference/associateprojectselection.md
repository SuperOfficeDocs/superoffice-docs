...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.AssociateProjectSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.AssociateProjectSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=NumberOfNotCompletedSales,appointment/associate/personId,projectMember/useAsMailingAddress,projectMember/personUdef/SuperOffice:10,projectMember/correspondingAssociate/simultaneousEjUser
