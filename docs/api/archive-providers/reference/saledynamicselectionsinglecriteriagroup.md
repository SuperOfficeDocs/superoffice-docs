...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=source,person/correspondingAssociate/contactDepartment,contact/LastCompletedSale,document/associate/contactFullName,project/name
