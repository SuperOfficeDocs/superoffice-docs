...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=time,person/personCategory,person/personDirectFax/formattedNumber,person/personUdef/SuperOffice:3,contact/contactPhone/description
