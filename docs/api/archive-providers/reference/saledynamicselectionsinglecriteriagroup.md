...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=probPercent,sale/textId,person/hasStoreConsent,contact/url/URLAddress,contact/contactAssociate/contactCategory
