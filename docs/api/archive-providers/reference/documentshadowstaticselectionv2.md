...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personExtra/x_person_shorttext,contact/orgnr,contact/email/emailAddress,contact/contactAssociate/title,associate/lastName
