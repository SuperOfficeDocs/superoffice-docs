...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/legalBaseStore,contact/updatedDate,project/projectPublish/publishedFrom,documentUdef/SuperOffice:5,documentUdef/SuperOffice:8
