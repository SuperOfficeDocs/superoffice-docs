...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=contact/contactUdef/SuperOffice:13,contact/saintAmountClass,contact/contactPhone/description
