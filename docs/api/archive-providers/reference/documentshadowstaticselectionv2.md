...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/retired,person/email/emailLastSent,contact/postAddress/formattedAddress,contact/saintIntention,project/projectPublish/publishedFrom
