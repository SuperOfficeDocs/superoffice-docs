...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/birthMonth,person/personDeletedDate,contact/name,contact/postAddress/formattedAddress,contact/restrictionAddress/zip
