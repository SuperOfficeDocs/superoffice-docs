...
```http!
GET /api/v1/archive/SimpleSale?$select=person/contactId,person/personAddress/state,person/isMailingRecipient,contact/postAddress/wgs84latitude,contact/LastActivity
