...
```http!
GET /api/v1/archive/SimpleSale?$select=contact/orgnr,contact/restrictionAddress/county,project/projectPublish/isPublished,project/projectAssociate/assocType,project/projectUdef/SuperOffice:10
