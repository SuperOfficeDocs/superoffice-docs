...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=contactAssociate/contactDepartment,sourceRelation/contactDeleted,sale/associate/ejUserId,appointment/appointmentPublish/isPublished,appointment/associate/isActive
