...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/firstName,contact/category,contact/contactInterestIds,contact/NumberOfSalesInPeriod
