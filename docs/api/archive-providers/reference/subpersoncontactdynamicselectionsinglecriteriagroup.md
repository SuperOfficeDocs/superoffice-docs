...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=personSourceRelation/supportLanguage,personTargetRelation/lastName,correspondingAssociate/assocType,projectMembers/nextMilestone,personAppointment/associate/credentialType
