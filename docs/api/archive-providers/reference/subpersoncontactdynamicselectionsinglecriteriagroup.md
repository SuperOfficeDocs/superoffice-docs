...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=isProjectMember,updatedDate,personUdef/SuperOffice:4,postAddress/county,contactUdef/SuperOffice:6
