...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=hasCompany,personAssociate/title,personAssociate/contactName,contactAssociate/mrMrs,contactUdef/SuperOffice:6
