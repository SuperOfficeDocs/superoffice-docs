...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=name,restrictionAddress/zip,contactUdef/SuperOffice:13,request/personId,projectMembers/projectUdef/SuperOffice:4
