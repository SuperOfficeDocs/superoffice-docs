...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=personAssociate/usergroup,postAddress/city,url/URLAddress,request/createdBy/fullName,projectMembers/name
