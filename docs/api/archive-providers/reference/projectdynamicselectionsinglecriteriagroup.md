...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=hasInfoText,projectUrl/URLAddress,sale/credited,projectMember/contactId,projectMember/kanaFirstName
