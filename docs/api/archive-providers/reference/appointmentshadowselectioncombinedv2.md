...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=isMilestone,contact/postAddress/line3,contact/restrictionAddress/wgs84latitude,person/middleName,appointmentUdef/SuperOffice:1
