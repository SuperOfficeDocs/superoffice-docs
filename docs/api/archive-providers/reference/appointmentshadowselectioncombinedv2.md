...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=alarm,contact/restrictionAddress/line1,contact/contactAssociate/ejUserId,contact/contactAssociate/otherGroups,contact/contactUdef/SuperOffice:8
