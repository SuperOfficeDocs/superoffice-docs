...
```http!
GET /api/v1/archive/FindDocument?$select=person/correspondingAssociate/mrMrs,person/correspondingAssociate/assocName,contact/contactAssociate/fullName,contact/LastCompletedTicket,project/projectPublish/publishedFrom
