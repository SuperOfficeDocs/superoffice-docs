...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personCategory,contactAssociate/ejStatus,contactUdef/SuperOffice:1,request/author,projectMembers/projectEvent/hasSignOff
