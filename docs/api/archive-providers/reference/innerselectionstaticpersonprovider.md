...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=postAddress/wgs84longitude,contactAssociate/assocTooltip,projectMembers/projectAssociate/usergroup
