...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=contactId,birthYear,personUpdatedByFullName,personPager/description,personEmail/emailLastSent
