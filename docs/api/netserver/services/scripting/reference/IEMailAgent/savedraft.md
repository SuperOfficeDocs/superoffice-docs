---
uid: IEMailAgent-SaveDraft
title: IEMailAgent.SaveDraft event method
description: Scripting events called on the SaveDraft method on the IEMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
