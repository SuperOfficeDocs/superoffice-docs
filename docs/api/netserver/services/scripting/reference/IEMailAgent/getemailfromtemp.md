---
uid: IEMailAgent-GetEMailFromTemp
title: IEMailAgent.GetEMailFromTemp event method
description: Scripting events called on the GetEMailFromTemp method on the IEMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
