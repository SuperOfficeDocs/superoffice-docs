---
uid: IDocumentAgent-GetDocument
title: IDocumentAgent.GetDocument event method
description: Scripting events called on the GetDocument method on the IDocumentAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
