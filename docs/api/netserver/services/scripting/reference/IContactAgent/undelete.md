---
uid: IContactAgent-Undelete
title: IContactAgent.Undelete event method
description: Scripting events called on the Undelete method on the IContactAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
