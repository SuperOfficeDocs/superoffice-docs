---
uid: IContactAgent-GetMyBizCard
title: IContactAgent.GetMyBizCard event method
description: Scripting events called on the GetMyBizCard method on the IContactAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
