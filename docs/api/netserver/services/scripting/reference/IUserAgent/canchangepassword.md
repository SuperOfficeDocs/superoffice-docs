---
uid: IUserAgent-CanChangePassword
title: IUserAgent.CanChangePassword event method
description: Scripting events called on the CanChangePassword method on the IUserAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
