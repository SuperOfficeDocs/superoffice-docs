---
uid: IUserAgent-GetAccessToken
title: IUserAgent.GetAccessToken event method
description: Scripting events called on the GetAccessToken method on the IUserAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
