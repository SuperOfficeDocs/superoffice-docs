---
uid: iblobagent-script-events
title: IBLOBAgent script event methods
...
# IBLOBAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IBLOBAgent'>IBLOBAgent</see> that can trigger server-side event scripts.
