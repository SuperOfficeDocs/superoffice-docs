---
uid: IBLOBAgent-GetQuoteLineImage
title: IBLOBAgent.GetQuoteLineImage event method
description: Scripting events called on the GetQuoteLineImage method on the IBLOBAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
