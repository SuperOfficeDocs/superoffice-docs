---
uid: IProjectAgent-GetDuplicates
title: IProjectAgent.GetDuplicates event method
description: Scripting events called on the GetDuplicates method on the IProjectAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
