---
uid: iaudienceagent-script-events
title: IAudienceAgent script event methods
...
# IAudienceAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IAudienceAgent'>IAudienceAgent</see> that can trigger server-side event scripts.
