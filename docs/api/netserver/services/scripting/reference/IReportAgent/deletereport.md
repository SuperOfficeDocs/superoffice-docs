---
uid: IReportAgent-DeleteReport
title: IReportAgent.DeleteReport event method
description: Scripting events called on the DeleteReport method on the IReportAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
