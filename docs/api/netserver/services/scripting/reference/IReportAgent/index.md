---
uid: ireportagent-script-events
title: IReportAgent script event methods
...
# IReportAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IReportAgent'>IReportAgent</see> that can trigger server-side event scripts.
