---
uid: IPartnerAgent-DeleteWebPanel
title: IPartnerAgent.DeleteWebPanel event method
description: Scripting events called on the DeleteWebPanel method on the IPartnerAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
