---
uid: IQuoteAgent-SaveQuoteLines
title: IQuoteAgent.SaveQuoteLines event method
description: Scripting events called on the SaveQuoteLines method on the IQuoteAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
