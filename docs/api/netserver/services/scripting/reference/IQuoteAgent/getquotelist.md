---
uid: IQuoteAgent-GetQuoteList
title: IQuoteAgent.GetQuoteList event method
description: Scripting events called on the GetQuoteList method on the IQuoteAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
