---
uid: IQuoteAgent-DeleteQuoteLines
title: IQuoteAgent.DeleteQuoteLines event method
description: Scripting events called on the DeleteQuoteLines method on the IQuoteAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
