---
uid: ISaleAgent-GetNextDueDate
title: ISaleAgent.GetNextDueDate event method
description: Scripting events called on the GetNextDueDate method on the ISaleAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
