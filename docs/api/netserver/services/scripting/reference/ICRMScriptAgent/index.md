---
uid: icrmscriptagent-script-events
title: ICRMScriptAgent script event methods
...
# ICRMScriptAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ICRMScriptAgent'>ICRMScriptAgent</see> that can trigger server-side event scripts.
