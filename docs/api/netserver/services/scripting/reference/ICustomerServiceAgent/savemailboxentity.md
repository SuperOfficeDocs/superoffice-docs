---
uid: ICustomerServiceAgent-SaveMailboxEntity
title: ICustomerServiceAgent.SaveMailboxEntity event method
description: Scripting events called on the SaveMailboxEntity method on the ICustomerServiceAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
...
so.envir:
  - "onsite"
---
# ICustomerServiceAgent.SaveMailboxEntity
...
```cs
    static void BeforeSaveMailboxEntity(
...
## AfterSaveMailboxEntity
```cs
    static void AfterSaveMailboxEntity(
       MailboxEntity  mailboxEntity,
