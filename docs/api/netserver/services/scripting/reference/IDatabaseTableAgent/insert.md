---
uid: IDatabaseTableAgent-Insert
title: IDatabaseTableAgent.Insert event method
description: Scripting events called on the Insert method on the IDatabaseTableAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
