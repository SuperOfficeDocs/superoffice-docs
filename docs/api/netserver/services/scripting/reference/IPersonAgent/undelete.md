---
uid: IPersonAgent-Undelete
title: IPersonAgent.Undelete event method
description: Scripting events called on the Undelete method on the IPersonAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
