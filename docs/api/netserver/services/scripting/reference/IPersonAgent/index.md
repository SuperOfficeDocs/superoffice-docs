---
uid: ipersonagent-script-events
title: IPersonAgent script event methods
...
# IPersonAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IPersonAgent'>IPersonAgent</see> that can trigger server-side event scripts.
