---
uid: IMDOAgent-GetListNames
title: IMDOAgent.GetListNames event method
description: Scripting events called on the GetListNames method on the IMDOAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
