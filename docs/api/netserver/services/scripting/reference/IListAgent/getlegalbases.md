---
uid: IListAgent-GetLegalBases
title: IListAgent.GetLegalBases event method
description: Scripting events called on the GetLegalBases method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
