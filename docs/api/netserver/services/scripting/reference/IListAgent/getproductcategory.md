---
uid: IListAgent-GetProductCategory
title: IListAgent.GetProductCategory event method
description: Scripting events called on the GetProductCategory method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
