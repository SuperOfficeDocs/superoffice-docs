---
uid: IListAgent-GetPositionList
title: IListAgent.GetPositionList event method
description: Scripting events called on the GetPositionList method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
