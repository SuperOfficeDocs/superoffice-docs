---
uid: IListAgent-GetMrMrsList
title: IListAgent.GetMrMrsList event method
description: Scripting events called on the GetMrMrsList method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
