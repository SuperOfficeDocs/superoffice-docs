---
uid: IListAgent-GetDepartment
title: IListAgent.GetDepartment event method
description: Scripting events called on the GetDepartment method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
