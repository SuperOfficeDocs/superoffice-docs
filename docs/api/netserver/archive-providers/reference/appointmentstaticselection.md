...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionStaticProvider">SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionStaticProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/streetAddress/addressId,contact/restrictionAddress/addressId,project/NumberOfNotCompletedSalesInPeriod,sale/currency,sale/saleUdef/SuperOffice:4
