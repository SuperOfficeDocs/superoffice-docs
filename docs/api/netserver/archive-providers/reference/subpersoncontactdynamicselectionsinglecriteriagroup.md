...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=firstName,number,postAddress/county,request/createdBy/portraitThumbnail,projectMembers/imageThumbnail
