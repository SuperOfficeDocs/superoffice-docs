...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=contact/contactDeleted,contact/postAddress/zip,contact/streetAddress/formattedMultiLineAddress,contact/saintActivityType,appointment/who
