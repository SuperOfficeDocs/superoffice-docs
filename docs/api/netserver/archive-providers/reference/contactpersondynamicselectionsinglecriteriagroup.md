...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=orgnr,restrictionAddress/line3,contactAssociate/title,contactUdef/SuperOffice:12,NumberOfNotCompletedTickets
