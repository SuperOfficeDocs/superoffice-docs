...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.LinksAppointmentProvider">SuperOffice.CRM.ArchiveLists.LinksAppointmentProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/contactAssociate/contactDepartment,contact/contactAssociate/role,person/personUdef/SuperOffice:3,project/description,project/projectAssociate/title
