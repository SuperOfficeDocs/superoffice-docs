...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.ProjectSelectionCombinedProvider">SuperOffice.CRM.ArchiveLists.Archive.ProjectSelectionCombinedProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=number,projectUrl/URLDescription,appointment/updatedDate,appointment/visibleInDiary,projectMember/saintDirection
