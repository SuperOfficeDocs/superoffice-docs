...
```http!
GET /api/v1/archive/PersonRelation?$select=target/contactAssociate/usergroup,portraitThumbnail,source/contactAssociate/middleName,source/NumberOfNotCompletedActivities
