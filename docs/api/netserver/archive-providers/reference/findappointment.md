...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.FindAppointmentProvider">SuperOffice.CRM.ArchiveLists.FindAppointmentProvider</see> inside NetServer's SODatabase assembly.
