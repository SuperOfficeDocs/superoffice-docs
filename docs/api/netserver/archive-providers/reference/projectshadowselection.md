...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/contactId,projectAssociate/assocTooltip,LastCompletedActivity,sale/earningPercent,appointment/registeredBy
