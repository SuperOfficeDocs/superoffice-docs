...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.ActivityArchiveProvider">SuperOffice.CRM.ArchiveLists.ActivityArchiveProvider</see> inside NetServer's SODatabase assembly.
