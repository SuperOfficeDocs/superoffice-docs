...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionDynamicProvider">SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionDynamicProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=time,person/birthDay,contact/contactPhone/description,associate/isActive,associate/isActiveText
