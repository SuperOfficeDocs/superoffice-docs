...
```http!
GET /api/v1/archive/Favourites?$select=person/personUdef/SuperOffice:1,contact/streetAddress/line2,contact/contactUdef/SuperOffice:11,saleUdef/SuperOffice:4,project/LastSale
