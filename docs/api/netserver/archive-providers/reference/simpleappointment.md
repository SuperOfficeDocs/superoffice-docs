...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.SimpleAppointmentsProvider">SuperOffice.CRM.ArchiveLists.SimpleAppointmentsProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SimpleAppointment?$select=personId,contact/code,contact/streetAddress/formattedMultiLineAddress,contact/LastDoByTicket,contact/saintIntention
