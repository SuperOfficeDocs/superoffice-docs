---
uid: DocumenthadowSelectionCombined
title: DocumenthadowSelectionCombined
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionCombinedProvider">SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionCombinedProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=mailMergeDraft,person/isStakeholder,project/icon,project/projectUdef/SuperOffice:7,sale/type
