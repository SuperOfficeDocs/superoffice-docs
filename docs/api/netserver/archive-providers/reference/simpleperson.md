...
```http!
GET /api/v1/archive/SimplePerson?$select=personContact/contactAssociate/isActive,personContact/NumberOfNotCompletedSales,projectMembers/projectAssociate/fullName,projectMembers/projectAssociate/assocName,personAppointment/userGroup
