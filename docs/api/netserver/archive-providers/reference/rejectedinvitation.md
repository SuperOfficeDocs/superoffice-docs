...
```http!
GET /api/v1/archive/RejectedInvitation?$select=contact/nameDepartment,contact/country,contact/NumberOfTicketsInPeriod,contact/LastTicket,person/personRegisteredBy
