...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectPublish/publishedBy,projectEvent/isExternalEvent,sale/source,sale/salePublish/publishedBy,sale/associate/contactDepartment
