...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.DocumentProvider">SuperOffice.CRM.ArchiveLists.DocumentProvider</see> inside NetServer's SODatabase assembly.

Archive provider for Document type activities. This provider can be used on its own, or can form part of the
