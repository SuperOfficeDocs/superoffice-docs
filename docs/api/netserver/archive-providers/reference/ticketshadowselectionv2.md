...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=personId,createdBy/personEmail,ownedBy/contactCategory,person/supportLanguage,contact/contactAssociate/credentialDisplayValue
