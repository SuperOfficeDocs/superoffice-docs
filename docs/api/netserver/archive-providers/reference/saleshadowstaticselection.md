...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionStaticProvider">SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionStaticProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=amountWeighted,person/personNoMail,person/personAddress/wgs84longitude,person/hasEmarketingConsent,contact/updatedBy
