---
uid: IListAgent-GetAllLegalBase
title: IListAgent.GetAllLegalBase event method
description: Scripting events called on the GetAllLegalBase method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
