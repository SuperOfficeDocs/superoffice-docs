---
uid: IListAgent-SaveListEntity
title: IListAgent.SaveListEntity event method
description: Scripting events called on the SaveListEntity method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
