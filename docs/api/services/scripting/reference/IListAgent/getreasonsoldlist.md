---
uid: IListAgent-GetReasonSoldList
title: IListAgent.GetReasonSoldList event method
description: Scripting events called on the GetReasonSoldList method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
