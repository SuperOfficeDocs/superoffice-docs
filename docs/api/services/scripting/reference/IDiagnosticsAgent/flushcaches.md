---
uid: IDiagnosticsAgent-FlushCaches
title: IDiagnosticsAgent.FlushCaches event method
description: Scripting events called on the FlushCaches method on the IDiagnosticsAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
