---
uid: idiagnosticsagent-script-events
title: IDiagnosticsAgent script event methods
...
# IDiagnosticsAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IDiagnosticsAgent'>IDiagnosticsAgent</see> that can trigger server-side event scripts.
