---
uid: IPersonAgent-GetAddress
title: IPersonAgent.GetAddress event method
description: Scripting events called on the GetAddress method on the IPersonAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
