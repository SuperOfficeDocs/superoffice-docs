---
uid: IQuoteAgent-GetQuoteLines
title: IQuoteAgent.GetQuoteLines event method
description: Scripting events called on the GetQuoteLines method on the IQuoteAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
