---
uid: IContactAgent-GetPersons
title: IContactAgent.GetPersons event method
description: Scripting events called on the GetPersons method on the IContactAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
