---
uid: IBLOBAgent-GetPersonImage
title: IBLOBAgent.GetPersonImage event method
description: Scripting events called on the GetPersonImage method on the IBLOBAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
