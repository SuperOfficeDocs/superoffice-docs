---
uid: ifreetextagent-script-events
title: IFreeTextAgent script event methods
...
# IFreeTextAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IFreeTextAgent'>IFreeTextAgent</see> that can trigger server-side event scripts.
