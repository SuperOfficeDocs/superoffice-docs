---
uid: ISaleAgent-IsNumberValid
title: ISaleAgent.IsNumberValid event method
description: Scripting events called on the IsNumberValid method on the ISaleAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
