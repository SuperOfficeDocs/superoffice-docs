---
uid: IEMailAgent-GetEMailFromId
title: IEMailAgent.GetEMailFromId event method
description: Scripting events called on the GetEMailFromId method on the IEMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
