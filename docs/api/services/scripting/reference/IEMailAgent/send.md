---
uid: IEMailAgent-Send
title: IEMailAgent.Send event method
description: Scripting events called on the Send method on the IEMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
