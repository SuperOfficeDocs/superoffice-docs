---
uid: iselectionagent-script-events
title: ISelectionAgent script event methods
...
# ISelectionAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ISelectionAgent'>ISelectionAgent</see> that can trigger server-side event scripts.
...
* [GetDynamicSelectionCriteriaGroups](getdynamicselectioncriteriagroups.md)
