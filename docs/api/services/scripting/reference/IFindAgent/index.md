---
uid: ifindagent-script-events
title: IFindAgent script event methods
...
# IFindAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IFindAgent'>IFindAgent</see> that can trigger server-side event scripts.
