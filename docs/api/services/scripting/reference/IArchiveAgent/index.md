---
uid: iarchiveagent-script-events
title: IArchiveAgent script event methods
...
# IArchiveAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IArchiveAgent'>IArchiveAgent</see> that can trigger server-side event scripts.
