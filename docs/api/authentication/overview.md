...
In many cases, such as PHP and Python, application depend on loading the WSDL file for interacting with SuperOffice web services. In that case, we make those files available for downloads along in the [SOAP web services API reference][8].
