...
The ID token is encoded as a [JSON Web Token (JWT)][8]. It consists of 3 elements separated by a period:
...
The **Hybrid** flow is a combination of the authorization code and implicit flow. In this flow, the client can request ID tokens, [access tokens][12], or both from the [authorization endpoint][4], along with an authorization code.
...
* The code is used to request access and the [refresh token][13] to get long-lived access to resources.
...
[7]: api.md
[8]: jwt-intro.md
[9]: ../sign-in-userauth-code-flow.md
[10]: ../sign-in-user/implicit-flow.md
[12]: ../sign-in-userhybrid-flow.md
[13]: ../../tokens/access-token.md
[14]: ../../tokens/refresh-token.md
