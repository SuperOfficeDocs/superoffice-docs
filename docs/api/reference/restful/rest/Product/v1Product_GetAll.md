...
GET /api/v1/Product?$entities=ut
GET /api/v1/Product?$top=337
GET /api/v1/Product?$skip=587
GET /api/v1/Product?$mode=Full
GET /api/v1/Product?$options=GrandTotal=true
GET /api/v1/Product?$context=eos
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3543,
      "fullName": "Rodger Gutkowski II"
    },
    {
      "PrimaryKey": 1992,
      "EntityName": "person",
      "personId": 1992,
      "fullName": "Garett Mayer"
    }
  ]
}
```