...
GET /api/v1/Contact/{id}/Activities?$entities=accusantium
GET /api/v1/Contact/{id}/Activities?$top=384
GET /api/v1/Contact/{id}/Activities?$skip=386
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 5143,
      "contactId": 4710,
      "name": "Schiller, Hagenes and Abernathy"
    }
  ]
}
```