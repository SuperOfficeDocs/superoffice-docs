...
GET /api/v1/Contact/{id}/Activities?$entities=quisquam
GET /api/v1/Contact/{id}/Activities?$top=504
GET /api/v1/Contact/{id}/Activities?$skip=560
GET /api/v1/Contact/{id}/Activities?$mode=Full
GET /api/v1/Contact/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Activities?$context=pariatur
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5755,
      "fullName": "Aylin Denesik"
    },
    {
      "PrimaryKey": 1013,
      "EntityName": "person",
      "personId": 1013,
      "fullName": "Ms. Rene Bergnaum I"
    }
  ]
}
```