...
GET /api/v1/ProjectMember?$entities=culpa
GET /api/v1/ProjectMember?$top=875
GET /api/v1/ProjectMember?$skip=716
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7728,
      "fullName": "Mr. Rafael Osinski"
    },
    {
      "PrimaryKey": 1957,
      "EntityName": "person",
      "personId": 1957,
      "fullName": "Kelley Stehr"
    }
  ]
}
```