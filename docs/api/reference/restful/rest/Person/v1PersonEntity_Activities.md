...
GET /api/v1/Person/{id}/Activities?$entities=excepturi
GET /api/v1/Person/{id}/Activities?$top=394
GET /api/v1/Person/{id}/Activities?$skip=473
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 3847,
      "contactId": 6067,
      "name": "Hoppe, Shanahan and Kohler"
    }
  ]
}
```