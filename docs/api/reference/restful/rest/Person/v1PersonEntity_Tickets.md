...
GET /api/v1/Person/{id}/Tickets?$entities=dolorem
GET /api/v1/Person/{id}/Tickets?$top=450
GET /api/v1/Person/{id}/Tickets?$skip=745
GET /api/v1/Person/{id}/Tickets?$mode=Full
GET /api/v1/Person/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Person/{id}/Tickets?$context=modi
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8120,
      "fullName": "Alison Kuhlman"
    },
    {
      "PrimaryKey": 7479,
      "EntityName": "person",
      "personId": 7479,
      "fullName": "Dr. Kirstin Carolyne McCullough MD"
    }
  ]
}
```
