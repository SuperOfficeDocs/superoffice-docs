---
title: Services85.AppointmentAgent.GetProjectMemberAppointments SOAP
generated: 1
uid: Services85-Appointment-GetProjectMemberAppointments
---

# Services85 Appointment GetProjectMemberAppointments

SOAP request and response examples **Remote/Services85/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IAppointmentAgent.GetProjectMemberAppointments">SuperOffice.Services85.IAppointmentAgent.GetProjectMemberAppointments</see> method.
...
## GetProjectMemberAppointments Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetProjectMemberAppointments>
    ...
    <Appointment:EndTime xsi:type="xsd:dateTime">2022-08-26T08:52:08Z</Appointment:EndTime>
...
## GetProjectMemberAppointments Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services85">
 <SOAP-ENV:Body>
  <Appointment:GetProjectMemberAppointmentsResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2022-08-26T08:52:08Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2022-08-26T08:52:08Z</Appointment:RecurringEndDate>
