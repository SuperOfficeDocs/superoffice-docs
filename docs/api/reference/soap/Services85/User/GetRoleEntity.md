---
title: Services85.UserAgent.GetRoleEntity SOAP
generated: 1
uid: Services85-User-GetRoleEntity
---

# Services85 User GetRoleEntity

SOAP request and response examples **Remote/Services85/User.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IUserAgent.GetRoleEntity">SuperOffice.Services85.IUserAgent.GetRoleEntity</see> method.
 ...
 <SOAP-ENV:Body>
  <User:GetRoleEntityResponse>
   <User:Response xsi:type="User:RoleEntity">
    ...
    <User:Created xsi:type="xsd:dateTime">2021-11-30T13:22:44Z</User:Created>
    ...
    <User:Updated xsi:type="xsd:dateTime">2021-11-30T13:22:44Z</User:Updated>
