---
title: Services85.UserAgent.ResolveUserFromInfo SOAP
generated: 1
uid: Services85-User-ResolveUserFromInfo
---

# Services85 User ResolveUserFromInfo

SOAP request and response examples **Remote/Services85/User.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IUserAgent.ResolveUserFromInfo">SuperOffice.Services85.IUserAgent.ResolveUserFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:ResolveUserFromInfo>
    ...
    <User:PhoneNumbers xsi:type="NetServerServices852:ArrayOfstring">
     <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
    </User:PhoneNumbers>
    <User:Emails xsi:type="NetServerServices852:ArrayOfstring">
     <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
    </User:Emails>
