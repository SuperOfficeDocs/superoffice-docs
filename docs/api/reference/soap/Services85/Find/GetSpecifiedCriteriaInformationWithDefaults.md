---
title: Services85.FindAgent.GetSpecifiedCriteriaInformationWithDefaults SOAP
generated: 1
uid: Services85-Find-GetSpecifiedCriteriaInformationWithDefaults
---

# Services85 Find GetSpecifiedCriteriaInformationWithDefaults

SOAP request and response examples **Remote/Services85/Find.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IFindAgent.GetSpecifiedCriteriaInformationWithDefaults">SuperOffice.Services85.IFindAgent.GetSpecifiedCriteriaInformationWithDefaults</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Find:GetSpecifiedCriteriaInformationWithDefaults>
    ...
    <Find:DesiredColumnNames xsi:type="NetServerServices852:ArrayOfstring">
     <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
    </Find:DesiredColumnNames>
    <Find:StaticColumns xsi:type="NetServerServices852:ArrayOfstring">
     <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
    </Find:StaticColumns>
   </Find:GetSpecifiedCriteriaInformationWithDefaults>
