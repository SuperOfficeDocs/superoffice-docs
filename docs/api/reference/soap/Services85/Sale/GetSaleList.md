---
title: Services85.SaleAgent.GetSaleList SOAP
generated: 1
uid: Services85-Sale-GetSaleList
---

# Services85 Sale GetSaleList

SOAP request and response examples **Remote/Services85/Sale.svc**
Implemented by the <see cref="M:SuperOffice.Services85.ISaleAgent.GetSaleList">SuperOffice.Services85.ISaleAgent.GetSaleList</see> method.
  ...
  <Sale:GetSaleListResponse>
   <Sale:Response xsi:type="Sale:ArrayOfSale">
    <Sale:Sale xsi:type="Sale:Sale">
     ...
     <Sale:SaleDate xsi:type="xsd:dateTime">2022-08-26T08:53:45Z</Sale:SaleDate>
     ...
     <Sale:NextDueDate xsi:type="xsd:dateTime">2022-08-26T08:53:45Z</Sale:NextDueDate>
    </Sale:Sale>
   </Sale:Response>
  </Sale:GetSaleListResponse>
 </SOAP-ENV:Body>
