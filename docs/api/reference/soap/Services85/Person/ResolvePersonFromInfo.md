---
title: Services85.PersonAgent.ResolvePersonFromInfo SOAP
generated: 1
uid: Services85-Person-ResolvePersonFromInfo
---

# Services85 Person ResolvePersonFromInfo

SOAP request and response examples **Remote/Services85/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services85.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    ...
    <Person:PhoneNumbers xsi:type="NetServerServices852:ArrayOfstring">
     <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices852:ArrayOfstring">
     <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
  ...
  <Person:ResolvePersonFromInfoResponse>
   <Person:Response xsi:type="Person:ResolvedPerson">
    <Person:Person xsi:type="Person:PersonEntity">
     ...
     <Person:UpdatedDate xsi:type="xsd:dateTime">2022-08-26T08:53:22Z</Person:UpdatedDate>
     <Person:CreatedDate xsi:type="xsd:dateTime">2022-08-26T08:53:22Z</Person:CreatedDate>
     <Person:BirthDate xsi:type="xsd:dateTime">2022-08-26T08:53:22Z</Person:BirthDate>
     ...
     <Person:Interests xsi:type="Person:ArrayOfSelectableMDOListItem">
      <Person:SelectableMDOListItem xsi:type="Person:SelectableMDOListItem">
       ...
       <Person:LastChanged xsi:type="xsd:dateTime">2022-08-26T08:53:22Z</Person:LastChanged>
     ...
     <Person:DbiLastModified xsi:type="xsd:dateTime">2022-08-26T08:53:22Z</Person:DbiLastModified>
     <Person:DbiLastSyncronized xsi:type="xsd:dateTime">2022-08-26T08:53:22Z</Person:DbiLastSyncronized>
     ...
     <Person:UserInfo xsi:type="Person:UserInfo">
      ...
      <Person:GrantedLicenses xsi:type="NetServerServices852:ArrayOfstring">
       <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
