...
Implemented by the <see cref="M:SuperOffice.Services88.INumberAllocationAgent.GetRefCountEntity">SuperOffice.Services88.INumberAllocationAgent.GetRefCountEntity</see> method.
