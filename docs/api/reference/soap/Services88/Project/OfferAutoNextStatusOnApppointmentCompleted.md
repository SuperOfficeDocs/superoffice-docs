...
Implemented by the <see cref="M:SuperOffice.Services88.IProjectAgent.OfferAutoNextStatusOnApppointmentCompleted">SuperOffice.Services88.IProjectAgent.OfferAutoNextStatusOnApppointmentCompleted</see> method.
