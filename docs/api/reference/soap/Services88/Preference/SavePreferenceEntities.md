...
Implemented by the <see cref="M:SuperOffice.Services88.IPreferenceAgent.SavePreferenceEntities">SuperOffice.Services88.IPreferenceAgent.SavePreferenceEntities</see> method.
