...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.DeleteSaleTypeQuoteAttachment">SuperOffice.Services88.IQuoteAgent.DeleteSaleTypeQuoteAttachment</see> method.
