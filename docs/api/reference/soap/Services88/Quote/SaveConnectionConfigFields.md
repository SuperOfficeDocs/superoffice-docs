...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.SaveConnectionConfigFields">SuperOffice.Services88.IQuoteAgent.SaveConnectionConfigFields</see> method.
