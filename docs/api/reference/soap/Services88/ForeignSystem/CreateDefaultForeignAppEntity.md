...
Implemented by the <see cref="M:SuperOffice.Services88.IForeignSystemAgent.CreateDefaultForeignAppEntity">SuperOffice.Services88.IForeignSystemAgent.CreateDefaultForeignAppEntity</see> method.
