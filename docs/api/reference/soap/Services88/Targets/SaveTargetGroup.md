...
Implemented by the <see cref="M:SuperOffice.Services88.ITargetsAgent.SaveTargetGroup">SuperOffice.Services88.ITargetsAgent.SaveTargetGroup</see> method.

## SaveTargetGroup

Updates the existing TargetGroup or creates a new TargetGroup if the id parameter is 0.

* **targetGroup:** The TargetGroup that is saved.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Targets:SaveTargetGroup>
    <Targets:TargetGroup xsi:type="Targets:TargetGroup">
       ...
       <Targets:TargetContact xsi:type="Targets:Contact">
        ...
        <Targets:Address xsi:type="Targets:Address">
         ...
         <Targets:LocalizedAddress xsi:type="Targets:ArrayOfArrayOfLocalizedField">
          <Targets:ArrayOfLocalizedField xsi:nil="true"></Targets:ArrayOfLocalizedField>
         </Targets:LocalizedAddress>
         <Targets:Street xsi:type="Targets:StructuredAddress">
          <Targets:AtypeIdx xsi:nil="true"></Targets:AtypeIdx>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Targets="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Targets:SaveTargetGroupResponse>
