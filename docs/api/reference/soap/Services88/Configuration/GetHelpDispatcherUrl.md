...
Implemented by the <see cref="M:SuperOffice.Services88.IConfigurationAgent.GetHelpDispatcherUrl">SuperOffice.Services88.IConfigurationAgent.GetHelpDispatcherUrl</see> method.
