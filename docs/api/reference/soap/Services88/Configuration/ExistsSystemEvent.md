...
Implemented by the <see cref="M:SuperOffice.Services88.IConfigurationAgent.ExistsSystemEvent">SuperOffice.Services88.IConfigurationAgent.ExistsSystemEvent</see> method.
