...
Implemented by the <see cref="M:SuperOffice.Services88.IArchiveAgent.CreateDefaultArchiveListResult">SuperOffice.Services88.IArchiveAgent.CreateDefaultArchiveListResult</see> method.
