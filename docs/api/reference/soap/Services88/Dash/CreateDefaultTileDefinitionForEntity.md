...
Implemented by the <see cref="M:SuperOffice.Services88.IDashAgent.CreateDefaultTileDefinitionForEntity">SuperOffice.Services88.IDashAgent.CreateDefaultTileDefinitionForEntity</see> method.
...
## CreateDefaultTileDefinitionForEntity Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Dash:CreateDefaultTileDefinitionForEntity>
...
## CreateDefaultTileDefinitionForEntity Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Dash="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Dash:CreateDefaultTileDefinitionForEntityResponse>
