...
# Services88 Appointment GetPersonDiary

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetPersonDiary">SuperOffice.Services88.IAppointmentAgent.GetPersonDiary</see> method.
