...
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.ToggleAppointmentStatus">SuperOffice.Services88.IAppointmentAgent.ToggleAppointmentStatus</see> method.
