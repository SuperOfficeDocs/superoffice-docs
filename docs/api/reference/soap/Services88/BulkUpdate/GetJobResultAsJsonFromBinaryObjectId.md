...
Implemented by the <see cref="M:SuperOffice.Services88.IBulkUpdateAgent.GetJobResultAsJsonFromBinaryObjectId">SuperOffice.Services88.IBulkUpdateAgent.GetJobResultAsJsonFromBinaryObjectId</see> method.
