...
Implemented by the <see cref="M:SuperOffice.Services88.IContactAgent.GetMyRecentContacts">SuperOffice.Services88.IContactAgent.GetMyRecentContacts</see> method.
