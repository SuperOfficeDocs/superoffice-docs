...
Implemented by the <see cref="M:SuperOffice.Services88.IDocumentAgent.GetDocumentStream">SuperOffice.Services88.IDocumentAgent.GetDocumentStream</see> method.
