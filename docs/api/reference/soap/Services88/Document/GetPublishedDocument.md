...
Implemented by the <see cref="M:SuperOffice.Services88.IDocumentAgent.GetPublishedDocument">SuperOffice.Services88.IDocumentAgent.GetPublishedDocument</see> method.
