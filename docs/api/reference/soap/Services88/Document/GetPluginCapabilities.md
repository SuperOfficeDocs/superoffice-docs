...
Implemented by the <see cref="M:SuperOffice.Services88.IDocumentAgent.GetPluginCapabilities">SuperOffice.Services88.IDocumentAgent.GetPluginCapabilities</see> method.
