---
title: Services88.TicketAgent.SaveTicketMessageEntityWithNotify SOAP
generated: 1
uid: Services88-Ticket-SaveTicketMessageEntityWithNotify
---

# Services88 Ticket SaveTicketMessageEntityWithNotify

SOAP request and response examples **Remote/Services88/Ticket.svc**
Implemented by the <see cref="M:SuperOffice.Services88.ITicketAgent.SaveTicketMessageEntityWithNotify">SuperOffice.Services88.ITicketAgent.SaveTicketMessageEntityWithNotify</see> method.

## SaveTicketMessageEntityWithNotify

Saves a ticket message and performs any user notifications

* **newEntity:** The ticket message to save
* **notify:** If true, then the notification will be sent along with the save
...
## SaveTicketMessageEntityWithNotify Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Ticket:SaveTicketMessageEntityWithNotify>
    <Ticket:NewEntity xsi:type="Ticket:TicketMessageEntity">
    ...
    <Ticket:Notify xsi:type="xsd:boolean">false</Ticket:Notify>
   </Ticket:SaveTicketMessageEntityWithNotify>
...
## SaveTicketMessageEntityWithNotify Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Ticket="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Ticket:SaveTicketMessageEntityWithNotifyResponse>
