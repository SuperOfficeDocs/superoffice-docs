---
title: Services88.ChatAgent.SaveChatTopicEntity SOAP
generated: 1
uid: Services88-Chat-SaveChatTopicEntity
---

# Services88 Chat SaveChatTopicEntity

SOAP request and response examples **Remote/Services88/Chat.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IChatAgent.SaveChatTopicEntity">SuperOffice.Services88.IChatAgent.SaveChatTopicEntity</see> method.

## SaveChatTopicEntity

Updates the existing ChatTopicEntity or creates a new ChatTopicEntity if the id parameter is 0.

* **chatTopicEntity:** The ChatTopicEntity that is saved.
