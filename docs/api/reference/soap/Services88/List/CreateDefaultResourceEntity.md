...
Implemented by the <see cref="M:SuperOffice.Services88.IListAgent.CreateDefaultResourceEntity">SuperOffice.Services88.IListAgent.CreateDefaultResourceEntity</see> method.
