...
Implemented by the <see cref="M:SuperOffice.Services88.IListAgent.GetDocumentTemplateEntity">SuperOffice.Services88.IListAgent.GetDocumentTemplateEntity</see> method.
