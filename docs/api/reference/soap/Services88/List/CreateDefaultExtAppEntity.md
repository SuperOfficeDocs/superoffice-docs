...
Implemented by the <see cref="M:SuperOffice.Services88.IListAgent.CreateDefaultExtAppEntity">SuperOffice.Services88.IListAgent.CreateDefaultExtAppEntity</see> method.
