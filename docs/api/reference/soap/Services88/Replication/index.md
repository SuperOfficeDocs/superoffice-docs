...
SOAP request and response examples, and WSDL files for **Remote/Services88/Replication.svc**

Handled by the <see cref="T:SuperOffice.Services88.IReplicationAgent">SuperOffice.Services88.IReplicationAgent</see> interface.
...
Download [WSDL file for Services88/Replication](../Services88-Replication.md) if you need to generate your own proxy code.
