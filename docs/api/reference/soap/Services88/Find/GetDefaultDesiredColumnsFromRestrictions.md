...
Implemented by the <see cref="M:SuperOffice.Services88.IFindAgent.GetDefaultDesiredColumnsFromRestrictions">SuperOffice.Services88.IFindAgent.GetDefaultDesiredColumnsFromRestrictions</see> method.
