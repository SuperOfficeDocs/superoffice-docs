...
SOAP request and response examples, and WSDL files for **Remote/Services84/ForeignSystem.svc**

Handled by the <see cref="T:SuperOffice.Services84.IForeignSystemAgent">SuperOffice.Services84.IForeignSystemAgent</see> interface.

Interface for the ForeignSystem Agent
Collection of all services that works with Foreign key data (Key/Value pairs)

Download [WSDL file for Services84/ForeignSystem](../Services84-ForeignSystem.md) if you need to generate your own proxy code.
