---
title: Services86.PersonAgent.ResolvePersonFromInfo SOAP
generated: 1
uid: Services86-Person-ResolvePersonFromInfo
---

# Services86 Person ResolvePersonFromInfo

SOAP request and response examples **Remote/Services86/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services86.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    ...
    <Person:PhoneNumbers xsi:type="NetServerServices862:ArrayOfstring">
     <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices862:ArrayOfstring">
     <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
  ...
  <Person:ResolvePersonFromInfoResponse>
   <Person:Response xsi:type="Person:ResolvedPerson">
    <Person:Person xsi:type="Person:PersonEntity">
     ...
     <Person:UpdatedDate xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:UpdatedDate>
     <Person:CreatedDate xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:CreatedDate>
     <Person:BirthDate xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:BirthDate>
     ...
     <Person:Interests xsi:type="Person:ArrayOfSelectableMDOListItem">
      <Person:SelectableMDOListItem xsi:type="Person:SelectableMDOListItem">
       ...
       <Person:LastChanged xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:LastChanged>
     ...
     <Person:DbiLastModified xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:DbiLastModified>
     <Person:DbiLastSyncronized xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:DbiLastSyncronized>
     ...
     <Person:UserInfo xsi:type="Person:UserInfo">
      ...
      <Person:GrantedLicenses xsi:type="NetServerServices862:ArrayOfstring">
       <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
     ...
     <Person:Consents xsi:type="Person:ArrayOfConsentInfo">
      <Person:ConsentInfo xsi:type="Person:ConsentInfo">
       ...
       <Person:Registered xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:Registered>
       <Person:RegisteredAssociateId xsi:type="xsd:int">0</Person:RegisteredAssociateId>
       <Person:Updated xsi:type="xsd:dateTime">2022-08-26T08:55:27Z</Person:Updated>
