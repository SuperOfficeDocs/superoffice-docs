---
title: Services86.ConfigurationAgent.GetDiaryViewEntity SOAP
generated: 1
uid: Services86-Configuration-GetDiaryViewEntity
---

# Services86 Configuration GetDiaryViewEntity

SOAP request and response examples **Remote/Services86/Configuration.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IConfigurationAgent.GetDiaryViewEntity">SuperOffice.Services86.IConfigurationAgent.GetDiaryViewEntity</see> method.
   ...
   <Configuration:Response xsi:type="Configuration:DiaryViewEntity">
    ...
    <Configuration:AssociateList xsi:type="Configuration:ArrayOfSelectableMDOListItem">
     <Configuration:SelectableMDOListItem xsi:type="Configuration:SelectableMDOListItem">
      ...
      <Configuration:LastChanged xsi:type="xsd:dateTime">2022-08-26T08:54:30Z</Configuration:LastChanged>
