---
title: Services86.AppointmentAgent.GetMySyncAppointments SOAP
generated: 1
uid: Services86-Appointment-GetMySyncAppointments
---

# Services86 Appointment GetMySyncAppointments

SOAP request and response examples **Remote/Services86/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IAppointmentAgent.GetMySyncAppointments">SuperOffice.Services86.IAppointmentAgent.GetMySyncAppointments</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetMySyncAppointments>
    <Appointment:StartTime xsi:type="xsd:dateTime">2022-08-26T08:54:03Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2022-08-26T08:54:03Z</Appointment:EndTime>
   </Appointment:GetMySyncAppointments>
  ...
  <Appointment:GetMySyncAppointmentsResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointmentSyncData">
    <Appointment:AppointmentSyncData xsi:type="Appointment:AppointmentSyncData">
     <Appointment:AlarmTime xsi:type="xsd:dateTime">2022-08-26T08:54:03Z</Appointment:AlarmTime>
     ...
     <Appointment:EndDate xsi:type="xsd:dateTime">2022-08-26T08:54:03Z</Appointment:EndDate>
     ...
     <Appointment:Participants xsi:type="Appointment:ArrayOfParticipantSyncData">
      <Appointment:ParticipantSyncData xsi:type="Appointment:ParticipantSyncData">
       ...
       <Appointment:ContactFullName xsi:type="xsd:string"></Appointment:ContactFullName>
       <Appointment:EMail xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:EMail>
       <Appointment:PhonePrivate xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:PhonePrivate>
       <Appointment:PhoneFax xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:PhoneFax>
       <Appointment:PhoneMobile xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:PhoneMobile>
       <Appointment:PhoneDirect xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:PhoneDirect>
       <Appointment:PhoneContact xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:PhoneContact>
       <Appointment:Messenger xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:Messenger>
       <Appointment:Voip xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:Voip>
       <Appointment:ContactUrl xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:ContactUrl>
       <Appointment:Url xsi:type="NetServerServices862:ArrayOfstring">
        <NetServerServices862:string xsi:type="xsd:string"></NetServerServices862:string>
       </Appointment:Url>
     ...
     <Appointment:StartDate xsi:type="xsd:dateTime">2022-08-26T08:54:03Z</Appointment:StartDate>
