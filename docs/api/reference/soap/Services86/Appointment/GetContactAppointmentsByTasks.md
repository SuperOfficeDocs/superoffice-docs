---
title: Services86.AppointmentAgent.GetContactAppointmentsByTasks SOAP
generated: 1
uid: Services86-Appointment-GetContactAppointmentsByTasks
---

# Services86 Appointment GetContactAppointmentsByTasks

SOAP request and response examples **Remote/Services86/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IAppointmentAgent.GetContactAppointmentsByTasks">SuperOffice.Services86.IAppointmentAgent.GetContactAppointmentsByTasks</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetContactAppointmentsByTasks>
    ...
    <Appointment:EndTime xsi:type="xsd:dateTime">2021-11-30T13:22:46Z</Appointment:EndTime>
    <Appointment:Count xsi:type="xsd:int">0</Appointment:Count>
    <Appointment:TaskIds xsi:type="NetServerServices862:ArrayOfint">
  ...
  <Appointment:GetContactAppointmentsByTasksResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2021-11-30T13:22:46Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2021-11-30T13:22:46Z</Appointment:RecurringEndDate>
