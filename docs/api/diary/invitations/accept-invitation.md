---
# Mandatory fields.
title: accept_invitation       # (Required) Very important for SEO.
description: How to accept an invitation  # (Required) Important for SEO.
...
[!code-csharp[CS](includes/accept-invite.cs)]
