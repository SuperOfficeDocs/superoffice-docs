...
GET /api/v1/Person/{id}/Documents?$entities=sunt
GET /api/v1/Person/{id}/Documents?$top=420
GET /api/v1/Person/{id}/Documents?$skip=598
GET /api/v1/Person/{id}/Documents?$mode=Full
GET /api/v1/Person/{id}/Documents?$options=GrandTotal=true
GET /api/v1/Person/{id}/Documents?$context=quos
