...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=nisi
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=modi
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=animi
```
