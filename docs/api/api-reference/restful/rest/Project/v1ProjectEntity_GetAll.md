...
* Project?$filter=col1 eq 'foo' and startswith(col2, 'baz')
* Project?$orderby=abc/col3,col1
* Project?$top=1000
* Project?$mode=full
...
GET /api/v1/Project?$entities=aliquid
GET /api/v1/Project?$top=145
GET /api/v1/Project?$skip=6
GET /api/v1/Project?$mode=Full
GET /api/v1/Project?$options=GrandTotal=true
GET /api/v1/Project?$context=totam
