...
GET /api/v1/Project/{id}/Activities?$entities=asperiores
GET /api/v1/Project/{id}/Activities?$top=844
GET /api/v1/Project/{id}/Activities?$skip=267
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=voluptatibus
