...
id: v1ProductFamilyList_PutProductFamily
---
...
Updates an existing ProductFamily list item.
...
|-----------|------|-------------|
| id | int32 | The id of ProductFamily to be saved. **Required** |
...
The details of ProductFamily list item to be saved. 
