...
OData list of all SaleEntity.

Can be sorted and further filtered using OData conventions:

* Sale?$select=col1,col2,abc/col3
* Sale?$filter=col1 eq 'foo' and startswith(col2, 'baz')
* Sale?$orderby=abc/col3,col1
* Sale?$top=1000
* Sale?$mode=full
...
Calls the Archive service using the "FindSale" archive.
...
GET /api/v1/Sale?$entities=veniam
GET /api/v1/Sale?$top=356
GET /api/v1/Sale?$skip=231
GET /api/v1/Sale?$mode=Full
GET /api/v1/Sale?$options=GrandTotal=true
GET /api/v1/Sale?$context=deserunt
  ...
  "value": [
    {
      ...
      "saleId": 8443,
      "contactId": 1095,
      "name": "Weissnat, McKenzie and Mante"
    },
    {
      "PrimaryKey": 7998,
      "EntityName": "sale",
      "saleId": 7998,
      "contactId": 316,
      "name": "Konopelski, Kovacek and Jaskolski"
    }
  ]
}
```