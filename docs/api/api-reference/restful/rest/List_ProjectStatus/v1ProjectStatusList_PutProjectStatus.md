...
id: v1ProjectStatusList_PutProjectStatus
---
...
Updates an existing ProjectStatus list item.
...
|-----------|------|-------------|
| id | int32 | The id of ProjectStatus to be saved. **Required** |
...
The details of ProjectStatus list item to be saved. 
