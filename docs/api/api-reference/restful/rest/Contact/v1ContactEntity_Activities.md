...
GET /api/v1/Contact/{id}/Activities?$entities=consectetur
GET /api/v1/Contact/{id}/Activities?$top=888
GET /api/v1/Contact/{id}/Activities?$skip=805
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2000,
      "fullName": "Thaddeus Wolf"
    },
    {
      "PrimaryKey": 5329,
      "EntityName": "person",
      "personId": 5329,
      "fullName": "Neva Reichert"
    }
  ]
}
```