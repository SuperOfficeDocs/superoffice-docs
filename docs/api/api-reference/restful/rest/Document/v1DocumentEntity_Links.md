...
OData list of Links under a specific DocumentEntity.

Can be sorted and further filtered using OData conventions:

* Document/1234/Links?$select=col1,col2,abc/col3
* Document/1234/Links?$filter=col1 eq 'foo' and startswith(col2, 'baz')
* Document/1234/Links?$orderby=abc/col3,col1
* Document/1234/Links?$top=1000
* Document/1234/Links?$mode=full
...
GET /api/v1/Document/{id}/Links?$entities=adipisci
GET /api/v1/Document/{id}/Links?$top=196
GET /api/v1/Document/{id}/Links?$skip=971
GET /api/v1/Document/{id}/Links?$mode=Full
GET /api/v1/Document/{id}/Links?$options=GrandTotal=true
GET /api/v1/Document/{id}/Links?$context=impedit
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9702,
      "fullName": "Mr. Krystal Hahn"
    },
    {
      "PrimaryKey": 7413,
      "EntityName": "person",
      "personId": 7413,
      "fullName": "Mrs. Unique Mann"
    }
  ]
}
```