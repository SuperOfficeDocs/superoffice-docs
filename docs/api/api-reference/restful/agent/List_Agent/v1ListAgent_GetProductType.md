...
```http
POST /api/v1/Agents/List/GetProductType?productTypeId=918
...
Services for the ProductType Carrier is available from the <see cref="T:SuperOffice.CRM.Services.IListAgent">List Agent</see>.
