...
|----------------|------|--------------|
| paymentTermId | int32 | **Required** The primary key. |
...
Services for the PaymentTerm Carrier is available from the <see cref="T:SuperOffice.CRM.Services.IListAgent">List Agent</see>.
