---
uid: services80-archive
title: Services80.ArchiveAgent SOAP
Generated: true
---

# Services80 Archive SOAP

SOAP request and response examples, and WSDL files for **Remote/Services80/Archive.svc**

Handled by the <see cref="T:SuperOffice.Services80.IArchiveAgent">SuperOffice.Services80.IArchiveAgent</see> interface.

Interface for the Archive Agent

Download [WSDL file for Services80/Archive](../Services80-Archive.md) if you need to generate your own proxy code.
