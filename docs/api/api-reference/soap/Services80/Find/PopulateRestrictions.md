---
uid: services80-find-populaterestrictions
title: Services80.FindAgent.PopulateRestrictions SOAP
Generated: true
---

# Services80 Find PopulateRestrictions SOAP

SOAP request and response examples **Remote/Services80/Find.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IFindAgent.PopulateRestrictions">SuperOffice.Services80.IFindAgent.PopulateRestrictions</see> method.
      ...
      <Find:ArchiveRestrictionInfo xsi:type="Find:ArchiveRestrictionInfo">
       ...
       <Find:SubRestrictions xsi:type="Find:ArrayOfArchiveRestrictionInfo">
        <Find:ArchiveRestrictionInfo xsi:type="Find:ArchiveRestrictionInfo">
         ...
         <Find:Operator xsi:type="xsd:string"></Find:Operator>
         <Find:Values xsi:type="NetServerServices802:ArrayOfstring">
          <NetServerServices802:string xsi:nil="true"></NetServerServices802:string>
         </Find:Values>
         <Find:DisplayValues xsi:type="NetServerServices802:ArrayOfstring">
          <NetServerServices802:string xsi:nil="true"></NetServerServices802:string>
         </Find:DisplayValues>
