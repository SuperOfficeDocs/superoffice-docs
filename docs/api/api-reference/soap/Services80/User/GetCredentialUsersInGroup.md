---
uid: services80-user-getcredentialusersingroup
title: Services80.UserAgent.GetCredentialUsersInGroup SOAP
Generated: true
---

# Services80 User GetCredentialUsersInGroup SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetCredentialUsersInGroup">SuperOffice.Services80.IUserAgent.GetCredentialUsersInGroup</see> method.
