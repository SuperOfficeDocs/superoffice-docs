---
uid: services80-user-getuserfromejuserid
title: Services80.UserAgent.GetUserFromEjUserId SOAP
Generated: true
---

# Services80 User GetUserFromEjUserId SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetUserFromEjUserId">SuperOffice.Services80.IUserAgent.GetUserFromEjUserId</see> method.
