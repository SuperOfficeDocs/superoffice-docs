---
uid: services80-user-changeownpassword
title: Services80.UserAgent.ChangeOwnPassword SOAP
Generated: true
---

# Services80 User ChangeOwnPassword SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.ChangeOwnPassword">SuperOffice.Services80.IUserAgent.ChangeOwnPassword</see> method.
