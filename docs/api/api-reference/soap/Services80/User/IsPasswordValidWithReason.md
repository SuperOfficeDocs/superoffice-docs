---
uid: services80-user-ispasswordvalidwithreason
title: Services80.UserAgent.IsPasswordValidWithReason SOAP
Generated: true
---

# Services80 User IsPasswordValidWithReason SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.IsPasswordValidWithReason">SuperOffice.Services80.IUserAgent.IsPasswordValidWithReason</see> method.
