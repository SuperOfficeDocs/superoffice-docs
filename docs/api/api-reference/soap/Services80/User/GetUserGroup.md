---
uid: services80-user-getusergroup
title: Services80.UserAgent.GetUserGroup SOAP
Generated: true
---

# Services80 User GetUserGroup SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetUserGroup">SuperOffice.Services80.IUserAgent.GetUserGroup</see> method.
