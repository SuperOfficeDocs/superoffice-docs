---
uid: services80-user
title: Services80.UserAgent SOAP
Generated: true
---

# Services80 User SOAP

SOAP request and response examples, and WSDL files for **Remote/Services80/User.svc**

Handled by the <see cref="T:SuperOffice.Services80.IUserAgent">SuperOffice.Services80.IUserAgent</see> interface.

Interface for the User Agent

Download [WSDL file for Services80/User](../Services80-User.md) if you need to generate your own proxy code.
