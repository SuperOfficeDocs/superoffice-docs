---
uid: services80-user-getallusergroups
title: Services80.UserAgent.GetAllUserGroups SOAP
Generated: true
---

# Services80 User GetAllUserGroups SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetAllUserGroups">SuperOffice.Services80.IUserAgent.GetAllUserGroups</see> method.
