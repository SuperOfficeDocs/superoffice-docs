---
uid: services80-user-getroleentity
title: Services80.UserAgent.GetRoleEntity SOAP
Generated: true
---

# Services80 User GetRoleEntity SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetRoleEntity">SuperOffice.Services80.IUserAgent.GetRoleEntity</see> method.
