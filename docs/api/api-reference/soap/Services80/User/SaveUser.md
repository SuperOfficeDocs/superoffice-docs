---
uid: services80-user-saveuser
title: Services80.UserAgent.SaveUser SOAP
Generated: true
---

# Services80 User SaveUser SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.SaveUser">SuperOffice.Services80.IUserAgent.SaveUser</see> method.
