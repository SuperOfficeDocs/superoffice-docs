---
uid: services80-user-createdefaultuser
title: Services80.UserAgent.CreateDefaultUser SOAP
Generated: true
---

# Services80 User CreateDefaultUser SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.CreateDefaultUser">SuperOffice.Services80.IUserAgent.CreateDefaultUser</see> method.
