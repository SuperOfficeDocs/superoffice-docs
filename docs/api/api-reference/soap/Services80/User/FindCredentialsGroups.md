---
uid: services80-user-findcredentialsgroups
title: Services80.UserAgent.FindCredentialsGroups SOAP
Generated: true
---

# Services80 User FindCredentialsGroups SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.FindCredentialsGroups">SuperOffice.Services80.IUserAgent.FindCredentialsGroups</see> method.
