---
uid: services80-user-getrole
title: Services80.UserAgent.GetRole SOAP
Generated: true
---

# Services80 User GetRole SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetRole">SuperOffice.Services80.IUserAgent.GetRole</see> method.
