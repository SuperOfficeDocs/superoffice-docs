---
uid: services80-user-getuserfrompersonid
title: Services80.UserAgent.GetUserFromPersonId SOAP
Generated: true
---

# Services80 User GetUserFromPersonId SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetUserFromPersonId">SuperOffice.Services80.IUserAgent.GetUserFromPersonId</see> method.
