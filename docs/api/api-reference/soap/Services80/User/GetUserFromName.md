---
uid: services80-user-getuserfromname
title: Services80.UserAgent.GetUserFromName SOAP
Generated: true
---

# Services80 User GetUserFromName SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.GetUserFromName">SuperOffice.Services80.IUserAgent.GetUserFromName</see> method.
