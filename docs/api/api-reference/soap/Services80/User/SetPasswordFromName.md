---
uid: services80-user-setpasswordfromname
title: Services80.UserAgent.SetPasswordFromName SOAP
Generated: true
---

# Services80 User SetPasswordFromName SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.SetPasswordFromName">SuperOffice.Services80.IUserAgent.SetPasswordFromName</see> method.
