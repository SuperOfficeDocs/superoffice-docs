---
uid: services80-user-changepasswordfromname
title: Services80.UserAgent.ChangePasswordFromName SOAP
Generated: true
---

# Services80 User ChangePasswordFromName SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.ChangePasswordFromName">SuperOffice.Services80.IUserAgent.ChangePasswordFromName</see> method.
