---
uid: services80-user-savecredential
title: Services80.UserAgent.SaveCredential SOAP
Generated: true
---

# Services80 User SaveCredential SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.SaveCredential">SuperOffice.Services80.IUserAgent.SaveCredential</see> method.
