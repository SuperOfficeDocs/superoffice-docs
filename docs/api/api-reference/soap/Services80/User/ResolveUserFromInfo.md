---
uid: services80-user-resolveuserfrominfo
title: Services80.UserAgent.ResolveUserFromInfo SOAP
Generated: true
---

# Services80 User ResolveUserFromInfo SOAP

SOAP request and response examples **Remote/Services80/User.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IUserAgent.ResolveUserFromInfo">SuperOffice.Services80.IUserAgent.ResolveUserFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:ResolveUserFromInfo>
    ...
    <User:PhoneNumbers xsi:type="NetServerServices802:ArrayOfstring">
     <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
    </User:PhoneNumbers>
    <User:Emails xsi:type="NetServerServices802:ArrayOfstring">
     <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
    </User:Emails>
