---
uid: services80-erpsync
title: Services80.ErpSyncAgent SOAP
Generated: true
---

# Services80 ErpSync SOAP

SOAP request and response examples, and WSDL files for **Remote/Services80/ErpSync.svc**

Handled by the <see cref="T:SuperOffice.Services80.IErpSyncAgent">SuperOffice.Services80.IErpSyncAgent</see> interface.

Interface for the ErpSync Agent
Services for the ERP Integration Services feature

Download [WSDL file for Services80/ErpSync](../Services80-ErpSync.md) if you need to generate your own proxy code.
