---
uid: services80-replication-getarealist
title: Services80.ReplicationAgent.GetAreaList SOAP
Generated: true
---

# Services80 Replication GetAreaList SOAP

SOAP request and response examples **Remote/Services80/Replication.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IReplicationAgent.GetAreaList">SuperOffice.Services80.IReplicationAgent.GetAreaList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Replication:GetAreaList>
    <Replication:AreaIds xsi:type="NetServerServices802:ArrayOfint">
