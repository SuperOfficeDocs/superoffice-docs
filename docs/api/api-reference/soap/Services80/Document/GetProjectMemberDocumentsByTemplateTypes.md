---
uid: services80-document-getprojectmemberdocumentsbytemplatetypes
title: Services80.DocumentAgent.GetProjectMemberDocumentsByTemplateTypes SOAP
Generated: true
---

# Services80 Document GetProjectMemberDocumentsByTemplateTypes SOAP

SOAP request and response examples **Remote/Services80/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IDocumentAgent.GetProjectMemberDocumentsByTemplateTypes">SuperOffice.Services80.IDocumentAgent.GetProjectMemberDocumentsByTemplateTypes</see> method.
