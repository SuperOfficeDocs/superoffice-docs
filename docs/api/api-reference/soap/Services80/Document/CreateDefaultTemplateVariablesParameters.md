---
uid: services80-document-createdefaulttemplatevariablesparameters
title: Services80.DocumentAgent.CreateDefaultTemplateVariablesParameters SOAP
Generated: true
---

# Services80 Document CreateDefaultTemplateVariablesParameters SOAP

SOAP request and response examples **Remote/Services80/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IDocumentAgent.CreateDefaultTemplateVariablesParameters">SuperOffice.Services80.IDocumentAgent.CreateDefaultTemplateVariablesParameters</see> method.
...
## CreateDefaultTemplateVariablesParameters Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:CreateDefaultTemplateVariablesParameters>
   </Document:CreateDefaultTemplateVariablesParameters>
...
## CreateDefaultTemplateVariablesParameters Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Document="http://www.superoffice.net/ws/crm/NetServer/Services80">
 <SOAP-ENV:Body>
  <Document:CreateDefaultTemplateVariablesParametersResponse>
   <Document:Response xsi:type="Document:TemplateVariablesParameters">
    ...
    <Document:CustomTags xsi:type="NetServerServices802:ArrayOfArrayOfstring">
     <NetServerServices802:ArrayOfstring xsi:type="NetServerServices802:ArrayOfstring">
      <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
     </NetServerServices802:ArrayOfstring>
    </Document:CustomTags>
    <Document:DocumentEntity xsi:type="Document:DocumentEntity">
     ...
     <Document:CreatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:CreatedDate>
     <Document:UpdatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:UpdatedDate>
     ...
     <Document:Project xsi:type="Document:Project">
      ...
      <Document:Updated xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:Updated>
      ...
      <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:PublishTo>
      <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:PublishFrom>
     ...
     <Document:Date xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:Date>
     ...
     <Document:Sale xsi:type="Document:Sale">
      <Document:ContactName xsi:type="xsd:string"></Document:ContactName>
      <Document:SaleDate xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:SaleDate>
      <Document:SaleId xsi:type="xsd:int">0</Document:SaleId>
      ...
      <Document:Completed xsi:type="Document:ActivityStatus">Unknown</Document:Completed>
      <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
      <Document:NextDueDate xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:NextDueDate>
     </Document:Sale>
     ...
     <Document:PublishEventDate xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:PublishEventDate>
     <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:PublishTo>
     <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:PublishFrom>
     <Document:IsPublished xsi:type="xsd:boolean">false</Document:IsPublished>
