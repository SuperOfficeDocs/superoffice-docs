---
uid: services80-document-getprojectmemberdocumentsbytemplateheading
title: Services80.DocumentAgent.GetProjectMemberDocumentsByTemplateHeading SOAP
Generated: true
---

# Services80 Document GetProjectMemberDocumentsByTemplateHeading SOAP

SOAP request and response examples **Remote/Services80/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading">SuperOffice.Services80.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading</see> method.
