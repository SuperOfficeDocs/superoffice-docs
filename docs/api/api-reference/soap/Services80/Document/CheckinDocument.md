---
uid: services80-document-checkindocument
title: Services80.DocumentAgent.CheckinDocument SOAP
Generated: true
---

# Services80 Document CheckinDocument SOAP

SOAP request and response examples **Remote/Services80/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IDocumentAgent.CheckinDocument">SuperOffice.Services80.IDocumentAgent.CheckinDocument</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:CheckinDocument>
    ...
    <Document:VersionExtraFields xsi:type="NetServerServices802:ArrayOfstring">
     <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
