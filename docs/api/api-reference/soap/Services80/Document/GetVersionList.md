---
uid: services80-document-getversionlist
title: Services80.DocumentAgent.GetVersionList SOAP
Generated: true
---

# Services80 Document GetVersionList SOAP

SOAP request and response examples **Remote/Services80/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IDocumentAgent.GetVersionList">SuperOffice.Services80.IDocumentAgent.GetVersionList</see> method.
  ...
  <Document:GetVersionListResponse>
   <Document:Response xsi:type="Document:ArrayOfVersionInfo">
    <Document:VersionInfo xsi:type="Document:VersionInfo">
     ...
     <Document:CheckedInDate xsi:type="xsd:dateTime">2021-03-25T21:34:08Z</Document:CheckedInDate>
     ...
     <Document:ExtraFields xsi:type="NetServerServices802:ArrayOfstring">
