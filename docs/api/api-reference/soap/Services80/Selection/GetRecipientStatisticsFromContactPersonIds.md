---
uid: services80-selection-getrecipientstatisticsfromcontactpersonids
title: Services80.SelectionAgent.GetRecipientStatisticsFromContactPersonIds SOAP
Generated: true
---

# Services80 Selection GetRecipientStatisticsFromContactPersonIds SOAP

SOAP request and response examples **Remote/Services80/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services80.ISelectionAgent.GetRecipientStatisticsFromContactPersonIds">SuperOffice.Services80.ISelectionAgent.GetRecipientStatisticsFromContactPersonIds</see> method.
