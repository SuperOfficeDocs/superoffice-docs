---
uid: services80-selection-editcontactselectionmemberdetails
title: Services80.SelectionAgent.EditContactSelectionMemberDetails SOAP
Generated: true
---

# Services80 Selection EditContactSelectionMemberDetails SOAP

SOAP request and response examples **Remote/Services80/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services80.ISelectionAgent.EditContactSelectionMemberDetails">SuperOffice.Services80.ISelectionAgent.EditContactSelectionMemberDetails</see> method.
...
* **selectionMemberEditValues:** An object of <see cref="T:SuperOffice.Services80.SelectionMemberEditValues" /> describing what should be changed for companys and contacts.
