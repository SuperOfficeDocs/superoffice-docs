---
uid: services80-selection-getrecipientstatisticsfromprojectmembers
title: Services80.SelectionAgent.GetRecipientStatisticsFromProjectMembers SOAP
Generated: true
---

# Services80 Selection GetRecipientStatisticsFromProjectMembers SOAP

SOAP request and response examples **Remote/Services80/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services80.ISelectionAgent.GetRecipientStatisticsFromProjectMembers">SuperOffice.Services80.ISelectionAgent.GetRecipientStatisticsFromProjectMembers</see> method.
