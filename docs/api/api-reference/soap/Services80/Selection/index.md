---
uid: services80-selection
title: Services80.SelectionAgent SOAP
Generated: true
---

# Services80 Selection SOAP

SOAP request and response examples, and WSDL files for **Remote/Services80/Selection.svc**

Handled by the <see cref="T:SuperOffice.Services80.ISelectionAgent">SuperOffice.Services80.ISelectionAgent</see> interface.

Interface for the Selection Agent

Download [WSDL file for Services80/Selection](../Services80-Selection.md) if you need to generate your own proxy code.
