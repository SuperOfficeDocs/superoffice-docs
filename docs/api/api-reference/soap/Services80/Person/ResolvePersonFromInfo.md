---
uid: services80-person-resolvepersonfrominfo
title: Services80.PersonAgent.ResolvePersonFromInfo SOAP
Generated: true
---

# Services80 Person ResolvePersonFromInfo SOAP

SOAP request and response examples **Remote/Services80/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services80.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    ...
    <Person:PhoneNumbers xsi:type="NetServerServices802:ArrayOfstring">
     <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices802:ArrayOfstring">
     <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
