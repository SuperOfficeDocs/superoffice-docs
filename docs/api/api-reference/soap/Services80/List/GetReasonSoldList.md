---
uid: services80-list-getreasonsoldlist
title: Services80.ListAgent.GetReasonSoldList SOAP
Generated: true
---

# Services80 List GetReasonSoldList SOAP

SOAP request and response examples **Remote/Services80/List.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IListAgent.GetReasonSoldList">SuperOffice.Services80.IListAgent.GetReasonSoldList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetReasonSoldList>
    <List:ReasonSoldIds xsi:type="NetServerServices802:ArrayOfint">
