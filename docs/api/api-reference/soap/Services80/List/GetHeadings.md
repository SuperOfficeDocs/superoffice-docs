---
uid: services80-list-getheadings
title: Services80.ListAgent.GetHeadings SOAP
Generated: true
---

# Services80 List GetHeadings SOAP

SOAP request and response examples **Remote/Services80/List.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IListAgent.GetHeadings">SuperOffice.Services80.IListAgent.GetHeadings</see> method.
  ...
  <List:GetHeadingsResponse>
   <List:Response xsi:type="List:ArrayOfSelectableMDOListItem">
    <List:SelectableMDOListItem xsi:type="List:SelectableMDOListItem">
     ...
     <List:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:34:13Z</List:LastChanged>
