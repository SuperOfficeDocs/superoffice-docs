---
uid: services80-list-getdepartmentlist
title: Services80.ListAgent.GetDepartmentList SOAP
Generated: true
---

# Services80 List GetDepartmentList SOAP

SOAP request and response examples **Remote/Services80/List.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IListAgent.GetDepartmentList">SuperOffice.Services80.IListAgent.GetDepartmentList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetDepartmentList>
    <List:DepartmentIds xsi:type="NetServerServices802:ArrayOfint">
