---
uid: services80-appointment-createdefaultappointmententityfromsalesuggestion
title: Services80.AppointmentAgent.CreateDefaultAppointmentEntityFromSaleSuggestion SOAP
Generated: true
---

# Services80 Appointment CreateDefaultAppointmentEntityFromSaleSuggestion SOAP

SOAP request and response examples **Remote/Services80/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IAppointmentAgent.CreateDefaultAppointmentEntityFromSaleSuggestion">SuperOffice.Services80.IAppointmentAgent.CreateDefaultAppointmentEntityFromSaleSuggestion</see> method.
...
## CreateDefaultAppointmentEntityFromSaleSuggestion Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:CreateDefaultAppointmentEntityFromSaleSuggestion>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services80">
 <SOAP-ENV:Body>
  <Appointment:CreateDefaultAppointmentEntityFromSaleSuggestionResponse>
   <Appointment:Response xsi:type="Appointment:AppointmentEntity">
    ...
    <Appointment:Project xsi:type="Appointment:Project">
     ...
     <Appointment:Updated xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:Updated>
     ...
     <Appointment:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:PublishTo>
     <Appointment:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:PublishFrom>
    ...
    <Appointment:UpdatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:UpdatedDate>
    ...
    <Appointment:LagTime xsi:type="NetServerServices801:duration"></Appointment:LagTime>
    <Appointment:LeadTime xsi:type="NetServerServices801:duration"></Appointment:LeadTime>
    ...
    <Appointment:Sale xsi:type="Appointment:Sale">
     <Appointment:ContactName xsi:type="xsd:string"></Appointment:ContactName>
     <Appointment:SaleDate xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:SaleDate>
     <Appointment:SaleId xsi:type="xsd:int">0</Appointment:SaleId>
     ...
     <Appointment:Completed xsi:type="Appointment:ActivityStatus">Unknown</Appointment:Completed>
     <Appointment:ActiveErpLinks xsi:type="xsd:int">0</Appointment:ActiveErpLinks>
     <Appointment:NextDueDate xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:NextDueDate>
    </Appointment:Sale>
    <Appointment:SuggestedAppointmentId xsi:type="xsd:int">0</Appointment:SuggestedAppointmentId>
    ...
    <Appointment:PublishEventDate xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:PublishEventDate>
    <Appointment:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:PublishTo>
    <Appointment:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</Appointment:PublishFrom>
    <Appointment:IsPublished xsi:type="xsd:boolean">false</Appointment:IsPublished>
