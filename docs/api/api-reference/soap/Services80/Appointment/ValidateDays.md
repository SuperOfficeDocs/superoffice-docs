---
uid: services80-appointment-validatedays
title: Services80.AppointmentAgent.ValidateDays SOAP
Generated: true
---

# Services80 Appointment ValidateDays SOAP

SOAP request and response examples **Remote/Services80/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IAppointmentAgent.ValidateDays">SuperOffice.Services80.IAppointmentAgent.ValidateDays</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateDays>
    ...
    <Appointment:Dates xsi:type="NetServerServices802:ArrayOfdateTime">
     <NetServerServices802:dateTime xsi:type="xsd:dateTime">2021-03-25T21:34:04Z</NetServerServices802:dateTime>
    </Appointment:Dates>
   </Appointment:ValidateDays>
