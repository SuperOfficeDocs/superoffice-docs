---
uid: services80-appointment-getdayinformationlistbydatesandassociate
title: Services80.AppointmentAgent.GetDayInformationListByDatesAndAssociate SOAP
Generated: true
---

# Services80 Appointment GetDayInformationListByDatesAndAssociate SOAP

SOAP request and response examples **Remote/Services80/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IAppointmentAgent.GetDayInformationListByDatesAndAssociate">SuperOffice.Services80.IAppointmentAgent.GetDayInformationListByDatesAndAssociate</see> method.
