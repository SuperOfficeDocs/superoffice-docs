---
uid: services80-import-createerpimportdata
title: Services80.ImportAgent.CreateErpImportData SOAP
Generated: true
---

# Services80 Import CreateErpImportData SOAP

SOAP request and response examples **Remote/Services80/Import.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IImportAgent.CreateErpImportData">SuperOffice.Services80.IImportAgent.CreateErpImportData</see> method.
   ...
   <Import:CreateErpImportData>
    <Import:Restriction xsi:type="Import:ArrayOfArchiveRestrictionInfo">
     <Import:ArchiveRestrictionInfo xsi:type="Import:ArchiveRestrictionInfo">
      ...
      <Import:DisplayValues xsi:type="NetServerServices802:ArrayOfstring">
       <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
    ...
    <Import:Columns xsi:type="NetServerServices802:ArrayOfstring">
     <NetServerServices802:string xsi:type="xsd:string"></NetServerServices802:string>
    </Import:Columns>
