---
uid: services80-contact-getquoteversionaddresses
title: Services80.ContactAgent.GetQuoteVersionAddresses SOAP
Generated: true
---

# Services80 Contact GetQuoteVersionAddresses SOAP

SOAP request and response examples **Remote/Services80/Contact.svc**
Implemented by the <see cref="M:SuperOffice.Services80.IContactAgent.GetQuoteVersionAddresses">SuperOffice.Services80.IContactAgent.GetQuoteVersionAddresses</see> method.
