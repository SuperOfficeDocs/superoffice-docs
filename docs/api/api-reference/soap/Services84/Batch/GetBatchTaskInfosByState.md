---
uid: services84-batch-getbatchtaskinfosbystate
title: Services84.BatchAgent.GetBatchTaskInfosByState SOAP
Generated: true
---

# Services84 Batch GetBatchTaskInfosByState SOAP

SOAP request and response examples **Remote/Services84/Batch.svc**
Implemented by the <see cref="M:SuperOffice.Services84.IBatchAgent.GetBatchTaskInfosByState">SuperOffice.Services84.IBatchAgent.GetBatchTaskInfosByState</see> method.
...
## GetBatchTaskInfosByState Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Batch:GetBatchTaskInfosByState>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Batch="http://www.superoffice.net/ws/crm/NetServer/Services84">
 <SOAP-ENV:Body>
  <Batch:GetBatchTaskInfosByStateResponse>
   <Batch:Response xsi:type="Batch:ArrayOfBatchTaskInfo">
    <Batch:BatchTaskInfo xsi:type="Batch:BatchTaskInfo">
     ...
     <Batch:LastStarted xsi:type="xsd:dateTime">2021-03-25T21:35:20Z</Batch:LastStarted>
     <Batch:Created xsi:type="xsd:dateTime">2021-03-25T21:35:20Z</Batch:Created>
