---
uid: services83-archive-getarchivelistwithcontext
title: Services83.ArchiveAgent.GetArchiveListWithContext SOAP
Generated: true
---

# Services83 Archive GetArchiveListWithContext SOAP

SOAP request and response examples **Remote/Services83/Archive.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IArchiveAgent.GetArchiveListWithContext">SuperOffice.Services83.IArchiveAgent.GetArchiveListWithContext</see> method.
   ...
   <Archive:GetArchiveListWithContext>
    ...
    <Archive:Restriction xsi:type="Archive:ArrayOfArchiveRestrictionInfo">
     <Archive:ArchiveRestrictionInfo xsi:type="Archive:ArchiveRestrictionInfo">
      ...
      <Archive:Values xsi:type="NetServerServices832:ArrayOfstring">
       <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
      </Archive:Values>
      <Archive:DisplayValues xsi:type="NetServerServices832:ArrayOfstring">
       <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
