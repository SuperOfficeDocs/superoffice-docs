---
uid: services83-archive
title: Services83.ArchiveAgent SOAP
Generated: true
---

# Services83 Archive SOAP

SOAP request and response examples, and WSDL files for **Remote/Services83/Archive.svc**

Handled by the <see cref="T:SuperOffice.Services83.IArchiveAgent">SuperOffice.Services83.IArchiveAgent</see> interface.

Interface for the Archive Agent
ArchiveList functions of all kinds

Download [WSDL file for Services83/Archive](../Services83-Archive.md) if you need to generate your own proxy code.
