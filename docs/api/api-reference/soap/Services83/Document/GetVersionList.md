---
uid: services83-document-getversionlist
title: Services83.DocumentAgent.GetVersionList SOAP
Generated: true
---

# Services83 Document GetVersionList SOAP

SOAP request and response examples **Remote/Services83/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IDocumentAgent.GetVersionList">SuperOffice.Services83.IDocumentAgent.GetVersionList</see> method.
  ...
  <Document:GetVersionListResponse>
   <Document:Response xsi:type="Document:ArrayOfVersionInfo">
    <Document:VersionInfo xsi:type="Document:VersionInfo">
     ...
     <Document:CheckedInDate xsi:type="xsd:dateTime">2021-03-25T21:35:03Z</Document:CheckedInDate>
     ...
     <Document:ExtraFields xsi:type="NetServerServices832:ArrayOfstring">
