---
uid: services83-document-createdefaultdocumententityfromsuggestion
title: Services83.DocumentAgent.CreateDefaultDocumentEntityFromSuggestion SOAP
Generated: true
---

# Services83 Document CreateDefaultDocumentEntityFromSuggestion SOAP

SOAP request and response examples **Remote/Services83/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IDocumentAgent.CreateDefaultDocumentEntityFromSuggestion">SuperOffice.Services83.IDocumentAgent.CreateDefaultDocumentEntityFromSuggestion</see> method.
