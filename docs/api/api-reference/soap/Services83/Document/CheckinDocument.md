---
uid: services83-document-checkindocument
title: Services83.DocumentAgent.CheckinDocument SOAP
Generated: true
---

# Services83 Document CheckinDocument SOAP

SOAP request and response examples **Remote/Services83/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IDocumentAgent.CheckinDocument">SuperOffice.Services83.IDocumentAgent.CheckinDocument</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:CheckinDocument>
    ...
    <Document:VersionExtraFields xsi:type="NetServerServices832:ArrayOfstring">
     <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
