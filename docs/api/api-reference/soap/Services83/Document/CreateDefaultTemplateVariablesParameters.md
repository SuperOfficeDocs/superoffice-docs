---
uid: services83-document-createdefaulttemplatevariablesparameters
title: Services83.DocumentAgent.CreateDefaultTemplateVariablesParameters SOAP
Generated: true
---

# Services83 Document CreateDefaultTemplateVariablesParameters SOAP

SOAP request and response examples **Remote/Services83/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IDocumentAgent.CreateDefaultTemplateVariablesParameters">SuperOffice.Services83.IDocumentAgent.CreateDefaultTemplateVariablesParameters</see> method.
