---
uid: services83-document-getprojectmemberdocumentsbytemplateheading
title: Services83.DocumentAgent.GetProjectMemberDocumentsByTemplateHeading SOAP
Generated: true
---

# Services83 Document GetProjectMemberDocumentsByTemplateHeading SOAP

SOAP request and response examples **Remote/Services83/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading">SuperOffice.Services83.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading</see> method.
