---
uid: services83-document-executedocumentcommand
title: Services83.DocumentAgent.ExecuteDocumentCommand SOAP
Generated: true
---

# Services83 Document ExecuteDocumentCommand SOAP

SOAP request and response examples **Remote/Services83/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IDocumentAgent.ExecuteDocumentCommand">SuperOffice.Services83.IDocumentAgent.ExecuteDocumentCommand</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:ExecuteDocumentCommand>
    ...
    <Document:AdditionalData xsi:type="NetServerServices832:ArrayOfstring">
     <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
