---
uid: services83-user
title: Services83.UserAgent SOAP
Generated: true
---

# Services83 User SOAP

SOAP request and response examples, and WSDL files for **Remote/Services83/User.svc**

Handled by the <see cref="T:SuperOffice.Services83.IUserAgent">SuperOffice.Services83.IUserAgent</see> interface.

Interface for the User Agent
User administration

Download [WSDL file for Services83/User](../Services83-User.md) if you need to generate your own proxy code.
