---
uid: services83-user-changeownpassword
title: Services83.UserAgent.ChangeOwnPassword SOAP
Generated: true
---

# Services83 User ChangeOwnPassword SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.ChangeOwnPassword">SuperOffice.Services83.IUserAgent.ChangeOwnPassword</see> method.
