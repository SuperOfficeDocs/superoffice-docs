---
uid: services83-user-getserviceauth
title: Services83.UserAgent.GetServiceAuth SOAP
Generated: true
---

# Services83 User GetServiceAuth SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.GetServiceAuth">SuperOffice.Services83.IUserAgent.GetServiceAuth</see> method.
