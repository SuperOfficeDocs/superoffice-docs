---
uid: services83-user-findcredentialusers
title: Services83.UserAgent.FindCredentialUsers SOAP
Generated: true
---

# Services83 User FindCredentialUsers SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.FindCredentialUsers">SuperOffice.Services83.IUserAgent.FindCredentialUsers</see> method.
