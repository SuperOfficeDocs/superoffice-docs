---
uid: services83-user-getuntrustedcredentials
title: Services83.UserAgent.GetUntrustedCredentials SOAP
Generated: true
---

# Services83 User GetUntrustedCredentials SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.GetUntrustedCredentials">SuperOffice.Services83.IUserAgent.GetUntrustedCredentials</see> method.
