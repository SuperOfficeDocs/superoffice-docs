---
uid: services83-user-getuserfromname
title: Services83.UserAgent.GetUserFromName SOAP
Generated: true
---

# Services83 User GetUserFromName SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.GetUserFromName">SuperOffice.Services83.IUserAgent.GetUserFromName</see> method.
