---
uid: services83-user-getroleentity
title: Services83.UserAgent.GetRoleEntity SOAP
Generated: true
---

# Services83 User GetRoleEntity SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.GetRoleEntity">SuperOffice.Services83.IUserAgent.GetRoleEntity</see> method.
