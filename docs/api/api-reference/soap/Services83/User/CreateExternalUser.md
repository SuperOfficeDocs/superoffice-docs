---
uid: services83-user-createexternaluser
title: Services83.UserAgent.CreateExternalUser SOAP
Generated: true
---

# Services83 User CreateExternalUser SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.CreateExternalUser">SuperOffice.Services83.IUserAgent.CreateExternalUser</see> method.
