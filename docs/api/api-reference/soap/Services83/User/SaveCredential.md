---
uid: services83-user-savecredential
title: Services83.UserAgent.SaveCredential SOAP
Generated: true
---

# Services83 User SaveCredential SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.SaveCredential">SuperOffice.Services83.IUserAgent.SaveCredential</see> method.
