---
uid: services83-user-resolveuserfrominfo
title: Services83.UserAgent.ResolveUserFromInfo SOAP
Generated: true
---

# Services83 User ResolveUserFromInfo SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.ResolveUserFromInfo">SuperOffice.Services83.IUserAgent.ResolveUserFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:ResolveUserFromInfo>
    ...
    <User:PhoneNumbers xsi:type="NetServerServices832:ArrayOfstring">
     <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
    </User:PhoneNumbers>
    <User:Emails xsi:type="NetServerServices832:ArrayOfstring">
     <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
    </User:Emails>
