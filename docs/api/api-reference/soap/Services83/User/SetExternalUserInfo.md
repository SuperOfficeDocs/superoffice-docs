---
uid: services83-user-setexternaluserinfo
title: Services83.UserAgent.SetExternalUserInfo SOAP
Generated: true
---

# Services83 User SetExternalUserInfo SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.SetExternalUserInfo">SuperOffice.Services83.IUserAgent.SetExternalUserInfo</see> method.
