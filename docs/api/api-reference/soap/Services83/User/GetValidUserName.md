---
uid: services83-user-getvalidusername
title: Services83.UserAgent.GetValidUserName SOAP
Generated: true
---

# Services83 User GetValidUserName SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.GetValidUserName">SuperOffice.Services83.IUserAgent.GetValidUserName</see> method.
