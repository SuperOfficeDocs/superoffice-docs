---
uid: services83-user-changeusertype
title: Services83.UserAgent.ChangeUserType SOAP
Generated: true
---

# Services83 User ChangeUserType SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.ChangeUserType">SuperOffice.Services83.IUserAgent.ChangeUserType</see> method.
 ...
 <SOAP-ENV:Body>
   <User:ChangeUserType>
    <User:User xsi:type="User:User">
     ...
     <User:Lastlogin xsi:type="xsd:dateTime">2021-03-25T21:35:17Z</User:Lastlogin>
     <User:Lastlogout xsi:type="xsd:dateTime">2021-03-25T21:35:17Z</User:Lastlogout>
