---
uid: services83-user-getuserfrompersonid
title: Services83.UserAgent.GetUserFromPersonId SOAP
Generated: true
---

# Services83 User GetUserFromPersonId SOAP

SOAP request and response examples **Remote/Services83/User.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IUserAgent.GetUserFromPersonId">SuperOffice.Services83.IUserAgent.GetUserFromPersonId</see> method.
