---
uid: services83-soprincipal-authenticateusernamepassword
title: Services83.SoPrincipalAgent.AuthenticateUsernamePassword SOAP
Generated: true
---

# Services83 SoPrincipal AuthenticateUsernamePassword SOAP

SOAP request and response examples **Remote/Services83/SoPrincipal.svc**
Implemented by the <see cref="M:SuperOffice.Services83.ISoPrincipalAgent.AuthenticateUsernamePassword">SuperOffice.Services83.ISoPrincipalAgent.AuthenticateUsernamePassword</see> method.
...
[WSDL file for Services83/SoPrincipal](../Services83-SoPrincipal.md)
...
<SOAP-ENV:Envelope
 ...
 xmlns:SoPrincipal="http://www.superoffice.net/ws/crm/NetServer/Services83">
   ...
   <SoPrincipal:Response xsi:type="SoPrincipal:SoPrincipalCarrier">
    ...
    <SoPrincipal:Licenses xsi:type="SoPrincipal:ArrayOfGrantedModuleLicense">
     <SoPrincipal:GrantedModuleLicense xsi:type="SoPrincipal:GrantedModuleLicense">
      ...
      <SoPrincipal:ExpiryDate xsi:type="xsd:dateTime">2021-03-25T21:35:16Z</SoPrincipal:ExpiryDate>
    ...
    <SoPrincipal:FunctionRights xsi:type="NetServerServices833:ArrayOfstring">
    ...
    <SoPrincipal:SecondaryGroups xsi:type="NetServerServices833:ArrayOfint">
     <NetServerServices833:int xsi:type="xsd:int">0</NetServerServices833:int>
