---
uid: services83-person-resolvepersonfrominfo
title: Services83.PersonAgent.ResolvePersonFromInfo SOAP
Generated: true
---

# Services83 Person ResolvePersonFromInfo SOAP

SOAP request and response examples **Remote/Services83/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services83.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    ...
    <Person:PhoneNumbers xsi:type="NetServerServices832:ArrayOfstring">
     <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices832:ArrayOfstring">
     <NetServerServices832:string xsi:type="xsd:string"></NetServerServices832:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
