---
uid: services83-person-getcolleaguesbysource
title: Services83.PersonAgent.GetColleaguesBySource SOAP
Generated: true
---

# Services83 Person GetColleaguesBySource SOAP

SOAP request and response examples **Remote/Services83/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IPersonAgent.GetColleaguesBySource">SuperOffice.Services83.IPersonAgent.GetColleaguesBySource</see> method.
...
* **sourceType:** The “source” the colleagues should be retrieved from. <see cref="T:SuperOffice.Services83.AssociateSourceType" /> for more information.
* **count:** 
