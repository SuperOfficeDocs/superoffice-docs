---
uid: services83-appointment-getalarms
title: Services83.AppointmentAgent.GetAlarms SOAP
Generated: true
---

# Services83 Appointment GetAlarms SOAP

SOAP request and response examples **Remote/Services83/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IAppointmentAgent.GetAlarms">SuperOffice.Services83.IAppointmentAgent.GetAlarms</see> method.
   ...
   <Appointment:Response xsi:type="Appointment:MultiAlarmData">
    <Appointment:Alarms xsi:type="Appointment:ArrayOfAlarmData">
     <Appointment:AlarmData xsi:type="Appointment:AlarmData">
      ...
      <Appointment:AlarmTime xsi:type="xsd:dateTime">2021-03-25T21:34:59Z</Appointment:AlarmTime>
