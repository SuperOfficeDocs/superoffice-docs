---
uid: services83-appointment-getdayinformationlistbydatesandassociate
title: Services83.AppointmentAgent.GetDayInformationListByDatesAndAssociate SOAP
Generated: true
---

# Services83 Appointment GetDayInformationListByDatesAndAssociate SOAP

SOAP request and response examples **Remote/Services83/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IAppointmentAgent.GetDayInformationListByDatesAndAssociate">SuperOffice.Services83.IAppointmentAgent.GetDayInformationListByDatesAndAssociate</see> method.
