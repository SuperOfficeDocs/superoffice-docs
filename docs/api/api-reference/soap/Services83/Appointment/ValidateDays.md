---
uid: services83-appointment-validatedays
title: Services83.AppointmentAgent.ValidateDays SOAP
Generated: true
---

# Services83 Appointment ValidateDays SOAP

SOAP request and response examples **Remote/Services83/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services83.IAppointmentAgent.ValidateDays">SuperOffice.Services83.IAppointmentAgent.ValidateDays</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateDays>
    ...
    <Appointment:Dates xsi:type="NetServerServices832:ArrayOfdateTime">
     <NetServerServices832:dateTime xsi:type="xsd:dateTime">2021-03-25T21:34:59Z</NetServerServices832:dateTime>
    </Appointment:Dates>
   </Appointment:ValidateDays>
