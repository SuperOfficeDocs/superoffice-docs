---
uid: services83-audience
title: Services83.AudienceAgent SOAP
Generated: true
---

# Services83 Audience SOAP

SOAP request and response examples, and WSDL files for **Remote/Services83/Audience.svc**

Handled by the <see cref="T:SuperOffice.Services83.IAudienceAgent">SuperOffice.Services83.IAudienceAgent</see> interface.

Interface for the Audience Agent
Services specific to the Audience client

Download [WSDL file for Services83/Audience](../Services83-Audience.md) if you need to generate your own proxy code.
