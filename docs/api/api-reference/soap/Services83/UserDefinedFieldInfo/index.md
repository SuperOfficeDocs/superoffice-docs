---
uid: services83-userdefinedfieldinfo
title: Services83.UserDefinedFieldInfoAgent SOAP
Generated: true
---

# Services83 UserDefinedFieldInfo SOAP

SOAP request and response examples, and WSDL files for **Remote/Services83/UserDefinedFieldInfo.svc**

Handled by the <see cref="T:SuperOffice.Services83.IUserDefinedFieldInfoAgent">SuperOffice.Services83.IUserDefinedFieldInfoAgent</see> interface.
...
Download [WSDL file for Services83/UserDefinedFieldInfo](../Services83-UserDefinedFieldInfo.md) if you need to generate your own proxy code.
