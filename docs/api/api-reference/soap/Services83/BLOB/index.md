---
uid: services83-blob
title: Services83.BLOBAgent SOAP
Generated: true
---

# Services83 BLOB SOAP

SOAP request and response examples, and WSDL files for **Remote/Services83/BLOB.svc**

Handled by the <see cref="T:SuperOffice.Services83.IBLOBAgent">SuperOffice.Services83.IBLOBAgent</see> interface.

Interface for the BLOB Agent
Collection of all services that works with binary objects (BLOBS), e.g. Images and documents.

Download [WSDL file for Services83/BLOB](../Services83-BLOB.md) if you need to generate your own proxy code.
