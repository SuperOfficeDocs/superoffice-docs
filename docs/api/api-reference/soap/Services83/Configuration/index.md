---
uid: services83-configuration
title: Services83.ConfigurationAgent SOAP
Generated: true
---

# Services83 Configuration SOAP

SOAP request and response examples, and WSDL files for **Remote/Services83/Configuration.svc**

Handled by the <see cref="T:SuperOffice.Services83.IConfigurationAgent">SuperOffice.Services83.IConfigurationAgent</see> interface.

Interface for the Configuration Agent
User interface configuration - XMLs and other elements such as inter-client URLs

Download [WSDL file for Services83/Configuration](../Services83-Configuration.md) if you need to generate your own proxy code.
