...
# Services88 Project SaveProjectMembersFunctionAndComment SOAP

SOAP request and response examples **Remote/Services88/Project.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IProjectAgent.SaveProjectMembersFunctionAndComment">SuperOffice.Services88.IProjectAgent.SaveProjectMembersFunctionAndComment</see> method.
