...
# Services88 Quote ToggleProductInAssortment SOAP

SOAP request and response examples **Remote/Services88/Quote.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.ToggleProductInAssortment">SuperOffice.Services88.IQuoteAgent.ToggleProductInAssortment</see> method.
