---
uid: services88-quote-savequotelines
title: Services88.QuoteAgent.SaveQuoteLines SOAP
Generated: true
---

# Services88 Quote SaveQuoteLines SOAP

SOAP request and response examples **Remote/Services88/Quote.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.SaveQuoteLines">SuperOffice.Services88.IQuoteAgent.SaveQuoteLines</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Quote:SaveQuoteLines>
    <Quote:QuoteLines xsi:type="Quote:ArrayOfQuoteLine">
     <Quote:QuoteLine xsi:type="Quote:QuoteLine">
      ...
      <Quote:SubscriptionStart xsi:type="xsd:dateTime">2021-03-25T21:37:08Z</Quote:SubscriptionStart>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Quote="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Quote:SaveQuoteLinesResponse>
   <Quote:Response xsi:type="Quote:ArrayOfQuoteLine">
    <Quote:QuoteLine xsi:type="Quote:QuoteLine">
     <Quote:QuoteLineId xsi:type="xsd:int">0</Quote:QuoteLineId>
     <Quote:ERPQuoteLineKey xsi:type="xsd:string"></Quote:ERPQuoteLineKey>
     <Quote:QuoteAlternativeId xsi:type="xsd:int">0</Quote:QuoteAlternativeId>
