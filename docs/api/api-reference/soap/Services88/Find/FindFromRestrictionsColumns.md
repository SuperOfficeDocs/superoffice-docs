...
# Services88 Find FindFromRestrictionsColumns SOAP

SOAP request and response examples **Remote/Services88/Find.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IFindAgent.FindFromRestrictionsColumns">SuperOffice.Services88.IFindAgent.FindFromRestrictionsColumns</see> method.
