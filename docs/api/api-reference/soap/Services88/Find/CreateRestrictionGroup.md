...
# Services88 Find CreateRestrictionGroup SOAP

SOAP request and response examples **Remote/Services88/Find.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IFindAgent.CreateRestrictionGroup">SuperOffice.Services88.IFindAgent.CreateRestrictionGroup</see> method.
