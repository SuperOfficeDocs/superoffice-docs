...
# Services88 Batch GetBatchTaskInfosByAssociatesAndState SOAP

SOAP request and response examples **Remote/Services88/Batch.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IBatchAgent.GetBatchTaskInfosByAssociatesAndState">SuperOffice.Services88.IBatchAgent.GetBatchTaskInfosByAssociatesAndState</see> method.
