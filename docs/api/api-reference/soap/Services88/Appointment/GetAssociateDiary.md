...
# Services88 Appointment GetAssociateDiary SOAP

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetAssociateDiary">SuperOffice.Services88.IAppointmentAgent.GetAssociateDiary</see> method.
