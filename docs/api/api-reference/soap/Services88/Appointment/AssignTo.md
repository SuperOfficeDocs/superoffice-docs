...
# Services88 Appointment AssignTo SOAP

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.AssignTo">SuperOffice.Services88.IAppointmentAgent.AssignTo</see> method.
