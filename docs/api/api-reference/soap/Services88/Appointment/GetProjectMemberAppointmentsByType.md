---
uid: services88-appointment-getprojectmemberappointmentsbytype
title: Services88.AppointmentAgent.GetProjectMemberAppointmentsByType SOAP
Generated: true
---

# Services88 Appointment GetProjectMemberAppointmentsByType SOAP

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetProjectMemberAppointmentsByType">SuperOffice.Services88.IAppointmentAgent.GetProjectMemberAppointmentsByType</see> method.
...
## GetProjectMemberAppointmentsByType Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetProjectMemberAppointmentsByType>
    <Appointment:PersonId xsi:type="xsd:int">0</Appointment:PersonId>
    <Appointment:StartTime xsi:type="xsd:dateTime">2021-03-25T21:36:50Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2021-03-25T21:36:50Z</Appointment:EndTime>
...
## GetProjectMemberAppointmentsByType Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:GetProjectMemberAppointmentsByTypeResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2021-03-25T21:36:50Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2021-03-25T21:36:50Z</Appointment:RecurringEndDate>
