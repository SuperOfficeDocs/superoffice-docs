---
uid: services88-chat-chatsessionsforuser
title: Services88.ChatAgent.ChatSessionsForUser SOAP
Generated: true
---

# Services88 Chat ChatSessionsForUser SOAP

SOAP request and response examples **Remote/Services88/Chat.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IChatAgent.ChatSessionsForUser">SuperOffice.Services88.IChatAgent.ChatSessionsForUser</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:Chat="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Chat:ChatSessionsForUserResponse>
   <Chat:Response xsi:type="Chat:ArrayOfChatSessionEntity">
    <Chat:ChatSessionEntity xsi:type="Chat:ChatSessionEntity">
       ...
       <Chat:LocalizedAddress xsi:type="Chat:ArrayOfArrayOfLocalizedField">
        <Chat:ArrayOfLocalizedField xsi:type="Chat:ArrayOfLocalizedField">
         <Chat:LocalizedField xsi:type="Chat:LocalizedField">
          ...
          <Chat:ValueLength xsi:nil="true"></Chat:ValueLength>
