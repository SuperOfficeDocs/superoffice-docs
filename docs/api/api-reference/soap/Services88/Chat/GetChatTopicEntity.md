...
# Services88 Chat GetChatTopicEntity SOAP

SOAP request and response examples **Remote/Services88/Chat.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IChatAgent.GetChatTopicEntity">SuperOffice.Services88.IChatAgent.GetChatTopicEntity</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:Chat="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Chat:GetChatTopicEntityResponse>
