---
uid: services88-chat-savechatsessionentity
title: Services88.ChatAgent.SaveChatSessionEntity SOAP
Generated: true
---

# Services88 Chat SaveChatSessionEntity SOAP

SOAP request and response examples **Remote/Services88/Chat.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IChatAgent.SaveChatSessionEntity">SuperOffice.Services88.IChatAgent.SaveChatSessionEntity</see> method.

## SaveChatSessionEntity

Updates the existing ChatSessionEntity or creates a new ChatSessionEntity if the id parameter is 0.

* **chatSessionEntity:** The ChatSessionEntity that is saved.
...
<SOAP-ENV:Envelope
 ...
 xmlns:Chat="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Chat:SaveChatSessionEntityResponse>
