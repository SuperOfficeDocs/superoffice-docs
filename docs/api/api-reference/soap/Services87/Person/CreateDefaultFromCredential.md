---
uid: services87-person-createdefaultfromcredential
title: Services87.PersonAgent.CreateDefaultFromCredential SOAP
Generated: true
---

# Services87 Person CreateDefaultFromCredential SOAP

SOAP request and response examples **Remote/Services87/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services87.IPersonAgent.CreateDefaultFromCredential">SuperOffice.Services87.IPersonAgent.CreateDefaultFromCredential</see> method.
...
## CreateDefaultFromCredential Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:CreateDefaultFromCredential>
    <Person:ContactId xsi:type="xsd:int">0</Person:ContactId>
    <Person:CredentialType xsi:type="xsd:string"></Person:CredentialType>
    <Person:CredentialValue xsi:type="xsd:string"></Person:CredentialValue>
    <Person:CredentialDisplayValue xsi:type="xsd:string"></Person:CredentialDisplayValue>
   </Person:CreateDefaultFromCredential>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Person="http://www.superoffice.net/ws/crm/NetServer/Services87">
 <SOAP-ENV:Body>
  <Person:CreateDefaultFromCredentialResponse>
   <Person:Response xsi:type="Person:PersonEntity">
    ...
    <Person:UpdatedDate xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:UpdatedDate>
    <Person:CreatedDate xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:CreatedDate>
    <Person:BirthDate xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:BirthDate>
    ...
    <Person:Interests xsi:type="Person:ArrayOfSelectableMDOListItem">
     <Person:SelectableMDOListItem xsi:type="Person:SelectableMDOListItem">
      ...
      <Person:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:LastChanged>
    ...
    <Person:DbiLastModified xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:DbiLastModified>
    <Person:DbiLastSyncronized xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:DbiLastSyncronized>
    ...
    <Person:UserInfo xsi:type="Person:UserInfo">
     ...
     <Person:GrantedLicenses xsi:type="NetServerServices872:ArrayOfstring">
    ...
    <Person:Consents xsi:type="Person:ArrayOfConsentInfo">
     <Person:ConsentInfo xsi:type="Person:ConsentInfo">
      ...
      <Person:Registered xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:Registered>
      <Person:RegisteredAssociateId xsi:type="xsd:int">0</Person:RegisteredAssociateId>
      <Person:Updated xsi:type="xsd:dateTime">2021-03-25T21:36:40Z</Person:Updated>
