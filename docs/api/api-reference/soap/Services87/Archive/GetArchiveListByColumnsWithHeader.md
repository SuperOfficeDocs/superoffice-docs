---
uid: services87-archive-getarchivelistbycolumnswithheader
title: Services87.ArchiveAgent.GetArchiveListByColumnsWithHeader SOAP
Generated: true
---

# Services87 Archive GetArchiveListByColumnsWithHeader SOAP

SOAP request and response examples **Remote/Services87/Archive.svc**
Implemented by the <see cref="M:SuperOffice.Services87.IArchiveAgent.GetArchiveListByColumnsWithHeader">SuperOffice.Services87.IArchiveAgent.GetArchiveListByColumnsWithHeader</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Archive:GetArchiveListByColumnsWithHeader>
    ...
    <Archive:Columns xsi:type="NetServerServices872:ArrayOfstring">
    ...
    <Archive:Restriction xsi:type="Archive:ArrayOfArchiveRestrictionInfo">
     <Archive:ArchiveRestrictionInfo xsi:type="Archive:ArchiveRestrictionInfo">
      ...
      <Archive:Values xsi:type="NetServerServices872:ArrayOfstring">
       <NetServerServices872:string xsi:type="xsd:string"></NetServerServices872:string>
      </Archive:Values>
      <Archive:DisplayValues xsi:type="NetServerServices872:ArrayOfstring">
       <NetServerServices872:string xsi:type="xsd:string"></NetServerServices872:string>
    ...
    <Archive:Entities xsi:type="NetServerServices872:ArrayOfstring">
     <NetServerServices872:string xsi:type="xsd:string"></NetServerServices872:string>
    </Archive:Entities>
