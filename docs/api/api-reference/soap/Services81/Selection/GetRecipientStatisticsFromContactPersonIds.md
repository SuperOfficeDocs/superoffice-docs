---
uid: services81-selection-getrecipientstatisticsfromcontactpersonids
title: Services81.SelectionAgent.GetRecipientStatisticsFromContactPersonIds SOAP
Generated: true
---

# Services81 Selection GetRecipientStatisticsFromContactPersonIds SOAP

SOAP request and response examples **Remote/Services81/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services81.ISelectionAgent.GetRecipientStatisticsFromContactPersonIds">SuperOffice.Services81.ISelectionAgent.GetRecipientStatisticsFromContactPersonIds</see> method.
