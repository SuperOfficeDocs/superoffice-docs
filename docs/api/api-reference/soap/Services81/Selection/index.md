---
uid: services81-selection
title: Services81.SelectionAgent SOAP
Generated: true
---

# Services81 Selection SOAP

SOAP request and response examples, and WSDL files for **Remote/Services81/Selection.svc**

Handled by the <see cref="T:SuperOffice.Services81.ISelectionAgent">SuperOffice.Services81.ISelectionAgent</see> interface.

Interface for the Selection Agent

Download [WSDL file for Services81/Selection](../Services81-Selection.md) if you need to generate your own proxy code.
