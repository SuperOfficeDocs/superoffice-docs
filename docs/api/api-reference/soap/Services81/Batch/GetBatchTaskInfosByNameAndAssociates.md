---
uid: services81-batch-getbatchtaskinfosbynameandassociates
title: Services81.BatchAgent.GetBatchTaskInfosByNameAndAssociates SOAP
Generated: true
---

# Services81 Batch GetBatchTaskInfosByNameAndAssociates SOAP

SOAP request and response examples **Remote/Services81/Batch.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IBatchAgent.GetBatchTaskInfosByNameAndAssociates">SuperOffice.Services81.IBatchAgent.GetBatchTaskInfosByNameAndAssociates</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Batch:GetBatchTaskInfosByNameAndAssociates>
    ...
    <Batch:AssociateIds xsi:type="NetServerServices812:ArrayOfint">
