---
uid: services81-foreignsystem-getdevicekeysondeviceidentifiertablerecordid
title: Services81.ForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId SOAP
Generated: true
---

# Services81 ForeignSystem GetDeviceKeysOnDeviceIdentifierTableRecordId SOAP

SOAP request and response examples **Remote/Services81/ForeignSystem.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId">SuperOffice.Services81.IForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId</see> method.
