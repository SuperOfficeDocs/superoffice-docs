---
uid: services81-document-getprojectmemberdocumentsbytemplatetypes
title: Services81.DocumentAgent.GetProjectMemberDocumentsByTemplateTypes SOAP
Generated: true
---

# Services81 Document GetProjectMemberDocumentsByTemplateTypes SOAP

SOAP request and response examples **Remote/Services81/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IDocumentAgent.GetProjectMemberDocumentsByTemplateTypes">SuperOffice.Services81.IDocumentAgent.GetProjectMemberDocumentsByTemplateTypes</see> method.
