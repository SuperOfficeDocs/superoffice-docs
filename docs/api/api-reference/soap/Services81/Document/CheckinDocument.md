---
uid: services81-document-checkindocument
title: Services81.DocumentAgent.CheckinDocument SOAP
Generated: true
---

# Services81 Document CheckinDocument SOAP

SOAP request and response examples **Remote/Services81/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IDocumentAgent.CheckinDocument">SuperOffice.Services81.IDocumentAgent.CheckinDocument</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:CheckinDocument>
    ...
    <Document:VersionExtraFields xsi:type="NetServerServices812:ArrayOfstring">
     <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
