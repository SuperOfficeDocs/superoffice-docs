---
uid: services81-document-createdefaulttemplatevariablesparameters
title: Services81.DocumentAgent.CreateDefaultTemplateVariablesParameters SOAP
Generated: true
---

# Services81 Document CreateDefaultTemplateVariablesParameters SOAP

SOAP request and response examples **Remote/Services81/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IDocumentAgent.CreateDefaultTemplateVariablesParameters">SuperOffice.Services81.IDocumentAgent.CreateDefaultTemplateVariablesParameters</see> method.
 ...
 <SOAP-ENV:Body>
  <Document:CreateDefaultTemplateVariablesParametersResponse>
   <Document:Response xsi:type="Document:TemplateVariablesParameters">
    ...
    <Document:CustomTags xsi:type="NetServerServices812:ArrayOfArrayOfstring">
     <NetServerServices812:ArrayOfstring xsi:type="NetServerServices812:ArrayOfstring">
      <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
     </NetServerServices812:ArrayOfstring>
    </Document:CustomTags>
    <Document:DocumentEntity xsi:type="Document:DocumentEntity">
     ...
     <Document:CreatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:CreatedDate>
     <Document:UpdatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:UpdatedDate>
     ...
     <Document:Project xsi:type="Document:Project">
      ...
      <Document:Updated xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:Updated>
      ...
      <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:PublishTo>
      <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:PublishFrom>
     ...
     <Document:Date xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:Date>
     ...
     <Document:Sale xsi:type="Document:Sale">
      <Document:ContactName xsi:type="xsd:string"></Document:ContactName>
      <Document:SaleDate xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:SaleDate>
      <Document:SaleId xsi:type="xsd:int">0</Document:SaleId>
      ...
      <Document:Completed xsi:type="Document:ActivityStatus">Unknown</Document:Completed>
      <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
      <Document:NextDueDate xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:NextDueDate>
     </Document:Sale>
     ...
     <Document:PublishEventDate xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:PublishEventDate>
     <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:PublishTo>
     <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:26Z</Document:PublishFrom>
     <Document:IsPublished xsi:type="xsd:boolean">false</Document:IsPublished>
