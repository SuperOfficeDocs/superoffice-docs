---
uid: services81-document-getprojectmemberdocumentsbytemplateheading
title: Services81.DocumentAgent.GetProjectMemberDocumentsByTemplateHeading SOAP
Generated: true
---

# Services81 Document GetProjectMemberDocumentsByTemplateHeading SOAP

SOAP request and response examples **Remote/Services81/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading">SuperOffice.Services81.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading</see> method.
