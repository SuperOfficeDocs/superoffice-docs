---
uid: services81-document-substitutemergedocumenttemplatevariables
title: Services81.DocumentAgent.SubstituteMergeDocumentTemplateVariables SOAP
Generated: true
---

# Services81 Document SubstituteMergeDocumentTemplateVariables SOAP

SOAP request and response examples **Remote/Services81/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IDocumentAgent.SubstituteMergeDocumentTemplateVariables">SuperOffice.Services81.IDocumentAgent.SubstituteMergeDocumentTemplateVariables</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:SubstituteMergeDocumentTemplateVariables>
    ...
    <Document:CustomTags xsi:type="NetServerServices812:ArrayOfstring">
     <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
    </Document:CustomTags>
    <Document:CustomValues xsi:type="NetServerServices812:ArrayOfstring">
     <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
