---
uid: services81-list-createdefaultsaletypeentity
title: Services81.ListAgent.CreateDefaultSaleTypeEntity SOAP
Generated: true
---

# Services81 List CreateDefaultSaleTypeEntity SOAP

SOAP request and response examples **Remote/Services81/List.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IListAgent.CreateDefaultSaleTypeEntity">SuperOffice.Services81.IListAgent.CreateDefaultSaleTypeEntity</see> method.
...
## CreateDefaultSaleTypeEntity Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:CreateDefaultSaleTypeEntity>
   </List:CreateDefaultSaleTypeEntity>
...
<SOAP-ENV:Envelope
 ...
 xmlns:List="http://www.superoffice.net/ws/crm/NetServer/Services81">
 <SOAP-ENV:Body>
  <List:CreateDefaultSaleTypeEntityResponse>
   <List:Response xsi:type="List:SaleTypeEntity">
    ...
    <List:Stages xsi:type="List:ArrayOfSelectableMDOListItem">
     <List:SelectableMDOListItem xsi:type="List:SelectableMDOListItem">
      ...
      <List:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:34:31Z</List:LastChanged>
