---
uid: services81-list-getdepartmentlist
title: Services81.ListAgent.GetDepartmentList SOAP
Generated: true
---

# Services81 List GetDepartmentList SOAP

SOAP request and response examples **Remote/Services81/List.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IListAgent.GetDepartmentList">SuperOffice.Services81.IListAgent.GetDepartmentList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetDepartmentList>
    <List:DepartmentIds xsi:type="NetServerServices812:ArrayOfint">
