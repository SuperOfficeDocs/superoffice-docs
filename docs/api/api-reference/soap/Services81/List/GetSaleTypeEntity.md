---
uid: services81-list-getsaletypeentity
title: Services81.ListAgent.GetSaleTypeEntity SOAP
Generated: true
---

# Services81 List GetSaleTypeEntity SOAP

SOAP request and response examples **Remote/Services81/List.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IListAgent.GetSaleTypeEntity">SuperOffice.Services81.IListAgent.GetSaleTypeEntity</see> method.
   ...
   <List:Response xsi:type="List:SaleTypeEntity">
    ...
    <List:Stages xsi:type="List:ArrayOfSelectableMDOListItem">
     <List:SelectableMDOListItem xsi:type="List:SelectableMDOListItem">
      ...
      <List:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:34:30Z</List:LastChanged>
