---
uid: services81-list-getlocalizedtextlist
title: Services81.ListAgent.GetLocalizedTextList SOAP
Generated: true
---

# Services81 List GetLocalizedTextList SOAP

SOAP request and response examples **Remote/Services81/List.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IListAgent.GetLocalizedTextList">SuperOffice.Services81.IListAgent.GetLocalizedTextList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetLocalizedTextList>
    <List:LocalizedTextIds xsi:type="NetServerServices812:ArrayOfint">
