---
uid: services81-user-resolveuserfrominfo
title: Services81.UserAgent.ResolveUserFromInfo SOAP
Generated: true
---

# Services81 User ResolveUserFromInfo SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.ResolveUserFromInfo">SuperOffice.Services81.IUserAgent.ResolveUserFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:ResolveUserFromInfo>
    ...
    <User:PhoneNumbers xsi:type="NetServerServices812:ArrayOfstring">
     <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
    </User:PhoneNumbers>
    <User:Emails xsi:type="NetServerServices812:ArrayOfstring">
     <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
    </User:Emails>
