---
uid: services81-user-getuserfromname
title: Services81.UserAgent.GetUserFromName SOAP
Generated: true
---

# Services81 User GetUserFromName SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.GetUserFromName">SuperOffice.Services81.IUserAgent.GetUserFromName</see> method.
