---
uid: services81-user-getuserfromejuserid
title: Services81.UserAgent.GetUserFromEjUserId SOAP
Generated: true
---

# Services81 User GetUserFromEjUserId SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.GetUserFromEjUserId">SuperOffice.Services81.IUserAgent.GetUserFromEjUserId</see> method.
