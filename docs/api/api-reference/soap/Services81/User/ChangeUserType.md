---
uid: services81-user-changeusertype
title: Services81.UserAgent.ChangeUserType SOAP
Generated: true
---

# Services81 User ChangeUserType SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.ChangeUserType">SuperOffice.Services81.IUserAgent.ChangeUserType</see> method.
