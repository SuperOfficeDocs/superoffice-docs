---
uid: services81-user-getuserfrompersonid
title: Services81.UserAgent.GetUserFromPersonId SOAP
Generated: true
---

# Services81 User GetUserFromPersonId SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.GetUserFromPersonId">SuperOffice.Services81.IUserAgent.GetUserFromPersonId</see> method.
