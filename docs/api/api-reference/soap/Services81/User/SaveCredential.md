---
uid: services81-user-savecredential
title: Services81.UserAgent.SaveCredential SOAP
Generated: true
---

# Services81 User SaveCredential SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.SaveCredential">SuperOffice.Services81.IUserAgent.SaveCredential</see> method.
