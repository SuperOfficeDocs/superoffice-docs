---
uid: services81-user-changepasswordfromname
title: Services81.UserAgent.ChangePasswordFromName SOAP
Generated: true
---

# Services81 User ChangePasswordFromName SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.ChangePasswordFromName">SuperOffice.Services81.IUserAgent.ChangePasswordFromName</see> method.
