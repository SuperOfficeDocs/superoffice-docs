---
uid: services81-user-getcredentialusersingroup
title: Services81.UserAgent.GetCredentialUsersInGroup SOAP
Generated: true
---

# Services81 User GetCredentialUsersInGroup SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.GetCredentialUsersInGroup">SuperOffice.Services81.IUserAgent.GetCredentialUsersInGroup</see> method.
