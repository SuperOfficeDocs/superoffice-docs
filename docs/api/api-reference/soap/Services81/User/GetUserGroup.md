---
uid: services81-user-getusergroup
title: Services81.UserAgent.GetUserGroup SOAP
Generated: true
---

# Services81 User GetUserGroup SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.GetUserGroup">SuperOffice.Services81.IUserAgent.GetUserGroup</see> method.
