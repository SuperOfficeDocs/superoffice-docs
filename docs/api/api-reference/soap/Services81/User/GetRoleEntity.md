---
uid: services81-user-getroleentity
title: Services81.UserAgent.GetRoleEntity SOAP
Generated: true
---

# Services81 User GetRoleEntity SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.GetRoleEntity">SuperOffice.Services81.IUserAgent.GetRoleEntity</see> method.
