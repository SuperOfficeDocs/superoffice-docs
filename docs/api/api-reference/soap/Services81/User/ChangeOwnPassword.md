---
uid: services81-user-changeownpassword
title: Services81.UserAgent.ChangeOwnPassword SOAP
Generated: true
---

# Services81 User ChangeOwnPassword SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.ChangeOwnPassword">SuperOffice.Services81.IUserAgent.ChangeOwnPassword</see> method.
