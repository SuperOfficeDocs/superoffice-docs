---
uid: services81-user-setdataright
title: Services81.UserAgent.SetDataRight SOAP
Generated: true
---

# Services81 User SetDataRight SOAP

SOAP request and response examples **Remote/Services81/User.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IUserAgent.SetDataRight">SuperOffice.Services81.IUserAgent.SetDataRight</see> method.
