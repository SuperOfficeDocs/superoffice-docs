---
uid: services81-blob
title: Services81.BLOBAgent SOAP
Generated: true
---

# Services81 BLOB SOAP

SOAP request and response examples, and WSDL files for **Remote/Services81/BLOB.svc**

Handled by the <see cref="T:SuperOffice.Services81.IBLOBAgent">SuperOffice.Services81.IBLOBAgent</see> interface.

Interface for the BLOB Agent
Collection of all services that works with binary objects (BLOBS), e.g. Images and documents.

Download [WSDL file for Services81/BLOB](../Services81-BLOB.md) if you need to generate your own proxy code.
