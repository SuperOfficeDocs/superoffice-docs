---
uid: services81-appointment-getmysyncappointments
title: Services81.AppointmentAgent.GetMySyncAppointments SOAP
Generated: true
---

# Services81 Appointment GetMySyncAppointments SOAP

SOAP request and response examples **Remote/Services81/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IAppointmentAgent.GetMySyncAppointments">SuperOffice.Services81.IAppointmentAgent.GetMySyncAppointments</see> method.
  ...
  <Appointment:GetMySyncAppointmentsResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointmentSyncData">
    <Appointment:AppointmentSyncData xsi:type="Appointment:AppointmentSyncData">
     <Appointment:AlarmTime xsi:type="xsd:dateTime">2021-03-25T21:34:22Z</Appointment:AlarmTime>
     ...
     <Appointment:Participants xsi:type="Appointment:ArrayOfParticipantSyncData">
      <Appointment:ParticipantSyncData xsi:type="Appointment:ParticipantSyncData">
       ...
       <Appointment:ContactFullName xsi:type="xsd:string"></Appointment:ContactFullName>
       <Appointment:EMail xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:EMail>
       <Appointment:PhonePrivate xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:PhonePrivate>
       <Appointment:PhoneFax xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:PhoneFax>
       <Appointment:PhoneMobile xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:PhoneMobile>
       <Appointment:PhoneDirect xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:PhoneDirect>
       <Appointment:PhoneContact xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:PhoneContact>
       <Appointment:Messenger xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:Messenger>
       <Appointment:Voip xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:Voip>
       <Appointment:ContactUrl xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:ContactUrl>
       <Appointment:Url xsi:type="NetServerServices812:ArrayOfstring">
        <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
       </Appointment:Url>
