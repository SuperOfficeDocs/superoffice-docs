---
uid: services81-appointment-validatedays
title: Services81.AppointmentAgent.ValidateDays SOAP
Generated: true
---

# Services81 Appointment ValidateDays SOAP

SOAP request and response examples **Remote/Services81/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IAppointmentAgent.ValidateDays">SuperOffice.Services81.IAppointmentAgent.ValidateDays</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateDays>
    ...
    <Appointment:Dates xsi:type="NetServerServices812:ArrayOfdateTime">
     <NetServerServices812:dateTime xsi:type="xsd:dateTime">2021-03-25T21:34:22Z</NetServerServices812:dateTime>
    </Appointment:Dates>
   </Appointment:ValidateDays>
