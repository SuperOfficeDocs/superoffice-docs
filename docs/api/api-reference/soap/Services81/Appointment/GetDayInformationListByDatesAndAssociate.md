---
uid: services81-appointment-getdayinformationlistbydatesandassociate
title: Services81.AppointmentAgent.GetDayInformationListByDatesAndAssociate SOAP
Generated: true
---

# Services81 Appointment GetDayInformationListByDatesAndAssociate SOAP

SOAP request and response examples **Remote/Services81/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IAppointmentAgent.GetDayInformationListByDatesAndAssociate">SuperOffice.Services81.IAppointmentAgent.GetDayInformationListByDatesAndAssociate</see> method.
