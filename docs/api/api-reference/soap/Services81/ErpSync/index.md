---
uid: services81-erpsync
title: Services81.ErpSyncAgent SOAP
Generated: true
---

# Services81 ErpSync SOAP

SOAP request and response examples, and WSDL files for **Remote/Services81/ErpSync.svc**

Handled by the <see cref="T:SuperOffice.Services81.IErpSyncAgent">SuperOffice.Services81.IErpSyncAgent</see> interface.

Interface for the ErpSync Agent
Services for the ERP Integration Services feature

Download [WSDL file for Services81/ErpSync](../Services81-ErpSync.md) if you need to generate your own proxy code.
