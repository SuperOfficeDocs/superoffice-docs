---
uid: services81-find-populaterestrictions
title: Services81.FindAgent.PopulateRestrictions SOAP
Generated: true
---

# Services81 Find PopulateRestrictions SOAP

SOAP request and response examples **Remote/Services81/Find.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IFindAgent.PopulateRestrictions">SuperOffice.Services81.IFindAgent.PopulateRestrictions</see> method.
      ...
      <Find:ArchiveRestrictionInfo xsi:type="Find:ArchiveRestrictionInfo">
       ...
       <Find:SubRestrictions xsi:type="Find:ArrayOfArchiveRestrictionInfo">
        <Find:ArchiveRestrictionInfo xsi:type="Find:ArchiveRestrictionInfo">
         ...
         <Find:Operator xsi:type="xsd:string"></Find:Operator>
         <Find:Values xsi:type="NetServerServices812:ArrayOfstring">
          <NetServerServices812:string xsi:nil="true"></NetServerServices812:string>
         </Find:Values>
         <Find:DisplayValues xsi:type="NetServerServices812:ArrayOfstring">
          <NetServerServices812:string xsi:nil="true"></NetServerServices812:string>
         </Find:DisplayValues>
