---
uid: services81-configuration
title: Services81.ConfigurationAgent SOAP
Generated: true
---

# Services81 Configuration SOAP

SOAP request and response examples, and WSDL files for **Remote/Services81/Configuration.svc**

Handled by the <see cref="T:SuperOffice.Services81.IConfigurationAgent">SuperOffice.Services81.IConfigurationAgent</see> interface.

Interface for the Configuration Agent

Download [WSDL file for Services81/Configuration](../Services81-Configuration.md) if you need to generate your own proxy code.
