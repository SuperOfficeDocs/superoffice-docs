---
uid: services81-project
title: Services81.ProjectAgent SOAP
Generated: true
---

# Services81 Project SOAP

SOAP request and response examples, and WSDL files for **Remote/Services81/Project.svc**

Handled by the <see cref="T:SuperOffice.Services81.IProjectAgent">SuperOffice.Services81.IProjectAgent</see> interface.

Interface for the Project Agent
Collection of all services that works with Project data.

Download [WSDL file for Services81/Project](../Services81-Project.md) if you need to generate your own proxy code.
