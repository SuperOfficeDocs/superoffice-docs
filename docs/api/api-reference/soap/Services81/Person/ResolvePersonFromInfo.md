---
uid: services81-person-resolvepersonfrominfo
title: Services81.PersonAgent.ResolvePersonFromInfo SOAP
Generated: true
---

# Services81 Person ResolvePersonFromInfo SOAP

SOAP request and response examples **Remote/Services81/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services81.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services81.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    ...
    <Person:PhoneNumbers xsi:type="NetServerServices812:ArrayOfstring">
     <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices812:ArrayOfstring">
     <NetServerServices812:string xsi:type="xsd:string"></NetServerServices812:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
