---
uid: services86-user-getusercommands
title: Services86.UserAgent.GetUserCommands SOAP
Generated: true
---

# Services86 User GetUserCommands SOAP

SOAP request and response examples **Remote/Services86/User.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IUserAgent.GetUserCommands">SuperOffice.Services86.IUserAgent.GetUserCommands</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:User="http://www.superoffice.net/ws/crm/NetServer/Services86">
 <SOAP-ENV:Body>
  <User:GetUserCommandsResponse>
   <User:Response xsi:type="User:ArrayOfCustomCommand">
    <User:CustomCommand xsi:type="User:CustomCommand">
     <User:Name xsi:type="xsd:string"></User:Name>
     <User:DisplayName xsi:type="xsd:string"></User:DisplayName>
     <User:Description xsi:type="xsd:string"></User:Description>
