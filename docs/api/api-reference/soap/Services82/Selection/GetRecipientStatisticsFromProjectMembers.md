---
uid: services82-selection-getrecipientstatisticsfromprojectmembers
title: Services82.SelectionAgent.GetRecipientStatisticsFromProjectMembers SOAP
Generated: true
---

# Services82 Selection GetRecipientStatisticsFromProjectMembers SOAP

SOAP request and response examples **Remote/Services82/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services82.ISelectionAgent.GetRecipientStatisticsFromProjectMembers">SuperOffice.Services82.ISelectionAgent.GetRecipientStatisticsFromProjectMembers</see> method.
