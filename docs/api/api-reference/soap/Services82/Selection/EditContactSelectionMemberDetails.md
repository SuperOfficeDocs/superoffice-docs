---
uid: services82-selection-editcontactselectionmemberdetails
title: Services82.SelectionAgent.EditContactSelectionMemberDetails SOAP
Generated: true
---

# Services82 Selection EditContactSelectionMemberDetails SOAP

SOAP request and response examples **Remote/Services82/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services82.ISelectionAgent.EditContactSelectionMemberDetails">SuperOffice.Services82.ISelectionAgent.EditContactSelectionMemberDetails</see> method.
...
* **selectionMemberEditValues:** An object of <see cref="T:SuperOffice.Services82.SelectionMemberEditValues" /> describing what should be changed for companys and contacts.
