---
uid: services82-selection-getrecipientstatisticsfromcontactpersonids
title: Services82.SelectionAgent.GetRecipientStatisticsFromContactPersonIds SOAP
Generated: true
---

# Services82 Selection GetRecipientStatisticsFromContactPersonIds SOAP

SOAP request and response examples **Remote/Services82/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services82.ISelectionAgent.GetRecipientStatisticsFromContactPersonIds">SuperOffice.Services82.ISelectionAgent.GetRecipientStatisticsFromContactPersonIds</see> method.
