---
uid: services82-selection-addremovecontactselectionmemberinterests
title: Services82.SelectionAgent.AddRemoveContactSelectionMemberInterests SOAP
Generated: true
---

# Services82 Selection AddRemoveContactSelectionMemberInterests SOAP

SOAP request and response examples **Remote/Services82/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services82.ISelectionAgent.AddRemoveContactSelectionMemberInterests">SuperOffice.Services82.ISelectionAgent.AddRemoveContactSelectionMemberInterests</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Selection:AddRemoveContactSelectionMemberInterests>
    ...
    <Selection:AddCompanyInterests xsi:type="NetServerServices822:ArrayOfint">
     <NetServerServices822:int xsi:type="xsd:int">0</NetServerServices822:int>
    </Selection:AddCompanyInterests>
    <Selection:RemoveCompanyInterests xsi:type="NetServerServices822:ArrayOfint">
     <NetServerServices822:int xsi:type="xsd:int">0</NetServerServices822:int>
    </Selection:RemoveCompanyInterests>
    <Selection:AddContactInterests xsi:type="NetServerServices822:ArrayOfint">
     <NetServerServices822:int xsi:type="xsd:int">0</NetServerServices822:int>
    </Selection:AddContactInterests>
    <Selection:RemoveContactInterests xsi:type="NetServerServices822:ArrayOfint">
     <NetServerServices822:int xsi:type="xsd:int">0</NetServerServices822:int>
