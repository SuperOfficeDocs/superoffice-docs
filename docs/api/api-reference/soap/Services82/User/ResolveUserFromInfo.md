---
uid: services82-user-resolveuserfrominfo
title: Services82.UserAgent.ResolveUserFromInfo SOAP
Generated: true
---

# Services82 User ResolveUserFromInfo SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.ResolveUserFromInfo">SuperOffice.Services82.IUserAgent.ResolveUserFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:ResolveUserFromInfo>
    ...
    <User:PhoneNumbers xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    </User:PhoneNumbers>
    <User:Emails xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    </User:Emails>
  ...
  <User:ResolveUserFromInfoResponse>
   <User:Response xsi:type="User:ResolvedUser">
    <User:User xsi:type="User:User">
     ...
     <User:Lastlogin xsi:type="xsd:dateTime">2021-03-25T21:34:57Z</User:Lastlogin>
     <User:Lastlogout xsi:type="xsd:dateTime">2021-03-25T21:34:57Z</User:Lastlogout>
