---
uid: services82-user-getuntrustedcredentials
title: Services82.UserAgent.GetUntrustedCredentials SOAP
Generated: true
---

# Services82 User GetUntrustedCredentials SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetUntrustedCredentials">SuperOffice.Services82.IUserAgent.GetUntrustedCredentials</see> method.
