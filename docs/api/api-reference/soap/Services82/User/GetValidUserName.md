---
uid: services82-user-getvalidusername
title: Services82.UserAgent.GetValidUserName SOAP
Generated: true
---

# Services82 User GetValidUserName SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetValidUserName">SuperOffice.Services82.IUserAgent.GetValidUserName</see> method.
