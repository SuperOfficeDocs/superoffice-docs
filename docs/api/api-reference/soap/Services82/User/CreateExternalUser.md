---
uid: services82-user-createexternaluser
title: Services82.UserAgent.CreateExternalUser SOAP
Generated: true
---

# Services82 User CreateExternalUser SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.CreateExternalUser">SuperOffice.Services82.IUserAgent.CreateExternalUser</see> method.
