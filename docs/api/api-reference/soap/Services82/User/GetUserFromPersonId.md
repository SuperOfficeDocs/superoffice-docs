---
uid: services82-user-getuserfrompersonid
title: Services82.UserAgent.GetUserFromPersonId SOAP
Generated: true
---

# Services82 User GetUserFromPersonId SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetUserFromPersonId">SuperOffice.Services82.IUserAgent.GetUserFromPersonId</see> method.
