---
uid: services82-user-ispasswordvalid
title: Services82.UserAgent.IsPasswordValid SOAP
Generated: true
---

# Services82 User IsPasswordValid SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.IsPasswordValid">SuperOffice.Services82.IUserAgent.IsPasswordValid</see> method.
