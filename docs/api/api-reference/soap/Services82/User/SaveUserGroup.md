---
uid: services82-user-saveusergroup
title: Services82.UserAgent.SaveUserGroup SOAP
Generated: true
---

# Services82 User SaveUserGroup SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.SaveUserGroup">SuperOffice.Services82.IUserAgent.SaveUserGroup</see> method.
