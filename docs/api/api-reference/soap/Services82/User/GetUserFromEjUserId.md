---
uid: services82-user-getuserfromejuserid
title: Services82.UserAgent.GetUserFromEjUserId SOAP
Generated: true
---

# Services82 User GetUserFromEjUserId SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetUserFromEjUserId">SuperOffice.Services82.IUserAgent.GetUserFromEjUserId</see> method.
