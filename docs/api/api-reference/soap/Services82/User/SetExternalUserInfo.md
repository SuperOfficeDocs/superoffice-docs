---
uid: services82-user-setexternaluserinfo
title: Services82.UserAgent.SetExternalUserInfo SOAP
Generated: true
---

# Services82 User SetExternalUserInfo SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.SetExternalUserInfo">SuperOffice.Services82.IUserAgent.SetExternalUserInfo</see> method.
