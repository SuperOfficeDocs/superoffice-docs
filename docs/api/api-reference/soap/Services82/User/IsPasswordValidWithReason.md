---
uid: services82-user-ispasswordvalidwithreason
title: Services82.UserAgent.IsPasswordValidWithReason SOAP
Generated: true
---

# Services82 User IsPasswordValidWithReason SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.IsPasswordValidWithReason">SuperOffice.Services82.IUserAgent.IsPasswordValidWithReason</see> method.
