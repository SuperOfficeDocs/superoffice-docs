---
uid: services82-user-getusergroup
title: Services82.UserAgent.GetUserGroup SOAP
Generated: true
---

# Services82 User GetUserGroup SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetUserGroup">SuperOffice.Services82.IUserAgent.GetUserGroup</see> method.
