---
uid: services82-user-getallroles
title: Services82.UserAgent.GetAllRoles SOAP
Generated: true
---

# Services82 User GetAllRoles SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetAllRoles">SuperOffice.Services82.IUserAgent.GetAllRoles</see> method.
