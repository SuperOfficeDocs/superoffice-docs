---
uid: services82-user-changepasswordfromname
title: Services82.UserAgent.ChangePasswordFromName SOAP
Generated: true
---

# Services82 User ChangePasswordFromName SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.ChangePasswordFromName">SuperOffice.Services82.IUserAgent.ChangePasswordFromName</see> method.
