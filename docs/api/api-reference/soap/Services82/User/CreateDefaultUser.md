---
uid: services82-user-createdefaultuser
title: Services82.UserAgent.CreateDefaultUser SOAP
Generated: true
---

# Services82 User CreateDefaultUser SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.CreateDefaultUser">SuperOffice.Services82.IUserAgent.CreateDefaultUser</see> method.
