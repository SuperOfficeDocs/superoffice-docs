---
uid: services82-user-changeownpassword
title: Services82.UserAgent.ChangeOwnPassword SOAP
Generated: true
---

# Services82 User ChangeOwnPassword SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.ChangeOwnPassword">SuperOffice.Services82.IUserAgent.ChangeOwnPassword</see> method.
