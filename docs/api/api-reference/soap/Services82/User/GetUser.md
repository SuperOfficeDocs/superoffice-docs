---
uid: services82-user-getuser
title: Services82.UserAgent.GetUser SOAP
Generated: true
---

# Services82 User GetUser SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetUser">SuperOffice.Services82.IUserAgent.GetUser</see> method.
