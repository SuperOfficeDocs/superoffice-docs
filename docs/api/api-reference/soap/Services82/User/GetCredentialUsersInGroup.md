---
uid: services82-user-getcredentialusersingroup
title: Services82.UserAgent.GetCredentialUsersInGroup SOAP
Generated: true
---

# Services82 User GetCredentialUsersInGroup SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetCredentialUsersInGroup">SuperOffice.Services82.IUserAgent.GetCredentialUsersInGroup</see> method.
