---
uid: services82-user-getuserfromname
title: Services82.UserAgent.GetUserFromName SOAP
Generated: true
---

# Services82 User GetUserFromName SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetUserFromName">SuperOffice.Services82.IUserAgent.GetUserFromName</see> method.
