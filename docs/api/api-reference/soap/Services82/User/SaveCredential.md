---
uid: services82-user-savecredential
title: Services82.UserAgent.SaveCredential SOAP
Generated: true
---

# Services82 User SaveCredential SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.SaveCredential">SuperOffice.Services82.IUserAgent.SaveCredential</see> method.
