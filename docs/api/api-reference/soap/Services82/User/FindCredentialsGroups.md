---
uid: services82-user-findcredentialsgroups
title: Services82.UserAgent.FindCredentialsGroups SOAP
Generated: true
---

# Services82 User FindCredentialsGroups SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.FindCredentialsGroups">SuperOffice.Services82.IUserAgent.FindCredentialsGroups</see> method.
