---
uid: services82-user-getcredentialtypes
title: Services82.UserAgent.GetCredentialTypes SOAP
Generated: true
---

# Services82 User GetCredentialTypes SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetCredentialTypes">SuperOffice.Services82.IUserAgent.GetCredentialTypes</see> method.
