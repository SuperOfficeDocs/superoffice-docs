---
uid: services82-user
title: Services82.UserAgent SOAP
Generated: true
---

# Services82 User SOAP

SOAP request and response examples, and WSDL files for **Remote/Services82/User.svc**

Handled by the <see cref="T:SuperOffice.Services82.IUserAgent">SuperOffice.Services82.IUserAgent</see> interface.

Interface for the User Agent

Download [WSDL file for Services82/User](../Services82-User.md) if you need to generate your own proxy code.
