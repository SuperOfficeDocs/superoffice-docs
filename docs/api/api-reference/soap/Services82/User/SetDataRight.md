---
uid: services82-user-setdataright
title: Services82.UserAgent.SetDataRight SOAP
Generated: true
---

# Services82 User SetDataRight SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.SetDataRight">SuperOffice.Services82.IUserAgent.SetDataRight</see> method.
