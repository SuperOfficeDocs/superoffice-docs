---
uid: services82-user-getallfunctionalrights
title: Services82.UserAgent.GetAllFunctionalRights SOAP
Generated: true
---

# Services82 User GetAllFunctionalRights SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetAllFunctionalRights">SuperOffice.Services82.IUserAgent.GetAllFunctionalRights</see> method.
  ...
  <User:GetAllFunctionalRightsResponse>
   <User:Response xsi:type="User:ArrayOfSelectableMDOListItem">
    <User:SelectableMDOListItem xsi:type="User:SelectableMDOListItem">
     ...
     <User:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:34:57Z</User:LastChanged>
