---
uid: services82-user-getallusergroups
title: Services82.UserAgent.GetAllUserGroups SOAP
Generated: true
---

# Services82 User GetAllUserGroups SOAP

SOAP request and response examples **Remote/Services82/User.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IUserAgent.GetAllUserGroups">SuperOffice.Services82.IUserAgent.GetAllUserGroups</see> method.
