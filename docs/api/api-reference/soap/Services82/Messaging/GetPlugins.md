---
uid: services82-messaging-getplugins
title: Services82.MessagingAgent.GetPlugins SOAP
Generated: true
---

# Services82 Messaging GetPlugins SOAP

SOAP request and response examples **Remote/Services82/Messaging.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IMessagingAgent.GetPlugins">SuperOffice.Services82.IMessagingAgent.GetPlugins</see> method.
  ...
  <Messaging:GetPluginsResponse>
   <Messaging:Response xsi:type="Messaging:ArrayOfProviderInfo">
    <Messaging:ProviderInfo xsi:type="Messaging:ProviderInfo">
     ...
     <Messaging:SupportedMessagingFormats xsi:type="NetServerServices822:ArrayOfstring">
