---
uid: services82-foreignsystem-getdevicekeysondeviceidentifiertablerecordid
title: Services82.ForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId SOAP
Generated: true
---

# Services82 ForeignSystem GetDeviceKeysOnDeviceIdentifierTableRecordId SOAP

SOAP request and response examples **Remote/Services82/ForeignSystem.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId">SuperOffice.Services82.IForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId</see> method.
