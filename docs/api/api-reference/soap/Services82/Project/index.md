---
uid: services82-project
title: Services82.ProjectAgent SOAP
Generated: true
---

# Services82 Project SOAP

SOAP request and response examples, and WSDL files for **Remote/Services82/Project.svc**

Handled by the <see cref="T:SuperOffice.Services82.IProjectAgent">SuperOffice.Services82.IProjectAgent</see> interface.

Interface for the Project Agent
Collection of all services that works with Project data.

Download [WSDL file for Services82/Project](../Services82-Project.md) if you need to generate your own proxy code.
