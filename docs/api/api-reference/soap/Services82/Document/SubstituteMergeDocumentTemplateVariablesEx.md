---
uid: services82-document-substitutemergedocumenttemplatevariablesex
title: Services82.DocumentAgent.SubstituteMergeDocumentTemplateVariablesEx SOAP
Generated: true
---

# Services82 Document SubstituteMergeDocumentTemplateVariablesEx SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.SubstituteMergeDocumentTemplateVariablesEx">SuperOffice.Services82.IDocumentAgent.SubstituteMergeDocumentTemplateVariablesEx</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:SubstituteMergeDocumentTemplateVariablesEx>
    ...
    <Document:CustomTags xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    </Document:CustomTags>
    <Document:CustomValues xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
