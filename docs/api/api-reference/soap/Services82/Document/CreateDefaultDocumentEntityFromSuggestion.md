---
uid: services82-document-createdefaultdocumententityfromsuggestion
title: Services82.DocumentAgent.CreateDefaultDocumentEntityFromSuggestion SOAP
Generated: true
---

# Services82 Document CreateDefaultDocumentEntityFromSuggestion SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.CreateDefaultDocumentEntityFromSuggestion">SuperOffice.Services82.IDocumentAgent.CreateDefaultDocumentEntityFromSuggestion</see> method.
 ...
 <SOAP-ENV:Body>
  <Document:CreateDefaultDocumentEntityFromSuggestionResponse>
   <Document:Response xsi:type="Document:DocumentEntity">
    ...
    <Document:CreatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:CreatedDate>
    <Document:UpdatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:UpdatedDate>
    ...
    <Document:Project xsi:type="Document:Project">
     ...
     <Document:Updated xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:Updated>
     ...
     <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:PublishTo>
     <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:PublishFrom>
    ...
    <Document:Date xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:Date>
    ...
    <Document:Sale xsi:type="Document:Sale">
     <Document:ContactName xsi:type="xsd:string"></Document:ContactName>
     <Document:SaleDate xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:SaleDate>
     ...
     <Document:Completed xsi:type="Document:ActivityStatus">Unknown</Document:Completed>
     <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
     <Document:NextDueDate xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:NextDueDate>
    </Document:Sale>
    <Document:SuggestedDocumentId xsi:type="xsd:int">0</Document:SuggestedDocumentId>
    ...
    <Document:PublishEventDate xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:PublishEventDate>
    <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:PublishTo>
    <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:45Z</Document:PublishFrom>
    <Document:IsPublished xsi:type="xsd:boolean">false</Document:IsPublished>
