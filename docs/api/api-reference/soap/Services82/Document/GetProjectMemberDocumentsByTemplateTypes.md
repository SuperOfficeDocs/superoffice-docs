---
uid: services82-document-getprojectmemberdocumentsbytemplatetypes
title: Services82.DocumentAgent.GetProjectMemberDocumentsByTemplateTypes SOAP
Generated: true
---

# Services82 Document GetProjectMemberDocumentsByTemplateTypes SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.GetProjectMemberDocumentsByTemplateTypes">SuperOffice.Services82.IDocumentAgent.GetProjectMemberDocumentsByTemplateTypes</see> method.
