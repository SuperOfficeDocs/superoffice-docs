---
uid: services82-document-substitutetemplatevariableswithcustomtags
title: Services82.DocumentAgent.SubstituteTemplateVariablesWithCustomTags SOAP
Generated: true
---

# Services82 Document SubstituteTemplateVariablesWithCustomTags SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.SubstituteTemplateVariablesWithCustomTags">SuperOffice.Services82.IDocumentAgent.SubstituteTemplateVariablesWithCustomTags</see> method.
