---
uid: services82-document-getprojectmemberdocumentsbytemplateheading
title: Services82.DocumentAgent.GetProjectMemberDocumentsByTemplateHeading SOAP
Generated: true
---

# Services82 Document GetProjectMemberDocumentsByTemplateHeading SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading">SuperOffice.Services82.IDocumentAgent.GetProjectMemberDocumentsByTemplateHeading</see> method.
