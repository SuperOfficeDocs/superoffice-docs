---
uid: services82-document-getdocumentstreamfromentity
title: Services82.DocumentAgent.GetDocumentStreamFromEntity SOAP
Generated: true
---

# Services82 Document GetDocumentStreamFromEntity SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.GetDocumentStreamFromEntity">SuperOffice.Services82.IDocumentAgent.GetDocumentStreamFromEntity</see> method.
...
## GetDocumentStreamFromEntity Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:GetDocumentStreamFromEntity>
    <Document:DocumentEntity xsi:type="Document:DocumentEntity">
     ...
     <Document:CreatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:CreatedDate>
     <Document:UpdatedDate xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:UpdatedDate>
     ...
     <Document:Project xsi:type="Document:Project">
      ...
      <Document:Updated xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:Updated>
      ...
      <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:PublishTo>
      <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:PublishFrom>
     ...
     <Document:Date xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:Date>
     ...
     <Document:Sale xsi:type="Document:Sale">
      <Document:ContactName xsi:type="xsd:string"></Document:ContactName>
      <Document:SaleDate xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:SaleDate>
      ...
      <Document:Completed xsi:type="Document:ActivityStatus">Unknown</Document:Completed>
      <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
      <Document:NextDueDate xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:NextDueDate>
     </Document:Sale>
     ...
     <Document:PublishEventDate xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:PublishEventDate>
     <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:PublishTo>
     <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:34:44Z</Document:PublishFrom>
     <Document:IsPublished xsi:type="xsd:boolean">false</Document:IsPublished>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Document="http://www.superoffice.net/ws/crm/NetServer/Services82">
 <SOAP-ENV:Body>
  <Document:GetDocumentStreamFromEntityResponse>
