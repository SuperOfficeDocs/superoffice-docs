---
uid: services82-document-getdocumentlist
title: Services82.DocumentAgent.GetDocumentList SOAP
Generated: true
---

# Services82 Document GetDocumentList SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.GetDocumentList">SuperOffice.Services82.IDocumentAgent.GetDocumentList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:GetDocumentList>
    <Document:DocumentIds xsi:type="NetServerServices822:ArrayOfint">
