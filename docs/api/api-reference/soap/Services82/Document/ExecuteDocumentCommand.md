---
uid: services82-document-executedocumentcommand
title: Services82.DocumentAgent.ExecuteDocumentCommand SOAP
Generated: true
---

# Services82 Document ExecuteDocumentCommand SOAP

SOAP request and response examples **Remote/Services82/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IDocumentAgent.ExecuteDocumentCommand">SuperOffice.Services82.IDocumentAgent.ExecuteDocumentCommand</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:ExecuteDocumentCommand>
    ...
    <Document:AdditionalData xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
