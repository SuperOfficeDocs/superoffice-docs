---
uid: services82-appointment-getprojectappointmentsbytaskheading
title: Services82.AppointmentAgent.GetProjectAppointmentsByTaskHeading SOAP
Generated: true
---

# Services82 Appointment GetProjectAppointmentsByTaskHeading SOAP

SOAP request and response examples **Remote/Services82/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IAppointmentAgent.GetProjectAppointmentsByTaskHeading">SuperOffice.Services82.IAppointmentAgent.GetProjectAppointmentsByTaskHeading</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetProjectAppointmentsByTaskHeading>
    ...
    <Appointment:StartTime xsi:type="xsd:dateTime">2021-03-25T21:34:40Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2021-03-25T21:34:40Z</Appointment:EndTime>
  ...
  <Appointment:GetProjectAppointmentsByTaskHeadingResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2021-03-25T21:34:40Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2021-03-25T21:34:40Z</Appointment:RecurringEndDate>
