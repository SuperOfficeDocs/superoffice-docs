---
uid: services82-appointment-getalarms
title: Services82.AppointmentAgent.GetAlarms SOAP
Generated: true
---

# Services82 Appointment GetAlarms SOAP

SOAP request and response examples **Remote/Services82/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IAppointmentAgent.GetAlarms">SuperOffice.Services82.IAppointmentAgent.GetAlarms</see> method.
   ...
   <Appointment:Response xsi:type="Appointment:MultiAlarmData">
    <Appointment:Alarms xsi:type="Appointment:ArrayOfAlarmData">
     <Appointment:AlarmData xsi:type="Appointment:AlarmData">
      ...
      <Appointment:AlarmTime xsi:type="xsd:dateTime">2021-03-25T21:34:41Z</Appointment:AlarmTime>
