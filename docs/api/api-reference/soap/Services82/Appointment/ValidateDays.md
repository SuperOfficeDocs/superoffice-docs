---
uid: services82-appointment-validatedays
title: Services82.AppointmentAgent.ValidateDays SOAP
Generated: true
---

# Services82 Appointment ValidateDays SOAP

SOAP request and response examples **Remote/Services82/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IAppointmentAgent.ValidateDays">SuperOffice.Services82.IAppointmentAgent.ValidateDays</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateDays>
    ...
    <Appointment:Dates xsi:type="NetServerServices822:ArrayOfdateTime">
     <NetServerServices822:dateTime xsi:type="xsd:dateTime">2021-03-25T21:34:40Z</NetServerServices822:dateTime>
    </Appointment:Dates>
   </Appointment:ValidateDays>
