---
uid: services82-list-getcreditedlist
title: Services82.ListAgent.GetCreditedList SOAP
Generated: true
---

# Services82 List GetCreditedList SOAP

SOAP request and response examples **Remote/Services82/List.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IListAgent.GetCreditedList">SuperOffice.Services82.IListAgent.GetCreditedList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetCreditedList>
    <List:CreditedIds xsi:type="NetServerServices822:ArrayOfint">
