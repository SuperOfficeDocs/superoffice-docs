---
uid: services82-list-getsaletypeentity
title: Services82.ListAgent.GetSaleTypeEntity SOAP
Generated: true
---

# Services82 List GetSaleTypeEntity SOAP

SOAP request and response examples **Remote/Services82/List.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IListAgent.GetSaleTypeEntity">SuperOffice.Services82.IListAgent.GetSaleTypeEntity</see> method.
   ...
   <List:Response xsi:type="List:SaleTypeEntity">
    ...
    <List:Stages xsi:type="List:ArrayOfSelectableMDOListItem">
     <List:SelectableMDOListItem xsi:type="List:SelectableMDOListItem">
      ...
      <List:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:34:49Z</List:LastChanged>
