---
uid: services82-contact
title: Services82.ContactAgent SOAP
Generated: true
---

# Services82 Contact SOAP

SOAP request and response examples, and WSDL files for **Remote/Services82/Contact.svc**

Handled by the <see cref="T:SuperOffice.Services82.IContactAgent">SuperOffice.Services82.IContactAgent</see> interface.

Interface for the Contact Agent
Collection of all services that works with Contact (company) data.

Download [WSDL file for Services82/Contact](../Services82-Contact.md) if you need to generate your own proxy code.
