---
uid: services82-contact-getquoteversionaddresses
title: Services82.ContactAgent.GetQuoteVersionAddresses SOAP
Generated: true
---

# Services82 Contact GetQuoteVersionAddresses SOAP

SOAP request and response examples **Remote/Services82/Contact.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IContactAgent.GetQuoteVersionAddresses">SuperOffice.Services82.IContactAgent.GetQuoteVersionAddresses</see> method.
