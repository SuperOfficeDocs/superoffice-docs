---
uid: services82-configuration-getdiaryviewentity
title: Services82.ConfigurationAgent.GetDiaryViewEntity SOAP
Generated: true
---

# Services82 Configuration GetDiaryViewEntity SOAP

SOAP request and response examples **Remote/Services82/Configuration.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IConfigurationAgent.GetDiaryViewEntity">SuperOffice.Services82.IConfigurationAgent.GetDiaryViewEntity</see> method.
   ...
   <Configuration:Response xsi:type="Configuration:DiaryViewEntity">
    ...
    <Configuration:AssociateList xsi:type="Configuration:ArrayOfSelectableMDOListItem">
     <Configuration:SelectableMDOListItem xsi:type="Configuration:SelectableMDOListItem">
      ...
      <Configuration:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:34:43Z</Configuration:LastChanged>
