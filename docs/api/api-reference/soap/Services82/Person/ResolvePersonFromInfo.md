---
uid: services82-person-resolvepersonfrominfo
title: Services82.PersonAgent.ResolvePersonFromInfo SOAP
Generated: true
---

# Services82 Person ResolvePersonFromInfo SOAP

SOAP request and response examples **Remote/Services82/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services82.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    ...
    <Person:PhoneNumbers xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
