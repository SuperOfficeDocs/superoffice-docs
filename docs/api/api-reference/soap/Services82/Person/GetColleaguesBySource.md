---
uid: services82-person-getcolleaguesbysource
title: Services82.PersonAgent.GetColleaguesBySource SOAP
Generated: true
---

# Services82 Person GetColleaguesBySource SOAP

SOAP request and response examples **Remote/Services82/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IPersonAgent.GetColleaguesBySource">SuperOffice.Services82.IPersonAgent.GetColleaguesBySource</see> method.
...
* **sourceType:** The “source” the colleagues should be retrieved from. <see cref="T:SuperOffice.Services82.AssociateSourceType" /> for more information.
* **count:** 
