---
uid: services82-soprincipal-authenticateimplicit
title: Services82.SoPrincipalAgent.AuthenticateImplicit SOAP
Generated: true
---

# Services82 SoPrincipal AuthenticateImplicit SOAP

SOAP request and response examples **Remote/Services82/SoPrincipal.svc**
Implemented by the <see cref="M:SuperOffice.Services82.ISoPrincipalAgent.AuthenticateImplicit">SuperOffice.Services82.ISoPrincipalAgent.AuthenticateImplicit</see> method.
 ...
 <SOAP-ENV:Body>
  <SoPrincipal:AuthenticateResponse>
   <SoPrincipal:Response xsi:type="SoPrincipal:SoPrincipalCarrier">
    ...
    <SoPrincipal:FunctionRights xsi:type="NetServerServices823:ArrayOfstring">
     <NetServerServices823:string xsi:type="xsd:string"></NetServerServices823:string>
    ...
    <SoPrincipal:SecondaryGroups xsi:type="NetServerServices823:ArrayOfint">
     <NetServerServices823:int xsi:type="xsd:int">0</NetServerServices823:int>
