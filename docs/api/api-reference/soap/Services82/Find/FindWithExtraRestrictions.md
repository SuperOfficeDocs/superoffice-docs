---
uid: services82-find-findwithextrarestrictions
title: Services82.FindAgent.FindWithExtraRestrictions SOAP
Generated: true
---

# Services82 Find FindWithExtraRestrictions SOAP

SOAP request and response examples **Remote/Services82/Find.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IFindAgent.FindWithExtraRestrictions">SuperOffice.Services82.IFindAgent.FindWithExtraRestrictions</see> method.
   ...
   <Find:FindWithExtraRestrictions>
    ...
    <Find:ExtraRestrictions xsi:type="Find:ArrayOfArchiveRestrictionInfo">
     <Find:ArchiveRestrictionInfo xsi:type="Find:ArchiveRestrictionInfo">
      ...
      <Find:Values xsi:type="NetServerServices822:ArrayOfstring">
       <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
      </Find:Values>
      <Find:DisplayValues xsi:type="NetServerServices822:ArrayOfstring">
       <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
      </Find:DisplayValues>
    ...
    <Find:DesiredColumns xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    </Find:DesiredColumns>
