---
uid: services82-import-createerpimportdata
title: Services82.ImportAgent.CreateErpImportData SOAP
Generated: true
---

# Services82 Import CreateErpImportData SOAP

SOAP request and response examples **Remote/Services82/Import.svc**
Implemented by the <see cref="M:SuperOffice.Services82.IImportAgent.CreateErpImportData">SuperOffice.Services82.IImportAgent.CreateErpImportData</see> method.
   ...
   <Import:CreateErpImportData>
    <Import:Restriction xsi:type="Import:ArrayOfArchiveRestrictionInfo">
     <Import:ArchiveRestrictionInfo xsi:type="Import:ArchiveRestrictionInfo">
      ...
      <Import:DisplayValues xsi:type="NetServerServices822:ArrayOfstring">
       <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    ...
    <Import:Columns xsi:type="NetServerServices822:ArrayOfstring">
     <NetServerServices822:string xsi:type="xsd:string"></NetServerServices822:string>
    </Import:Columns>
