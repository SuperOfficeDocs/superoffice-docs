---
uid: services82-erpsync
title: Services82.ErpSyncAgent SOAP
Generated: true
---

# Services82 ErpSync SOAP

SOAP request and response examples, and WSDL files for **Remote/Services82/ErpSync.svc**

Handled by the <see cref="T:SuperOffice.Services82.IErpSyncAgent">SuperOffice.Services82.IErpSyncAgent</see> interface.

Interface for the ErpSync Agent
Services for the ERP Integration Services feature

Download [WSDL file for Services82/ErpSync](../Services82-ErpSync.md) if you need to generate your own proxy code.
