---
uid: services75-project
title: Services75.ProjectAgent SOAP
Generated: true
---

# Services75 Project SOAP

SOAP request and response examples, and WSDL files for **Remote/Services75/Project.svc**

Handled by the <see cref="T:SuperOffice.Services75.IProjectAgent">SuperOffice.Services75.IProjectAgent</see> interface.

Interface for the Project Agent
Collection of all services that works with Project data.

Download [WSDL file for Services75/Project](../Services75-Project.md) if you need to generate your own proxy code.
