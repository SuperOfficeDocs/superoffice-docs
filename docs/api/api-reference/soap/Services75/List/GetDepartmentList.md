---
uid: services75-list-getdepartmentlist
title: Services75.ListAgent.GetDepartmentList SOAP
Generated: true
---

# Services75 List GetDepartmentList SOAP

SOAP request and response examples **Remote/Services75/List.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IListAgent.GetDepartmentList">SuperOffice.Services75.IListAgent.GetDepartmentList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetDepartmentList>
    <List:DepartmentIds xsi:type="NetServerServices752:ArrayOfint">
