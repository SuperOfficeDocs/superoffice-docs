---
uid: services75-list-gettask
title: Services75.ListAgent.GetTask SOAP
Generated: true
---

# Services75 List GetTask SOAP

SOAP request and response examples **Remote/Services75/List.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IListAgent.GetTask">SuperOffice.Services75.IListAgent.GetTask</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetTask>
    <List:TaskId xsi:type="xsd:int">0</List:TaskId>
   </List:GetTask>
