---
uid: services75-list-getlanguageinfolist
title: Services75.ListAgent.GetLanguageInfoList SOAP
Generated: true
---

# Services75 List GetLanguageInfoList SOAP

SOAP request and response examples **Remote/Services75/List.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IListAgent.GetLanguageInfoList">SuperOffice.Services75.IListAgent.GetLanguageInfoList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetLanguageInfoList>
    <List:LanguageInfoIds xsi:type="NetServerServices752:ArrayOfint">
