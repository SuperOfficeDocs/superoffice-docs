---
uid: services75-list-getdocumenttemplatelist
title: Services75.ListAgent.GetDocumentTemplateList SOAP
Generated: true
---

# Services75 List GetDocumentTemplateList SOAP

SOAP request and response examples **Remote/Services75/List.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IListAgent.GetDocumentTemplateList">SuperOffice.Services75.IListAgent.GetDocumentTemplateList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetDocumentTemplateList>
    <List:DocumentTemplateIds xsi:type="NetServerServices752:ArrayOfint">
