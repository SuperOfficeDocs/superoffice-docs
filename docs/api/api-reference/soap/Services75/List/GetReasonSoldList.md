---
uid: services75-list-getreasonsoldlist
title: Services75.ListAgent.GetReasonSoldList SOAP
Generated: true
---

# Services75 List GetReasonSoldList SOAP

SOAP request and response examples **Remote/Services75/List.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IListAgent.GetReasonSoldList">SuperOffice.Services75.IListAgent.GetReasonSoldList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <List:GetReasonSoldList>
    <List:ReasonSoldIds xsi:type="NetServerServices752:ArrayOfint">
