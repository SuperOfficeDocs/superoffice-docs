---
uid: services75-list-getdepartments
title: Services75.ListAgent.GetDepartments SOAP
Generated: true
---

# Services75 List GetDepartments SOAP

SOAP request and response examples **Remote/Services75/List.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IListAgent.GetDepartments">SuperOffice.Services75.IListAgent.GetDepartments</see> method.

## GetDepartments

Getting all departments for the internal phone list with the user's colleagues.
