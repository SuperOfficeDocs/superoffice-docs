---
uid: services75-blob
title: Services75.BLOBAgent SOAP
Generated: true
---

# Services75 BLOB SOAP

SOAP request and response examples, and WSDL files for **Remote/Services75/BLOB.svc**

Handled by the <see cref="T:SuperOffice.Services75.IBLOBAgent">SuperOffice.Services75.IBLOBAgent</see> interface.

Interface for the BLOB Agent
Collection of all services that works with binary objects (BLOBS), e.g. Images and documents.

Download [WSDL file for Services75/BLOB](../Services75-BLOB.md) if you need to generate your own proxy code.
