---
uid: services75-person-resolvepersonfrominfo
title: Services75.PersonAgent.ResolvePersonFromInfo SOAP
Generated: true
---

# Services75 Person ResolvePersonFromInfo SOAP

SOAP request and response examples **Remote/Services75/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services75.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    ...
    <Person:PhoneNumbers xsi:type="NetServerServices752:ArrayOfstring">
     <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices752:ArrayOfstring">
     <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
