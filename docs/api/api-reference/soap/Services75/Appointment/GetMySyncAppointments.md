---
uid: services75-appointment-getmysyncappointments
title: Services75.AppointmentAgent.GetMySyncAppointments SOAP
Generated: true
---

# Services75 Appointment GetMySyncAppointments SOAP

SOAP request and response examples **Remote/Services75/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IAppointmentAgent.GetMySyncAppointments">SuperOffice.Services75.IAppointmentAgent.GetMySyncAppointments</see> method.
    ...
    <Appointment:AppointmentSyncData xsi:type="Appointment:AppointmentSyncData">
     ...
     <Appointment:Participants xsi:type="Appointment:ArrayOfParticipantSyncData">
      <Appointment:ParticipantSyncData xsi:type="Appointment:ParticipantSyncData">
       ...
       <Appointment:ContactFullName xsi:type="xsd:string"></Appointment:ContactFullName>
       <Appointment:EMail xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:EMail>
       <Appointment:PhonePrivate xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:PhonePrivate>
       <Appointment:PhoneFax xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:PhoneFax>
       <Appointment:PhoneMobile xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:PhoneMobile>
       <Appointment:PhoneDirect xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:PhoneDirect>
       <Appointment:PhoneContact xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:PhoneContact>
       <Appointment:Messenger xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:Messenger>
       <Appointment:Voip xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:Voip>
       <Appointment:ContactUrl xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:ContactUrl>
       <Appointment:Url xsi:type="NetServerServices752:ArrayOfstring">
        <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
       </Appointment:Url>
