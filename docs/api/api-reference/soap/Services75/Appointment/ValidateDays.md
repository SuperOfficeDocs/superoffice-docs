---
uid: services75-appointment-validatedays
title: Services75.AppointmentAgent.ValidateDays SOAP
Generated: true
---

# Services75 Appointment ValidateDays SOAP

SOAP request and response examples **Remote/Services75/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IAppointmentAgent.ValidateDays">SuperOffice.Services75.IAppointmentAgent.ValidateDays</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateDays>
    ...
    <Appointment:Dates xsi:type="NetServerServices752:ArrayOfdateTime">
     <NetServerServices752:dateTime xsi:type="xsd:dateTime">2021-03-25T21:32:17Z</NetServerServices752:dateTime>
    </Appointment:Dates>
   </Appointment:ValidateDays>
