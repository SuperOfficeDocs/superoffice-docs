---
uid: services75-appointment-getprojectmemberappointmentsbytaskheading
title: Services75.AppointmentAgent.GetProjectMemberAppointmentsByTaskHeading SOAP
Generated: true
---

# Services75 Appointment GetProjectMemberAppointmentsByTaskHeading SOAP

SOAP request and response examples **Remote/Services75/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IAppointmentAgent.GetProjectMemberAppointmentsByTaskHeading">SuperOffice.Services75.IAppointmentAgent.GetProjectMemberAppointmentsByTaskHeading</see> method.
