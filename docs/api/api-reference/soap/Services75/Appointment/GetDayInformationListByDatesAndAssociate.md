---
uid: services75-appointment-getdayinformationlistbydatesandassociate
title: Services75.AppointmentAgent.GetDayInformationListByDatesAndAssociate SOAP
Generated: true
---

# Services75 Appointment GetDayInformationListByDatesAndAssociate SOAP

SOAP request and response examples **Remote/Services75/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IAppointmentAgent.GetDayInformationListByDatesAndAssociate">SuperOffice.Services75.IAppointmentAgent.GetDayInformationListByDatesAndAssociate</see> method.
