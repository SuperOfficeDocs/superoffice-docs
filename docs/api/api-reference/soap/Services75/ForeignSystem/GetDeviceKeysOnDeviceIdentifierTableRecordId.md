---
uid: services75-foreignsystem-getdevicekeysondeviceidentifiertablerecordid
title: Services75.ForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId SOAP
Generated: true
---

# Services75 ForeignSystem GetDeviceKeysOnDeviceIdentifierTableRecordId SOAP

SOAP request and response examples **Remote/Services75/ForeignSystem.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId">SuperOffice.Services75.IForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTableRecordId</see> method.
