---
uid: services75-sale
title: Services75.SaleAgent SOAP
Generated: true
---

# Services75 Sale SOAP

SOAP request and response examples, and WSDL files for **Remote/Services75/Sale.svc**

Handled by the <see cref="T:SuperOffice.Services75.ISaleAgent">SuperOffice.Services75.ISaleAgent</see> interface.

Interface for the Sale Agent
Collection of all services that works with Sale data.

Download [WSDL file for Services75/Sale](../Services75-Sale.md) if you need to generate your own proxy code.
