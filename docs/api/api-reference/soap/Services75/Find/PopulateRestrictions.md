---
uid: services75-find-populaterestrictions
title: Services75.FindAgent.PopulateRestrictions SOAP
Generated: true
---

# Services75 Find PopulateRestrictions SOAP

SOAP request and response examples **Remote/Services75/Find.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IFindAgent.PopulateRestrictions">SuperOffice.Services75.IFindAgent.PopulateRestrictions</see> method.
      ...
      <Find:ArchiveRestrictionInfo xsi:type="Find:ArchiveRestrictionInfo">
       ...
       <Find:SubRestrictions xsi:type="Find:ArrayOfArchiveRestrictionInfo">
        <Find:ArchiveRestrictionInfo xsi:type="Find:ArchiveRestrictionInfo">
         ...
         <Find:Operator xsi:type="xsd:string"></Find:Operator>
         <Find:Values xsi:type="NetServerServices752:ArrayOfstring">
          <NetServerServices752:string xsi:nil="true"></NetServerServices752:string>
         </Find:Values>
         <Find:DisplayValues xsi:type="NetServerServices752:ArrayOfstring">
          <NetServerServices752:string xsi:nil="true"></NetServerServices752:string>
         </Find:DisplayValues>
