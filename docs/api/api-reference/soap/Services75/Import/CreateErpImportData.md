---
uid: services75-import-createerpimportdata
title: Services75.ImportAgent.CreateErpImportData SOAP
Generated: true
---

# Services75 Import CreateErpImportData SOAP

SOAP request and response examples **Remote/Services75/Import.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IImportAgent.CreateErpImportData">SuperOffice.Services75.IImportAgent.CreateErpImportData</see> method.
   ...
   <Import:CreateErpImportData>
    <Import:Restriction xsi:type="Import:ArrayOfArchiveRestrictionInfo">
     <Import:ArchiveRestrictionInfo xsi:type="Import:ArchiveRestrictionInfo">
      ...
      <Import:DisplayValues xsi:type="NetServerServices752:ArrayOfstring">
       <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
    ...
    <Import:Columns xsi:type="NetServerServices752:ArrayOfstring">
     <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
    </Import:Columns>
