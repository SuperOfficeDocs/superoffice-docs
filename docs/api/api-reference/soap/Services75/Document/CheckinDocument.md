---
uid: services75-document-checkindocument
title: Services75.DocumentAgent.CheckinDocument SOAP
Generated: true
---

# Services75 Document CheckinDocument SOAP

SOAP request and response examples **Remote/Services75/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IDocumentAgent.CheckinDocument">SuperOffice.Services75.IDocumentAgent.CheckinDocument</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:CheckinDocument>
    ...
    <Document:VersionExtraFields xsi:type="NetServerServices752:ArrayOfstring">
     <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
