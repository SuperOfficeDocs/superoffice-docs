---
uid: services75-document-getversionlist
title: Services75.DocumentAgent.GetVersionList SOAP
Generated: true
---

# Services75 Document GetVersionList SOAP

SOAP request and response examples **Remote/Services75/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IDocumentAgent.GetVersionList">SuperOffice.Services75.IDocumentAgent.GetVersionList</see> method.
  ...
  <Document:GetVersionListResponse>
   <Document:Response xsi:type="Document:ArrayOfVersionInfo">
    <Document:VersionInfo xsi:type="Document:VersionInfo">
     ...
     <Document:CheckedInDate xsi:type="xsd:dateTime">2021-03-25T21:32:22Z</Document:CheckedInDate>
     ...
     <Document:ExtraFields xsi:type="NetServerServices752:ArrayOfstring">
