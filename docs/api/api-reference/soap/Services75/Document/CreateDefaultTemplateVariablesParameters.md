---
uid: services75-document-createdefaulttemplatevariablesparameters
title: Services75.DocumentAgent.CreateDefaultTemplateVariablesParameters SOAP
Generated: true
---

# Services75 Document CreateDefaultTemplateVariablesParameters SOAP

SOAP request and response examples **Remote/Services75/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IDocumentAgent.CreateDefaultTemplateVariablesParameters">SuperOffice.Services75.IDocumentAgent.CreateDefaultTemplateVariablesParameters</see> method.
 ...
 <SOAP-ENV:Body>
  <Document:CreateDefaultTemplateVariablesParametersResponse>
   <Document:Response xsi:type="Document:TemplateVariablesParameters">
    ...
    <Document:CustomTags xsi:type="NetServerServices752:ArrayOfArrayOfstring">
     <NetServerServices752:ArrayOfstring xsi:type="NetServerServices752:ArrayOfstring">
      <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
     </NetServerServices752:ArrayOfstring>
    </Document:CustomTags>
    <Document:DocumentEntity xsi:type="Document:DocumentEntity">
     ...
     <Document:CreatedDate xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:CreatedDate>
     <Document:UpdatedDate xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:UpdatedDate>
     ...
     <Document:Project xsi:type="Document:Project">
      ...
      <Document:Updated xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:Updated>
      ...
      <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:PublishTo>
      <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:PublishFrom>
     ...
     <Document:Date xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:Date>
     ...
     <Document:Sale xsi:type="Document:Sale">
      <Document:ContactName xsi:type="xsd:string"></Document:ContactName>
      <Document:SaleDate xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:SaleDate>
      <Document:SaleId xsi:type="xsd:int">0</Document:SaleId>
     ...
     <Document:PublishEventDate xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:PublishEventDate>
     <Document:PublishTo xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:PublishTo>
     <Document:PublishFrom xsi:type="xsd:dateTime">2021-03-25T21:32:21Z</Document:PublishFrom>
     <Document:IsPublished xsi:type="xsd:boolean">false</Document:IsPublished>
