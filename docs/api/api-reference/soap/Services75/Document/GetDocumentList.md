---
uid: services75-document-getdocumentlist
title: Services75.DocumentAgent.GetDocumentList SOAP
Generated: true
---

# Services75 Document GetDocumentList SOAP

SOAP request and response examples **Remote/Services75/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IDocumentAgent.GetDocumentList">SuperOffice.Services75.IDocumentAgent.GetDocumentList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:GetDocumentList>
    <Document:DocumentIds xsi:type="NetServerServices752:ArrayOfint">
