---
uid: services75-document-executedocumentcommand
title: Services75.DocumentAgent.ExecuteDocumentCommand SOAP
Generated: true
---

# Services75 Document ExecuteDocumentCommand SOAP

SOAP request and response examples **Remote/Services75/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IDocumentAgent.ExecuteDocumentCommand">SuperOffice.Services75.IDocumentAgent.ExecuteDocumentCommand</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:ExecuteDocumentCommand>
    ...
    <Document:AdditionalData xsi:type="NetServerServices752:ArrayOfstring">
     <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
