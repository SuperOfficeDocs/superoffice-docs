---
uid: services75-user-getallusergroups
title: Services75.UserAgent.GetAllUserGroups SOAP
Generated: true
---

# Services75 User GetAllUserGroups SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetAllUserGroups">SuperOffice.Services75.IUserAgent.GetAllUserGroups</see> method.
