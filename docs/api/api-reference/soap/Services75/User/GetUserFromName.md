---
uid: services75-user-getuserfromname
title: Services75.UserAgent.GetUserFromName SOAP
Generated: true
---

# Services75 User GetUserFromName SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetUserFromName">SuperOffice.Services75.IUserAgent.GetUserFromName</see> method.
