---
uid: services75-user-getallfunctionalrights
title: Services75.UserAgent.GetAllFunctionalRights SOAP
Generated: true
---

# Services75 User GetAllFunctionalRights SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetAllFunctionalRights">SuperOffice.Services75.IUserAgent.GetAllFunctionalRights</see> method.
  ...
  <User:GetAllFunctionalRightsResponse>
   <User:Response xsi:type="User:ArrayOfSelectableMDOListItem">
    <User:SelectableMDOListItem xsi:type="User:SelectableMDOListItem">
     ...
     <User:LastChanged xsi:type="xsd:dateTime">2021-03-25T21:34:02Z</User:LastChanged>
