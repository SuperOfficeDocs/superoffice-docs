---
uid: services75-user-getvalidusername
title: Services75.UserAgent.GetValidUserName SOAP
Generated: true
---

# Services75 User GetValidUserName SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetValidUserName">SuperOffice.Services75.IUserAgent.GetValidUserName</see> method.
