---
uid: services75-user-getuntrustedcredentials
title: Services75.UserAgent.GetUntrustedCredentials SOAP
Generated: true
---

# Services75 User GetUntrustedCredentials SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetUntrustedCredentials">SuperOffice.Services75.IUserAgent.GetUntrustedCredentials</see> method.
