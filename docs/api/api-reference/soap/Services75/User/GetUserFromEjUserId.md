---
uid: services75-user-getuserfromejuserid
title: Services75.UserAgent.GetUserFromEjUserId SOAP
Generated: true
---

# Services75 User GetUserFromEjUserId SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetUserFromEjUserId">SuperOffice.Services75.IUserAgent.GetUserFromEjUserId</see> method.
