---
uid: services75-user-getusergroup
title: Services75.UserAgent.GetUserGroup SOAP
Generated: true
---

# Services75 User GetUserGroup SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetUserGroup">SuperOffice.Services75.IUserAgent.GetUserGroup</see> method.
