---
uid: services75-user-getuser
title: Services75.UserAgent.GetUser SOAP
Generated: true
---

# Services75 User GetUser SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetUser">SuperOffice.Services75.IUserAgent.GetUser</see> method.
