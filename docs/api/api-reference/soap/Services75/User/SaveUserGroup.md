---
uid: services75-user-saveusergroup
title: Services75.UserAgent.SaveUserGroup SOAP
Generated: true
---

# Services75 User SaveUserGroup SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.SaveUserGroup">SuperOffice.Services75.IUserAgent.SaveUserGroup</see> method.
