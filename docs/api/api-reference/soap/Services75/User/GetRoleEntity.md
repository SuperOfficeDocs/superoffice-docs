---
uid: services75-user-getroleentity
title: Services75.UserAgent.GetRoleEntity SOAP
Generated: true
---

# Services75 User GetRoleEntity SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetRoleEntity">SuperOffice.Services75.IUserAgent.GetRoleEntity</see> method.
