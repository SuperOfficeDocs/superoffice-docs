---
uid: services75-user-getallroles
title: Services75.UserAgent.GetAllRoles SOAP
Generated: true
---

# Services75 User GetAllRoles SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetAllRoles">SuperOffice.Services75.IUserAgent.GetAllRoles</see> method.
