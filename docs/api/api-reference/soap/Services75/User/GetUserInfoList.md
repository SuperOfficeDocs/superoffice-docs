---
uid: services75-user-getuserinfolist
title: Services75.UserAgent.GetUserInfoList SOAP
Generated: true
---

# Services75 User GetUserInfoList SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetUserInfoList">SuperOffice.Services75.IUserAgent.GetUserInfoList</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:GetUserInfoList>
    <User:UserInfoIds xsi:type="NetServerServices752:ArrayOfint">
  ...
  <User:GetUserInfoListResponse>
   <User:Response xsi:type="User:ArrayOfUserInfo">
    <User:UserInfo xsi:type="User:UserInfo">
     ...
     <User:GrantedLicenses xsi:type="NetServerServices752:ArrayOfstring">
