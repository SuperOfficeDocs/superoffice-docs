---
uid: services75-user-ispasswordvalid
title: Services75.UserAgent.IsPasswordValid SOAP
Generated: true
---

# Services75 User IsPasswordValid SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.IsPasswordValid">SuperOffice.Services75.IUserAgent.IsPasswordValid</see> method.
