---
uid: services75-user-resolveuserfrominfo
title: Services75.UserAgent.ResolveUserFromInfo SOAP
Generated: true
---

# Services75 User ResolveUserFromInfo SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.ResolveUserFromInfo">SuperOffice.Services75.IUserAgent.ResolveUserFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:ResolveUserFromInfo>
    ...
    <User:PhoneNumbers xsi:type="NetServerServices752:ArrayOfstring">
     <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
    </User:PhoneNumbers>
    <User:Emails xsi:type="NetServerServices752:ArrayOfstring">
     <NetServerServices752:string xsi:type="xsd:string"></NetServerServices752:string>
    </User:Emails>
  ...
  <User:ResolveUserFromInfoResponse>
   <User:Response xsi:type="User:ResolvedUser">
    <User:User xsi:type="User:User">
     ...
     <User:Lastlogin xsi:type="xsd:dateTime">2021-03-25T21:34:03Z</User:Lastlogin>
     <User:Lastlogout xsi:type="xsd:dateTime">2021-03-25T21:34:03Z</User:Lastlogout>
