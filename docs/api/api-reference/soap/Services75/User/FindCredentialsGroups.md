---
uid: services75-user-findcredentialsgroups
title: Services75.UserAgent.FindCredentialsGroups SOAP
Generated: true
---

# Services75 User FindCredentialsGroups SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.FindCredentialsGroups">SuperOffice.Services75.IUserAgent.FindCredentialsGroups</see> method.
