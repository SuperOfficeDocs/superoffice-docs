---
uid: services75-user-changeownpassword
title: Services75.UserAgent.ChangeOwnPassword SOAP
Generated: true
---

# Services75 User ChangeOwnPassword SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.ChangeOwnPassword">SuperOffice.Services75.IUserAgent.ChangeOwnPassword</see> method.
