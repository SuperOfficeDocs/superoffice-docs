---
uid: services75-user-findcredentialusers
title: Services75.UserAgent.FindCredentialUsers SOAP
Generated: true
---

# Services75 User FindCredentialUsers SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.FindCredentialUsers">SuperOffice.Services75.IUserAgent.FindCredentialUsers</see> method.
