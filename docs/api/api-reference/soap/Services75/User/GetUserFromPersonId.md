---
uid: services75-user-getuserfrompersonid
title: Services75.UserAgent.GetUserFromPersonId SOAP
Generated: true
---

# Services75 User GetUserFromPersonId SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.GetUserFromPersonId">SuperOffice.Services75.IUserAgent.GetUserFromPersonId</see> method.
