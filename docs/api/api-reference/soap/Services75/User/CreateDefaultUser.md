---
uid: services75-user-createdefaultuser
title: Services75.UserAgent.CreateDefaultUser SOAP
Generated: true
---

# Services75 User CreateDefaultUser SOAP

SOAP request and response examples **Remote/Services75/User.svc**
Implemented by the <see cref="M:SuperOffice.Services75.IUserAgent.CreateDefaultUser">SuperOffice.Services75.IUserAgent.CreateDefaultUser</see> method.
