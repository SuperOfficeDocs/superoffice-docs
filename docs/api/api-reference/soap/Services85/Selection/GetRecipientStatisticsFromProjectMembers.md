---
uid: services85-selection-getrecipientstatisticsfromprojectmembers
title: Services85.SelectionAgent.GetRecipientStatisticsFromProjectMembers SOAP
Generated: true
---

# Services85 Selection GetRecipientStatisticsFromProjectMembers SOAP

SOAP request and response examples **Remote/Services85/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services85.ISelectionAgent.GetRecipientStatisticsFromProjectMembers">SuperOffice.Services85.ISelectionAgent.GetRecipientStatisticsFromProjectMembers</see> method.
