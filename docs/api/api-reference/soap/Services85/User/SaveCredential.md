---
uid: services85-user-savecredential
title: Services85.UserAgent.SaveCredential SOAP
Generated: true
---

# Services85 User SaveCredential SOAP

SOAP request and response examples **Remote/Services85/User.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IUserAgent.SaveCredential">SuperOffice.Services85.IUserAgent.SaveCredential</see> method.
