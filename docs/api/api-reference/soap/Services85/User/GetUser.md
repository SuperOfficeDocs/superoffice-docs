---
uid: services85-user-getuser
title: Services85.UserAgent.GetUser SOAP
Generated: true
---

# Services85 User GetUser SOAP

SOAP request and response examples **Remote/Services85/User.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IUserAgent.GetUser">SuperOffice.Services85.IUserAgent.GetUser</see> method.
