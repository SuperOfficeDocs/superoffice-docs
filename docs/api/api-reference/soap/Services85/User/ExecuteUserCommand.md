---
uid: services85-user-executeusercommand
title: Services85.UserAgent.ExecuteUserCommand SOAP
Generated: true
---

# Services85 User ExecuteUserCommand SOAP

SOAP request and response examples **Remote/Services85/User.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IUserAgent.ExecuteUserCommand">SuperOffice.Services85.IUserAgent.ExecuteUserCommand</see> method.
