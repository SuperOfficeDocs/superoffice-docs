---
uid: services85-appointment-getmysyncappointments
title: Services85.AppointmentAgent.GetMySyncAppointments SOAP
Generated: true
---

# Services85 Appointment GetMySyncAppointments SOAP

SOAP request and response examples **Remote/Services85/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IAppointmentAgent.GetMySyncAppointments">SuperOffice.Services85.IAppointmentAgent.GetMySyncAppointments</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetMySyncAppointments>
    ...
    <Appointment:EndTime xsi:type="xsd:dateTime">2021-03-25T21:35:40Z</Appointment:EndTime>
   </Appointment:GetMySyncAppointments>
    ...
    <Appointment:AppointmentSyncData xsi:type="Appointment:AppointmentSyncData">
     ...
     <Appointment:Participants xsi:type="Appointment:ArrayOfParticipantSyncData">
      <Appointment:ParticipantSyncData xsi:type="Appointment:ParticipantSyncData">
       ...
       <Appointment:ContactFullName xsi:type="xsd:string"></Appointment:ContactFullName>
       <Appointment:EMail xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:EMail>
       <Appointment:PhonePrivate xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:PhonePrivate>
       <Appointment:PhoneFax xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:PhoneFax>
       <Appointment:PhoneMobile xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:PhoneMobile>
       <Appointment:PhoneDirect xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:PhoneDirect>
       <Appointment:PhoneContact xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:PhoneContact>
       <Appointment:Messenger xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:Messenger>
       <Appointment:Voip xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:Voip>
       <Appointment:ContactUrl xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:ContactUrl>
       <Appointment:Url xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
       </Appointment:Url>
