...
# Mandatory fields.
title: variables_from_senders_company_card       # (Required) Very important for SEO. Intent in a unique string of 43-59 chars including spaces.
description: Variables from the sender’s own company card # (Required) Important for SEO. Recommended character length is 115-145 characters including spaces.
