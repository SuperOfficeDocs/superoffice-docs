...
|link\_id|Connection to a link that the customer clicked on|FK [s_link](s_link.md)| |
|shipment\_id|Which shipment the customer received.|FK [s_shipment](s_shipment.md)| |
|pressed|When the link was clicked.|DateTime|&#x25CF;|
|link\_type|If this is a link to a link or an image (gif/jpeg). See SpmLink::LinkType|Enum [ShipmentLinkType](enums\EnumShipmentLinkType.md)|&#x25CF;|
