...
|type|The type of the message (plaintext/html).|Enum [TicketMessageType](enums\EnumTicketMessageType.md)|&#x25CF;|
|message\_category|Defines what kind of message this is.|Enum [TicketMessageCategory](enums\EnumTicketMessageCategory.md)| |
|author|A string representing the author of the message. Could be a user&amp;apos;s name, or a persons email address.|String(255)|&#x25CF;|
|slevel|The securitylevel of the message.|Enum [TicketSecurityLevel](enums\EnumTicketSecurityLevel.md)|&#x25CF;|
