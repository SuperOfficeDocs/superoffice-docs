...
|category\_id|The id of the category in which this entry is located.|FK [kb_category](kb_category.md)| |
...
|access\_level|The access level for this entry (enum).|Enum [](enums\Enum.md)|&#x25CF;|
...
|status|The status for this entry (enum).|Enum [](enums\Enum.md)|&#x25CF;|
|expire\_date|The date until which this entry is valid.|DateTime|&#x25CF;|
|workflow\_phase|The workflow phase this entry is in|FK [kb_workflow](kb_workflow.md)| |
