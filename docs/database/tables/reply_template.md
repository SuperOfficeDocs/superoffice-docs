...
|folder\_id|The id of the folder in which this reply template is located. NULL or -1 if this is a toplevel reply template.|FK [reply_template_folder](reply_template_folder.md)| |
...
|access\_level|The access level (enum) for this reply template.|Enum [](enums\Enum.md)|&#x25CF;|
