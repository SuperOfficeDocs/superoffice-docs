...
|status|Sending/stopped/failed etc.|Enum [ShipmentStatus](enums\EnumShipmentStatus.md)| |
...
|sorting|Which sorting should be used on the document mailing recipient list, used when generating PDF|Enum [RecipientSorting](enums\EnumRecipientSorting.md)| |
