...
|Status|If there was a problem with for instance calculation, this field is set to warning or error. Typically shown as an icon. QuoteStatus is an enum with statuses: OK, OKWithInfo, Warning, Error.|Enum [QuoteStatus](enums\EnumQuoteStatus.md)|&#x25CF;|
