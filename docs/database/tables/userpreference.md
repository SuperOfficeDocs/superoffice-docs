...
|deflevel|The level: 0=hard default, 1=systemwide, 2=database, 3=group, 4=individual|Enum [PreferenceLevel](enums\EnumPreferenceLevel.md)| |
|maxlevel|Highest override level allowed|Enum [PreferenceLevel](enums\EnumPreferenceLevel.md)| |
