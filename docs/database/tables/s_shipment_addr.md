...
|------|-------------|------|:----:|
|id|Primary key|PK| |
|shipment\_id|Which shipment this address belongs to|FK [s_shipment](s_shipment.md)| |
...
|status|Status for sending to this particular recipient|Enum [ShipmentAddrStatus](enums\EnumShipmentAddrStatus.md)|&#x25CF;|
