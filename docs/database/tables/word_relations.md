...
|------|-------------|------|:----:|
|id|Primary key|PK| |
|entry\_word\_id|A reference to the id of the word|FK [kb_entry_words](kb_entry_words.md)| |
|entry\_id|A reference to the id of the entry|FK [kb_entry](kb_entry.md)| |
