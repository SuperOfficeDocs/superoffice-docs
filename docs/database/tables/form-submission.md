---
uid: table-form-submission
title: form\_submission table
...
|response\_shipment\_addr\_id|The id of the s_shipment_addr that is the response mail|FK [s-shipment-addr](s-shipment-addr.md)| |
