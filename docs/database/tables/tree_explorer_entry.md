...
|------|-------------|------|:----:|
|id|Primary key|PK| |
|parent\_id|The parent id of the entry|FK [tree_explorer_entry](tree_explorer_entry.md)| |
...
![tree_explorer_entry table relationship diagram](media\tree_explorer_entry.png)
