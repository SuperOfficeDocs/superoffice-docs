...
|468| [script\_trace](script-trace.md) |Scripts which should be traced|
|469| [script\_trace\_run](script-trace-run.md) |Traces of executed scripts|
|470| [attachment\_location](attachment-location.md) |A location for storing attachments|
|471| [cust\_config](cust-config.md) |This table contains JSON structures used for customizing the customer center|
|472| [form](form.md) |A form which can be published on a webpage and submitted by visitors|
|473| [form\_submission](form-submission.md) |A form submission|
|474| [email\_account](email-account.md) |Email account information|
|475| [email\_folder](email-folder.md) |Corresponds to an email folder on a mail server|
|476| [service\_auth](service-auth.md) |Authentication for a service (imap, smtp...)|
|477| [email\_item](email-item.md) |Email data|
|478| [email\_attachment](email-attachment.md) |Attachment info related to an email_item|
|479| [invitation](invitation.md) |Invitations to events|
|480| [s\_messageblock](s-messageblock.md) |Contains a block of a mailing message, that can be reused in a mailing|
