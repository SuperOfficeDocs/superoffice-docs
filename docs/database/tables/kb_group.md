...
|kb\_category\_id|The id of the kb_category in which this group is located.|FK [kb_category](kb_category.md)| |
...
|parent\_id|The parent group for this group. -1 if this is a toplevel group.|FK [ej_category](ej_category.md)| |
