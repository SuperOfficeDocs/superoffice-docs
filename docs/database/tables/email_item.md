...
|flags|Email flags - answered, deleted, seen, flagged, draft, recent...|Enum [EMailFlags](enums\EnumEMailFlags.md)|&#x25CF;|
|email\_folder\_id|Folder this email is in on the imap server|FK [email_folder](email_folder.md)|&#x25CF;|
|mime|Mime text|Clob|&#x25CF;|
...
|priority|Email priority|Enum [EMailPriority](enums\EnumEMailPriority.md)|&#x25CF;|
