...
|incoming\_auth|Incoming server (imap) authentication |FK [service_auth](service_auth.md)|&#x25CF;|
|outgoing\_auth|Outgoing server (smtp) authentication |FK [service_auth](service_auth.md)|&#x25CF;|
...
|account\_status|The status of this email account|Enum [EmailAccountStatus](enums\EnumEmailAccountStatus.md)|&#x25CF;|
