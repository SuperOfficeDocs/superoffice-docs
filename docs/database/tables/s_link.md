...
|status|Deleted or not. Deleted links should still work.|Enum [](enums\Enum.md)|&#x25CF;|
...
|ticket\_category|The id of the category a ticket is in.|FK [ej_category](ej_category.md)| |
|ticket\_priority|The reference to the ticket_priority table.|FK [ticket_priority](ticket_priority.md)| |
...
|action\_flags|Bitmask defining what action should be taken|Enum [ShipmentLinkAction](enums\EnumShipmentLinkAction.md)|&#x25CF;|
...
|task\_flags|Flags that control how the task is created|Enum [ShipmentLinkTaskFlags](enums\EnumShipmentLinkTaskFlags.md)|&#x25CF;|
