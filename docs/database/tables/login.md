...
|authentication\_type|The authentication type (enum) for this session.|Enum [](enums\Enum.md)|&#x25CF;|
|active\_menu|The currently active (open) left-menu for this session.|Int|&#x25CF;|
|ns\_secret|Netserver login secret.|String(255)|&#x25CF;|
|flags|Bitmask of flags for a service login session|Enum [LoginFlags](enums\EnumLoginFlags.md)|&#x25CF;|
