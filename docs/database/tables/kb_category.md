...
|parent\_id|This entry contains a reference to the parent category. NULL or -1 if this is a toplevel category.|FK [kb_category](kb_category.md)| |
...
|access\_level|The access level for this category (enum).|Enum [](enums\Enum.md)|&#x25CF;|
|inherited\_access\_level|The lowest access level for this category or any parent|Enum [](enums\Enum.md)|&#x25CF;|
