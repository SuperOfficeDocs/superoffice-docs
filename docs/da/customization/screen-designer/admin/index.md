...
1. Åbn skærmdesigneren ved at klikke på <i class="ph ph-list" aria-label="Main menu"></i>, vælge **Indstillinger og vedligeholdelse** og derefter vælge **Skærmdesigner** fra navigatoren.
