...
Hvis du vil tilføje posten i foretrukne, skal du klikke på stjerneikonet (![ikon][img3]) i det aktuelle kort, den aktuelle fane eller den aktuelle dialogboks. Stjernen bliver gul, og udvalget føjes med det samme til foretrukne. Du behøver ikke at klikke på **Gem**.

På listerne (for eksempel detaljekortene og Søg) kan du højreklikke på en post og vælge **Føj til Foretrukne** i menuen.

Nu kan du hurtigt få adgang til posten ved at klikke på ![ikon][img1] fra navigationsmenuen. Foretrukne er også tilgængelige i [sidepanelet][4].
...
1. Klik på favoritikonet (![ikon][img2]) i toppen. Ikonet skifter tilbage til standard, hvilket indikerer, at posten ikke længere er en favorit.
