...
Du kan have genveje til URL-adresser i SuperOffice CRM, så du kan åbne dem direkte derfra.

Du definerer, hvilke URL-adresser der skal være tilgængelige for brugerne i SuperOffice CRM, på skærmbilledet **Lister** under Indstillinger og vedligeholdelse.
...
* [Tilføjelse af forekomster på listen GUI – Webpanel][3]
