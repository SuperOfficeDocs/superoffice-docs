...
Du kan have genveje til eksterne programmer i SuperOffice CRM, så du kan åbne dem direkte i SuperOffice CRM for Windows.

Du definerer, hvilke URL-adresser der skal være tilgængelige for brugerne, på skærmbilledet **Lister** under Indstillinger og vedligeholdelse.
