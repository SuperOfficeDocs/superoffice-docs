...
## <a id="owner"></a>Overførsel af ejerskab

Som ejer eller administrator kan du overføre ejerskabet af et dashboard til en anden bruger.

1. Klik på knappen **Opgave** (<i class="ph ph-dots-three-circle-vertical" aria-hidden="true"></i>), og vælg **Rediger dashboarddetaljer**.

1. I **Ejer** skal du vælge den nye ejer.

    ![Dialogboksen Rediger dashboarddetaljer med Ejer-listen udvidet for at vise tilgængelige brugere -screenshot][img1]
...
Kun **ejeren** af et dashboard, en generel administrator eller en dashboardadministrator kan slette et dashboard.
