...
Statusser og tællere kan bruges i søgninger og til at oprette dynamiske udvalg. Du kan for eksempel søge efter firmaer, personer eller projekter, som opfylder en status eller en tæller. [!include[Define counter](../../../learn/includes/def-counter.md)]
