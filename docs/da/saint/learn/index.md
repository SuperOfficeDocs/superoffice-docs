...
| Statusnavn | Kriterier | Forklaring | Opgave |
|---|---|---|---|
| Forsømt projekt | **Projektstatus** er indstillet til igangværende. **Dato for sidste aktivitet** (opfølgning) er ældre end 14 dage. | Projektet er aktivt, men der har ikke været nogen aktiviteter de sidste to uger. | Planlæg et projektmøde for at få gang i hjulene. |
| Ikke-lønsomt projekt | **Antal salg** (fuldført) er nul. **Projektstatus** er fuldført eller standset. | Projektet er færdigt, men der er ikke solgt noget. | Aftal et internt møde for at finde ud af, hvorfor der ikke blev gennemført noget salg. |
