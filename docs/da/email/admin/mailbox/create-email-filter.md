...
1. På fanen **Angiv egenskaber** kan du angive bestemte egenskaber for sager, der registreres fra e-mails, som matcher det aktuelle filter. Se egenskaber nedenfor.
...
* **Sagstype**: Hvis du markerer her og vælger en type, vil e-mails, der behandles af dette filter, blive tildelt den angivne [sagstype][4].
...
## <a id="delete"></a>Slet e-mail-filter
