...
| ![ikon][img3] | Tilføj modtager | Åbner dialogboksen **Vælg modtagere**. | [Valg af modtagere][4] |
| ![ikon][img4] | Vedhæft dokument | Åbner dialogboksen **Medtag vedhæftning(er)**. | [Tilføj SuperOffice-dokumenter som vedhæftede filer][5] |
