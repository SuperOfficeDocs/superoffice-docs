...
Som standard er der ingen tags i din SuperOffice CRM-løsning. Du kan [tilføje så mange nye tags][4], du vil, og tags, der bliver overflødige, kan altid fjernes eller ændres.
...
1. Klik på knappen **Opgave** (![ikon][img1]) i nederste venstre hjørne på sagslisten.
...
Hvis du har den nødvendige funktionelle rettighed, kan du også oprette nye tags. Skriv et tagnavn, du vil oprette, i et tagfelt i en sag eller i [hurtigsøgningsfeltet][2]. Hvis taggen allerede findes, vises det på listen. Hvis ikke, skal du klikke på meddelelsen under feltet for at oprette taggen.

> [!NOTE]
> Tilføjelse og sletning af tags er en funktionel rettighed, der indstilles af administratoren, for at få et mere effektivt tagsystem og for at undgå dubletter af tags for samme sag. Administratorer kan også tilføje tags på listen **Tag** i skærmbilledet Lister i Indstillinger og vedligeholdelse.
