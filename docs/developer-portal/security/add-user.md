...
* If it matches an existing SuperID user account **in production**, all you have to do is to assign it to the partner. If you know this user is a SuperOffice CRM Online user, make sure you use the correct UPN - firstname@company.com vs firstname.lastname@company.com
