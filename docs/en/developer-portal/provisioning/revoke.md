...
3. Click **Uninstall** to start the process to remove the apps access to your SuperOffice CRM. Only a tenant user with administrator rights will see this button. 
