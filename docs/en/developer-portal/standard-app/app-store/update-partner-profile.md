...
4. Select **Partner profile** and then update logo, description, meta description, and links such as home page and your trust center URLs. Click **Add Links** to enter additional URLs.
    ...
    <!--TODO retake after URL field is lengthened -->
...
1. Review your listing in the SOD App Store.
    ...
    > [!TIP]
    > Click the eye icon on a version to preview the published app store information in the [SOD App Store][4]. This is a shortcut to `https://appstore-sod.superoffice.com/PARTNER-NAME`.
...
<!-- Referenced links -->
[1]: ../../create-app/versioning.md
[2]: ../../create-app/request-to-publish.md
[3]: ../../partner/update-partner-settings.md
[4]: https://appstore-sod.superoffice.com/
