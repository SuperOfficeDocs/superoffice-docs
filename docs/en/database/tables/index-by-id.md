...
|505| [OnlineApp](onlineapp.md) |Echo and track information about Online Apps and their usage|
|506| [PushNotificationService](pushnotificationservice.md) |Used for storing handles to user devices that should receive push notifications|
|507| [ShipmentType](shipmenttype.md) |Shipment type list table. Classification of a mailing, allowing recipients to subscribe to lists|
|508| [ShipmentTypeReservation](shipmenttypereservation.md) |ShipmentTypes a person has reserved against. Note that the absense of a record here implies acceptance of a mailings of this type|
|509| [TemporaryKey](temporarykey.md) |Temporary keys for lightweight authentications such as changing ones subscriptions|
|510| [target\_group](target-group.md) |Info about a set of (sales, project, selection...) targets|
|511| [target\_period](target-period.md) |A set of periods linked with target amounts for users/usergroups and the target groups/years.|
|512| [target\_assignment\_info](target-assignment-info.md) |Linking associate, company or user group target and other information with target values|
|513| [target\_assignment\_value](target-assignment-value.md) |A set of values linked to assignment info and a period in a target group.|
|514| [target\_revision\_history](target-revision-history.md) |Revision history info in case the original target group or assignment info was deleted|
|515| [target\_revision](target-revision.md) |One batch of changes made to targets|
|516| [target\_change](target-change.md) |A single field change.|
|517| [target\_dimension](target-dimension.md) |Defining target dimension|
|518| [Webhook](webhook.md) |Webhook URL to call when events occur in the client or in NetServer. Also tracks call+error statistics.|
|519| [Webhook\_usage](webhook-usage.md) |Webhook usage statistics - tracks call+error statistics. Same primary key as the webhook.|
|520| [Webhook\_notify](webhook-notify.md) |Notification recipients for webhook failure events. Each row defines one recipient (associate or ad-hoc email) that should be notified when a webhook fails.|
|521| [workflow](workflow.md) |SuperOffice specific info about a workflow|
|522| [email\_flow](email-flow.md) |A set of properties related to the email workflow.|
|523| [workflow\_instance](workflow-instance.md) |A set of properties related to the workflow instance of one participant going through the flow|
|524| [workflow\_goal](workflow-goal.md) |A set of goals related to a workflow. Some goals will have search criterias associated with it to determine if the goal has been reached.|
|525| [workflow\_step](workflow-step.md) |A set of steps related to a workflow.|
|526| [workflow\_trigger](workflow-trigger.md) |A set of triggers related to a workflow.|
|527| [workflow\_step\_option](workflow-step-option.md) |Some steps can have optional child &apos;flows&apos;, a new series of steps|
|528| [workflow\_step\_option\_link](workflow-step-option-link.md) |Link steps to other steps through step options|
|529| [email\_flow\_content\_link](email-flow-content-link.md) |Links content to an email workflow|
|530| [temp\_db\_lock](temp-db-lock.md) |Represents a temporary lock on a resource identified by table_id and key|
|531| [workflow\_wait\_for\_action](workflow-wait-for-action.md) |Some steps wait for actions, this is info about those actions|
|532| [workflow\_root\_step\_link](workflow-root-step-link.md) |Link root steps to the workflow|
|533| [form\_field\_value](form-field-value.md) |Form field values saved in a searchable format|
|534| [AssociateHistory](associatehistory.md) |Historical information about associates that have been deleted. Most references are NOT declared as foreign keys; this is a historical table that should not be updated when further changes occur in the database|
|535| [CacheInvalidation](cacheinvalidation.md) |Names and generation numbers for distributed invalidation of caches|
|536| [QuoteApprReason](quoteapprreason.md) |Predefined reasons for quote approval|
|537| [QuoteApprReasonGroupLink](quoteapprreasongrouplink.md) |User group link table for QuoteApprReason, for MDO item hiding|
|538| [QuoteApprReasonHeadingLink](quoteapprreasonheadinglink.md) |Heading link table for QuoteApprReason, for MDO headers|
|539| [QuoteDenyReason](quotedenyreason.md) |Predefined reasons for quote denial|
|540| [QuoteDenyReasonGroupLink](quotedenyreasongrouplink.md) |User group link table for QuoteDenyReason, for MDO item hiding|
|541| [QuoteDenyReasonHeadingLink](quotedenyreasonheadinglink.md) |Heading link table for QuoteDenyReason, for MDO headers|
|542| [EntityCounts](entitycounts.md) |Number of different entities an associate has created for usage statistics|
|543| [utm\_parameters](utm-parameters.md) |Table for utm parameters collected from visits and formsubmissions|
|544| [leadstatus](leadstatus.md) |List items of lead status that is selectable for contacts and persons that have specific category|
|545| [AutomatedCategoryUpdate](automatedcategoryupdate.md) |Info on how to autoupdate category when changing sale or leadstatus on person|
|546| [available\_fonts](available-fonts.md) |This table contains all fonts selected to be available for external usage|
|547| [ticket\_type](ticket-type.md) |A ticket (request) type|
|548| [ticket\_type\_priority](ticket-type-priority.md) |Link table defining what Priorities are relevant to a particular Ticket type|
|549| [ticket\_type\_status](ticket-type-status.md) |Link table defining what Statuses are relevant to a particular Ticket type|
|550| [ticket\_relation\_def](ticket-relation-def.md) |Ticket relation definition|
|551| [ticket\_rel\_def\_ticket\_type](ticket-rel-def-ticket-type.md) |Link table defining what Ticket types are involved in this relation. Will have M:N rows for a single relation definition|
|552| [ticket\_relation](ticket-relation.md) |A relation between 2 tickets|
