...
| [AssociateHistory](associatehistory.md) |Historical information about associates that have been deleted. Most references are NOT declared as foreign keys; this is a historical table that should not be updated when further changes occur in the database| 527 |
...
| [board\_view\_settings](board-view-settings.md) |Settings for selection board view| 497 |
...
| [CacheInvalidation](cacheinvalidation.md) |Names and generation numbers for distributed invalidation of caches| 528 |
...
| [email\_account](email-account.md) |Email account information| 488 |
| [email\_attachment](email-attachment.md) |Attachment info related to an email_item| 492 |
| [email\_flow](email-flow.md) |A set of properties related to the email workflow.| 515 |
| [email\_flow\_content\_link](email-flow-content-link.md) |Links content to an email workflow| 522 |
| [email\_folder](email-folder.md) |Corresponds to an email folder on a mail server| 489 |
| [email\_item](email-item.md) |Email data| 491 |
| [EntityCounts](entitycounts.md) |Number of different entities an associate has created for usage statistics| 535 |
...
| [external\_owner](external-owner.md) |Owner of external data imported into the system| 485 |
...
| [form](form.md) |A form which can be published on a webpage and submitted by visitors| 486 |
| [form\_field\_value](form-field-value.md) |Form field values saved in a searchable format| 526 |
| [form\_keys](form-keys.md) |Keys that makes sure a form is not posted twice| 366 |
| [form\_submission](form-submission.md) |A form submission| 487 |
...
| [invitation](invitation.md) |Invitations to events| 493 |
...
| [leadstatus](leadstatus.md) |List items of lead status that is selectable for contacts and persons that have specific category| 537 |
...
| [MailingDomains](mailingdomains.md) |List of allowed domains used in a Mailing| 495 |
...
| [OnlineApp](onlineapp.md) |Echo and track information about Online Apps and their usage| 499 |
...
| [PushNotificationService](pushnotificationservice.md) |Used for storing handles to user devices that should receive push notifications| 500 |
| [quick\_filter\_info](quick-filter-info.md) |Connect quick filter info from a specific provider to a dashboard| 484 |
...
| [QuoteApprReason](quoteapprreason.md) |Predefined reasons for quote approval| 529 |
| [QuoteApprReasonGroupLink](quoteapprreasongrouplink.md) |User group link table for QuoteApprReason, for MDO item hiding| 530 |
| [QuoteApprReasonHeadingLink](quoteapprreasonheadinglink.md) |Heading link table for QuoteApprReason, for MDO headers| 531 |
...
| [QuoteDenyReason](quotedenyreason.md) |Predefined reasons for quote denial| 532 |
| [QuoteDenyReasonGroupLink](quotedenyreasongrouplink.md) |User group link table for QuoteDenyReason, for MDO item hiding| 533 |
| [QuoteDenyReasonHeadingLink](quotedenyreasonheadinglink.md) |Heading link table for QuoteDenyReason, for MDO headers| 534 |
...
| [s\_messageblock](s-messageblock.md) |Contains a block of a mailing message, that can be reused in a mailing| 494 |
...
| [service\_auth](service-auth.md) |Authentication for a service (imap, smtp...)| 490 |
...
| [ShipmentType](shipmenttype.md) |Shipment type list table. Classification of a mailing, allowing recipients to subscribe to lists| 501 |
| [ShipmentTypeReservation](shipmenttypereservation.md) |ShipmentTypes a person has reserved against. Note that the absense of a record here implies acceptance of a mailings of this type| 502 |
...
| [target\_assignment\_info](target-assignment-info.md) |Linking associate, company or user group target and other information with target values| 506 |
| [target\_assignment\_value](target-assignment-value.md) |A set of values linked to assignment info and a period in a target group.| 507 |
| [target\_change](target-change.md) |A single field change.| 510 |
| [target\_dimension](target-dimension.md) |Defining target dimension| 511 |
| [target\_group](target-group.md) |Info about a set of (sales, project, selection...) targets| 504 |
| [target\_period](target-period.md) |A set of periods linked with target amounts for users/usergroups and the target groups/years.| 505 |
| [target\_revision](target-revision.md) |One batch of changes made to targets| 509 |
| [target\_revision\_history](target-revision-history.md) |Revision history info in case the original target group or assignment info was deleted| 508 |
...
| [temp\_db\_lock](temp-db-lock.md) |Represents a temporary lock on a resource identified by table_id and key| 523 |
...
| [TemporaryKey](temporarykey.md) |Temporary keys for lightweight authentications such as changing ones subscriptions| 503 |
...
| [ticket\_type](ticket-type.md) |A ticket (request) type| 538 |
| [ticket\_type\_priority](ticket-type-priority.md) |Link table defining what Priorities are relevant to a particular Ticket type| 539 |
| [ticket\_type\_status](ticket-type-status.md) |Link table defining what Statuses are relevant to a particular Ticket type| 540 |
| [time\_keeping](time-keeping.md) |Time keeping for how much time a sale or project or other entity has spent in a given stage or other state| 498 |
...
| [TypicalSearch](typicalsearch.md) |Owner of a set of predefined selection criteria| 496 |
...
| [utm\_parameters](utm-parameters.md) |Table for utm parameters collected from visits and formsubmissions| 536 |
...
| [Webhook](webhook.md) |Webhook URL to call when events occur in the client or in NetServer. Also tracks call+error statistics.| 512 |
| [Webhook\_usage](webhook-usage.md) |Webhook usage statistics - tracks call+error statistics. Same primary key as the webhook.| 513 |
...
| [workflow](workflow.md) |SuperOffice specific info about a workflow| 514 |
| [workflow\_goal](workflow-goal.md) |A set of goals related to a workflow. Some goals will have search criterias associated with it to determine if the goal has been reached.| 517 |
| [workflow\_instance](workflow-instance.md) |A set of properties related to the workflow instance of one participant going through the flow| 516 |
| [workflow\_root\_step\_link](workflow-root-step-link.md) |Link root steps to the workflow| 525 |
| [workflow\_step](workflow-step.md) |A set of steps related to a workflow.| 518 |
| [workflow\_step\_option](workflow-step-option.md) |Some steps can have optional child &apos;flows&apos;, a new series of steps| 520 |
| [workflow\_step\_option\_link](workflow-step-option-link.md) |Link steps to other steps through step options| 521 |
| [workflow\_trigger](workflow-trigger.md) |A set of triggers related to a workflow.| 519 |
| [workflow\_wait\_for\_action](workflow-wait-for-action.md) |Some steps wait for actions, this is info about those actions| 524 |
