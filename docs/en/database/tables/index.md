...
| [AssociateHistory](associatehistory.md) |Historical information about associates that have been deleted. Most references are NOT declared as foreign keys; this is a historical table that should not be updated when further changes occur in the database| 534 |
...
| [AutomatedCategoryUpdate](automatedcategoryupdate.md) |Info on how to autoupdate category when changing sale or leadstatus on person| 545 |
| [autosave](autosave.md) |Autosaved text clobs from ejscript and emarketeer messages| 402 |
| [available\_fonts](available-fonts.md) |This table contains all fonts selected to be available for external usage| 546 |
...
| [CacheInvalidation](cacheinvalidation.md) |Names and generation numbers for distributed invalidation of caches| 535 |
...
| [email\_flow](email-flow.md) |A set of properties related to the email workflow.| 522 |
| [email\_flow\_content\_link](email-flow-content-link.md) |Links content to an email workflow| 529 |
...
| [EntityCounts](entitycounts.md) |Number of different entities an associate has created for usage statistics| 542 |
...
| [form\_field\_value](form-field-value.md) |Form field values saved in a searchable format| 533 |
...
| [leadstatus](leadstatus.md) |List items of lead status that is selectable for contacts and persons that have specific category| 544 |
...
| [OnlineApp](onlineapp.md) |Echo and track information about Online Apps and their usage| 505 |
...
| [PushNotificationService](pushnotificationservice.md) |Used for storing handles to user devices that should receive push notifications| 506 |
...
| [QuoteApprReason](quoteapprreason.md) |Predefined reasons for quote approval| 536 |
| [QuoteApprReasonGroupLink](quoteapprreasongrouplink.md) |User group link table for QuoteApprReason, for MDO item hiding| 537 |
| [QuoteApprReasonHeadingLink](quoteapprreasonheadinglink.md) |Heading link table for QuoteApprReason, for MDO headers| 538 |
...
| [QuoteDenyReason](quotedenyreason.md) |Predefined reasons for quote denial| 539 |
| [QuoteDenyReasonGroupLink](quotedenyreasongrouplink.md) |User group link table for QuoteDenyReason, for MDO item hiding| 540 |
| [QuoteDenyReasonHeadingLink](quotedenyreasonheadinglink.md) |Heading link table for QuoteDenyReason, for MDO headers| 541 |
...
| [ShipmentType](shipmenttype.md) |Shipment type list table. Classification of a mailing, allowing recipients to subscribe to lists| 507 |
| [ShipmentTypeReservation](shipmenttypereservation.md) |ShipmentTypes a person has reserved against. Note that the absense of a record here implies acceptance of a mailings of this type| 508 |
...
| [target\_assignment\_info](target-assignment-info.md) |Linking associate, company or user group target and other information with target values| 512 |
| [target\_assignment\_value](target-assignment-value.md) |A set of values linked to assignment info and a period in a target group.| 513 |
| [target\_change](target-change.md) |A single field change.| 516 |
| [target\_dimension](target-dimension.md) |Defining target dimension| 517 |
| [target\_group](target-group.md) |Info about a set of (sales, project, selection...) targets| 510 |
| [target\_period](target-period.md) |A set of periods linked with target amounts for users/usergroups and the target groups/years.| 511 |
| [target\_revision](target-revision.md) |One batch of changes made to targets| 515 |
| [target\_revision\_history](target-revision-history.md) |Revision history info in case the original target group or assignment info was deleted| 514 |
...
| [temp\_db\_lock](temp-db-lock.md) |Represents a temporary lock on a resource identified by table_id and key| 530 |
...
| [TemporaryKey](temporarykey.md) |Temporary keys for lightweight authentications such as changing ones subscriptions| 509 |
...
| [ticket\_rel\_def\_ticket\_type](ticket-rel-def-ticket-type.md) |Link table defining what Ticket types are involved in this relation. Will have M:N rows for a single relation definition| 551 |
| [ticket\_relation](ticket-relation.md) |A relation between 2 tickets| 552 |
| [ticket\_relation\_def](ticket-relation-def.md) |Ticket relation definition| 550 |
...
| [ticket\_type](ticket-type.md) |A ticket (request) type| 547 |
| [ticket\_type\_priority](ticket-type-priority.md) |Link table defining what Priorities are relevant to a particular Ticket type| 548 |
| [ticket\_type\_status](ticket-type-status.md) |Link table defining what Statuses are relevant to a particular Ticket type| 549 |
...
| [utm\_parameters](utm-parameters.md) |Table for utm parameters collected from visits and formsubmissions| 543 |
...
| [Webhook](webhook.md) |Webhook URL to call when events occur in the client or in NetServer. Also tracks call+error statistics.| 518 |
| [Webhook\_notify](webhook-notify.md) |Notification recipients for webhook failure events. Each row defines one recipient (associate or ad-hoc email) that should be notified when a webhook fails.| 520 |
| [Webhook\_usage](webhook-usage.md) |Webhook usage statistics - tracks call+error statistics. Same primary key as the webhook.| 519 |
...
| [workflow](workflow.md) |SuperOffice specific info about a workflow| 521 |
| [workflow\_goal](workflow-goal.md) |A set of goals related to a workflow. Some goals will have search criterias associated with it to determine if the goal has been reached.| 524 |
| [workflow\_instance](workflow-instance.md) |A set of properties related to the workflow instance of one participant going through the flow| 523 |
| [workflow\_root\_step\_link](workflow-root-step-link.md) |Link root steps to the workflow| 532 |
| [workflow\_step](workflow-step.md) |A set of steps related to a workflow.| 525 |
| [workflow\_step\_option](workflow-step-option.md) |Some steps can have optional child &apos;flows&apos;, a new series of steps| 527 |
| [workflow\_step\_option\_link](workflow-step-option-link.md) |Link steps to other steps through step options| 528 |
| [workflow\_trigger](workflow-trigger.md) |A set of triggers related to a workflow.| 526 |
| [workflow\_wait\_for\_action](workflow-wait-for-action.md) |Some steps wait for actions, this is info about those actions| 531 |
