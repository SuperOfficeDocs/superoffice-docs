...
2. Select the person you want to help in the **Owner** list box from the properties panel. This means that you are transferring responsibility for the request to that person.
...
7. Click **Save**. The request is transferred to the other person.
