---
uid: help-en-use-column-filters-in-section-tabs
...
To activate the column filter, click ![icon][img1] to the right of the column headers and click **Enable filter**. The filter button (![icon][img2]) is now displayed on columns that can be filtered.
