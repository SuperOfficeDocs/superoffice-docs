...
> [!NOTE]
> This option requires a Microsoft 365 subscription and is available only if your administrator has [set up the Microsoft Sharepoint document library][3]. Alternatively, use SuperOffice document library with WebTools (or Google Workspace).
