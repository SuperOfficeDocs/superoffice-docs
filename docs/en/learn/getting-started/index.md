...
The system also has other features. For example, you can use Dashboards, Selections and Reports to can get an overview of contacts (based on categories, business or other criteria), sales, projects and activities. This is very helpful when you need to keep colleagues up to date on a weekly basis.
