...
|---|---|---|---|
| Expensive customer | **Number of activities** of type **Marketing** in period is high. **Number of sales** with status **Sold** in period is low. | You have undertaken a lot of marketing towards the customer, but this has led to few or no sales. | Plan an internal meeting to find out what can be done to make the customer profitable. |
...
| Sleeping customer | **Number of activities** with direction **Incoming** in period is low or zero. **Number of activities** with direction **Outgoing** in period is high. | You are trying to get into contact with the customer, but are getting little or no response. | Arrange a meeting with the customer to find out why they do not want to communicate. |
