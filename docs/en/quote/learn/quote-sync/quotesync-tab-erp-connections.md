...
title: quotesync tab ERP connections
description: quotesync tab ERP connections
...
Active Quote Connectors are displayed here. Hold the mouse pointer over a row to display detailed information.

Visible connectors are DLL files located on the server.
