---
title: Services86.AppointmentAgent.ValidateDays SOAP
generated: 1
uid: Services86-Appointment-ValidateDays
---

# Services86 Appointment ValidateDays

SOAP request and response examples **Remote/Services86/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IAppointmentAgent.ValidateDays">SuperOffice.Services86.IAppointmentAgent.ValidateDays</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateDays>
    ...
    <Appointment:Dates xsi:type="NetServerServices862:ArrayOfdateTime">
     <NetServerServices862:dateTime xsi:type="xsd:dateTime">2023-03-31T13:22:40Z</NetServerServices862:dateTime>
    </Appointment:Dates>
   </Appointment:ValidateDays>
