---
title: Services86.AppointmentAgent.GetProjectAppointmentsByTaskHeading SOAP
generated: 1
uid: Services86-Appointment-GetProjectAppointmentsByTaskHeading
---

# Services86 Appointment GetProjectAppointmentsByTaskHeading

SOAP request and response examples **Remote/Services86/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IAppointmentAgent.GetProjectAppointmentsByTaskHeading">SuperOffice.Services86.IAppointmentAgent.GetProjectAppointmentsByTaskHeading</see> method.
...
## GetProjectAppointmentsByTaskHeading Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetProjectAppointmentsByTaskHeading>
    <Appointment:ProjectId xsi:type="xsd:int">0</Appointment:ProjectId>
    <Appointment:StartTime xsi:type="xsd:dateTime">2023-03-31T13:22:40Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2023-03-31T13:22:40Z</Appointment:EndTime>
...
## GetProjectAppointmentsByTaskHeading Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services86">
 <SOAP-ENV:Body>
  <Appointment:GetProjectAppointmentsByTaskHeadingResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2023-03-31T13:22:40Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2023-03-31T13:22:40Z</Appointment:RecurringEndDate>
