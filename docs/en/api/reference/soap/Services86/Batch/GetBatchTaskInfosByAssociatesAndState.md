---
title: Services86.BatchAgent.GetBatchTaskInfosByAssociatesAndState SOAP
generated: 1
uid: Services86-Batch-GetBatchTaskInfosByAssociatesAndState
---

# Services86 Batch GetBatchTaskInfosByAssociatesAndState

SOAP request and response examples **Remote/Services86/Batch.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IBatchAgent.GetBatchTaskInfosByAssociatesAndState">SuperOffice.Services86.IBatchAgent.GetBatchTaskInfosByAssociatesAndState</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Batch:GetBatchTaskInfosByAssociatesAndState>
    <Batch:AssociateIds xsi:type="NetServerServices862:ArrayOfint">
  ...
  <Batch:GetBatchTaskInfosByAssociatesAndStateResponse>
   <Batch:Response xsi:type="Batch:ArrayOfBatchTaskInfo">
    <Batch:BatchTaskInfo xsi:type="Batch:BatchTaskInfo">
     ...
     <Batch:LastStarted xsi:type="xsd:dateTime">2023-03-31T13:22:50Z</Batch:LastStarted>
     <Batch:Created xsi:type="xsd:dateTime">2023-03-31T13:22:50Z</Batch:Created>
