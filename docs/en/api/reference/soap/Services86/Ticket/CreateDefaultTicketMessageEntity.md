---
title: Services86.TicketAgent.CreateDefaultTicketMessageEntity SOAP
generated: 1
uid: Services86-Ticket-CreateDefaultTicketMessageEntity
---

# Services86 Ticket CreateDefaultTicketMessageEntity

SOAP request and response examples **Remote/Services86/Ticket.svc**
Implemented by the <see cref="M:SuperOffice.Services86.ITicketAgent.CreateDefaultTicketMessageEntity">SuperOffice.Services86.ITicketAgent.CreateDefaultTicketMessageEntity</see> method.
  ...
  <Ticket:CreateDefaultTicketMessageEntityResponse>
   <Ticket:Response xsi:type="Ticket:TicketMessageEntity">
    ...
    <Ticket:Ticket xsi:type="Ticket:Ticket">
     ...
     <Ticket:CreatedAt xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:CreatedAt>
     <Ticket:LastChanged xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:LastChanged>
     <Ticket:ReadByOwner xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:ReadByOwner>
     <Ticket:ReadByCustomer xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:ReadByCustomer>
     <Ticket:FirstReadByUser xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:FirstReadByUser>
     <Ticket:Activate xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:Activate>
     <Ticket:ClosedAt xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:ClosedAt>
     <Ticket:RepliedAt xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:RepliedAt>
     <Ticket:AlertTimeout xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:AlertTimeout>
     <Ticket:Deadline xsi:type="xsd:dateTime">2023-03-31T13:24:21Z</Ticket:Deadline>
