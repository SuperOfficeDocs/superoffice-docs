---
title: Services86.PersonAgent.GetSalesRep SOAP
generated: 1
uid: Services86-Person-GetSalesRep
---

# Services86 Person GetSalesRep

SOAP request and response examples **Remote/Services86/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services86.IPersonAgent.GetSalesRep">SuperOffice.Services86.IPersonAgent.GetSalesRep</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:GetSalesRep>
    ...
    <Person:PersonFirstname xsi:type="xsd:string"></Person:PersonFirstname>
    <Person:PersonLastname xsi:type="xsd:string"></Person:PersonLastname>
    <Person:EmailAddress xsi:type="xsd:string"></Person:EmailAddress>
    <Person:PhoneNumber xsi:type="xsd:string"></Person:PhoneNumber>
   </Person:GetSalesRep>
 ...
 <SOAP-ENV:Body>
  <Person:GetSalesRepResponse>
   <Person:Response xsi:type="Person:PersonEntity">
    ...
    <Person:UpdatedDate xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:UpdatedDate>
    <Person:CreatedDate xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:CreatedDate>
    <Person:BirthDate xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:BirthDate>
    ...
    <Person:Interests xsi:type="Person:ArrayOfSelectableMDOListItem">
     <Person:SelectableMDOListItem xsi:type="Person:SelectableMDOListItem">
      ...
      <Person:LastChanged xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:LastChanged>
    ...
    <Person:DbiLastModified xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:DbiLastModified>
    <Person:DbiLastSyncronized xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:DbiLastSyncronized>
    ...
    <Person:Consents xsi:type="Person:ArrayOfConsentInfo">
     <Person:ConsentInfo xsi:type="Person:ConsentInfo">
      ...
      <Person:Registered xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:Registered>
      <Person:RegisteredAssociateId xsi:type="xsd:int">0</Person:RegisteredAssociateId>
      <Person:Updated xsi:type="xsd:dateTime">2022-08-26T08:55:22Z</Person:Updated>
