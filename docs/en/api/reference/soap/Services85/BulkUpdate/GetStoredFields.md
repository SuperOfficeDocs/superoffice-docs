---
title: Services85.BulkUpdateAgent.GetStoredFields SOAP
generated: 1
uid: Services85-BulkUpdate-GetStoredFields
---

# Services85 BulkUpdate GetStoredFields

SOAP request and response examples **Remote/Services85/BulkUpdate.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IBulkUpdateAgent.GetStoredFields">SuperOffice.Services85.IBulkUpdateAgent.GetStoredFields</see> method.
  ...
  <BulkUpdate:GetStoredFieldsResponse>
   <BulkUpdate:Response xsi:type="BulkUpdate:ArrayOfFieldValueInfo">
    <BulkUpdate:FieldValueInfo xsi:type="BulkUpdate:FieldValueInfo">
     ...
     <BulkUpdate:Values xsi:type="NetServerServices852:ArrayOfstring">
      <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
     </BulkUpdate:Values>
     <BulkUpdate:DisplayValues xsi:type="NetServerServices852:ArrayOfstring">
      <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
     ...
     <BulkUpdate:OperationInfos xsi:type="BulkUpdate:ArrayOfOperationInfo">
      <BulkUpdate:OperationInfo xsi:type="BulkUpdate:OperationInfo">
       <BulkUpdate:Key xsi:type="xsd:string"></BulkUpdate:Key>
       <BulkUpdate:EncodedDisplayName xsi:type="xsd:string"></BulkUpdate:EncodedDisplayName>
       <BulkUpdate:EncodedLeadTexts xsi:type="NetServerServices852:ArrayOfstring">
        <NetServerServices852:string xsi:type="xsd:string"></NetServerServices852:string>
