---
title: Services85.AppointmentAgent.GetContactAppointmentsByTasks SOAP
generated: 1
uid: Services85-Appointment-GetContactAppointmentsByTasks
---

# Services85 Appointment GetContactAppointmentsByTasks

SOAP request and response examples **Remote/Services85/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IAppointmentAgent.GetContactAppointmentsByTasks">SuperOffice.Services85.IAppointmentAgent.GetContactAppointmentsByTasks</see> method.
...
## GetContactAppointmentsByTasks Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetContactAppointmentsByTasks>
    <Appointment:ContactId xsi:type="xsd:int">0</Appointment:ContactId>
    <Appointment:StartTime xsi:type="xsd:dateTime">2023-03-01T11:06:51Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2023-03-01T11:06:51Z</Appointment:EndTime>
...
## GetContactAppointmentsByTasks Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services85">
 <SOAP-ENV:Body>
  <Appointment:GetContactAppointmentsByTasksResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2023-03-01T11:06:51Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2023-03-01T11:06:51Z</Appointment:RecurringEndDate>
