---
title: Services85.AppointmentAgent.ValidateDays SOAP
generated: 1
uid: Services85-Appointment-ValidateDays
---

# Services85 Appointment ValidateDays

SOAP request and response examples **Remote/Services85/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IAppointmentAgent.ValidateDays">SuperOffice.Services85.IAppointmentAgent.ValidateDays</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateDays>
    ...
    <Appointment:Dates xsi:type="NetServerServices852:ArrayOfdateTime">
     <NetServerServices852:dateTime xsi:type="xsd:dateTime">2023-03-31T13:20:48Z</NetServerServices852:dateTime>
    </Appointment:Dates>
   </Appointment:ValidateDays>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services85">
 <SOAP-ENV:Body>
  <Appointment:ValidateDaysResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfRecurrenceDate">
    <Appointment:RecurrenceDate xsi:type="Appointment:RecurrenceDate">
     <Appointment:Date xsi:type="xsd:dateTime">2023-03-31T13:20:48Z</Appointment:Date>
     <Appointment:IsConflict xsi:type="xsd:boolean">false</Appointment:IsConflict>
     <Appointment:Description xsi:type="xsd:string"></Appointment:Description>
