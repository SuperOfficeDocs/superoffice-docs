---
title: Services85.ListAgent.GetProjectTypeEntity SOAP
generated: 1
uid: Services85-List-GetProjectTypeEntity
---

# Services85 List GetProjectTypeEntity

SOAP request and response examples **Remote/Services85/List.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IListAgent.GetProjectTypeEntity">SuperOffice.Services85.IListAgent.GetProjectTypeEntity</see> method.
   ...
   <List:Response xsi:type="List:ProjectTypeEntity">
    ...
    <List:Stages xsi:type="List:ArrayOfSelectableMDOListItem">
     <List:SelectableMDOListItem xsi:type="List:SelectableMDOListItem">
      ...
      <List:LastChanged xsi:type="xsd:dateTime">2023-03-31T13:21:50Z</List:LastChanged>
