---
title: Services85.UserAgent.GetAllRoles SOAP
generated: 1
uid: Services85-User-GetAllRoles
---

# Services85 User GetAllRoles

SOAP request and response examples **Remote/Services85/User.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IUserAgent.GetAllRoles">SuperOffice.Services85.IUserAgent.GetAllRoles</see> method.
  ...
  <User:GetAllRolesResponse>
   <User:Response xsi:type="User:ArrayOfSelectableMDOListItem">
    <User:SelectableMDOListItem xsi:type="User:SelectableMDOListItem">
     ...
     <User:LastChanged xsi:type="xsd:dateTime">2023-03-31T13:22:29Z</User:LastChanged>
