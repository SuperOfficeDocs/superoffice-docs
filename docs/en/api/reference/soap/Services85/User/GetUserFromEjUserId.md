---
title: Services85.UserAgent.GetUserFromEjUserId SOAP
generated: 1
uid: Services85-User-GetUserFromEjUserId
---

# Services85 User GetUserFromEjUserId

SOAP request and response examples **Remote/Services85/User.svc**
Implemented by the <see cref="M:SuperOffice.Services85.IUserAgent.GetUserFromEjUserId">SuperOffice.Services85.IUserAgent.GetUserFromEjUserId</see> method.
  ...
  <User:GetUserFromEjUserIdResponse>
   <User:Response xsi:type="User:ArrayOfUser">
    <User:User xsi:type="User:User">
     ...
     <User:Lastlogin xsi:type="xsd:dateTime">2023-03-31T13:22:29Z</User:Lastlogin>
     <User:Lastlogout xsi:type="xsd:dateTime">2023-03-31T13:22:29Z</User:Lastlogout>
     <User:EjUserId xsi:type="xsd:int">0</User:EjUserId>
