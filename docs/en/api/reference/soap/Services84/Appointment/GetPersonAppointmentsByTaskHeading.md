---
title: Services84.AppointmentAgent.GetPersonAppointmentsByTaskHeading SOAP
generated: 1
uid: Services84-Appointment-GetPersonAppointmentsByTaskHeading
---

# Services84 Appointment GetPersonAppointmentsByTaskHeading

SOAP request and response examples **Remote/Services84/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services84.IAppointmentAgent.GetPersonAppointmentsByTaskHeading">SuperOffice.Services84.IAppointmentAgent.GetPersonAppointmentsByTaskHeading</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetPersonAppointmentsByTaskHeading>
    ...
    <Appointment:StartTime xsi:type="xsd:dateTime">2023-03-31T13:18:56Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2023-03-31T13:18:56Z</Appointment:EndTime>
  ...
  <Appointment:GetPersonAppointmentsByTaskHeadingResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2023-03-31T13:18:56Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2023-03-31T13:18:56Z</Appointment:RecurringEndDate>
