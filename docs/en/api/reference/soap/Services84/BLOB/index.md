---
title: Services84.BLOBAgent SOAP
uid: Services84-BLOB-soap
generated: 1
---

# Services84 BLOB SOAP

SOAP request and response examples, and WSDL files for **Remote/Services84/BLOB.svc**

Handled by the <see cref="T:SuperOffice.Services84.IBLOBAgent">SuperOffice.Services84.IBLOBAgent</see> interface.

Interface for the BLOB Agent
Collection of all services that works with binary objects (BLOBS), e.g. Images and documents.

Download [WSDL file for Services84/BLOB](../Services84-BLOB.md) if you need to generate your own proxy code.
