---
title: Services84.UserAgent.GetUserFromPersonId SOAP
generated: 1
uid: Services84-User-GetUserFromPersonId
---

# Services84 User GetUserFromPersonId

SOAP request and response examples **Remote/Services84/User.svc**
Implemented by the <see cref="M:SuperOffice.Services84.IUserAgent.GetUserFromPersonId">SuperOffice.Services84.IUserAgent.GetUserFromPersonId</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:User="http://www.superoffice.net/ws/crm/NetServer/Services84">
 <SOAP-ENV:Body>
  <User:GetUserFromPersonIdResponse>
   <User:Response xsi:type="User:ArrayOfUser">
    <User:User xsi:type="User:User">
     ...
     <User:Lastlogin xsi:type="xsd:dateTime">2023-03-31T13:20:37Z</User:Lastlogin>
     <User:Lastlogout xsi:type="xsd:dateTime">2023-03-31T13:20:37Z</User:Lastlogout>
