...
Implemented by the <see cref="M:SuperOffice.Services88.IFavouriteAgent.AddTicketsToFavouritesByProvider">SuperOffice.Services88.IFavouriteAgent.AddTicketsToFavouritesByProvider</see> method.

## AddTicketsToFavouritesByProvider
...
## AddTicketsToFavouritesByProvider Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Favourite:AddTicketsToFavouritesByProvider>
...
## AddTicketsToFavouritesByProvider Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Favourite="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Favourite:AddTicketsToFavouritesByProviderResponse>
  </Favourite:AddTicketsToFavouritesByProviderResponse>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
