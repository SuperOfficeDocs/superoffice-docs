...
## ForceResyncExternalNoBlankValues Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <ErpSync:ForceResyncExternalNoBlankValues>
...
## ForceResyncExternalNoBlankValues Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:ErpSync="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <ErpSync:ForceResyncExternalNoBlankValuesResponse>
