...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Pocket:GetPocketStartupData>
    ...
    <Pocket:CurrentClientTime xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Pocket:CurrentClientTime>
   </Pocket:GetPocketStartupData>
   ...
   <Pocket:Response xsi:type="Pocket:PocketStartupData">
    ...
    <Pocket:SystemWebPanels xsi:type="Pocket:ArrayOfWebPanelEntity">
     <Pocket:WebPanelEntity xsi:type="Pocket:WebPanelEntity">
      ...
      <Pocket:NeverReloadOnCurrentChange xsi:type="xsd:boolean">false</Pocket:NeverReloadOnCurrentChange>
      <Pocket:CustomObjectEntity xsi:type="xsd:string"></Pocket:CustomObjectEntity>
