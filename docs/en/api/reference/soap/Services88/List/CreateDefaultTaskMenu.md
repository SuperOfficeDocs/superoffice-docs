...
Implemented by the <see cref="M:SuperOffice.Services88.IListAgent.CreateDefaultTaskMenu">SuperOffice.Services88.IListAgent.CreateDefaultTaskMenu</see> method.
...
## CreateDefaultTaskMenu Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:List="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <List:CreateDefaultTaskMenuResponse>
