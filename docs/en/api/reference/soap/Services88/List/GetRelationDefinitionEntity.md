...
Implemented by the <see cref="M:SuperOffice.Services88.IListAgent.GetRelationDefinitionEntity">SuperOffice.Services88.IListAgent.GetRelationDefinitionEntity</see> method.
