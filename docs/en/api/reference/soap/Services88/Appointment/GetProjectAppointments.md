---
title: Services88.AppointmentAgent.GetProjectAppointments SOAP
generated: true
uid: Services88-Appointment-GetProjectAppointments
content_type: reference
---

# Services88 Appointment GetProjectAppointments

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetProjectAppointments">SuperOffice.Services88.IAppointmentAgent.GetProjectAppointments</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetProjectAppointments>
    ...
    <Appointment:EndTime xsi:type="xsd:dateTime">2025-10-14T01:38:05Z</Appointment:EndTime>
  ...
  <Appointment:GetProjectAppointmentsResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2025-10-14T01:38:05Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2025-10-14T01:38:05Z</Appointment:RecurringEndDate>
