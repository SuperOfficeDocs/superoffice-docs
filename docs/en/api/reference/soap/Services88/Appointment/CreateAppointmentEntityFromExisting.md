...
# Services88 Appointment CreateAppointmentEntityFromExisting

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.CreateAppointmentEntityFromExisting">SuperOffice.Services88.IAppointmentAgent.CreateAppointmentEntityFromExisting</see> method.

## CreateAppointmentEntityFromExisting
...
## CreateAppointmentEntityFromExisting Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:CreateAppointmentEntityFromExisting>
...
## CreateAppointmentEntityFromExisting Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:CreateAppointmentEntityFromExistingResponse>
