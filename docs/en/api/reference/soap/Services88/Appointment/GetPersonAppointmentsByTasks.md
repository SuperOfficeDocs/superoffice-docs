---
title: Services88.AppointmentAgent.GetPersonAppointmentsByTasks SOAP
generated: true
uid: Services88-Appointment-GetPersonAppointmentsByTasks
content_type: reference
---

# Services88 Appointment GetPersonAppointmentsByTasks

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetPersonAppointmentsByTasks">SuperOffice.Services88.IAppointmentAgent.GetPersonAppointmentsByTasks</see> method.
...
## GetPersonAppointmentsByTasks Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetPersonAppointmentsByTasks>
    ...
    <Appointment:StartTime xsi:type="xsd:dateTime">2025-12-18T01:29:28Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2025-12-18T01:29:28Z</Appointment:EndTime>
...
## GetPersonAppointmentsByTasks Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:GetPersonAppointmentsByTasksResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2025-12-18T01:29:28Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2025-12-18T01:29:28Z</Appointment:RecurringEndDate>
     ...
     <Appointment:MotherAssociateId xsi:type="xsd:int">0</Appointment:MotherAssociateId>
