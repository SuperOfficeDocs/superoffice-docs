...
# Services88 Appointment ValidateAppointmentEntity

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.ValidateAppointmentEntity">SuperOffice.Services88.IAppointmentAgent.ValidateAppointmentEntity</see> method.
...
## ValidateAppointmentEntity Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ValidateAppointmentEntity>
    <Appointment:AppointmentEntity xsi:type="Appointment:AppointmentEntity">
     ...
     <Appointment:CreatedDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:CreatedDate>
     ...
     <Appointment:StartDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:StartDate>
     <Appointment:EndDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:EndDate>
     ...
     <Appointment:Project xsi:type="Appointment:Project">
      ...
      <Appointment:Updated xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:Updated>
      ...
      <Appointment:PublishTo xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:PublishTo>
      <Appointment:PublishFrom xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:PublishFrom>
      ...
      <Appointment:ActiveErpLinks xsi:type="xsd:int">0</Appointment:ActiveErpLinks>
      <Appointment:EventId xsi:type="xsd:int">0</Appointment:EventId>
      <Appointment:StartDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:StartDate>
     </Appointment:Project>
     <Appointment:Type xsi:type="Appointment:AppointmentType">Unknown</Appointment:Type>
     <Appointment:UpdatedDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:UpdatedDate>
     ...
     <Appointment:LagTime xsi:type="NetServerServices881:duration"></Appointment:LagTime>
     <Appointment:LeadTime xsi:type="NetServerServices881:duration"></Appointment:LeadTime>
     ...
     <Appointment:Recurrence xsi:type="Appointment:RecurrenceInfo">
      ...
      <Appointment:Dates xsi:type="Appointment:ArrayOfRecurrenceDate">
       <Appointment:RecurrenceDate xsi:type="Appointment:RecurrenceDate">
        <Appointment:Date xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:Date>
     ...
     <Appointment:Participants xsi:type="Appointment:ArrayOfParticipantInfo">
      <Appointment:ParticipantInfo xsi:type="Appointment:ParticipantInfo">
       ...
       <Appointment:EmailAddress xsi:type="xsd:string"></Appointment:EmailAddress>
       <Appointment:Description xsi:type="xsd:string"></Appointment:Description>
       <Appointment:ExternallyOwnedType xsi:type="Appointment:ExternallyOwnedType">Unknown</Appointment:ExternallyOwnedType>
       <Appointment:ExternallyOwnedStatus xsi:type="Appointment:ExternallyOwnedStatus">Unknown</Appointment:ExternallyOwnedStatus>
     ...
     <Appointment:ActiveDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:ActiveDate>
     ...
     <Appointment:PreferredTZLocationData xsi:type="Appointment:TimeZoneData">
      <Appointment:TZLocationID xsi:type="xsd:int">0</Appointment:TZLocationID>
      <Appointment:Name xsi:type="xsd:string"></Appointment:Name>
      <Appointment:TZLocationCode xsi:type="xsd:string"></Appointment:TZLocationCode>
      <Appointment:TZLocationCities xsi:type="xsd:string"></Appointment:TZLocationCities>
      <Appointment:IsoNumber xsi:type="xsd:int">0</Appointment:IsoNumber>
      <Appointment:TimeZoneSTDRules xsi:type="Appointment:TimeZoneRuleDictionary">
       <Appointment:TimeZoneRuleKeyValuePair>
        <Appointment:Key xsi:type="xsd:dateTime"></Appointment:Key>
        <Appointment:Value xsi:type="Appointment:TimeZoneRule">
         <Appointment:TZOffset xsi:type="xsd:int">0</Appointment:TZOffset>
         <Appointment:StartRulePattern xsi:type="xsd:string"></Appointment:StartRulePattern>
         <Appointment:EndRulePattern xsi:type="xsd:string"></Appointment:EndRulePattern>
         <Appointment:StartDay xsi:type="xsd:int">0</Appointment:StartDay>
         <Appointment:StartMonth xsi:type="xsd:int">0</Appointment:StartMonth>
         <Appointment:EndDay xsi:type="xsd:int">0</Appointment:EndDay>
         <Appointment:EndMonth xsi:type="xsd:int">0</Appointment:EndMonth>
        </Appointment:Value>
       </Appointment:TimeZoneRuleKeyValuePair>
      </Appointment:TimeZoneSTDRules>
      <Appointment:TimeZoneDSTRules xsi:type="Appointment:TimeZoneRuleDictionary">
       <Appointment:TimeZoneRuleKeyValuePair>
        <Appointment:Key xsi:type="xsd:dateTime"></Appointment:Key>
        <Appointment:Value xsi:type="Appointment:TimeZoneRule">
         <Appointment:TZOffset xsi:type="xsd:int">0</Appointment:TZOffset>
      ...
      </Appointment:TimeZoneDSTRules>
     </Appointment:PreferredTZLocationData>
     <Appointment:Sale xsi:type="Appointment:Sale">
      <Appointment:ContactName xsi:type="xsd:string"></Appointment:ContactName>
      <Appointment:SaleDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:SaleDate>
      ...
      <Appointment:Completed xsi:type="Appointment:ActivityStatus">Unknown</Appointment:Completed>
      <Appointment:ActiveErpLinks xsi:type="xsd:int">0</Appointment:ActiveErpLinks>
      <Appointment:NextDueDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:NextDueDate>
     ...
     <Appointment:CentralserviceVideomeetId xsi:type="xsd:string"></Appointment:CentralserviceVideomeetId>
     ...
     <Appointment:PublishEventDate xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:PublishEventDate>
     <Appointment:PublishTo xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:PublishTo>
     <Appointment:PublishFrom xsi:type="xsd:dateTime">2026-03-26T12:15:21Z</Appointment:PublishFrom>
     <Appointment:IsPublished xsi:type="xsd:boolean">false</Appointment:IsPublished>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:ValidateAppointmentEntityResponse>
   <Appointment:Response xsi:type="Appointment:StringDictionary">
    <Appointment:StringKeyValuePair>
     <Appointment:Key xsi:type="xsd:string"></Appointment:Key>
     <Appointment:Value xsi:type="xsd:string"></Appointment:Value>
    </Appointment:StringKeyValuePair>
