...
# Services88 Appointment ConvertAppointmentToTask

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.ConvertAppointmentToTask">SuperOffice.Services88.IAppointmentAgent.ConvertAppointmentToTask</see> method.

## ConvertAppointmentToTask
...
## ConvertAppointmentToTask Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:ConvertAppointmentToTask>
...
## ConvertAppointmentToTask Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:ConvertAppointmentToTaskResponse>
