...
# Services88 Appointment SaveWithCustomInvitation

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.SaveWithCustomInvitation">SuperOffice.Services88.IAppointmentAgent.SaveWithCustomInvitation</see> method.

## SaveWithCustomInvitation
...
## SaveWithCustomInvitation Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:SaveWithCustomInvitation>
    ...
    <Appointment:EmailBody xsi:type="xsd:string"></Appointment:EmailBody>
    <Appointment:Subject xsi:type="xsd:string"></Appointment:Subject>
    <Appointment:TemplateLanguage xsi:type="xsd:string"></Appointment:TemplateLanguage>
   </Appointment:SaveWithCustomInvitation>
...
## SaveWithCustomInvitation Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:SaveWithCustomInvitationResponse>
   <Appointment:Response xsi:type="Appointment:AppointmentSaveData">
    <Appointment:AppointmentEntity xsi:type="Appointment:AppointmentEntity">
     <Appointment:Associate xsi:type="Appointment:Associate">
      <Appointment:AssociateId xsi:type="xsd:int">0</Appointment:AssociateId>
      <Appointment:Name xsi:type="xsd:string"></Appointment:Name>
    ...
    <Appointment:EmailCreated xsi:type="xsd:boolean">false</Appointment:EmailCreated>
