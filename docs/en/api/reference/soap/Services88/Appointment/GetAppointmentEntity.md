---
title: Services88.AppointmentAgent.GetAppointmentEntity SOAP
generated: true
uid: Services88-Appointment-GetAppointmentEntity
content_type: reference
---

# Services88 Appointment GetAppointmentEntity

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetAppointmentEntity">SuperOffice.Services88.IAppointmentAgent.GetAppointmentEntity</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetAppointmentEntity>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:GetAppointmentEntityResponse>
   <Appointment:Response xsi:type="Appointment:AppointmentEntity">
    ...
    <Appointment:CreatedDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:CreatedDate>
    ...
    <Appointment:StartDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:StartDate>
    <Appointment:EndDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:EndDate>
    ...
    <Appointment:Project xsi:type="Appointment:Project">
     ...
     <Appointment:Updated xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:Updated>
     ...
     <Appointment:PublishTo xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:PublishTo>
     <Appointment:PublishFrom xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:PublishFrom>
    ...
    <Appointment:UpdatedDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:UpdatedDate>
    ...
    <Appointment:Recurrence xsi:type="Appointment:RecurrenceInfo">
     ...
     <Appointment:Dates xsi:type="Appointment:ArrayOfRecurrenceDate">
      <Appointment:RecurrenceDate xsi:type="Appointment:RecurrenceDate">
       <Appointment:Date xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:Date>
    ...
    <Appointment:ActiveDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:ActiveDate>
    ...
    <Appointment:Sale xsi:type="Appointment:Sale">
     <Appointment:ContactName xsi:type="xsd:string"></Appointment:ContactName>
     <Appointment:SaleDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:SaleDate>
     ...
     <Appointment:Completed xsi:type="Appointment:ActivityStatus">Unknown</Appointment:Completed>
     <Appointment:ActiveErpLinks xsi:type="xsd:int">0</Appointment:ActiveErpLinks>
     <Appointment:NextDueDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:NextDueDate>
    ...
    <Appointment:PublishEventDate xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:PublishEventDate>
    <Appointment:PublishTo xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:PublishTo>
    <Appointment:PublishFrom xsi:type="xsd:dateTime">2026-03-26T12:15:20Z</Appointment:PublishFrom>
    <Appointment:IsPublished xsi:type="xsd:boolean">false</Appointment:IsPublished>
