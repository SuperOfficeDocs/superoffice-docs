...
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.RejectWithEmailConfirmation">SuperOffice.Services88.IAppointmentAgent.RejectWithEmailConfirmation</see> method.
