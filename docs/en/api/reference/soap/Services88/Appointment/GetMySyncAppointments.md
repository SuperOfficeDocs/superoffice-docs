---
title: Services88.AppointmentAgent.GetMySyncAppointments SOAP
generated: true
uid: Services88-Appointment-GetMySyncAppointments
content_type: reference
---

# Services88 Appointment GetMySyncAppointments

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetMySyncAppointments">SuperOffice.Services88.IAppointmentAgent.GetMySyncAppointments</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetMySyncAppointments>
    <Appointment:StartTime xsi:type="xsd:dateTime">2025-11-05T01:28:11Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2025-11-05T01:28:11Z</Appointment:EndTime>
   </Appointment:GetMySyncAppointments>
  ...
  <Appointment:GetMySyncAppointmentsResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointmentSyncData">
    <Appointment:AppointmentSyncData xsi:type="Appointment:AppointmentSyncData">
     <Appointment:AlarmTime xsi:type="xsd:dateTime">2025-11-05T01:28:11Z</Appointment:AlarmTime>
     ...
     <Appointment:EndDate xsi:type="xsd:dateTime">2025-11-05T01:28:11Z</Appointment:EndDate>
     ...
     <Appointment:Participants xsi:type="Appointment:ArrayOfParticipantSyncData">
      <Appointment:ParticipantSyncData xsi:type="Appointment:ParticipantSyncData">
       ...
       <Appointment:ContactFullName xsi:type="xsd:string"></Appointment:ContactFullName>
       <Appointment:EMail xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:EMail>
       <Appointment:PhonePrivate xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:PhonePrivate>
       <Appointment:PhoneFax xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:PhoneFax>
       <Appointment:PhoneMobile xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:PhoneMobile>
       <Appointment:PhoneDirect xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:PhoneDirect>
       <Appointment:PhoneContact xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:PhoneContact>
       <Appointment:Messenger xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:Messenger>
       <Appointment:Voip xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:Voip>
       <Appointment:ContactUrl xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:ContactUrl>
       <Appointment:Url xsi:type="NetServerServices882:ArrayOfstring">
        <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
       </Appointment:Url>
     ...
     <Appointment:StartDate xsi:type="xsd:dateTime">2025-11-05T01:28:11Z</Appointment:StartDate>
