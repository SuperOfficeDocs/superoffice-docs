---
title: Services88.AppointmentAgent.GetMyAppointments SOAP
generated: true
uid: Services88-Appointment-GetMyAppointments
---

# Services88 Appointment GetMyAppointments

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.GetMyAppointments">SuperOffice.Services88.IAppointmentAgent.GetMyAppointments</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:GetMyAppointments>
    <Appointment:StartTime xsi:type="xsd:dateTime">2024-03-07T13:21:00Z</Appointment:StartTime>
    <Appointment:EndTime xsi:type="xsd:dateTime">2024-03-07T13:21:00Z</Appointment:EndTime>
  ...
  <Appointment:GetMyAppointmentsResponse>
   <Appointment:Response xsi:type="Appointment:ArrayOfAppointment">
    <Appointment:Appointment xsi:type="Appointment:Appointment">
     ...
     <Appointment:RecurringStartDate xsi:type="xsd:dateTime">2024-03-07T13:21:00Z</Appointment:RecurringStartDate>
     <Appointment:RecurringEndDate xsi:type="xsd:dateTime">2024-03-07T13:21:00Z</Appointment:RecurringEndDate>
