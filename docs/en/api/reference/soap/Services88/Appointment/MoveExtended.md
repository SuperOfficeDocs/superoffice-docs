...
# Services88 Appointment MoveExtended

SOAP request and response examples **Remote/Services88/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IAppointmentAgent.MoveExtended">SuperOffice.Services88.IAppointmentAgent.MoveExtended</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:MoveExtended>
    <Appointment:AppointmentMoveData xsi:type="Appointment:AppointmentMoveData">
    ...
    </Appointment:AppointmentMoveData>
   </Appointment:MoveExtended>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Appointment="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Appointment:MoveExtendedResponse>
