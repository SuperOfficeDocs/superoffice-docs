---
title: Services88.DocumentAgent.SetDocumentStreamFromId SOAP
generated: true
uid: Services88-Document-SetDocumentStreamFromId
content_type: reference
---

# Services88 Document SetDocumentStreamFromId

SOAP request and response examples **Remote/Services88/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IDocumentAgent.SetDocumentStreamFromId">SuperOffice.Services88.IDocumentAgent.SetDocumentStreamFromId</see> method.
 ...
 <SOAP-ENV:Body>
  <Document:SetDocumentStreamFromIdResponse>
   <Document:Response xsi:type="Document:DocumentEntity">
    ...
    <Document:CreatedDate xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:CreatedDate>
    <Document:UpdatedDate xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:UpdatedDate>
    ...
    <Document:Person xsi:type="Document:Person">
     ...
     <Document:PersonNumber xsi:type="xsd:string"></Document:PersonNumber>
    </Document:Person>
    ...
    <Document:Contact xsi:type="Document:Contact">
     ...
     <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
     <Document:Number1 xsi:type="xsd:string"></Document:Number1>
     <Document:Number2 xsi:type="xsd:string"></Document:Number2>
    </Document:Contact>
    <Document:Project xsi:type="Document:Project">
     ...
     <Document:Updated xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:Updated>
     ...
     <Document:PublishTo xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:PublishTo>
     <Document:PublishFrom xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:PublishFrom>
     ...
     <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
     <Document:EventId xsi:type="xsd:int">0</Document:EventId>
     <Document:StartDate xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:StartDate>
    </Document:Project>
    <Document:Date xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:Date>
    ...
    <Document:Sale xsi:type="Document:Sale">
     <Document:ContactName xsi:type="xsd:string"></Document:ContactName>
     <Document:SaleDate xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:SaleDate>
     ...
     <Document:Completed xsi:type="Document:ActivityStatus">Unknown</Document:Completed>
     <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
     <Document:NextDueDate xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:NextDueDate>
    ...
    <Document:PublishEventDate xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:PublishEventDate>
    <Document:PublishTo xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:PublishTo>
    <Document:PublishFrom xsi:type="xsd:dateTime">2026-02-26T20:48:07Z</Document:PublishFrom>
    <Document:IsPublished xsi:type="xsd:boolean">false</Document:IsPublished>
