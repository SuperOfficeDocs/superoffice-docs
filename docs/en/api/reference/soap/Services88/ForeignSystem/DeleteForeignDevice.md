...
Implemented by the <see cref="M:SuperOffice.Services88.IForeignSystemAgent.DeleteForeignDevice">SuperOffice.Services88.IForeignSystemAgent.DeleteForeignDevice</see> method.
