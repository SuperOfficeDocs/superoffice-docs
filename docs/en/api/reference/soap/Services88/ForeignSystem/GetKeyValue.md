...
Implemented by the <see cref="M:SuperOffice.Services88.IForeignSystemAgent.GetKeyValue">SuperOffice.Services88.IForeignSystemAgent.GetKeyValue</see> method.
