...
Implemented by the <see cref="M:SuperOffice.Services88.ISaleAgent.CreateDefaultSaleStakeholder">SuperOffice.Services88.ISaleAgent.CreateDefaultSaleStakeholder</see> method.
