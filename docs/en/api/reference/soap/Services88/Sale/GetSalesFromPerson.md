---
title: Services88.SaleAgent.GetSalesFromPerson SOAP
generated: true
uid: Services88-Sale-GetSalesFromPerson
---

# Services88 Sale GetSalesFromPerson

SOAP request and response examples **Remote/Services88/Sale.svc**
Implemented by the <see cref="M:SuperOffice.Services88.ISaleAgent.GetSalesFromPerson">SuperOffice.Services88.ISaleAgent.GetSalesFromPerson</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Sale:GetSalesFromPerson>
    <Sale:PersonId xsi:type="xsd:int">0</Sale:PersonId>
    <Sale:OnlyOpenSales xsi:type="xsd:boolean">false</Sale:OnlyOpenSales>
   </Sale:GetSalesFromPerson>
  ...
  <Sale:GetSalesFromPersonResponse>
   <Sale:Response xsi:type="Sale:ArrayOfSale">
    <Sale:Sale xsi:type="Sale:Sale">
     ...
     <Sale:NextDueDate xsi:type="xsd:dateTime">2025-02-13T13:31:23Z</Sale:NextDueDate>
