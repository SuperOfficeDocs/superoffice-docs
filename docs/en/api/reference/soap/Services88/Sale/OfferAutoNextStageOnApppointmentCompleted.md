...
Implemented by the <see cref="M:SuperOffice.Services88.ISaleAgent.OfferAutoNextStageOnApppointmentCompleted">SuperOffice.Services88.ISaleAgent.OfferAutoNextStageOnApppointmentCompleted</see> method.
