...
Implemented by the <see cref="M:SuperOffice.Services88.IDiagnosticsAgent.GetNextTableNumber">SuperOffice.Services88.IDiagnosticsAgent.GetNextTableNumber</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Diagnostics:GetNextTableNumber>
   </Diagnostics:GetNextTableNumber>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Diagnostics="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Diagnostics:GetNextTableNumberResponse>
   <Diagnostics:Response xsi:type="xsd:int">0</Diagnostics:Response>
  </Diagnostics:GetNextTableNumberResponse>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
