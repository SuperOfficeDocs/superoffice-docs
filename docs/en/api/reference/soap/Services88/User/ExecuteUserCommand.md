---
title: Services88.UserAgent.ExecuteUserCommand SOAP
generated: true
uid: Services88-User-ExecuteUserCommand
---

# Services88 User ExecuteUserCommand

SOAP request and response examples **Remote/Services88/User.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IUserAgent.ExecuteUserCommand">SuperOffice.Services88.IUserAgent.ExecuteUserCommand</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:ExecuteUserCommand>
    <User:CommandName xsi:type="xsd:string"></User:CommandName>
    <User:CommandActionResult xsi:type="User:CommandActionResult">Implicit</User:CommandActionResult>
    <User:User xsi:type="User:User">
     ...
     <User:Deleted xsi:type="xsd:boolean">false</User:Deleted>
     <User:Lastlogin xsi:type="xsd:dateTime">2023-11-10T12:37:53Z</User:Lastlogin>
     <User:Lastlogout xsi:type="xsd:dateTime">2023-11-10T12:37:53Z</User:Lastlogout>
...
<SOAP-ENV:Envelope
 ...
 xmlns:User="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <User:ExecuteUserCommandResponse>
   <User:Response xsi:type="User:CommandResult">
    <User:Success xsi:type="xsd:boolean">false</User:Success>
    <User:Message xsi:type="xsd:string"></User:Message>
    <User:Result xsi:type="User:CommandActionResult">Implicit</User:Result>
   </User:Response>
  </User:ExecuteUserCommandResponse>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
