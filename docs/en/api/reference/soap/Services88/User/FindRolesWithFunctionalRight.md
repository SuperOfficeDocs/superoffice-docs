...
Implemented by the <see cref="M:SuperOffice.Services88.IUserAgent.FindRolesWithFunctionalRight">SuperOffice.Services88.IUserAgent.FindRolesWithFunctionalRight</see> method.
