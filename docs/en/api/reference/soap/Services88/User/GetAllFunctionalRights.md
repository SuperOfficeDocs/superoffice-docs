---
title: Services88.UserAgent.GetAllFunctionalRights SOAP
generated: true
uid: Services88-User-GetAllFunctionalRights
content_type: reference
---

# Services88 User GetAllFunctionalRights

SOAP request and response examples **Remote/Services88/User.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IUserAgent.GetAllFunctionalRights">SuperOffice.Services88.IUserAgent.GetAllFunctionalRights</see> method.
  ...
  <User:GetAllFunctionalRightsResponse>
   <User:Response xsi:type="User:ArrayOfSelectableMDOListItem">
    <User:SelectableMDOListItem xsi:type="User:SelectableMDOListItem">
     ...
     <User:LastChanged xsi:type="xsd:dateTime">2025-12-18T01:31:41Z</User:LastChanged>
