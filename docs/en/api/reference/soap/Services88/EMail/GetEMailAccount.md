---
title: Services88.EMailAgent.GetEMailAccount SOAP
generated: true
uid: Services88-EMail-GetEMailAccount
content_type: reference
---

# Services88 EMail GetEMailAccount

SOAP request and response examples **Remote/Services88/EMail.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IEMailAgent.GetEMailAccount">SuperOffice.Services88.IEMailAgent.GetEMailAccount</see> method.
 ...
 <SOAP-ENV:Body>
  <EMail:GetEMailAccountResponse>
   <EMail:Response xsi:type="EMail:EMailAccount">
    ...
    <EMail:LastFetch xsi:type="xsd:dateTime">2026-07-02T01:22:52Z</EMail:LastFetch>
    <EMail:UseGraphApi xsi:type="xsd:short">0</EMail:UseGraphApi>
   </EMail:Response>
  </EMail:GetEMailAccountResponse>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
