...
Implemented by the <see cref="M:SuperOffice.Services88.IPersonAgent.DeletePersonEntity">SuperOffice.Services88.IPersonAgent.DeletePersonEntity</see> method.
