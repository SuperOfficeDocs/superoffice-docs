...
<SOAP-ENV:Envelope
 ...
 xmlns:Person="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Person:ValidatePersonEntityResponse>
   <Person:Response xsi:type="Person:StringDictionary">
    <Person:StringKeyValuePair>
     <Person:Key xsi:type="xsd:string"></Person:Key>
     <Person:Value xsi:type="xsd:string"></Person:Value>
    </Person:StringKeyValuePair>
