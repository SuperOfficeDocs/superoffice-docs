---
title: Services88.PersonAgent.ResolvePersonFromInfo SOAP
generated: true
uid: Services88-Person-ResolvePersonFromInfo
content_type: reference
---

# Services88 Person ResolvePersonFromInfo

SOAP request and response examples **Remote/Services88/Person.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IPersonAgent.ResolvePersonFromInfo">SuperOffice.Services88.IPersonAgent.ResolvePersonFromInfo</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Person:ResolvePersonFromInfo>
    <Person:ContactId xsi:type="xsd:int">0</Person:ContactId>
    <Person:PersonName xsi:type="xsd:string"></Person:PersonName>
    <Person:PhoneNumbers xsi:type="NetServerServices882:ArrayOfstring">
     <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
    </Person:PhoneNumbers>
    <Person:Emails xsi:type="NetServerServices882:ArrayOfstring">
     <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
    </Person:Emails>
   </Person:ResolvePersonFromInfo>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Person="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Person:ResolvePersonFromInfoResponse>
   <Person:Response xsi:type="Person:ResolvedPerson">
    <Person:Person xsi:type="Person:PersonEntity">
     ...
     <Person:UpdatedDate xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:UpdatedDate>
     <Person:CreatedDate xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:CreatedDate>
     <Person:BirthDate xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:BirthDate>
     ...
     <Person:Contact xsi:type="Person:Contact">
      ...
      <Person:Number1 xsi:type="xsd:string"></Person:Number1>
      <Person:Number2 xsi:type="xsd:string"></Person:Number2>
     </Person:Contact>
     ...
     <Person:Interests xsi:type="Person:ArrayOfSelectableMDOListItem">
      <Person:SelectableMDOListItem xsi:type="Person:SelectableMDOListItem">
       ...
       <Person:LastChanged xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:LastChanged>
     ...
     <Person:Category xsi:type="Person:Category">
      ...
      <Person:Value xsi:type="xsd:string"></Person:Value>
      <Person:Tooltip xsi:type="xsd:string"></Person:Tooltip>
      <Person:CategoryGroup xsi:type="Person:CategoryGroup">Unknown</Person:CategoryGroup>
      <Person:EnableLeadStatus xsi:type="xsd:boolean">false</Person:EnableLeadStatus>
      <Person:Rank xsi:type="xsd:short">0</Person:Rank>
      <Person:Deleted xsi:type="xsd:boolean">false</Person:Deleted>
     </Person:Category>
     ...
     <Person:DbiLastModified xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:DbiLastModified>
     <Person:DbiLastSyncronized xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:DbiLastSyncronized>
     ...
     <Person:UserInfo xsi:type="Person:UserInfo">
      ...
      <Person:GrantedLicenses xsi:type="NetServerServices882:ArrayOfstring">
       <NetServerServices882:string xsi:type="xsd:string"></NetServerServices882:string>
     ...
     <Person:Consents xsi:type="Person:ArrayOfConsentInfo">
      <Person:ConsentInfo xsi:type="Person:ConsentInfo">
       ...
       <Person:Registered xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:Registered>
       <Person:RegisteredAssociateId xsi:type="xsd:int">0</Person:RegisteredAssociateId>
       <Person:Updated xsi:type="xsd:dateTime">2026-01-26T11:34:07Z</Person:Updated>
     ...
     <Person:CreatedByFormId xsi:type="xsd:int">0</Person:CreatedByFormId>
     <Person:UtmParameters xsi:type="Person:SavedUtmParameters">
      <Person:FormName xsi:type="xsd:string"></Person:FormName>
     ...
     </Person:UtmParameters>
     <Person:LeadstatusId xsi:type="xsd:int">0</Person:LeadstatusId>
     <Person:Leadstatus xsi:type="xsd:string"></Person:Leadstatus>
    ...
    <Person:PersonCreated xsi:type="xsd:boolean">false</Person:PersonCreated>
   </Person:Response>
  </Person:ResolvePersonFromInfoResponse>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
