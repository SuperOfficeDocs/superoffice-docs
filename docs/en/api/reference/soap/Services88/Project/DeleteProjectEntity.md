...
Implemented by the <see cref="M:SuperOffice.Services88.IProjectAgent.DeleteProjectEntity">SuperOffice.Services88.IProjectAgent.DeleteProjectEntity</see> method.
