...
Implemented by the <see cref="M:SuperOffice.Services88.IProjectAgent.SaveProjectEventEntity">SuperOffice.Services88.IProjectAgent.SaveProjectEventEntity</see> method.
