---
title: Services88.SelectionAgent.GenerateFollowUps SOAP
generated: true
uid: Services88-Selection-GenerateFollowUps
content_type: reference
---

# Services88 Selection GenerateFollowUps

SOAP request and response examples **Remote/Services88/Selection.svc**
Implemented by the <see cref="M:SuperOffice.Services88.ISelectionAgent.GenerateFollowUps">SuperOffice.Services88.ISelectionAgent.GenerateFollowUps</see> method.
   ...
   <Selection:GenerateFollowUps>
    ...
    <Selection:AppointmentEntity xsi:type="Selection:AppointmentEntity">
     ...
     <Selection:Contact xsi:type="Selection:Contact">
      ...
      <Selection:Number1 xsi:type="xsd:string"></Selection:Number1>
      <Selection:Number2 xsi:type="xsd:string"></Selection:Number2>
     </Selection:Contact>
     ...
     <Selection:StartDate xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:StartDate>
     <Selection:EndDate xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:EndDate>
     <Selection:InvitedPerson xsi:type="Selection:Person">
      ...
      <Selection:CategoryName xsi:type="xsd:string"></Selection:CategoryName>
      <Selection:PersonNumber xsi:type="xsd:string"></Selection:PersonNumber>
     ...
     <Selection:Project xsi:type="Selection:Project">
      ...
      <Selection:Updated xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:Updated>
      ...
      <Selection:PublishTo xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:PublishTo>
      <Selection:PublishFrom xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:PublishFrom>
      ...
      <Selection:ActiveErpLinks xsi:type="xsd:int">0</Selection:ActiveErpLinks>
      <Selection:EventId xsi:type="xsd:int">0</Selection:EventId>
      <Selection:StartDate xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:StartDate>
     </Selection:Project>
     ...
     <Selection:AlarmLeadTime xsi:type="NetServerServices881:duration"></Selection:AlarmLeadTime>
     ...
     <Selection:LagTime xsi:type="NetServerServices881:duration"></Selection:LagTime>
     <Selection:LeadTime xsi:type="NetServerServices881:duration"></Selection:LeadTime>
     ...
     <Selection:Recurrence xsi:type="Selection:RecurrenceInfo">
      ...
      <Selection:Dates xsi:type="Selection:ArrayOfRecurrenceDate">
       <Selection:RecurrenceDate xsi:type="Selection:RecurrenceDate">
        <Selection:Date xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:Date>
     ...
     <Selection:Participants xsi:type="Selection:ArrayOfParticipantInfo">
      <Selection:ParticipantInfo xsi:type="Selection:ParticipantInfo">
       ...
       <Selection:EmailAddress xsi:type="xsd:string"></Selection:EmailAddress>
       <Selection:Description xsi:type="xsd:string"></Selection:Description>
       <Selection:ExternallyOwnedType xsi:type="Selection:ExternallyOwnedType">Unknown</Selection:ExternallyOwnedType>
       <Selection:ExternallyOwnedStatus xsi:type="Selection:ExternallyOwnedStatus">Unknown</Selection:ExternallyOwnedStatus>
     ...
     <Selection:ActiveDate xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:ActiveDate>
     ...
     <Selection:Task xsi:type="Selection:TaskListItem">
      ...
      <Selection:DefaultVideomeetingStatus xsi:type="Selection:VideoMeetingStatus">NoChange</Selection:DefaultVideomeetingStatus>
     </Selection:Task>
     <Selection:PreferredTZLocation xsi:type="xsd:int">0</Selection:PreferredTZLocation>
     <Selection:PreferredTZLocationData xsi:type="Selection:TimeZoneData">
      <Selection:TZLocationID xsi:type="xsd:int">0</Selection:TZLocationID>
      <Selection:Name xsi:type="xsd:string"></Selection:Name>
      <Selection:TZLocationCode xsi:type="xsd:string"></Selection:TZLocationCode>
      <Selection:TZLocationCities xsi:type="xsd:string"></Selection:TZLocationCities>
      <Selection:IsoNumber xsi:type="xsd:int">0</Selection:IsoNumber>
      <Selection:TimeZoneSTDRules xsi:type="Selection:TimeZoneRuleDictionary">
       <Selection:TimeZoneRuleKeyValuePair>
        <Selection:Key xsi:type="xsd:dateTime"></Selection:Key>
        <Selection:Value xsi:type="Selection:TimeZoneRule">
         <Selection:TZOffset xsi:type="xsd:int">0</Selection:TZOffset>
         <Selection:StartRulePattern xsi:type="xsd:string"></Selection:StartRulePattern>
         <Selection:EndRulePattern xsi:type="xsd:string"></Selection:EndRulePattern>
         <Selection:StartDay xsi:type="xsd:int">0</Selection:StartDay>
         <Selection:StartMonth xsi:type="xsd:int">0</Selection:StartMonth>
         <Selection:EndDay xsi:type="xsd:int">0</Selection:EndDay>
         <Selection:EndMonth xsi:type="xsd:int">0</Selection:EndMonth>
        </Selection:Value>
       </Selection:TimeZoneRuleKeyValuePair>
      </Selection:TimeZoneSTDRules>
      <Selection:TimeZoneDSTRules xsi:type="Selection:TimeZoneRuleDictionary">
       <Selection:TimeZoneRuleKeyValuePair>
        <Selection:Key xsi:type="xsd:dateTime"></Selection:Key>
        <Selection:Value xsi:type="Selection:TimeZoneRule">
         <Selection:TZOffset xsi:type="xsd:int">0</Selection:TZOffset>
      ...
      </Selection:TimeZoneDSTRules>
     </Selection:PreferredTZLocationData>
     <Selection:Sale xsi:type="Selection:Sale">
      <Selection:ContactName xsi:type="xsd:string"></Selection:ContactName>
      <Selection:SaleDate xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:SaleDate>
      ...
      <Selection:Completed xsi:type="Selection:ActivityStatus">Unknown</Selection:Completed>
      <Selection:ActiveErpLinks xsi:type="xsd:int">0</Selection:ActiveErpLinks>
      <Selection:NextDueDate xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:NextDueDate>
     ...
     <Selection:OwnedExternally xsi:type="Selection:AppointmentExternalOwner">None</Selection:OwnedExternally>
     <Selection:JoinVideomeetUrl xsi:type="xsd:string"></Selection:JoinVideomeetUrl>
     <Selection:CentralserviceVideomeetId xsi:type="xsd:string"></Selection:CentralserviceVideomeetId>
     ...
     <Selection:PublishEventDate xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:PublishEventDate>
     <Selection:PublishTo xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:PublishTo>
     <Selection:PublishFrom xsi:type="xsd:dateTime">2026-03-26T12:17:18Z</Selection:PublishFrom>
     <Selection:IsPublished xsi:type="xsd:boolean">false</Selection:IsPublished>
