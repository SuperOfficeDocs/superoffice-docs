...
Implemented by the <see cref="M:SuperOffice.Services88.ISelectionAgent.AddContactSelectionMembers">SuperOffice.Services88.ISelectionAgent.AddContactSelectionMembers</see> method.
