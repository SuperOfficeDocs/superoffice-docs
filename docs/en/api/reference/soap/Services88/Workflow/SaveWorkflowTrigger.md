...
Implemented by the <see cref="M:SuperOffice.Services88.IWorkflowAgent.SaveWorkflowTrigger">SuperOffice.Services88.IWorkflowAgent.SaveWorkflowTrigger</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:Workflow="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Workflow:SaveWorkflowTriggerResponse>
