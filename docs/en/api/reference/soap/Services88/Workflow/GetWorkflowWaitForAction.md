...
Implemented by the <see cref="M:SuperOffice.Services88.IWorkflowAgent.GetWorkflowWaitForAction">SuperOffice.Services88.IWorkflowAgent.GetWorkflowWaitForAction</see> method.

## GetWorkflowWaitForAction
...
## GetWorkflowWaitForAction Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Workflow:GetWorkflowWaitForAction>
...
## GetWorkflowWaitForAction Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Workflow="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Workflow:GetWorkflowWaitForActionResponse>
