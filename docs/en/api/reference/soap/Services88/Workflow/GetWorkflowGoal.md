...
Implemented by the <see cref="M:SuperOffice.Services88.IWorkflowAgent.GetWorkflowGoal">SuperOffice.Services88.IWorkflowAgent.GetWorkflowGoal</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:Workflow="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Workflow:GetWorkflowGoalResponse>
