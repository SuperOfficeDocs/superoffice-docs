...
Implemented by the <see cref="M:SuperOffice.Services88.IWorkflowAgent.CreateDefaultWorkflowGoal">SuperOffice.Services88.IWorkflowAgent.CreateDefaultWorkflowGoal</see> method.
...
## CreateDefaultWorkflowGoal Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Workflow:CreateDefaultWorkflowGoal>
   </Workflow:CreateDefaultWorkflowGoal>
...
## CreateDefaultWorkflowGoal Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Workflow="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Workflow:CreateDefaultWorkflowGoalResponse>
