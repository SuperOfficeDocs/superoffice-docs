---
title: Services88.WorkflowAgent.CreateDefaultEmailFlow SOAP
generated: true
uid: Services88-Workflow-CreateDefaultEmailFlow
---

# Services88 Workflow CreateDefaultEmailFlow

SOAP request and response examples **Remote/Services88/Workflow.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IWorkflowAgent.CreateDefaultEmailFlow">SuperOffice.Services88.IWorkflowAgent.CreateDefaultEmailFlow</see> method.
...
## CreateDefaultEmailFlow Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Workflow:CreateDefaultEmailFlow>
   </Workflow:CreateDefaultEmailFlow>
...
## CreateDefaultEmailFlow Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Workflow="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Workflow:CreateDefaultEmailFlowResponse>
   <Workflow:Response xsi:type="Workflow:EmailFlow">
      ...
      <Workflow:HierarchyEntity xsi:type="Workflow:HierarchyEntity">
       ...
       <Workflow:Children xsi:type="Workflow:ArrayOfHierarchyEntity">
        <Workflow:HierarchyEntity xsi:type="Workflow:HierarchyEntity">
         ...
         <Workflow:Registered xsi:type="xsd:dateTime">2025-05-28T15:53:51Z</Workflow:Registered>
         <Workflow:RegisteredAssociateId xsi:type="xsd:int">0</Workflow:RegisteredAssociateId>
         <Workflow:Updated xsi:type="xsd:dateTime">2025-05-28T15:53:51Z</Workflow:Updated>
    ...
    <Workflow:ContentInfo xsi:type="Workflow:ArrayOfWorkflowContentInfo">
     <Workflow:WorkflowContentInfo xsi:type="Workflow:WorkflowContentInfo">
      <Workflow:WorkflowContentType xsi:type="Workflow:WorkflowContentType">None</Workflow:WorkflowContentType>
      <Workflow:Id xsi:type="xsd:int">0</Workflow:Id>
      <Workflow:Actions xsi:type="xsd:boolean">false</Workflow:Actions>
     </Workflow:WorkflowContentInfo>
    </Workflow:ContentInfo>
    <Workflow:ExitFlowId xsi:type="xsd:int">0</Workflow:ExitFlowId>
    <Workflow:ExitSuccessFlowId xsi:type="xsd:int">0</Workflow:ExitSuccessFlowId>
    ...
    <Workflow:CreatedDate xsi:type="xsd:dateTime">2025-05-28T15:53:51Z</Workflow:CreatedDate>
    <Workflow:UpdatedDate xsi:type="xsd:dateTime">2025-05-28T15:53:51Z</Workflow:UpdatedDate>
