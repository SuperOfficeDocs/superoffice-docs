---
title: Services88.WorkflowAgent.SaveWorkflowWaitForAction SOAP
generated: true
uid: Services88-Workflow-SaveWorkflowWaitForAction
content_type: reference
---

# Services88 Workflow SaveWorkflowWaitForAction

SOAP request and response examples **Remote/Services88/Workflow.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IWorkflowAgent.SaveWorkflowWaitForAction">SuperOffice.Services88.IWorkflowAgent.SaveWorkflowWaitForAction</see> method.

## SaveWorkflowWaitForAction
...
## SaveWorkflowWaitForAction Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Workflow:SaveWorkflowWaitForAction>
    <Workflow:WorkflowWaitForAction xsi:type="Workflow:WorkflowWaitForAction">
     ...
     <Workflow:ActionType xsi:type="Workflow:WorkflowWaitForActionType">None</Workflow:ActionType>
    ...
    </Workflow:WorkflowWaitForAction>
   </Workflow:SaveWorkflowWaitForAction>
...
## SaveWorkflowWaitForAction Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Workflow="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Workflow:SaveWorkflowWaitForActionResponse>
   <Workflow:Response xsi:type="Workflow:WorkflowWaitForAction">
    <Workflow:WorkflowWaitForActionId xsi:type="xsd:int">0</Workflow:WorkflowWaitForActionId>
    <Workflow:WorkflowStepId xsi:type="xsd:int">0</Workflow:WorkflowStepId>
    <Workflow:WorkflowId xsi:type="xsd:int">0</Workflow:WorkflowId>
    <Workflow:Rank xsi:type="xsd:int">0</Workflow:Rank>
