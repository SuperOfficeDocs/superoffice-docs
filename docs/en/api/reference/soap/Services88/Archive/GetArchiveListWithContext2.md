...
Implemented by the <see cref="M:SuperOffice.Services88.IArchiveAgent.GetArchiveListWithContext2">SuperOffice.Services88.IArchiveAgent.GetArchiveListWithContext2</see> method.
