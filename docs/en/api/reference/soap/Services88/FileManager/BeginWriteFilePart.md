...
Implemented by the <see cref="M:SuperOffice.Services88.IFileManagerAgent.BeginWriteFilePart">SuperOffice.Services88.IFileManagerAgent.BeginWriteFilePart</see> method.
