---
title: Services88.ChatAgent.CreateDefaultChatSessionEntity SOAP
generated: true
uid: Services88-Chat-CreateDefaultChatSessionEntity
content_type: reference
---

# Services88 Chat CreateDefaultChatSessionEntity

SOAP request and response examples **Remote/Services88/Chat.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IChatAgent.CreateDefaultChatSessionEntity">SuperOffice.Services88.IChatAgent.CreateDefaultChatSessionEntity</see> method.
...
## CreateDefaultChatSessionEntity Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Chat:CreateDefaultChatSessionEntity>
   </Chat:CreateDefaultChatSessionEntity>
...
## CreateDefaultChatSessionEntity Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Chat="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Chat:CreateDefaultChatSessionEntityResponse>
   <Chat:Response xsi:type="Chat:ChatSessionEntity">
    ...
    <Chat:Person xsi:type="Chat:Person">
     ...
     <Chat:PersonNumber xsi:type="xsd:string"></Chat:PersonNumber>
    </Chat:Person>
    ...
    <Chat:WhenRequested xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:WhenRequested>
    <Chat:WhenStarted xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:WhenStarted>
    <Chat:WhenEnded xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:WhenEnded>
    <Chat:WhenIdle xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:WhenIdle>
    <Chat:WhenFetched xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:WhenFetched>
    ...
    <Chat:Project xsi:type="Chat:Project">
     ...
     <Chat:Updated xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:Updated>
     ...
     <Chat:PublishTo xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:PublishTo>
     <Chat:PublishFrom xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:PublishFrom>
     <Chat:IsPublished xsi:type="xsd:boolean">false</Chat:IsPublished>
     <Chat:URLName xsi:type="xsd:string"></Chat:URLName>
     <Chat:ProjectNumber xsi:type="xsd:string"></Chat:ProjectNumber>
     <Chat:ActiveErpLinks xsi:type="xsd:int">0</Chat:ActiveErpLinks>
     <Chat:EventId xsi:type="xsd:int">0</Chat:EventId>
     <Chat:StartDate xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:StartDate>
    </Chat:Project>
    <Chat:Sale xsi:type="Chat:Sale">
     <Chat:ContactName xsi:type="xsd:string"></Chat:ContactName>
     <Chat:SaleDate xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:SaleDate>
     ...
     <Chat:ActiveErpLinks xsi:type="xsd:int">0</Chat:ActiveErpLinks>
     <Chat:NextDueDate xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:NextDueDate>
    ...
    <Chat:Ticket xsi:type="Chat:Ticket">
     ...
     <Chat:Title xsi:type="xsd:string"></Chat:Title>
     <Chat:CreatedAt xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:CreatedAt>
     <Chat:LastChanged xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:LastChanged>
     <Chat:ReadByOwner xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:ReadByOwner>
     <Chat:ReadByCustomer xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:ReadByCustomer>
     <Chat:FirstReadByUser xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:FirstReadByUser>
     <Chat:Activate xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:Activate>
     <Chat:ClosedAt xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:ClosedAt>
     <Chat:RepliedAt xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:RepliedAt>
     <Chat:AlertTimeout xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:AlertTimeout>
     <Chat:Deadline xsi:type="xsd:dateTime">2026-03-26T12:15:31Z</Chat:Deadline>
     ...
     <Chat:TimeSpent xsi:type="xsd:int">0</Chat:TimeSpent>
     ...
     <Chat:ProjectName xsi:type="xsd:string"></Chat:ProjectName>
     <Chat:FormSubmissionId xsi:type="xsd:int">0</Chat:FormSubmissionId>
     <Chat:TicketTypeId xsi:type="xsd:int">0</Chat:TicketTypeId>
     <Chat:TicketTypeName xsi:type="xsd:string"></Chat:TicketTypeName>
    </Chat:Ticket>
    ...
    <Chat:Rating xsi:type="xsd:int">0</Chat:Rating>
   </Chat:Response>
  </Chat:CreateDefaultChatSessionEntityResponse>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
