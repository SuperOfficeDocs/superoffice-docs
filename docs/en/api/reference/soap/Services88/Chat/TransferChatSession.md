---
title: Services88.ChatAgent.TransferChatSession SOAP
generated: true
uid: Services88-Chat-TransferChatSession
content_type: reference
---

# Services88 Chat TransferChatSession

SOAP request and response examples **Remote/Services88/Chat.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IChatAgent.TransferChatSession">SuperOffice.Services88.IChatAgent.TransferChatSession</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Chat:TransferChatSession>
    <Chat:ChatSessionId xsi:type="xsd:int">0</Chat:ChatSessionId>
    <Chat:ToAssociate xsi:type="xsd:string"></Chat:ToAssociate>
   </Chat:TransferChatSession>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Chat="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Chat:TransferChatSessionResponse>
