...
Implemented by the <see cref="M:SuperOffice.Services88.IConfigurationAgent.DeleteSystemEventEntity">SuperOffice.Services88.IConfigurationAgent.DeleteSystemEventEntity</see> method.
