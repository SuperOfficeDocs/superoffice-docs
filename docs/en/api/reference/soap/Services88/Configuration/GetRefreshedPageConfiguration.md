...
Implemented by the <see cref="M:SuperOffice.Services88.IConfigurationAgent.GetRefreshedPageConfiguration">SuperOffice.Services88.IConfigurationAgent.GetRefreshedPageConfiguration</see> method.
