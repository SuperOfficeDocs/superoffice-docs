---
title: Services88.NewsFeedAgent.MarkAsHandled SOAP
generated: true
uid: Services88-NewsFeed-MarkAsHandled
content_type: reference
---

# Services88 NewsFeed MarkAsHandled

SOAP request and response examples **Remote/Services88/NewsFeed.svc**
Implemented by the <see cref="M:SuperOffice.Services88.INewsFeedAgent.MarkAsHandled">SuperOffice.Services88.INewsFeedAgent.MarkAsHandled</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:NewsFeed="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <NewsFeed:MarkAsHandledResponse>
   <NewsFeed:Response xsi:type="xsd:boolean">false</NewsFeed:Response>
  </NewsFeed:MarkAsHandledResponse>
 </SOAP-ENV:Body>
</SOAP-ENV:Envelope>
