---
title: Services88.ContactAgent.GetContactWithPersons SOAP
generated: true
uid: Services88-Contact-GetContactWithPersons
content_type: reference
---

# Services88 Contact GetContactWithPersons

SOAP request and response examples **Remote/Services88/Contact.svc**
Implemented by the <see cref="M:SuperOffice.Services88.IContactAgent.GetContactWithPersons">SuperOffice.Services88.IContactAgent.GetContactWithPersons</see> method.
...
<SOAP-ENV:Envelope
 ...
 xmlns:Contact="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Contact:GetContactWithPersonsResponse>
   <Contact:Response xsi:type="Contact:ContactEntity">
    ...
    <Contact:UpdatedDate xsi:type="xsd:dateTime">2026-01-26T11:32:55Z</Contact:UpdatedDate>
    <Contact:CreatedDate xsi:type="xsd:dateTime">2026-01-26T11:32:55Z</Contact:CreatedDate>
    ...
    <Contact:Interests xsi:type="Contact:ArrayOfSelectableMDOListItem">
     <Contact:SelectableMDOListItem xsi:type="Contact:SelectableMDOListItem">
      ...
      <Contact:LastChanged xsi:type="xsd:dateTime">2026-01-26T11:32:55Z</Contact:LastChanged>
    ...
    <Contact:Category xsi:type="Contact:Category">
     ...
     <Contact:Value xsi:type="xsd:string"></Contact:Value>
     <Contact:Tooltip xsi:type="xsd:string"></Contact:Tooltip>
     <Contact:CategoryGroup xsi:type="Contact:CategoryGroup">Unknown</Contact:CategoryGroup>
     <Contact:EnableLeadStatus xsi:type="xsd:boolean">false</Contact:EnableLeadStatus>
     <Contact:Rank xsi:type="xsd:short">0</Contact:Rank>
     <Contact:Deleted xsi:type="xsd:boolean">false</Contact:Deleted>
    </Contact:Category>
    ...
    <Contact:DbiLastSyncronized xsi:type="xsd:dateTime">2026-01-26T11:32:55Z</Contact:DbiLastSyncronized>
    <Contact:DbiKey xsi:type="xsd:string"></Contact:DbiKey>
    <Contact:DbiLastModified xsi:type="xsd:dateTime">2026-01-26T11:32:55Z</Contact:DbiLastModified>
    ...
    <Contact:UtmParameters xsi:type="Contact:SavedUtmParameters">
     <Contact:FormName xsi:type="xsd:string"></Contact:FormName>
     <Contact:FirsttouchSource xsi:type="xsd:string"></Contact:FirsttouchSource>
     <Contact:FirsttouchMedium xsi:type="xsd:string"></Contact:FirsttouchMedium>
     <Contact:FirsttouchCampaign xsi:type="xsd:string"></Contact:FirsttouchCampaign>
     <Contact:FirsttouchTerm xsi:type="xsd:string"></Contact:FirsttouchTerm>
     <Contact:FirsttouchContent xsi:type="xsd:string"></Contact:FirsttouchContent>
     <Contact:FirsttouchReferrerDomain xsi:type="xsd:string"></Contact:FirsttouchReferrerDomain>
     <Contact:Source xsi:type="xsd:string"></Contact:Source>
     <Contact:Medium xsi:type="xsd:string"></Contact:Medium>
     <Contact:Campaign xsi:type="xsd:string"></Contact:Campaign>
     <Contact:Term xsi:type="xsd:string"></Contact:Term>
     <Contact:Content xsi:type="xsd:string"></Contact:Content>
     <Contact:ReferrerDomain xsi:type="xsd:string"></Contact:ReferrerDomain>
