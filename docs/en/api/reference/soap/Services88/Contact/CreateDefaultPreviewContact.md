...
Implemented by the <see cref="M:SuperOffice.Services88.IContactAgent.CreateDefaultPreviewContact">SuperOffice.Services88.IContactAgent.CreateDefaultPreviewContact</see> method.
...
## CreateDefaultPreviewContact Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Contact:CreateDefaultPreviewContact>
   </Contact:CreateDefaultPreviewContact>
...
## CreateDefaultPreviewContact Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Contact="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Contact:CreateDefaultPreviewContactResponse>
