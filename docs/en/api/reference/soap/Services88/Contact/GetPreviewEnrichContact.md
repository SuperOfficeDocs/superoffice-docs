...
Implemented by the <see cref="M:SuperOffice.Services88.IContactAgent.GetPreviewEnrichContact">SuperOffice.Services88.IContactAgent.GetPreviewEnrichContact</see> method.

## GetPreviewEnrichContact
...
## GetPreviewEnrichContact Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Contact:GetPreviewEnrichContact>
...
## GetPreviewEnrichContact Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Contact="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Contact:GetPreviewEnrichContactResponse>
