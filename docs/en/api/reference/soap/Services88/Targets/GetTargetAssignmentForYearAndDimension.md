---
title: Services88.TargetsAgent.GetTargetAssignmentForYearAndDimension SOAP
generated: true
uid: Services88-Targets-GetTargetAssignmentForYearAndDimension
content_type: reference
---

# Services88 Targets GetTargetAssignmentForYearAndDimension

SOAP request and response examples **Remote/Services88/Targets.svc**
Implemented by the <see cref="M:SuperOffice.Services88.ITargetsAgent.GetTargetAssignmentForYearAndDimension">SuperOffice.Services88.ITargetsAgent.GetTargetAssignmentForYearAndDimension</see> method.

## GetTargetAssignmentForYearAndDimension
...
## GetTargetAssignmentForYearAndDimension Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Targets:GetTargetAssignmentForYearAndDimension>
    ...
    <Targets:TargetLevel xsi:type="Targets:TargetLevel">None</Targets:TargetLevel>
    <Targets:Id xsi:type="xsd:int">0</Targets:Id>
    <Targets:DimensionId xsi:type="xsd:int">0</Targets:DimensionId>
   </Targets:GetTargetAssignmentForYearAndDimension>
...
## GetTargetAssignmentForYearAndDimension Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Targets="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Targets:GetTargetAssignmentForYearAndDimensionResponse>
   <Targets:Response xsi:type="Targets:TargetAssignment">
      ...
      <Targets:LocalizedAddress xsi:type="Targets:ArrayOfArrayOfLocalizedField">
       <Targets:ArrayOfLocalizedField xsi:type="Targets:ArrayOfLocalizedField">
        <Targets:LocalizedField xsi:type="Targets:LocalizedField">
         ...
         <Targets:ValueLength xsi:type="xsd:int">0</Targets:ValueLength>
