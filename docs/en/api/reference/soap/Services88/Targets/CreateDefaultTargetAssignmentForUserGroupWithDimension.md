---
title: Services88.TargetsAgent.CreateDefaultTargetAssignmentForUserGroupWithDimension SOAP
generated: true
uid: Services88-Targets-CreateDefaultTargetAssignmentForUserGroupWithDimension
content_type: reference
---

# Services88 Targets CreateDefaultTargetAssignmentForUserGroupWithDimension

SOAP request and response examples **Remote/Services88/Targets.svc**
Implemented by the <see cref="M:SuperOffice.Services88.ITargetsAgent.CreateDefaultTargetAssignmentForUserGroupWithDimension">SuperOffice.Services88.ITargetsAgent.CreateDefaultTargetAssignmentForUserGroupWithDimension</see> method.

## CreateDefaultTargetAssignmentForUserGroupWithDimension
...
## CreateDefaultTargetAssignmentForUserGroupWithDimension Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Targets:CreateDefaultTargetAssignmentForUserGroupWithDimension>
    <Targets:UserGroupId xsi:type="xsd:int">0</Targets:UserGroupId>
...
## CreateDefaultTargetAssignmentForUserGroupWithDimension Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Targets="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Targets:CreateDefaultTargetAssignmentForUserGroupWithDimensionResponse>
