...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.AddSaleTypeQuoteAttachment">SuperOffice.Services88.IQuoteAgent.AddSaleTypeQuoteAttachment</see> method.
