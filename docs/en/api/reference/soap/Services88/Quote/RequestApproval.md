...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.RequestApproval">SuperOffice.Services88.IQuoteAgent.RequestApproval</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Quote:RequestApproval>
    ...
    <Quote:Comment xsi:type="xsd:string"></Quote:Comment>
   </Quote:RequestApproval>
