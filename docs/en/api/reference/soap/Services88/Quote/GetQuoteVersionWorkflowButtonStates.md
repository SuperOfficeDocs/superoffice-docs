...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.GetQuoteVersionWorkflowButtonStates">SuperOffice.Services88.IQuoteAgent.GetQuoteVersionWorkflowButtonStates</see> method.
