...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.CreateOrUpdateQuoteVersionAttachments">SuperOffice.Services88.IQuoteAgent.CreateOrUpdateQuoteVersionAttachments</see> method.
