...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.GetQuoteLineConfigurationFromFieldName">SuperOffice.Services88.IQuoteAgent.GetQuoteLineConfigurationFromFieldName</see> method.
