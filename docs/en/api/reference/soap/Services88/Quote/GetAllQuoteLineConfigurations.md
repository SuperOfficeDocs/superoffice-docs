...
Implemented by the <see cref="M:SuperOffice.Services88.IQuoteAgent.GetAllQuoteLineConfigurations">SuperOffice.Services88.IQuoteAgent.GetAllQuoteLineConfigurations</see> method.
