...
Implemented by the <see cref="M:SuperOffice.Services88.ITicketAgent.CopyFromCRMDocument">SuperOffice.Services88.ITicketAgent.CopyFromCRMDocument</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Ticket:CopyFromCRMDocument>
    <Ticket:DocumentId xsi:type="xsd:int">0</Ticket:DocumentId>
   </Ticket:CopyFromCRMDocument>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Ticket="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Ticket:CopyFromCRMDocumentResponse>
