---
title: Services88.TicketAgent.SetTicketReadByOwner SOAP
generated: true
uid: Services88-Ticket-SetTicketReadByOwner
content_type: reference
---

# Services88 Ticket SetTicketReadByOwner

SOAP request and response examples **Remote/Services88/Ticket.svc**
Implemented by the <see cref="M:SuperOffice.Services88.ITicketAgent.SetTicketReadByOwner">SuperOffice.Services88.ITicketAgent.SetTicketReadByOwner</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Ticket:SetTicketReadByOwner>
    ...
    <Ticket:CheckEscalating xsi:type="xsd:boolean">false</Ticket:CheckEscalating>
   </Ticket:SetTicketReadByOwner>
...
<SOAP-ENV:Envelope
 ...
 xmlns:Ticket="http://www.superoffice.net/ws/crm/NetServer/Services88">
 <SOAP-ENV:Body>
  <Ticket:SetTicketReadByOwnerResponse>
   <Ticket:Response xsi:type="Ticket:TicketEntity">
    ...
    <Ticket:CreatedAt xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:CreatedAt>
    <Ticket:LastChanged xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:LastChanged>
    <Ticket:ReadByOwner xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:ReadByOwner>
    <Ticket:ReadByCustomer xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:ReadByCustomer>
    <Ticket:FirstReadByOwner xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:FirstReadByOwner>
    <Ticket:FirstReadByUser xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:FirstReadByUser>
    <Ticket:Activate xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:Activate>
    <Ticket:ClosedAt xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:ClosedAt>
    <Ticket:RepliedAt xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:RepliedAt>
    <Ticket:AlertTimeout xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:AlertTimeout>
    <Ticket:Deadline xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:Deadline>
    ...
    <Ticket:Priority xsi:type="Ticket:TicketPriorityEntity">
     ...
     <Ticket:MonStart xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:MonStart>
     <Ticket:MonStop xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:MonStop>
     <Ticket:TueStart xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:TueStart>
     <Ticket:TueStop xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:TueStop>
     <Ticket:WedStart xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:WedStart>
     <Ticket:WedStop xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:WedStop>
     <Ticket:ThuStart xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:ThuStart>
     <Ticket:ThuStop xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:ThuStop>
     <Ticket:FriStart xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:FriStart>
     <Ticket:FriStop xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:FriStop>
     <Ticket:SatStart xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:SatStart>
     <Ticket:SatStop xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:SatStop>
     <Ticket:SunStart xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:SunStart>
     <Ticket:SunStop xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:SunStop>
     <Ticket:NonDates xsi:type="NetServerServices882:ArrayOfdateTime">
      <NetServerServices882:dateTime xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</NetServerServices882:dateTime>
     </Ticket:NonDates>
    ...
    <Ticket:Messages xsi:type="Ticket:ArrayOfTicketMessage">
     <Ticket:TicketMessage xsi:type="Ticket:TicketMessage">
      ...
      <Ticket:ChangedAt xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:ChangedAt>
    ...
    <Ticket:Sale xsi:type="Ticket:Sale">
     <Ticket:ContactName xsi:type="xsd:string"></Ticket:ContactName>
     <Ticket:SaleDate xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:SaleDate>
     ...
     <Ticket:ActiveErpLinks xsi:type="xsd:int">0</Ticket:ActiveErpLinks>
     <Ticket:NextDueDate xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:NextDueDate>
    ...
    <Ticket:Project xsi:type="Ticket:Project">
     ...
     <Ticket:Updated xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:Updated>
     ...
     <Ticket:PublishTo xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:PublishTo>
     <Ticket:PublishFrom xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:PublishFrom>
     ...
     <Ticket:StartDate xsi:type="xsd:dateTime">2026-04-28T11:04:14Z</Ticket:StartDate>
    </Ticket:Project>
