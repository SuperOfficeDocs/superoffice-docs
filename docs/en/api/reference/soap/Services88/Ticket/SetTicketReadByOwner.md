 ...
 <SOAP-ENV:Body>
  <Ticket:SetTicketReadByOwnerResponse>
   <Ticket:Response xsi:type="Ticket:TicketEntity">
    ...
    <Ticket:CreatedAt xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:CreatedAt>
    <Ticket:LastChanged xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:LastChanged>
    <Ticket:ReadByOwner xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:ReadByOwner>
    <Ticket:ReadByCustomer xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:ReadByCustomer>
    <Ticket:FirstReadByOwner xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:FirstReadByOwner>
    <Ticket:FirstReadByUser xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:FirstReadByUser>
    <Ticket:Activate xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:Activate>
    <Ticket:ClosedAt xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:ClosedAt>
    <Ticket:RepliedAt xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:RepliedAt>
    <Ticket:AlertTimeout xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:AlertTimeout>
    <Ticket:Deadline xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:Deadline>
    ...
    <Ticket:Priority xsi:type="Ticket:TicketPriorityEntity">
     ...
     <Ticket:MonStart xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:MonStart>
     <Ticket:MonStop xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:MonStop>
     <Ticket:TueStart xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:TueStart>
     <Ticket:TueStop xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:TueStop>
     <Ticket:WedStart xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:WedStart>
     <Ticket:WedStop xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:WedStop>
     <Ticket:ThuStart xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:ThuStart>
     <Ticket:ThuStop xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:ThuStop>
     <Ticket:FriStart xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:FriStart>
     <Ticket:FriStop xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:FriStop>
     <Ticket:SatStart xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:SatStart>
     <Ticket:SatStop xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:SatStop>
     <Ticket:SunStart xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:SunStart>
     <Ticket:SunStop xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:SunStop>
     <Ticket:NonDates xsi:type="NetServerServices882:ArrayOfdateTime">
      <NetServerServices882:dateTime xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</NetServerServices882:dateTime>
     </Ticket:NonDates>
    ...
    <Ticket:Messages xsi:type="Ticket:ArrayOfTicketMessage">
     <Ticket:TicketMessage xsi:type="Ticket:TicketMessage">
      ...
      <Ticket:ChangedAt xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:ChangedAt>
    ...
    <Ticket:Sale xsi:type="Ticket:Sale">
     <Ticket:ContactName xsi:type="xsd:string"></Ticket:ContactName>
     <Ticket:SaleDate xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:SaleDate>
     ...
     <Ticket:ActiveErpLinks xsi:type="xsd:int">0</Ticket:ActiveErpLinks>
     <Ticket:NextDueDate xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:NextDueDate>
    ...
    <Ticket:Project xsi:type="Ticket:Project">
     ...
     <Ticket:Updated xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:Updated>
     ...
     <Ticket:PublishTo xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:PublishTo>
     <Ticket:PublishFrom xsi:type="xsd:dateTime">2026-01-21T01:34:47Z</Ticket:PublishFrom>
