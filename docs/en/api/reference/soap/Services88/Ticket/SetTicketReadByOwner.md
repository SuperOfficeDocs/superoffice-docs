 ...
 <SOAP-ENV:Body>
  <Ticket:SetTicketReadByOwnerResponse>
   <Ticket:Response xsi:type="Ticket:TicketEntity">
    ...
    <Ticket:CreatedAt xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:CreatedAt>
    <Ticket:LastChanged xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:LastChanged>
    <Ticket:ReadByOwner xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:ReadByOwner>
    <Ticket:ReadByCustomer xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:ReadByCustomer>
    <Ticket:FirstReadByOwner xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:FirstReadByOwner>
    <Ticket:FirstReadByUser xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:FirstReadByUser>
    <Ticket:Activate xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:Activate>
    <Ticket:ClosedAt xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:ClosedAt>
    <Ticket:RepliedAt xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:RepliedAt>
    <Ticket:AlertTimeout xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:AlertTimeout>
    <Ticket:Deadline xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:Deadline>
    ...
    <Ticket:Priority xsi:type="Ticket:TicketPriorityEntity">
     ...
     <Ticket:MonStart xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:MonStart>
     <Ticket:MonStop xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:MonStop>
     <Ticket:TueStart xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:TueStart>
     <Ticket:TueStop xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:TueStop>
     <Ticket:WedStart xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:WedStart>
     <Ticket:WedStop xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:WedStop>
     <Ticket:ThuStart xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:ThuStart>
     <Ticket:ThuStop xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:ThuStop>
     <Ticket:FriStart xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:FriStart>
     <Ticket:FriStop xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:FriStop>
     <Ticket:SatStart xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:SatStart>
     <Ticket:SatStop xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:SatStop>
     <Ticket:SunStart xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:SunStart>
     <Ticket:SunStop xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:SunStop>
     <Ticket:NonDates xsi:type="NetServerServices882:ArrayOfdateTime">
      <NetServerServices882:dateTime xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</NetServerServices882:dateTime>
     </Ticket:NonDates>
    ...
    <Ticket:Messages xsi:type="Ticket:ArrayOfTicketMessage">
     <Ticket:TicketMessage xsi:type="Ticket:TicketMessage">
      ...
      <Ticket:ChangedAt xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:ChangedAt>
    ...
    <Ticket:Sale xsi:type="Ticket:Sale">
     <Ticket:ContactName xsi:type="xsd:string"></Ticket:ContactName>
     <Ticket:SaleDate xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:SaleDate>
     ...
     <Ticket:ActiveErpLinks xsi:type="xsd:int">0</Ticket:ActiveErpLinks>
     <Ticket:NextDueDate xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:NextDueDate>
    ...
    <Ticket:Project xsi:type="Ticket:Project">
     ...
     <Ticket:Updated xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:Updated>
     ...
     <Ticket:PublishTo xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:PublishTo>
     <Ticket:PublishFrom xsi:type="xsd:dateTime">2023-01-23T10:22:08Z</Ticket:PublishFrom>
