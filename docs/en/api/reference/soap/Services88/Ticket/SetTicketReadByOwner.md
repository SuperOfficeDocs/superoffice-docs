 ...
 <SOAP-ENV:Body>
  <Ticket:SetTicketReadByOwnerResponse>
   <Ticket:Response xsi:type="Ticket:TicketEntity">
    ...
    <Ticket:CreatedAt xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:CreatedAt>
    <Ticket:LastChanged xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:LastChanged>
    <Ticket:ReadByOwner xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:ReadByOwner>
    <Ticket:ReadByCustomer xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:ReadByCustomer>
    <Ticket:FirstReadByOwner xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:FirstReadByOwner>
    <Ticket:FirstReadByUser xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:FirstReadByUser>
    <Ticket:Activate xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:Activate>
    <Ticket:ClosedAt xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:ClosedAt>
    <Ticket:RepliedAt xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:RepliedAt>
    <Ticket:AlertTimeout xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:AlertTimeout>
    <Ticket:Deadline xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:Deadline>
    ...
    <Ticket:Priority xsi:type="Ticket:TicketPriorityEntity">
     ...
     <Ticket:MonStart xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:MonStart>
     <Ticket:MonStop xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:MonStop>
     <Ticket:TueStart xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:TueStart>
     <Ticket:TueStop xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:TueStop>
     <Ticket:WedStart xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:WedStart>
     <Ticket:WedStop xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:WedStop>
     <Ticket:ThuStart xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:ThuStart>
     <Ticket:ThuStop xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:ThuStop>
     <Ticket:FriStart xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:FriStart>
     <Ticket:FriStop xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:FriStop>
     <Ticket:SatStart xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:SatStart>
     <Ticket:SatStop xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:SatStop>
     <Ticket:SunStart xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:SunStart>
     <Ticket:SunStop xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:SunStop>
     <Ticket:NonDates xsi:type="NetServerServices882:ArrayOfdateTime">
      <NetServerServices882:dateTime xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</NetServerServices882:dateTime>
     </Ticket:NonDates>
    ...
    <Ticket:Messages xsi:type="Ticket:ArrayOfTicketMessage">
     <Ticket:TicketMessage xsi:type="Ticket:TicketMessage">
      ...
      <Ticket:ChangedAt xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:ChangedAt>
    ...
    <Ticket:Sale xsi:type="Ticket:Sale">
     <Ticket:ContactName xsi:type="xsd:string"></Ticket:ContactName>
     <Ticket:SaleDate xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:SaleDate>
     ...
     <Ticket:ActiveErpLinks xsi:type="xsd:int">0</Ticket:ActiveErpLinks>
     <Ticket:NextDueDate xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:NextDueDate>
    ...
    <Ticket:Project xsi:type="Ticket:Project">
     ...
     <Ticket:Updated xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:Updated>
     ...
     <Ticket:PublishTo xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:PublishTo>
     <Ticket:PublishFrom xsi:type="xsd:dateTime">2023-03-01T11:14:55Z</Ticket:PublishFrom>
