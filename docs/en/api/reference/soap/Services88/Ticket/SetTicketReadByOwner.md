 ...
 <SOAP-ENV:Body>
  <Ticket:SetTicketReadByOwnerResponse>
   <Ticket:Response xsi:type="Ticket:TicketEntity">
    ...
    <Ticket:CreatedAt xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:CreatedAt>
    <Ticket:LastChanged xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:LastChanged>
    <Ticket:ReadByOwner xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:ReadByOwner>
    <Ticket:ReadByCustomer xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:ReadByCustomer>
    <Ticket:FirstReadByOwner xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:FirstReadByOwner>
    <Ticket:FirstReadByUser xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:FirstReadByUser>
    <Ticket:Activate xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:Activate>
    <Ticket:ClosedAt xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:ClosedAt>
    <Ticket:RepliedAt xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:RepliedAt>
    <Ticket:AlertTimeout xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:AlertTimeout>
    <Ticket:Deadline xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:Deadline>
    ...
    <Ticket:Priority xsi:type="Ticket:TicketPriorityEntity">
     ...
     <Ticket:MonStart xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:MonStart>
     <Ticket:MonStop xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:MonStop>
     <Ticket:TueStart xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:TueStart>
     <Ticket:TueStop xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:TueStop>
     <Ticket:WedStart xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:WedStart>
     <Ticket:WedStop xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:WedStop>
     <Ticket:ThuStart xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:ThuStart>
     <Ticket:ThuStop xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:ThuStop>
     <Ticket:FriStart xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:FriStart>
     <Ticket:FriStop xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:FriStop>
     <Ticket:SatStart xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:SatStart>
     <Ticket:SatStop xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:SatStop>
     <Ticket:SunStart xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:SunStart>
     <Ticket:SunStop xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:SunStop>
     <Ticket:NonDates xsi:type="NetServerServices882:ArrayOfdateTime">
      <NetServerServices882:dateTime xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</NetServerServices882:dateTime>
     </Ticket:NonDates>
    ...
    <Ticket:Messages xsi:type="Ticket:ArrayOfTicketMessage">
     <Ticket:TicketMessage xsi:type="Ticket:TicketMessage">
      ...
      <Ticket:ChangedAt xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:ChangedAt>
    ...
    <Ticket:Sale xsi:type="Ticket:Sale">
     <Ticket:ContactName xsi:type="xsd:string"></Ticket:ContactName>
     <Ticket:SaleDate xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:SaleDate>
     ...
     <Ticket:ActiveErpLinks xsi:type="xsd:int">0</Ticket:ActiveErpLinks>
     <Ticket:NextDueDate xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:NextDueDate>
    ...
    <Ticket:Project xsi:type="Ticket:Project">
     ...
     <Ticket:Updated xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:Updated>
     ...
     <Ticket:PublishTo xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:PublishTo>
     <Ticket:PublishFrom xsi:type="xsd:dateTime">2023-06-09T14:00:17Z</Ticket:PublishFrom>
