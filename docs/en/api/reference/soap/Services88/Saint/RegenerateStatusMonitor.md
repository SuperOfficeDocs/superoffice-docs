...
Implemented by the <see cref="M:SuperOffice.Services88.ISaintAgent.RegenerateStatusMonitor">SuperOffice.Services88.ISaintAgent.RegenerateStatusMonitor</see> method.
