---
title: Services87.UserAgent.CreateDefaultUserFromUserTypeAndCredential SOAP
generated: 1
uid: Services87-User-CreateDefaultUserFromUserTypeAndCredential
---

# Services87 User CreateDefaultUserFromUserTypeAndCredential

SOAP request and response examples **Remote/Services87/User.svc**
Implemented by the <see cref="M:SuperOffice.Services87.IUserAgent.CreateDefaultUserFromUserTypeAndCredential">SuperOffice.Services87.IUserAgent.CreateDefaultUserFromUserTypeAndCredential</see> method.
...
## CreateDefaultUserFromUserTypeAndCredential Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <User:CreateDefaultUserFromUserTypeAndCredential>
    ...
    <User:CredentialValue xsi:type="xsd:string"></User:CredentialValue>
    <User:CredentialDisplayValue xsi:type="xsd:string"></User:CredentialDisplayValue>
   </User:CreateDefaultUserFromUserTypeAndCredential>
...
<SOAP-ENV:Envelope
 ...
 xmlns:User="http://www.superoffice.net/ws/crm/NetServer/Services87">
 <SOAP-ENV:Body>
  <User:CreateDefaultUserFromUserTypeAndCredentialResponse>
   <User:Response xsi:type="User:User">
    ...
    <User:Deleted xsi:type="xsd:boolean">false</User:Deleted>
    <User:Lastlogin xsi:type="xsd:dateTime">2023-03-01T11:12:30Z</User:Lastlogin>
    <User:Lastlogout xsi:type="xsd:dateTime">2023-03-01T11:12:30Z</User:Lastlogout>
     ...
     <User:MDOListItem xsi:type="User:MDOListItem">
      ...
      <User:ChildItems xsi:type="User:ArrayOfMDOListItem">
       <User:MDOListItem xsi:type="User:MDOListItem">
        ...
        <User:ChildItems xsi:type="User:ArrayOfMDOListItem">
         <User:MDOListItem xsi:type="User:MDOListItem">
          <User:Id xsi:nil="true"></User:Id>
          <User:Name xsi:type="xsd:string"></User:Name>
          <User:ToolTip xsi:type="xsd:string"></User:ToolTip>
          <User:Deleted xsi:nil="true"></User:Deleted>
          <User:Rank xsi:nil="true"></User:Rank>
          <User:Type xsi:type="xsd:string"></User:Type>
          <User:ChildItems xsi:nil="true"></User:ChildItems>
          <User:IconHint xsi:type="xsd:string"></User:IconHint>
          <User:ColorBlock xsi:nil="true"></User:ColorBlock>
