---
title: Services87.AppointmentAgent.Move SOAP
generated: 1
uid: Services87-Appointment-Move
---

# Services87 Appointment Move

SOAP request and response examples **Remote/Services87/Appointment.svc**
Implemented by the <see cref="M:SuperOffice.Services87.IAppointmentAgent.Move">SuperOffice.Services87.IAppointmentAgent.Move</see> method.
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Appointment:Move>
    ...
    <Appointment:NewStartTime xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:NewStartTime>
 ...
 <SOAP-ENV:Body>
  <Appointment:MoveResponse>
   <Appointment:Response xsi:type="Appointment:AppointmentEntity">
    ...
    <Appointment:CreatedDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:CreatedDate>
    <Appointment:AppointmentId xsi:type="xsd:int">0</Appointment:AppointmentId>
    <Appointment:Description xsi:type="xsd:string"></Appointment:Description>
    <Appointment:StartDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:StartDate>
    <Appointment:EndDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:EndDate>
    ...
    <Appointment:Project xsi:type="Appointment:Project">
     ...
     <Appointment:Updated xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:Updated>
     ...
     <Appointment:PublishTo xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:PublishTo>
     <Appointment:PublishFrom xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:PublishFrom>
    ...
    <Appointment:UpdatedDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:UpdatedDate>
    ...
    <Appointment:Recurrence xsi:type="Appointment:RecurrenceInfo">
     ...
     <Appointment:Dates xsi:type="Appointment:ArrayOfRecurrenceDate">
      <Appointment:RecurrenceDate xsi:type="Appointment:RecurrenceDate">
       <Appointment:Date xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:Date>
    ...
    <Appointment:ActiveDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:ActiveDate>
    ...
    <Appointment:Sale xsi:type="Appointment:Sale">
     <Appointment:ContactName xsi:type="xsd:string"></Appointment:ContactName>
     <Appointment:SaleDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:SaleDate>
     ...
     <Appointment:Completed xsi:type="Appointment:ActivityStatus">Unknown</Appointment:Completed>
     <Appointment:ActiveErpLinks xsi:type="xsd:int">0</Appointment:ActiveErpLinks>
     <Appointment:NextDueDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:NextDueDate>
    </Appointment:Sale>
    ...
    <Appointment:PublishEventDate xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:PublishEventDate>
    <Appointment:PublishTo xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:PublishTo>
    <Appointment:PublishFrom xsi:type="xsd:dateTime">2023-02-15T13:14:27Z</Appointment:PublishFrom>
    <Appointment:IsPublished xsi:type="xsd:boolean">false</Appointment:IsPublished>
