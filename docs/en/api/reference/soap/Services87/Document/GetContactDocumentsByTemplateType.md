---
title: Services87.DocumentAgent.GetContactDocumentsByTemplateType SOAP
generated: 1
uid: Services87-Document-GetContactDocumentsByTemplateType
---

# Services87 Document GetContactDocumentsByTemplateType

SOAP request and response examples **Remote/Services87/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services87.IDocumentAgent.GetContactDocumentsByTemplateType">SuperOffice.Services87.IDocumentAgent.GetContactDocumentsByTemplateType</see> method.
...
## GetContactDocumentsByTemplateType Request
...
<SOAP-ENV:Envelope
 ...
 <SOAP-ENV:Body>
   <Document:GetContactDocumentsByTemplateType>
    ...
    <Document:StartTime xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:StartTime>
    <Document:EndTime xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:EndTime>
...
## GetContactDocumentsByTemplateType Response
...
<SOAP-ENV:Envelope
 ...
 xmlns:Document="http://www.superoffice.net/ws/crm/NetServer/Services87">
 <SOAP-ENV:Body>
  <Document:GetContactDocumentsByTemplateTypeResponse>
