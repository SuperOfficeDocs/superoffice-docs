---
title: Services87.DocumentAgent.CreateNewPhysicalDocumentFromTemplateWithCustomTags SOAP
generated: 1
uid: Services87-Document-CreateNewPhysicalDocumentFromTemplateWithCustomTags
---

# Services87 Document CreateNewPhysicalDocumentFromTemplateWithCustomTags

SOAP request and response examples **Remote/Services87/Document.svc**
Implemented by the <see cref="M:SuperOffice.Services87.IDocumentAgent.CreateNewPhysicalDocumentFromTemplateWithCustomTags">SuperOffice.Services87.IDocumentAgent.CreateNewPhysicalDocumentFromTemplateWithCustomTags</see> method.
 ...
 <SOAP-ENV:Body>
  <Document:CreateNewPhysicalDocumentFromTemplateWithCustomTagsResponse>
   <Document:Response xsi:type="Document:DocumentEntity">
    ...
    <Document:CreatedDate xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:CreatedDate>
    <Document:UpdatedDate xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:UpdatedDate>
    ...
    <Document:Project xsi:type="Document:Project">
     ...
     <Document:Updated xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:Updated>
     ...
     <Document:PublishTo xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:PublishTo>
     <Document:PublishFrom xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:PublishFrom>
    ...
    <Document:Date xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:Date>
    ...
    <Document:Sale xsi:type="Document:Sale">
     <Document:ContactName xsi:type="xsd:string"></Document:ContactName>
     <Document:SaleDate xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:SaleDate>
     <Document:SaleId xsi:type="xsd:int">0</Document:SaleId>
     ...
     <Document:Completed xsi:type="Document:ActivityStatus">Unknown</Document:Completed>
     <Document:ActiveErpLinks xsi:type="xsd:int">0</Document:ActiveErpLinks>
     <Document:NextDueDate xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:NextDueDate>
    </Document:Sale>
    ...
    <Document:PublishEventDate xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:PublishEventDate>
    <Document:PublishTo xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:PublishTo>
    <Document:PublishFrom xsi:type="xsd:dateTime">2023-02-15T13:15:03Z</Document:PublishFrom>
    <Document:IsPublished xsi:type="xsd:boolean">false</Document:IsPublished>
