...
GET /api/v1/ForeignApp?$entities=sequi
GET /api/v1/ForeignApp?$top=188
GET /api/v1/ForeignApp?$skip=35
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2126,
      "fullName": "Jeanie Chyna Walter DDS"
    },
    {
      "PrimaryKey": 3453,
      "EntityName": "person",
      "personId": 3453,
      "fullName": "Emelia Lonny Larson IV"
    }
  ]
}
```