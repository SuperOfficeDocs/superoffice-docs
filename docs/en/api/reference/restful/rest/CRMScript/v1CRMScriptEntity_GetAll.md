...
GET /api/v1/CRMScript?$entities=enim
GET /api/v1/CRMScript?$top=540
GET /api/v1/CRMScript?$skip=287
GET /api/v1/CRMScript?$mode=Full
GET /api/v1/CRMScript?$options=GrandTotal=true
GET /api/v1/CRMScript?$context=incidunt
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3699,
      "fullName": "Finn Lynch V"
    },
    {
      "PrimaryKey": 4002,
      "EntityName": "person",
      "personId": 4002,
      "fullName": "Celestino Reilly"
    }
  ]
}
```