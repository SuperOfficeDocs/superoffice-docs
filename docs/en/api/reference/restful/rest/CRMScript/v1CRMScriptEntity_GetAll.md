...
GET /api/v1/CRMScript?$entities=ullam
GET /api/v1/CRMScript?$top=4
GET /api/v1/CRMScript?$skip=194
GET /api/v1/CRMScript?$mode=Full
GET /api/v1/CRMScript?$options=GrandTotal=true
GET /api/v1/CRMScript?$context=qui
