...
GET /api/v1/ChatSession?$entities=omnis
GET /api/v1/ChatSession?$top=93
GET /api/v1/ChatSession?$skip=4
GET /api/v1/ChatSession?$mode=Full
GET /api/v1/ChatSession?$options=GrandTotal=true
GET /api/v1/ChatSession?$context=omnis
  ...
  "value": [
    {
      ...
      "saleId": 6690,
      "contactId": 1739,
      "name": "Oberbrunner, Beier and Leannon"
    },
    {
      "PrimaryKey": 6364,
      "EntityName": "sale",
      "saleId": 6364,
      "contactId": 5515,
      "name": "Effertz, Lubowitz and Predovic"
    }
  ]
}
```