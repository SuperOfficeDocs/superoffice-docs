...
GET /api/v1/ChatSession?$entities=quo
GET /api/v1/ChatSession?$top=289
GET /api/v1/ChatSession?$skip=372
GET /api/v1/ChatSession?$mode=Full
GET /api/v1/ChatSession?$options=GrandTotal=true
GET /api/v1/ChatSession?$context=amet
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8490,
      "fullName": "Miss Addie Thiel DDS"
    },
    {
      "PrimaryKey": 2330,
      "EntityName": "person",
      "personId": 2330,
      "fullName": "Mr. Oliver Brekke V"
    }
  ]
}
```