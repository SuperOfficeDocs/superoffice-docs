...
OData list of all SelectionEntity.


Can be sorted and further filtered using OData conventions:

* Selection?$select=col1,col2,abc/col3
* Selection?$filter=col1 eq 'foo' and startswith(col2, 'baz')
* Selection?$orderby=abc/col3,col1
* Selection?$top=1000
* Selection?$mode=full
...
Calls the Archive service using the "FindSelection" archive.
...
GET /api/v1/Selection?$entities=consequuntur
GET /api/v1/Selection?$top=893
GET /api/v1/Selection?$skip=387
GET /api/v1/Selection?$mode=Full
GET /api/v1/Selection?$options=GrandTotal=true
GET /api/v1/Selection?$context=modi
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7096,
      "fullName": "Josefa Darron Cronin II"
    },
    {
      "PrimaryKey": 4954,
      "EntityName": "person",
      "personId": 4954,
      "fullName": "Merlin Elva Ziemann DDS"
    }
  ]
}
```