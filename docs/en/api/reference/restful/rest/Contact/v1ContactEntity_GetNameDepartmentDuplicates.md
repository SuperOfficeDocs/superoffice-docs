...
```http
GET /api/v1/Contact/Duplicates/{name}?department=dolores
```
...
[
  {
    "RuleName": "Muller, Kertzmann and Jenkins",
    "SoPrimaryKey": 945,
    "EntryName": "Schimmel Inc and Sons",
    "EntryIdentifier": "atque",
    "RuleDisplayName": "Daugherty, Pagac and Sipes",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
