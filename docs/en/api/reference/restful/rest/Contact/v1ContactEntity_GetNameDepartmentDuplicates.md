...
```http
GET /api/v1/Contact/Duplicates/{name}?department=officiis
```
...
[
  {
    "RuleName": "Parker-Konopelski",
    "SoPrimaryKey": 45,
    "EntryName": "Monahan, Hudson and Mayert",
    "EntryIdentifier": "illum",
    "RuleDisplayName": "Morar, Konopelski and Smitham",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
