...
```http
GET /api/v1/Contact/Duplicates/{name}?department=praesentium
```
...
[
  {
    "RuleName": "Willms-Abernathy",
    "SoPrimaryKey": 370,
    "EntryName": "Leannon, Hammes and Tromp",
    "EntryIdentifier": "consequuntur",
    "RuleDisplayName": "Collins-Schamberger",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
