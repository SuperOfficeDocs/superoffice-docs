...
```http
GET /api/v1/Contact/Duplicates/{name}?department=est
```
...
[
  {
    "RuleName": "Dicki, Schmidt and Ward",
    "SoPrimaryKey": 266,
    "EntryName": "Welch, Stark and Hegmann",
    "EntryIdentifier": "occaecati",
    "RuleDisplayName": "Champlin, Connelly and Gislason",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
