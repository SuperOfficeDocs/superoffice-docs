...
```http
GET /api/v1/Contact/Duplicates/{name}?department=adipisci
```
...
[
  {
    "RuleName": "Stokes Group",
    "SoPrimaryKey": 332,
    "EntryName": "Ratke-Breitenberg",
    "EntryIdentifier": "possimus",
    "RuleDisplayName": "Emmerich-Kozey",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
