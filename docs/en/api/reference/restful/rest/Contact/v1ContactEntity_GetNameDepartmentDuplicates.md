...
```http
GET /api/v1/Contact/Duplicates/{name}?department=voluptatem
```
...
[
  {
    "RuleName": "Lockman-McCullough",
    "SoPrimaryKey": 408,
    "EntryName": "Borer, Gottlieb and Gerhold",
    "EntryIdentifier": "tempore",
    "RuleDisplayName": "Schulist, Hilll and Kub",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
