...
GET /api/v1/Contact/{id}/Projects?$entities=rerum
GET /api/v1/Contact/{id}/Projects?$top=739
GET /api/v1/Contact/{id}/Projects?$skip=902
GET /api/v1/Contact/{id}/Projects?$mode=Full
GET /api/v1/Contact/{id}/Projects?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Projects?$context=hic
