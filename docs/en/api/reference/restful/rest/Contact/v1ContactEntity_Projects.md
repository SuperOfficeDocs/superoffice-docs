...
GET /api/v1/Contact/{id}/Projects?$entities=odit
GET /api/v1/Contact/{id}/Projects?$top=281
GET /api/v1/Contact/{id}/Projects?$skip=518
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1519,
      "fullName": "Kennith Eichmann PhD"
    },
    {
      "PrimaryKey": 4071,
      "EntityName": "person",
      "personId": 4071,
      "fullName": "Jarret Emmerich"
    }
  ]
}
```