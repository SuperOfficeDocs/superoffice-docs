...
GET /api/v1/Contact/{id}/Projects?$entities=doloribus
GET /api/v1/Contact/{id}/Projects?$top=497
GET /api/v1/Contact/{id}/Projects?$skip=734
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5740,
      "fullName": "Leonel Beer"
    },
    {
      "PrimaryKey": 3485,
      "EntityName": "person",
      "personId": 3485,
      "fullName": "Claudie Sawayn DVM"
    }
  ]
}
```