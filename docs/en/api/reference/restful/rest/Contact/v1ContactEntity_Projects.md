...
GET /api/v1/Contact/{id}/Projects?$entities=qui
GET /api/v1/Contact/{id}/Projects?$top=198
GET /api/v1/Contact/{id}/Projects?$skip=228
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3150,
      "fullName": "Katrine Wisoky"
    },
    {
      "PrimaryKey": 8012,
      "EntityName": "person",
      "personId": 8012,
      "fullName": "Thurman Brakus"
    }
  ]
}
```