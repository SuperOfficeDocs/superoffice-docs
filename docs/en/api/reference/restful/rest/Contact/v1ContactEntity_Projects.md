...
GET /api/v1/Contact/{id}/Projects?$entities=delectus
GET /api/v1/Contact/{id}/Projects?$top=403
GET /api/v1/Contact/{id}/Projects?$skip=742
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3763,
      "fullName": "Alia Hettinger"
    },
    {
      "PrimaryKey": 1904,
      "EntityName": "person",
      "personId": 1904,
      "fullName": "Mr. Leonor Darien Bartell"
    }
  ]
}
```