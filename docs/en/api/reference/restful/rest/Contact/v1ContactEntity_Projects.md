...
GET /api/v1/Contact/{id}/Projects?$entities=ratione
GET /api/v1/Contact/{id}/Projects?$top=94
GET /api/v1/Contact/{id}/Projects?$skip=823
GET /api/v1/Contact/{id}/Projects?$mode=Full
GET /api/v1/Contact/{id}/Projects?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Projects?$context=aperiam
