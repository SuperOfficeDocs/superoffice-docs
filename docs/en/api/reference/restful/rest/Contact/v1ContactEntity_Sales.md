...
GET /api/v1/Contact/{id}/Sales?$entities=vero
GET /api/v1/Contact/{id}/Sales?$top=41
GET /api/v1/Contact/{id}/Sales?$skip=442
GET /api/v1/Contact/{id}/Sales?$mode=Full
GET /api/v1/Contact/{id}/Sales?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Sales?$context=sapiente
