...
GET /api/v1/Contact/{id}/Sales?$entities=voluptatem
GET /api/v1/Contact/{id}/Sales?$top=111
GET /api/v1/Contact/{id}/Sales?$skip=434
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 224,
      "fullName": "Carlo Johnston DDS"
    },
    {
      "PrimaryKey": 6180,
      "EntityName": "person",
      "personId": 6180,
      "fullName": "Ms. Ahmad King Jr."
    }
  ]
}
```