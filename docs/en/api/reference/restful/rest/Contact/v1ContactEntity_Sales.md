...
GET /api/v1/Contact/{id}/Sales?$entities=repellat
GET /api/v1/Contact/{id}/Sales?$top=968
GET /api/v1/Contact/{id}/Sales?$skip=940
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4400,
      "fullName": "Tevin Bashirian"
    },
    {
      "PrimaryKey": 2924,
      "EntityName": "person",
      "personId": 2924,
      "fullName": "Bennie Abshire"
    }
  ]
}
```