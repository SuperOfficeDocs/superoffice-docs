...
GET /api/v1/Contact/{id}/Sales?$entities=provident
GET /api/v1/Contact/{id}/Sales?$top=420
GET /api/v1/Contact/{id}/Sales?$skip=128
GET /api/v1/Contact/{id}/Sales?$mode=Full
GET /api/v1/Contact/{id}/Sales?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Sales?$context=nam
