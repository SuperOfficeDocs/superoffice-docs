...
GET /api/v1/Contact/{id}/Sales?$entities=ratione
GET /api/v1/Contact/{id}/Sales?$top=88
GET /api/v1/Contact/{id}/Sales?$skip=642
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1274,
      "fullName": "Dayton Ernser"
    },
    {
      "PrimaryKey": 8066,
      "EntityName": "person",
      "personId": 8066,
      "fullName": "Steve VonRueden"
    }
  ]
}
```