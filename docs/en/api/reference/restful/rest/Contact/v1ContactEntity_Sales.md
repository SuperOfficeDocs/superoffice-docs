...
GET /api/v1/Contact/{id}/Sales?$top=61
GET /api/v1/Contact/{id}/Sales?$skip=962
GET /api/v1/Contact/{id}/Sales?$mode=Full
GET /api/v1/Contact/{id}/Sales?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Sales?$context=rerum
