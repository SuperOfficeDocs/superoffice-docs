...
GET /api/v1/Contact/{id}/Sales?$entities=iure
GET /api/v1/Contact/{id}/Sales?$top=647
GET /api/v1/Contact/{id}/Sales?$skip=383
GET /api/v1/Contact/{id}/Sales?$mode=Full
GET /api/v1/Contact/{id}/Sales?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Sales?$context=facere
