...
GET /api/v1/Contact/{id}/Sales?$entities=velit
GET /api/v1/Contact/{id}/Sales?$top=550
GET /api/v1/Contact/{id}/Sales?$skip=104
GET /api/v1/Contact/{id}/Sales?$mode=Full
GET /api/v1/Contact/{id}/Sales?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Sales?$context=nostrum
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9673,
      "fullName": "Pansy Leannon II"
    },
    {
      "PrimaryKey": 9698,
      "EntityName": "person",
      "personId": 9698,
      "fullName": "Miss Henry Richard Bogan"
    }
  ]
}
```