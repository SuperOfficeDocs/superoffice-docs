...
GET /api/v1/Contact/{id}/Persons?$entities=consectetur
GET /api/v1/Contact/{id}/Persons?$top=567
GET /api/v1/Contact/{id}/Persons?$skip=443
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=magni
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7256,
      "fullName": "Emery White"
    },
    {
      "PrimaryKey": 4367,
      "EntityName": "person",
      "personId": 4367,
      "fullName": "Armand Pacocha Jr."
    }
  ]
}
```