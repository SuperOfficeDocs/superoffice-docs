...
GET /api/v1/Contact/{id}/Persons?$entities=sint
GET /api/v1/Contact/{id}/Persons?$top=512
GET /api/v1/Contact/{id}/Persons?$skip=36
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=eius
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7956,
      "fullName": "Ms. Gabe Ward II"
    },
    {
      "PrimaryKey": 3753,
      "EntityName": "person",
      "personId": 3753,
      "fullName": "Ms. Amely Euna Morissette"
    }
  ]
}
```