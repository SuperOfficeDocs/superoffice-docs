...
GET /api/v1/Contact/{id}/Persons?$top=827
GET /api/v1/Contact/{id}/Persons?$skip=496
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=amet
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2311,
      "fullName": "Prof. Isabella Lemke IV"
    },
    {
      "PrimaryKey": 6195,
      "EntityName": "person",
      "personId": 6195,
      "fullName": "Gaston Lubowitz"
    }
  ]
}
```