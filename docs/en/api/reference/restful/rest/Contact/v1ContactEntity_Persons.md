...
GET /api/v1/Contact/{id}/Persons?$entities=minima
GET /api/v1/Contact/{id}/Persons?$top=262
GET /api/v1/Contact/{id}/Persons?$skip=750
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=aut
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7076,
      "fullName": "Mrs. Earline McKenzie"
    },
    {
      "PrimaryKey": 1763,
      "EntityName": "person",
      "personId": 1763,
      "fullName": "Felipe Thompson V"
    }
  ]
}
```