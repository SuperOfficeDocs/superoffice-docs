...
GET /api/v1/Contact/{id}/Persons?$entities=laborum
GET /api/v1/Contact/{id}/Persons?$top=921
GET /api/v1/Contact/{id}/Persons?$skip=603
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5515,
      "fullName": "Furman Russel"
    },
    {
      "PrimaryKey": 2337,
      "EntityName": "person",
      "personId": 2337,
      "fullName": "Joy Hegmann"
    }
  ]
}
```