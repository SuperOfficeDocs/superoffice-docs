...
GET /api/v1/Contact/{id}/Persons?$entities=unde
GET /api/v1/Contact/{id}/Persons?$top=485
GET /api/v1/Contact/{id}/Persons?$skip=90
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=quisquam
  ...
  "value": [
    {
      ...
      "saleId": 3801,
      "contactId": 9193,
      "name": "Ruecker, Jakubowski and Jacobi"
    },
    {
      "PrimaryKey": 222,
      "EntityName": "sale",
