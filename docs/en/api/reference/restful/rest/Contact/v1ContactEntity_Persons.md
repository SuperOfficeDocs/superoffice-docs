...
GET /api/v1/Contact/{id}/Persons?$entities=occaecati
GET /api/v1/Contact/{id}/Persons?$top=67
GET /api/v1/Contact/{id}/Persons?$skip=706
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4308,
      "fullName": "Lavern Collier"
    },
    {
      "PrimaryKey": 8728,
      "EntityName": "person",
      "personId": 8728,
      "fullName": "Mrs. Oleta Casimer Smitham"
    }
  ]
}
```