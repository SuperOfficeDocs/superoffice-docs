...
GET /api/v1/Contact/{id}/Persons?$entities=eveniet
GET /api/v1/Contact/{id}/Persons?$top=679
GET /api/v1/Contact/{id}/Persons?$skip=656
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=qui
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2671,
      "fullName": "Theodora Jacklyn Monahan DVM"
    },
    {
      "PrimaryKey": 957,
      "EntityName": "person",
      "personId": 957,
      "fullName": "Daren Labadie"
    }
  ]
}
```