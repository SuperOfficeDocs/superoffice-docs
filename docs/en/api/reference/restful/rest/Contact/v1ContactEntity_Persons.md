...
GET /api/v1/Contact/{id}/Persons?$entities=aperiam
GET /api/v1/Contact/{id}/Persons?$top=112
GET /api/v1/Contact/{id}/Persons?$skip=872
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=at
  ...
  "value": [
    {
      ...
      "saleId": 7123,
      "contactId": 8543,
      "name": "Zieme, Kreiger and McLaughlin"
    },
    {
      "PrimaryKey": 5488,
      "EntityName": "sale",
      "saleId": 5488,
      "contactId": 1250,
      "name": "Barton, Bartell and Bailey"
    }
  ]
}
```