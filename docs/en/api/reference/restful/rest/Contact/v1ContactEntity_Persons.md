...
GET /api/v1/Contact/{id}/Persons?$entities=quisquam
GET /api/v1/Contact/{id}/Persons?$top=5
GET /api/v1/Contact/{id}/Persons?$skip=19
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=rem
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9949,
      "fullName": "Rosina Yost"
    },
    {
      "PrimaryKey": 9425,
      "EntityName": "person",
      "personId": 9425,
      "fullName": "Cleveland Watsica"
    }
  ]
}
```