...
GET /api/v1/Contact/{id}/Persons?$top=674
GET /api/v1/Contact/{id}/Persons?$skip=896
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=dolores
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 8836,
      "contactId": 6661,
      "name": "Botsford, Heaney and Friesen"
    }
  ]
}
```