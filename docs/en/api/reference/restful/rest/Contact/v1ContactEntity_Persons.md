...
GET /api/v1/Contact/{id}/Persons?$entities=voluptatem
GET /api/v1/Contact/{id}/Persons?$top=140
GET /api/v1/Contact/{id}/Persons?$skip=253
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=quia
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2573,
      "fullName": "Mrs. Celia Heaney V"
    },
    {
      "PrimaryKey": 8099,
      "EntityName": "person",
      "personId": 8099,
      "fullName": "Daren Wilkinson MD"
    }
  ]
}
```