...
GET /api/v1/Contact/{id}/Persons?$entities=rerum
GET /api/v1/Contact/{id}/Persons?$top=432
GET /api/v1/Contact/{id}/Persons?$skip=711
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=non
