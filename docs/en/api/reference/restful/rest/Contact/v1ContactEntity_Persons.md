...
GET /api/v1/Contact/{id}/Persons?$entities=aliquid
GET /api/v1/Contact/{id}/Persons?$top=79
GET /api/v1/Contact/{id}/Persons?$skip=171
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 4481,
      "contactId": 4581,
      "name": "Cremin, Marvin and Nitzsche"
    }
  ]
}
```