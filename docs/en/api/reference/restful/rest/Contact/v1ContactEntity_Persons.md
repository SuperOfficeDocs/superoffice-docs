...
GET /api/v1/Contact/{id}/Persons?$entities=quo
GET /api/v1/Contact/{id}/Persons?$top=624
GET /api/v1/Contact/{id}/Persons?$skip=142
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=nostrum
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 896,
      "contactId": 3610,
      "name": "O'Keefe, Turner and Konopelski"
    }
  ]
}
```