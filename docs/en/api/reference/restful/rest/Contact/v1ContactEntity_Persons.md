...
GET /api/v1/Contact/{id}/Persons?$top=707
GET /api/v1/Contact/{id}/Persons?$skip=260
GET /api/v1/Contact/{id}/Persons?$mode=Full
GET /api/v1/Contact/{id}/Persons?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Persons?$context=eligendi
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5135,
      "fullName": "Sigmund Kautzer DVM"
    },
    {
      "PrimaryKey": 151,
      "EntityName": "person",
      "personId": 151,
      "fullName": "Raul Eichmann"
    }
  ]
}
```