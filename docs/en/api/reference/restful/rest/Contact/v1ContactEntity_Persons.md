...
GET /api/v1/Contact/{id}/Persons?$entities=praesentium
GET /api/v1/Contact/{id}/Persons?$top=640
GET /api/v1/Contact/{id}/Persons?$skip=679
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 552,
      "fullName": "Abby Ray Heidenreich DDS"
    },
    {
      "PrimaryKey": 8520,
      "EntityName": "person",
      "personId": 8520,
      "fullName": "Marina Boehm"
    }
  ]
}
```