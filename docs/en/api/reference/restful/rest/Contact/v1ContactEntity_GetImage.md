...
```http
GET /api/v1/Contact/{contactId}/Image?w=838
GET /api/v1/Contact/{contactId}/Image?h=602
GET /api/v1/Contact/{contactId}/Image?type=voluptatem
...
[!include[sample request](../../samples/rest/request/v1ContactEntity_GetImage.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1ContactEntity_GetImage.md)]