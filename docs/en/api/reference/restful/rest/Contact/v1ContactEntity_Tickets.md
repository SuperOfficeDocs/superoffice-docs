...
GET /api/v1/Contact/{id}/Tickets?$entities=nobis
GET /api/v1/Contact/{id}/Tickets?$top=550
GET /api/v1/Contact/{id}/Tickets?$skip=253
GET /api/v1/Contact/{id}/Tickets?$mode=Full
GET /api/v1/Contact/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Tickets?$context=quod
