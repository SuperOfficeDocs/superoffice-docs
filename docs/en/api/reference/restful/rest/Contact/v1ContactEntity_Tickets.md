...
GET /api/v1/Contact/{id}/Tickets?$entities=quis
GET /api/v1/Contact/{id}/Tickets?$top=142
GET /api/v1/Contact/{id}/Tickets?$skip=782
GET /api/v1/Contact/{id}/Tickets?$mode=Full
GET /api/v1/Contact/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Tickets?$context=consectetur
