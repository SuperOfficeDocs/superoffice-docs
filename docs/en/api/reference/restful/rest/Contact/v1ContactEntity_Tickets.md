...
GET /api/v1/Contact/{id}/Tickets?$entities=iure
GET /api/v1/Contact/{id}/Tickets?$top=189
GET /api/v1/Contact/{id}/Tickets?$skip=50
GET /api/v1/Contact/{id}/Tickets?$mode=Full
GET /api/v1/Contact/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Tickets?$context=modi
