...
GET /api/v1/Contact/{id}/Tickets?$entities=eaque
GET /api/v1/Contact/{id}/Tickets?$top=675
GET /api/v1/Contact/{id}/Tickets?$skip=151
  ...
  "value": [
    {
      ...
      "saleId": 2053,
      "contactId": 9858,
      "name": "Rutherford, Treutel and Wilkinson"
    },
    {
      "PrimaryKey": 3753,
      "EntityName": "sale",
