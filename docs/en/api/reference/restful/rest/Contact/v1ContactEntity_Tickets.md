...
GET /api/v1/Contact/{id}/Tickets?$entities=assumenda
GET /api/v1/Contact/{id}/Tickets?$top=268
GET /api/v1/Contact/{id}/Tickets?$skip=5
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7331,
      "fullName": "Brown Lynch"
    },
    {
      "PrimaryKey": 4339,
      "EntityName": "person",
      "personId": 4339,
      "fullName": "Sister Klein"
    }
  ]
}
```