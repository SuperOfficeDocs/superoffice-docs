...
GET /api/v1/Contact/{id}/Tickets?$entities=accusamus
GET /api/v1/Contact/{id}/Tickets?$top=43
GET /api/v1/Contact/{id}/Tickets?$skip=535
GET /api/v1/Contact/{id}/Tickets?$mode=Full
GET /api/v1/Contact/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Tickets?$context=quibusdam
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7938,
      "fullName": "Maddison Huels II"
    },
    {
      "PrimaryKey": 2969,
      "EntityName": "person",
      "personId": 2969,
      "fullName": "Ms. Hollis Mitchell I"
    }
  ]
}
```