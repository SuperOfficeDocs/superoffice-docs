...
GET /api/v1/Contact/{id}/Tickets?$entities=sint
GET /api/v1/Contact/{id}/Tickets?$top=255
GET /api/v1/Contact/{id}/Tickets?$skip=191
GET /api/v1/Contact/{id}/Tickets?$mode=Full
GET /api/v1/Contact/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Tickets?$context=nihil
