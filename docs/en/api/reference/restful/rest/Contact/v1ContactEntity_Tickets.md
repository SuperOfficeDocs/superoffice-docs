...
GET /api/v1/Contact/{id}/Tickets?$entities=provident
GET /api/v1/Contact/{id}/Tickets?$top=96
GET /api/v1/Contact/{id}/Tickets?$skip=574
GET /api/v1/Contact/{id}/Tickets?$mode=Full
GET /api/v1/Contact/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Tickets?$context=ut
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5840,
      "fullName": "Kelsie Johns V"
    },
    {
      "PrimaryKey": 5583,
      "EntityName": "person",
      "personId": 5583,
      "fullName": "Mohammed Lakin"
    }
  ]
}
```