...
GET /api/v1/Contact/{id}/Tickets?$entities=autem
GET /api/v1/Contact/{id}/Tickets?$top=964
GET /api/v1/Contact/{id}/Tickets?$skip=465
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4177,
      "fullName": "Ms. Carroll Ruth Blanda"
    },
    {
      "PrimaryKey": 5322,
      "EntityName": "person",
