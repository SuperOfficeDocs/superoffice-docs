...
GET /api/v1/Contact/{id}/Tickets?$entities=quod
GET /api/v1/Contact/{id}/Tickets?$top=953
GET /api/v1/Contact/{id}/Tickets?$skip=834
GET /api/v1/Contact/{id}/Tickets?$mode=Full
GET /api/v1/Contact/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Tickets?$context=corporis
