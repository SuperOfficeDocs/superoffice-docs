...
GET /api/v1/Contact/{id}/Activities?$entities=voluptate
GET /api/v1/Contact/{id}/Activities?$top=29
GET /api/v1/Contact/{id}/Activities?$skip=68
GET /api/v1/Contact/{id}/Activities?$mode=Full
GET /api/v1/Contact/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Activities?$context=earum
