...
GET /api/v1/Contact/{id}/Activities?$entities=debitis
GET /api/v1/Contact/{id}/Activities?$top=248
...
GET /api/v1/Contact/{id}/Activities?$context=qui
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8953,
      "fullName": "Carter Pfeffer"
    },
    {
      "PrimaryKey": 2426,
      "EntityName": "person",
      "personId": 2426,
      "fullName": "Marques Rogahn"
    }
  ]
}
```