...
GET /api/v1/Contact/{id}/Relations?$entities=eum
GET /api/v1/Contact/{id}/Relations?$top=968
GET /api/v1/Contact/{id}/Relations?$skip=481
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9601,
      "fullName": "Gideon Hermann"
    },
    {
      "PrimaryKey": 8547,
      "EntityName": "person",
      "personId": 8547,
      "fullName": "Mr. Kurtis Gusikowski"
    }
  ]
}
```