...
GET /api/v1/Contact/{id}/Relations?$entities=reprehenderit
GET /api/v1/Contact/{id}/Relations?$top=292
GET /api/v1/Contact/{id}/Relations?$skip=703
GET /api/v1/Contact/{id}/Relations?$mode=Full
GET /api/v1/Contact/{id}/Relations?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Relations?$context=eum
  ...
  "value": [
    {
      ...
      "saleId": 8575,
      "contactId": 1635,
      "name": "Shanahan, Schmeler and Rice"
    },
    {
      "PrimaryKey": 4909,
      "EntityName": "sale",
      "saleId": 4909,
      "contactId": 6691,
      "name": "Senger, Gislason and Schaden"
    }
  ]
}
```