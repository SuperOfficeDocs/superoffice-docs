...
GET /api/v1/Contact/{id}/Relations?$entities=laborum
GET /api/v1/Contact/{id}/Relations?$top=367
GET /api/v1/Contact/{id}/Relations?$skip=672
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8574,
      "fullName": "Eldora Wuckert"
    },
    {
      "PrimaryKey": 8856,
      "EntityName": "person",
      "personId": 8856,
      "fullName": "Ms. Shawna Andrew Sporer Sr."
    }
  ]
}
```