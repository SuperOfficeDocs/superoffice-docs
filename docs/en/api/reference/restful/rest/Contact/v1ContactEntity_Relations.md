...
GET /api/v1/Contact/{id}/Relations?$entities=quasi
GET /api/v1/Contact/{id}/Relations?$top=191
...
GET /api/v1/Contact/{id}/Relations?$context=consequatur
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4092,
      "fullName": "Kristofer Hane"
    },
    {
      "PrimaryKey": 5822,
      "EntityName": "person",
      "personId": 5822,
      "fullName": "Dr. Gonzalo Lillie Reilly MD"
    }
  ]
}
```