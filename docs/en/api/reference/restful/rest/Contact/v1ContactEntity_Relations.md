...
GET /api/v1/Contact/{id}/Relations?$entities=quia
GET /api/v1/Contact/{id}/Relations?$top=225
GET /api/v1/Contact/{id}/Relations?$skip=807
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 6612,
      "contactId": 6828,
      "name": "Douglas, Murray and Denesik"
    }
  ]
}
```