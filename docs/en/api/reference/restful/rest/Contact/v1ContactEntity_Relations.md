...
GET /api/v1/Contact/{id}/Relations?$entities=sequi
GET /api/v1/Contact/{id}/Relations?$top=531
GET /api/v1/Contact/{id}/Relations?$skip=477
  ...
  "value": [
    {
      ...
      "saleId": 7219,
      "contactId": 7964,
      "name": "Boehm, Hegmann and Morissette"
    },
    {
      "PrimaryKey": 1935,
      "EntityName": "sale",
