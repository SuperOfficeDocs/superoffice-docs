...
GET /api/v1/Contact/{id}/Appointments?$entities=dolorem
GET /api/v1/Contact/{id}/Appointments?$top=60
GET /api/v1/Contact/{id}/Appointments?$skip=624
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9842,
      "fullName": "Ms. Austen Grady II"
    },
    {
      "PrimaryKey": 9155,
      "EntityName": "person",
      "personId": 9155,
      "fullName": "Kathryn Klein"
    }
  ]
}
```