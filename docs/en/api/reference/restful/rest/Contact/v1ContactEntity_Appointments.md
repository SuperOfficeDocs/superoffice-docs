...
GET /api/v1/Contact/{id}/Appointments?$entities=suscipit
GET /api/v1/Contact/{id}/Appointments?$top=68
GET /api/v1/Contact/{id}/Appointments?$skip=783
GET /api/v1/Contact/{id}/Appointments?$mode=Full
GET /api/v1/Contact/{id}/Appointments?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Appointments?$context=necessitatibus
...
[!include[sample request](../../samples/rest/request/v1ContactEntity_Appointments.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1ContactEntity_Appointments.md)]