...
GET /api/v1/Contact/{id}/Appointments?$entities=et
GET /api/v1/Contact/{id}/Appointments?$top=548
GET /api/v1/Contact/{id}/Appointments?$skip=800
  ...
  "value": [
    {
      ...
      "saleId": 7444,
      "contactId": 4396,
      "name": "Kovacek, Monahan and Harris"
    },
    {
      "PrimaryKey": 9388,
      "EntityName": "sale",
