...
GET /api/v1/Contact/{id}/Appointments?$entities=quibusdam
GET /api/v1/Contact/{id}/Appointments?$top=286
GET /api/v1/Contact/{id}/Appointments?$skip=243
GET /api/v1/Contact/{id}/Appointments?$mode=Full
GET /api/v1/Contact/{id}/Appointments?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Appointments?$context=quod
