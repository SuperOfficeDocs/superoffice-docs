...
GET /api/v1/Contact/{id}/Appointments?$entities=commodi
GET /api/v1/Contact/{id}/Appointments?$top=41
GET /api/v1/Contact/{id}/Appointments?$skip=639
GET /api/v1/Contact/{id}/Appointments?$mode=Full
GET /api/v1/Contact/{id}/Appointments?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Appointments?$context=enim
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 326,
      "contactId": 4671,
      "name": "Wisoky, Kshlerin and Kozey"
    }
  ]
}
```