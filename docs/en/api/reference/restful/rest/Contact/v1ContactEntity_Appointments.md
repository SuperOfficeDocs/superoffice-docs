...
GET /api/v1/Contact/{id}/Appointments?$entities=quam
GET /api/v1/Contact/{id}/Appointments?$top=813
GET /api/v1/Contact/{id}/Appointments?$skip=929
GET /api/v1/Contact/{id}/Appointments?$mode=Full
GET /api/v1/Contact/{id}/Appointments?$options=GrandTotal=true
GET /api/v1/Contact/{id}/Appointments?$context=omnis
