...
GET /api/v1/TimeZone?$entities=quos
GET /api/v1/TimeZone?$top=395
GET /api/v1/TimeZone?$skip=766
GET /api/v1/TimeZone?$mode=FULL
GET /api/v1/TimeZone?$options=GrandTotal=true
GET /api/v1/TimeZone?$context=dolores
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7292,
      "fullName": "Gage Stokes"
    },
    {
      "PrimaryKey": 731,
      "EntityName": "person",
      "personId": 731,
      "fullName": "Junius Muller"
    }
  ]
}
```