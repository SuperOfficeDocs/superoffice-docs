...
```http
POST /api/v1/Document/{documentId}/Command/{command}?versionId=molestias
...
[!include[sample request](../../samples/rest/request/v1DocumentEntity_ExecuteDocumentCommand.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1DocumentEntity_ExecuteDocumentCommand.md)]