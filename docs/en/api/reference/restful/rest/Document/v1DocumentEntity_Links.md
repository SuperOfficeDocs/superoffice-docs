...
GET /api/v1/Document/{id}/Links?$entities=ullam
GET /api/v1/Document/{id}/Links?$top=65
GET /api/v1/Document/{id}/Links?$skip=792
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4411,
      "fullName": "Elmer Sauer"
    },
    {
      "PrimaryKey": 1378,
      "EntityName": "person",
      "personId": 1378,
      "fullName": "Miss Zelda Reinger"
    }
  ]
}
```