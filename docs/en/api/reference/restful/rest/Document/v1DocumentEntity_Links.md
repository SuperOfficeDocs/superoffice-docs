...
GET /api/v1/Document/{id}/Links?$entities=veritatis
GET /api/v1/Document/{id}/Links?$top=947
...
GET /api/v1/Document/{id}/Links?$context=laboriosam
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5432,
      "fullName": "Miss Rodger Goyette"
    },
    {
      "PrimaryKey": 7276,
      "EntityName": "person",
      "personId": 7276,
      "fullName": "Stacy Hagenes"
    }
  ]
}
```