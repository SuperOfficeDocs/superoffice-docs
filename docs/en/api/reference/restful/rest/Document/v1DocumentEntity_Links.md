...
GET /api/v1/Document/{id}/Links?$top=904
GET /api/v1/Document/{id}/Links?$skip=396
GET /api/v1/Document/{id}/Links?$mode=Full
GET /api/v1/Document/{id}/Links?$options=GrandTotal=true
GET /api/v1/Document/{id}/Links?$context=pariatur
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5450,
      "fullName": "Mr. Raleigh Raphaelle Hessel"
    },
    {
      "PrimaryKey": 4850,
      "EntityName": "person",
      "personId": 4850,
      "fullName": "Adrianna Yost"
    }
  ]
}
```