...
GET /api/v1/Document/{id}/Links?$entities=ut
GET /api/v1/Document/{id}/Links?$top=212
GET /api/v1/Document/{id}/Links?$skip=260
GET /api/v1/Document/{id}/Links?$mode=Full
GET /api/v1/Document/{id}/Links?$options=GrandTotal=true
GET /api/v1/Document/{id}/Links?$context=eaque
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1341,
      "fullName": "Winfield Weimann"
    },
    {
      "PrimaryKey": 1097,
      "EntityName": "person",
      "personId": 1097,
      "fullName": "Ethelyn Bailey V"
    }
  ]
}
```