...
GET /api/v1/Document/{id}/Links?$entities=ipsum
GET /api/v1/Document/{id}/Links?$top=286
GET /api/v1/Document/{id}/Links?$skip=286
GET /api/v1/Document/{id}/Links?$mode=Full
GET /api/v1/Document/{id}/Links?$options=GrandTotal=true
GET /api/v1/Document/{id}/Links?$context=sapiente
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 3153,
      "contactId": 2713,
      "name": "Beahan, Greenholt and Davis"
    }
  ]
}
```