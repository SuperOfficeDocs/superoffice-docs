...
GET /api/v1/Document/{id}/Links?$entities=ratione
GET /api/v1/Document/{id}/Links?$top=146
GET /api/v1/Document/{id}/Links?$skip=711
GET /api/v1/Document/{id}/Links?$mode=Full
GET /api/v1/Document/{id}/Links?$options=GrandTotal=true
GET /api/v1/Document/{id}/Links?$context=adipisci
