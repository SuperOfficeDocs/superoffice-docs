...
GET /api/v1/Document/{id}/Links?$entities=qui
GET /api/v1/Document/{id}/Links?$top=879
...
GET /api/v1/Document/{id}/Links?$context=laudantium
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2738,
      "fullName": "Guillermo Moen"
    },
    {
      "PrimaryKey": 1362,
      "EntityName": "person",
      "personId": 1362,
      "fullName": "Donnie Collier"
    }
  ]
}
```