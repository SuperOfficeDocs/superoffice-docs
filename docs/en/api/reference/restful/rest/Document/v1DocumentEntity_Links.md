...
GET /api/v1/Document/{id}/Links?$entities=facilis
GET /api/v1/Document/{id}/Links?$top=148
GET /api/v1/Document/{id}/Links?$skip=235
  ...
  "value": [
    {
      ...
      "saleId": 5585,
      "contactId": 9870,
      "name": "Ryan, Cruickshank and Rodriguez"
    },
    {
      "PrimaryKey": 6679,
      "EntityName": "sale",
      "saleId": 6679,
      "contactId": 8849,
      "name": "Raynor, Anderson and Bashirian"
    }
  ]
}
```