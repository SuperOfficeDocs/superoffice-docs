...
PUT /api/v1/Document/{documentId}/Lock?versionDescription=Fully-configurable contextually-based access
PUT /api/v1/Document/{documentId}/Lock?versionExtraFields=quis,aut
```
