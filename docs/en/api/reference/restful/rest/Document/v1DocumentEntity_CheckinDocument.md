...
PUT /api/v1/Document/{documentId}/Lock?versionDescription=Re-contextualized neutral frame
PUT /api/v1/Document/{documentId}/Lock?versionExtraFields=consectetur,sapiente
```
