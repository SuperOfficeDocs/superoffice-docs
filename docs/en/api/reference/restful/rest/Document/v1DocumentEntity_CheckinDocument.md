...
PUT /api/v1/Document/{documentId}/Lock?versionDescription=Distributed homogeneous framework
PUT /api/v1/Document/{documentId}/Lock?versionExtraFields=a,dolorem
```
