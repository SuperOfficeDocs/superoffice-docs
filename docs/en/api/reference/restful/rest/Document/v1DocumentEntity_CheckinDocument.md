...
PUT /api/v1/Document/{documentId}/Lock?versionDescription=Up-sized holistic groupware
PUT /api/v1/Document/{documentId}/Lock?versionExtraFields=inventore,quia
```
