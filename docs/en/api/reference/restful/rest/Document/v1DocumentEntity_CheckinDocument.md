...
PUT /api/v1/Document/{documentId}/Lock?versionDescription=Business-focused high-level initiative
PUT /api/v1/Document/{documentId}/Lock?versionExtraFields=in,praesentium
```
