...
PUT /api/v1/Document/{documentId}/Lock?versionDescription=Distributed transitional definition
PUT /api/v1/Document/{documentId}/Lock?versionExtraFields=sit,ut
```
