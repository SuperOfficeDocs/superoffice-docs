...
PUT /api/v1/Document/{documentId}/Lock?versionDescription=Sharable radical synergy
PUT /api/v1/Document/{documentId}/Lock?versionExtraFields=placeat,quis
```
