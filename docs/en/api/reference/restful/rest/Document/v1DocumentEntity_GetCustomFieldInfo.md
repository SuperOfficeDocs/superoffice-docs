...

{
  ...
  "FieldName": "Considine-Wilderman",
  "DisplayName": "Quigley, Gerlach and Predovic",
  "Description": "Multi-tiered local model",
  "ShortLabel": "qui",
  "HideLabel": true,
  "HideField": false,
  "IsIndexed": false,
  ...
  "Rank": 495,
  "TemplateVariableName": "Stracke, Nikolaus and Rempel"
}
```