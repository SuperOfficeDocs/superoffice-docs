...
```http
POST /api/v1/Document/{documentId}/Content?contactId=123
POST /api/v1/Document/{documentId}/Content?personId=707
POST /api/v1/Document/{documentId}/Content?appointmentId=113
POST /api/v1/Document/{documentId}/Content?saleId=626
POST /api/v1/Document/{documentId}/Content?selectionId=364
POST /api/v1/Document/{documentId}/Content?projectId=245
