...
GET /api/v1/Pricelist/{id}/Products?$entities=corrupti
GET /api/v1/Pricelist/{id}/Products?$top=350
GET /api/v1/Pricelist/{id}/Products?$skip=323
GET /api/v1/Pricelist/{id}/Products?$mode=Full
GET /api/v1/Pricelist/{id}/Products?$options=GrandTotal=true
GET /api/v1/Pricelist/{id}/Products?$context=harum
