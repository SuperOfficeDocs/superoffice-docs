...
GET /api/v1/Pricelist/{id}/Products?$entities=numquam
GET /api/v1/Pricelist/{id}/Products?$top=471
GET /api/v1/Pricelist/{id}/Products?$skip=694
  ...
  "value": [
    {
      ...
      "saleId": 3699,
      "contactId": 6171,
      "name": "Collier, Leffler and Kiehn"
    },
    {
      "PrimaryKey": 790,
      "EntityName": "sale",
