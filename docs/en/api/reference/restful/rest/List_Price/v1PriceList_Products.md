...
GET /api/v1/Pricelist/{id}/Products?$entities=quasi
GET /api/v1/Pricelist/{id}/Products?$top=492
GET /api/v1/Pricelist/{id}/Products?$skip=166
GET /api/v1/Pricelist/{id}/Products?$mode=Full
GET /api/v1/Pricelist/{id}/Products?$options=GrandTotal=true
GET /api/v1/Pricelist/{id}/Products?$context=eos
  ...
  "value": [
    {
      ...
      "saleId": 3078,
      "contactId": 5715,
      "name": "Hintz, Langosh and Predovic"
    },
    {
      "PrimaryKey": 5371,
      "EntityName": "sale",
