...
GET /api/v1/Pricelist/{id}/Products?$entities=ut
GET /api/v1/Pricelist/{id}/Products?$top=908
GET /api/v1/Pricelist/{id}/Products?$skip=458
GET /api/v1/Pricelist/{id}/Products?$mode=Full
GET /api/v1/Pricelist/{id}/Products?$options=GrandTotal=true
GET /api/v1/Pricelist/{id}/Products?$context=voluptatibus
...
[!include[sample request](../../samples/rest/request/v1PriceList_Products.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1PriceList_Products.md)]