...
GET /api/v1/Pricelist/{id}/Products?$entities=saepe
GET /api/v1/Pricelist/{id}/Products?$top=78
GET /api/v1/Pricelist/{id}/Products?$skip=313
GET /api/v1/Pricelist/{id}/Products?$mode=Full
GET /api/v1/Pricelist/{id}/Products?$options=GrandTotal=true
GET /api/v1/Pricelist/{id}/Products?$context=mollitia
