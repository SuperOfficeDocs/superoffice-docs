...
GET /api/v1/Pricelist/{id}/Products?$entities=quaerat
GET /api/v1/Pricelist/{id}/Products?$top=206
GET /api/v1/Pricelist/{id}/Products?$skip=380
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1057,
      "fullName": "Miss Jarret Roberto Kris V"
    },
    {
      "PrimaryKey": 8772,
      "EntityName": "person",
      "personId": 8772,
      "fullName": "Jose Stroman"
    }
  ]
}
```