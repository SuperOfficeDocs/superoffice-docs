...
GET /api/v1/Pricelist?$entities=inventore
GET /api/v1/Pricelist?$top=769
GET /api/v1/Pricelist?$skip=375
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2251,
      "fullName": "Lorine Jacinthe Pollich II"
    },
    {
      "PrimaryKey": 574,
      "EntityName": "person",
      "personId": 574,
      "fullName": "Jessica Cummerata"
    }
  ]
}
```