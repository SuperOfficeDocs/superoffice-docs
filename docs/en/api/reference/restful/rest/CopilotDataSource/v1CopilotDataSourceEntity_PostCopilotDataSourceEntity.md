---
title: POST CopilotDataSource
uid: v1CopilotDataSourceEntity_PostCopilotDataSourceEntity
generated: true
content_type: reference
---

# POST CopilotDataSource

```http
POST /api/v1/CopilotDataSource
```

Creates a new CopilotDataSourceEntity


Calls the AI agent service SaveCopilotDataSourceEntity.
...
```http
POST /api/v1/CopilotDataSource?$select=name,department,category/id
```
...
[!include[sample request](../../samples/rest/request/v1CopilotDataSourceEntity_PostCopilotDataSourceEntity.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1CopilotDataSourceEntity_PostCopilotDataSourceEntity.md)]