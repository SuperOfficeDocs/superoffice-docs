...
GET /api/v1/Archive/{archiveProviderName}?$entities=laudantium
GET /api/v1/Archive/{archiveProviderName}?$top=439
GET /api/v1/Archive/{archiveProviderName}?$skip=991
