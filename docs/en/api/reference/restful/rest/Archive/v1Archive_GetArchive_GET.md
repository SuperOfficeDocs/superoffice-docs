...
GET /api/v1/Archive/{archiveProviderName}?$entities=aut
GET /api/v1/Archive/{archiveProviderName}?$top=270
GET /api/v1/Archive/{archiveProviderName}?$skip=526
GET /api/v1/Archive/{archiveProviderName}?$mode=Full
GET /api/v1/Archive/{archiveProviderName}?$options=GrandTotal=true
GET /api/v1/Archive/{archiveProviderName}?$context=eveniet
GET /api/v1/Archive/{archiveProviderName}?$format=JSON
GET /api/v1/Archive/{archiveProviderName}?$metadata=vitae
