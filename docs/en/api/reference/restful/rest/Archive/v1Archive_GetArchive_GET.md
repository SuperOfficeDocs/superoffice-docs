...
GET /api/v1/Archive/{archiveProviderName}?$entities=nesciunt
GET /api/v1/Archive/{archiveProviderName}?$top=231
GET /api/v1/Archive/{archiveProviderName}?$skip=288
GET /api/v1/Archive/{archiveProviderName}?$mode=Full
GET /api/v1/Archive/{archiveProviderName}?$options=GrandTotal=true
GET /api/v1/Archive/{archiveProviderName}?$context=nemo
GET /api/v1/Archive/{archiveProviderName}?$format=JSON
GET /api/v1/Archive/{archiveProviderName}?$metadata=tenetur
