...
GET /api/v1/TriggerScript?$entities=aperiam
GET /api/v1/TriggerScript?$top=119
GET /api/v1/TriggerScript?$skip=661
GET /api/v1/TriggerScript?$mode=Full
GET /api/v1/TriggerScript?$options=GrandTotal=true
GET /api/v1/TriggerScript?$context=cupiditate
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7258,
      "fullName": "Vivien Quigley"
    },
    {
      "PrimaryKey": 2119,
      "EntityName": "person",
      "personId": 2119,
      "fullName": "Audrey Jackie Kris IV"
    }
  ]
}
```