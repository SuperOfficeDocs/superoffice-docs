...
GET /api/v1/SaleStakeholder?$entities=voluptatum
GET /api/v1/SaleStakeholder?$top=108
GET /api/v1/SaleStakeholder?$skip=548
GET /api/v1/SaleStakeholder?$mode=Full
GET /api/v1/SaleStakeholder?$options=GrandTotal=true
GET /api/v1/SaleStakeholder?$context=quia
