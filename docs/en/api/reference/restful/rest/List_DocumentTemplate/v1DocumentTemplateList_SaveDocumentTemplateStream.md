...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=440
```
...
{
  "Name": "Skiles, Waters and Jerde",
  "Description": "Secured mission-critical infrastructure",
