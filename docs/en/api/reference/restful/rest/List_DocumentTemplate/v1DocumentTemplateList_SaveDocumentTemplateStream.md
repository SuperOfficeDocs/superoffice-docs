...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=671
```
...
{
  "Name": "Rutherford-Koepp",
  "Description": "Enterprise-wide web-enabled migration",
  "ExternalReference": "soluta",
  "MimeType": "illum",
  "PluginId": 422
}
```