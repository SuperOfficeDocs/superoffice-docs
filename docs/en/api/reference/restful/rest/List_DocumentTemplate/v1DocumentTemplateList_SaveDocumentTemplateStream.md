...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=422
```
...
{
  "Name": "Dibbert-Kerluke",
  "Description": "Realigned intangible encoding",
