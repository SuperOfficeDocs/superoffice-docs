...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=147
```
...
{
  "Name": "Denesik, Miller and Hermiston",
  "Description": "Integrated high-level firmware",
