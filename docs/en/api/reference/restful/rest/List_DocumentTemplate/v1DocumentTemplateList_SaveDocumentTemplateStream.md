...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=544
```
...
{
  "Name": "Jaskolski, Bruen and Stroman",
  "Description": "Managed real-time monitoring",
  "ExternalReference": "veritatis",
  "MimeType": "delectus",
  "PluginId": 95
}
```