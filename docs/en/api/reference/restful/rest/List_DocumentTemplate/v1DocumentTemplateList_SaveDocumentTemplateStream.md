...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=939
```
...
{
  "Name": "Schulist, Rutherford and Frami",
  "Description": "Versatile 5th generation algorithm",
