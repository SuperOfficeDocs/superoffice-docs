...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=97
```
...
{
  "Name": "Schneider LLC",
  "Description": "Multi-channelled zero administration installation",
