...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=396
```
...
{
  "Name": "Herman, Kohler and Maggio",
  "Description": "Diverse solution-oriented toolset",
  "ExternalReference": "fuga",
  "MimeType": "dolorum",
  "PluginId": 927
}
```