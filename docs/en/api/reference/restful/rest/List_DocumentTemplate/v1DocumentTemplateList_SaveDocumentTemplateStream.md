...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=785
```
...
{
  "Name": "Schamberger, McClure and Nienow",
  "Description": "Versatile optimizing open system",
