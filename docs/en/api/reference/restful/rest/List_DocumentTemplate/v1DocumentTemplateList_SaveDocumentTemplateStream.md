...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=296
```
...
{
  "Name": "Rau, Bins and Emmerich",
  "Description": "Cloned encompassing open architecture",
  "ExternalReference": "excepturi",
  "MimeType": "incidunt",
  "PluginId": 418
}
```