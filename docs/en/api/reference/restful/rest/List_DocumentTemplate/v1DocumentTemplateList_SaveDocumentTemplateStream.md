...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=366
```
...

{
  ...
  "Description": "Horizontal heuristic pricing structure",
  "ExternalReference": "placeat",
  "MimeType": "optio",
  "PluginId": 138
}
```