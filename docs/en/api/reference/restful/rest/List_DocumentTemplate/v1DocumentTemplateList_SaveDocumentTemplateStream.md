...
```http
PUT /api/v1/List/DocumentTemplate/Items/{documentTemplateId}/Content/{languageCode}?pluginId=484
```
...
{
  "Name": "Larkin LLC",
  "Description": "De-engineered 24 hour budgetary management",
  "ExternalReference": "laboriosam",
  "MimeType": "porro",
  "PluginId": 695
}
```