...
| mergedTicketEntity.category.defaultTicketStatus.status | Enum: Unknown, Active, Closed, Postponed, Deleted, Merged, Spam, PostponedSpecific, Postponed1Hour, Postponed2Hours, Postponed3Hours, Postponed4Hours, PostponedDay, PostponedWeek, PostponedMonth |  The &amp;apos;classic&amp;apos; ticket status. I.e. active/closed/postponed/deleted |
...
| mergedTicketEntity.category.defaultMessageStatus.status | Enum: Unknown, Active, Closed, Postponed, Deleted, Merged, Spam, PostponedSpecific, Postponed1Hour, Postponed2Hours, Postponed3Hours, Postponed4Hours, PostponedDay, PostponedWeek, PostponedMonth |  The &amp;apos;classic&amp;apos; ticket status. I.e. active/closed/postponed/deleted |
...
| mergedTicketEntity.baseStatus | Enum: Unknown, Active, Closed, Postponed, Deleted, Merged, Spam, PostponedSpecific, Postponed1Hour, Postponed2Hours, Postponed3Hours, Postponed4Hours, PostponedDay, PostponedWeek, PostponedMonth |  The status of the ticket. I.e. active/closed/postponed/deleted Use MDO List name "ticketstatus" to get list items. |
...
| mergedTicketEntity.status.status | Enum: Unknown, Active, Closed, Postponed, Deleted, Merged, Spam, PostponedSpecific, Postponed1Hour, Postponed2Hours, Postponed3Hours, Postponed4Hours, PostponedDay, PostponedWeek, PostponedMonth |  The &amp;apos;classic&amp;apos; ticket status. I.e. active/closed/postponed/deleted |
...
| mergedTicketEntity.origin | Enum: Unknown, Email, SMS, Fax, Phone, Facebook, Twitter, Internal, CustomerCentre, EMarketing, AutoGenerated, Chat, Form, API, Flow |  What is the origin of this ticket |
...
```http
POST /api/v1/Ticket/Merge?secondaryTicketIds=340,710
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketId=537
POST /api/v1/Ticket/Merge?mergedTicketEntity.title=voluptatem
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdAt=09/09/2009 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.lastChanged=09/30/2003 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.readByOwner=01/14/2006 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.readByCustomer=11/24/2025 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.firstReadByOwner=05/16/2012 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.firstReadByUser=02/04/2025 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.activate=08/07/2017 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.closedAt=09/10/2023 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.repliedAt=04/08/2024 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.alertTimeout=01/05/2010 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.deadline=12/25/2001 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.associateId=398
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.name=sit
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.personId=429
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.rank=9
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.tooltip=quibusdam
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.type=AnonymousAssociate
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.groupIdx=773
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.fullName=Hammes LLC
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.formalName=Mitchell LLC
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.deleted=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.ejUserId=772
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.userName=Kessler Group
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.tableRight.mask=tenetur
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.author=eligendi
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.associateId=187
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.name=omnis
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.personId=278
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.rank=586
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.groupIdx=24
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.fullName=Daniel, Daugherty and Skiles
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.formalName=Predovic Inc and Sons
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.deleted=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.ejUserId=227
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.userName=Bayer LLC
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.tableRight.mask=unde
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.tableRight.reason=omnis
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.ticketCategoryId=834
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.parentId=757
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.categoryMaster=233
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.externalName=Littel Inc and Sons
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.assignmentLag=603
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.replyTemplate=867
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.notificationEmail=justina@feil.name
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.ticketStatusId=355
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.name=dignissimos
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.tableRight.mask=eum
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.tableRight.reason=dicta
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.ticketStatusId=384
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.name=dolores
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.tableRight.mask=consectetur
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.tableRight.reason=delectus
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.effectiveReplyTemplateId=621
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.tableRight.mask=dolor
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.tableRight.reason=reiciendis
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.ticketPriorityId=982
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.name=sed
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.sortOrder=931
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.deadline=470
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.monStart=11/24/2018 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.monStop=01/27/2001 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.tueStart=03/16/2015 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.tueStop=04/17/2019 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.wedStart=11/25/2006 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.wedStop=03/22/2004 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.thuStart=09/13/2001 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.thuStop=04/28/2022 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.friStart=09/01/2012 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.friStop=03/29/2021 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.satStart=06/02/2003 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.satStop=01/17/2002 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.sunStart=10/22/2016 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.sunStop=11/25/2012 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.nonDates=beatae,maxime
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.escalationLevels=natus,nam
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.tableRight.mask=omnis
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.tableRight.reason=rerum
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.status.ticketStatusId=968
POST /api/v1/Ticket/Merge?mergedTicketEntity.status.name=suscipit
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.status.tableRight.mask=sed
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.origin=API
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.position=cum
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.personId=309
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.mrmrs=et
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.firstname=impedit
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.lastname=quo
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.middleName=Cummings-Predovic
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.title=quia
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.description=non
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.email=facere
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.fullName=Mertz-Ratke
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.directPhone=(523)991-3415 x01340
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.formalName=Bernhard-Wolff
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.countryId=217
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactId=659
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactName=Kessler, Thompson and Turner
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.retired=962
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.rank=13
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.activeInterests=872
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactDepartment=
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactCountryId=11
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactOrgNr=460129
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.faxPhone=(759)340-7790 x852
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.mobilePhone=1-065-114-5167
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactPhone=848-670-4433 x03861
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.associateName=Reichel, Hodkiewicz and Oberbrunner
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.associateId=247
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.usePersonAddress=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactFax=odio
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.kanafname=quibusdam
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.kanalname=vero
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.post1=sit
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.post2=doloribus
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.post3=aspernatur
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.emailName=Nitzsche LLC
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactFullName=Avery Sherman Greenholt II
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.activeErpLinks=678
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.ticketPriorityId=752
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.supportLanguageId=364
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.supportAssociateId=343
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.categoryName=Upton Inc and Sons
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.personNumber=135110
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.tableRight.mask=at
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.tableRight.reason=eaque
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.secondaryPersons=est,omnis
POST /api/v1/Ticket/Merge?mergedTicketEntity.alertLevel=841
POST /api/v1/Ticket/Merge?mergedTicketEntity.connectId=27
POST /api/v1/Ticket/Merge?mergedTicketEntity.readStatus=Green
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeToReply=116
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeToReply=46
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeToClose=742
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeToClose=567
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpentInternally=684
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpentExternally=942
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpentQueue=76
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeSpentInternally=45
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeSpentExternally=696
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeSpentQueue=181
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpent=947
POST /api/v1/Ticket/Merge?mergedTicketEntity.hasAttachment=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.numReplies=237
POST /api/v1/Ticket/Merge?mergedTicketEntity.numMessages=29
POST /api/v1/Ticket/Merge?mergedTicketEntity.fromAddress=porro
POST /api/v1/Ticket/Merge?mergedTicketEntity.messages=similique,mollitia
POST /api/v1/Ticket/Merge?mergedTicketEntity.tags=aut,in
POST /api/v1/Ticket/Merge?mergedTicketEntity.language=qui
POST /api/v1/Ticket/Merge?mergedTicketEntity.sentiment=352
POST /api/v1/Ticket/Merge?mergedTicketEntity.sentimentConfidence=305
POST /api/v1/Ticket/Merge?mergedTicketEntity.suggestedCategoryId=342
POST /api/v1/Ticket/Merge?mergedTicketEntity.suggestedCategoryName=VIP Customer
POST /api/v1/Ticket/Merge?mergedTicketEntity.origHumanCategoryId=404
POST /api/v1/Ticket/Merge?mergedTicketEntity.iconHint=eligendi
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.contactName=Armstrong Group
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleDate=08/25/2018 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleId=811
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.probability=13
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.title=possimus
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.amount=28121.382
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.currency=cumque
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.projectName=Leffler, Shanahan and Leffler
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.associateFullName=Seth Diana Smitham Jr.
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.description=iusto
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.status=Lost
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.weightedAmount=655.006
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.projectId=979
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.earningPercent=188.04
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.earning=11166.442
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.contactId=841
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.associateId=625
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.personId=821
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleTypeId=779
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleTypeName=Ward-Brakus
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.personFullName=Melisa Shields
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.completed=Completed
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.activeErpLinks=685
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.nextDueDate=02/07/2017 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.number=nostrum
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.tableRight.mask=inventore
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.tableRight.reason=eum
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.projectId=572
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.name=deleniti
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.description=culpa
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.uRL=maiores
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.type=ab
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.associateId=591
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.associateFullName=Prof. Darrion Foster Keebler MD
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.typeId=465
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.updated=05/17/2011 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.statusId=110
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.status=ullam
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.textId=964
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.publishTo=01/12/2026 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.publishFrom=09/12/2024 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.isPublished=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.uRLName=McGlynn-Carter
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.projectNumber=960888
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.activeErpLinks=547
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.eventId=505
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.startDate=06/23/2015 13:35:28
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.tableRight.mask=labore
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.tableRight.reason=amet
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.formSubmission.formSubmissionId=971
POST /api/v1/Ticket/Merge?mergedTicketEntity.formSubmission.emailAddress=dolore
POST /api/v1/Ticket/Merge?mergedTicketEntity.formSubmission.status=EmailVerification
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.ticketTypeId=804
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.name=commodi
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.icon=id
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.defaultTicketStatus=406
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.defaultTicketPriority=936
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.visibleForGroups=502,55
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.tableRight.mask=labore
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.tableRight.reason=ut
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.activeStatusMonitorId=90
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.tableRight.mask=qui
