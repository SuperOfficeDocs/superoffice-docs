...
```http
POST /api/v1/Ticket/Merge?secondaryTicketIds=763,426
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketId=408
POST /api/v1/Ticket/Merge?mergedTicketEntity.title=blanditiis
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdAt=12/24/2001 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.lastChanged=11/05/2013 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.readByOwner=10/10/2025 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.readByCustomer=11/08/2019 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.firstReadByOwner=06/30/2017 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.firstReadByUser=07/17/2022 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.activate=01/21/2009 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.closedAt=07/20/2017 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.repliedAt=12/16/2021 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.alertTimeout=08/26/1999 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.deadline=03/30/2007 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.associateId=744
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.name=aspernatur
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.personId=370
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.rank=939
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.tooltip=quod
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.type=AnonymousAssociate
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.groupIdx=797
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.fullName=Fritsch, Hyatt and Grady
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.formalName=Quitzon, Kuhn and Quigley
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.deleted=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.ejUserId=750
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.userName=Pagac-Simonis
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.createdBy.tableRight.mask=maxime
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.author=soluta
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.associateId=852
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.name=sequi
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.personId=668
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.rank=70
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.groupIdx=976
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.fullName=Funk-Stokes
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.formalName=Eichmann-Hoeger
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.deleted=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.ejUserId=883
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.userName=Vandervort Group
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ownedBy.tableRight.mask=molestiae
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.ticketCategoryId=874
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.parentId=626
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.name=aperiam
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.fullname=officia
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.categoryMaster=277
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.externalName=Waelchi, Luettgen and Bergnaum
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.assignmentLag=969
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.replyTemplate=46
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.notificationEmail=ransom@schaeferlebsack.com
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.ticketStatusId=685
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.name=vel
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.tableRight.mask=consequatur
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.tableRight.reason=ipsa
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultTicketStatus.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.ticketStatusId=322
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.name=explicabo
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.defaultMessageStatus.tableRight.mask=quasi
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.effectiveReplyTemplateId=398
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.tableRight.mask=officiis
POST /api/v1/Ticket/Merge?mergedTicketEntity.category.tableRight.reason=repudiandae
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.ticketPriorityId=97
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.sortOrder=87
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.deadline=453
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.monStart=11/01/1999 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.monStop=07/29/2011 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.tueStart=08/28/2017 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.tueStop=05/15/1999 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.wedStart=02/04/2018 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.wedStop=04/20/2019 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.thuStart=03/06/2000 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.thuStop=08/23/2012 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.friStart=01/25/1999 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.friStop=12/01/2003 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.satStart=08/16/2003 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.satStop=04/10/2007 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.sunStart=10/16/2013 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.sunStop=03/30/2016 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.nonDates=aut,molestias
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.escalationLevels=minus,ut
POST /api/v1/Ticket/Merge?mergedTicketEntity.priority.tableRight.mask=et
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.status.ticketStatusId=206
POST /api/v1/Ticket/Merge?mergedTicketEntity.status.name=dolorem
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.status.tableRight.mask=repudiandae
POST /api/v1/Ticket/Merge?mergedTicketEntity.status.tableRight.reason=debitis
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.personId=49
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.mrmrs=sequi
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.firstname=voluptas
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.lastname=iusto
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.middleName=Witting Inc and Sons
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.title=cumque
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.description=quaerat
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.email=earum
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.fullName=Christiansen LLC
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.directPhone=(937)532-3239
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.formalName=Hilll-Kreiger
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.countryId=892
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactId=968
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactName=Hyatt, Nikolaus and Eichmann
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.retired=733
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.rank=929
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.activeInterests=308
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactDepartment=
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactCountryId=460
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactOrgNr=1211202
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.faxPhone=1-274-472-1964 x70537
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.mobilePhone=227.729.4885 x30809
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactPhone=1-475-781-3012
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.associateName=Brown-Wilderman
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.associateId=786
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.usePersonAddress=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactFax=natus
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.kanafname=voluptas
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.kanalname=dolore
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.post1=quisquam
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.post2=aut
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.post3=et
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.emailName=Goyette-O'Reilly
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.contactFullName=Amani Carroll V
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.activeErpLinks=662
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.ticketPriorityId=829
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.supportLanguageId=20
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.supportAssociateId=311
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.categoryName=Pfeffer-Mertz
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.personNumber=1006446
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.tableRight.mask=ut
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.tableRight.reason=voluptates
POST /api/v1/Ticket/Merge?mergedTicketEntity.person.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.secondaryPersons=velit,in
POST /api/v1/Ticket/Merge?mergedTicketEntity.alertLevel=521
POST /api/v1/Ticket/Merge?mergedTicketEntity.connectId=486
POST /api/v1/Ticket/Merge?mergedTicketEntity.readStatus=Green
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeToReply=447
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeToReply=44
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeToClose=485
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeToClose=866
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpentInternally=698
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpentExternally=713
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpentQueue=78
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeSpentInternally=213
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeSpentExternally=909
POST /api/v1/Ticket/Merge?mergedTicketEntity.realTimeSpentQueue=44
POST /api/v1/Ticket/Merge?mergedTicketEntity.timeSpent=748
POST /api/v1/Ticket/Merge?mergedTicketEntity.hasAttachment=False
POST /api/v1/Ticket/Merge?mergedTicketEntity.numReplies=283
POST /api/v1/Ticket/Merge?mergedTicketEntity.numMessages=85
POST /api/v1/Ticket/Merge?mergedTicketEntity.fromAddress=nobis
POST /api/v1/Ticket/Merge?mergedTicketEntity.messages=accusantium,consequuntur
POST /api/v1/Ticket/Merge?mergedTicketEntity.tags=nemo,est
POST /api/v1/Ticket/Merge?mergedTicketEntity.language=et
POST /api/v1/Ticket/Merge?mergedTicketEntity.sentiment=28
POST /api/v1/Ticket/Merge?mergedTicketEntity.sentimentConfidence=679
POST /api/v1/Ticket/Merge?mergedTicketEntity.suggestedCategoryId=908
POST /api/v1/Ticket/Merge?mergedTicketEntity.suggestedCategoryName=VIP Customer
POST /api/v1/Ticket/Merge?mergedTicketEntity.origHumanCategoryId=776
POST /api/v1/Ticket/Merge?mergedTicketEntity.iconHint=voluptatem
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.contactName=Hauck-Welch
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleDate=10/27/2025 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleId=193
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.probability=655
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.title=consequatur
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.amount=16967.476
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.currency=qui
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.projectName=Pollich Group
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.associateFullName=Mr. Lafayette Adams
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.description=occaecati
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.status=Lost
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.weightedAmount=15055.736
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.projectId=140
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.earningPercent=7001.356
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.earning=25426.142
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.contactId=153
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.associateId=718
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.personId=310
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleTypeId=369
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.saleTypeName=Swaniawski-Lakin
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.personFullName=Rhoda Boyle
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.completed=Completed
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.activeErpLinks=618
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.nextDueDate=11/14/2014 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.number=iusto
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.tableRight.mask=sint
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.tableRight.reason=fugiat
POST /api/v1/Ticket/Merge?mergedTicketEntity.sale.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.projectId=285
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.name=fugiat
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.description=beatae
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.uRL=eum
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.type=aut
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.associateId=702
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.associateFullName=Mr. Lyric Mauricio Rath
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.typeId=787
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.updated=07/01/2002 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.statusId=121
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.status=quae
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.textId=564
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.publishTo=10/06/2010 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.publishFrom=10/31/2024 02:35:16
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.isPublished=True
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.uRLName=Wisoky-Veum
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.projectNumber=1086229
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.activeErpLinks=246
POST /api/v1/Ticket/Merge?mergedTicketEntity.project.tableRight.mask=pariatur
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.formSubmission.formSubmissionId=152
POST /api/v1/Ticket/Merge?mergedTicketEntity.formSubmission.emailAddress=facilis
POST /api/v1/Ticket/Merge?mergedTicketEntity.formSubmission.status=EmailVerification
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.ticketTypeId=738
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.name=dolorem
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.icon=aspernatur
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.defaultTicketStatus=384
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.defaultTicketPriority=162
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.visibleForGroups=615,575
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.tableRight.mask=cupiditate
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.tableRight.reason=delectus
POST /api/v1/Ticket/Merge?mergedTicketEntity.ticketType.fieldProperties=An object of some kind
POST /api/v1/Ticket/Merge?mergedTicketEntity.activeStatusMonitorId=975
...
POST /api/v1/Ticket/Merge?mergedTicketEntity.tableRight.mask=molestiae
POST /api/v1/Ticket/Merge?mergedTicketEntity.tableRight.reason=dolorem
