...
GET /api/v1/Ticket/{id}/Messages?$entities=rerum
GET /api/v1/Ticket/{id}/Messages?$top=244
GET /api/v1/Ticket/{id}/Messages?$skip=183
GET /api/v1/Ticket/{id}/Messages?$mode=Full
GET /api/v1/Ticket/{id}/Messages?$options=GrandTotal=true
GET /api/v1/Ticket/{id}/Messages?$context=dolorem
