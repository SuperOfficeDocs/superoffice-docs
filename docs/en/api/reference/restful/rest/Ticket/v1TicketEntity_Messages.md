...
GET /api/v1/Ticket/{id}/Messages?$entities=quibusdam
GET /api/v1/Ticket/{id}/Messages?$top=630
GET /api/v1/Ticket/{id}/Messages?$skip=633
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1817,
      "fullName": "Dr. Bessie Frami II"
    },
    {
      "PrimaryKey": 3450,
      "EntityName": "person",
      "personId": 3450,
      "fullName": "Mr. Oren Deondre Schuster DDS"
    }
  ]
}
```