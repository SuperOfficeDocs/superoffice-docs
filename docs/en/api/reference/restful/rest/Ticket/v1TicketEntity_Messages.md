...
GET /api/v1/Ticket/{id}/Messages?$entities=illum
GET /api/v1/Ticket/{id}/Messages?$top=157
GET /api/v1/Ticket/{id}/Messages?$skip=83
GET /api/v1/Ticket/{id}/Messages?$mode=Full
GET /api/v1/Ticket/{id}/Messages?$options=GrandTotal=true
GET /api/v1/Ticket/{id}/Messages?$context=aliquam
