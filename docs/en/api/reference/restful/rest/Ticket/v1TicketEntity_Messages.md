...
GET /api/v1/Ticket/{id}/Messages?$entities=temporibus
GET /api/v1/Ticket/{id}/Messages?$top=328
GET /api/v1/Ticket/{id}/Messages?$skip=823
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9435,
      "fullName": "Trisha Hyatt"
    },
    {
      "PrimaryKey": 9432,
      "EntityName": "person",
      "personId": 9432,
      "fullName": "Sigrid Schimmel"
    }
  ]
}
```