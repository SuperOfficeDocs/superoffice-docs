...
GET /api/v1/Ticket/{id}/Messages?$entities=quasi
GET /api/v1/Ticket/{id}/Messages?$top=761
GET /api/v1/Ticket/{id}/Messages?$skip=522
GET /api/v1/Ticket/{id}/Messages?$mode=Full
GET /api/v1/Ticket/{id}/Messages?$options=GrandTotal=true
GET /api/v1/Ticket/{id}/Messages?$context=dignissimos
...
[!include[sample request](../../samples/rest/request/v1TicketEntity_Messages.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1TicketEntity_Messages.md)]