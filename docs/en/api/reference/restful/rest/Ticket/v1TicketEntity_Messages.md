...
GET /api/v1/Ticket/{id}/Messages?$entities=nesciunt
GET /api/v1/Ticket/{id}/Messages?$top=975
GET /api/v1/Ticket/{id}/Messages?$skip=393
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7033,
      "fullName": "Mr. Mathew Wolff"
    },
    {
      "PrimaryKey": 6317,
      "EntityName": "person",
      "personId": 6317,
      "fullName": "Emely Thompson"
    }
  ]
}
```