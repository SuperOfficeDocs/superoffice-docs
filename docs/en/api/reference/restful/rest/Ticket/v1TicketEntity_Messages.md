...
GET /api/v1/Ticket/{id}/Messages?$entities=dolores
GET /api/v1/Ticket/{id}/Messages?$top=375
GET /api/v1/Ticket/{id}/Messages?$skip=448
  ...
  "value": [
    {
      ...
      "saleId": 7795,
      "contactId": 9428,
      "name": "Nolan, Lubowitz and Labadie"
    },
    {
      "PrimaryKey": 6840,
      "EntityName": "sale",
