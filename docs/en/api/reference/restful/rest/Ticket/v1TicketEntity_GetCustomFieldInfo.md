...

{
  ...
  "FieldName": "Orn, Hettinger and Gorczany",
  "DisplayName": "Monahan, Lesch and Jones",
  "Description": "Exclusive grid-enabled capability",
  "ShortLabel": "ex",
  "HideLabel": false,
  "HideField": true,
  "IsIndexed": true,
  ...
  "IsDisplayField": true,
  "Rank": 633,
  "TemplateVariableName": "Gerhold Inc and Sons"
}
```