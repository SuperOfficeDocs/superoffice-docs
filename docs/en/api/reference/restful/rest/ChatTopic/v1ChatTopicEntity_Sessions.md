...
GET /api/v1/ChatTopic/{id}/Sessions?$entities=quam
GET /api/v1/ChatTopic/{id}/Sessions?$top=936
GET /api/v1/ChatTopic/{id}/Sessions?$skip=541
  ...
  "value": [
    {
      ...
      "saleId": 5343,
      "contactId": 8671,
      "name": "Fisher, Hintz and Bergnaum"
    },
    {
      "PrimaryKey": 5315,
      "EntityName": "sale",
