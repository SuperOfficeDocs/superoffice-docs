...
GET /api/v1/ChatTopic/{id}/Sessions?$entities=ipsa
GET /api/v1/ChatTopic/{id}/Sessions?$top=140
GET /api/v1/ChatTopic/{id}/Sessions?$skip=1002
GET /api/v1/ChatTopic/{id}/Sessions?$mode=Full
GET /api/v1/ChatTopic/{id}/Sessions?$options=GrandTotal=true
GET /api/v1/ChatTopic/{id}/Sessions?$context=impedit
