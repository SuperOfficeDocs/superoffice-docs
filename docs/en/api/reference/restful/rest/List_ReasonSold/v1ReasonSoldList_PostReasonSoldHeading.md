...
Saves a new heading for the ReasonSold list.
...
[!include[sample request](../../samples/rest/request/v1ReasonSoldList_PostReasonSoldHeading.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1ReasonSoldList_PostReasonSoldHeading.md)]