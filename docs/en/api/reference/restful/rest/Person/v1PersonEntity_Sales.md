...
GET /api/v1/Person/{id}/Sales?$entities=voluptas
GET /api/v1/Person/{id}/Sales?$top=648
GET /api/v1/Person/{id}/Sales?$skip=579
GET /api/v1/Person/{id}/Sales?$mode=Full
GET /api/v1/Person/{id}/Sales?$options=GrandTotal=true
GET /api/v1/Person/{id}/Sales?$context=fugit
