...
GET /api/v1/Person/{id}/Sales?$entities=tempore
GET /api/v1/Person/{id}/Sales?$top=281
GET /api/v1/Person/{id}/Sales?$skip=552
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5919,
      "fullName": "Coty Bailey"
    },
    {
      "PrimaryKey": 299,
      "EntityName": "person",
      "personId": 299,
      "fullName": "Enoch Gerhold"
    }
  ]
}
```