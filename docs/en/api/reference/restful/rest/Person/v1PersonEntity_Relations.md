...
GET /api/v1/Person/{id}/Relations?$entities=nemo
GET /api/v1/Person/{id}/Relations?$top=809
GET /api/v1/Person/{id}/Relations?$skip=764
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2460,
      "fullName": "Mrs. Chadrick Titus Hessel MD"
    },
    {
      "PrimaryKey": 8226,
      "EntityName": "person",
      "personId": 8226,
      "fullName": "Prof. Adrien Morissette"
    }
  ]
}
```