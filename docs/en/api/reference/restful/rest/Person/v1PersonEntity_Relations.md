...
GET /api/v1/Person/{id}/Relations?$entities=sequi
GET /api/v1/Person/{id}/Relations?$top=508
GET /api/v1/Person/{id}/Relations?$skip=588
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2275,
      "fullName": "Brenda Sanford IV"
    },
    {
      "PrimaryKey": 7639,
      "EntityName": "person",
      "personId": 7639,
      "fullName": "Prof. Kristopher Osinski II"
    }
  ]
}
```