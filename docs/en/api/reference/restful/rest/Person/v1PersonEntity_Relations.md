...
GET /api/v1/Person/{id}/Relations?$entities=vel
GET /api/v1/Person/{id}/Relations?$top=486
GET /api/v1/Person/{id}/Relations?$skip=266
GET /api/v1/Person/{id}/Relations?$mode=Full
GET /api/v1/Person/{id}/Relations?$options=GrandTotal=true
GET /api/v1/Person/{id}/Relations?$context=facilis
