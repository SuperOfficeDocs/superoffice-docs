...
GET /api/v1/Person/{id}/Relations?$entities=sed
GET /api/v1/Person/{id}/Relations?$top=663
GET /api/v1/Person/{id}/Relations?$skip=140
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4885,
      "fullName": "Ms. Kiara Lenna Cronin"
    },
    {
      "PrimaryKey": 1262,
      "EntityName": "person",
      "personId": 1262,
      "fullName": "Ivory Sporer"
    }
  ]
}
```