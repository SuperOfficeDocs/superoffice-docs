...
GET /api/v1/Person/{id}/Relations?$entities=quisquam
GET /api/v1/Person/{id}/Relations?$top=782
GET /api/v1/Person/{id}/Relations?$skip=769
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 6495,
      "fullName": "Miss Braulio Jenkins"
    },
    {
      "PrimaryKey": 6058,
      "EntityName": "person",
      "personId": 6058,
      "fullName": "Santa Mosciski"
    }
  ]
}
```