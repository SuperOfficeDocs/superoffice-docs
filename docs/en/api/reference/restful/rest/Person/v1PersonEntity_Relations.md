...
GET /api/v1/Person/{id}/Relations?$entities=quidem
GET /api/v1/Person/{id}/Relations?$top=504
GET /api/v1/Person/{id}/Relations?$skip=161
GET /api/v1/Person/{id}/Relations?$mode=Full
GET /api/v1/Person/{id}/Relations?$options=GrandTotal=true
GET /api/v1/Person/{id}/Relations?$context=velit
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 8757,
      "contactId": 1522,
      "name": "Marquardt, Langosh and Marvin"
    }
  ]
}
```