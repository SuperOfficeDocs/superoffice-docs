...
GET /api/v1/Person/{id}/Relations?$entities=sint
GET /api/v1/Person/{id}/Relations?$top=859
GET /api/v1/Person/{id}/Relations?$skip=325
GET /api/v1/Person/{id}/Relations?$mode=Full
GET /api/v1/Person/{id}/Relations?$options=GrandTotal=true
GET /api/v1/Person/{id}/Relations?$context=est
