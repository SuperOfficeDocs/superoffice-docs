...
GET /api/v1/Person/{id}/Documents?$entities=esse
GET /api/v1/Person/{id}/Documents?$top=945
GET /api/v1/Person/{id}/Documents?$skip=368
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 4723,
      "contactId": 2654,
      "name": "Walsh, Weimann and Spencer"
    }
  ]
}
```