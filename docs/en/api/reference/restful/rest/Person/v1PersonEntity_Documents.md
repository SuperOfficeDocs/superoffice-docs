...
GET /api/v1/Person/{id}/Documents?$entities=distinctio
GET /api/v1/Person/{id}/Documents?$top=854
GET /api/v1/Person/{id}/Documents?$skip=93
GET /api/v1/Person/{id}/Documents?$mode=Full
GET /api/v1/Person/{id}/Documents?$options=GrandTotal=true
GET /api/v1/Person/{id}/Documents?$context=corporis
