...
GET /api/v1/Person/{id}/Documents?$entities=voluptatum
GET /api/v1/Person/{id}/Documents?$top=426
GET /api/v1/Person/{id}/Documents?$skip=596
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 1466,
      "contactId": 1238,
      "name": "Stoltenberg, Franecki and Murazik"
    }
  ]
}
```