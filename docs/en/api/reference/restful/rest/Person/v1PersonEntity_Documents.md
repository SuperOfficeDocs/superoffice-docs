...
GET /api/v1/Person/{id}/Documents?$entities=eaque
GET /api/v1/Person/{id}/Documents?$top=207
GET /api/v1/Person/{id}/Documents?$skip=139
GET /api/v1/Person/{id}/Documents?$mode=Full
GET /api/v1/Person/{id}/Documents?$options=GrandTotal=true
GET /api/v1/Person/{id}/Documents?$context=reiciendis
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9202,
      "fullName": "Jillian Bergnaum"
    },
    {
      "PrimaryKey": 3343,
      "EntityName": "person",
      "personId": 3343,
      "fullName": "Mathilde Crooks"
    }
  ]
}
```