...
GET /api/v1/Person/{id}/Documents?$entities=aut
GET /api/v1/Person/{id}/Documents?$top=282
GET /api/v1/Person/{id}/Documents?$skip=155
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9549,
      "fullName": "Mr. Francesco Konopelski Jr."
    },
    {
      "PrimaryKey": 3082,
      "EntityName": "person",
      "personId": 3082,
      "fullName": "Colleen Feest"
    }
  ]
}
```