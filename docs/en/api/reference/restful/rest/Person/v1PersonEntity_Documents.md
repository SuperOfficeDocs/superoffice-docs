...
GET /api/v1/Person/{id}/Documents?$entities=enim
GET /api/v1/Person/{id}/Documents?$top=986
GET /api/v1/Person/{id}/Documents?$skip=130
GET /api/v1/Person/{id}/Documents?$mode=Full
GET /api/v1/Person/{id}/Documents?$options=GrandTotal=true
GET /api/v1/Person/{id}/Documents?$context=est
