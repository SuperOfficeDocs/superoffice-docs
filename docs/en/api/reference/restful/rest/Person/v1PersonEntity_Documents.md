...
GET /api/v1/Person/{id}/Documents?$entities=soluta
GET /api/v1/Person/{id}/Documents?$top=969
GET /api/v1/Person/{id}/Documents?$skip=434
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4511,
      "fullName": "Dr. Karley Onie Runte"
    },
    {
      "PrimaryKey": 3773,
      "EntityName": "person",
      "personId": 3773,
      "fullName": "Roy Jacobson"
    }
  ]
}
```