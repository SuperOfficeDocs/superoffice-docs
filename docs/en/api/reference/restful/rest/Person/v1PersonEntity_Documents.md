...
GET /api/v1/Person/{id}/Documents?$entities=nesciunt
GET /api/v1/Person/{id}/Documents?$top=999
GET /api/v1/Person/{id}/Documents?$skip=534
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 653,
      "fullName": "Ms. Vern Wiegand V"
    },
    {
      "PrimaryKey": 2578,
      "EntityName": "person",
      "personId": 2578,
      "fullName": "Hayley D'Amore"
    }
  ]
}
```