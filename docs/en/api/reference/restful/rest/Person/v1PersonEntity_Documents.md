...
GET /api/v1/Person/{id}/Documents?$entities=non
GET /api/v1/Person/{id}/Documents?$top=65
GET /api/v1/Person/{id}/Documents?$skip=403
GET /api/v1/Person/{id}/Documents?$mode=Full
GET /api/v1/Person/{id}/Documents?$options=GrandTotal=true
GET /api/v1/Person/{id}/Documents?$context=inventore
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 6050,
      "fullName": "Amie McDermott"
    },
    {
      "PrimaryKey": 1368,
      "EntityName": "person",
      "personId": 1368,
      "fullName": "Vallie Flo Runte DDS"
    }
  ]
}
```