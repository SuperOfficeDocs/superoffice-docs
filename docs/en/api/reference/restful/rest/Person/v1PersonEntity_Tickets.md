...
GET /api/v1/Person/{id}/Tickets?$entities=sit
GET /api/v1/Person/{id}/Tickets?$top=682
GET /api/v1/Person/{id}/Tickets?$skip=997
GET /api/v1/Person/{id}/Tickets?$mode=Full
GET /api/v1/Person/{id}/Tickets?$options=GrandTotal=true
GET /api/v1/Person/{id}/Tickets?$context=possimus
