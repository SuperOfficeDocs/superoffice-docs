...
GET /api/v1/Person/{id}/Tickets?$entities=blanditiis
GET /api/v1/Person/{id}/Tickets?$top=880
GET /api/v1/Person/{id}/Tickets?$skip=543
  ...
  "value": [
    {
      ...
      "saleId": 1685,
      "contactId": 1248,
      "name": "Harber, Leannon and Quigley"
    },
    {
      "PrimaryKey": 8562,
      "EntityName": "sale",
