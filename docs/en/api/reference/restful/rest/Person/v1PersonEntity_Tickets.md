...
GET /api/v1/Person/{id}/Tickets?$entities=eligendi
GET /api/v1/Person/{id}/Tickets?$top=751
GET /api/v1/Person/{id}/Tickets?$skip=921
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5811,
      "fullName": "Aurelie Schinner"
    },
    {
      "PrimaryKey": 2111,
      "EntityName": "person",
      "personId": 2111,
      "fullName": "Devante Prohaska"
    }
  ]
}
```