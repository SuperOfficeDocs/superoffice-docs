...
```http
GET /api/v1/Person/{personId}/Image?w=432
GET /api/v1/Person/{personId}/Image?h=601
GET /api/v1/Person/{personId}/Image?type=consequuntur
...
[!include[sample request](../../samples/rest/request/v1PersonEntity_GetImage.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1PersonEntity_GetImage.md)]