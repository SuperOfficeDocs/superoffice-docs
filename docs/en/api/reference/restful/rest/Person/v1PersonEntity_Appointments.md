...
GET /api/v1/Person/{id}/Appointments?$entities=temporibus
GET /api/v1/Person/{id}/Appointments?$top=206
GET /api/v1/Person/{id}/Appointments?$skip=106
GET /api/v1/Person/{id}/Appointments?$mode=Full
GET /api/v1/Person/{id}/Appointments?$options=GrandTotal=true
GET /api/v1/Person/{id}/Appointments?$context=ea
