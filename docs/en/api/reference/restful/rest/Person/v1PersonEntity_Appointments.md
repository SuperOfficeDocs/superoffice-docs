...
GET /api/v1/Person/{id}/Appointments?$entities=eius
GET /api/v1/Person/{id}/Appointments?$top=676
GET /api/v1/Person/{id}/Appointments?$skip=867
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 6030,
      "contactId": 1882,
      "name": "Labadie, Wiegand and Donnelly"
    }
  ]
}
```