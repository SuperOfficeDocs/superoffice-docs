...
GET /api/v1/Person/{id}/Appointments?$entities=eum
GET /api/v1/Person/{id}/Appointments?$top=668
GET /api/v1/Person/{id}/Appointments?$skip=582
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3428,
      "fullName": "Devon Kautzer"
    },
    {
      "PrimaryKey": 5634,
      "EntityName": "person",
      "personId": 5634,
      "fullName": "Carli Jacobi"
    }
  ]
}
```