...
GET /api/v1/Person/{id}/Appointments?$entities=ut
GET /api/v1/Person/{id}/Appointments?$top=75
GET /api/v1/Person/{id}/Appointments?$skip=220
GET /api/v1/Person/{id}/Appointments?$mode=Full
GET /api/v1/Person/{id}/Appointments?$options=GrandTotal=true
GET /api/v1/Person/{id}/Appointments?$context=sunt
