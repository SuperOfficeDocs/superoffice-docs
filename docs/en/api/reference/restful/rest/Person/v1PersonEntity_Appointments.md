...
GET /api/v1/Person/{id}/Appointments?$entities=sint
GET /api/v1/Person/{id}/Appointments?$top=54
GET /api/v1/Person/{id}/Appointments?$skip=857
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8354,
      "fullName": "Prof. Clement Kamron Mohr"
    },
    {
      "PrimaryKey": 9327,
      "EntityName": "person",
      "personId": 9327,
      "fullName": "Dr. Dillan Hermann"
    }
  ]
}
```