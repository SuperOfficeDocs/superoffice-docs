...
GET /api/v1/Person/{id}/Appointments?$entities=quia
GET /api/v1/Person/{id}/Appointments?$top=476
GET /api/v1/Person/{id}/Appointments?$skip=198
GET /api/v1/Person/{id}/Appointments?$mode=Full
GET /api/v1/Person/{id}/Appointments?$options=GrandTotal=true
GET /api/v1/Person/{id}/Appointments?$context=harum
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9802,
      "fullName": "Miss Marcelino Hills V"
    },
    {
      "PrimaryKey": 5142,
      "EntityName": "person",
      "personId": 5142,
      "fullName": "Ms. Kristin Lazaro Altenwerth"
    }
  ]
}
```