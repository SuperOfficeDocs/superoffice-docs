...
GET /api/v1/Person/{id}/Appointments?$entities=nisi
GET /api/v1/Person/{id}/Appointments?$top=669
GET /api/v1/Person/{id}/Appointments?$skip=44
  ...
  "value": [
    {
      ...
      "saleId": 3171,
      "contactId": 2190,
      "name": "Greenholt, Wolff and Goyette"
    },
    {
      "PrimaryKey": 8288,
      "EntityName": "sale",
