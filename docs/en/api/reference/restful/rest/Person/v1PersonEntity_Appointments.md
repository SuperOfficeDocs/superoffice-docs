...
GET /api/v1/Person/{id}/Appointments?$entities=consequuntur
GET /api/v1/Person/{id}/Appointments?$top=995
GET /api/v1/Person/{id}/Appointments?$skip=754
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "EntityName": "person",
      "personId": 8514,
      "fullName": "Annette Christopher Huels MD"
    }
  ]
}
```