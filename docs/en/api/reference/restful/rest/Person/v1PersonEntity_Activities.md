...
GET /api/v1/Person/{id}/Activities?$entities=recusandae
GET /api/v1/Person/{id}/Activities?$top=663
GET /api/v1/Person/{id}/Activities?$skip=110
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 795,
      "fullName": "Dr. Christ Naomie Koelpin MD"
    },
    {
      "PrimaryKey": 5308,
      "EntityName": "person",
      "personId": 5308,
      "fullName": "Savion DuBuque"
    }
  ]
}
```