...
GET /api/v1/Person/{id}/Activities?$entities=sit
GET /api/v1/Person/{id}/Activities?$top=295
GET /api/v1/Person/{id}/Activities?$skip=547
GET /api/v1/Person/{id}/Activities?$mode=Full
GET /api/v1/Person/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Person/{id}/Activities?$context=labore
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8397,
      "fullName": "Rowena Hickle"
    },
    {
      "PrimaryKey": 6177,
      "EntityName": "person",
      "personId": 6177,
      "fullName": "Larue Keebler"
    }
  ]
}
```