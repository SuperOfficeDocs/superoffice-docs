...
GET /api/v1/Person/{id}/Activities?$entities=iure
GET /api/v1/Person/{id}/Activities?$top=398
GET /api/v1/Person/{id}/Activities?$skip=558
GET /api/v1/Person/{id}/Activities?$mode=Full
GET /api/v1/Person/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Person/{id}/Activities?$context=doloremque
