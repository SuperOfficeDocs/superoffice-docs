...
GET /api/v1/Person/{id}/Activities?$entities=nostrum
GET /api/v1/Person/{id}/Activities?$top=37
GET /api/v1/Person/{id}/Activities?$skip=173
  ...
  "value": [
    {
      ...
      "saleId": 9378,
      "contactId": 5653,
      "name": "Beahan, VonRueden and Spinka"
    },
    {
      "PrimaryKey": 6823,
      "EntityName": "sale",
