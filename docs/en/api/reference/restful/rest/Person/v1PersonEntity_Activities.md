...
GET /api/v1/Person/{id}/Activities?$entities=soluta
GET /api/v1/Person/{id}/Activities?$top=200
GET /api/v1/Person/{id}/Activities?$skip=98
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 281,
      "contactId": 916,
      "name": "Little, Zboncak and Goyette"
    }
  ]
}
```