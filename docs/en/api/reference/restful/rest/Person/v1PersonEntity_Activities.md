...
GET /api/v1/Person/{id}/Activities?$entities=debitis
GET /api/v1/Person/{id}/Activities?$top=479
GET /api/v1/Person/{id}/Activities?$skip=300
GET /api/v1/Person/{id}/Activities?$mode=Full
GET /api/v1/Person/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Person/{id}/Activities?$context=omnis
