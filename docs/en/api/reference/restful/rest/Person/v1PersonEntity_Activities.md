...
GET /api/v1/Person/{id}/Activities?$entities=expedita
GET /api/v1/Person/{id}/Activities?$top=62
GET /api/v1/Person/{id}/Activities?$skip=142
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5741,
      "fullName": "Caleigh Runolfsdottir"
    },
    {
      "PrimaryKey": 1589,
      "EntityName": "person",
