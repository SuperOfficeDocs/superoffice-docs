...
GET /api/v1/Person/{id}/Activities?$entities=molestiae
GET /api/v1/Person/{id}/Activities?$top=321
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9005,
      "fullName": "Prof. Cynthia Paxton Durgan"
    },
    {
      "PrimaryKey": 7219,
      "EntityName": "person",
      "personId": 7219,
      "fullName": "Prof. Danial Flavio Schuppe"
    }
  ]
}
```