...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=cum
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=id
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=accusamus
```
