...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=praesentium
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=delectus
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=laudantium
```
