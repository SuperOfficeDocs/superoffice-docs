...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=libero
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=nostrum
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=earum
```
