...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=sed
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=magnam
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=consequuntur
```
