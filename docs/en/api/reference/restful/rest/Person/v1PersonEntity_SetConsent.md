...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=aliquid
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=ex
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=similique
```
