...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=harum
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=dolorem
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=consequatur
```
