...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=quaerat
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=repellendus
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=ut
```
