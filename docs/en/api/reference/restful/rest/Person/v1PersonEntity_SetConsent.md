...
```http
PUT /api/v1/Person/{personId}/Consent/{purpose}?source=ratione
PUT /api/v1/Person/{personId}/Consent/{purpose}?legalBase=voluptas
PUT /api/v1/Person/{personId}/Consent/{purpose}?comment=assumenda
```
