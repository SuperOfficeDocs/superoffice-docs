...
|-----------|------|-------------|
| attachmentId | int32 | The id of the root attachment **Required** |
| position | int32 | The position (index) of the attachment within the root attachment. Numbering starts from 0 **Required** |
...
[!include[sample request](../../samples/rest/request/v1TicketMessageEntity_GetRfcAttachmentStream.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1TicketMessageEntity_GetRfcAttachmentStream.md)]