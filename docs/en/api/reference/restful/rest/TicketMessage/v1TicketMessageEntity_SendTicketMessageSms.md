...
```http
POST /api/v1/TicketMessage/{ticketMessageEntityId}/SendSms?sms=minus,veritatis
POST /api/v1/TicketMessage/{ticketMessageEntityId}/SendSms?replyTemplateId=354
```
