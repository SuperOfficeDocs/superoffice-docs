...
```http
POST /api/v1/TicketMessage/{ticketMessageEntityId}/SendSms?sms=recusandae,error
POST /api/v1/TicketMessage/{ticketMessageEntityId}/SendSms?replyTemplateId=716
```
