...
```http
POST /api/v1/TicketMessage/{ticketMessageEntityId}/SendSms?sms=temporibus,fugiat
POST /api/v1/TicketMessage/{ticketMessageEntityId}/SendSms?replyTemplateId=852
```
