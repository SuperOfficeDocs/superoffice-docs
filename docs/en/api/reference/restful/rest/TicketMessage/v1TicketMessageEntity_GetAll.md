...
GET /api/v1/TicketMessage?$entities=debitis
GET /api/v1/TicketMessage?$top=624
GET /api/v1/TicketMessage?$skip=549
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 560,
      "fullName": "Dr. Caleb Sally Medhurst"
    },
    {
      "PrimaryKey": 3741,
      "EntityName": "person",
      "personId": 3741,
      "fullName": "Daphney Bogisich"
    }
  ]
}
```