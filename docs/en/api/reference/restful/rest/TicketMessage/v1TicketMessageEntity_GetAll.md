...
GET /api/v1/TicketMessage?$entities=enim
GET /api/v1/TicketMessage?$top=436
GET /api/v1/TicketMessage?$skip=639
  ...
  "value": [
    {
      ...
      "saleId": 124,
      "contactId": 7803,
      "name": "Towne, Collins and Kertzmann"
    },
    {
      "PrimaryKey": 1334,
      "EntityName": "sale",
      "saleId": 1334,
      "contactId": 1027,
      "name": "Kuhlman, Gleichner and Goldner"
    }
  ]
}
```