...
```http
POST /api/v1/License/ChangeSerialNumber?newCompanyName=Kris, Fay and Keeling
POST /api/v1/License/ChangeSerialNumber?newSerialNumber=420865
```
...
{
  "Succeeded": true,
  "Reason": "synergize viral communities",
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
      "FieldRight": null,
