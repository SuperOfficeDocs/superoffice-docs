...
[
  {
    ...
    "FieldName": "Mitchell, Hartmann and Tremblay",
    "DisplayName": "Harvey, Becker and O'Reilly",
    "Description": "Multi-layered zero administration flexibility",
    "ShortLabel": "labore",
    "HideLabel": false,
    "HideField": false,
    "IsIndexed": false,
    ...
    "IsDisplayField": true,
    "Rank": 60,
    "TemplateVariableName": "Weimann, Torphy and Runolfsdottir"
  }
]
```