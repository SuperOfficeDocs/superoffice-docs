...
GET /api/v1/BatchTask?$entities=accusantium
GET /api/v1/BatchTask?$top=906
GET /api/v1/BatchTask?$skip=29
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3479,
      "fullName": "Mrs. Dannie Kreiger Jr."
    },
    {
      "PrimaryKey": 866,
      "EntityName": "person",
      "personId": 866,
      "fullName": "Mr. Darian Botsford"
    }
  ]
}
```