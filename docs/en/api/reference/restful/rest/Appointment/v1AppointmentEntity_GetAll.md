...
GET /api/v1/Appointment?$entities=aliquam
GET /api/v1/Appointment?$top=170
GET /api/v1/Appointment?$skip=652
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 677,
      "fullName": "Miss Rosamond Domenica Daniel Sr."
    },
    {
      "PrimaryKey": 9933,
      "EntityName": "person",
      "personId": 9933,
      "fullName": "Mrs. Rene Diana Pfeffer"
    }
  ]
}
```