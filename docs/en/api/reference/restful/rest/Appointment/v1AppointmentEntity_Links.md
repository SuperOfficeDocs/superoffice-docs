...
GET /api/v1/Appointment/{id}/Links?$entities=nam
GET /api/v1/Appointment/{id}/Links?$top=361
GET /api/v1/Appointment/{id}/Links?$skip=301
GET /api/v1/Appointment/{id}/Links?$mode=Full
GET /api/v1/Appointment/{id}/Links?$options=GrandTotal=true
GET /api/v1/Appointment/{id}/Links?$context=veritatis
