...
GET /api/v1/Appointment/{id}/Links?$entities=alias
GET /api/v1/Appointment/{id}/Links?$top=281
GET /api/v1/Appointment/{id}/Links?$skip=747
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7889,
      "fullName": "Miss Adrianna Robin Ratke III"
    },
    {
      "PrimaryKey": 2652,
      "EntityName": "person",
      "personId": 2652,
      "fullName": "Dr. Jadon Vandervort"
    }
  ]
}
```