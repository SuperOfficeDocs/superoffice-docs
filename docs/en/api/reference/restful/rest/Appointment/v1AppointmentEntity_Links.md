...
GET /api/v1/Appointment/{id}/Links?$entities=incidunt
GET /api/v1/Appointment/{id}/Links?$top=740
GET /api/v1/Appointment/{id}/Links?$skip=994
GET /api/v1/Appointment/{id}/Links?$mode=Full
GET /api/v1/Appointment/{id}/Links?$options=GrandTotal=true
GET /api/v1/Appointment/{id}/Links?$context=ab
