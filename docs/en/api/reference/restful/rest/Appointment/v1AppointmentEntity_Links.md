...
GET /api/v1/Appointment/{id}/Links?$entities=dolores
GET /api/v1/Appointment/{id}/Links?$top=679
GET /api/v1/Appointment/{id}/Links?$skip=677
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 6775,
      "fullName": "Kaycee Kovacek V"
    },
    {
      "PrimaryKey": 7208,
      "EntityName": "person",
      "personId": 7208,
      "fullName": "Hettie Weber"
    }
  ]
}
```