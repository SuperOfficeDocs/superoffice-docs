...
[!include[sample request](../../samples/rest/request/v1AppointmentEntity_DeleteAppointmentEntity.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1AppointmentEntity_DeleteAppointmentEntity.md)]