...
GET /api/v1/Appointment/{id}/Participants?$entities=ratione
GET /api/v1/Appointment/{id}/Participants?$top=563
GET /api/v1/Appointment/{id}/Participants?$skip=711
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5120,
      "fullName": "Patricia Darryl Bergnaum DVM"
    },
    {
      "PrimaryKey": 9791,
      "EntityName": "person",
