...
GET /api/v1/Appointment/{id}/Participants?$entities=ab
GET /api/v1/Appointment/{id}/Participants?$top=204
GET /api/v1/Appointment/{id}/Participants?$skip=960
GET /api/v1/Appointment/{id}/Participants?$mode=Full
GET /api/v1/Appointment/{id}/Participants?$options=GrandTotal=true
GET /api/v1/Appointment/{id}/Participants?$context=placeat
