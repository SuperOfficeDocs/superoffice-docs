...
GET /api/v1/Appointment/{id}/Participants?$entities=est
GET /api/v1/Appointment/{id}/Participants?$top=479
GET /api/v1/Appointment/{id}/Participants?$skip=809
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 844,
      "contactId": 4655,
      "name": "Gibson, Konopelski and Hermann"
    }
  ]
}
```