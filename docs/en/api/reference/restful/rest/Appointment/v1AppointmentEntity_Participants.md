...
GET /api/v1/Appointment/{id}/Participants?$entities=rerum
GET /api/v1/Appointment/{id}/Participants?$top=458
GET /api/v1/Appointment/{id}/Participants?$skip=879
GET /api/v1/Appointment/{id}/Participants?$mode=Full
GET /api/v1/Appointment/{id}/Participants?$options=GrandTotal=true
GET /api/v1/Appointment/{id}/Participants?$context=adipisci
