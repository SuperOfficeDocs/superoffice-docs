...
GET /api/v1/Appointment/{id}/Participants?$entities=sapiente
GET /api/v1/Appointment/{id}/Participants?$top=883
GET /api/v1/Appointment/{id}/Participants?$skip=153
GET /api/v1/Appointment/{id}/Participants?$mode=Full
GET /api/v1/Appointment/{id}/Participants?$options=GrandTotal=true
GET /api/v1/Appointment/{id}/Participants?$context=libero
