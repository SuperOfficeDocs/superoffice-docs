...
GET /api/v1/User/Default?personId=409
```
...
[!include[sample request](../../samples/rest/request/v1User_CreateDefaultUserFromUserTypeAndPersonId.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1User_CreateDefaultUserFromUserTypeAndPersonId.md)]