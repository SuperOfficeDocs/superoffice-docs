...
GET /api/v1/User?$entities=temporibus
GET /api/v1/User?$top=133
GET /api/v1/User?$skip=955
GET /api/v1/User?$mode=Full
GET /api/v1/User?$options=GrandTotal=true
GET /api/v1/User?$context=eaque
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3682,
      "fullName": "Felipa Spinka"
    },
    {
      "PrimaryKey": 3284,
      "EntityName": "person",
      "personId": 3284,
      "fullName": "Lupe Rodriguez"
    }
  ]
}
```