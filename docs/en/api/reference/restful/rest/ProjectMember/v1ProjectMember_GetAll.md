...
GET /api/v1/ProjectMember?$entities=voluptatibus
GET /api/v1/ProjectMember?$top=890
GET /api/v1/ProjectMember?$skip=666
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8880,
      "fullName": "Janet Kirlin"
    },
    {
      "PrimaryKey": 7423,
      "EntityName": "person",
      "personId": 7423,
      "fullName": "Miss Lacy Chloe Kilback III"
    }
  ]
}
```