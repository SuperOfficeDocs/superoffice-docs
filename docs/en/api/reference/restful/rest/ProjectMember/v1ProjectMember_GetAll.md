...
GET /api/v1/ProjectMember?$entities=officiis
GET /api/v1/ProjectMember?$top=193
GET /api/v1/ProjectMember?$skip=34
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1272,
      "fullName": "Mr. Mose Shaun Hayes"
    },
    {
      "PrimaryKey": 5146,
      "EntityName": "person",
      "personId": 5146,
      "fullName": "Cara Langosh"
    }
  ]
}
```