...
GET /api/v1/ProjectMember?$entities=quidem
GET /api/v1/ProjectMember?$top=892
GET /api/v1/ProjectMember?$skip=373
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2980,
      "fullName": "Izabella Kuhn"
    },
    {
      "PrimaryKey": 3503,
      "EntityName": "person",
      "personId": 3503,
      "fullName": "Mrs. Nelle Cordelia Kerluke"
    }
  ]
}
```