...
GET /api/v1/Project/{id}/Contacts?$entities=at
GET /api/v1/Project/{id}/Contacts?$top=965
GET /api/v1/Project/{id}/Contacts?$skip=757
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8258,
      "fullName": "Prof. Mateo Baron Casper V"
    },
    {
      "PrimaryKey": 3309,
      "EntityName": "person",
      "personId": 3309,
      "fullName": "Prof. Garnett Bosco Jr."
    }
  ]
}
```