...
GET /api/v1/Project/{id}/Contacts?$entities=voluptatibus
GET /api/v1/Project/{id}/Contacts?$top=489
GET /api/v1/Project/{id}/Contacts?$skip=149
  ...
  "value": [
    {
      ...
      "saleId": 426,
      "contactId": 4501,
      "name": "Goldner, Schowalter and Steuber"
    },
    {
      "PrimaryKey": 4000,
      "EntityName": "sale",
