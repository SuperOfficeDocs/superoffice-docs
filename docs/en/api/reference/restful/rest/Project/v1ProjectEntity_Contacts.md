...
OData list of Contacts under a specific ProjectEntity.


Can be sorted and further filtered using OData conventions:

* Project/1234/Contacts?$select=col1,col2,abc/col3
* Project/1234/Contacts?$filter=col1 eq 'foo' and startswith(col2, 'baz')
* Project/1234/Contacts?$orderby=abc/col3,col1
* Project/1234/Contacts?$top=1000
* Project/1234/Contacts?$mode=full
...
GET /api/v1/Project/{id}/Contacts?$entities=dignissimos
GET /api/v1/Project/{id}/Contacts?$top=870
GET /api/v1/Project/{id}/Contacts?$skip=307
GET /api/v1/Project/{id}/Contacts?$mode=Full
GET /api/v1/Project/{id}/Contacts?$options=GrandTotal=true
GET /api/v1/Project/{id}/Contacts?$context=consequatur
...
[!include[sample request](../../samples/rest/request/v1ProjectEntity_Contacts.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1ProjectEntity_Contacts.md)]