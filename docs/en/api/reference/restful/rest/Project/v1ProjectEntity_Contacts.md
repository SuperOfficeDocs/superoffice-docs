...
GET /api/v1/Project/{id}/Contacts?$entities=placeat
GET /api/v1/Project/{id}/Contacts?$top=829
GET /api/v1/Project/{id}/Contacts?$skip=58
GET /api/v1/Project/{id}/Contacts?$mode=Full
GET /api/v1/Project/{id}/Contacts?$options=GrandTotal=true
GET /api/v1/Project/{id}/Contacts?$context=ad
