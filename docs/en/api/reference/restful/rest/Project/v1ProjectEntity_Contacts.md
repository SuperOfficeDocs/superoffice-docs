...
GET /api/v1/Project/{id}/Contacts?$entities=debitis
GET /api/v1/Project/{id}/Contacts?$top=479
GET /api/v1/Project/{id}/Contacts?$skip=605
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "EntityName": "person",
      "personId": 326,
      "fullName": "Miss Lowell Stewart Rolfson"
    }
  ]
}
```