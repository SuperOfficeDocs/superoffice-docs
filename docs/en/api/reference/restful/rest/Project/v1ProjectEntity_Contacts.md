...
GET /api/v1/Project/{id}/Contacts?$entities=vero
GET /api/v1/Project/{id}/Contacts?$top=552
GET /api/v1/Project/{id}/Contacts?$skip=272
  ...
  "value": [
    {
      ...
      "saleId": 5022,
      "contactId": 48,
      "name": "Williamson, Waters and Becker"
    },
    {
      "PrimaryKey": 7806,
      "EntityName": "sale",
