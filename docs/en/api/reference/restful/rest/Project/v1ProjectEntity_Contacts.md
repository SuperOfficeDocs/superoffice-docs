...
GET /api/v1/Project/{id}/Contacts?$entities=dolorem
GET /api/v1/Project/{id}/Contacts?$top=2
GET /api/v1/Project/{id}/Contacts?$skip=53
GET /api/v1/Project/{id}/Contacts?$mode=Full
GET /api/v1/Project/{id}/Contacts?$options=GrandTotal=true
GET /api/v1/Project/{id}/Contacts?$context=non
