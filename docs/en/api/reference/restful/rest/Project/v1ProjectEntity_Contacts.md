...
GET /api/v1/Project/{id}/Contacts?$entities=sequi
GET /api/v1/Project/{id}/Contacts?$top=415
GET /api/v1/Project/{id}/Contacts?$skip=607
GET /api/v1/Project/{id}/Contacts?$mode=Full
GET /api/v1/Project/{id}/Contacts?$options=GrandTotal=true
GET /api/v1/Project/{id}/Contacts?$context=accusamus
