...
GET /api/v1/Project/{id}/Contacts?$entities=iste
GET /api/v1/Project/{id}/Contacts?$top=210
GET /api/v1/Project/{id}/Contacts?$skip=432
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 9677,
      "fullName": "Reggie Lehner"
    },
    {
      "PrimaryKey": 5989,
      "EntityName": "person",
      "personId": 5989,
      "fullName": "Berta Grady II"
    }
  ]
}
```