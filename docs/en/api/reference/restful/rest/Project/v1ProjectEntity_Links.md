...
GET /api/v1/Project/{id}/Links?$entities=porro
GET /api/v1/Project/{id}/Links?$top=637
GET /api/v1/Project/{id}/Links?$skip=511
GET /api/v1/Project/{id}/Links?$mode=Full
GET /api/v1/Project/{id}/Links?$options=GrandTotal=true
GET /api/v1/Project/{id}/Links?$context=rerum
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 6500,
      "fullName": "Arely Greenholt"
    },
    {
      "PrimaryKey": 6909,
      "EntityName": "person",
      "personId": 6909,
      "fullName": "Dr. Sterling Stokes"
    }
  ]
}
```