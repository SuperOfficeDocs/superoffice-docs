...
GET /api/v1/Project/{id}/Links?$entities=incidunt
GET /api/v1/Project/{id}/Links?$top=415
GET /api/v1/Project/{id}/Links?$skip=36
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 1747,
      "contactId": 7173,
      "name": "Ankunding, Gerlach and Johnson"
    }
  ]
}
```