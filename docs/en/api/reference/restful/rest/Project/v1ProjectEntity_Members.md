...
GET /api/v1/Project/{id}/Members?$entities=dignissimos
GET /api/v1/Project/{id}/Members?$top=316
GET /api/v1/Project/{id}/Members?$skip=818
GET /api/v1/Project/{id}/Members?$mode=Full
GET /api/v1/Project/{id}/Members?$options=GrandTotal=true
GET /api/v1/Project/{id}/Members?$context=id
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1218,
      "fullName": "Aglae Weber"
    },
    {
      "PrimaryKey": 6389,
      "EntityName": "person",
      "personId": 6389,
      "fullName": "Levi Parker"
    }
  ]
}
```