...
GET /api/v1/Project/{id}/Members?$entities=vel
GET /api/v1/Project/{id}/Members?$top=591
GET /api/v1/Project/{id}/Members?$skip=927
GET /api/v1/Project/{id}/Members?$mode=Full
GET /api/v1/Project/{id}/Members?$options=GrandTotal=true
GET /api/v1/Project/{id}/Members?$context=quae
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "EntityName": "person",
      "personId": 5083,
      "fullName": "Ms. Amir Malvina Pfeffer Jr."
    }
  ]
}
```