...
GET /api/v1/Project/{id}/Members?$entities=ea
GET /api/v1/Project/{id}/Members?$top=723
...
GET /api/v1/Project/{id}/Members?$context=praesentium
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7910,
      "fullName": "Mr. Darryl Nolan"
    },
    {
      "PrimaryKey": 8876,
      "EntityName": "person",
      "personId": 8876,
      "fullName": "Freida Hessel"
    }
  ]
}
```