...
```http
GET /api/v1/Project/{projectId}/Image?w=182
GET /api/v1/Project/{projectId}/Image?h=276
GET /api/v1/Project/{projectId}/Image?type=repellendus
...
[!include[sample request](../../samples/rest/request/v1ProjectEntity_GetImage.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1ProjectEntity_GetImage.md)]