...
GET /api/v1/Project/{id}/Activities?$entities=sed
GET /api/v1/Project/{id}/Activities?$top=937
GET /api/v1/Project/{id}/Activities?$skip=684
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=vel
