...
GET /api/v1/Project/{id}/Activities?$entities=optio
GET /api/v1/Project/{id}/Activities?$top=92
GET /api/v1/Project/{id}/Activities?$skip=871
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=iure
