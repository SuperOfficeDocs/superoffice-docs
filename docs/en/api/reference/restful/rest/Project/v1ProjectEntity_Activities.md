...
GET /api/v1/Project/{id}/Activities?$entities=quas
GET /api/v1/Project/{id}/Activities?$top=369
GET /api/v1/Project/{id}/Activities?$skip=533
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=vero
