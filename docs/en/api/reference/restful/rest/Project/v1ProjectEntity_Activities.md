...
GET /api/v1/Project/{id}/Activities?$entities=amet
GET /api/v1/Project/{id}/Activities?$top=632
GET /api/v1/Project/{id}/Activities?$skip=189
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=eum
