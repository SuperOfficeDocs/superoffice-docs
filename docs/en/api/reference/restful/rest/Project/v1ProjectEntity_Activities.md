...
GET /api/v1/Project/{id}/Activities?$top=416
GET /api/v1/Project/{id}/Activities?$skip=366
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 309,
      "fullName": "Jaida Kathryne Gerhold DDS"
    },
    {
      "PrimaryKey": 1917,
      "EntityName": "person",
      "personId": 1917,
      "fullName": "Dr. Annette Edmond Klocko Sr."
    }
  ]
}
```