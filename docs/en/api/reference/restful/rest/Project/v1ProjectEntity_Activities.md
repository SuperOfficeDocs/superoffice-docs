...
GET /api/v1/Project/{id}/Activities?$entities=quia
GET /api/v1/Project/{id}/Activities?$top=796
GET /api/v1/Project/{id}/Activities?$skip=819
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 34,
      "fullName": "Trisha Howe"
    },
    {
      "PrimaryKey": 9101,
      "EntityName": "person",
      "personId": 9101,
      "fullName": "Clementine Jaqueline Lowe Jr."
    }
  ]
}
```