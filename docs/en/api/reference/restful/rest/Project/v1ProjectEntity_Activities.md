...
GET /api/v1/Project/{id}/Activities?$entities=nemo
GET /api/v1/Project/{id}/Activities?$top=28
GET /api/v1/Project/{id}/Activities?$skip=830
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=odit
