...
GET /api/v1/Project/{id}/Activities?$entities=ut
GET /api/v1/Project/{id}/Activities?$top=155
GET /api/v1/Project/{id}/Activities?$skip=832
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=repudiandae
