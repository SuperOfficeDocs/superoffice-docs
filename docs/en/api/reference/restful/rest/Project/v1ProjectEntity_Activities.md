...
GET /api/v1/Project/{id}/Activities?$entities=rerum
GET /api/v1/Project/{id}/Activities?$top=519
GET /api/v1/Project/{id}/Activities?$skip=47
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=natus
