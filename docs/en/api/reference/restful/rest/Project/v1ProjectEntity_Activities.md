...
GET /api/v1/Project/{id}/Activities?$entities=qui
GET /api/v1/Project/{id}/Activities?$top=319
GET /api/v1/Project/{id}/Activities?$skip=442
GET /api/v1/Project/{id}/Activities?$mode=Full
GET /api/v1/Project/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Project/{id}/Activities?$context=mollitia
