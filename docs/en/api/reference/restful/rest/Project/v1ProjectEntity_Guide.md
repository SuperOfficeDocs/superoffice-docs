...
GET /api/v1/Project/{id}/Guide?$entities=neque
GET /api/v1/Project/{id}/Guide?$top=613
GET /api/v1/Project/{id}/Guide?$skip=756
GET /api/v1/Project/{id}/Guide?$mode=Full
GET /api/v1/Project/{id}/Guide?$options=GrandTotal=true
GET /api/v1/Project/{id}/Guide?$context=quaerat
