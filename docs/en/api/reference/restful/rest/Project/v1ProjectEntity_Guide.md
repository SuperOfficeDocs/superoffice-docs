...
GET /api/v1/Project/{id}/Guide?$entities=ab
GET /api/v1/Project/{id}/Guide?$top=713
GET /api/v1/Project/{id}/Guide?$skip=173
GET /api/v1/Project/{id}/Guide?$mode=Full
GET /api/v1/Project/{id}/Guide?$options=GrandTotal=true
GET /api/v1/Project/{id}/Guide?$context=itaque
