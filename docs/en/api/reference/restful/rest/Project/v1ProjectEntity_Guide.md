...
GET /api/v1/Project/{id}/Guide?$entities=nihil
GET /api/v1/Project/{id}/Guide?$top=468
GET /api/v1/Project/{id}/Guide?$skip=719
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4020,
      "fullName": "Aron Johnston"
    },
    {
      "PrimaryKey": 9550,
      "EntityName": "person",
      "personId": 9550,
      "fullName": "Gudrun Berta Kunze V"
    }
  ]
}
```