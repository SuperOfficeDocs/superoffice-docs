...
GET /api/v1/Sale/{id}/Stakeholders?$entities=aut
GET /api/v1/Sale/{id}/Stakeholders?$top=203
GET /api/v1/Sale/{id}/Stakeholders?$skip=277
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7723,
      "fullName": "Camron Homenick"
    },
    {
      "PrimaryKey": 9515,
      "EntityName": "person",
      "personId": 9515,
      "fullName": "Kailey Kihn"
    }
  ]
}
```