...
GET /api/v1/Sale/{id}/Stakeholders?$entities=eius
GET /api/v1/Sale/{id}/Stakeholders?$top=28
GET /api/v1/Sale/{id}/Stakeholders?$skip=474
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 4214,
      "fullName": "Alvena Nya Mills III"
    },
    {
      "PrimaryKey": 3837,
      "EntityName": "person",
      "personId": 3837,
      "fullName": "Katherine Omari Murazik Sr."
    }
  ]
}
```