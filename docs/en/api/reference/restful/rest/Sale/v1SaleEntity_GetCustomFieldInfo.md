...

{
  ...
  "FieldName": "Satterfield, Balistreri and Smitham",
  "DisplayName": "Kris, Thompson and Frami",
  "Description": "Exclusive needs-based intranet",
  "ShortLabel": "ut",
  "HideLabel": true,
  "HideField": false,
  "IsIndexed": true,
  ...
  "IsExternal": true,
  "Rank": 132,
  "TemplateVariableName": "Schinner-Eichmann"
}
```