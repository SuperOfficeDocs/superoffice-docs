...
GET /api/v1/Sale/{id}/Activities?$entities=doloremque
GET /api/v1/Sale/{id}/Activities?$top=635
GET /api/v1/Sale/{id}/Activities?$skip=888
GET /api/v1/Sale/{id}/Activities?$mode=Full
GET /api/v1/Sale/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Sale/{id}/Activities?$context=odio
