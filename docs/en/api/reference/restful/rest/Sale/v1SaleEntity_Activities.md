...
GET /api/v1/Sale/{id}/Activities?$entities=esse
GET /api/v1/Sale/{id}/Activities?$top=927
GET /api/v1/Sale/{id}/Activities?$skip=537
GET /api/v1/Sale/{id}/Activities?$mode=Full
GET /api/v1/Sale/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Sale/{id}/Activities?$context=laudantium
