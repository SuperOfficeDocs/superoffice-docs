...
GET /api/v1/Sale/{id}/Activities?$entities=quia
GET /api/v1/Sale/{id}/Activities?$top=869
GET /api/v1/Sale/{id}/Activities?$skip=172
GET /api/v1/Sale/{id}/Activities?$mode=Full
GET /api/v1/Sale/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Sale/{id}/Activities?$context=ab
