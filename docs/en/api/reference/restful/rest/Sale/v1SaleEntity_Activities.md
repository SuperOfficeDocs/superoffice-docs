...
GET /api/v1/Sale/{id}/Activities?$entities=voluptas
GET /api/v1/Sale/{id}/Activities?$top=743
GET /api/v1/Sale/{id}/Activities?$skip=112
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 2034,
      "contactId": 9808,
      "name": "Collier, Bogisich and Williamson"
    }
  ]
}
```