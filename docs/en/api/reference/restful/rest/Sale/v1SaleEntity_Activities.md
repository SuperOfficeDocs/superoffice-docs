...
GET /api/v1/Sale/{id}/Activities?$top=547
GET /api/v1/Sale/{id}/Activities?$skip=460
GET /api/v1/Sale/{id}/Activities?$mode=Full
GET /api/v1/Sale/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Sale/{id}/Activities?$context=molestias
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 2347,
      "fullName": "Mrs. Eloisa Nitzsche"
    },
    {
      "PrimaryKey": 4157,
      "EntityName": "person",
      "personId": 4157,
      "fullName": "Ms. Ruben Bette Pfannerstill V"
    }
  ]
}
```