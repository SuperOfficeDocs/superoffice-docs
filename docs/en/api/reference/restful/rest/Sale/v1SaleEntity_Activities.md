...
GET /api/v1/Sale/{id}/Activities?$entities=deleniti
GET /api/v1/Sale/{id}/Activities?$top=451
GET /api/v1/Sale/{id}/Activities?$skip=386
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5781,
      "fullName": "Maximillian Wisoky"
    },
    {
      "PrimaryKey": 881,
      "EntityName": "person",
      "personId": 881,
      "fullName": "Thurman Wyman"
    }
  ]
}
```