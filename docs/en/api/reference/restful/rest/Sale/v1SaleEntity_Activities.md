...
GET /api/v1/Sale/{id}/Activities?$entities=error
GET /api/v1/Sale/{id}/Activities?$top=294
GET /api/v1/Sale/{id}/Activities?$skip=752
GET /api/v1/Sale/{id}/Activities?$mode=Full
GET /api/v1/Sale/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Sale/{id}/Activities?$context=voluptas
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 7628,
      "fullName": "Estell Smith"
    },
    {
      "PrimaryKey": 4893,
      "EntityName": "person",
      "personId": 4893,
      "fullName": "Diana Hackett"
    }
  ]
}
```