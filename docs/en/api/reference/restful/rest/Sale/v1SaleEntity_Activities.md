...
GET /api/v1/Sale/{id}/Activities?$top=434
GET /api/v1/Sale/{id}/Activities?$skip=607
GET /api/v1/Sale/{id}/Activities?$mode=Full
GET /api/v1/Sale/{id}/Activities?$options=GrandTotal=true
GET /api/v1/Sale/{id}/Activities?$context=harum
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1456,
      "fullName": "Bryon Gottlieb"
    },
    {
      "PrimaryKey": 9870,
      "EntityName": "person",
      "personId": 9870,
      "fullName": "Verlie Grant IV"
    }
  ]
}
```