...
GET /api/v1/Sale/{id}/Activities?$entities=eum
GET /api/v1/Sale/{id}/Activities?$top=157
...
GET /api/v1/Sale/{id}/Activities?$context=id
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 9672,
      "contactId": 4455,
      "name": "Reichel, Russel and Schiller"
    }
  ]
}
```