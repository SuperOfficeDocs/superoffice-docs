...
GET /api/v1/Sale/{id}/Links?$entities=quis
GET /api/v1/Sale/{id}/Links?$top=521
GET /api/v1/Sale/{id}/Links?$skip=412
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1271,
      "fullName": "Everardo Smith"
    },
    {
      "PrimaryKey": 7498,
      "EntityName": "person",
      "personId": 7498,
      "fullName": "Miss Nicholaus Desiree Dibbert DVM"
    }
  ]
}
```