...
GET /api/v1/Sale/{id}/Guide?$entities=suscipit
GET /api/v1/Sale/{id}/Guide?$top=810
GET /api/v1/Sale/{id}/Guide?$skip=535
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 8829,
      "fullName": "Sheridan Elvis Renner PhD"
    },
    {
      "PrimaryKey": 5139,
      "EntityName": "person",
      "personId": 5139,
      "fullName": "Glenda Ankunding"
    }
  ]
}
```