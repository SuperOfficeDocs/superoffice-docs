...
GET /api/v1/Sale/{id}/Guide?$entities=sit
GET /api/v1/Sale/{id}/Guide?$top=737
GET /api/v1/Sale/{id}/Guide?$skip=119
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 5470,
      "fullName": "Ayana Bartoletti"
    },
    {
      "PrimaryKey": 4187,
      "EntityName": "person",
      "personId": 4187,
      "fullName": "Miss Damien Emelia Ryan DVM"
    }
  ]
}
```