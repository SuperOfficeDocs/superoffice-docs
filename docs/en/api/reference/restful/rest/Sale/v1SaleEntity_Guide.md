...
GET /api/v1/Sale/{id}/Guide?$entities=perspiciatis
GET /api/v1/Sale/{id}/Guide?$top=531
GET /api/v1/Sale/{id}/Guide?$skip=203
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 2045,
      "contactId": 1567,
      "name": "Bartoletti, Dicki and Morissette"
    }
  ]
}
```