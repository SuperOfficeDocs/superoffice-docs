...
GET /api/v1/Sale/{id}/Guide?$entities=veniam
GET /api/v1/Sale/{id}/Guide?$top=25
GET /api/v1/Sale/{id}/Guide?$skip=830
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1738,
      "fullName": "Ms. Einar Braun DVM"
    },
    {
      "PrimaryKey": 1166,
      "EntityName": "person",
      "personId": 1166,
      "fullName": "Miss Catharine Shanahan"
    }
  ]
}
```