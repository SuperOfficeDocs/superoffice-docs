...
[!include[sample request](../../samples/rest/request/v1SaleEntity_GetNextDueDate.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1SaleEntity_GetNextDueDate.md)]