...
GET /api/v1/Sale?$entities=accusantium
GET /api/v1/Sale?$top=468
GET /api/v1/Sale?$skip=608
GET /api/v1/Sale?$mode=Full
GET /api/v1/Sale?$options=GrandTotal=true
GET /api/v1/Sale?$context=perspiciatis
...
[!include[sample request](../../samples/rest/request/v1SaleEntity_GetAll.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1SaleEntity_GetAll.md)]