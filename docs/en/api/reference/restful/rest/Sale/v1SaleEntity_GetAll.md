...
GET /api/v1/Sale?$entities=rem
GET /api/v1/Sale?$top=738
GET /api/v1/Sale?$skip=904
GET /api/v1/Sale?$mode=Full
GET /api/v1/Sale?$options=GrandTotal=true
GET /api/v1/Sale?$context=cupiditate
