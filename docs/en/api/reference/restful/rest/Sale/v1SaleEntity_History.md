...
GET /api/v1/Sale/{id}/History?$entities=similique
GET /api/v1/Sale/{id}/History?$top=187
...
GET /api/v1/Sale/{id}/History?$context=voluptatem
  ...
  "value": [
    {
      ...
      "saleId": 1652,
      "contactId": 4700,
      "name": "Walsh, Larkin and O'Reilly"
    },
    {
      "PrimaryKey": 3773,
      "EntityName": "sale",
