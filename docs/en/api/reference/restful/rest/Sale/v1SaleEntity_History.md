...
GET /api/v1/Sale/{id}/History?$entities=inventore
GET /api/v1/Sale/{id}/History?$top=53
GET /api/v1/Sale/{id}/History?$skip=381
GET /api/v1/Sale/{id}/History?$mode=Full
GET /api/v1/Sale/{id}/History?$options=GrandTotal=true
GET /api/v1/Sale/{id}/History?$context=facere
