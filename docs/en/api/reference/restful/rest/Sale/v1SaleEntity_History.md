...
GET /api/v1/Sale/{id}/History?$entities=minus
GET /api/v1/Sale/{id}/History?$top=528
GET /api/v1/Sale/{id}/History?$skip=694
GET /api/v1/Sale/{id}/History?$mode=Full
GET /api/v1/Sale/{id}/History?$options=GrandTotal=true
GET /api/v1/Sale/{id}/History?$context=rerum
