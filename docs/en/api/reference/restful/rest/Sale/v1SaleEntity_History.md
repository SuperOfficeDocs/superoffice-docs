...
GET /api/v1/Sale/{id}/History?$entities=error
GET /api/v1/Sale/{id}/History?$top=182
GET /api/v1/Sale/{id}/History?$skip=621
GET /api/v1/Sale/{id}/History?$mode=Full
GET /api/v1/Sale/{id}/History?$options=GrandTotal=true
GET /api/v1/Sale/{id}/History?$context=molestiae
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 1909,
      "fullName": "Arlo Beahan DDS"
    },
    {
      "PrimaryKey": 3437,
      "EntityName": "person",
      "personId": 3437,
      "fullName": "Ms. Clare Issac Runolfsson"
    }
  ]
}
```