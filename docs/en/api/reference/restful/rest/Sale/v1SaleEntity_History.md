...
GET /api/v1/Sale/{id}/History?$entities=adipisci
GET /api/v1/Sale/{id}/History?$top=229
...
GET /api/v1/Sale/{id}/History?$context=quibusdam
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3996,
      "fullName": "Dr. Lenora Ankunding"
    },
    {
      "PrimaryKey": 5613,
      "EntityName": "person",
      "personId": 5613,
      "fullName": "Aurore Runte"
    }
  ]
}
```