...
GET /api/v1/Sale/{id}/History?$entities=exercitationem
GET /api/v1/Sale/{id}/History?$top=307
...
GET /api/v1/Sale/{id}/History?$context=dolore
...

{
  ...
  "value": [
    ...
    },
    {
      ...
      "saleId": 2565,
      "contactId": 3458,
      "name": "Lubowitz, Johnston and Bauch"
    }
  ]
}
```