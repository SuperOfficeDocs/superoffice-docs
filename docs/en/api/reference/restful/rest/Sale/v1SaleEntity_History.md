...
GET /api/v1/Sale/{id}/History?$entities=neque
GET /api/v1/Sale/{id}/History?$top=897
GET /api/v1/Sale/{id}/History?$skip=782
GET /api/v1/Sale/{id}/History?$mode=Full
GET /api/v1/Sale/{id}/History?$options=GrandTotal=true
GET /api/v1/Sale/{id}/History?$context=dolores
