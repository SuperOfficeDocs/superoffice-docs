...
GET /api/v1/Sale/{id}/History?$entities=placeat
GET /api/v1/Sale/{id}/History?$top=205
GET /api/v1/Sale/{id}/History?$skip=77
GET /api/v1/Sale/{id}/History?$mode=Full
GET /api/v1/Sale/{id}/History?$options=GrandTotal=true
GET /api/v1/Sale/{id}/History?$context=facilis
