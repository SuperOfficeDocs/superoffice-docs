...
GET /api/v1/Sale/{id}/History?$entities=dolores
GET /api/v1/Sale/{id}/History?$top=679
GET /api/v1/Sale/{id}/History?$skip=80
GET /api/v1/Sale/{id}/History?$mode=Full
GET /api/v1/Sale/{id}/History?$options=GrandTotal=true
GET /api/v1/Sale/{id}/History?$context=reiciendis
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 946,
      "fullName": "Mr. Andy Legros DVM"
    },
    {
      "PrimaryKey": 1143,
      "EntityName": "person",
      "personId": 1143,
      "fullName": "Haven Keeling"
    }
  ]
}
```