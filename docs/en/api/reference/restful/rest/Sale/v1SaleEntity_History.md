...
GET /api/v1/Sale/{id}/History?$entities=impedit
GET /api/v1/Sale/{id}/History?$top=342
GET /api/v1/Sale/{id}/History?$skip=776
  ...
  "value": [
    {
      ...
      "EntityName": "person",
      "personId": 3404,
      "fullName": "Blanche Cormier"
    },
    {
      "PrimaryKey": 4391,
      "EntityName": "person",
      "personId": 4391,
      "fullName": "Chet Ziemann"
    }
  ]
}
```