...
GET /api/v1/List/Reason/MDOItems?query=molestiae
```
...
[
  {
    ...
    "ChildItems": [
      {
        "Id": 20,
        "Name": "O'Reilly, Quigley and Lemke",
        "ToolTip": "Placeat corrupti nam veniam quaerat.",
        "Deleted": false,
        "Rank": 108,
        "Type": "accusamus",
        "ChildItems": [
    ...
    "ExtraInfo": "deleniti",
    "StyleHint": "natus",
    "FullName": "Prof. Layne Wilber Donnelly I",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
