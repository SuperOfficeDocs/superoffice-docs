---
title: GET TicketRelationDefinition/default
uid: v1TicketRelationDefinitionEntity_DefaultTicketRelationDefinitionEntity
generated: true
content_type: reference
---

# GET TicketRelationDefinition/default

```http
GET /api/v1/TicketRelationDefinition/default
```
...
[!include[sample request](../../samples/rest/request/v1TicketRelationDefinitionEntity_DefaultTicketRelationDefinitionEntity.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1TicketRelationDefinitionEntity_DefaultTicketRelationDefinitionEntity.md)]