...
```http
POST /api/v1/Preference/{section}/{key}/{prefLevel}?value=asperiores
```
...
[!include[sample request](../../samples/rest/request/v1Preference_SetPrefValueAtLevel_POST.md)]

## Sample response

[!include[sample response](../../samples/rest/response/v1Preference_SetPrefValueAtLevel_POST.md)]