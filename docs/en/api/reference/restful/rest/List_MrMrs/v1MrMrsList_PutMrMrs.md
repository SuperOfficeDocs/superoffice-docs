...
Updates an existing MrMrs list item.
...
|-----------|------|-------------|
| id | int32 | The id of MrMrs to be saved. **Required** |
...
The details of MrMrs list item to be saved. 
...
{
  "Id": 240,
  "Name": "Strosin, Cronin and Simonis",
  "Tooltip": "architecto",
  "Deleted": false,
...
{
  "Id": 278,
  "Name": "Douglas, Stiedemann and Marquardt",
  "Tooltip": "ea",
  "Deleted": false,
