...
[!include[sample request](../../samples/agent/request/v1FavouriteAgent_RemoveFavouritesById.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1FavouriteAgent_RemoveFavouritesById.md)]