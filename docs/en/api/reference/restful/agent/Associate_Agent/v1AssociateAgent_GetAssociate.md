...
```http
POST /api/v1/Agents/Associate/GetAssociate?associateId=780
...

{
  ...
  "GroupIdx": 700,
  "FullName": "Prof. Brooklyn Frankie Crist",
  "FormalName": "Wolff, O'Keefe and Quigley",
  "Deleted": false,
  "EjUserId": 288,
  "UserName": "Harris, Tillman and Kozey",
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
      "FieldRight": null,
