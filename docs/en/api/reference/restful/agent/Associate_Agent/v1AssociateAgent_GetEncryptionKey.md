...
```http
POST /api/v1/Agents/Associate/GetEncryptionKey?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1AssociateAgent_GetEncryptionKey.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AssociateAgent_GetEncryptionKey.md)]