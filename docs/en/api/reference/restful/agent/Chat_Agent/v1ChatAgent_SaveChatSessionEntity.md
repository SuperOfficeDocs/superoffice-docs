...
[!include[sample request](../../samples/agent/request/v1ChatAgent_SaveChatSessionEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ChatAgent_SaveChatSessionEntity.md)]