...
```http
POST /api/v1/Agents/Chat/DeleteChatTopicEntity?chatTopicEntityId=335
```
...
[!include[sample request](../../samples/agent/request/v1ChatAgent_DeleteChatTopicEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ChatAgent_DeleteChatTopicEntity.md)]