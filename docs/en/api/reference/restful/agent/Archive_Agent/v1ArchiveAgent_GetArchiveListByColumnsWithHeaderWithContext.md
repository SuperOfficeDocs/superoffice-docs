...
[!include[sample request](../../samples/agent/request/v1ArchiveAgent_GetArchiveListByColumnsWithHeaderWithContext.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ArchiveAgent_GetArchiveListByColumnsWithHeaderWithContext.md)]