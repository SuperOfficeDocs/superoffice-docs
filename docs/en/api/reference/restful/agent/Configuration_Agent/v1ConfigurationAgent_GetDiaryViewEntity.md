...
```http
POST /api/v1/Agents/Configuration/GetDiaryViewEntity?diaryViewEntityId=616
  ...
  "AssociateList": [
    {
      ...
      "IconHint": "sequi",
      "Selected": true,
      "LastChanged": "2009-07-06T03:44:52.2771517+02:00",
      "ChildItems": [
        {},
        {}
      ],
      ...
      "StyleHint": "in",
      "Hidden": false,
      "FullName": "Elian Jackie Effertz PhD",
      "TableRight": null,
      "FieldProperties": {
        "fieldName": {
          "FieldRight": null,
