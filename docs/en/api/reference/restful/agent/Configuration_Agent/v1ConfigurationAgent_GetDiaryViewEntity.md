...
```http
POST /api/v1/Agents/Configuration/GetDiaryViewEntity?diaryViewEntityId=407
...

{
  ...
  "AssociateList": [
    {
      "Id": 342,
      "Name": "Marvin, O'Keefe and Walsh",
      "ToolTip": "Maxime aut quisquam.",
      "Deleted": true,
      "Rank": 380,
      "Type": "eos",
      "ColorBlock": 20,
      "IconHint": "culpa",
      "Selected": false,
      "LastChanged": "2010-05-22T04:22:26.1684694+02:00",
      "ChildItems": [
        {},
        {}
      ],
