...
[!include[sample request](../../samples/agent/request/v1BatchAgent_DeleteBatchTask.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1BatchAgent_DeleteBatchTask.md)]