---
title: POST Agents/Selection/SaveBoardViewSettings
uid: v1SelectionAgent_SaveBoardViewSettings
generated: true
content_type: reference
---

# POST Agents/Selection/SaveBoardViewSettings
...
```http
POST /api/v1/Agents/Selection/SaveBoardViewSettings?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1SelectionAgent_SaveBoardViewSettings.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1SelectionAgent_SaveBoardViewSettings.md)]