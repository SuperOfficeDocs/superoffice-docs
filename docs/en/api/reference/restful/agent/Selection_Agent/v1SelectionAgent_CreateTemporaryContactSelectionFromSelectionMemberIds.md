...
[!include[sample request](../../samples/agent/request/v1SelectionAgent_CreateTemporaryContactSelectionFromSelectionMemberIds.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1SelectionAgent_CreateTemporaryContactSelectionFromSelectionMemberIds.md)]