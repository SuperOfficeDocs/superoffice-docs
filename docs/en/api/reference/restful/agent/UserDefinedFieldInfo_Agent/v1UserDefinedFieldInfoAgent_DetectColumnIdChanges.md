...
```http
POST /api/v1/Agents/UserDefinedFieldInfo/DetectColumnIdChanges?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1UserDefinedFieldInfoAgent_DetectColumnIdChanges.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1UserDefinedFieldInfoAgent_DetectColumnIdChanges.md)]