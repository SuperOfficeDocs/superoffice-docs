...
```http
POST /api/v1/Agents/UserDefinedFieldInfo/Revert?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1UserDefinedFieldInfoAgent_Revert.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1UserDefinedFieldInfoAgent_Revert.md)]