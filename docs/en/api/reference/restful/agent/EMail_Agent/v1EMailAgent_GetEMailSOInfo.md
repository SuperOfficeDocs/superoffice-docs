...
```http
POST /api/v1/Agents/EMail/GetEMailSOInfo?eMailSOInfoId=820
...
[!include[sample request](../../samples/agent/request/v1EMailAgent_GetEMailSOInfo.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1EMailAgent_GetEMailSOInfo.md)]