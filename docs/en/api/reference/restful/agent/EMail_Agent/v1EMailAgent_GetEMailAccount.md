...
```http
POST /api/v1/Agents/EMail/GetEMailAccount?eMailAccountId=344
...
[!include[sample request](../../samples/agent/request/v1EMailAgent_GetEMailAccount.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1EMailAgent_GetEMailAccount.md)]