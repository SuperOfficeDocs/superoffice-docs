...
```http
POST /api/v1/Agents/EMail/DeleteEMailAccount?eMailAccountId=236
```
...
[!include[sample request](../../samples/agent/request/v1EMailAgent_DeleteEMailAccount.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1EMailAgent_DeleteEMailAccount.md)]