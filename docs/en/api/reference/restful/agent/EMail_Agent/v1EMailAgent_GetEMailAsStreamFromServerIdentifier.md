---
title: POST Agents/EMail/GetEMailAsStreamFromServerIdentifier
uid: v1EMailAgent_GetEMailAsStreamFromServerIdentifier
generated: true
content_type: reference
---

# POST Agents/EMail/GetEMailAsStreamFromServerIdentifier

```http
POST /api/v1/Agents/EMail/GetEMailAsStreamFromServerIdentifier
```
...
```http
POST /api/v1/Agents/EMail/GetEMailAsStreamFromServerIdentifier?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1EMailAgent_GetEMailAsStreamFromServerIdentifier.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1EMailAgent_GetEMailAsStreamFromServerIdentifier.md)]