...
[!include[sample request](../../samples/agent/request/v1BLOBAgent_GetOutputFromBatch.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1BLOBAgent_GetOutputFromBatch.md)]