...
```http
POST /api/v1/Agents/BLOB/GetBlobEntity?blobEntityId=373
...
[!include[sample request](../../samples/agent/request/v1BLOBAgent_GetBlobEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1BLOBAgent_GetBlobEntity.md)]