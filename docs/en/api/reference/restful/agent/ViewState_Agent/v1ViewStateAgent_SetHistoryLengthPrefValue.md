...
[!include[sample request](../../samples/agent/request/v1ViewStateAgent_SetHistoryLengthPrefValue.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ViewStateAgent_SetHistoryLengthPrefValue.md)]