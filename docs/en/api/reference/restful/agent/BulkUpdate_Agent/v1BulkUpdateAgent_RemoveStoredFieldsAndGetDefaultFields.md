...
[!include[sample request](../../samples/agent/request/v1BulkUpdateAgent_RemoveStoredFieldsAndGetDefaultFields.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1BulkUpdateAgent_RemoveStoredFieldsAndGetDefaultFields.md)]