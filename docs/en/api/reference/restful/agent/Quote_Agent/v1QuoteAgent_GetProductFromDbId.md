...
[!include[sample request](../../samples/agent/request/v1QuoteAgent_GetProductFromDbId.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1QuoteAgent_GetProductFromDbId.md)]