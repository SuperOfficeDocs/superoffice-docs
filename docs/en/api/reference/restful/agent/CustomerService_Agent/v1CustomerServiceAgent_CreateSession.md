...
[!include[sample request](../../samples/agent/request/v1CustomerServiceAgent_CreateSession.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1CustomerServiceAgent_CreateSession.md)]