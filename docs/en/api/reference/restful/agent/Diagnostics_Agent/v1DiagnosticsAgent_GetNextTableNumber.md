...
```http
POST /api/v1/Agents/Diagnostics/GetNextTableNumber?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1DiagnosticsAgent_GetNextTableNumber.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1DiagnosticsAgent_GetNextTableNumber.md)]