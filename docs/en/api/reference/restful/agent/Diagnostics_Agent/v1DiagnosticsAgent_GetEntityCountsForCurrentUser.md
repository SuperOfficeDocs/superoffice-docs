...
```http
POST /api/v1/Agents/Diagnostics/GetEntityCountsForCurrentUser?$select=name,department,category/id
```
...
|----------------|------|--------------|
| EntityName | string | The entity measured by this tile |
| Records | int32 | Number of entities (EntityName) an associate has created |
...
[
  {
    "EntityName": "Bradtke, Altenwerth and Koelpin",
    "Records": 22,
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
