...
```http
POST /api/v1/Agents/Person/GetPersonEntity?personEntityId=581
...
[!include[sample request](../../samples/agent/request/v1PersonAgent_GetPersonEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1PersonAgent_GetPersonEntity.md)]