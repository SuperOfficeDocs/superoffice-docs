...
```http
POST /api/v1/Agents/Person/GetConsentPerson?consentPersonId=610
...
[!include[sample request](../../samples/agent/request/v1PersonAgent_GetConsentPerson.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1PersonAgent_GetConsentPerson.md)]