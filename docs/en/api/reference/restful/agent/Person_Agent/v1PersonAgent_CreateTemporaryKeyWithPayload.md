...
```http
POST /api/v1/Agents/Person/CreateTemporaryKeyWithPayload?$select=name,department,category/id
```
...
Domain, TargetId, PersonId, Expires, Payload 
...

{
  ...
  "TargetId": 575,
  "PersonId": 409,
  "Expires": "2000-01-08T14:45:05.9125422+01:00",
  "Payload": "dicta"
}
```
