...
```http
POST /api/v1/Agents/Preference/GetPreferenceDescriptionLine?preferenceDescriptionLineId=791
...

{
  ...
  "PrefShowValue": "libero",
  "Description": "Configurable responsive ability",
  "IsBuiltin": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
