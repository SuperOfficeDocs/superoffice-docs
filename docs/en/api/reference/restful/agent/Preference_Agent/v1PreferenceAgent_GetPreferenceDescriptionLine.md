...
```http
POST /api/v1/Agents/Preference/GetPreferenceDescriptionLine?preferenceDescriptionLineId=126
...
[!include[sample request](../../samples/agent/request/v1PreferenceAgent_GetPreferenceDescriptionLine.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1PreferenceAgent_GetPreferenceDescriptionLine.md)]