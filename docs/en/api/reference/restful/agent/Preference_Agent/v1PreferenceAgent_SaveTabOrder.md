...
[!include[sample request](../../samples/agent/request/v1PreferenceAgent_SaveTabOrder.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1PreferenceAgent_SaveTabOrder.md)]