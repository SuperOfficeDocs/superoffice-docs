...
[!include[sample request](../../samples/agent/request/v1PreferenceAgent_UpdateNetServicesStatus.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1PreferenceAgent_UpdateNetServicesStatus.md)]