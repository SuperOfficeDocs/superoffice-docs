...
```http
POST /api/v1/Agents/Preference/GetPreferenceDescription?preferenceDescriptionId=972
...

{
  ...
  "Description": "Versatile web-enabled approach",
  "IsBuiltin": false,
  "TableName": "Fadel, McKenzie and Wintheiser",
