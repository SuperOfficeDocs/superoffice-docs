...
```http
POST /api/v1/Agents/Preference/GetPreferenceDescription?preferenceDescriptionId=789
...

{
  ...
  "Description": "Secured object-oriented solution",
  "IsBuiltin": false,
  "TableName": "Hayes-Goyette",
  "UserDefinedListId": 87,
  "Rank": 271,
  "SubGroup": "quisquam",
  "MinLevel": 323,
  "MaxValue": 156,
