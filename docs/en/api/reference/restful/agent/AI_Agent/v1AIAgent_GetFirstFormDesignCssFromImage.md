---
title: POST Agents/AI/GetFirstFormDesignCssFromImage
uid: v1AIAgent_GetFirstFormDesignCssFromImage
generated: true
content_type: reference
---

# POST Agents/AI/GetFirstFormDesignCssFromImage

```http
POST /api/v1/Agents/AI/GetFirstFormDesignCssFromImage
```
...
```http
POST /api/v1/Agents/AI/GetFirstFormDesignCssFromImage?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1AIAgent_GetFirstFormDesignCssFromImage.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AIAgent_GetFirstFormDesignCssFromImage.md)]