---
title: POST Agents/AI/GetIndexingStatus
uid: v1AIAgent_GetIndexingStatus
generated: true
content_type: reference
---

# POST Agents/AI/GetIndexingStatus

```http
POST /api/v1/Agents/AI/GetIndexingStatus
```
...
```http
POST /api/v1/Agents/AI/GetIndexingStatus?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1AIAgent_GetIndexingStatus.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AIAgent_GetIndexingStatus.md)]