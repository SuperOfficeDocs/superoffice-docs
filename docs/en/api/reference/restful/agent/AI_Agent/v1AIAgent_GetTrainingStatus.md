...
[!include[sample request](../../samples/agent/request/v1AIAgent_GetTrainingStatus.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AIAgent_GetTrainingStatus.md)]