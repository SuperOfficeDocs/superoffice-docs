---
title: POST Agents/AI/CreateDefaultCopilotDataSourceEntity
uid: v1AIAgent_CreateDefaultCopilotDataSourceEntity
generated: true
content_type: reference
---

# POST Agents/AI/CreateDefaultCopilotDataSourceEntity

```http
POST /api/v1/Agents/AI/CreateDefaultCopilotDataSourceEntity
```
...
[!include[sample request](../../samples/agent/request/v1AIAgent_CreateDefaultCopilotDataSourceEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AIAgent_CreateDefaultCopilotDataSourceEntity.md)]