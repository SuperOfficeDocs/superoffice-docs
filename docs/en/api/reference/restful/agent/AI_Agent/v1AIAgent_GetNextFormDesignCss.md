---
title: POST Agents/AI/GetNextFormDesignCss
uid: v1AIAgent_GetNextFormDesignCss
generated: true
content_type: reference
---

# POST Agents/AI/GetNextFormDesignCss

```http
POST /api/v1/Agents/AI/GetNextFormDesignCss
```
...
```http
POST /api/v1/Agents/AI/GetNextFormDesignCss?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1AIAgent_GetNextFormDesignCss.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AIAgent_GetNextFormDesignCss.md)]