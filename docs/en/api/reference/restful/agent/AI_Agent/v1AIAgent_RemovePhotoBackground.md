---
title: POST Agents/AI/RemovePhotoBackground
uid: v1AIAgent_RemovePhotoBackground
generated: true
content_type: reference
---

# POST Agents/AI/RemovePhotoBackground

```http
POST /api/v1/Agents/AI/RemovePhotoBackground
```

Returns an image with the background removed, leaving only the main subject


NsApiSlow threshold: 10000 ms.
...
```http
POST /api/v1/Agents/AI/RemovePhotoBackground?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1AIAgent_RemovePhotoBackground.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AIAgent_RemovePhotoBackground.md)]