...
Create a VideoMeetingReservation.
...
```http
POST /api/v1/Agents/Appointment/CreateVideoMeetingReservation?$select=name,department,category/id
```
...
### Response body: VideoMeetingReservation
