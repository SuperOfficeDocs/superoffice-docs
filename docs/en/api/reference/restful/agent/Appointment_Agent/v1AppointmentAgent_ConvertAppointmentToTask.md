...
```http
POST /api/v1/Agents/Appointment/ConvertAppointmentToTask?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1AppointmentAgent_ConvertAppointmentToTask.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AppointmentAgent_ConvertAppointmentToTask.md)]