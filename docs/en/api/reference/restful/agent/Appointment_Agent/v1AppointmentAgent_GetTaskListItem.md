...
```http
POST /api/v1/Agents/Appointment/GetTaskListItem?taskListItemId=187
...
[!include[sample request](../../samples/agent/request/v1AppointmentAgent_GetTaskListItem.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AppointmentAgent_GetTaskListItem.md)]