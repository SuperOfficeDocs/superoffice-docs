...
[!include[sample request](../../samples/agent/request/v1AppointmentAgent_GetProjectMemberAppointmentsByTaskHeading.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1AppointmentAgent_GetProjectMemberAppointmentsByTaskHeading.md)]