...
[!include[sample request](../../samples/agent/request/v1ContactAgent_GetDuplicateRules.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ContactAgent_GetDuplicateRules.md)]