...
[!include[sample request](../../samples/agent/request/v1ContactAgent_GetMyBizCard.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ContactAgent_GetMyBizCard.md)]