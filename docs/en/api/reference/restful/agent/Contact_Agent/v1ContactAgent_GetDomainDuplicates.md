...
```http
POST /api/v1/Agents/Contact/GetDomainDuplicates?$select=name,department,category/id
```
...
[
  {
    "RuleName": "McClure, Kozey and Price",
    "SoPrimaryKey": 364,
    "EntryName": "Christiansen Inc and Sons",
    "EntryIdentifier": "veniam",
    "RuleDisplayName": "Skiles-Kuphal",
    "TableRight": null,
    "FieldProperties": {
      "fieldName": {
        "FieldRight": null,
