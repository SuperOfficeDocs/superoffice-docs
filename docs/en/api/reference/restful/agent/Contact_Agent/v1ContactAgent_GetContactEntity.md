...
```http
POST /api/v1/Agents/Contact/GetContactEntity?contactEntityId=434
...
[!include[sample request](../../samples/agent/request/v1ContactAgent_GetContactEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ContactAgent_GetContactEntity.md)]