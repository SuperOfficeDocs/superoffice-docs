...
[!include[sample request](../../samples/agent/request/v1ContactAgent_IsNumberValid.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ContactAgent_IsNumberValid.md)]