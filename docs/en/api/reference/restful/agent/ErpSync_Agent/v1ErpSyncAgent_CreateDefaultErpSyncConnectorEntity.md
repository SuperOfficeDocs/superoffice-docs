...
[!include[sample request](../../samples/agent/request/v1ErpSyncAgent_CreateDefaultErpSyncConnectorEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ErpSyncAgent_CreateDefaultErpSyncConnectorEntity.md)]