...
[!include[sample request](../../samples/agent/request/v1ErpSyncAgent_GetCrmActorType.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ErpSyncAgent_GetCrmActorType.md)]