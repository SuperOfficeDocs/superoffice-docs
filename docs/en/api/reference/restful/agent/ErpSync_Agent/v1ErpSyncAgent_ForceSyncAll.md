...
```http
POST /api/v1/Agents/ErpSync/ForceSyncAll?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ErpSyncAgent_ForceSyncAll.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ErpSyncAgent_ForceSyncAll.md)]