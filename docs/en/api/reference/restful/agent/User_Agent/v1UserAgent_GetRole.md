...
```http
POST /api/v1/Agents/User/GetRole?roleId=450
...
[!include[sample request](../../samples/agent/request/v1UserAgent_GetRole.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1UserAgent_GetRole.md)]