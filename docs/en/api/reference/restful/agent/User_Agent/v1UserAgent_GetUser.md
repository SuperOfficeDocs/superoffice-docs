...
```http
POST /api/v1/Agents/User/GetUser?userId=650
...
[!include[sample request](../../samples/agent/request/v1UserAgent_GetUser.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1UserAgent_GetUser.md)]