...
[!include[sample request](../../samples/agent/request/v1UserAgent_GetAccessToken.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1UserAgent_GetAccessToken.md)]