...
```http
POST /api/v1/Agents/User/GetUserInfo?userInfoId=413
...

{
  ...
  "CanLogon": false,
  "RoleName": "Runolfsdottir LLC",
  "RoleTooltip": "nostrum",
  "UserGroupName": "Osinski-Pacocha",
  "UserGroupTooltip": "tempore",
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
      "FieldRight": null,
