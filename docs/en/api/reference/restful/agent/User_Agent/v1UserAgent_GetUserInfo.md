...
```http
POST /api/v1/Agents/User/GetUserInfo?userInfoId=158
...
[!include[sample request](../../samples/agent/request/v1UserAgent_GetUserInfo.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1UserAgent_GetUserInfo.md)]