...
```http
POST /api/v1/Agents/User/GetUserInfo?userInfoId=314
...

{
  ...
  "CanLogon": true,
  "RoleName": "Stanton-Rippin",
  "RoleTooltip": "voluptates",
  "UserGroupName": "Legros Inc and Sons",
  "UserGroupTooltip": "fugiat",
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
      "FieldRight": null,
