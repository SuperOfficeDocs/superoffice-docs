...
[!include[sample request](../../samples/agent/request/v1UserAgent_CreateUserGroup.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1UserAgent_CreateUserGroup.md)]