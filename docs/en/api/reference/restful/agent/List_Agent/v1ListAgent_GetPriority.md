...
```http
POST /api/v1/Agents/List/GetPriority?priorityId=738
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetPriority.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetPriority.md)]