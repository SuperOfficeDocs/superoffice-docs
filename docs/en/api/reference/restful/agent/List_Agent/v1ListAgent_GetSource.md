...
|----------------|------|--------------|
| sourceId | int32 | **Required** The identifier of the Source object |
| $select | string |  Optional comma separated list of properties to include in the result. Other fields are then nulled out to reduce payload size: "Name,department,category". Default = show all fields. |

```http
POST /api/v1/Agents/List/GetSource?sourceId=265
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetSource.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetSource.md)]