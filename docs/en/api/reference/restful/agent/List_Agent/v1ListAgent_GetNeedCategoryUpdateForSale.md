---
title: POST Agents/List/GetNeedCategoryUpdateForSale
uid: v1ListAgent_GetNeedCategoryUpdateForSale
generated: true
content_type: reference
---

# POST Agents/List/GetNeedCategoryUpdateForSale
...
```http
POST /api/v1/Agents/List/GetNeedCategoryUpdateForSale?$select=name,department,category/id
```
...
SaleStatus, SaleId, ContactId, PersonId 
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetNeedCategoryUpdateForSale.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetNeedCategoryUpdateForSale.md)]