...
```http
POST /api/v1/Agents/List/GetCategory?categoryId=129
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetCategory.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetCategory.md)]