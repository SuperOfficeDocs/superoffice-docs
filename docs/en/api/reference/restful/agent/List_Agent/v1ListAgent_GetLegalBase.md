...
```http
POST /api/v1/Agents/List/GetLegalBase?legalBaseId=349
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetLegalBase.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetLegalBase.md)]