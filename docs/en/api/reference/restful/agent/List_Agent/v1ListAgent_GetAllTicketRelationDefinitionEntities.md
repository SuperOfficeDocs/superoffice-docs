---
title: POST Agents/List/GetAllTicketRelationDefinitionEntities
uid: v1ListAgent_GetAllTicketRelationDefinitionEntities
generated: true
content_type: reference
---

# POST Agents/List/GetAllTicketRelationDefinitionEntities

```http
POST /api/v1/Agents/List/GetAllTicketRelationDefinitionEntities
```
...
```http
POST /api/v1/Agents/List/GetAllTicketRelationDefinitionEntities?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetAllTicketRelationDefinitionEntities.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetAllTicketRelationDefinitionEntities.md)]