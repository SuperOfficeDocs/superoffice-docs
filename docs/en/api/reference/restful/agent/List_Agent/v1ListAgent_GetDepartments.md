...
```http
POST /api/v1/Agents/List/GetDepartments?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetDepartments.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetDepartments.md)]