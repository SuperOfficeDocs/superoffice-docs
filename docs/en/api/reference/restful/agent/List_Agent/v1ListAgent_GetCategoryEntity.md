...
```http
POST /api/v1/Agents/List/GetCategoryEntity?categoryEntityId=548
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetCategoryEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetCategoryEntity.md)]