...
```http
POST /api/v1/Agents/List/DeleteTicketPriorityEntity?ticketPriorityEntityId=158
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_DeleteTicketPriorityEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_DeleteTicketPriorityEntity.md)]