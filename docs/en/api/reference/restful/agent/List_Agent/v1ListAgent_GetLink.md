...
```http
POST /api/v1/Agents/List/GetLink?linkId=172
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetLink.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetLink.md)]