...
```http
POST /api/v1/Agents/List/GetCountry?countryId=115
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetCountry.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetCountry.md)]