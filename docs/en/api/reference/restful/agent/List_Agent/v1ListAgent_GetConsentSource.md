...
```http
POST /api/v1/Agents/List/GetConsentSource?consentSourceId=926
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetConsentSource.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetConsentSource.md)]