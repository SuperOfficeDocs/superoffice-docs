...
```http
POST /api/v1/Agents/List/DeleteTicketTypeEntity?ticketTypeEntityId=929
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_DeleteTicketTypeEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_DeleteTicketTypeEntity.md)]