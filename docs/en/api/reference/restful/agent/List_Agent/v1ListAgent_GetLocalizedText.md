...
```http
POST /api/v1/Agents/List/GetLocalizedText?localizedTextId=1002
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetLocalizedText.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetLocalizedText.md)]