...
```http
POST /api/v1/Agents/List/GetBusiness?businessId=632
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetBusiness.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetBusiness.md)]