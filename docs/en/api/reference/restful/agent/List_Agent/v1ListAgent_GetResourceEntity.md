...
```http
POST /api/v1/Agents/List/GetResourceEntity?resourceEntityId=631
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetResourceEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetResourceEntity.md)]