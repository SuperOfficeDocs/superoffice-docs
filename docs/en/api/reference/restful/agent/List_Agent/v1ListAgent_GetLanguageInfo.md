...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=297
...

{
  "LanguageInfoId": 117,
  "LCID": 824,
  "EnglishName": "Keebler Group",
  "NativeName": "Yost, Cormier and Gleason",
  "ThreeLetterISOLanguageName": "Mills Inc and Sons",
  "TwoLetterISOLanguageName": "Bednar, Reichel and Ziemann",
  "IsBuiltIn": true,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
