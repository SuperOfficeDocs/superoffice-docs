...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=726
...

{
  "LanguageInfoId": 70,
  "LCID": 783,
  "EnglishName": "Buckridge, Wiza and Wisoky",
  "NativeName": "Raynor LLC",
  "ThreeLetterISOLanguageName": "Schuster, Will and Collins",
  "TwoLetterISOLanguageName": "Toy, Jakubowski and Will",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
