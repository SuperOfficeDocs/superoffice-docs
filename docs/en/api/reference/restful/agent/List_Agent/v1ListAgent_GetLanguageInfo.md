...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=378
...

{
  "LanguageInfoId": 408,
  "LCID": 709,
  "EnglishName": "Weimann-Block",
  "NativeName": "Reichel, Satterfield and Hansen",
  "ThreeLetterISOLanguageName": "Simonis-Bogan",
  "TwoLetterISOLanguageName": "Cole-Jacobson",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
