...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=105
...

{
  "LanguageInfoId": 733,
  "LCID": 688,
  "EnglishName": "Graham, Erdman and Turcotte",
  "NativeName": "Kutch Inc and Sons",
  "ThreeLetterISOLanguageName": "Anderson Inc and Sons",
  "TwoLetterISOLanguageName": "Raynor Group",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
