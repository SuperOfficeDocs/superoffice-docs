...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=967
...

{
  "LanguageInfoId": 947,
  "LCID": 818,
  "EnglishName": "Cummings-Lakin",
  "NativeName": "Pacocha-Zemlak",
  "ThreeLetterISOLanguageName": "Hayes-Kuhn",
  "TwoLetterISOLanguageName": "Wilkinson-Auer",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
