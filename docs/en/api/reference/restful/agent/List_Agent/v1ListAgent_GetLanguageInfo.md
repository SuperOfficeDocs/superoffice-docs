...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=755
...

{
  "LanguageInfoId": 372,
  "LCID": 15,
  "EnglishName": "Kuvalis-Ortiz",
  "NativeName": "Brown Inc and Sons",
  "ThreeLetterISOLanguageName": "Turner Group",
  "TwoLetterISOLanguageName": "Gutmann-Reinger",
  "IsBuiltIn": true,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
