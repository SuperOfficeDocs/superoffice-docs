...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=919
...

{
  "LanguageInfoId": 613,
  "LCID": 901,
  "EnglishName": "Jacobi, Abshire and Williamson",
  "NativeName": "Ullrich LLC",
  "ThreeLetterISOLanguageName": "Hegmann LLC",
  "TwoLetterISOLanguageName": "Ledner-Rippin",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
