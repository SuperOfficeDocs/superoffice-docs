...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=553
...

{
  ...
  "NativeName": "Shanahan-Bednar",
  "ThreeLetterISOLanguageName": "Crist-Carroll",
  "TwoLetterISOLanguageName": "Schuster, Lueilwitz and Kreiger",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
