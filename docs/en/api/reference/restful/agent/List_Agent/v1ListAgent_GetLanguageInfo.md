...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=358
...

{
  "LanguageInfoId": 342,
  "LCID": 100,
  "EnglishName": "Wolff, Shields and Gerlach",
  "NativeName": "Dare LLC",
  "ThreeLetterISOLanguageName": "Steuber Inc and Sons",
  "TwoLetterISOLanguageName": "Stehr Group",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
