...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=926
...

{
  "LanguageInfoId": 929,
  "LCID": 871,
  "EnglishName": "Pacocha Inc and Sons",
  "NativeName": "Ankunding Inc and Sons",
  "ThreeLetterISOLanguageName": "Blanda-Emard",
  "TwoLetterISOLanguageName": "Little LLC",
  "IsBuiltIn": true,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
