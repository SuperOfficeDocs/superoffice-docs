...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=303
...

{
  "LanguageInfoId": 246,
  "LCID": 981,
  "EnglishName": "Ondricka Group",
  "NativeName": "Kshlerin-Brekke",
  "ThreeLetterISOLanguageName": "Johnson, Powlowski and Hermiston",
  "TwoLetterISOLanguageName": "Cummings-Schuppe",
  "IsBuiltIn": true,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
