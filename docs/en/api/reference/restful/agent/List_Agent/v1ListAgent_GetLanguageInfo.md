...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=270
...

{
  "LanguageInfoId": 792,
  "LCID": 131,
  "EnglishName": "Windler Inc and Sons",
  "NativeName": "Berge-Schowalter",
  "ThreeLetterISOLanguageName": "Christiansen Inc and Sons",
  "TwoLetterISOLanguageName": "Kirlin, Lynch and Herman",
  "IsBuiltIn": false,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
