...
```http
POST /api/v1/Agents/List/GetLanguageInfo?languageInfoId=827
...

{
  "LanguageInfoId": 267,
  "LCID": 243,
  "EnglishName": "Weber-Nicolas",
  "NativeName": "Crona-Erdman",
  "ThreeLetterISOLanguageName": "Waters LLC",
  "TwoLetterISOLanguageName": "Reichert Group",
  "IsBuiltIn": true,
  "TableRight": null,
  "FieldProperties": {
    "fieldName": {
