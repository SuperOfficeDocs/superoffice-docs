---
title: POST Agents/List/GetAllAutomatedCategoryUpdates
uid: v1ListAgent_GetAllAutomatedCategoryUpdates
generated: true
content_type: reference
---

# POST Agents/List/GetAllAutomatedCategoryUpdates

```http
POST /api/v1/Agents/List/GetAllAutomatedCategoryUpdates
```
...
```http
POST /api/v1/Agents/List/GetAllAutomatedCategoryUpdates?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetAllAutomatedCategoryUpdates.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetAllAutomatedCategoryUpdates.md)]