...
```http
POST /api/v1/Agents/List/GetTicketTypeList?$select=name,department,category/id
```
...
[
  {
    "TicketTypeId": 968,
    "Name": "Kassulke, Altenwerth and Murphy",
    "Rank": 323,
    "Tooltip": "quisquam",
    "Icon": "quos",
    "DefaultTicketStatus": 753,
    "TicketStatuses": [
      189,
      233
    ],
    "DefaultTicketPriority": 754,
    "TicketPriorities": [
      318,
      149
    ],
