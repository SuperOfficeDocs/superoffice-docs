...
```http
POST /api/v1/Agents/List/GetQuoteApproveReason?quoteApproveReasonId=239
...
### Response body: QuoteApproveReason
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetQuoteApproveReason.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetQuoteApproveReason.md)]