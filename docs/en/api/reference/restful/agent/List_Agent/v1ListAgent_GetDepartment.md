...
|----------------|------|--------------|
| departmentId | int32 | **Required** The identifier of the Department object |
| $select | string |  Optional comma separated list of properties to include in the result. Other fields are then nulled out to reduce payload size: "Name,department,category". Default = show all fields. |

```http
POST /api/v1/Agents/List/GetDepartment?departmentId=144
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetDepartment.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetDepartment.md)]