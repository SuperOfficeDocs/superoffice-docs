...
```http
POST /api/v1/Agents/List/GetCompetitor?competitorId=368
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetCompetitor.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetCompetitor.md)]