...
```http
POST /api/v1/Agents/List/GetDeliveryTerm?deliveryTermId=907
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetDeliveryTerm.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetDeliveryTerm.md)]