...
|----------------|------|--------------|
| customerLanguageId | int32 | **Required** The identifier of the CustomerLanguage object |
| $select | string |  Optional comma separated list of properties to include in the result. Other fields are then nulled out to reduce payload size: "Name,department,category". Default = show all fields. |

```http
POST /api/v1/Agents/List/GetCustomerLanguage?customerLanguageId=516
...
### Response body: CustomerLanguage
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetCustomerLanguage.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetCustomerLanguage.md)]