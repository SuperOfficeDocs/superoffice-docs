...
```http
POST /api/v1/Agents/List/GetTaskMenu?taskMenuId=913
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetTaskMenu.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetTaskMenu.md)]