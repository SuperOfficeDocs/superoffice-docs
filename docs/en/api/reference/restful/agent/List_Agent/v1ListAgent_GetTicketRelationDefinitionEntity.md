---
title: POST Agents/List/GetTicketRelationDefinitionEntity
uid: v1ListAgent_GetTicketRelationDefinitionEntity
generated: true
content_type: reference
---

# POST Agents/List/GetTicketRelationDefinitionEntity

```http
POST /api/v1/Agents/List/GetTicketRelationDefinitionEntity
```
...
|----------------|------|--------------|
| ticketRelationDefinitionEntityId | int32 | **Required** The identifier of the TicketRelationDefinitionEntity object |
| $select | string |  Optional comma separated list of properties to include in the result. Other fields are then nulled out to reduce payload size: "Name,department,category". Default = show all fields. |

```http
POST /api/v1/Agents/List/GetTicketRelationDefinitionEntity?ticketRelationDefinitionEntityId=671
POST /api/v1/Agents/List/GetTicketRelationDefinitionEntity?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetTicketRelationDefinitionEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetTicketRelationDefinitionEntity.md)]