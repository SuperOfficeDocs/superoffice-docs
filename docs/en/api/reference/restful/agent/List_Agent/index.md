...
* [POST Agents/List/GetTicketCategoriesForUserGroups](v1ListAgent_GetTicketCategoriesForUserGroups.md)

* [POST Agents/List/SetTicketCategoriesForUserGroup](v1ListAgent_SetTicketCategoriesForUserGroup.md)

* [POST Agents/List/UpdateCategoryMemberships](v1ListAgent_UpdateCategoryMemberships.md)
...
* [POST Agents/List/GetAllTicketRelationDefinitionEntities](v1ListAgent_GetAllTicketRelationDefinitionEntities.md)
...
* [POST Agents/List/GlobalChangeTicketStatus](v1ListAgent_GlobalChangeTicketStatus.md)

* [POST Agents/List/SetTicketStatusSortOrder](v1ListAgent_SetTicketStatusSortOrder.md)

* [POST Agents/List/GetTicketStatusList](v1ListAgent_GetTicketStatusList.md)
...
* [POST Agents/List/SetTicketTypeSortOrder](v1ListAgent_SetTicketTypeSortOrder.md)
...
* [POST Agents/List/GetWebPanelList](v1ListAgent_GetWebPanelList.md)

* [POST Agents/List/DeleteWebPanel](v1ListAgent_DeleteWebPanel.md)

* [POST Agents/List/GetAppWebPanels](v1ListAgent_GetAppWebPanels.md)
...
* [POST Agents/List/GetProductFamilies](v1ListAgent_GetProductFamilies.md)

* [POST Agents/List/GetProductType](v1ListAgent_GetProductType.md)

* [POST Agents/List/GetProductTypes](v1ListAgent_GetProductTypes.md)

* [POST Agents/List/GetProjectStatus](v1ListAgent_GetProjectStatus.md)

* [POST Agents/List/DeleteProjectStatus](v1ListAgent_DeleteProjectStatus.md)

* [POST Agents/List/GetProjectStatusList](v1ListAgent_GetProjectStatusList.md)
...
* [POST Agents/List/GetProjectTypeList](v1ListAgent_GetProjectTypeList.md)

* [POST Agents/List/GetProjectTypes](v1ListAgent_GetProjectTypes.md)

* [POST Agents/List/SaveQuickReplies](v1ListAgent_SaveQuickReplies.md)

* [POST Agents/List/GetQuickReplies](v1ListAgent_GetQuickReplies.md)

* [POST Agents/List/GetRating](v1ListAgent_GetRating.md)

* [POST Agents/List/GetRatingList](v1ListAgent_GetRatingList.md)

* [POST Agents/List/GetRatings](v1ListAgent_GetRatings.md)

* [POST Agents/List/GetAllSaleStages](v1ListAgent_GetAllSaleStages.md)

* [POST Agents/List/GetReason](v1ListAgent_GetReason.md)

* [POST Agents/List/GetReasonList](v1ListAgent_GetReasonList.md)

* [POST Agents/List/GetReasons](v1ListAgent_GetReasons.md)

* [POST Agents/List/GetQuoteApproveReason](v1ListAgent_GetQuoteApproveReason.md)

* [POST Agents/List/GetQuoteApproveReasonList](v1ListAgent_GetQuoteApproveReasonList.md)

* [POST Agents/List/GetQuoteApproveReasons](v1ListAgent_GetQuoteApproveReasons.md)

* [POST Agents/List/GetQuoteDenyReason](v1ListAgent_GetQuoteDenyReason.md)

* [POST Agents/List/GetQuoteDenyReasonList](v1ListAgent_GetQuoteDenyReasonList.md)

* [POST Agents/List/GetQuoteDenyReasons](v1ListAgent_GetQuoteDenyReasons.md)

* [POST Agents/List/GetReasonSold](v1ListAgent_GetReasonSold.md)
...
* [POST Agents/List/GetSaleTypeList](v1ListAgent_GetSaleTypeList.md)

* [POST Agents/List/GetAllSaleType](v1ListAgent_GetAllSaleType.md)

* [POST Agents/List/GetAllSaleTypeEntities](v1ListAgent_GetAllSaleTypeEntities.md)

* [POST Agents/List/GetSelectionCategory](v1ListAgent_GetSelectionCategory.md)
...
* [POST Agents/List/SetVisibleForUserGroupsFromListName](v1ListAgent_SetVisibleForUserGroupsFromListName.md)

* [POST Agents/List/SetVisibleForUserGroup](v1ListAgent_SetVisibleForUserGroup.md)

* [POST Agents/List/GetListItemsForUserGroup](v1ListAgent_GetListItemsForUserGroup.md)

* [POST Agents/List/GetListItemsForUserGroupFromListName](v1ListAgent_GetListItemsForUserGroupFromListName.md)

* [POST Agents/List/SetListItemsForUserGroup](v1ListAgent_SetListItemsForUserGroup.md)

* [POST Agents/List/SetListItemsForUserGroupFromListName](v1ListAgent_SetListItemsForUserGroupFromListName.md)

* [POST Agents/List/GetHeadings](v1ListAgent_GetHeadings.md)

* [POST Agents/List/GetHeadingsForListItemFromListName](v1ListAgent_GetHeadingsForListItemFromListName.md)

* [POST Agents/List/SaveHeadingsForListItemFromListDefinition](v1ListAgent_SaveHeadingsForListItemFromListDefinition.md)

* [POST Agents/List/SaveHeadingsForListItemFromListName](v1ListAgent_SaveHeadingsForListItemFromListName.md)

* [POST Agents/List/GetListItemsForHeading](v1ListAgent_GetListItemsForHeading.md)

* [POST Agents/List/GetListItemsForHeadingFromListName](v1ListAgent_GetListItemsForHeadingFromListName.md)

* [POST Agents/List/SetListItemsForHeading](v1ListAgent_SetListItemsForHeading.md)

* [POST Agents/List/SetListItemsForHeadingFromListName](v1ListAgent_SetListItemsForHeadingFromListName.md)

* [POST Agents/List/SetHeadingsForListItem](v1ListAgent_SetHeadingsForListItem.md)

* [POST Agents/List/SetRankOnHeadings](v1ListAgent_SetRankOnHeadings.md)

* [POST Agents/List/SetRankOnSaleActivity](v1ListAgent_SetRankOnSaleActivity.md)

* [POST Agents/List/SetRankOnSaleDocument](v1ListAgent_SetRankOnSaleDocument.md)

* [POST Agents/List/SetRankOnProjectActivity](v1ListAgent_SetRankOnProjectActivity.md)

* [POST Agents/List/SetRankOnProjectDocument](v1ListAgent_SetRankOnProjectDocument.md)

* [POST Agents/List/GetAllFromListDefinition](v1ListAgent_GetAllFromListDefinition.md)

* [POST Agents/List/GetAllFromListName](v1ListAgent_GetAllFromListName.md)

* [POST Agents/List/SaveAllFromListDefinition](v1ListAgent_SaveAllFromListDefinition.md)

* [POST Agents/List/SaveAllFromListName](v1ListAgent_SaveAllFromListName.md)

* [POST Agents/List/AddFromListDefinition](v1ListAgent_AddFromListDefinition.md)

* [POST Agents/List/AddFromListName](v1ListAgent_AddFromListName.md)

* [POST Agents/List/DeleteAllFromListDefinition](v1ListAgent_DeleteAllFromListDefinition.md)

* [POST Agents/List/DeleteAllFromListName](v1ListAgent_DeleteAllFromListName.md)

* [POST Agents/List/GetFromListDefinition](v1ListAgent_GetFromListDefinition.md)

* [POST Agents/List/GetFromListName](v1ListAgent_GetFromListName.md)

* [POST Agents/List/SaveFromListDefinition](v1ListAgent_SaveFromListDefinition.md)

* [POST Agents/List/SaveFromListName](v1ListAgent_SaveFromListName.md)

* [POST Agents/List/DeleteFromListDefinition](v1ListAgent_DeleteFromListDefinition.md)

* [POST Agents/List/DeleteFromListName](v1ListAgent_DeleteFromListName.md)

* [POST Agents/List/GetHeadingsFromName](v1ListAgent_GetHeadingsFromName.md)

* [POST Agents/List/GetHeadingsFromListDefinition](v1ListAgent_GetHeadingsFromListDefinition.md)

* [POST Agents/List/SaveHeadingsFromName](v1ListAgent_SaveHeadingsFromName.md)

* [POST Agents/List/SaveHeadingsFromListDefinition](v1ListAgent_SaveHeadingsFromListDefinition.md)

* [POST Agents/List/SaveHeadingFromName](v1ListAgent_SaveHeadingFromName.md)

* [POST Agents/List/SaveHeadingFromListDefinition](v1ListAgent_SaveHeadingFromListDefinition.md)

* [POST Agents/List/DeleteAllHeadingsFromName](v1ListAgent_DeleteAllHeadingsFromName.md)

* [POST Agents/List/DeleteAllHeadingsFromListDefinition](v1ListAgent_DeleteAllHeadingsFromListDefinition.md)
...
* [POST Agents/List/SetDocumentTemplateStream](v1ListAgent_SetDocumentTemplateStream.md)

* [POST Agents/List/GetDocumentTemplateUsedInSalesStage](v1ListAgent_GetDocumentTemplateUsedInSalesStage.md)

* [POST Agents/List/GetDocumentTemplateUsedInProjectStage](v1ListAgent_GetDocumentTemplateUsedInProjectStage.md)

* [POST Agents/List/GetDocumentTemplateUrl](v1ListAgent_GetDocumentTemplateUrl.md)

* [POST Agents/List/GetDocumentTemplateProperties](v1ListAgent_GetDocumentTemplateProperties.md)

* [POST Agents/List/GetDocumentTemplateLanguages](v1ListAgent_GetDocumentTemplateLanguages.md)

* [POST Agents/List/CreateDefaultDocumentTemplateLanguage](v1ListAgent_CreateDefaultDocumentTemplateLanguage.md)

* [POST Agents/List/DeleteDocumentTemplateLanguage](v1ListAgent_DeleteDocumentTemplateLanguage.md)

* [POST Agents/List/GetDocumentTemplateExtension](v1ListAgent_GetDocumentTemplateExtension.md)

* [POST Agents/List/SetDocumentTemplateFromDocumentTemplate](v1ListAgent_SetDocumentTemplateFromDocumentTemplate.md)

* [POST Agents/List/GetDocumentTemplateStreamFromId](v1ListAgent_GetDocumentTemplateStreamFromId.md)

* [POST Agents/List/SaveDocumentTemplateStream](v1ListAgent_SaveDocumentTemplateStream.md)

* [POST Agents/List/GetPluginList](v1ListAgent_GetPluginList.md)

* [POST Agents/List/GetPluginCapabilities](v1ListAgent_GetPluginCapabilities.md)

* [POST Agents/List/GetDocumentTypesForPlugin](v1ListAgent_GetDocumentTypesForPlugin.md)

* [POST Agents/List/GetDocumentTemplateList](v1ListAgent_GetDocumentTemplateList.md)

* [POST Agents/List/GetDocumentTemplates](v1ListAgent_GetDocumentTemplates.md)

* [POST Agents/List/GetAllDocumentTemplates](v1ListAgent_GetAllDocumentTemplates.md)
...
* [POST Agents/List/GetAllDomains](v1ListAgent_GetAllDomains.md)

* [POST Agents/List/GetAllInDomain](v1ListAgent_GetAllInDomain.md)

* [POST Agents/List/GetHierarchyFromPath](v1ListAgent_GetHierarchyFromPath.md)

* [POST Agents/List/AddHierarchyToPath](v1ListAgent_AddHierarchyToPath.md)
...
* [POST Agents/List/SaveListEntity](v1ListAgent_SaveListEntity.md)
...
* [POST Agents/List/GetBusinesses](v1ListAgent_GetBusinesses.md)
...
* [POST Agents/List/GetCompetitor](v1ListAgent_GetCompetitor.md)
