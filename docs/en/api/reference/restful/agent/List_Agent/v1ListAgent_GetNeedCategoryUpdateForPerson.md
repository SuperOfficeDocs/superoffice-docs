---
title: POST Agents/List/GetNeedCategoryUpdateForPerson
uid: v1ListAgent_GetNeedCategoryUpdateForPerson
generated: true
content_type: reference
---

# POST Agents/List/GetNeedCategoryUpdateForPerson
...
```http
POST /api/v1/Agents/List/GetNeedCategoryUpdateForPerson?$select=name,department,category/id
```
...
LeadStatus, PersonId, ContactId, CategoryId 
...
### Response body: AutomatedCategoryUpdate
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetNeedCategoryUpdateForPerson.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetNeedCategoryUpdateForPerson.md)]