...
```http
POST /api/v1/Agents/List/GetCredited?creditedId=808
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetCredited.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetCredited.md)]