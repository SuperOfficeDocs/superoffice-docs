...
```http
POST /api/v1/Agents/List/DeleteTaskMenu?taskMenuId=115
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_DeleteTaskMenu.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_DeleteTaskMenu.md)]