...
```http
POST /api/v1/Agents/List/GetProductType?productTypeId=150
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetProductType.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetProductType.md)]