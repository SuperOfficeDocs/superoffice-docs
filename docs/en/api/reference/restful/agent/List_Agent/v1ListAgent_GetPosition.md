...
```http
POST /api/v1/Agents/List/GetPosition?positionId=516
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetPosition.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetPosition.md)]