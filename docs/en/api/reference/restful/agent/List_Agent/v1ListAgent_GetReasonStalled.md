...
```http
POST /api/v1/Agents/List/GetReasonStalled?reasonStalledId=215
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetReasonStalled.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetReasonStalled.md)]