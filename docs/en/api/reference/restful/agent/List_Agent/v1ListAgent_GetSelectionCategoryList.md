...
```http
POST /api/v1/Agents/List/GetSelectionCategoryList?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetSelectionCategoryList.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetSelectionCategoryList.md)]