...
```http
POST /api/v1/Agents/List/GetReasonStalledList?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetReasonStalledList.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetReasonStalledList.md)]