...
```http
POST /api/v1/Agents/List/GetProductCategory?productCategoryId=531
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetProductCategory.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetProductCategory.md)]