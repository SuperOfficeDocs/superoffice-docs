...
```http
POST /api/v1/Agents/List/GetPaymentType?paymentTypeId=833
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetPaymentType.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetPaymentType.md)]