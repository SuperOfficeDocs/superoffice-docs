...
```http
POST /api/v1/Agents/List/GetProductFamily?productFamilyId=480
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetProductFamily.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetProductFamily.md)]