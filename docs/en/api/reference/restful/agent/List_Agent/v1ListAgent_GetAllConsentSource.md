---
title: POST Agents/List/GetAllConsentSource
uid: v1ListAgent_GetAllConsentSource
generated: true
content_type: reference
---

# POST Agents/List/GetAllConsentSource
...
```http
POST /api/v1/Agents/List/GetAllConsentSource?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ListAgent_GetAllConsentSource.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ListAgent_GetAllConsentSource.md)]