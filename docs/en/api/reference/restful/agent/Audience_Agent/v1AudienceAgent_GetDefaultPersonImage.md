...
uid: v1AudienceAgent_GetDefaultPersonImage
generated: true
---
...
Returns the default person (sales rep) image that is displayed in Audience when no person image is found.
...
{
  "LayoutName": "Oberbrunner, Auer and Christiansen"
}
```
