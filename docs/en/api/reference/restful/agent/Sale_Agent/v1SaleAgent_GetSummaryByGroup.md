...
[!include[sample request](../../samples/agent/request/v1SaleAgent_GetSummaryByGroup.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1SaleAgent_GetSummaryByGroup.md)]