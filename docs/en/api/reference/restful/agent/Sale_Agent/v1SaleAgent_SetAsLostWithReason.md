...
[!include[sample request](../../samples/agent/request/v1SaleAgent_SetAsLostWithReason.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1SaleAgent_SetAsLostWithReason.md)]