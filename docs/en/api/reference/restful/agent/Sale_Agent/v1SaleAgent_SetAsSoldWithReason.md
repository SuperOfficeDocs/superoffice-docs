...
[!include[sample request](../../samples/agent/request/v1SaleAgent_SetAsSoldWithReason.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1SaleAgent_SetAsSoldWithReason.md)]