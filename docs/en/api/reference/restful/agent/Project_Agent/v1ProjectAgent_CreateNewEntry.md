...
|----------------|------|--------------|
| Duplicate | DuplicateEntry | A duplicate entry <para /> Carrier object for DuplicateEntry. |
...
[!include[sample request](../../samples/agent/request/v1ProjectAgent_CreateNewEntry.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ProjectAgent_CreateNewEntry.md)]