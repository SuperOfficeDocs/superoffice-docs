---
title: POST Agents/Project/SaveProjectEntityWithoutMembers
uid: v1ProjectAgent_SaveProjectEntityWithoutMembers
generated: true
content_type: reference
---

# POST Agents/Project/SaveProjectEntityWithoutMembers

```http
POST /api/v1/Agents/Project/SaveProjectEntityWithoutMembers
```
...
```http
POST /api/v1/Agents/Project/SaveProjectEntityWithoutMembers?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1ProjectAgent_SaveProjectEntityWithoutMembers.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1ProjectAgent_SaveProjectEntityWithoutMembers.md)]