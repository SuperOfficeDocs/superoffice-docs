...
[!include[sample request](../../samples/agent/request/v1NumberAllocationAgent_SaveRefCountEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1NumberAllocationAgent_SaveRefCountEntity.md)]