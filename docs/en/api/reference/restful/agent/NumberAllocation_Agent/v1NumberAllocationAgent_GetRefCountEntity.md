...
```http
POST /api/v1/Agents/NumberAllocation/GetRefCountEntity?refCountEntityId=244
...
[!include[sample request](../../samples/agent/request/v1NumberAllocationAgent_GetRefCountEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1NumberAllocationAgent_GetRefCountEntity.md)]