...
```http
POST /api/v1/Agents/NumberAllocation/GetRefCountEntity?refCountEntityId=613
  ...
  "SuggestedRecords": [
    {
      "Id": 639,
      "Name": "Nikolaus Group",
      "ToolTip": "Atque nisi quia assumenda assumenda consequatur.",
      "Deleted": true,
      "Rank": 507,
      "Type": "dolorum",
      "ChildItems": [
