...
```http
POST /api/v1/Agents/NumberAllocation/GetRefCountEntity?refCountEntityId=143
...

{
  ...
  "SuggestedRecords": [
    {
      "Id": 42,
      "Name": "Crona, Swaniawski and Treutel",
      "ToolTip": "Dolore sit voluptatum cum in.",
      "Deleted": true,
      "Rank": 873,
      "Type": "ea",
      "ChildItems": [
