...
[!include[sample request](../../samples/agent/request/v1SaintAgent_GetSaintConfigurations.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1SaintAgent_GetSaintConfigurations.md)]