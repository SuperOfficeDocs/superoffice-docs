...
```http
POST /api/v1/Agents/Document/GetDocument?documentId=323
...
[!include[sample request](../../samples/agent/request/v1DocumentAgent_GetDocument.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1DocumentAgent_GetDocument.md)]