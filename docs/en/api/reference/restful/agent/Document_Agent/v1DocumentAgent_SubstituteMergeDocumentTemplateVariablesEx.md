...
[!include[sample request](../../samples/agent/request/v1DocumentAgent_SubstituteMergeDocumentTemplateVariablesEx.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1DocumentAgent_SubstituteMergeDocumentTemplateVariablesEx.md)]