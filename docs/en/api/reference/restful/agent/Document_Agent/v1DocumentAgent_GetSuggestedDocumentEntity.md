...
```http
POST /api/v1/Agents/Document/GetSuggestedDocumentEntity?suggestedDocumentEntityId=442
...
[!include[sample request](../../samples/agent/request/v1DocumentAgent_GetSuggestedDocumentEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1DocumentAgent_GetSuggestedDocumentEntity.md)]