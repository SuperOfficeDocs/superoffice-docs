...
```http
POST /api/v1/Agents/Report/GetReportLabelLayoutEntity?reportLabelLayoutEntityId=971
...
{
  "ReportLabelLayoutId": 965,
  "Name": "Herman-Skiles",
  "Description": "Business-focused empowering migration",
