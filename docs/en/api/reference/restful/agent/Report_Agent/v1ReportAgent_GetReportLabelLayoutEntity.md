...
```http
POST /api/v1/Agents/Report/GetReportLabelLayoutEntity?reportLabelLayoutEntityId=685
...
{
  "ReportLabelLayoutId": 270,
  "Name": "Beer, Gorczany and Paucek",
  "Description": "Versatile zero tolerance capability",
