...
```http
POST /api/v1/Agents/Report/GetReportLabelLayoutEntity?reportLabelLayoutEntityId=157
...
{
  "ReportLabelLayoutId": 455,
  "Name": "Torphy-Harber",
  "Description": "User-friendly attitude-oriented leverage",
