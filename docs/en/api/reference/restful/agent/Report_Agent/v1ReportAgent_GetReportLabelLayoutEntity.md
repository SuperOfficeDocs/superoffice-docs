...
```http
POST /api/v1/Agents/Report/GetReportLabelLayoutEntity?reportLabelLayoutEntityId=835
...
{
  "ReportLabelLayoutId": 10,
  "Name": "DuBuque, Carter and Grimes",
  "Description": "Reverse-engineered foreground emulation",
