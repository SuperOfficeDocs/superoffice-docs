...
```http
POST /api/v1/Agents/Report/GetReportLabelLayoutEntity?reportLabelLayoutEntityId=407
...
{
  "ReportLabelLayoutId": 229,
  "Name": "Feeney-Bernhard",
  "Description": "Mandatory system-worthy moderator",
