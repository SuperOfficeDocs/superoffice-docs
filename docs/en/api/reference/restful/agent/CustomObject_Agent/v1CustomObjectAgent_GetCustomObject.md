---
title: POST Agents/CustomObject/GetCustomObject
uid: v1CustomObjectAgent_GetCustomObject
generated: true
content_type: reference
---

# POST Agents/CustomObject/GetCustomObject

```http
POST /api/v1/Agents/CustomObject/GetCustomObject
```
...
```http
POST /api/v1/Agents/CustomObject/GetCustomObject?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1CustomObjectAgent_GetCustomObject.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1CustomObjectAgent_GetCustomObject.md)]