...
```http
POST /api/v1/Agents/Workflow/GetWorkflowWaitForAction?workflowWaitForActionId=833
...

{
  ...
  "RestrictionGroups": [
    {
      "Name": "Stroman, Kerluke and Kub",
      "Description": "Re-contextualized background secured line",
      "Rank": 175,
      "Restrictions": [
        {},
        {}
