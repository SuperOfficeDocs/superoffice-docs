...
Copy smessage and connected shipment to the email flow.
...
```http
POST /api/v1/Agents/Workflow/CopyEmailFlowContent?$select=name,department,category/id
```
