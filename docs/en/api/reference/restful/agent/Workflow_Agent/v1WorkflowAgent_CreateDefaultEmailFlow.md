...
[!include[sample request](../../samples/agent/request/v1WorkflowAgent_CreateDefaultEmailFlow.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1WorkflowAgent_CreateDefaultEmailFlow.md)]