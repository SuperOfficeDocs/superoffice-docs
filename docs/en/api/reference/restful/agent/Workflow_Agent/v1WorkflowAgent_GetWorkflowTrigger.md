...
```http
POST /api/v1/Agents/Workflow/GetWorkflowTrigger?workflowTriggerId=665
...
{
  "WorkflowTriggerId": 582,
  "WorkflowId": 440,
  "TriggerType": "AddedMessage",
  "RestrictionGroups": [
    {
      "Name": "Grant, Nienow and Homenick",
      "Description": "Distributed interactive superstructure",
      "Rank": 266,
      "Restrictions": [
        {},
        {}
