...
```http
POST /api/v1/Agents/Workflow/GetWorkflowTrigger?workflowTriggerId=175
...
{
  "WorkflowTriggerId": 924,
  "WorkflowId": 4,
  "TriggerType": "AddedMessage",
  "RestrictionGroups": [
    {
      "Name": "Hilll-Cartwright",
      "Description": "Monitored 4th generation portal",
      "Rank": 143,
      "Restrictions": [
        {},
        {}
