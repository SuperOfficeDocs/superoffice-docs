...
```http
POST /api/v1/Agents/Workflow/GetWorkflowTrigger?workflowTriggerId=409
...
{
  "WorkflowTriggerId": 983,
  "WorkflowId": 874,
  "TriggerType": "AddedMessage",
  "RestrictionGroups": [
    {
      "Name": "Gorczany, Heaney and Pfeffer",
      "Description": "Monitored motivating middleware",
      "Rank": 408,
      "Restrictions": [
        {},
        {}
