...
```http
POST /api/v1/Agents/Workflow/GetWorkflowTrigger?workflowTriggerId=833
...
{
  "WorkflowTriggerId": 744,
  "WorkflowId": 865,
  "TriggerType": "AddedMessage",
  "RestrictionGroups": [
    {
      "Name": "Dicki-Kertzmann",
      "Description": "Future-proofed encompassing encoding",
      "Rank": 618,
      "Restrictions": [
        {},
        {}
