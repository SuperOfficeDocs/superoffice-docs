...
```http
POST /api/v1/Agents/Workflow/GetEmailFlow?emailFlowId=983
...
[!include[sample request](../../samples/agent/request/v1WorkflowAgent_GetEmailFlow.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1WorkflowAgent_GetEmailFlow.md)]