...
```http
POST /api/v1/Agents/Workflow/UpdateFormSubmissions?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1WorkflowAgent_UpdateFormSubmissions.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1WorkflowAgent_UpdateFormSubmissions.md)]