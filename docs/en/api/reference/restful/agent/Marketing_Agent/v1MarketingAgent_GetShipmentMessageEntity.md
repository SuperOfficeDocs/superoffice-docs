...
```http
POST /api/v1/Agents/Marketing/GetShipmentMessageEntity?shipmentMessageEntityId=297
...
[!include[sample request](../../samples/agent/request/v1MarketingAgent_GetShipmentMessageEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1MarketingAgent_GetShipmentMessageEntity.md)]