...
```http
POST /api/v1/Agents/Marketing/DeleteFormEntity?formEntityId=595
```
...
[!include[sample request](../../samples/agent/request/v1MarketingAgent_DeleteFormEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1MarketingAgent_DeleteFormEntity.md)]