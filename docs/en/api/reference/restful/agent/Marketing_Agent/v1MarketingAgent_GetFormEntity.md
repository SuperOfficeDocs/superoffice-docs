...
```http
POST /api/v1/Agents/Marketing/GetFormEntity?formEntityId=550
...
[!include[sample request](../../samples/agent/request/v1MarketingAgent_GetFormEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1MarketingAgent_GetFormEntity.md)]