...
```http
POST /api/v1/Agents/Marketing/DeleteShipmentMessageBlockEntity?shipmentMessageBlockEntityId=234
```
...
[!include[sample request](../../samples/agent/request/v1MarketingAgent_DeleteShipmentMessageBlockEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1MarketingAgent_DeleteShipmentMessageBlockEntity.md)]