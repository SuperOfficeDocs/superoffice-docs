...
[!include[sample request](../../samples/agent/request/v1FindAgent_GetSpecifiedCriteriaInformationWithDefaultsWithContext.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1FindAgent_GetSpecifiedCriteriaInformationWithDefaultsWithContext.md)]