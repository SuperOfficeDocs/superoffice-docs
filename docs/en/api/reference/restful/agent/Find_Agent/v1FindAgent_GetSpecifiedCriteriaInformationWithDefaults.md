...
[!include[sample request](../../samples/agent/request/v1FindAgent_GetSpecifiedCriteriaInformationWithDefaults.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1FindAgent_GetSpecifiedCriteriaInformationWithDefaults.md)]