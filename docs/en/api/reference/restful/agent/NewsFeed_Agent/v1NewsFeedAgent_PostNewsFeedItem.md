---
title: POST Agents/NewsFeed/PostNewsFeedItem
uid: v1NewsFeedAgent_PostNewsFeedItem
generated: true
content_type: reference
---

# POST Agents/NewsFeed/PostNewsFeedItem

```http
POST /api/v1/Agents/NewsFeed/PostNewsFeedItem
```
...
```http
POST /api/v1/Agents/NewsFeed/PostNewsFeedItem?$select=name,department,category/id
```
...
NewsFeedItem, ToAssociateIds, ToGroupIds, ToAll 

| Property Name | Type |  Description |
|----------------|------|--------------|
| NewsFeedItem | NewsFeedItem | News feed items are created by agents or other services for display on the start page and other relevant places in the UI. <para /> Carrier object for NewsFeedItem. Services for the NewsFeedItem Carrier is available from the <see cref="T:SuperOffice.CRM.Services.INewsFeedAgent">NewsFeed Agent</see>. |
| ToAssociateIds | Array |  |
| ToGroupIds | Array |  |
| ToAll | Boolean |  |
...
[!include[sample request](../../samples/agent/request/v1NewsFeedAgent_PostNewsFeedItem.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1NewsFeedAgent_PostNewsFeedItem.md)]