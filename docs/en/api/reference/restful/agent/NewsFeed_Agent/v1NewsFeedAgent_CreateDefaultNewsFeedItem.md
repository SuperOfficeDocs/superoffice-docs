---
title: POST Agents/NewsFeed/CreateDefaultNewsFeedItem
uid: v1NewsFeedAgent_CreateDefaultNewsFeedItem
generated: true
content_type: reference
---

# POST Agents/NewsFeed/CreateDefaultNewsFeedItem

```http
POST /api/v1/Agents/NewsFeed/CreateDefaultNewsFeedItem
```
...
[!include[sample request](../../samples/agent/request/v1NewsFeedAgent_CreateDefaultNewsFeedItem.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1NewsFeedAgent_CreateDefaultNewsFeedItem.md)]