---
title: POST Agents/NewsFeed/GetNewsItemsForUser
uid: v1NewsFeedAgent_GetNewsItemsForUser
generated: true
content_type: reference
---

# POST Agents/NewsFeed/GetNewsItemsForUser

```http
POST /api/v1/Agents/NewsFeed/GetNewsItemsForUser
```

Get a list of newsfeed items for a particular user between two dates.
...
```http
POST /api/v1/Agents/NewsFeed/GetNewsItemsForUser?$select=name,department,category/id
```
...
AssociateId, FromDate, ToDate, Top, Skip 
...
[!include[sample request](../../samples/agent/request/v1NewsFeedAgent_GetNewsItemsForUser.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1NewsFeedAgent_GetNewsItemsForUser.md)]