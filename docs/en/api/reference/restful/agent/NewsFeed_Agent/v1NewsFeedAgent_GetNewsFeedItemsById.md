---
title: POST Agents/NewsFeed/GetNewsFeedItemsById
uid: v1NewsFeedAgent_GetNewsFeedItemsById
generated: true
content_type: reference
---

# POST Agents/NewsFeed/GetNewsFeedItemsById

```http
POST /api/v1/Agents/NewsFeed/GetNewsFeedItemsById
```
...
```http
POST /api/v1/Agents/NewsFeed/GetNewsFeedItemsById?$select=name,department,category/id
```
...
[!include[sample request](../../samples/agent/request/v1NewsFeedAgent_GetNewsFeedItemsById.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1NewsFeedAgent_GetNewsFeedItemsById.md)]