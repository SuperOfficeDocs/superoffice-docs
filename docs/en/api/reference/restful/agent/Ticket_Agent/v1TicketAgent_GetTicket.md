...
```http
POST /api/v1/Agents/Ticket/GetTicket?ticketId=495
...
[!include[sample request](../../samples/agent/request/v1TicketAgent_GetTicket.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1TicketAgent_GetTicket.md)]