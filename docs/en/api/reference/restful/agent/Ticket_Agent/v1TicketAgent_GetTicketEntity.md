...
```http
POST /api/v1/Agents/Ticket/GetTicketEntity?ticketEntityId=318
...
[!include[sample request](../../samples/agent/request/v1TicketAgent_GetTicketEntity.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1TicketAgent_GetTicketEntity.md)]