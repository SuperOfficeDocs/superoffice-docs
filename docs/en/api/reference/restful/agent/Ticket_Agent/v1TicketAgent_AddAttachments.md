...
[!include[sample request](../../samples/agent/request/v1TicketAgent_AddAttachments.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1TicketAgent_AddAttachments.md)]