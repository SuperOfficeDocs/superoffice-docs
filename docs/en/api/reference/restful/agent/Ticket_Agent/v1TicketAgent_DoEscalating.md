...
Checks if the ticket should change its alert level based on the priority and action.
...
```http
POST /api/v1/Agents/Ticket/DoEscalating?$select=name,department,category/id
```
