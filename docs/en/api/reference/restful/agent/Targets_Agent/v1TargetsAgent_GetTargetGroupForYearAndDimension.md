...
```http
POST /api/v1/Agents/Targets/GetTargetGroupForYearAndDimension?$select=name,department,category/id
```
  ...
  "TargetAssignments": [
    {
      ...
      "Currency": null,
      "DimensionListItem": 103,
      "DimensionListItemDisplayName": "Hansen Inc and Sons",
      "TableRight": null,
      "FieldProperties": {
        "fieldName": {
          "FieldRight": null,
