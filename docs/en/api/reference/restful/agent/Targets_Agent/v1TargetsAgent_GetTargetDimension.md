...
```http
POST /api/v1/Agents/Targets/GetTargetDimension?targetDimensionId=542
...
[!include[sample request](../../samples/agent/request/v1TargetsAgent_GetTargetDimension.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1TargetsAgent_GetTargetDimension.md)]