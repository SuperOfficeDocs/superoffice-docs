...
```http
POST /api/v1/Agents/Targets/GetTargetDimension?targetDimensionId=769
...
{
  "TargetDimensionId": 957,
  "AssignmentLevel": "Associate",
  "EntityType": "None",
  "MeasurementUnit": "Amount",
  "DimensionListField": "molestiae",
  "DimensionListName": "Pacocha, Kuhlman and Osinski",
  "DimensionListId": 169,
  "DimensionListLabel": "iste",
  "SelectedDimensions": [
    452,
    607
  ],
