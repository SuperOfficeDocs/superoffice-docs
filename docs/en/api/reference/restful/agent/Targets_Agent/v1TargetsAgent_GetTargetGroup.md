...
```http
POST /api/v1/Agents/Targets/GetTargetGroup?targetGroupId=925
  ...
  "TargetAssignments": [
    {
      ...
      "Currency": null,
      "DimensionListItem": 449,
      "DimensionListItemDisplayName": "King Inc and Sons",
      "TableRight": null,
      "FieldProperties": {
        "fieldName": {
          "FieldRight": null,
