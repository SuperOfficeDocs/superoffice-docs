...
```http
POST /api/v1/Agents/Targets/GetTargetGroup?targetGroupId=234
  ...
  "TargetAssignments": [
    {
      ...
      "Currency": null,
      "DimensionListItem": 484,
      "DimensionListItemDisplayName": "McCullough-Parker",
      "TableRight": null,
      "FieldProperties": {
        "fieldName": {
          "FieldRight": null,
