...
```http
POST /api/v1/Agents/Dash/GetDash?dashId=572
...
[!include[sample request](../../samples/agent/request/v1DashAgent_GetDash.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1DashAgent_GetDash.md)]