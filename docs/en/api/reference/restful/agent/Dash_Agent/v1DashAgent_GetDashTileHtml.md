...
[!include[sample request](../../samples/agent/request/v1DashAgent_GetDashTileHtml.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1DashAgent_GetDashTileHtml.md)]