...
```http
POST /api/v1/Agents/Dash/GetDashTile?dashTileId=810
...
[!include[sample request](../../samples/agent/request/v1DashAgent_GetDashTile.md)]

## Sample response

[!include[sample response](../../samples/agent/response/v1DashAgent_GetDashTile.md)]