...
```http
POST /api/v1/Agents/Dashboard/GetDashboardTile?dashboardTileId=373
...

{
  "DashboardTileId": 257,
  "Caption": "nihil",
  "Description": "Persevering explicit service-desk",
  "ChartName": "Fahey-Haag",
  "ChartId": "quidem",
  "IsDefault": false,
  "AssociateId": 563,
  "GroupId": 654,
  ...
  "Options": [
    {
      ...
      "Description": "Exclusive bottom-line middleware",
      "Type": "Boolean",
      "ListName": "Wolf-Dibbert",
      "ListItems": [
        {},
        {}
      ],
