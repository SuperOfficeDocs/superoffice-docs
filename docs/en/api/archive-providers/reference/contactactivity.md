...
```http!
GET /api/v1/archive/ContactActivity?$select=person/useAsMailingAddress,person/correspondingAssociate/ejStatus,contact/category,contact/contactUdef/SuperOffice:4,contact/contactExtra/x_contact_boolean
