...
```http!
GET /api/v1/archive/ContactActivity?$select=person/personUdef/SuperOffice:4,person/withdrawnEmarketingConsent,contact/registeredDate,contact/streetAddress/formattedAddress,documentUdef/SuperOffice:5
