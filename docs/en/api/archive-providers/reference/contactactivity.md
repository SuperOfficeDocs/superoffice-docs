...
```http!
GET /api/v1/archive/ContactActivity?$select=getAllRows,contactId,associate/contactCategory,person/personUdef/SuperOffice:11,contact/restrictionAddress/city
