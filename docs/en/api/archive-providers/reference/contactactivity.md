...
```http!
GET /api/v1/archive/ContactActivity?$select=associate/credentialDisplayValue,person/hasInterests,person/personUdef/SuperOffice:11,person/personAssociate/mrMrs,contact/restrictionAddress/wgs84latitude
