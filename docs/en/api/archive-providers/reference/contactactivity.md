...
```http!
GET /api/v1/archive/ContactActivity?$select=agent,person/personExtra/x_person_priority_relation,contact/streetAddress/county,contact/contactUdef/SuperOffice:13,project/projectAssociate/ejStatus
