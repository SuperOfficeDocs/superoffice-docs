...
```http!
GET /api/v1/archive/ContactActivity?$select=person/fullName,person/personAddress/addressId,person/personUdef/SuperOffice:2,person/correspondingAssociate/firstName,person/consentSourceStore
