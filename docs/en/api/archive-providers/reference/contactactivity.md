...
```http!
GET /api/v1/archive/ContactActivity?$select=person/personCountry,person/personExtra/y_rental/id,person/personAssociate/userName,person/correspondingAssociate/lastName,person/correspondingAssociate/contactFullName
