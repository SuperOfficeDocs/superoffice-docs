...
```http!
GET /api/v1/archive/ContactActivity?$select=lastMessage,person/hasInfoText,person/email/emailLastBounce,person/consentSourceStore,contact/contactAssociate/credentialType
