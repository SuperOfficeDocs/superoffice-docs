...
```http!
GET /api/v1/archive/ContactActivity?$select=associate/firstName,associate/lastName,person/personExtra/y_rental/x_contact,person/personAssociate/mrMrs,contact/contactUdef/SuperOffice:9
