...
```http!
GET /api/v1/archive/ContactActivity?$select=contact/postAddress/line1,contact/contactUdef/SuperOffice:8,contact/saintDirection,project/registeredByFullName,associate/usergroup
