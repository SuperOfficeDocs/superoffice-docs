...
```http!
GET /api/v1/archive/ContactActivity?$select=person/personAddress/zip,contact/postAddress/line1,contact/restrictionAddress/county,contact/contactExtra/x_contact_contact,contact/NumberOfSalesInPeriod
