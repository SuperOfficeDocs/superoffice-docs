...
```http!
GET /api/v1/archive/ContactActivity?$select=person/hasInterests,person/personRegisteredDate,person/email/emailHasBounced,person/consentSourceEmarketing,isReport
