...
```http!
GET /api/v1/archive/ContactActivity?$select=rating,person/birthMonth,person/restrictionAddress/line2,person/restrictionAddress/wgs84longitude,contact/department
