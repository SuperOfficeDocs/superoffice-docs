...
```http!
GET /api/v1/archive/ContactActivity?$select=person/correspondingAssociate/lastName,contact/postAddress/line3,contact/streetAddress/wgs84latitude,contact/contactAssociate/assocType,contact/contactUdef/SuperOffice:3
