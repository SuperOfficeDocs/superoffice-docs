...
```http!
GET /api/v1/archive/ContactActivity?$select=person/personCategory,person/personExtra/x_person_category_relation,person/personAssociate/assocName,contact/contactExtra/x_contact_datetime,project/updatedByFullName
