...
```http!
GET /api/v1/archive/ContactActivity?$select=timeInQueue,person/correspondingAssociate/ejStatus,contact/url/URLDescription,contact/contactExtra/x_contact_float,contact/LastCompletedSale
