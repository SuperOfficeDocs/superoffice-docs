...
```http!
GET /api/v1/archive/ContactActivity?$select=associate/contactCategory,person/personExtra/x_person_date,contact/restrictionAddress/formattedMultiLineAddress,contact/contactAssociate/lastName,contact/contactAssociate/title
