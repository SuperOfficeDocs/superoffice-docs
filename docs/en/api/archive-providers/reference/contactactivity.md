...
```http!
GET /api/v1/archive/ContactActivity?$select=person/personHasInterests,person/personExtra/x_person_longtext,contact/registeredDate,contact/postAddress/wgs84latitude,visibleFor
