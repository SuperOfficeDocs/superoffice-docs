...
```http!
GET /api/v1/archive/ContactActivity?$select=firstMessage,person/personExtra/y_rental/x_start,project/projectAssociate/isLocation,formSubmissionStatus,appointmentPublish/publishedBy
