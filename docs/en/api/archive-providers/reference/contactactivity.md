...
```http!
GET /api/v1/archive/ContactActivity?$select=associate/assocName,person/title,person/personAssociate/middleName,person/personAssociate/otherGroups,person/correspondingAssociate/firstName
