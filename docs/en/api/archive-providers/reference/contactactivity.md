...
```http!
GET /api/v1/archive/ContactActivity?$select=associateId,associate/firstName,person/personInterestIds,person/personAssociate/firstName,person/personAssociate/credentialDisplayValue
