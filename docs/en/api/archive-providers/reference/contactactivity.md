...
```http!
GET /api/v1/archive/ContactActivity?$select=person/title,contact/contactAssociate/contactCategory,contact/LastActivity,contact/LastDoByActivity,contact/NumberOfNotCompletedSales
