...
```http!
GET /api/v1/archive/ContactActivity?$select=type,who,person/personMobilePhone/description,person/personAddress/wgs84longitude,person/personExtra/x_person_hidden_integer
