...
```http!
GET /api/v1/archive/ContactActivity?$select=associate/credentialType,name,project/registeredBy,project/projectUrl/URLDescription,sale/associate/associateDbId
