...
```http!
GET /api/v1/archive/ContactActivity?$select=chatTopic/description,person/restrictionAddress/state,person/personExtra/x_person_shorttext,person/personExtra/x_person_priority_relation,contact/contactAssociate/contactDepartment
