...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=contact/contactAssociate/ejDisplayName,contact/saintActivityType,project/name,project/projectAssociate/contactId
