...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/hasInterests,person/personNumber,person/personUrl/URLDescription,person/personAddress/city,project/LastCompletedActivity
