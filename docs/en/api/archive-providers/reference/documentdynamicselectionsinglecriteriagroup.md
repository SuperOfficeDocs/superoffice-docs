...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=updatedDate,documentId,person/personPager/description,person/personAssociate/lastName,person/correspondingAssociate/contactFullName
