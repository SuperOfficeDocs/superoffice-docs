...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/firstName,person/personAssociateFullName,person/restrictionAddress/addressId,associate/isActive,sale/reopenDate
