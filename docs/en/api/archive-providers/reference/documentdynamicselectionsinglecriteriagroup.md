...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=documentPublish/publishedBy,person/lastName,person/supportLanguage,person/email/emailBounceCount,person/personUdef/SuperOffice:10
