...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/email/emailHasBounced,contact/contactExtra/x_contact_dropdown,sale/saleNumber
