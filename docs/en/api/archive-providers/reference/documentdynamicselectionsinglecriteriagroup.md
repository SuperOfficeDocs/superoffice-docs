...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=recordTypeText,person/lastName,person/restrictionAddress/line1,project/LastDoByActivity
