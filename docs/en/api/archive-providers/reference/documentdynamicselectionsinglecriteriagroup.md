...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personActiveErpLinks,person/email/emailLastSent,person/personExtra/y_rental/x_end,person/personAssociate/isActive,person/correspondingAssociate/ejDisplayName
