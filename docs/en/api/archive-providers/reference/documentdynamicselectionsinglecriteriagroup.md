...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personRegisteredDate,person/personPrivate/description,person/personAddress/line3
