...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/contactCategory,contact/postAddress/wgs84latitude,associate/isActiveText,sale/stage
