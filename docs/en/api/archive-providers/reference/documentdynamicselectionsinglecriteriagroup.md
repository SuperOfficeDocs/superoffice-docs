...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=contact/url/URLDescription,contact/contactAssociate/credentialDisplayValue,project/updatedDate,associate/portraitThumbnail,sale/associate/otherGroups
