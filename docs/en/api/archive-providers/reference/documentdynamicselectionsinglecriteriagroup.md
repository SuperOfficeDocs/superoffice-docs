...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/assocType,contact/NumberOfActivitiesInPeriod,project/projectId,project/number,project/projectAssociate/contactDepartment
