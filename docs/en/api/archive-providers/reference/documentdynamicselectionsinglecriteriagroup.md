...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/withdrawnEmarketingConsent,contact/stop,contact/NumberOfSales,project/completed,project/hasInfoText
