...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/birthDay,person/personExtra/x_person_date,person/correspondingAssociate/mrMrs,contact/postAddress/line2,contact/saintTicketCategory
