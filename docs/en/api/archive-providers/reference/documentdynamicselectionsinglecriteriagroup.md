...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/consentSourceStore,project/projectAssociate/isLocation,sale/source,sale/salePublish/publishedFrom
