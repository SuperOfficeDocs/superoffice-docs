...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=updatedDate,person/supportLanguage,person/personInfo/textId,contact/contactUdef/SuperOffice:13,project/nextMilestone
