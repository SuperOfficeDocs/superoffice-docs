...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/personId,person/personAssociate/ejStatus,person/correspondingAssociate/ejDisplayName,contact/updatedByFullName,project/NumberOfNotCompletedSalesInPeriod
