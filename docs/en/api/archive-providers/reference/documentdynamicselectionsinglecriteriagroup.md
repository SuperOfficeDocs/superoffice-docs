...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/contactId,person/correspondingAssociate/credentialType,contact/contactAssociate/contactFullName,contact/contactExtra/x_contact_integer,project/projectEvent/isExternalEvent
