...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/isStakeholder,person/personAddress/state,person/personExtra/x_person_request_relation,project/projectUrl/URLDescription
