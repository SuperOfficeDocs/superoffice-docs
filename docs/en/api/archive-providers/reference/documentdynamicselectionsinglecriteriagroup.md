...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=who,person/ticketPriority,person/personAssociate/contactId,contact/streetAddress/addressId,contact/contactAssociate/usergroup
