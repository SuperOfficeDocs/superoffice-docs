...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personCategory,person/personExtra/x_person_date,person/correspondingAssociate/userName,contact/streetAddress/addressId,sale/saleNumber
