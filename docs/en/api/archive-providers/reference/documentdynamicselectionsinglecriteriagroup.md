...
```http!
GET /api/v1/archive/DocumentDynamicSelectionSingleCriteriaGroup?$select=person/personExtra/x_person_longtext,person/personAssociate/usergroup,contact/business,contact/restrictionAddress/zip
