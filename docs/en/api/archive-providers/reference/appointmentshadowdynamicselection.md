...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=booking,person/personId,project/number,project/registeredByFullName,project/projectPublish/publishedTo
