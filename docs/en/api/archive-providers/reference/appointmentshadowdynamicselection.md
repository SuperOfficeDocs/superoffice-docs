...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=appointmentPublish/publishedBy,contact/hasInterests,contact/deletedDate,contact/email/emailDescription,contact/restrictionAddress/line3
