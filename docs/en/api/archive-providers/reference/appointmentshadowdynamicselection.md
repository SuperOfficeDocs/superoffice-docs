...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=person/personSource,person/ticketPriority,project/projectAssociate/assocName,sale/amountInBaseCurrency,sale/associate/userName
