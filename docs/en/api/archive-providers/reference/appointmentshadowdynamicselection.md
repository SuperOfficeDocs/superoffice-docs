...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/name,contact/registeredDate,contact/email/emailProtocol,contact/streetAddress/state,contact/contactAssociate/usergroup
