...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/contactExtra/x_contact_time,person/correspondingAssociate/mrMrs,project/projectUdef/SuperOffice:10
