...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/streetAddress/state,person/personRegisteredDate,project/LastSale,sale/time,appointment/internalNotesHtml
