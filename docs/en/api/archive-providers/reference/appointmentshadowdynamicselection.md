...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contactId,contact/restrictionAddress/wgs84latitude,contact/contactAssociate/personId,contact/contactExtra/x_contact_float,person/rank
