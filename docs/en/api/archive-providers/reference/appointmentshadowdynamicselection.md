...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=recurring,contact/number,contact/streetAddress/zip,contact/contactUdef/SuperOffice:10,contact/saintTicketCategory
