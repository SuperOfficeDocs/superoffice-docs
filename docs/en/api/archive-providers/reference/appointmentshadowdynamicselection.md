...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/category,contact/contactDeleted,contact/contactFax/description,person/personRegisteredByFullName,person/supportAssociateFullName
