...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/NumberOfNotCompletedSales,person/restrictionAddress/wgs84longitude,contact/saintIntention
