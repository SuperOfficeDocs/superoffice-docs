...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=cautionWarning,contact/contactUdef/SuperOffice:6,contact/contactExtra/x_contact_longtext,person/email/emailLastSent
