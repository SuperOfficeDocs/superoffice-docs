...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=appointmentId,contact/contactAssociate/usergroup,person/personRegisteredBy,sale/heading,sale/description
