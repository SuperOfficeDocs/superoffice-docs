...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=person/email/emailProtocol,person/personExtra/y_rental/y_equipment/x_name,project/number,project/projectUdef/SuperOffice:8
