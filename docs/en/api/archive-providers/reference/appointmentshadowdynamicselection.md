...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=isMilestone,duration,contact/streetAddress/state,contact/LastDoBySale,person/personCategory
