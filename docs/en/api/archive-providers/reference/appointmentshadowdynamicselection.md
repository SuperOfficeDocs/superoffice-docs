...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=getAllRows,type,contact/contactUdef/SuperOffice:13,contact/NumberOfActivitiesInPeriod,person/personUdef/SuperOffice:3
