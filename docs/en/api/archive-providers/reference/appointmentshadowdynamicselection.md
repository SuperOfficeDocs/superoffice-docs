...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=rowKind,text,contact/streetAddress/line1,person/searchPhone/description,person/personAssociate/associateDbId
