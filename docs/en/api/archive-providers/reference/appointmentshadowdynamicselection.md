...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/companyCategoryRank,contact/registeredByFullName,contact/postAddress/zip,contact/streetAddress/formattedAddress,contact/LastDoByTicket
