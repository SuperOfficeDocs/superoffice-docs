...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/contactExtra/x_contact_date,person/birthMonth,person/hasCompany,project/LastSale,sale/personId
