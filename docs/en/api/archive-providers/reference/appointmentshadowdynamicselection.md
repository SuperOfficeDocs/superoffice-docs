...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/orgnr,contact/postAddress/line3,contact/contactExtra/x_contact_contact_relation,person/personId,person/searchPhone/formattedNumber
