...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/email/emailHasBounced,contact/contactAssociate/middleName,contact/contactUdef/SuperOffice:1,person/personExtra/y_car/id,person/correspondingAssociate/assocName
