...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelection?$select=contact/restrictionAddress/zip,project/name,project/type,project/LastDoByActivity,sale/saleTypeCategory
