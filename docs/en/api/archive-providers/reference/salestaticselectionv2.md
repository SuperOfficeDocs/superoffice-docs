...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=originalStage,salePublish/publishedFrom,person/personPrivate/description,person/searchPhone/formattedNumber,contact/streetAddress/line2
