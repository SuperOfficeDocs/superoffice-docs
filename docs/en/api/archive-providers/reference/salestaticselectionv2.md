...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=contact/email/emailLastSent,contact/contactAssociate/isActive,contact/contactUdef/SuperOffice:2,contact/NumberOfNotCompletedTickets,associate/assocName
