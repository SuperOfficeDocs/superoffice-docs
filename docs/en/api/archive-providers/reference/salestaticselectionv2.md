...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=who,person/personPager/formattedNumber,person/restrictionAddress/formattedAddress,contact/phone/formattedNumber,contact/contactAssociate/otherGroups
