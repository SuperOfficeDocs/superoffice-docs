...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/title,person/personDeletedDate,person/personAssociate/userName,contact/saintTicketCategory,appointment/type
