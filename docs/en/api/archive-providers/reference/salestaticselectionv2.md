...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=personId,person/correspondingAssociate/associateDbId,contact/contactExtra/x_contact_float,appointment/updatedBy,document/associate/isActive
