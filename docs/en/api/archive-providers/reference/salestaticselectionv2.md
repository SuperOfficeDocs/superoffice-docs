...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=registeredDate,description,person/contactId,person/correspondingAssociate/simultaneousEjUser,contact/saintSaleStatus
