...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/restrictionAddress/addressId,contact/orgnr,associate/contactFullName,appointment/associate/assocName,project/projectEvent/isExternalEvent
