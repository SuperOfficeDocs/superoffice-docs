...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=hasGuide,salePublish/publishedBy,person/whenUpdatedByWorkflow,person/personAssociate/ejUserId,person/hasEmarketingConsent
