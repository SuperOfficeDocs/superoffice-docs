...
keywords: SaleStaticSelectionV2 archive provider
so.generated: true
so.topic: reference
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionStaticProviderV2">SuperOffice.CRM.ArchiveLists.Archive.SaleSelectionStaticProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/email/emailHasBounced,person/personExtra/y_rental/x_contact,contact/phone/formattedNumber,contact/postAddress/formattedMultiLineAddress,saleStakeholder/person/personAssociate/locationAddress
