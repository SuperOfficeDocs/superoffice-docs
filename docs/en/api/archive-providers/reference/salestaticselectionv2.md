...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=contact/saintTicketCategory,appointment/associate/title,project/projectAssociate/usergroup,saleStakeholder/person/consentSourceEmarketing,saleStakeholder/contact/postAddress/addressId
