...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/personExtra/x_person_boolean,person/correspondingAssociate/role,person/correspondingAssociate/otherGroups,contact/hasInfoText,appointment/userGroup
