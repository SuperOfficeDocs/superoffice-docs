...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=contactId,person/ticketPriority,person/personExtra/y_rental/x_contact,person/personAssociate/lastName,contact/contactAssociate/assocType
