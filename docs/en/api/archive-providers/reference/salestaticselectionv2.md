...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=recordType,registeredDate,person/personExtra/y_rental/id,person/correspondingAssociate/otherGroups,contact/postAddress/city
