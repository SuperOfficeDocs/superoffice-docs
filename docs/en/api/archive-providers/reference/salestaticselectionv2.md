...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=saleId,person/personCategory,contact/contactExtra/x_contact_dropdown,contact/NumberOfActivities,document/associate/ejUserId
