...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=description,person/personAddress/zip,person/correspondingAssociate/assocType,person/correspondingAssociate/personEmail,contact/companyCategoryRank
