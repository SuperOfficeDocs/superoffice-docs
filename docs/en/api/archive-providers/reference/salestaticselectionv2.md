...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=contact/email/emailId,associate/fullName,appointment/associate/fullName,document/contactId,document/recordTypeText
