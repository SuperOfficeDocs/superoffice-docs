...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=createdByWorkflow,person/firstName,person/personUpdatedBy,contact/contactFax/description,contact/postAddress/line1
