...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=amount,nextDueDate,person/email/emailBounceCount,person/personAssociate/mrMrs,person/personAssociate/contactName
