...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/personUdef/SuperOffice:1,person/personExtra/y_rental/x_contact,contact/country,contact/email/emailLastSent,contact/email/emailBounceCount
