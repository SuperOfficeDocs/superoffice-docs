...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=saleStatus,description,person/personUdef/SuperOffice:2,person/correspondingAssociate/credentialDisplayValue,contact/contactExtra/x_contact_float
