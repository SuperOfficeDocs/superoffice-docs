...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=credited,contact/updatedBy,associate/firstName,saleStakeholder/person/birthMonth,saleStakeholder/person/email/emailProtocol
