...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=probPercent,visibleFor,person/correspondingAssociate/isActiveText,contact/contactAssociate/isActive,contact/NumberOfNotCompletedSales
