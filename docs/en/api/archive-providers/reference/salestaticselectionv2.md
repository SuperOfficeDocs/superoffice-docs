...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/email/emailLastSent,person/personAddress/line2,person/personExtra/x_person_longtext,person/legalBaseEmarketing,contact/restrictionAddress/city
