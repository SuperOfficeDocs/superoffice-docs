...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=probPercent,person/personActiveErpLinks,person/personUdef/SuperOffice:10,person/personExtra/x_person_priority_relation,person/personAssociate/title
