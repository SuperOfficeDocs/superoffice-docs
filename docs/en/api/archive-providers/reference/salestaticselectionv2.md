...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=userGroup,contact/companyCategoryRank,contact/contactExtra/x_contact_request_relation,appointment/associate/userName,document/date
