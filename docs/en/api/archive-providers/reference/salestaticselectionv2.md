...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/personUpdatedDate,person/supportLanguage,person/personUdef/SuperOffice:4,person/personAssociate/assocName,contact/saintSaleStatus
