...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=registeredByFullName,contact/contactAssociate/fullName,document/snum,document/associate/personEmail,saleStakeholder/person/email/emailAddress
