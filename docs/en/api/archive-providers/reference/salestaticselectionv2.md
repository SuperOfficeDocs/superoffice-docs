...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/personCountryId,person/personExtra/x_person_appointment_relation,contact/url/URLAddress,saleUdef/SuperOffice:6,appointment/associate/ejUserId
