...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/isProjectMember,person/personUdef/SuperOffice:11,contact/restrictionAddress/zip,appointment/endDate,document/projectId
