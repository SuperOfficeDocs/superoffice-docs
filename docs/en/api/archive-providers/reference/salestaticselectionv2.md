...
```http!
GET /api/v1/archive/SaleStaticSelectionV2?$select=person/isProjectMember,person/phone/formattedNumber,person/personAddress/county,associate/locationAddress,appointment/joinVideomeetUrl
