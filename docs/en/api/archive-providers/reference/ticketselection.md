...
```http!
GET /api/v1/archive/TicketSelection?$select=priorityName,ownedBy/credentialDisplayValue,person/personInfo/infoText,contact/restrictionAddress/zip,sale/saleUdef/SuperOffice:5
