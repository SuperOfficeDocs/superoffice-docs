...
```http!
GET /api/v1/archive/TicketSelection?$select=person/personCountryId,person/personMobilePhone/description,person/personAssociate/firstName,contact/contactAssociate/personEmail,contact/contactUdef/SuperOffice:6
