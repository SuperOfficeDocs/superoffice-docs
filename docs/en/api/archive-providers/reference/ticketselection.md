...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/contactName,ticketPriority/name,person/personUpdatedBy,person/personUdef/SuperOffice:1,person/personUdef/SuperOffice:6
