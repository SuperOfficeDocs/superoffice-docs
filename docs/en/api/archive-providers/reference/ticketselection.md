...
```http!
GET /api/v1/archive/TicketSelection?$select=ownedBy/ejUserId,person/correspondingAssociate/portraitThumbnail,contact/contactExtra/x_contact_boolean,contact/NumberOfActivities,contact/LastDoBySale
