...
```http!
GET /api/v1/archive/TicketSelection?$select=deadline,person/personAddress/state,person/personUdef/SuperOffice:10,person/personExtra/x_person_request_relation,person/personExtra/y_rental/x_start
