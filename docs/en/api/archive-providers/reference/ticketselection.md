...
```http!
GET /api/v1/archive/TicketSelection?$select=firstReadByUser,person/personAssociate/personId,extra/x_ticket_boolean,project/hasGuide,project/projectAssociate/contactFullName
