...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/contactFullName,ownedBy/mrMrs,ownedBy/locationAddress,person/personRegisteredDate,person/searchPhone/formattedNumber
