...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/title,createdBy/credentialType,ownedBy/lastName,person/supportLanguage,person/personExtra/x_person_user_relation
