...
```http!
GET /api/v1/archive/TicketSelection?$select=personId,createdBy/contactDepartment,person/hasInterests,person/personCountry,person/personExtra/y_rental/x_end
