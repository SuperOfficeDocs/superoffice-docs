...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/contactId,ownedBy/userName,person/email/emailAddress,person/personAddress/zip,person/personUdef/SuperOffice:4
