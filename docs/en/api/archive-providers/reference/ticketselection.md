...
```http!
GET /api/v1/archive/TicketSelection?$select=person/fullName,person/personAddress/addressId,person/personAssociate/associateDbId,person/correspondingAssociate/contactCategory,sale/saleId
