...
```http!
GET /api/v1/archive/TicketSelection?$select=numberOfMessages,person/personExtra/x_person_category_relation,person/personAssociate/ejStatus,person/correspondingAssociate/lastName,contact/contactExtra/x_contact_dropdown
