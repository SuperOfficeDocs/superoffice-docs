...
```http!
GET /api/v1/archive/TicketSelection?$select=sentimentScore,createdBy/ejDisplayName,person/personDirectPhone/description,person/personDirectFax/description,person/personExtra/x_person_user_relation
