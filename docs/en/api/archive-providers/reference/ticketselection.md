...
```http!
GET /api/v1/archive/TicketSelection?$select=ownedBy/associateDbId,person/correspondingAssociate/ejUserId,contact/number,contact/postAddress/city,contact/streetAddress/county
