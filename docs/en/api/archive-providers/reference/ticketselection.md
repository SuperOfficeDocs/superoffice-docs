...
```http!
GET /api/v1/archive/TicketSelection?$select=person/personDeletedDate,person/restrictionAddress/addressId,person/personExtra/x_person_shorttext,person/personExtra/x_person_priority_relation,contact/searchPhone/description
