...
```http!
GET /api/v1/archive/TicketSelection?$select=firstReadByOwner,numberOfReplies,createdBy/assocTooltip,contact/contactAssociate/credentialDisplayValue,sale/credited
