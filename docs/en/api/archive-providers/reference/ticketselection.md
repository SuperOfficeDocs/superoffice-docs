...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/ejUserId,person/personExtra/y_rental/x_amount,person/correspondingAssociate/assocTooltip,person/correspondingAssociate/ejStatus,person/isMailingRecipient
