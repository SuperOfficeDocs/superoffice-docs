...
```http!
GET /api/v1/archive/TicketSelection?$select=person/supportAssociateFullName,person/phone/formattedNumber,person/searchPhone/formattedNumber,contact/saintIntention,sale/text
