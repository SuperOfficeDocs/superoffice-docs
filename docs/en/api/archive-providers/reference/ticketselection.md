...
```http!
GET /api/v1/archive/TicketSelection?$select=person/personRegisteredDate,person/personAssociate/middleName,contact/nameDepartment,contact/streetAddress/wgs84latitude,project/projectPublish/publishedFrom
