...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/lastName,createdBy/title,person/personUrl/URLDescription,person/correspondingAssociate/contactFullName,contact/restrictionAddress/formattedAddress
