...
```http!
GET /api/v1/archive/TicketSelection?$select=getAllRows,createdBy/isLocation,person/correspondingAssociate/firstName,person/correspondingAssociate/otherGroups,sale/stalledComment
