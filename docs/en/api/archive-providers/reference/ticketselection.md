...
```http!
GET /api/v1/archive/TicketSelection?$select=activated,ownedBy/contactFullName,contact/updatedBy,contact/contactExtra/y_organization/x_name,contact/saintTicketStatus
