...
```http!
GET /api/v1/archive/TicketSelection?$select=person/title,person/personExtra/x_person_boolean,person/personAssociate/isActive,contact/email/emailId,contact/contactUdef/SuperOffice:1
