...
```http!
GET /api/v1/archive/TicketSelection?$select=createdBy/isLocation,person/ticketPriority,contact/contactUdef/SuperOffice:11,sale/updatedByFullName,project/LastSale
