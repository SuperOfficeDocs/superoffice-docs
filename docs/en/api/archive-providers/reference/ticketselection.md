...
```http!
GET /api/v1/archive/TicketSelection?$select=ticketTypeName,connectId,ticketPriority/ticketPriorityId,person/isStakeholder,person/personAssociate/simultaneousEjUser
