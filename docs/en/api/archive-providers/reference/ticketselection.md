...
```http!
GET /api/v1/archive/TicketSelection?$select=ticketStatusName,createdAt,createdBy/personId,person/personExtra/x_person_boolean,person/correspondingAssociate/ejDisplayName
