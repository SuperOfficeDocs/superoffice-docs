...
```http!
GET /api/v1/archive/TicketSelection?$select=person/personUdef/SuperOffice:1,contact/streetAddress/wgs84latitude,contact/contactAssociate/ejDisplayName,contact/contactUdef/SuperOffice:3,sale/icon
