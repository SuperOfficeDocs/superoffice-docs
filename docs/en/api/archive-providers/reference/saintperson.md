...
```http!
GET /api/v1/archive/SaintPerson?$select=contactExtra/x_contact_datetime,targetRelation/name,appointment/associate/lastName,appointment/associate/contactFullName,document/associate/firstName
