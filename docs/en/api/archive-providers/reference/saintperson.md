...
```http!
GET /api/v1/archive/SaintPerson?$select=streetAddress/wgs84latitude,restrictionAddress/wgs84longitude,contactUdef/SuperOffice:11,sourceRelation/who,targetRelation/department
