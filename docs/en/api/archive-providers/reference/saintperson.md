...
```http!
GET /api/v1/archive/SaintPerson?$select=country,email/emailProtocol,contactAssociate/assocName,sale/updatedDate,appointment/appointmentUdef/SuperOffice:1
