...
```http!
GET /api/v1/archive/SaintPerson?$select=contactAssociate/contactFullName,contactInterestIds,saintIntention,targetRelation/personContactRelation,sale/currencyId
