...
```http!
GET /api/v1/archive/SaintPerson?$select=forceCompany,postAddress/formattedMultiLineAddress,restrictionAddress/formattedAddress,document/associate/usergroupId,personCategoryRank
