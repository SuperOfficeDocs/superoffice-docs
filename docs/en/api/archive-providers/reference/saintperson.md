...
```http!
GET /api/v1/archive/SaintPerson?$select=contactFax/description,streetAddress/wgs84latitude,sale/registeredDate,sale/saleUdef/SuperOffice:3,appointment/icon
