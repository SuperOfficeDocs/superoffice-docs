...
```http!
GET /api/v1/archive/SaintPerson?$select=contactId,appointment/type,appointment/registeredDate,appointment/associate/contactDepartment,document/userGroup
