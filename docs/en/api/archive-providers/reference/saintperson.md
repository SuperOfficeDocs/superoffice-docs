...
```http!
GET /api/v1/archive/SaintPerson?$select=restrictionAddress/line3,LastCompletedActivity,NumberOfSales,sale/associate/middleName,sale/associate/isActiveText
