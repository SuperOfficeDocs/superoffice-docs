...
```http!
GET /api/v1/archive/SaintPerson?$select=sale/updatedDate,sale/saleStatus,sale/associate/credentialDisplayValue,appointment/invitedPersonId,personCountryId
