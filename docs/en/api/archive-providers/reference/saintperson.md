...
```http!
GET /api/v1/archive/SaintPerson?$select=email/emailAddress,restrictionAddress/addressId,sourceRelation/contactId,sourceRelation/business,appointment/personId
