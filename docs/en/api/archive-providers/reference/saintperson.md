...
```http!
GET /api/v1/archive/SaintPerson?$select=contactAssociate/firstName,contactAssociate/isActiveText,contactInterestIds,targetRelation/updatedDate,appointment/appointment/internalNotes
