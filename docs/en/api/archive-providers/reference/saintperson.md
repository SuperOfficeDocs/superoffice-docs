...
```http!
GET /api/v1/archive/SaintPerson?$select=code,streetAddress/wgs84latitude,contactAssociate/contactFullName,contactAssociate/ejDisplayName,sourceRelation/registeredBy
