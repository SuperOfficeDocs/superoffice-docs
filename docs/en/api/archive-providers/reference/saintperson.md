...
```http!
GET /api/v1/archive/SaintPerson?$select=url/URLDescription,contactUdef/SuperOffice:13,contactExtra/x_contact_time,targetRelation/updatedDate,sale/stalledComment
