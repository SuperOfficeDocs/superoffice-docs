...
```http!
GET /api/v1/archive/SaintPerson?$select=contactExtra/x_contact_timespan,saintDirection,sale/salePublish/isPublished,appointment/associate/contactFullName,birthYear
