...
```http!
GET /api/v1/archive/SaintPerson?$select=contactAssociate/contactName,sale/updatedBy,sale/associate/middleName,sale/associate/ejStatus,personAddress/line2
