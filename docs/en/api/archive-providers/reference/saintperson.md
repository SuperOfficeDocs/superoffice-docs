...
```http!
GET /api/v1/archive/SaintPerson?$select=contactAssociate/personId,NumberOfNotCompletedActivitiesInPeriod,LastCompletedTicket,sale/who,personExtra/x_person_longtext
