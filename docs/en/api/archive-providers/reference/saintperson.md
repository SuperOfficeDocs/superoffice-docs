...
```http!
GET /api/v1/archive/SaintPerson?$select=contactUdef/SuperOffice:9,appointment/duration,document/name,personExtra/y_rental/x_amount,personAssociate/ejDisplayName
