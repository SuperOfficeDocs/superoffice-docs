...
```http!
GET /api/v1/archive/SaintPerson?$select=sourceRelation/stop,sale/competitor,document/associate/isActiveText,personAssociate/title,personAssociate/portraitThumbnail
