...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=name,alternative/version/quote/sale/person/subscription,alternative/version/quote/sale/contact/restrictionAddress/addressId,alternative/version/quote/connection/erpConnection/connector/url
