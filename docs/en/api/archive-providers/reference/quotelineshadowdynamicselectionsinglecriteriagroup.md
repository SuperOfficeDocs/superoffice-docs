...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=updatedDate,alternative/earningPercent,alternative/version/approvedText,alternative/version/quote/sale/completed,alternative/version/quote/sale/person/withdrawnEmarketingConsent
