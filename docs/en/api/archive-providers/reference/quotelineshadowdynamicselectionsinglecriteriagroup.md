...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=description,alternative/earningAmount,alternative/totalPriceIncVAT,alternative/version/quote/sale/reopenDate,alternative/version/quote/sale/stakeholdersEnabled
