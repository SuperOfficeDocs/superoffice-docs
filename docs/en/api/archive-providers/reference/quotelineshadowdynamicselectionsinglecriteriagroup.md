...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=alternative/extraField4,alternative/version/expiration,alternative/version/quote/sale/stage,alternative/version/quote/sale/person/personExtra/y_rental/x_start,alternative/version/quote/sale/contact/updatedBy
