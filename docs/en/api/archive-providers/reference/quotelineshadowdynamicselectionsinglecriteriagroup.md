...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionSingleCriteriaGroup?$select=code,PriceUnitSubscriptionQuantityUnit,unitCost,alternative/vat,alternative/version/quote/sale/originalStage
