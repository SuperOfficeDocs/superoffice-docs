...
```http!
GET /api/v1/archive/SystemEvents?$select=registered_associate_id/contactDepartment,registered_associate_id/simultaneousEjUser,registered_associate_id/lastName
