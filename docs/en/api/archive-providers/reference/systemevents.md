...
```http!
GET /api/v1/archive/SystemEvents?$select=registered_associate_id/credentialDisplayValue,registered_associate_id/lastName,registered_associate_id/contactName
