...
```http!
GET /api/v1/archive/SimpleChatSession?$select=chatSessionId,person/personInfo/textId,person/personUrl/URLDescription,person/correspondingAssociate/fullName,contact/streetAddress/addressId
