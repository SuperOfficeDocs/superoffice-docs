...
```http!
GET /api/v1/archive/SimpleChatSession?$select=person/hasInterests,person/personAddress/formattedAddress,person/personExtra/y_rental/y_equipment/x_name,contact/saintAmountClass,contact/saintTicketStatus
