...
```http!
GET /api/v1/archive/SimpleChatSession?$select=whenRequested,associate/portraitThumbnail,person/fullName,person/personExtra/x_person_boolean,contact/restrictionAddress/addressId
