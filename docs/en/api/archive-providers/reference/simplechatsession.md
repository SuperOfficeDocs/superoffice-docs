...
```http!
GET /api/v1/archive/SimpleChatSession?$select=chatTopic/name,person/personAssociate/personEmail,contact/contactId,contact/restrictionAddress/county,contact/contactUdef/SuperOffice:2
