...
```http!
GET /api/v1/archive/SimpleChatSession?$select=date,person/associateType,person/useAsMailingAddress,person/personSource,contact/streetAddress/wgs84longitude
