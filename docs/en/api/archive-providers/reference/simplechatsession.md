...
```http!
GET /api/v1/archive/SimpleChatSession?$select=registeredDate,person/position,person/personUpdatedDate,person/personMobilePhone/formattedNumber,person/email/emailDescription
