...
```http!
GET /api/v1/archive/SimpleChatSession?$select=associate/contactId,person/restrictionAddress/line2,person/personAssociate/middleName,person/withdrawnStoreConsent,contact/contactUdef/SuperOffice:11
