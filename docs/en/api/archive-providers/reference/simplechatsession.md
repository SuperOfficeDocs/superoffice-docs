...
```http!
GET /api/v1/archive/SimpleChatSession?$select=date,person/retired,person/personAssociate/isActive,person/withdrawnStoreConsent,person/withdrawnEmarketingConsent
