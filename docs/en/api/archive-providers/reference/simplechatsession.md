...
```http!
GET /api/v1/archive/SimpleChatSession?$select=status,person/hasInfoText,person/searchPhone/formattedNumber,person/personAddress/zip,person/personUdef/SuperOffice:9
