...
```http!
GET /api/v1/archive/SimpleChatSession?$select=contact/contactAssociate/otherGroups,contact/NumberOfNotCompletedSalesInPeriod,person/restrictionAddress/line1
