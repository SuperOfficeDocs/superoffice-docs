...
```http!
GET /api/v1/archive/SimpleChatSession?$select=person/hasInterests,person/personAssociate/contactId,person/correspondingAssociate/credentialType,person/consentSourceStore
