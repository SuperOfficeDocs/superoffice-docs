...
```http!
GET /api/v1/archive/SimpleChatSession?$select=person/personUdef/SuperOffice:1,person/personAssociate/personEmail,person/correspondingAssociate/assocName,contact/contactUdef/SuperOffice:6
