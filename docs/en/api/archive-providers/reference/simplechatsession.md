...
```http!
GET /api/v1/archive/SimpleChatSession?$select=associate/isActive,person/hasInterests,person/personAssociate/assocName,person/correspondingAssociate/usergroup,person/legalBaseStore
