...
```http!
GET /api/v1/archive/SimpleChatSession?$select=contact/NumberOfTicketsInPeriod,person/restrictionAddress/addressId,person/personAssociate/portraitThumbnail
