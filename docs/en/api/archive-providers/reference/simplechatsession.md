...
```http!
GET /api/v1/archive/SimpleChatSession?$select=recordTypeText,person/mrMrs,person/correspondingAssociate/assocTooltip,person/hasStoreConsent,person/consentSourceEmarketing
