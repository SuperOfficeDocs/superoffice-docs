...
```http!
GET /api/v1/archive/SimpleChatSession?$select=type,person/leadStatus,person/correspondingAssociate/locationAddress,person/hasEmarketingConsent,contact/category
