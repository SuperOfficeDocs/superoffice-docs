...
```http!
GET /api/v1/archive/SimpleChatSession?$select=person/restrictionAddress/city,person/restrictionAddress/formattedAddress,contact/restrictionAddress/state
