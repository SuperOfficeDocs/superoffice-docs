...
```http!
GET /api/v1/archive/SimpleChatSession?$select=person/mrMrs,person/birthYear,person/personAssociate/usergroup,person/correspondingAssociate/portraitThumbnail,contact/contactAssociate/assocType
