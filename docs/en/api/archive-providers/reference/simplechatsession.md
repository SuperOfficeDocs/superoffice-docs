...
```http!
GET /api/v1/archive/SimpleChatSession?$select=person/personExtra/x_person_user_relation,person/correspondingAssociate/usergroup,person/restrictionAddress/addressId
