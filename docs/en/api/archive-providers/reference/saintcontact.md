...
```http!
GET /api/v1/archive/SaintContact?$select=searchPhone/formattedNumber,streetAddress/line1,contactAssociate/firstName,LastCompletedSale,targetRelation/updatedByFullName
