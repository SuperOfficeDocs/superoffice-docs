...
```http!
GET /api/v1/archive/SaintContact?$select=contactAssociate/ejDisplayName,contactAssociate/portraitThumbnail,NumberOfActivities,sale/associate/contactFullName,appointment/updatedBy
