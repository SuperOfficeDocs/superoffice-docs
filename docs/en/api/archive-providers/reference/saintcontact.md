...
```http!
GET /api/v1/archive/SaintContact?$select=postAddress/county,sale/currency,sale/sale/textId,document/documentPublish/publishedBy,document/associate/assocName
