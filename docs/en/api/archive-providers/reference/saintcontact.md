...
```http!
GET /api/v1/archive/SaintContact?$select=registeredByFullName,contactExtra/x_contact_integer,contactExtra/x_contact_short_dropdown,NumberOfNotCompletedTickets,sale/earningPercent
