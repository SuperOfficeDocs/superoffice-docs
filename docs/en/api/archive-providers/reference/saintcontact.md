...
```http!
GET /api/v1/archive/SaintContact?$select=sale/projectId,sale/amountWeighted,appointment/appointment/internalNotesHtml,personAssociate/assocType,correspondingAssociate/credentialDisplayValue
