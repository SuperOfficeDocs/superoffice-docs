...
```http!
GET /api/v1/archive/SaintContact?$select=url/URLAddress,contactAssociate/usergroup,sale/currencyId,appointment/appointmentPublish/publishedBy,appointment/associate/contactId
