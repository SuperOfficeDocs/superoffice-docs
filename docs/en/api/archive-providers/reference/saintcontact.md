...
```http!
GET /api/v1/archive/SaintContact?$select=restrictionAddress/formattedAddress,contactAssociate/firstName,contactExtra/x_contact_contact_relation,targetRelation/country,appointment/cautionWarning
