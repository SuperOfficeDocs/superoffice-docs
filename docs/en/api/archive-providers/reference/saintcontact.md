...
```http!
GET /api/v1/archive/SaintContact?$select=contactAssociate/personId,LastActivity,targetRelation/hasInfoText,sale/saleUdef/SuperOffice:2,appointment/appointmentUdef/SuperOffice:3
