...
```http!
GET /api/v1/archive/SaintContact?$select=contactAssociate/usergroup,contactUdef/SuperOffice:12,sale/saleUdef/SuperOffice:5,document/documentPublish/publishedTo,personPrivate/formattedNumber
