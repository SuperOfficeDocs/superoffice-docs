...
```http!
GET /api/v1/archive/SaintContact?$select=contactAssociate/ejDisplayName,targetRelation/restrictionContactId,appointment/booking,appointment/associate/contactName,appointment/associate/contactCategory
