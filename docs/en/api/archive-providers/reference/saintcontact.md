...
```http!
GET /api/v1/archive/SaintContact?$select=sourceRelation/orgnr,targetRelation/business,sale/associate/assocName,appointment/updatedDate,appointment/associate/personId
