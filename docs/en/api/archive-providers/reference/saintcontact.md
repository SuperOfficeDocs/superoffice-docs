...
```http!
GET /api/v1/archive/SaintContact?$select=activeErpLinks,contactUdef/SuperOffice:11,appointment/appointmentUdef/SuperOffice:6,document/contactId,document/documentPublish/publishedBy
