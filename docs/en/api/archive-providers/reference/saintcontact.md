...
```http!
GET /api/v1/archive/SaintContact?$select=sale/activeErpLinks,sale/associate/portraitThumbnail,appointment/personId,appointment/registeredBy,appointment/appointmentUdef/SuperOffice:4
