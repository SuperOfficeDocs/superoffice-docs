...
```http!
GET /api/v1/archive/SaintContact?$select=targetRelation/restrictionContactId,appointment/associate/contactId,appointment/associate/contactName,document/ourref,birthYear
