...
```http!
GET /api/v1/archive/SaintContact?$select=email/emailProtocol,sourceRelation/restrictionContactId,sale/userGroup,sale/amountInBaseCurrency,appointment/associate/contactDepartment
