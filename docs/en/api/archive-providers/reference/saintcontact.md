...
```http!
GET /api/v1/archive/SaintContact?$select=restrictionAddress/zip,contactAssociate/isLocation,sourceRelation/contactId,appointment/associate/otherGroups,document/documentUdef/SuperOffice:8
