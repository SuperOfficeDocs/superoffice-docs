...
```http!
GET /api/v1/archive/SaintContact?$select=hasInterests,email/emailDescription,contactUdef/SuperOffice:13,NumberOfNotCompletedSalesInPeriod,sale/stageRank
