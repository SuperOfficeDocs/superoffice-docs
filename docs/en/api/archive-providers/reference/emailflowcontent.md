...
```http!
GET /api/v1/archive/EmailFlowContent?$select=registeredDate,shipment/mailingSelectionId,shipment/emailFlow/thumbnail,shipment/emailFlow/workflowDefinitionStatusId,shipment/emailFlow/hierarchyFullname
