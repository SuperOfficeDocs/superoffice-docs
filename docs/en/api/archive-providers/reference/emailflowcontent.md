...
```http!
GET /api/v1/archive/EmailFlowContent?$select=shipment/emailFlow/thumbnail,shipment/emailFlow/hierarchyName,shipment/project/projectAssociate/contactCategory
