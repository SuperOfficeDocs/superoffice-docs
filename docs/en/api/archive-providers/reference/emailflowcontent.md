...
```http!
GET /api/v1/archive/EmailFlowContent?$select=contentThumbnail,shipment/emailFlow/workflowAssociate/associateDbId,shipment/project/NumberOfNotCompletedSalesInPeriod
