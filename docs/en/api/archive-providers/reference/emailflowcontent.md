...
```http!
GET /api/v1/archive/EmailFlowContent?$select=shipment/mailingSimpleStatus,shipment/emailFlow/workflowAssociate/contactCategory,shipment/project/projectUdef/SuperOffice:8
