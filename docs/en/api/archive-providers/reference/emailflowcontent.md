...
```http!
GET /api/v1/archive/EmailFlowContent?$select=shipment/emailFlow/workflowEnrolledCount,shipment/emailFlow/workflowAssociate/contactName,shipment/project/projectEvent/hasSignOn
