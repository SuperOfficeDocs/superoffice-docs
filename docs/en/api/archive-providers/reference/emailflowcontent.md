...
```http!
GET /api/v1/archive/EmailFlowContent?$select=emailFlow/updatedDate,shipment/project/projectAssociate/firstName,shipment/project/projectUdef/SuperOffice:4,shipment/project/saintSaleStatus
