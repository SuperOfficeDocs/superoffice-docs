...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectEvent/isExternalEvent,projectUdef/SuperOffice:8,sale/saleUdef/SuperOffice:4,document/registeredBy,projectMember/ticketPriority
