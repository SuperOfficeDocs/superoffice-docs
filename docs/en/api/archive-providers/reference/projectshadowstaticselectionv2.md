...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=sale/saleTypeCategory,projectMember/personUdef/SuperOffice:9,projectMember/contactAssociate/assocType,projectMember/contactUdef/SuperOffice:8
