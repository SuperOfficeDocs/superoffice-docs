...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=activeErpLinks,sale/text,projectMember/personAddress/wgs84latitude,projectMember/correspondingAssociate/contactDepartment
