...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/contactId,sale/associate/isActiveText,sale/saleUdef/SuperOffice:4,appointment/associate/middleName,appointment/associate/contactId
