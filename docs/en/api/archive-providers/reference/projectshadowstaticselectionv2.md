...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=LastCompletedActivity,sale/saleId,sale/associate/contactFullName,document/name,projectMember/postAddress/line3
