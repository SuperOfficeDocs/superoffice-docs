...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/personEmail,SaintStatus3,sale/credited,sale/associate/role,appointment/associate/role
