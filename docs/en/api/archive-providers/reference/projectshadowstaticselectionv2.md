...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectUdef/SuperOffice:8,NumberOfSalesInPeriod,appointment/associate/credentialType,projectMember/function,projectMember/postAddress/county
