...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/isActive,sale/time,document/saleId,document/associate/contactId,projectMember/firstName
