...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=hasInfoText,appointment/appointmentUdef/SuperOffice:4,appointment/appointmentUdef/SuperOffice:3
