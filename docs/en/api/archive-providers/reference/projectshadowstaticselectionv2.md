...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectEvent/eventDate,projectUdef/SuperOffice:9,appointment/associate/associateDbId,appointment/appointment/agendaHtml,appointment/appointment/internalNotesHtml
