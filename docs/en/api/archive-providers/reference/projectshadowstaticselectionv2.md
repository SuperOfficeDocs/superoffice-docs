...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=status,LastSale,appointment/location,appointment/associate/contactId,appointment/appointment/titleHtml
