...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/associateDbId,projectAssociate/contactFullName,NumberOfSales,sale/activeErpLinks,appointment/location
