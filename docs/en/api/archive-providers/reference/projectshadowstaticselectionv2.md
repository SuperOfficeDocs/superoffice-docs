...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=sale/visibleFor,sale/salePublish/publishedTo,appointment/recurring,appointment/associate/userName,appointment/appointment/isConverted
