...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=registeredByFullName,projectUrl/URLDescription,appointment/appointment/titleHtml,projectMember/updated,projectMember/email/emailLastBounce
