...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectId,updatedByFullName,sale/associate/title,sale/associate/contactCategory,appointment/saleId
