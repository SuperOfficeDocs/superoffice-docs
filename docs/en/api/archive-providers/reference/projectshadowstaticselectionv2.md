...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=sale/lossReason,appointment/duration,appointment/appointmentUdef/SuperOffice:4,projectMember/orgnr,projectMember/contactUdef/SuperOffice:4
