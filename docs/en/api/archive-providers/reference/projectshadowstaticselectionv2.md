...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=document/who,projectMember/withdrawnEmarketingConsent,appointment/appointmentUdef/SuperOffice:4
