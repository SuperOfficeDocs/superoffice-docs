...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/personEmail,projectUdef/SuperOffice:10,sale/stalledComment,sale/saleNumber,appointment/updatedDate
