...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=sale/originalStage,appointment/associate/contactCategory,projectMember/firstName,projectMember/hasInterests,projectMember/email/emailBounceCount
