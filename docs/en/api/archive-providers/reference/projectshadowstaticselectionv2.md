...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectMember/correspondingAssociate/contactCategory,projectMember/contactNoMail,projectMember/url/URLAddress,projectMember/contactAssociate/ejStatus,projectMember/contactAssociate/credentialType
