...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=imageThumbnail,sale/associate/credentialDisplayValue,appointment/duration,appointment/associate/credentialDisplayValue,document/isReport
