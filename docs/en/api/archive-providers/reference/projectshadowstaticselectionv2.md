...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectPublish/isPublished,sale/saleNumber,appointment/appointmentPublish/publishedTo,projectMember/mrMrs,projectMember/legalBaseStore
