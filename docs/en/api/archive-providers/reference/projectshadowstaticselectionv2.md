...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=saintDirection,appointment/intention,projectMember/personAssociate/contactCategory,projectMember/correspondingAssociate/assocType,projectMember/legalBaseEmarketing
