...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=registeredByFullName,appointment/associate/contactName,projectMember/personAddress/state,projectMember/deletedDate
