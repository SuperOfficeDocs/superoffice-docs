...
```http!
GET /api/v1/archive/ProjectShadowStaticSelectionV2?$select=projectAssociate/firstName,NumberOfNotCompletedSalesInPeriod,sale/amount,appointment/associate/assocType,document/associate/assocName
