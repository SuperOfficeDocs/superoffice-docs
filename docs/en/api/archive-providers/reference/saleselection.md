...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personExtra/x_person_request_relation,contact/hasInfoText,contact/contactPhone/formattedNumber,contact/contactAssociate/role,associate/middleName
