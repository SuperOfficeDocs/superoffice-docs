...
```http!
GET /api/v1/archive/SaleSelection?$select=soldReason,person/birthYear,person/email/emailProtocol,person/personAssociate/middleName,person/personAssociate/isActive
