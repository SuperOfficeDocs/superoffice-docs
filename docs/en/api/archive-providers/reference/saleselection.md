...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personPrivate/formattedNumber,person/personUdef/SuperOffice:4,contact/contactExtra/x_contact_short_dropdown,contact/SaintStatus2,appointment/updatedBy
