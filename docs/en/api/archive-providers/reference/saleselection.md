...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personUpdatedDate,person/personUdef/SuperOffice:4,contact/updatedBy,contact/email/emailLastBounce,contact/contactExtra/x_contact_timespan
