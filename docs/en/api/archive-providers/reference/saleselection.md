...
```http!
GET /api/v1/archive/SaleSelection?$select=person/lastName,person/personDirectPhone/description,contact/restrictionAddress/line2,document/registeredByFullName,document/associate/lastName
