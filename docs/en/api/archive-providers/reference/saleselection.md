...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personId,person/personNoMail,person/personPager/formattedNumber,person/personAddress/formattedAddress,person/personExtra/x_person_integer
