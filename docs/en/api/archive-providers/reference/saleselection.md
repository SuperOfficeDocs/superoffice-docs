...
```http!
GET /api/v1/archive/SaleSelection?$select=source,person/personUpdatedBy,person/personAssociate/usergroup,contact/country,contact/contactUdef/SuperOffice:5
