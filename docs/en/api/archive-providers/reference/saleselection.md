...
```http!
GET /api/v1/archive/SaleSelection?$select=currency,person/restrictionAddress/addressId,person/correspondingAssociate/otherGroups,contact/contactSource,associate/contactFullName
