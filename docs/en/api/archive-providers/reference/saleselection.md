...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personAssociate/isActive,contact/hasInfoText,contact/contactAssociate/lastName,contact/NumberOfTickets,associate/firstName
