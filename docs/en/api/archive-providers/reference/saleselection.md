...
```http!
GET /api/v1/archive/SaleSelection?$select=recordType,reopenDate,person/personAssociateFullName,contact/restrictionAddress/city,contact/contactAssociate/locationAddress
