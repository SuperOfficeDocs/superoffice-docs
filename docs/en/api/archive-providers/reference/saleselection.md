...
```http!
GET /api/v1/archive/SaleSelection?$select=person/restrictionAddress/city,contact/updatedByFullName,contact/restrictionAddress/wgs84latitude,associate/isLocation,appointment/location
