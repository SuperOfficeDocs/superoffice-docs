...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personExtra/x_person_shorttext,person/personAssociate/personEmail,contact/associateId,contact/postAddress/addressId,contact/NumberOfSalesInPeriod
