...
```http!
GET /api/v1/archive/SaleSelection?$select=getNoRows,person/email/emailId,contact/hasInterests,contact/registeredDate,contact/contactExtra/x_contact_float
