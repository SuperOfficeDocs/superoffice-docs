...
```http!
GET /api/v1/archive/SaleSelection?$select=amountWeighted,person/personRegisteredBy,person/personAssociateFullName,person/personAssociate/isLocation,contact/activeErpLinks
