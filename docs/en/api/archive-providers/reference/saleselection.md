...
```http!
GET /api/v1/archive/SaleSelection?$select=contact/hasInterests,contact/countryId,contact/email/emailBounceCount,contact/restrictionAddress/line2,appointment/location
