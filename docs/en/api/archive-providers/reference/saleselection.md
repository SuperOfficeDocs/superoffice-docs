...
```http!
GET /api/v1/archive/SaleSelection?$select=person/restrictionAddress/state,contact/updatedByFullName,contact/contactAssociate/isActive,appointment/associate/contactFullName,document/recordType
