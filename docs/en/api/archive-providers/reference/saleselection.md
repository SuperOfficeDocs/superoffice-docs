...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personCategoryRank,person/whenUpdatedByWorkflow,person/restrictionAddress/city,person/personUdef/SuperOffice:5,contact/streetAddress/zip
