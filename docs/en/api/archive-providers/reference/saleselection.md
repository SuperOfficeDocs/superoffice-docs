...
```http!
GET /api/v1/archive/SaleSelection?$select=person/email/emailBounceCount,person/hasStoreConsent,contact/updatedDate,contact/contactAssociate/contactId,contact/contactExtra/x_contact_integer
