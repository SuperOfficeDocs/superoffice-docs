...
```http!
GET /api/v1/archive/SaleSelection?$select=personId,salePublish/publishedFrom,person/personDeletedDate,person/personPrivate/description,person/personAssociate/assocTooltip
