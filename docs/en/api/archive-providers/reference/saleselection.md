...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personCategoryGroup,person/personAssociate/lastName,contact/NumberOfNotCompletedActivitiesInPeriod,contact/saintAmountClass,appointment/appointment/agendaHtml
