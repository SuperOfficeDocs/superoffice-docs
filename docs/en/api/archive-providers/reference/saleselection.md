...
```http!
GET /api/v1/archive/SaleSelection?$select=person/email/emailProtocol,person/email/emailAddress,person/restrictionAddress/city,person/personUdef/SuperOffice:5,person/personExtra/x_person_boolean
