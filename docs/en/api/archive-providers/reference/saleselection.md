...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personInterestIds,person/personUdef/SuperOffice:8,contact/postAddress/line1,contact/contactExtra/x_contact_longtext,document/saleId
