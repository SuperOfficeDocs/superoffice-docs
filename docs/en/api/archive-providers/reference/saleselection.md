...
```http!
GET /api/v1/archive/SaleSelection?$select=person/personDirectFax/description,contact/email/emailBounceCount,appointment/associate/contactFullName,document/updatedBy,project/type
