...
```http!
GET /api/v1/archive/SaleSelection?$select=saleTypeCategory,person/correspondingAssociate/lastName,contact/contactUdef/SuperOffice:3,saleStakeholder/person/personInfo/textId,saleStakeholder/person/isMailingRecipient
