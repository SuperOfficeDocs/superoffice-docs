...
```http!
GET /api/v1/archive/SaleSelection?$select=date,person/birthMonth,contact/contactExtra/x_contact_contact_relation,contact/NumberOfNotCompletedTicketsInPeriod,project/project/textId
