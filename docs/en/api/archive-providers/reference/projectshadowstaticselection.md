...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=updatedByFullName,projectEvent/hasSignOn,sale/updatedDate,appointment/completedDate,appointment/associate/credentialDisplayValue
