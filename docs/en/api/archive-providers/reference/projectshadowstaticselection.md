...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectAssociate/middleName,appointment/time,document/associate/lastName,document/associate/mrMrs,document/associate/assocType
