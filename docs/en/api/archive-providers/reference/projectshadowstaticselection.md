...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=sale/completed,appointment/invitedPersonId,appointment/associate/contactName,projectMember/personExtra/x_person_shorttext
