...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=sale/amountWeighted,sale/associate/userName,sale/saleUdef/SuperOffice:7,projectMember/personHasInterests,projectMember/personAddress/zip
