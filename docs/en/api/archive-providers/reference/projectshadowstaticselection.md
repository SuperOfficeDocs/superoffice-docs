...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=appointment/endTime,appointment/associate/associateDbId,appointment/associate/contactFullName,projectMember/NumberOfActivities
