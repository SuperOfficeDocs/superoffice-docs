...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=LastSale,sale/soldReason,appointment/associate/credentialType,appointment/associate/isActive,document/icon
