...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=NumberOfNotCompletedActivities,appointment/associate/isLocation,document/associate/usergroup,projectMember/leadStatus,projectMember/mainContact
