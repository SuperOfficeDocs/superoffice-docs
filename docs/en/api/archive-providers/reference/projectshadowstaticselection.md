...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=NumberOfSales,NumberOfNotCompletedSales,sale/who,appointment/associate/contactName,appointment/associate/assocType
