...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=hasInfoText,endDate,document/associate/portraitThumbnail,projectMember/firstName,projectMember/personCountry
