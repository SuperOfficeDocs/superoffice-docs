...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=appointment/associate/isLocation,document/subject,projectMember/hasCompany,projectMember/personAddress/addressId,projectMember/NumberOfTickets
