...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectAssociate/ejDisplayName,sale/reopenDate,appointment/who,document/documentPublish/publishedTo,projectMember/personAddress/county
