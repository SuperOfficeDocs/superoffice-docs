...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=type,projectAssociate/contactId,NumberOfNotCompletedActivitiesInPeriod,sale/earning,appointment/associate/role
