...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=LastDoBySale,sale/saleUdef/SuperOffice:5,appointment/icon,projectMember/department,projectMember/contactAssociate/usergroup
