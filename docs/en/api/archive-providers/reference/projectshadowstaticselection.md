...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectId,projectAssociate/personEmail,sale/associate/assocType,projectMember/contactExtra/x_contact_dropdown
