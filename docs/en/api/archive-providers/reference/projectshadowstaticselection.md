...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=LastDoByActivity,appointment/recordTypeText,document/ourref,document/associate/associateDbId,document/associate/contactCategory
