...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectAssociate/contactId,document/subject,projectMember/personUdef/SuperOffice:3,projectMember/orgnr,projectMember/contactUdef/SuperOffice:1
