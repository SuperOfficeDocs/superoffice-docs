---
uid: ProjectShadowStaticSelection
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.ProjectShadowSelectionStaticProvider">SuperOffice.CRM.ArchiveLists.Archive.ProjectShadowSelectionStaticProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=registeredBy,projectMember/supportAssociate,projectMember/searchPhone/description,projectMember/personExtra/x_person_hidden_integer,projectMember/contactAssociate/contactCategory
