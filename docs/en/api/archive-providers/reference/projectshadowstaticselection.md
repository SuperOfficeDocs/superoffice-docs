...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=status,sale/currency,appointment/userGroup,document/recordTypeText,projectMember/useAsMailingAddress
