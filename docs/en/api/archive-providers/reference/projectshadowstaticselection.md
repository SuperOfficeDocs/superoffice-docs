...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectAssociate/contactId,sale/projectId,appointment/appointment/description,projectMember/retired,projectMember/personExtra/x_person_integer
