...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=document/documentId,document/associate/personEmail,projectMember/correspondingAssociate/credentialDisplayValue
