...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=sale/amount,appointment/appointmentPublish/publishedTo,appointment/associate/isActive,document/icon,document/documentUdef/SuperOffice:4
