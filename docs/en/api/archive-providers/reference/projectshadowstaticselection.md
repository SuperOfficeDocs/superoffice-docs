...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=document/updatedBy,projectMember/ticketPriority,projectMember/updatedByWorkflow,projectMember/personExtra/x_person_float,projectMember/correspondingAssociate/firstName
