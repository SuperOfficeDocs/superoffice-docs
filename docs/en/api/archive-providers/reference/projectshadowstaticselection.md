...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=getAllRows,sale/updatedDate,sale/associate/usergroupId,sale/associate/ejStatus,document/associate/locationAddress
