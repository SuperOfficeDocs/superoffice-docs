...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectUdef/SuperOffice:8,sale/saleType,sale/associate/ejUserId,projectMember/personInfo/textId,projectMember/email/emailAddress
