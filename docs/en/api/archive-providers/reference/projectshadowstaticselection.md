...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=projectEvent/hasSignOn,sale/associateId,sale/saleTypeCategory,document/associate/middleName,projectMember/correspondingAssociate/credentialType
