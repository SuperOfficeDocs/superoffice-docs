...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=number,sale/contactId,appointment/appointmentId,projectMember/correspondingAssociate/contactName,projectMember/number
