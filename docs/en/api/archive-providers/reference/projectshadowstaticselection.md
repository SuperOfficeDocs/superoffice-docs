...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=appointment/time,appointment/associate/title,document/associate/contactName,projectMember/restrictionAddress/state,projectMember/postAddress/state
