...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=updatedDate,projectAssociate/locationAddress,sale/reopenDate,sale/associate/fullName,document/associate/ejDisplayName
