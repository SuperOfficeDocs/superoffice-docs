...
```http!
GET /api/v1/archive/ProjectShadowStaticSelection?$select=sale/icon,appointment/appointment/internalNotesHtml,projectMember/personUpdatedDate,projectMember/personExtra/y_rental/x_end
