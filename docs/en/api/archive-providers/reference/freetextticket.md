...
```http!
GET /api/v1/archive/FreetextTicket?$select=author,firstReadByUser,person/rank,person/personExtra/y_rental/y_equipment/x_name,contact/contactPhone/formattedNumber
