...
```http!
GET /api/v1/archive/FreetextTicket?$select=firstReadByUser,ownedBy/ejUserId,person/personExtra/x_person_hidden_integer,contact/contactExtra/x_contact_request_relation,sale/associate/lastName
