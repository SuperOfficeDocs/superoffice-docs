...
```http!
GET /api/v1/archive/FreetextTicket?$select=realTimeToClose,person/personUdef/SuperOffice:9,person/personAssociate/contactCategory,person/isMailingRecipient,contact/email/emailBounceCount
