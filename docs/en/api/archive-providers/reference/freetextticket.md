...
```http!
GET /api/v1/archive/FreetextTicket?$select=readStatus,person/email/emailLastBounce,contact/searchPhone/formattedNumber,sale/salePublish/publishedFrom,sale/associate/otherGroups
