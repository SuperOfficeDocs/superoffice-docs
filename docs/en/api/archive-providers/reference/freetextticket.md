...
```http!
GET /api/v1/archive/FreetextTicket?$select=saleId,origin,person/personCategory,person/restrictionAddress/formattedMultiLineAddress,contact/streetAddress/addressId
