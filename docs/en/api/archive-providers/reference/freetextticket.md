...
```http!
GET /api/v1/archive/FreetextTicket?$select=ticketId,person/createdByForm,person/personExtra/x_person_timespan,contact/searchPhone/description,contact/contactAssociate/fullName
