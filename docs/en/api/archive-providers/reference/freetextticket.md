...
```http!
GET /api/v1/archive/FreetextTicket?$select=person/hasCompany,person/correspondingAssociate/isActive,contact/contactFax/description,contact/LastTicket,contact/saintTicketCategory
