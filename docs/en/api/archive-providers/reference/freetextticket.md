...
```http!
GET /api/v1/archive/FreetextTicket?$select=closedAt,person/correspondingAssociate/personEmail,contact/contactUdef/SuperOffice:8,sale/stageName,sale/salePublish/publishedTo
