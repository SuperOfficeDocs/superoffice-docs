...
```http!
GET /api/v1/archive/FreetextTicket?$select=ticketId,ownedBy/firstName,person/personUrl/URLAddress,person/personUdef/SuperOffice:1,person/personExtra/x_person_shorttext
