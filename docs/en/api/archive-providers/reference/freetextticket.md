...
```http!
GET /api/v1/archive/FreetextTicket?$select=has_attachment,person/personAssociate/contactName,contact/contactNoMail,contact/email/emailAddress,contact/url/URLDescription
