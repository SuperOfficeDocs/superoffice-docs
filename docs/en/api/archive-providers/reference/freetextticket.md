...
```http!
GET /api/v1/archive/FreetextTicket?$select=realTimeSpentInternally,suggestedCategory,ownedBy/contactFullName,person/personRegisteredDate,person/correspondingAssociate/fullName
