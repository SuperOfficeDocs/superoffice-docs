...
```http!
GET /api/v1/archive/FreetextTicket?$select=ownedBy/contactId,person/personDirectFax/formattedNumber,person/personExtra/x_person_integer,contact/LastTicket,sale/registeredDate
