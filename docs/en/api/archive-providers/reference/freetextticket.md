...
```http!
GET /api/v1/archive/FreetextTicket?$select=person/personAssociateFullName,contact/restrictionAddress/state,contact/contactAssociate/fullName,contact/NumberOfSalesInPeriod,contact/saintDirection
