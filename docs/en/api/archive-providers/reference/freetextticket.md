...
```http!
GET /api/v1/archive/FreetextTicket?$select=realTimeSpentExternally,createdBy/ejUserId,ownedBy/assocType,person/personRegisteredBy,person/restrictionAddress/formattedAddress
