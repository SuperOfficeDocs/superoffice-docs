...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.FreetextTicketResultProvider">SuperOffice.CRM.ArchiveLists.FreetextTicketResultProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/FreetextTicket?$select=createdBy/usergroup,person/personInfo/textId,person/personAssociate/contactFullName,person/personAssociate/locationAddress,person/correspondingAssociate/associateDbId
