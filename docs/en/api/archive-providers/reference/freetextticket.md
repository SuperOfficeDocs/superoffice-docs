...
```http!
GET /api/v1/archive/FreetextTicket?$select=person/personActiveErpLinks,person/personAssociate/personId,contact/phone/formattedNumber,contact/SaintStatus1,sale/source
