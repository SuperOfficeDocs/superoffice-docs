...
```http!
GET /api/v1/archive/FreetextTicket?$select=createdBy,ownedBy/usergroup,person/personExtra/x_person_priority_relation,person/correspondingAssociate/title,contact/contactExtra/x_contact_float
