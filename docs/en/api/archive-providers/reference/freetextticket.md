...
```http!
GET /api/v1/archive/FreetextTicket?$select=sentimentConfidence,person/supportAssociateFullName,person/personAssociate/contactId,person/personAssociate/isActiveText
