...
```http!
GET /api/v1/archive/FreetextTicket?$select=ownedBy/otherGroups,person/personUdef/SuperOffice:5,person/correspondingAssociate/personEmail,contact/countryId,contact/contactAssociate/fullName
