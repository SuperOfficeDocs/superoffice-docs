...
```http!
GET /api/v1/archive/FreetextTicket?$select=person/email/emailLastBounce,person/personExtra/y_rental/id,person/personAssociate/personId,sale/saleStatus,sale/reopenDate
