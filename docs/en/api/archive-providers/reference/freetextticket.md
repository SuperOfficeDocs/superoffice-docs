...
```http!
GET /api/v1/archive/FreetextTicket?$select=person/title,person/personActiveErpLinks,person/personAddress/wgs84longitude,contact/email/emailId,contact/contactAssociate/ejStatus
