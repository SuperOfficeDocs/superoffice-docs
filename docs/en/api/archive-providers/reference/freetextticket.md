...
```http!
GET /api/v1/archive/FreetextTicket?$select=createdBy/ejDisplayName,contact/contactAssociate/associateDbId,contact/contactAssociate/ejStatus,contact/contactUdef/SuperOffice:11,sale/currencyId
