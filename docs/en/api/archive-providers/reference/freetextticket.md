...
```http!
GET /api/v1/archive/FreetextTicket?$select=createdBy/assocName,person/firstName,person/fullName,person/correspondingAssociate/ejDisplayName,person/legalBaseStore
