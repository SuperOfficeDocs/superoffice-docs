...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=NumberOfActivitiesInPeriod,sourceRelation/updatedBy,sale/associate/fullName,appointment/associateId,appointment/associate/isActive
