...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=phone/formattedNumber,streetAddress/wgs84latitude,contactAssociate/usergroupId,sale/stalledComment,sale/saleUdef/SuperOffice:7
