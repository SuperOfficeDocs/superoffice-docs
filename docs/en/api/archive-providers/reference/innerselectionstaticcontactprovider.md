...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactExtra/x_contact_datetime,sourceRelation/hasInfoText,document/associate/contactCategory,whenUpdatedByWorkflow
