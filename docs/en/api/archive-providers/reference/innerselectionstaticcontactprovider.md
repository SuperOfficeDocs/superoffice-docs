...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=url/URLAddress,contactExtra/x_contact_boolean,sale/amount,appointment/associate/otherGroups,personUdef/SuperOffice:11
