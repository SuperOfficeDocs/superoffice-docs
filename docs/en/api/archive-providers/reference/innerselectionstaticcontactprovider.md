...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=sale/projectId,sale/associate/ejUserId,appointment/associate/simultaneousEjUser,document/text,document/isMail
