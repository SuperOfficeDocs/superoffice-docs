...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactAssociate/contactFullName,sourceRelation/countryId,sourceRelation/registeredByFullName,sale/stageName,appointment/associate/fullName
