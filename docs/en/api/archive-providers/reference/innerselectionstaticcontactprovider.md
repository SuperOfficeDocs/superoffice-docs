...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=targetRelation/name,sale/projectId,sale/visibleFor,document/associate/isActive,personUpdatedByFullName
