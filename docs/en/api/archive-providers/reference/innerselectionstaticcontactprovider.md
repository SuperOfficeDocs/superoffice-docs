...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=sale/who,sale/updatedByFullName,sale/registeredDate,sale/associate/isActiveText,appointment/recordTypeText
