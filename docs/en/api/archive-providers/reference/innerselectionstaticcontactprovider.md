...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactPhone/description,searchPhone/formattedNumber,contactExtra/x_contact_date,sourceRelation/associateId,sale/associate/assocType
