...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactAssociate/isActive,contactExtra/x_contact_dropdown,sale/updatedDate,appointment/recordTypeText
