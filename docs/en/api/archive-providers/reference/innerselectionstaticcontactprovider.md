...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=code,contactAssociate/personId,contactAssociate/isActiveText,contactExtra/x_contact_request_relation,targetRelation/nameDepartment
