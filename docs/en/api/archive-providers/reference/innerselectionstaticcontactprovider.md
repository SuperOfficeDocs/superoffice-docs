...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=postAddress/formattedAddress,sourceRelation/countryId,targetRelation/name,appointment/priority,appointment/associate/title
