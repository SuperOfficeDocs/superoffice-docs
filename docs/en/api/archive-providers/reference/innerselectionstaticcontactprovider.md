...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactAssociate/mrMrs,contactAssociate/contactFullName,appointment/updatedByFullName,appointment/suggestedAppointmentId,legalBaseStore
