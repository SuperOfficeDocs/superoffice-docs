...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=who,contactExtra/x_contact_float,sale/registeredBy,appointment/text,appointment/associate/fullName
