...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactPhone/formattedNumber,contactAssociate/contactName,contactUdef/SuperOffice:7,appointment/associate/fullName
