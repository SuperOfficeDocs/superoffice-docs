...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=country,email/emailId,restrictionAddress/city,contactAssociate/associateDbId,sale/hasQuote
