...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=hasInterests,sale/earning,sale/associate/credentialDisplayValue,sale/associate/isActiveText,appointment/associate/associateDbId
