...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactExtra/x_contact_time,appointment/location,appointment/associate/otherGroups,document/associate/assocType
