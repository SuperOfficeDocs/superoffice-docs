...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=postAddress/city,postAddress/zip,targetRelation/activeErpLinks,appointment/associate/middleName,document/associate/simultaneousEjUser
