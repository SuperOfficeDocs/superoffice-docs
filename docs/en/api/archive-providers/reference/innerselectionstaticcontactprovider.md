...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=contactAssociate/assocTooltip,document/associate/ejDisplayName,associateType,personExtra/x_person_hidden_integer
