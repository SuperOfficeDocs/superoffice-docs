...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=email/emailAddress,restrictionAddress/formattedMultiLineAddress,sourceRelation/stop,sourceRelation/contactDeleted,targetRelation/number
