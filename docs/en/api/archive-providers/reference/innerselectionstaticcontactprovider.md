...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=orgnr,NumberOfNotCompletedSalesInPeriod,sale/saleId,appointment/projectId,appointment/rawType
