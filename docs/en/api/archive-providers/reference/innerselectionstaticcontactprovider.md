...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=nameDepartment,restrictionAddress/wgs84latitude,appointment/associate/otherGroups,personExtra/x_person_longtext
