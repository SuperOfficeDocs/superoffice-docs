...
```http!
GET /api/v1/archive/InnerSelectionStaticContactProvider?$select=email/emailLastSent,sourceRelation/nameDepartment,targetRelation/updatedByFullName,sale/currency,sale/sale/description
