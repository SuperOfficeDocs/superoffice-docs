...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/streetAddress/addressId,contact/contactAssociate/portraitThumbnail,person/title,person/personCountryId,person/personInfo/textId
