...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/email/emailBounceCount,contact/streetAddress/zip,contact/contactAssociate/ejStatus,person/personInfo/textId,person/personAddress/line1
