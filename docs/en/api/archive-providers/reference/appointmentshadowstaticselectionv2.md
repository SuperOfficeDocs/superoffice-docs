...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/companyCategoryRank,contact/updatedBy,person/personCountryId,person/personRegisteredByFullName,person/updatedByWorkflow
