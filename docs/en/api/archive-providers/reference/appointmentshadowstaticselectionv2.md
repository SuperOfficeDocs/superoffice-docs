...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=person/hasEmarketingConsent,project/hasGuide,project/projectAssociate/assocType,sale/earning,sale/salePublish/isPublished
