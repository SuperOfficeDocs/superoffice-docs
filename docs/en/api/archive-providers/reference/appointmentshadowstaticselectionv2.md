...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=projectId,person/email/emailHasBounced,person/personAddress/formattedAddress,person/personAssociate/associateDbId,person/personAssociate/locationAddress
