...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/contactNoMail,contact/streetAddress/addressId,contact/streetAddress/line2,contact/streetAddress/city
