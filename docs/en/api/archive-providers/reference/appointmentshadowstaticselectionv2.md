...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=appointmentPublish/isPublished,contact/hasInfoText,contact/updatedDate,contact/searchPhone/formattedNumber,contact/email/emailProtocol
