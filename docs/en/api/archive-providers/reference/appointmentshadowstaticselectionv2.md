...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=who,location,contact/streetAddress/formattedMultiLineAddress,person/kanaFirstName,person/personUpdatedByFullName
