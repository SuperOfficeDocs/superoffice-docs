...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/contactAssociate/role,contact/contactAssociate/ejUserId,person/personDirectPhone/description,project/name,project/projectAssociate/credentialType
