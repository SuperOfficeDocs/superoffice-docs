...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=appointmentId,contact/postAddress/formattedAddress,contact/saintAmountClass,person/associateType,person/restrictionAddress/county
