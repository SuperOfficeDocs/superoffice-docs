...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=endDate,cautionWarning,contact/updatedDate,contact/contactAssociate/contactDepartment,contact/contactExtra/x_contact_request_relation
