...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=text,contact/email/emailProtocol,contact/email/emailBounceCount,person/restrictionAddress/county,person/personUdef/SuperOffice:6
