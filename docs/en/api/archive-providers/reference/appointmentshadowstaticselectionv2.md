...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/contactUdef/SuperOffice:11,contact/NumberOfNotCompletedTicketsInPeriod,person/personMobilePhone/description,person/personPager/formattedNumber,person/restrictionAddress/zip
