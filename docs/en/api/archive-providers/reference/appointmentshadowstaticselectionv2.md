...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/category,person/personExtra/x_person_longtext,person/personAssociate/isActive,project/projectAssociate/contactDepartment
