...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=person/personInfo/infoText,person/correspondingAssociate/title,sale/associate/assocType,associate/contactName
