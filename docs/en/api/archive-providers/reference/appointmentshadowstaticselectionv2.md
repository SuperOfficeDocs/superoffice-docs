...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=recurrenceRuleId,endTime,contact/name,contact/postAddress/city,contact/contactAssociate/ejUserId
