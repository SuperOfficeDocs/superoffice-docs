...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=registeredByFullName,recurrenceRuleId,contact/contactExtra/x_contact_contact,person/ticketPriority,person/personExtra/x_person_boolean
