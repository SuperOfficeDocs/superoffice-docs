...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/NumberOfNotCompletedTicketsInPeriod,person/legalBaseEmarketing,project/projectAssociate/personEmail,associate/ejUserId
