...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/registeredDate,contact/postAddress/zip,contact/saintAmountClass,contact/saintDirection,person/contactId
