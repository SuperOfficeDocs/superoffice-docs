...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=cautionWarning,contact/contactAssociate/usergroup,person/associateType,person/birthMonth,person/email/emailLastBounce
