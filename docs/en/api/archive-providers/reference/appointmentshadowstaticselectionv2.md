...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=intention,appointmentPublish/publishedBy,contact/associateId,contact/deletedDate,contact/email/emailBounceCount
