...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/email/emailLastBounce,contact/postAddress/city,person/birthdate,person/restrictionAddress/line2,person/personAssociate/otherGroups
