...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=getAllRows,cautionWarning,person/email/emailBounceCount,sale/associate/ejDisplayName,sale/associate/personEmail
