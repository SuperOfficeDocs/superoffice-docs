...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/contactFax/formattedNumber,contact/contactExtra/x_contact_float,person/personNoMail,person/personAssociate/isActive,sale/personId
