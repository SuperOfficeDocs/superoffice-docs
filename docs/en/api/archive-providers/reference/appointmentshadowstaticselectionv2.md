...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/contactAssociate/role,contact/contactUdef/SuperOffice:3,person/isProjectMember,sale/updatedDate,sale/associate/associateDbId
