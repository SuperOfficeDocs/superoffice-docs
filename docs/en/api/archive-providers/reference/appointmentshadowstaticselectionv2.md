...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=duration,contact/postAddress/line1,person/title,person/personDirectPhone/description,person/correspondingAssociate/credentialDisplayValue
