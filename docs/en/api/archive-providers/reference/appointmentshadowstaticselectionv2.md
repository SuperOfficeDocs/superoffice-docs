...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelectionV2?$select=contact/category,contact/contactAssociate/ejDisplayName,person/personNumber,sale/updatedBy
