...
```http!
GET /api/v1/archive/QuoteLineSelectionCombined?$select=quoteLineId,registeredBy,alternative/version/extraField5,alternative/version/quote/sale/stageName,alternative/version/quote/sale/person/personAssociate/personId
