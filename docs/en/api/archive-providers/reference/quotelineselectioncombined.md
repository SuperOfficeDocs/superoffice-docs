...
```http!
GET /api/v1/archive/QuoteLineSelectionCombined?$select=subscriptionQuantity,alternative/description,alternative/vatInfo,alternative/version/quote/sale/contactId,alternative/version/quote/sale/person/birthYear
