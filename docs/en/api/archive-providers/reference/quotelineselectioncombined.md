...
```http!
GET /api/v1/archive/QuoteLineSelectionCombined?$select=alternative/version/quote/sale/person/personInfo/textId,alternative/version/quote/sale/contact/restrictionAddress/addressId,alternative/version/quote/sale/contact/contactExtra/x_contact_timespan
