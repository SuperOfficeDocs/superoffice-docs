...
```http!
GET /api/v1/archive/QuoteLineSelectionCombined?$select=alternative/totalPrice,alternative/version/quote/sale/person/personExtra/x_person_longtext,alternative/version/quote/sale/contact/SaintStatus1
