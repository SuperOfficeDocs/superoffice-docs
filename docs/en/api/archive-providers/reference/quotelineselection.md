...
```http!
GET /api/v1/archive/QuoteLineSelection?$select=name,targetRecordId,alternative/version/sent,alternative/version/quote/sale/person/personAddress/state,alternative/version/quote/sale/person/personUdef/SuperOffice:3
