...
```http!
GET /api/v1/archive/QuoteLineSelection?$select=subscriptionUnit,alternative/version/quote/sale/contact/NumberOfTickets,alternative/version/quote/sale/project/projectAssociate/credentialType
