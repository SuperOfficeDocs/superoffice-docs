---
uid: QuoteLineSelection
title: QuoteLineSelection
description: This is the archive Provider for the Selection QuoteLine archive.
keywords: QuoteLineSelection archive provider
so.generated: true
so.topic: reference
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.QuoteLineSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.QuoteLineSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/QuoteLineSelection?$select=alternative/version/quote/sale/person/kanaLastName,alternative/version/quote/sale/person/correspondingAssociate/contactDepartment,alternative/version/quote/sale/contact/contactExtra/x_contact_datetime,alternative/version/quote/sale/project/projectEvent/isExternalEvent,alternative/version/quote/sale/project/projectAssociate/associateDbId
