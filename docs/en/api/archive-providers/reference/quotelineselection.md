...
```http!
GET /api/v1/archive/QuoteLineSelection?$select=targetRecordId,alternative/version/quote/sale/contact/contactAssociate/contactId,alternative/version/quote/sale/person/personAddress/zip
