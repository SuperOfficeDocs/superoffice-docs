...
```http!
GET /api/v1/archive/QuoteLineSelection?$select=erpProductKey,alternative/version/quote/sale/person/isMailingRecipient,alternative/version/quote/sale/contact/searchPhone/formattedNumber
