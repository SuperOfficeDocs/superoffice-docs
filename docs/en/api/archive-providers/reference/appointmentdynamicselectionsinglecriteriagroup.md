...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=associateId,updatedByFullName,createdByWorkflow,contact/streetAddress/state,contact/LastDoBySale
