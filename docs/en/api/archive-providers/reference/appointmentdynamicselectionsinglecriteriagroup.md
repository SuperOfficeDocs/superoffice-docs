...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=appointmentId,completedDate,isMilestone,contact/contactAssociate/assocType,contact/contactAssociate/ejStatus
