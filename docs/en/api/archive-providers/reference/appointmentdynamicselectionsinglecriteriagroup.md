...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=date,contact/deletedDate,contact/mainContact,contact/contactAssociate/otherGroups,contact/contactExtra/x_contact_float
