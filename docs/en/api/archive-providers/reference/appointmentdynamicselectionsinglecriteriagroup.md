...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=text,contact/stop,person/personSource,person/birthMonth,person/personUrl/URLDescription
