...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=contact/hasInfoText,person/position,person/retired,person/personAssociate/portraitThumbnail,associate/contactCategory
