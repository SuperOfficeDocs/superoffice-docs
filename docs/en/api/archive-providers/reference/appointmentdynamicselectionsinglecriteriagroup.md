...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=contact/forceCompany,person/personUpdatedBy,person/ticketPriority,person/personInterestIds,project/projectAssociate/ejUserId
