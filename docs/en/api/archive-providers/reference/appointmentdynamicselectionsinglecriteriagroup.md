...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=registeredBy,duration,contact/email/emailLastSent,contact/restrictionAddress/addressId,contact/NumberOfNotCompletedActivities
