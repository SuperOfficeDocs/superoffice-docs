...
|skipTentativeAndRejectedRestriction|bool|SR\_FINDACTIVITY\_SKIPTENT: SR\_FINDACTIVITY\_SKIPTENT\_TOOLTIP|  |
...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=saleId,contact/categoryGroup,contact/restrictionAddress/wgs84latitude,person/birthDay,associate/credentialType
