...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=recordType,contact/updatedBy,person/kanaFirstName,person/personUdef/SuperOffice:11,person/personAssociate/title
