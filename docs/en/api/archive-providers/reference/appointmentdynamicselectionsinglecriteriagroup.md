...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=duration,contact/streetAddress/formattedMultiLineAddress,contact/saintTicketCategory,person/restrictionAddress/city,appointmentUdef/SuperOffice:8
