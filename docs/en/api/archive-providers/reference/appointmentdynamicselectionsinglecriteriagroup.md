...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=contact/restrictionAddress/addressId,person/personDeletedDate,project/projectUdef/SuperOffice:3,associate/isActiveText
