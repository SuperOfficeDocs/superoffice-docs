...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=registeredDate,contact/email/emailProtocol,contact/contactAssociate/associateDbId,contact/contactAssociate/contactCategory,contact/contactAssociate/assocTooltip
