...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=person/birthMonth,person/personAssociateFullName,person/personInterestIds,project/projectAssociate/contactId,associate/ejDisplayName
