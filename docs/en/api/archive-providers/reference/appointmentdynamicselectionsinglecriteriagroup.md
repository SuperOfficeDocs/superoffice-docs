...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=skipTentativeAndRejectedRestriction,person/personRegisteredDate,person/isMailingRecipient,project/projectUrl/URLDescription,sale/salePublish/publishedBy
