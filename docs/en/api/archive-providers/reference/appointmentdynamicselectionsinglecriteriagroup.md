...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/fullName,person/correspondingAssociate/contactDepartment,sale/saleId,associate/isActiveText
