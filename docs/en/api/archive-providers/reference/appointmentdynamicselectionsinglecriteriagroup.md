...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=recordType,person/correspondingAssociate/associateDbId,sale/saleType,sale/saleUdef/SuperOffice:8
