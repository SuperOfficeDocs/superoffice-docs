...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionSingleCriteriaGroup?$select=contact/contactUdef/SuperOffice:3,sale/associate/contactFullName,person/contactId
