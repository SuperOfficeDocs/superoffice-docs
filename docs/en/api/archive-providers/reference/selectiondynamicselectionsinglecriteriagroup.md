...
```http!
GET /api/v1/archive/SelectionDynamicSelectionSingleCriteriaGroup?$select=selectionAssociate/locationAddress,lastMembershipChange,selectionAssociate/contactId
