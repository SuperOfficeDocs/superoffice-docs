...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=mailingSent,mailingAddr/person/personUpdatedBy,associate/credentialDisplayValue,associate/userName,emailFlow/workflowAssociate/mrMrs
