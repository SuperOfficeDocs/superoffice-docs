...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=mailingAddr/contact/phone/formattedNumber,mailingAddr/contact/contactInterestIds,mailingAddr/person/ticketPriority,mailingAddr/person/personAssociate/firstName,mailingAddr/person/consentSourceStore
