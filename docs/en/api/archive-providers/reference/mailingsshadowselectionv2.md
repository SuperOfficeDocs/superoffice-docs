...
```http!
GET /api/v1/archive/MailingsShadowSelectionV2?$select=mailingAddr/person/personCountryId,mailingAddr/person/birthdate,mailingAddr/person/leadstatusRank,mailingAddr/person/isProjectMember,mailingAddr/person/email/emailProtocol
