...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/business,mailingAddr/contact/activeErpLinks,mailingAddr/contact/postAddress/county,mailingAddr/contact/contactExtra/x_contact_shorttext,mailingAddr/person/leadstatusRank
