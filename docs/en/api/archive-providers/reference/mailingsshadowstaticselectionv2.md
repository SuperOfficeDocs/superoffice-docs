...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/person/personExtra/x_person_datetime,associate/assocType,project/projectAssociate/isActiveText
