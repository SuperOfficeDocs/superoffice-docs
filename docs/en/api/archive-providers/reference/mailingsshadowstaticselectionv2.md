...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingReplyTo,mailingAddr/contact/registeredBy,mailingAddr/person/personRegisteredDate,mailingAddr/person/personAssociateId,mailingAddr/person/personUrl/URLAddress
