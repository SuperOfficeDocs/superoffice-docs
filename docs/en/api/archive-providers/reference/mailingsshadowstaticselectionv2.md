...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/contactAssociate/assocName,mailingAddr/person/hasCompany,emailFlow/shipmentType
