...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/person/correspondingAssociate/personId,emailFlow/workflowAssociate/role,mailingAddr/contact/saintIntention
