...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingBounceRate,mailingAddr/person/middleName,mailingAddr/person/correspondingAssociate/credentialDisplayValue
