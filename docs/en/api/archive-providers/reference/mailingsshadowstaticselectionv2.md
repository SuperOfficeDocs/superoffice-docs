...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/person/personAddress/state,project/hasGuide,project/projectAssociate/mrMrs,project/NumberOfActivitiesInPeriod
