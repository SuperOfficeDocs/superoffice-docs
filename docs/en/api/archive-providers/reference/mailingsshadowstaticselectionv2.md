...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=registeredBy,mailingAddr/person/retired,mailingAddr/person/email/emailDescription,mailingAddr/person/personUrl/URLAddress,mailingAddr/person/personExtra/x_person_shorttext
