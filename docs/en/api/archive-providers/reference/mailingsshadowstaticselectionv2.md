...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/NumberOfActivities,mailingAddr/person/updatedByWorkflow,emailFlow/emailFlowId,project/registeredDate
