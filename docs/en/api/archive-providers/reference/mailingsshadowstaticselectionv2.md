...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/department,mailingAddr/contact/email/emailProtocol,mailingAddr/contact/LastCompletedActivity
