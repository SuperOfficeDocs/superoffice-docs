...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingAddr/contact/contactAssociate/firstName,mailingAddr/person/personExtra/x_person_hidden_integer,mailingAddr/person/personAssociate/assocTooltip,mailingAddr/person/correspondingAssociate/personId,associate/role
