...
```http!
GET /api/v1/archive/MailingsShadowStaticSelectionV2?$select=mailingBounceRate,mailingAddr/contact/postAddress/line2,mailingAddr/person/personRegisteredBy,project/projectAssociate/ejUserId
