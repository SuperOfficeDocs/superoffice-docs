...
```http!
GET /api/v1/archive/EmailAddress?$select=emailLastSent,personRegisteredBy,personContact/associateId,personContact/stop,personContact/streetAddress/line3
