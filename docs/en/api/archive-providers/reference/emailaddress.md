...
```http!
GET /api/v1/archive/EmailAddress?$select=personContact/contactNoMail,personContact/postAddress/county,contactSupportPerson/personUdef/SuperOffice:6,contactSupportPerson/personExtra/y_rental/x_end
