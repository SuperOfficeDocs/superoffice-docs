...
```http!
GET /api/v1/archive/EmailAddress?$select=personContact/restrictionAddress/state,contactSupportPerson/hasInfoText,contactSupportPerson/personRegisteredByFullName,contactExtra/x_contact_shorttext
