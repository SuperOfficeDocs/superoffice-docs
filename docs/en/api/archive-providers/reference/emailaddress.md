...
```http!
GET /api/v1/archive/EmailAddress?$select=personContact/postAddress/addressId,personContact/postAddress/wgs84latitude,streetAddress/line3,streetAddress/city,contactAssociate/ejUserId
