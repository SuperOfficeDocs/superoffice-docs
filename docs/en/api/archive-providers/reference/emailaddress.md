...
```http!
GET /api/v1/archive/EmailAddress?$select=middleName,contactSupportPerson/birthdate,contactExtra/x_contact_float,contactExtra/x_contact_contact,NumberOfTicketsInPeriod
