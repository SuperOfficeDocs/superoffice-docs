...
```http!
GET /api/v1/archive/EmailAddress?$select=contactAssociate/ejStatus,contactSupportAssociate/associateDbId,contactSupportPerson/personCategoryGroup,contactSupportPerson/personUdef/SuperOffice:8
