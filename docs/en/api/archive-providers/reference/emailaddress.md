...
```http!
GET /api/v1/archive/EmailAddress?$select=email/emailLastSent,contactAssociate/fullName,contactAssociate/mrMrs,contactSupportPerson/personUpdatedByFullName,contactSupportPerson/personUdef/SuperOffice:1
