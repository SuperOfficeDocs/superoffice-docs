...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=amount,person/personNumber,person/personExtra/x_person_priority_relation,contact/contactAssociate/userName,appointment/duration
