...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=saleNumber,person/personAssociate/portraitThumbnail,contact/contactFax/description,contact/contactAssociate/contactId,contact/contactUdef/SuperOffice:5
