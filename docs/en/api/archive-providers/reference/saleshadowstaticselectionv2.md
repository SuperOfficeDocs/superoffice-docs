...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/personUpdatedDate,person/consentSourceEmarketing,contact/restrictionAddress/formattedMultiLineAddress,contact/contactAssociate/ejStatus,appointment/appointment/description
