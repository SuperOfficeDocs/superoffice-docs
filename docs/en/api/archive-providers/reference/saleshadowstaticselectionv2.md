...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/personNumber,person/personDirectFax/formattedNumber,appointment/time,appointment/associate/fullName,document/associateId
