...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/birthYear,person/personPager/description,person/personAssociate/isActive,contact/name,appointment/associateId
