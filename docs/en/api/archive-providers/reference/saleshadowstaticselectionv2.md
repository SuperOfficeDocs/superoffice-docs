...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=contact/number,contact/streetAddress/line1,contact/NumberOfActivitiesInPeriod,contact/LastDoBySale,appointment/appointmentPublish/isPublished
