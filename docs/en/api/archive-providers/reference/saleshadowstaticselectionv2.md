...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/correspondingAssociate/title,contact/contactAssociate/userName,contact/contactExtra/x_contact_shorttext,contact/LastCompletedTicket,appointment/associate/credentialDisplayValue
