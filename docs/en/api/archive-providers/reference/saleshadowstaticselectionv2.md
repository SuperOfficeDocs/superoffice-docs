...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=currency,person/hasInfoText,person/personAssociate/isActiveText,person/isMailingRecipient,contact/stop
