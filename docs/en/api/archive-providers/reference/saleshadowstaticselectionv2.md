...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=time,person/personUdef/SuperOffice:6,contact/hasInterests,contact/NumberOfNotCompletedSales,appointment/associateId
