...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/associateType,person/updatedByWorkflow,person/correspondingAssociate/userName,contact/url/URLDescription,contact/LastCompletedSale
