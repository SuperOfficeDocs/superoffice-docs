...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=date,contact/email/emailId,contact/postAddress/formattedMultiLineAddress,contact/contactAssociate/ejStatus,contact/SaintStatus2
