...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=activeErpLinks,salePublish/isPublished,person/birthYear,person/personPrivate/formattedNumber,appointment/userGroup
