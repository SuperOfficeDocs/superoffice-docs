...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=visibleFor,person/isProjectMember,person/personMobilePhone/description,person/personExtra/x_person_time,person/personExtra/y_rental/x_start
