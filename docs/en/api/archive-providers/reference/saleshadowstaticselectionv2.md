...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=stage,person/personNoMail,person/personExtra/x_person_request_relation,contact/contactAssociate/credentialType,contact/saintDirection
