...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/birthMonth,person/personRegisteredDate,contact/LastSale,associate/otherGroups,appointment/alarm
