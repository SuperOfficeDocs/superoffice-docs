...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/withdrawnStoreConsent,contact/nameDepartment,contact/postAddress/state,contact/contactUdef/SuperOffice:11,appointment/associate/fullName
