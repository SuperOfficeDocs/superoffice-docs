...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/firstName,person/personAssociate/isActiveText,saleStakeholder/person/personCategory,saleStakeholder/person/personDirectFax/formattedNumber,saleStakeholder/contact/postAddress/state
