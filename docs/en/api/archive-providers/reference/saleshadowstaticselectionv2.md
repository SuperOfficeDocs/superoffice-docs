...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/personAssociateId,person/consentSourceStore,appointment/recordTypeText,appointment/appointment/description,project/registeredByFullName
