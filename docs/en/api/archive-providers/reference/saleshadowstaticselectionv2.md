...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=earningPercent,person/firstName,person/personNoMail,person/personAddress/city,contact/email/emailAddress
