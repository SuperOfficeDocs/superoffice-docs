...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/supportAssociateFullName,document/text,project/projectAssociate/isActiveText,saleStakeholder/comment,quote/version/deliveryTerms
