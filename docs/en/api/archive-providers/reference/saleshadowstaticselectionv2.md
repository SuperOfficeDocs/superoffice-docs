...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/personAddress/county,person/personExtra/x_person_contact_relation,contact/restrictionAddress/wgs84longitude,contact/NumberOfSales,associate/otherGroups
