...
```http!
GET /api/v1/archive/SaleShadowStaticSelectionV2?$select=person/kanaLastName,person/personAddress/city,person/personAddress/state,contact/code,contact/contactAssociate/assocType
