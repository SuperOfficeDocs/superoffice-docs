...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=mailMergeDraft,person/personUdef/SuperOffice:9,person/personExtra/x_person_float,contact/contactSource,contact/contactAssociate/userName
