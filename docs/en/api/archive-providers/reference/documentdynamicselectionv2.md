...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=selectionId,person/portraitThumbnail,person/email/emailId,person/personExtra/y_car/id,person/correspondingAssociate/associateDbId
