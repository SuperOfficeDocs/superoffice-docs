...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/hasInfoText,person/personSource,contact/email/emailProtocol,contact/saintAmountClass,project/hasGuide
