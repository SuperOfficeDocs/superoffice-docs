...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/personDeletedDate,person/personAssociate/contactFullName,contact/SaintStatus2,project/projectPublish/publishedBy
