...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/rank,person/supportLanguage,person/personAssociateFullName,person/withdrawnEmarketingConsent,project/projectAssociate/mrMrs
