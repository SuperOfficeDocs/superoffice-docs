...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=updatedBy,person/personExtra/x_person_appointment_relation,project/projectAssociate/lastName,sale/credited,document/description
