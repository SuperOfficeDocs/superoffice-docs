...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/hasInfoText,contact/phone/formattedNumber,contact/streetAddress/zip,project/description,associate/userName
