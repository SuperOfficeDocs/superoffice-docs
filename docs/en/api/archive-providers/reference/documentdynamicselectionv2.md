...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=documentPublish/publishedBy,person/supportAssociateFullName,person/personAddress/formattedAddress,associate/credentialType,sale/stageId
