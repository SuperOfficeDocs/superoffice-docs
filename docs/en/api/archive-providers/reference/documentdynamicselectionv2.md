...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/personNumber,person/personBusiness,person/personExtra/x_person_date,project/status,associate/isActive
