...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/personMobilePhone/description,person/personPager/description,contact/updatedDate,contact/contactAssociate/contactCategory,contact/contactExtra/x_contact_contact_relation
