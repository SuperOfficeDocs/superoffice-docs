...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=attention,person/kanaLastName,person/personAddress/city,person/personAssociate/contactDepartment,sale/associate/assocType
