...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/personUdef/SuperOffice:9,person/personExtra/y_rental/id,person/correspondingAssociate/ejUserId
