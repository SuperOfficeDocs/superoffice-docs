...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/correspondingAssociate/mrMrs,contact/department,project/projectUrl/URLDescription,project/projectAssociate/middleName,project/LastSale
