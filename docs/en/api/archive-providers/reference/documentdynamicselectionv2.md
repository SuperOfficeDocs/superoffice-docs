...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/personUdef/SuperOffice:7,person/personExtra/x_person_integer,contact/restrictionAddress/addressId,contact/contactAssociate/associateDbId,contact/NumberOfNotCompletedSalesInPeriod
