...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=icon,person/personAssociateId,person/personDirectFax/description,contact/NumberOfNotCompletedSales,contact/saintTicketCategory
