...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=recordType,person/personAssociateFullName,person/personUdef/SuperOffice:11,contact/name,contact/streetAddress/formattedMultiLineAddress
