...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/personAssociate/userName,contact/email/emailProtocol,contact/contactUdef/SuperOffice:10,contact/saintSaleStatus,project/LastSale
