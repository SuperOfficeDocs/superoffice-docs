...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=isMail,person/personInfo/infoText,person/email/emailAddress,contact/contactFax/description,contact/restrictionAddress/line3
