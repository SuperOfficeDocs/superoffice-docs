...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/personExtra/x_person_category_relation,contact/contactAssociate/contactCategory,contact/contactAssociate/ejStatus
