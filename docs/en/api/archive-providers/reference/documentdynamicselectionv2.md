...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/email/emailProtocol,person/restrictionAddress/line3,person/personExtra/y_car/id,person/personAssociate/mrMrs,contact/name
