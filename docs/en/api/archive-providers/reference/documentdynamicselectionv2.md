...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=contact/code,contact/url/URLAddress,project/projectAssociate/role,associate/isActive,sale/currency
