...
```http!
GET /api/v1/archive/DocumentDynamicSelectionV2?$select=person/mrMrs,person/kanaLastName,person/personUdef/SuperOffice:2,person/personAssociate/usergroup,contact/contactAssociate/title
