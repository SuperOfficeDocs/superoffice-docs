...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingAddr/contact/registeredBy,mailingAddr/contact/contactAssociate/userName,mailingAddr/person/email/emailId,mailingAddr/person/personAddress/state
