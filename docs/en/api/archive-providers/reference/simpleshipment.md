...
```http!
GET /api/v1/archive/simpleshipment?$select=getAllRows,mailingAddr/contact/contactAssociate/assocType,mailingAddr/contact/contactExtra/x_contact_boolean,mailingAddr/person/searchPhone/description,mailingAddr/person/personAddress/state
