...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingAddr/contact/updatedBy,mailingAddr/contact/contactAssociate/role,mailingAddr/contact/saintTicketCategory,mailingAddr/person/personSource,mailingAddr/person/personAddress/state
