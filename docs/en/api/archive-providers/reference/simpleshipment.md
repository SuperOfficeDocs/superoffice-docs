...
```http!
GET /api/v1/archive/simpleshipment?$select=updatedDate,mailingAddr/person/retired,mailingAddr/person/updatedByWorkflow,mailingAddr/person/personAssociate/contactFullName,associate/contactCategory
