...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingAddr/person/hasCompany,mailingAddr/contact/saintDirection,mailingAddr/person/restrictionAddress/wgs84latitude
