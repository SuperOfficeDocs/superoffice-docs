...
```http!
GET /api/v1/archive/simpleshipment?$select=registeredDate,mailingAddr/person/birthdate,mailingAddr/person/personExtra/x_person_time,mailingAddr/person/personAssociate/ejStatus,associate/fullName
