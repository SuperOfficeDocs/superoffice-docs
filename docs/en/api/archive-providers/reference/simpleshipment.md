...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingReplyTo,mailingAddr/person/firstName,mailingAddr/person/personUdef/SuperOffice:10,emailFlow/updatedDate,project/projectAssociate/firstName
