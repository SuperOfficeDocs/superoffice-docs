...
```http!
GET /api/v1/archive/simpleshipment?$select=mailingAddr/contact/LastCompletedSale,mailingAddr/contact/LastTicket,mailingAddr/person/personAddress/addressId,emailFlow/mediumThumbnail,project/status
