...
```http!
GET /api/v1/archive/simpleshipment?$select=registeredBy,mailingAddr/contact/contactExtra/x_contact_contact_relation,mailingAddr/person/personExtra/x_person_integer,project/updatedBy,project/updatedByFullName
