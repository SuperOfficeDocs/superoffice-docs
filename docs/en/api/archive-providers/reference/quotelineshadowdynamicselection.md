...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelection?$select=quantity,alternative/version/quote/sale/icon,alternative/version/quote/sale/contact/streetAddress/zip
