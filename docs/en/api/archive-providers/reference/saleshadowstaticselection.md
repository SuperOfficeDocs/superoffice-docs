...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=registeredDate,competitor,person/hasInterests,person/personSource,person/correspondingAssociate/otherGroups
