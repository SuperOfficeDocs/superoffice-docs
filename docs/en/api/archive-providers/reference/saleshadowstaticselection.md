...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/personAssociate/usergroupId,contact/name,document/associate/credentialDisplayValue,project/projectId,project/projectAssociate/otherGroups
