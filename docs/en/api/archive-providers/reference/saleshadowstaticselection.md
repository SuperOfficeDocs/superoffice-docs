...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/hasCompany,contact/country,contact/streetAddress/line1,contact/contactAssociate/title,contact/NumberOfNotCompletedSales
