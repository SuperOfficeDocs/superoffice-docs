...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=hasGuide,appointment/appointmentUdef/SuperOffice:8,project/registeredByFullName,saleStakeholder/contact/NumberOfNotCompletedTickets
