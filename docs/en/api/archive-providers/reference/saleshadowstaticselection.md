...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=completed,person/personCountry,person/restrictionAddress/wgs84latitude,person/correspondingAssociate/personEmail,person/legalBaseEmarketing
