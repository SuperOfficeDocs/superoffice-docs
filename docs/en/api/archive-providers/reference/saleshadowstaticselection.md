...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=stageRank,person/birthMonth,person/personAssociate/locationAddress,appointment/appointmentUdef/SuperOffice:7,document/associate/simultaneousEjUser
