...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/personUpdatedBy,person/personAssociate/contactId,person/personAssociate/ejUserId,contact/restrictionAddress/county,appointment/updatedByFullName
