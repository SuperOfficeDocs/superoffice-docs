...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=userGroup,who,person/personUdef/SuperOffice:9,person/legalBaseEmarketing,contact/contactAssociate/simultaneousEjUser
