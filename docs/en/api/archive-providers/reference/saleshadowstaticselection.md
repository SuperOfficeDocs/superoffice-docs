...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=daysInStage,person/isProjectMember,contact/contactAssociate/credentialType,associate/simultaneousEjUser,saleUdef/SuperOffice:2
