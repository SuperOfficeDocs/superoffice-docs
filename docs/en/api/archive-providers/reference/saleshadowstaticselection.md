...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/personAssociate/userName,contact/name,contact/postAddress/line3,contact/NumberOfNotCompletedActivities,appointment/userGroup
