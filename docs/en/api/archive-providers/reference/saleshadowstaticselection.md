...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/personExtra/x_person_request_relation,contact/updatedBy,contact/contactExtra/x_contact_shorttext,associate/personId,appointment/date
