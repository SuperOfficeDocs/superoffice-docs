...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/correspondingAssociate/otherGroups,person/correspondingAssociate/personEmail,contact/hasInfoText,contact/restrictionAddress/formattedAddress,contact/NumberOfNotCompletedSalesInPeriod
