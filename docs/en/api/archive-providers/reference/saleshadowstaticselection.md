...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/birthMonth,person/correspondingAssociate/lastName,contact/hasInfoText,contact/contactAssociate/assocType,appointment/visibleInDiary
