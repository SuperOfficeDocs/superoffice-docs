...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=projectId,person/personUdef/SuperOffice:8,contact/contactAssociate/isLocation,contact/contactExtra/y_organization/x_name,saleUdef/SuperOffice:2
