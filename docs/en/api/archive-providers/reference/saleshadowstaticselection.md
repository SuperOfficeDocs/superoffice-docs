...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=saleId,who,person/personUpdatedByFullName,contact/postAddress/formattedAddress,contact/contactExtra/x_contact_datetime
