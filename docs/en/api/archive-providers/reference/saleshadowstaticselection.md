...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/ticketPriority,person/email/emailAddress,contact/contactAssociate/isLocation,contact/contactUdef/SuperOffice:1,associate/assocName
