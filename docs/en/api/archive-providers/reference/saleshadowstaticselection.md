...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=contact/contactAssociate/contactName,contact/contactExtra/x_contact_hidden_integer,saleUdef/SuperOffice:7,document/saleId,document/name
