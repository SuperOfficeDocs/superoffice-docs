...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=heading,person/personUpdatedDate,contact/contactAssociate/userName,contact/contactExtra/x_contact_integer,appointment/date
