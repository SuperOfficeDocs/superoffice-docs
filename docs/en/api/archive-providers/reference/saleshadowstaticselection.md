...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=salePublish/publishedBy,person/personExtra/x_person_date,person/personAssociate/credentialType,person/consentSourceStore,associate/contactCategory
