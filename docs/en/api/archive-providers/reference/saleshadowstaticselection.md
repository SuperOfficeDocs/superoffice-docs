...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=salePublish/publishedBy,person/correspondingAssociate/ejUserId,contact/category,contact/contactAssociate/assocName,contact/contactAssociate/ejStatus
