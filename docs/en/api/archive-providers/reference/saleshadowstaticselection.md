...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/birthDay,contact/restrictionAddress/line1,contact/contactAssociate/personEmail,contact/contactUdef/SuperOffice:2,appointment/recurring
