...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=stalledComment,saleNumber,person/kanaLastName,person/personAssociate/fullName,appointment/recordType
