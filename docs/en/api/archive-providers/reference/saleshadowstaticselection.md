...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=contact/contactId,contact/updatedDate,appointment/associate/assocTooltip,project/type,saleStakeholder/person/personHasInterests
