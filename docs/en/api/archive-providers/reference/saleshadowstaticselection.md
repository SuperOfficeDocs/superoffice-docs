...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=originalStage,amountWeightedInBaseCurrency,person/personDirectPhone/description,person/subscription,contact/number
