...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=sale/textId,person/kanaLastName,appointment/updatedByFullName,appointment/intention,appointment/associate/ejStatus
