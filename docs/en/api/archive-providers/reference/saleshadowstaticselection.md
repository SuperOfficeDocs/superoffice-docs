...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=person/correspondingAssociate/personId,contact/updatedDate,associate/contactCategory,appointment/associate/lastName,appointment/associate/ejStatus
