...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=date,sale/textId,salePublish/publishedTo,person/personAssociateFullName,person/personPrivate/description
