...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=recordType,registeredDate,person/personExtra/x_person_priority_relation,person/personAssociate/contactName,contact/contactAssociate/firstName
