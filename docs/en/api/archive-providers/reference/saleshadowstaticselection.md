...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=getNoRows,person/personRegisteredByFullName,person/personUdef/SuperOffice:3,person/personUdef/SuperOffice:6,person/hasStoreConsent
