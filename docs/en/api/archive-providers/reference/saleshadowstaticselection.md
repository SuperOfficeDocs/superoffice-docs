...
```http!
GET /api/v1/archive/SaleShadowStaticSelection?$select=hasStakeholders,person/birthdate,associate/mrMrs,document/associate/ejUserId,project/projectAssociate/otherGroups
