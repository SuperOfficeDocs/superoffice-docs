...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/personExtra/x_person_hidden_integer,person/legalBaseEmarketing,contact/deletedDate,contact/postAddress/zip,contact/contactAssociate/title
