...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=description,person/title,person/withdrawnEmarketingConsent,contact/country,contact/streetAddress/wgs84latitude
