...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=date,person/personUdef/SuperOffice:7,contact/contactAssociate/contactId,associate/portraitThumbnail,appointment/alarm
