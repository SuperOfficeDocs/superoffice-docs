...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/personExtra/x_person_boolean,person/personExtra/y_car/id,contact/updatedDate,contact/streetAddress/line3,appointment/isMilestone
