...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/personAssociate/contactDepartment,person/personAssociate/contactCategory,contact/deletedDate,contact/contactAssociate/contactDepartment,contact/LastDoBySale
