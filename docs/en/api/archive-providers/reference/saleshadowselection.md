...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=currencyId,description,person/personMobilePhone/formattedNumber,person/email/emailHasBounced,person/consentSourceStore
