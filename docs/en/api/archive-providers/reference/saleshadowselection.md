...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=amountInBaseCurrency,person/personAddress/wgs84longitude,person/personExtra/y_rental/x_start,person/personAssociate/ejUserId,person/isMailingRecipient
