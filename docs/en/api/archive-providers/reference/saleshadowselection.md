...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=contact/LastDoByTicket,contact/saintAmountClass,associate/simultaneousEjUser,document/associate/isActive,project/hasInfoText
