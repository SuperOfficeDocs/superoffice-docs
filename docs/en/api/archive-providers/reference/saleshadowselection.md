...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=amountInBaseCurrency,contact/name,contact/email/emailProtocol,contact/postAddress/addressId,contact/contactUdef/SuperOffice:5
