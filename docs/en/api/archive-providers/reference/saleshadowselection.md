...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/birthYear,person/personUpdatedByFullName,person/personRegisteredBy,person/correspondingAssociate/assocType,contact/contactAssociate/lastName
