...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=contact/email/emailAddress,contact/streetAddress/city,contact/streetAddress/wgs84longitude,contact/contactUdef/SuperOffice:5,contact/contactUdef/SuperOffice:8
