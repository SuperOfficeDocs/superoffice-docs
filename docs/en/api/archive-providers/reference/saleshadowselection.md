...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=registeredBy,person/personExtra/x_person_boolean,person/personAssociate/personEmail,associate/credentialDisplayValue,saleUdef/SuperOffice:7
