...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=saleType,person/email/emailLastBounce,person/personUdef/SuperOffice:10,contact/department,document/documentUdef/SuperOffice:7
