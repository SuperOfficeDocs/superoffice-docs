...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=registeredDate,person/hasInterests,person/correspondingAssociate/lastName,person/correspondingAssociate/fullName,person/isMailingRecipient
