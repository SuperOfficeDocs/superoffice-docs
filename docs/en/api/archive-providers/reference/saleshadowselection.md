...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/email/emailProtocol,person/personAddress/zip,person/correspondingAssociate/lastName,contact/contactId,contact/updatedDate
