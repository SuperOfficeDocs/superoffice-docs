...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=source,person/correspondingAssociate/assocName,contact/code,contact/contactAssociate/personEmail,associate/middleName
