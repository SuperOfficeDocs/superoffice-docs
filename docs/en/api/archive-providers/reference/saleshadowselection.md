...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=saleStatus,person/birthdate,person/correspondingAssociate/firstName,contact/streetAddress/city,contact/contactAssociate/portraitThumbnail
