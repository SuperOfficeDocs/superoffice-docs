...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/personCountry,person/personExtra/y_rental/x_start,person/subscription,contact/contactAssociate/userName,associate/assocType
