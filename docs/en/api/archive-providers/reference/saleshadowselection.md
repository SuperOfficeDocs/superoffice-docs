...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/kanaLastName,person/personRegisteredDate,contact/contactNoMail,contact/registeredByFullName,contact/contactAssociate/contactName
