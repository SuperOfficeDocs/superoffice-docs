...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=userGroup,currencyId,probPercent,person/personExtra/x_person_shorttext_list,person/correspondingAssociate/title
