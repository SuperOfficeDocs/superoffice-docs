...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=contact/contactUdef/SuperOffice:8,contact/saintActivityType,associate/middleName,associate/fullName,appointment/updatedDate
