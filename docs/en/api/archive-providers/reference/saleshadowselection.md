---
uid: SaleShadowSelection
title: SaleShadowSelection
description: Shadow contact provider for the sale provider.
keywords: SaleShadowSelection archive provider
so.generated: true
so.topic: reference
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=appointment/appointmentUdef/SuperOffice:1,appointment/associate/credentialDisplayValue,project/projectEvent/eventDate,saleStakeholder/person/personAssociate/contactName,saleStakeholder/person/personAssociate/assocTooltip
