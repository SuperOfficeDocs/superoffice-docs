...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/personDirectPhone/description,person/personUdef/SuperOffice:9,person/personAssociate/isActiveText,person/consentSourceStore,contact/url/URLAddress
