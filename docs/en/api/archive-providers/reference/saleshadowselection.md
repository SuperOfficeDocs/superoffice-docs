...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/contactId,person/personRegisteredDate,person/restrictionAddress/state,contact/restrictionAddress/city,contact/restrictionAddress/wgs84longitude
