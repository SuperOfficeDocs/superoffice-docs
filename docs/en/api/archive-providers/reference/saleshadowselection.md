...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=stageRank,person/correspondingAssociate/middleName,contact/contactExtra/x_contact_request_relation,appointment/priority,project/projectAssociate/ejUserId
