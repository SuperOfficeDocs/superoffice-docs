...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/personPrivate/description,contact/registeredDate,saleUdef/SuperOffice:5,appointment/joinVideomeetUrl,saleStakeholder/person/personInterestIds
