...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=soldReason,person/middleName,contact/restrictionAddress/county,appointment/associate/role,document/documentUdef/SuperOffice:4
