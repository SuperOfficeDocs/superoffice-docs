...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=type,person/personAssociate/portraitThumbnail,person/correspondingAssociate/isActiveText,contact/restrictionAddress/formattedAddress,contact/contactUdef/SuperOffice:8
