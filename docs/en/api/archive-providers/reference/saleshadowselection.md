...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/hasInterests,person/personUdef/SuperOffice:9,person/personAssociate/ejDisplayName,person/correspondingAssociate/personId,contact/stop
