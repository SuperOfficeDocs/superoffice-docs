...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=person/lastName,contact/restrictionAddress/line2,contact/contactUdef/SuperOffice:1,contact/NumberOfNotCompletedSalesInPeriod,contact/SaintStatus1
