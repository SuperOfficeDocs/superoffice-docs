...
```http!
GET /api/v1/archive/SaleShadowSelection?$select=updatedByFullName,person/firstName,contact/postAddress/line2,contact/contactAssociate/associateDbId,appointment/associateId
