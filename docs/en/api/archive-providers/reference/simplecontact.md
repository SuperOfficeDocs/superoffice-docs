...
```http!
GET /api/v1/archive/SimpleContact?$select=restrictionAddress/city,contactAssociate/usergroup,contactSupportAssociate/lastName,contactSupportPerson/personExtra/x_person_timespan,LastSale
