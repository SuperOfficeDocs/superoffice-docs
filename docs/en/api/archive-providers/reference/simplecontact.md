...
```http!
GET /api/v1/archive/SimpleContact?$select=activeErpLinks,streetAddress/city,contactSupportAssociate/assocName,contactSupportPerson/personExtra/x_person_integer
