...
```http!
GET /api/v1/archive/SimpleContact?$select=code,contactAssociate/associateDbId,contactSupportPerson/consentSourceStore,contactUdef/SuperOffice:3,contactExtra/x_contact_float
