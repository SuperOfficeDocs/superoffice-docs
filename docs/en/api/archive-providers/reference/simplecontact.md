...
```http!
GET /api/v1/archive/SimpleContact?$select=contactSupportPerson/personInfo/textId,contactSupportPerson/personExtra/x_person_category_relation,contactAssociate/usergroupId
