...
```http!
GET /api/v1/archive/SimpleContact?$select=postAddress/formattedAddress,contactSupportPerson/personExtra/x_person_category_relation,contactAssociate/contactFullName
