...
```http!
GET /api/v1/archive/SimpleContact?$select=updatedDate,restrictionPostalAddress/formattedMultiLineAddress,restrictionAddress/zip,contactAssociate/simultaneousEjUser,contactSupportAssociate/lastName
