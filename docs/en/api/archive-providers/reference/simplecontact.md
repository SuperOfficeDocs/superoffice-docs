...
```http!
GET /api/v1/archive/SimpleContact?$select=contactSupportPerson/isProjectMember,contactSupportPerson/isStakeholder,contactExtra/x_contact_boolean,contactExtra/x_contact_shorttext
