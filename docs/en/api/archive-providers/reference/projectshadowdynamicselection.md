...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=text,projectPublish/publishedFrom,projectAssociate/ejUserId,appointment/invitedPersonId,projectMember/associateId
