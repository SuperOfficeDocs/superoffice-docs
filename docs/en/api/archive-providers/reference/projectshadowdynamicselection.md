...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectAssociate/mrMrs,NumberOfNotCompletedActivities,sale/saleId,document/completed,projectMember/portraitThumbnail
