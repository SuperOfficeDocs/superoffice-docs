...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=appointment/updatedByFullName,appointment/isFree,appointment/appointmentUdef/SuperOffice:2,projectMember/lastName,projectMember/email/emailProtocol
