...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectPublish/publishedTo,saintDirection,sale/associate/locationAddress,appointment/recurring,appointment/associate/ejDisplayName
