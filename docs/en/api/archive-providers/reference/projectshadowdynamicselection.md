...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectEvent/eventDate,projectAssociate/assocName,projectUdef/SuperOffice:4,NumberOfNotCompletedActivities,sale/completed
