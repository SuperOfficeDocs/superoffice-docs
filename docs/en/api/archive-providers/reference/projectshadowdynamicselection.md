...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=document/suggestedDocumentId,projectMember/personUpdatedDate,projectMember/department,projectMember/contactEmail/emailId
