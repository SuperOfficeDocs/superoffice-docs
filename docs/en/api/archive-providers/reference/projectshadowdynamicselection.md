...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectAssociate/contactFullName,sale/associate/fullName,appointment/registeredByFullName,document/updatedByFullName,document/recordTypeText
