...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=updatedDate,NumberOfActivities,sale/saleUdef/SuperOffice:8,document/associate/contactFullName,projectMember/associateId
