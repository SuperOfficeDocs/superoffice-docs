...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=appointment/visibleFor,appointment/associate/contactId,appointment/appointmentUdef/SuperOffice:2
