...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectAssociate/ejStatus,saintTicketStatus,sale/stage,sale/associate/personId,sale/associate/otherGroups
