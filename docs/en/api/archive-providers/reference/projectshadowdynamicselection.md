...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=sale/registeredByFullName,sale/stageId,sale/stalledComment,appointment/associate/contactName,document/associate/role
