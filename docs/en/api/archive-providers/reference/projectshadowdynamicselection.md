...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=sale/stage,appointment/associate/ejDisplayName,projectMember/personNumber,projectMember/personAssociate/lastName,projectMember/streetAddress/formattedAddress
