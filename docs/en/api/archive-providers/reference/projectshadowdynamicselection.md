...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectPublish/publishedBy,sale/earning,sale/associate/personEmail,projectMember/contactInterestIds
