...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=sale/projectId,appointment/appointmentPublish/publishedBy,document/updatedDate,document/associate/assocType,document/documentUdef/SuperOffice:5
