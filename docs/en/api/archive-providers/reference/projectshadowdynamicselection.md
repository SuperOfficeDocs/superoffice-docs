...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=hasGuide,appointment/appointment/titleHtml,projectMember/personCategory,projectMember/personAssociate/associateDbId,projectMember/department
