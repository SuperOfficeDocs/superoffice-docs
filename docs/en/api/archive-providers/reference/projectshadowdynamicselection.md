...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=projectAssociate/mrMrs,appointment/associateId,appointment/saleId,appointment/visibleInDiary,projectMember/url/URLDescription
