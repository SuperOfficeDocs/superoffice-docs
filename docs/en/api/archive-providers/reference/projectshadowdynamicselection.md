...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=getNoRows,text,appointment/associate/simultaneousEjUser,projectMember/personPager/description,projectMember/legalBaseEmarketing
