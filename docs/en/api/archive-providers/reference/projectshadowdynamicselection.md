...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=number,appointment/appointment/titleHtml,document/documentPublish/isPublished,document/associate/personId,projectMember/updatedByWorkflow
