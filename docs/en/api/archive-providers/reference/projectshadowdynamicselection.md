...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=sale/stageName,document/registeredByFullName,projectMember/countryId,projectMember/contactAssociate/contactCategory
