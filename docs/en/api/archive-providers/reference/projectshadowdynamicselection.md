...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=sale/updatedByFullName,document/documentPublish/isPublished,projectMember/postAddress/zip,projectMember/contactExtra/x_contact_contact_relation
