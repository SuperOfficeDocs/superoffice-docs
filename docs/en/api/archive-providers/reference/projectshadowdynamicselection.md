...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=updatedDate,appointment/associate/assocType,document/isMail,document/documentUdef/SuperOffice:8,projectMember/contactPhone/formattedNumber
