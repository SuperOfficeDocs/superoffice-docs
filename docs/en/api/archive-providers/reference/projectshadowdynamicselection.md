...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelection?$select=saintActivityType,sale/saleUdef/SuperOffice:3,projectMember/correspondingAssociate/ejDisplayName,projectMember/NumberOfTickets
