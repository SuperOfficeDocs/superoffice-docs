...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=registeredBy,postAddress/formattedAddress,contactAssociate/credentialType,contactExtra/y_organization/x_name,sale/createdByWorkflow
