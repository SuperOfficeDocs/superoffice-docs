...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=postAddress/state,sale/associate/locationAddress,sale/saleUdef/SuperOffice:2,appointment/userGroup,appointment/visibleInDiary
