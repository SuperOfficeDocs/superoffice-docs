...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=targetRelation/country,sale/currency,sale/saleType,appointment/priority,document/documentUdef/SuperOffice:5
