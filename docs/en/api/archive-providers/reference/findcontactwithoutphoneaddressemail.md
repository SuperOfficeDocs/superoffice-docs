...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=sale/updatedBy,sale/stage,appointment/associate/contactFullName,supportAssociateFullName,personUdef/SuperOffice:9
