...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=contactId,stop,contactPhone/formattedNumber,postAddress/line3,contactAssociate/assocName
