...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=email/emailBounceCount,postAddress/wgs84latitude,postAddress/formattedMultiLineAddress,contactAssociate/locationAddress,sale/hasGuide
