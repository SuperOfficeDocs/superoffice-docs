...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=contactNoMail,registeredBy,sourceRelation/registeredByFullName,appointment/suggestedAppointmentId,appointment/associate/lastName
