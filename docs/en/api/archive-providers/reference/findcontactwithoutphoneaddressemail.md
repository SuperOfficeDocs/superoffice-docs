...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=updatedByFullName,sale/associate/contactDepartment,personUdef/SuperOffice:5,personAssociate/credentialDisplayValue
