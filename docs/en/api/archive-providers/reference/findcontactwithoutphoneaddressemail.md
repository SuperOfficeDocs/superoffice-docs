...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=contactUdef/SuperOffice:13,appointment/appointment/title,hasCompany,personExtra/x_person_request_relation,personAssociate/middleName
