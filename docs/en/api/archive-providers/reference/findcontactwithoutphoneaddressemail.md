...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=saintTicketStatus,targetRelation/country,appointment/associate/ejStatus,document/projectId,personMobilePhone/formattedNumber
