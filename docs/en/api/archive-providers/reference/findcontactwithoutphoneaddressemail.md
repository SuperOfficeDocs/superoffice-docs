...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=mainContact,contactAssociate/simultaneousEjUser,targetRelation/updatedByFullName,appointment/duration,document/associate/ejDisplayName
