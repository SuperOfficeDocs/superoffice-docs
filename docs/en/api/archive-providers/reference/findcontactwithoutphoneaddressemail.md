...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=email/emailDescription,sale/hasStakeholders,appointment/associate/contactFullName,document/suggestedDocumentId,personInfo/textId
