...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=updatedDate,restrictionAddress/addressId,document/associate/otherGroups,personAssociate/ejUserId
