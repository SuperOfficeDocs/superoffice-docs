...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=postAddress/zip,sale/associate/portraitThumbnail,appointment/registeredBy,document/type,document/associate/firstName
