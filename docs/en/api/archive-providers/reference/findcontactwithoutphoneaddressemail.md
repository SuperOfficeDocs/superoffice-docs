...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=updatedByFullName,registeredDate,sourceRelation/updatedBy,targetRelation/contactId,targetRelation/associateId
