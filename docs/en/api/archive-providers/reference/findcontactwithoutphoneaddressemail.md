...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=nameDepartment,searchPhone/formattedNumber,contactAssociate/locationAddress,sourceRelation/registeredBy,targetRelation/activeErpLinks
