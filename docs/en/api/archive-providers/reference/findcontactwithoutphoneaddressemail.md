...
```http!
GET /api/v1/archive/FindContactWithoutPhoneAddressEmail?$select=contactNoMail,searchPhone/formattedNumber,streetAddress/wgs84longitude,restrictionAddress/wgs84latitude,appointment/appointment/title
