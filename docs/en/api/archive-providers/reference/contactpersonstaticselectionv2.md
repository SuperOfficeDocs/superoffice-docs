...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=targetRelation/name,sale/recordType,sale/projectId,document/associate/title,personExtra/x_person_priority_relation
