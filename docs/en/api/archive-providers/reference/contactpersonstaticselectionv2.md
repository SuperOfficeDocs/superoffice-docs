...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactUdef/SuperOffice:5,contactUdef/SuperOffice:6,targetRelation/updatedByFullName,document/associate/role,lastName
