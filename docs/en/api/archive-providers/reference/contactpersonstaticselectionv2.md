...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=lastName,personExtra/x_person_user_relation,personExtra/y_rental/x_start,personSourceRelation/personSource,correspondingAssociate/firstName
