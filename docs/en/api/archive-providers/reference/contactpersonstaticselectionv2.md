...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactAssociate/ejUserId,appointment/associate/contactId,personUdef/SuperOffice:11,personTargetRelation/personNoMail
