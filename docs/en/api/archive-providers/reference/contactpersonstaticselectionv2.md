...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=rowKind,NumberOfActivitiesInPeriod,sale/stageRank,document/associate/isActiveText,document/documentUdef/SuperOffice:2
