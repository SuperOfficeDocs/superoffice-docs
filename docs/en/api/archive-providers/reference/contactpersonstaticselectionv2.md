...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactUdef/SuperOffice:12,sale/amount,document/projectId,document/associate/firstName,personTargetRelation/personId
