...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=NumberOfNotCompletedTicketsInPeriod,sale/probPercent,sale/saleUdef/SuperOffice:4,appointment/endDate,document/keywords
