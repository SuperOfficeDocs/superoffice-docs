...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=restrictionAddress/wgs84longitude,targetRelation/stop,personUdef/SuperOffice:4,personAddress/line1,personSourceRelation/personHasInterests
