...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=NumberOfTicketsInPeriod,sourceRelation/mainContact,appointment/userGroup,document/snum,document/documentPublish/publishedBy
