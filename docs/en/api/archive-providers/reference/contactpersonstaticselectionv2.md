...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=searchPhone/description,restrictionAddress/formattedMultiLineAddress,SaintStatus2,sourceRelation/country,sale/amountWeighted
