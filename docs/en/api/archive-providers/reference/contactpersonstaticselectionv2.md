...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=nameDepartment,contactAssociate/ejDisplayName,targetRelation/mainContact,appointment/associate/portraitThumbnail,document/isReport
