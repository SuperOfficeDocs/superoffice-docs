...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=sourceRelation/updatedDate,sale/associate/assocName,appointment/who,appointment/updatedDate,personRegisteredBy
