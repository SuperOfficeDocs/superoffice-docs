...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactAssociate/contactName,sourceRelation/restrictionContactId,targetRelation/business,document/associate/userName,personUdef/SuperOffice:11
