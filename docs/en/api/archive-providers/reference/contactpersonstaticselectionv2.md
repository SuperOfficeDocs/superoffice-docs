...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=email/emailBounceCount,contactUdef/SuperOffice:2,sale/hasGuide,appointment/endDate,appointment/associate/isActive
