...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactDeleted,sale/completed,sale/updatedByFullName,request/ownedBy/personEmail,request/extra/y_equipment/x_name
