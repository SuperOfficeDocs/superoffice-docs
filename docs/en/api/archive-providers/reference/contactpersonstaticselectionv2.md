...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=NumberOfSales,sourceRelation/contactNoMail,targetRelation/department,personSourceRelation/hasInfoText,personTargetRelation/rank
