...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=targetRelation/contactNoMail,document/userGroup,document/keywords,birthDay,supportAssociateFullName
