...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=updatedDate,contactAssociate/assocTooltip,sourceRelation/number,targetRelation/registeredByFullName,appointment/projectId
