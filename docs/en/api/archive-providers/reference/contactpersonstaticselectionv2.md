...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactExtra/x_contact_dropdown,saintSaleStatus,sale/heading,document/documentPublish/publishedBy,retired
