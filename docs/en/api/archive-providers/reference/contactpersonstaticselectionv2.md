...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=targetRelation/updatedBy,sourceRelation/contactPersonRelation,sale/stageRank,sale/hasGuide,sale/associate/personId
