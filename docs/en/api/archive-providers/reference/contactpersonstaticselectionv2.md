...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=countryId,restrictionAddress/zip,contactUdef/SuperOffice:13,NumberOfNotCompletedTicketsInPeriod,document/documentPublish/publishedTo
