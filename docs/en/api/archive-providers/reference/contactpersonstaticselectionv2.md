...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=hasInfoText,postAddress/addressId,contactAssociate/role,contactUdef/SuperOffice:3,LastActivity
