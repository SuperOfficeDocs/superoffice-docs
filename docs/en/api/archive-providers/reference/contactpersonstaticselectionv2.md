...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=getNoRows,postAddress/addressId,sale/competitor,sale/associate/simultaneousEjUser,appointment/appointmentUdef/SuperOffice:7
