...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactAssociate/otherGroups,contactUdef/SuperOffice:3,NumberOfSales,sourceRelation/companyCategoryRank,targetRelation/country
