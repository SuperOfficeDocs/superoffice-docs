...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactExtra/x_contact_datetime,document/yourref,document/suggestedDocumentId,personUpdatedBy,personExtra/x_person_appointment_relation
