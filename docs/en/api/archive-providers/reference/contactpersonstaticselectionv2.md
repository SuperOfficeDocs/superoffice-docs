...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=selectionMemberId,email/emailDescription,restrictionAddress/line1,restrictionAddress/wgs84longitude,SaintStatus2
