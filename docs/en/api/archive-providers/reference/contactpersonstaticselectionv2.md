...
```http!
GET /api/v1/archive/ContactPersonStaticSelectionV2?$select=contactUdef/SuperOffice:1,targetRelation/personContactRelation,appointment/invitedPersonId,birthMonth,personEmail/emailLastSent
