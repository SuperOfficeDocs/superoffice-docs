...
```http!
GET /api/v1/archive/QuoteLineStaticSelectionV2?$select=status,alternative/status,alternative/version/quote/orderComment,alternative/version/quote/sale/person/personExtra/x_person_hidden_integer,alternative/version/quote/sale/person/personExtra/x_person_shorttext_list
