...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactAssociate/middleName,contactAssociate/isActiveText,sourceRelation/contactPersonRelation,sale/associate/contactFullName,appointment/isMilestone
