...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=mainContact,url/URLDescription,appointment/date,personAddress/county,personTargetRelation/createdByForm
