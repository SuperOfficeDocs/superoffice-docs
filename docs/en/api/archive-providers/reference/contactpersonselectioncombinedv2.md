...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=registeredDate,contactAssociate/assocTooltip,LastCompletedSale,sourceRelation/hasInfoText,targetRelation/business
