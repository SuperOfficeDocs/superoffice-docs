...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=LastDoByTicket,targetRelation/registeredByFullName,sale/associate/isActiveText,appointment/saleId,appointment/appointmentPublish/isPublished
