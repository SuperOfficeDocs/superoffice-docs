...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=email/emailLastBounce,streetAddress/county,NumberOfNotCompletedSalesInPeriod,document/documentId,document/documentUdef/SuperOffice:4
