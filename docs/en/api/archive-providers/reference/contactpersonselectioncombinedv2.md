...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactAssociate/assocType,sale/updatedByFullName,appointment/contactId,document/associate/title,personUrl/URLAddress
