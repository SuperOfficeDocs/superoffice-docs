...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=targetRelation/category,appointment/updatedByFullName,appointment/booking,document/associate/contactDepartment,personUdef/SuperOffice:8
