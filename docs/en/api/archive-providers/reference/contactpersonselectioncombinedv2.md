...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=who,streetAddress/city,contactExtra/x_contact_contact,targetRelation/code,sale/associate/mrMrs
