...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=postAddress/county,contactAssociate/personEmail,saintAmountClass,sourceRelation/countryId,targetRelation/hasInfoText
