...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactUdef/SuperOffice:4,LastDoBySale,document/isReport,document/associate/isActive,personRegisteredBy
