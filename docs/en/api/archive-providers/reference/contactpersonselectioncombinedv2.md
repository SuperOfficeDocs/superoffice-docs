...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=LastDoByActivity,appointment/associate/firstName,document/registeredByFullName,document/associate/isActive,personTargetRelation/position
