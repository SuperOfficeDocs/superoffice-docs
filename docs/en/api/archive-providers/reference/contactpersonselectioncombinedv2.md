...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=name,postAddress/county,contactUdef/SuperOffice:3,contactExtra/x_contact_timespan,sourceRelation/number
