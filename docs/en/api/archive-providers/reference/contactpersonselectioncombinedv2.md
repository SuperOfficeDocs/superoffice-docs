...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactAssociate/usergroup,LastCompletedSale,sale/sale/textId,isStakeholder,correspondingAssociate/contactCategory
