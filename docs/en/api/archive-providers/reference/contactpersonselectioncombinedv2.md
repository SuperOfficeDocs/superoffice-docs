...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=updatedBy,targetRelation/name,document/yourref,personSourceRelation/personCategoryGroup,request/createdBy/role
