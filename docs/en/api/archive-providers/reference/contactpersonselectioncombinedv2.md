...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactUdef/SuperOffice:9,NumberOfSales,sale/userGroup,appointment/associate/assocType,document/associate/assocName
