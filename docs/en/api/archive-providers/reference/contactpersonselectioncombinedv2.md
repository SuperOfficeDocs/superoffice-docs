...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=updatedByFullName,sale/hasStakeholders,appointment/visibleFor,appointment/associate/contactCategory,personRegisteredBy
