...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=name,department,contactUdef/SuperOffice:11,personSourceRelation/kanaLastName,personTargetRelation/birthYear
