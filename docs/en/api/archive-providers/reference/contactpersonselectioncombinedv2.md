...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactFax/description,streetAddress/zip,sale/contactId,appointment/appointment/titleHtml,personUdef/SuperOffice:7
