...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=sale/type,sale/competitor,sale/stageRank,appointment/appointmentUdef/SuperOffice:3,consentSourceStore
