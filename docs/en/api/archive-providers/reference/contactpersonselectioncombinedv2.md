...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=contactAssociate/credentialDisplayValue,contactExtra/x_contact_shorttext,targetRelation/contactDeleted,sale/earning,document/registeredBy
