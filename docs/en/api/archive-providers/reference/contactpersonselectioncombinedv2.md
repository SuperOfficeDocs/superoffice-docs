...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=getNoRows,countryId,contactAssociate/contactFullName,LastSale,targetRelation/personContactRelation
