...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=sourceRelation/business,sale/hasStakeholders,appointment/visibleFor,document/registeredBy,document/associate/mrMrs
