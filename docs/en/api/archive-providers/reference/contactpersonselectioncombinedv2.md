...
```http!
GET /api/v1/archive/ContactPersonSelectionCombinedV2?$select=searchPhone/description,streetAddress/formattedMultiLineAddress,LastTicket,sale/type,sale/saleUdef/SuperOffice:8
