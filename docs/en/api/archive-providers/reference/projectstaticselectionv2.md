...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/associateDbId,appointment/time,appointment/associate/locationAddress,projectMember/personUpdatedBy,projectMember/postAddress/zip
