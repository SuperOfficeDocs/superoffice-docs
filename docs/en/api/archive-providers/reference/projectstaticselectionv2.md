...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=appointment/time,appointment/associateId,appointment/associate/middleName,projectMember/personHasInterests,projectMember/title
