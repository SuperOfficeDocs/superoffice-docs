...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/simultaneousEjUser,appointment/appointmentUdef/SuperOffice:8,document/text,projectMember/personPrivate/formattedNumber,projectMember/personAssociate/assocName
