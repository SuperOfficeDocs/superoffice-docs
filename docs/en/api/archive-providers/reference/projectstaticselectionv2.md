...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=icon,appointment/alarm,document/attention,document/isReport,projectMember/correspondingAssociate/isActive
