...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=hasGuide,sale/associate/associateDbId,document/associate/role,projectMember/personUdef/SuperOffice:4,projectMember/streetAddress/zip
