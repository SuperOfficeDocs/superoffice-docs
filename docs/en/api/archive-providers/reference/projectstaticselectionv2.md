...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=sale/associate/lastName,document/associate/userName,projectMember/associateType,projectMember/personPrivate/description,projectMember/registeredDate
