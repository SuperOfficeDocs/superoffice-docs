...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=activeErpLinks,projectPublish/publishedFrom,projectAssociate/mrMrs,projectAssociate/title,sale/saleUdef/SuperOffice:1
