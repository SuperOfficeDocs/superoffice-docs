...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/assocName,LastCompletedSale,sale/source,document/registeredDate,document/associate/assocName
