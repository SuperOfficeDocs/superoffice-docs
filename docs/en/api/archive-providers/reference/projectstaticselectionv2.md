...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/title,projectMember/personCountry,projectMember/whenUpdatedByWorkflow,projectMember/restrictionAddress/formattedAddress,projectMember/personAssociate/ejDisplayName
