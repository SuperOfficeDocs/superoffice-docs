...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/ejStatus,sale/completed,document/keywords,projectMember/personCountryId,projectMember/birthDay
