...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=appointment/saleId,appointment/appointmentPublish/publishedBy,appointment/associate/assocType,projectMember/personDirectPhone/description
