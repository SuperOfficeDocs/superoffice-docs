...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectEvent/hasSignOn,sale/associate/credentialType,projectMember/personExtra/x_person_category_relation,projectMember/personExtra/y_rental/id
