...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=description,sale/sale/textId,appointment/associate/ejUserId,document/recordTypeText,document/associate/assocType
