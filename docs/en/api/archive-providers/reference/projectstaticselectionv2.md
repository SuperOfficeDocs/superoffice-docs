...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/associateDbId,LastCompletedSale,sale/associate/lastName,document/registeredDate,projectMember/contactAssociate/firstName
