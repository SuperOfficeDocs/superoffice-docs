...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=saintTicketStatus,sale/updatedByFullName,appointment/recordType,projectMember/personUdef/SuperOffice:5,projectMember/personAssociate/personId
