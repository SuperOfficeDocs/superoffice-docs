...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=sale/lossReason,appointment/appointment/internalNotesHtml,document/isMail,document/associate/contactCategory,projectMember/personAddress/line2
