...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=statusRank,document/registeredByFullName,document/associate/role,projectMember/personExtra/x_person_time,projectMember/streetAddress/county
