...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/userName,sale/probPercent,appointment/associate/credentialDisplayValue,document/documentUdef/SuperOffice:6,projectMember/infoText
