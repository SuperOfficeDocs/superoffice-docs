...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectUdef/SuperOffice:4,sale/saleId,document/icon,document/associate/title,document/associate/credentialDisplayValue
