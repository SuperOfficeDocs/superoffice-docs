...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectId,sale/associate/associateDbId,appointment/associate/portraitThumbnail,document/visibleFor,projectMember/personNumber
