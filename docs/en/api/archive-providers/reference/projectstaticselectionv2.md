...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=updatedBy,projectAssociate/simultaneousEjUser,LastCompletedActivity,sale/associate/contactDepartment,appointment/cautionWarning
