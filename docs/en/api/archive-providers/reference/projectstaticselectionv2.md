...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=sale/associate/contactFullName,appointment/associate/associateDbId,document/contactId,projectMember/birthdate,projectMember/correspondingAssociate/isActive
