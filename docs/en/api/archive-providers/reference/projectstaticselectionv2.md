...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=NumberOfNotCompletedSales,projectMember/mrMrs,projectMember/personExtra/x_person_category_relation,projectMember/contactInterestIds
