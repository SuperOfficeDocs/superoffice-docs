...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=endDate,projectAssociate/portraitThumbnail,NumberOfNotCompletedActivitiesInPeriod,sale/associate/contactDepartment,document/documentPublish/publishedTo
