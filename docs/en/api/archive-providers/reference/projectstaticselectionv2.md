...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=registeredBy,endDate,appointment/appointment/isConverted,document/associate/associateDbId,document/associate/ejDisplayName
