...
```http!
GET /api/v1/archive/ProjectStaticSelectionV2?$select=projectAssociate/credentialDisplayValue,projectAssociate/isActive,sale/currency,appointment/associate/personEmail,document/saleId
