...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=realTimeSpentExternally,ownedBy/isActiveText,person/position,person/rank,person/email/emailDescription
