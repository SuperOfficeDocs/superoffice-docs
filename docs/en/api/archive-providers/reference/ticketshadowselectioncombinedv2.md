...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=createdBy/assocTooltip,ownedBy/credentialDisplayValue,person/correspondingAssociate/credentialType,contact/deletedDate,contact/contactAssociate/portraitThumbnail
