...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=ownedBy/contactName,person/personUdef/SuperOffice:2,person/personExtra/x_person_hidden_integer,contact/contactAssociate/isActiveText,contact/saintDirection
