...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=createdBy/isActiveText,person/email/emailId,person/personExtra/x_person_longtext,person/correspondingAssociate/role,contact/hasInfoText
