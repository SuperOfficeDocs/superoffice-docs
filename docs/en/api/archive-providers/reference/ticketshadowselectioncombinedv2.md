...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=ticketStatus/ticketStatusId,contact/category,sale/recordType,sale/updatedByFullName,sale/saleStatus
