...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=tags,createdBy/portraitThumbnail,person/personAssociate/personEmail,person/subscription,contact/contactFax/description
