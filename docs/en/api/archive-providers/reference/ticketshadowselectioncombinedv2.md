...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=readByCustomer,ownedBy/assocTooltip,person/personCountryId,person/rank,person/personExtra/y_rental/x_start
