...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=person/email/emailLastBounce,person/correspondingAssociate/role,project/projectUdef/SuperOffice:7
