...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=createdBy/isActive,ownedBy/contactId,person/correspondingAssociate/ejDisplayName,contact/postAddress/line3,contact/restrictionAddress/county
