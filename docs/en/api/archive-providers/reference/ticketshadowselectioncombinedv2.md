...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=realTimeSpentExternally,person/correspondingAssociate/credentialType,contact/postAddress/city,sale/userGroup
