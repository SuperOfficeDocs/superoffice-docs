...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=contact/contactAssociate/role,contact/LastCompletedActivity,project/projectUdef/SuperOffice:5,project/NumberOfNotCompletedSales
