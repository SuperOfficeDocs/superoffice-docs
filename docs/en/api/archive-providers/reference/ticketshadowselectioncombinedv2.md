...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=createdAt,person/hasInterests,person/personCountryId,person/personActiveErpLinks,person/personAddress/wgs84longitude
