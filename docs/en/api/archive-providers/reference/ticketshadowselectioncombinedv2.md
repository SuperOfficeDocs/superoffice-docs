...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=messageLanguage,contact/contactAssociate/mrMrs,contact/contactExtra/x_contact_integer,sale/saleTypeCategory,project/projectAssociate/contactFullName
