...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=timeSpentExternally,person/personUpdatedBy,person/personAssociate/fullName,person/legalBaseStore,sale/saleUdef/SuperOffice:4
