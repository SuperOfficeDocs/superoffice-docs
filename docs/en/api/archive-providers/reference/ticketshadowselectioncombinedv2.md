...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=connectId,createdBy/middleName,createdBy/contactCategory,person/personAssociate/contactName,contact/contactUdef/SuperOffice:4
