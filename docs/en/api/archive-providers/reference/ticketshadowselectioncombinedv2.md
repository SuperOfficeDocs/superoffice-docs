...
keywords: TicketShadowSelectionCombinedV2 archive provider
so.generated: true
so.topic: reference
...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=ownedBy/contactName,person/kanaFirstName,person/supportAssociateFullName,person/personAssociate/credentialDisplayValue,contact/streetAddress/formattedMultiLineAddress
