...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=ownedBy/contactCategory,person/lastName,person/personExtra/x_person_user_relation,extra/x_ticket_integer,project/hasGuide
