...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=createdAt,createdBy/contactDepartment,createdBy/userName,person/withdrawnEmarketingConsent,contact/NumberOfTicketsInPeriod
