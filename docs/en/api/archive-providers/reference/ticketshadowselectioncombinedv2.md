...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=createdBy/assocName,person/personDirectPhone/description,person/personAddress/wgs84latitude,person/personExtra/x_person_float,contact/streetAddress/line3
