...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=numberOfReplies,person/restrictionAddress/state,person/personUdef/SuperOffice:8,person/personAssociate/ejUserId,contact/number
