...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=person/isStakeholder,person/personExtra/x_person_longtext,contact/contactUdef/SuperOffice:10,contact/saintTicketCategory,sale/lossReason
