...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=personId,person/kanaLastName,person/personUdef/SuperOffice:6,person/correspondingAssociate/fullName,person/subscription
