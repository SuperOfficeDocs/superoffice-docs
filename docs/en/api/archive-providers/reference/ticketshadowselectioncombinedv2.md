...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=ownedBy/mrMrs,person/personExtra/x_person_float,person/personExtra/x_person_priority_relation,project/projectAssociate/role
