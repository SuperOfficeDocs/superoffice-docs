...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=status,person/personRegisteredDate,person/correspondingAssociate/ejUserId,contact/contactUdef/SuperOffice:13,project/projectPublish/isPublished
