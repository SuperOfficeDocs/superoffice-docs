...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=ownedBy/contactName,person/personHasInterests,person/personDirectFax/description,person/email/emailHasBounced,sale/completed
