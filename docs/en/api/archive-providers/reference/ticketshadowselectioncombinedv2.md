...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=person/hasInfoText,person/personUdef/SuperOffice:1,contact/contactUdef/SuperOffice:1,sale/userGroup,sale/lossReason
