...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=timeSpentInternally,content,ownedBy/assocType,person/personAssociate/contactName,person/correspondingAssociate/ejDisplayName
