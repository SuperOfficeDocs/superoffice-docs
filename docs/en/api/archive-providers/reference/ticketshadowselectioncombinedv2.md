...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=timeSpentExternally,ownedBy/isLocation,person/associateType,contact/contactPhone/formattedNumber,contact/contactAssociate/lastName
