...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=realTimeSpentQueue,repliedAt,createdBy/contactCategory,person/personAddress/county,person/correspondingAssociate/contactDepartment
