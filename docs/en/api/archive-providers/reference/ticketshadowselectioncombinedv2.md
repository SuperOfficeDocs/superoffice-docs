...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=realTimeToClose,person/position,person/kanaFirstName,contact/streetAddress/line3,project/text
