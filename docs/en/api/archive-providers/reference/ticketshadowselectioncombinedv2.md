...
```http!
GET /api/v1/archive/TicketShadowSelectionCombinedV2?$select=timeSpentInternally,createdBy/title,person/personAssociate/mrMrs,person/hasStoreConsent,contact/saintSaleStatus
