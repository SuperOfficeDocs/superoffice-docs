...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelection?$select=alternative/version/number,alternative/version/sent,alternative/version/quote/registeredDate,alternative/version/quote/sale/reopenDate,alternative/version/quote/sale/person/personAssociate/associateDbId
