...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelection?$select=UnitListPriceSubscriptionQuantity,alternative/extraField4,alternative/version/quote/sale/amountWeighted,alternative/version/quote/sale/person/personExtra/x_person_priority_relation,alternative/version/quote/sale/project/nextMilestone
