...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelection?$select=alternative/version/quote/sale/person/personExtra/y_rental/x_contact,alternative/version/quote/sale/contact/deletedDate,alternative/version/quote/sale/project/projectEvent/isExternalEvent,alternative/version/quote/sale/project/projectAssociate/assocType
