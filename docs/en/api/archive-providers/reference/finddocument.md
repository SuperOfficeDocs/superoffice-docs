...
```http!
GET /api/v1/archive/FindDocument?$select=person/correspondingAssociate/ejStatus,project/projectAssociate/associateDbId,project/LastSale,associate/userName
