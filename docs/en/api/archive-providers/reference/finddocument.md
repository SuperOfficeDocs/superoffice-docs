...
```http!
GET /api/v1/archive/FindDocument?$select=person/personAddress/line2,person/personAssociate/personId,project/projectEvent/hasSignOff,project/NumberOfNotCompletedSalesInPeriod
