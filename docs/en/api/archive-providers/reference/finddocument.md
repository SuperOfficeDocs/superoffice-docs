...
```http!
GET /api/v1/archive/FindDocument?$select=person/personCategory,person/personUdef/SuperOffice:7,person/personAssociate/role,person/correspondingAssociate/ejStatus,sale/salePublish/publishedTo
