...
```http!
GET /api/v1/archive/FindDocument?$select=getAllRows,documentPublish/publishedTo,person/correspondingAssociate/contactName,contact/NumberOfNotCompletedTicketsInPeriod,project/projectAssociate/associateDbId
