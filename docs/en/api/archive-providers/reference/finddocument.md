...
```http!
GET /api/v1/archive/FindDocument?$select=person/useAsMailingAddress,person/personDirectPhone/formattedNumber,contact/postAddress/city,project/projectAssociate/ejDisplayName,sale/associate/assocName
