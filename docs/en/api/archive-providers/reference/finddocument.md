...
```http!
GET /api/v1/archive/FindDocument?$select=person/personAssociate/contactFullName,person/legalBaseStore,contact/contactDeleted,contact/activeErpLinks,contact/LastActivity
