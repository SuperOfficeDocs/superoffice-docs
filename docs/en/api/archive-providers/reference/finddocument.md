...
```http!
GET /api/v1/archive/FindDocument?$select=icon,person/personAddress/formattedAddress,person/correspondingAssociate/contactDepartment,sale/userGroup,sale/associate/contactName
