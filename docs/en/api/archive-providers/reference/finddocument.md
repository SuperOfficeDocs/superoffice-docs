...
```http!
GET /api/v1/archive/FindDocument?$select=person/personHasInterests,person/hasCompany,person/personUdef/SuperOffice:10,person/legalBaseStore,contact/nameDepartment
