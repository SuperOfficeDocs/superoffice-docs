...
```http!
GET /api/v1/archive/FindDocument?$select=person/retired,person/personRegisteredBy,person/correspondingAssociate/isLocation,contact/streetAddress/zip,contact/contactUdef/SuperOffice:9
