...
```http!
GET /api/v1/archive/FindDocument?$select=person/personAddress/zip,person/personExtra/x_person_user_relation,person/personExtra/y_rental/y_equipment/x_name
