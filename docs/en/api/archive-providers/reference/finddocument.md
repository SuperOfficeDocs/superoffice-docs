...
```http!
GET /api/v1/archive/FindDocument?$select=contact/streetAddress/addressId,contact/contactUdef/SuperOffice:7,project/projectAssociate/contactDepartment,sale/associate/firstName
