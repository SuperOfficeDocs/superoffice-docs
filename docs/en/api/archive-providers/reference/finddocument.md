...
```http!
GET /api/v1/archive/FindDocument?$select=person/email/emailAddress,person/personAssociate/contactCategory,contact/nameDepartment,contact/category,contact/updatedBy
