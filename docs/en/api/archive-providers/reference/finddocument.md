...
```http!
GET /api/v1/archive/FindDocument?$select=userGroup,person/birthDay,person/personAssociateId,person/personExtra/x_person_date,person/correspondingAssociate/associateDbId
