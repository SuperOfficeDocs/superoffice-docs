...
```http!
GET /api/v1/archive/FindDocument?$select=person/personAddress/city,person/personAssociate/role,project/projectEvent/hasSignOn,sale/currencyId,sale/associate/simultaneousEjUser
