...
```http!
GET /api/v1/archive/FindDocument?$select=person/isStakeholder,person/email/emailProtocol,person/personExtra/x_person_contact_relation,person/correspondingAssociate/fullName,contact/contactId
