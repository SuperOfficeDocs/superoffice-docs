...
```http!
GET /api/v1/archive/FindDocument?$select=person/personAssociate/userName,contact/NumberOfActivitiesInPeriod,project/projectAssociate/simultaneousEjUser,sale/registeredBy
