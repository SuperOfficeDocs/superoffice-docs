...
```http!
GET /api/v1/archive/FindDocument?$select=person/supportLanguage,person/personDirectFax/description,person/email/emailDescription,person/personAddress/addressId,person/restrictionAddress/zip
