...
```http!
GET /api/v1/archive/FindDocument?$select=person/personHasInterests,person/personAssociate/isLocation,contact/hasInterests,contact/saintDirection,sale/earningPercent
