...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=rowKind,sale/personId,sale/stalledComment,appointment/appointmentId,document/associate/contactFullName
