...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/saleStatus,sale/associate/contactDepartment,appointment/appointmentUdef/SuperOffice:2,projectMember/personUrl/URLDescription,projectMember/associateId
