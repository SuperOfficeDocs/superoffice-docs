...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/userGroup,sale/saleNumber,appointment/appointment/agendaHtml,document/associate/firstName,projectMember/postAddress/city
