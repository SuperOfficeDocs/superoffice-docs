...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=LastCompletedSale,saintSaleStatus,appointment/appointment/agendaHtml,projectMember/personDirectPhone/formattedNumber,projectMember/contactFax/formattedNumber
