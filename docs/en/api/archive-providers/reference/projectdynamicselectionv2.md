...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=type,projectUrl/URLDescription,projectUdef/SuperOffice:6,document/associate/ejStatus,projectMember/personPrivate/formattedNumber
