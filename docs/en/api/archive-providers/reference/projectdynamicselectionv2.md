...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectEvent/eventDate,sale/amount,sale/associate/associateDbId,appointment/completed,appointment/appointment/isConverted
