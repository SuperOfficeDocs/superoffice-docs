...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=getNoRows,sale/text,sale/associate/mrMrs,appointment/associate/credentialType,projectMember/email/emailProtocol
