...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/nextDueDate,sale/associate/ejUserId,appointment/associate/contactName,document/associate/mrMrs,projectMember/contactId
