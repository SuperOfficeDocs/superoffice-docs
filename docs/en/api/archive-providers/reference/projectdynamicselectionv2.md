...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/createdByWorkflow,sale/associate/title,appointment/date,document/associate/ejStatus,projectMember/hasInfoText
