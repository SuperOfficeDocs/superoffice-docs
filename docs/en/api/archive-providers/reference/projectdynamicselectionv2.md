...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectAssociate/ejUserId,sale/registeredByFullName,appointment/appointment/textId,projectMember/contactId,projectMember/personRegisteredBy
