...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/associateId,sale/saleUdef/SuperOffice:3,projectMember/personNoMail,projectMember/correspondingAssociate/mrMrs
