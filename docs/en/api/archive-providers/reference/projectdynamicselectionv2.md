...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=text,projectAssociate/personId,appointment/associate/assocType,document/associate/associateDbId,document/associate/otherGroups
