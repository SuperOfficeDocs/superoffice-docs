...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/registeredDate,appointment/appointmentUdef/SuperOffice:8,document/snum,projectMember/name,projectMember/code
