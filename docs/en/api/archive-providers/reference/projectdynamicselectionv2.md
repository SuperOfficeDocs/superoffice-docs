...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/associate/personId,appointment/date,appointment/appointmentPublish/publishedBy,document/associate/mrMrs,projectMember/streetAddress/line3
