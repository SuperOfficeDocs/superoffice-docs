...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/associate/locationAddress,appointment/appointmentUdef/SuperOffice:5,appointment/associate/ejDisplayName,document/registeredByFullName
