...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=sale/updatedBy,projectMember/restrictionAddress/state,projectMember/personAssociate/simultaneousEjUser,projectMember/registeredByFullName,projectMember/deletedDate
