...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectEvent/eventDate,projectAssociate/contactCategory,document/date,document/documentUdef/SuperOffice:7,projectMember/personAssociate/credentialType
