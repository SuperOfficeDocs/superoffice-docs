...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=NumberOfNotCompletedSalesInPeriod,LastSale,sale/currency,sale/associate/usergroupId,appointment/associate/isActiveText
