...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectAssociate/locationAddress,sale/personId,sale/associate/middleName,document/registeredBy,document/associate/credentialDisplayValue
