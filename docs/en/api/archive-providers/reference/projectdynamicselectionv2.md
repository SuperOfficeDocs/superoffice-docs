...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectAssociate/personEmail,LastCompletedSale,sale/heading,appointment/userGroup,appointment/associate/firstName
