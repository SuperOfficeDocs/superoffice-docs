...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectAssociate/assocName,saintIntention,appointment/projectId,appointment/associate/userName,appointment/appointment/titleHtml
