...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectAssociate/userName,sale/projectId,sale/lossReason,sale/associate/portraitThumbnail,document/type
