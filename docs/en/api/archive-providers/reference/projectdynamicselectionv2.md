...
```http!
GET /api/v1/archive/ProjectDynamicSelectionV2?$select=projectAssociate/fullName,LastCompletedActivity,sale/salePublish/publishedBy,sale/associate/contactDepartment,appointment/associate/contactFullName
