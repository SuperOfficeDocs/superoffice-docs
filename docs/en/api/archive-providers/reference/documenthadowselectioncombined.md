...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/correspondingAssociate/contactDepartment,contact/postAddress/zip,contact/contactAssociate/otherGroups,associate/isLocation
