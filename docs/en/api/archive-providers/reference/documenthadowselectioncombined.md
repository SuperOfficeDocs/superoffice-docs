...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/leadstatusRank,contact/contactExtra/x_contact_short_dropdown,documentUdef/SuperOffice:2
