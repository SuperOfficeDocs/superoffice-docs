...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/personCountryId,person/personAssociate/contactDepartment,person/consentSourceEmarketing,contact/contactUdef/SuperOffice:5,project/icon
