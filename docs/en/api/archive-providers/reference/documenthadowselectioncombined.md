...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/supportAssociate,contact/streetAddress/zip,contact/restrictionAddress/formattedAddress,contact/NumberOfActivities,contact/LastCompletedSale
