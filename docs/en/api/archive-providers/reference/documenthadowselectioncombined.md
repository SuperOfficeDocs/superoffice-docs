...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=associateId,visibleFor,contact/stop,contact/restrictionAddress/formattedMultiLineAddress,contact/contactExtra/x_contact_shorttext
