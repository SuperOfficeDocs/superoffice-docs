...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/correspondingAssociate/ejStatus,contact/postAddress/zip,contact/contactUdef/SuperOffice:11,sale/source,sale/stalledComment
