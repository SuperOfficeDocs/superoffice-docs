...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/hasCompany,person/personAddress/formattedMultiLineAddress,person/correspondingAssociate/assocType,contact/NumberOfNotCompletedSales
