...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/retired,person/restrictionAddress/line2,person/correspondingAssociate/usergroup,contact/deletedDate,contact/contactExtra/x_contact_date
