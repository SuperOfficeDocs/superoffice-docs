...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=type,person/personAddress/addressId,person/restrictionAddress/line2,person/personAssociate/credentialDisplayValue,project/hasInfoText
