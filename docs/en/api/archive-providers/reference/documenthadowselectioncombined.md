...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=date,person/correspondingAssociate/isActiveText,contact/category,contact/contactAssociate/ejStatus,project/projectPublish/publishedFrom
