...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=projectId,person/personCountryId,person/personAddress/county,person/personExtra/y_rental/x_contact,contact/restrictionAddress/wgs84latitude
