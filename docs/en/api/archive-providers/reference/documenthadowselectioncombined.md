...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=contactId,contact/contactPhone/formattedNumber,contact/LastDoBySale,project/projectAssociate/isActive,sale/saleUdef/SuperOffice:6
