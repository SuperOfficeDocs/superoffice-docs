...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/email/emailId,person/personAssociate/usergroup,contact/contactAssociate/personEmail,sale/hasStakeholders,sale/associate/usergroup
