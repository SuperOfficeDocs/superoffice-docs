...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=time,person/hasCompany,associate/isActiveText,sale/associate/contactFullName,sale/associate/locationAddress
