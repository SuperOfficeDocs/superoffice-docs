...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=snum,person/restrictionAddress/line2,person/correspondingAssociate/fullName,person/correspondingAssociate/ejDisplayName,contact/name
