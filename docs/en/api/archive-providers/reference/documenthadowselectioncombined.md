...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/personCategoryGroup,person/personBusiness,contact/postAddress/line1,contact/contactInterestIds,contact/contactUdef/SuperOffice:1
