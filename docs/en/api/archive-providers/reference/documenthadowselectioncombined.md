...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=personId,contact/contactExtra/x_contact_shorttext,project/completed,project/NumberOfActivities,sale/registeredDate
