...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/fullName,person/personAddress/addressId,contact/restrictionAddress/zip,project/projectAssociate/middleName,sale/currencyId
