...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=completed,person/correspondingAssociate/simultaneousEjUser,contact/postAddress/city,project/description,associate/role
