...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=mailMergeDraft,person/correspondingAssociate/isActive,contact/contactUdef/SuperOffice:2,project/nextMilestone,project/NumberOfSalesInPeriod
