...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/personExtra/x_person_contact_relation,person/personAssociate/ejUserId,contact/countryId,contact/saintTicketStatus,sale/updatedBy
