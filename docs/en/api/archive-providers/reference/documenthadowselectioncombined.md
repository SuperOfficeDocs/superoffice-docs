...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=registeredBy,person/email/emailLastSent,person/personExtra/x_person_date,contact/activeErpLinks,project/projectAssociate/contactName
