...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/personAddress/county,person/personUdef/SuperOffice:9,person/legalBaseStore,associate/otherGroups
