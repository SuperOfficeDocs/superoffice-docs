...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/personAssociate/assocTooltip,person/correspondingAssociate/personId,contact/registeredByFullName,contact/postAddress/formattedMultiLineAddress,contact/restrictionAddress/wgs84latitude
