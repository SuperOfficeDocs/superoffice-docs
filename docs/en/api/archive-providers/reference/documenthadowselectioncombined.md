...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombined?$select=person/personUdef/SuperOffice:9,contact/contactExtra/x_contact_shorttext,person/correspondingAssociate/assocTooltip
