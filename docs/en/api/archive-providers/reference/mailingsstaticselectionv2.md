...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=updatedBy,mailingAddr/contact/name,mailingAddr/person/portraitThumbnail,mailingAddr/person/supportLanguage,emailFlow/workflowAssociate/personId
