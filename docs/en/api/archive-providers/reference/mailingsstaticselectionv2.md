...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingSent,mailingDeleted,mailingAddr/contact/contactAssociate/contactName,mailingAddr/person/email/emailAddress,mailingAddr/person/personAssociate/lastName
