...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/contactExtra/x_contact_timespan,mailingAddr/person/correspondingAssociate/credentialType,emailFlow/workflowEnrolledCount,emailFlow/workflowSucceededCount,emailFlow/workflowAssociate/mrMrs
