...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingType,mailingDeleted,mailingAddr/contact/name,mailingAddr/contact/contactSource,mailingAddr/contact/streetAddress/wgs84longitude
