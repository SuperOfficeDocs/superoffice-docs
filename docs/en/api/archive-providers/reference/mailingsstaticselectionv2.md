...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/streetAddress/city,mailingAddr/person/personAssociate/role,associate/assocName
