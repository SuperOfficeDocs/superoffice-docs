...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingDeleted,mailingAddr/person/correspondingAssociate/ejStatus,mailingAddr/contact/saintIntention
