...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingSubscriptionType,mailingAddr/contact/contactFax/description,mailingAddr/contact/postAddress/formattedAddress,mailingAddr/contact/streetAddress/wgs84latitude,mailingAddr/person/personMobilePhone/description
