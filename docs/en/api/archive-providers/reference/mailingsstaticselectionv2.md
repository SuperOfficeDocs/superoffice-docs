...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/contactAssociate/fullName,mailingAddr/contact/LastTicket,mailingAddr/person/correspondingAssociate/firstName,mailingAddr/person/correspondingAssociate/role,emailFlow/workflowName
