...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/contactAssociate/contactCategory,project/projectAssociate/credentialDisplayValue,project/NumberOfSalesInPeriod
