...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/mainContact,mailingAddr/contact/LastDoByActivity,mailingAddr/person/personUpdatedDate,emailFlow/workflowAssociate/role
