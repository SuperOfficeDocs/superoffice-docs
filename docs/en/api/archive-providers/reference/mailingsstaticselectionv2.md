...
```http!
GET /api/v1/archive/MailingsStaticSelectionV2?$select=mailingAddr/contact/postAddress/line1,mailingAddr/contact/postAddress/line2,mailingAddr/contact/contactAssociate/contactFullName,mailingAddr/contact/contactAssociate/portraitThumbnail,associate/ejStatus
