...
```http!
GET /api/v1/archive/QuoteLineDynamicSelectionV2?$select=quoteLineThumbnail,productCategoryKey,status,alternative/vatInfo,alternative/version/quote/sale/person/personCountryId
