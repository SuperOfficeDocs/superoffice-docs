...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/title,person/personExtra/x_person_timespan,person/correspondingAssociate/portraitThumbnail,contact/contactId,contact/contactExtra/x_contact_timespan
