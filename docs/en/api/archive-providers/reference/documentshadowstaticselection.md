...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=recordTypeText,documentPublish/publishedTo,person/searchPhone/formattedNumber,person/email/emailLastBounce,person/personAddress/wgs84latitude
