...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=recordType,person/email/emailBounceCount,person/personInterestIds,person/personAssociate/ejUserId,contact/contactNoMail
