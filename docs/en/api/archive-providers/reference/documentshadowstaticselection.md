...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/middleName,person/kanaLastName,person/email/emailId,person/personAssociate/credentialDisplayValue,contact/contactExtra/x_contact_short_dropdown
