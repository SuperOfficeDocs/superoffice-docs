...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=saleId,documentPublish/publishedBy,person/portraitThumbnail,person/personExtra/y_rental/id,person/personExtra/y_rental/y_equipment/x_name
