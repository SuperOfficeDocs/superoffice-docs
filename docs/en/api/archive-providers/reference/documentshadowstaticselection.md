...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=getNoRows,isReport,person/personInfo/infoText,person/personAssociate/isActive,person/personAssociate/isActiveText
