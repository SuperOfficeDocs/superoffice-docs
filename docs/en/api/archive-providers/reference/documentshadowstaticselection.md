...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=ourref,person/firstName,person/correspondingAssociate/locationAddress,person/consentSourceEmarketing,contact/countryId
