...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=contact/contactSource,contact/restrictionAddress/addressId,contact/contactAssociate/personId,contact/contactUdef/SuperOffice:7,contact/saintActivityType
