...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=contact/NumberOfSales,project/projectAssociate/contactId,project/saintAmountClass,sale/lossReason
