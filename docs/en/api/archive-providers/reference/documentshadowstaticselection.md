...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=registeredBy,person/createdByForm,person/personAssociate/assocTooltip,contact/SaintStatus2,project/NumberOfActivitiesInPeriod
