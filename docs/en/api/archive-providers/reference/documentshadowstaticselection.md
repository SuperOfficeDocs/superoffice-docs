...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=getNoRows,icon,person/personExtra/x_person_priority_relation,contact/nameDepartment,contact/deletedDate
