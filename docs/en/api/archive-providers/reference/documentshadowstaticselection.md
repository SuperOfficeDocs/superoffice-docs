...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=documentId,person/personUrl/URLAddress,contact/updatedDate,project/projectAssociate/ejStatus,sale/associate/role
