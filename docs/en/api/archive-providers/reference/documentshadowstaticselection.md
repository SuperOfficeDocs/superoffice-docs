...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=registeredByFullName,person/position,person/birthdate,person/email/emailHasBounced,contact/contactNoMail
