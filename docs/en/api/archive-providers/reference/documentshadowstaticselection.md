...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/supportLanguage,person/personExtra/y_rental/y_equipment/x_name,sale/contactId,sale/registeredByFullName,sale/associate/ejUserId
