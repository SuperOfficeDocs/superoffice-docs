...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=type,person/kanaFirstName,person/personUdef/SuperOffice:2,documentUdef/SuperOffice:1,sale/saleType
