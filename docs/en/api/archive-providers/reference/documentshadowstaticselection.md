...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/supportLanguage,person/personPager/description,person/correspondingAssociate/personId,contact/contactAssociate/credentialDisplayValue,project/projectAssociate/assocTooltip
