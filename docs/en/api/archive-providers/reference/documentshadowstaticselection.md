...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/personCountryId,person/email/emailId,person/personAddress/addressId,person/personAddress/line2
