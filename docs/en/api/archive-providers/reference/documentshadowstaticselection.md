...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/personAssociate/mrMrs,person/personAssociate/credentialType,contact/contactAssociate/contactFullName,contact/contactUdef/SuperOffice:10,contact/contactExtra/x_contact_default_integer
