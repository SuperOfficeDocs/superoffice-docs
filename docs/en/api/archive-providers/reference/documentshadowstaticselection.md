...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/restrictionAddress/county,person/personAssociate/ejStatus,contact/contactUdef/SuperOffice:12,project/hasInfoText,sale/personId
