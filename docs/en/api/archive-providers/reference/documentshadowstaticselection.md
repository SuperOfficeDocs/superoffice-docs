...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/hasInterests,person/personExtra/x_person_time,contact/updatedByFullName,project/name,sale/associate/associateDbId
