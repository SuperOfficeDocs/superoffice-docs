...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=updatedBy,person/personId,person/fullName,contact/postAddress/state,sale/associate/contactDepartment
