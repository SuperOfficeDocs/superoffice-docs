...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/legalBaseStore,contact/country,contact/contactExtra/x_contact_datetime,project/projectAssociate/associateDbId
