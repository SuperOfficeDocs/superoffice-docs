...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=mailMergeDraft,person/personCountry,contact/business,project/name,project/projectAssociate/portraitThumbnail
