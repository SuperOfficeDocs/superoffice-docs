...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=getNoRows,person/correspondingAssociate/personId,project/projectAssociate/userName,sale/updatedByFullName
