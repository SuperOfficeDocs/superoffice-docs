...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=who,isMail,contact/postAddress/formattedMultiLineAddress,contact/streetAddress/line2,contact/contactExtra/x_contact_timespan
