...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=person/phone/formattedNumber,person/personUrl/URLDescription,person/personUdef/SuperOffice:6,contact/number,contact/streetAddress/line2
