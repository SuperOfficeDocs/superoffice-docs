...
```http!
GET /api/v1/archive/DocumentShadowStaticSelection?$select=documentId,person/email/emailHasBounced,person/restrictionAddress/line3,sale/associate/ejUserId
