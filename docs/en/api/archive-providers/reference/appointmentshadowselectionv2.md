...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/streetAddress/line3,person/hasInfoText,person/kanaLastName,person/correspondingAssociate/isActiveText,project/projectUdef/SuperOffice:1
