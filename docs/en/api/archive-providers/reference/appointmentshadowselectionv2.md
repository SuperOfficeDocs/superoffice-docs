...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=recurring,suggestedAppointmentId,recordTypeText,contact/contactPhone/formattedNumber,contact/postAddress/wgs84latitude
