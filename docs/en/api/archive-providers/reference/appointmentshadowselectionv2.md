...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/contactFax/description,contact/SaintStatus2,person/personUrl/URLAddress,project/hasGuide,project/projectAssociate/isLocation
