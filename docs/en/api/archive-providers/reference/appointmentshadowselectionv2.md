...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=location,contact/countryId,contact/contactUdef/SuperOffice:2,person/isProjectMember,sale/saleUdef/SuperOffice:2
