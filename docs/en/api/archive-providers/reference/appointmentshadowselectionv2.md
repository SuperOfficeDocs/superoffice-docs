...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=createdByWorkflow,person/email/emailBounceCount,person/personUdef/SuperOffice:10,project/NumberOfSalesInPeriod
