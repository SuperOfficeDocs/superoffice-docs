...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/updatedBy,contact/email/emailProtocol,contact/contactInterestIds,contact/LastSale,person/personUpdatedByFullName
