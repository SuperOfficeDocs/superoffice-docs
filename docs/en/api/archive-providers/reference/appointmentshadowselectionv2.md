...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=personId,contact/url/URLDescription,contact/contactAssociate/assocName,contact/contactUdef/SuperOffice:5,person/fullName
