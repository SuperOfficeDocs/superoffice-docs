...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=completed,contact/contactId,contact/NumberOfNotCompletedActivitiesInPeriod,contact/saintTicketCategory,project/projectAssociate/ejStatus
