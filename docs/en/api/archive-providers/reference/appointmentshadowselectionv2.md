...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=registeredBy,contact/email/emailProtocol,person/personDirectPhone/formattedNumber,person/withdrawnStoreConsent,project/projectAssociate/contactCategory
