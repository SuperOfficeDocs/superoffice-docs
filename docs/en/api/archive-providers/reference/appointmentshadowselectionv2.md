...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=visibleFor,contact/contactExtra/x_contact_shorttext,person/portraitThumbnail,project/projectAssociate/assocTooltip,project/saintDirection
