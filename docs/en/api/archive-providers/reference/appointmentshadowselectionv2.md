...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=personId,saleId,person/personAddress/wgs84longitude,person/personExtra/x_person_timespan,person/personAssociate/isActiveText
