...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=isMilestone,contact/deletedDate,contact/postAddress/wgs84latitude,contact/contactUdef/SuperOffice:7,person/personSource
