...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/nameDepartment,contact/updatedDate,contact/contactAssociate/lastName,contact/contactAssociate/title,contact/contactUdef/SuperOffice:8
