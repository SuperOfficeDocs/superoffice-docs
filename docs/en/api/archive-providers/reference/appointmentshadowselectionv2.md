...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=associateId,contact/streetAddress/state,contact/NumberOfSalesInPeriod,person/personAddress/zip,person/restrictionAddress/zip
