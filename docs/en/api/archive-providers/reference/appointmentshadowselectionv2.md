...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=associateId,person/email/emailAddress,person/restrictionAddress/state,person/correspondingAssociate/usergroup,project/projectAssociate/lastName
