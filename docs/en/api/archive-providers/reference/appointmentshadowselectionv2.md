...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/postAddress/wgs84longitude,person/contactId,person/hasCompany,person/personAssociate/title,project/registeredDate
