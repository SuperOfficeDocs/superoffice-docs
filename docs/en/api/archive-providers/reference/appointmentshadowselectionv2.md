...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=text,contact/NumberOfSalesInPeriod,person/useAsMailingAddress,person/personInfo/textId,person/personAssociate/isActive
