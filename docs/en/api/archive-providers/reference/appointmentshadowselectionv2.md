...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=project/updatedBy,project/projectAssociate/assocName,project/projectAssociate/ejDisplayName,associate/firstName
