...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/category,contact/streetAddress/line2,contact/streetAddress/formattedAddress,contact/LastCompletedActivity,person/position
