...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=personId,person/correspondingAssociate/isActiveText,project/projectEvent/hasSignOn,project/projectUdef/SuperOffice:1,project/LastCompletedSale
