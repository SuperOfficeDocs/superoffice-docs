...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/contactAssociate/ejStatus,person/isStakeholder,project/projectUdef/SuperOffice:8,sale/icon,sale/associate/contactFullName
