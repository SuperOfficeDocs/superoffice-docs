...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/postAddress/wgs84longitude,contact/contactExtra/x_contact_time,contact/saintActivityType,person/lastName,person/personUrl/URLAddress
