...
```http!
GET /api/v1/archive/AppointmentShadowSelectionV2?$select=contact/deletedDate,contact/restrictionAddress/line3,contact/contactAssociate/role,person/supportAssociateFullName,sale/hasStakeholders
