...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectEvent/hasSignOn,projectAssociate/personId,projectUdef/SuperOffice:9,sale/associateId,sale/earning
