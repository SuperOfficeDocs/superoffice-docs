...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=document/documentPublish/isPublished,projectMember/email/emailAddress,projectMember/correspondingAssociate/middleName,project/textId,personId
