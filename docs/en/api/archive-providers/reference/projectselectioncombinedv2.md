...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=registeredDate,projectAssociate/firstName,sale/associate/ejDisplayName,appointment/alarm,appointment/associate/ejUserId
