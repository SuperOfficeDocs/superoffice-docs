...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectUrl/URLAddress,projectMember/personAssociate/locationAddress,projectMember/NumberOfSalesInPeriod
