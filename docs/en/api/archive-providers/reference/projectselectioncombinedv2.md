...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectUrl/URLDescription,projectMember/retired,projectMember/personAddress/line3,projectMember/personInterestIds,projectMember/contactAssociate/associateDbId
