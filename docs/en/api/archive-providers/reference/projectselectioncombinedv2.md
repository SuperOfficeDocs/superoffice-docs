...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=updatedByFullName,projectAssociate/contactName,document/recordTypeText,projectMember/personRegisteredDate,projectMember/postAddress/wgs84latitude
