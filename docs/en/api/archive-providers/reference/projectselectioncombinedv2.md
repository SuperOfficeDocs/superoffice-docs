...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/time,sale/projectId,appointment/intention,appointment/appointmentUdef/SuperOffice:6,appointment/associate/role
