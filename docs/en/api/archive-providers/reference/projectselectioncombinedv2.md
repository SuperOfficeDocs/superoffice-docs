...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/saleId,appointment/associate/contactFullName,appointment/appointment/titleHtml,projectMember/birthMonth,projectMember/personRegisteredDate
