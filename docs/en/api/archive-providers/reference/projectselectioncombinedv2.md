...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/stage,document/associate/isActive,projectMember/personPager/description,projectMember/personUdef/SuperOffice:4,projectMember/personAssociate/ejUserId
