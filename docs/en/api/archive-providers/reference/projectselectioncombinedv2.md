...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectUdef/SuperOffice:7,appointment/updatedByFullName,document/subject,projectMember/kanaFirstName,projectMember/personExtra/x_person_datetime
