...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectMember/personAssociateFullName,projectMember/streetAddress/wgs84longitude,projectMember/contactAssociate/ejStatus
