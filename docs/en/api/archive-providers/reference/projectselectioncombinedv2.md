...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/associate/firstName,document/ourref,document/document/textId,projectMember/correspondingAssociate/usergroupId
