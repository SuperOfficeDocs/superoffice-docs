...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectAssociate/associateDbId,sale/sale/description,appointment/suggestedAppointmentId,appointment/appointment/isConverted,projectMember/supportLanguage
