...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectUdef/SuperOffice:1,projectUdef/SuperOffice:8,sale/contactId,sale/associate/ejDisplayName,sale/saleUdef/SuperOffice:6
