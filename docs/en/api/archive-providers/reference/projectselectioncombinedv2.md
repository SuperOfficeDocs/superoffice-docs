...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectAssociate/isActive,projectUdef/SuperOffice:6,appointment/visibleInDiary,projectMember/correspondingAssociate/ejStatus,projectMember/name
