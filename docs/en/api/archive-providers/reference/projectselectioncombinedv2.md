...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=saintDirection,projectMember/contactExtra/x_contact_boolean,appointment/appointmentUdef/SuperOffice:2
