...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectUdef/SuperOffice:4,NumberOfActivitiesInPeriod,appointment/associateId,appointment/registeredByFullName,document/projectId
