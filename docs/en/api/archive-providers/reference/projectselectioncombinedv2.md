...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/saleNumber,projectMember/supportAssociateFullName,projectMember/legalBaseEmarketing,projectMember/contactAssociate/contactCategory
