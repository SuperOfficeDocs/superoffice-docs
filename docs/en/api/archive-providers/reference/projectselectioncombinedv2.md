...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/date,sale/lossReason,projectMember/personAssociate/locationAddress,projectMember/contactExtra/x_contact_default_integer
