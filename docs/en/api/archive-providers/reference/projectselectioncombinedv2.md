...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/associate/mrMrs,projectMember/mrMrs,projectMember/personPrivate/formattedNumber,projectMember/personExtra/y_rental/y_equipment/x_name,projectMember/contactAssociate/ejUserId
