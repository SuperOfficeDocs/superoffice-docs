...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/saleStatus,sale/associate/portraitThumbnail,appointment/isMilestone,appointment/appointmentUdef/SuperOffice:3,appointment/associate/otherGroups
