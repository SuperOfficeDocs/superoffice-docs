...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/registeredByFullName,document/associate/contactFullName,document/associate/assocTooltip,projectMember/restrictionAddress/addressId,projectMember/personExtra/x_person_shorttext_list
