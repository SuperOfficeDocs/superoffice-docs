...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/amountWeighted,sale/associate/assocType,document/subject,document/associate/mrMrs,document/associate/associateDbId
