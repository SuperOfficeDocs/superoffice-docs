...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectMember/associateType,projectMember/personAddress/county,projectMember/contactAssociate/middleName
