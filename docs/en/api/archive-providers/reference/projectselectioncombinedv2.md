...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectEvent/eventDate,projectUdef/SuperOffice:5,NumberOfSales,LastCompletedSale,sale/registeredByFullName
