...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/associate/userName,appointment/associate/middleName,document/personId,projectMember/personRegisteredDate,projectMember/legalBaseStore
