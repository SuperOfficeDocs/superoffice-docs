...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=sale/visibleFor,document/updatedDate,document/registeredDate,projectMember/personNumber,projectMember/supportAssociate
