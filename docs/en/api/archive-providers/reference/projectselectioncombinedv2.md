...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=projectAssociate/title,sale/personId,projectMember/personExtra/x_person_datetime,projectMember/consentSourceEmarketing,projectMember/updatedDate
