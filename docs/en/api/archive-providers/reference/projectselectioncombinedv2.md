...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=LastSale,appointment/associate/firstName,projectMember/personUpdatedBy,projectMember/correspondingAssociate/ejStatus
