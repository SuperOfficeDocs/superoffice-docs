...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=registeredByFullName,LastCompletedSale,sale/associate/contactCategory,document/associate/personEmail,projectMember/restrictionAddress/state
