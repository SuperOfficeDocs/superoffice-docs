...
```http!
GET /api/v1/archive/ProjectSelectionCombinedV2?$select=NumberOfActivities,sale/associate/personEmail,appointment/recurrenceRuleId,appointment/endTime,appointment/associate/credentialType
