...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/personRegisteredDate,person/personUdef/SuperOffice:5,person/personExtra/x_person_datetime,contact/contactAssociate/fullName
