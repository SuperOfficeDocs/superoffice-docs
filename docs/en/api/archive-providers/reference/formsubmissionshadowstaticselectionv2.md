...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=getNoRows,associate/contactName,person/whenUpdatedByWorkflow,person/personExtra/y_rental/x_end,person/correspondingAssociate/isActive
