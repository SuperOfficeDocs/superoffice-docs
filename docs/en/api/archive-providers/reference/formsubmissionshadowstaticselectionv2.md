...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/correspondingAssociate/ejStatus,contact/contactExtra/x_contact_hidden_integer,contact/contactExtra/x_contact_longtext
