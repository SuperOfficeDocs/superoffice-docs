...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/personUpdatedBy,person/personAddress/wgs84longitude,contact/registeredByFullName
