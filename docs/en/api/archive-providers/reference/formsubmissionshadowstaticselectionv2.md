...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=contact/countryId,contact/restrictionAddress/formattedAddress,contact/contactAssociate/title
