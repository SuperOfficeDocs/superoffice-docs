...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=associate/portraitThumbnail,person/personBusiness,person/hasCompany,person/personUdef/SuperOffice:10,contact/contactAssociate/ejStatus
