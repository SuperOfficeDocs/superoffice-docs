...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/personAddress/formattedAddress,person/personExtra/y_rental/x_contact,person/restrictionAddress/wgs84latitude
