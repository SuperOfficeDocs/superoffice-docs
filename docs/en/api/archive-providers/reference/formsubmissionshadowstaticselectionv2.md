...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/personUdef/SuperOffice:5,contact/NumberOfSalesInPeriod,person/restrictionAddress/wgs84latitude
