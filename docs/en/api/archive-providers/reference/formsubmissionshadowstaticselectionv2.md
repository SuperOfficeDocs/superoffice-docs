...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=contact/contactUdef/SuperOffice:2,contact/contactExtra/x_contact_float,person/restrictionAddress/zip
