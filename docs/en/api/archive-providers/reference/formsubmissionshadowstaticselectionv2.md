...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=registeredDate,associate/assocType,contact/streetAddress/wgs84latitude,contact/contactExtra/x_contact_time,contact/LastCompletedActivity
