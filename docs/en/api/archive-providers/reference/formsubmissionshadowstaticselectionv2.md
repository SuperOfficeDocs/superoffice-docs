...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=associate/locationAddress,person/mrMrs,person/correspondingAssociate/ejDisplayName,contact/contactAssociate/otherGroups,contact/NumberOfNotCompletedActivities
