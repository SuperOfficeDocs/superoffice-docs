...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=personId,associate/isActiveText,person/birthMonth,person/personUdef/SuperOffice:4,person/personAssociate/credentialDisplayValue
