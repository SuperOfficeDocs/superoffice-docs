...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/restrictionAddress/wgs84latitude,contact/streetAddress/line1,person/restrictionAddress/wgs84latitude
