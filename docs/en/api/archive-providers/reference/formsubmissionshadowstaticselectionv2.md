---
uid: FormSubmissionShadowStaticSelectionV2
title: FormSubmissionShadowStaticSelectionV2
description: Shadow contact provider for the static FormSubmission provider.
keywords: FormSubmissionShadowStaticSelectionV2 archive provider
generated: true
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionShadowSelectionStaticProviderV2">SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionShadowSelectionStaticProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/personUpdatedBy,person/restrictionAddress/wgs84longitude,person/personExtra/x_person_time,contact/restrictionAddress/formattedAddress,contact/contactAssociate/contactFullName
