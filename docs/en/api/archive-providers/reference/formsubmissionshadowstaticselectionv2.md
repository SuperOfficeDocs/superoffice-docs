...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=person/restrictionAddress/wgs84latitude,contact/name,contact/restrictionAddress/county,contact/contactExtra/y_organization/x_name
