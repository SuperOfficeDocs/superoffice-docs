...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=associate/fullName,person/personExtra/x_person_shorttext,contact/code,contact/contactUdef/SuperOffice:9
