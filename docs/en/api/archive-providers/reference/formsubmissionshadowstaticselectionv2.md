...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=associate/role,associate/portraitThumbnail,person/rank,person/searchPhone/formattedNumber,person/email/emailId
