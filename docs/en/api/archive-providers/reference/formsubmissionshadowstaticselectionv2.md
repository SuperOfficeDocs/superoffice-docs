...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=associateId,associate/middleName,person/personUdef/SuperOffice:8,person/correspondingAssociate/contactId,person/hasStoreConsent
