...
```http!
GET /api/v1/archive/FormSubmissionShadowStaticSelectionV2?$select=associate/contactName,associate/assocTooltip,person/kanaLastName,person/personExtra/y_rental/id,contact/hasInfoText
