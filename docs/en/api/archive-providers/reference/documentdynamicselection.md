...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=who,person/supportAssociateFullName,person/correspondingAssociate/usergroup,person/correspondingAssociate/portraitThumbnail,contact/postAddress/city
