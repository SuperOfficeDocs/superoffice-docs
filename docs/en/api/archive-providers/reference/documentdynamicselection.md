...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=date,person/supportAssociateFullName,contact/url/URLDescription,project/registeredBy,project/projectAssociate/contactCategory
