...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=name,person/personUpdatedBy,contact/searchPhone/formattedNumber,contact/postAddress/wgs84longitude,contact/contactExtra/x_contact_contact_relation
