...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/personNumber,person/withdrawnEmarketingConsent,contact/restrictionAddress/formattedMultiLineAddress,project/projectAssociate/contactId
