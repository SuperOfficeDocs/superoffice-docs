...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/personAddress/city,person/personAddress/formattedAddress,person/personExtra/y_rental/x_contact,contact/contactUdef/SuperOffice:13,project/updatedBy
