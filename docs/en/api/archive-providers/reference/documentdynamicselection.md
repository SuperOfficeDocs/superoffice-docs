...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=getAllRows,registeredBy,person/personId,person/personExtra/x_person_appointment_relation,project/endDate
