...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=visibleFor,person/useAsMailingAddress,person/personExtra/x_person_priority_relation,contact/activeErpLinks,contact/contactAssociate/title
