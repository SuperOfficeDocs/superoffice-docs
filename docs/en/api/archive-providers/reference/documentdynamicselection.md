...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/personUdef/SuperOffice:4,contact/contactAssociate/ejUserId,contact/LastDoBySale,project/projectAssociate/contactDepartment,sale/associateId
