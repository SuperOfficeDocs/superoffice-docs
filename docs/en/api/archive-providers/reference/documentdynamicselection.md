...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=type,person/email/emailAddress,contact/email/emailLastBounce,contact/contactUdef/SuperOffice:5,project/projectUrl/URLAddress
