...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/rank,person/restrictionAddress/formattedAddress,person/personAssociate/assocType,project/LastCompletedActivity,sale/salePublish/publishedTo
