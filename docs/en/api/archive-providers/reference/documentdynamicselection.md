...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/contactId,person/mrMrs,person/email/emailHasBounced,person/personAddress/line3,project/NumberOfNotCompletedActivitiesInPeriod
