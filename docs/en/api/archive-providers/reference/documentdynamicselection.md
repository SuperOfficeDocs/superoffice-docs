...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=sale/amountWeighted,person/correspondingAssociate/contactFullName,contact/contactAssociate/firstName
