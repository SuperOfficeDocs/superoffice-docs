...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=recordType,person/supportAssociate,person/personMobilePhone/formattedNumber,person/searchPhone/description,person/restrictionAddress/state
