...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/personNoMail,contact/hasInterests,contact/countryId,contact/email/emailHasBounced,contact/streetAddress/formattedMultiLineAddress
