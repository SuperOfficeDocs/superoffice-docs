...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=documentPublish/publishedTo,person/birthYear,person/personExtra/x_person_boolean,person/personAssociate/isLocation,project/updatedByFullName
