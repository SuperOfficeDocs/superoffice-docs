...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=updatedDate,person/personAssociate/contactId,person/personAssociate/userName,contact/updatedDate,contact/contactAssociate/ejUserId
