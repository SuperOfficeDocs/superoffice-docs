...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/createdByForm,person/correspondingAssociate/ejStatus,contact/email/emailAddress,contact/email/emailLastSent,project/projectAssociate/simultaneousEjUser
