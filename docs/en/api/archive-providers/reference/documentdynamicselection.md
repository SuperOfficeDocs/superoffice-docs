...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=saleId,person/birthYear,person/restrictionAddress/city,person/correspondingAssociate/firstName,person/isMailingRecipient
