...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=person/personAssociate/credentialType,contact/NumberOfNotCompletedActivities,person/correspondingAssociate/usergroup
