...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=personId,person/searchPhone/description,person/personUdef/SuperOffice:2,contact/streetAddress/formattedMultiLineAddress,contact/contactExtra/y_organization/x_name
