...
```http!
GET /api/v1/archive/DocumentDynamicSelection?$select=snum,person/personRegisteredByFullName,person/personCategory,person/email/emailDescription,person/restrictionAddress/addressId
