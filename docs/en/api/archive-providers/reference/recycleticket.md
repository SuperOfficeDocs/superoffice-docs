...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdBy/isActive,person/useAsMailingAddress,person/personExtra/y_rental/x_amount,person/personAssociate/contactFullName,contact/contactFax/description
