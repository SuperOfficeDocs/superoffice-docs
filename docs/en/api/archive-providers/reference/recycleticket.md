...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/isProjectMember,person/correspondingAssociate/isActive,person/subscription,contact/contactAssociate/credentialDisplayValue,sale/createdByWorkflow
