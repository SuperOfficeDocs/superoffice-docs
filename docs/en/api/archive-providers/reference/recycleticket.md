...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/fullName,person/email/emailHasBounced,person/personAddress/wgs84longitude,contact/LastCompletedSale,sale/userGroup
