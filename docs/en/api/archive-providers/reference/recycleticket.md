...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdBy/usergroupId,person/personExtra/x_person_appointment_relation,contact/streetAddress/zip,contact/NumberOfActivitiesInPeriod,sale/currencyId
