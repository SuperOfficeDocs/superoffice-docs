...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/personDirectFax/description,person/email/emailBounceCount,person/restrictionAddress/wgs84longitude,sale/associate/firstName
