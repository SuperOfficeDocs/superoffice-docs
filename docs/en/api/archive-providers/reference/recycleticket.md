...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/personAssociate/usergroupId,contact/contactAssociate/personEmail,contact/NumberOfSalesInPeriod,sale/stage,sale/daysInStage
