...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdBy/contactCategory,contact/contactAssociate/ejUserId,contact/NumberOfNotCompletedActivitiesInPeriod,extra/x_ticket_date,extra/x_ticket_time
