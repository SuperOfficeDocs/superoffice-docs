...
```http!
GET /api/v1/archive/RecycleTicket?$select=ownedBy/assocTooltip,person/portraitThumbnail,person/personActiveErpLinks,person/personUdef/SuperOffice:10,contact/saintSaleStatus
