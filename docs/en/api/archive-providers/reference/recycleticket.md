...
```http!
GET /api/v1/archive/RecycleTicket?$select=status,createdBy/isActiveText,person/birthDay,person/correspondingAssociate/role,contact/contactAssociate/contactName
