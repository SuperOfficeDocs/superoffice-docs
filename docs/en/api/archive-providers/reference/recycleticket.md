...
```http!
GET /api/v1/archive/RecycleTicket?$select=timeToReply,ticketStatus/rank,person/personUdef/SuperOffice:9,person/personAssociate/isActiveText,person/personAssociate/isLocation
