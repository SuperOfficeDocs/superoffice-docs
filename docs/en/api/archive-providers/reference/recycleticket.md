...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdBy/firstName,person/retired,person/personPager/formattedNumber,person/personUdef/SuperOffice:9,contact/url/URLDescription
