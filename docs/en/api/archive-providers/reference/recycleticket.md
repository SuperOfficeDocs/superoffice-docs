...
```http!
GET /api/v1/archive/RecycleTicket?$select=content,createdBy/role,person/personUrl/URLAddress,person/correspondingAssociate/assocTooltip,contact/companyCategoryRank
