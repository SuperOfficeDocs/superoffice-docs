...
```http!
GET /api/v1/archive/RecycleTicket?$select=categoryFullName,person/restrictionAddress/wgs84longitude,person/personAssociate/mrMrs,sale/associate/contactCategory,project/projectAssociate/simultaneousEjUser
