...
```http!
GET /api/v1/archive/RecycleTicket?$select=repliedAt,ticketPriority/rank,person/retired,person/personAssociate/ejStatus,person/personAssociate/credentialType
