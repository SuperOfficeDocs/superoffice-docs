...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/personExtra/y_rental/x_start,contact/email/emailDescription,contact/email/emailLastSent,sale/saleType,sale/associate/credentialType
