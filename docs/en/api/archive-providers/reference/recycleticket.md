...
```http!
GET /api/v1/archive/RecycleTicket?$select=readByCustomer,createdBy/lastName,createdBy/ejDisplayName,person/personUpdatedByFullName,person/email/emailLastSent
