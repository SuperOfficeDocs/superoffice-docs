...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/restrictionAddress/line2,contact/restrictionAddress/line1,contact/url/URLDescription,project/projectUdef/SuperOffice:3
