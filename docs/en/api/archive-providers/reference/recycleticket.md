...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdBy/credentialType,person/birthYear,person/portraitThumbnail,person/isProjectMember,person/personExtra/y_rental/y_equipment/x_name
