...
```http!
GET /api/v1/archive/RecycleTicket?$select=ownedBy/otherGroups,person/personPager/description,person/personExtra/x_person_request_relation,person/personAssociate/isActiveText,sale/description
