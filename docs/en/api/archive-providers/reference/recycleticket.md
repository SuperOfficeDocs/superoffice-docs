...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdBy/assocTooltip,person/lastName,person/ticketPriority,person/personUdef/SuperOffice:7,person/personExtra/y_rental/x_start
