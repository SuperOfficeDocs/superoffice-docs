...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/personDirectPhone/formattedNumber,person/personAddress/line3,person/restrictionAddress/zip,contact/contactAssociate/assocName,contact/contactAssociate/simultaneousEjUser
