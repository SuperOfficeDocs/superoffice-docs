...
```http!
GET /api/v1/archive/RecycleTicket?$select=person/personAssociate/otherGroups,contact/updatedBy,sale/associate/locationAddress,sale/saleUdef/SuperOffice:1,project/projectUdef/SuperOffice:3
