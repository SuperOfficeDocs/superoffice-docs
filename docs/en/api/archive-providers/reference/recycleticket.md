...
```http!
GET /api/v1/archive/RecycleTicket?$select=createdBy/personId,person/personDirectFax/description,contact/contactDeleted,contact/contactAssociate/contactName,contact/NumberOfNotCompletedSalesInPeriod
