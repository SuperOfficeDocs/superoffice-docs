...
```http!
GET /api/v1/archive/RecycleTicket?$select=firstReadByUser,createdByWorkflow,person/personExtra/x_person_appointment_relation,contact/contactAssociate/associateDbId,sale/recordType
