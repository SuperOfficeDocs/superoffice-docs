...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=reopenDate,contact/contactSource,contact/contactExtra/x_contact_request_relation,contact/LastSale,appointment/appointmentPublish/publishedBy
