...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=saleStatus,person/personHasInterests,person/personUdef/SuperOffice:1,contact/contactUdef/SuperOffice:1,contact/contactUdef/SuperOffice:6
