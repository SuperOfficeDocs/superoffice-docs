...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/birthdate,contact/hasInfoText,contact/code,contact/NumberOfSales,appointment/appointmentUdef/SuperOffice:2
