...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/personSource,person/personExtra/x_person_request_relation,person/personAssociate/contactFullName,contact/contactFax/description,contact/restrictionAddress/wgs84longitude
