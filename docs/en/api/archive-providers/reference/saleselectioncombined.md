...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=originalStage,person/hasInfoText,person/personAddress/county,person/personUdef/SuperOffice:4,contact/contactExtra/x_contact_float
