...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=getAllRows,appointment/completed,appointment/appointmentUdef/SuperOffice:3,appointment/associate/personId,document/yourref
