...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=contact/stop,contact/postAddress/zip,contact/contactUdef/SuperOffice:8,contact/NumberOfActivities,document/documentUdef/SuperOffice:5
