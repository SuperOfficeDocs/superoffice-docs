...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=saleType,person/supportAssociateFullName,person/personPager/description,person/restrictionAddress/addressId,person/personUdef/SuperOffice:11
