...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=contact/country,contact/stop,contact/updatedBy,contact/contactAssociate/contactId,contact/contactAssociate/contactDepartment
