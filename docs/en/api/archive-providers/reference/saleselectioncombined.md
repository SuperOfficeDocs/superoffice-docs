...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=getNoRows,stalledComment,person/personAddress/formattedAddress,person/personUdef/SuperOffice:11,person/legalBaseStore
