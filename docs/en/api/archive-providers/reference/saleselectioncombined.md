...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=reopenDate,amountInBaseCurrency,person/personAssociate/isLocation,person/hasEmarketingConsent,contact/contactAssociate/ejStatus
