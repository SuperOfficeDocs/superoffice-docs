...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=sale/textId,person/personExtra/x_person_hidden_integer,person/personAssociate/ejStatus,document/associate/usergroup,project/projectAssociate/firstName
