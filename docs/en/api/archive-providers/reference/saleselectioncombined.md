...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=registeredBy,heading,reopenDate,person/personExtra/x_person_datetime,person/correspondingAssociate/ejUserId
