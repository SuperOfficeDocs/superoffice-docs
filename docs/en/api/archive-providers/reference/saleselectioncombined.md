...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=daysInStage,person/personUdef/SuperOffice:4,contact/LastDoBySale,appointment/location,saleStakeholder/contact/contactAssociate/middleName
