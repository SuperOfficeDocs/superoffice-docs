...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/personRegisteredDate,person/personDirectFax/description,person/restrictionAddress/addressId,appointment/type,appointment/associate/otherGroups
