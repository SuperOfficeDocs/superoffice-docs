...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=saleStatus,person/withdrawnStoreConsent,contact/contactAssociate/userName,document/associate/portraitThumbnail,project/projectPublish/publishedTo
