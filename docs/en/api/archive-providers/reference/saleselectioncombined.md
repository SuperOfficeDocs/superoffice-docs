...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=registeredBy,person/email/emailLastBounce,person/personExtra/x_person_timespan,person/personAssociate/credentialType,person/isMailingRecipient
