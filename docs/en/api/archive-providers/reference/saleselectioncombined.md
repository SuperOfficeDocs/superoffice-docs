...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=time,createdByWorkflow,contact/hasInterests,contact/phone/formattedNumber,contact/contactAssociate/usergroup
