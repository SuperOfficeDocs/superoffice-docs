...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/personExtra/x_person_date,contact/contactAssociate/credentialType,contact/contactExtra/y_organization/x_name,appointment/text,appointment/registeredDate
