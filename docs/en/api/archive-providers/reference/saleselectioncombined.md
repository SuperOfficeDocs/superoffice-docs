...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=sale/textId,person/personExtra/y_rental/x_start,contact/updatedByFullName,contact/contactAssociate/assocName,saleUdef/SuperOffice:6
