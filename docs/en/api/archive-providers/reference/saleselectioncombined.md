...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=projectId,registeredByFullName,earningPercent,person/consentSourceStore,project/NumberOfNotCompletedSales
