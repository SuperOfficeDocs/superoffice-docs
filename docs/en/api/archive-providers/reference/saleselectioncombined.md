...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=earningPercent,person/contactId,person/restrictionAddress/line1,person/personExtra/x_person_shorttext,person/correspondingAssociate/firstName
