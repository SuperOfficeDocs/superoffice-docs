...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=contact/contactAssociate/title,associate/isActive,saleUdef/SuperOffice:7,appointment/appointment/description,document/associate/credentialType
