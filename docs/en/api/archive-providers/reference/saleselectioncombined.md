...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/retired,person/restrictionAddress/formattedAddress,contact/contactFax/description,contact/contactUdef/SuperOffice:12,associate/associateDbId
