...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/personCountry,person/personUdef/SuperOffice:3,contact/updatedBy,contact/streetAddress/line2,contact/streetAddress/county
