...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=person/associateType,person/personAssociate/ejUserId,person/correspondingAssociate/usergroup,contact/contactAssociate/firstName,contact/saintTicketCategory
