...
```http!
GET /api/v1/archive/SaleSelectionCombined?$select=updatedDate,person/mrMrs,person/correspondingAssociate/lastName,contact/postAddress/wgs84latitude,contact/NumberOfActivities
