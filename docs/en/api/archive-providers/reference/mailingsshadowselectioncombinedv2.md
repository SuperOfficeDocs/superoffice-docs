...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/number,mailingAddr/contact/saintAmountClass,mailingAddr/contact/saintTicketCategory,mailingAddr/person/personAssociate/ejUserId,mailingAddr/person/correspondingAssociate/ejStatus
