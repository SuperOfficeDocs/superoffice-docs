...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/hasInfoText,mailingAddr/person/fullName,mailingAddr/person/personPager/description,mailingAddr/person/personExtra/x_person_appointment_relation,mailingAddr/person/personExtra/x_person_contact_relation
