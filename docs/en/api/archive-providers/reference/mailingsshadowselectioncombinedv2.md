...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/contactAssociate/fullName,mailingAddr/contact/NumberOfActivitiesInPeriod,mailingAddr/person/personExtra/x_person_category_relation,emailFlow/shipmentType,emailFlow/hierarchyName
