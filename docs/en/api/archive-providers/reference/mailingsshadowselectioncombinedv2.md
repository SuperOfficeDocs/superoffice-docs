...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/category,mailingAddr/contact/contactAssociate/title,mailingAddr/contact/contactExtra/x_contact_time,mailingAddr/contact/saintAmountClass,mailingAddr/person/personCountryId
