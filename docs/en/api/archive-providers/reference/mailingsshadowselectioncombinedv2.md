...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/person/email/emailLastBounce,associate/usergroup,mailingAddr/contact/LastCompletedActivity
