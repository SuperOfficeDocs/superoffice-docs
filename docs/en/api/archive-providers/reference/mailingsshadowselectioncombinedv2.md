...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/contactId,mailingAddr/person/mrMrs,mailingAddr/person/position,associate/ejStatus
