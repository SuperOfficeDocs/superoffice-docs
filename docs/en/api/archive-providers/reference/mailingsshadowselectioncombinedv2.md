---
uid: MailingsShadowSelectionCombinedV2
title: MailingsShadowSelectionCombinedV2
description: Implementation of the provider for the combined selection
keywords: MailingsShadowSelectionCombinedV2 archive provider
generated: true
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.MailingsShadowSelectionCombinedProviderV2">SuperOffice.CRM.ArchiveLists.Archive.MailingsShadowSelectionCombinedProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/MailingsShadowSelectionCombinedV2?$select=mailingAddr/contact/streetAddress/line1,mailingAddr/person/personDirectPhone/formattedNumber,mailingAddr/person/restrictionAddress/line3,mailingAddr/person/correspondingAssociate/credentialDisplayValue,associate/locationAddress
