...
|id|int|SR\_MAIL\_ID: SR\_MAIL\_ID\_TOOLTIP| x |
|status|int|SR\_INBOX\_STATUS| x |
|attachment|bool|SR\_INBOX\_ATTACHMENT: SR\_INBOX\_ATTACHMENT\_TOOLTIP| x |
|from|string|SR\_ARCHIVE\_EMAIL\_FROM: SR\_MAIL\_PREVIEW\_FROM\_TOOLTIP| x |
|fromName| *None* |SR\_ARCHIVE\_EMAIL\_FROMNAME: SR\_MAIL\_PREVIEW\_FROMNAME\_TOOLTIP| x |
|to|string|SR\_ARCHIVE\_EMAIL\_TO: SR\_MAIL\_PREVIEW\_TO\_TOOLTIP| x |
|toName| *None* |SR\_ARCHIVE\_EMAIL\_TONAME: SR\_MAIL\_PREVIEW\_TONAME\_TOOLTIP| x |
|cc|string|SR\_ARCHIVE\_EMAIL\_CC: SR\_MAIL\_PREVIEW\_CC\_TOOLTIP| x |
|subject|string|SR\_INBOX\_SUBJECT: SR\_INBOX\_SUBJECT\_TOOLTIP| x |
|bodyPlain|string|!!BodyPlain: !!BodyPlain tooltip| x |
|sent|datetime|SR\_DDLG\_DATO: SR\_INBOX\_SENT\_TOOLTIP| x |
|received|datetime|SR\_DDLG\_DATO: SR\_INBOX\_SENT\_TOOLTIP| x |
|size|int|SR\_MAIL\_SIZE: SR\_MAIL\_SIZE\_TOOLTIP| x |
|archived|bool|SR\_MAIL\_ARCHIVED: SR\_MAIL\_ARCHIVED\_TOOLTIP|  |
|priority|int|SR\_MAIL\_PRIORITY: SR\_MAIL\_PRIORITY\_TOOLTIP| x |
...
|accountAssociate/firstName|string|SR\_PERSONARCHIVE\_FIRSTNAME: SR\_PERSONARCHIVE\_FIRSTNAME\_TOOLTIP| x |
|accountAssociate/lastName|string|SR\_PERSONARCHIVE\_LASTNAME: SR\_PERSONARCHIVE\_LASTNAME\_TOOLTIP| x |
|accountAssociate/middleName|string|SR\_LABEL\_MIDDLENAME: SR\_PERSONARCHIVE\_MIDDLENAME\_TOOLTIP| x |
|accountAssociate/fullName|string|SR\_ARCHIVE\_ASSOC\_FULLNAME: SR\_ARCHIVE\_ASSOC\_FULLNAME\_TOOLTIP| x |
|accountAssociate/contactId|int|SR\_ASSOCCONTACT\_ID: SR\_ASSOCCONTACT\_ID\_TOOLTIP|  |
|accountAssociate/personId|int|SR\_PERSON\_ID: SR\_PERSON\_ID\_TOOLTIP|  |
|accountAssociate/mrMrs|string|SR\_PERSONARCHIVE\_MRMSS: SR\_PERSONARCHIVE\_MRMSS\_TOOLTIP| x |
|accountAssociate/title|string|SR\_PERSONARCHIVE\_JOBTITLE: SR\_PERSONARCHIVE\_MRMSS\_TOOLTIP| x |
|accountAssociate/associateDbId|associate|SR\_ACTIVITYARCHIVE\_ASSOCIATEID| x |
|accountAssociate/contactName|string|SR\_ASSOCCONTACT\_NAME: SR\_ASSOCCONTACT\_NAME\_TOOLTIP| x |
|accountAssociate/contactDepartment|string|SR\_ASSOCCONTACT\_DEPT: SR\_ASSOCCONTACT\_DEPT\_TOOLTIP| x |
|accountAssociate/usergroup|userGroup|SR\_ADMIN\_USERS\_LIST\_GROUP: SR\_ADMIN\_USERS\_LIST\_GROUP\_TOOLTIP| x |
|accountAssociate/usergroupId|int|SR\_FIELD\_PERSON\_GROUP\_ID\_NAME: SR\_ADMIN\_USERS\_LIST\_GROUP\_TOOLTIP| x |
|accountAssociate/contactFullName|string|SR\_ASSOCCONTACT\_NAMEDEPT: SR\_ASSOCCONTACT\_NAMEDEPT\_TOOLTIP| x |
|accountAssociate/contactCategory|listAny|SR\_ARCHIVE\_CATEGORY: SR\_ARCHIVE\_CATEGORY| x |
|accountAssociate/role|listAny|SR\_ADMIN\_USERS\_ROLE: SR\_ADMIN\_USERS\_ROLE| x |
|accountAssociate/assocName|associate|SR\_ADMIN\_USERS\_ID: SR\_ADMIN\_USERS\_ID| x |
|accountAssociate/assocTooltip|string|SR\_ADMIN\_LIST\_DESCRIPTION: SR\_ADMIN\_LIST\_DESCRIPTION|  |
|accountAssociate/assocType|listAny|SR\_ADMIN\_USERS\_LIST\_TYPE: SR\_ADMIN\_USERS\_LIST\_TYPE\_TOOLTIP| x |
|accountAssociate/ejUserId|int|SR\_ADMIN\_EJUSERID\_8: SR\_ADMIN\_EJUSERID\_TOOLTIP\_8|  |
|accountAssociate/simultaneousEjUser|bool|SR\_ADMIN\_SIMEJUSER\_8: SR\_ADMIN\_SIMEJUSER\_TOOLTIP|  |
|accountAssociate/ejDisplayName|string|SR\_ADMIN\_EJDISPLAYNAME\_8: SR\_ADMIN\_EJDISPLAYNAME\_TOOLTIP\_8| x |
|accountAssociate/ejStatus|int|SR\_ADMIN\_EJSTATUS\_8: SR\_ADMIN\_EJSTATUS\_TOOLTIP\_8|  |
|accountAssociate/credentialType| *None* |SR\_ADMIN\_CREDTYPE: SR\_ADMIN\_CREDTYPE\_TOOLTIP| x |
|accountAssociate/credentialDisplayValue| *None* |SR\_ADMIN\_CREDVALUE: SR\_ADMIN\_CREDVALUE\_TOOLTIP| x |
|accountAssociate/isActive|bool|SR\_ASOWW\_ACTIVE: SR\_ASOWW\_ACTIVE\_TOOLTIP| x |
|accountAssociate/isActiveText|bool|SR\_ADMIN\_ACTIVESTATUS: SR\_ADMIN\_ACTIVESTATUS\_TOOLTIP| x |
|accountAssociate/portraitThumbnail| *None* |SR\_PERSONARCHIVE\_THUMBNAIL: SR\_PERSONARCHIVE\_THUMBNAIL|  |
|accountAssociate/otherGroups|userGroup|SR\_ARCHIVE\_OTHERGROUPS: SR\_ARCHIVE\_OTHERGROUPS|  |
|accountAssociate/userName|string|SR\_ADMIN\_USERS\_NAME: SR\_ADMIN\_USERS\_NAME\_TOOLTIP| x |
|accountAssociate/personEmail|string|SR\_ARCHIVE\_EMAIL| x |
|accountAssociate/locationAddress|string|SR\_ADMIN\_LIST\_LOCATION: SR\_ADMIN\_LIST\_LOCATION| x |
|accountAssociate/isLocation|bool|SR\_ARCHIVE\_ISLOCATION: SR\_ARCHIVE\_ISLOCATION| x |

## Sample

```http!
GET /api/v1/archive/Mail2?$select=person/whenUpdatedByWorkflow,person/personDirectPhone/formattedNumber,person/personAddress/line3,person/personExtra/x_person_longtext,person/personAssociate/isActive
