...
```http!
GET /api/v1/archive/Mail2?$select=updatedBy,person/personUpdatedDate,person/personUdef/SuperOffice:11,person/correspondingAssociate/contactId,contact/restrictionAddress/formattedAddress
