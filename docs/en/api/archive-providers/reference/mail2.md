...
```http!
GET /api/v1/archive/Mail2?$select=mailusername,person/personUrl/URLAddress,person/personUdef/SuperOffice:3,person/personExtra/x_person_float,person/personAssociate/portraitThumbnail
