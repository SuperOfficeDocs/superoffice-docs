...
```http!
GET /api/v1/archive/FindTicket?$select=getAllRows,person/personDirectPhone/description,person/restrictionAddress/line3,person/personExtra/x_person_integer,contact/streetAddress/line2
