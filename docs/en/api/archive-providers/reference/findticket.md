...
```http!
GET /api/v1/archive/FindTicket?$select=contactId,createdBy/ejDisplayName,ownedBy/contactId,person/restrictionAddress/wgs84latitude,person/personAssociate/userName
