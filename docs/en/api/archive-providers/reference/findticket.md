...
```http!
GET /api/v1/archive/FindTicket?$select=person/personExtra/x_person_datetime,contact/email/emailHasBounced,contact/contactUdef/SuperOffice:10,sale/earningPercent,sale/saleUdef/SuperOffice:5
