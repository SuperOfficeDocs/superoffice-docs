...
```http!
GET /api/v1/archive/FindTicket?$select=timeSpent,person/correspondingAssociate/ejStatus,contact/contactFax/formattedNumber,project/projectAssociate/contactName
