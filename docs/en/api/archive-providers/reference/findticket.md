...
```http!
GET /api/v1/archive/FindTicket?$select=timeSpentQueue,createdBy/isActive,person/personAddress/wgs84latitude,person/personUdef/SuperOffice:1,person/personAssociate/lastName
