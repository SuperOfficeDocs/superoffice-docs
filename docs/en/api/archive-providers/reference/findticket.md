...
```http!
GET /api/v1/archive/FindTicket?$select=createdBy/credentialDisplayValue,person/personUdef/SuperOffice:7,contact/stop,sale/sale/textId,project/projectEvent/eventDate
