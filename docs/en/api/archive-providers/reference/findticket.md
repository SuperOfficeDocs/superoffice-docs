...
```http!
GET /api/v1/archive/FindTicket?$select=person/hasInfoText,person/personPrivate/description,person/personExtra/y_car/id,contact/contactAssociate/firstName,contact/contactAssociate/role
