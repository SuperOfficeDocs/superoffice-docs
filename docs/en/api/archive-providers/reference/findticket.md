...
```http!
GET /api/v1/archive/FindTicket?$select=createdBy/mrMrs,person/personExtra/x_person_time,person/withdrawnEmarketingConsent,contact/restrictionAddress/city,contact/contactExtra/x_contact_short_dropdown
