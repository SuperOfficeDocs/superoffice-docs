...
```http!
GET /api/v1/archive/FindTicket?$select=timeSpentExternally,timeSpentInternally,person/personId,person/restrictionAddress/line2,person/personAssociate/lastName
