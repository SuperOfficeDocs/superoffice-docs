...
```http!
GET /api/v1/archive/FindTicket?$select=person/personAddress/county,person/personUdef/SuperOffice:3,contact/contactPhone/formattedNumber,sale/registeredByFullName,sale/currencyId
