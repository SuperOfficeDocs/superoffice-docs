...
```http!
GET /api/v1/archive/FindTicket?$select=slevel,messageLanguage,createdBy/portraitThumbnail,contact/contactAssociate/personId,contact/contactAssociate/ejDisplayName
