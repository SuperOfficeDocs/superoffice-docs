...
```http!
GET /api/v1/archive/FindTicket?$select=createdAt,realTimeSpentQueue,createdBy/contactName,person/correspondingAssociate/simultaneousEjUser,contact/activeErpLinks
