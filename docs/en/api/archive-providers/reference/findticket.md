...
```http!
GET /api/v1/archive/FindTicket?$select=firstReadByUser,person/personRegisteredDate,person/portraitThumbnail,contact/postAddress/line2,contact/contactAssociate/simultaneousEjUser
