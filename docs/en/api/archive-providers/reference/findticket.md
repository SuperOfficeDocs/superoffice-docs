...
```http!
GET /api/v1/archive/FindTicket?$select=createdBy/userName,ownedBy/portraitThumbnail,person/personRegisteredDate,person/personAddress/zip,person/personUdef/SuperOffice:11
