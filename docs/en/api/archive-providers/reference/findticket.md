...
```http!
GET /api/v1/archive/FindTicket?$select=createdBy/credentialType,person/personRegisteredDate,person/personAssociate/usergroup,contact/department,contact/phone/formattedNumber
