...
```http!
GET /api/v1/archive/FindTicket?$select=ownedBy/contactId,person/fullName,person/contactId,person/personRegisteredByFullName,person/restrictionAddress/city
