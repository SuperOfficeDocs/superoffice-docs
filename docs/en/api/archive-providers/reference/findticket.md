...
```http!
GET /api/v1/archive/FindTicket?$select=timeSpentQueue,ownedBy/otherGroups,person/personAddress/line3,person/personExtra/x_person_user_relation,contact/registeredByFullName
