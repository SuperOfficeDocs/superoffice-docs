...
```http!
GET /api/v1/archive/FindTicket?$select=contact/activeErpLinks,contact/restrictionAddress/wgs84latitude,project/icon,project/projectAssociate/assocTooltip
