...
```http!
GET /api/v1/archive/FindTicket?$select=ownedBy/lastName,person/personDirectPhone/description,person/correspondingAssociate/role,contact/restrictionAddress/formattedMultiLineAddress,contact/contactAssociate/usergroup
