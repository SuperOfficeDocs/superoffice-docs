...
```http!
GET /api/v1/archive/FindTicket?$select=person/isProjectMember,person/restrictionAddress/wgs84longitude,person/personUdef/SuperOffice:6,contact/postAddress/county,contact/restrictionAddress/city
