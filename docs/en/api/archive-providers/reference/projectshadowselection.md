...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/date,document/documentId,document/yourref,projectMember/searchPhone/formattedNumber,projectMember/email/emailLastSent
