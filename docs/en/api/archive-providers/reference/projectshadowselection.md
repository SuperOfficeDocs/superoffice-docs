...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=completed,sale/saleUdef/SuperOffice:5,document/userGroup,document/associate/assocTooltip,projectMember/personUpdatedDate
