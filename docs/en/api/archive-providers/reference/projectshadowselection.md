...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/associate/otherGroups,sale/saleUdef/SuperOffice:3,appointment/associate/lastName,document/keywords,projectMember/projectId
