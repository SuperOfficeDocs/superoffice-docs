...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectPublish/isPublished,sale/contactId,sale/currencyId,projectMember/personAssociate/mrMrs,projectMember/url/URLAddress
