...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/saleStatus,sale/saleUdef/SuperOffice:1,projectMember/infoText,projectMember/personBusiness,projectMember/streetAddress/formattedAddress
