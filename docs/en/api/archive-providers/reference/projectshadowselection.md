...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/mrMrs,projectAssociate/ejStatus,sale/saleId,sale/hasQuote,projectMember/personUpdatedBy
