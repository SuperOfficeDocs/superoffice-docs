...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/middleName,projectUdef/SuperOffice:1,sale/associate/middleName,sale/saleUdef/SuperOffice:4,appointment/appointmentUdef/SuperOffice:8
