...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/type,sale/associate/isActive,appointment/associate/role,document/associate/associateDbId,projectMember/email/emailId
