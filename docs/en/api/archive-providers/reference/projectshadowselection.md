...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectEvent/eventDate,NumberOfActivities,document/type,document/document/description,projectMember/contactAssociate/mrMrs
