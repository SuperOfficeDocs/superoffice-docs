...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/middleName,sale/saleId,sale/probPercent,document/documentUdef/SuperOffice:8,projectMember/firstName
