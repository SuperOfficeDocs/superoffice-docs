...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/associate/lastName,sale/associate/role,sale/saleUdef/SuperOffice:5,projectMember/personUpdatedDate,projectMember/personUdef/SuperOffice:7
