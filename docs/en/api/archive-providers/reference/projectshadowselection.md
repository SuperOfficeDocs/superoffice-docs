...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=appointment/associate/title,document/icon,projectMember/restrictionAddress/formattedMultiLineAddress,projectMember/personAssociate/lastName,projectMember/personAssociate/portraitThumbnail
