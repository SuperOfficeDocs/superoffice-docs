...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=appointment/associate/simultaneousEjUser,document/mailMergeDraft,projectMember/personAddress/zip,projectMember/personAssociate/credentialDisplayValue,projectMember/hasStoreConsent
