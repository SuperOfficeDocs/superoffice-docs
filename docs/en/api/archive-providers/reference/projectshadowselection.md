...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/role,appointment/registeredByFullName,projectMember/personMobilePhone/formattedNumber,projectMember/correspondingAssociate/title
