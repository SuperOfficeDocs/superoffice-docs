...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/userName,document/recordTypeText,document/associate/isLocation,projectMember/email/emailLastBounce,projectMember/isMailingRecipient
