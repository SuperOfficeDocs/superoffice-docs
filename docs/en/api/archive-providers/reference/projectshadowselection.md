...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.ProjectShadowSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.ProjectShadowSelectionProvider</see> inside NetServer's SODatabase assembly.
...
|contactId| *None* |SR\_CONTACT\_ID: SR\_CONTACT\_ID\_TOOLTIP| x |
|personId| *None* |SR\_PERSON\_ID: SR\_PERSON\_ID\_TOOLTIP| x |
|projectMember/contactEmail/emailProtocol| *None* |SR\_CRITERIONTYPE\_CONTACT - SR\_EMAIL\_PROTOCOL: SR\_EMAIL\_PROTOCOL\_TOOLTIP| x |
|projectMember/contactEmail/emailAddress| *None* |SR\_CRITERIONTYPE\_CONTACT - SR\_ARCHIVE\_EMAIL| x |
|projectMember/contactEmail/emailDescription| *None* |SR\_CRITERIONTYPE\_CONTACT - SR\_ARCHIVE\_DESCRIPTION| x |
|projectMember/contactEmail/emailId| *None* |SR\_CRITERIONTYPE\_CONTACT - ID| x |
|projectMember/contactEmail/emailLastSent| *None* |SR\_CRITERIONTYPE\_CONTACT - SR\_EMAIL\_LAST\_SENT: SR\_EMAIL\_LAST\_SENT\_TOOLTIP| x |
|projectMember/contactEmail/emailBounceCount| *None* |SR\_CRITERIONTYPE\_CONTACT - SR\_EMAIL\_BOUNCE\_COUNT: SR\_EMAIL\_BOUNCE\_COUNT\_TOOLTIP| x |
|projectMember/contactEmail/emailLastBounce| *None* |SR\_CRITERIONTYPE\_CONTACT - SR\_EMAIL\_LAST\_BOUNCE: SR\_EMAIL\_LAST\_BOUNCE\_TOOLTIP| x |
|projectMember/contactEmail/emailHasBounced| *None* |SR\_CRITERIONTYPE\_CONTACT - SR\_ARCHIVE\_HASBOUNCED: SR\_ARCHIVE\_HASBOUNCED\_TOOLTIP| x |

## Sample

```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/saleTypeCategory,sale/associate/usergroup,document/type,document/registeredByFullName,projectMember/personPrivate/description
