...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/registeredDate,sale/associate/ejUserId,appointment/appointmentUdef/SuperOffice:7,document/associate/assocName,projectMember/personNumber
