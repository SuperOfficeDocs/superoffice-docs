...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/saleUdef/SuperOffice:6,appointment/associate/role,appointment/associate/personEmail,document/associate/mrMrs,projectMember/phone/formattedNumber
