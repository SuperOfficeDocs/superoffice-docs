...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectAssociate/credentialDisplayValue,appointment/userGroup,document/associate/credentialDisplayValue,projectMember/personExtra/y_car/id,projectMember/correspondingAssociate/middleName
