...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/probPercent,sale/associate/fullName,document/associate/userName,document/documentUdef/SuperOffice:7,projectMember/personExtra/x_person_date
