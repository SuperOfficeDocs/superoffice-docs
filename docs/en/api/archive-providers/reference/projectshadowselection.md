...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=sale/currency,appointment/associate/fullName,projectMember/personExtra/x_person_time,projectMember/personAssociate/contactFullName
