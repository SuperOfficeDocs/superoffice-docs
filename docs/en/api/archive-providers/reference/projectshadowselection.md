...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=projectEvent/hasSignOff,appointment/associate/mrMrs,document/date,document/documentUdef/SuperOffice:2,projectMember/projectMemberId
