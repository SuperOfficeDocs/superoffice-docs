...
```http!
GET /api/v1/archive/ProjectShadowSelection?$select=saintIntention,sale/activeErpLinks,sale/associate/portraitThumbnail,document/documentUdef/SuperOffice:1,projectMember/personNumber
