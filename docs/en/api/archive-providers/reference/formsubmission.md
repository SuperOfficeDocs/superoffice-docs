...
```http!
GET /api/v1/archive/FormSubmission?$select=associate/role,contact/streetAddress/addressId,contact/contactAssociate/firstName,contact/NumberOfNotCompletedTickets
