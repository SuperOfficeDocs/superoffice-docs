...
```http!
GET /api/v1/archive/FormSubmission?$select=associate/firstName,associate/contactId,person/personRegisteredByFullName,person/personAddress/zip,person/personUdef/SuperOffice:3
