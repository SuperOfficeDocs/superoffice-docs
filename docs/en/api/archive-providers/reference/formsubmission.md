...
```http!
GET /api/v1/archive/FormSubmission?$select=person/restrictionAddress/county,person/personAssociate/portraitThumbnail,contact/name,contact/mainContact,contact/email/emailAddress
