...
```http!
GET /api/v1/archive/FormSubmission?$select=formSubmissionEmail,person/personAddress/state,contact/postAddress/zip,contact/contactAssociate/contactCategory
