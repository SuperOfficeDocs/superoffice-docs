...
```http!
GET /api/v1/archive/FormSubmission?$select=associate/portraitThumbnail,person/correspondingAssociate/credentialType,contact/contactAssociate/ejUserId,contact/contactExtra/x_contact_boolean
