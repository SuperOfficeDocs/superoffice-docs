...
```http!
GET /api/v1/archive/FormSubmission?$select=associate/title,associate/contactDepartment,person/personAssociate/personId,person/personAssociate/title,contact/contactAssociate/usergroupId
