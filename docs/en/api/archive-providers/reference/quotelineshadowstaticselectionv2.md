...
```http!
GET /api/v1/archive/QuoteLineShadowStaticSelectionV2?$select=totalPriceIncVAT,selectionMemberId,alternative/totalPrice,alternative/version/sent,alternative/version/quote/sale/currency
