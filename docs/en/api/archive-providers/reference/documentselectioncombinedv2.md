...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/searchPhone/description,person/restrictionAddress/line2,person/personUdef/SuperOffice:1,contact/name,contact/postAddress/zip
