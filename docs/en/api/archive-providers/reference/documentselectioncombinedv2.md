...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personUrl/URLDescription,contact/deletedDate,project/statusRank,project/nextMilestone,project/projectAssociate/personEmail
