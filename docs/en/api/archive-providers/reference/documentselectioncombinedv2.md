...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/title,person/personAssociate/assocTooltip,person/hasStoreConsent,associate/usergroup,sale/completed
