...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/correspondingAssociate/role,contact/postAddress/county,associate/ejUserId,sale/associate/isActive
