...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/birthdate,person/isStakeholder,person/personAssociate/ejUserId,person/legalBaseEmarketing,contact/saintDirection
