...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=getAllRows,person/correspondingAssociate/isActiveText,contact/streetAddress/state,contact/contactAssociate/middleName
