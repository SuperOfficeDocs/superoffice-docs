...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/mrMrs,person/personUrl/URLDescription,person/personExtra/x_person_integer,contact/streetAddress/wgs84latitude,contact/contactAssociate/locationAddress
