...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=documentPublish/publishedTo,person/personExtra/x_person_hidden_integer,person/personAssociate/contactName,associate/locationAddress
