...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personCategory,person/personUdef/SuperOffice:6,person/personAssociate/title,contact/streetAddress/addressId,contact/streetAddress/zip
