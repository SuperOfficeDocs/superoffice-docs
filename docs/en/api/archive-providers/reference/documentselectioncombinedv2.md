...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/useAsMailingAddress,person/personAssociate/mrMrs,person/personAssociate/ejDisplayName,person/subscription,contact/associateId
