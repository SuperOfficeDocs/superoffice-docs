...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=text,person/personSource,person/ticketPriority,person/searchPhone/description,person/personAddress/line3
