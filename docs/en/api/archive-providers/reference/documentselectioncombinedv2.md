...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personAssociate/ejDisplayName,contact/contactAssociate/assocName,project/projectEvent/hasSignOff,sale/associate/contactName
