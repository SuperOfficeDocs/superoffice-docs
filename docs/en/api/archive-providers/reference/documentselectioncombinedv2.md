...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/correspondingAssociate/simultaneousEjUser,contact/saintActivityType,project/status,associate/userName,sale/associate/isActive
