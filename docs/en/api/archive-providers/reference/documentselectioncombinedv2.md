...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=time,person/personMobilePhone/formattedNumber,person/personAssociate/ejUserId,contact/contactDeleted,contact/contactAssociate/assocType
