...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=contact/restrictionAddress/state,project/registeredBy,associate/simultaneousEjUser,sale/associate/fullName
