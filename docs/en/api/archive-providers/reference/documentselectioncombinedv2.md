...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=subject,person/personCountryId,person/correspondingAssociate/usergroup,project/associateId,project/registeredBy
