...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/portraitThumbnail,person/personAddress/wgs84longitude,person/personUdef/SuperOffice:4,contact/countryId,contact/updatedDate
