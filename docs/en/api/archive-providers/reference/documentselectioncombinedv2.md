...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personSource,person/personDirectFax/description,person/personAddress/addressId,person/withdrawnEmarketingConsent,contact/associateId
