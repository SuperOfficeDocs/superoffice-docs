...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/consentSourceEmarketing,person/correspondingAssociate/assocName,contact/contactAssociate/contactId
