...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/firstName,person/email/emailId,person/personAssociate/credentialDisplayValue,person/subscription,contact/email/emailLastBounce
