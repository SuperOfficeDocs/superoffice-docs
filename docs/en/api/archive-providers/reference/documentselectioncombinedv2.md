...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/searchPhone/formattedNumber,person/personUdef/SuperOffice:6,contact/department,sale/associate/associateDbId
