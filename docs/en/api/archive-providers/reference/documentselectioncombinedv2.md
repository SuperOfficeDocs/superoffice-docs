...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personCountry,contact/restrictionAddress/formattedMultiLineAddress,contact/url/URLDescription,contact/LastDoBySale,sale/userGroup
