...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=updatedByFullName,person/personExtra/x_person_longtext,person/personExtra/y_rental/x_start,contact/orgnr,contact/postAddress/zip
