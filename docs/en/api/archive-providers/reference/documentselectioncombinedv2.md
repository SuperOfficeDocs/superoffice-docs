...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personAddress/city,person/personAssociate/usergroup,contact/contactId,project/projectAssociate/personId
