...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=documentPublish/publishedBy,person/mrMrs,person/personCategoryRank,person/personPrivate/formattedNumber,person/restrictionAddress/zip
