...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personRegisteredByFullName,person/personDirectPhone/description,contact/contactAssociate/contactFullName,sale/associate/contactName
