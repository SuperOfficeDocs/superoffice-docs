...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/supportAssociate,project/saintDirection,associate/personId,associate/contactFullName,associate/simultaneousEjUser
