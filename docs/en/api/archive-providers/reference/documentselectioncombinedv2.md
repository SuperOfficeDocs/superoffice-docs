...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personExtra/x_person_shorttext_list,person/personAssociate/isActiveText,person/correspondingAssociate/fullName,person/correspondingAssociate/credentialType,contact/companyCategoryRank
