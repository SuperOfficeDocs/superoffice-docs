...
```http!
GET /api/v1/archive/DocumentSelectionCombinedV2?$select=person/personAssociate/fullName,contact/postAddress/line3,project/imageThumbnail,associate/lastName,associate/title
