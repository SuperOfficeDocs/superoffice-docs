...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/mrMrs,ownedBy/contactDepartment,ownedBy/portraitThumbnail,person/personCountryId,person/personExtra/y_rental/x_end
