...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/usergroup,createdBy/assocType,person/personAssociate/ejDisplayName,sale/associate/usergroup,sale/associate/credentialType
