...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/simultaneousEjUser,person/searchPhone/formattedNumber,person/correspondingAssociate/usergroup,contact/url/URLAddress,sale/description
