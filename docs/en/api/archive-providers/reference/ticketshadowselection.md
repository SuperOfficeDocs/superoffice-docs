...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/searchPhone/description,contact/contactAssociate/contactFullName,person/personExtra/x_person_priority_relation
