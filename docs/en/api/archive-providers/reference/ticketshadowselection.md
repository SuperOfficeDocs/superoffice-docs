...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/contactName,createdBy/contactCategory,ownedBy/usergroup,person/email/emailDescription,contact/postAddress/line2
