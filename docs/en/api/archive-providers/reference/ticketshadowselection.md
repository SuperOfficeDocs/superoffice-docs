...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=readByCustomer,person/rank,person/restrictionAddress/zip,person/correspondingAssociate/ejDisplayName,contact/contactAssociate/assocType
