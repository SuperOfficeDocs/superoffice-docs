...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=getNoRows,ownedBy/contactDepartment,person/personCategoryGroup,person/restrictionAddress/line3,sale/type
