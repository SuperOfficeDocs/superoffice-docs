...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=ticketStatusName,createdBy/credentialType,person/personUdef/SuperOffice:5,person/personAssociate/contactId,person/correspondingAssociate/isActive
