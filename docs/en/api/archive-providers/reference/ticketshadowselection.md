...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=sentimentScore,createdBy/isActiveText,ownedBy/contactFullName,ownedBy/locationAddress,contact/updatedByFullName
