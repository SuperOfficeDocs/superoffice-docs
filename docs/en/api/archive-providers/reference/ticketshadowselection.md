...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=deadline,createdBy/firstName,person/lastName,person/personUdef/SuperOffice:7,contact/contactAssociate/contactId
