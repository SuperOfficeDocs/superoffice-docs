...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/mrMrs,person/restrictionAddress/line3,person/personAssociate/userName,contact/name,contact/contactSource
