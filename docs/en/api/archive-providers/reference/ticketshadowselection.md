...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/rank,person/email/emailLastBounce,person/personAssociate/isActiveText,contact/streetAddress/zip,contact/contactAssociate/assocName
