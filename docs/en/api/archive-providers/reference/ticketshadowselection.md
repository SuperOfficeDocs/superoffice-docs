...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/ejUserId,ownedBy/otherGroups,person/associateType,person/personExtra/y_rental/x_contact,contact/email/emailBounceCount
