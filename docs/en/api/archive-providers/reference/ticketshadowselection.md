...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=origin,person/personDirectFax/description,person/personExtra/x_person_date,contact/associateId,sale/projectId
