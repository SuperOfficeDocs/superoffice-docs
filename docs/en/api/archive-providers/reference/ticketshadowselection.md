...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/userName,person/phone/formattedNumber,person/correspondingAssociate/lastName,person/correspondingAssociate/associateDbId,contact/streetAddress/county
