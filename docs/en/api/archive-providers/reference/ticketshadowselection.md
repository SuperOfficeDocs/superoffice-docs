...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=status,createdBy/otherGroups,ownedBy/contactCategory,person/personAddress/formattedAddress,person/personAssociate/locationAddress
