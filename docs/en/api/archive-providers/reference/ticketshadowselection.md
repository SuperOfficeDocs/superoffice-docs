...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personExtra/x_person_shorttext,person/correspondingAssociate/personEmail,contact/restrictionAddress/wgs84longitude,contact/contactAssociate/personId,contact/contactExtra/x_contact_integer
