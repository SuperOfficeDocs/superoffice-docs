...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personExtra/x_person_float,person/personAssociate/role,sale/associate/personId,sale/associate/personEmail,project/LastDoBySale
