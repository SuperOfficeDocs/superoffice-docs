...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=projectId,createdBy/mrMrs,person/correspondingAssociate/personId,sale/saleUdef/SuperOffice:4,project/imageThumbnail
