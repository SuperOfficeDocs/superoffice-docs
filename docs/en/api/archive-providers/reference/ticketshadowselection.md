---
uid: TicketShadowSelection
title: TicketShadowSelection
description: Shadow contact provider for the ticket provider.
keywords: TicketShadowSelection archive provider
so.generated: true
so.topic: reference
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personUpdatedByFullName,person/personExtra/x_person_datetime,person/personExtra/x_person_priority_relation,person/correspondingAssociate/isActiveText,person/correspondingAssociate/locationAddress
