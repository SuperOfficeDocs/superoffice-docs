...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/personId,person/personExtra/y_rental/x_start,person/personAssociate/fullName,person/personAssociate/ejStatus,person/correspondingAssociate/associateDbId
