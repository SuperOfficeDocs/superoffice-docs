...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=status,person/correspondingAssociate/credentialDisplayValue,contact/contactExtra/y_organization/x_name,sale/associate/associateDbId,project/projectUdef/SuperOffice:2
