...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=numberOfReplies,ownedBy/personId,ownedBy/otherGroups,person/personExtra/y_rental/x_start,person/correspondingAssociate/contactFullName
