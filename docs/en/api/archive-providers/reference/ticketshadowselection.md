...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personBusiness,person/email/emailProtocol,contact/countryId,contact/streetAddress/wgs84latitude,contact/streetAddress/wgs84longitude
