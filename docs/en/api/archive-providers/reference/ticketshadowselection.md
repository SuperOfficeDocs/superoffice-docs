...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=ownedBy/role,contact/nameDepartment,contact/streetAddress/zip,contact/contactUdef/SuperOffice:3,contact/NumberOfNotCompletedActivitiesInPeriod
