...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personUdef/SuperOffice:11,contact/contactAssociate/title,sale/salePublish/publishedBy,sale/associate/ejStatus,project/projectUdef/SuperOffice:4
