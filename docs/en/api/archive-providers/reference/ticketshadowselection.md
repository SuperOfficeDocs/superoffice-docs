...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=createdBy/contactId,person/personExtra/x_person_timespan,person/personAssociate/associateDbId,contact/streetAddress/zip,contact/saintTicketStatus
