...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personExtra/y_rental/x_amount,person/correspondingAssociate/title,person/correspondingAssociate/personEmail,contact/associateId,contact/contactAssociate/contactId
