...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=person/personAssociate/middleName,contact/searchPhone/formattedNumber,contact/email/emailDescription,contact/saintTicketStatus,extra/x_ticket_faq
