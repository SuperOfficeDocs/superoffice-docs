...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=ownedBy/isActiveText,person/personCountryId,person/personPager/formattedNumber,contact/number,extra/x_ticket_date
