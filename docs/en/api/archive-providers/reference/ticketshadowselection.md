...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=realTimeSpentQueue,ownedBy/contactDepartment,person/correspondingAssociate/credentialType,contact/postAddress/wgs84latitude,project/projectUdef/SuperOffice:8
