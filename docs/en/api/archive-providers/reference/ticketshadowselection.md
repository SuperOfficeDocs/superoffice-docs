...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=contactId,person/email/emailLastBounce,person/personAssociate/ejDisplayName,contact/contactAssociate/assocTooltip
