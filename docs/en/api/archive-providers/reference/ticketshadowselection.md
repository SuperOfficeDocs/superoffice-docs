...
```http!
GET /api/v1/archive/TicketShadowSelection?$select=ownedBy/assocType,person/useAsMailingAddress,sale/projectId,sale/saleUdef/SuperOffice:1,project/projectUdef/SuperOffice:10
