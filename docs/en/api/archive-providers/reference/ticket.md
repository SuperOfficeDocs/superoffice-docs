...
```http!
GET /api/v1/archive/Ticket?$select=person/birthMonth,person/personAssociate/ejUserId,contact/searchPhone/formattedNumber,contact/email/emailLastSent,contact/contactUdef/SuperOffice:9
