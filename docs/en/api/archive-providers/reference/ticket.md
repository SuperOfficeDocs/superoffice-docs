...
```http!
GET /api/v1/archive/Ticket?$select=person/supportAssociate,person/personDirectPhone/formattedNumber,person/personAssociate/isActive,sale/credited,project/projectAssociate/assocType
