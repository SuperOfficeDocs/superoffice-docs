...
```http!
GET /api/v1/archive/Ticket?$select=person/personExtra/x_person_datetime,person/correspondingAssociate/contactCategory,person/hasStoreConsent,contact/contactAssociate/usergroup,contact/contactAssociate/ejStatus
