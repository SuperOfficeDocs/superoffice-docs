...
```http!
GET /api/v1/archive/Ticket?$select=person/email/emailId,person/restrictionAddress/city,person/personExtra/x_person_time,person/correspondingAssociate/lastName,contact/streetAddress/line2
