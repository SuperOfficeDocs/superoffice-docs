...
```http!
GET /api/v1/archive/Ticket?$select=timeSpent,contact/postAddress/wgs84latitude,contact/postAddress/wgs84longitude,contact/LastCompletedSale,project/project/infoText
