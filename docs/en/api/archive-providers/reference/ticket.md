...
```http!
GET /api/v1/archive/Ticket?$select=createdBy/contactId,createdBy/contactCategory,contact/hasInterests,contact/postAddress/addressId,contact/postAddress/line3
