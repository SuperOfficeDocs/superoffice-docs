...
```http!
GET /api/v1/archive/Ticket?$select=createdBy/locationAddress,ownedBy/role,person/personUdef/SuperOffice:4,person/correspondingAssociate/simultaneousEjUser,contact/associateId
