...
```http!
GET /api/v1/archive/Ticket?$select=person/personAssociate/title,contact/email/emailHasBounced,contact/streetAddress/formattedMultiLineAddress,contact/restrictionAddress/zip,extra/y_equipment/x_name
