...
```http!
GET /api/v1/archive/Ticket?$select=person/hasCompany,person/personAddress/line1,contact/email/emailId,contact/email/emailHasBounced,contact/contactAssociate/ejStatus
