...
```http!
GET /api/v1/archive/Ticket?$select=categoryFullName,person/personDirectFax/formattedNumber,person/personAssociate/portraitThumbnail,person/legalBaseEmarketing,contact/restrictionAddress/wgs84longitude
