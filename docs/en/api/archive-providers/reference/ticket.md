...
```http!
GET /api/v1/archive/Ticket?$select=realTimeToClose,ownedBy/title,person/personUdef/SuperOffice:5,contact/email/emailDescription,contact/NumberOfNotCompletedTicketsInPeriod
