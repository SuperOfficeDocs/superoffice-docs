...
```http!
GET /api/v1/archive/Ticket?$select=createdAt,person/personUpdatedByFullName,person/personMobilePhone/description,person/personUdef/SuperOffice:5,extra/x_ticket_datetime
