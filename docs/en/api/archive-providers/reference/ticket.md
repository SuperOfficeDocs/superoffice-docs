...
```http!
GET /api/v1/archive/Ticket?$select=suggestedCategory,person/hasCompany,person/personDirectPhone/description,person/personPager/formattedNumber,person/searchPhone/formattedNumber
