...
```http!
GET /api/v1/archive/Ticket?$select=getNoRows,ownedBy/isActiveText,person/personAddress/wgs84latitude,contact/contactUdef/SuperOffice:10,project/saintIntention
