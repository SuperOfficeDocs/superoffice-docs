...
```http!
GET /api/v1/archive/Ticket?$select=ownedBy/personEmail,person/personAddress/line1,person/personAssociate/contactId,contact/countryId,contact/contactAssociate/contactCategory
