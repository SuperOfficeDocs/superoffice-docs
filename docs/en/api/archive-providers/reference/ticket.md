...
```http!
GET /api/v1/archive/Ticket?$select=timeToClose,ownedBy/assocTooltip,person/personId,person/restrictionAddress/county,contact/contactExtra/x_contact_contact
