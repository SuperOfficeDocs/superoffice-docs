...
```http!
GET /api/v1/archive/Ticket?$select=person/personUpdatedByFullName,person/personExtra/x_person_longtext,contact/streetAddress/county,contact/restrictionAddress/state,contact/restrictionAddress/formattedAddress
