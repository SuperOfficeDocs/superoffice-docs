...
```http!
GET /api/v1/archive/Ticket?$select=person/personPrivate/description,person/restrictionAddress/addressId,contact/registeredDate,contact/email/emailHasBounced,contact/streetAddress/line2
