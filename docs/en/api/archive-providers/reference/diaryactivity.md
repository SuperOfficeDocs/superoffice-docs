...
```http!
GET /api/v1/archive/DiaryActivity?$select=contact/contactNoMail,contact/postAddress/state,contact/streetAddress/line2,project/associateId,project/projectPublish/publishedTo
