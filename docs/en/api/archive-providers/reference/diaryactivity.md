...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/personUpdatedDate,person/personUdef/SuperOffice:4,person/personUdef/SuperOffice:5,person/correspondingAssociate/role,contact/hasInterests
