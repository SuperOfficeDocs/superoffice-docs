...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/personUpdatedBy,person/personUdef/SuperOffice:2,contact/contactNoMail,contact/postAddress/state,contact/contactAssociate/usergroup
