...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/personAddress/line3,person/personUdef/SuperOffice:7,person/correspondingAssociate/isActiveText,contact/countryId,contact/contactAssociate/userName
