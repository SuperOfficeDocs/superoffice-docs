...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/personExtra/x_person_priority_relation,person/correspondingAssociate/personId,contact/restrictionAddress/wgs84longitude,contact/contactAssociate/isActive,project/description
