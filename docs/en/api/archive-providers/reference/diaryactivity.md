...
```http!
GET /api/v1/archive/DiaryActivity?$select=updatedDate,person/hasInterests,person/personAssociateFullName,person/searchPhone/description,person/email/emailHasBounced
