...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/personUdef/SuperOffice:8,contact/contactAssociate/credentialDisplayValue,contact/saintTicketCategory,sale/registeredDate,sale/createdByWorkflow
