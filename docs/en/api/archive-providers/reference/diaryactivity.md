...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/personAssociate/ejStatus,contact/streetAddress/city,project/nextMilestone,documentUdef/SuperOffice:4,sale/updatedByFullName
