...
```http!
GET /api/v1/archive/DiaryActivity?$select=userGroup,subject,person/personExtra/x_person_appointment_relation,person/personExtra/x_person_contact_relation,contact/contactExtra/x_contact_hidden_integer
