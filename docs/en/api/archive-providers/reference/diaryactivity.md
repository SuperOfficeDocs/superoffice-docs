...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/personCountry,person/useAsMailingAddress,person/personUrl/URLAddress,person/restrictionAddress/addressId,person/personAssociate/usergroup
