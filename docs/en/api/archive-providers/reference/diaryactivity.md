...
```http!
GET /api/v1/archive/DiaryActivity?$select=updatedBy,contact/email/emailId,contact/contactAssociate/usergroup,contact/contactAssociate/assocName,contact/NumberOfSalesInPeriod
