...
```http!
GET /api/v1/archive/DiaryActivity?$select=keywords,person/personAssociateId,person/personExtra/x_person_request_relation,person/correspondingAssociate/mrMrs,contact/contactAssociate/isActiveText
