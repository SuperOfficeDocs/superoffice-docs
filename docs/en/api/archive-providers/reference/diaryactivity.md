...
```http!
GET /api/v1/archive/DiaryActivity?$select=contact/contactAssociate/firstName,person/withdrawnEmarketingConsent,person/legalBaseEmarketing,project/projectAssociate/isActive,project/NumberOfSales
