...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/email/emailHasBounced,contact/email/emailProtocol,contact/streetAddress/county,project/LastDoByActivity,associate/contactId
