...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/contactId,person/personExtra/x_person_appointment_relation,person/personAssociate/contactName,contact/hasInfoText,contact/contactSource
