...
```http!
GET /api/v1/archive/DiaryActivity?$select=contact/contactId,contact/streetAddress/addressId,contact/contactExtra/x_contact_contact_relation,contact/saintIntention,project/saintActivityType
