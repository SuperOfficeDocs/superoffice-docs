...
```http!
GET /api/v1/archive/DiaryActivity?$select=person/phone/formattedNumber,person/personPager/formattedNumber,person/personInfo/textId,person/personAssociate/otherGroups,contact/contactUdef/SuperOffice:3
