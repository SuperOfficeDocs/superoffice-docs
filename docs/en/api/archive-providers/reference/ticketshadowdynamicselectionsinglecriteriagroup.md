...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=content,person/personAssociate/role,contact/restrictionAddress/county,contact/NumberOfSales,contact/saintTicketStatus
