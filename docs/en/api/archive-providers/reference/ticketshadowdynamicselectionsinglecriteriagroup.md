...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=timeSpentExternally,ownedBy/isActive,contact/restrictionAddress/line3,extra/x_ticket_time,sale/associate/middleName
