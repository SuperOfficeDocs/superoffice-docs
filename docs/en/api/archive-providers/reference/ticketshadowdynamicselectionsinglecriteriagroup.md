...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=contact/contactUdef/SuperOffice:2,contact/contactExtra/x_contact_shorttext,person/personExtra/x_person_user_relation
