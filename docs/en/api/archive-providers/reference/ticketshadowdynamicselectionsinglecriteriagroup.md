...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/contactCategory,ownedBy/lastName,ownedBy/assocType,ownedBy/simultaneousEjUser,person/retired
