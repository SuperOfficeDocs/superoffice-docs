...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=person/personRegisteredBy,person/personDirectFax/formattedNumber,contact/postAddress/zip,contact/url/URLDescription,contact/contactExtra/x_contact_boolean
