...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=ownedBy/credentialDisplayValue,person/personPager/formattedNumber,person/personAssociate/mrMrs,sale/icon,sale/stalledComment
