...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=person/birthMonth,person/personAssociate/mrMrs,contact/hasInfoText,contact/restrictionAddress/state,contact/url/URLAddress
