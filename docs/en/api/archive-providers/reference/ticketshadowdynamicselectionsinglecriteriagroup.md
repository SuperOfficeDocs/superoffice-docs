...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=person/email/emailHasBounced,person/personExtra/x_person_user_relation,sale/associate/personEmail,project/LastDoByActivity
