...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/assocTooltip,person/personActiveErpLinks,contact/contactAssociate/contactId,contact/contactAssociate/contactCategory,extra/x_ticket_boolean
