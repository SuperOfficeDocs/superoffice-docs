...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/isActive,person/mrMrs,person/personAssociate/contactDepartment,contact/saintActivityType,sale/createdByWorkflow
