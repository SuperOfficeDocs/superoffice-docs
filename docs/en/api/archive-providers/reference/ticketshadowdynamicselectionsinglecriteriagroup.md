...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=contact/contactAssociate/associateDbId,project/type,person/personExtra/x_person_datetime
