...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=ownedBy/assocType,person/email/emailDescription,person/correspondingAssociate/personId,contact/hasInfoText,sale/soldReason
