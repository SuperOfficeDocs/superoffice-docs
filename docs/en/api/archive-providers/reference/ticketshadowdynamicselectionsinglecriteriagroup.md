...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/role,person/personUpdatedBy,person/personDirectFax/description,person/legalBaseEmarketing,contact/searchPhone/description
