...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=has_attachment,person/personAssociate/firstName,contact/NumberOfNotCompletedTicketsInPeriod,sale/contactId,project/LastDoBySale
