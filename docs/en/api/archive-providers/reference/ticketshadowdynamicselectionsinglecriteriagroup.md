...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/middleName,createdBy/simultaneousEjUser,person/supportLanguage,person/personAddress/zip,person/restrictionAddress/state
