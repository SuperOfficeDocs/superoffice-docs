...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdByWorkflow,ownedBy/personId,contact/phone/formattedNumber,contact/contactAssociate/ejDisplayName,contact/LastSale
