...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=ownedBy/otherGroups,person/supportLanguage,person/personAddress/line1,contact/contactAssociate/role,sale/saleTypeCategory
