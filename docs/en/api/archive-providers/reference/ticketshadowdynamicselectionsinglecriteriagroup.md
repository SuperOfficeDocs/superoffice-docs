...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=realTimeToReply,createdBy/personId,createdBy/usergroup,person/birthDay,person/isStakeholder
