...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/isLocation,person/legalBaseStore,contact/postAddress/line1,sale/updatedBy,sale/activeErpLinks
