...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=readStatus,timeSpent,person/restrictionAddress/wgs84longitude,person/personUdef/SuperOffice:4,contact/streetAddress/city
