...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/simultaneousEjUser,person/associateType,person/personAddress/line1,person/personAssociate/fullName,person/correspondingAssociate/personEmail
