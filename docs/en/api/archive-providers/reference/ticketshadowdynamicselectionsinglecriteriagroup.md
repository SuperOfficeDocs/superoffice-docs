...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=getAllRows,projectId,person/personPager/description,person/personExtra/y_rental/x_contact,person/personAssociate/userName
