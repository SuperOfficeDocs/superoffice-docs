...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=person/title,contact/contactUdef/SuperOffice:10,project/projectUdef/SuperOffice:10,project/saintSaleStatus
