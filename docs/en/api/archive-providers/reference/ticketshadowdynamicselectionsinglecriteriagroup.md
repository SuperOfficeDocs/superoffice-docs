...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=createdBy/isActive,ownedBy/assocTooltip,person/personExtra/y_rental/x_amount,sale/earning,sale/associate/fullName
