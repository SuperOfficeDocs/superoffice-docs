...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionSingleCriteriaGroup?$select=person/restrictionAddress/line2,contact/streetAddress/line2,contact/contactExtra/x_contact_contact,sale/personId,project/NumberOfSalesInPeriod
