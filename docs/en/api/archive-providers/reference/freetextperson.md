...
```http!
GET /api/v1/archive/FreetextPerson?$select=personSourceRelation/fullName,personSourceRelation/who,request/numberOfReplies,projectMembers/projectAssociate/assocTooltip,personAppointment/endDate
