...
```http!
GET /api/v1/archive/FreetextPerson?$select=personUpdatedByFullName,email/emailDescription,personAddress/city,personContact/contactAssociate/associateDbId,personContact/contactSupportPerson/hasCompany
