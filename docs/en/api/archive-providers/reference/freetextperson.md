...
```http!
GET /api/v1/archive/FreetextPerson?$select=personSourceRelation/birthYear,personContact/contactSupportPerson/hasInfoText,personContact/contactSupportPerson/personUpdatedBy,personContact/contactUdef/SuperOffice:1,legalBaseEmarketing
