...
```http!
GET /api/v1/archive/FreetextPerson?$select=mrMrs,supportAssociateFullName,personSourceRelation/mrMrs,personAssociate/portraitThumbnail,request/projectId
