...
```http!
GET /api/v1/archive/FreetextPerson?$select=contactId,restrictionAddress/zip,personSourceRelation/hasInfoText,personSourceRelation/isProjectMember,personTargetRelation/personAssociateId
