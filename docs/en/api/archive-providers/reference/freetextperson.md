...
```http!
GET /api/v1/archive/FreetextPerson?$select=personRegisteredDate,personTargetRelation/personId,personContact/email/emailLastSent,personContact/restrictionPostalAddress/city,personContact/restrictionAddress/zip
