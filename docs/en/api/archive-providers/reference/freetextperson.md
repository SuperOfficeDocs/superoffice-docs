...
|personContact/contactSupportPerson/whenUpdatedByWorkflow|datetime|User support contact - Updated by flow: Updated by flow| x |
...
```http!
GET /api/v1/archive/FreetextPerson?$select=personUdef/SuperOffice:7,personExtra/x_person_float,personSourceRelation/personCountry,personTargetRelation/contactId,personContact/contactSupportAssociate/mrMrs
