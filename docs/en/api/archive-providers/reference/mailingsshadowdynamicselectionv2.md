...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/postAddress/county,mailingAddr/contact/NumberOfNotCompletedSalesInPeriod,mailingAddr/person/kanaFirstName,mailingAddr/person/personAssociate/contactId,mailingAddr/person/personAssociate/portraitThumbnail
