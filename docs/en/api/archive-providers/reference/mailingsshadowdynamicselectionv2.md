...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/restrictionAddress/zip,mailingAddr/contact/contactAssociate/firstName,mailingAddr/contact/NumberOfNotCompletedActivities,mailingAddr/person/personBusiness,mailingAddr/person/correspondingAssociate/usergroupId
