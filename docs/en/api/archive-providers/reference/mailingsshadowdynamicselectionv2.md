...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=registeredBy,mailingAddr/contact/streetAddress/city,mailingAddr/contact/streetAddress/formattedAddress,mailingAddr/contact/contactAssociate/userName,mailingAddr/contact/NumberOfSales
