...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/person/personUpdatedByFullName,mailingAddr/person/personUdef/SuperOffice:10,mailingAddr/person/personAssociate/isActive,project/projectAssociate/usergroupId
