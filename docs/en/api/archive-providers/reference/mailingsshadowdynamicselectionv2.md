...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/streetAddress/formattedAddress,mailingAddr/contact/contactAssociate/contactFullName,project/projectUdef/SuperOffice:1
