...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/nameDepartment,mailingAddr/person/personId,mailingAddr/person/personCategory,associate/isActive,associate/isActiveText
