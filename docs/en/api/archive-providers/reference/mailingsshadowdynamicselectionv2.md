...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/registeredByFullName,mailingAddr/contact/contactExtra/x_contact_default_integer,project/project/textId
