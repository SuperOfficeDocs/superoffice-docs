...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/contactAssociate/otherGroups,mailingAddr/person/isMailingRecipient,project/projectAssociate/userName
