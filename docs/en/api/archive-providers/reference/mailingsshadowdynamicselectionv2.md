...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/contactAssociate/title,mailingAddr/person/personExtra/x_person_category_relation,mailingAddr/contact/saintAmountClass
