...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/streetAddress/city,mailingAddr/contact/contactExtra/x_contact_contact_relation,mailingAddr/person/personDeletedDate
