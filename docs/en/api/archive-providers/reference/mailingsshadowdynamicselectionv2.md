...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=mailingAddr/contact/contactAssociate/locationAddress,mailingAddr/person/personCategoryGroup,project/projectId,project/description,project/projectEvent/eventDate
