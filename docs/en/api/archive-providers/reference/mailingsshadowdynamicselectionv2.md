...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionV2?$select=text,mailingAddr/contact/LastActivity,mailingAddr/person/restrictionAddress/city,project/projectAssociate/credentialType
