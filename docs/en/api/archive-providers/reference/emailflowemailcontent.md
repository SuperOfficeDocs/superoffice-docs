...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=shipment/emailFlow/workflowSuccessRate,shipment/emailFlow/updatedDate,shipment/emailFlow/workflowAssociate/contactId,shipment/project/LastDoBySale
