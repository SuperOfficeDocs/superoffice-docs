...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=shipment/contactId,shipment/emailFlow/workflowAssociate/assocName,shipment/emailFlow/workflowAssociate/locationAddress
