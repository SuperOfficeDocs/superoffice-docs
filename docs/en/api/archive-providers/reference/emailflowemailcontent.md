...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=shipment/recordTypeText,shipment/emailFlow/overrideConsentSubscription,shipment/emailFlow/workflowSucceededCount,shipment/project/LastDoBySale
