...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=shipment/project/projectAssociate/contactFullName,shipment/emailFlow/workflowDefinitionStatus,shipment/emailFlow/workflowAssociate/isActive
