...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=shipment/project/projectAssociate/ejDisplayName,shipment/project/NumberOfSales,shipment/emailFlow/workflowDefinitionStatus
