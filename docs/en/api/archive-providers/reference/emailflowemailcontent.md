...
```http!
GET /api/v1/archive/EmailFlowEmailContent?$select=shipment/recipientStatus,shipment/emailFlow/workflowDefinitionStatus,shipment/emailFlow/workflowAssociate/isActive
