...
```http!
GET /api/v1/archive/SimplePerson?$select=phone/formattedNumber,personExtra/x_person_timespan,personContact/contactSource,personContact/restrictionAddress/county,request/createdAt
