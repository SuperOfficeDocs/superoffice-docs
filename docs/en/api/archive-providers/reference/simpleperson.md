...
```http!
GET /api/v1/archive/SimplePerson?$select=personDirectFax/formattedNumber,personInterestIds,personSourceRelation/fullName,personContact/streetAddress/zip,withdrawnStoreConsent
