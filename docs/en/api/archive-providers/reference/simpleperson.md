...
```http!
GET /api/v1/archive/SimplePerson?$select=personExtra/x_person_float,correspondingAssociate/isActive,personContact/contactId,personContact/nameDepartment,personContact/postAddress/line2
