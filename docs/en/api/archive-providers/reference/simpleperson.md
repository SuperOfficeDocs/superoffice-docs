...
```http!
GET /api/v1/archive/SimplePerson?$select=birthMonth,personDirectPhone/formattedNumber,personSourceRelation/rank,personSourceRelation/personSource,personSourceRelation/personAssociateId
