...
```http!
GET /api/v1/archive/SimplePerson?$select=retired,portraitThumbnail,personSourceRelation/supportAssociate,personContact/email/emailHasBounced,personContact/restrictionAddress/addressId
