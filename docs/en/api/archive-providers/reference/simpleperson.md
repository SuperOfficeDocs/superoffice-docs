...
```http!
GET /api/v1/archive/SimplePerson?$select=personRegisteredBy,personTargetRelation/personNumber,correspondingAssociate/mrMrs,personContact/department,personContact/contactAssociate/role
