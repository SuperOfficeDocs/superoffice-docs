...
```http!
GET /api/v1/archive/SimplePerson?$select=personRegisteredBy,portraitThumbnail,email/emailLastBounce,personTargetRelation/personRegisteredDate,personAssociate/locationAddress
