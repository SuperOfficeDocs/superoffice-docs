...
```http!
GET /api/v1/archive/SimplePerson?$select=personTargetRelation/fullName,personAssociate/lastName,personContact/restrictionPostalAddress/wgs84latitude,personContact/url/URLAddress,personContact/contactSupportPerson/personUdef/SuperOffice:6
