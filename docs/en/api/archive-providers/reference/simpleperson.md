...
```http!
GET /api/v1/archive/SimplePerson?$select=fullNameWithContact,email/emailLastBounce,restrictionAddress/line2,personExtra/y_rental/x_contact,personSourceRelation/who
