...
```http!
GET /api/v1/archive/SimplePerson?$select=personExtra/y_rental/id,personContact/contactAssociate/credentialType,projectMembers/projectAssociate/ejDisplayName,projectMembers/projectAssociate/otherGroups,projectMembers/projectAssociate/userName
