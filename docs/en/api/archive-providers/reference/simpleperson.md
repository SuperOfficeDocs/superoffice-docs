...
```http!
GET /api/v1/archive/SimplePerson?$select=firstName,correspondingAssociate/associateDbId,personContact/hasInterests,personContact/countryId,personContact/contactSupportPerson/middleName
