...
```http!
GET /api/v1/archive/SimplePerson?$select=correspondingAssociate/portraitThumbnail,personContact/restrictionPostalAddress/line2,personContact/contactSupportPerson/hasEmarketingConsent,personAppointment/priority,personAppointment/suggestedAppointmentId
