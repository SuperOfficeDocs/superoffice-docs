...
```http!
GET /api/v1/archive/SimplePerson?$select=position,restrictionAddress/line3,personSourceRelation/personRegisteredDate,personTargetRelation/personHasInterests,personContact/contactFax/formattedNumber
