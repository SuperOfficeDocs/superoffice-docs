...
```http!
GET /api/v1/archive/SimplePerson?$select=personExtra/x_person_float,personSourceRelation/title,personTargetRelation/rank,personTargetRelation/personRegisteredDate,personAssociate/userName
