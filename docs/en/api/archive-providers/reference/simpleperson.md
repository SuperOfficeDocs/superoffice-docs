...
```http!
GET /api/v1/archive/SimplePerson?$select=personSourceRelation/associateType,personContact/contactInterestIds,consentSourceStore,projectMembers/endDate,projectMembers/project/textId
