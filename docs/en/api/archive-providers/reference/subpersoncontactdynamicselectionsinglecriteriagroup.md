...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=contactSource,forceCompany,personExtra/x_person_integer,personSourceRelation/kanaFirstName,correspondingAssociate/usergroup
