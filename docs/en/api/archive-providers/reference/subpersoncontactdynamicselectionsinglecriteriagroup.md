...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=category,request/ownedBy/credentialType,projectMembers/updatedByFullName
