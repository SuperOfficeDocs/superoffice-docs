...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=personSourceRelation/contactId,correspondingAssociate/contactName,linkClicked/shipmentId,chatSession/status,personAppointment/updatedByFullName
