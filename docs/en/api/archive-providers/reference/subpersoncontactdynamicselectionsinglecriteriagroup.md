...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=mrMrs,country,personExtra/x_person_priority_relation,postAddress/state,request/has_attachment
