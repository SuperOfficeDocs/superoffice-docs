...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=lastName,personNoMail,personEmail/emailBounceCount,formSubmission/associateId,request/createdBy/simultaneousEjUser
