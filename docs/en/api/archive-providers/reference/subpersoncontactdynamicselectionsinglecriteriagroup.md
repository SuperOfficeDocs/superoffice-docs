...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=hasCompany,personAddress/city,personTargetRelation/personRegisteredByFullName,request/personId,personAppointment/saleId
