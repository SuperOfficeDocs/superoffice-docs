...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=hasInterests,phone/formattedNumber,nameDepartment,stop,personAppointment/appointmentUdef/SuperOffice:4
