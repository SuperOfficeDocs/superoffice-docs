...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=personId,email/emailLastSent,personExtra/x_person_integer,correspondingAssociate/personEmail,streetAddress/wgs84longitude
