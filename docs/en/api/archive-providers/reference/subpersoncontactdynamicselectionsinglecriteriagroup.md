...
```http!
GET /api/v1/archive/SubPersonContactDynamicSelectionSingleCriteriaGroup?$select=updatedByFullName,registeredDate,email/emailLastSent,personUdef/SuperOffice:7,personUdef/SuperOffice:9
