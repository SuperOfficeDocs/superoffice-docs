...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/personAddress/line1,person/personAssociate/contactName,contact/nameDepartment,contact/restrictionAddress/line3
