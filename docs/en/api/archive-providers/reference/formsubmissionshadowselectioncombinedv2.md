...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/isProjectMember,person/correspondingAssociate/personId,person/restrictionAddress/wgs84latitude
