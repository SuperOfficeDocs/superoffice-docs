...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/personDirectPhone/formattedNumber,person/email/emailProtocol,contact/contactAssociate/contactDepartment,contact/LastDoBySale
