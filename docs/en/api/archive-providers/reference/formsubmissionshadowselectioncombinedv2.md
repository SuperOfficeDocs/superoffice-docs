...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=registeredDate,person/restrictionAddress/wgs84latitude,contact/restrictionAddress/county
