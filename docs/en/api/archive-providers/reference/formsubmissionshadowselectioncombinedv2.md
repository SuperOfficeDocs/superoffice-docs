...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/rank,person/personExtra/x_person_datetime,contact/email/emailId,contact/restrictionAddress/line1
