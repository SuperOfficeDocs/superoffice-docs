...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=associate/isActiveText,person/birthDay,person/consentSourceEmarketing,contact/contactNoMail,contact/streetAddress/zip
