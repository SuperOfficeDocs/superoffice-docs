...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/firstName,person/email/emailProtocol,person/restrictionAddress/city,person/personExtra/y_rental/id,person/hasEmarketingConsent
