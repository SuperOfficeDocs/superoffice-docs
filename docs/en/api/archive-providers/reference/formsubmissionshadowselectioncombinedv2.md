...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/portraitThumbnail,person/hasCompany,person/isProjectMember,contact/streetAddress/city,contact/contactAssociate/assocType
