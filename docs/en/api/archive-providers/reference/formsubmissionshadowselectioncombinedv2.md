...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/hasInterests,person/personNoMail,person/personExtra/x_person_longtext,contact/NumberOfTickets
