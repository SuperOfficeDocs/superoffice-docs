...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/personExtra/y_rental/x_start,person/correspondingAssociate/simultaneousEjUser,contact/LastDoByTicket
