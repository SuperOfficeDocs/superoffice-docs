...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/email/emailLastBounce,person/personUrl/URLDescription,person/personAssociate/contactCategory,contact/contactUdef/SuperOffice:2
