...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=icon,person/contactId,person/personAddress/city,contact/streetAddress/line1,contact/restrictionAddress/wgs84latitude
