...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=associate/middleName,person/personExtra/x_person_shorttext,person/restrictionAddress/zip
