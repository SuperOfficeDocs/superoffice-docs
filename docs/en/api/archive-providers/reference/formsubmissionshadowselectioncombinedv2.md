...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=associate/isActiveText,contact/countryId,contact/contactExtra/x_contact_request_relation
