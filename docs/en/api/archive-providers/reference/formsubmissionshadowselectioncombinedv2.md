...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/whenUpdatedByWorkflow,contact/contactFax/formattedNumber,contact/streetAddress/line1
