...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=associate/ejDisplayName,person/personDeletedDate,person/personAssociate/fullName,person/personAssociate/credentialType
