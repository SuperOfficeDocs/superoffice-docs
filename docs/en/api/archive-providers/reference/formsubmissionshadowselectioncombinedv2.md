...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/personAddress/line2,contact/streetAddress/line3,contact/contactAssociate/contactName
