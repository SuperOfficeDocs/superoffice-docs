...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/kanaLastName,person/personInterestIds,person/personExtra/y_car/id,contact/name,contact/streetAddress/formattedAddress
