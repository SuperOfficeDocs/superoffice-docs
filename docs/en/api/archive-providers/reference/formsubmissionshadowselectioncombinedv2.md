...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=contact/contactExtra/x_contact_default_integer,person/restrictionAddress/zip,person/correspondingAssociate/firstName
