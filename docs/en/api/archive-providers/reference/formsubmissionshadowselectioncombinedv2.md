...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=updatedBy,person/correspondingAssociate/personId,contact/contactExtra/x_contact_longtext
