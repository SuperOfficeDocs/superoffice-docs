...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=associate/contactId,associate/personId,person/personBusiness,person/personPager/formattedNumber,person/searchPhone/formattedNumber
