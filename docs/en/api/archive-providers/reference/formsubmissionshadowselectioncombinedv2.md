...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=associate/fullName,person/personCategory,person/personPrivate/formattedNumber,contact/registeredBy
