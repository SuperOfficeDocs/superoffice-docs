...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=personId,person/consentSourceStore,person/consentSourceEmarketing,contact/contactPhone/description,contact/contactAssociate/personId
