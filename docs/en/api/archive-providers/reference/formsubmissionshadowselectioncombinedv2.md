...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/searchPhone/description,person/personExtra/x_person_hidden_integer,contact/hasInfoText,contact/contactPhone/description
