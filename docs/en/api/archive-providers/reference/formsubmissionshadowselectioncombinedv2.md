...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=icon,associate/isActiveText,person/personDirectFax/formattedNumber,person/hasEmarketingConsent,contact/url/URLAddress
