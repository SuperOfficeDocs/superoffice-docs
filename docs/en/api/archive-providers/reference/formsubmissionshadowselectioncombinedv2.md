...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=personId,person/hasInterests,person/personCountryId,person/personNoMail,person/personUrl/URLAddress
