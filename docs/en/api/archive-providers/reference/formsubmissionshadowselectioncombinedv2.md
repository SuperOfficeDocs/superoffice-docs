...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionCombinedV2?$select=person/lastName,person/personAssociate/contactDepartment,contact/email/emailDescription,contact/contactUdef/SuperOffice:3
