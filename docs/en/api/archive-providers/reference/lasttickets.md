...
```http!
GET /api/v1/archive/LastTickets?$select=person/restrictionAddress/addressId,person/personExtra/x_person_shorttext,person/correspondingAssociate/personEmail,contact/contactAssociate/middleName,contact/saintSaleStatus
