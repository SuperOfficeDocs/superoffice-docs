...
```http!
GET /api/v1/archive/LastTickets?$select=person/middleName,person/personAddress/formattedAddress,contact/postAddress/addressId,contact/restrictionAddress/wgs84latitude,project/projectAssociate/firstName
