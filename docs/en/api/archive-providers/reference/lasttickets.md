...
```http!
GET /api/v1/archive/LastTickets?$select=deadline,createdBy/role,person/correspondingAssociate/contactDepartment,contact/postAddress/line2,contact/contactAssociate/credentialType
