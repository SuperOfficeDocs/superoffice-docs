...
```http!
GET /api/v1/archive/LastTickets?$select=tags,contact/postAddress/formattedAddress,contact/contactExtra/x_contact_dropdown,contact/contactExtra/x_contact_boolean,contact/LastCompletedTicket
