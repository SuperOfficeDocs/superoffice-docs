...
```http!
GET /api/v1/archive/LastTickets?$select=ownedBy/associateDbId,person/isProjectMember,person/personUdef/SuperOffice:3,contact/postAddress/state,project/projectPublish/publishedBy
