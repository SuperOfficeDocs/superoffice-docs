...
```http!
GET /api/v1/archive/LastTickets?$select=ownedBy/otherGroups,person/personUpdatedByFullName,person/personAssociateFullName,person/personUrl/URLAddress,person/personAssociate/role
