...
```http!
GET /api/v1/archive/LastTickets?$select=ownedBy/assocType,sale/associate/assocTooltip,project/type,project/projectAssociate/contactDepartment,project/projectAssociate/isActive
