...
```http!
GET /api/v1/archive/LastTickets?$select=createdBy/portraitThumbnail,person/birthYear,person/personUpdatedBy,person/correspondingAssociate/credentialType,contact/contactPhone/description
