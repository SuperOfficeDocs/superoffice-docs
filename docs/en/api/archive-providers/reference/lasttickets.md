...
```http!
GET /api/v1/archive/LastTickets?$select=origin,ownedBy/ejDisplayName,person/personBusiness,person/personAssociate/associateDbId,person/personAssociate/usergroup
