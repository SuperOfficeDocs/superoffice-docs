...
```http!
GET /api/v1/archive/LastTickets?$select=createdBy/fullName,ownedBy/personEmail,person/position,person/personUdef/SuperOffice:3,person/correspondingAssociate/middleName
