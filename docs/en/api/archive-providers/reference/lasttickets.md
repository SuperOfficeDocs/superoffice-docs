...
```http!
GET /api/v1/archive/LastTickets?$select=createdBy/credentialType,person/correspondingAssociate/credentialDisplayValue,contact/searchPhone/description,contact/contactUdef/SuperOffice:5,sale/updatedDate
