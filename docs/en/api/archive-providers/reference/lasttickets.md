...
```http!
GET /api/v1/archive/LastTickets?$select=person/restrictionAddress/state,person/personAssociate/contactDepartment,person/personAssociate/portraitThumbnail,person/withdrawnStoreConsent,sale/reopenDate
