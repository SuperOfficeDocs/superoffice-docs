...
```http!
GET /api/v1/archive/LastTickets?$select=createdBy/simultaneousEjUser,ownedBy/portraitThumbnail,person/personAssociateId,person/personExtra/x_person_datetime,person/personAssociate/title
