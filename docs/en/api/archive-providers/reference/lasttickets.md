...
```http!
GET /api/v1/archive/LastTickets?$select=contact/contactAssociate/contactFullName,contact/contactAssociate/credentialDisplayValue,sale/associate/title,project/projectPublish/publishedFrom
