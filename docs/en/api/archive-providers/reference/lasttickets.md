...
```http!
GET /api/v1/archive/LastTickets?$select=realTimeToClose,person/personPrivate/formattedNumber,person/personUdef/SuperOffice:6,contact/associateId,contact/LastActivity
