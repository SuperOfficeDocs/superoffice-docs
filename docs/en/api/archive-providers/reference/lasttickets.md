...
```http!
GET /api/v1/archive/LastTickets?$select=ownedBy/assocType,person/email/emailId,contact/contactSource,sale/saleUdef/SuperOffice:2,project/projectAssociate/userName
