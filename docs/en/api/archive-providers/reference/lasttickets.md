...
```http!
GET /api/v1/archive/LastTickets?$select=ownedBy/contactFullName,person/restrictionAddress/line3,contact/code,contact/contactAssociate/assocTooltip,contact/contactExtra/x_contact_date
