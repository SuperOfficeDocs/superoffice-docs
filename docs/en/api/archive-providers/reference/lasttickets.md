...
```http!
GET /api/v1/archive/LastTickets?$select=createdBy/portraitThumbnail,ownedBy/contactFullName,contact/contactAssociate/isActiveText,sale/icon,sale/recordType
