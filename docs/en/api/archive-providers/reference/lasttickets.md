...
```http!
GET /api/v1/archive/LastTickets?$select=createdBy/associateDbId,person/personAssociateId,person/whenUpdatedByWorkflow,person/correspondingAssociate/usergroupId,contact/email/emailAddress
