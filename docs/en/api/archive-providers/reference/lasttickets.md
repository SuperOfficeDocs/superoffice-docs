...
```http!
GET /api/v1/archive/LastTickets?$select=createdBy,ownedBy/portraitThumbnail,person/personMobilePhone/description,person/personExtra/y_rental/x_end,contact/nameDepartment
