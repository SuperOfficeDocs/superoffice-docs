...
```http!
GET /api/v1/archive/LastTickets?$select=person/personUdef/SuperOffice:1,person/correspondingAssociate/personId,contact/hasInfoText,contact/contactExtra/x_contact_hidden_integer,sale/hasGuide
