...
```http!
GET /api/v1/archive/LastTickets?$select=person/personAddress/wgs84longitude,person/personExtra/x_person_hidden_integer,person/correspondingAssociate/middleName
