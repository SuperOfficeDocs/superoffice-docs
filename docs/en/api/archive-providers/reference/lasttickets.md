...
```http!
GET /api/v1/archive/LastTickets?$select=realTimeToClose,ownedBy/isActiveText,person/useAsMailingAddress,person/personAssociate/isActive,contact/updatedByFullName
