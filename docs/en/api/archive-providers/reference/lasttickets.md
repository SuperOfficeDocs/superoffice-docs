...
```http!
GET /api/v1/archive/LastTickets?$select=person/updatedByWorkflow,person/legalBaseEmarketing,contact/updatedDate,sale/soldReason,sale/associate/portraitThumbnail
