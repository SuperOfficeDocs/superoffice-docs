...
```http!
GET /api/v1/archive/ConsentPurpose?$select=consentPerson/person/supportAssociate,consentPerson/person/personUdef/SuperOffice:2,consentPerson/person/personUpdatedByFullName
