...
```http!
GET /api/v1/archive/ConsentPurpose?$select=consentPerson/person/kanaLastName,consentPerson/person/personUpdatedByFullName,consentPerson/person/personMobilePhone/description
