...
```http!
GET /api/v1/archive/ConsentPurpose?$select=consentPerson/person/personRegisteredBy,consentPerson/person/whenUpdatedByWorkflow,consentPerson/person/personRegisteredBy
