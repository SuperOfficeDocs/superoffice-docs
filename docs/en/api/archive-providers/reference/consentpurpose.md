...
```http!
GET /api/v1/archive/ConsentPurpose?$select=consentPerson/person/email/emailProtocol,consentPerson/person/personUpdatedDate,consentPerson/person/personMobilePhone/description
