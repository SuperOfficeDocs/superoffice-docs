...
```http!
GET /api/v1/archive/ConsentPurpose?$select=privacyStatementDescription,consentPerson/person/whenUpdatedByWorkflow,consentPerson/person/personUpdatedDate
