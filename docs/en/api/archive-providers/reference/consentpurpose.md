...
```http!
GET /api/v1/archive/ConsentPurpose?$select=privacyStatementDescription,consentPerson/person/personUpdatedDate,consentPerson/person/personMobilePhone/description
