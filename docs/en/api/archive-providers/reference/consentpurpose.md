...
```http!
GET /api/v1/archive/ConsentPurpose?$select=consentPerson/person/kanaFirstName,consentPerson/person/ticketPriority,consentPerson/person/email/emailDescription
