...
```http!
GET /api/v1/archive/ConsentPurpose?$select=privacyStatementUrl,consentPerson/person/personUpdatedDate,consentPerson/person/personMobilePhone/description
