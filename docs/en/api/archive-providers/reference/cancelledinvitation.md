...
```http!
GET /api/v1/archive/CancelledInvitation?$select=invitationTypeIcon,contact/business,contact/contactExtra/x_contact_request_relation,contact/NumberOfSales,person/retired
