...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/restrictionAddress/addressId,contact/NumberOfSales,project/projectAssociate/role,sale/userGroup,sale/registeredDate
