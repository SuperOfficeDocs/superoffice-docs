...
```http!
GET /api/v1/archive/CancelledInvitation?$select=isFree,suggestedAppointmentId,contact/department,person/personMobilePhone/formattedNumber,person/correspondingAssociate/personId
