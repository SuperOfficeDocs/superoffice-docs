...
```http!
GET /api/v1/archive/CancelledInvitation?$select=registeredBy,contact/email/emailProtocol,person/restrictionAddress/county,person/personAssociate/simultaneousEjUser,project/endDate
