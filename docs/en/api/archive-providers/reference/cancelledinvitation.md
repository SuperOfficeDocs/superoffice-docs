...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/updatedByFullName,person/personInfo/infoText,person/personAssociate/title,appointmentUdef/SuperOffice:4,sale/associate/usergroup
