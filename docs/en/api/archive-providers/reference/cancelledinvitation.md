...
```http!
GET /api/v1/archive/CancelledInvitation?$select=invitationTypeIcon,date,contact/contactAssociate/firstName,person/useAsMailingAddress,person/restrictionAddress/county
