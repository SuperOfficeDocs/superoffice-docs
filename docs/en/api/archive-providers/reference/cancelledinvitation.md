...
```http!
GET /api/v1/archive/CancelledInvitation?$select=location,contact/category,contact/email/emailAddress,contact/contactAssociate/middleName,contact/contactAssociate/contactName
