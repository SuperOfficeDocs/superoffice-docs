...
```http!
GET /api/v1/archive/CancelledInvitation?$select=appointmentPublish/publishedTo,contact/restrictionAddress/zip,contact/url/URLDescription,contact/contactAssociate/isActive,person/fullName
