...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/contactUdef/SuperOffice:6,contact/contactUdef/SuperOffice:8,person/personAssociateFullName,associate/credentialDisplayValue
