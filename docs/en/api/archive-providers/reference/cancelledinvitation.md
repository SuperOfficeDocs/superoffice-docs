...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/streetAddress/city,contact/contactAssociate/ejUserId,contact/contactAssociate/credentialType,contact/contactAssociate/isLocation,sale/competitor
