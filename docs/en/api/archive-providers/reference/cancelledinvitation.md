...
```http!
GET /api/v1/archive/CancelledInvitation?$select=updatedDate,contact/contactAssociate/associateDbId,contact/contactUdef/SuperOffice:5,contact/LastCompletedSale,person/fullName
