...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/streetAddress/line1,contact/contactUdef/SuperOffice:8,person/lastName,person/personAddress/wgs84longitude,person/personAssociate/userName
