...
```http!
GET /api/v1/archive/CancelledInvitation?$select=person/personUpdatedByFullName,person/personInterestIds,person/personAssociate/ejUserId,person/withdrawnStoreConsent,sale/salePublish/publishedTo
