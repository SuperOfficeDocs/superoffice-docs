...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/mainContact,contact/contactPhone/formattedNumber,contact/streetAddress/state,person/personAddress/wgs84latitude,person/personUdef/SuperOffice:9
