...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/saintDirection,person/hasInterests,person/personMobilePhone/description,person/personAddress/state,person/personExtra/x_person_contact_relation
