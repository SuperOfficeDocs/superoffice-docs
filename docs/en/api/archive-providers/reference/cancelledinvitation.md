...
```http!
GET /api/v1/archive/CancelledInvitation?$select=person/personExtra/y_car/id,project/projectUdef/SuperOffice:4,project/projectUdef/SuperOffice:6,associate/contactFullName
