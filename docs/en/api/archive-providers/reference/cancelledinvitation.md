...
```http!
GET /api/v1/archive/CancelledInvitation?$select=contact/LastCompletedActivity,person/personExtra/x_person_time,person/hasEmarketingConsent,project/associateId
