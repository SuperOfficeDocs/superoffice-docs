...
```http!
GET /api/v1/archive/Relation?$select=source/personActiveErpLinks,source/code,target/restrictionAddress/formattedAddress,contactFullName,target/fullNameWithContact
