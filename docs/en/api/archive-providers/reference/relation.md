...
```http!
GET /api/v1/archive/Relation?$select=source/personId,source/phone/formattedNumber,target/streetAddress/wgs84latitude,target/NumberOfTickets,target/birthMonth
