...
```http!
GET /api/v1/archive/Relation?$select=source/stop,target/contactUdef/SuperOffice:6,target/NumberOfNotCompletedSalesInPeriod,userName,source/postAddress/wgs84longitude
