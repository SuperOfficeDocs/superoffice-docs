...
```http!
GET /api/v1/archive/Relation?$select=target/streetAddress/addressId,target/restrictionAddress/addressId,target/contactExtra/x_contact_contact_relation,contactName
