...
```http!
GET /api/v1/archive/Relation?$select=target/searchPhone/description,target/restrictionAddress/formattedAddress,target/streetAddress/formattedMultiLineAddress
