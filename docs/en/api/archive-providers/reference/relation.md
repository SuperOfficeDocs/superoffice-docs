...
```http!
GET /api/v1/archive/Relation?$select=source/personRegisteredByFullName,target/birthDay,source/contactAssociate/middleName,source/contactExtra/x_contact_hidden_integer
