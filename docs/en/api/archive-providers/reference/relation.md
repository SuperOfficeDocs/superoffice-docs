...
```http!
GET /api/v1/archive/Relation?$select=target/contactId,target/email/emailAddress,target/contactAssociate/usergroupId,assocName,source/contactExtra/x_contact_default_integer
