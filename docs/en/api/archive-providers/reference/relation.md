...
```http!
GET /api/v1/archive/Relation?$select=source/birthMonth,target/contactFax/description,target/contactExtra/x_contact_default_integer,target/portraitThumbnail
