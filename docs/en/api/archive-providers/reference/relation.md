...
```http!
GET /api/v1/archive/Relation?$select=source/supportAssociateFullName,source/personCategory,target/contactUdef/SuperOffice:6,target/personId,source/url/URLAddress
