...
```http!
GET /api/v1/archive/Relation?$select=source/birthDay,source/supportLanguage,source/personDirectFax/formattedNumber,target/contactExtra/x_contact_float,source/streetAddress/state
