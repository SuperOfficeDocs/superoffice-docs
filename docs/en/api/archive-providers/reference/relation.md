...
```http!
GET /api/v1/archive/Relation?$select=getAllRows,target/contactExtra/x_contact_float,target/birthDay,target/isProjectMember,target/personPager/formattedNumber
