...
```http!
GET /api/v1/archive/Relation?$select=source/deletedDate,target/LastDoBySale,source/restrictionAddress/wgs84longitude,source/contactAssociate/personEmail,source/contactUdef/SuperOffice:10
