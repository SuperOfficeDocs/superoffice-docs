...
```http!
GET /api/v1/archive/Relation?$select=relationId,source/personUpdatedDate,source/portraitThumbnail,source/contactAssociate/personEmail,source/contactExtra/x_contact_dropdown
