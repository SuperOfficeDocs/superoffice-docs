...
```http!
GET /api/v1/archive/Relation?$select=source/personDirectFax/description,target/restrictionAddress/line1,target/contactExtra/x_contact_integer,source/postAddress/wgs84longitude,source/contactAssociate/portraitThumbnail
