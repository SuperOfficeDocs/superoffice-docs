...
```http!
GET /api/v1/archive/Relation?$select=source/deletedDate,target/contactPhone/description,target/email/emailId,target/restrictionAddress/zip,target/contactAssociate/isLocation
