...
```http!
GET /api/v1/archive/Relation?$select=source/personCategory,target/restrictionAddress/line1,target/NumberOfNotCompletedTicketsInPeriod,target/SaintStatus2,source/email/emailLastBounce
