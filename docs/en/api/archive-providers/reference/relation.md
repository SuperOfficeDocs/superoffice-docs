...
```http!
GET /api/v1/archive/Relation?$select=source/personPrivate/description,target/mainContact,target/contactAssociate/title,target/contactUdef/SuperOffice:9,target/contactUdef/SuperOffice:12
