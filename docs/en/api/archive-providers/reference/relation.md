...
```http!
GET /api/v1/archive/Relation?$select=target/email/emailBounceCount,target/streetAddress/zip,target/contactAssociate/mrMrs,target/contactUdef/SuperOffice:3,target/contactExtra/x_contact_default_integer
