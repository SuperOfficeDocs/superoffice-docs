...
```http!
GET /api/v1/archive/Relation?$select=target/forceCompany,target/contactAssociate/contactCategory,target/contactExtra/x_contact_hidden_integer,target/LastDoByActivity
