...
```http!
GET /api/v1/archive/Relation?$select=target/contactAssociate/personId,source/contactAssociate/credentialDisplayValue,source/NumberOfNotCompletedSalesInPeriod
