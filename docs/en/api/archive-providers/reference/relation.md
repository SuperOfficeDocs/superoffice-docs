...
```http!
GET /api/v1/archive/Relation?$select=source/supportAssociate,source/whenUpdatedByWorkflow,target/email/emailId,target/email/emailBounceCount,target/contactAssociate/otherGroups
