...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=personId,person/email/emailAddress,person/personAssociate/locationAddress,contact/business,contact/contactNoMail
