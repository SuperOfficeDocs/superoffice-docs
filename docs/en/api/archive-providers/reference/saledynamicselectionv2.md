...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=probPercent,description,person/personPrivate/description,person/personAddress/wgs84longitude,person/personAssociate/assocTooltip
