...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=updatedBy,person/personDeletedDate,person/personAddress/addressId,contact/restrictionAddress/formattedAddress,contact/contactAssociate/otherGroups
