...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=soldReason,person/kanaLastName,person/supportLanguage,person/personAssociate/portraitThumbnail,contact/contactExtra/x_contact_longtext
