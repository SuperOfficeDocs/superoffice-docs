...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=person/personAddress/city,person/restrictionAddress/line2,person/restrictionAddress/wgs84longitude,contact/contactFax/formattedNumber,associate/lastName
