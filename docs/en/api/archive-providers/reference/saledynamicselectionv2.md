...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=stalledComment,person/isStakeholder,person/createdByForm,person/personInfo/infoText,contact/contactExtra/x_contact_longtext
