...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=earning,contact/contactAssociate/otherGroups,contact/contactExtra/x_contact_request_relation,appointment/associate/otherGroups,project/hasGuide
