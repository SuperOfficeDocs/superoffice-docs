...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=person/mrMrs,person/personRegisteredByFullName,person/restrictionAddress/line3,contact/restrictionAddress/zip,contact/contactAssociate/role
