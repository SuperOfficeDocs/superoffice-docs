...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=currency,person/email/emailAddress,contact/registeredByFullName,contact/contactUdef/SuperOffice:7,contact/NumberOfNotCompletedTicketsInPeriod
