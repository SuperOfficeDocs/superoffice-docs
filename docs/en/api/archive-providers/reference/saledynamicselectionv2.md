...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=saleCycle,person/personDeletedDate,person/email/emailId,person/personAddress/county,contact/registeredDate
