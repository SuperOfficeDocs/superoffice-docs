...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=description,person/supportAssociate,person/personAssociate/contactDepartment,person/personAssociate/assocType,contact/streetAddress/city
