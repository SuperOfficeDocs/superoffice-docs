...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=currency,person/personHasInterests,person/personUpdatedByFullName,person/personAddress/wgs84longitude,person/consentSourceStore
