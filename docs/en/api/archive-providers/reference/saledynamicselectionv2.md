...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=userGroup,person/title,person/personAssociateId,person/personDeletedDate,person/email/emailDescription
