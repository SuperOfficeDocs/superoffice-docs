...
keywords: SaleDynamicSelectionV2 archive provider
generated: true
...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=person/middleName,person/restrictionAddress/formattedAddress,person/personExtra/x_person_user_relation,person/personExtra/x_person_priority_relation,person/personExtra/x_person_appointment_relation
