...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=amountWeightedInBaseCurrency,person/personUdef/SuperOffice:4,person/personAssociate/simultaneousEjUser,contact/email/emailAddress,contact/url/URLAddress
