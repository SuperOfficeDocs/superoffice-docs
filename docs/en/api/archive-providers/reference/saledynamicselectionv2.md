...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=completed,person/personInfo/infoText,person/correspondingAssociate/associateDbId,contact/mainContact,contact/contactAssociate/isActiveText
