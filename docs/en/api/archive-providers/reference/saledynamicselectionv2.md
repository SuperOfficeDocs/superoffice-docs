...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=reopenDate,person/personUpdatedByFullName,person/restrictionAddress/city,contact/country,contact/streetAddress/county
