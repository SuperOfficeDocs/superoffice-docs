...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=person/phone/formattedNumber,person/personExtra/x_person_category_relation,contact/business,contact/stop,contact/mainContact
