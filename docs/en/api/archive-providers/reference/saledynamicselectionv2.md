...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=projectId,person/personAssociate/contactId,person/withdrawnEmarketingConsent,contact/deletedDate,contact/contactExtra/x_contact_longtext
