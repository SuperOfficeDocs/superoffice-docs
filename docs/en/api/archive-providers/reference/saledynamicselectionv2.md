...
```http!
GET /api/v1/archive/SaleDynamicSelectionV2?$select=earning,originalStage,person/personAddress/city,person/personAssociate/contactDepartment,contact/restrictionAddress/zip
