...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ticketId,timeToClose,person/personExtra/x_person_integer,person/personAssociate/assocType,contact/restrictionAddress/line3
