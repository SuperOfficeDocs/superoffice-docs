...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=createdBy/associateDbId,createdBy/contactDepartment,contact/contactUdef/SuperOffice:7,contact/NumberOfNotCompletedSalesInPeriod,project/projectAssociate/mrMrs
