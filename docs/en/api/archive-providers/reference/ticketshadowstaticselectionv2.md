...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ownedBy/contactId,person/email/emailAddress,person/restrictionAddress/zip,person/personAssociate/mrMrs,person/correspondingAssociate/fullName
