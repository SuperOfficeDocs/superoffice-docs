...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ownedBy/title,person/personAssociateId,contact/contactExtra/x_contact_longtext,project/projectAssociate/personId
