...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=createdBy/ejDisplayName,person/hasInterests,contact/contactAssociate/isActiveText,contact/NumberOfNotCompletedTicketsInPeriod,sale/personId
