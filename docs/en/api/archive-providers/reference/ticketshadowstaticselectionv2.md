...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ownedBy/middleName,person/personAssociate/fullName,person/personExtra/x_person_request_relation
