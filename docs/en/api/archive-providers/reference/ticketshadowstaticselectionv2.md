...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ownedBy/locationAddress,person/personAddress/wgs84longitude,person/personAssociate/contactCategory,person/correspondingAssociate/lastName,person/correspondingAssociate/fullName
