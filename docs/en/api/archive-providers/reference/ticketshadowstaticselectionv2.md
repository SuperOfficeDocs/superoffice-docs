...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/restrictionAddress/wgs84longitude,person/correspondingAssociate/middleName,contact/contactAssociate/portraitThumbnail
