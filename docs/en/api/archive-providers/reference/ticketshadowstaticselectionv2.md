...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=priorityName,ownedBy/contactId,person/personExtra/x_person_date,person/correspondingAssociate/mrMrs,contact/contactAssociate/personId
