...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=projectId,firstReadByUser,createdBy/assocTooltip,ownedBy/isActive,person/email/emailBounceCount
