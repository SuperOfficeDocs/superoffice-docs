...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=timeSpentQueue,timeToReply,createdBy/middleName,person/restrictionAddress/formattedMultiLineAddress,contact/LastActivity
