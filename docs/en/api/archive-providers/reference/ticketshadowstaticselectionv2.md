...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/correspondingAssociate/fullName,contact/restrictionAddress/formattedAddress,contact/saintIntention,sale/currencyId
