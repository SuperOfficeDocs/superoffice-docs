...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=origin,createdBy/assocType,ownedBy/assocType,person/personExtra/x_person_float,contact/postAddress/line1
