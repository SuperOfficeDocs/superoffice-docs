...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=numberOfMessages,person/email/emailAddress,person/personAssociate/contactId,person/correspondingAssociate/ejDisplayName,contact/contactUdef/SuperOffice:1
