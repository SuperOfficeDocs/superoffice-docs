...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=createdBy/userName,person/associateType,person/personAddress/wgs84longitude,person/personExtra/y_car/id,person/correspondingAssociate/mrMrs
