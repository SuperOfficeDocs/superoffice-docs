...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=timeToReply,createdBy/fullName,person/personAssociate/otherGroups,contact/updatedDate,contact/searchPhone/formattedNumber
