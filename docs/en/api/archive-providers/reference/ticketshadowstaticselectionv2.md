...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=createdAt,createdBy/assocName,ownedBy/assocTooltip,person/personAddress/line2,person/personAssociate/usergroup
