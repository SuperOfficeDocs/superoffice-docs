...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=priorityName,person/personHasInterests,person/supportAssociate,person/personExtra/y_rental/y_equipment/x_name,contact/contactAssociate/isActive
