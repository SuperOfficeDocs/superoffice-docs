...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=projectId,person/kanaLastName,person/personBusiness,person/correspondingAssociate/ejDisplayName,person/legalBaseEmarketing
