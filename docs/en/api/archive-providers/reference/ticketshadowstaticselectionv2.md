...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/personCountryId,person/personAssociate/personEmail,person/isMailingRecipient,contact/contactAssociate/assocType,contact/contactUdef/SuperOffice:9
