...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=getAllRows,createdBy/credentialDisplayValue,person/personExtra/y_rental/x_end,contact/contactId,contact/department
