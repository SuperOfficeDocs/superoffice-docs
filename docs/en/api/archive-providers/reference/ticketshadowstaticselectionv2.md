...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/personCountryId,person/personAssociateFullName,person/personExtra/x_person_appointment_relation,person/personAssociate/role,person/personAssociate/portraitThumbnail
