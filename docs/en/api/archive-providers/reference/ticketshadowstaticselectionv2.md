...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ownedBy/title,ownedBy/assocTooltip,person/firstName,person/correspondingAssociate/contactFullName,contact/email/emailBounceCount
