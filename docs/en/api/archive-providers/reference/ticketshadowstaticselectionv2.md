...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/personAddress/addressId,contact/contactAssociate/portraitThumbnail,contact/contactExtra/x_contact_default_integer,targetRecordId
