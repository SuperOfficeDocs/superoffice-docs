...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=activated,createdBy/otherGroups,person/useAsMailingAddress,person/personActiveErpLinks,person/personAssociate/ejStatus
