...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/personHasInterests,person/mrMrs,person/isProjectMember,person/personUdef/SuperOffice:8,contact/contactNoMail
