...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=contact/email/emailHasBounced,person/personExtra/x_person_appointment_relation,contact/email/emailDescription
