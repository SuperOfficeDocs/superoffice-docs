...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=lastChanged,person/subscription,contact/contactExtra/x_contact_default_integer,project/registeredByFullName
