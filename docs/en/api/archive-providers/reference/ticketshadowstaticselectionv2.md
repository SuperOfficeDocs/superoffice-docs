...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=realTimeToReply,contact/mainContact,contact/contactAssociate/usergroup,contact/contactAssociate/credentialDisplayValue,contact/contactExtra/x_contact_datetime
