...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/personInterestIds,person/personUdef/SuperOffice:5,person/personAssociate/lastName,contact/code,contact/email/emailAddress
