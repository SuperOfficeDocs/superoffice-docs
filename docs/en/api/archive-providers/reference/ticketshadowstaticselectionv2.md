...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=person/mrMrs,person/correspondingAssociate/mrMrs,sale/associateId,sale/saleTypeCategory,sale/associate/otherGroups
