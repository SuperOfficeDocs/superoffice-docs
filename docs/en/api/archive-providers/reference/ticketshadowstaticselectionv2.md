...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=ownedBy,sentimentConfidence,person/personExtra/x_person_shorttext_list,person/correspondingAssociate/contactId,contact/contactAssociate/personEmail
