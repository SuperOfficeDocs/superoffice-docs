...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=createdBy/contactFullName,ownedBy/lastName,person/personAssociate/isLocation,person/correspondingAssociate/middleName,person/consentSourceStore
