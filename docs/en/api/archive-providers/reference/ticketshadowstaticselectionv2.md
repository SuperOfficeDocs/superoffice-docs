...
```http!
GET /api/v1/archive/TicketShadowStaticSelectionV2?$select=timeToClose,person/correspondingAssociate/isActiveText,sale/projectId,project/hasInfoText,project/updatedDate
