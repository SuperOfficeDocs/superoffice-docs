...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=contact/name,contact/activeErpLinks,contact/contactExtra/x_contact_timespan,project/LastCompletedSale,associate/usergroup
