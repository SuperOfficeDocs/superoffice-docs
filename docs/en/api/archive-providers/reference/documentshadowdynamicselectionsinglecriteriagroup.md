...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/personExtra/x_person_datetime,person/correspondingAssociate/credentialType,person/correspondingAssociate/credentialDisplayValue,project/projectAssociate/ejStatus,documentUdef/SuperOffice:7
