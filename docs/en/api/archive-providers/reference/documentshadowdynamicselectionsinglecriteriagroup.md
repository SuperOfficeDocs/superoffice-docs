...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=personId,person/restrictionAddress/city,contact/contactAssociate/assocName,contact/saintTicketStatus
