...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=recordTypeText,person/personUpdatedBy,person/correspondingAssociate/contactCategory
