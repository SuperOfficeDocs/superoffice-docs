...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=getAllRows,snum,person/personAssociate/lastName,person/correspondingAssociate/portraitThumbnail
