...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=isReport,person/updatedByWorkflow,person/email/emailProtocol,contact/streetAddress/state,contact/contactAssociate/usergroupId
