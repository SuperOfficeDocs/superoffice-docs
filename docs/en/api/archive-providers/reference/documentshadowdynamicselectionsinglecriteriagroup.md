...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=date,person/middleName,person/email/emailProtocol,person/restrictionAddress/wgs84latitude,person/personAssociate/ejUserId
