...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=type,person/personPrivate/formattedNumber,person/personAssociate/assocName,contact/restrictionAddress/county,contact/NumberOfSales
