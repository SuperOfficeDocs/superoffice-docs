...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=recordType,person/email/emailId,contact/deletedDate,contact/contactAssociate/middleName,project/projectAssociate/assocType
