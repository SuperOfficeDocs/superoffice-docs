...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=associateId,person/personPrivate/formattedNumber,contact/associateId,contact/searchPhone/description,sale/nextDueDate
