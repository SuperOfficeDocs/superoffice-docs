...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=contact/stop,contact/NumberOfSales,project/projectAssociate/userName,associate/personId
