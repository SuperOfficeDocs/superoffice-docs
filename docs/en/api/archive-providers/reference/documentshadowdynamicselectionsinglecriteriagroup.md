...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/email/emailProtocol,person/restrictionAddress/county,project/projectId,project/number
