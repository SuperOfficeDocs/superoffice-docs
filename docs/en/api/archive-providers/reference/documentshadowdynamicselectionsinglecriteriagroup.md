...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/contactFullName,project/text,project/projectEvent/eventDate
