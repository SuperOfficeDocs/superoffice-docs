...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=icon,person/personAssociate/isActiveText,contact/contactDeleted,project/projectPublish/isPublished,associate/mrMrs
