...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/personAddress/county,contact/contactFax/formattedNumber,sale/completed,sale/updatedDate,sale/registeredBy
