...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/email/emailProtocol,person/personAddress/state,person/personExtra/x_person_request_relation,person/correspondingAssociate/assocType,contact/email/emailDescription
