...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=projectId,person/birthMonth,person/ticketPriority,person/personAssociate/isLocation,project/registeredBy
