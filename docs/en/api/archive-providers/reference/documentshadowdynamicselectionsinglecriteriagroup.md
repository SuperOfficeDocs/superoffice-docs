...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/personRegisteredByFullName,person/personAddress/formattedAddress,person/correspondingAssociate/ejDisplayName
