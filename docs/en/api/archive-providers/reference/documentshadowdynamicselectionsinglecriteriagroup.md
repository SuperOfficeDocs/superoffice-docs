...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionSingleCriteriaGroup?$select=person/personExtra/y_rental/x_amount,project/projectAssociate/title,associate/userName,sale/updatedBy,sale/source
