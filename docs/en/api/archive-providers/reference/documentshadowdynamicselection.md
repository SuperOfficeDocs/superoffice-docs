...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/mrMrs,person/personAssociate/lastName,contact/postAddress/zip,contact/url/URLDescription,sale/associate/title
