...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/hasInfoText,person/ticketPriority,contact/contactFax/description,contact/email/emailDescription,contact/contactAssociate/usergroupId
