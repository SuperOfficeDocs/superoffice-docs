...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/email/emailDescription,person/personAssociate/personId,person/correspondingAssociate/portraitThumbnail,contact/contactExtra/x_contact_short_dropdown,project/project/textId
