...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=contact/postAddress/line3,contact/contactExtra/x_contact_float,sale/amountWeighted,sale/associate/assocTooltip
