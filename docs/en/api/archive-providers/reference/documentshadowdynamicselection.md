...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/birthMonth,person/searchPhone/description,person/personExtra/x_person_priority_relation,contact/email/emailAddress,project/completed
