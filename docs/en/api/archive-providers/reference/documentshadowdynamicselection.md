...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/legalBaseEmarketing,contact/updatedBy,contact/registeredBy,project/NumberOfNotCompletedActivities,associate/fullName
