...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=attention,person/personAssociate/credentialDisplayValue,person/correspondingAssociate/role,contact/contactDeleted,associate/mrMrs
