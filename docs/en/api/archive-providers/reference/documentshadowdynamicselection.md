...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=documentPublish/publishedFrom,person/personInfo/infoText,person/personAddress/wgs84latitude,person/restrictionAddress/line3,person/personAssociate/fullName
