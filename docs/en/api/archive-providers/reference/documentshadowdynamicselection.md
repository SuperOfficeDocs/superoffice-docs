...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=getAllRows,person/personDirectFax/description,person/personUdef/SuperOffice:1,contact/streetAddress/state,contact/contactUdef/SuperOffice:12
