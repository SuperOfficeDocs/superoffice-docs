...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=personId,person/supportAssociate,person/personAddress/line2,person/personAssociate/assocName,project/projectAssociate/simultaneousEjUser
