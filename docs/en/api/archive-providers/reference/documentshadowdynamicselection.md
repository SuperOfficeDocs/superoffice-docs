...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=updatedByFullName,isMail,visibleFor,person/phone/formattedNumber,contact/contactAssociate/portraitThumbnail
