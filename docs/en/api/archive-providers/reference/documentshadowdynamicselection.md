...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=updatedDate,documentId,person/personCategoryRank,person/personPager/description,person/personAssociate/contactName
