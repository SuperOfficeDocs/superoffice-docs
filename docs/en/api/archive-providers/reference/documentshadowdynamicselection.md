...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=rowKind,person/personAssociate/credentialDisplayValue,contact/registeredDate,project/imageThumbnail,associate/contactId
