...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/personAssociateFullName,contact/updatedDate,project/hasInfoText,project/projectUdef/SuperOffice:4,project/projectUdef/SuperOffice:10
