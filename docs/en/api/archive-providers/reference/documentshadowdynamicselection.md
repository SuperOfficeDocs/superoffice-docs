...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionDynamicProvider">SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionDynamicProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=time,person/personMobilePhone/formattedNumber,person/email/emailLastSent,contact/restrictionAddress/line3,contact/contactAssociate/ejStatus
