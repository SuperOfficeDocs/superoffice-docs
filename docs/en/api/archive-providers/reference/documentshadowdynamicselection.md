...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=recordTypeText,person/hasInterests,person/kanaLastName,person/email/emailHasBounced,person/personUdef/SuperOffice:6
