...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=person/email/emailBounceCount,person/personExtra/x_person_priority_relation,contact/postAddress/wgs84latitude,sale/associate/middleName,sale/associate/credentialDisplayValue
