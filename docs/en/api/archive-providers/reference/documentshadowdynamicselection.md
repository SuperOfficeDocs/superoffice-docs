...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=completed,person/personAddress/wgs84latitude,person/personUdef/SuperOffice:3,person/personAssociate/ejDisplayName,contact/contactDeleted
