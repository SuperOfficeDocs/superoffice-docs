...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=contactId,person/retired,person/portraitThumbnail,person/personAssociate/personEmail,project/updatedByFullName
