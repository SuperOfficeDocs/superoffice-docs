...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelection?$select=personId,contact/phone/formattedNumber,contact/contactExtra/x_contact_contact_relation,project/updatedDate,project/projectEvent/isExternalEvent
