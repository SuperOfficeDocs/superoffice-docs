...
```http!
GET /api/v1/archive/ChatSession?$select=person/personAssociate/credentialType,person/correspondingAssociate/usergroupId,contact/contactNoMail,contact/streetAddress/line3
