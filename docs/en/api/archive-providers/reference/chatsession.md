...
```http!
GET /api/v1/archive/ChatSession?$select=person/fullName,person/personNumber,person/personDirectPhone/formattedNumber,person/personPager/description,person/correspondingAssociate/locationAddress
