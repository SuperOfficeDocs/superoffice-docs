...
```http!
GET /api/v1/archive/ChatSession?$select=updatedDate,chatTopic/chatTopicId,person/personRegisteredByFullName,person/isProjectMember,person/withdrawnStoreConsent
