...
```http!
GET /api/v1/archive/ChatSession?$select=person/personNumber,person/personAssociateFullName,contact/contactAssociate/ejDisplayName,contact/NumberOfActivitiesInPeriod
