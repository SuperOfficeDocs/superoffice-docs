...
```http!
GET /api/v1/archive/ChatSession?$select=agent,updatedDate,person/restrictionAddress/zip,person/personUdef/SuperOffice:6,contact/contactAssociate/assocTooltip
