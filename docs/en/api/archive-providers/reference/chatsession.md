...
```http!
GET /api/v1/archive/ChatSession?$select=associate/simultaneousEjUser,associate/portraitThumbnail,associate/personEmail,person/correspondingAssociate/middleName,person/correspondingAssociate/otherGroups
