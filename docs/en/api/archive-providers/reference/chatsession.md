...
```http!
GET /api/v1/archive/ChatSession?$select=contactId,person/email/emailLastSent,person/personExtra/x_person_user_relation,contact/phone/formattedNumber,contact/restrictionAddress/formattedMultiLineAddress
