...
```http!
GET /api/v1/archive/ChatSession?$select=associate/personId,person/title,person/personAddress/formattedMultiLineAddress,contact/postAddress/state,contact/streetAddress/city
