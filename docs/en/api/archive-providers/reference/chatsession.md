...
```http!
GET /api/v1/archive/ChatSession?$select=associate/firstName,person/personAssociateFullName,person/personExtra/y_rental/x_amount,contact/streetAddress/formattedMultiLineAddress
