...
```http!
GET /api/v1/archive/ChatSession?$select=person/email/emailHasBounced,person/personExtra/x_person_request_relation,person/legalBaseStore,contact/contactAssociate/middleName
