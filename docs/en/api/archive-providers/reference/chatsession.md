...
```http!
GET /api/v1/archive/ChatSession?$select=associate/isLocation,person/hasInfoText,person/hasCompany,person/email/emailId,contact/restrictionAddress/formattedAddress
