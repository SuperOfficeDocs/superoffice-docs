...
```http!
GET /api/v1/archive/ChatSession?$select=whenRequested,person/personUrl/URLDescription,person/restrictionAddress/wgs84longitude,person/personAssociate/contactId,contact/contactAssociate/title
