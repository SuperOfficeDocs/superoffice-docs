...
```http!
GET /api/v1/archive/ChatSession?$select=person/middleName,person/retired,person/personDeletedDate,person/restrictionAddress/formattedMultiLineAddress,person/correspondingAssociate/contactCategory
