...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personAssociate/isActive,contact/email/emailBounceCount,contact/NumberOfNotCompletedActivitiesInPeriod
