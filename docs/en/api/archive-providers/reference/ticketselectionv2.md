...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=timeSpentInternally,person/personAssociate/mrMrs,person/personAssociate/assocName,person/correspondingAssociate/contactFullName,contact/contactPhone/description
