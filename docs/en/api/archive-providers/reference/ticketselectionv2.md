...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=ownedBy/ejUserId,person/hasInfoText,person/personAddress/formattedMultiLineAddress,person/correspondingAssociate/contactDepartment,sale/registeredDate
