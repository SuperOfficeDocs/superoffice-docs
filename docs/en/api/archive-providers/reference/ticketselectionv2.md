...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personUdef/SuperOffice:7,person/personExtra/x_person_priority_relation,person/correspondingAssociate/credentialType,contact/updatedByFullName,contact/restrictionAddress/state
