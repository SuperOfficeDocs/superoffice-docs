...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=ownedBy/middleName,person/email/emailDescription,person/subscription,contact/contactNoMail,sale/associate/credentialType
