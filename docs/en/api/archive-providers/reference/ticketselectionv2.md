...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=createdBy/assocType,person/personInterestIds,person/personAssociate/role,contact/contactSource,contact/contactExtra/x_contact_timespan
