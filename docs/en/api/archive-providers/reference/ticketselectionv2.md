...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personAssociate/userName,contact/postAddress/zip,contact/contactUdef/SuperOffice:5,contact/saintActivityType,project/projectAssociate/mrMrs
