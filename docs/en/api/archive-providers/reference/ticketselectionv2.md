...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=ownedBy/mrMrs,person/personInterestIds,person/personExtra/x_person_boolean,person/personAssociate/contactFullName,contact/associateId
