...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personId,person/personUdef/SuperOffice:8,person/personAssociate/ejDisplayName,contact/name,extra/x_ticket_integer
