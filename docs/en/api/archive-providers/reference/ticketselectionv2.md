...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/restrictionAddress/line2,person/personExtra/x_person_float,person/hasEmarketingConsent,sale/userGroup
