...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personId,person/personAddress/line1,person/personUdef/SuperOffice:9,person/personAssociate/assocTooltip,person/correspondingAssociate/isActive
