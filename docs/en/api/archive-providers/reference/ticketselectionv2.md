...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=createdBy/title,ownedBy/firstName,person/associateType,person/personDirectFax/description,person/personUdef/SuperOffice:2
