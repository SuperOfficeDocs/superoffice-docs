...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=origin,createdBy/assocName,person/personAssociate/isActiveText,person/correspondingAssociate/associateDbId,person/correspondingAssociate/isLocation
