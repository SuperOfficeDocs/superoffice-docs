...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=ownedBy/lastName,ownedBy/contactDepartment,person/ticketPriority,person/personAddress/addressId,person/personUdef/SuperOffice:3
