...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personInterestIds,person/personExtra/x_person_date,contact/category,contact/contactUdef/SuperOffice:5
