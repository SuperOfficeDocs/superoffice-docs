...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/ticketPriority,person/personUdef/SuperOffice:5,person/personUdef/SuperOffice:10,contact/category,contact/contactAssociate/ejStatus
