...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=contact/contactAssociate/contactId,contact/LastTicket,contact/saintAmountClass,sale/associate/role,project/status
