...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=priorityName,createdBy/assocType,person/personExtra/x_person_date,person/correspondingAssociate/associateDbId,contact/registeredBy
