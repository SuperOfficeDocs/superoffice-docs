...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=ownedBy/userName,person/ticketPriority,contact/email/emailBounceCount,contact/contactExtra/x_contact_dropdown,project/registeredBy
