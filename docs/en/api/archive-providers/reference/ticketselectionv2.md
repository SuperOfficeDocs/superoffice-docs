...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personInfo/textId,person/personUdef/SuperOffice:4,person/personExtra/y_rental/id,contact/contactFax/description,contact/LastCompletedTicket
