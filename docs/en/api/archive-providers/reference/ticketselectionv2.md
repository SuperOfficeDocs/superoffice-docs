...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=createdBy/ejStatus,ownedBy/contactCategory,person/personExtra/x_person_longtext,person/personExtra/x_person_time,project/saintSaleStatus
