...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=createdBy,person/personSource,person/searchPhone/formattedNumber,person/restrictionAddress/county,person/personUdef/SuperOffice:7
