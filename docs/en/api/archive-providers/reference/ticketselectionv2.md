...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/correspondingAssociate/contactFullName,contact/nameDepartment,person/personExtra/x_person_category_relation
