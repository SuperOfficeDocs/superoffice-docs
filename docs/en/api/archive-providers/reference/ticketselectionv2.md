...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=createdBy/credentialType,ownedBy/ejDisplayName,person/personAddress/wgs84longitude,person/personExtra/x_person_shorttext,contact/postAddress/state
