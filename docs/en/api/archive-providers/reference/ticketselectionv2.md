...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personAddress/addressId,person/correspondingAssociate/assocName,contact/postAddress/city,sale/earning
