...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personCountry,person/correspondingAssociate/firstName,contact/contactAssociate/credentialType,sale/createdByWorkflow,project/projectEvent/hasSignOn
