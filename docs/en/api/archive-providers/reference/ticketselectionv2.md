...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=sentimentConfidence,createdBy/isLocation,ownedBy/userName,person/personRegisteredBy,person/restrictionAddress/formattedMultiLineAddress
