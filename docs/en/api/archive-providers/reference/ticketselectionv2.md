...
```http!
GET /api/v1/archive/TicketSelectionV2?$select=person/personAddress/line1,contact/streetAddress/zip,contact/contactExtra/x_contact_longtext,project/imageThumbnail
