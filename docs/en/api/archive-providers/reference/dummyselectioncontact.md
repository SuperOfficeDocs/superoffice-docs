...
```http!
GET /api/v1/archive/DummySelectionContact?$select=registeredByFullName,targetRelation/orgnr,sale/hasQuote,appointment/who,appointment/associate/middleName
