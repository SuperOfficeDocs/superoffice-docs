...
```http!
GET /api/v1/archive/DummySelectionContact?$select=searchPhone/formattedNumber,LastCompletedActivity,targetRelation/code,sale/associate/firstName,sale/associate/middleName
