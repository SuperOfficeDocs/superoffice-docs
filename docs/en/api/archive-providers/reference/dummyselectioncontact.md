...
```http!
GET /api/v1/archive/DummySelectionContact?$select=business,NumberOfSalesInPeriod,NumberOfNotCompletedSales,sale/saleTypeId,sale/associate/simultaneousEjUser
