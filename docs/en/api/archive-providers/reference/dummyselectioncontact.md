...
```http!
GET /api/v1/archive/DummySelectionContact?$select=restrictionAddress/zip,sale/salePublish/publishedTo,sale/associate/fullName,document/documentPublish/publishedBy
