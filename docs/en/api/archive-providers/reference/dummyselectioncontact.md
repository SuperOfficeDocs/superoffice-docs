...
```http!
GET /api/v1/archive/DummySelectionContact?$select=postAddress/state,appointment/saleId,appointment/associate/contactName,appointment/associate/isActive,document/documentId
