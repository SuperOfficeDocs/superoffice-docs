...
```http!
GET /api/v1/archive/DummySelectionContact?$select=email/emailLastSent,LastCompletedTicket,appointment/associate/personId,document/mailMergeDraft,document/visibleFor
