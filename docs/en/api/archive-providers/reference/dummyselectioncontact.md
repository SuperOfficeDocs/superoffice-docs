...
```http!
GET /api/v1/archive/DummySelectionContact?$select=sale/source,appointment/appointmentPublish/publishedTo,appointment/associate/firstName,document/yourref
