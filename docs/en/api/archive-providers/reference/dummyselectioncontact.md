...
```http!
GET /api/v1/archive/DummySelectionContact?$select=contactAssociate/credentialType,contactExtra/x_contact_contact,sourceRelation/hasInfoText,sourceRelation/country,targetRelation/hasInfoText
