...
```http!
GET /api/v1/archive/DummySelectionContact?$select=companyCategoryRank,contactFax/description,postAddress/wgs84longitude,contactAssociate/ejUserId,targetRelation/orgnr
