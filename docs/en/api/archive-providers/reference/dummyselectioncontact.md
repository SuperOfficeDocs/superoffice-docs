...
```http!
GET /api/v1/archive/DummySelectionContact?$select=restrictionAddress/formattedAddress,restrictionAddress/formattedMultiLineAddress,contactUdef/SuperOffice:9,LastSale,sale/daysInStage
