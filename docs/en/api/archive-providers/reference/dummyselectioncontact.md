...
```http!
GET /api/v1/archive/DummySelectionContact?$select=streetAddress/line1,restrictionAddress/county,contactAssociate/credentialType,saintSaleStatus,targetRelation/category
