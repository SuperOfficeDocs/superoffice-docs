...
```http!
GET /api/v1/archive/DummySelectionContact?$select=email/emailLastSent,streetAddress/line1,sourceRelation/updatedByFullName,sale/saleUdef/SuperOffice:8,appointment/booking
