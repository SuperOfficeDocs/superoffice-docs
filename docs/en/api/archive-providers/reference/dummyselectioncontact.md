...
```http!
GET /api/v1/archive/DummySelectionContact?$select=getAllRows,sale/earning,appointment/associate/contactFullName,document/completed,document/associate/contactCategory
