...
```http!
GET /api/v1/archive/DummySelectionContact?$select=postAddress/city,sale/earningPercent,sale/soldReason,appointment/associate/assocName,appointment/associate/ejUserId
