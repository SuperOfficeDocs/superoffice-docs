...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/personAddress/formattedAddress,person/personUdef/SuperOffice:1,contact/contactAssociate/portraitThumbnail
