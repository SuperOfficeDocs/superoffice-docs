...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=selectionId,person/restrictionAddress/addressId,person/restrictionAddress/line1,person/personExtra/x_person_datetime,person/personExtra/y_rental/id
