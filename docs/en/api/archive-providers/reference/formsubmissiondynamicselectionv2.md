...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=associate/isActiveText,person/kanaFirstName,person/consentSourceEmarketing,contact/contactAssociate/personEmail
