...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/correspondingAssociate/credentialType,contact/contactAssociate/title,person/restrictionAddress/line3
