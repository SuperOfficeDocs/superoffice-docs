...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=contact/activeErpLinks,contact/contactAssociate/isLocation,contact/contactUdef/SuperOffice:9
