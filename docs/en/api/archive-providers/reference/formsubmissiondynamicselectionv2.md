...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=contact/postAddress/state,person/restrictionAddress/line3,person/personAssociate/personEmail
