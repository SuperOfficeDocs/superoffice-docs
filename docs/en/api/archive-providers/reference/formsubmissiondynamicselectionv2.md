...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/personAssociate/title,person/correspondingAssociate/assocTooltip,contact/contactNoMail,contact/saintActivityType
