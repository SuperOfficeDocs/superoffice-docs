...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/personExtra/x_person_boolean,person/personAssociate/credentialDisplayValue,person/legalBaseStore
