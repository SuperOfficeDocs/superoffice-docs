...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=contact/contactAssociate/assocTooltip,person/restrictionAddress/line3,person/personAssociate/personEmail
