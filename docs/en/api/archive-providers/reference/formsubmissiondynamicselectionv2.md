...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/birthYear,person/phone/formattedNumber,person/email/emailId,person/restrictionAddress/state,contact/postAddress/addressId
