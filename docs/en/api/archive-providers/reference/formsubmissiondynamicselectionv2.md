...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/useAsMailingAddress,person/restrictionAddress/county,contact/phone/formattedNumber,contact/streetAddress/city
