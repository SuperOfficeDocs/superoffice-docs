...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=associate/title,person/mrMrs,person/supportAssociateFullName,person/personAssociate/contactFullName,person/personAssociate/isActiveText
