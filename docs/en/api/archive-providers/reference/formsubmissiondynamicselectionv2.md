...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/firstName,person/mrMrs,person/email/emailLastSent,person/correspondingAssociate/isActive,contact/NumberOfTickets
