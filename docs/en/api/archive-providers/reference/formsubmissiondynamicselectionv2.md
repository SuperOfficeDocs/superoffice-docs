...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/personMobilePhone/formattedNumber,person/personAssociate/isActiveText,contact/contactAssociate/lastName
