...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/lastName,person/personPager/description,person/personUdef/SuperOffice:7,person/isMailingRecipient,contact/NumberOfSalesInPeriod
