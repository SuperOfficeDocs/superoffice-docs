...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/personCountryId,person/portraitThumbnail,contact/contactAssociate/lastName,contact/saintDirection
