...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=associate/isActiveText,person/personExtra/x_person_integer,person/personExtra/x_person_time,person/personExtra/x_person_shorttext_list
