...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=associate/assocTooltip,person/personAssociate/credentialType,person/correspondingAssociate/contactId,contact/contactAssociate/contactName
