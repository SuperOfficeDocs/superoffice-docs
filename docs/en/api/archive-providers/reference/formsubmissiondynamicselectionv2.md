...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionV2?$select=person/personAssociate/middleName,contact/contactFax/description,contact/streetAddress/line3,contact/contactUdef/SuperOffice:11
