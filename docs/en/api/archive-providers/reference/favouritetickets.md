...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.FavouriteTicketsProvider">SuperOffice.CRM.ArchiveLists.FavouriteTicketsProvider</see> inside NetServer's SODatabase assembly.

## Supported Entities
| Name | Description |
| ---- | ----- |
|"ticket"|[[SR_PL_TICKETS]]|
|"ticketdisplayclosed"|[[SR_TICKETARCHIVE_STATUS_CLOSED]]|
...
```http!
GET /api/v1/archive/FavouriteTickets?$select=sentimentScore,person/email/emailId,person/personExtra/y_rental/id,extra/y_equipment/x_name,sale/associate/contactCategory
