...
```http!
GET /api/v1/archive/FavouriteTickets?$select=categoryFullName,person/phone/formattedNumber,person/personExtra/x_person_date,person/personAssociate/assocName,extra/x_ticket_date
