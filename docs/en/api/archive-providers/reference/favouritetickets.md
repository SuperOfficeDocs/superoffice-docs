...
```http!
GET /api/v1/archive/FavouriteTickets?$select=realTimeSpentQueue,createdBy/isLocation,person/personMobilePhone/description,sale/associate/contactFullName,sale/associate/assocTooltip
