...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ownedBy/ejUserId,person/email/emailLastBounce,person/restrictionAddress/formattedMultiLineAddress,contact/stop,sale/salePublish/publishedBy
