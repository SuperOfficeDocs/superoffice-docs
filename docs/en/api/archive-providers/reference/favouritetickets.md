...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ticketStatusName,createdBy/credentialType,person/correspondingAssociate/ejStatus,sale/currency,sale/amountWeighted
