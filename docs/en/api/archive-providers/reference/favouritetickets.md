...
```http!
GET /api/v1/archive/FavouriteTickets?$select=person/birthMonth,person/personAddress/formattedMultiLineAddress,person/personExtra/x_person_datetime,person/personExtra/y_rental/id,contact/contactAssociate/simultaneousEjUser
