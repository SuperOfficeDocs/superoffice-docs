...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/middleName,createdBy/simultaneousEjUser,createdBy/credentialType,ownedBy/usergroup,person/birthYear
