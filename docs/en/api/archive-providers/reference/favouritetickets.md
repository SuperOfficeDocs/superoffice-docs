...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/usergroupId,contact/postAddress/addressId,sale/who,sale/sale/description,project/NumberOfActivitiesInPeriod
