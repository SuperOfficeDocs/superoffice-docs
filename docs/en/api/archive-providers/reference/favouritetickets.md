...
```http!
GET /api/v1/archive/FavouriteTickets?$select=person/personPager/formattedNumber,person/restrictionAddress/zip,person/personAssociate/ejDisplayName,person/correspondingAssociate/contactDepartment,person/consentSourceStore
