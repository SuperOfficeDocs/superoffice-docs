...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdByWorkflow,person/personUdef/SuperOffice:1,person/personAssociate/contactId,contact/postAddress/addressId,contact/contactAssociate/middleName
