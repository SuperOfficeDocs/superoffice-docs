...
```http!
GET /api/v1/archive/FavouriteTickets?$select=person/birthYear,person/personDirectFax/description,contact/code,contact/LastCompletedSale,sale/associate/isActiveText
