...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ticketStatusName,createdBy/otherGroups,contact/country,contact/contactFax/description,contact/contactUdef/SuperOffice:6
