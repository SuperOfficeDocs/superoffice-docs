...
```http!
GET /api/v1/archive/FavouriteTickets?$select=person/restrictionAddress/line1,contact/postAddress/addressId,contact/restrictionAddress/formattedAddress,contact/saintSaleStatus,sale/associate/portraitThumbnail
