...
```http!
GET /api/v1/archive/FavouriteTickets?$select=person/updatedByWorkflow,person/personInterestIds,contact/email/emailHasBounced,contact/saintSaleStatus,project/projectUdef/SuperOffice:7
