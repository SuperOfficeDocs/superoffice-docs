...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/userName,ownedBy/assocTooltip,person/personAssociate/simultaneousEjUser,contact/contactUdef/SuperOffice:4,extra/x_ticket_project_relation
