...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ticketId,createdBy/credentialType,person/personExtra/x_person_priority_relation,person/personAssociate/contactName,person/correspondingAssociate/fullName
