...
```http!
GET /api/v1/archive/FavouriteTickets?$select=status,timeSpentQueue,person/email/emailProtocol,person/restrictionAddress/formattedAddress,contact/mainContact
