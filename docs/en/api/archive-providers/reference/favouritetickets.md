...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ownedBy/userName,person/personNoMail,person/personAddress/zip,person/personExtra/x_person_hidden_integer,person/personExtra/x_person_time
