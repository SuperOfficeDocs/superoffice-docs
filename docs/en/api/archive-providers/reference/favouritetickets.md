...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdAt,createdBy/lastName,ownedBy/usergroup,person/personHasInterests,person/personAssociate/credentialDisplayValue
