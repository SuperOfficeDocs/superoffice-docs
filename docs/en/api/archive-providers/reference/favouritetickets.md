...
```http!
GET /api/v1/archive/FavouriteTickets?$select=getNoRows,origin,person/personExtra/y_rental/x_start,person/correspondingAssociate/portraitThumbnail,sale/visibleFor
