...
```http!
GET /api/v1/archive/FavouriteTickets?$select=timeSpentInternally,createdBy/personId,person/personExtra/y_rental/y_equipment/x_name,project/projectAssociate/contactId
