...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/ejDisplayName,ownedBy/contactId,ownedBy/contactCategory,person/personUpdatedDate,person/personAssociate/firstName
