...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ownedBy/mrMrs,person/personAssociateId,person/personExtra/y_rental/x_start,contact/streetAddress/formattedAddress,contact/contactUdef/SuperOffice:5
