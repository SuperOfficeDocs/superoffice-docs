...
```http!
GET /api/v1/archive/FavouriteTickets?$select=person/personExtra/y_rental/id,person/correspondingAssociate/isActiveText,contact/url/URLAddress,contact/contactAssociate/contactCategory,sale/stageId
