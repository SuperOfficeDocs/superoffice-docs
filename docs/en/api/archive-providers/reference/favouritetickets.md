...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/userName,person/hasInfoText,person/personRegisteredByFullName,person/restrictionAddress/wgs84latitude,contact/streetAddress/county
