...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ticketStatusName,timeSpent,tags,person/personExtra/x_person_appointment_relation,person/personAssociate/ejUserId
