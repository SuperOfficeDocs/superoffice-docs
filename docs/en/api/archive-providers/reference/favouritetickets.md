...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/assocName,createdBy/isActive,person/withdrawnEmarketingConsent,contact/category,contact/postAddress/zip
