...
```http!
GET /api/v1/archive/FavouriteTickets?$select=person/personExtra/x_person_user_relation,person/personAssociate/usergroupId,contact/updatedByFullName,contact/contactAssociate/lastName,sale/stalledComment
