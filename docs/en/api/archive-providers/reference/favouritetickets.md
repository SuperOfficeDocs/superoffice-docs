...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/locationAddress,ownedBy/contactName,contact/restrictionAddress/line2,contact/saintActivityType,sale/associate/ejUserId
