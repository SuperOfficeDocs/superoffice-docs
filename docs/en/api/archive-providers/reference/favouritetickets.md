...
```http!
GET /api/v1/archive/FavouriteTickets?$select=origin,sentimentConfidence,person/correspondingAssociate/portraitThumbnail,contact/contactExtra/x_contact_request_relation,extra/x_ticket_category_relation
