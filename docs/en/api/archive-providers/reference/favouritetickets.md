...
```http!
GET /api/v1/archive/FavouriteTickets?$select=ticketId,contact/registeredDate,contact/streetAddress/wgs84latitude,contact/streetAddress/formattedAddress,extra/x_ticket_shorttext_list
