...
```http!
GET /api/v1/archive/FavouriteTickets?$select=createdBy/associateDbId,ticketStatus/ticketStatusId,person/fullName,person/personExtra/x_person_user_relation,contact/updatedDate
