...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/associateDbId,appointment/appointmentId,appointment/appointment/titleHtml,document/documentUdef/SuperOffice:5,projectMember/personAddress/wgs84latitude
