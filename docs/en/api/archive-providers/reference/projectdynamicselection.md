...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/isLocation,document/contactId,document/associate/contactCategory,projectMember/personSource
