...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=updatedByFullName,projectAssociate/firstName,projectAssociate/title,projectUdef/SuperOffice:10,NumberOfNotCompletedSales
