...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=name,projectAssociate/isLocation,sale/stageRank,appointment/associate/credentialType,document/saleId
