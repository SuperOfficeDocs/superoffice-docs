...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/associateDbId,sale/originalStage,sale/createdByWorkflow,sale/saleUdef/SuperOffice:2,projectMember/personAddress/line1
