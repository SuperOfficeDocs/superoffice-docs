...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/role,sale/amountWeighted,document/registeredBy,document/associate/contactName,projectMember/personUpdatedByFullName
