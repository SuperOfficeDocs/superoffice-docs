...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=LastCompletedActivity,document/text,document/associateId,projectMember/deletedDate,projectMember/contactExtra/y_organization/x_name
