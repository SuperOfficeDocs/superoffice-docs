...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=registeredDate,sale/saleUdef/SuperOffice:2,appointment/registeredDate,appointment/associate/contactCategory,appointment/associate/ejDisplayName
