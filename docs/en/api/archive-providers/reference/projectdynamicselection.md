...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/contactCategory,saintSaleStatus,sale/stage,appointment/associate/lastName,projectMember/email/emailBounceCount
