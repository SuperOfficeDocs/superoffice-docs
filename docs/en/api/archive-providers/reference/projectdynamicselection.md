...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=sale/salePublish/isPublished,sale/associate/fullName,sale/associate/locationAddress,appointment/endDate,document/subject
