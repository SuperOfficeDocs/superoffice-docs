...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectPublish/publishedFrom,appointment/alarm,appointment/associate/contactId,projectMember/postAddress/state,projectMember/contactUdef/SuperOffice:2
