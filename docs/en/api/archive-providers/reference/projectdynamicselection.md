...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=rowKind,projectMember/textId,projectMember/kanaFirstName,projectMember/personUdef/SuperOffice:7,projectMember/personExtra/x_person_float
