...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/otherGroups,sale/associate/fullName,appointment/text,appointment/recurrenceRuleId,appointment/associate/credentialType
