...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectAssociate/credentialDisplayValue,projectAssociate/isActive,projectMember/personUpdatedDate,projectMember/postAddress/addressId,projectMember/contactAssociate/portraitThumbnail
