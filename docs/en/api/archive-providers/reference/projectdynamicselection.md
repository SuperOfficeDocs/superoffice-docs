...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=sale/stalledComment,appointment/associate/fullName,document/time,document/associate/title,projectMember/useAsMailingAddress
