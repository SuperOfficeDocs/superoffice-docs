...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectEvent/hasSignOn,projectUdef/SuperOffice:2,projectUdef/SuperOffice:3,sale/updatedDate,document/associate/isActive
