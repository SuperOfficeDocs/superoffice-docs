...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectUdef/SuperOffice:6,sale/visibleFor,sale/associate/isActive,sale/associate/otherGroups,document/name
