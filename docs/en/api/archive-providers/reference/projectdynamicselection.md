...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectPublish/publishedTo,projectAssociate/title,appointment/associate/personId,projectMember/correspondingAssociate/otherGroups
