...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=appointment/associate/credentialDisplayValue,projectMember/postAddress/wgs84latitude,projectMember/contactExtra/x_contact_request_relation
