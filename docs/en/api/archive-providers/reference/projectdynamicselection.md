...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=sale/associate/contactFullName,projectMember/contactEmail/emailLastSent,projectMember/contactAssociate/associateDbId,projectMember/contactAssociate/locationAddress,projectMember/contactUdef/SuperOffice:10
