...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectUdef/SuperOffice:8,saintIntention,sale/activeErpLinks,document/attention,projectMember/personAddress/formattedAddress
