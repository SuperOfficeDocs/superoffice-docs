...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=projectUdef/SuperOffice:4,sale/amountWeighted,sale/activeErpLinks,appointment/who,appointment/appointment/internalNotes
