...
```http!
GET /api/v1/archive/ProjectDynamicSelection?$select=registeredDate,appointment/associate/usergroupId,appointment/associate/credentialDisplayValue,document/personId,document/mailMergeDraft
