...
```http!
GET /api/v1/archive/SaleActivity?$select=person/searchPhone/description,contact/contactFax/description,project/projectAssociate/assocName,sale/salePublish/isPublished
