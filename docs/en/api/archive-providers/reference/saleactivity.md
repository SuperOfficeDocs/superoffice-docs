...
```http!
GET /api/v1/archive/SaleActivity?$select=updatedBy,person/personDirectPhone/formattedNumber,person/email/emailHasBounced,contact/restrictionAddress/line2,documentUdef/SuperOffice:7
