...
```http!
GET /api/v1/archive/SaleActivity?$select=person/correspondingAssociate/personEmail,project/name,project/projectUdef/SuperOffice:8,sale/saleUdef/SuperOffice:2,endTime
