...
```http!
GET /api/v1/archive/SaleActivity?$select=contact/countryId,contact/NumberOfNotCompletedSales,sale/registeredDate,sale/associate/personId,sale/associate/isActive
