...
```http!
GET /api/v1/archive/SaleActivity?$select=personId,person/personRegisteredDate,person/personDirectPhone/formattedNumber,person/personMobilePhone/description,contact/contactSource
