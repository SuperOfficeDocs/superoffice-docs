...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.SaleActivityArchiveProvider">SuperOffice.CRM.ArchiveLists.SaleActivityArchiveProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleActivity?$select=person/personAssociate/usergroup,sale/associate/assocTooltip,sale/associate/portraitThumbnail
