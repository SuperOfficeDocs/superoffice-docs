...
```http!
GET /api/v1/archive/SaleActivity?$select=person/rank,person/personAssociate/assocName,contact/contactUdef/SuperOffice:5,contact/contactExtra/x_contact_date,project/projectAssociate/credentialType
