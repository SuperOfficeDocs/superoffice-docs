...
```http!
GET /api/v1/archive/SaleActivity?$select=icon,person/personAddress/zip,person/correspondingAssociate/userName,person/legalBaseEmarketing,contact/streetAddress/formattedAddress
