...
```http!
GET /api/v1/archive/SaleActivity?$select=isReport,person/personExtra/x_person_priority_relation,contact/deletedDate,contact/restrictionAddress/line1,contact/contactExtra/x_contact_longtext
