...
```http!
GET /api/v1/archive/SaleActivity?$select=person/personInfo/textId,person/restrictionAddress/zip,contact/contactAssociate/ejDisplayName,contact/contactExtra/x_contact_integer,project/description
