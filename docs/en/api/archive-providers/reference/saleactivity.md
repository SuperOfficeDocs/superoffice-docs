...
```http!
GET /api/v1/archive/SaleActivity?$select=associateId,documentPublish/publishedBy,person/personAddress/formattedMultiLineAddress,person/personExtra/y_rental/x_contact,person/correspondingAssociate/ejStatus
