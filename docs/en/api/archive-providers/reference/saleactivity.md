...
```http!
GET /api/v1/archive/SaleActivity?$select=person/fullName,person/personDirectFax/formattedNumber,person/personAddress/wgs84longitude,person/personAssociate/userName,person/isMailingRecipient
