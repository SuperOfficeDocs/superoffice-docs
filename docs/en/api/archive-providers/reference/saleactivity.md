...
```http!
GET /api/v1/archive/SaleActivity?$select=attention,person/personUrl/URLAddress,project/projectPublish/publishedFrom,project/projectEvent/eventDate,associate/assocName
