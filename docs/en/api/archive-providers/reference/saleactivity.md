...
```http!
GET /api/v1/archive/SaleActivity?$select=person/personInfo/infoText,contact/activeErpLinks,contact/streetAddress/line2,sale/stageRank,sale/saleUdef/SuperOffice:7
