...
```http!
GET /api/v1/archive/SaleActivity?$select=attention,person/personAssociate/simultaneousEjUser,person/correspondingAssociate/otherGroups,contact/contactExtra/x_contact_integer,project/completed
