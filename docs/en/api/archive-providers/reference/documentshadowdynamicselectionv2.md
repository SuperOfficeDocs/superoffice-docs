...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=person/personExtra/x_person_datetime,person/personAssociate/ejStatus,contact/updatedByFullName,contact/streetAddress/zip,associate/credentialType
