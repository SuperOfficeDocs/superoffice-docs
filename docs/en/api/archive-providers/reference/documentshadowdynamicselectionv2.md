...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=person/personCountryId,person/restrictionAddress/wgs84latitude,person/personAssociate/otherGroups,contact/updatedDate,document/description
