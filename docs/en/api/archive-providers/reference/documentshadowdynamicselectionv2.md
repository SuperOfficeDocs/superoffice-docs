...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=suggestedDocumentId,person/personExtra/y_car/id,person/personAssociate/ejStatus,contact/phone/formattedNumber,associate/usergroup
