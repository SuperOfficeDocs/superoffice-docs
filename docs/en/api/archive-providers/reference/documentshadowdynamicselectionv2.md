...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=associateId,person/personMobilePhone/formattedNumber,person/correspondingAssociate/assocTooltip,contact/streetAddress/wgs84latitude,contact/contactAssociate/credentialType
