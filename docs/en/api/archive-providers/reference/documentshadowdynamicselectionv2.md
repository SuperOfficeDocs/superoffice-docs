...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=person/personBusiness,person/personDeletedDate,person/hasCompany,contact/contactUdef/SuperOffice:7,contact/LastActivity
