...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=person/personDirectFax/formattedNumber,person/withdrawnStoreConsent,contact/contactUdef/SuperOffice:13,associate/contactName
