...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=icon,person/personExtra/x_person_longtext,contact/contactId,contact/NumberOfNotCompletedTickets,associate/otherGroups
