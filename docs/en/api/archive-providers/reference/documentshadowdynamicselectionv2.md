...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=text,person/position,person/restrictionAddress/formattedAddress,contact/contactFax/formattedNumber,contact/contactExtra/x_contact_short_dropdown
