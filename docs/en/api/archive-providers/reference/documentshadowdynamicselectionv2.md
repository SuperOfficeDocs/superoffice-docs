...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=person/correspondingAssociate/fullName,contact/postAddress/line1,project/registeredByFullName,sale/stalledComment,sale/saleTypeCategory
