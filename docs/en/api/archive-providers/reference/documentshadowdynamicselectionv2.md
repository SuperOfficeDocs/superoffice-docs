...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=person/email/emailLastSent,person/personAddress/line1,person/correspondingAssociate/ejUserId,contact/streetAddress/line1,contact/contactExtra/x_contact_boolean
