...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=saleId,contact/LastTicket,project/projectAssociate/title,project/projectUdef/SuperOffice:10,associate/personId
