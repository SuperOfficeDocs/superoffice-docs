...
```http!
GET /api/v1/archive/DocumentShadowDynamicSelectionV2?$select=updatedBy,person/email/emailLastBounce,person/restrictionAddress/formattedAddress,person/personAssociate/ejDisplayName,contact/postAddress/wgs84latitude
