...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=ownedBy/firstName,ownedBy/contactFullName,contact/registeredByFullName,project/registeredBy,project/NumberOfNotCompletedActivities
