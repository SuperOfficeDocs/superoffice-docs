...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=createdBy/contactFullName,contact/deletedDate,sale/activeErpLinks,project/projectAssociate/lastName,project/LastDoBySale
