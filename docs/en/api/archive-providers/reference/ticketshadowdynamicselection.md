...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=createdBy/contactFullName,ownedBy/assocName,ownedBy/assocType,person/personExtra/y_rental/y_equipment/x_name,contact/searchPhone/formattedNumber
