...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=deadline,person/contactId,person/personActiveErpLinks,person/personAssociate/usergroup,contact/restrictionAddress/line2
