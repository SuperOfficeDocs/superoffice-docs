...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/personAddress/line1,person/personAssociate/personEmail,contact/number,contact/contactAssociate/contactCategory,sale/associate/assocTooltip
