...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=priorityName,person/personAssociateId,person/email/emailHasBounced,person/restrictionAddress/city,person/personAssociate/simultaneousEjUser
