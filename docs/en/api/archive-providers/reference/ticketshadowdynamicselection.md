...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/correspondingAssociate/otherGroups,contact/contactAssociate/simultaneousEjUser,contact/contactExtra/y_organization/x_name,project/projectAssociate/assocTooltip,project/projectAssociate/personEmail
