...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=createdBy/lastName,person/personAssociate/ejDisplayName,sale/associate/isActive,project/projectEvent/eventDate
