...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=ticketStatusName,person/birthMonth,person/ticketPriority,person/correspondingAssociate/isActiveText,person/subscription
