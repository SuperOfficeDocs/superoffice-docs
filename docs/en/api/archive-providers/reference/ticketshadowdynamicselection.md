...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=createdBy/contactDepartment,person/personUpdatedDate,person/personExtra/y_rental/y_equipment/x_name,person/personAssociate/ejDisplayName,contact/registeredByFullName
