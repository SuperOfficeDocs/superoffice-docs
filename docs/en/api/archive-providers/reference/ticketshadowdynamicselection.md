...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=content,person/leadStatus,person/restrictionAddress/formattedMultiLineAddress,person/personExtra/x_person_user_relation,person/correspondingAssociate/title
