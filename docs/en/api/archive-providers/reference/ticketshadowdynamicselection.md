...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=createdBy/assocName,person/title,person/personDirectPhone/formattedNumber,person/personAssociate/firstName,person/personAssociate/contactFullName
