...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=readByCustomer,ownedBy/ejStatus,person/firstName,person/correspondingAssociate/contactCategory,contact/code
