...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/correspondingAssociate/middleName,contact/registeredDate,contact/postAddress/wgs84latitude,extra/x_ticket_longtext,sale/registeredDate
