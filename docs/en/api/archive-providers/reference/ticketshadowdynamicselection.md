...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=categoryId,ticketTypeName,person/personDirectPhone/description,person/personAddress/wgs84latitude,person/correspondingAssociate/locationAddress
