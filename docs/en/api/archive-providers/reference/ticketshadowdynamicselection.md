...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=contact/contactAssociate/personEmail,extra/x_ticket_integer,sale/associate/usergroup,project/icon
