...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=ownedBy/firstName,ownedBy/title,ownedBy/assocTooltip,contact/postAddress/wgs84longitude,project/projectEvent/hasSignOn
