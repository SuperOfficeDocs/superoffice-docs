...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/restrictionAddress/line1,contact/NumberOfNotCompletedActivitiesInPeriod,contact/saintAmountClass,sale/associate/isLocation
