...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=person/personSource,person/restrictionAddress/formattedAddress,contact/countryId,contact/registeredBy,contact/email/emailProtocol
