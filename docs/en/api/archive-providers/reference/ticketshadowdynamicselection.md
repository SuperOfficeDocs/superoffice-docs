...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=status,createdBy/assocName,person/kanaLastName,person/personAssociate/contactName,contact/business
