...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=timeSpentInternally,contact/registeredByFullName,contact/contactExtra/x_contact_boolean,sale/salePublish/isPublished
