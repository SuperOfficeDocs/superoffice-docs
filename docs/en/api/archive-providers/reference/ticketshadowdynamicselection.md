...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=connectId,person/personUdef/SuperOffice:10,contact/mainContact,contact/postAddress/zip,contact/contactAssociate/contactId
