...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=closedAt,createdBy/middleName,person/useAsMailingAddress,contact/orgnr,contact/streetAddress/city
