...
```http!
GET /api/v1/archive/TicketShadowDynamicSelection?$select=title,ownedBy/contactId,person/personAssociate/ejDisplayName,contact/restrictionAddress/city,contact/contactAssociate/isActive
