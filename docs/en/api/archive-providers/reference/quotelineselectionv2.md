...
```http!
GET /api/v1/archive/QuoteLineSelectionV2?$select=name,alternative/version/quote/registeredDate,alternative/version/quote/sale/person/birthDay,alternative/version/quote/sale/person/personAssociate/ejDisplayName,alternative/version/quote/sale/contact/streetAddress/formattedAddress
