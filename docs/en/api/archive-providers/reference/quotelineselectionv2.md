...
```http!
GET /api/v1/archive/QuoteLineSelectionV2?$select=alternative/version/state,alternative/version/quote/sale/type,alternative/version/quote/sale/contact/restrictionAddress/state
