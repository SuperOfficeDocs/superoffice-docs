...
```http!
GET /api/v1/archive/PersonRelation?$select=source/personPager/formattedNumber,source/category,target/contactUdef/SuperOffice:5,target/SaintStatus2,source/email/emailProtocol
