...
```http!
GET /api/v1/archive/PersonRelation?$select=source/personAssociateFullName,source/stop,target/streetAddress/formattedAddress,target/SaintStatus1,source/url/URLDescription
