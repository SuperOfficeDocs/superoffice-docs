...
```http!
GET /api/v1/archive/PersonRelation?$select=source/personPrivate/formattedNumber,target/postAddress/city,target/postAddress/wgs84latitude,target/restrictionAddress/county,target/saintSaleStatus
