...
```http!
GET /api/v1/archive/PersonRelation?$select=source/personUpdatedByFullName,source/personRegisteredBy,source/personDirectPhone/formattedNumber,target/searchPhone/formattedNumber,target/saintDirection
