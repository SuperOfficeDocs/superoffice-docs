...
```http!
GET /api/v1/archive/PersonRelation?$select=source/restrictionContactId,target/contactUdef/SuperOffice:12,target/contactExtra/x_contact_boolean,target/LastSale,source/contactExtra/x_contact_integer
