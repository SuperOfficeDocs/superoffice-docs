...
```http!
GET /api/v1/archive/PersonRelation?$select=target/contactAssociate/associateDbId,target/contactUdef/SuperOffice:5,target/portraitThumbnail,source/restrictionAddress/city
