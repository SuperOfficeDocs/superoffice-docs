...
```http!
GET /api/v1/archive/PersonRelation?$select=source/restrictionPersonId,source/personDirectPhone/description,source/number,source/updatedBy,target/contactDeleted
