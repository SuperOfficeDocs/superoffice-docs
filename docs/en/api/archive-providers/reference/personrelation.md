...
```http!
GET /api/v1/archive/PersonRelation?$select=source/personDirectFax/formattedNumber,target/code,target/deletedDate,target/postAddress/formattedAddress,target/NumberOfSales
