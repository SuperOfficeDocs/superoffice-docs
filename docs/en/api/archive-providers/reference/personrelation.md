...
```http!
GET /api/v1/archive/PersonRelation?$select=source/birthYear,target/streetAddress/line3,target/contactExtra/x_contact_boolean,source/contactUdef/SuperOffice:7,source/contactExtra/x_contact_timespan
