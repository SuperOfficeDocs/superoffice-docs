...
```http!
GET /api/v1/archive/PersonRelation?$select=source/personCategoryRank,source/restrictionPersonId,target/contactExtra/x_contact_shorttext,target/NumberOfTicketsInPeriod
