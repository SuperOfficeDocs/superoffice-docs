...
```http!
GET /api/v1/archive/PersonRelation?$select=source/birthYear,source/updatedByFullName,target/contactAssociate/locationAddress,source/email/emailHasBounced,source/postAddress/line3
