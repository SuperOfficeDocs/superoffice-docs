...
```http!
GET /api/v1/archive/PersonRelation?$select=source/personId,source/personCountryId,source/number,source/streetAddress/line2,source/restrictionAddress/state
