...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=contact/streetAddress/county,contact/restrictionAddress/addressId,extra/x_ticket_longtext,extra/x_ticket_category_relation
