...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=suggestedCategory,ownedBy/personId,contact/email/emailDescription,sale/source,sale/associate/simultaneousEjUser
