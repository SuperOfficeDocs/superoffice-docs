...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdBy/ejDisplayName,person/hasInterests,contact/orgnr,contact/phone/formattedNumber,contact/streetAddress/zip
