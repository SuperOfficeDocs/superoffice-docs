...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=person/personExtra/x_person_request_relation,contact/restrictionAddress/state,project/projectUrl/URLDescription,project/projectAssociate/assocType
