...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=person/personExtra/x_person_appointment_relation,contact/nameDepartment,contact/mainContact,sale/earningPercent,project/status
