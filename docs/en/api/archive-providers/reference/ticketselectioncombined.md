...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=ticketTypeName,status,closedAt,person/restrictionAddress/wgs84latitude,contact/searchPhone/description
