...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=deadline,person/personRegisteredByFullName,person/personAddress/wgs84longitude,person/personExtra/x_person_appointment_relation,contact/country
