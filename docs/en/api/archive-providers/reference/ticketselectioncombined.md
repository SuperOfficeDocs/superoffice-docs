...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=categoryFullName,timeSpentInternally,createdBy/userName,contact/postAddress/formattedAddress,contact/contactAssociate/ejUserId
