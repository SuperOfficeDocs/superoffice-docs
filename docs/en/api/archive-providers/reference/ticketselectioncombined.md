...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdBy/fullName,person/personExtra/x_person_integer,contact/contactAssociate/credentialType,sale/saleNumber,sale/associate/ejStatus
