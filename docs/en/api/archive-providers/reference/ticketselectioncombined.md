...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=ownedBy/usergroup,person/portraitThumbnail,contact/postAddress/county,contact/NumberOfActivities,sale/associate/title
