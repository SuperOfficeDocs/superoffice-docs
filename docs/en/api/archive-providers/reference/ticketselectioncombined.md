...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=connectId,realTimeSpentExternally,createdBy/contactCategory,createdBy/isActive,person/personAssociate/credentialDisplayValue
