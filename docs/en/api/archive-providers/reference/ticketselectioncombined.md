...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdBy/personEmail,person/whenUpdatedByWorkflow,person/restrictionAddress/formattedMultiLineAddress,person/correspondingAssociate/ejUserId,extra/x_ticket_short_text
