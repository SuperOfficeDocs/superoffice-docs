...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=contact/email/emailDescription,contact/postAddress/addressId,sale/associate/userName,project/nextMilestone,project/projectAssociate/personEmail
