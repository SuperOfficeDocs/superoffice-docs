...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=ticketStatusName,createdAt,person/personExtra/x_person_contact_relation,person/personExtra/y_rental/id,person/personExtra/y_rental/x_start
