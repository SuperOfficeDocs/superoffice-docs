...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=readByCustomer,ownedBy/simultaneousEjUser,person/birthdate,person/personAddress/addressId,person/personAddress/zip
