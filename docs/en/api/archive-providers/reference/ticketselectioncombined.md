...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdBy/contactId,createdBy/credentialDisplayValue,createdBy/isActiveText,ownedBy/contactCategory,person/email/emailLastSent
