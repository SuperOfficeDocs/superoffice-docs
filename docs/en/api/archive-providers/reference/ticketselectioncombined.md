...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdAt,person/personAssociateFullName,person/restrictionAddress/state,person/personExtra/x_person_priority_relation,contact/contactPhone/formattedNumber
