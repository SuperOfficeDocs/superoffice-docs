...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=readByOwner,person/personExtra/x_person_hidden_integer,contact/updatedByFullName,sale/soldReason,sale/associate/middleName
