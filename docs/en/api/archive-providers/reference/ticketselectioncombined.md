...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdBy/simultaneousEjUser,person/personAddress/wgs84longitude,contact/nameDepartment,contact/SaintStatus2,sale/stage
