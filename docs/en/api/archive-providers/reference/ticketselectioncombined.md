...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=ownedBy/userName,person/rank,person/personExtra/x_person_category_relation,person/personAssociate/mrMrs,contact/streetAddress/wgs84longitude
