...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=closedAt,createdBy/personId,ownedBy/otherGroups,person/supportAssociateFullName,person/personInfo/textId
