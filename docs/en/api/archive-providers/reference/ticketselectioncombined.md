...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=createdBy/contactId,person/supportAssociate,person/correspondingAssociate/associateDbId,contact/code,contact/contactPhone/formattedNumber
