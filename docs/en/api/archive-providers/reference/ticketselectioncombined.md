...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=sentimentScore,person/birthDay,person/hasEmarketingConsent,contact/mainContact,contact/contactAssociate/isActiveText
