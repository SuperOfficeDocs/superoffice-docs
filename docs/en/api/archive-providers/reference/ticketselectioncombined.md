...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=timeToReply,person/personAssociate/title,person/correspondingAssociate/otherGroups,contact/country,contact/registeredByFullName
