...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=person/correspondingAssociate/role,contact/NumberOfNotCompletedActivitiesInPeriod,sale/currencyId,sale/credited,sale/hasGuide
