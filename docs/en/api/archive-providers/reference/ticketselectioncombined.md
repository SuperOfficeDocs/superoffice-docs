...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=status,realTimeSpentInternally,person/personAddress/formattedMultiLineAddress,person/personUdef/SuperOffice:4,person/correspondingAssociate/contactName
