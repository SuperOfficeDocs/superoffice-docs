...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=saleId,person/title,person/restrictionAddress/line1,person/personAssociate/usergroup,person/correspondingAssociate/mrMrs
