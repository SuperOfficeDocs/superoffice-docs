...
```http!
GET /api/v1/archive/TicketSelectionCombined?$select=ownedBy/contactFullName,person/restrictionAddress/line3,person/personAssociate/ejDisplayName,contact/country,contact/contactFax/description
