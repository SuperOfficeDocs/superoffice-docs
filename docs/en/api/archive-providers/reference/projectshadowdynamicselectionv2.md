...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=getAllRows,sale/sale/textId,appointment/associate/ejUserId,projectMember/personCountryId,projectMember/personExtra/x_person_contact_relation
