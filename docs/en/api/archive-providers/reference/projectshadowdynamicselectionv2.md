...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectAssociate/isActive,sale/time,sale/saleNumber,appointment/associate/middleName,projectMember/personNumber
