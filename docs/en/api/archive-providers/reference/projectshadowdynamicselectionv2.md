...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectEvent/hasSignOn,document/associate/assocTooltip,document/associate/otherGroups,projectMember/retired,projectMember/personAssociate/contactId
