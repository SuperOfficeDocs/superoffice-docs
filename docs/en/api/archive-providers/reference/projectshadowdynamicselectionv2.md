...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectEvent/isExternalEvent,sale/registeredByFullName,projectMember/portraitThumbnail,projectMember/isMailingRecipient
