...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectUdef/SuperOffice:5,NumberOfNotCompletedSalesInPeriod,sale/updatedDate,document/associate/assocTooltip,projectMember/personInfo/textId
