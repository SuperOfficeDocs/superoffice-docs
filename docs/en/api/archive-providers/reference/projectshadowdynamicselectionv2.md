...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=type,projectAssociate/contactId,sale/saleNumber,appointment/location,appointment/associate/portraitThumbnail
