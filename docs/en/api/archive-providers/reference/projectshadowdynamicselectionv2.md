...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=icon,updatedDate,sale/registeredBy,sale/associate/assocTooltip,projectMember/personAssociate/middleName
