...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=sale/projectId,sale/registeredDate,sale/amountInBaseCurrency,document/associate/mrMrs,projectMember/personUdef/SuperOffice:5
