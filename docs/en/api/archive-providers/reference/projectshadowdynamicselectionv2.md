...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=appointment/associate/locationAddress,document/documentPublish/isPublished,projectMember/personExtra/x_person_priority_relation,projectMember/legalBaseStore,projectMember/url/URLAddress
