...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectUdef/SuperOffice:3,sale/amountInBaseCurrency,appointment/associate/portraitThumbnail,document/documentUdef/SuperOffice:8,projectMember/correspondingAssociate/ejDisplayName
