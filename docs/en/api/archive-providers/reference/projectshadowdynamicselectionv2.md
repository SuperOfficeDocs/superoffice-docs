...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=sale/associateId,sale/associate/otherGroups,projectMember/personAddress/addressId,projectMember/restrictionAddress/addressId
