...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=text,projectAssociate/otherGroups,appointment/associate/otherGroups,document/documentUdef/SuperOffice:4,projectMember/deletedDate
