...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectAssociate/isActive,saintSaleStatus,appointment/completed,projectMember/personDirectFax/description,projectMember/personAddress/line3
