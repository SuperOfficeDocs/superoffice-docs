...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionV2?$select=projectAssociate/personId,NumberOfActivitiesInPeriod,document/isReport,projectMember/personCategory,projectMember/personUdef/SuperOffice:6
