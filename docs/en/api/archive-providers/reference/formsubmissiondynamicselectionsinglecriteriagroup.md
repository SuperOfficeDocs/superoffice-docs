...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=time,associate/contactId,person/isStakeholder,person/updatedByWorkflow,person/personAssociate/assocName
