...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=personId,person/personCountry,person/rank,person/personUdef/SuperOffice:1,contact/contactSource
