...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personNoMail,person/restrictionAddress/wgs84longitude,contact/nameDepartment
