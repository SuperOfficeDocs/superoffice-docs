...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personAddress/city,person/personUdef/SuperOffice:3,person/personAssociate/role,contact/saintSaleStatus
