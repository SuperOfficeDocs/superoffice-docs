...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=text,person/supportLanguage,person/personBusiness,person/updatedByWorkflow,person/personAssociate/personId
