...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personAssociateFullName,contact/streetAddress/city,contact/contactAssociate/contactName
