...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/lastName,person/personMobilePhone/description,person/personAssociate/locationAddress,person/correspondingAssociate/ejDisplayName,contact/LastCompletedActivity
