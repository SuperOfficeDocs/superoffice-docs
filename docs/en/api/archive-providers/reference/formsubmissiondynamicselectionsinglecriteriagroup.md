...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/kanaFirstName,person/ticketPriority,person/personExtra/x_person_shorttext,person/personAssociate/credentialType,contact/SaintStatus2
