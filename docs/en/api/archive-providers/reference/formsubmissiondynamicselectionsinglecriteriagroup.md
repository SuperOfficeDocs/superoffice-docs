...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=associate/title,person/personId,person/personExtra/x_person_shorttext_list,contact/email/emailLastSent
