...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/middleName,person/restrictionAddress/county,contact/contactAssociate/assocTooltip,contact/contactUdef/SuperOffice:13
