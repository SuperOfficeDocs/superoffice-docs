...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personSource,person/searchPhone/formattedNumber,person/personAssociate/contactDepartment,person/personAssociate/usergroupId,contact/activeErpLinks
