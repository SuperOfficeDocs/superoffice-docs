...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/email/emailId,contact/contactAssociate/assocType,contact/NumberOfNotCompletedSales
