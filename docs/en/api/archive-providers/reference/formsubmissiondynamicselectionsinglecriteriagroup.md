...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personRegisteredByFullName,person/restrictionAddress/county,person/personAssociate/personEmail
