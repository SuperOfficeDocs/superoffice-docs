...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personPrivate/description,person/restrictionAddress/state,person/personAssociate/locationAddress
