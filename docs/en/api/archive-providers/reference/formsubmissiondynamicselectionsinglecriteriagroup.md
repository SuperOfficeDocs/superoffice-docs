...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=getNoRows,person/title,person/personUdef/SuperOffice:1,person/correspondingAssociate/isActiveText,contact/postAddress/zip
