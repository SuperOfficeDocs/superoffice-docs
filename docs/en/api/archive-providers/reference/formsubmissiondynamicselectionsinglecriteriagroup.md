...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=associate/title,person/personAssociate/fullName,contact/contactAssociate/locationAddress
