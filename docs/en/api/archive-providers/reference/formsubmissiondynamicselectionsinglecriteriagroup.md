...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=formSubmissionStatus,person/restrictionAddress/county,person/personAssociate/personEmail
