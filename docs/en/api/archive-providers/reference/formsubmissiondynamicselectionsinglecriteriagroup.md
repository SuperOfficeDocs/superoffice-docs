...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personAddress/zip,contact/LastDoByActivity,person/restrictionAddress/city
