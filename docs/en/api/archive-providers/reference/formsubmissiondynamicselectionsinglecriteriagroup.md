...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=associate/credentialDisplayValue,associate/isLocation,person/personCountryId,contact/postAddress/county,contact/contactAssociate/assocType
