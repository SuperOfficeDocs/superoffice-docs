...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=associate/isLocation,contact/restrictionAddress/county,contact/contactUdef/SuperOffice:3
