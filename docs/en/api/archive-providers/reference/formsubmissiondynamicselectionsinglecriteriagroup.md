...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=associate/associateDbId,person/personPrivate/formattedNumber,person/personAddress/formattedMultiLineAddress,person/personAssociate/assocTooltip,contact/contactExtra/x_contact_date
