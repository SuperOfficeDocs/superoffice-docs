...
```http!
GET /api/v1/archive/FormSubmissionDynamicSelectionSingleCriteriaGroup?$select=person/personCategory,contact/updatedByFullName,contact/contactAssociate/fullName
