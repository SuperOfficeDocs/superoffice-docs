...
```http!
GET /api/v1/archive/SaintProject?$select=sale/earningPercent,appointment/who,projectMember/birthDay,projectMember/personAssociate/middleName,projectMember/correspondingAssociate/contactCategory
