...
```http!
GET /api/v1/archive/SaintProject?$select=projectEvent/eventDate,saintDirection,saintTicketCategory,appointment/appointmentPublish/isPublished,appointment/associate/credentialDisplayValue
