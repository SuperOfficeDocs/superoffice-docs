...
```http!
GET /api/v1/archive/SaintProject?$select=updatedBy,projectMember/useAsMailingAddress,projectMember/email/emailHasBounced,projectMember/correspondingAssociate/assocType,projectMember/streetAddress/zip
