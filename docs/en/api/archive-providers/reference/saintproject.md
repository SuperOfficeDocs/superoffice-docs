...
```http!
GET /api/v1/archive/SaintProject?$select=projectAssociate/contactName,sale/associate/middleName,appointment/booking,appointment/invitedPersonId,appointment/recordTypeText
