...
```http!
GET /api/v1/archive/SaintProject?$select=associateId,projectPublish/publishedFrom,sale/saleTypeCategory,sale/saleUdef/SuperOffice:5,appointment/visibleFor
