...
```http!
GET /api/v1/archive/SaintProject?$select=NumberOfActivities,sale/visibleFor,appointment/associate/otherGroups,projectMember/middleName,projectMember/personAssociate/isLocation
