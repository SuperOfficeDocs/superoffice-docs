...
```http!
GET /api/v1/archive/SaintProject?$select=sale/stakeholdersEnabled,appointment/who,appointment/appointmentUdef/SuperOffice:1,projectMember/personExtra/x_person_time,projectMember/correspondingAssociate/simultaneousEjUser
