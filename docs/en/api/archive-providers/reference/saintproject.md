...
```http!
GET /api/v1/archive/SaintProject?$select=getNoRows,NumberOfNotCompletedSales,sale/associate/personId,document/associate/otherGroups,projectMember/companyCategoryRank
