...
```http!
GET /api/v1/archive/SaintProject?$select=saintActivityType,sale/earningPercent,appointment/personId,projectMember/correspondingAssociate/locationAddress,projectMember/withdrawnEmarketingConsent
