...
```http!
GET /api/v1/archive/SaintProject?$select=projectAssociate/ejUserId,appointment/associate/credentialDisplayValue,document/text,projectMember/personDeletedDate,projectMember/personAddress/formattedMultiLineAddress
