...
```http!
GET /api/v1/archive/SaintProject?$select=projectUrl/URLAddress,projectAssociate/associateDbId,sale/nextDueDate,appointment/updatedByFullName,appointment/location
