...
```http!
GET /api/v1/archive/SaintProject?$select=sale/saleTypeCategory,projectMember/contactEmail/emailDescription,projectMember/contactExtra/x_contact_boolean,projectMember/contactExtra/x_contact_contact
