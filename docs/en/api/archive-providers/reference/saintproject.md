...
```http!
GET /api/v1/archive/SaintProject?$select=projectAssociate/isActive,appointment/endDate,document/isReport,document/associate/contactId,projectMember/personAddress/wgs84longitude
