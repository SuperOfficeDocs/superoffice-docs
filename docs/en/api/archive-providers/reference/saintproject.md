...
```http!
GET /api/v1/archive/SaintProject?$select=projectAssociate/contactCategory,sale/reopenDate,appointment/associate/mrMrs,document/associate/assocTooltip,projectMember/email/emailLastBounce
