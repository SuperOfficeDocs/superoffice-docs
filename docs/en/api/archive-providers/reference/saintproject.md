...
```http!
GET /api/v1/archive/SaintProject?$select=type,sale/saleStatus,appointment/associate/ejDisplayName,projectMember/correspondingAssociate/fullName,projectMember/legalBaseEmarketing
