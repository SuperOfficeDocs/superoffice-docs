...
```http!
GET /api/v1/archive/SaintProject?$select=appointment/booking,appointment/associate/ejUserId,document/userGroup,document/associate/credentialType,projectMember/personUdef/SuperOffice:3
