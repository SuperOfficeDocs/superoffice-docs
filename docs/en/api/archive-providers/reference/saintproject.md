...
```http!
GET /api/v1/archive/SaintProject?$select=projectAssociate/credentialType,projectUdef/SuperOffice:2,saintSaleStatus,document/associate/assocType,projectMember/textId
