...
```http!
GET /api/v1/archive/SaintProject?$select=projectAssociate/assocTooltip,LastDoBySale,sale/saleUdef/SuperOffice:1,projectMember/kanaLastName,projectMember/ticketPriority
