...
```http!
GET /api/v1/archive/SaintProject?$select=document/associate/credentialType,projectMember/email/emailLastBounce,projectMember/personAssociate/contactName,projectMember/postAddress/state
