...
```http!
GET /api/v1/archive/SaintProject?$select=document/keywords,projectMember/personHasInterests,projectMember/hasCompany,projectMember/personExtra/x_person_contact_relation,projectMember/stop
