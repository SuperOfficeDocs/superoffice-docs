...
```http!
GET /api/v1/archive/QuoteLineDynamicSelection?$select=alternative/version/quote/sale/contact/contactExtra/x_contact_datetime,alternative/version/quote/sale/project/saintTicketStatus,alternative/version/quote/sale/person/personAddress/wgs84longitude
