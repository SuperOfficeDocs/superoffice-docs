...
```http!
GET /api/v1/archive/QuoteLineDynamicSelection?$select=updatedDate,alternative/totalPriceIncVAT,alternative/version/quote/poNumber,alternative/version/quote/sale/contact/NumberOfNotCompletedActivities,alternative/version/quote/sale/project/projectAssociate/usergroup
