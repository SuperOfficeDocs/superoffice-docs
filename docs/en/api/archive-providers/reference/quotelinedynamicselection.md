...
```http!
GET /api/v1/archive/QuoteLineDynamicSelection?$select=alternative/vatInfo,alternative/version/deliveryType,alternative/version/quote/sale/person/personAddress/state
