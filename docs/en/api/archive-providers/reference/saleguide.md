...
```http!
GET /api/v1/archive/SaleGuide?$select=appointmentInstance/contact/email/emailAddress,appointmentInstance/person/personRegisteredByFullName,appointmentInstance/sale/amountInBaseCurrency,appointmentInstance/sale/associate/lastName,appointmentInstance/associate/contactDepartment
