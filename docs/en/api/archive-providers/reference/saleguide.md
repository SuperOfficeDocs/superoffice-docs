...
```http!
GET /api/v1/archive/SaleGuide?$select=appointmentInstance/personId,appointmentInstance/who,appointmentInstance/createdByWorkflow,appointmentInstance/project/NumberOfNotCompletedActivities,documentInstance/person/personExtra/x_person_contact_relation
