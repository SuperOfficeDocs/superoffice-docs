...
```http!
GET /api/v1/archive/SaleGuide?$select=appointmentInstance/time,appointmentInstance/updatedBy,appointmentInstance/contact/name,appointmentInstance/person/fullName,appointmentInstance/sale/saleStatus
