...
```http!
GET /api/v1/archive/emailcontactaddress?$select=contactSupportPerson/fullName,contactSupportPerson/birthMonth,contactSupportPerson/portraitThumbnail,NumberOfNotCompletedActivitiesInPeriod
