...
```http!
GET /api/v1/archive/emailcontactaddress?$select=contactSupportPerson/personExtra/x_person_contact_relation,NumberOfNotCompletedActivitiesInPeriod,contactAssociate/personId
