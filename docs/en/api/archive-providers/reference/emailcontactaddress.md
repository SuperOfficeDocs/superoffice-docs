...
```http!
GET /api/v1/archive/emailcontactaddress?$select=contactSource,streetAddress/line1,restrictionAddress/formattedMultiLineAddress,contactSupportAssociate/title,contactSupportAssociate/assocType
