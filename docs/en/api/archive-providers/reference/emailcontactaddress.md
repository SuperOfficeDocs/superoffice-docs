...
```http!
GET /api/v1/archive/emailcontactaddress?$select=email/emailLastBounce,contactAssociate/usergroup,contactAssociate/credentialDisplayValue,contactSupportAssociate/fullName,contactExtra/x_contact_date
