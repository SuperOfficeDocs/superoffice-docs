...
```http!
GET /api/v1/archive/emailcontactaddress?$select=restrictionAddress/zip,contactAssociate/associateDbId,contactAssociate/assocTooltip,contactSupportPerson/personRegisteredBy
