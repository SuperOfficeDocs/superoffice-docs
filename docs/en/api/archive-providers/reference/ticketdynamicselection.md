...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=createdByWorkflow,ownedBy/middleName,contact/searchPhone/formattedNumber,sale/associate/portraitThumbnail
