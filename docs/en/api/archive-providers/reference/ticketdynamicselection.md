...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/hasInterests,person/searchPhone/description,person/personUrl/URLDescription,contact/postAddress/addressId,extra/x_ticket_timespan
