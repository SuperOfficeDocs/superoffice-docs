...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=createdBy/ejDisplayName,ticketPriority/name,person/personNumber,contact/restrictionAddress/zip,contact/contactExtra/x_contact_float
