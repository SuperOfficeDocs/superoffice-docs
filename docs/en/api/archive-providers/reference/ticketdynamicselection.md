...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/middleName,contact/contactAssociate/associateDbId,extra/y_car/id,sale/associate/contactDepartment
