...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/kanaLastName,contact/updatedByFullName,contact/LastDoByActivity,project/projectId,project/LastDoBySale
