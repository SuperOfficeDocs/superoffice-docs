...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=timeToClose,ownedBy/usergroupId,person/personAssociate/simultaneousEjUser,contact/restrictionAddress/state,project/projectPublish/publishedFrom
