...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=slevel,person/personAssociate/role,sale/associate/credentialType,project/projectAssociate/assocTooltip,project/projectUdef/SuperOffice:9
