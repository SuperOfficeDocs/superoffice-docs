...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=realTimeToClose,person/personPager/formattedNumber,contact/postAddress/state,contact/contactAssociate/contactDepartment,sale/sale/description
