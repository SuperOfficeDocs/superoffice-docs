...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=ownedBy/personEmail,person/title,person/personUpdatedByFullName,person/correspondingAssociate/simultaneousEjUser,extra/y_equipment/x_name
