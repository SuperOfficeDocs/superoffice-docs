...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=createdBy/fullName,person/createdByForm,person/searchPhone/formattedNumber,person/isMailingRecipient,contact/contactExtra/x_contact_hidden_integer
