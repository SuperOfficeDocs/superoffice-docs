...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=readByOwner,createdBy/contactId,person/email/emailId,person/personAddress/wgs84latitude,person/restrictionAddress/county
