...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=contact/searchPhone/description,contact/saintSaleStatus,sale/lossReason,sale/reopenDate,project/imageThumbnail
