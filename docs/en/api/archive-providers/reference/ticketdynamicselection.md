...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/birthMonth,person/correspondingAssociate/associateDbId,contact/contactExtra/x_contact_boolean,sale/currencyId,project/projectAssociate/isActive
