...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=origin,person/personAssociate/mrMrs,contact/contactAssociate/mrMrs,contact/contactAssociate/contactDepartment,contact/NumberOfNotCompletedActivitiesInPeriod
