...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=createdBy/fullName,person/personSource,person/personAddress/line1,person/personExtra/x_person_integer,person/personAssociate/lastName
