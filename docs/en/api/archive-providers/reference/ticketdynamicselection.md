...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/email/emailBounceCount,person/personExtra/x_person_request_relation,sale/salePublish/publishedFrom,project/endDate
