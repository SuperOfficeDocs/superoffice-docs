...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=timeSpentInternally,ownedBy/associateDbId,person/useAsMailingAddress,person/personAddress/addressId,person/correspondingAssociate/assocType
