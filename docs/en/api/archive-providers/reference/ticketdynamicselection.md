...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=firstReadByUser,ownedBy/locationAddress,person/personActiveErpLinks,sale/heading,sale/associate/isLocation
