...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=deadline,person/associateType,person/restrictionAddress/city,person/legalBaseEmarketing,contact/contactAssociate/role
