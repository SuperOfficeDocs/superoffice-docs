...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=createdAt,person/personExtra/y_rental/y_equipment/x_name,contact/saintTicketStatus,sale/projectId,sale/updatedBy
