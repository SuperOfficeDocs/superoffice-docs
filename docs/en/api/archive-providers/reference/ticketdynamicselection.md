...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/isStakeholder,contact/contactUdef/SuperOffice:1,contact/LastDoByTicket,extra/x_ticket_datetime
