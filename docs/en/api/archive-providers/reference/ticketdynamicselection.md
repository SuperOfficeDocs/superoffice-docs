...
```http!
GET /api/v1/archive/TicketDynamicSelection?$select=person/rank,person/personDirectFax/formattedNumber,person/personExtra/y_car/id,person/personAssociate/userName,person/correspondingAssociate/personId
