...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/contactExtra/x_contact_time,person/personUdef/SuperOffice:5,person/correspondingAssociate/assocName,project/projectAssociate/lastName
