...
```http!
GET /api/v1/archive/AppointmentSelection?$select=text,contact/contactDeleted,contact/email/emailHasBounced,contact/streetAddress/wgs84latitude,contact/contactAssociate/portraitThumbnail
