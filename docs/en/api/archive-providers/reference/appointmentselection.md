...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/contactAssociate/role,contact/contactAssociate/locationAddress,person/subscription,project/eventId,project/projectAssociate/userName
