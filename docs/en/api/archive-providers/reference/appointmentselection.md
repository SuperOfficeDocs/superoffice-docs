...
```http!
GET /api/v1/archive/AppointmentSelection?$select=completed,updatedDate,person/searchPhone/description,project/projectEvent/eventDate,project/projectAssociate/contactCategory
