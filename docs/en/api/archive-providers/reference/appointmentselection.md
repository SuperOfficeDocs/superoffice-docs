...
```http!
GET /api/v1/archive/AppointmentSelection?$select=icon,contact/department,contact/restrictionAddress/formattedMultiLineAddress,contact/contactAssociate/otherGroups,sale/saleType
