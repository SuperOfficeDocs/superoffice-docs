...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/streetAddress/addressId,contact/saintDirection,project/icon,project/projectAssociate/lastName,sale/date
