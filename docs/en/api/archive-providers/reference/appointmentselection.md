...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/contactUdef/SuperOffice:12,person/personActiveErpLinks,project/text,sale/contactId,sale/nextDueDate
