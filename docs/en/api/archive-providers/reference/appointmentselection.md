...
```http!
GET /api/v1/archive/AppointmentSelection?$select=personId,contact/contactDeleted,contact/contactAssociate/middleName,person/firstName,person/personAddress/city
