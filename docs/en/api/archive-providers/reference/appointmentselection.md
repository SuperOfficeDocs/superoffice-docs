...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/NumberOfNotCompletedTickets,person/birthMonth,person/kanaLastName,person/email/emailAddress,person/personUdef/SuperOffice:3
