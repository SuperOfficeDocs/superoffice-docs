...
```http!
GET /api/v1/archive/AppointmentSelection?$select=recordTypeText,contact/activeErpLinks,contact/mainContact,contact/email/emailAddress,contact/contactAssociate/contactDepartment
