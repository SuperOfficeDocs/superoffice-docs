...
```http!
GET /api/v1/archive/AppointmentSelection?$select=registeredByFullName,contact/searchPhone/formattedNumber,contact/postAddress/line1,person/useAsMailingAddress,person/kanaFirstName
