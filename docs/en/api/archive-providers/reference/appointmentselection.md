...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/email/emailDescription,person/createdByForm,person/restrictionAddress/city,project/projectUdef/SuperOffice:6,sale/source
