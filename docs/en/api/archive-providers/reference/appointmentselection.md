...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/registeredByFullName,contact/restrictionAddress/line3,contact/NumberOfSalesInPeriod,person/whenUpdatedByWorkflow,project/LastCompletedSale
