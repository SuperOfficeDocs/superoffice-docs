...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/number,person/lastName,person/supportAssociateFullName,person/createdByForm,person/personMobilePhone/formattedNumber
