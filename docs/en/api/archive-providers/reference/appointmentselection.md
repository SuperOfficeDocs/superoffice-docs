...
```http!
GET /api/v1/archive/AppointmentSelection?$select=appointmentPublish/publishedBy,contact/nameDepartment,contact/LastDoByActivity,person/firstName,person/searchPhone/description
