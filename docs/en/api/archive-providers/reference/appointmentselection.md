...
```http!
GET /api/v1/archive/AppointmentSelection?$select=person/hasInfoText,person/personExtra/x_person_timespan,person/personAssociate/simultaneousEjUser,sale/salePublish/publishedBy,sale/associate/ejUserId
