...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/streetAddress/formattedAddress,person/personExtra/x_person_float,person/hasStoreConsent,sale/updatedByFullName,associate/contactId
