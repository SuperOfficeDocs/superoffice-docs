...
```http!
GET /api/v1/archive/AppointmentSelection?$select=visibleInDiary,appointmentPublish/isPublished,contact/contactPhone/formattedNumber,contact/contactExtra/x_contact_dropdown,person/birthYear
