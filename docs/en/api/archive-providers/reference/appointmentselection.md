...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/contactUdef/SuperOffice:13,person/personUdef/SuperOffice:1,appointmentUdef/SuperOffice:1,project/name,project/LastCompletedActivity
