...
```http!
GET /api/v1/archive/AppointmentSelection?$select=icon,updatedBy,contact/contactExtra/x_contact_contact,person/personNumber,person/personExtra/x_person_time
