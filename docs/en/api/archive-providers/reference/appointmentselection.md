...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/email/emailProtocol,contact/contactAssociate/personId,person/personMobilePhone/description,project/projectUrl/URLAddress,sale/saleNumber
