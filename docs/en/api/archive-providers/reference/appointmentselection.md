...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/NumberOfNotCompletedSales,person/personBusiness,person/personUdef/SuperOffice:7,person/personAssociate/ejUserId,project/projectEvent/hasSignOff
