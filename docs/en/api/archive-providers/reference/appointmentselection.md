...
```http!
GET /api/v1/archive/AppointmentSelection?$select=contact/registeredByFullName,contact/contactAssociate/isActive,person/correspondingAssociate/role,project/projectAssociate/assocName
