...
```http!
GET /api/v1/archive/AppointmentSelection?$select=userGroup,contact/name,person/personInfo/textId,person/personAssociate/assocTooltip,person/correspondingAssociate/otherGroups
