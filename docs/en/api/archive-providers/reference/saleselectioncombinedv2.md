...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/lastName,person/personUpdatedDate,person/personPrivate/description,person/isMailingRecipient,contact/restrictionAddress/line1
