...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=originalStage,person/personNumber,person/personExtra/y_car/id,person/personAssociate/usergroupId,contact/country
