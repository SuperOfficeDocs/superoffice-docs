...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=projectId,amount,person/hasCompany,person/personExtra/x_person_datetime,person/correspondingAssociate/personEmail
