...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/personExtra/x_person_appointment_relation,contact/contactAssociate/credentialDisplayValue,contact/contactExtra/x_contact_short_dropdown,associate/lastName,saleStakeholder/person/birthMonth
