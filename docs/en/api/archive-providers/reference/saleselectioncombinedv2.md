...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=originalStage,salePublish/publishedFrom,person/email/emailLastSent,person/personExtra/y_rental/y_equipment/x_name,person/personExtra/y_car/id
