...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=getNoRows,probPercent,person/personRegisteredBy,person/personAssociate/assocTooltip,person/correspondingAssociate/contactName
