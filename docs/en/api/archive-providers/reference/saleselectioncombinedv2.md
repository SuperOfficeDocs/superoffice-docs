...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=time,person/personExtra/y_rental/x_end,contact/contactExtra/x_contact_hidden_integer,contact/NumberOfNotCompletedTickets,document/associate/usergroup
