...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/mrMrs,person/personMobilePhone/formattedNumber,contact/email/emailAddress,contact/restrictionAddress/wgs84longitude,associate/ejDisplayName
