...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/fullName,person/personUpdatedBy,person/personDirectPhone/description,associate/personId,appointment/alarm
