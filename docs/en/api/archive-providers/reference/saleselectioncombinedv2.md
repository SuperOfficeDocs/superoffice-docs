...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=contact/hasInterests,saleUdef/SuperOffice:8,appointment/associate/ejDisplayName,document/associate/credentialType,document/associate/otherGroups
