...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/restrictionAddress/county,contact/category,contact/contactUdef/SuperOffice:5,appointment/createdByWorkflow,appointment/appointmentPublish/publishedBy
