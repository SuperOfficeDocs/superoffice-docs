...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=credited,person/isProjectMember,contact/countryId,contact/phone/formattedNumber,contact/contactAssociate/assocType
