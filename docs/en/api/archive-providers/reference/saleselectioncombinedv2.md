...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/lastName,person/personExtra/x_person_request_relation,associate/usergroup,associate/locationAddress,appointment/appointment/textId
