...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=hasStakeholders,person/isProjectMember,person/personUdef/SuperOffice:1,contact/business,contact/contactAssociate/usergroup
