...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/ticketPriority,person/personAddress/county,person/correspondingAssociate/contactName,contact/name,contact/nameDepartment
