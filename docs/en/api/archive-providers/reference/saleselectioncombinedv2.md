...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=source,person/personSource,person/personExtra/x_person_contact_relation,person/personAssociate/middleName,person/correspondingAssociate/personId
