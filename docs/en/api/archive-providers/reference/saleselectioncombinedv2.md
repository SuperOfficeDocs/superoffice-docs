...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/retired,person/consentSourceStore,contact/stop,associate/credentialDisplayValue,document/icon
