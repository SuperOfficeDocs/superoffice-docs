...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=stageRank,contact/companyCategoryRank,contact/postAddress/formattedMultiLineAddress,contact/url/URLAddress,contact/contactAssociate/contactName
