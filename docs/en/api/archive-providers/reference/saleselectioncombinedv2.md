...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/personExtra/x_person_float,contact/registeredBy,contact/contactFax/formattedNumber,appointment/projectId,document/registeredBy
