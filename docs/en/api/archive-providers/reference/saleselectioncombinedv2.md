...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=contact/countryId,contact/streetAddress/city,contact/NumberOfActivities,contact/LastCompletedActivity,appointment/appointment/isConverted
