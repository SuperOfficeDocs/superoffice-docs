...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=contact/contactNoMail,contact/postAddress/line3,contact/NumberOfSales,appointment/recurring,appointment/associate/personEmail
