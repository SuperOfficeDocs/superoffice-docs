...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=stage,person/personUpdatedBy,contact/registeredByFullName,contact/registeredDate,contact/restrictionAddress/line1
