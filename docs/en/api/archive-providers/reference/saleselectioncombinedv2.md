...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=sale/textId,person/personPrivate/formattedNumber,person/personAddress/line3,person/restrictionAddress/formattedMultiLineAddress,person/correspondingAssociate/firstName
