...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=getNoRows,person/birthDay,person/personAddress/state,person/personExtra/x_person_boolean,person/hasEmarketingConsent
