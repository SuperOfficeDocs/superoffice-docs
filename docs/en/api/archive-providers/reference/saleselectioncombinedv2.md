...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=projectId,updatedByFullName,person/correspondingAssociate/contactFullName,associate/userName,project/saintTicketCategory
