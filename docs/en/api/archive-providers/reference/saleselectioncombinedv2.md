...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=saleUdef/SuperOffice:4,appointment/duration,appointment/createdByWorkflow,appointment/associate/mrMrs,appointment/associate/isLocation
