...
```http!
GET /api/v1/archive/SaleSelectionCombinedV2?$select=person/personCategoryGroup,person/personAddress/state,contact/contactId,contact/number,contact/email/emailHasBounced
