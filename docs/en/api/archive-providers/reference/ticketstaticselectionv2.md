...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=timeToReply,createdBy/contactCategory,ownedBy/simultaneousEjUser,person/restrictionAddress/formattedMultiLineAddress,person/legalBaseStore
