...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=person/isStakeholder,person/personPager/formattedNumber,person/email/emailAddress,contact/NumberOfSalesInPeriod,sale/stage
