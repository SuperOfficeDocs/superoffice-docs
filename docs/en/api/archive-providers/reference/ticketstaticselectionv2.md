...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=categoryFullName,person/email/emailId,person/personUdef/SuperOffice:9,person/correspondingAssociate/personEmail,contact/streetAddress/line2
