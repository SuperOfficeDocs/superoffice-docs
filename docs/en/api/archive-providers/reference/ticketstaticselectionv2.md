...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=ownedBy/isLocation,person/correspondingAssociate/usergroup,contact/NumberOfSales,sale/associate/associateDbId,sale/saleUdef/SuperOffice:3
