...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=readByOwner,contact/email/emailProtocol,project/registeredByFullName,project/projectAssociate/portraitThumbnail
