...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=title,createdBy/contactId,person/personActiveErpLinks,person/personUdef/SuperOffice:11,contact/streetAddress/formattedMultiLineAddress
