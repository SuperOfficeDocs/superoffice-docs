...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=contact/country,contact/contactAssociate/ejStatus,contact/LastDoByTicket,sale/projectId,sale/currencyId
