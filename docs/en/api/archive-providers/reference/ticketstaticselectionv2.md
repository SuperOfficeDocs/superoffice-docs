...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=saleId,createdBy/lastName,person/personAddress/state,person/personExtra/x_person_date,person/personAssociate/fullName
