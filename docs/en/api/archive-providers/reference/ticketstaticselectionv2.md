...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=ticketPriority/ticketPriorityId,person/position,person/personNumber,person/correspondingAssociate/ejUserId,contact/category
