...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=createdBy/role,person/hasInterests,person/restrictionAddress/state,person/personExtra/x_person_date,person/personAssociate/fullName
