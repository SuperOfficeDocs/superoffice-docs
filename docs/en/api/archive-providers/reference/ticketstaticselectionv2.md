...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=person/personDirectFax/formattedNumber,sale/associate/title,person/personExtra/x_person_priority_relation
