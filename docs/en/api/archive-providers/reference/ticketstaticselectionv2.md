...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=contact/name,contact/postAddress/line2,contact/contactAssociate/personId,contact/NumberOfSales,sale/saleTypeCategory
