...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=sentimentConfidence,person/email/emailLastSent,person/restrictionAddress/city,person/personAssociate/ejDisplayName,contact/restrictionAddress/zip
