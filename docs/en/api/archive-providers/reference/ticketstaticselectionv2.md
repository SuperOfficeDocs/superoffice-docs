...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=readStatus,person/supportAssociate,person/personAssociate/title,sale/stakeholdersEnabled,project/projectPublish/publishedBy
