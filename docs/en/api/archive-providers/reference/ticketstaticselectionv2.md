...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=person/personRegisteredByFullName,person/withdrawnStoreConsent,person/personExtra/x_person_request_relation
