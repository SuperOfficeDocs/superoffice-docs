...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=timeToClose,person/firstName,person/personPager/description,person/searchPhone/description,person/correspondingAssociate/userName
