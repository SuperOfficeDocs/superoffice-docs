...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=person/birthDay,person/correspondingAssociate/isActiveText,contact/email/emailAddress,contact/contactAssociate/contactFullName,contact/NumberOfNotCompletedActivitiesInPeriod
