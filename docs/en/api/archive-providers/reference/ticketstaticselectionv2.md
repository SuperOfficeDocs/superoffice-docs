...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=status,ownedBy/isActive,person/personRegisteredDate,person/personUrl/URLDescription,person/personExtra/x_person_contact_relation
