...
```http!
GET /api/v1/archive/TicketStaticSelectionV2?$select=closedAt,person/middleName,person/restrictionAddress/line1,person/correspondingAssociate/credentialType,contact/contactAssociate/assocTooltip
