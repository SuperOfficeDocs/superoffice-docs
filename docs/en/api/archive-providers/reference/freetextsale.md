...
```http!
GET /api/v1/archive/FreetextSale?$select=completed,type,contact/contactAssociate/ejUserId,project/status,saleStakeholder/person/personRegisteredByFullName
