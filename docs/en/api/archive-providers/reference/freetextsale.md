...
```http!
GET /api/v1/archive/FreetextSale?$select=stageRank,person/personDeletedDate,person/personUdef/SuperOffice:6,person/correspondingAssociate/otherGroups,contact/contactAssociate/contactName
