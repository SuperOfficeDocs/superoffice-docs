...
```http!
GET /api/v1/archive/FreetextSale?$select=updatedBy,amountInBaseCurrency,person/personAssociate/isLocation,contact/postAddress/line1,contact/NumberOfTickets
