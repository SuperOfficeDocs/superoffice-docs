...
```http!
GET /api/v1/archive/FreetextSale?$select=person/supportAssociate,person/personCategory,person/personUdef/SuperOffice:7,person/personAssociate/firstName,person/personAssociate/fullName
