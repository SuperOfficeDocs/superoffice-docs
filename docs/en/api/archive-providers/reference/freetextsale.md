...
```http!
GET /api/v1/archive/FreetextSale?$select=time,person/personAssociate/ejUserId,person/correspondingAssociate/isActiveText,contact/postAddress/city,project/text
