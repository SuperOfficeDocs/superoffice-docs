...
```http!
GET /api/v1/archive/FreetextSale?$select=person/personExtra/x_person_time,person/personExtra/y_rental/x_start,contact/contactAssociate/usergroupId,contact/contactUdef/SuperOffice:1,saleUdef/SuperOffice:5
