...
```http!
GET /api/v1/archive/FreetextSale?$select=person/personExtra/x_person_date,person/correspondingAssociate/contactId,contact/stop,contact/email/emailDescription,contact/NumberOfSales
