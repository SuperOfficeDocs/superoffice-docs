...
```http!
GET /api/v1/archive/FreetextSale?$select=probPercent,person/firstName,person/hasInfoText,person/hasCompany,saleStakeholder/person/correspondingAssociate/middleName
