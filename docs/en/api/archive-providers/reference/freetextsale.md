...
```http!
GET /api/v1/archive/FreetextSale?$select=updatedDate,person/personCategory,contact/updatedBy,contact/postAddress/formattedMultiLineAddress,associate/ejStatus
