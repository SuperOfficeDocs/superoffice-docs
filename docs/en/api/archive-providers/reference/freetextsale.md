...
```http!
GET /api/v1/archive/FreetextSale?$select=person/correspondingAssociate/contactCategory,person/legalBaseEmarketing,contact/contactUdef/SuperOffice:8,associate/userName,project/name
