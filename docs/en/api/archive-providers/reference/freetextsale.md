...
```http!
GET /api/v1/archive/FreetextSale?$select=completed,person/personAssociate/credentialDisplayValue,person/isMailingRecipient,contact/contactPhone/description,associate/firstName
