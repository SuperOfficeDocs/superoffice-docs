...
```http!
GET /api/v1/archive/FreetextSale?$select=person/personNumber,person/personAssociate/role,contact/contactExtra/x_contact_date,contact/LastDoByActivity,project/type
