...
```http!
GET /api/v1/archive/FreetextSale?$select=text,person/personHasInterests,person/correspondingAssociate/mrMrs,person/hasStoreConsent,contact/restrictionAddress/wgs84longitude
