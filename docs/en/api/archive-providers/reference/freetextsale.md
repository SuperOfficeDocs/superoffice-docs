...
```http!
GET /api/v1/archive/FreetextSale?$select=completed,saleStatus,person/personUrl/URLAddress,person/correspondingAssociate/assocName,contact/activeErpLinks
