...
```http!
GET /api/v1/archive/FreetextSale?$select=heading,amount,person/personPrivate/description,person/personAssociate/usergroup,person/correspondingAssociate/ejStatus
