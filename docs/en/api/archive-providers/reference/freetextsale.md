...
```http!
GET /api/v1/archive/FreetextSale?$select=salePublish/publishedTo,person/fullName,person/portraitThumbnail,person/leadstatusRank,person/personAddress/state
