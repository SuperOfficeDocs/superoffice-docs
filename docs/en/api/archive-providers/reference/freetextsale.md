...
```http!
GET /api/v1/archive/FreetextSale?$select=registeredDate,contact/postAddress/wgs84latitude,contact/saintIntention,project/name,saleStakeholder/person/personSource
