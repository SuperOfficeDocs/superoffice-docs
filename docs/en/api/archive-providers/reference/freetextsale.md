...
```http!
GET /api/v1/archive/FreetextSale?$select=userGroup,person/personExtra/y_rental/x_amount,person/personAssociate/isLocation,person/correspondingAssociate/firstName,contact/contactAssociate/contactId
