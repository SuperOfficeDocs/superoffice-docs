...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=createdBy/contactDepartment,person/personExtra/y_rental/x_amount,person/correspondingAssociate/assocName,contact/registeredBy,contact/deletedDate
