...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=person/personUdef/SuperOffice:7,person/personAssociate/contactFullName,contact/contactId,contact/hasInfoText,targetTableNumber
