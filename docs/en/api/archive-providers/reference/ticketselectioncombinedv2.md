...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=readByCustomer,person/personUpdatedByFullName,person/personAssociateFullName,person/personMobilePhone/formattedNumber,person/personUrl/URLAddress
