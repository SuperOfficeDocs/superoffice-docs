...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=firstReadByOwner,createdBy/contactCategory,ownedBy/credentialDisplayValue,person/personDirectPhone/formattedNumber,contact/contactUdef/SuperOffice:11
