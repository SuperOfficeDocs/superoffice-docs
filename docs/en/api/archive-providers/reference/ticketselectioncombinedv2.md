...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=ownedBy/usergroup,person/personUdef/SuperOffice:5,person/personExtra/x_person_shorttext_list,sale/sale/textId,project/text
