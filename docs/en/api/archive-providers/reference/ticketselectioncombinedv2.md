...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=contactId,person/isProjectMember,person/personDirectPhone/description,person/personExtra/x_person_shorttext_list,person/correspondingAssociate/userName
