...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=createdBy/assocType,person/personCountry,contact/searchPhone/description,project/projectAssociate/usergroup,project/projectAssociate/credentialDisplayValue
