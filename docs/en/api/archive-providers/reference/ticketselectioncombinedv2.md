...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=ticketStatus/name,person/personExtra/y_rental/x_start,contact/countryId,contact/orgnr,contact/email/emailAddress
