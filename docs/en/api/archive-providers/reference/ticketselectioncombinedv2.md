...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=person/restrictionAddress/wgs84latitude,sale/stalledComment,project/projectAssociate/ejDisplayName
