...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=createdBy/isActive,person/restrictionAddress/state,contact/contactAssociate/personEmail,sale/completed,sale/reopenDate
