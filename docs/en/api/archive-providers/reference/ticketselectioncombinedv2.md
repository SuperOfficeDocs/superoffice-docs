...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=contact/registeredDate,contact/contactAssociate/credentialType,person/personExtra/x_person_priority_relation
