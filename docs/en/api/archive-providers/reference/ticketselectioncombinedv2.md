...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=ownedBy/userName,person/personActiveErpLinks,person/personExtra/x_person_float,person/personAssociate/simultaneousEjUser,person/correspondingAssociate/portraitThumbnail
