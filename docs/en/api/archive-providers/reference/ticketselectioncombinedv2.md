...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=person/personActiveErpLinks,person/personExtra/x_person_date,contact/streetAddress/zip,sale/associate/usergroup,project/projectAssociate/middleName
