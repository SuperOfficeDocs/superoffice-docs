...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=createdBy,person/rank,person/portraitThumbnail,person/personPager/formattedNumber,person/personExtra/x_person_integer
