...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=createdBy/firstName,createdBy/mrMrs,person/personNoMail,person/personAssociateFullName,person/personAssociate/credentialDisplayValue
