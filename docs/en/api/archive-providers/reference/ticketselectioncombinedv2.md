...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=deadline,createdBy/locationAddress,person/personRegisteredBy,person/personAddress/line2,person/personExtra/x_person_user_relation
