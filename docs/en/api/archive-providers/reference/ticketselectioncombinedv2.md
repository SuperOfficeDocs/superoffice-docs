...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=person/fullName,person/birthdate,contact/NumberOfSalesInPeriod,sale/saleTypeCategory,sale/associate/portraitThumbnail
