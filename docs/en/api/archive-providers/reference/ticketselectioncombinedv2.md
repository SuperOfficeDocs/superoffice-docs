...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=createdBy/usergroup,ownedBy/fullName,person/correspondingAssociate/associateDbId,project/projectEvent/eventDate
