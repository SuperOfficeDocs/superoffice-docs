...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=personId,status,createdBy/contactDepartment,person/correspondingAssociate/credentialType,contact/hasInfoText
