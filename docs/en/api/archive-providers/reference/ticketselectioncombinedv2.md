...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=sale/salePublish/publishedBy,sale/saleUdef/SuperOffice:5,project/projectAssociate/associateDbId,project/NumberOfSalesInPeriod
