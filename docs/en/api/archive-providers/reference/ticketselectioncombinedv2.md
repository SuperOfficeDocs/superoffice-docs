...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=person/personAddress/city,person/personAddress/formattedMultiLineAddress,person/personUdef/SuperOffice:11,contact/contactExtra/x_contact_datetime,sale/competitor
