...
```http!
GET /api/v1/archive/TicketSelectionCombinedV2?$select=origin,person/position,contact/contactAssociate/middleName,contact/contactAssociate/mrMrs,contact/contactExtra/x_contact_request_relation
