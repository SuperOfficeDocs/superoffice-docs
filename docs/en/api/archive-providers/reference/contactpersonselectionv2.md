...
|includePersonRestriction| *None* |SR\_FIND\_CONT\_ONLY\_MAIN\_PERS: SR\_RESTRICTION\_INCLUDEMP\_TOOLTIP|  |
|includePersonWithNoDMRestriction| *None* |SR\_FIND\_PERS\_EXC\_NODM: SR\_RESTRICTION\_NODMTOOLTIP|  |
|selectionIdRequest| *None* |SR\_RESTRICTION\_SELECTIONID: SR\_RESTRICTION\_SELECTIONID\_TOOLTIP|  |
|linkClicked/linkId| *None* |SR\_RESTRICTION\_LINK: SR\_RESTRICTION\_LINK|  |

## Supported Columns (cont.)
| Name | Restriction | Description | OrderBy
| ---- | ----- | ------- | ------ |
|linkClicked/shipmentId| *None* |SR\_ARCHIVE\_MAILING\_ID: SR\_ARCHIVE\_MAILING\_ID\_TOOLTIP|  |
|formSubmission/formSubmissionId| *None* |SR\_FORMSUBMISSIONARCHIVE\_SUBMISSIONID: SR\_FORMSUBMISSIONARCHIVE\_SUBMISSIONID\_TOOLTIP| x |
|formSubmission/formSubmissionFormId| *None* |SR\_FORMSUBMISSIONARCHIVE\_FORMID: SR\_FORMSUBMISSIONARCHIVE\_FORMID\_TOOLTIP| x |
|formSubmission/formSubmissionName| *None* |SR\_FORMS\_FORM: SR\_ACTIVITYARCHIVE\_DESCRIPTION\_TOOLTIP| x |
|formSubmission/formSubmissionStatus| *None* |SR\_FORMSUBMISSION\_STATUS: SR\_FORMSUBMISSION\_STATUS\_TOOLTIP| x |
|formSubmission/formSubmissionEmail| *None* |SR\_FORMSUBMISSION\_EMAIL: SR\_FORMSUBMISSION\_EMAIL\_TOOLTIP| x |
|formSubmission/icon| *None* |SR\_ACTIVITYARCHIVE\_CATEGORY: SR\_ACTIVITYARCHIVE\_CATEGORY\_TOOLTIP| x |
|formSubmission/date| *None* |SR\_ACTIVITYARCHIVE\_STARTDATE: SR\_ACTIVITYARCHIVE\_STARTDATE\_TOOLTIP| x |
|formSubmission/time| *None* |SR\_INVITE\_TIME: SR\_INVITE\_TIME|  |
|formSubmission/type| *None* |SR\_ACTIVITYARCHIVE\_TYPE: SR\_ACTIVITYARCHIVE\_TYPE\_TOOLTIP| x |
|formSubmission/text| *None* |SR\_ACTIVITYARCHIVE\_DESCRIPTION: SR\_ACTIVITYARCHIVE\_DESCRIPTION\_TOOLTIP| x |
|formSubmission/associateId| *None* |SR\_ACTIVITYARCHIVE\_ASSOCIATEID: SR\_ACTIVITYARCHIVE\_ASSOCIATEID\_TOOLTIP| x |
|formSubmission/contactId| *None* |SR\_CONTACT\_ID: SR\_CONTACT\_ID\_TOOLTIP| x |
|formSubmission/personId| *None* |SR\_PERSON\_ID: SR\_PERSON\_ID\_TOOLTIP| x |
|formSubmission/updatedBy| *None* |SR\_UPDATEDASSOC: SR\_UPDATEDASSOC\_TOOLTIP| x |
|formSubmission/updatedDate| *None* |SR\_UPDATEDDATE: SR\_UPDATEDDATE\_TOOLTIP| x |
|formSubmission/registeredBy| *None* |SR\_REGISTEREDASSOC: SR\_REGISTEREDASSOC\_TOOLTIP| x |
|formSubmission/registeredDate| *None* |SR\_REGISTEREDDATE: SR\_REGISTEREDDATE\_TOOLTIP| x |
|formSubmission/recordTypeText| *None* |SR\_ARCHIVE\_RECORDTYPETEXT: SR\_ARCHIVE\_RECORDTYPETEXT\_TOOLTIP| x |
|workflowInstance/workflowInstanceId| *None* |SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_ID: SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_ID\_TOOLTIP| x |
|workflowInstance/workflowInstanceStatus| *None* |SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_STATUS: SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_STATUS\_TOOLTIP| x |
|workflowInstance/workflowInstanceWaitUntil| *None* |SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_WAITUNTIL: SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_WAITUNTIL\_TOOLTIP| x |
|workflowInstance/workflowInstanceStepStarted| *None* |SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_STEPSTARTED: SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_STEPSTARTED\_TOOLTIP| x |
...
|workflowInstance/workflowInstanceLastCommunicationTime| *None* |SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_LASTCOMMUNICATIONTIME: SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_LASTCOMMUNICATIONTIME\_TOOLTIP| x |
|workflowInstance/workflowInstanceLastCommunicationStatus| *None* |SR\_ARCHIVE\_EMAILFLOW\_INSTANCE\_RESPONSELASTEMAIL: SR\_ARCHIVE\_RECIPIENT\_STATUS\_TOOLTIP| x |
|workflowInstance/updatedBy| *None* |SR\_UPDATEDASSOC: SR\_UPDATEDASSOC\_TOOLTIP| x |
|workflowInstance/updatedDate| *None* |SR\_UPDATEDDATE: SR\_UPDATEDDATE\_TOOLTIP| x |
|workflowInstance/registeredBy| *None* |SR\_REGISTEREDASSOC: SR\_REGISTEREDASSOC\_TOOLTIP| x |
|workflowInstance/registeredDate| *None* |SR\_REGISTEREDDATE: SR\_REGISTEREDDATE\_TOOLTIP| x |
|workflowInstance/emailFlow/emailFlowId| *None* |SR\_ARCHIVE\_EMAILFLOW\_ID: SR\_ARCHIVE\_EMAILFLOW\_ID\_TOOLTIP| x |
|workflowInstance/emailFlow/emailFlowHierarchyId| *None* |SR\_HIERARCHY\_ID: SR\_HIERARCHY\_ID\_TOOLTIP| x |
|workflowInstance/emailFlow/shipmentType| *None* |SR\_ARCHIVE\_EMAILFLOW\_MAILING\_TYPE: SR\_ARCHIVE\_EMAILFLOW\_MAILING\_TYPE\_TOOLTIP| x |
|workflowInstance/emailFlow/overrideConsentSubscription| *None* |SR\_ARCHIVE\_EMAILFLOW\_OVERRIDE\_CONSENT\_SUBSCRIPTION: SR\_ARCHIVE\_EMAILFLOW\_OVERRIDE\_CONSENT\_SUBSCRIPTION\_TOOLTIP| x |
...
|workflowInstance/emailFlow/workflowId| *None* |SR\_ARCHIVE\_WORKFLOW\_ID: SR\_ARCHIVE\_WORKFLOW\_ID\_TOOLTIP| x |
|workflowInstance/emailFlow/workflowName| *None* |SR\_ARCHIVE\_WORKFLOW\_NAME: SR\_ARCHIVE\_WORKFLOW\_NAME\_TOOLTIP| x |
|workflowInstance/emailFlow/workflowDescription| *None* |SR\_ARCHIVE\_WORKFLOW\_DESC: SR\_ARCHIVE\_WORKFLOW\_DESC\_TOOLTIP| x |
|workflowInstance/emailFlow/workflowDefinitionStatus| *None* |SR\_ARCHIVE\_WORKFLOW\_DEFINITION\_STATUS: SR\_ARCHIVE\_WORKFLOW\_\_DEFINITION\_STATUS\_TOOLTIP| x |
|workflowInstance/emailFlow/workflowDefinitionStatusId| *None* |SR\_ARCHIVE\_WORKFLOW\_DEFINITION\_STATUS: SR\_ARCHIVE\_WORKFLOW\_\_DEFINITION\_STATUS\_TOOLTIP| x |
|workflowInstance/emailFlow/jumpToFinish| *None* |SR\_ARCHIVE\_WORKFLOW\_JUMP\_TO\_FINISH: SR\_ARCHIVE\_WORKFLOW\_\_DEFINITION\_JUMP\_TO\_FINISH\_TOOLTIP| x |
|workflowInstance/emailFlow/startOnlyOnce| *None* |SR\_ARCHIVE\_WORKFLOW\_START\_ONLY\_ONCE: SR\_ARCHIVE\_WORKFLOW\_\_DEFINITION\_START\_ONLY\_ONCE\_TOOLTIP| x |
...
|workflowInstance/emailFlow/updatedBy| *None* |SR\_UPDATEDASSOC: SR\_UPDATEDASSOC\_TOOLTIP| x |
|workflowInstance/emailFlow/updatedDate| *None* |SR\_UPDATEDDATE: SR\_UPDATEDDATE\_TOOLTIP| x |
|workflowInstance/emailFlow/registeredBy| *None* |SR\_REGISTEREDASSOC: SR\_REGISTEREDASSOC\_TOOLTIP| x |
|workflowInstance/emailFlow/registeredDate| *None* |SR\_REGISTEREDDATE: SR\_REGISTEREDDATE\_TOOLTIP| x |
|chatSession/chatSessionId| *None* |SR\_CHATARCHIVE\_SESSIONID: SR\_CHATARCHIVE\_SESSIONID\_TOOLTIP| x |
|chatSession/firstMessage| *None* |SR\_CHATARCHIVE\_FIRSTMESSAGE: SR\_CHATARCHIVE\_FIRSTMESSAGE\_TOOLTIP| x |
|chatSession/lastMessage| *None* |SR\_CHATARCHIVE\_LASTMESSAGE: SR\_CHATARCHIVE\_LASTMESSAGE\_TOOLTIP| x |
|chatSession/whenRequested| *None* |SR\_CHATARCHIVE\_WHENREQUESTED: SR\_CHATARCHIVE\_WHENREQUESTED\_TOOLTIP| x |
|chatSession/whenStarted| *None* |SR\_CHATARCHIVE\_WHENSTARTED: SR\_CHATARCHIVE\_WHENSTARTED\_TOOLTIP| x |
|chatSession/whenEnded| *None* |SR\_CHATARCHIVE\_WHENENDED: SR\_CHATARCHIVE\_WHENENDED\_TOOLTIP| x |
|chatSession/duration| *None* |SR\_CHATARCHIVE\_DURATION: SR\_CHATARCHIVE\_DURATION\_TOOLTIP|  |
|chatSession/timeInQueue| *None* |SR\_CHATARCHIVE\_TIMINQUEUE: SR\_CHATARCHIVE\_TIMINQUEUE\_TOOLTIP| x |
|chatSession/queueLength| *None* |SR\_CHATARCHIVE\_QUEUE\_LENGTH: SR\_CHATARCHIVE\_QUEUE\_LENGTH\_TOOLTIP| x |
|chatSession/rating| *None* |SR\_CHATARCHIVE\_RATING: SR\_CHATARCHIVE\_RATING\_TOOLTIP| x |
|chatSession/agent| *None* |SR\_CHAT\_AGENT: SR\_CHAT\_AGENT\_TOOLTIP| x |
|chatSession/status| *None* |SR\_CHAT\_STATUS: SR\_CHAT\_STATUS\_TOOLTIP| x |
|chatSession/icon| *None* |SR\_ACTIVITYARCHIVE\_CATEGORY: SR\_ACTIVITYARCHIVE\_CATEGORY\_TOOLTIP| x |
|chatSession/date| *None* |SR\_ACTIVITYARCHIVE\_STARTDATE: SR\_ACTIVITYARCHIVE\_STARTDATE\_TOOLTIP| x |
|chatSession/type| *None* |SR\_ACTIVITYARCHIVE\_TYPE: SR\_ACTIVITYARCHIVE\_TYPE\_TOOLTIP| x |
|chatSession/text| *None* |SR\_ACTIVITYARCHIVE\_DESCRIPTION: SR\_ACTIVITYARCHIVE\_DESCRIPTION\_TOOLTIP| x |
|chatSession/associateId| *None* |SR\_ACTIVITYARCHIVE\_ASSOCIATEID: SR\_ACTIVITYARCHIVE\_ASSOCIATEID\_TOOLTIP| x |
|chatSession/contactId| *None* |SR\_CONTACT\_ID: SR\_CONTACT\_ID\_TOOLTIP| x |
|chatSession/personId| *None* |SR\_PERSON\_ID: SR\_PERSON\_ID\_TOOLTIP| x |
|chatSession/updatedDate| *None* |SR\_UPDATEDDATE: SR\_UPDATEDDATE\_TOOLTIP| x |
|chatSession/registeredDate| *None* |SR\_REGISTEREDDATE: SR\_REGISTEREDDATE\_TOOLTIP| x |
|chatSession/recordTypeText| *None* |SR\_ARCHIVE\_RECORDTYPETEXT: SR\_ARCHIVE\_RECORDTYPETEXT\_TOOLTIP| x |
|chatSession/chatTopic/chatTopicId| *None* |SR\_CHATARCHIVE\_CHANNEL\_ID: SR\_CHATARCHIVE\_CHANNEL\_ID\_TOOLTIP| x |
|chatSession/chatTopic/name| *None* |SR\_CHATARCHIVE\_CHANNEL\_NAME: SR\_CHATARCHIVE\_CHANNEL\_NAME| x |
|chatSession/chatTopic/description| *None* |SR\_CHATARCHIVE\_CHANNEL\_DESCRIPTION: SR\_CHATARCHIVE\_CHANNEL\_DESCRIPTION\_TOOLTIP| x |
|chatSession/chatTopic/badgeHeader| *None* |SR\_CHATARCHIVE\_CHANNEL\_BADGEHEADER: SR\_CHATARCHIVE\_CHANNEL\_BADGEHEADER\_TOOLTIP| x |
|sale/quote/quoteId| *None* |SR\_QUOTE\_QUOTE\_ID: SR\_QUOTE\_QUOTE\_ID\_TOOLTIP| x |
|sale/quote/poNumber| *None* |SR\_QUOTE\_QUOTE\_PONUMBER: SR\_QUOTE\_QUOTE\_PONUMBER\_TOOLTIP| x |
|sale/quote/orderComment| *None* |SR\_QUOTE\_QUOTE\_ORDERCOMMENT: SR\_QUOTE\_QUOTE\_ORDERCOMMENT\_TOOLTIP| x |
|sale/quote/connectionId| *None* |SR\_QUOTE\_CONNECTIONID: SR\_QUOTE\_CONNECTIONID\_TOOLTIP| x |
|sale/quote/registeredDate| *None* |SR\_QUOTE\_QUOTE\_REGISTERED: SR\_QUOTE\_QUOTE\_REGISTERED\_TOOLTIP| x |
|sale/quote/version/quoteVersionId| *None* |SR\_QUOTE\_QUOTEVERSION\_ID: SR\_QUOTE\_QUOTEVERSION\_ID\_TOOLTIP| x |
|sale/quote/version/description| *None* |SR\_QUOTE\_QUOTEVERSION\_DESCRIPTION: SR\_QUOTE\_QUOTEVERSION\_DESCRIPTION\_TOOLTIP| x |
|sale/quote/version/number| *None* |SR\_QUOTE\_QUOTEVERSION\_NUMBER: SR\_QUOTE\_QUOTEVERSION\_NUMBER\_TOOLTIP| x |
|sale/quote/version/sent| *None* |SR\_QUOTE\_QUOTEVERSION\_SENT: SR\_QUOTE\_QUOTEVERSION\_SENT\_TOOLTIP| x |
|sale/quote/version/expiration| *None* |SR\_QUOTE\_QUOTEVERSION\_EXPIRATION: SR\_QUOTE\_QUOTEVERSION\_EXPIRATION\_TOOLTIP| x |
|sale/quote/version/state| *None* |SR\_QUOTE\_QUOTEVERSION\_STATE: SR\_QUOTE\_QUOTEVERSION\_STATE\_TOOLTIP| x |
|sale/quote/version/status| *None* |SR\_QUOTE\_QUOTELINE\_QUOTESTATUS: SR\_QUOTE\_QUOTELINE\_QUOTESTATUS\_TOOLTIP| x |
|sale/quote/version/reason| *None* |SR\_QUOTE\_QUOTELINE\_QUOTEREASON: SR\_QUOTE\_QUOTELINE\_QUOTEREASON\_TOOLTIP| x |
|sale/quote/version/paymentTerms| *None* |SR\_QUOTE\_QUOTEVERSION\_PAYMENTTERMS: SR\_QUOTE\_QUOTEVERSION\_PAYMENTTERMS\_TOOLTIP|  |
|sale/quote/version/paymentType| *None* |SR\_QUOTE\_QUOTEVERSION\_PAYMENTTYPE: SR\_QUOTE\_QUOTEVERSION\_PAYMENTTYPE\_TOOLTIP|  |
|sale/quote/version/deliveryTerms| *None* |SR\_QUOTE\_QUOTEVERSION\_DELIVERYTERMS: SR\_QUOTE\_QUOTEVERSION\_DELIVERYTERMS\_TOOLTIP|  |
|sale/quote/version/deliveryType| *None* |SR\_QUOTE\_QUOTEVERSION\_DELIVERYTYPE: SR\_QUOTE\_QUOTEVERSION\_DELIVERYTYPE\_TOOLTIP|  |
|sale/quote/version/approvedBy| *None* |SR\_QUOTE\_QUOTEVERSION\_APPROVEDBY: SR\_QUOTE\_QUOTEVERSION\_APPROVEDBY\_TOOLTIP| x |

## Supported Columns (cont.)
| Name | Restriction | Description | OrderBy
| ---- | ----- | ------- | ------ |
|sale/quote/version/approvalRegisteredBy| *None* |SR\_QUOTE\_QUOTEVERSION\_APPROVALREGISTEREDBY: SR\_QUOTE\_QUOTEVERSION\_APPROVALREGISTEREDBY\_TOOLTIP| x |
|sale/quote/version/approvedText| *None* |SR\_QUOTE\_QUOTEVERSION\_APPROVEDTEXT: SR\_QUOTE\_QUOTEVERSION\_APPROVEDTEXT\_TOOLTIP| x |
|sale/quote/version/approvedDate| *None* |SR\_QUOTE\_QUOTEVERSION\_APPROVEDDATE: SR\_QUOTE\_QUOTEVERSION\_APPROVEDDATE\_TOOLTIP| x |
|sale/quote/version/extraField1| *None* |SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD1: SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD1\_TOOLTIP| x |
|sale/quote/version/extraField2| *None* |SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD2: SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD2\_TOOLTIP| x |
|sale/quote/version/extraField3| *None* |SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD3: SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD3\_TOOLTIP| x |
|sale/quote/version/extraField4| *None* |SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD4: SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD4\_TOOLTIP| x |
|sale/quote/version/extraField5| *None* |SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD5: SR\_QUOTE\_QUOTEVERSION\_EXTRAFIELD5\_TOOLTIP| x |
|sale/quote/version/alternative/quoteAlternativeId| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_ID: SR\_QUOTE\_QUOTEALTERNATIVE\_ID\_TOOLTIP| x |
|sale/quote/version/alternative/quoteVersionId| *None* |SR\_QUOTE\_QUOTEVERSION\_ID: SR\_QUOTE\_QUOTEVERSION\_ID\_TOOLTIP| x |
|sale/quote/version/alternative/name| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_NAME: SR\_QUOTE\_QUOTEALTERNATIVE\_NAME\_TOOLTIP| x |
|sale/quote/version/alternative/description| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_DESCRIPTION: SR\_QUOTE\_QUOTEALTERNATIVE\_DESCRIPTION\_TOOLTIP| x |
|sale/quote/version/alternative/status| *None* |SR\_QUOTE\_QUOTELINE\_QUOTESTATUS: SR\_QUOTE\_QUOTELINE\_QUOTESTATUS\_TOOLTIP| x |
|sale/quote/version/alternative/reason| *None* |SR\_QUOTE\_QUOTELINE\_QUOTEREASON: SR\_QUOTE\_QUOTELINE\_QUOTEREASON\_TOOLTIP| x |
|sale/quote/version/alternative/erpDiscountPercent| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_ERPDISCOUNTPERCENT: SR\_QUOTE\_QUOTEALTERNATIVE\_ERPDISCOUNTPERCENT\_TOOLTIP| x |
|sale/quote/version/alternative/erpDiscountAmount| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_ERPDISCOUNTAMOUNT: SR\_QUOTE\_QUOTEALTERNATIVE\_ERPDISCOUNTAMOUNT\_TOOLTIP| x |
|sale/quote/version/alternative/discountPercent| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_DISCOUNTPERCENT: SR\_QUOTE\_QUOTEALTERNATIVE\_DISCOUNTPERCENT\_TOOLTIP| x |
|sale/quote/version/alternative/discountAmount| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_DISCOUNTAMOUNT: SR\_QUOTE\_QUOTEALTERNATIVE\_DISCOUNTAMOUNT\_TOOLTIP| x |
|sale/quote/version/alternative/vatInfo| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_VATINFO: SR\_QUOTE\_QUOTEALTERNATIVE\_VATINFO\_TOOLTIP| x |
|sale/quote/version/alternative/vat| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_VAT: SR\_QUOTE\_QUOTEALTERNATIVE\_VAT\_TOOLTIP| x |
|sale/quote/version/alternative/earningPercent| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_EARNINGSPERCENT: SR\_QUOTE\_QUOTEALTERNATIVE\_EARNINGSPERCENT\_TOOLTIP| x |
|sale/quote/version/alternative/earningAmount| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_EARNINGSAMOUNT: SR\_QUOTE\_QUOTEALTERNATIVE\_EARNINGSAMOUNT\_TOOLTIP| x |
|sale/quote/version/alternative/totalPrice| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_TOTAL: SR\_QUOTE\_QUOTEALTERNATIVE\_TOTAL\_TOOLTIP| x |
|sale/quote/version/alternative/extraField1| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD1: SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD1\_TOOLTIP| x |
|sale/quote/version/alternative/extraField2| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD2: SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD2\_TOOLTIP| x |
|sale/quote/version/alternative/extraField3| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD3: SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD3\_TOOLTIP| x |
|sale/quote/version/alternative/extraField4| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD4: SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD4\_TOOLTIP| x |
|sale/quote/version/alternative/extraField5| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD5: SR\_QUOTE\_QUOTEALTERNATIVE\_EXTRAFIELD5\_TOOLTIP| x |
|sale/quote/version/alternative/alternativeOrdering| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_ID: SR\_QUOTE\_QUOTEALTERNATIVE\_ID\_TOOLTIP| x |
|sale/quote/version/alternative/subTotal| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_SUBTOTAL: SR\_QUOTE\_QUOTEALTERNATIVE\_SUBTOTAL\_TOOLTIP| x |
|sale/quote/version/alternative/totalPriceIncVAT| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_ALTTOTINCVAT: SR\_QUOTE\_QUOTEALTERNATIVE\_ALTTOTINCVAT\_TOOLTIP| x |
|sale/quote/version/alternative/vatAmount| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_ALTVATAMT: SR\_QUOTE\_QUOTEALTERNATIVE\_ALTVATAMT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/quoteLineId| *None* |SR\_QUOTE\_QUOTELINE\_QUOTELINEID: SR\_QUOTE\_QUOTELINE\_QUOTELINEID\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/quoteAlternativeId| *None* |SR\_QUOTE\_QUOTELINE\_QUOTEALTERNATIVEID: SR\_QUOTE\_QUOTELINE\_QUOTEALTERNATIVEID\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/erpProductKey| *None* |SR\_QUOTE\_QUOTELINE\_PRODUCTKEY: SR\_QUOTE\_QUOTELINE\_PRODUCTKEY\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/rank| *None* |SR\_QUOTE\_QUOTELINE\_RANK: SR\_QUOTE\_QUOTELINE\_RANK\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/quantity| *None* |SR\_QUOTE\_QUOTELINE\_QUANTITY: SR\_QUOTE\_QUOTELINE\_QUANTITY\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/name| *None* |SR\_QUOTE\_QUOTELINE\_NAME: SR\_QUOTE\_QUOTELINE\_NAME\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/description| *None* |SR\_QUOTE\_QUOTELINE\_DESCRIPTION: SR\_QUOTE\_QUOTELINE\_DESCRIPTION\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/code| *None* |SR\_QUOTE\_QUOTELINE\_CODE: SR\_QUOTE\_QUOTELINE\_CODE\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/quantityUnit| *None* |SR\_QUOTE\_QUOTELINE\_UNIT: SR\_QUOTE\_QUOTELINE\_UNIT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/priceUnit| *None* |SR\_QUOTE\_QUOTELINE\_PRICEUNIT: SR\_QUOTE\_QUOTELINE\_PRICEUNIT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/url| *None* |SR\_QUOTE\_QUOTELINE\_URL: SR\_QUOTE\_QUOTELINE\_URL\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/subscriptionUnit| *None* |SR\_QUOTE\_QUOTELINE\_SUBSCRIPTIONUNIT: SR\_QUOTE\_QUOTELINE\_SUBSCRIPTIONUNIT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/subscriptionQuantity| *None* |SR\_QUOTE\_QUOTELINE\_SUBSCRIPTIONQUANTITY: SR\_QUOTE\_QUOTELINE\_SUBSCRIPTIONQUANTITY\_TOOLTIP| x |
...
|sale/quote/version/alternative/quoteline/vatInfo| *None* |SR\_QUOTE\_QUOTELINE\_VATINFO: SR\_QUOTE\_QUOTELINE\_VATINFO\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/vat| *None* |SR\_QUOTE\_QUOTELINE\_VAT: SR\_QUOTE\_QUOTELINE\_VAT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/unitCost| *None* |SR\_QUOTE\_QUOTELINE\_UNITCOST: SR\_QUOTE\_QUOTELINE\_UNITCOST\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/unitMinimumPrice| *None* |SR\_QUOTE\_QUOTELINE\_UNITMINIMUMPRICE: SR\_QUOTE\_QUOTELINE\_UNITMINIMUMPRICE\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/unitListPrice| *None* |SR\_QUOTE\_QUOTELINE\_UNITLISTPRICE: SR\_QUOTE\_QUOTELINE\_UNITLISTPRICE\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/totalPrice| *None* |SR\_QUOTE\_QUOTELINE\_TOTALPRICE: SR\_QUOTE\_QUOTELINE\_TOTALPRICE\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/totalCost| *None* |SR\_QUOTE\_QUOTEALTERNATIVE\_TOTALCOST|  |
...
|sale/quote/version/alternative/quoteline/discountAmount| *None* |SR\_QUOTE\_QUOTELINE\_DISCOUNTAMOUNT: SR\_QUOTE\_QUOTELINE\_DISCOUNTAMOUNT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/discountPercent| *None* |SR\_QUOTE\_QUOTELINE\_DISCOUNTPERCENT: SR\_QUOTE\_QUOTELINE\_DISCOUNTPERCENT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/earningAmount| *None* |SR\_QUOTE\_QUOTELINE\_EARNINGAMOUNT: SR\_QUOTE\_QUOTELINE\_EARNINGAMOUNT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/earningPercent| *None* |SR\_QUOTE\_QUOTELINE\_EARNINGPERCENT: SR\_QUOTE\_QUOTELINE\_EARNINGPERCENT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/updatedBy| *None* |SR\_UPDATEDASSOC: SR\_UPDATEDASSOC\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/updatedByFullName| *None* |SR\_UPDATEDASSOC - SR\_ARCHIVE\_ASSOC\_FULLNAME: SR\_UPDATEDASSOC\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/updatedDate| *None* |SR\_UPDATEDDATE: SR\_UPDATEDDATE\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/registeredBy| *None* |SR\_REGISTEREDASSOC: SR\_REGISTEREDASSOC\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/registeredByFullName| *None* |SR\_REGISTEREDASSOC - SR\_ARCHIVE\_ASSOC\_FULLNAME: SR\_REGISTEREDASSOC\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/registeredDate| *None* |SR\_REGISTEREDDATE: SR\_REGISTEREDDATE\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/productCategoryKey| *None* |SR\_QUOTE\_QUOTELINE\_PRODUCTCATEGORYKEY: SR\_QUOTE\_QUOTELINE\_PRODUCTCATEGORYKEY\_TOOLTIP|  |
|sale/quote/version/alternative/quoteline/productFamilyKey| *None* |SR\_QUOTE\_QUOTELINE\_PRODUCTFAMILYKEY: SR\_QUOTE\_QUOTELINE\_PRODUCTFAMILYKEY\_TOOLTIP|  |
|sale/quote/version/alternative/quoteline/productTypeKey| *None* |SR\_QUOTE\_QUOTELINE\_PRODUCTTYPEKEY: SR\_QUOTE\_QUOTELINE\_PRODUCTTYPEKEY\_TOOLTIP|  |
|sale/quote/version/alternative/quoteline/status| *None* |SR\_QUOTE\_QUOTELINE\_QUOTESTATUS: SR\_QUOTE\_QUOTELINE\_QUOTESTATUS\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/subTotal| *None* |SR\_QUOTE\_QUOTELINE\_SUBTOTAL: SR\_QUOTE\_QUOTELINE\_SUBTOTAL\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/vatAmount| *None* |SR\_QUOTE\_QUOTELINE\_VATAMNT: SR\_QUOTE\_QUOTELINE\_VATAMNT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/totalPriceIncVAT| *None* |SR\_QUOTE\_QUOTELINE\_TOTINCVAT: SR\_QUOTE\_QUOTELINE\_TOTINCVAT\_TOOLTIP| x |
|sale/quote/version/alternative/quoteline/totalPriceWithAlternativeDiscount| *None* |SR\_QUOTE\_QUOTELINE\_TOTINCALTDIS: SR\_QUOTE\_QUOTELINE\_TOTINCALTDIS\_TOOLTIP| x |

## Sample

```http!
GET /api/v1/archive/ContactPersonSelectionV2?$select=country,contactAssociate/ejStatus,targetRelation/registeredDate,sale/icon,sale/currencyId
