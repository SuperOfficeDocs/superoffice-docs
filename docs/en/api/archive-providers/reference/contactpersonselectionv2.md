...
```http!
GET /api/v1/archive/ContactPersonSelectionV2?$select=selectionId,contactExtra/x_contact_time,sale/associate/ejStatus,kanaFirstName,personSourceRelation/personNoMail
