...
```http!
GET /api/v1/archive/ContactPersonSelectionV2?$select=restrictionAddress/county,contactAssociate/contactDepartment,fullNameWithContact,personSourceRelation/personAssociateId,request/createdBy/assocTooltip
