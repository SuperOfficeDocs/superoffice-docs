...
```http!
GET /api/v1/archive/ContactPersonSelectionV2?$select=restrictionAddress/line3,contactAssociate/middleName,contactAssociate/simultaneousEjUser,NumberOfNotCompletedTickets,targetRelation/hasInterests
