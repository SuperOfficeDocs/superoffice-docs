...
```http!
GET /api/v1/archive/ContactPersonSelectionV2?$select=email/emailLastSent,contactUdef/SuperOffice:2,contactUdef/SuperOffice:8,sale/sale/textId,sale/saleUdef/SuperOffice:8
