...
```http!
GET /api/v1/archive/ContactPersonSelectionV2?$select=stop,restrictionAddress/line3,targetRelation/personContactRelation,document/icon,personMobilePhone/formattedNumber
