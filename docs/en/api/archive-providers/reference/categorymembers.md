...
|removedRows| *None* ||  |
|editedRows| *None* ||  |
|categoryMembershipId| *None* |SR\_ARCHIVE\_CATEGORYMEMBERS\_ID: SR\_ARCHIVE\_CATEGORYMEMBERS\_ID|  |
|categoryId| *None* |SR\_ARCHIVE\_TICKETNOTIFICATION\_CATEGORYID: SR\_ARCHIVE\_TICKETNOTIFICATION\_CATEGORYID|  |
|weight|int|SR\_ARCHIVE\_CATEGORYMEMBERS\_WEIGHT: SR\_ARCHIVE\_CATEGORYMEMBERS\_WEIGHT| x |
|isDefinedByUsergroup| *None* |SR\_ARCHIVE\_CATEGORYMEMBERS\_IS\_DEFINED\_BY\_USERGROUP: SR\_ARCHIVE\_CATEGORYMEMBERS\_IS\_DEFINED\_BY\_USERGROUP|  |
...
```http!
GET /api/v1/archive/CategoryMembers?$select=mrMrs,contactFullName
