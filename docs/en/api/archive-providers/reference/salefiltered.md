...
```http!
GET /api/v1/archive/SaleFiltered?$select=nextDueDate,person/personSource,person/personAssociate/isActive,person/personAssociate/isLocation,associate/usergroupId
