...
```http!
GET /api/v1/archive/SaleFiltered?$select=heading,person/personExtra/x_person_integer,contact/contactAssociate/portraitThumbnail,project/projectAssociate/usergroupId,project/projectUdef/SuperOffice:8
