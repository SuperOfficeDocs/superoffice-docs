...
```http!
GET /api/v1/archive/SaleFiltered?$select=person/firstName,person/hasInterests,person/personHasInterests,person/personAddress/zip,person/personAssociate/contactFullName
