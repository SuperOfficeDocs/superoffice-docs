...
```http!
GET /api/v1/archive/SaleFiltered?$select=icon,contact/saintSaleStatus,associate/ejStatus,saleStakeholder/person/subscription,saleStakeholder/contact/contactUdef/SuperOffice:12
