...
```http!
GET /api/v1/archive/SaleFiltered?$select=person/birthdate,person/useAsMailingAddress,person/kanaLastName,person/personPager/formattedNumber,person/personAssociate/assocName
