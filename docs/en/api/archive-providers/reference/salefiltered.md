...
```http!
GET /api/v1/archive/SaleFiltered?$select=person/personAssociate/contactName,contact/number,contact/contactAssociate/isLocation,saleStakeholder/person/personAssociateId,saleStakeholder/contact/restrictionAddress/zip
