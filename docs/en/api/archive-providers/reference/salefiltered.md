...
```http!
GET /api/v1/archive/SaleFiltered?$select=activeErpLinks,person/rank,contact/searchPhone/formattedNumber,contact/contactAssociate/mrMrs,project/projectUrl/URLDescription
