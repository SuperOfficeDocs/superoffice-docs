...
```http!
GET /api/v1/archive/SaleFiltered?$select=hasStakeholders,person/personUdef/SuperOffice:10,person/personAssociate/usergroup,person/correspondingAssociate/middleName,person/correspondingAssociate/usergroupId
