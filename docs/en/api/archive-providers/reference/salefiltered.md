...
```http!
GET /api/v1/archive/SaleFiltered?$select=registeredBy,salePublish/isPublished,person/personUdef/SuperOffice:9,person/correspondingAssociate/contactFullName,person/correspondingAssociate/ejStatus
