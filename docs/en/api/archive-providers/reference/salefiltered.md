...
```http!
GET /api/v1/archive/SaleFiltered?$select=getAllRows,saleTypeCategory,contact/contactExtra/x_contact_time,project/projectAssociate/credentialType,project/NumberOfNotCompletedActivities
