...
```http!
GET /api/v1/archive/SaleFiltered?$select=soldReason,person/correspondingAssociate/role,contact/activeErpLinks,contact/contactFax/description,contact/contactUdef/SuperOffice:6
