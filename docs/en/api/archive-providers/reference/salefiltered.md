...
```http!
GET /api/v1/archive/SaleFiltered?$select=currency,person/personCountryId,person/personUpdatedByFullName,person/correspondingAssociate/usergroup,contact/contactFax/description
