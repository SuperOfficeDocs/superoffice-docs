...
```http!
GET /api/v1/archive/SaleFiltered?$select=userGroup,sale/description,person/personExtra/x_person_category_relation,person/personAssociate/usergroup,contact/NumberOfSalesInPeriod
