...
```http!
GET /api/v1/archive/SaleFiltered?$select=activeErpLinks,person/email/emailLastSent,person/personAssociate/lastName,person/personAssociate/assocTooltip,contact/registeredDate
