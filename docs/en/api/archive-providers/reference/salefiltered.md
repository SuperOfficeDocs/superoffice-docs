...
```http!
GET /api/v1/archive/SaleFiltered?$select=saleNumber,person/personMobilePhone/formattedNumber,person/personExtra/x_person_category_relation,person/personAssociate/contactId,contact/stop
