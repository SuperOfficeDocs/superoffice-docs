...
```http!
GET /api/v1/archive/FindAppointment?$select=type,contact/phone/formattedNumber,contact/postAddress/line2,contact/streetAddress/state,contact/contactAssociate/fullName
