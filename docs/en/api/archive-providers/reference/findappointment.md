...
```http!
GET /api/v1/archive/FindAppointment?$select=getAllRows,appointmentPublish/publishedBy,contact/contactAssociate/credentialType,person/correspondingAssociate/locationAddress,associate/credentialType
