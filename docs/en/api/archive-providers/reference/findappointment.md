...
```http!
GET /api/v1/archive/FindAppointment?$select=appointmentPublish/publishedTo,person/restrictionAddress/county,person/personExtra/x_person_longtext,person/correspondingAssociate/ejUserId,project/activeErpLinks
