...
```http!
GET /api/v1/archive/FindAppointment?$select=contact/postAddress/county,contact/contactAssociate/role,contact/contactAssociate/isActiveText,contact/NumberOfTickets,person/personCountryId
