...
```http!
GET /api/v1/archive/FindAppointment?$select=contact/searchPhone/formattedNumber,contact/postAddress/county,contact/streetAddress/county,person/position,person/personInfo/textId
