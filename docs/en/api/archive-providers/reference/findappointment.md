...
```http!
GET /api/v1/archive/FindAppointment?$select=person/personCountry,person/personInfo/infoText,sale/updatedDate,sale/description,sale/saleUdef/SuperOffice:8
