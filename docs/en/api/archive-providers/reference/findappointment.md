...
```http!
GET /api/v1/archive/FindAppointment?$select=contact/contactExtra/x_contact_float,person/position,person/retired,person/personInfo/textId,person/personAddress/wgs84latitude
