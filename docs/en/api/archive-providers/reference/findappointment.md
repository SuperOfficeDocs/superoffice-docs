...
```http!
GET /api/v1/archive/FindAppointment?$select=date,contact/phone/formattedNumber,contact/email/emailLastBounce,contact/email/emailHasBounced,contact/contactExtra/x_contact_timespan
