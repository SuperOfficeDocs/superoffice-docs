...
```http!
GET /api/v1/archive/FindAppointment?$select=registeredDate,contact/contactAssociate/assocTooltip,person/portraitThumbnail,person/ticketPriority,person/personAssociate/simultaneousEjUser
