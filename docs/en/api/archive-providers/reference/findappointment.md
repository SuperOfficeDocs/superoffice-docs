...
```http!
GET /api/v1/archive/FindAppointment?$select=person/correspondingAssociate/credentialDisplayValue,project/projectUrl/URLDescription,sale/associate/simultaneousEjUser,sale/saleUdef/SuperOffice:8
