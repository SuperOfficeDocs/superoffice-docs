...
```http!
GET /api/v1/archive/FindAppointment?$select=contact/contactAssociate/lastName,person/useAsMailingAddress,person/personAddress/line3,person/personAddress/zip,person/personAssociate/ejDisplayName
