...
```http!
GET /api/v1/archive/FindAppointment?$select=registeredBy,person/personHasInterests,person/useAsMailingAddress,person/personUdef/SuperOffice:3,appointmentUdef/SuperOffice:2
