...
```http!
GET /api/v1/archive/FindAppointment?$select=contact/streetAddress/city,person/birthYear,person/personExtra/x_person_float,person/personAssociate/lastName,person/correspondingAssociate/assocType
