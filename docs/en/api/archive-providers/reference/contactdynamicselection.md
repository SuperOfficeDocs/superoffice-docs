...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=streetAddress/county,NumberOfNotCompletedSales,appointment/associate/title,document/type,document/documentPublish/publishedTo
