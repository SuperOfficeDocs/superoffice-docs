...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactExtra/x_contact_shorttext,sale/sale/textId,appointment/associate/otherGroups,appointment/appointment/description,portraitThumbnail
