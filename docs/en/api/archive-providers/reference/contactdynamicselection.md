...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=restrictionAddress/line3,contactAssociate/contactId,contactAssociate/mrMrs,sale/userGroup,document/contactId
