...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=sale/associate/mrMrs,appointment/rawStatus,document/associate/contactFullName,personAssociateFullName,personAssociate/contactName
