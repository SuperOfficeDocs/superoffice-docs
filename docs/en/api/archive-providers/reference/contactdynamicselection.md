...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=restrictionAddress/wgs84longitude,sourceRelation/countryId,document/updatedBy,document/associate/contactDepartment,fullName
