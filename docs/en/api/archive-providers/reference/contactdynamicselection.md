...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=sourceRelation/business,sale/associate/title,appointment/alarm,personSourceRelation/personRegisteredBy,personTargetRelation/personRegisteredBy
