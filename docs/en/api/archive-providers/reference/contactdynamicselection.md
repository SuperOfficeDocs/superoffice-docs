...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=rowKind,contactUdef/SuperOffice:2,personUdef/SuperOffice:5,personExtra/x_person_integer,personSourceRelation/personUpdatedByFullName
