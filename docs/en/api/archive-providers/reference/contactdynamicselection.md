...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=sourceRelation/department,sale/associate/isActiveText,personEmail/emailHasBounced,personExtra/x_person_boolean,personExtra/y_rental/x_contact
