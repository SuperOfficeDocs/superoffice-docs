...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=targetRelation/updatedDate,targetRelation/contactDeleted,appointment/visibleInDiary,middleName,personTargetRelation/hasCompany
