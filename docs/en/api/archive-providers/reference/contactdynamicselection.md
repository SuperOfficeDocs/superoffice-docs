...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactAssociate/portraitThumbnail,LastTicket,sale/saleUdef/SuperOffice:7,appointment/time,appointment/contactId
