...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=postAddress/state,contactAssociate/contactFullName,sale/associate/assocTooltip,appointment/visibleFor,personUpdatedBy
