...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactAssociate/userName,contactUdef/SuperOffice:11,personUrl/URLAddress,personSourceRelation/whenUpdatedByWorkflow,correspondingAssociate/personId
