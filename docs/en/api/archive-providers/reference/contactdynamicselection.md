...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=postAddress/line2,NumberOfActivitiesInPeriod,saintAmountClass,sourceRelation/business,appointment/completed
