...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=email/emailLastBounce,contactExtra/x_contact_request_relation,targetRelation/updatedDate,targetRelation/registeredDate,appointment/registeredBy
