...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=sourceRelation/contactNoMail,sourceRelation/deletedDate,appointment/icon,document/saleId,document/associate/assocTooltip
