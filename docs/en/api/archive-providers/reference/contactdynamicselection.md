...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactExtra/x_contact_contact,NumberOfNotCompletedActivities,sale/updatedByFullName,appointment/joinVideomeetUrl,personAssociate/otherGroups
