...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactUdef/SuperOffice:5,targetRelation/registeredByFullName,appointment/associateId,appointment/intention,document/associate/role
