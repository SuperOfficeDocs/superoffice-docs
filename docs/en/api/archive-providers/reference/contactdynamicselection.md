...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=LastSale,sale/userGroup,appointment/completedDate,appointment/associate/contactId,appointment/associate/assocTooltip
