...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=updatedBy,contactAssociate/contactFullName,sale/amount,sale/stalledComment,sale/salePublish/publishedBy
