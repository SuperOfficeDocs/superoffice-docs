...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=streetAddress/line1,contactAssociate/portraitThumbnail,contactUdef/SuperOffice:7,sale/text,sale/saleId
