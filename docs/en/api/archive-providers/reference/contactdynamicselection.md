...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=saintActivityType,sale/associateId,sale/associate/isActiveText,appointment/joinVideomeetUrl,appointment/createdByWorkflow
