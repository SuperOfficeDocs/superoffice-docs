...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=appointment/associate/credentialType,document/icon,document/documentUdef/SuperOffice:3,personAddress/wgs84latitude
