...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=business,streetAddress/wgs84longitude,contactExtra/x_contact_boolean,SaintStatus1,targetRelation/contactSource
