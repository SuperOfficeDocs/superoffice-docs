...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=number,contactNoMail,postAddress/addressId,sale/updatedDate,appointment/appointmentPublish/publishedFrom
