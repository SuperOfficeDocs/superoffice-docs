...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactAssociate/assocName,contactExtra/x_contact_contact,LastTicket,sourceRelation/activeErpLinks,sale/saleUdef/SuperOffice:7
