...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=registeredDate,contactUdef/SuperOffice:13,sale/stageRank,sale/hasQuote,personSourceRelation/personHasInterests
