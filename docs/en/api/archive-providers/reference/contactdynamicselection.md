...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=updatedByFullName,postAddress/formattedAddress,sale/associate/associateDbId,document/associate/associateDbId,personExtra/y_rental/x_end
