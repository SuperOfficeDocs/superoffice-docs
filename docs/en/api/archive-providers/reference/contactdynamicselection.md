...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactPhone/description,streetAddress/county,targetRelation/updatedByFullName,sale/projectId,document/documentUdef/SuperOffice:4
