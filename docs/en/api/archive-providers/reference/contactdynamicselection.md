...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=contactAssociate/contactDepartment,sourceRelation/associateId,sale/date,sale/associateId,sale/description
