...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=restrictionAddress/formattedAddress,contactAssociate/ejDisplayName,sale/text,sale/visibleFor,appointment/text
