...
```http!
GET /api/v1/archive/ContactDynamicSelection?$select=email/emailId,contactAssociate/usergroup,contactExtra/x_contact_timespan,sale/earningPercent,sale/associate/contactCategory
