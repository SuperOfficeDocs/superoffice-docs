...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/email/emailLastBounce,person/firstName,person/phone/formattedNumber,person/restrictionAddress/addressId,project/projectPublish/publishedBy
