...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=updatedDate,contact/postAddress/zip,contact/contactAssociate/isActive,person/personPager/formattedNumber,project/imageThumbnail
