...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/contactAssociate/isActiveText,contact/contactAssociate/isLocation,contact/contactExtra/x_contact_default_integer,contact/contactExtra/x_contact_request_relation,contact/NumberOfTickets
