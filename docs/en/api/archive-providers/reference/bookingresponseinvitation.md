...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/streetAddress/formattedAddress,contact/saintTicketStatus,person/personAddress/wgs84longitude,sale/salePublish/publishedTo
