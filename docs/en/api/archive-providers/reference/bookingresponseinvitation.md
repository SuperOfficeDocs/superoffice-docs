...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=appointmentPublish/isPublished,person/personUrl/URLAddress,person/restrictionAddress/line1,person/personAssociate/locationAddress,sale/saleId
