...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/saintDirection,person/personHasInterests,person/correspondingAssociate/contactId,project/hasGuide,project/projectAssociate/personEmail
