...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=endTime,contact/code,contact/contactDeleted,contact/contactAssociate/contactCategory,contact/contactAssociate/isActive
