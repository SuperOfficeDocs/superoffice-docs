...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/updatedBy,contact/email/emailAddress,contact/contactAssociate/portraitThumbnail,person/personAssociate/isLocation,project/registeredDate
