...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/email/emailBounceCount,person/personAssociate/assocTooltip,person/correspondingAssociate/fullName
