...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/nameDepartment,contact/associateId,contact/contactAssociate/isActive,contact/contactExtra/x_contact_request_relation,person/mrMrs
