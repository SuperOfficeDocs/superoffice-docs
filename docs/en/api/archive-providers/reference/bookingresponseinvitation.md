...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=recurring,person/personBusiness,person/correspondingAssociate/ejDisplayName,person/correspondingAssociate/otherGroups,project/status
