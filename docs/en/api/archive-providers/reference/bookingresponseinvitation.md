...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/postAddress/zip,person/hasInfoText,person/kanaFirstName,person/personPager/description,person/correspondingAssociate/role
