...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/contactNoMail,contact/contactAssociate/assocName,contact/contactUdef/SuperOffice:2,person/firstName,project/updatedDate
