...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=priority,person/hasInterests,person/personPrivate/description,person/personUdef/SuperOffice:2,project/icon
