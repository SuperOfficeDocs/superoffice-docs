...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/stop,contact/streetAddress/state,contact/contactAssociate/ejStatus,contact/contactAssociate/otherGroups,person/personAssociate/usergroupId
