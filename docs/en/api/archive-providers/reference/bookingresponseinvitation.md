...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=text,joinVideomeetUrl,contact/streetAddress/addressId,contact/streetAddress/formattedMultiLineAddress,contact/contactExtra/x_contact_hidden_integer
