...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=contact/mainContact,contact/contactAssociate/usergroupId,contact/LastCompletedSale,person/hasCompany,person/personAssociate/role
