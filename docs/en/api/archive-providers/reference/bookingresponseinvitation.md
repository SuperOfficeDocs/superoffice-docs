...
```http!
GET /api/v1/archive/BookingResponseInvitation?$select=text,recordTypeText,contact/url/URLDescription,contact/SaintStatus2,person/restrictionAddress/line1
