...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=salePublish/publishedTo,contact/contactAssociate/contactDepartment,contact/contactExtra/x_contact_time,appointment/text,document/subject
