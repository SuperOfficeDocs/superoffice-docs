...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/hasInfoText,person/personExtra/x_person_shorttext,person/personAssociate/contactFullName,appointment/associate/contactFullName,project/LastCompletedSale
