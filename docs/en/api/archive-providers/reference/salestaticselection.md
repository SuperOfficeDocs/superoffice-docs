...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=saleTypeId,person/email/emailHasBounced,person/personAssociate/assocTooltip,contact/contactFax/formattedNumber,contact/contactAssociate/otherGroups
