...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/personAddress/formattedMultiLineAddress,appointment/time,appointment/associate/mrMrs,project/projectAssociate/fullName,project/projectAssociate/title
