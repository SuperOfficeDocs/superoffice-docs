...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=associateId,person/personUpdatedByFullName,contact/phone/formattedNumber,contact/streetAddress/city,contact/streetAddress/state
