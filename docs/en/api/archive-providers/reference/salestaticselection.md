...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=personId,person/personAddress/city,person/personExtra/x_person_float,person/legalBaseEmarketing,contact/deletedDate
