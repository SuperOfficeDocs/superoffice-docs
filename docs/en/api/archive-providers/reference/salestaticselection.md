...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=stage,saleTypeCategory,person/hasInfoText,person/personPager/formattedNumber,person/personUrl/URLAddress
