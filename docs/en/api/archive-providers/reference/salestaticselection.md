...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=visibleFor,person/portraitThumbnail,person/personUrl/URLAddress,person/personExtra/x_person_integer,person/personAssociate/otherGroups
