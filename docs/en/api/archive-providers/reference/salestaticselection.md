...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=visibleFor,contact/postAddress/line3,appointment/associate/isLocation,project/projectUrl/URLDescription,project/projectUdef/SuperOffice:10
