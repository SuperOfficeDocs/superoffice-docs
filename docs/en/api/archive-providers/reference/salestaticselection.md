...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=earningPercent,hasQuote,person/email/emailHasBounced,contact/searchPhone/description,contact/url/URLAddress
