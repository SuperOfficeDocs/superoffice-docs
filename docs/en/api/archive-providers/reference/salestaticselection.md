...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/middleName,person/personExtra/x_person_float,contact/contactId,appointment/isMilestone,appointment/associate/isActive
