...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=updatedByFullName,createdByWorkflow,person/personUpdatedByFullName,person/supportAssociate,person/personCategoryGroup
