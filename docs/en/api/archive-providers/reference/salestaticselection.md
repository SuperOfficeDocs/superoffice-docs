...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/position,person/personExtra/x_person_time,person/personAssociate/middleName,contact/nameDepartment,contact/contactAssociate/credentialDisplayValue
