...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/personMobilePhone/description,person/correspondingAssociate/assocName,person/consentSourceEmarketing,contact/orgnr,appointment/projectId
