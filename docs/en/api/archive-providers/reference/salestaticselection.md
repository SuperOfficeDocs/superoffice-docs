...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/personUdef/SuperOffice:10,person/personAssociate/contactId,contact/phone/formattedNumber,contact/LastTicket,contact/saintIntention
