...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=saleNumber,person/personAddress/zip,contact/name,contact/contactSource,contact/contactAssociate/assocName
