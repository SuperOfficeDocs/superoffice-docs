...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=competitor,person/personNoMail,person/personAssociate/contactCategory,person/personAssociate/userName,person/correspondingAssociate/isActiveText
