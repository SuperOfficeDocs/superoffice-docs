...
```http!
GET /api/v1/archive/SaleStaticSelection?$select=person/useAsMailingAddress,person/personActiveErpLinks,person/personExtra/x_person_priority_relation,person/correspondingAssociate/personId,contact/contactAssociate/middleName
