...
```http!
GET /api/v1/archive/mailingfavourites?$select=mailingFrom,mailingAddr/contact/mainContact,mailingAddr/contact/LastTicket,mailingAddr/person/contactId,mailingAddr/person/personAddress/state
