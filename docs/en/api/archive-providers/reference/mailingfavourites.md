...
```http!
GET /api/v1/archive/mailingfavourites?$select=mailingAddr/contact/hasInfoText,mailingAddr/contact/contactAssociate/isActiveText,mailingAddr/person/personCountry,mailingAddr/person/personAddress/line1
