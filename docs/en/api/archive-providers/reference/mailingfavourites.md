...
```http!
GET /api/v1/archive/mailingfavourites?$select=mailingAddr/contact/contactExtra/x_contact_integer,mailingAddr/person/correspondingAssociate/userName,project/NumberOfNotCompletedSales
