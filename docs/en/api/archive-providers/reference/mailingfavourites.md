...
```http!
GET /api/v1/archive/mailingfavourites?$select=mailingAddr/contact/restrictionAddress/formattedAddress,mailingAddr/contact/saintAmountClass,mailingAddr/person/restrictionAddress/wgs84latitude
