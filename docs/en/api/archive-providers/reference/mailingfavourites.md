...
```http!
GET /api/v1/archive/mailingfavourites?$select=mailingAddr/contact/streetAddress/state,mailingAddr/person/email/emailBounceCount,mailingAddr/person/restrictionAddress/county
