...
```http!
GET /api/v1/archive/mailingfavourites?$select=entityIcon,mailingAddr/contact/orgnr,mailingAddr/person/mrMrs,mailingAddr/person/title,mailingAddr/person/birthMonth
