...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=stageName,person/personDirectPhone/description,person/personExtra/x_person_contact_relation,person/personAssociate/contactFullName,contact/nameDepartment
