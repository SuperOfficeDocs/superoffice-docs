...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/firstName,contact/contactNoMail,contact/contactAssociate/contactName,appointment/appointmentUdef/SuperOffice:6,document/associate/usergroup
