...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=stalledComment,person/personCategory,person/leadstatus,person/updatedByWorkflow,person/personExtra/x_person_user_relation
