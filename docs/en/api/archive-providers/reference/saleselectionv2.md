...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/personCategory,contact/saintAmountClass,document/mailMergeDraft,saleStakeholder/contact/activeErpLinks,saleStakeholder/contact/streetAddress/state
