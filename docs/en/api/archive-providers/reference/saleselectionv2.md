...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/personAddress/line1,person/correspondingAssociate/simultaneousEjUser,person/correspondingAssociate/otherGroups,contact/streetAddress/addressId,appointment/associate/assocType
