...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/rank,contact/NumberOfNotCompletedSalesInPeriod,associate/simultaneousEjUser,appointment/updatedBy,appointment/associate/usergroup
