...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/personNumber,person/email/emailBounceCount,contact/deletedDate,project/projectEvent/isExternalEvent,project/projectAssociate/locationAddress
