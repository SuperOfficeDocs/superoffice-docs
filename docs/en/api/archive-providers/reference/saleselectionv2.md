...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=stalledComment,person/personRegisteredDate,person/personExtra/x_person_integer,contact/deletedDate,contact/contactAssociate/assocTooltip
