...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/personNumber,contact/contactDeleted,contact/restrictionAddress/formattedAddress,associate/contactDepartment,appointment/recurrenceRuleId
