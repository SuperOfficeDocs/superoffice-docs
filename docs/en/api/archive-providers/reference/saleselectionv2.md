...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=person/createdByForm,person/personAssociate/locationAddress,contact/LastDoByTicket,associate/otherGroups,document/time
