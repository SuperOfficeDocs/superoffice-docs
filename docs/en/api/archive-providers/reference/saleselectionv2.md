...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=type,person/personAssociate/assocType,contact/contactUdef/SuperOffice:1,contact/NumberOfActivities,associate/isActiveText
