...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=stalledComment,person/hasInfoText,person/email/emailLastBounce,person/personAddress/formattedMultiLineAddress,person/restrictionAddress/formattedMultiLineAddress
