...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=visibleFor,person/searchPhone/description,person/personUrl/URLAddress,person/personAssociate/personId,person/correspondingAssociate/isActiveText
