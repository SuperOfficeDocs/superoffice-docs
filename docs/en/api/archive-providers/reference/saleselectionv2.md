...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=salePublish/isPublished,contact/contactFax/description,contact/contactExtra/x_contact_timespan,associate/userName,document/associate/isActiveText
