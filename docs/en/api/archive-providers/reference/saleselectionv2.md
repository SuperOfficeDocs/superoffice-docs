...
```http!
GET /api/v1/archive/SaleSelectionV2?$select=userGroup,person/personUdef/SuperOffice:6,person/personAssociate/personId,person/correspondingAssociate/personId,contact/updatedByFullName
