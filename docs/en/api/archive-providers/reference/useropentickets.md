...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ownedBy/ejStatus,person/personAssociate/personEmail,contact/business,contact/contactAssociate/firstName,contact/contactExtra/x_contact_hidden_integer
