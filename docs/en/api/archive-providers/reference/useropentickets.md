...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/firstName,person/associateType,person/personAssociate/associateDbId,contact/LastDoBySale,sale/completed
