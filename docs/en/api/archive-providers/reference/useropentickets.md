...
```http!
GET /api/v1/archive/UserOpenTickets?$select=createdBy/ejStatus,createdBy/credentialType,ownedBy/portraitThumbnail,person/birthYear,person/personAddress/state
