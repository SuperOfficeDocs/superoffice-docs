...
```http!
GET /api/v1/archive/UserOpenTickets?$select=createdBy/usergroup,person/personDeletedDate,person/searchPhone/description,contact/mainContact,contact/streetAddress/addressId
