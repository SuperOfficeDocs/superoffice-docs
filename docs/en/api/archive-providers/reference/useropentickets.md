...
```http!
GET /api/v1/archive/UserOpenTickets?$select=firstReadByOwner,person/personUdef/SuperOffice:6,contact/contactAssociate/contactId,contact/LastDoByTicket,sale/currencyId
