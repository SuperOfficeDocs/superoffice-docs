...
```http!
GET /api/v1/archive/UserOpenTickets?$select=realTimeSpentInternally,timeSpentInternally,contact/nameDepartment,contact/contactAssociate/assocName,contact/contactAssociate/userName
