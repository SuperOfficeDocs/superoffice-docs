...
```http!
GET /api/v1/archive/UserOpenTickets?$select=realTimeToClose,person/legalBaseEmarketing,contact/companyCategoryRank,contact/updatedByFullName,contact/contactAssociate/contactCategory
