...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ticketStatusName,person/personMobilePhone/description,person/personExtra/y_rental/x_end,extra/x_ticket_timestamp,sale/associate/locationAddress
