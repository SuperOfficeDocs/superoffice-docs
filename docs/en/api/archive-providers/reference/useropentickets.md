...
```http!
GET /api/v1/archive/UserOpenTickets?$select=createdAt,ownedBy/usergroupId,person/personDirectFax/description,person/personAssociate/otherGroups,contact/activeErpLinks
