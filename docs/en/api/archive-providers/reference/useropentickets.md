...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/personCountryId,person/personExtra/x_person_float,person/personExtra/x_person_request_relation,contact/contactAssociate/personId
