...
```http!
GET /api/v1/archive/UserOpenTickets?$select=timeSpentInternally,createdBy/lastName,person/personMobilePhone/description,contact/contactUdef/SuperOffice:12,extra/x_ticket_datetime
