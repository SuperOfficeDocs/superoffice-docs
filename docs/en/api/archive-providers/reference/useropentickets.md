...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/personSource,person/restrictionAddress/line1,person/personExtra/x_person_longtext,contact/postAddress/line2,sale/personId
