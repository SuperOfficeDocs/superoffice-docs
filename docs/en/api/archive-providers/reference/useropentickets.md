...
```http!
GET /api/v1/archive/UserOpenTickets?$select=suggestedCategory,ownedBy/contactId,person/personDirectFax/formattedNumber,person/restrictionAddress/formattedAddress,contact/phone/formattedNumber
