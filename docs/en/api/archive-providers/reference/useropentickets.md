...
```http!
GET /api/v1/archive/UserOpenTickets?$select=contact/name,contact/contactPhone/formattedNumber,contact/restrictionAddress/wgs84longitude,sale/associateId
