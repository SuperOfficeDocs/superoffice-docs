...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/birthdate,person/restrictionAddress/wgs84longitude,person/personExtra/y_rental/x_end,person/correspondingAssociate/ejUserId,contact/name
