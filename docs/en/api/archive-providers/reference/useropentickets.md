...
```http!
GET /api/v1/archive/UserOpenTickets?$select=contact/searchPhone/description,sale/associate/role,sale/saleUdef/SuperOffice:7,project/projectUdef/SuperOffice:6
