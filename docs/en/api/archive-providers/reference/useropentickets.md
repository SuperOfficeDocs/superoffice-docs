...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/personId,person/correspondingAssociate/isActive,person/legalBaseStore,contact/hasInterests,contact/searchPhone/formattedNumber
