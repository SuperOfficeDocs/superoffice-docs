...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/supportLanguage,person/personAssociate/ejStatus,sale/associate/credentialDisplayValue,project/projectAssociate/personEmail
