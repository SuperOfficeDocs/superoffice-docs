...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/personExtra/y_rental/x_start,contact/contactAssociate/isActiveText,contact/LastCompletedSale,sale/projectId,sale/updatedBy
