...
```http!
GET /api/v1/archive/UserOpenTickets?$select=createdBy/contactName,createdBy/contactCategory,createdBy/credentialType,person/email/emailLastSent,person/personExtra/x_person_contact_relation
