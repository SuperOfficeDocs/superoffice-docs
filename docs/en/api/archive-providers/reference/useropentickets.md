...
```http!
GET /api/v1/archive/UserOpenTickets?$select=categoryId,person/personCategory,person/personAssociate/assocName,person/correspondingAssociate/fullName,contact/email/emailId
