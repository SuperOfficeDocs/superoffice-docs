...
```http!
GET /api/v1/archive/UserOpenTickets?$select=readByOwner,createdBy/isLocation,person/personAddress/wgs84latitude,person/personAssociate/credentialType,contact/contactPhone/description
