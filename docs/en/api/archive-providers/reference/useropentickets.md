...
```http!
GET /api/v1/archive/UserOpenTickets?$select=createdBy/ejStatus,ownedBy/credentialDisplayValue,person/personExtra/x_person_appointment_relation,contact/email/emailProtocol,contact/NumberOfSales
