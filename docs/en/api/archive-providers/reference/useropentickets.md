...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ownedBy/lastName,person/personAssociate/contactId,person/correspondingAssociate/otherGroups,contact/email/emailHasBounced,contact/restrictionAddress/city
