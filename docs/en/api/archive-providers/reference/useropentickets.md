...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ownedBy/isLocation,person/email/emailId,person/personAssociate/fullName,contact/contactExtra/x_contact_time,project/projectAssociate/locationAddress
