...
```http!
GET /api/v1/archive/UserOpenTickets?$select=createdBy,person/personBusiness,contact/LastDoByTicket,extra/x_ticket_timespan,project/projectAssociate/middleName
