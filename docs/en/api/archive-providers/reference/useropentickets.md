...
```http!
GET /api/v1/archive/UserOpenTickets?$select=connectId,createdBy/usergroup,ownedBy/middleName,person/personUdef/SuperOffice:11,person/correspondingAssociate/isActiveText
