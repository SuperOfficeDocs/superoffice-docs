...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ticketPriority/rank,person/personCategory,person/leadStatus,person/personAssociate/assocTooltip,project/projectUrl/URLAddress
