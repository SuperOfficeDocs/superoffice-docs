...
```http!
GET /api/v1/archive/UserOpenTickets?$select=status,person/supportLanguage,person/personExtra/y_rental/x_start,contact/postAddress/line1,project/projectAssociate/assocType
