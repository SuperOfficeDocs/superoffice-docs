...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ownedBy/credentialDisplayValue,person/isProjectMember,contact/email/emailDescription,contact/contactUdef/SuperOffice:3,sale/sale/description
