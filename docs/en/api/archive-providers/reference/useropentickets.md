...
```http!
GET /api/v1/archive/UserOpenTickets?$select=person/contactId,person/personAddress/county,person/personAssociate/credentialDisplayValue,contact/contactDeleted,contact/email/emailAddress
