...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ownedBy/ejUserId,person/restrictionAddress/addressId,person/personExtra/x_person_date,person/correspondingAssociate/ejDisplayName,contact/countryId
