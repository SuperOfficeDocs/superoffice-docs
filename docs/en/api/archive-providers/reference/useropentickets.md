...
```http!
GET /api/v1/archive/UserOpenTickets?$select=createdBy/otherGroups,person/personRegisteredBy,person/email/emailBounceCount,person/personExtra/x_person_category_relation,person/personAssociate/middleName
