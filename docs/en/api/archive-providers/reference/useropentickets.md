...
```http!
GET /api/v1/archive/UserOpenTickets?$select=ownedBy/assocTooltip,person/fullName,contact/hasInterests,contact/contactAssociate/simultaneousEjUser,contact/LastDoByTicket
