...
```http!
GET /api/v1/archive/SavedReports?$select=mailMergeDraft,contact/contactUdef/SuperOffice:1,project/projectPublish/publishedBy,project/projectUdef/SuperOffice:6,sale/probPercent
