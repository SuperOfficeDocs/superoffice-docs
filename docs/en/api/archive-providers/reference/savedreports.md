...
```http!
GET /api/v1/archive/SavedReports?$select=text,person/personUdef/SuperOffice:8,contact/restrictionAddress/line1,project/associateId,project/projectAssociate/contactId
