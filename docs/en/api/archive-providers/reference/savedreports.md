...
```http!
GET /api/v1/archive/SavedReports?$select=person/personSource,person/supportLanguage,person/correspondingAssociate/otherGroups,person/withdrawnStoreConsent,contact/contactFax/description
