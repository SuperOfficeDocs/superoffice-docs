...
```http!
GET /api/v1/archive/SavedReports?$select=person/personAssociateId,person/personPager/description,person/personUdef/SuperOffice:7,person/personExtra/x_person_date,contact/registeredDate
