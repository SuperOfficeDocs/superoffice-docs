...
```http!
GET /api/v1/archive/SavedReports?$select=person/correspondingAssociate/assocName,contact/registeredByFullName,contact/streetAddress/state,contact/LastCompletedTicket,contact/saintActivityType
