...
```http!
GET /api/v1/archive/SavedReports?$select=person/correspondingAssociate/usergroup,sale/associate/simultaneousEjUser,person/correspondingAssociate/contactCategory
