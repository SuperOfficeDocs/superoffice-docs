...
```http!
GET /api/v1/archive/SavedReports?$select=person/personId,person/middleName,person/personAssociate/firstName,contact/searchPhone/description,contact/streetAddress/line3
