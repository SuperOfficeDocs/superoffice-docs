...
```http!
GET /api/v1/archive/SavedReports?$select=person/email/emailProtocol,contact/contactPhone/description,contact/email/emailHasBounced,contact/restrictionAddress/line1,contact/restrictionAddress/line2
