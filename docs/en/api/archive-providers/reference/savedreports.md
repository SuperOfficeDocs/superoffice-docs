...
```http!
GET /api/v1/archive/SavedReports?$select=person/firstName,person/personInfo/textId,person/personInfo/infoText,contact/contactAssociate/credentialType,project/registeredDate
