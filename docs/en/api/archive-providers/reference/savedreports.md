...
```http!
GET /api/v1/archive/SavedReports?$select=person/personAssociate/personId,person/correspondingAssociate/associateDbId,contact/contactUdef/SuperOffice:8,contact/saintActivityType,project/projectEvent/hasSignOn
