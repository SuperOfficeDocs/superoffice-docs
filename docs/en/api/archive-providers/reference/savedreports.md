...
```http!
GET /api/v1/archive/SavedReports?$select=person/personDirectFax/description,person/correspondingAssociate/contactCategory,contact/contactAssociate/firstName
