...
```http!
GET /api/v1/archive/SavedReports?$select=documentPublish/publishedBy,person/personRegisteredBy,person/correspondingAssociate/isActive,contact/saintIntention,project/icon
