...
```http!
GET /api/v1/archive/SavedReports?$select=person/personInfo/textId,person/personAssociate/title,person/personAssociate/isLocation,contact/name,contact/contactAssociate/assocType
