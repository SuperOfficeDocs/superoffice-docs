...
```http!
GET /api/v1/archive/SavedReports?$select=person/personAddress/line3,person/correspondingAssociate/ejDisplayName,contact/hasInfoText,contact/SaintStatus1,project/icon
