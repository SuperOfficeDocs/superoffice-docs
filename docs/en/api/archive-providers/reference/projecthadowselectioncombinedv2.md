...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=sale/saleUdef/SuperOffice:8,document/associate/contactCategory,projectMember/registered,projectMember/hasInterests,projectMember/personCategoryGroup
