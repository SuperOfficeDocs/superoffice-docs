...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=sale/type,sale/source,appointment/isFree,appointment/duration,projectMember/personAssociate/portraitThumbnail
