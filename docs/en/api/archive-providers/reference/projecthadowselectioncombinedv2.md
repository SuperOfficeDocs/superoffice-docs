...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectAssociate/lastName,sale/type,sale/reopenDate,appointment/associate/credentialDisplayValue,projectMember/personAssociate/personId
