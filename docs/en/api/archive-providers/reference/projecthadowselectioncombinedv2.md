...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectAssociate/contactCategory,sale/hasGuide,document/contactId,projectMember/position,projectMember/personActiveErpLinks
