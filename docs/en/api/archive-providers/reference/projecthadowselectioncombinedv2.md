...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=getNoRows,projectEvent/isExternalEvent,appointment/cautionWarning,appointment/appointment/internalNotesHtml,projectMember/personUpdatedBy
