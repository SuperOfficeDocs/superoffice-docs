...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectUdef/SuperOffice:5,document/documentUdef/SuperOffice:4,projectMember/personId,projectMember/contactNoMail,projectMember/LastDoByTicket
