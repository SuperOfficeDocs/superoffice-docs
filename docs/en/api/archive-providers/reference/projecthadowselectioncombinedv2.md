...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectEvent/hasSignOff,sale/associate/associateDbId,sale/saleUdef/SuperOffice:1,appointment/userGroup,appointment/associate/usergroup
