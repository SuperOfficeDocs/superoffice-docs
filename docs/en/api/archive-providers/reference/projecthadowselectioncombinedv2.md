...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectAssociate/ejUserId,saintAmountClass,sale/saleNumber,document/mailMergeDraft,projectMember/mrMrs
