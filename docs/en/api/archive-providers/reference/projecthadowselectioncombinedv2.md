...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=sale/time,projectMember/personExtra/x_person_category_relation,projectMember/personAssociate/isActive,projectMember/number
