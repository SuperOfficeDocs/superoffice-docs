...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectAssociate/mrMrs,sale/associate/title,sale/associate/assocType,sale/associate/isActiveText,appointment/completed
