...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectId,projectAssociate/portraitThumbnail,projectUdef/SuperOffice:10,sale/associate/userName,projectMember/personAssociate/isActive
