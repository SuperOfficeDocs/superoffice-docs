...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=appointment/completedDate,projectMember/personAssociate/userName,projectMember/postAddress/wgs84latitude
