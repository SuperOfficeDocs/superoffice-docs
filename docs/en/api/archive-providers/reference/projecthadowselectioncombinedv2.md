...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=sale/updatedBy,appointment/rawType,appointment/endTime,document/associate/fullName,document/associate/contactName
