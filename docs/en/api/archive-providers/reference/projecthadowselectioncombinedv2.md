...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectEvent/eventDate,sale/associate/isActiveText,appointment/type,appointment/rawStatus,projectMember/personDirectFax/description
