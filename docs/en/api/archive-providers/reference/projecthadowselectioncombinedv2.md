...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectAssociate/contactName,projectAssociate/isActiveText,sale/hasQuote,sale/associate/mrMrs,appointment/location
