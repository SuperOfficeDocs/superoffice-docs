...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=sale/salePublish/publishedTo,appointment/recordType,appointment/userGroup,projectMember/deletedDate
