...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectAssociate/contactFullName,sale/registeredByFullName,appointment/associate/contactDepartment,document/isReport,document/documentUdef/SuperOffice:8
