...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=registeredBy,LastDoByActivity,appointment/registeredBy,projectMember/email/emailHasBounced,projectMember/streetAddress/wgs84longitude
