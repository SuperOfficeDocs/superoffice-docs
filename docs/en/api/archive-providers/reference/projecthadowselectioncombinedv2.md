...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=completed,projectPublish/publishedBy,appointment/associate/contactId,document/updatedBy,projectMember/middleName
