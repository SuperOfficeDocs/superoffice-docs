...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectAssociate/role,projectUdef/SuperOffice:7,sale/updatedDate,sale/amount,sale/associate/simultaneousEjUser
