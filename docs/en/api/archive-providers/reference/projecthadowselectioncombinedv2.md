...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=associateId,NumberOfActivitiesInPeriod,sale/associate/otherGroups,document/date,projectMember/contactId
