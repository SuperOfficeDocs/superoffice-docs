...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=name,saintActivityType,sale/associate/ejStatus,projectMember/personHasInterests,projectMember/correspondingAssociate/personEmail
