...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombinedV2?$select=projectUdef/SuperOffice:2,LastCompletedActivity,sale/updatedByFullName,sale/credited,sale/associate/usergroup
