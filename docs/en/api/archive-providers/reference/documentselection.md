...
```http!
GET /api/v1/archive/DocumentSelection?$select=contact/restrictionAddress/formattedAddress,contact/contactAssociate/usergroupId,contact/contactAssociate/personEmail,contact/saintDirection,project/projectPublish/publishedFrom
