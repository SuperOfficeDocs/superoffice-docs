...
```http!
GET /api/v1/archive/DocumentSelection?$select=subject,person/restrictionAddress/state,person/correspondingAssociate/ejDisplayName,person/correspondingAssociate/personEmail,contact/updatedBy
