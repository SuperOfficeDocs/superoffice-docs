...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/rank,person/personUpdatedDate,person/searchPhone/description,person/correspondingAssociate/ejStatus,contact/registeredDate
