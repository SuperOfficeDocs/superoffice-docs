...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personUdef/SuperOffice:3,person/correspondingAssociate/locationAddress,project/projectUdef/SuperOffice:10,project/saintSaleStatus
