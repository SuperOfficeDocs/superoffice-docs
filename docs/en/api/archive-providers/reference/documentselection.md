...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personPager/description,person/searchPhone/description,contact/name,contact/updatedDate,contact/NumberOfNotCompletedSales
