...
```http!
GET /api/v1/archive/DocumentSelection?$select=recordTypeText,person/personAddress/wgs84latitude,contact/department,contact/restrictionAddress/county,project/SaintStatus3
