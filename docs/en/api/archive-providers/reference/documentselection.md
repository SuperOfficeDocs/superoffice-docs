...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionProvider">SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentSelection?$select=suggestedDocumentId,person/personExtra/x_person_hidden_integer,contact/postAddress/wgs84latitude,contact/contactAssociate/role,sale/updatedByFullName
