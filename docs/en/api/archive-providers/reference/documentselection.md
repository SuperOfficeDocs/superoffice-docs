...
```http!
GET /api/v1/archive/DocumentSelection?$select=icon,person/personRegisteredDate,person/personUrl/URLAddress,person/personExtra/x_person_date,person/personExtra/y_rental/x_start
