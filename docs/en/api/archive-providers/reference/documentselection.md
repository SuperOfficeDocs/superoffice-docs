...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/mrMrs,person/email/emailBounceCount,person/subscription,contact/department,contact/streetAddress/city
