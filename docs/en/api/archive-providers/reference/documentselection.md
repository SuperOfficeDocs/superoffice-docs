...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personExtra/x_person_contact_relation,person/correspondingAssociate/assocTooltip,contact/contactAssociate/mrMrs
