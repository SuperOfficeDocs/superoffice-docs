...
```http!
GET /api/v1/archive/DocumentSelection?$select=contact/country,contact/restrictionAddress/formattedAddress,contact/contactAssociate/contactDepartment,project/projectId,project/LastCompletedActivity
