...
```http!
GET /api/v1/archive/DocumentSelection?$select=getAllRows,documentId,person/ticketPriority,contact/contactPhone/description,contact/searchPhone/description
