...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personAssociate/isLocation,contact/contactAssociate/assocTooltip,contact/NumberOfNotCompletedSales,project/saintActivityType,sale/sale/textId
