...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/retired,person/searchPhone/description,person/personAssociate/middleName,project/projectUdef/SuperOffice:3,associate/contactDepartment
