...
```http!
GET /api/v1/archive/DocumentSelection?$select=recordType,person/personAddress/line3,person/personExtra/x_person_integer,contact/contactFax/description,contact/email/emailDescription
