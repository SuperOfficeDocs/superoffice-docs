...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personUdef/SuperOffice:1,person/withdrawnStoreConsent,contact/registeredBy,contact/postAddress/addressId,contact/streetAddress/zip
