...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/rank,person/personUdef/SuperOffice:10,person/correspondingAssociate/userName,person/hasStoreConsent,person/withdrawnEmarketingConsent
