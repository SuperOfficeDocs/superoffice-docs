...
```http!
GET /api/v1/archive/DocumentSelection?$select=contact/department,contact/updatedDate,contact/contactAssociate/credentialType,project/projectAssociate/mrMrs,project/projectUdef/SuperOffice:6
