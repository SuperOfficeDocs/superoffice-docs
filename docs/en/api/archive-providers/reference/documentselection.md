...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personExtra/x_person_appointment_relation,contact/contactAssociate/userName,contact/contactUdef/SuperOffice:9
