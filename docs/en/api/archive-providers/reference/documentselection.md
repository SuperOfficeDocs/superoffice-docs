...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personExtra/y_rental/x_contact,person/legalBaseEmarketing,contact/email/emailLastSent,project/LastActivity,sale/completed
