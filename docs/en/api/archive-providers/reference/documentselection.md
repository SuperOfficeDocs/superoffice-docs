...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personCountry,person/personExtra/y_rental/y_equipment/x_name,person/personAssociate/role,contact/name,contact/contactAssociate/contactName
