...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personAssociate/otherGroups,contact/contactUdef/SuperOffice:4,project/projectAssociate/portraitThumbnail
