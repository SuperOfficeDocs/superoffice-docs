...
```http!
GET /api/v1/archive/DocumentSelection?$select=person/personInfo/infoText,person/personUdef/SuperOffice:3,contact/contactAssociate/contactCategory,project/projectAssociate/contactName,sale/date
