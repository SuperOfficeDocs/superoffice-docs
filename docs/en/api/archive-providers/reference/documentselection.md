...
```http!
GET /api/v1/archive/DocumentSelection?$select=contact/contactAssociate/simultaneousEjUser,contact/NumberOfActivitiesInPeriod,person/correspondingAssociate/role
