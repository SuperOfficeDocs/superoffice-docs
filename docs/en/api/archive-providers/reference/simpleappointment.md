...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/streetAddress/addressId,contact/streetAddress/state,person/firstName,project/projectAssociate/contactDepartment,sale/associate/contactFullName
