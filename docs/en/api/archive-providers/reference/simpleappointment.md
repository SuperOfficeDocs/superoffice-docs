...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/hasInfoText,person/birthMonth,person/personAddress/line2,person/personAssociate/credentialType,project/projectAssociate/portraitThumbnail
