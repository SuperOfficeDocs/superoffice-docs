...
```http!
GET /api/v1/archive/SimpleAppointment?$select=recurring,contact/SaintStatus2,person/personAssociate/usergroupId,sale/associate/simultaneousEjUser,associate/firstName
