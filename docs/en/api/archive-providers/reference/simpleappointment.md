...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/streetAddress/city,contact/saintTicketStatus,person/personId,person/personExtra/x_person_time,project/projectAssociate/contactFullName
