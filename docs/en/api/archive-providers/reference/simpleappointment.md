...
```http!
GET /api/v1/archive/SimpleAppointment?$select=visibleFor,person/portraitThumbnail,person/email/emailAddress,person/withdrawnStoreConsent,project/projectAssociate/contactDepartment
