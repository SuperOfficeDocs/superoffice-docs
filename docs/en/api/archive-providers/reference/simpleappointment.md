...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/contactAssociate/isLocation,contact/saintAmountClass,person/kanaLastName,project/updatedBy,project/NumberOfNotCompletedActivities
