...
```http!
GET /api/v1/archive/SimpleAppointment?$select=getNoRows,registeredDate,contact/streetAddress/addressId,contact/NumberOfNotCompletedTicketsInPeriod,person/personExtra/y_rental/x_amount
