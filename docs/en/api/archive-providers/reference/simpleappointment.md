...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/country,contact/NumberOfSalesInPeriod,person/personUdef/SuperOffice:2,person/correspondingAssociate/locationAddress,project/completed
