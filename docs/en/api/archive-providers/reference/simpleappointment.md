...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/NumberOfSalesInPeriod,contact/LastDoBySale,person/personPrivate/description,person/personUdef/SuperOffice:9,project/hasInfoText
