...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/contactInterestIds,person/personHasInterests,person/personInfo/textId,sale/amountWeighted,appointment/agenda
