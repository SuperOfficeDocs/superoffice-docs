...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/postAddress/wgs84longitude,contact/streetAddress/wgs84longitude,person/birthYear,person/personUpdatedBy,person/personAssociate/isActive
