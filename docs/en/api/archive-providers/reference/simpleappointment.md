...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/streetAddress/wgs84latitude,contact/contactAssociate/contactId,person/birthdate,person/personExtra/x_person_date,person/personAssociate/title
