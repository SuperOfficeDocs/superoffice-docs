...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/NumberOfActivitiesInPeriod,person/retired,person/personAssociate/ejDisplayName,project/projectUrl/URLDescription,project/LastCompletedActivity
