...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/code,person/correspondingAssociate/fullName,person/legalBaseEmarketing,sale/completed,associate/usergroup
