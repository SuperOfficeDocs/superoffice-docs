...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/postAddress/line1,contact/postAddress/county,contact/streetAddress/formattedMultiLineAddress,person/personUdef/SuperOffice:4,person/personAssociate/ejStatus
