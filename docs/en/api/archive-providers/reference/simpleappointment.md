...
```http!
GET /api/v1/archive/SimpleAppointment?$select=time,contact/contactAssociate/mrMrs,contact/LastCompletedActivity,contact/NumberOfNotCompletedTicketsInPeriod,person/personCountry
