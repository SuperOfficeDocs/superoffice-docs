...
```http!
GET /api/v1/archive/SimpleAppointment?$select=endTime,person/retired,person/personAssociate/role,person/correspondingAssociate/portraitThumbnail,project/updatedByFullName
