...
```http!
GET /api/v1/archive/SimpleAppointment?$select=personId,contact/postAddress/state,contact/restrictionAddress/line3,contact/LastCompletedSale,person/personExtra/x_person_priority_relation
