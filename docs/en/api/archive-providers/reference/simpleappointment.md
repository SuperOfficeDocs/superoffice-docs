...
```http!
GET /api/v1/archive/SimpleAppointment?$select=personId,contact/business,contact/contactAssociate/ejStatus,person/supportAssociate,person/hasEmarketingConsent
