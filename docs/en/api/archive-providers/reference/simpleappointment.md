...
```http!
GET /api/v1/archive/SimpleAppointment?$select=priority,contact/contactExtra/x_contact_integer,contact/contactExtra/x_contact_datetime,person/birthdate,person/personAssociate/usergroup
