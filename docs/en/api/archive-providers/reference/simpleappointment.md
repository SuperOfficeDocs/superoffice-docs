...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/updatedDate,contact/contactAssociate/lastName,contact/contactUdef/SuperOffice:13,person/restrictionAddress/addressId,project/saintActivityType
