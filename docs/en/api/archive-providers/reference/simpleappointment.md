...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/contactAssociate/isActive,contact/contactUdef/SuperOffice:2,contact/saintTicketCategory,person/contactId,person/personCountry
