...
```http!
GET /api/v1/archive/SimpleAppointment?$select=contact/contactAssociate/simultaneousEjUser,contact/LastCompletedActivity,contact/NumberOfSales,person/personNumber,person/personAssociate/assocTooltip
