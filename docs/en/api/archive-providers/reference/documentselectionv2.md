...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=recordType,projectId,person/birthdate,person/personAssociate/middleName,contact/contactExtra/x_contact_longtext
