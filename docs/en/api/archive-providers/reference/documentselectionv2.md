...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/personInfo/infoText,contact/registeredDate,contact/postAddress/line3,project/projectEvent/hasSignOn
