...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=visibleFor,person/personAddress/formattedMultiLineAddress,person/personUdef/SuperOffice:2,contact/business,contact/postAddress/wgs84latitude
