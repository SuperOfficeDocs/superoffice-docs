...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/email/emailDescription,person/personAddress/county,person/restrictionAddress/addressId,contact/email/emailProtocol,contact/SaintStatus1
