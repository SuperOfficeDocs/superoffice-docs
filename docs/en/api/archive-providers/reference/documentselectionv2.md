...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/birthMonth,person/restrictionAddress/line3,person/personUdef/SuperOffice:10,contact/contactAssociate/lastName,associate/contactFullName
