...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=contact/contactUdef/SuperOffice:8,contact/contactExtra/x_contact_longtext,contact/NumberOfNotCompletedSalesInPeriod,sale/text,sale/soldReason
