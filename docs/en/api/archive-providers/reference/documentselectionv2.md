...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=updatedBy,person/personCategoryRank,person/leadStatus,person/personExtra/x_person_shorttext,person/correspondingAssociate/ejStatus
