...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=associateId,person/personActiveErpLinks,person/personAssociate/firstName,person/correspondingAssociate/portraitThumbnail,contact/email/emailHasBounced
