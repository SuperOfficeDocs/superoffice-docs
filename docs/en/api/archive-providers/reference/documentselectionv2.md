...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=contact/contactAssociate/contactName,contact/contactAssociate/isActive,associate/contactDepartment,associate/otherGroups
