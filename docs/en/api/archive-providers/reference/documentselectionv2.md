...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=userGroup,person/consentSourceEmarketing,contact/restrictionAddress/line3,contact/contactAssociate/ejUserId,documentUdef/SuperOffice:4
