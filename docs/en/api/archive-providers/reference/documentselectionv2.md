...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/lastName,person/supportAssociateFullName,contact/contactAssociate/assocTooltip,project/projectUdef/SuperOffice:1,project/saintTicketStatus
