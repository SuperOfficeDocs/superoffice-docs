...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=personId,person/birthDay,person/restrictionAddress/wgs84longitude,project/projectAssociate/contactName,sale/time
