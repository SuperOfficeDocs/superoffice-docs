...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/personNoMail,person/personUdef/SuperOffice:3,contact/activeErpLinks,contact/searchPhone/description,contact/NumberOfNotCompletedActivitiesInPeriod
