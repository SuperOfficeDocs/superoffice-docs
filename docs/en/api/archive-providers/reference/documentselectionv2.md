...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/consentSourceEmarketing,contact/updatedDate,contact/registeredDate,project/LastActivity,associate/personId
