...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/middleName,project/projectPublish/publishedFrom,associate/assocName,sale/projectId,selectionMemberId
