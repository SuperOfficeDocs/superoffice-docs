...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=date,person/personUdef/SuperOffice:11,person/personExtra/y_rental/x_contact,person/correspondingAssociate/fullName,contact/url/URLAddress
