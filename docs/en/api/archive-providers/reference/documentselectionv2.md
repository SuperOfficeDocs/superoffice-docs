...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=documentId,person/ticketPriority,person/personPager/formattedNumber,person/correspondingAssociate/portraitThumbnail,contact/contactExtra/x_contact_float
