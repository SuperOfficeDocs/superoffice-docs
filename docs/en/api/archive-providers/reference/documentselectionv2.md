...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/ticketPriority,contact/email/emailProtocol,contact/streetAddress/line1,contact/streetAddress/zip,contact/contactAssociate/title
