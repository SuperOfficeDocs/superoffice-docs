...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/supportAssociate,person/email/emailLastBounce,person/correspondingAssociate/mrMrs,contact/contactAssociate/isLocation,contact/SaintStatus1
