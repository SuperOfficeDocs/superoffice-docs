...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/phone/formattedNumber,person/personExtra/x_person_contact_relation,person/consentSourceEmarketing,contact/saintTicketCategory,project/icon
