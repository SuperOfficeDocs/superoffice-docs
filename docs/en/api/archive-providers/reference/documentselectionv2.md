...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/updatedByWorkflow,person/email/emailId,person/restrictionAddress/line2,contact/contactUdef/SuperOffice:10,contact/contactExtra/y_organization/x_name
