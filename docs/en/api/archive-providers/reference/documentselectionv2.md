...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=associateId,person/birthDay,person/personExtra/x_person_datetime,person/correspondingAssociate/locationAddress,project/activeErpLinks
