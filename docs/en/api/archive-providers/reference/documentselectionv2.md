...
```http!
GET /api/v1/archive/DocumentSelectionV2?$select=person/kanaFirstName,person/correspondingAssociate/fullName,project/icon,associate/simultaneousEjUser,sale/saleId
