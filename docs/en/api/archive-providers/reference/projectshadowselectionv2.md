...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=NumberOfNotCompletedActivities,appointment/associate/isLocation,document/associate/usergroup,projectMember/leadStatus,projectMember/mainContact
