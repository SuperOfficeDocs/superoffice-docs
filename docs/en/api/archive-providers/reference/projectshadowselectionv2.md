...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/contactCategory,saintTicketCategory,sale/probPercent,sale/associate/contactCategory,document/snum
