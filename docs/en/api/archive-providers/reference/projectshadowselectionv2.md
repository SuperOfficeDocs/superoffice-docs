...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=sale/type,document/updatedDate,projectMember/restrictionAddress/line2,projectMember/saintActivityType
