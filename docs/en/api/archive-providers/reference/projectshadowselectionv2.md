...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=appointment/time,appointment/updatedBy,projectMember/personUrl/URLAddress,projectMember/contactUdef/SuperOffice:13
