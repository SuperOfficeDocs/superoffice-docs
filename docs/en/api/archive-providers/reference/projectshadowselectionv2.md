...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/userName,projectUdef/SuperOffice:2,appointment/completed,projectMember/infoText,projectMember/restrictionAddress/wgs84longitude
