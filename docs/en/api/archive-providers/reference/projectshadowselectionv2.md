...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectEvent/hasSignOff,projectUdef/SuperOffice:9,projectUdef/SuperOffice:10,sale/associate/contactFullName,sale/saleUdef/SuperOffice:6
