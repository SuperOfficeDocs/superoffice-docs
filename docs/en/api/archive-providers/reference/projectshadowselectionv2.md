...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/ejStatus,appointment/appointment/isConverted,document/registeredBy,document/attention,projectMember/projectId
