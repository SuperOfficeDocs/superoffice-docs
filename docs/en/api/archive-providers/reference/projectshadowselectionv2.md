...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/mrMrs,projectUdef/SuperOffice:6,sale/registeredByFullName,sale/saleUdef/SuperOffice:3,appointment/booking
