...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=saintDirection,sale/associate/credentialType,appointment/type,appointment/priority,appointment/associate/credentialType
