...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/fullName,sale/saleUdef/SuperOffice:4,sale/saleUdef/SuperOffice:6,projectMember/updated,projectMember/personNoMail
