...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=SaintStatus3,sale/hasStakeholders,document/associate/portraitThumbnail,projectMember/personCountry,projectMember/personAssociate/lastName
