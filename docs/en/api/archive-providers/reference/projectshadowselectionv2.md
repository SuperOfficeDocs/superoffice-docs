...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=sale/projectId,sale/updatedByFullName,sale/associate/assocTooltip,appointment/appointmentUdef/SuperOffice:8,projectMember/LastDoBySale
