...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectUdef/SuperOffice:5,NumberOfNotCompletedSales,sale/associate/role,sale/associate/locationAddress,document/updatedBy
