...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/isActive,sale/icon,document/isReport,document/associate/lastName,document/associate/personId
