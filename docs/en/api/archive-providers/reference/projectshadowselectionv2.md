...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=updatedDate,projectAssociate/assocName,projectAssociate/assocTooltip,sale/visibleFor,projectMember/personAddress/city
