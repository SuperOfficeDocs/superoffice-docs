...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=sale/associate/contactName,appointment/duration,projectMember/infoText,projectMember/restrictionAddress/addressId,projectMember/contactAssociate/lastName
