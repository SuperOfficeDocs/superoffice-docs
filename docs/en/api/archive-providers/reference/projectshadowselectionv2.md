...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectPublish/publishedFrom,sale/projectId,sale/createdByWorkflow,appointment/cautionWarning,document/mailMergeDraft
