...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=sale/associate/contactFullName,sale/saleUdef/SuperOffice:3,appointment/rawStatus,document/name,projectMember/legalBaseEmarketing
