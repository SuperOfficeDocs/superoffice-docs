...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=associateId,LastCompletedActivity,document/associate/firstName,projectMember/streetAddress/line2,projectMember/contactAssociate/credentialDisplayValue
