...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectAssociate/fullName,sale/registeredDate,sale/hasQuote,document/registeredByFullName,document/associate/firstName
