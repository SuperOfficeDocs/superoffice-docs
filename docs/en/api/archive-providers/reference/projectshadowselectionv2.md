...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=projectUdef/SuperOffice:7,appointment/createdByWorkflow,document/associate/isActive,projectMember/hasCompany,projectMember/contactAssociate/otherGroups
