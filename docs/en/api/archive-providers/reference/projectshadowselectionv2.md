...
```http!
GET /api/v1/archive/ProjectShadowSelectionV2?$select=imageThumbnail,sale/saleUdef/SuperOffice:6,appointment/recordTypeText,document/documentPublish/publishedFrom,document/documentUdef/SuperOffice:3
