...
```http!
GET /api/v1/archive/TicketMessage?$select=ticket/repliedAt,ticket/createdBy/contactId,ticket/person/lastName,ticket/person/personAddress/line3,ticket/person/personUdef/SuperOffice:8
