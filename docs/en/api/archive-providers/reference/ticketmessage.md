...
```http!
GET /api/v1/archive/TicketMessage?$select=ticket/person/personAddress/state,ticket/person/personAssociate/associateDbId,ticket/extra/x_ticket_faq,ticket/sale/registeredByFullName,ticket/project/number
