...
```http!
GET /api/v1/archive/TicketMessage?$select=ticket/createdBy/locationAddress,ticket/contact/nameDepartment,ticket/contact/restrictionAddress/zip,ticket/contact/LastCompletedActivity,ticket/sale/personId
