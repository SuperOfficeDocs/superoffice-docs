...
```http!
GET /api/v1/archive/TicketMessage?$select=ticket/person/birthYear,ticket/person/personExtra/x_person_timespan,ticket/person/withdrawnStoreConsent,ticketMessageExtra/x_message_short_text
