...
```http!
GET /api/v1/archive/Mailings?$select=mailingAddr/contact/contactFax/description,mailingAddr/contact/NumberOfSales,mailingAddr/person/fullName,mailingAddr/person/email/emailLastBounce,project/type
