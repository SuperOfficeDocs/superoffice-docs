...
```http!
GET /api/v1/archive/Mailings?$select=updatedDate,mailingAddr/contact/email/emailLastBounce,mailingAddr/person/birthDay,mailingAddr/person/personInfo/textId,mailingAddr/person/personExtra/x_person_appointment_relation
