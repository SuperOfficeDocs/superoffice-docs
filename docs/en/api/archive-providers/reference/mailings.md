...
```http!
GET /api/v1/archive/Mailings?$select=mailingAddr/contact/postAddress/wgs84longitude,mailingAddr/contact/contactAssociate/role,mailingAddr/contact/saintAmountClass,mailingAddr/person/title,project/NumberOfNotCompletedActivitiesInPeriod
