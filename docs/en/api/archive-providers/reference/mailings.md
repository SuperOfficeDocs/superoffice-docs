...
```http!
GET /api/v1/archive/Mailings?$select=type,mailingAddr/contact/contactAssociate/lastName,mailingAddr/person/fullName,mailingAddr/person/birthYear,mailingAddr/person/personDirectPhone/formattedNumber
