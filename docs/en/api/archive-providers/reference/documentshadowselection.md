...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=snum,person/personRegisteredDate,person/personAssociate/ejDisplayName,sale/associate/otherGroups,sale/saleUdef/SuperOffice:2
