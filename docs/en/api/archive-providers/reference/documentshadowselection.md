...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personAddress/formattedAddress,person/personUdef/SuperOffice:3,person/personAssociate/isActiveText,person/withdrawnEmarketingConsent,contact/registeredByFullName
