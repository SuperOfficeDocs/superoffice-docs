...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personAddress/city,person/personAssociate/lastName,contact/mainContact,contact/contactUdef/SuperOffice:6,contact/contactUdef/SuperOffice:7
