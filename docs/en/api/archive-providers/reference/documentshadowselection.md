...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/hasInterests,person/birthYear,person/personAddress/city,contact/phone/formattedNumber,project/projectAssociate/contactId
