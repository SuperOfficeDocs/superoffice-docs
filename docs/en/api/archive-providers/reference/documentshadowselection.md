...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=recordTypeText,contact/department,contact/contactAssociate/contactFullName,associate/credentialType,sale/associate/title
