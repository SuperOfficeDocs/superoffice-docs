...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personAssociate/isActiveText,person/personAssociate/portraitThumbnail,person/correspondingAssociate/portraitThumbnail,contact/contactNoMail,contact/postAddress/county
