...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/restrictionAddress/county,person/personAssociate/contactDepartment,contact/contactUdef/SuperOffice:5,project/saintDirection
