...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/phone/formattedNumber,person/restrictionAddress/wgs84longitude,person/personUdef/SuperOffice:10,contact/email/emailLastSent,contact/contactAssociate/credentialType
