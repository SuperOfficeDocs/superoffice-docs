...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/email/emailId,person/restrictionAddress/city,person/personAssociate/personId,person/correspondingAssociate/fullName,person/correspondingAssociate/isActive
