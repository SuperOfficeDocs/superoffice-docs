...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=contact/restrictionAddress/line1,contact/contactAssociate/simultaneousEjUser,sale/saleUdef/SuperOffice:6
