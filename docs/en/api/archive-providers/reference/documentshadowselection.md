...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=contact/saintActivityType,sale/saleStatus,sale/stalledComment,sale/associate/ejDisplayName,selectionId
