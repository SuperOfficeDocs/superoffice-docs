...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=updatedByFullName,person/personUrl/URLAddress,person/personExtra/y_rental/y_equipment/x_name,contact/updatedDate,project/projectEvent/hasSignOff
