...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personUdef/SuperOffice:4,contact/NumberOfSalesInPeriod,contact/NumberOfNotCompletedSalesInPeriod,contact/NumberOfNotCompletedTicketsInPeriod,project/hasInfoText
