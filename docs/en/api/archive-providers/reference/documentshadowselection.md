...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personAssociate/userName,person/correspondingAssociate/credentialDisplayValue,contact/postAddress/line3,project/name,associate/isActive
