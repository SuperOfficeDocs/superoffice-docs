...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=project/projectUdef/SuperOffice:4,person/correspondingAssociate/role,contact/contactAssociate/middleName
