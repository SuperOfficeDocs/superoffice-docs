...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=personId,person/personId,person/correspondingAssociate/associateDbId,contact/streetAddress/state,contact/restrictionAddress/line1
