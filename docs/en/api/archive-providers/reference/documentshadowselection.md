...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=isMail,recordTypeText,documentPublish/publishedBy,sale/nextDueDate,sale/associate/credentialDisplayValue
