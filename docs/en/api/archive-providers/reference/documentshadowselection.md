...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personAssociate/ejStatus,contact/saintActivityType,project/registeredByFullName,documentUdef/SuperOffice:6,sale/who
