...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personCountryId,person/whenUpdatedByWorkflow,person/withdrawnEmarketingConsent,contact/postAddress/line1,contact/contactAssociate/contactName
