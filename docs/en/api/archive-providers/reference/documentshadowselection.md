...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=who,updatedDate,person/updatedByWorkflow,person/personAddress/line3,person/personAssociate/assocTooltip
