...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personDeletedDate,person/personMobilePhone/formattedNumber,contact/restrictionAddress/zip,project/LastCompletedSale,sale/associate/usergroupId
