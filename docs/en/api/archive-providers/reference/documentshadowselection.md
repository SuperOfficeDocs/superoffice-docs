...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/legalBaseEmarketing,project/nextMilestone,project/projectAssociate/contactDepartment,project/projectAssociate/isActive
