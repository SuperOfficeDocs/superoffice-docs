...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/birthdate,person/personActiveErpLinks,person/whenUpdatedByWorkflow,person/correspondingAssociate/contactDepartment,project/registeredDate
