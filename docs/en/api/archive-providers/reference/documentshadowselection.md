...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personCountry,person/personInfo/textId,person/personAssociate/isActive,contact/updatedByFullName
