...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=snum,person/personDirectPhone/formattedNumber,person/personAssociate/contactFullName,person/personAssociate/assocName,person/subscription
