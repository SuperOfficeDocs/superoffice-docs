...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personPrivate/formattedNumber,contact/code,contact/streetAddress/line2,contact/restrictionAddress/state,project/projectAssociate/isLocation
