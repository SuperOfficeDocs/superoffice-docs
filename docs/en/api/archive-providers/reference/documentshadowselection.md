...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/personInfo/textId,person/personExtra/x_person_request_relation,person/correspondingAssociate/firstName,contact/contactExtra/x_contact_datetime,project/number
