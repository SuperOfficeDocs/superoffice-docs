...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/supportAssociate,person/email/emailDescription,project/NumberOfNotCompletedSales,project/project/infoText,sale/icon
