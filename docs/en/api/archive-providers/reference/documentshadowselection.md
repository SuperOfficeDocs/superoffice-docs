...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=person/supportAssociate,person/personUdef/SuperOffice:10,person/personAssociate/credentialDisplayValue,contact/country,contact/email/emailLastBounce
