...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=documentPublish/publishedFrom,person/personHasInterests,contact/contactAssociate/usergroup,associate/contactDepartment,associate/ejStatus
