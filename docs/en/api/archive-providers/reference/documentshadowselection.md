...
```http!
GET /api/v1/archive/DocumentShadowSelection?$select=registeredByFullName,person/personCountryId,person/personCategory,contact/deletedDate,contact/contactUdef/SuperOffice:4
