...
```http!
GET /api/v1/archive/DiaryAppointment?$select=priority,contact/streetAddress/wgs84latitude,contact/contactExtra/x_contact_boolean,person/retired,person/restrictionAddress/addressId
