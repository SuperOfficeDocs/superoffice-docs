...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/contactAssociate/personEmail,person/title,person/ticketPriority,person/correspondingAssociate/contactCategory,project/projectUrl/URLDescription
