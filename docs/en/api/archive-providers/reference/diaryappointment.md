...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/streetAddress/line1,person/email/emailBounceCount,person/correspondingAssociate/contactName,sale/saleUdef/SuperOffice:6
