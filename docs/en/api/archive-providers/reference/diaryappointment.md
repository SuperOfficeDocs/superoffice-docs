...
```http!
GET /api/v1/archive/DiaryAppointment?$select=isFree,contact/email/emailProtocol,contact/streetAddress/line3,person/personNoMail,person/personRegisteredByFullName
