...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/countryId,contact/postAddress/wgs84latitude,contact/contactUdef/SuperOffice:2,person/birthMonth,person/personAssociate/contactId
