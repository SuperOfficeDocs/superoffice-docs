...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/postAddress/county,contact/contactUdef/SuperOffice:2,project/projectAssociate/otherGroups,sale/saleUdef/SuperOffice:5
