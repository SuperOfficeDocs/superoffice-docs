...
```http!
GET /api/v1/archive/DiaryAppointment?$select=who,contact/contactUdef/SuperOffice:3,person/personAssociate/contactFullName,person/correspondingAssociate/mrMrs,project/projectAssociate/usergroup
