...
```http!
GET /api/v1/archive/DiaryAppointment?$select=visibleInDiary,contact/postAddress/line2,contact/contactUdef/SuperOffice:8,contact/contactExtra/x_contact_integer,person/personExtra/y_rental/x_contact
