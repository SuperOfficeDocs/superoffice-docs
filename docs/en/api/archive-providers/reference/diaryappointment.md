...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/NumberOfNotCompletedActivities,person/retired,person/correspondingAssociate/ejUserId,person/correspondingAssociate/personEmail,sale/associate/portraitThumbnail
