...
```http!
GET /api/v1/archive/DiaryAppointment?$select=endDate,contact/code,person/email/emailId,person/personAssociate/middleName,person/personAssociate/associateDbId
