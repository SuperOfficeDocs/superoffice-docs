...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/hasInterests,person/personRegisteredBy,person/personAssociate/middleName,sale/currency,appointment/internalNotes
