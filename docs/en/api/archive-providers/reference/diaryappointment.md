...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/contactPhone/formattedNumber,contact/contactAssociate/credentialType,person/personAssociate/usergroup,associate/assocName
