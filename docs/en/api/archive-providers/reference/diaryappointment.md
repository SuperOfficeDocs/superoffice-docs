...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/contactAssociate/usergroup,contact/LastTicket,person/personAddress/line1,sale/associate/associateDbId,sale/saleUdef/SuperOffice:2
