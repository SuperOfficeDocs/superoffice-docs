...
```http!
GET /api/v1/archive/DiaryAppointment?$select=location,contact/name,contact/contactAssociate/assocName,contact/LastDoByActivity,person/personAddress/formattedAddress
