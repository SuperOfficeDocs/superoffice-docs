...
```http!
GET /api/v1/archive/DiaryAppointment?$select=type,person/personAssociate/isActiveText,person/correspondingAssociate/locationAddress,person/hasEmarketingConsent,sale/salePublish/publishedTo
