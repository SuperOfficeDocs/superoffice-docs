...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/contactUdef/SuperOffice:5,person/correspondingAssociate/assocType,project/projectPublish/isPublished,sale/hasQuote
