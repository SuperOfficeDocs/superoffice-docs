...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/email/emailBounceCount,person/personInterestIds,person/personAssociate/otherGroups,project/description,project/projectPublish/isPublished
