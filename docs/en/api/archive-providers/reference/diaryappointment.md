...
```http!
GET /api/v1/archive/DiaryAppointment?$select=person/email/emailHasBounced,person/personExtra/x_person_float,person/personAssociate/firstName,person/personAssociate/associateDbId,sale/earningPercent
