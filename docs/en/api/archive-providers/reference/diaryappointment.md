...
```http!
GET /api/v1/archive/DiaryAppointment?$select=contact/associateId,contact/contactAssociate/assocType,person/firstName,person/middleName,person/personBusiness
