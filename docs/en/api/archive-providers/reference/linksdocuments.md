...
```http!
GET /api/v1/archive/LinksDocuments?$select=associateId,person/contactId,person/personAssociate/firstName,contact/contactAssociate/associateDbId,contact/contactExtra/x_contact_longtext
