...
```http!
GET /api/v1/archive/LinksDocuments?$select=saleId,person/personMobilePhone/formattedNumber,person/correspondingAssociate/contactDepartment,person/correspondingAssociate/assocName,person/correspondingAssociate/credentialType
