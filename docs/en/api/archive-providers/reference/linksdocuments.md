...
```http!
GET /api/v1/archive/LinksDocuments?$select=registeredByFullName,isMail,person/supportAssociate,person/personExtra/x_person_integer,person/personAssociate/mrMrs
