...
```http!
GET /api/v1/archive/LinksDocuments?$select=person/personAssociate/personId,contact/restrictionAddress/formattedMultiLineAddress,contact/contactAssociate/contactId,contact/LastDoByTicket,project/name
