...
```http!
GET /api/v1/archive/LinksDocuments?$select=person/personAddress/formattedMultiLineAddress,contact/contactFax/formattedNumber,contact/restrictionAddress/line2,project/updatedDate
