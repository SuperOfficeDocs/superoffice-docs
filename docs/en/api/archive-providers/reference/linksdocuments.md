...
```http!
GET /api/v1/archive/LinksDocuments?$select=mailMergeDraft,person/personAssociateId,person/isMailingRecipient,contact/contactExtra/x_contact_shorttext,contact/LastDoByActivity
