...
```http!
GET /api/v1/archive/LinksDocuments?$select=mailMergeDraft,person/personAssociate/ejUserId,person/personAssociate/ejDisplayName,contact/contactUdef/SuperOffice:7,contact/contactExtra/x_contact_date
