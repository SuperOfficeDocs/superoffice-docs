...
```http!
GET /api/v1/archive/LinksDocuments?$select=documentPublish/isPublished,documentPublish/publishedBy,person/position,person/personUdef/SuperOffice:2,person/personExtra/x_person_shorttext
