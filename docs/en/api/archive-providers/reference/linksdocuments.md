...
```http!
GET /api/v1/archive/LinksDocuments?$select=text,person/personAssociate/assocName,contact/registeredDate,project/projectAssociate/contactFullName,project/saintIntention
