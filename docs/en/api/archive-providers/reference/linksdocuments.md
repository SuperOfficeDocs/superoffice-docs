...
```http!
GET /api/v1/archive/LinksDocuments?$select=person/kanaFirstName,contact/country,contact/countryId,contact/postAddress/wgs84longitude,contact/contactAssociate/isActive
