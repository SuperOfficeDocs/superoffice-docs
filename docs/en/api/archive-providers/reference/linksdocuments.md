...
```http!
GET /api/v1/archive/LinksDocuments?$select=person/personCountry,person/retired,person/personExtra/x_person_priority_relation,person/correspondingAssociate/contactFullName,contact/hasInfoText
