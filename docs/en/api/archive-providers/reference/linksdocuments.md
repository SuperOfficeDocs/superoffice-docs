...
```http!
GET /api/v1/archive/LinksDocuments?$select=person/personMobilePhone/formattedNumber,person/email/emailId,person/restrictionAddress/city,person/personAssociate/usergroup,contact/updatedBy
