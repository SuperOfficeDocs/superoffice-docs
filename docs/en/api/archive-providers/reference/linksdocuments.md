...
```http!
GET /api/v1/archive/LinksDocuments?$select=projectId,isMail,person/personAssociate/ejStatus,person/correspondingAssociate/fullName,contact/contactPhone/formattedNumber
