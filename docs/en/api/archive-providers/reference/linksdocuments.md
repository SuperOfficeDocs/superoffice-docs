...
```http!
GET /api/v1/archive/LinksDocuments?$select=userGroup,person/personActiveErpLinks,person/restrictionAddress/zip,person/restrictionAddress/formattedAddress,person/personAssociate/contactFullName
