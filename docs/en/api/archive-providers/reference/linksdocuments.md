...
```http!
GET /api/v1/archive/LinksDocuments?$select=person/personAssociate/assocTooltip,contact/email/emailId,contact/restrictionAddress/line1,contact/contactAssociate/isActiveText,contact/NumberOfSalesInPeriod
