...
```http!
GET /api/v1/archive/LinksDocuments?$select=contact/updatedByFullName,contact/contactAssociate/otherGroups,associate/fullName,associate/isActive,associate/portraitThumbnail
