...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=hasQuote,person/email/emailLastBounce,person/personUdef/SuperOffice:4,person/personAssociate/contactName,person/correspondingAssociate/personId
