...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/mrMrs,person/personAssociate/title,person/personAssociate/associateDbId,contact/registeredBy,contact/contactUdef/SuperOffice:4
