...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=userGroup,person/retired,person/personAssociate/middleName,associate/contactId,associate/ejDisplayName
