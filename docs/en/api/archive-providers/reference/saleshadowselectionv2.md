...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=originalStage,amountInBaseCurrency,person/lastName,person/personUrl/URLAddress,person/personUdef/SuperOffice:5
