...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/hasInterests,person/personDirectFax/formattedNumber,person/personDirectFax/description,person/correspondingAssociate/credentialType,contact/updatedByFullName
