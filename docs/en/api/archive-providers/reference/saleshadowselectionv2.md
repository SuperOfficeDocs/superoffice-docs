...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/hasInterests,person/personAssociate/otherGroups,person/correspondingAssociate/personEmail,contact/postAddress/wgs84latitude,contact/contactExtra/x_contact_timespan
