...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=hasQuote,person/supportAssociate,person/personUdef/SuperOffice:1,person/correspondingAssociate/lastName,contact/contactFax/description
