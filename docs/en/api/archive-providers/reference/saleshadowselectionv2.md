...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/personAssociate/title,contact/postAddress/county,contact/contactAssociate/lastName,contact/NumberOfTicketsInPeriod,associate/title
