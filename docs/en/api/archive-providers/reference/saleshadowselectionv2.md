...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/rank,person/restrictionAddress/wgs84latitude,person/personAssociate/personId,person/personAssociate/personEmail,document/associate/ejUserId
