...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=credited,person/correspondingAssociate/ejStatus,contact/contactInterestIds,associate/ejStatus,document/associate/title
