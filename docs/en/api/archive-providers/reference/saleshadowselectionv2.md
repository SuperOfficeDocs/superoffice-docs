...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=salePublish/isPublished,person/birthYear,person/isProjectMember,person/email/emailLastBounce,contact/postAddress/line1
