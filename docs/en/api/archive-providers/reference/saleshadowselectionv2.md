...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/supportLanguage,person/personAssociateId,person/personExtra/x_person_hidden_integer,contact/email/emailProtocol,contact/LastCompletedTicket
