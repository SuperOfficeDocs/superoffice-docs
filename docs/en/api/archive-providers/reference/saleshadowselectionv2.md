...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/legalBaseStore,appointment/invitedPersonId,saleStakeholder/person/birthdate,saleStakeholder/person/email/emailLastSent,saleStakeholder/person/correspondingAssociate/contactFullName
