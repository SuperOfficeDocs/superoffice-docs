...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/fullName,contact/restrictionAddress/line2,contact/NumberOfActivities,appointment/associate/contactFullName,appointment/appointment/title
