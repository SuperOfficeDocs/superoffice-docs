...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=saleTypeCategory,person/supportLanguage,person/isStakeholder,contact/streetAddress/zip,contact/contactAssociate/personId
