...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=updatedByFullName,soldReason,person/personExtra/y_rental/x_amount,person/personAssociate/simultaneousEjUser,contact/contactNoMail
