...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=description,contact/streetAddress/line1,contact/NumberOfNotCompletedTickets,appointment/appointmentUdef/SuperOffice:4,document/projectId
