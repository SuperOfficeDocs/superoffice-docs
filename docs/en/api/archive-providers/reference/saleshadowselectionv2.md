...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/birthYear,person/personExtra/x_person_integer,person/personExtra/y_rental/y_equipment/x_name,person/hasStoreConsent,contact/restrictionAddress/line2
