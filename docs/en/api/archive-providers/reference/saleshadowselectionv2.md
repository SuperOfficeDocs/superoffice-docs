...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=earning,saleTypeId,person/restrictionAddress/line3,person/personExtra/y_rental/x_amount,contact/hasInfoText
