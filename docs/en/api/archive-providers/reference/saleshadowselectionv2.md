...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/personPrivate/formattedNumber,person/restrictionAddress/line3,person/personUdef/SuperOffice:11,person/withdrawnEmarketingConsent,contact/email/emailLastSent
