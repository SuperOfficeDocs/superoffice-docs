...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=completed,type,contact/postAddress/city,contact/saintTicketCategory,appointment/appointmentUdef/SuperOffice:8
