...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/personAssociate/assocName,person/personAssociate/ejDisplayName,contact/associateId,contact/country,contact/contactFax/description
