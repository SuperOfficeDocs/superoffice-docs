...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=updatedBy,salePublish/isPublished,person/personUdef/SuperOffice:3,person/personExtra/x_person_timespan,person/personExtra/x_person_category_relation
