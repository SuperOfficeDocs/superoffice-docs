...
```http!
GET /api/v1/archive/SaleShadowSelectionV2?$select=person/fullName,person/personCountry,person/personAssociate/associateDbId,person/correspondingAssociate/middleName,contact/email/emailHasBounced
