...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personEmail/emailAddress,postAddress/addressId,streetAddress/line1,contactAssociate/ejDisplayName,contactAssociate/credentialDisplayValue
