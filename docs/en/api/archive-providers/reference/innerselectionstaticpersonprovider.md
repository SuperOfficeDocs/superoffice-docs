...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personSourceRelation/supportLanguage,personTargetRelation/hasCompany,projectMembers/LastDoByActivity
