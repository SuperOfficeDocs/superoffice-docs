...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=countryId,email/emailBounceCount,streetAddress/line1,contactAssociate/mrMrs,contactExtra/x_contact_hidden_integer
