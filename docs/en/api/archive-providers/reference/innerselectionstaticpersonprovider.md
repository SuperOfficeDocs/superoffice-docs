...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personBusiness,personAddress/formattedAddress,personTargetRelation/useAsMailingAddress,personAssociate/assocType,legalBaseStore
