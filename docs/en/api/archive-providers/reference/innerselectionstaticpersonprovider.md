...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=hasInfoText,personActiveErpLinks,correspondingAssociate/credentialDisplayValue,streetAddress/addressId,withdrawnEmarketingConsent
