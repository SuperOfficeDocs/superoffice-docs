...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personAssociate/contactCategory,restrictionAddress/addressId,contactExtra/x_contact_time,request/author,projectMembers/projectAssociate/credentialDisplayValue
