...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=request/numberOfMessages,projectMembers/projectUdef/SuperOffice:3,projectMembers/saintIntention,personAppointment/priority
