...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personTargetRelation/useAsMailingAddress,streetAddress/zip,personTargetRelation/personBusiness
