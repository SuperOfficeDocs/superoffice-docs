...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=hasInterests,kanaLastName,correspondingAssociate/isActive,request/createdBy/userName,personAppointment/associate/isActiveText
