...
```http!
GET /api/v1/archive/InnerSelectionStaticPersonProvider?$select=personUpdatedBy,department,personTargetRelation/personBusiness,personTargetRelation/personDeletedDate,contactAssociate/simultaneousEjUser
