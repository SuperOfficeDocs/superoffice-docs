...
```http!
GET /api/v1/archive/salefavourites?$select=person/personDirectPhone/description,contact/activeErpLinks,contact/contactFax/description,contact/postAddress/state,contact/contactUdef/SuperOffice:8
