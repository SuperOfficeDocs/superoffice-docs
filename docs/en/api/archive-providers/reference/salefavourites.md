...
```http!
GET /api/v1/archive/salefavourites?$select=person/personUpdatedBy,person/supportAssociate,contact/postAddress/line2,contact/streetAddress/addressId,contact/restrictionAddress/city
