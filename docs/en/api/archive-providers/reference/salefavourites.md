...
```http!
GET /api/v1/archive/salefavourites?$select=registeredDate,salePublish/isPublished,person/personCountry,person/personPrivate/description,person/correspondingAssociate/firstName
