...
```http!
GET /api/v1/archive/salefavourites?$select=person/birthYear,person/personRegisteredBy,person/isStakeholder,person/email/emailHasBounced,person/restrictionAddress/line2
