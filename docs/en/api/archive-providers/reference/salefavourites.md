...
```http!
GET /api/v1/archive/salefavourites?$select=person/email/emailHasBounced,person/personAssociate/ejStatus,contact/NumberOfTickets,saleUdef/SuperOffice:7,project/projectPublish/publishedFrom
