...
```http!
GET /api/v1/archive/salefavourites?$select=who,person/personDirectFax/formattedNumber,contact/contactDeleted,contact/contactAssociate/locationAddress,contact/contactExtra/x_contact_date
