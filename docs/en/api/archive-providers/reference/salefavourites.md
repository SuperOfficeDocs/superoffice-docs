...
```http!
GET /api/v1/archive/salefavourites?$select=person/hasInfoText,contact/number,contact/contactPhone/formattedNumber,contact/contactAssociate/personId,project/projectAssociate/contactFullName
