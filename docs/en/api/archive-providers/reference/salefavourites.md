...
```http!
GET /api/v1/archive/salefavourites?$select=entityIcon,salePublish/isPublished,person/restrictionAddress/formattedMultiLineAddress,contact/restrictionAddress/addressId,saleStakeholder/person/middleName
