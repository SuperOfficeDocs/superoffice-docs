...
```http!
GET /api/v1/archive/salefavourites?$select=person/personRegisteredByFullName,person/personPager/description,contact/contactFax/formattedNumber,contact/restrictionAddress/line3,contact/contactUdef/SuperOffice:11
