...
```http!
GET /api/v1/archive/salefavourites?$select=person/title,person/personRegisteredBy,person/correspondingAssociate/role,contact/email/emailDescription,contact/postAddress/county
