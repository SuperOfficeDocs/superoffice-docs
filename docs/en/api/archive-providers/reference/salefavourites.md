...
```http!
GET /api/v1/archive/salefavourites?$select=person/restrictionAddress/wgs84latitude,contact/contactId,contact/postAddress/formattedAddress,contact/streetAddress/city,project/projectAssociate/title
