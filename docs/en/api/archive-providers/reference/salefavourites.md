...
```http!
GET /api/v1/archive/salefavourites?$select=getAllRows,source,person/associateType,person/email/emailLastBounce,person/personExtra/x_person_user_relation
