...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/contactAssociate/usergroup,person/correspondingAssociate/contactName,sale/soldReason,sale/associate/associateDbId
