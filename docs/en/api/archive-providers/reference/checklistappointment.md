...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/postAddress/wgs84longitude,contact/contactAssociate/contactName,contact/saintIntention,person/hasInterests,person/isStakeholder
