...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/updatedDate,contact/streetAddress/wgs84longitude,contact/contactAssociate/lastName,contact/NumberOfSalesInPeriod,contact/SaintStatus2
