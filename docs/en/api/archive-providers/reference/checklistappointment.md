...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=alarm,contact/postAddress/wgs84longitude,person/personAddress/line1,person/consentSourceEmarketing,sale/salePublish/publishedFrom
