...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=registeredDate,contact/contactId,contact/mainContact,person/personExtra/x_person_date,person/personExtra/y_rental/id
