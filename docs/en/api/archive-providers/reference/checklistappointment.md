...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/code,contact/email/emailHasBounced,project/projectAssociate/fullName,project/projectAssociate/contactDepartment,sale/associate/usergroup
