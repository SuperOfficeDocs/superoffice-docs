...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/LastDoBySale,person/email/emailId,person/personAddress/city,person/personExtra/y_rental/x_amount,person/personAssociate/portraitThumbnail
