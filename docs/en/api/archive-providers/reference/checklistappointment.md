...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/email/emailHasBounced,contact/postAddress/wgs84longitude,contact/LastCompletedSale,person/searchPhone/formattedNumber,person/personUdef/SuperOffice:4
