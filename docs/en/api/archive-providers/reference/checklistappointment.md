...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/code,contact/contactAssociate/contactFullName,person/personAddress/line3,person/personAssociate/assocType,person/correspondingAssociate/mrMrs
