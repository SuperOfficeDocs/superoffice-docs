...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/streetAddress/wgs84latitude,contact/LastDoBySale,person/email/emailBounceCount,person/restrictionAddress/wgs84longitude,sale/associate/isActiveText
