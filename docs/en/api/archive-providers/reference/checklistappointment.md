...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=intention,contact/email/emailAddress,contact/contactAssociate/credentialType,person/lastName,person/personAddress/formattedAddress
