...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contactId,registeredByFullName,contact/contactAssociate/contactId,contact/LastDoByTicket,person/personPrivate/formattedNumber
