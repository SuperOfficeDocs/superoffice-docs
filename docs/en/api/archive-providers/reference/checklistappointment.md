...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/registeredDate,person/ticketPriority,person/supportAssociate,person/personAssociate/isActiveText,sale/earningPercent
