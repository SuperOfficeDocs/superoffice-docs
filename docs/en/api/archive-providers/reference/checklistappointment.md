...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=contact/contactUdef/SuperOffice:2,person/personUpdatedDate,person/email/emailLastBounce,project/updatedBy,project/updatedByFullName
