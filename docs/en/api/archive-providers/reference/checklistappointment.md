...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=getNoRows,contact/email/emailHasBounced,person/personExtra/x_person_integer,person/correspondingAssociate/mrMrs,appointmentUdef/SuperOffice:6
