...
```http!
GET /api/v1/archive/ChecklistAppointment?$select=suggestedAppointmentId,contact/SaintStatus1,person/position,person/personNumber,person/restrictionAddress/line1
