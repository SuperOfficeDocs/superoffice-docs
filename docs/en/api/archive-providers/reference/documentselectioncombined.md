...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/personHasInterests,person/kanaFirstName,contact/contactAssociate/credentialType,project/projectPublish/isPublished,project/projectAssociate/fullName
