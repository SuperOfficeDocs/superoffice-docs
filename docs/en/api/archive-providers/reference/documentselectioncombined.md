...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=updatedBy,person/restrictionAddress/line2,person/correspondingAssociate/associateDbId,contact/contactAssociate/otherGroups,contact/NumberOfTickets
