...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=contact/department,contact/contactExtra/x_contact_float,contact/LastCompletedActivity,project/icon,project/NumberOfNotCompletedActivities
