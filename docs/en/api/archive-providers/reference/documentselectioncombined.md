...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=completed,recordType,contact/restrictionAddress/wgs84longitude,contact/SaintStatus2,sale/saleUdef/SuperOffice:5
