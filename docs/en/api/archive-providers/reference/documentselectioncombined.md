...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=name,person/supportLanguage,person/personDirectPhone/formattedNumber,person/personAssociate/title,contact/contactUdef/SuperOffice:8
