...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/personPager/description,person/restrictionAddress/city,person/correspondingAssociate/contactDepartment,associate/assocName,sale/text
