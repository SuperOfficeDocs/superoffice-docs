...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/personInfo/infoText,person/personExtra/x_person_appointment_relation,contact/contactAssociate/associateDbId,project/LastActivity,project/project/textId
