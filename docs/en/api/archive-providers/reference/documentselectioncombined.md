...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=yourref,person/correspondingAssociate/ejStatus,associate/credentialDisplayValue,sale/associate/contactFullName,sale/associate/ejUserId
