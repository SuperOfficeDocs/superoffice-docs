...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=recordTypeText,person/personCountry,contact/streetAddress/zip,contact/contactAssociate/middleName,documentUdef/SuperOffice:8
