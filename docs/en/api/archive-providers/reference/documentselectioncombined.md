...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/email/emailLastBounce,project/LastDoBySale,associate/contactDepartment,sale/associate/locationAddress
