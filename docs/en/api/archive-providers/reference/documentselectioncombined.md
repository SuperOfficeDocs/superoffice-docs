...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=registeredDate,person/contactId,person/personCountry,person/personInterestIds,person/personAssociate/assocName
