...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=documentPublish/publishedTo,person/personPager/description,person/personExtra/y_rental/x_end,project/registeredBy,project/projectEvent/hasSignOff
