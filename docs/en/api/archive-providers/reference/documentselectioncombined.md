...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/personRegisteredByFullName,person/personAssociate/mrMrs,contact/activeErpLinks,contact/NumberOfSales,project/activeErpLinks
