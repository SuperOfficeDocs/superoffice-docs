...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/personNumber,person/personExtra/x_person_user_relation,project/statusRank,project/activeErpLinks,associate/assocName
