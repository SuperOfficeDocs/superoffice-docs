...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=isReport,person/restrictionAddress/line3,person/restrictionAddress/wgs84longitude,contact/restrictionAddress/line1,contact/contactExtra/x_contact_hidden_integer
