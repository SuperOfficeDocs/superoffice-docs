...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/restrictionAddress/state,contact/contactAssociate/isActive,contact/contactExtra/x_contact_longtext
