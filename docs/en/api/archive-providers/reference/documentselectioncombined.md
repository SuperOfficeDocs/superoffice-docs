...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=contact/stop,project/projectAssociate/portraitThumbnail,project/NumberOfNotCompletedSales,project/project/infoText,sale/icon
