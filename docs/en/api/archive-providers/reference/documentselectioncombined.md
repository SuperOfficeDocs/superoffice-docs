...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=contact/email/emailHasBounced,contact/contactAssociate/role,contact/NumberOfNotCompletedActivities,documentUdef/SuperOffice:4
