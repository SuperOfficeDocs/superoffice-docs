...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=yourref,person/restrictionAddress/formattedAddress,person/personAssociate/assocTooltip,contact/contactAssociate/contactCategory,contact/contactUdef/SuperOffice:13
