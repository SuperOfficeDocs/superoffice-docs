...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/birthMonth,contact/contactId,contact/streetAddress/formattedAddress,contact/contactAssociate/assocTooltip,project/LastDoBySale
