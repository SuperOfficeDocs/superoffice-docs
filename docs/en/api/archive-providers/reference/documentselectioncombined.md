...
```http!
GET /api/v1/archive/DocumentSelectionCombined?$select=person/personInfo/infoText,contact/email/emailDescription,contact/contactAssociate/credentialType,project/projectAssociate/ejStatus,sale/saleUdef/SuperOffice:7
