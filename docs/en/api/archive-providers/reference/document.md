...
```http!
GET /api/v1/archive/Document?$select=who,person/birthDay,person/restrictionAddress/state,person/correspondingAssociate/middleName,person/withdrawnStoreConsent
