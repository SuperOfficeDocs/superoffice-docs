...
```http!
GET /api/v1/archive/Document?$select=documentPublish/isPublished,person/personUdef/SuperOffice:6,person/personExtra/x_person_longtext,person/personExtra/y_rental/x_amount,contact/contactExtra/x_contact_dropdown
