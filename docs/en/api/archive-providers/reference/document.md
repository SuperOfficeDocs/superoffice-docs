...
```http!
GET /api/v1/archive/Document?$select=isReport,person/personInfo/infoText,contact/contactSource,contact/NumberOfNotCompletedActivitiesInPeriod,project/endDate
