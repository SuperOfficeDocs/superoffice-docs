...
```http!
GET /api/v1/archive/Document?$select=person/restrictionAddress/formattedMultiLineAddress,person/personInterestIds,person/personAssociate/ejUserId,person/correspondingAssociate/assocName,contact/code
