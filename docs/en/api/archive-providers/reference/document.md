...
```http!
GET /api/v1/archive/Document?$select=person/createdByForm,person/personDirectPhone/description,person/personUdef/SuperOffice:10,contact/contactAssociate/role,associate/middleName
