...
```http!
GET /api/v1/archive/Document?$select=person/restrictionAddress/addressId,contact/code,contact/saintActivityType,project/projectAssociate/ejStatus,sale/saleTypeId
