...
```http!
GET /api/v1/archive/Document?$select=contact/contactId,contact/contactUdef/SuperOffice:2,project/projectId,project/projectAssociate/role,sale/associate/ejUserId
