...
```http!
GET /api/v1/archive/Document?$select=person/email/emailProtocol,person/personExtra/x_person_integer,contact/contactFax/formattedNumber,project/statusRank,associate/credentialType
