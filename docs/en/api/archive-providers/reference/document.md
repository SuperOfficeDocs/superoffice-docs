...
```http!
GET /api/v1/archive/Document?$select=person/middleName,person/personAddress/addressId,person/personAddress/line3,person/personExtra/y_rental/x_end,person/withdrawnStoreConsent
