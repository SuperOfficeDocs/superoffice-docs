...
```http!
GET /api/v1/archive/Document?$select=person/leadStatus,person/personAssociate/locationAddress,project/projectPublish/publishedTo,associate/isLocation,sale/time
