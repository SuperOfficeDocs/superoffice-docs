...
```http!
GET /api/v1/archive/Document?$select=personId,person/subscription,contact/contactPhone/formattedNumber,project/projectAssociate/role,project/projectAssociate/isActiveText
