...
```http!
GET /api/v1/archive/Document?$select=contact/phone/formattedNumber,contact/contactInterestIds,contact/contactExtra/x_contact_boolean,contact/NumberOfSalesInPeriod,project/projectUdef/SuperOffice:4
