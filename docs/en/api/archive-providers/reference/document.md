...
```http!
GET /api/v1/archive/Document?$select=userGroup,updatedByFullName,person/correspondingAssociate/firstName,contact/streetAddress/wgs84longitude,contact/restrictionAddress/zip
