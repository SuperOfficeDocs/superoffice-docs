...
```http!
GET /api/v1/archive/Document?$select=subject,person/personExtra/y_rental/x_end,contact/contactId,contact/registeredBy,contact/streetAddress/wgs84longitude
