...
```http!
GET /api/v1/archive/Document?$select=documentId,person/personUpdatedDate,person/personExtra/x_person_timespan,person/personAssociate/contactDepartment,contact/department
