...
```http!
GET /api/v1/archive/Document?$select=updatedBy,person/kanaLastName,person/correspondingAssociate/contactCategory,person/correspondingAssociate/assocName,contact/contactUdef/SuperOffice:3
