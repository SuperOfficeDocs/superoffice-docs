...
```http!
GET /api/v1/archive/Document?$select=person/personDirectPhone/formattedNumber,person/personExtra/y_rental/id,person/personAssociate/ejStatus,person/correspondingAssociate/contactName,contact/LastCompletedActivity
