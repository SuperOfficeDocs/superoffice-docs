...
```http!
GET /api/v1/archive/Document?$select=documentId,person/restrictionAddress/zip,person/correspondingAssociate/mrMrs,person/correspondingAssociate/assocType,contact/streetAddress/line3
