...
```http!
GET /api/v1/archive/Document?$select=contact/activeErpLinks,contact/deletedDate,contact/streetAddress/zip,contact/contactAssociate/contactName,project/type
