...
```http!
GET /api/v1/archive/Document?$select=registeredBy,person/personNoMail,person/personExtra/x_person_time,person/correspondingAssociate/contactCategory,contact/updatedDate
