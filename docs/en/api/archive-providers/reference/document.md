...
```http!
GET /api/v1/archive/Document?$select=person/personInterestIds,contact/registeredByFullName,contact/LastDoBySale,contact/saintTicketStatus,project/projectAssociate/isActiveText
