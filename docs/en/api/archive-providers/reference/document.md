...
```http!
GET /api/v1/archive/Document?$select=person/createdByForm,person/personAssociate/isLocation,contact/email/emailLastSent,contact/LastCompletedSale,contact/SaintStatus2
