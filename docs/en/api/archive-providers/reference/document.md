...
```http!
GET /api/v1/archive/Document?$select=person/personAssociate/ejUserId,contact/hasInterests,contact/updatedBy,project/projectAssociate/ejStatus,sale/saleStatus
