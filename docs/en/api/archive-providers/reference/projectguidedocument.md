...
```http!
GET /api/v1/archive/ProjectGuideDocument?$select=documentInstance/person/personRegisteredDate,documentInstance/person/email/emailDescription,documentInstance/project/projectId
