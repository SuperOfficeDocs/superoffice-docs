...
```http!
GET /api/v1/archive/ProjectGuideDocument?$select=projectId,suggestedItemOrderBy,documentInstance/completed,documentInstance/who,documentInstance/person/personUpdatedDate
