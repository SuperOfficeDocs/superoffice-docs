...
```http!
GET /api/v1/archive/ProjectGuideDocument?$select=instanceItemId,documentInstance/person/portraitThumbnail,documentInstance/contact/phone/formattedNumber
