...
```http!
GET /api/v1/archive/ProjectGuideDocument?$select=documentInstance/person/personRegisteredBy,documentInstance/person/personAssociate/contactFullName,documentInstance/project/projectAssociate/otherGroups
