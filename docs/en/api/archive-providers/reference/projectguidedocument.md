...
```http!
GET /api/v1/archive/ProjectGuideDocument?$select=documentInstance/person/hasCompany,documentInstance/person/personAddress/addressId,documentInstance/contact/contactAssociate/mrMrs
