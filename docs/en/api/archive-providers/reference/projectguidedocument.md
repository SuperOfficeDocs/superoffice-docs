...
```http!
GET /api/v1/archive/ProjectGuideDocument?$select=documentInstance/person/hasInterests,documentInstance/person/personAssociate/contactName,documentInstance/contact/contactAssociate/usergroupId,documentInstance/contact/contactAssociate/locationAddress,documentInstance/project/projectAssociate/contactDepartment
