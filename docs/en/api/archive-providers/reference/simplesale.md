...
```http!
GET /api/v1/archive/SimpleSale?$select=contactId,person/associateType,person/personExtra/y_rental/id,person/hasStoreConsent,contact/contactFax/description
