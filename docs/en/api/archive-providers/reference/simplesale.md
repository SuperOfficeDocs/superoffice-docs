...
```http!
GET /api/v1/archive/SimpleSale?$select=person/birthDay,person/email/emailId,person/personAssociate/ejUserId,person/correspondingAssociate/personId,contact/contactAssociate/contactDepartment
