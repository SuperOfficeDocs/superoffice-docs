...
```http!
GET /api/v1/archive/SimpleSale?$select=icon,recordType,person/personSource,person/personAddress/city,person/personExtra/x_person_user_relation
