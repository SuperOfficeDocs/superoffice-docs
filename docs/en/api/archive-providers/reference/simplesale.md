...
```http!
GET /api/v1/archive/SimpleSale?$select=person/birthYear,person/correspondingAssociate/contactFullName,contact/streetAddress/line2,contact/streetAddress/city,associate/contactFullName
