...
```http!
GET /api/v1/archive/SimpleSale?$select=sale/description,person/portraitThumbnail,person/restrictionAddress/addressId,person/personExtra/x_person_datetime,contact/nameDepartment
