...
```http!
GET /api/v1/archive/SimpleSale?$select=person/updatedByWorkflow,person/personAddress/line3,person/restrictionAddress/wgs84longitude,person/personAssociate/title,person/correspondingAssociate/middleName
