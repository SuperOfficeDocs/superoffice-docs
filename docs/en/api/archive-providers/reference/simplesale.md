...
```http!
GET /api/v1/archive/SimpleSale?$select=person/lastName,person/personAssociateId,person/personExtra/x_person_shorttext_list,person/personAssociate/usergroupId,person/personAssociate/isLocation
