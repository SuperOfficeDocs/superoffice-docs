...
```http!
GET /api/v1/archive/SimpleSale?$select=saleTypeCategory,person/middleName,person/personBusiness,person/personExtra/y_rental/x_contact,contact/contactPhone/formattedNumber
