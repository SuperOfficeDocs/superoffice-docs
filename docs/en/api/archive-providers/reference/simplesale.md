...
```http!
GET /api/v1/archive/SimpleSale?$select=person/personAssociateId,person/personExtra/x_person_contact_relation,contact/contactUdef/SuperOffice:9,contact/LastSale,project/projectEvent/hasSignOn
