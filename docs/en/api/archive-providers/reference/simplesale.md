...
```http!
GET /api/v1/archive/SimpleSale?$select=contact/postAddress/formattedMultiLineAddress,saleUdef/SuperOffice:6,project/projectAssociate/middleName,project/projectUdef/SuperOffice:2
