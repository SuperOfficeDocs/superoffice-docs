...
```http!
GET /api/v1/archive/SimpleSale?$select=stalledComment,person/personCategory,person/personAssociate/ejStatus,contact/url/URLAddress,contact/url/URLDescription
