...
```http!
GET /api/v1/archive/SimpleSale?$select=updatedDate,person/middleName,person/personUpdatedByFullName,person/personAddress/wgs84longitude,contact/searchPhone/description
