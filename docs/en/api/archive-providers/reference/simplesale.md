...
```http!
GET /api/v1/archive/SimpleSale?$select=person/portraitThumbnail,person/personAddress/line3,person/personAssociate/role,contact/searchPhone/formattedNumber,project/NumberOfNotCompletedSales
