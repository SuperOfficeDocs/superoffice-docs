...
```http!
GET /api/v1/archive/SimpleSale?$select=person/personAddress/county,person/correspondingAssociate/middleName,contact/contactUdef/SuperOffice:11,contact/NumberOfActivitiesInPeriod,contact/saintSaleStatus
