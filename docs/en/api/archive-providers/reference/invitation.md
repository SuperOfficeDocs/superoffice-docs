...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactId,contact/countryId,contact/streetAddress/zip,contact/contactAssociate/mrMrs,person/searchPhone/description
