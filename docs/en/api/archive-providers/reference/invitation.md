...
```http!
GET /api/v1/archive/Invitation?$select=contact/restrictionAddress/wgs84latitude,contact/contactAssociate/contactCategory,person/personAddress/city,person/personAssociate/portraitThumbnail,sale/salePublish/publishedBy
