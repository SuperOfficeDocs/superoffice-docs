...
```http!
GET /api/v1/archive/Invitation?$select=appointmentId,appointmentPublish/publishedTo,contact/contactAssociate/contactId,contact/contactExtra/x_contact_time,contact/NumberOfActivitiesInPeriod
