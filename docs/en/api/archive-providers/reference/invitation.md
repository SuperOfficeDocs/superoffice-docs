...
```http!
GET /api/v1/archive/Invitation?$select=registeredBy,contact/code,person/firstName,person/personDirectFax/description,person/correspondingAssociate/otherGroups
