...
```http!
GET /api/v1/archive/Invitation?$select=associateId,contactId,contact/streetAddress/county,person/correspondingAssociate/contactFullName,project/statusRank
