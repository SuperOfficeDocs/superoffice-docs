...
```http!
GET /api/v1/archive/Invitation?$select=contact/updatedByFullName,contact/contactAssociate/credentialType,person/personExtra/x_person_time,project/imageThumbnail,project/projectUdef/SuperOffice:4
