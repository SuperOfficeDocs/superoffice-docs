...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactAssociate/mrMrs,person/middleName,person/hasStoreConsent,project/projectAssociate/middleName,sale/text
