...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactExtra/y_organization/x_name,person/mrMrs,person/personAddress/wgs84latitude,person/personExtra/x_person_time,person/personExtra/y_rental/x_end
