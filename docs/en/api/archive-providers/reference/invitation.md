...
```http!
GET /api/v1/archive/Invitation?$select=person/useAsMailingAddress,person/personAssociate/lastName,person/personAssociate/personId,project/projectAssociate/fullName,sale/associate/personEmail
