...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactAssociate/contactId,contact/contactAssociate/title,contact/contactUdef/SuperOffice:12,project/type,project/projectAssociate/fullName
