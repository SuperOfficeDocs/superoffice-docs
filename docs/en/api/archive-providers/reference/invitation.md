...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactSource,contact/streetAddress/county,person/personCategoryGroup,person/correspondingAssociate/ejDisplayName,project/projectAssociate/contactFullName
