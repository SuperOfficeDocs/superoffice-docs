...
```http!
GET /api/v1/archive/Invitation?$select=rawStatus,contact/contactExtra/x_contact_hidden_integer,person/hasInfoText,person/birthYear,sale/associate/contactFullName
