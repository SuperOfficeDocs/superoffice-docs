...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactAssociate/contactName,contact/contactUdef/SuperOffice:5,person/personInfo/textId,person/restrictionAddress/line3,person/legalBaseEmarketing
