...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactId,contact/contactPhone/description,contact/postAddress/county,contact/restrictionAddress/county,contact/contactExtra/x_contact_contact
