...
```http!
GET /api/v1/archive/Invitation?$select=contact/contactAssociate/contactId,contact/contactExtra/x_contact_timespan,person/retired,person/personExtra/x_person_request_relation,project/number
