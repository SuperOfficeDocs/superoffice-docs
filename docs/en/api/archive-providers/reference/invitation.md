...
```http!
GET /api/v1/archive/Invitation?$select=contact/nameDepartment,contact/activeErpLinks,contact/restrictionAddress/wgs84latitude,person/personId,person/personExtra/x_person_user_relation
