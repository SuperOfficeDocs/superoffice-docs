...
```http!
GET /api/v1/archive/Invitation?$select=contact/updatedDate,person/personUpdatedDate,person/hasCompany,person/restrictionAddress/state,person/correspondingAssociate/simultaneousEjUser
