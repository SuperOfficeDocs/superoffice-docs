...
```http!
GET /api/v1/archive/Invitation?$select=contact/postAddress/state,person/personAssociate/role,person/personAssociate/ejDisplayName,project/saintTicketCategory,associate/assocName
