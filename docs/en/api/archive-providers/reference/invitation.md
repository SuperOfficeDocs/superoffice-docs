...
```http!
GET /api/v1/archive/Invitation?$select=contact/postAddress/county,contact/contactAssociate/mrMrs,contact/NumberOfSalesInPeriod,contact/NumberOfNotCompletedSales,person/personAssociate/locationAddress
