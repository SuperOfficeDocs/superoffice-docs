...
```http!
GET /api/v1/archive/Invitation?$select=updatedDate,contact/restrictionAddress/zip,contact/NumberOfNotCompletedTickets,person/personHasInterests,person/personExtra/y_rental/x_contact
