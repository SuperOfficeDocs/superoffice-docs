...
```http!
GET /api/v1/archive/personfavourites?$select=searchPhone/description,personContact/postAddress/line1,request/ticketStatusName,request/author,request/numberOfReplies
