...
```http!
GET /api/v1/archive/personfavourites?$select=personExtra/x_person_shorttext_list,personAssociate/firstName,personAssociate/simultaneousEjUser,personAssociate/ejStatus,department
