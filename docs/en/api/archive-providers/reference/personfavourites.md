...
```http!
GET /api/v1/archive/personfavourites?$select=personRegisteredDate,personSourceRelation/birthYear,personAssociate/mrMrs,personContact/registeredDate,personContact/restrictionPostalAddress/zip
