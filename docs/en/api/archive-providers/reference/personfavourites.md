...
```http!
GET /api/v1/archive/personfavourites?$select=rank,personRegisteredBy,personExtra/x_person_date,personAssociate/fullName,personAssociate/contactDepartment
