...
```http!
GET /api/v1/archive/personfavourites?$select=icon,personContact/contactAssociate/usergroup,request/realTimeToReply,request/createdBy/role,request/extra/x_ticket_datetime
