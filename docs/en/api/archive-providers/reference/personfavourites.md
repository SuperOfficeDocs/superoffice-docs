...
```http!
GET /api/v1/archive/personfavourites?$select=personAssociate/assocType,correspondingAssociate/firstName,correspondingAssociate/role,forceCompany,contactAssociate/userName
