...
```http!
GET /api/v1/archive/personfavourites?$select=portraitThumbnail,searchPhone/description,personSourceRelation/personHasInterests,personAssociate/lastName,personAssociate/otherGroups
