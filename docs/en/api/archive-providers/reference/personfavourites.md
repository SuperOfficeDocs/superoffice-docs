...
```http!
GET /api/v1/archive/personfavourites?$select=personRegisteredDate,personMobilePhone/description,restrictionAddress/county,personExtra/x_person_hidden_integer,correspondingAssociate/mrMrs
