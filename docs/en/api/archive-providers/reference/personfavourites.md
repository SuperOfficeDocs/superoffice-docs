...
```http!
GET /api/v1/archive/personfavourites?$select=lastName,personAddress/addressId,personSourceRelation/hasInfoText,personTargetRelation/mrMrs,personTargetRelation/personDeletedDate
