...
```http!
GET /api/v1/archive/personfavourites?$select=restrictionAddress/line3,personSourceRelation/personSource,personSourceRelation/createdByForm,correspondingAssociate/mrMrs,correspondingAssociate/isLocation
