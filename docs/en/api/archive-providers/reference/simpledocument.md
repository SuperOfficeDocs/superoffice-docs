...
```http!
GET /api/v1/archive/SimpleDocument?$select=registeredByFullName,contact/contactUdef/SuperOffice:12,project/projectAssociate/contactDepartment,sale/associate/mrMrs
