...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/mrMrs,person/position,contact/streetAddress/wgs84longitude,contact/contactAssociate/usergroup,contact/contactAssociate/isActive
