...
```http!
GET /api/v1/archive/SimpleDocument?$select=date,person/hasInfoText,person/restrictionAddress/state,person/personAssociate/mrMrs,associate/credentialType
