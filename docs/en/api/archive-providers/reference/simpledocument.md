...
```http!
GET /api/v1/archive/SimpleDocument?$select=time,person/correspondingAssociate/isActiveText,person/correspondingAssociate/isLocation,person/hasEmarketingConsent,contact/email/emailHasBounced
