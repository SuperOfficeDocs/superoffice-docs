...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personAssociate/contactCategory,contact/number,project/saintIntention,associate/credentialDisplayValue
