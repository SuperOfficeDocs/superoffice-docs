...
```http!
GET /api/v1/archive/SimpleDocument?$select=documentPublish/publishedBy,contact/url/URLDescription,project/projectAssociate/ejStatus,sale/stalledComment,sale/createdByWorkflow
