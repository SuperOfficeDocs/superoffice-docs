...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personCategory,person/personDeletedDate,person/personMobilePhone/formattedNumber,person/email/emailHasBounced,person/correspondingAssociate/usergroupId
