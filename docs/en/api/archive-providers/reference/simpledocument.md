...
```http!
GET /api/v1/archive/SimpleDocument?$select=registeredByFullName,person/ticketPriority,person/personDeletedDate,project/projectAssociate/contactCategory,sale/source
