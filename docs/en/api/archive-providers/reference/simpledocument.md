...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/mrMrs,person/birthMonth,person/personPrivate/formattedNumber,contact/restrictionAddress/state,associate/lastName
