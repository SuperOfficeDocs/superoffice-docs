...
```http!
GET /api/v1/archive/SimpleDocument?$select=isMail,person/personExtra/x_person_boolean,person/correspondingAssociate/associateDbId,contact/updatedBy,project/projectPublish/isPublished
