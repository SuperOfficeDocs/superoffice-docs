...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personAddress/line2,person/correspondingAssociate/ejUserId,person/legalBaseStore,contact/number,contact/contactAssociate/contactId
