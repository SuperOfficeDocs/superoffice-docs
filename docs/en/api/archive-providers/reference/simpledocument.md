...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personAssociate/simultaneousEjUser,contact/contactId,contact/url/URLDescription,contact/saintDirection
