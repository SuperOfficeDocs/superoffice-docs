...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/correspondingAssociate/mrMrs,person/correspondingAssociate/locationAddress,contact/contactExtra/x_contact_shorttext,project/registeredByFullName,sale/stalledComment
