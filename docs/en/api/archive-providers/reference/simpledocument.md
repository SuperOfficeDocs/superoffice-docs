...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personMobilePhone/description,person/correspondingAssociate/personId,contact/code,contact/updatedDate,contact/restrictionAddress/wgs84latitude
