...
```http!
GET /api/v1/archive/SimpleDocument?$select=saleId,person/personCountryId,person/personUdef/SuperOffice:10,contact/email/emailAddress,project/registeredBy
