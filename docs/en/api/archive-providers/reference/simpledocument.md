...
```http!
GET /api/v1/archive/SimpleDocument?$select=recordType,documentPublish/publishedFrom,person/birthdate,person/personActiveErpLinks,person/personExtra/x_person_appointment_relation
