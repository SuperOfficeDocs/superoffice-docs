...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/restrictionAddress/line3,person/subscription,contact/nameDepartment,contact/contactExtra/x_contact_integer,project/projectAssociate/ejUserId
