...
```http!
GET /api/v1/archive/SimpleDocument?$select=name,person/personUpdatedByFullName,contact/NumberOfNotCompletedActivities,contact/NumberOfSalesInPeriod,project/projectUdef/SuperOffice:5
