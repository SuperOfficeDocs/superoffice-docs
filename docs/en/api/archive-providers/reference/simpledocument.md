...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personRegisteredDate,contact/streetAddress/addressId,contact/streetAddress/wgs84latitude,project/projectAssociate/assocTooltip,sale/who
