...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personCountryId,person/personDirectPhone/formattedNumber,person/personAddress/line1,person/personAssociate/contactDepartment,contact/countryId
