...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personUpdatedByFullName,person/portraitThumbnail,person/correspondingAssociate/mrMrs,project/projectAssociate/title,project/projectAssociate/ejUserId
