...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/personAssociate/contactId,contact/restrictionAddress/county,contact/NumberOfNotCompletedSalesInPeriod,project/nextMilestone,project/saintSaleStatus
