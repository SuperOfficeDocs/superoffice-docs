...
```http!
GET /api/v1/archive/SimpleDocument?$select=person/email/emailAddress,person/personAssociate/credentialType,person/correspondingAssociate/contactId,contact/contactId,contact/department
