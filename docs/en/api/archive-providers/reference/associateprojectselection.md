...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=LastCompletedActivity,document/recordType,document/associate/otherGroups,projectMember/email/emailBounceCount,projectMember/restrictionAddress/line1
