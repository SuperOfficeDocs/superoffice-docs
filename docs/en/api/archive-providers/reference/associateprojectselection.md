...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=LastActivity,sale/associate/contactCategory,sale/associate/assocType,sale/associate/credentialDisplayValue,projectMember/personUdef/SuperOffice:6
