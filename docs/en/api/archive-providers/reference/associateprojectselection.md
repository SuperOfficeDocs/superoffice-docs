...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=projectAssociate/contactCategory,sale/probPercent,sale/saleUdef/SuperOffice:2,appointment/recordType,document/updatedDate
