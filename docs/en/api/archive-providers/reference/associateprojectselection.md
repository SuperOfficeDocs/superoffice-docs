...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/type,projectMember/registered,projectMember/personAssociate/mrMrs,projectMember/contactNoMail,projectMember/contactAssociate/mrMrs
