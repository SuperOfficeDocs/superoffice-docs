...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=getAllRows,sale/amountWeightedInBaseCurrency,sale/associate/contactId,sale/associate/ejDisplayName,appointment/recordType
