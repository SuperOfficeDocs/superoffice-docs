...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/associate/userName,document/personId,document/associate/contactFullName,document/associate/role,document/associate/ejDisplayName
