...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/personId,sale/userGroup,sale/associate/assocName,document/saleId,projectMember/personRegisteredBy
