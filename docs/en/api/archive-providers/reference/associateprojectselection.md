...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=projectPublish/publishedTo,projectAssociate/isActiveText,appointment/icon,appointment/suggestedAppointmentId,appointment/associate/associateDbId
