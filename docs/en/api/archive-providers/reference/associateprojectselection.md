...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=appointment/appointment/titleHtml,appointment/appointment/agendaHtml,projectMember/personPrivate/formattedNumber,projectMember/countryId,projectMember/contactUdef/SuperOffice:1
