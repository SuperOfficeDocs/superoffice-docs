...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/associate/associateDbId,document/time,document/updatedByFullName,document/documentPublish/publishedFrom,document/documentUdef/SuperOffice:1
