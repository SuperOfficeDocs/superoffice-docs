...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/source,sale/saleUdef/SuperOffice:6,appointment/isMilestone,document/ourref,document/associate/usergroup
