...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=getNoRows,saintAmountClass,appointment/personId,appointment/appointmentPublish/isPublished,projectMember/personUdef/SuperOffice:8
