...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/who,appointment/associate/credentialType,document/ourref,projectMember/middleName,projectMember/personNoMail
