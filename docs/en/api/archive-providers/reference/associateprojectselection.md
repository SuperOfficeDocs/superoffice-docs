...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=projectAssociate/firstName,projectAssociate/role,sale/lossReason,appointment/appointmentUdef/SuperOffice:6,appointment/associate/contactDepartment
