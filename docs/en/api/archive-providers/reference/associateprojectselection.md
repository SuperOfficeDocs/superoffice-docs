...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=projectAssociate/otherGroups,projectUdef/SuperOffice:7,sale/hasGuide,appointment/appointmentId,projectMember/birthYear
