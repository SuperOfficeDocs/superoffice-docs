...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=appointment/recurring,document/associate/role,projectMember/hasInfoText,projectMember/personCountryId,projectMember/email/emailLastSent
