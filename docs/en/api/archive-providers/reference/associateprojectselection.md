...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=projectAssociate/ejUserId,sale/contactId,appointment/appointment/agenda,document/isMail,document/recordTypeText
