...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=activeErpLinks,projectMember/email/emailId,projectMember/personAddress/formattedAddress,projectMember/restrictionAddress/formattedMultiLineAddress,projectMember/correspondingAssociate/simultaneousEjUser
