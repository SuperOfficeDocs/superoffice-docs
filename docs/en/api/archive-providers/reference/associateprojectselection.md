...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=updatedDate,sale/associate/simultaneousEjUser,document/attention,document/associate/assocType,projectMember/personAddress/city
