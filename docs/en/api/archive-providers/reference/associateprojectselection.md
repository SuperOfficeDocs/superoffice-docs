...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=projectUdef/SuperOffice:1,projectUdef/SuperOffice:10,NumberOfNotCompletedActivitiesInPeriod,sale/description,sale/associate/ejDisplayName
