...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=registeredByFullName,saintActivityType,sale/registeredDate,sale/visibleFor,projectMember/personDirectFax/description
