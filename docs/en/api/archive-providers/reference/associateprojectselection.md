...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=saintIntention,sale/activeErpLinks,sale/associate/contactFullName,appointment/appointmentUdef/SuperOffice:4,document/updatedByFullName
