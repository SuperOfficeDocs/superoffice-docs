...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=appointment/completed,document/type,document/yourref,document/mailMergeDraft,document/associate/ejStatus
