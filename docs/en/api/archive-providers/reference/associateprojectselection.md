...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/date,document/associate/firstName,document/associate/title,document/associate/userName,projectMember/email/emailBounceCount
