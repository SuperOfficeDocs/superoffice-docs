...
```http!
GET /api/v1/archive/AssociateProjectSelection?$select=sale/heading,appointment/priority,appointment/recordTypeText,document/associate/personId,document/associate/credentialDisplayValue
