...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=projectId,registeredByFullName,person/personAssociate/lastName,person/personAssociate/assocType,sale/associate/contactId
