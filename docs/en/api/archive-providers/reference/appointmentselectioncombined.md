...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=completedDate,contact/registeredByFullName,contact/LastDoBySale,contact/SaintStatus2,person/personUdef/SuperOffice:4
