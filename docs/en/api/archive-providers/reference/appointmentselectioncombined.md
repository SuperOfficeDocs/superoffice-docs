...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=icon,registeredBy,contact/contactUdef/SuperOffice:4,person/correspondingAssociate/contactDepartment,sale/saleType
