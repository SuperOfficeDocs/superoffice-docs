...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=registeredBy,contact/contactExtra/x_contact_timespan,person/kanaFirstName,person/personRegisteredByFullName,person/personAddress/zip
