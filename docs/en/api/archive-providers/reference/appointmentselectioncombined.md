...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/contactSource,contact/postAddress/zip,person/personExtra/y_rental/x_amount,person/personAssociate/assocType,person/isMailingRecipient
