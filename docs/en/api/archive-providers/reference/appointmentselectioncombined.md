...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/restrictionAddress/county,person/retired,person/personExtra/x_person_priority_relation,sale/who,associate/contactDepartment
