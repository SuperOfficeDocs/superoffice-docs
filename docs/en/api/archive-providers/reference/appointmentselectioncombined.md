...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=saleId,contact/mainContact,contact/contactExtra/x_contact_default_integer,person/email/emailLastBounce,sale/earning
