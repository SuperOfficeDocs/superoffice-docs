...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/contactAssociate/personEmail,person/email/emailHasBounced,project/endDate,project/LastCompletedActivity,sale/time
