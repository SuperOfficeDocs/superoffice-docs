...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/contactAssociate/usergroup,contact/contactAssociate/credentialDisplayValue,person/personPrivate/description,person/correspondingAssociate/personId,project/updatedBy
