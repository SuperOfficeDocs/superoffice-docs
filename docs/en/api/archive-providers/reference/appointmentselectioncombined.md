...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/mainContact,contact/email/emailAddress,contact/contactAssociate/contactId,contact/LastDoByTicket,person/personUdef/SuperOffice:1
