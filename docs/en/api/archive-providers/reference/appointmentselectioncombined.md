...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=alarm,contact/contactAssociate/lastName,person/kanaFirstName,person/personRegisteredDate,person/personUdef/SuperOffice:8
