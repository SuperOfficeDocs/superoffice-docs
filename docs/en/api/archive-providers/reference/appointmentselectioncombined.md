...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=recordTypeText,contact/registeredBy,contact/contactUdef/SuperOffice:12,person/personCountryId,project/projectAssociate/assocName
