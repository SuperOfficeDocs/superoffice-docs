...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/country,person/personExtra/x_person_priority_relation,project/saintAmountClass,sale/associate/ejDisplayName,associate/assocName
