...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=person/withdrawnStoreConsent,appointmentUdef/SuperOffice:5,appointmentUdef/SuperOffice:7,project/projectAssociate/isActive
