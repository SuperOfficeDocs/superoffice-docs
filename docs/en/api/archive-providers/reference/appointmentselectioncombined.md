...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/contactAssociate/mrMrs,person/correspondingAssociate/contactCategory,sale/recordType,sale/associate/personId
