...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=updatedByFullName,createdByWorkflow,contact/streetAddress/county,person/personExtra/y_rental/x_amount,person/isMailingRecipient
