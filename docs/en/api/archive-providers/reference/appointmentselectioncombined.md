...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/contactAssociate/associateDbId,project/statusRank,project/projectPublish/publishedTo,project/saintDirection,sale/stalledComment
