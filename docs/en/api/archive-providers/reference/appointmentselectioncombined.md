...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/contactExtra/x_contact_time,contact/LastCompletedSale,person/position,person/birthYear,person/personExtra/x_person_datetime
