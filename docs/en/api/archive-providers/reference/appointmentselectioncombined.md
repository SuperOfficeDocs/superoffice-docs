...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=time,contact/postAddress/wgs84longitude,contact/contactUdef/SuperOffice:7,person/firstName,person/searchPhone/description
