...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/restrictionAddress/addressId,contact/restrictionAddress/wgs84latitude,person/fullName,person/birthMonth,project/projectAssociate/otherGroups
