...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/name,contact/streetAddress/zip,contact/contactExtra/x_contact_request_relation,person/personAddress/line2,associate/mrMrs
