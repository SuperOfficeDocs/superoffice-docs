...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=appointmentId,contact/name,contact/LastSale,project/projectAssociate/contactCategory,project/project/infoText
