...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=projectId,contact/contactAssociate/middleName,contact/contactAssociate/ejDisplayName,person/personRegisteredByFullName,person/personPrivate/formattedNumber
