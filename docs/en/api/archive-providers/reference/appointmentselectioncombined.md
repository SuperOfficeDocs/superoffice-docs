...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=who,contact/LastDoBySale,person/restrictionAddress/line2,project/saintAmountClass,project/saintIntention
