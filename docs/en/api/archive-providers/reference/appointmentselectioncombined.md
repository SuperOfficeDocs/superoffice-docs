...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=contact/contactPhone/description,contact/searchPhone/description,person/personAssociate/usergroup,person/personAssociate/ejUserId,sale/hasQuote
