...
```http!
GET /api/v1/archive/AppointmentSelectionCombined?$select=icon,contact/searchPhone/description,contact/email/emailLastSent,contact/contactAssociate/isLocation,person/email/emailLastSent
