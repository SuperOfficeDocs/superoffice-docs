...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectMember/streetAddress/zip,projectMember/contactAssociate/firstName,projectMember/LastTicket
