...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectUdef/SuperOffice:2,sale/lossReason,sale/activeErpLinks,appointment/associate/assocTooltip,document/type
