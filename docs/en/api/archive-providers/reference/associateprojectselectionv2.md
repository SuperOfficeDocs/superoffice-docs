...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=sale/projectId,sale/associate/assocName,document/associate/assocName,projectMember/streetAddress/formattedAddress,projectMember/contactAssociate/otherGroups
