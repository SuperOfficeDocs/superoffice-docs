...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectUdef/SuperOffice:2,sale/amount,appointment/associate/userName,document/saleId,document/registeredBy
