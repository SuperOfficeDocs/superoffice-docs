...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/portraitThumbnail,projectUdef/SuperOffice:8,sale/currency,appointment/updatedBy,appointment/appointmentUdef/SuperOffice:2
