...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=completed,NumberOfNotCompletedActivities,sale/heading,appointment/associate/lastName,document/icon
