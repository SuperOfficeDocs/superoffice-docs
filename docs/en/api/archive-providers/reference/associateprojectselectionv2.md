...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectUrl/URLAddress,projectAssociate/isActive,projectUdef/SuperOffice:3,projectUdef/SuperOffice:10,NumberOfNotCompletedActivitiesInPeriod
