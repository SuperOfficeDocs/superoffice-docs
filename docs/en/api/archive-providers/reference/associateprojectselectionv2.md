...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=appointment/location,appointment/associate/firstName,projectMember/personUrl/URLDescription,projectMember/contactExtra/x_contact_shorttext
