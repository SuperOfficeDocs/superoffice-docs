...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=NumberOfNotCompletedActivitiesInPeriod,sale/icon,sale/sale/textId,sale/associate/associateDbId,projectMember/hasStoreConsent
