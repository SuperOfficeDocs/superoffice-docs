...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=sale/credited,sale/earningPercent,appointment/contactId,appointment/appointmentUdef/SuperOffice:4,projectMember/infoText
