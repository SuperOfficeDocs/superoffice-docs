...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=type,sale/saleTypeCategory,appointment/associate/credentialDisplayValue,document/associate/title,projectMember/leadStatus
