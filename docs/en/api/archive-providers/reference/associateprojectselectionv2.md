...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/role,LastCompletedActivity,appointment/associate/role,appointment/associate/credentialType,document/associate/isActiveText
