...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=hasGuide,projectAssociate/simultaneousEjUser,sale/registeredDate,sale/visibleFor,sale/associate/isActiveText
