...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectPublish/isPublished,projectMember/personAssociate/contactCategory,projectMember/activeErpLinks,projectMember/contactAssociate/ejUserId,projectMember/contactAssociate/otherGroups
