...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=appointment/userGroup,appointment/registeredBy,appointment/cautionWarning,projectMember/personSource,projectMember/personAssociate/ejUserId
