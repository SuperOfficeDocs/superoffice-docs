...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/userName,sale/contactId,sale/salePublish/publishedTo,sale/associate/userName,document/associate/userName
