...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=registeredDate,appointment/associate/middleName,projectMember/isProjectMember,projectMember/personAssociate/title
