...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/assocName,saintSaleStatus,sale/stage,appointment/location,appointment/completedDate
