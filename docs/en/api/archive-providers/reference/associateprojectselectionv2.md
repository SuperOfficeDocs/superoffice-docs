...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/ejDisplayName,projectUdef/SuperOffice:9,NumberOfActivities,NumberOfNotCompletedActivitiesInPeriod,sale/associate/assocType
