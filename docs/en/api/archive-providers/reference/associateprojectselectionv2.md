...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectUdef/SuperOffice:10,appointment/rawType,appointment/associate/title,appointment/associate/simultaneousEjUser,document/updatedDate
