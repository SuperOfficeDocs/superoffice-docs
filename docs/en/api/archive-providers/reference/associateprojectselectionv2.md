...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=document/registeredBy,document/associate/associateDbId,document/associate/contactFullName,document/document/textId,projectMember/contactExtra/x_contact_dropdown
