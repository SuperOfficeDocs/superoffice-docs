...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectEvent/eventDate,projectAssociate/fullName,appointment/saleId,projectMember/restrictionAddress/line1,projectMember/personAssociate/assocName
