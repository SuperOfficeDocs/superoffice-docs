...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/fullName,NumberOfNotCompletedSalesInPeriod,sale/amountWeighted,sale/salePublish/publishedTo,document/who
