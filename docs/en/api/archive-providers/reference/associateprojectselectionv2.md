...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/assocTooltip,NumberOfSales,document/snum,projectMember/personExtra/x_person_category_relation,projectMember/code
