...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectAssociate/isActive,sale/icon,sale/credited,sale/source,projectMember/personExtra/x_person_integer
