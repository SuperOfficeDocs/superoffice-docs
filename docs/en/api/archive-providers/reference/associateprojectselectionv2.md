...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=sale/soldReason,sale/saleUdef/SuperOffice:7,sale/saleUdef/SuperOffice:8,appointment/visibleInDiary,appointment/associate/usergroup
