...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=sale/nextDueDate,projectMember/hasInfoText,projectMember/position,projectMember/contactAssociate/middleName,contactId
