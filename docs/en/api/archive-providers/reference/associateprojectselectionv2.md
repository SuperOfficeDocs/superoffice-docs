...
```http!
GET /api/v1/archive/AssociateProjectSelectionV2?$select=projectUdef/SuperOffice:5,sale/associate/contactCategory,document/associate/usergroupId,projectMember/leadStatus,projectMember/personAssociate/mrMrs
