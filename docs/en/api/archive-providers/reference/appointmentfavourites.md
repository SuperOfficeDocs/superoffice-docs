...
```http!
GET /api/v1/archive/appointmentfavourites?$select=person/personNumber,person/personAssociateId,person/personInterestIds,project/associateId,project/updatedByFullName
