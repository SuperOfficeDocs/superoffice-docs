...
```http!
GET /api/v1/archive/appointmentfavourites?$select=registeredDate,contact/restrictionAddress/city,person/restrictionAddress/line1,appointmentUdef/SuperOffice:2,project/projectEvent/isExternalEvent
