...
```http!
GET /api/v1/archive/appointmentfavourites?$select=projectId,contact/streetAddress/wgs84latitude,contact/contactAssociate/portraitThumbnail,person/restrictionAddress/state,person/subscription
