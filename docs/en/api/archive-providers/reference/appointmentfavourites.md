...
```http!
GET /api/v1/archive/appointmentfavourites?$select=contact/contactAssociate/ejDisplayName,person/personActiveErpLinks,project/projectAssociate/credentialType,sale/saleUdef/SuperOffice:7
