...
```http!
GET /api/v1/archive/appointmentfavourites?$select=saleId,contact/contactAssociate/credentialType,person/restrictionAddress/formattedAddress,project/updatedDate,project/projectEvent/eventDate
