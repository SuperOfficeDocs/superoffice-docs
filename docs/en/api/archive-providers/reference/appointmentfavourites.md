...
```http!
GET /api/v1/archive/appointmentfavourites?$select=priority,contact/name,contact/contactFax/formattedNumber,contact/postAddress/line1,contact/contactAssociate/ejDisplayName
