...
```http!
GET /api/v1/archive/appointmentfavourites?$select=recordTypeText,favouriteAssociateId,contact/streetAddress/line1,contact/contactUdef/SuperOffice:13,contact/contactExtra/x_contact_float
