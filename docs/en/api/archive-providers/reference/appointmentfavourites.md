...
```http!
GET /api/v1/archive/appointmentfavourites?$select=contact/postAddress/line3,contact/contactAssociate/locationAddress,contact/contactUdef/SuperOffice:11,person/lastName,person/personMobilePhone/description
