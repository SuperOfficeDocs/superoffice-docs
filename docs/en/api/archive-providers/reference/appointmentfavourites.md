...
```http!
GET /api/v1/archive/appointmentfavourites?$select=projectId,intention,contact/contactUdef/SuperOffice:11,contact/LastDoByTicket,person/personAddress/state
