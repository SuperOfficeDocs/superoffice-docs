...
```http!
GET /api/v1/archive/appointmentfavourites?$select=updatedByFullName,contact/email/emailId,person/searchPhone/formattedNumber,person/personAssociate/ejUserId,associate/ejUserId
