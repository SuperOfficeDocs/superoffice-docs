...
```http!
GET /api/v1/archive/appointmentfavourites?$select=contact/hasInterests,contact/activeErpLinks,contact/restrictionAddress/zip,contact/contactUdef/SuperOffice:5,associate/assocTooltip
