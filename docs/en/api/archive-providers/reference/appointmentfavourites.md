...
```http!
GET /api/v1/archive/appointmentfavourites?$select=contact/streetAddress/formattedMultiLineAddress,contact/contactAssociate/userName,contact/contactExtra/x_contact_default_integer,contact/contactExtra/x_contact_time,person/personPrivate/description
