...
```http!
GET /api/v1/archive/appointmentfavourites?$select=contact/streetAddress/line3,contact/streetAddress/state,contact/contactAssociate/middleName,contact/NumberOfSales,person/personUdef/SuperOffice:10
