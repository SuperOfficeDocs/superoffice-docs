...
```http!
GET /api/v1/archive/appointmentfavourites?$select=joinVideomeetUrl,person/personBusiness,person/email/emailId,person/correspondingAssociate/firstName,sale/associate/assocType
