...
```http!
GET /api/v1/archive/appointmentfavourites?$select=contact/contactId,contact/LastSale,person/personAssociate/contactFullName,project/projectAssociate/title,associate/middleName
