...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=contact/postAddress/state,contact/contactAssociate/contactCategory,document/associate/ejDisplayName,project/projectAssociate/userName,saleStakeholder/contact/LastSale
