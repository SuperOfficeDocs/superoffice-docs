...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/email/emailAddress,person/correspondingAssociate/assocName,contact/streetAddress/formattedMultiLineAddress,contact/restrictionAddress/line3,contact/contactAssociate/personId
