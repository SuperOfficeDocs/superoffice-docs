...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/personUrl/URLDescription,person/personAssociate/title,contact/NumberOfNotCompletedSalesInPeriod,appointment/associate/assocType,appointment/associate/ejUserId
