...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/birthMonth,person/email/emailHasBounced,person/personAssociate/title,person/correspondingAssociate/contactId,appointment/recurrenceRuleId
