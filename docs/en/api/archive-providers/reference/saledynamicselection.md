...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/fullName,person/personUdef/SuperOffice:3,person/personUdef/SuperOffice:4,person/personExtra/x_person_float,contact/NumberOfTicketsInPeriod
