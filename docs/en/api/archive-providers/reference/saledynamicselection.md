...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=associateId,person/restrictionAddress/formattedAddress,contact/contactAssociate/assocTooltip,contact/contactUdef/SuperOffice:4,associate/locationAddress
