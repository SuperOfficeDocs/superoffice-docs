...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/personExtra/x_person_priority_relation,contact/restrictionAddress/line1,appointment/text,document/updatedBy,project/projectPublish/publishedBy
