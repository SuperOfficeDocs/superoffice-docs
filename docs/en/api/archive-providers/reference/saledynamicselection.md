...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=projectId,earningPercent,salePublish/publishedFrom,person/personExtra/y_car/id,person/correspondingAssociate/fullName
