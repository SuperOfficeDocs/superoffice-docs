...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=nextDueDate,hasQuote,person/whenUpdatedByWorkflow,contact/contactAssociate/associateDbId,contact/contactInterestIds
