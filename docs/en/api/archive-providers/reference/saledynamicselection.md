...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=activeErpLinks,person/personExtra/x_person_float,person/correspondingAssociate/userName,person/legalBaseEmarketing,project/icon
