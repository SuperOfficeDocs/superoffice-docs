...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/portraitThumbnail,person/personAssociateId,person/personAssociate/credentialDisplayValue,person/personAssociate/locationAddress,contact/contactAssociate/ejStatus
