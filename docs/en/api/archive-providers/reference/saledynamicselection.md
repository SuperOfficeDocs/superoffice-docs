...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=currency,amountInBaseCurrency,person/personExtra/y_rental/x_contact,person/personAssociate/locationAddress,person/consentSourceEmarketing
