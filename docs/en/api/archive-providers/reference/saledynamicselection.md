...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/personInterestIds,person/correspondingAssociate/simultaneousEjUser,contact/hasInfoText,associate/assocType,appointment/updatedBy
