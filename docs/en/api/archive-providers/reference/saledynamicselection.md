...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=earning,person/personDeletedDate,person/email/emailId,contact/searchPhone/formattedNumber,contact/SaintStatus1
