...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/personUdef/SuperOffice:7,person/personAssociate/credentialDisplayValue,person/correspondingAssociate/credentialDisplayValue,contact/restrictionAddress/city,contact/contactExtra/x_contact_datetime
