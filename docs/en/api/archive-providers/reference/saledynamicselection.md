...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=person/title,person/correspondingAssociate/isLocation,person/hasStoreConsent,contact/NumberOfNotCompletedTickets,document/associate/ejDisplayName
