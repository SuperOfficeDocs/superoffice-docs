...
```http!
GET /api/v1/archive/SaleDynamicSelection?$select=amountInBaseCurrency,person/fullName,person/personAssociate/contactId,project/projectUdef/SuperOffice:3,project/projectUdef/SuperOffice:10
