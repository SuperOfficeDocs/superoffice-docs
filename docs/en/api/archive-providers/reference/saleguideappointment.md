...
```http!
GET /api/v1/archive/SaleGuideAppointment?$select=suggestedItemTooltip,appointmentInstance/sale/visibleFor,appointmentInstance/associate/contactCategory,appointmentInstance/associate/isActive
