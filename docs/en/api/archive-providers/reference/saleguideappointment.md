...
```http!
GET /api/v1/archive/SaleGuideAppointment?$select=appointmentInstance/contact/updatedDate,appointmentInstance/sale/probPercent,appointmentInstance/contact/LastCompletedTicket
