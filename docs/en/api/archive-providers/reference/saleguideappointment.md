...
```http!
GET /api/v1/archive/SaleGuideAppointment?$select=appointmentInstance/contact/contactExtra/x_contact_dropdown,appointmentInstance/contact/saintSaleStatus,appointmentInstance/project/registeredByFullName
