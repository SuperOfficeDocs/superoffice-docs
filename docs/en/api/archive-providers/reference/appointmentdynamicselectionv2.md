...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/countryId,contact/streetAddress/addressId,person/personExtra/y_rental/x_amount,sale/recordType,appointment/textId
