...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=person/createdByForm,person/restrictionAddress/county,project/NumberOfSalesInPeriod,sale/nextDueDate,sale/amountWeightedInBaseCurrency
