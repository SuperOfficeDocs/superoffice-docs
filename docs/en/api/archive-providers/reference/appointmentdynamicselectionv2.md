...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=person/personUdef/SuperOffice:6,person/personAssociate/ejStatus,project/projectAssociate/locationAddress,project/saintSaleStatus
