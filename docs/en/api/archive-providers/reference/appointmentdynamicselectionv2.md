...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/department,contact/country,contact/streetAddress/line1,person/correspondingAssociate/userName
