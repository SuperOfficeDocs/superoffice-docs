...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=recurring,suggestedAppointmentId,contact/postAddress/line1,contact/streetAddress/zip,contact/streetAddress/formattedMultiLineAddress
