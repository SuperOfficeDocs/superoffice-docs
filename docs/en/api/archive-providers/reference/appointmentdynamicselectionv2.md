...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/contactNoMail,contact/registeredByFullName,contact/postAddress/formattedMultiLineAddress,person/hasInfoText,person/portraitThumbnail
