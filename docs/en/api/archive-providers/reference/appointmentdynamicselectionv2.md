...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=isFree,person/personAddress/city,person/personAssociate/assocTooltip,sale/associate/assocTooltip,associate/contactId
