...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/updatedByFullName,contact/contactAssociate/credentialType,contact/LastActivity,person/mrMrs,person/personUdef/SuperOffice:1
