...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=joinVideomeetUrl,contact/NumberOfNotCompletedTickets,person/personUdef/SuperOffice:9,person/correspondingAssociate/isActive,project/name
