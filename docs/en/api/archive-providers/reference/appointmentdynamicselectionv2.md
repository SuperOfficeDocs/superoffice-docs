...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/restrictionAddress/line2,project/projectPublish/publishedFrom,project/projectAssociate/assocName
