...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=type,contact/restrictionAddress/formattedMultiLineAddress,person/createdByForm,project/type,appointment/internalNotes
