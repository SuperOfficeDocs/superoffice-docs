...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=recordTypeText,contact/categoryGroup,contact/searchPhone/formattedNumber,contact/restrictionAddress/line2,contact/contactExtra/x_contact_contact
