...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/number,contact/email/emailLastSent,contact/streetAddress/city,person/personAssociateFullName,person/personInfo/textId
