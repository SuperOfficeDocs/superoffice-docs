...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=registeredByFullName,booking,contact/postAddress/state,person/personAddress/formattedAddress,person/correspondingAssociate/title
