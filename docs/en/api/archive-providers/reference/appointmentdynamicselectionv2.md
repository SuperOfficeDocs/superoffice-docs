...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/email/emailHasBounced,person/personCountryId,person/personAddress/formattedAddress,sale/contactId,sale/salePublish/isPublished
