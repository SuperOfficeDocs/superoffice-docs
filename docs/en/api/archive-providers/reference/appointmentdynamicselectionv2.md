...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=priority,person/personUdef/SuperOffice:4,project/projectAssociate/contactName,project/projectUdef/SuperOffice:9,associate/contactDepartment
