...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/registeredBy,contact/streetAddress/wgs84longitude,person/personDirectPhone/description,person/personInfo/textId,person/correspondingAssociate/contactCategory
