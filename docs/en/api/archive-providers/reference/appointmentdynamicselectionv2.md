...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=contact/updatedDate,contact/streetAddress/line2,project/projectUdef/SuperOffice:6,associate/contactDepartment
