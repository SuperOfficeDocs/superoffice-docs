...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=rowKind,contact/NumberOfSales,person/personUdef/SuperOffice:1,project/NumberOfSales,sale/description
