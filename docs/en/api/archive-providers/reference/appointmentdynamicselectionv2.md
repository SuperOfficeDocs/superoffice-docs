...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=appointmentPublish/publishedTo,contact/nameDepartment,contact/category,contact/countryId,contact/stop
