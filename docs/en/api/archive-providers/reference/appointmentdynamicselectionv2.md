...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=appointmentId,contact/postAddress/zip,contact/contactAssociate/mrMrs,contact/contactExtra/x_contact_default_integer,person/personCountry
