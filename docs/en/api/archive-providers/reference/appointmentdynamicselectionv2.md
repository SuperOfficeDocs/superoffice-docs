...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=alarm,contact/phone/formattedNumber,person/personPrivate/formattedNumber,person/restrictionAddress/addressId,person/restrictionAddress/line1
