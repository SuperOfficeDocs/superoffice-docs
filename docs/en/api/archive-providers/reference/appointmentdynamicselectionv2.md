...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=intention,contact/name,contact/contactAssociate/associateDbId,contact/contactUdef/SuperOffice:8,contact/NumberOfActivities
