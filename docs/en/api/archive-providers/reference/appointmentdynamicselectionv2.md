...
```http!
GET /api/v1/archive/AppointmentDynamicSelectionV2?$select=rawType,contact/email/emailProtocol,contact/contactUdef/SuperOffice:13,person/phone/formattedNumber,person/restrictionAddress/line3
