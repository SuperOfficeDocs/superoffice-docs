...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=completed,person/correspondingAssociate/contactCategory,project/description,project/LastSale,sale/associate/ejDisplayName
