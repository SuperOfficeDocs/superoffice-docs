...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=who,contact/contactAssociate/otherGroups,contact/contactAssociate/personEmail,contact/contactExtra/x_contact_shorttext,person/personExtra/x_person_timespan
