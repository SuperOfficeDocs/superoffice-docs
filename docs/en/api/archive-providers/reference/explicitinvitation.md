...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=appointmentPublish/isPublished,contact/streetAddress/county,contact/restrictionAddress/county,contact/LastActivity,person/personHasInterests
