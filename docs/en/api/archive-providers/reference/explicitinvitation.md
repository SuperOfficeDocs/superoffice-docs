...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=completedDate,contact/NumberOfNotCompletedTickets,person/title,person/useAsMailingAddress,person/restrictionAddress/city
