...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/contactUdef/SuperOffice:2,person/mrMrs,project/projectAssociate/middleName,project/projectAssociate/assocType
