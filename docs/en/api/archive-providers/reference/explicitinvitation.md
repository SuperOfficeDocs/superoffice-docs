...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/orgnr,contact/postAddress/line1,contact/streetAddress/wgs84longitude,person/email/emailBounceCount,person/personAddress/formattedMultiLineAddress
