...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=projectId,contact/contactAssociate/associateDbId,contact/NumberOfNotCompletedActivities,person/personAssociate/contactName,project/saintDirection
