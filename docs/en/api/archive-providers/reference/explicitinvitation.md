...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/contactAssociate/contactCategory,person/personAssociate/credentialDisplayValue,project/projectAssociate/assocTooltip,project/NumberOfNotCompletedActivitiesInPeriod,sale/heading
