...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/contactAssociate/ejStatus,contact/saintAmountClass,person/supportAssociateFullName,person/personInfo/infoText,person/restrictionAddress/line1
