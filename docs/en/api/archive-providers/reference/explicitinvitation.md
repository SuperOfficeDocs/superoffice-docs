...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/LastDoByActivity,person/personUdef/SuperOffice:7,person/personExtra/x_person_float,project/number,project/projectAssociate/personEmail
