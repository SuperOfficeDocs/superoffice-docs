...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=recurring,recordTypeText,contact/streetAddress/line2,person/email/emailProtocol,sale/associate/locationAddress
