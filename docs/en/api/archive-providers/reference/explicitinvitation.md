...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/countryId,contact/contactSource,person/correspondingAssociate/personId,project/updatedDate,project/projectAssociate/associateDbId
