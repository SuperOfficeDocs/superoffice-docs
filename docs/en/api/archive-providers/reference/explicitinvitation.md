...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/code,contact/updatedDate,contact/contactExtra/x_contact_date,person/personAssociate/lastName,person/personAssociate/associateDbId
