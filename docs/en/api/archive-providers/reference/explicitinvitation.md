...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=registeredByFullName,contact/email/emailHasBounced,contact/postAddress/wgs84longitude,person/kanaFirstName,person/email/emailDescription
