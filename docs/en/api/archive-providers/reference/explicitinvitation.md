...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=person/lastName,person/personUrl/URLAddress,person/personExtra/x_person_timespan,project/projectAssociate/userName
