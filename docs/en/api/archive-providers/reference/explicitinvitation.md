...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=recordType,invitationStatusIcon,contact/contactExtra/x_contact_integer,contact/contactExtra/x_contact_datetime,person/email/emailLastSent
