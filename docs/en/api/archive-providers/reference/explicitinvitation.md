...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=invitationStatusIcon,contact/postAddress/wgs84latitude,contact/postAddress/formattedAddress,contact/contactExtra/x_contact_integer,person/supportAssociate
