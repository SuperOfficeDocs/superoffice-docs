...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/postAddress/county,contact/streetAddress/wgs84latitude,contact/saintSaleStatus,person/personCategory,person/personPager/description
