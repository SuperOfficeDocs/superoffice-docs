...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/registeredBy,contact/restrictionAddress/wgs84latitude,person/position,person/personUdef/SuperOffice:1,person/personAssociate/associateDbId
