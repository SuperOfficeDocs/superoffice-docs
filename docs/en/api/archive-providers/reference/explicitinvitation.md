...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=contact/contactAssociate/ejUserId,contact/contactExtra/x_contact_time,person/birthYear,person/personUdef/SuperOffice:6,person/personAssociate/isLocation
