...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=who,contact/contactAssociate/isLocation,appointmentUdef/SuperOffice:1,appointmentUdef/SuperOffice:3,project/projectAssociate/isActiveText
