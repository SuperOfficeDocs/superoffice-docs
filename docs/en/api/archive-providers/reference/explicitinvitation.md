...
```http!
GET /api/v1/archive/ExplicitInvitation?$select=completed,contact/contactDeleted,contact/NumberOfNotCompletedActivitiesInPeriod,person/correspondingAssociate/role,associate/isActive
