...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/mrMrs,person/searchPhone/description,person/personExtra/y_rental/x_start,contact/email/emailProtocol,contact/contactUdef/SuperOffice:10
