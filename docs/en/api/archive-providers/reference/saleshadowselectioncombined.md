...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/personHasInterests,person/personInfo/textId,person/email/emailBounceCount,contact/phone/formattedNumber,contact/SaintStatus1
