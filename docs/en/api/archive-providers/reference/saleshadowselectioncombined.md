...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=registeredByFullName,competitor,person/phone/formattedNumber,saleStakeholder/contact/forceCompany,saleStakeholder/contact/contactExtra/x_contact_integer
