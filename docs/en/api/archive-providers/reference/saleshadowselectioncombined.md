...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=createdByWorkflow,person/personAssociate/otherGroups,person/correspondingAssociate/title,saleUdef/SuperOffice:5,document/mailMergeDraft
