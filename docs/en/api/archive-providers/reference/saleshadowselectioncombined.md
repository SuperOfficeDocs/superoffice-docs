...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=recordType,amount,person/updatedByWorkflow,person/personAssociate/lastName,contact/streetAddress/formattedAddress
