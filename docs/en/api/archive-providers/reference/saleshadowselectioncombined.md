...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/hasInterests,person/portraitThumbnail,person/searchPhone/formattedNumber,person/personUdef/SuperOffice:6,person/personAssociate/fullName
