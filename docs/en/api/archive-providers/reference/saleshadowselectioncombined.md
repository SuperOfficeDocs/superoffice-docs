---
uid: SaleShadowSelectionCombined
title: SaleShadowSelectionCombined
description: Implementation of the provider for the combined selection
keywords: SaleShadowSelectionCombined archive provider
generated: true
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionCombinedProvider">SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionCombinedProvider</see> inside NetServer's SODatabase assembly.
...
|saleStakeholder/person/personCategoryRank|int|Stakeholder - !!Category rank| x |
...
|saleStakeholder/person/leadstatusRank|int|Stakeholder - !!Lead status RANK| x |
...
|saleStakeholder/person/personExtra/y\_rental/x\_start|date|Stakeholder - Rental - Start rental: Start rental| x |
|saleStakeholder/person/personExtra/y\_rental/x\_end|date|Stakeholder - Rental - End: End| x |
...
|saleStakeholder/person/personAssociate/ejDisplayName|string|Stakeholder - Nickname: User's nickname in Service| x |
...
|saleStakeholder/contact/nameDepartment|string|Stakeholder - Company: Displays the company an activity is linked to| x |
...
|saleStakeholder/contact/companyCategoryRank|int|Stakeholder - Category rank| x |
...
|saleStakeholder/contact/contactExtra/y\_organization/x\_name|string|Stakeholder - Organization - Name: Name| x |
...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=date,person/personUrl/URLDescription,person/restrictionAddress/city,person/personExtra/y_rental/x_end,contact/contactAssociate/contactCategory
