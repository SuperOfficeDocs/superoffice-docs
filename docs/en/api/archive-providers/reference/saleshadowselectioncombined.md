...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=stalledComment,person/personAssociateId,person/personAssociateFullName,person/personAssociate/assocName,contact/contactAssociate/isActive
