...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=lossReason,person/personUdef/SuperOffice:7,person/correspondingAssociate/firstName,contact/orgnr,associate/assocTooltip
