...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/personAssociate/title,contact/streetAddress/state,contact/contactAssociate/title,document/attention,document/documentPublish/publishedBy
