...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/personNumber,person/personRegisteredByFullName,person/restrictionAddress/line1,contact/saintActivityType,document/associate/ejStatus
