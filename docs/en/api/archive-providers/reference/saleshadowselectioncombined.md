...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/associateType,person/personAssociate/title,person/personAssociate/otherGroups,contact/postAddress/line2,associate/otherGroups
