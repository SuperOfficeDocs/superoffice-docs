...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=activeErpLinks,person/personExtra/x_person_shorttext,contact/updatedByFullName,contact/searchPhone/description,contact/streetAddress/zip
