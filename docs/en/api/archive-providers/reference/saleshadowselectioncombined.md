...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=updatedBy,person/lastName,person/correspondingAssociate/contactDepartment,contact/postAddress/city,contact/contactExtra/x_contact_boolean
