...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=probPercent,person/personAssociate/contactName,person/personAssociate/contactDepartment,person/consentSourceStore,contact/registeredBy
