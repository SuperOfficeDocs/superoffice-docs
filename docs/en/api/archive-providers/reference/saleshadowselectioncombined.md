...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/personExtra/y_rental/x_end,person/correspondingAssociate/personEmail,contact/restrictionAddress/city,project/statusRank,project/projectAssociate/mrMrs
