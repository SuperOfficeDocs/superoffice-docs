...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=stageRank,person/personUpdatedBy,person/personUdef/SuperOffice:5,contact/restrictionAddress/formattedAddress,contact/contactAssociate/contactFullName
