...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=hasQuote,person/personAddress/addressId,person/personAssociate/assocType,contact/registeredDate,appointment/alarm
