...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/birthDay,person/personUdef/SuperOffice:9,contact/contactPhone/formattedNumber,appointment/priority,document/icon
