...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/hasInterests,person/personSource,person/personInfo/infoText,contact/streetAddress/line1,contact/restrictionAddress/addressId
