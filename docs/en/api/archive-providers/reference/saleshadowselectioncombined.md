...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=getAllRows,person/fullName,person/email/emailProtocol,person/personAssociate/isLocation,contact/streetAddress/formattedAddress
