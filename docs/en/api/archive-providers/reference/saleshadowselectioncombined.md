...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=icon,person/subscription,contact/registeredBy,contact/restrictionAddress/wgs84latitude,appointment/associate/credentialDisplayValue
