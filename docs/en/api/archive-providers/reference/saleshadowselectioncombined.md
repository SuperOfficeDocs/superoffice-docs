...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=who,person/personExtra/x_person_hidden_integer,person/personAssociate/simultaneousEjUser,contact/updatedDate,contact/email/emailLastBounce
