...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=type,sale/textId,person/personUdef/SuperOffice:3,contact/restrictionAddress/wgs84latitude,associate/contactFullName
