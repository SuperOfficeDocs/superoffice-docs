...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/personPager/formattedNumber,contact/contactAssociate/isActive,contact/contactAssociate/isActiveText,associate/userName,document/isMail
