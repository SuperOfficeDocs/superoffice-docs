...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=sale/textId,person/correspondingAssociate/ejUserId,contact/saintDirection,project/projectUdef/SuperOffice:7,project/LastCompletedSale
