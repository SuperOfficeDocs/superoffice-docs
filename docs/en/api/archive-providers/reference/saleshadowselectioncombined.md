...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/personUpdatedDate,person/personUdef/SuperOffice:10,person/personAssociate/contactId,person/personAssociate/portraitThumbnail,person/hasStoreConsent
