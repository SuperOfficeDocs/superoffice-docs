...
```http!
GET /api/v1/archive/SaleShadowSelectionCombined?$select=person/personCountryId,person/correspondingAssociate/locationAddress,contact/restrictionAddress/wgs84longitude,contact/contactAssociate/usergroupId,contact/contactExtra/x_contact_hidden_integer
