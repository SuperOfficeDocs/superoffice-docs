...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=tags,person/personHasInterests,person/hasCompany,person/restrictionAddress/wgs84latitude,person/personExtra/x_person_date
