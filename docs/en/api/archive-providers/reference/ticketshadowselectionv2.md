...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=ownedBy,person/restrictionAddress/line2,person/personUdef/SuperOffice:4,person/personExtra/x_person_shorttext_list,contact/postAddress/line2
