...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=createdByWorkflow,person/personDirectFax/description,person/email/emailDescription,person/restrictionAddress/city,contact/contactFax/description
