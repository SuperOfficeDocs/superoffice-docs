...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=title,ownedBy/personId,person/restrictionAddress/formattedAddress,person/personAssociate/otherGroups,person/correspondingAssociate/credentialType
