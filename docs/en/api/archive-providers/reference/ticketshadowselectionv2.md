...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=priorityName,createdBy/isLocation,person/associateType,person/correspondingAssociate/firstName,person/correspondingAssociate/isActive
