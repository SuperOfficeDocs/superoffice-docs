...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/correspondingAssociate/credentialType,contact/number,contact/contactAssociate/contactId,sale/source,project/endDate
