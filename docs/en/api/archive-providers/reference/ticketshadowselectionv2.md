...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=ownedBy/assocTooltip,ownedBy/isActive,person/correspondingAssociate/ejStatus,contact/hasInterests,extra/x_ticket_faq
