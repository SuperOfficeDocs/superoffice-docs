...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=ownedBy,createdBy/contactFullName,person/rank,person/personExtra/x_person_shorttext_list,person/personAssociate/mrMrs
