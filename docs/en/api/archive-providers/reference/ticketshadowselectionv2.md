...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personCategory,contact/deletedDate,contact/contactUdef/SuperOffice:12,project/projectAssociate/userName
