...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=projectId,person/personExtra/x_person_float,person/personAssociate/contactFullName,person/correspondingAssociate/assocTooltip,contact/stop
