...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.TicketShadowSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personUpdatedBy,person/personExtra/y_rental/x_start,person/personAssociate/locationAddress,person/correspondingAssociate/portraitThumbnail,contact/contactExtra/x_contact_default_integer
