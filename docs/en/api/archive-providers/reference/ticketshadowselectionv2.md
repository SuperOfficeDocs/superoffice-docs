...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=ticketId,person/personAddress/wgs84longitude,person/personAssociate/isActiveText,person/correspondingAssociate/simultaneousEjUser,sale/hasQuote
