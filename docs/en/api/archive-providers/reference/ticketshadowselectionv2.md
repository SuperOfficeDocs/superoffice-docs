...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=contact/hasInfoText,contact/restrictionAddress/addressId,contact/contactAssociate/contactDepartment,contact/contactAssociate/credentialType,extra/x_ticket_boolean
