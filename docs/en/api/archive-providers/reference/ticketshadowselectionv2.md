...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/position,contact/contactAssociate/fullName,contact/LastDoByActivity,sale/earning,sale/associate/lastName
