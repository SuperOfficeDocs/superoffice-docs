...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=ticketTypeName,ticketStatus/rank,person/personPrivate/description,person/personAddress/line2,contact/nameDepartment
