...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=connectId,person/email/emailLastSent,person/email/emailLastBounce,person/personAddress/formattedMultiLineAddress,contact/restrictionAddress/addressId
