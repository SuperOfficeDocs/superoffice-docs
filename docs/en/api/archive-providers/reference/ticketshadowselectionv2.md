...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=ticketStatusId,person/personUdef/SuperOffice:8,extra/x_ticket_float,extra/x_ticket_timespan,sale/saleId
