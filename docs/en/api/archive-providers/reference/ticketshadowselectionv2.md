...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personBusiness,person/personAddress/line2,person/personAssociate/assocType,sale/associate/isActiveText
