...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=createdBy/mrMrs,person/correspondingAssociate/portraitThumbnail,contact/activeErpLinks,contact/contactAssociate/fullName,extra/x_ticket_shorttext_list
