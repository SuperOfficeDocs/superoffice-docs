...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=author,contact/registeredDate,contact/contactAssociate/firstName,contact/contactAssociate/assocType,contact/saintTicketStatus
