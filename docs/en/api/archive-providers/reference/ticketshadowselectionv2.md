...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personBusiness,contact/contactPhone/description,sale/time,project/projectPublish/publishedTo,project/projectAssociate/fullName
