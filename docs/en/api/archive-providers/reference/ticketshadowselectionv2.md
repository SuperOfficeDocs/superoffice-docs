...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/correspondingAssociate/contactName,extra/x_ticket_boolean,project/projectAssociate/contactCategory,project/projectUdef/SuperOffice:7
