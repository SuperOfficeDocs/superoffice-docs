...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=createdBy,createdBy/contactCategory,person/personAssociateId,contact/email/emailLastBounce,contact/postAddress/formattedAddress
