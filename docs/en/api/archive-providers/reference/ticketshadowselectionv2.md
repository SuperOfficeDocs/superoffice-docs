...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/whenUpdatedByWorkflow,person/personInfo/infoText,person/email/emailDescription,contact/postAddress/addressId,contact/contactAssociate/associateDbId
