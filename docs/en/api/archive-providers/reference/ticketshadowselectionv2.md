...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personAddress/state,contact/number,contact/restrictionAddress/line2,extra/x_ticket_timespan,project/projectAssociate/isActive
