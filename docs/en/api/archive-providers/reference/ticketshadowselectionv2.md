...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/hasInterests,person/isStakeholder,contact/contactAssociate/assocTooltip,contact/NumberOfNotCompletedTickets,contact/saintSaleStatus
