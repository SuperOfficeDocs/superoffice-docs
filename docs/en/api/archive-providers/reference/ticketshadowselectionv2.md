...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/personRegisteredDate,person/personUrl/URLDescription,person/restrictionAddress/line2,contact/number,contact/contactAssociate/contactId
