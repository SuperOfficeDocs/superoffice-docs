...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=getNoRows,person/personCountryId,person/rank,person/restrictionAddress/line3,person/personAssociate/userName
