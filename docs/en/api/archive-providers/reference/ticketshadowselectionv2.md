...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=createdBy/isActive,ownedBy/usergroup,person/personBusiness,contact/restrictionAddress/addressId,contact/contactAssociate/credentialDisplayValue
