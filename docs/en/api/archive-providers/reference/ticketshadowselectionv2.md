...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=connectId,createdBy,person/restrictionAddress/line2,extra/x_ticket_category_relation,sale/visibleFor
