...
```http!
GET /api/v1/archive/TicketShadowSelectionV2?$select=person/withdrawnEmarketingConsent,contact/contactExtra/x_contact_longtext,contact/contactExtra/x_contact_date,contact/contactExtra/x_contact_boolean,sale/saleTypeCategory
