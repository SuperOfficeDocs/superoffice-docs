...
```http!
GET /api/v1/archive/LinksAppointments?$select=icon,contact/contactPhone/description,person/retired,person/isProjectMember,person/restrictionAddress/wgs84longitude
