...
```http!
GET /api/v1/archive/LinksAppointments?$select=registeredDate,appointmentPublish/publishedBy,contact/saintActivityType,person/personUdef/SuperOffice:9,person/correspondingAssociate/mrMrs
