...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/searchPhone/description,person/correspondingAssociate/middleName,project/projectAssociate/firstName,project/projectAssociate/assocType,sale/type
