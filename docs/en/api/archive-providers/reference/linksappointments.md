...
```http!
GET /api/v1/archive/LinksAppointments?$select=person/contactId,person/updatedByWorkflow,appointmentUdef/SuperOffice:7,sale/text,sale/associate/contactName
