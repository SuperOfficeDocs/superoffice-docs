...
```http!
GET /api/v1/archive/LinksAppointments?$select=visibleInDiary,contact/NumberOfNotCompletedActivities,person/correspondingAssociate/credentialType,project/endDate,project/saintIntention
