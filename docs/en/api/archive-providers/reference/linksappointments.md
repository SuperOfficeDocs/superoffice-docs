...
```http!
GET /api/v1/archive/LinksAppointments?$select=registeredByFullName,contact/postAddress/line2,contact/contactExtra/x_contact_contact_relation,person/personId,person/isProjectMember
