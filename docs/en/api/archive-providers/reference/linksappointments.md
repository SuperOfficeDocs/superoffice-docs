...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/streetAddress/line1,contact/restrictionAddress/city,contact/contactExtra/x_contact_default_integer,project/saintActivityType,associate/firstName
