...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/streetAddress/formattedAddress,contact/contactExtra/x_contact_dropdown,person/useAsMailingAddress,person/kanaFirstName,person/personAssociate/title
