...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/contactDeleted,contact/searchPhone/description,contact/contactAssociate/personEmail,contact/contactExtra/x_contact_datetime,person/birthYear
