...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/email/emailAddress,person/birthMonth,person/personActiveErpLinks,person/personBusiness,person/personExtra/y_car/id
