...
```http!
GET /api/v1/archive/LinksAppointments?$select=contact/hasInterests,contact/contactPhone/formattedNumber,contact/contactAssociate/assocType,person/mrMrs,appointmentUdef/SuperOffice:1
