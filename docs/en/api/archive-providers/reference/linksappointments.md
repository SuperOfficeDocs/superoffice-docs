...
```http!
GET /api/v1/archive/LinksAppointments?$select=sourceAppointmentRestrictionId,invitedPersonId,appointmentPublish/isPublished,contact/restrictionAddress/county,person/personSource
