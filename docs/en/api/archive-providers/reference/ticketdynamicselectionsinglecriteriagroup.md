...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=createdBy/mrMrs,person/restrictionAddress/county,contact/registeredDate,contact/contactExtra/x_contact_dropdown,contact/NumberOfNotCompletedSales
