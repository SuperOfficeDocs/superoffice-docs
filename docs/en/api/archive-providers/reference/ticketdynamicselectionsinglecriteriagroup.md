...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=createdBy/firstName,contact/contactExtra/x_contact_datetime,project/projectAssociate/middleName,project/saintIntention
