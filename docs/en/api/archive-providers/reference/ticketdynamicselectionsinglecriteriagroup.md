...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=connectId,tags,createdBy/simultaneousEjUser,person/personExtra/x_person_request_relation,person/correspondingAssociate/role
