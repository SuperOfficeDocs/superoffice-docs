...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=realTimeSpentQueue,ownedBy,ownedBy/associateDbId,person/supportAssociate,person/personInterestIds
