...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=person/birthMonth,person/personRegisteredDate,contact/contactAssociate/role,sale/saleStatus,sale/associate/contactName
