...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=sentimentScore,ownedBy/contactId,ownedBy/personId,person/retired,person/personExtra/x_person_appointment_relation
