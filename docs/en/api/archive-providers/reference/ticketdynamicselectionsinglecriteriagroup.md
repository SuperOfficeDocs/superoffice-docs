...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=getAllRows,repliedAt,person/personAssociate/contactDepartment,person/correspondingAssociate/mrMrs,person/withdrawnStoreConsent
