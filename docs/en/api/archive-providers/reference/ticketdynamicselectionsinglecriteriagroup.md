...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=createdBy/assocType,ownedBy/contactName,person/supportAssociate,person/personExtra/x_person_contact_relation,person/correspondingAssociate/title
