...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=readByCustomer,ownedBy/assocTooltip,person/personUdef/SuperOffice:4,person/personExtra/x_person_request_relation,contact/contactAssociate/personId
