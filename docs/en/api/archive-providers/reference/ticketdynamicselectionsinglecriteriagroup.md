...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=person/lastName,person/birthYear,person/email/emailProtocol,person/personAssociate/isActiveText,contact/postAddress/wgs84longitude
