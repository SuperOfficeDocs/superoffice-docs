...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=person/rank,person/personAddress/addressId,person/correspondingAssociate/otherGroups,sale/type
