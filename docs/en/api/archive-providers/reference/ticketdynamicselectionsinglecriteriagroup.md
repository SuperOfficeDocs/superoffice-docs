...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=person/rank,person/personInfo/textId,person/email/emailBounceCount,person/personAddress/addressId,person/personAddress/state
