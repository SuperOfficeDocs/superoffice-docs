...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=ticketStatusName,person/personAssociateId,person/personExtra/x_person_category_relation,person/personAssociate/assocTooltip,contact/postAddress/wgs84longitude
