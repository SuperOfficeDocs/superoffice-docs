...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=contactId,person/personPrivate/description,person/personExtra/x_person_date,person/correspondingAssociate/otherGroups,contact/restrictionAddress/line1
