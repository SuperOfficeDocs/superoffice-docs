...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=person/rank,person/retired,person/phone/formattedNumber,person/personAssociate/lastName,person/personAssociate/contactDepartment
