...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=person/leadstatusRank,person/updatedByWorkflow,person/personAddress/state,person/correspondingAssociate/credentialType,contact/contactAssociate/usergroupId
