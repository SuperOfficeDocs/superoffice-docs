...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=createdBy/associateDbId,createdBy/contactName,contact/streetAddress/formattedAddress,contact/restrictionAddress/line2,sale/associate/credentialDisplayValue
