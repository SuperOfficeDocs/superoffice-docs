...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=ownedBy/credentialType,contact/saintAmountClass,sale/icon,sale/earning,project/projectAssociate/personEmail
