...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=realTimeSpentQueue,content,person/searchPhone/description,person/restrictionAddress/wgs84latitude,person/restrictionAddress/formattedMultiLineAddress
