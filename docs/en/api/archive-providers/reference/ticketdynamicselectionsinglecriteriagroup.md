...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=ownedBy/contactDepartment,ownedBy/isLocation,person/personAssociate/contactId,contact/business,contact/email/emailDescription
