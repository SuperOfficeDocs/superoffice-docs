...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=createdBy/personEmail,person/middleName,person/personUdef/SuperOffice:11,contact/forceCompany,contact/contactAssociate/assocTooltip
