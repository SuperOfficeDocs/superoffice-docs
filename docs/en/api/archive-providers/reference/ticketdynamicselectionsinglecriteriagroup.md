...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=createdAt,createdBy/associateDbId,person/personCategoryRank,person/restrictionAddress/county,person/correspondingAssociate/credentialType
