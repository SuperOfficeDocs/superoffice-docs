...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=realTimeToClose,ownedBy/contactCategory,person/personAssociate/ejStatus,contact/restrictionAddress/wgs84longitude,project/projectPublish/publishedBy
