...
```http!
GET /api/v1/archive/TicketDynamicSelectionSingleCriteriaGroup?$select=categoryFullName,sentimentScore,person/correspondingAssociate/lastName,contact/email/emailLastSent,project/projectId
