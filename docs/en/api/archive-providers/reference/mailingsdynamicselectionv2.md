...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=selectionId,associateId,mailingAddr/contact/email/emailId,mailingAddr/contact/contactExtra/x_contact_shorttext,mailingAddr/person/personId
