...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=mailingSubscriptionType,mailingAddr/contact/contactUdef/SuperOffice:10,mailingAddr/person/personHasInterests,project/hasInfoText,project/LastActivity
