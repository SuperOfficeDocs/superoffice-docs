...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=mailingAddr/contact/contactAssociate/assocType,mailingAddr/person/retired,mailingAddr/person/personExtra/x_person_request_relation
