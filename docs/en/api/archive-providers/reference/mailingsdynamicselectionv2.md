...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=mailingAddr/contact/streetAddress/line1,mailingAddr/contact/restrictionAddress/line3,mailingAddr/person/whenUpdatedByWorkflow,mailingAddr/person/personAddress/state
