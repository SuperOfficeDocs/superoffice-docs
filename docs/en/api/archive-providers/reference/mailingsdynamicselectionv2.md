...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=project/projectEvent/isExternalEvent,mailingAddr/contact/saintAmountClass,mailingAddr/person/restrictionAddress/wgs84latitude
