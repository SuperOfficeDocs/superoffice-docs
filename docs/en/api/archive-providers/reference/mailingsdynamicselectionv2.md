...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=getNoRows,mailingAddr/contact/contactFax/description,mailingAddr/person/email/emailHasBounced,mailingAddr/person/personAssociate/contactCategory
