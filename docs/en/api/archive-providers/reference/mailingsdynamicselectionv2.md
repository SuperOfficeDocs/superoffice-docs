...
```http!
GET /api/v1/archive/MailingsDynamicSelectionV2?$select=mailingAddr/person/associateType,mailingAddr/contact/LastActivity,mailingAddr/person/email/emailProtocol
