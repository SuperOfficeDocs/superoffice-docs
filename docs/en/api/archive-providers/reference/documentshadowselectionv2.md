...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personUpdatedBy,person/personDeletedDate,person/correspondingAssociate/isActive,contact/restrictionAddress/formattedAddress,contact/contactUdef/SuperOffice:8
