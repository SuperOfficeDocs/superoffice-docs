...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=documentPublish/publishedFrom,person/personHasInterests,person/position,person/restrictionAddress/line2,person/personUdef/SuperOffice:8
