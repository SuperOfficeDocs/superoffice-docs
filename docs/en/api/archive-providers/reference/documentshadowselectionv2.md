...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personAssociate/contactDepartment,contact/saintAmountClass,associate/credentialType,sale/saleId
