...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=text,person/personAssociate/simultaneousEjUser,person/isMailingRecipient,contact/searchPhone/formattedNumber,contact/contactAssociate/assocName
