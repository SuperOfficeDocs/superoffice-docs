...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personExtra/x_person_priority_relation,project/projectUrl/URLAddress,sale/saleUdef/SuperOffice:1
