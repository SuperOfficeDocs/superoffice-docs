...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personCountryId,person/rank,person/personUpdatedDate,person/personAddress/state,person/correspondingAssociate/locationAddress
