...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=recordTypeText,person/correspondingAssociate/personId,contact/orgnr,contact/email/emailDescription,contact/contactAssociate/isActiveText
