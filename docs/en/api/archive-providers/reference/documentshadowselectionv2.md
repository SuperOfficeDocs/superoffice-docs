...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=updatedDate,attention,person/updatedByWorkflow,person/personExtra/x_person_shorttext_list,contact/postAddress/wgs84latitude
