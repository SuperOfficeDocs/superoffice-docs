...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personUdef/SuperOffice:10,person/personExtra/x_person_datetime,project/NumberOfNotCompletedActivitiesInPeriod,sale/associate/contactCategory
