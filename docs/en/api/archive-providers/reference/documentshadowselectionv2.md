...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=updatedBy,documentId,person/personInterestIds,person/personAssociate/assocName,person/correspondingAssociate/isActive
