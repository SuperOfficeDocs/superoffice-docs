...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=icon,person/personUrl/URLAddress,contact/contactUdef/SuperOffice:5,contact/NumberOfNotCompletedActivities,sale/associate/fullName
