...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personAddress/addressId,project/projectAssociate/middleName,sale/soldReason,sale/saleUdef/SuperOffice:6
