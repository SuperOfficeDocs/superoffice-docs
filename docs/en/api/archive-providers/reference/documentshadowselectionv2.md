...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personExtra/x_person_contact_relation,contact/contactAssociate/role,contact/LastDoBySale,associate/contactCategory,sale/earning
