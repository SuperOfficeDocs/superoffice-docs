...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/birthYear,contact/postAddress/formattedAddress,contact/streetAddress/line1,contact/streetAddress/formattedMultiLineAddress,project/name
