...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=contact/contactSource,contact/restrictionAddress/addressId,contact/contactAssociate/personId,contact/contactUdef/SuperOffice:7,contact/saintActivityType
