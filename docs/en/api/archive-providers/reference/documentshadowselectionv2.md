...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/personSource,project/updatedByFullName,project/projectUdef/SuperOffice:6,sale/stage,sale/visibleFor
