...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=keywords,contact/contactAssociate/fullName,contact/contactAssociate/personId,associate/contactId,associate/isLocation
