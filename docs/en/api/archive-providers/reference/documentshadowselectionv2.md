...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=ourref,person/correspondingAssociate/personId,contact/contactAssociate/contactCategory,documentUdef/SuperOffice:2,sale/projectId
