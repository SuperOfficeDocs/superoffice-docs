...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=who,isMail,person/personExtra/x_person_category_relation,person/personAssociate/otherGroups,contact/streetAddress/state
