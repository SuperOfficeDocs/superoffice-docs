...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=recordType,person/correspondingAssociate/usergroup,person/legalBaseEmarketing,project/projectAssociate/contactName,project/LastActivity
