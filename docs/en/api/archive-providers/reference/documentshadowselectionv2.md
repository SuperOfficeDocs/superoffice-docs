...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=isMail,person/birthdate,person/updatedByWorkflow,person/personExtra/x_person_category_relation,contact/contactPhone/description
