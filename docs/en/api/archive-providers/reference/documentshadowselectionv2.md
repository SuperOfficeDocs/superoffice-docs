...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/correspondingAssociate/ejStatus,person/consentSourceStore,contact/searchPhone/description,contact/restrictionAddress/city,contact/contactAssociate/lastName
