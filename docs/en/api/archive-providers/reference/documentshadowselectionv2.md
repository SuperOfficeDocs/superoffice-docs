...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/email/emailLastSent,project/projectAssociate/contactName,project/projectUdef/SuperOffice:1,associate/assocName,documentUdef/SuperOffice:8
