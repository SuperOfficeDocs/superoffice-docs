...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/legalBaseEmarketing,contact/contactId,contact/contactUdef/SuperOffice:7,project/projectUdef/SuperOffice:5,associate/contactDepartment
