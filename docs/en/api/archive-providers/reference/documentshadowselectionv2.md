...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=person/withdrawnStoreConsent,contact/restrictionAddress/county,contact/restrictionAddress/city,project/number,project/projectAssociate/mrMrs
