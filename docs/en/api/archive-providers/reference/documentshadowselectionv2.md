...
```http!
GET /api/v1/archive/DocumentShadowSelectionV2?$select=getAllRows,person/personUdef/SuperOffice:5,person/correspondingAssociate/role,contact/contactAssociate/middleName,contact/contactAssociate/contactName
