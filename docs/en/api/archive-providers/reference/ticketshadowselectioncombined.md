...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/personAssociate/personId,contact/department,contact/LastActivity,contact/SaintStatus2,sale/soldReason
