...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=firstReadByOwner,realTimeSpentQueue,createdBy/firstName,createdBy/contactFullName,createdBy/credentialDisplayValue
