...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=contact/hasInfoText,extra/x_ticket_time,sale/description,project/updatedDate,project/projectAssociate/userName
