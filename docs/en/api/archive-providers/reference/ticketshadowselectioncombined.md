...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=createdBy/assocName,ownedBy/role,person/correspondingAssociate/contactFullName,person/consentSourceEmarketing,contact/orgnr
