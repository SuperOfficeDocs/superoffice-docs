...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/personAddress/line2,contact/email/emailLastSent,contact/contactAssociate/usergroup,contact/contactExtra/x_contact_shorttext,sale/hasStakeholders
