...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=ownedBy/contactDepartment,ticketPriority/rank,person/personDirectPhone/formattedNumber,person/personExtra/x_person_shorttext,contact/NumberOfSalesInPeriod
