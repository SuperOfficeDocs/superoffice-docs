...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=createdAt,person/email/emailBounceCount,person/personUrl/URLAddress,contact/country,project/projectAssociate/contactCategory
