...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=origin,createdBy/contactName,person/personUpdatedByFullName,person/correspondingAssociate/fullName,person/correspondingAssociate/contactId
