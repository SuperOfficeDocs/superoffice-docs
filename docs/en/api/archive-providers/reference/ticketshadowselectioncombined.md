...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=createdBy/title,createdBy/usergroupId,createdBy/ejUserId,person/lastName,person/personAssociate/credentialDisplayValue
