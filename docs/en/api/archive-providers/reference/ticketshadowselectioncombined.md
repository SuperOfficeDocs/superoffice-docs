...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=realTimeSpentInternally,person/personAssociate/credentialDisplayValue,contact/streetAddress/zip,sale/saleUdef/SuperOffice:3
