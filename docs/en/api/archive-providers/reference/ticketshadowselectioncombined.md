...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/personAddress/state,person/personExtra/x_person_float,contact/email/emailId,contact/NumberOfNotCompletedActivities,contact/LastCompletedActivity
