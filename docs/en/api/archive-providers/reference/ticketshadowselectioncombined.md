...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=priorityId,person/personMobilePhone/formattedNumber,person/personAssociate/ejDisplayName,contact/country,contact/url/URLDescription
