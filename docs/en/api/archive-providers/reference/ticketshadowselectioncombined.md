...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=ownedBy/mrMrs,ownedBy/contactCategory,person/personUdef/SuperOffice:8,contact/country,contact/email/emailAddress
