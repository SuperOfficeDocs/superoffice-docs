...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=ownedBy/assocName,person/personAssociate/contactFullName,person/personAssociate/assocType,contact/postAddress/city,contact/url/URLAddress
