...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=createdBy/contactName,createdBy/assocName,ownedBy/simultaneousEjUser,contact/contactAssociate/credentialType,contact/saintIntention
