...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/phone/formattedNumber,contact/NumberOfSales,person/personExtra/x_person_priority_relation
