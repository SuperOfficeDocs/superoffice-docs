...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=createdBy/lastName,person/personExtra/x_person_hidden_integer,person/personAssociate/personEmail,contact/contactAssociate/associateDbId,project/NumberOfNotCompletedActivities
