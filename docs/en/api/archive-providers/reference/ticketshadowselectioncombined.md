...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=createdBy/mrMrs,ticketStatus/rank,person/title,person/personUdef/SuperOffice:10,person/isMailingRecipient
