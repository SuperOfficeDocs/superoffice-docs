...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/restrictionAddress/formattedAddress,person/correspondingAssociate/locationAddress,project/projectEvent/eventDate
