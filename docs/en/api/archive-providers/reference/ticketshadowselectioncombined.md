...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=getNoRows,createdByWorkflow,person/personInfo/infoText,contact/countryId,contact/streetAddress/addressId
