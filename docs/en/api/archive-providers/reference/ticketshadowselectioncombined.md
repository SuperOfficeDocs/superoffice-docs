...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/personPager/description,person/personInfo/textId,person/email/emailLastBounce,person/personInterestIds,contact/restrictionAddress/wgs84latitude
