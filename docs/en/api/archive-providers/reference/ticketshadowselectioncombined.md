...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/email/emailId,person/personUrl/URLDescription,person/personExtra/y_rental/x_amount,person/personAssociate/userName
