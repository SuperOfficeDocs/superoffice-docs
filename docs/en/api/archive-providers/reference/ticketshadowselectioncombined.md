...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=createdBy/personEmail,person/kanaLastName,person/personBusiness,contact/contactAssociate/personEmail,sale/nextDueDate
