...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=ownedBy/locationAddress,person/personUdef/SuperOffice:6,person/personExtra/y_rental/x_end,contact/contactAssociate/personId,contact/contactAssociate/isActive
