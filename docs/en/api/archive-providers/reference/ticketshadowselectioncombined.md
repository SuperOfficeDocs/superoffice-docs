...
```http!
GET /api/v1/archive/TicketShadowSelectionCombined?$select=person/personAssociate/contactId,person/personAssociate/isLocation,contact/streetAddress/formattedAddress,contact/restrictionAddress/line1,contact/contactUdef/SuperOffice:7
