...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/personAssociate/assocName,person/isMailingRecipient,sale/originalStage,sale/saleTypeCategory,project/LastCompletedSale
