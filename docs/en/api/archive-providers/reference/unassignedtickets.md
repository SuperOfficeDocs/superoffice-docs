...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ownedBy/credentialType,person/personAssociate/ejUserId,person/correspondingAssociate/assocType,contact/contactFax/formattedNumber,sale/earning
