...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/isProjectMember,person/correspondingAssociate/isActive,contact/contactFax/formattedNumber,contact/contactAssociate/ejStatus,contact/contactAssociate/portraitThumbnail
