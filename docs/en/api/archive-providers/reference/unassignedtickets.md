...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/personHasInterests,contact/country,contact/code,contact/postAddress/line1,contact/contactAssociate/lastName
