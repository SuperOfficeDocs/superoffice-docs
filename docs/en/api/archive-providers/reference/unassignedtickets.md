...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ownedBy/portraitThumbnail,person/supportAssociate,person/correspondingAssociate/isActiveText,contact/NumberOfActivities
