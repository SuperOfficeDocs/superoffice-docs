...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/correspondingAssociate/userName,contact/restrictionAddress/state,sale/associate/lastName,project/SaintStatus3
