...
```http!
GET /api/v1/archive/UnassignedTickets?$select=createdBy/ejStatus,createdBy/portraitThumbnail,ownedBy/assocName,person/mrMrs,person/personExtra/x_person_appointment_relation
