...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/personAddress/line1,person/personAssociate/mrMrs,contact/postAddress/state,contact/streetAddress/zip,contact/contactAssociate/assocTooltip
