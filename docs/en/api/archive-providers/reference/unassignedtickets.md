...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ticketTypeName,realTimeSpentQueue,person/personRegisteredDate,person/personAssociateId,person/restrictionAddress/wgs84longitude
