...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/personAssociate/otherGroups,contact/contactAssociate/contactCategory,contact/contactExtra/x_contact_float,sale/icon,project/projectUrl/URLAddress
