...
```http!
GET /api/v1/archive/UnassignedTickets?$select=createdBy/fullName,ticketPriority/ticketPriorityId,person/hasCompany,person/personExtra/y_rental/x_contact,person/correspondingAssociate/fullName
