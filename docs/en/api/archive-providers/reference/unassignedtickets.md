...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ticketId,person/correspondingAssociate/otherGroups,extra/x_ticket_category_relation,sale/associate/ejStatus,project/LastActivity
