...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/hasInterests,person/rank,person/personAssociate/contactId,contact/email/emailAddress,contact/contactExtra/x_contact_shorttext
