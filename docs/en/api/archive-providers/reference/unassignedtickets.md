...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ticketTypeName,createdBy/contactDepartment,person/legalBaseEmarketing,contact/contactSource,contact/contactUdef/SuperOffice:10
