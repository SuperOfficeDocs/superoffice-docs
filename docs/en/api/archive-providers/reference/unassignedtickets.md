...
```http!
GET /api/v1/archive/UnassignedTickets?$select=timeSpentExternally,ownedBy/assocName,person/fullName,person/position,person/personExtra/x_person_hidden_integer
