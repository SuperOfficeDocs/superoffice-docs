...
```http!
GET /api/v1/archive/UnassignedTickets?$select=readStatus,person/personId,person/personUrl/URLAddress,person/restrictionAddress/line3,person/personAssociate/middleName
