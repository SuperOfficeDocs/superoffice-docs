...
```http!
GET /api/v1/archive/UnassignedTickets?$select=status,ownedBy/isActive,contact/contactExtra/x_contact_date,contact/NumberOfNotCompletedTicketsInPeriod,sale/associate/personId
