...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ticketTypeName,ownedBy/contactId,ownedBy/ejStatus,person/personUdef/SuperOffice:6,contact/restrictionAddress/formattedAddress
