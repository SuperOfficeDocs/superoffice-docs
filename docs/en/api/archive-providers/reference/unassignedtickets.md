...
```http!
GET /api/v1/archive/UnassignedTickets?$select=createdByWorkflow,person/personAssociate/contactId,contact/contactAssociate/fullName,contact/NumberOfTickets,sale/earningPercent
