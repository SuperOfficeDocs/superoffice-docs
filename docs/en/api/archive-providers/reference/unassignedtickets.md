...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ownedBy/usergroup,ownedBy/portraitThumbnail,person/personAssociateId,person/legalBaseStore,contact/contactUdef/SuperOffice:8
