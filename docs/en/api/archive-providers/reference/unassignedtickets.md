...
```http!
GET /api/v1/archive/UnassignedTickets?$select=person/personMobilePhone/description,person/personAddress/state,person/personAssociate/mrMrs,person/correspondingAssociate/otherGroups,project/projectAssociate/isActive
