...
```http!
GET /api/v1/archive/UnassignedTickets?$select=ownedBy/contactDepartment,person/personPager/formattedNumber,person/personAssociate/contactId,contact/email/emailDescription,sale/earningPercent
