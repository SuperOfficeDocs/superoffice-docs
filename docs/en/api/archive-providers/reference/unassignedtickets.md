...
```http!
GET /api/v1/archive/UnassignedTickets?$select=realTimeToClose,ownedBy/contactDepartment,person/contactId,person/personAddress/line1,person/personExtra/x_person_user_relation
