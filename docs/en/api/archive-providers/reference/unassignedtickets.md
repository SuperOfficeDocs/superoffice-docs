...
```http!
GET /api/v1/archive/UnassignedTickets?$select=createdBy/title,person/leadStatus,contact/url/URLAddress,contact/contactAssociate/middleName,contact/LastTicket
