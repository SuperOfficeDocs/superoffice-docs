...
```http!
GET /api/v1/archive/UnassignedTickets?$select=lastChanged,person/hasInterests,person/personAddress/county,person/personExtra/x_person_date,person/personAssociate/ejStatus
