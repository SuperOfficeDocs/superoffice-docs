...
```http!
GET /api/v1/archive/UnassignedTickets?$select=activated,person/personExtra/x_person_category_relation,person/withdrawnEmarketingConsent,contact/NumberOfSalesInPeriod
