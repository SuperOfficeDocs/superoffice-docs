...
```http!
GET /api/v1/archive/PersonActivity?$select=associate/contactFullName,person/personMobilePhone/formattedNumber,person/restrictionAddress/zip,person/restrictionAddress/state,person/personExtra/x_person_float
