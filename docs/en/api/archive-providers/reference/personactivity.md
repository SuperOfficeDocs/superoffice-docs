...
```http!
GET /api/v1/archive/PersonActivity?$select=mailingAddr/contact/LastCompletedTicket,person/personAssociate/contactCategory,person/correspondingAssociate/credentialType,contact/contactAssociate/otherGroups,contact/contactUdef/SuperOffice:8
