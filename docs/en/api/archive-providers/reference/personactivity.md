...
```http!
GET /api/v1/archive/PersonActivity?$select=person/isStakeholder,contact/stop,contact/contactPhone/formattedNumber,mailingAddr/contact/contactAssociate/contactDepartment,mailingAddr/contact/contactAssociate/simultaneousEjUser
