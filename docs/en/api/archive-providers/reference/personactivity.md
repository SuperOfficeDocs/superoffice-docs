...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personId,person/personDirectFax/formattedNumber,person/personAssociate/ejStatus,contact/email/emailAddress,contact/NumberOfNotCompletedTickets
