...
```http!
GET /api/v1/archive/PersonActivity?$select=updatedDate,person/personExtra/x_person_float,mailingAddr/contact/registeredByFullName,mailingAddr/contact/email/emailHasBounced,mailingAddr/contact/postAddress/line1
