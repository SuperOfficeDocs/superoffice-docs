...
```http!
GET /api/v1/archive/PersonActivity?$select=person/middleName,person/supportAssociate,person/personUdef/SuperOffice:8,contact/associateId,contact/restrictionAddress/line2
