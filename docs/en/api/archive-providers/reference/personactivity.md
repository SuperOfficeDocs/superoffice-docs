...
```http!
GET /api/v1/archive/PersonActivity?$select=mailingAddr/contact/postAddress/formattedMultiLineAddress,mailingAddr/person/personPager/description,mailingAddr/person/personInterestIds,mailingAddr/person/personAssociate/associateDbId,project/icon
