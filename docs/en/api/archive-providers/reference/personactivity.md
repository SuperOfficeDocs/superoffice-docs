...
```http!
GET /api/v1/archive/PersonActivity?$select=person/restrictionAddress/formattedAddress,person/personExtra/x_person_contact_relation,person/personAssociate/contactFullName,project/number,mailingSentCount
