...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personUdef/SuperOffice:2,person/personAssociate/firstName,contact/contactAssociate/assocName,contact/contactAssociate/locationAddress,mailingAddr/contact/searchPhone/formattedNumber
