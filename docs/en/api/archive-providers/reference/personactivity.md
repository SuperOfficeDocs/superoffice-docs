...
```http!
GET /api/v1/archive/PersonActivity?$select=person/useAsMailingAddress,person/searchPhone/formattedNumber,person/personInfo/textId,mailingAddr/contact/contactNoMail,mailingAddr/contact/streetAddress/city
