...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personAddress/line2,contact/contactExtra/x_contact_datetime,contact/contactExtra/x_contact_timespan,contact/saintIntention,sale/associate/ejStatus
