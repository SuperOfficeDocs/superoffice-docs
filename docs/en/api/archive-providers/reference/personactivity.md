...
```http!
GET /api/v1/archive/PersonActivity?$select=associate/fullName,person/birthdate,contact/forceCompany,contact/contactAssociate/isActiveText,mailingReplyTo
