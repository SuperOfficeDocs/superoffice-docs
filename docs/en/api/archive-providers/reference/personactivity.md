...
```http!
GET /api/v1/archive/PersonActivity?$select=recordType,contact/contactFax/formattedNumber,contact/contactExtra/x_contact_request_relation,sale/registeredBy,sale/hasStakeholders
