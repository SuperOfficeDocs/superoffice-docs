...
```http!
GET /api/v1/archive/PersonActivity?$select=chatTopic/badgeHeader,person/personExtra/x_person_contact_relation,person/subscription,person/consentSourceEmarketing,contact/contactExtra/x_contact_short_dropdown
