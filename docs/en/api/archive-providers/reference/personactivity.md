...
```http!
GET /api/v1/archive/PersonActivity?$select=person/email/emailProtocol,person/personAddress/wgs84latitude,person/personExtra/y_rental/id,person/personAssociate/role,contact/contactUdef/SuperOffice:4
