...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personCategory,person/personMobilePhone/formattedNumber,person/personAssociate/assocName,person/withdrawnEmarketingConsent,contact/email/emailLastSent
