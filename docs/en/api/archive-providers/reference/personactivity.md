...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personActiveErpLinks,person/personUdef/SuperOffice:6,person/personExtra/x_person_shorttext,person/personAssociate/isActiveText,contact/streetAddress/zip
