...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personExtra/y_rental/y_equipment/x_name,person/correspondingAssociate/ejStatus,contact/mainContact,contact/contactAssociate/contactId,contact/contactAssociate/contactCategory
