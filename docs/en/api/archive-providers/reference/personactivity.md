...
```http!
GET /api/v1/archive/PersonActivity?$select=getNoRows,mailingAddr/contact/restrictionAddress/zip,mailingAddr/contact/LastCompletedSale,mailingAddr/person/title,mailingAddr/person/restrictionAddress/zip
