...
```http!
GET /api/v1/archive/PersonActivity?$select=person/supportAssociate,contact/contactExtra/x_contact_integer,mailingAddr/contact/postAddress/formattedMultiLineAddress,mailingAddr/contact/saintActivityType,mailingAddr/person/supportLanguage
