...
```http!
GET /api/v1/archive/PersonActivity?$select=associate/personEmail,person/hasInfoText,contact/searchPhone/formattedNumber,contact/contactUdef/SuperOffice:13,sale/salePublish/publishedFrom
