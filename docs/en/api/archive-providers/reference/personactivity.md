...
```http!
GET /api/v1/archive/PersonActivity?$select=lastMessage,person/personCountry,person/personExtra/x_person_float,person/personAssociate/credentialType,contact/email/emailAddress
