...
```http!
GET /api/v1/archive/PersonActivity?$select=person/personAddress/line2,contact/hasInfoText,mailingAddr/contact/restrictionAddress/line3,mailingAddr/contact/contactExtra/x_contact_contact,sale/associate/contactFullName
