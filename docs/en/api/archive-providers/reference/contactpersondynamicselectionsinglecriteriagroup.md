...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=SaintStatus2,sale/originalStage,sale/saleUdef/SuperOffice:2,appointment/appointmentUdef/SuperOffice:6,appointment/associate/mrMrs
