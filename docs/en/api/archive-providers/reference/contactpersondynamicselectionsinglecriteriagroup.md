...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=sourceRelation/restrictionContactId,personSourceRelation/personCategory,personAssociate/ejDisplayName,request/createdBy/associateDbId,projectMembers/imageThumbnail
