...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactPhone/formattedNumber,appointment/icon,appointment/associate/mrMrs,appointment/associate/title,personMobilePhone/description
