...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactAssociate/usergroupId,contactAssociate/ejUserId,NumberOfSalesInPeriod,LastTicket,sale/personId
