...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=name,companyCategoryRank,activeErpLinks,contactAssociate/otherGroups,sourceRelation/contactId
