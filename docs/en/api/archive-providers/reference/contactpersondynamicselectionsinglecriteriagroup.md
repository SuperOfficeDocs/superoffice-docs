...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=category,email/emailHasBounced,sale/sale/textId,document/associate/otherGroups,request/connectId
