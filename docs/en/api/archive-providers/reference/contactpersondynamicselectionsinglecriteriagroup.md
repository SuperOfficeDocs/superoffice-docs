...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=email/emailId,contactInterestIds,document/ourref,document/documentPublish/isPublished,document/associate/middleName
