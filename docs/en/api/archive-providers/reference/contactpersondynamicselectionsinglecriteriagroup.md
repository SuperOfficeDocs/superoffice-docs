...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactId,searchPhone/description,sale/type,appointment/appointmentUdef/SuperOffice:2,request/createdBy/personId
