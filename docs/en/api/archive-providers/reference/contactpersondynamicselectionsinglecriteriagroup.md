...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactAssociate/role,contactUdef/SuperOffice:9,sourceRelation/restrictionContactId,sale/competitor,sale/earningPercent
