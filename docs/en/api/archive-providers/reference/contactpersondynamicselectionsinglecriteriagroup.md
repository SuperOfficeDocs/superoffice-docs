...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactNoMail,contactUdef/SuperOffice:9,sale/stageRank,appointment/associate/assocType,personSourceRelation/personNoMail
