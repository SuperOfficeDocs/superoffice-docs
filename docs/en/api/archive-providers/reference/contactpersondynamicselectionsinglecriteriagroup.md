...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=postAddress/city,NumberOfSales,NumberOfSalesInPeriod,LastSale,sale/visibleFor
