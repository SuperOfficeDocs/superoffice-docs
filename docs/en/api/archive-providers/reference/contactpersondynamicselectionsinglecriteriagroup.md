...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=targetRelation/department,targetRelation/nameDepartment,targetRelation/contactNoMail,sale/salePublish/publishedFrom,sale/associate/mrMrs
