...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=streetAddress/county,restrictionAddress/line1,sale/nextDueDate,sale/salePublish/publishedFrom,document/associate/title
