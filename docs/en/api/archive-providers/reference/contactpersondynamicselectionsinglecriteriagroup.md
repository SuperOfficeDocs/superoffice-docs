...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=nameDepartment,saintTicketCategory,targetRelation/contactNoMail,targetRelation/contactSource,sale/saleType
