...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=phone/formattedNumber,contactAssociate/contactId,sale/saleUdef/SuperOffice:4,appointment/recordTypeText,appointment/associate/associateDbId
