...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionSingleCriteriaGroup?$select=streetAddress/city,personRegisteredDate,personTargetRelation/restrictionPersonId,request/numberOfMessages,projectMembers/function
