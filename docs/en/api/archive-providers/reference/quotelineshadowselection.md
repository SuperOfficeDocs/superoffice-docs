...
```http!
GET /api/v1/archive/QuoteLineShadowSelection?$select=alternative/version/extraField1,alternative/version/quote/sale/associate/userName,alternative/version/quote/sale/person/personAddress/state
