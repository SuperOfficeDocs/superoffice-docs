...
```http!
GET /api/v1/archive/QuoteLineShadowSelection?$select=PriceUnitSubscriptionQuantityUnit,alternative/version/state,alternative/version/quote/sale/person/birthMonth,alternative/version/quote/sale/person/personAddress/formattedAddress,alternative/version/quote/sale/contact/contactExtra/x_contact_contact
