...
```http!
GET /api/v1/archive/QuoteLineShadowSelection?$select=alternative/vatInfo,alternative/version/quote/sale/text,alternative/version/quote/sale/person/email/emailId
