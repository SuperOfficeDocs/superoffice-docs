...
```http!
GET /api/v1/archive/QuoteLineShadowSelection?$select=subscriptionUnit,earningAmount,alternative/version/paymentTerms,alternative/version/paymentType,alternative/version/quote/sale/createdByWorkflow
