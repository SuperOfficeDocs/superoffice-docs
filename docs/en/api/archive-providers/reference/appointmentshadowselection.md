...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/postAddress/addressId,contact/contactAssociate/contactCategory,project/projectUdef/SuperOffice:7,appointment/titleHtml
