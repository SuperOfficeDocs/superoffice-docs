...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/orgnr,person/fullName,person/ticketPriority,person/email/emailHasBounced,person/personAddress/line3
