...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/streetAddress/addressId,contact/contactAssociate/personId,contact/contactAssociate/title,person/middleName,person/personUrl/URLDescription
