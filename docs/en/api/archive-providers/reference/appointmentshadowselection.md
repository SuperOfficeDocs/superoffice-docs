...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=isMilestone,contact/associateId,contact/restrictionAddress/addressId,contact/restrictionAddress/wgs84latitude,contact/NumberOfActivities
