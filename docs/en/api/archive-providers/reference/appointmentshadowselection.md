...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=visibleInDiary,contact/saintActivityType,person/personRegisteredDate,project/projectAssociate/otherGroups,project/NumberOfNotCompletedActivities
