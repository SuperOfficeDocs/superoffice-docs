...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=appointmentId,contact/contactSource,contact/contactExtra/y_organization/x_name,contact/LastTicket,person/firstName
