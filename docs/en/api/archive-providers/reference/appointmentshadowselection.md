...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/streetAddress/county,contact/saintTicketStatus,person/personUdef/SuperOffice:1,person/personUdef/SuperOffice:4,sale/saleId
