...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=appointmentPublish/isPublished,contact/business,contact/countryId,contact/contactUdef/SuperOffice:1,person/correspondingAssociate/otherGroups
