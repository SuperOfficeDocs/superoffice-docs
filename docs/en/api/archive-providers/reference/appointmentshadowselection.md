...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=intention,endTime,contact/contactSource,contact/searchPhone/description,contact/contactExtra/x_contact_timespan
