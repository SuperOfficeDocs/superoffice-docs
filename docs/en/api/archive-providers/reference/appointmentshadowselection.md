...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/contactUdef/SuperOffice:9,person/personAssociate/isActive,person/correspondingAssociate/otherGroups,project/projectAssociate/mrMrs,sale/contactId
