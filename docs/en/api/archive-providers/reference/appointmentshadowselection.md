...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/contactAssociate/lastName,contact/contactAssociate/personEmail,contact/LastSale,person/rank,person/personInfo/infoText
