...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=updatedBy,completedDate,contact/contactAssociate/otherGroups,appointmentUdef/SuperOffice:6,project/projectAssociate/ejUserId
