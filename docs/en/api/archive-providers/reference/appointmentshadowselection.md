...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/restrictionAddress/line2,contact/contactExtra/x_contact_contact_relation,person/personAddress/formattedMultiLineAddress,appointment/isConverted
