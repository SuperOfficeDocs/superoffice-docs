...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=person/updatedByWorkflow,person/correspondingAssociate/portraitThumbnail,person/correspondingAssociate/isLocation,appointmentUdef/SuperOffice:6,project/nextMilestone
