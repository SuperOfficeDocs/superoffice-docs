...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=projectId,registeredBy,contact/registeredByFullName,contact/postAddress/wgs84longitude,contact/NumberOfTickets
