...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=location,contact/number,contact/postAddress/addressId,person/email/emailDescription,person/correspondingAssociate/contactId
