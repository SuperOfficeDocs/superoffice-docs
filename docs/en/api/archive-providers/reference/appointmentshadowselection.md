...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=contact/contactExtra/x_contact_default_integer,person/correspondingAssociate/contactName,sale/associate/isActiveText
