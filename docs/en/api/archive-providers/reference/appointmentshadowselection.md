...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=invitedPersonId,contact/NumberOfActivitiesInPeriod,person/personAddress/city,person/personAddress/wgs84longitude,project/type
