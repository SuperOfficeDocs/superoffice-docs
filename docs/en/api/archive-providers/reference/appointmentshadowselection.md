...
```http!
GET /api/v1/archive/AppointmentShadowSelection?$select=text,contact/LastDoByTicket,contact/saintSaleStatus,person/position,person/personAssociate/contactDepartment
