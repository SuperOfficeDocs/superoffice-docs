...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/personId,sale/createdByWorkflow,appointment/associate/locationAddress,document/associateId,document/associate/usergroup
