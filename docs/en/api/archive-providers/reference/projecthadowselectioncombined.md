...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=appointment/associateId,projectMember/contactAssociate/firstName,projectMember/contactExtra/x_contact_contact_relation
