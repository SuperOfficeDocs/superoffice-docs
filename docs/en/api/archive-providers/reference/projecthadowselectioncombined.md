...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=text,projectAssociate/assocType,projectAssociate/isActiveText,NumberOfNotCompletedSalesInPeriod,sale/associateId
