...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/ejUserId,document/visibleFor,document/associate/title,projectMember/projectId,projectMember/title
