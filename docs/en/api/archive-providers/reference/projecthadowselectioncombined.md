...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/contactId,sale/sale/textId,appointment/projectId,projectMember/personUrl/URLAddress,projectMember/personAddress/state
