...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=activeErpLinks,sale/time,projectMember/correspondingAssociate/usergroup,projectMember/activeErpLinks
