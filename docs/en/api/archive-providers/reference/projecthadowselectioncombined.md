...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=type,sale/saleUdef/SuperOffice:1,appointment/rawType,appointment/associate/mrMrs,projectMember/leadstatusRank
