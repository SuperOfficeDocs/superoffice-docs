...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=document/mailMergeDraft,document/associate/mrMrs,projectMember/registeredByFullName,projectMember/contactExtra/x_contact_default_integer
