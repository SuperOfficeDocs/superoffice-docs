...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/ejUserId,saintAmountClass,sale/saleNumber,document/mailMergeDraft,projectMember/mrMrs
