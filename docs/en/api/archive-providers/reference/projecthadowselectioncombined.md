...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/middleName,sale/hasQuote,appointment/saleId,appointment/associate/isActiveText,document/associate/contactDepartment
