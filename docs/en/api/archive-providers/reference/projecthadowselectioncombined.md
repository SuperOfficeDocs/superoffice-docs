...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/isActiveText,sale/currencyId,sale/salePublish/publishedFrom,appointment/associate/assocName,projectMember/personAssociateId
