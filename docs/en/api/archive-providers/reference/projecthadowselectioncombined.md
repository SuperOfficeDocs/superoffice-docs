...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=name,projectUdef/SuperOffice:1,sale/currency,sale/associate/contactId,projectMember/personExtra/x_person_float
