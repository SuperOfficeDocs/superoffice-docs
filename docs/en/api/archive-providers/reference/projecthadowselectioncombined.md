...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/locationAddress,sale/associate/lastName,sale/associate/credentialType,document/yourref,document/associate/personEmail
