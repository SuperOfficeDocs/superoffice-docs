...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=text,sale/personId,document/type,projectMember/function,projectMember/correspondingAssociate/portraitThumbnail
