...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectUdef/SuperOffice:2,sale/amountWeighted,sale/hasGuide,sale/associate/ejDisplayName,appointment/isMilestone
