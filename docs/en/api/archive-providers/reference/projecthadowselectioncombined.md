...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectUdef/SuperOffice:1,projectUdef/SuperOffice:7,LastActivity,sale/associate/lastName,appointment/appointment/agendaHtml
