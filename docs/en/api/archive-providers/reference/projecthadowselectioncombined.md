...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/contactDepartment,NumberOfNotCompletedSalesInPeriod,sale/competitor,sale/saleType,sale/associate/ejStatus
