...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/assocType,projectUdef/SuperOffice:7,sale/text,sale/stalledComment,sale/associate/contactCategory
