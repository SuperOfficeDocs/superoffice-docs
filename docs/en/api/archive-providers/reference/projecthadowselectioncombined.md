...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=updatedByFullName,registeredBy,projectAssociate/isActive,appointment/associate/personId,document/associate/role
