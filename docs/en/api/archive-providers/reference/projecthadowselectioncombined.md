...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectAssociate/ejStatus,sale/updatedBy,appointment/appointmentUdef/SuperOffice:2,appointment/associate/personId,document/documentUdef/SuperOffice:8
