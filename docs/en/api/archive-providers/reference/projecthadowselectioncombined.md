...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=projectMember/restrictionAddress/line2,projectMember/personAssociate/contactName,projectMember/updatedByFullName,projectMember/postAddress/zip,projectMember/contactUdef/SuperOffice:3
