...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=type,projectUdef/SuperOffice:6,sale/saleTypeCategory,sale/associate/personId,appointment/associate/title
