...
```http!
GET /api/v1/archive/ProjecthadowSelectionCombined?$select=appointment/isMilestone,document/document/description,projectMember/lastName,projectMember/personCountry,projectMember/restrictionAddress/line2
