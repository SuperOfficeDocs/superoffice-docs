...
# "AssignmentPersonNotification"

This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.AssignmentPersonNotificationSubProvider">SuperOffice.CRM.ArchiveLists.AssignmentPersonNotificationSubProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AssignmentPersonNotification?$select=type,notifyDateTime,type
