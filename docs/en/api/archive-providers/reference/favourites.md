...
```http!
GET /api/v1/archive/Favourites?$select=sale/textId,person/email/emailDescription,person/email/emailLastBounce,person/correspondingAssociate/assocName,contact/nameDepartment
