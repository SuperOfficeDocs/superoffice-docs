...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=visibleFor,contact/country,contact/countryId,contact/contactAssociate/contactId,contact/contactExtra/x_contact_float
