...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/postAddress/line1,person/personCountryId,person/personAddress/county,person/personExtra/y_car/id,person/personAssociate/credentialType
