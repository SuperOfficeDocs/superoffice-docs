...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contactId,contact/postAddress/formattedMultiLineAddress,person/mrMrs,person/personNoMail,person/correspondingAssociate/assocTooltip
