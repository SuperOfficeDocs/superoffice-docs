...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/countryId,contact/contactAssociate/portraitThumbnail,contact/contactUdef/SuperOffice:7,person/useAsMailingAddress,person/email/emailHasBounced
