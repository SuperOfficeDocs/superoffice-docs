...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/name,contact/email/emailDescription,contact/contactAssociate/assocTooltip,contact/LastDoByTicket,person/personExtra/y_rental/id
