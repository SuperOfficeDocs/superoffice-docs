...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/deletedDate,contact/postAddress/line2,contact/contactUdef/SuperOffice:3,contact/NumberOfNotCompletedSales,contact/NumberOfTickets
