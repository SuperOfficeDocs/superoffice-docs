...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/contactDeleted,person/isProjectMember,person/updatedByWorkflow,person/personExtra/y_rental/x_end,person/personExtra/y_car/id
