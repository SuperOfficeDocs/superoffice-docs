...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=recurrenceRuleId,contact/contactAssociate/contactId,contact/contactAssociate/contactFullName,contact/saintAmountClass,contact/saintDirection
