...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=person/restrictionAddress/wgs84longitude,project/completed,project/name,project/associateId,project/projectPublish/publishedFrom
