...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=userGroup,cautionWarning,completedDate,contact/LastCompletedTicket,project/projectAssociate/usergroup
