...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=person/personAddress/formattedMultiLineAddress,person/personAssociate/isActive,appointmentUdef/SuperOffice:4,sale/associate/ejStatus
