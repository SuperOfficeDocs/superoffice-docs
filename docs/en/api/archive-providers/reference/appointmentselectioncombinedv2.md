...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=projectId,contact/streetAddress/line3,project/projectAssociate/assocTooltip,sale/who,associate/firstName
