...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=person/title,person/supportLanguage,person/personAddress/county,person/personUdef/SuperOffice:2,person/correspondingAssociate/isLocation
