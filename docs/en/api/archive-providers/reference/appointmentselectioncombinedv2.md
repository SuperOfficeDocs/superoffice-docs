...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/streetAddress/county,contact/url/URLAddress,contact/contactAssociate/usergroup,contact/LastDoByTicket,person/middleName
