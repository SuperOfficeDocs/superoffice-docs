...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=type,alarm,contact/hasInfoText,project/projectUdef/SuperOffice:6,sale/salePublish/publishedBy
