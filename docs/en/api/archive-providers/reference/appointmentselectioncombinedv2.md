...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/contactExtra/x_contact_short_dropdown,person/personAssociate/isActiveText,sale/originalStage
