...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=endDate,contact/LastSale,person/personDirectPhone/description,person/restrictionAddress/line1,appointmentUdef/SuperOffice:1
