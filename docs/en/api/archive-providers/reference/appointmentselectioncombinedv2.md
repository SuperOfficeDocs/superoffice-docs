...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/contactAssociate/usergroup,contact/contactAssociate/contactFullName,sale/time,sale/type,sale/lossReason
