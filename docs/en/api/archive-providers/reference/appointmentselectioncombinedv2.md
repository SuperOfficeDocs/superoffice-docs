...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/email/emailAddress,contact/postAddress/addressId,contact/restrictionAddress/county,contact/NumberOfNotCompletedActivitiesInPeriod,person/firstName
