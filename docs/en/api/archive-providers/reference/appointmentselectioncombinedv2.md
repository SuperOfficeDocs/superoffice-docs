...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/restrictionAddress/state,contact/contactExtra/x_contact_date,person/personExtra/x_person_date,person/personAssociate/isLocation,sale/saleUdef/SuperOffice:3
