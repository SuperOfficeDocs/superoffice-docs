...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=endDate,contact/category,contact/restrictionAddress/formattedMultiLineAddress,person/isProjectMember,project/projectAssociate/credentialDisplayValue
