...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=person/hasCompany,person/personUdef/SuperOffice:7,person/hasEmarketingConsent,person/legalBaseEmarketing,person/consentSourceEmarketing
