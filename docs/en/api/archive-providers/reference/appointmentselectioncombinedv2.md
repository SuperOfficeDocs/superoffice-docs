...
```http!
GET /api/v1/archive/AppointmentSelectionCombinedV2?$select=contact/countryId,contact/postAddress/formattedAddress,person/personAssociate/title,sale/salePublish/publishedTo
