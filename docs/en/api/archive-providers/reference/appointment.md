...
```http!
GET /api/v1/archive/Appointment?$select=registeredDate,contact/country,contact/postAddress/line2,contact/contactAssociate/assocType,person/personPrivate/formattedNumber
