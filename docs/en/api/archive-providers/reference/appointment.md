...
```http!
GET /api/v1/archive/Appointment?$select=appointmentPublish/publishedBy,contact/streetAddress/line3,contact/LastCompletedSale,appointmentUdef/SuperOffice:3,project/projectAssociate/assocTooltip
