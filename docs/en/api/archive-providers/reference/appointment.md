...
```http!
GET /api/v1/archive/Appointment?$select=contact/LastActivity,person/personCategory,person/personUdef/SuperOffice:8,person/personAssociate/personId,project/projectPublish/isPublished
