...
```http!
GET /api/v1/archive/Appointment?$select=priority,appointmentPublish/publishedBy,contact/contactAssociate/isActiveText,contact/saintActivityType,person/middleName
