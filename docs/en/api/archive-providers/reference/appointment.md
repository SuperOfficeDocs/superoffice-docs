...
```http!
GET /api/v1/archive/Appointment?$select=contact/SaintStatus1,contact/saintActivityType,person/personAssociateId,person/email/emailHasBounced,person/personUdef/SuperOffice:5
