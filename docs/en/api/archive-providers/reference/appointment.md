...
```http!
GET /api/v1/archive/Appointment?$select=time,contact/contactExtra/x_contact_datetime,person/personUdef/SuperOffice:6,person/personUdef/SuperOffice:8,person/personUdef/SuperOffice:9
