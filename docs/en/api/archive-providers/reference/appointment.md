...
```http!
GET /api/v1/archive/Appointment?$select=completed,contact/category,contact/contactAssociate/personId,contact/saintSaleStatus,person/personUdef/SuperOffice:3
