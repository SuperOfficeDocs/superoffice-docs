...
```http!
GET /api/v1/archive/Appointment?$select=completedDate,contact/LastCompletedTicket,person/personAssociateId,person/personCategoryGroup,person/correspondingAssociate/fullName
