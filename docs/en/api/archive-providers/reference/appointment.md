...
```http!
GET /api/v1/archive/Appointment?$select=contact/updatedByFullName,contact/email/emailId,contact/contactAssociate/middleName,person/position,person/searchPhone/formattedNumber
