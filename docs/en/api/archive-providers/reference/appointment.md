...
```http!
GET /api/v1/archive/Appointment?$select=contact/postAddress/city,contact/contactExtra/x_contact_date,person/personUdef/SuperOffice:8,sale/saleTypeCategory,sale/associate/ejStatus
