...
```http!
GET /api/v1/archive/Appointment?$select=contact/contactExtra/x_contact_dropdown,person/personId,person/personPager/formattedNumber,person/correspondingAssociate/contactFullName,project/projectUdef/SuperOffice:1
