...
```http!
GET /api/v1/archive/Appointment?$select=contact/email/emailHasBounced,contact/contactAssociate/title,person/personAssociate/usergroup,sale/currencyId,sale/associate/mrMrs
