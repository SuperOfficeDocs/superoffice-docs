...
```http!
GET /api/v1/archive/Appointment?$select=contact/contactExtra/x_contact_contact,person/personPager/description,person/personAddress/wgs84latitude,project/projectAssociate/fullName,project/LastSale
