...
```http!
GET /api/v1/archive/Appointment?$select=contact/department,contact/email/emailLastBounce,contact/streetAddress/city,contact/contactUdef/SuperOffice:7,sale/associateId
