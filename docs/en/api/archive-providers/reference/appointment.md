...
```http!
GET /api/v1/archive/Appointment?$select=recurring,contact/postAddress/line1,contact/restrictionAddress/wgs84longitude,person/personPager/description,person/personExtra/x_person_date
