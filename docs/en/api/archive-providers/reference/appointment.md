...
```http!
GET /api/v1/archive/Appointment?$select=recurring,contact/restrictionAddress/formattedMultiLineAddress,contact/NumberOfNotCompletedActivitiesInPeriod,person/hasInfoText,person/useAsMailingAddress
