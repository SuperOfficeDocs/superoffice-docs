...
```http!
GET /api/v1/archive/Appointment?$select=contact/contactExtra/x_contact_timespan,person/personAssociateFullName,sale/saleType,sale/visibleFor,sale/associate/locationAddress
