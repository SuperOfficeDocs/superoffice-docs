...
```http!
GET /api/v1/archive/Appointment?$select=contact/hasInfoText,contact/contactSource,contact/contactPhone/description,contact/NumberOfNotCompletedSales,person/birthdate
