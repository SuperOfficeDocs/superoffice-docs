...
```http!
GET /api/v1/archive/Appointment?$select=location,contact/contactAssociate/assocName,contact/NumberOfActivities,person/kanaFirstName,person/personAssociateId
