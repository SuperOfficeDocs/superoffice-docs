...
```http!
GET /api/v1/archive/Appointment?$select=recordType,contact/department,person/birthYear,person/personExtra/y_rental/x_amount,appointmentUdef/SuperOffice:4
