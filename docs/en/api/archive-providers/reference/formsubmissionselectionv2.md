...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=associate/contactId,associate/contactCategory,person/kanaFirstName,person/personUdef/SuperOffice:1,person/personAssociate/credentialType
