...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=associate/middleName,associate/assocName,person/birthYear,person/personAddress/zip,person/personUdef/SuperOffice:9
