...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=associate/simultaneousEjUser,person/position,person/useAsMailingAddress,person/personAddress/county,person/personUdef/SuperOffice:5
