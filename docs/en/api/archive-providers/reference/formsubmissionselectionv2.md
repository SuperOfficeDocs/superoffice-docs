...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=formSubmissionStatus,person/mrMrs,person/email/emailHasBounced,person/personExtra/x_person_appointment_relation,contact/postAddress/state
