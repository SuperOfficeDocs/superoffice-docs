...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=selectionMemberId,person/restrictionAddress/wgs84longitude,person/correspondingAssociate/middleName
