...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=contact/contactAssociate/assocType,contact/contactAssociate/ejStatus,contact/contactUdef/SuperOffice:11
