...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=person/personUdef/SuperOffice:8,person/personUdef/SuperOffice:9,person/correspondingAssociate/contactDepartment,contact/contactAssociate/mrMrs,contact/contactAssociate/isActiveText
