...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=person/searchPhone/formattedNumber,person/personAssociate/mrMrs,person/correspondingAssociate/isActiveText,contact/postAddress/line3,contact/contactAssociate/contactName
