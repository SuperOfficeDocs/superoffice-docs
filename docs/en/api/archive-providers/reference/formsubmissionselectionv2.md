...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=contact/contactAssociate/title,person/restrictionAddress/wgs84latitude,person/correspondingAssociate/middleName
