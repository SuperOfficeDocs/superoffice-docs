...
```http!
GET /api/v1/archive/FormSubmissionSelectionV2?$select=person/personDeletedDate,person/correspondingAssociate/userName,contact/postAddress/city,contact/contactExtra/x_contact_timespan
