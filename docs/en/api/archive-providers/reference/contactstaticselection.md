...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=email/emailProtocol,NumberOfNotCompletedActivitiesInPeriod,targetRelation/name,appointment/associate/mrMrs,appointment/associate/contactDepartment
