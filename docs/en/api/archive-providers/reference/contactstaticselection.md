...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=postAddress/formattedMultiLineAddress,contactAssociate/firstName,contactExtra/x_contact_short_dropdown,contactExtra/x_contact_contact,sourceRelation/contactNoMail
