...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=business,targetRelation/updatedBy,sale/source,personExtra/x_person_boolean,personExtra/x_person_shorttext_list
