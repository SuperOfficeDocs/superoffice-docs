...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=appointment/registeredBy,document/mailMergeDraft,fullNameWithContact,request/createdBy/contactCategory,projectMembers/projectUdef/SuperOffice:1
