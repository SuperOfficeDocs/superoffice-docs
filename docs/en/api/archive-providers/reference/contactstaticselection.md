...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=searchPhone/formattedNumber,postAddress/formattedMultiLineAddress,contactAssociate/usergroup,contactExtra/x_contact_short_dropdown,LastCompletedSale
