...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=contactSource,streetAddress/city,contactUdef/SuperOffice:1,contactExtra/x_contact_contact_relation,NumberOfNotCompletedTickets
