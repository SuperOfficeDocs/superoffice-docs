...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=contactAssociate/contactDepartment,appointment/associate/contactName,document/associate/portraitThumbnail,lastName,personNumber
