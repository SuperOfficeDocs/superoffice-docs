...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=email/emailLastBounce,contactUdef/SuperOffice:2,NumberOfSalesInPeriod,sale/associate/assocName,sale/associate/credentialDisplayValue
