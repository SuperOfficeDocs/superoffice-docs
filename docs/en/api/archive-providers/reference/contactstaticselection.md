...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=contactUdef/SuperOffice:8,sale/associate/firstName,sale/saleUdef/SuperOffice:8,document/associate/assocTooltip,personNumber
