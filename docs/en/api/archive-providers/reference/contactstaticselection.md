...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=contactNoMail,NumberOfActivitiesInPeriod,sourceRelation/countryId,sourceRelation/orgnr,targetRelation/updatedByFullName
