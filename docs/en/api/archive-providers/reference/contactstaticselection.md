...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=postAddress/line1,sale/saleTypeCategory,document/associate/usergroup,position,personSourceRelation/personDeletedDate
