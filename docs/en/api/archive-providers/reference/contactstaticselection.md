...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=sourceRelation/hasInterests,sourceRelation/associateId,document/associate/assocType,document/associate/locationAddress,position
