...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=email/emailAddress,restrictionAddress/addressId,restrictionAddress/line3,sourceRelation/name,targetRelation/business
