...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=contactExtra/x_contact_dropdown,LastTicket,sourceRelation/hasInterests,sale/associate/isLocation,appointment/contactId
