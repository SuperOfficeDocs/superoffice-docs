...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=streetAddress/line1,streetAddress/city,appointment/associate/mrMrs,personUpdatedBy,personExtra/x_person_shorttext_list
