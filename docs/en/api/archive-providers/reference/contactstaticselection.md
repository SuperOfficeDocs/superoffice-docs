...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=selectionId,contactAssociate/credentialDisplayValue,sale/icon,sale/associate/credentialType,document/associate/mrMrs
