...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=sourceRelation/csRelation,targetRelation/hasInterests,targetRelation/deletedDate,appointment/associate/assocTooltip,document/associate/mrMrs
