...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=LastCompletedActivity,targetRelation/business,sale/saleUdef/SuperOffice:5,document/suggestedDocumentId,document/associate/contactFullName
