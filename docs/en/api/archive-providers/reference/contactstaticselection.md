...
```http!
GET /api/v1/archive/ContactStaticSelection?$select=contactAssociate/userName,sale/createdByWorkflow,appointment/associateId,appointment/projectId,appointment/visibleFor
