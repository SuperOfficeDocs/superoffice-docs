...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=getAllRows,orgnr,deletedDate,url/URLDescription,contactUdef/SuperOffice:2
