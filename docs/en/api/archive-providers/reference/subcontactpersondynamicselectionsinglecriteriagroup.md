...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=streetAddress/city,NumberOfNotCompletedActivities,NumberOfTicketsInPeriod,sale/contactId,sale/sale/textId
