...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=email/emailLastSent,sale/type,sale/description,appointment/appointment/internalNotes,document/mailMergeDraft
