...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=email/emailProtocol,postAddress/line3,restrictionAddress/zip,SaintStatus2,fullName
