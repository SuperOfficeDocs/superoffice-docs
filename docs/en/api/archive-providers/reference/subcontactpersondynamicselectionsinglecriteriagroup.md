...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=email/emailHasBounced,postAddress/county,contactUdef/SuperOffice:4,NumberOfNotCompletedTickets,sale/originalStage
