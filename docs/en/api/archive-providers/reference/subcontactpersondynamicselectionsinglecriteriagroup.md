...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=targetRelation/updatedByFullName,sale/completed,sale/hasQuote,sale/saleUdef/SuperOffice:5,appointment/associateId
