...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=postAddress/city,streetAddress/addressId,streetAddress/line3,restrictionAddress/wgs84longitude,personAddress/line2
