...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactUdef/SuperOffice:1,sourceRelation/department,document/documentUdef/SuperOffice:1,lastName,supportLanguage
