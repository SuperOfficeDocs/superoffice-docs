...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=streetAddress/wgs84latitude,targetRelation/contactSource,sale/earningPercent,appointment/appointment/isConverted,rank
