...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=number,updatedByFullName,sourceRelation/contactId,sourceRelation/contactSource,targetRelation/contactSource
