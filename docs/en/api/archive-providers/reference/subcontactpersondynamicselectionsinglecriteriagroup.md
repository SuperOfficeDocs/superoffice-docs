...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=streetAddress/wgs84longitude,contactAssociate/simultaneousEjUser,contactAssociate/isLocation,sale/associate/firstName,appointment/appointmentUdef/SuperOffice:1
