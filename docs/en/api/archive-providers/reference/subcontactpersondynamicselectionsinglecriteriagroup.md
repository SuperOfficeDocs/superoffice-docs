...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=orgnr,registeredDate,restrictionAddress/county,sale/associate/mrMrs,appointment/contactId
