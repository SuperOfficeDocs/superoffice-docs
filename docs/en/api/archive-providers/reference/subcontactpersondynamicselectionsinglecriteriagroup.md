...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactAssociate/ejStatus,sourceRelation/contactNoMail,sale/salePublish/publishedBy,document/associate/isLocation,whenUpdatedByWorkflow
