...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=targetRelation/registeredBy,appointment/associate/isActive,appointment/associate/isActiveText,personAddress/formattedAddress,personTargetRelation/contactId
