...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=contactAssociate/contactDepartment,saintActivityType,sourceRelation/contactDeleted,sale/associate/title,appointment/appointment/title
