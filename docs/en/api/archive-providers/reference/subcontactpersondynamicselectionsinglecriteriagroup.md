...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=NumberOfSales,targetRelation/updatedBy,kanaLastName,personAddress/state,personAddress/formattedMultiLineAddress
