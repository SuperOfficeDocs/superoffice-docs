...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=hasInfoText,contactAssociate/middleName,sourceRelation/companyCategoryRank,appointment/booking,document/updatedByFullName
