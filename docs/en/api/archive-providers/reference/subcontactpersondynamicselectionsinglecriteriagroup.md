...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=department,hasInterests,url/URLDescription,contactAssociate/ejUserId,targetRelation/department
