...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=registeredBy,document/registeredDate,projectMembers/projectAssociate/userName
