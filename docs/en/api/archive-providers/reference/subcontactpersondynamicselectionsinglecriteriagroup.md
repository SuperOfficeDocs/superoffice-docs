...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=NumberOfActivities,LastDoByTicket,sourceRelation/department,appointment/appointment/description,personRegisteredBy
