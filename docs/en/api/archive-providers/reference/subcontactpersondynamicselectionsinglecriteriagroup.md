...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=sale/associate/isActive,appointment/registeredByFullName,appointment/associate/simultaneousEjUser,personSourceRelation/personCategory,personTargetRelation/middleName
