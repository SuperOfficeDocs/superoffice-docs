...
```http!
GET /api/v1/archive/SubContactPersonDynamicSelectionSingleCriteriaGroup?$select=url/URLDescription,contactAssociate/isActiveText,targetRelation/registeredBy,sale/updatedDate,sale/associate/fullName
