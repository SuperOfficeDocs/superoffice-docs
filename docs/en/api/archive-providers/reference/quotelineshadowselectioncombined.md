...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionCombined?$select=subscriptionUnit,productTypeKey,alternative/erpDiscountAmount,alternative/version/extraField2,alternative/version/quote/sale/stageRank
