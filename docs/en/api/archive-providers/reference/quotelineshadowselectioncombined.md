...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionCombined?$select=quantityUnit,quoteLineThumbnailLarge,alternative/version/quoteVersionId,alternative/version/quote/sale/type,alternative/version/quote/sale/person/lastName
