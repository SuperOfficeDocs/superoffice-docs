...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionCombined?$select=name,updatedDate,alternative/version/quote/sale/person/rank,alternative/version/quote/sale/person/personExtra/x_person_float,alternative/version/quote/sale/contact/contactUdef/SuperOffice:4
