...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionCombined?$select=name,rowKind,alternative/description,alternative/version/quote/sale/registeredByFullName,alternative/version/quote/sale/originalStage
