...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingAddr/contact/streetAddress/line1,mailingAddr/contact/restrictionAddress/state,mailingAddr/person/personAddress/state
