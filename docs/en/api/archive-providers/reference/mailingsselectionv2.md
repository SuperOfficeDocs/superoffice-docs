...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingAddr/contact/postAddress/line3,mailingAddr/contact/restrictionAddress/wgs84longitude,mailingAddr/contact/contactAssociate/ejStatus,mailingAddr/person/personPager/description,emailFlow/hierarchyParentId
