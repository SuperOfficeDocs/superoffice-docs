...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=getAllRows,mailingAddr/contact/contactAssociate/fullName,mailingAddr/person/personAssociate/portraitThumbnail,project/projectAssociate/isActive
