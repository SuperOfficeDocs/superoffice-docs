...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=getNoRows,mailingAddr/contact/contactId,mailingAddr/person/personInfo/textId,mailingAddr/person/correspondingAssociate/ejStatus,project/projectAssociate/lastName
