...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingAddr/contact/NumberOfTickets,mailingAddr/person/personUdef/SuperOffice:11,emailFlow/workflowSuccessRate,emailFlow/updatedBy
