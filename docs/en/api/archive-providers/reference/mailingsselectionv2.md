...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingDeleted,mailingAddr/contact/category,mailingAddr/contact/postAddress/line3,mailingAddr/contact/contactAssociate/assocType,mailingAddr/contact/contactUdef/SuperOffice:7
