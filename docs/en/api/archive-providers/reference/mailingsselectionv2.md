...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=type,mailingAddr/contact/contactAssociate/simultaneousEjUser,mailingAddr/contact/LastDoBySale,mailingAddr/person/personDirectFax/description,mailingAddr/person/correspondingAssociate/isLocation
