...
```http!
GET /api/v1/archive/MailingsSelectionV2?$select=mailingAddr/contact/orgnr,mailingAddr/contact/contactUdef/SuperOffice:7,mailingAddr/person/personCountry,mailingAddr/person/associateType,mailingAddr/person/useAsMailingAddress
