...
```http!
GET /api/v1/archive/TargetValueSub?$select=contact/contactSupportAssociate/mrMrs,contact/contactSupportPerson/personHasInterests,contact/streetAddress/zip
