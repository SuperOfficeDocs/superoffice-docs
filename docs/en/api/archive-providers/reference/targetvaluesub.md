...
```http!
GET /api/v1/archive/TargetValueSub?$select=targetDimensionEntityType,contact/code,contact/restrictionAddress/line2,contact/contactSupportPerson/birthYear
