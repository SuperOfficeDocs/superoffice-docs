...
```http!
GET /api/v1/archive/TargetValueSub?$select=associate/lastName,associate/isLocation,contact/url/URLAddress,contact/contactSupportAssociate/role,contact/contactSupportAssociate/assocTooltip
