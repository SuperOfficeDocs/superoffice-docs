...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/personExtra/x_person_date,associate/firstName,appointment/text,project/updatedDate,project/NumberOfNotCompletedActivitiesInPeriod
