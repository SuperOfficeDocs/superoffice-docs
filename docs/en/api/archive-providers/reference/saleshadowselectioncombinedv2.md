...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionCombinedProviderV2">SuperOffice.CRM.ArchiveLists.Archive.SaleShadowSelectionCombinedProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=date,person/personUdef/SuperOffice:8,contact/hasInterests,contact/code,contact/contactExtra/x_contact_timespan
