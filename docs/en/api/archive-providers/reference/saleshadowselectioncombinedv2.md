...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/correspondingAssociate/mrMrs,person/correspondingAssociate/assocName,person/consentSourceEmarketing,associate/contactId,appointment/recurrenceRuleId
