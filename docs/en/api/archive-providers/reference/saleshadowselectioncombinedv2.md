...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=hasQuote,person/kanaLastName,person/personExtra/x_person_timespan,person/correspondingAssociate/assocType,person/correspondingAssociate/locationAddress
