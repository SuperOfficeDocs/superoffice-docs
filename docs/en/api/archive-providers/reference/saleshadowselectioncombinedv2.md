...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=personId,document/yourref,project/hasGuide,project/projectAssociate/ejUserId,saleStakeholder/person/searchPhone/description
