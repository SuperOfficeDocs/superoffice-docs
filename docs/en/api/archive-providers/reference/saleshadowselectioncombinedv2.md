...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=stage,nextDueDate,person/useAsMailingAddress,person/restrictionAddress/line1,person/restrictionAddress/state
