...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=sale/textId,person/personMobilePhone/description,person/consentSourceStore,contact/searchPhone/formattedNumber,document/associate/otherGroups
