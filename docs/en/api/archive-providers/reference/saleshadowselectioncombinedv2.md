...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=associate/title,project/nextMilestone,saleStakeholder/person/email/emailAddress,saleStakeholder/person/restrictionAddress/wgs84latitude,saleStakeholder/person/personUdef/SuperOffice:3
