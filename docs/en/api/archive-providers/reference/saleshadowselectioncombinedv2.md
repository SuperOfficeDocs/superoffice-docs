...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=heading,contact/postAddress/formattedAddress,contact/restrictionAddress/line2,appointment/icon,appointment/appointment/title
