...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=heading,person/personAddress/city,person/personAssociate/title,contact/streetAddress/county,contact/LastCompletedSale
