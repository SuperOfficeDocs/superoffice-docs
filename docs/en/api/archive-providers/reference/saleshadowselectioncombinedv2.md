...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=currency,stage,person/personExtra/x_person_time,person/correspondingAssociate/fullName,person/correspondingAssociate/personId
