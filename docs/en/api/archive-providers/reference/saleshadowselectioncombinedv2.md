...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/email/emailAddress,person/personExtra/y_rental/x_amount,person/correspondingAssociate/usergroup,person/hasStoreConsent,contact/stop
