...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=type,person/personNoMail,person/personAssociate/title,person/personAssociate/simultaneousEjUser,appointment/associate/title
