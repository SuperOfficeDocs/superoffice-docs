...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/personAssociateId,person/personAddress/line1,person/personAssociate/fullName,contact/streetAddress/line1,contact/url/URLDescription
