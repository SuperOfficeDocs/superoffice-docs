...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=saleStatus,person/personAssociate/fullName,person/personAssociate/assocTooltip,contact/saintIntention,appointment/associate/contactName
