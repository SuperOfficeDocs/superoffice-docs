...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/personCountryId,person/personExtra/y_car/id,person/correspondingAssociate/simultaneousEjUser,contact/contactExtra/x_contact_dropdown,contact/contactExtra/x_contact_time
