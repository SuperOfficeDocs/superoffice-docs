...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/phone/formattedNumber,person/correspondingAssociate/otherGroups,contact/hasInfoText,contact/email/emailProtocol,contact/contactAssociate/contactCategory
