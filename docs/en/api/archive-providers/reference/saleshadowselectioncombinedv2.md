...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/phone/formattedNumber,contact/streetAddress/addressId,associate/isActiveText,appointment/associate/role,project/name
