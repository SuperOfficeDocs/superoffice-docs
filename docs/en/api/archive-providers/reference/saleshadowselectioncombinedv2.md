...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/personDeletedDate,contact/code,appointment/updatedByFullName,appointment/appointmentId,appointment/associate/associateDbId
