...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/personExtra/y_rental/id,contact/email/emailLastBounce,contact/postAddress/county,associate/lastName,project/projectAssociate/userName
