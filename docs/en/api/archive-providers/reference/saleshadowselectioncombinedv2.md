...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=person/associateType,person/personAssociate/isActive,contact/postAddress/wgs84longitude,associate/contactFullName,appointment/associate/portraitThumbnail
