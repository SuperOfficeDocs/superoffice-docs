...
```http!
GET /api/v1/archive/SaleShadowSelectionCombinedV2?$select=registeredDate,sale/description,person/personExtra/y_rental/x_start,person/correspondingAssociate/role,contact/contactAssociate/associateDbId
