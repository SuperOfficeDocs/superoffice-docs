...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/personExtra/y_rental/y_equipment/x_name,contact/country,contact/searchPhone/description,project/NumberOfSales
