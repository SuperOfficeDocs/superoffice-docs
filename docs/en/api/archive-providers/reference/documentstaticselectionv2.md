...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/portraitThumbnail,person/personPrivate/formattedNumber,person/personInfo/infoText,contact/streetAddress/formattedAddress,sale/hasQuote
