...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=suggestedDocumentId,person/personRegisteredByFullName,person/correspondingAssociate/isActiveText,contact/orgnr
