...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/personDeletedDate,contact/contactSource,contact/postAddress/zip,contact/postAddress/wgs84latitude,contact/contactUdef/SuperOffice:5
