...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/personExtra/x_person_float,project/updatedBy,project/saintTicketCategory,sale/saleUdef/SuperOffice:5
