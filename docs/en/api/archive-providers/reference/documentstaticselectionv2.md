...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=registeredBy,person/personCategoryGroup,person/personAddress/wgs84longitude,person/personExtra/y_car/id,project/LastCompletedSale
