...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=updatedByFullName,person/personUpdatedDate,person/email/emailDescription,contact/contactFax/formattedNumber,contact/contactAssociate/role
