...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=getNoRows,person/personUdef/SuperOffice:5,person/correspondingAssociate/credentialDisplayValue,sale/activeErpLinks,selectionMemberId
