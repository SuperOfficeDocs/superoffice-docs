...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=getNoRows,person/retired,person/personActiveErpLinks,person/restrictionAddress/zip,contact/streetAddress/line2
