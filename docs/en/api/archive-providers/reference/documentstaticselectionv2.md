...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=contact/contactAssociate/contactDepartment,contact/contactAssociate/usergroupId,contact/contactAssociate/credentialDisplayValue,project/projectAssociate/lastName,project/projectUdef/SuperOffice:6
