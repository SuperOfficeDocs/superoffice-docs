...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/personUrl/URLDescription,person/restrictionAddress/line1,person/personExtra/x_person_category_relation,project/type,associate/contactName
