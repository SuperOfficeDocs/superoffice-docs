...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/createdByForm,person/withdrawnEmarketingConsent,contact/email/emailDescription,sale/registeredDate
