...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/middleName,person/personPager/description,person/personAddress/city,contact/contactId,contact/contactAssociate/role
