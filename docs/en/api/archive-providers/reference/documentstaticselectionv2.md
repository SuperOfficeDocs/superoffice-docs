...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/leadStatus,person/isProjectMember,person/email/emailLastBounce,person/correspondingAssociate/fullName,person/correspondingAssociate/ejStatus
