...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=name,contact/restrictionAddress/wgs84longitude,project/saintDirection,sale/associate/contactFullName
