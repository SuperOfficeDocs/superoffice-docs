...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/email/emailLastBounce,person/personAssociate/fullName,project/projectAssociate/contactId,sale/who,sale/updatedByFullName
