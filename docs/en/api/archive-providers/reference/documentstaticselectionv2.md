...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=contact/searchPhone/formattedNumber,contact/contactAssociate/credentialDisplayValue,associate/otherGroups,documentUdef/SuperOffice:5,documentUdef/SuperOffice:8
