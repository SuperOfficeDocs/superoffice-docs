...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=userGroup,person/personMobilePhone/formattedNumber,person/isMailingRecipient,person/hasStoreConsent,person/withdrawnStoreConsent
