...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/restrictionAddress/zip,person/personExtra/y_rental/x_amount,contact/restrictionAddress/wgs84longitude,contact/contactAssociate/simultaneousEjUser,project/projectAssociate/associateDbId
