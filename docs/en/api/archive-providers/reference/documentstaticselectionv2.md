...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=getNoRows,person/personDeletedDate,person/personUdef/SuperOffice:6,person/personAssociate/role,project/projectAssociate/assocName
