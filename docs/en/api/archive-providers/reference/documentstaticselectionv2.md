...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=contactId,person/isProjectMember,contact/contactAssociate/usergroup,project/projectEvent/isExternalEvent,sale/saleUdef/SuperOffice:4
