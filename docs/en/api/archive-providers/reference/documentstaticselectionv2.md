...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=person/birthDay,person/supportLanguage,person/consentSourceEmarketing,contact/postAddress/wgs84longitude,contact/contactAssociate/ejUserId
