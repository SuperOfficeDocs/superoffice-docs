...
```http!
GET /api/v1/archive/DocumentStaticSelectionV2?$select=contact/LastCompletedActivity,project/projectAssociate/lastName,project/projectAssociate/personEmail,associate/usergroup
