...
```http!
GET /api/v1/archive/FreetextDocument?$select=contact/restrictionAddress/wgs84longitude,contact/contactAssociate/usergroup,associate/contactId,sale/updatedDate,sale/registeredByFullName
