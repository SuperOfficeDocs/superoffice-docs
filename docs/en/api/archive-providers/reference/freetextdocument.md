...
```http!
GET /api/v1/archive/FreetextDocument?$select=snum,person/personAddress/city,person/personAssociate/simultaneousEjUser,person/personAssociate/credentialType,contact/phone/formattedNumber
