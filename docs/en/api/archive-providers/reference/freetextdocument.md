...
```http!
GET /api/v1/archive/FreetextDocument?$select=updatedBy,visibleFor,person/searchPhone/formattedNumber,person/personInfo/infoText,contact/postAddress/formattedMultiLineAddress
