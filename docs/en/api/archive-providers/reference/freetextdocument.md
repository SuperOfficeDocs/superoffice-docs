...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/isStakeholder,person/personUdef/SuperOffice:8,person/personExtra/y_car/id,person/personAssociate/ejUserId,project/projectAssociate/mrMrs
