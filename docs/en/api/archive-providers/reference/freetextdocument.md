...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/birthMonth,person/personRegisteredBy,person/personAssociate/personEmail,contact/contactAssociate/assocType
