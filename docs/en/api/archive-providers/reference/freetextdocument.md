...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/personAddress/line2,person/personExtra/x_person_time,project/projectAssociate/mrMrs,sale/stalledComment
