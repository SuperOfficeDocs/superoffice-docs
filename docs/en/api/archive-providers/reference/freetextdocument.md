...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/birthdate,person/personDirectPhone/formattedNumber,person/personAddress/line3,contact/contactExtra/x_contact_contact,associate/middleName
