...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/email/emailDescription,contact/business,contact/contactFax/description,contact/postAddress/formattedAddress,contact/contactAssociate/isLocation
