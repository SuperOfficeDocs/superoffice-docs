...
```http!
GET /api/v1/archive/FreetextDocument?$select=searchwords,person/email/emailProtocol,person/personExtra/y_car/id,person/personAssociate/associateDbId,person/correspondingAssociate/assocName
