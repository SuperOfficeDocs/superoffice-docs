...
```http!
GET /api/v1/archive/FreetextDocument?$select=registeredBy,person/personAssociateId,contact/streetAddress/wgs84longitude,project/projectUdef/SuperOffice:10
