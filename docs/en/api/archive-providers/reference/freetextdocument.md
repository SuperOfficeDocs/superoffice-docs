...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/personAssociate/assocTooltip,person/correspondingAssociate/contactFullName,contact/url/URLDescription
