...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/personAddress/wgs84latitude,contact/hasInfoText,contact/contactAssociate/credentialDisplayValue,contact/saintActivityType,sale/amount
