...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/restrictionAddress/county,project/projectPublish/isPublished,project/saintTicketCategory,associate/credentialDisplayValue
