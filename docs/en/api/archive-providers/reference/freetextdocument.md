...
```http!
GET /api/v1/archive/FreetextDocument?$select=person/correspondingAssociate/assocName,contact/nameDepartment,contact/phone/formattedNumber,contact/contactAssociate/usergroup,sale/recordType
