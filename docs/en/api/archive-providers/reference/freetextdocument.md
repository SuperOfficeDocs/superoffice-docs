...
```http!
GET /api/v1/archive/FreetextDocument?$select=suggestedDocumentId,person/middleName,contact/email/emailId,contact/streetAddress/addressId,contact/contactUdef/SuperOffice:1
