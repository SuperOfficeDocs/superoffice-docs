...
```http!
GET /api/v1/archive/FreetextDocument?$select=associateId,person/personInfo/textId,person/personAssociate/contactId,person/personAssociate/otherGroups,project/hasInfoText
