...
```http!
GET /api/v1/archive/FreetextDocument?$select=documentPublish/isPublished,person/personRegisteredDate,person/personAssociate/contactId,person/personAssociate/contactFullName,person/correspondingAssociate/fullName
