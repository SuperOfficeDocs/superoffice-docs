...
```http!
GET /api/v1/archive/FreetextDocument?$select=contact/contactAssociate/title,contact/contactUdef/SuperOffice:4,contact/contactExtra/x_contact_contact,contact/LastSale,project/projectPublish/isPublished
