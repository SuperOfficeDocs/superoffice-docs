...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=documentInstance/keywords,documentInstance/contact/saintActivityType,documentInstance/person/correspondingAssociate/personId
