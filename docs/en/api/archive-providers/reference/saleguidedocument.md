...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=documentInstance/who,documentInstance/person/correspondingAssociate/contactId,documentInstance/contact/restrictionAddress/wgs84longitude
