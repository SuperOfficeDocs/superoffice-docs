...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=documentInstance/person/correspondingAssociate/otherGroups,documentInstance/contact/postAddress/zip,documentInstance/contact/SaintStatus2
