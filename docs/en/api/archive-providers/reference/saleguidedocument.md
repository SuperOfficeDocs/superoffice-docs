...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=stageName,documentInstance/date,documentInstance/person/middleName,documentInstance/person/isProjectMember,documentInstance/person/phone/formattedNumber
