...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=documentInstance/contact/contactPhone/description,documentInstance/contact/contactExtra/x_contact_request_relation,documentInstance/associate/ejStatus
