...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=documentInstance/person/personExtra/y_rental/x_amount,documentInstance/contact/name,documentInstance/associate/assocName,documentInstance/sale/personId
