...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=instanceItemId,instanceItemText,documentInstance/type,documentInstance/who,documentInstance/person/personInterestIds
