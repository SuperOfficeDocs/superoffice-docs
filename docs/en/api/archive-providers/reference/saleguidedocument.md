...
```http!
GET /api/v1/archive/SaleGuideDocument?$select=documentInstance/person/email/emailHasBounced,documentInstance/person/correspondingAssociate/simultaneousEjUser,documentInstance/associate/isActive
