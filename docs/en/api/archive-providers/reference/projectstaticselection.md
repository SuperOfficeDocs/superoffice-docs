...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=registeredBy,sale/saleNumber,sale/associate/lastName,sale/associate/associateDbId,sale/associate/contactName
