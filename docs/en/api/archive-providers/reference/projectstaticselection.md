...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=LastCompletedSale,sale/saleId,sale/associate/contactFullName,appointment/updatedBy,projectMember/personExtra/x_person_user_relation
