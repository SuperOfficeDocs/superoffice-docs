...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=number,projectPublish/publishedTo,projectUrl/URLAddress,appointment/appointmentPublish/isPublished,document/document/textId
