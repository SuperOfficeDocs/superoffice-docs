...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/contactCategory,LastDoBySale,document/subject,projectMember/personUdef/SuperOffice:10
