...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=NumberOfSales,sale/associate/isLocation,appointment/who,projectMember/mrMrs,projectMember/supportLanguage
