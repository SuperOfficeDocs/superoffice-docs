...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=sale/competitor,sale/associate/otherGroups,appointment/associate/lastName,appointment/associate/usergroupId,document/mailMergeDraft
