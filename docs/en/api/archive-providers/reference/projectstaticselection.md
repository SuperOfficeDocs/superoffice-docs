...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/personEmail,NumberOfNotCompletedSalesInPeriod,sale/text,document/associate/assocName,projectMember/personAddress/wgs84latitude
