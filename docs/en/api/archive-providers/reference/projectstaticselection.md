...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=status,statusRank,appointment/recordType,document/associate/usergroup,projectMember/personDeletedDate
