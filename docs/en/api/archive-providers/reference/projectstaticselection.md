...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/otherGroups,projectUdef/SuperOffice:10,sale/associate/fullName,appointment/updatedByFullName,projectMember/mrMrs
