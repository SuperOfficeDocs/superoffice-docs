...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/ejStatus,sale/text,appointment/associate/contactDepartment,appointment/associate/personEmail,document/saleId
