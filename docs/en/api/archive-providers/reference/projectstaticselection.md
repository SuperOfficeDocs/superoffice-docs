...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=appointment/appointmentUdef/SuperOffice:2,appointment/associate/portraitThumbnail,projectMember/personExtra/x_person_time,projectMember/streetAddress/wgs84latitude
