...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/title,projectAssociate/role,document/documentId,document/associate/assocType,projectMember/leadstatusRank
