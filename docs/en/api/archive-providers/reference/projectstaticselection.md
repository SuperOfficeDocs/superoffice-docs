...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=updatedBy,projectUrl/URLAddress,NumberOfNotCompletedSalesInPeriod,appointment/associate/associateDbId,document/updatedDate
