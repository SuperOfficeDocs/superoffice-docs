...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=appointment/registeredBy,appointment/endDate,document/saleId,projectMember/personUdef/SuperOffice:3,projectMember/contactUdef/SuperOffice:2
