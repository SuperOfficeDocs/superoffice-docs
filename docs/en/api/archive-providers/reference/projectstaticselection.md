...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=NumberOfActivities,appointment/location,appointment/associate/role,document/documentPublish/publishedBy,projectMember/personCategoryRank
