...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=sale/registeredDate,sale/sale/description,appointment/associate/personId,document/documentId,document/associate/isActive
