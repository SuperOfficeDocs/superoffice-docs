...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=sale/recordType,sale/saleUdef/SuperOffice:4,appointment/appointmentUdef/SuperOffice:2,document/ourref,document/documentPublish/publishedTo
