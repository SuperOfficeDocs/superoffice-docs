...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=sale/type,appointment/saleId,document/associate/firstName,projectMember/personDirectPhone/description,projectMember/hasStoreConsent
