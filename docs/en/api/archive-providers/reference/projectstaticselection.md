...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectMember/registeredDate,projectMember/contactDeleted,projectMember/contactExtra/x_contact_request_relation
