...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=LastActivity,sale/originalStage,sale/saleType,document/documentPublish/publishedTo,projectMember/personCountryId
