...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectUdef/SuperOffice:6,sale/associate/personId,sale/associate/usergroup,appointment/registeredDate,document/attention
