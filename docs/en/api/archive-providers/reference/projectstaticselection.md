...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/credentialType,appointment/associate/isActive,document/associate/title,projectMember/contactAssociate/ejStatus
