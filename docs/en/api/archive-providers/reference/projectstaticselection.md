...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=updatedByFullName,sale/stageRank,appointment/projectId,appointment/endTime,appointment/associate/usergroupId
