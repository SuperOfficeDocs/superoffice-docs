...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectEvent/isExternalEvent,appointment/associate/personId,projectMember/personAssociate/portraitThumbnail
