...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=appointment/appointmentUdef/SuperOffice:2,projectMember/searchPhone/description,projectMember/hasStoreConsent,projectMember/updatedDate
