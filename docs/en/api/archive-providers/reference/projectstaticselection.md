...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=hasInfoText,appointment/endTime,appointment/associate/portraitThumbnail,document/updatedByFullName,document/documentUdef/SuperOffice:6
