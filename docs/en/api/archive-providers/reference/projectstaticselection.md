...
```http!
GET /api/v1/archive/ProjectStaticSelection?$select=projectAssociate/credentialDisplayValue,appointment/appointmentUdef/SuperOffice:8,document/associate/title,document/associate/credentialDisplayValue
