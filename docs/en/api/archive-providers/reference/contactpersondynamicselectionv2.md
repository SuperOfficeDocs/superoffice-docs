...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=LastCompletedActivity,targetRelation/contactId,sale/hasGuide,document/who,document/updatedBy
