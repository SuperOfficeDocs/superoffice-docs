...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=sale/originalStage,sale/daysInStage,document/keywords,kanaFirstName,personEmail/emailDescription
