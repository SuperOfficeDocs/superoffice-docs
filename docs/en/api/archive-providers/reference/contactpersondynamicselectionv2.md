...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=contactUdef/SuperOffice:4,LastCompletedTicket,sale/currencyId,appointment/associate/lastName,request/createdAt
