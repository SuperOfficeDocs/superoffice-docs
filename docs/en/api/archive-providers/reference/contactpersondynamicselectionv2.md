...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=getAllRows,postAddress/wgs84latitude,sale/visibleFor,document/attention,document/associate/assocTooltip
