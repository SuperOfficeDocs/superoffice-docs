...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=contactUdef/SuperOffice:10,sourceRelation/department,sourceRelation/contactNoMail,sale/updatedDate,appointment/createdByWorkflow
