...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=contactPhone/formattedNumber,sourceRelation/code,sourceRelation/registeredByFullName,targetRelation/business,targetRelation/stop
