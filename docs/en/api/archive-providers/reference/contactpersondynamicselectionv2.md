...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=hasInfoText,contactUdef/SuperOffice:7,targetRelation/hasInfoText,sourceRelation/contactPersonRelation,sale/type
