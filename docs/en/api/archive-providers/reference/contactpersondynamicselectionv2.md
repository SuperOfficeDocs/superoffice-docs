...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=restrictionAddress/line3,contactUdef/SuperOffice:9,sourceRelation/mainContact,targetRelation/contactDeleted,sale/associate/isLocation
