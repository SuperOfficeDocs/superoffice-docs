...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=email/emailAddress,email/emailHasBounced,appointment/associate/contactFullName,appointment/associate/assocName,appointment/appointment/textId
