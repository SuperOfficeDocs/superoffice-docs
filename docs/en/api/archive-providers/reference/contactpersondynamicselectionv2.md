...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=contactAssociate/simultaneousEjUser,contactUdef/SuperOffice:7,sale/currency,appointment/appointmentUdef/SuperOffice:2,appointment/associate/ejUserId
