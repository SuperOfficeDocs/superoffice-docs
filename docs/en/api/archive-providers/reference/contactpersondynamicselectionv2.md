...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=registeredDate,contactAssociate/firstName,sourceRelation/countryId,sale/associate/contactFullName,sale/associate/role
