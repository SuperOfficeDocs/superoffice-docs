...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=sale/icon,sale/hasStakeholders,appointment/isFree,useAsMailingAddress,personRegisteredByFullName
