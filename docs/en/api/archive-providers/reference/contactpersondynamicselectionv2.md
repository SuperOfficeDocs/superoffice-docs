...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=postAddress/formattedMultiLineAddress,NumberOfNotCompletedSalesInPeriod,sourceRelation/updatedDate,sourceRelation/contactSource,sourceRelation/contactDeleted
