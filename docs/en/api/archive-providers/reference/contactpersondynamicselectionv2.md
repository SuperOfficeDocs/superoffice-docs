...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=email/emailBounceCount,sale/associate/credentialDisplayValue,appointment/visibleFor,appointment/associate/assocType,document/associate/assocType
