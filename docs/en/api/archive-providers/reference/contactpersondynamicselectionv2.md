...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=contactAssociate/isLocation,document/yourref,document/subject,document/associate/locationAddress,personUpdatedDate
