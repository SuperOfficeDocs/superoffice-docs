...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=deletedDate,contactExtra/x_contact_shorttext,NumberOfNotCompletedTickets,sale/associate/credentialDisplayValue,appointment/type
