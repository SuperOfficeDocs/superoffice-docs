...
```http!
GET /api/v1/archive/ContactPersonDynamicSelectionV2?$select=contactDeleted,contactFax/description,contactUdef/SuperOffice:13,NumberOfNotCompletedActivitiesInPeriod,SaintStatus1
