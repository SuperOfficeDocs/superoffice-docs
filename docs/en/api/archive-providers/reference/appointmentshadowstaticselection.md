...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/searchPhone/formattedNumber,person/withdrawnStoreConsent,project/projectUdef/SuperOffice:6
