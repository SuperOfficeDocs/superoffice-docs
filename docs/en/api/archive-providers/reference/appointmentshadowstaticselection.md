...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/updatedDate,contact/contactAssociate/contactDepartment,contact/contactUdef/SuperOffice:5,contact/LastSale,person/lastName
