...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=icon,contact/restrictionAddress/state,contact/contactUdef/SuperOffice:7,contact/NumberOfSales,project/projectAssociate/isActive
