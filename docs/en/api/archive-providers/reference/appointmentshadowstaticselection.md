...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/companyCategoryRank,contact/updatedBy,person/personCountryId,person/personRegisteredByFullName,person/updatedByWorkflow
