...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/email/emailLastBounce,contact/contactExtra/x_contact_date,project/hasInfoText,project/projectAssociate/credentialType,sale/updatedBy
