...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/streetAddress/wgs84latitude,contact/contactUdef/SuperOffice:1,contact/LastCompletedSale,person/personRegisteredBy,person/personExtra/x_person_integer
