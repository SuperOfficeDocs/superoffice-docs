...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/email/emailAddress,contact/email/emailId,contact/contactAssociate/personId,person/personDirectFax/description,person/correspondingAssociate/assocType
