...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/postAddress/line1,contact/contactUdef/SuperOffice:9,contact/NumberOfActivitiesInPeriod,sale/associate/contactId,associate/title
