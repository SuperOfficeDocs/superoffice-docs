...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=person/personCategoryGroup,person/personExtra/y_rental/y_equipment/x_name,person/correspondingAssociate/usergroupId,project/registeredBy,sale/saleUdef/SuperOffice:8
