...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/category,contact/email/emailLastBounce,contact/email/emailHasBounced,contact/restrictionAddress/addressId,contact/contactUdef/SuperOffice:11
