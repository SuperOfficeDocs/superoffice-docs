...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=recordType,contact/mainContact,contact/restrictionAddress/wgs84latitude,contact/contactExtra/x_contact_short_dropdown,person/position
