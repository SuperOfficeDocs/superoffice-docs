...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/contactPhone/description,contact/streetAddress/addressId,contact/contactAssociate/role,person/personNoMail,person/personUpdatedBy
