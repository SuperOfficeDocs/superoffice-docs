...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=type,appointmentPublish/isPublished,contact/updatedBy,contact/contactAssociate/assocName,contact/contactAssociate/ejUserId
