...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=recordType,contact/LastCompletedActivity,person/birthDay,person/personExtra/x_person_integer,appointmentUdef/SuperOffice:4
