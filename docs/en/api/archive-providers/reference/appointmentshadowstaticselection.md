...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=person/personAddress/line3,person/personAssociate/fullName,person/correspondingAssociate/associateDbId,sale/text,associate/assocType
