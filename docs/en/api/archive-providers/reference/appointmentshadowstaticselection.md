...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/email/emailBounceCount,contact/postAddress/line3,contact/postAddress/formattedAddress,person/personRegisteredBy,person/email/emailAddress
