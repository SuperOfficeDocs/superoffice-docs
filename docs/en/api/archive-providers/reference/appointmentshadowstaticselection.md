...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=registeredDate,alarm,contact/contactAssociate/fullName,contact/contactAssociate/otherGroups,person/personAssociate/associateDbId
