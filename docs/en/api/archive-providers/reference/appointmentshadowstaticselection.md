...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/streetAddress/wgs84latitude,contact/contactAssociate/title,person/personCountryId,person/isProjectMember,person/personAddress/line3
