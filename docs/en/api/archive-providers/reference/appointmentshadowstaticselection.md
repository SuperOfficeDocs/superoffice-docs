...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=isFree,intention,person/personUpdatedByFullName,person/personUrl/URLAddress,person/restrictionAddress/formattedAddress
