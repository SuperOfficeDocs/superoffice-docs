...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=endTime,contact/email/emailLastSent,contact/contactAssociate/firstName,sale/personId,sale/registeredByFullName
