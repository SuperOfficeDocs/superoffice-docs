...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/contactPhone/description,contact/postAddress/line1,project/projectUdef/SuperOffice:8,project/LastDoBySale,targetRecordId
