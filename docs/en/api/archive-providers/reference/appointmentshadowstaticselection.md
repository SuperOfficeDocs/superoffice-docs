...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/contactFax/formattedNumber,contact/LastSale,person/personRegisteredBy,person/restrictionAddress/state,person/personAssociate/mrMrs
