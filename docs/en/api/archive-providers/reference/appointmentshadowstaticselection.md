...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=contact/postAddress/city,contact/postAddress/zip,contact/LastCompletedTicket,project/endDate,project/projectPublish/publishedBy
