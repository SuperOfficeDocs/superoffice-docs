...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=rawStatus,contact/contactAssociate/mrMrs,person/personAddress/wgs84latitude,person/personUdef/SuperOffice:11,sale/userGroup
