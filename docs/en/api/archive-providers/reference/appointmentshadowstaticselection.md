...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=appointmentPublish/publishedTo,contact/nameDepartment,contact/contactExtra/y_organization/x_name,person/personAssociateId,person/correspondingAssociate/credentialDisplayValue
