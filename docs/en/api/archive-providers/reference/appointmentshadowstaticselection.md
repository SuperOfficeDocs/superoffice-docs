...
```http!
GET /api/v1/archive/AppointmentShadowStaticSelection?$select=getNoRows,contact/contactPhone/formattedNumber,contact/postAddress/county,contact/streetAddress/county,person/personHasInterests
