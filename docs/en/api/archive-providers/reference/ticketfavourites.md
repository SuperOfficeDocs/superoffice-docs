...
```http!
GET /api/v1/archive/ticketfavourites?$select=ownedBy/contactDepartment,contact/contactExtra/x_contact_contact_relation,project/projectUdef/SuperOffice:8
