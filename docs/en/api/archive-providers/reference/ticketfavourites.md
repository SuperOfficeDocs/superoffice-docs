...
```http!
GET /api/v1/archive/ticketfavourites?$select=createdBy/ejUserId,person/personHasInterests,person/personExtra/x_person_date,person/personExtra/y_rental/id,contact/contactId
