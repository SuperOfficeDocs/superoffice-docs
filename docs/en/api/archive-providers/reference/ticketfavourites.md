...
```http!
GET /api/v1/archive/ticketfavourites?$select=person/mrMrs,person/searchPhone/formattedNumber,contact/postAddress/formattedMultiLineAddress,contact/contactAssociate/assocType,extra/x_ticket_float
