...
```http!
GET /api/v1/archive/ticketfavourites?$select=createdBy/contactDepartment,person/hasStoreConsent,person/legalBaseStore,sale/salePublish/publishedTo,project/projectEvent/hasSignOff
