...
```http!
GET /api/v1/archive/ticketfavourites?$select=favouriteAssociateId,createdBy/personId,person/position,person/personAssociate/contactFullName,person/correspondingAssociate/fullName
