...
```http!
GET /api/v1/archive/ticketfavourites?$select=ownedBy/contactFullName,person/personExtra/x_person_appointment_relation,contact/contactUdef/SuperOffice:7,sale/type,project/projectAssociate/userName
