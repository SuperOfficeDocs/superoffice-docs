...
```http!
GET /api/v1/archive/ticketfavourites?$select=timeSpentExternally,person/supportAssociateFullName,contact/contactPhone/description,contact/restrictionAddress/zip,project/projectAssociate/personEmail
