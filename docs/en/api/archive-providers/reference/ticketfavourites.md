...
```http!
GET /api/v1/archive/ticketfavourites?$select=createdBy/personId,createdBy/ejStatus,person/email/emailDescription,person/personExtra/x_person_priority_relation,person/consentSourceStore
