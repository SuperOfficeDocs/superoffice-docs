...
```http!
GET /api/v1/archive/ProjectSelection?$select=hasGuide,projectAssociate/middleName,projectAssociate/contactId,sale/saleUdef/SuperOffice:4,projectMember/personRegisteredBy
