...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectAssociate/contactDepartment,NumberOfActivities,sale/saleUdef/SuperOffice:3,appointment/recordType,document/completed
