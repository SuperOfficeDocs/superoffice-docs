...
```http!
GET /api/v1/archive/ProjectSelection?$select=number,projectAssociate/assocTooltip,NumberOfNotCompletedSalesInPeriod,projectMember/personAssociate/ejStatus,projectMember/correspondingAssociate/title
