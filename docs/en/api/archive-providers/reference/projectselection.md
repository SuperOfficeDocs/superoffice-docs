...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectAssociate/otherGroups,LastCompletedSale,sale/associate/contactName,document/associate/personEmail,projectMember/restrictionAddress/line2
