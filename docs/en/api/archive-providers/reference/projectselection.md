...
```http!
GET /api/v1/archive/ProjectSelection?$select=saintIntention,sale/associate/personEmail,document/registeredDate,document/associate/credentialType,projectMember/personCategoryRank
