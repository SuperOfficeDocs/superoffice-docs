...
```http!
GET /api/v1/archive/ProjectSelection?$select=sale/associate/contactName,projectMember/personAssociate/contactId,appointment/appointmentUdef/SuperOffice:5
