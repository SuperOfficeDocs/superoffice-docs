...
```http!
GET /api/v1/archive/ProjectSelection?$select=document/documentPublish/publishedTo,projectMember/birthYear,projectMember/personAssociate/assocName,projectMember/contactAssociate/credentialType
