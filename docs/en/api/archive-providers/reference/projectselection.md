...
```http!
GET /api/v1/archive/ProjectSelection?$select=sale/hasGuide,projectMember/projectId,projectMember/restrictionAddress/line2,projectMember/personAssociate/title,projectMember/contactPhone/description
