...
```http!
GET /api/v1/archive/ProjectSelection?$select=sale/stage,appointment/registeredByFullName,projectMember/correspondingAssociate/contactName,projectMember/contactAssociate/isLocation,projectMember/saintTicketCategory
