...
```http!
GET /api/v1/archive/ProjectSelection?$select=sale/associate/fullName,sale/associate/contactDepartment,document/associate/ejUserId,document/associate/portraitThumbnail,projectMember/textId
