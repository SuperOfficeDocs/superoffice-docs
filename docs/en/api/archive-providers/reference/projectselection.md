...
```http!
GET /api/v1/archive/ProjectSelection?$select=sale/originalStage,sale/saleNumber,appointment/registeredDate,document/documentPublish/isPublished,projectMember/contactId
