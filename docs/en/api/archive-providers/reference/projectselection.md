...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectAssociate/contactName,sale/saleUdef/SuperOffice:1,appointment/associate/locationAddress,document/visibleFor,document/associate/contactDepartment
