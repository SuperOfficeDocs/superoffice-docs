...
```http!
GET /api/v1/archive/ProjectSelection?$select=associateId,description,projectAssociate/contactId,projectMember/hasInfoText,projectMember/personAddress/wgs84latitude
