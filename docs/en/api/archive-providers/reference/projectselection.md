...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectId,appointment/associate/title,appointment/associate/credentialDisplayValue,document/associate/credentialDisplayValue,projectMember/personAddress/zip
