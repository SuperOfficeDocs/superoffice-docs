...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectUdef/SuperOffice:7,sale/associateId,sale/visibleFor,appointment/associate/credentialDisplayValue,projectMember/contactExtra/x_contact_time
