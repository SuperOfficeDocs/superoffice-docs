...
```http!
GET /api/v1/archive/ProjectSelection?$select=appointment/associate/otherGroups,document/mailMergeDraft,document/documentUdef/SuperOffice:6,projectMember/isProjectMember
