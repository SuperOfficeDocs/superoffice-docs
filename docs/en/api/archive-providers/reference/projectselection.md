...
```http!
GET /api/v1/archive/ProjectSelection?$select=appointment/personId,appointment/appointmentId,document/documentId,document/visibleFor,document/associate/contactDepartment
