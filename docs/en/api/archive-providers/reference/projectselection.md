...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectPublish/publishedTo,saintActivityType,projectMember/correspondingAssociate/credentialDisplayValue,projectMember/business,projectMember/country
