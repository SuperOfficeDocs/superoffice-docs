...
```http!
GET /api/v1/archive/ProjectSelection?$select=registeredDate,projectPublish/isPublished,sale/associate/simultaneousEjUser,sale/saleUdef/SuperOffice:8,projectMember/kanaLastName
