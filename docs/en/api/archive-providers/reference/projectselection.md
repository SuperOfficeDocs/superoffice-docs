...
```http!
GET /api/v1/archive/ProjectSelection?$select=LastSale,saintAmountClass,appointment/associate/portraitThumbnail,projectMember/personAddress/line3,projectMember/contactAssociate/middleName
