...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectUrl/URLDescription,document/associate/ejStatus,projectMember/personDirectFax/description,projectMember/correspondingAssociate/firstName
