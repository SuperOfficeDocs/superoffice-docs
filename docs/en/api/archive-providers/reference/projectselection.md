...
```http!
GET /api/v1/archive/ProjectSelection?$select=projectAssociate/firstName,appointment/recordType,appointment/associate/isActive,appointment/associate/userName,projectMember/personAssociate/assocTooltip
