...
```http!
GET /api/v1/archive/ProjectSelection?$select=saintAmountClass,sale/saleId,sale/originalStage,appointment/associate/title,document/associate/associateDbId
