...
```http!
GET /api/v1/archive/Sale?$select=person/personAddress/wgs84latitude,person/personExtra/x_person_float,person/personAssociate/usergroupId,project/status,project/description
