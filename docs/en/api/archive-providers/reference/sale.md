...
```http!
GET /api/v1/archive/Sale?$select=person/personHasInterests,person/restrictionAddress/wgs84latitude,contact/saintAmountClass,project/imageThumbnail,saleStakeholder/person/personAssociate/title
