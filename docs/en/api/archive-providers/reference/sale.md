...
```http!
GET /api/v1/archive/Sale?$select=person/lastName,person/personPrivate/description,person/personExtra/y_rental/y_equipment/x_name,person/correspondingAssociate/associateDbId,contact/updatedDate
