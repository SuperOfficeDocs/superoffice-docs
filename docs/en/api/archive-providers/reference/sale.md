...
```http!
GET /api/v1/archive/Sale?$select=person/personNumber,person/personRegisteredBy,person/personAddress/state,person/restrictionAddress/line3,person/personAssociate/isActiveText
