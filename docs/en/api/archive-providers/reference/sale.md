...
```http!
GET /api/v1/archive/Sale?$select=sale/textId,person/personAssociate/mrMrs,contact/restrictionAddress/zip,contact/LastCompletedTicket,project/registeredByFullName
