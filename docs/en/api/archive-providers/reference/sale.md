...
```http!
GET /api/v1/archive/Sale?$select=hasStakeholders,person/phone/formattedNumber,person/restrictionAddress/zip,person/personAssociate/credentialType,contact/contactPhone/description
