...
```http!
GET /api/v1/archive/Sale?$select=amountWeightedInBaseCurrency,person/withdrawnStoreConsent,contact/contactAssociate/contactFullName,contact/contactUdef/SuperOffice:5,project/projectAssociate/personId
