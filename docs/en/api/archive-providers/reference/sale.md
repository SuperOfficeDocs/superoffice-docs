...
```http!
GET /api/v1/archive/Sale?$select=person/personAddress/line3,person/personAssociate/credentialDisplayValue,contact/code,contact/email/emailDescription,contact/postAddress/county
