...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.SaleProvider">SuperOffice.CRM.ArchiveLists.SaleProvider</see> inside NetServer's SODatabase assembly.

Archive provider for Sale type activities. This provider can be used on its own, or can form part of the
...
```http!
GET /api/v1/archive/Sale?$select=person/personAssociate/contactFullName,saleStakeholder/person/supportAssociateFullName,saleStakeholder/person/personPrivate/formattedNumber,saleStakeholder/person/email/emailLastBounce,saleStakeholder/person/personExtra/y_rental/y_equipment/x_name
