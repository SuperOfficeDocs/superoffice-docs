...
```http!
GET /api/v1/archive/Sale?$select=person/restrictionAddress/line1,person/personExtra/x_person_contact_relation,person/correspondingAssociate/mrMrs,person/correspondingAssociate/ejDisplayName,contact/postAddress/state
