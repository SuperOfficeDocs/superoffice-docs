...
```http!
GET /api/v1/archive/Sale?$select=person/personNumber,person/correspondingAssociate/assocType,contact/nameDepartment,contact/contactUdef/SuperOffice:2,contact/contactUdef/SuperOffice:3
