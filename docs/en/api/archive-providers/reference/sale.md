...
```http!
GET /api/v1/archive/Sale?$select=person/personUdef/SuperOffice:10,person/correspondingAssociate/contactDepartment,contact/restrictionAddress/zip,associate/credentialType,associate/personEmail
