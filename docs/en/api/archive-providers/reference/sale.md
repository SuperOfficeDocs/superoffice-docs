...
```http!
GET /api/v1/archive/Sale?$select=sale/description,person/kanaFirstName,contact/restrictionAddress/formattedMultiLineAddress,contact/contactAssociate/title,contact/NumberOfNotCompletedActivitiesInPeriod
