...
```http!
GET /api/v1/archive/Sale?$select=person/restrictionAddress/line1,person/correspondingAssociate/ejDisplayName,contact/contactId,contact/number,contact/contactUdef/SuperOffice:13
