...
```http!
GET /api/v1/archive/Sale?$select=person/personUpdatedBy,person/personAddress/wgs84latitude,person/personUdef/SuperOffice:3,person/personAssociate/ejStatus,contact/contactNoMail
