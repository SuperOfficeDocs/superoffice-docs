...
```http!
GET /api/v1/archive/Sale?$select=saleNumber,person/birthYear,person/personUpdatedByFullName,person/restrictionAddress/county,contact/email/emailLastSent
