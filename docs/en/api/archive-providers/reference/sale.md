...
```http!
GET /api/v1/archive/Sale?$select=person/title,person/createdByForm,contact/postAddress/county,associate/credentialDisplayValue,project/projectAssociate/simultaneousEjUser
