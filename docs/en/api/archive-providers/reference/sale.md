...
```http!
GET /api/v1/archive/Sale?$select=amount,person/personAddress/county,person/correspondingAssociate/assocName,contact/searchPhone/formattedNumber,contact/contactUdef/SuperOffice:13
