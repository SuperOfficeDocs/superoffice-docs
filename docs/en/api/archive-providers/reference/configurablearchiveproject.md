...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=appointment/text,appointment/rawType,document/ourref,projectMember/correspondingAssociate/credentialDisplayValue
