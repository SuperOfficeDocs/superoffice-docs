...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=sale/updatedBy,sale/sale/description,document/saleId,document/subject,projectMember/personExtra/x_person_request_relation
