...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=appointment/endTime,appointment/associate/associateDbId,appointment/associate/assocType,document/associate/assocTooltip,document/associate/locationAddress
