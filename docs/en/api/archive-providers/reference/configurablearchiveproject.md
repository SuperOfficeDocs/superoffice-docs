...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=NumberOfActivitiesInPeriod,sale/associate/assocName,appointment/registeredDate,document/associate/fullName,projectMember/personBusiness
