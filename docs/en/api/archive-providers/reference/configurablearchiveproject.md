...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectUdef/SuperOffice:5,projectUdef/SuperOffice:10,sale/activeErpLinks,appointment/associate/title,document/isReport
