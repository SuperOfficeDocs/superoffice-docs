...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=sale/recordType,sale/currency,sale/associate/isLocation,appointment/completedDate,appointment/associate/usergroup
