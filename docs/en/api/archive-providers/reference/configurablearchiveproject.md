...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=sale/saleUdef/SuperOffice:8,appointment/associate/mrMrs,document/associate/mrMrs,projectMember/hasInfoText,projectMember/fullName
