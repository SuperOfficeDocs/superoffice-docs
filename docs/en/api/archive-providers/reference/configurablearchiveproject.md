...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectAssociate/isActive,sale/hasGuide,appointment/alarm,appointment/appointmentUdef/SuperOffice:7,document/attention
