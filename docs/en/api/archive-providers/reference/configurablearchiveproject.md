...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=activeErpLinks,projectAssociate/contactDepartment,sale/associate/contactName,sale/associate/ejDisplayName,document/documentId
