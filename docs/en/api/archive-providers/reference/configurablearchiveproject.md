...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectMember/personAddress/formattedMultiLineAddress,projectMember/restrictionAddress/addressId,projectMember/contactExtra/x_contact_longtext
