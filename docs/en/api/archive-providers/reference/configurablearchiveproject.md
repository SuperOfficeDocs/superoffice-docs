...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectAssociate/mrMrs,saintAmountClass,sale/saleStatus,sale/hasStakeholders,projectMember/personInterestIds
