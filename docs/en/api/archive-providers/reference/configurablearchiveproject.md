...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=NumberOfNotCompletedActivities,sale/contactId,sale/registeredByFullName,sale/saleUdef/SuperOffice:8,appointment/associate/contactFullName
