...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=document/associate/isActive,document/document/description,projectMember/hasInfoText,projectMember/personAssociate/portraitThumbnail,projectMember/correspondingAssociate/assocType
