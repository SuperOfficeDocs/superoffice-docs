...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=sale/saleNumber,sale/saleUdef/SuperOffice:8,appointment/priority,appointment/isMilestone,appointment/associate/personEmail
