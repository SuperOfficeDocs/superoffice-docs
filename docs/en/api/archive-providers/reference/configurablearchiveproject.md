...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=updatedByFullName,sale/hasQuote,appointment/associate/ejStatus,document/associate/mrMrs,document/document/description
