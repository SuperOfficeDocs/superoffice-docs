...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectAssociate/personId,projectAssociate/isActive,projectUdef/SuperOffice:7,sale/daysInStage,sale/associate/firstName
