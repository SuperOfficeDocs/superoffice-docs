...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectUdef/SuperOffice:7,sale/type,sale/stageRank,sale/associate/usergroup,appointment/associate/firstName
