...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectAssociate/lastName,appointment/appointmentPublish/isPublished,projectMember/personNoMail,projectMember/restrictionAddress/wgs84longitude,projectMember/personExtra/x_person_integer
