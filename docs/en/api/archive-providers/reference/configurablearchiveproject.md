...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=getAllRows,projectAssociate/lastName,appointment/associate/isLocation,projectMember/personAssociate/credentialType
