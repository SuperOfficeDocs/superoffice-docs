...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=appointment/appointment/textId,document/associate/contactId,projectMember/mrMrs,projectMember/personAddress/line2,projectMember/consentSourceStore
