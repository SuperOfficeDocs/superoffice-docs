...
```http!
GET /api/v1/archive/ConfigurableArchiveProject?$select=projectMember/middleName,projectMember/personInterestIds,projectMember/correspondingAssociate/assocName,projectMember/contactFax/description,projectMember/contactAssociate/isLocation
