...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=type,who,contact/contactAssociate/usergroup,person/personCategory,person/personAssociate/simultaneousEjUser
