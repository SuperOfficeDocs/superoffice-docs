...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/contactPhone/description,contact/email/emailAddress,person/personId,person/email/emailAddress,person/personExtra/x_person_category_relation
