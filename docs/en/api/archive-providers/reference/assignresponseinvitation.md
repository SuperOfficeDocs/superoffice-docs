...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=visibleFor,contact/NumberOfActivities,person/firstName,person/birthMonth,person/restrictionAddress/formattedAddress
