...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=rawType,contact/SaintStatus2,person/hasInterests,project/statusRank,project/NumberOfNotCompletedSales
