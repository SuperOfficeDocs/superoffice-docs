...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=person/personHasInterests,person/consentSourceEmarketing,associate/fullName,associate/role,associate/portraitThumbnail
