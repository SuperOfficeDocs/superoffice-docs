...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=visibleFor,contact/saintTicketStatus,person/withdrawnEmarketingConsent,project/icon,project/registeredBy
