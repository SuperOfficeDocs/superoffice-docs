...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/contactAssociate/usergroupId,person/retired,person/personExtra/x_person_float,person/personAssociate/middleName,project/eventId
