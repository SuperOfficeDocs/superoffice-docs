...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=endTime,contact/saintIntention,person/personExtra/y_rental/x_start,project/status,project/updatedBy
