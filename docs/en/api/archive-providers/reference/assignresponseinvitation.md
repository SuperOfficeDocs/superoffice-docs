...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/contactAssociate/locationAddress,contact/saintTicketStatus,person/personUpdatedByFullName,person/searchPhone/formattedNumber,project/projectUrl/URLAddress
