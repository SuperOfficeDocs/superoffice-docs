...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=userGroup,contact/restrictionAddress/line3,person/isStakeholder,person/personExtra/x_person_boolean,person/personExtra/x_person_category_relation
