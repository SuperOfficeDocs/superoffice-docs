...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/activeErpLinks,contact/streetAddress/state,contact/streetAddress/formattedAddress,person/createdByForm,person/personAddress/addressId
