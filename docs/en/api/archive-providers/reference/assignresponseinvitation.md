...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/department,person/mrMrs,person/retired,person/personExtra/x_person_datetime,person/correspondingAssociate/assocType
