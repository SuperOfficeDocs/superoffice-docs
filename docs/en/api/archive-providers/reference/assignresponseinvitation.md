...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=suggestedAppointmentId,contact/updatedDate,contact/contactAssociate/contactId,contact/contactAssociate/otherGroups,person/birthMonth
