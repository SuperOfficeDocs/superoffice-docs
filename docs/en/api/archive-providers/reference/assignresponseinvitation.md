...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=associateId,invitationStatusIcon,contact/streetAddress/line1,contact/contactAssociate/usergroup,contact/contactInterestIds
