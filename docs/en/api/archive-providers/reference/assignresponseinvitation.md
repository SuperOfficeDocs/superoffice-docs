...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=contact/updatedDate,person/restrictionAddress/line3,project/description,project/projectEvent/eventDate,project/projectAssociate/personEmail
