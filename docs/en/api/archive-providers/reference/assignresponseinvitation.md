...
```http!
GET /api/v1/archive/AssignResponseInvitation?$select=person/personExtra/x_person_boolean,project/projectUdef/SuperOffice:5,project/saintSaleStatus,sale/recordType,sale/createdByWorkflow
