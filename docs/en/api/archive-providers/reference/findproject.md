...
```http!
GET /api/v1/archive/FindProject?$select=appointment/completedDate,appointment/associate/contactFullName,appointment/associate/assocType,appointment/associate/isLocation,document/ourref
