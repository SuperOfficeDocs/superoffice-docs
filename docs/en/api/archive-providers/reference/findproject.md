...
```http!
GET /api/v1/archive/FindProject?$select=projectAssociate/fullName,appointment/completed,appointment/suggestedAppointmentId,appointment/appointmentUdef/SuperOffice:8,document/completed
