...
```http!
GET /api/v1/archive/FindProject?$select=LastSale,appointment/duration,projectMember/restrictionAddress/line2,projectMember/contactExtra/x_contact_timespan,projectMember/SaintStatus1
