...
```http!
GET /api/v1/archive/FindProject?$select=text,projectAssociate/role,LastCompletedSale,sale/associate/assocName,appointment/appointmentPublish/isPublished
