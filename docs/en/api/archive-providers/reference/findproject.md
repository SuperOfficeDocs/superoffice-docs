...
```http!
GET /api/v1/archive/FindProject?$select=projectUdef/SuperOffice:6,sale/saleTypeCategory,appointment/rawType,appointment/appointmentUdef/SuperOffice:3,document/associate/contactId
