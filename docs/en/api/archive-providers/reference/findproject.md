...
```http!
GET /api/v1/archive/FindProject?$select=associateId,sale/associate/firstName,appointment/associate/contactCategory,projectMember/number,projectMember/contactAssociate/contactId
