...
```http!
GET /api/v1/archive/FindProject?$select=projectMember/contactAssociate/personEmail,projectMember/contactUdef/SuperOffice:12,projectMember/LastDoByTicket
