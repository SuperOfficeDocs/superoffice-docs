...
```http!
GET /api/v1/archive/FindProject?$select=projectUdef/SuperOffice:5,sale/associate/locationAddress,appointment/associate/lastName,document/associate/assocType,projectMember/postAddress/formattedAddress
