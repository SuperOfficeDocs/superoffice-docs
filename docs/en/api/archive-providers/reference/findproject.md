...
```http!
GET /api/v1/archive/FindProject?$select=imageThumbnail,sale/userGroup,sale/associate/lastName,appointment/isMilestone,appointment/appointment/internalNotes
