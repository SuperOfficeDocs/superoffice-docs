...
```http!
GET /api/v1/archive/FindProject?$select=projectAssociate/contactCategory,sale/amount,sale/hasStakeholders,appointment/appointmentId,appointment/associate/contactFullName
