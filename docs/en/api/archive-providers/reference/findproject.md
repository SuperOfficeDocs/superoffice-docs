...
```http!
GET /api/v1/archive/FindProject?$select=sale/stage,projectMember/retired,projectMember/personExtra/x_person_user_relation,projectMember/personAssociate/usergroupId,projectMember/personAssociate/contactCategory
