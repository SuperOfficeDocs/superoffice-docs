...
```http!
GET /api/v1/archive/FindProject?$select=document/time,projectMember/personAssociate/usergroupId,projectMember/correspondingAssociate/simultaneousEjUser,projectMember/updatedByFullName,projectMember/NumberOfTickets
