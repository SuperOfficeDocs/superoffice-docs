...
```http!
GET /api/v1/archive/SaleDiary?$select=person/personNoMail,contact/email/emailDescription,contact/url/URLAddress,project/projectEvent/hasSignOn,saleStakeholder/person/portraitThumbnail
