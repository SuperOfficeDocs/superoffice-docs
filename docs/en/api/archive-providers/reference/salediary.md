...
```http!
GET /api/v1/archive/SaleDiary?$select=stageId,salePublish/publishedFrom,person/personAssociate/usergroup,associate/contactId,saleStakeholder/person/personExtra/x_person_request_relation
