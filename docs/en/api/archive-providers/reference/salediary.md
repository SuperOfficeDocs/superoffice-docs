...
```http!
GET /api/v1/archive/SaleDiary?$select=who,person/personExtra/y_rental/id,person/correspondingAssociate/ejUserId,contact/contactUdef/SuperOffice:12,saleStakeholder/person/personPrivate/formattedNumber
