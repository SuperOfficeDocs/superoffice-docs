...
```http!
GET /api/v1/archive/SaleDiary?$select=person/personUdef/SuperOffice:1,person/personAssociate/contactId,person/hasStoreConsent,contact/contactDeleted,contact/mainContact
