...
```http!
GET /api/v1/archive/SaleDiary?$select=icon,person/personHasInterests,person/email/emailLastSent,person/personExtra/x_person_contact_relation,person/personAssociate/otherGroups
