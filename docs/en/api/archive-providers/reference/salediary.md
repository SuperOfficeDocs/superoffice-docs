...
```http!
GET /api/v1/archive/SaleDiary?$select=associateId,updatedByFullName,person/searchPhone/description,person/personAssociate/fullName,person/correspondingAssociate/personId
