...
```http!
GET /api/v1/archive/SaleDiary?$select=person/personId,saleStakeholder/person/middleName,saleStakeholder/person/restrictionAddress/city,saleStakeholder/contact/contactAssociate/associateDbId
