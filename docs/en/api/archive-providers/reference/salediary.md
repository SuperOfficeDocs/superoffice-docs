...
```http!
GET /api/v1/archive/SaleDiary?$select=person/correspondingAssociate/contactId,contact/countryId,associate/assocType,saleStakeholder/person/supportAssociateFullName
