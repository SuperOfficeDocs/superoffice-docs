...
```http!
GET /api/v1/archive/SaleDiary?$select=contact/category,associate/title,project/number,project/projectEvent/eventDate,saleStakeholder/person/whenUpdatedByWorkflow
