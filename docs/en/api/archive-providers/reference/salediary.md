...
```http!
GET /api/v1/archive/SaleDiary?$select=registeredBy,person/personMobilePhone/description,person/personAssociate/userName,person/correspondingAssociate/portraitThumbnail,contact/postAddress/zip
