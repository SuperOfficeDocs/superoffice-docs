...
```http!
GET /api/v1/archive/SaleDiary?$select=person/email/emailId,person/personAddress/line1,person/personUdef/SuperOffice:3,person/correspondingAssociate/contactId,project/projectUdef/SuperOffice:1
