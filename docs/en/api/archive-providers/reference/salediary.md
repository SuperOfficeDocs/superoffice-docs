...
```http!
GET /api/v1/archive/SaleDiary?$select=saleId,person/email/emailLastBounce,person/personUrl/URLAddress,person/personExtra/y_rental/x_amount,person/personAssociate/contactCategory
