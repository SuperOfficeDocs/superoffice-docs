...
```http!
GET /api/v1/archive/SaleDiary?$select=description,person/personUpdatedDate,person/personExtra/x_person_date,person/correspondingAssociate/role,person/subscription
