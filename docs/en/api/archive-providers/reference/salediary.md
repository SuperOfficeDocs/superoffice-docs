...
```http!
GET /api/v1/archive/SaleDiary?$select=icon,person/personMobilePhone/description,person/personUdef/SuperOffice:5,person/personAssociate/isActive,contact/streetAddress/addressId
