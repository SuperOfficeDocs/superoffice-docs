...
```http!
GET /api/v1/archive/SaleDiary?$select=visibleFor,person/personAssociate/ejDisplayName,person/correspondingAssociate/title,contact/streetAddress/state,contact/contactAssociate/contactDepartment
