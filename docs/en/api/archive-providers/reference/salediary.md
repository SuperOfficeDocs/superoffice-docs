...
```http!
GET /api/v1/archive/SaleDiary?$select=person/personAddress/state,person/personAssociate/ejUserId,project/completed,project/LastCompletedSale,saleStakeholder/person/fullName
