...
```http!
GET /api/v1/archive/SaleDiary?$select=person/personUdef/SuperOffice:9,person/personAssociate/contactCategory,contact/url/URLAddress,contact/contactAssociate/assocType,project/projectId
