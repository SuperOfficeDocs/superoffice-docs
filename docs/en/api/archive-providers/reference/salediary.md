...
```http!
GET /api/v1/archive/SaleDiary?$select=contactId,person/personPager/formattedNumber,contact/contactUdef/SuperOffice:10,contact/saintDirection,saleStakeholder/person/personUdef/SuperOffice:11
