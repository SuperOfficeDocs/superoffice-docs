...
```http!
GET /api/v1/archive/SaleDiary?$select=person/title,contact/contactExtra/x_contact_longtext,associate/usergroup,project/NumberOfNotCompletedSalesInPeriod,saleStakeholder/contact/streetAddress/line2
