...
```http!
GET /api/v1/archive/SaleDiary?$select=person/restrictionAddress/addressId,person/personExtra/x_person_float,person/personAssociate/credentialType,person/personAssociate/personEmail,contact/country
