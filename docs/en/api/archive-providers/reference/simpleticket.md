...
```http!
GET /api/v1/archive/SimpleTicket?$select=createdBy/mrMrs,createdBy/isActive,person/mrMrs,person/personExtra/x_person_user_relation,contact/restrictionAddress/line1
