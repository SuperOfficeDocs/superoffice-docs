...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/mrMrs,person/personAddress/formattedMultiLineAddress,contact/contactDeleted,contact/url/URLAddress,contact/contactAssociate/firstName
