...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/supportAssociate,person/personExtra/y_rental/x_amount,person/correspondingAssociate/portraitThumbnail,contact/contactAssociate/title,sale/credited
