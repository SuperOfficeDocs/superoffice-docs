...
```http!
GET /api/v1/archive/SimpleTicket?$select=suggestedCategory,person/personActiveErpLinks,person/personExtra/x_person_shorttext_list,contact/associateId,contact/contactUdef/SuperOffice:5
