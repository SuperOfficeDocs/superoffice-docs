...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/assocType,ownedBy/isLocation,person/personAssociate/mrMrs,person/personAssociate/assocType,contact/associateId
