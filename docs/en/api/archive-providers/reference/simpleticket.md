...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/birthYear,person/personExtra/y_car/id,person/personAssociate/associateDbId,person/correspondingAssociate/locationAddress,contact/contactNoMail
