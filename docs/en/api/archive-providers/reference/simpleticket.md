...
```http!
GET /api/v1/archive/SimpleTicket?$select=connectId,person/restrictionAddress/wgs84longitude,person/personExtra/x_person_integer,contact/contactAssociate/title,contact/contactExtra/x_contact_datetime
