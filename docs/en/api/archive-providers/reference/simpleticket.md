...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/associateDbId,contact/saintTicketStatus,sale/registeredDate,sale/salePublish/publishedTo,project/projectUdef/SuperOffice:8
