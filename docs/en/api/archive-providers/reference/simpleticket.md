...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/correspondingAssociate/assocType,contact/associateId,contact/contactNoMail,contact/email/emailLastBounce,sale/personId
