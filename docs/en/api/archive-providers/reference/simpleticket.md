...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/personEmail,person/correspondingAssociate/portraitThumbnail,contact/streetAddress/wgs84longitude,contact/contactAssociate/contactCategory,extra/x_ticket_short_text
