...
```http!
GET /api/v1/archive/SimpleTicket?$select=contact/postAddress/line1,contact/streetAddress/county,contact/contactUdef/SuperOffice:2,contact/LastSale,project/hasGuide
