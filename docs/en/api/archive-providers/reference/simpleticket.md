...
```http!
GET /api/v1/archive/SimpleTicket?$select=firstReadByOwner,person/personRegisteredDate,person/email/emailLastSent,person/personUdef/SuperOffice:1,person/personExtra/x_person_time
