...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/personAddress/zip,contact/registeredBy,contact/contactExtra/x_contact_short_dropdown,extra/x_ticket_longtext
