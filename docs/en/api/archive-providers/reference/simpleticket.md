...
```http!
GET /api/v1/archive/SimpleTicket?$select=createdBy/isLocation,person/personUdef/SuperOffice:5,person/personAssociate/userName,person/correspondingAssociate/title,sale/activeErpLinks
