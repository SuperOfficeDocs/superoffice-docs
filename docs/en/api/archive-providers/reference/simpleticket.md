...
```http!
GET /api/v1/archive/SimpleTicket?$select=content,createdBy/isActiveText,person/personAssociate/middleName,person/personAssociate/userName,extra/x_ticket_time
