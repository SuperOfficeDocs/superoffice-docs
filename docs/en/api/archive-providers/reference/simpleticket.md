...
```http!
GET /api/v1/archive/SimpleTicket?$select=realTimeToReply,person/personExtra/x_person_hidden_integer,person/personExtra/y_rental/x_amount,sale/credited,sale/visibleFor
