...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/middleName,ownedBy/assocName,ownedBy/isActive,contact/streetAddress/formattedAddress,contact/NumberOfSalesInPeriod
