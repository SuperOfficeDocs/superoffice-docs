...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/personId,person/associateType,person/personDirectPhone/formattedNumber,contact/orgnr,contact/contactAssociate/title
