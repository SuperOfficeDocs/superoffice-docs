...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/restrictionAddress/city,contact/streetAddress/line1,contact/contactAssociate/contactFullName,extra/x_ticket_short_text
