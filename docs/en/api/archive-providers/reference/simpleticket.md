...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/personHasInterests,person/isProjectMember,person/personExtra/x_person_category_relation,person/personAssociate/assocName,person/subscription
