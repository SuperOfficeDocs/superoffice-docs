...
```http!
GET /api/v1/archive/SimpleTicket?$select=createdBy/personEmail,person/personCategory,person/personAddress/county,contact/mainContact,contact/restrictionAddress/wgs84latitude
