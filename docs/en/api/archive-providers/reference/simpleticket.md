...
```http!
GET /api/v1/archive/SimpleTicket?$select=readStatus,ownedBy/isLocation,person/rank,person/personExtra/x_person_user_relation,person/personAssociate/isActiveText
