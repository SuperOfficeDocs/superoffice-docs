...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/personCountry,person/personAssociate/locationAddress,contact/contactInterestIds,extra/x_ticket_date,sale/registeredDate
