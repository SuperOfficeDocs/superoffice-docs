...
```http!
GET /api/v1/archive/SimpleTicket?$select=getAllRows,person/middleName,person/correspondingAssociate/credentialDisplayValue,contact/streetAddress/zip,contact/contactAssociate/contactDepartment
