...
```http!
GET /api/v1/archive/SimpleTicket?$select=createdBy/fullName,person/restrictionAddress/line2,person/personExtra/x_person_integer,person/personAssociate/fullName,person/legalBaseEmarketing
