...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/credentialDisplayValue,ownedBy/userName,person/createdByForm,person/correspondingAssociate/title,contact/updatedByFullName
