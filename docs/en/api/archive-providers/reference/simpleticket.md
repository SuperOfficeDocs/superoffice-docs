...
```http!
GET /api/v1/archive/SimpleTicket?$select=createdBy/personEmail,person/isStakeholder,person/personAssociate/isLocation,contact/registeredByFullName,contact/NumberOfTickets
