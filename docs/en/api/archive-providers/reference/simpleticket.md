...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/fullName,person/personUpdatedByFullName,person/personCategory,person/personAddress/state,person/personExtra/y_rental/x_contact
