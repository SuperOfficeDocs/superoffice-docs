...
```http!
GET /api/v1/archive/SimpleTicket?$select=getAllRows,contact/contactAssociate/fullName,contact/contactExtra/x_contact_float,extra/x_ticket_shorttext_list,sale/amountWeightedInBaseCurrency
