...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/hasInfoText,person/personBusiness,person/personPager/description,person/personUrl/URLDescription,person/personExtra/x_person_priority_relation
