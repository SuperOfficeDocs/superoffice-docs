...
```http!
GET /api/v1/archive/SimpleTicket?$select=realTimeSpentExternally,timeSpentQueue,createdBy/assocType,ownedBy/role,person/personExtra/x_person_contact_relation
