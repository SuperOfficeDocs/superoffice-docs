...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/personPrivate/description,person/personInfo/textId,person/restrictionAddress/zip,person/personExtra/y_rental/x_end,sale/icon
