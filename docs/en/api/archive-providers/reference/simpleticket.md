...
```http!
GET /api/v1/archive/SimpleTicket?$select=activated,person/personDeletedDate,person/personMobilePhone/formattedNumber,person/email/emailLastSent,contact/restrictionAddress/wgs84longitude
