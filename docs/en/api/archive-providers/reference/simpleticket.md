...
```http!
GET /api/v1/archive/SimpleTicket?$select=realTimeSpentQueue,person/personRegisteredBy,person/ticketPriority,person/personExtra/x_person_boolean,person/personAssociate/associateDbId
