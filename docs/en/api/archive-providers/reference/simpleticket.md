...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/firstName,person/personExtra/y_rental/x_amount,person/personAssociate/isActive,contact/activeErpLinks,sale/stalledComment
