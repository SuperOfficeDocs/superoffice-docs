...
```http!
GET /api/v1/archive/SimpleTicket?$select=ownedBy/middleName,ownedBy/assocTooltip,person/leadStatus,person/personAssociate/firstName,person/correspondingAssociate/ejDisplayName
