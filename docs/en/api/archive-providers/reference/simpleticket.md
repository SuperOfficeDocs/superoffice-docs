...
```http!
GET /api/v1/archive/SimpleTicket?$select=person/position,person/searchPhone/formattedNumber,person/personUdef/SuperOffice:8,person/correspondingAssociate/assocType,contact/contactExtra/x_contact_float
