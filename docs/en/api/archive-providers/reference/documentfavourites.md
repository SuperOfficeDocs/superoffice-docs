...
```http!
GET /api/v1/archive/documentfavourites?$select=ourref,person/kanaLastName,person/restrictionAddress/line1,person/correspondingAssociate/credentialDisplayValue,contact/NumberOfActivities
