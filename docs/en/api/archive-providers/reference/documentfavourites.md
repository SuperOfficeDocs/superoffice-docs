...
```http!
GET /api/v1/archive/documentfavourites?$select=userGroup,contact/restrictionAddress/addressId,project/projectAssociate/firstName,project/projectUdef/SuperOffice:5,associate/associateDbId
