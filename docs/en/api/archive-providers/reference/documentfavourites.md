...
```http!
GET /api/v1/archive/documentfavourites?$select=updatedBy,person/personDirectPhone/description,person/personExtra/x_person_date,person/personExtra/y_rental/id,person/correspondingAssociate/ejUserId
