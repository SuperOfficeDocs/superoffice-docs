...
```http!
GET /api/v1/archive/documentfavourites?$select=person/supportLanguage,contact/restrictionAddress/formattedAddress,contact/saintAmountClass,sale/probPercent
