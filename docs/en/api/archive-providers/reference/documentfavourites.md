...
```http!
GET /api/v1/archive/documentfavourites?$select=keywords,person/personHasInterests,person/personAddress/county,person/personUdef/SuperOffice:3,person/personExtra/x_person_shorttext_list
