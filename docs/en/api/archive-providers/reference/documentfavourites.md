...
```http!
GET /api/v1/archive/documentfavourites?$select=userGroup,person/restrictionAddress/formattedAddress,person/personUdef/SuperOffice:3,person/personUdef/SuperOffice:4,contact/NumberOfSales
