...
```http!
GET /api/v1/archive/documentfavourites?$select=contact/country,contact/contactAssociate/usergroup,contact/NumberOfNotCompletedActivities,contact/saintAmountClass,project/projectUdef/SuperOffice:1
