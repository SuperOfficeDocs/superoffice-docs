...
```http!
GET /api/v1/archive/documentfavourites?$select=person/personMobilePhone/description,person/email/emailHasBounced,person/personAssociate/assocType,contact/category,project/projectPublish/publishedTo
