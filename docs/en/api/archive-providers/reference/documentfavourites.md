...
```http!
GET /api/v1/archive/documentfavourites?$select=completed,person/personAssociate/portraitThumbnail,contact/streetAddress/wgs84latitude,contact/contactUdef/SuperOffice:5
