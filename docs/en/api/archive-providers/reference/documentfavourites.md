...
```http!
GET /api/v1/archive/documentfavourites?$select=person/personAssociate/firstName,contact/contactExtra/x_contact_date,person/correspondingAssociate/usergroup
