...
```http!
GET /api/v1/archive/documentfavourites?$select=person/portraitThumbnail,person/personAddress/addressId,person/personExtra/y_rental/x_amount,person/correspondingAssociate/personId,person/correspondingAssociate/personEmail
