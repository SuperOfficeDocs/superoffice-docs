...
```http!
GET /api/v1/archive/documentfavourites?$select=person/personAddress/formattedMultiLineAddress,contact/registeredBy,project/NumberOfNotCompletedSalesInPeriod
