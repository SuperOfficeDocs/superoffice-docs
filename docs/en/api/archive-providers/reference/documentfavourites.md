...
```http!
GET /api/v1/archive/documentfavourites?$select=person/supportAssociateFullName,person/consentSourceStore,contact/restrictionAddress/line2,contact/restrictionAddress/zip,sale/saleTypeCategory
