...
```http!
GET /api/v1/archive/RelatedTickets?$select=person/middleName,person/leadStatus,person/hasStoreConsent,contact/restrictionAddress/city,contact/contactAssociate/usergroupId
