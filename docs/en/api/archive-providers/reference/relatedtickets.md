...
```http!
GET /api/v1/archive/RelatedTickets?$select=person/personExtra/x_person_date,person/personAssociate/otherGroups,contact/postAddress/city,contact/restrictionAddress/line3,contact/contactAssociate/personId
