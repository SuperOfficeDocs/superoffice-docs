...
```http!
GET /api/v1/archive/RelatedTickets?$select=createdBy,ownedBy/contactDepartment,person/personId,contact/email/emailLastBounce,contact/contactAssociate/ejDisplayName
