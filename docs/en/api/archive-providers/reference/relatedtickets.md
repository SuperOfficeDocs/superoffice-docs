...
```http!
GET /api/v1/archive/RelatedTickets?$select=createdBy/usergroupId,person/personAddress/county,person/personAssociate/role,contact/email/emailLastBounce,contact/url/URLDescription
