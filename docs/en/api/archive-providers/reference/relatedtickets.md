...
```http!
GET /api/v1/archive/RelatedTickets?$select=timeSpentExternally,ticketStatus/rank,person/personAssociateFullName,person/personAddress/wgs84longitude,person/personExtra/y_rental/x_end
