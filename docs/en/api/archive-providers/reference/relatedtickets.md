...
```http!
GET /api/v1/archive/RelatedTickets?$select=person/personInfo/infoText,person/restrictionAddress/state,person/personUdef/SuperOffice:7,person/correspondingAssociate/personId,sale/saleUdef/SuperOffice:8
