...
```http!
GET /api/v1/archive/RelatedTickets?$select=person/personUdef/SuperOffice:1,contact/contactAssociate/contactName,contact/contactUdef/SuperOffice:7,extra/x_ticket_shorttext_list,sale/registeredDate
