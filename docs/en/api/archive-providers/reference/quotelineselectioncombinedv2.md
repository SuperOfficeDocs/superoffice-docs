...
```http!
GET /api/v1/archive/QuoteLineSelectionCombinedV2?$select=personId,alternative/version/status,alternative/version/paymentType,alternative/version/quote/sale/contactId,alternative/version/quote/sale/person/personDeletedDate
