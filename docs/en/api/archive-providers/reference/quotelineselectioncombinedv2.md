...
```http!
GET /api/v1/archive/QuoteLineSelectionCombinedV2?$select=subscriptionQuantity,vatInfo,alternative/subTotal,alternative/version/deliveryTerms,alternative/version/quote/sale/person/portraitThumbnail
