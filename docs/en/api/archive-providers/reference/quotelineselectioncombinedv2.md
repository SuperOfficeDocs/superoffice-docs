...
```http!
GET /api/v1/archive/QuoteLineSelectionCombinedV2?$select=vat,alternative/version/approvedDate,alternative/version/quote/sale/updatedDate,alternative/version/quote/sale/person/personCountryId,alternative/version/quote/sale/person/associateType
