...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=contact/streetAddress/formattedMultiLineAddress,contact/contactAssociate/ejUserId,project/projectAssociate/usergroup
