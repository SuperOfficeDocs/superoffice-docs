...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=project/NumberOfNotCompletedActivitiesInPeriod,person/correspondingAssociate/role,contact/contactAssociate/fullName
