...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=updatedByFullName,person/personExtra/x_person_user_relation,contact/contactId,project/projectAssociate/assocName
