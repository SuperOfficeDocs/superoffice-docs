...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=snum,person/personExtra/x_person_time,contact/registeredByFullName,contact/postAddress/city,contact/streetAddress/line2
