...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=recordType,person/personPager/formattedNumber,contact/postAddress/formattedAddress,contact/streetAddress/formattedAddress,contact/contactUdef/SuperOffice:12
