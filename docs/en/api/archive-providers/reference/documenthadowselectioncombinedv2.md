...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=contact/email/emailAddress,associate/firstName,sale/saleTypeCategory,sale/associate/fullName
