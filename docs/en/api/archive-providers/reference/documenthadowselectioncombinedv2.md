...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/supportAssociate,contact/streetAddress/zip,contact/restrictionAddress/formattedAddress,contact/NumberOfActivities,contact/LastCompletedSale
