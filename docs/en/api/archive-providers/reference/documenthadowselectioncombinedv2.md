...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=contact/streetAddress/wgs84latitude,contact/contactUdef/SuperOffice:2,associate/role,sale/contactId
