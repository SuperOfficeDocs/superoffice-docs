...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=date,keywords,person/associateType,person/correspondingAssociate/assocName,project/projectAssociate/ejStatus
