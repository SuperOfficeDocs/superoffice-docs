...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=contact/number,contact/contactAssociate/isActiveText,contact/NumberOfSalesInPeriod,sale/icon
