...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/personSource,person/personAssociate/personId,person/personAssociate/ejUserId,contact/postAddress/zip,contact/streetAddress/city
