...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/personAddress/county,person/personUdef/SuperOffice:9,person/legalBaseStore,associate/otherGroups
