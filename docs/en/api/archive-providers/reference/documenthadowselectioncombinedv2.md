...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=documentId,person/personUpdatedBy,person/restrictionAddress/state,associate/contactId,associate/contactDepartment
