...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=isMail,person/lastName,person/personAddress/addressId,person/restrictionAddress/addressId,contact/streetAddress/state
