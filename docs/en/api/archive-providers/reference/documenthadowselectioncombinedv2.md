...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=icon,person/email/emailAddress,contact/name,contact/updatedByFullName,contact/contactAssociate/ejUserId
