...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionCombinedProviderV2">SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionCombinedProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/hasInterests,person/personSource,person/personUpdatedBy,person/supportAssociateFullName,person/personAssociate/middleName
