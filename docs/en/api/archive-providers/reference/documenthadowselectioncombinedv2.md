...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=subject,person/isStakeholder,contact/contactAssociate/middleName,sale/nextDueDate,document/description
