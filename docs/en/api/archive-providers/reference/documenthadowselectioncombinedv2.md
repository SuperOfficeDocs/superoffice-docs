...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/isMailingRecipient,contact/contactAssociate/credentialDisplayValue,associate/assocTooltip
