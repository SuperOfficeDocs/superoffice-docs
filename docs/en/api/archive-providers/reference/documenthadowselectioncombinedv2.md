...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=contact/mainContact,contact/contactAssociate/simultaneousEjUser,contact/contactUdef/SuperOffice:5,contact/NumberOfNotCompletedTicketsInPeriod
