...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/personAddress/county,contact/updatedDate,documentUdef/SuperOffice:3,sale/saleTypeCategory,sale/hasQuote
