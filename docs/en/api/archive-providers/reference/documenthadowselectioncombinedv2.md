...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=date,person/personExtra/x_person_priority_relation,person/personExtra/y_rental/x_start,person/personAssociate/title,contact/contactSource
