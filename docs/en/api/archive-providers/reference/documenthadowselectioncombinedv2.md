...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/personAssociate/ejStatus,person/legalBaseEmarketing,contact/contactExtra/x_contact_datetime,sale/amountWeightedInBaseCurrency,sale/associate/mrMrs
