...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/personExtra/x_person_category_relation,contact/postAddress/wgs84longitude,contact/LastSale,associate/otherGroups,sale/hasStakeholders
