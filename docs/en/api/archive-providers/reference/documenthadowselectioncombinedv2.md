...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=who,person/personAssociateFullName,person/personAssociate/contactDepartment,contact/NumberOfTicketsInPeriod,sale/time
