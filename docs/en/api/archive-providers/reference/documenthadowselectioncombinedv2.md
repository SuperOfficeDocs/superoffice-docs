...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=person/email/emailId,person/restrictionAddress/state,contact/number,contact/restrictionAddress/state,project/projectEvent/isExternalEvent
