...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=getAllRows,icon,suggestedDocumentId,person/restrictionAddress/line3,person/personAssociate/ejUserId
