...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=contact/streetAddress/wgs84longitude,contact/contactAssociate/ejUserId,contact/contactAssociate/ejStatus
