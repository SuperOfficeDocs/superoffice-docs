...
```http!
GET /api/v1/archive/DocumenthadowSelectionCombinedV2?$select=contactId,saleId,person/personAddress/line1,person/restrictionAddress/addressId,person/personAssociate/contactCategory
