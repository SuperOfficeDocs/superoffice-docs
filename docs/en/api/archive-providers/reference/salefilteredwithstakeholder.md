...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=heading,person/birthdate,person/email/emailLastBounce,person/personAddress/zip,person/personAssociate/usergroup
