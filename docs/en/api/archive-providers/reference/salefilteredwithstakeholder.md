...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=contact/business,contact/activeErpLinks,contact/streetAddress/formattedMultiLineAddress,contact/contactAssociate/contactId,associate/ejUserId
