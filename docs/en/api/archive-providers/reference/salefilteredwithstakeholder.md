...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=person/correspondingAssociate/assocName,associate/usergroup,quote/version/alternative/quoteline/totalCost
