...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=contactId,hasQuote,person/personExtra/x_person_boolean,contact/searchPhone/formattedNumber,contact/contactAssociate/contactId
