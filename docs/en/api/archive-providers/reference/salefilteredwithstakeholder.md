...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=heading,person/birthdate,person/personAssociate/mrMrs,contact/contactId,contact/restrictionAddress/county
