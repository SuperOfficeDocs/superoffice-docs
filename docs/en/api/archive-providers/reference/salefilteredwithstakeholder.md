...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=recordType,probPercent,person/lastName,person/personUrl/URLDescription,person/personAssociate/role
