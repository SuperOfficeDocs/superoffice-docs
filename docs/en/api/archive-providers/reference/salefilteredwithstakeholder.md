...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=salePublish/publishedFrom,contact/activeErpLinks,contact/contactUdef/SuperOffice:3,contact/contactExtra/x_contact_float,contact/LastDoByActivity
