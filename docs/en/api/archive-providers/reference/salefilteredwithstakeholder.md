...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=isStakeholderSale,person/personAssociate/role,contact/updatedBy,contact/contactPhone/formattedNumber,contact/streetAddress/formattedMultiLineAddress
