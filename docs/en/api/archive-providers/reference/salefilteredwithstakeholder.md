...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=person/hasInterests,person/personInfo/textId,person/personAddress/wgs84longitude,contact/registeredBy,contact/postAddress/zip
