...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=person/contactId,person/personAssociate/mrMrs,person/correspondingAssociate/userName,project/imageThumbnail,project/activeErpLinks
