...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=saleNumber,person/birthDay,person/correspondingAssociate/role,person/correspondingAssociate/personEmail,contact/email/emailLastBounce
