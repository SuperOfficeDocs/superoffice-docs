...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=updatedByFullName,person/rank,person/personAssociate/simultaneousEjUser,person/correspondingAssociate/contactId,contact/name
