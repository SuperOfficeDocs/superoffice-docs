...
| ---- | ----- |
|"sale"|[[SR_AA_SALES]]|
|"includestakeholders"|[[SR_STAKEHOLDERS_INCLUDE]]|
...
|isStakeholderSale|bool|SR\_STAKEHOLDERS\_STAKEHOLDER\_SALE: SR\_STAKEHOLDERS\_STAKEHOLDER\_SALE| x |
...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=activeErpLinks,person/subscription,contact/contactAssociate/isLocation,associate/assocType,saleUdef/SuperOffice:6
