...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=time,earningPercent,person/personExtra/y_rental/x_contact,contact/email/emailHasBounced,contact/restrictionAddress/county
