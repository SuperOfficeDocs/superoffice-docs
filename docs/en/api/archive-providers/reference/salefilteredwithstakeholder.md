...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=userGroup,competitor,person/personUdef/SuperOffice:5,person/subscription,associate/locationAddress
