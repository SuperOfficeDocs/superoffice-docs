...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=saleStakeholderId,icon,person/personNumber,person/personExtra/x_person_shorttext,contact/contactAssociate/isLocation
