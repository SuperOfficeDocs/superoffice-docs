...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=heading,createdByWorkflow,person/personAddress/addressId,person/personUdef/SuperOffice:1,person/correspondingAssociate/portraitThumbnail
