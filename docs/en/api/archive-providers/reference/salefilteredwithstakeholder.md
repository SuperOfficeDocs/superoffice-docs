...
```http!
GET /api/v1/archive/SaleFilteredWithStakeholder?$select=icon,registeredDate,contact/contactAssociate/isLocation,project/updatedByFullName,project/projectAssociate/contactCategory
