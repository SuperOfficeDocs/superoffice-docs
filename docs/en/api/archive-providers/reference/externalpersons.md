...
```http!
GET /api/v1/archive/ExternalPersons?$select=personAddress/city,personAddress/wgs84latitude,personSourceRelation/hasCompany,personTargetRelation/birthMonth,personAssociate/middleName
