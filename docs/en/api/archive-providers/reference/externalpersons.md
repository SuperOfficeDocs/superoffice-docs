...
```http!
GET /api/v1/archive/ExternalPersons?$select=personPrivate/description,request/ownedBy/personId,projectMembers/projectAssociate/ejUserId,personAppointment/endDate
