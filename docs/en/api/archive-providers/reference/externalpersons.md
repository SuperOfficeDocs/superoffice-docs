...
```http!
GET /api/v1/archive/ExternalPersons?$select=personCountry,personPager/formattedNumber,personAddress/line3,personAddress/wgs84longitude,personSourceRelation/leadStatus
