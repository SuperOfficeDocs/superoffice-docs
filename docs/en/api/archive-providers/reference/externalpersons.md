...
```http!
GET /api/v1/archive/ExternalPersons?$select=personTargetRelation/title,withdrawnEmarketingConsent,request/ownedBy/firstName,request/ownedBy/personEmail,projectMembers/projectAssociate/isActive
