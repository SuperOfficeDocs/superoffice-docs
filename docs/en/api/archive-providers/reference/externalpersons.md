...
```http!
GET /api/v1/archive/ExternalPersons?$select=personExtra/x_person_longtext,personAssociate/isActive,projectMembers/hasInfoText,projectMembers/text,projectMembers/projectUdef/SuperOffice:10
