...
```http!
GET /api/v1/archive/ExternalPersons?$select=restrictionAddress/wgs84latitude,personUdef/SuperOffice:2,request/numberOfReplies,request/closedAt,request/extra/x_ticket_project_relation
