...
```http!
GET /api/v1/archive/ExternalPersons?$select=personInfo/infoText,personAddress/city,personUdef/SuperOffice:3,personSourceRelation/supportAssociate,withdrawnStoreConsent
