...
```http!
GET /api/v1/archive/ExternalPersons?$select=isStakeholder,personSourceRelation/personUpdatedDate,personSourceRelation/personPersonRelation,request/messageLanguage,projectMembers/NumberOfSalesInPeriod
