...
```http!
GET /api/v1/archive/ExternalPersons?$select=isStakeholder,restrictionAddress/county,correspondingAssociate/personId,correspondingAssociate/simultaneousEjUser,request/ticketTypeName
