...
```http!
GET /api/v1/archive/ExternalPersons?$select=supportAssociate,personSourceRelation/personUpdatedDate,personSourceRelation/personPersonRelation,request/realTimeSpentInternally,request/createdBy/ejUserId
