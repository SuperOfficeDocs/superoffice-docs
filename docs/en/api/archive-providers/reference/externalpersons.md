...
```http!
GET /api/v1/archive/ExternalPersons?$select=isProjectMember,personSourceRelation/personRegisteredDate,personSourceRelation/portraitThumbnail,projectMembers/completed
