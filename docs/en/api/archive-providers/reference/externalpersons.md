...
```http!
GET /api/v1/archive/ExternalPersons?$select=personAddress/city,personAssociate/personId,request/ticketStatusName,projectMembers/projectAssociate/credentialDisplayValue
