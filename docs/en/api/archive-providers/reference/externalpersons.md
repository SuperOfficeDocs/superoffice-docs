...
```http!
GET /api/v1/archive/ExternalPersons?$select=personExtra/y_rental/x_contact,personTargetRelation/associateType,personAssociate/usergroup,request/ownedBy/assocType
