...
```http!
GET /api/v1/archive/ExternalPersons?$select=personUrl/URLAddress,request/projectId,request/extra/y_equipment/x_name,projectMembers/text,projectMembers/registeredBy
