...
```http!
GET /api/v1/archive/ExternalPersons?$select=personSourceRelation/supportAssociateFullName,personAssociate/ejDisplayName,personAssociate/ejStatus,personAssociate/isActive,request/author
