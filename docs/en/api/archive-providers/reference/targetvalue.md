...
```http!
GET /api/v1/archive/TargetValue?$select=contact/contactAssociate/contactDepartment,contact/contactSupportAssociate/assocName,contact/contactUdef/SuperOffice:4,contact/NumberOfActivities
