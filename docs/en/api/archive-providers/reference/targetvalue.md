...
```http!
GET /api/v1/archive/TargetValue?$select=contact/orgnr,contact/contactSupportAssociate/ejStatus,contact/contactSupportPerson/isMailingRecipient,contact/contactUdef/SuperOffice:13
