...
```http!
GET /api/v1/archive/TargetValue?$select=contact/country,contact/restrictionAddress/wgs84longitude,contact/contactAssociate/middleName,contact/contactAssociate/assocTooltip
