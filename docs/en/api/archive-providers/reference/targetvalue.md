...
```http!
GET /api/v1/archive/TargetValue?$select=contact/restrictionPostalAddress/state,contact/restrictionAddress/wgs84latitude,contact/contactAssociate/assocType,contact/contactSupportPerson/personSource
