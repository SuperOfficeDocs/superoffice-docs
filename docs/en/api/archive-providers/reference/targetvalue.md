...
```http!
GET /api/v1/archive/TargetValue?$select=getAllRows,contact/restrictionAddress/city,contact/url/URLAddress,contact/contactSupportPerson/kanaLastName,contact/LastSale
