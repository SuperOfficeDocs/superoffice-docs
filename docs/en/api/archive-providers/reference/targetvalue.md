...
```http!
GET /api/v1/archive/TargetValue?$select=targetAssociate,targetDimensionEntityType,associate/simultaneousEjUser,contact/contactSupportAssociate/contactId,contact/contactSupportPerson/isStakeholder
