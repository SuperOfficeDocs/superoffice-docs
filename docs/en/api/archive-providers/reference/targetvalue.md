...
```http!
GET /api/v1/archive/TargetValue?$select=contact/number,contact/contactAssociate/contactId,contact/contactSupportAssociate/associateDbId,contact/contactSupportPerson/personInfo/textId
