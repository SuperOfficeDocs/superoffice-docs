...
```http!
GET /api/v1/archive/TargetValue?$select=contact/hasInfoText,contact/hasInterests,contact/contactSupportAssociate/credentialDisplayValue,contact/LastCompletedActivity
