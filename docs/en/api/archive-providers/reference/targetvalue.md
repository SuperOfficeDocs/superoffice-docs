...
```http!
GET /api/v1/archive/TargetValue?$select=associate/ejUserId,contact/number,contact/streetAddress/county,contact/contactSupportPerson/personUdef/SuperOffice:2,contact/contactExtra/x_contact_request_relation
