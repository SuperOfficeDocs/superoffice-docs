...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=associate/ejStatus,person/personUdef/SuperOffice:10,person/personAssociate/contactId,contact/contactAssociate/usergroupId
