...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=associate/contactId,person/hasInterests,person/position,person/consentSourceStore
