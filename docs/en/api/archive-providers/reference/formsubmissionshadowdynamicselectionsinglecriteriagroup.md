...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=contact/stop,contact/email/emailProtocol,contact/postAddress/wgs84longitude
