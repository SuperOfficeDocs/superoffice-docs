...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=associate/lastName,person/personHasInterests,person/personMobilePhone/description,person/personDirectFax/description,contact/contactAssociate/contactId
