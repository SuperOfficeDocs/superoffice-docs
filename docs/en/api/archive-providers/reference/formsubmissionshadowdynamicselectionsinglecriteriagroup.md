...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=time,person/personAssociate/contactFullName,contact/contactAssociate/mrMrs,contact/contactAssociate/role
