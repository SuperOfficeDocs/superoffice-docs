...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=contact/contactExtra/x_contact_longtext,contact/saintDirection,person/restrictionAddress/county
