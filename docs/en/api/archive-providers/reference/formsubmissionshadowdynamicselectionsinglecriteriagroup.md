...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=person/personUdef/SuperOffice:7,contact/contactExtra/x_contact_request_relation,person/restrictionAddress/state
