...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=person/personNoMail,person/personAssociate/title,person/restrictionAddress/city
