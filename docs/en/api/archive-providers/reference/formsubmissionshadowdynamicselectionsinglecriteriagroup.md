...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=formSubmissionEmail,person/kanaFirstName,contact/department,contact/deletedDate,contact/streetAddress/city
