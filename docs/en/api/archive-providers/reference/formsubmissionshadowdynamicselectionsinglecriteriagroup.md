...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=person/correspondingAssociate/contactFullName,person/restrictionAddress/zip,person/personAssociate/locationAddress
