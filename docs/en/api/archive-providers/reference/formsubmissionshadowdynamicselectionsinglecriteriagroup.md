...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=person/personAddress/formattedMultiLineAddress,contact/countryId,contact/contactAssociate/fullName
