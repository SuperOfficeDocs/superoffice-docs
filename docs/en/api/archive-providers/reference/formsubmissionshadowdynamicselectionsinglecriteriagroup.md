...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=person/email/emailId,person/restrictionAddress/state,person/correspondingAssociate/firstName
