...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionSingleCriteriaGroup?$select=formSubmissionName,person/personDirectPhone/formattedNumber,contact/postAddress/wgs84longitude
