...
```http!
GET /api/v1/archive/FindSale?$select=person/consentSourceEmarketing,contact/streetAddress/zip,project/projectUrl/URLDescription,project/project/textId,saleStakeholder/person/correspondingAssociate/assocType
