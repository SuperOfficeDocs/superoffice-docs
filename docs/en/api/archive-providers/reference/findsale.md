...
```http!
GET /api/v1/archive/FindSale?$select=person/kanaFirstName,person/restrictionAddress/county,person/personAssociate/userName,contact/postAddress/state,contact/SaintStatus1
