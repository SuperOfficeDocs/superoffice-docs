...
```http!
GET /api/v1/archive/FindSale?$select=userGroup,person/email/emailDescription,person/personAssociate/contactCategory,person/correspondingAssociate/personId,person/correspondingAssociate/ejDisplayName
