...
```http!
GET /api/v1/archive/FindSale?$select=amountWeightedInBaseCurrency,sale/description,person/correspondingAssociate/simultaneousEjUser,person/correspondingAssociate/userName,contact/code
