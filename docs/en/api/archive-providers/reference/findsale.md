...
```http!
GET /api/v1/archive/FindSale?$select=source,person/personAssociateFullName,person/personAssociate/ejStatus,person/correspondingAssociate/contactFullName,person/correspondingAssociate/assocType
