...
```http!
GET /api/v1/archive/FindSale?$select=stalledComment,person/correspondingAssociate/middleName,person/correspondingAssociate/assocType,person/correspondingAssociate/credentialType,contact/contactAssociate/userName
