...
```http!
GET /api/v1/archive/FindSale?$select=person/personUrl/URLAddress,person/personAssociate/isActive,person/personAssociate/portraitThumbnail,person/correspondingAssociate/lastName,contact/NumberOfNotCompletedActivitiesInPeriod
