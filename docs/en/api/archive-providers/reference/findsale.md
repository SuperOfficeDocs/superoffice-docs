...
```http!
GET /api/v1/archive/FindSale?$select=getAllRows,saleStatus,person/email/emailDescription,person/email/emailId,person/correspondingAssociate/portraitThumbnail
