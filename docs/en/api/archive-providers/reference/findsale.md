...
```http!
GET /api/v1/archive/FindSale?$select=person/title,person/personUdef/SuperOffice:3,contact/updatedByFullName,contact/postAddress/wgs84longitude,contact/streetAddress/line3
