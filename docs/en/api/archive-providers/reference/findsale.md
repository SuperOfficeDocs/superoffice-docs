...
```http!
GET /api/v1/archive/FindSale?$select=person/personAddress/line1,person/personAssociate/title,person/personAssociate/personEmail,contact/updatedBy,associate/middleName
