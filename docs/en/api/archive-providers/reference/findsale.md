...
```http!
GET /api/v1/archive/FindSale?$select=person/personUpdatedByFullName,person/email/emailLastBounce,person/personAssociate/isLocation,contact/contactAssociate/lastName,contact/contactAssociate/contactId
