...
```http!
GET /api/v1/archive/FindSale?$select=recordType,person/personUdef/SuperOffice:3,person/personExtra/x_person_priority_relation,contact/number,contact/postAddress/line2
