...
```http!
GET /api/v1/archive/FindSale?$select=registeredDate,salePublish/publishedFrom,person/personCountryId,person/whenUpdatedByWorkflow,person/personAddress/county
