...
```http!
GET /api/v1/archive/FindSale?$select=person/hasInfoText,person/correspondingAssociate/credentialType,associate/ejDisplayName,project/projectUdef/SuperOffice:1,project/NumberOfSales
