...
```http!
GET /api/v1/archive/FindSale?$select=personId,person/createdByForm,person/personAddress/city,contact/phone/formattedNumber,contact/contactAssociate/isActive
