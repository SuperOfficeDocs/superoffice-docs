...
```http!
GET /api/v1/archive/FindSale?$select=userGroup,description,person/personAssociate/credentialType,contact/contactAssociate/isActiveText,associate/isActiveText
