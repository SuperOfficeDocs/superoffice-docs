...
```http!
GET /api/v1/archive/FindSale?$select=saleStatus,person/personAddress/formattedMultiLineAddress,contact/postAddress/wgs84latitude,contact/streetAddress/line2,contact/contactAssociate/simultaneousEjUser
