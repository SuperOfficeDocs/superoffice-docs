...
```http!
GET /api/v1/archive/FindSale?$select=userGroup,person/personExtra/y_rental/x_end,person/correspondingAssociate/credentialType,contact/activeErpLinks,appointment/associate/contactDepartment
