...
```http!
GET /api/v1/archive/FindSale?$select=person/createdByForm,person/personPrivate/description,person/personAddress/formattedAddress,person/restrictionAddress/line2,person/personExtra/y_rental/id
