...
```http!
GET /api/v1/archive/FindSale?$select=heading,person/personUdef/SuperOffice:10,person/correspondingAssociate/credentialDisplayValue,contact/contactExtra/x_contact_integer,document/associate/simultaneousEjUser
