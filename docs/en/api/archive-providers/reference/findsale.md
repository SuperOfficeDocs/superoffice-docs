...
```http!
GET /api/v1/archive/FindSale?$select=credited,person/personUpdatedByFullName,person/personActiveErpLinks,person/restrictionAddress/formattedAddress,contact/contactUdef/SuperOffice:9
