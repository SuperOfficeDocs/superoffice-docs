...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=person/whenUpdatedByWorkflow,person/email/emailAddress,contact/LastCompletedSale,document/text,document/associate/fullName
