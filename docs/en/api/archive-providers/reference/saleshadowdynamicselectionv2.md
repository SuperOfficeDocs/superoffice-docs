...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=type,contact/nameDepartment,contact/hasInfoText,contact/registeredDate,contact/restrictionAddress/addressId
