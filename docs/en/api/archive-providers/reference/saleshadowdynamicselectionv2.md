...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=registeredByFullName,contact/contactAssociate/userName,associate/isLocation,project/status,saleStakeholder/person/isMailingRecipient
