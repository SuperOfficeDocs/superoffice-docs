...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=person/lastName,contact/contactAssociate/associateDbId,document/icon,project/registeredBy,project/projectAssociate/mrMrs
