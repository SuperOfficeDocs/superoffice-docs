...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=projectId,contact/email/emailAddress,appointment/associate/associateDbId,document/documentPublish/publishedTo,document/associate/lastName
