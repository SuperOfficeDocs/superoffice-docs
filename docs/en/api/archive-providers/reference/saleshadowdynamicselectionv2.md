...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=registeredBy,person/personAddress/county,contact/contactAssociate/isActive,contact/contactExtra/x_contact_dropdown,appointment/associate/firstName
