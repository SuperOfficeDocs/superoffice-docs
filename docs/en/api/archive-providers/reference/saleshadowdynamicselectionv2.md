...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=person/position,person/portraitThumbnail,person/personExtra/y_car/id,contact/contactAssociate/userName,contact/contactUdef/SuperOffice:4
