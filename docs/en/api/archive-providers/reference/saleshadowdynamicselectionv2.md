...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=icon,person/personAddress/wgs84longitude,contact/contactDeleted,contact/email/emailLastSent,contact/postAddress/zip
