...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=currencyId,person/correspondingAssociate/isActive,person/hasEmarketingConsent,appointment/associate/isLocation,document/isReport
