...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=associate/personId,associate/otherGroups,appointment/associate/assocType,appointment/associate/ejStatus,document/documentPublish/publishedBy
