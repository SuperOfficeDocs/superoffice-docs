...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=currencyId,person/birthDay,person/personDirectPhone/description,person/personUdef/SuperOffice:7,person/personUdef/SuperOffice:8
