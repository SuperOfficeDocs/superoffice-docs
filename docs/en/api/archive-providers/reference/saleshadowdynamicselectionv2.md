...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=person/personUpdatedDate,person/restrictionAddress/line2,contact/code,contact/postAddress/line1,contact/contactExtra/x_contact_short_dropdown
