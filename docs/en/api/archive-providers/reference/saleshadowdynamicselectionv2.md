...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=source,person/personHasInterests,person/restrictionAddress/line1,contact/postAddress/zip,contact/contactAssociate/contactId
