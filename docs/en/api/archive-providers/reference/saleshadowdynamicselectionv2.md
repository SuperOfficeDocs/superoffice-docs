...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=saleStatus,salePublish/isPublished,contact/contactDeleted,contact/restrictionAddress/wgs84latitude,contact/contactExtra/x_contact_float
