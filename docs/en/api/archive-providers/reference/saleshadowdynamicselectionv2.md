...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=stageName,person/personAddress/city,person/personAssociate/otherGroups,person/hasStoreConsent,contact/streetAddress/formattedMultiLineAddress
