...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=person/hasCompany,person/email/emailBounceCount,person/personAddress/line1,person/personAssociate/role,contact/contactInterestIds
