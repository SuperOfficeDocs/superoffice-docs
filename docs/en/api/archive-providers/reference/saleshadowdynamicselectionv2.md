...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=contact/saintSaleStatus,associate/isActive,document/associate/ejUserId,document/associate/simultaneousEjUser,document/associate/otherGroups
