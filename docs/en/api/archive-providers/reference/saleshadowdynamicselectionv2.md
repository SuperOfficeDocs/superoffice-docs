...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=salePublish/publishedTo,person/personCategory,person/personAssociate/contactDepartment,contact/registeredByFullName,contact/streetAddress/line1
