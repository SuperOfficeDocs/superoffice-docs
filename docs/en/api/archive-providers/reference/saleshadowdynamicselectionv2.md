...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=stageId,person/personUdef/SuperOffice:3,person/personAssociate/contactDepartment,contact/updatedDate,contact/contactFax/formattedNumber
