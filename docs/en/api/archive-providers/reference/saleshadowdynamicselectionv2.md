...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=salePublish/publishedBy,person/personRegisteredByFullName,person/personAssociate/assocName,associate/ejDisplayName,project/projectUrl/URLAddress
