...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=hasGuide,person/portraitThumbnail,person/personPrivate/description,person/personAssociate/role,contact/associateId
