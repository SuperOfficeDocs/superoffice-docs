...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionV2?$select=currencyId,person/birthDay,person/personUpdatedBy,person/searchPhone/formattedNumber,person/personAssociate/associateDbId
