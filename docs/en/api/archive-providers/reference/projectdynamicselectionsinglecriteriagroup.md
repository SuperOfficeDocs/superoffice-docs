...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/personId,NumberOfActivities,sale/saleUdef/SuperOffice:4,appointment/appointment/titleHtml,projectMember/infoText
