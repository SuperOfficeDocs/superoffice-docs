...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectEvent/eventDate,projectAssociate/firstName,projectAssociate/userName,saintTicketStatus,appointment/registeredDate
