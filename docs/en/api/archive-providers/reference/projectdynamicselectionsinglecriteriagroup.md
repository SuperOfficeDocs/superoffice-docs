...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/assocTooltip,LastCompletedSale,sale/projectId,appointment/associate/middleName,document/associate/personId
