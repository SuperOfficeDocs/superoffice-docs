...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/mrMrs,projectUdef/SuperOffice:2,appointment/isMilestone,appointment/associate/ejUserId,projectMember/birthdate
