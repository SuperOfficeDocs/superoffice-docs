...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectEvent/hasSignOff,projectAssociate/firstName,sale/associate/credentialDisplayValue,appointment/associate/usergroup,document/type
