...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectPublish/publishedBy,sale/associate/contactId,projectMember/contactAssociate/lastName,projectMember/contactUdef/SuperOffice:12
