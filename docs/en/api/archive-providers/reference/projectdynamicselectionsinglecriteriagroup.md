...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=registeredBy,projectAssociate/middleName,projectAssociate/contactName,NumberOfActivitiesInPeriod,LastSale
