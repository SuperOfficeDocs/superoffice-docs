...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=sale/updatedBy,sale/saleNumber,appointment/completed,appointment/appointmentUdef/SuperOffice:5,appointment/associate/isLocation
