...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectEvent/isExternalEvent,sale/time,sale/text,appointment/updatedByFullName,appointment/appointment/textId
