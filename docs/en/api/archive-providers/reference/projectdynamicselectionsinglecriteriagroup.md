...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/isActiveText,saintTicketStatus,appointment/updatedBy,appointment/booking,document/contactId
