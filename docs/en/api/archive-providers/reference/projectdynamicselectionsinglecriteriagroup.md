...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=saintSaleStatus,appointment/recurring,document/associateId,projectMember/kanaFirstName,projectMember/restrictionAddress/city
