...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/usergroupId,sale/hasQuote,appointment/personId,projectMember/personNumber,projectMember/correspondingAssociate/middleName
