...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/locationAddress,sale/icon,sale/contactId,sale/salePublish/publishedTo,appointment/completedDate
