...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=getNoRows,registeredBy,projectAssociate/role,appointment/appointmentUdef/SuperOffice:8,document/registeredBy
