...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=sale/personId,sale/associate/ejDisplayName,appointment/icon,document/recordTypeText,document/documentUdef/SuperOffice:8
