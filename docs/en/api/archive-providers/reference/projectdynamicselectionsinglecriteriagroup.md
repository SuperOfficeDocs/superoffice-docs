...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=NumberOfNotCompletedActivitiesInPeriod,document/recordTypeText,projectMember/personAssociate/personEmail,projectMember/legalBaseStore
