...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=endDate,projectAssociate/ejUserId,sale/projectId,appointment/createdByWorkflow,document/type
