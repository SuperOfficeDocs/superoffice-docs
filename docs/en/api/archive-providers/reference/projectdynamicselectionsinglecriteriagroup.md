...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=eventId,LastDoByActivity,sale/associate/ejStatus,appointment/associate/firstName,appointment/associate/isLocation
