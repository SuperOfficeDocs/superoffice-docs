...
```http!
GET /api/v1/archive/ProjectDynamicSelectionSingleCriteriaGroup?$select=associateId,projectUdef/SuperOffice:3,sale/associate/simultaneousEjUser,projectMember/personBusiness,projectMember/postAddress/zip
