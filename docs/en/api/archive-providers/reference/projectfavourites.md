...
```http!
GET /api/v1/archive/projectfavourites?$select=projectPublish/publishedFrom,projectAssociate/middleName,projectAssociate/associateDbId,NumberOfSalesInPeriod
