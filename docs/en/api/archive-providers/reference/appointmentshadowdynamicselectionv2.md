...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=booking,person/correspondingAssociate/usergroup,person/correspondingAssociate/assocTooltip,person/correspondingAssociate/otherGroups
