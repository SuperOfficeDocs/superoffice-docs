...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/contactId,contact/LastDoBySale,person/personInterestIds,person/personExtra/x_person_shorttext,person/correspondingAssociate/role
