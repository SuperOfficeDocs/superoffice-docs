...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=intention,contact/registeredDate,person/personCountry,person/personUdef/SuperOffice:6,person/consentSourceEmarketing
