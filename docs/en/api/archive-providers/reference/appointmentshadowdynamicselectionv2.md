...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=personId,registeredDate,booking,contact/contactUdef/SuperOffice:9,person/personRegisteredDate
