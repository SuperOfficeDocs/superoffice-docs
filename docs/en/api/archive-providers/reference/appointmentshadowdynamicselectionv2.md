...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=location,contact/contactSource,person/phone/formattedNumber,person/personExtra/x_person_date,sale/associate/contactName
