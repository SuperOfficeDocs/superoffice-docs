...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/business,person/personHasInterests,person/kanaFirstName,person/personAssociate/isLocation,associate/contactCategory
