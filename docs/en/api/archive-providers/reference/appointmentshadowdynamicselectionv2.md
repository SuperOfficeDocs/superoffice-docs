...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=registeredDate,contact/stop,contact/updatedBy,person/isMailingRecipient,project/NumberOfNotCompletedActivitiesInPeriod
