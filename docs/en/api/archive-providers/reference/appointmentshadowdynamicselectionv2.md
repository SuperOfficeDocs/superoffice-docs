...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/contactExtra/x_contact_integer,person/searchPhone/formattedNumber,person/personExtra/x_person_appointment_relation
