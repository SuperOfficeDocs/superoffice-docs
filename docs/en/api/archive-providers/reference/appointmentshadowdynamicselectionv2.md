...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=appointmentId,contact/contactAssociate/ejStatus,contact/NumberOfSales,contact/LastDoBySale,person/kanaFirstName
