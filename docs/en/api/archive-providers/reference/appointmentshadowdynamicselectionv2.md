...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=registeredDate,contact/contactPhone/formattedNumber,contact/contactAssociate/contactId,contact/contactUdef/SuperOffice:9,contact/LastActivity
