...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/code,contact/saintDirection,contact/saintTicketStatus,person/personExtra/y_rental/id,project/projectUdef/SuperOffice:9
