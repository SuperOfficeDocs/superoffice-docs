...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/category,person/createdByForm,person/searchPhone/description,person/correspondingAssociate/contactId
