...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=person/hasInfoText,person/isStakeholder,person/personUdef/SuperOffice:10,project/projectAssociate/simultaneousEjUser,associate/ejStatus
