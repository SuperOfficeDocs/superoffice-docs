...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/postAddress/wgs84latitude,contact/restrictionAddress/wgs84latitude,contact/NumberOfNotCompletedActivitiesInPeriod,person/personId,appointmentUdef/SuperOffice:6
