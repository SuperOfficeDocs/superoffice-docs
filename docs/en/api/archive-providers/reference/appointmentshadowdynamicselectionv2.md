...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=getAllRows,contact/contactNoMail,contact/email/emailProtocol,contact/contactAssociate/simultaneousEjUser,contact/contactExtra/x_contact_time
