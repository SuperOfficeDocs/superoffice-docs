...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/LastDoByActivity,contact/NumberOfSales,person/ticketPriority,project/projectAssociate/associateDbId,sale/associate/userName
