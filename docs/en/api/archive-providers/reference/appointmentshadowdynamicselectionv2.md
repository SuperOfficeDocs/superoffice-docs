...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionV2?$select=contact/number,contact/streetAddress/wgs84longitude,contact/contactAssociate/ejStatus,project/NumberOfNotCompletedActivitiesInPeriod,sale/currency
