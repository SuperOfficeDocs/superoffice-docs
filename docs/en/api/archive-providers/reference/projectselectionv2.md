...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=updatedBy,appointment/appointmentUdef/SuperOffice:7,appointment/associate/credentialType,document/associate/personId,projectMember/postAddress/addressId
