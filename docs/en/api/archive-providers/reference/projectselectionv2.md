...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=description,registeredByFullName,sale/sale/description,appointment/appointment/titleHtml,projectMember/personCategory
