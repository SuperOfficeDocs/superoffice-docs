...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=appointment/registeredDate,document/associate/middleName,document/associate/assocTooltip,projectMember/leadstatusRank,projectMember/correspondingAssociate/isActiveText
