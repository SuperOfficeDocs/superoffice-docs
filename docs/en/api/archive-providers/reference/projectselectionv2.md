...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=sale/stageId,sale/associate/contactName,appointment/duration,appointment/createdByWorkflow,appointment/associate/fullName
