...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=statusRank,projectMember/personAddress/city,projectMember/personUdef/SuperOffice:2,projectMember/personAssociate/lastName,projectMember/activeErpLinks
