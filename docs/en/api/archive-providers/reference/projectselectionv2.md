...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/ejUserId,projectAssociate/locationAddress,projectUdef/SuperOffice:9,sale/saleUdef/SuperOffice:1,document/associate/fullName
