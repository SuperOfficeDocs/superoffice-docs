...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/portraitThumbnail,sale/earningPercent,sale/nextDueDate,sale/salePublish/publishedTo,sale/associate/assocName
