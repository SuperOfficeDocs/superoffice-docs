...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=name,projectAssociate/ejDisplayName,sale/saleUdef/SuperOffice:7,projectMember/deletedDate,projectMember/contactExtra/x_contact_contact
