...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=endDate,NumberOfNotCompletedActivities,sale/saleNumber,document/updatedByFullName,document/associate/personId
