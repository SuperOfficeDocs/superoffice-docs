...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=sale/associate/credentialDisplayValue,projectMember/personUpdatedByFullName,projectMember/personDirectPhone/description,projectMember/personAddress/wgs84longitude,projectMember/restrictionAddress/formattedMultiLineAddress
