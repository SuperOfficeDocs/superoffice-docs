...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=status,appointment/appointmentPublish/publishedFrom,appointment/associate/personEmail,document/registeredDate,document/subject
