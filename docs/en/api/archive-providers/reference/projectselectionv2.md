...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=registeredDate,appointment/associate/ejDisplayName,projectMember/hasInfoText,projectMember/personExtra/x_person_integer,projectMember/updatedByFullName
