...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=imageThumbnail,projectAssociate/associateDbId,projectAssociate/contactDepartment,sale/associateId,sale/createdByWorkflow
