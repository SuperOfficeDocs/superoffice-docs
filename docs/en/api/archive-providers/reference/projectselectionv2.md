...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/firstName,projectAssociate/isActive,projectAssociate/portraitThumbnail,appointment/associate/contactId,document/associate/isActive
