...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=SaintStatus3,appointment/isMilestone,document/personId,projectMember/infoText,projectMember/portraitThumbnail
