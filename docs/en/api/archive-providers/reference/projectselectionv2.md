...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=registeredDate,projectEvent/hasSignOn,projectAssociate/usergroup,projectAssociate/userName,sale/associate/associateDbId
