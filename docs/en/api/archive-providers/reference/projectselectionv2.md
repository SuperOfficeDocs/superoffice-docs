...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/usergroup,projectAssociate/otherGroups,sale/associate/assocName,appointment/appointmentUdef/SuperOffice:6,appointment/associate/assocName
