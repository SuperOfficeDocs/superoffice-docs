...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/personId,sale/visibleFor,appointment/who,appointment/associate/contactId,document/personId
