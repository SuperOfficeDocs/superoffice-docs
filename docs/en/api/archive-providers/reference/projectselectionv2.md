...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=getNoRows,appointment/alarm,projectMember/birthDay,projectMember/kanaLastName,projectMember/restrictionAddress/addressId
