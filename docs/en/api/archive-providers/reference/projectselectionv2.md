...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/personEmail,appointment/who,projectMember/personExtra/x_person_priority_relation,projectMember/contactAssociate/assocTooltip
