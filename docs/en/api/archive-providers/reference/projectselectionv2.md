...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectPublish/isPublished,projectAssociate/firstName,appointment/intention,appointment/associate/contactName,appointment/associate/userName
