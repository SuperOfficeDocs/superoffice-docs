...
```http!
GET /api/v1/archive/ProjectSelectionV2?$select=projectAssociate/contactDepartment,sale/saleTypeId,sale/associate/usergroupId,sale/associate/credentialDisplayValue,appointment/createdByWorkflow
