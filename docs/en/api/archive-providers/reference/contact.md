...
```http!
GET /api/v1/archive/Contact?$select=hasInterests,contactFax/description,contactSupportPerson/personAssociateFullName,contactSupportPerson/personExtra/x_person_datetime,contactUdef/SuperOffice:6
