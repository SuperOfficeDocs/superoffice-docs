...
```http!
GET /api/v1/archive/Contact?$select=email/emailAddress,contactAssociate/portraitThumbnail,contactSupportAssociate/isLocation,contactSupportPerson/personExtra/x_person_shorttext_list
