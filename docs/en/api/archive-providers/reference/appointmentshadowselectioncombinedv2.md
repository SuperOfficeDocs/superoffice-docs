...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/postAddress/wgs84latitude,contact/streetAddress/line2,contact/contactAssociate/contactId,contact/contactExtra/x_contact_time,contact/saintDirection
