...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/contactAssociate/personEmail,person/consentSourceStore,project/name,project/projectPublish/publishedBy
