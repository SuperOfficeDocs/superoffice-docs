...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/saintTicketStatus,person/personPrivate/description,project/projectAssociate/role,sale/associate/isActive,associate/associateDbId
