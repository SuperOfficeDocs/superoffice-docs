...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/contactAssociate/lastName,person/rank,person/personUdef/SuperOffice:3,project/saintTicketCategory,sale/currency
