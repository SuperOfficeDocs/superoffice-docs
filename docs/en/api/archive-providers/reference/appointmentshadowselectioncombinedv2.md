...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=rawStatus,person/personAddress/line2,person/correspondingAssociate/simultaneousEjUser,project/projectAssociate/isActiveText,sale/type
