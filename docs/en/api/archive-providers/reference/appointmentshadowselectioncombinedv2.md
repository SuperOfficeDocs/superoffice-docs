...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=invitedPersonId,person/restrictionAddress/line1,person/personUdef/SuperOffice:10,sale/saleStatus
