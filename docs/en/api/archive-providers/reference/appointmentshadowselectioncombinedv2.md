...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=saleId,registeredDate,contact/contactExtra/x_contact_date,person/personUdef/SuperOffice:2,sale/salePublish/publishedTo
