...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/contactPhone/formattedNumber,contact/contactUdef/SuperOffice:9,contact/LastTicket,contact/SaintStatus1,person/personExtra/x_person_datetime
