...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/contactAssociate/locationAddress,person/retired,person/personAddress/wgs84latitude,person/restrictionAddress/formattedMultiLineAddress,person/personExtra/x_person_datetime
