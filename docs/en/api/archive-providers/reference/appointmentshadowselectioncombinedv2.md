...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=person/personExtra/x_person_hidden_integer,project/projectAssociate/otherGroups,sale/projectId
