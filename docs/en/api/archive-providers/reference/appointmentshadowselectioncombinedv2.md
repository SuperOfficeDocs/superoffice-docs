...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/contactAssociate/assocName,person/restrictionAddress/zip,sale/earning,associate/otherGroups
