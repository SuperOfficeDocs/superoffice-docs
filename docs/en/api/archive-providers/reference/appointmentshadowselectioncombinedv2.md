...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/restrictionAddress/state,project/updatedBy,project/saintDirection,sale/date,sale/hasStakeholders
