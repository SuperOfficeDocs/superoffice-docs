...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/updatedDate,person/hasInfoText,person/personDirectPhone/description,person/personInfo/infoText,person/restrictionAddress/line1
