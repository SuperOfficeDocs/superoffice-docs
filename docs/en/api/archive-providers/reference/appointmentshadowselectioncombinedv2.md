...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=person/personExtra/y_rental/x_contact,person/correspondingAssociate/isActive,sale/personId,associate/firstName,appointment/textId
