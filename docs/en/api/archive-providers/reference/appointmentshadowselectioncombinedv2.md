...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/hasInterests,contact/saintIntention,person/birthMonth,person/personRegisteredBy,person/personAssociate/personId
