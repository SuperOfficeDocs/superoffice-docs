...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=time,contact/category,person/personUrl/URLAddress,person/personAssociate/usergroup,sale/type
