...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/contactAssociate/role,contact/contactExtra/x_contact_timespan,person/rank,person/personUpdatedBy,person/personAddress/line2
