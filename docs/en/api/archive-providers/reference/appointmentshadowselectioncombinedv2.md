...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=rawType,contact/restrictionAddress/line2,contact/contactUdef/SuperOffice:1,person/rank,person/email/emailBounceCount
