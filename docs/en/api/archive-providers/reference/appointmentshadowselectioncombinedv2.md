...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/restrictionAddress/addressId,contact/contactAssociate/ejStatus,contact/contactExtra/x_contact_longtext,person/mrMrs,project/projectAssociate/usergroup
