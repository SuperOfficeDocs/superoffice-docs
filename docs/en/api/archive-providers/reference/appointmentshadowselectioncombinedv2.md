...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=rawStatus,visibleFor,contact/registeredDate,project/registeredBy,project/projectAssociate/lastName
