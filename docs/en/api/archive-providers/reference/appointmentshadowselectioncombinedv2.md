...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=time,contact/country,person/correspondingAssociate/usergroup,sale/stageRank,sale/associate/assocName
