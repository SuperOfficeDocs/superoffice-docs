...
```http!
GET /api/v1/archive/AppointmentShadowSelectionCombinedV2?$select=contact/streetAddress/addressId,contact/contactUdef/SuperOffice:7,project/projectAssociate/role
