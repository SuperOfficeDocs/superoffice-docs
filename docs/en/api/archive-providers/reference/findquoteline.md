...
```http!
GET /api/v1/archive/FindQuoteLine?$select=status,alternative/status,alternative/vatAmount,alternative/version/extraField5,alternative/version/quote/sale/person/correspondingAssociate/contactCategory
