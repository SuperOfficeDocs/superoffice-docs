...
```http!
GET /api/v1/archive/FindQuoteLine?$select=quoteAlternativeId,totalPrice,productFamilyKey,alternative/version/quote/sale/person/personExtra/x_person_float,alternative/version/quote/sale/person/hasStoreConsent
