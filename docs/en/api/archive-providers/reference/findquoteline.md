...
```http!
GET /api/v1/archive/FindQuoteLine?$select=discountAmount,alternative/version/extraField4,alternative/version/quote/sale/stageId,alternative/version/quote/sale/createdByWorkflow,alternative/version/quote/sale/contact/hasInterests
