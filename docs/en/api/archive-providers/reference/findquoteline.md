...
```http!
GET /api/v1/archive/FindQuoteLine?$select=quoteLineId,alternative/version/quote/sale/updatedBy,alternative/version/quote/sale/person/legalBaseEmarketing,alternative/version/quote/sale/person/consentSourceEmarketing,alternative/version/quote/sale/contact/code
