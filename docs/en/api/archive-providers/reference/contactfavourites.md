...
```http!
GET /api/v1/archive/contactfavourites?$select=restrictionAddress/wgs84longitude,contactSupportPerson/personExtra/y_rental/x_contact,contactAssociate/mrMrs
