...
```http!
GET /api/v1/archive/contactfavourites?$select=contactSupportAssociate/ejStatus,contactSupportAssociate/isLocation,contactExtra/x_contact_contact_relation
