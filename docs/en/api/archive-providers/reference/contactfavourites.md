...
```http!
GET /api/v1/archive/contactfavourites?$select=restrictionPostalAddress/state,contactAssociate/fullName,contactAssociate/contactName,contactAssociate/role,contactSupportPerson/withdrawnEmarketingConsent
