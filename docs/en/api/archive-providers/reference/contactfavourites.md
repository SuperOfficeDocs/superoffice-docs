...
```http!
GET /api/v1/archive/contactfavourites?$select=entityIcon,email/emailBounceCount,restrictionAddress/line2,contactAssociate/credentialType,contactExtra/x_contact_contact_relation
