...
```http!
GET /api/v1/archive/contactfavourites?$select=postAddress/line1,streetAddress/state,streetAddress/wgs84latitude,contactSupportPerson/personExtra/y_rental/id,contactUdef/SuperOffice:8
