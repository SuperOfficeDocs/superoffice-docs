...
```http!
GET /api/v1/archive/contactfavourites?$select=streetAddress/wgs84latitude,contactSupportAssociate/personEmail,contactSupportPerson/personUpdatedByFullName,contactSupportPerson/personInfo/infoText
