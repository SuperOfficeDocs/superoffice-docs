...
```http!
GET /api/v1/archive/contactfavourites?$select=phone/formattedNumber,contactAssociate/userName,contactSupportPerson/isMailingRecipient,NumberOfActivitiesInPeriod
