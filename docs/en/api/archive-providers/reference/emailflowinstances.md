...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=emailFlow/workflowAssociate/contactCategory,person/hasInfoText,person/birthMonth,person/createdByForm,person/restrictionAddress/line3
