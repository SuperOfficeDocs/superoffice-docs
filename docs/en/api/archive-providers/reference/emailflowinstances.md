...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=emailFlow/workflowAssociate/personEmail,person/personHasInterests,person/email/emailDescription,person/personAssociate/isActive,contact/contactPhone/description
