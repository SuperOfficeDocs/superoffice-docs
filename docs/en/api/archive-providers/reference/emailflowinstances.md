...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=updatedBy,emailFlow/workflowCompletedCount,person/associateType,person/personActiveErpLinks,person/personMobilePhone/formattedNumber
