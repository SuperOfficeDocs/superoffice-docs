...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=person/kanaLastName,person/personRegisteredDate,person/personAddress/addressId,person/personExtra/x_person_datetime,person/hasEmarketingConsent
