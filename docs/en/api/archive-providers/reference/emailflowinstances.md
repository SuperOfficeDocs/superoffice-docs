...
```http!
GET /api/v1/archive/EmailFlowInstances?$select=person/personDeletedDate,person/personPrivate/description,person/personAssociate/personEmail,contact/contactAssociate/ejDisplayName
