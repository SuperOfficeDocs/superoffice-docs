...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=heading,earningPercent,person/leadstatusRank,person/isStakeholder,person/personExtra/x_person_time
