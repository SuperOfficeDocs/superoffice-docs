...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=originalStage,person/hasInfoText,person/personAddress/city,contact/postAddress/county,associate/contactDepartment
