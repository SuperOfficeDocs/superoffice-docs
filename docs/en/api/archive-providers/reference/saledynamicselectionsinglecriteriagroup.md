...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=amountWeightedInBaseCurrency,contact/email/emailId,contact/LastDoByTicket,appointment/date,document/documentUdef/SuperOffice:5
