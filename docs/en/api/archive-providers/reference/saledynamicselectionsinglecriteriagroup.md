...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=soldReason,contact/postAddress/county,contact/contactAssociate/ejUserId,associate/contactFullName,project/saintDirection
