...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=personId,person/personDirectPhone/description,contact/email/emailHasBounced,contact/SaintStatus2,appointment/saleId
