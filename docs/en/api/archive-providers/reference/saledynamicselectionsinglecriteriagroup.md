...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=reopenDate,person/personRegisteredByFullName,contact/updatedBy,contact/searchPhone/description,saleStakeholder/person/personDirectFax/description
