...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=earning,person/personUdef/SuperOffice:8,person/personAssociate/credentialType,appointment/date,appointment/rawType
