...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=sale/textId,salePublish/isPublished,person/restrictionAddress/line3,person/personExtra/x_person_category_relation,associate/ejStatus
