...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=getAllRows,description,contact/email/emailProtocol,contact/restrictionAddress/zip,appointment/associateId
