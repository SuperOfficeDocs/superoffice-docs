...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/middleName,person/correspondingAssociate/portraitThumbnail,contact/searchPhone/description,document/contactId,saleStakeholder/person/personExtra/y_rental/x_end
