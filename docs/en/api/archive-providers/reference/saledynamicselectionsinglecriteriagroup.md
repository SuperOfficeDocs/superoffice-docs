...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/contactDepartment,saleUdef/SuperOffice:6,appointment/visibleFor,document/associate/firstName,project/projectUdef/SuperOffice:5
