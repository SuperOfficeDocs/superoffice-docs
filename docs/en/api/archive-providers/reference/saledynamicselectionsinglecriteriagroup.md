...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=person/personNumber,contact/contactUdef/SuperOffice:8,document/text,document/associate/simultaneousEjUser,saleStakeholder/person/personDirectFax/formattedNumber
