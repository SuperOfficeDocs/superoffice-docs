...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=person/whenUpdatedByWorkflow,person/personAssociate/usergroup,contact/updatedBy,contact/NumberOfNotCompletedTicketsInPeriod,document/contactId
