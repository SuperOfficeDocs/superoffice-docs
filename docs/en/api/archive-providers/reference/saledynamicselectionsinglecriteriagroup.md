...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=person/personMobilePhone/description,person/personDirectFax/description,person/correspondingAssociate/isLocation,contact/NumberOfActivitiesInPeriod,saleUdef/SuperOffice:5
