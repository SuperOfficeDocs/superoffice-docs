...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=personId,person/associateType,person/personUdef/SuperOffice:4,person/personExtra/y_car/id,person/personAssociate/mrMrs
