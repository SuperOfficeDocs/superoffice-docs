...
```http!
GET /api/v1/archive/SaleDynamicSelectionSingleCriteriaGroup?$select=userGroup,person/portraitThumbnail,person/correspondingAssociate/assocTooltip,person/withdrawnEmarketingConsent,contact/restrictionAddress/county
