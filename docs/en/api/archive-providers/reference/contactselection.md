...
```http!
GET /api/v1/archive/ContactSelection?$select=saintActivityType,sourceRelation/category,targetRelation/companyCategoryRank,appointment/registeredByFullName,appointment/duration
