...
```http!
GET /api/v1/archive/ContactSelection?$select=country,postAddress/city,streetAddress/zip,NumberOfNotCompletedActivitiesInPeriod,targetRelation/registeredByFullName
