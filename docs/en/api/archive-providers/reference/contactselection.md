...
```http!
GET /api/v1/archive/ContactSelection?$select=contactAssociate/contactFullName,contactExtra/x_contact_contact_relation,LastCompletedTicket,SaintStatus2,sale/text
