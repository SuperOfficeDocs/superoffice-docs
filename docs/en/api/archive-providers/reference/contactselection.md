...
```http!
GET /api/v1/archive/ContactSelection?$select=postAddress/addressId,sale/activeErpLinks,sale/associate/assocType,appointment/associate/assocTooltip,appointment/appointment/internalNotesHtml
