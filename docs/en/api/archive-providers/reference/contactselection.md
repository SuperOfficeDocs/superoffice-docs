...
```http!
GET /api/v1/archive/ContactSelection?$select=department,url/URLAddress,NumberOfNotCompletedTicketsInPeriod,sourceRelation/registeredByFullName,sale/amountWeightedInBaseCurrency
