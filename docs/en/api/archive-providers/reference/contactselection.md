...
```http!
GET /api/v1/archive/ContactSelection?$select=contactFax/description,contactExtra/x_contact_dropdown,sourceRelation/mainContact,sale/amountWeighted,sale/saleUdef/SuperOffice:2
