...
```http!
GET /api/v1/archive/ContactSelection?$select=streetAddress/addressId,streetAddress/line2,contactExtra/x_contact_contact_relation,sale/updatedDate,sale/saleUdef/SuperOffice:5
