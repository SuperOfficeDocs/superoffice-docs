...
```http!
GET /api/v1/archive/ContactSelection?$select=NumberOfSales,sourceRelation/registeredDate,sale/associate/contactCategory,sale/associate/ejStatus,appointment/associate/assocType
