...
```http!
GET /api/v1/archive/ContactSelection?$select=contactAssociate/contactCategory,targetRelation/hasInterests,sale/source,appointment/associate/personId,appointment/associate/title
