...
```http!
GET /api/v1/archive/ContactSelection?$select=postAddress/city,sale/contactId,appointment/associate/ejStatus,document/recordType,document/associate/personEmail
