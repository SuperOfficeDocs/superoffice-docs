...
```http!
GET /api/v1/archive/ContactSelection?$select=contactId,targetRelation/registeredByFullName,sale/userGroup,sale/associate/ejStatus,appointment/associate/locationAddress
