...
```http!
GET /api/v1/archive/ContactSelection?$select=sale/amountWeighted,sale/saleTypeId,sale/reopenDate,appointment/priority,appointment/suggestedAppointmentId
