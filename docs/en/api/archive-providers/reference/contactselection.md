...
```http!
GET /api/v1/archive/ContactSelection?$select=appointment/associate/userName,document/registeredBy,personAssociateFullName,hasCompany,personUdef/SuperOffice:5
