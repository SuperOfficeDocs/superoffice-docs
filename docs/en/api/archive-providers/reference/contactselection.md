...
```http!
GET /api/v1/archive/ContactSelection?$select=postAddress/line3,contactAssociate/contactName,contactExtra/x_contact_contact_relation,sale/text,sale/associate/lastName
