...
```http!
GET /api/v1/archive/ContactSelection?$select=updatedByFullName,contactExtra/x_contact_contact,sale/amountWeighted,supportAssociateFullName,hasEmarketingConsent
