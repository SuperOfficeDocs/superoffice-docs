...
```http!
GET /api/v1/archive/ContactSelection?$select=contactFax/formattedNumber,sale/source,sale/amountInBaseCurrency,appointment/recordType,appointment/appointment/titleHtml
