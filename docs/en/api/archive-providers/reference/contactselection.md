...
```http!
GET /api/v1/archive/ContactSelection?$select=sourceRelation/activeErpLinks,sale/stage,sale/associate/associateDbId,document/associate/personId,document/associate/isActiveText
