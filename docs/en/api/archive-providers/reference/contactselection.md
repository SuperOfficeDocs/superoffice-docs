...
```http!
GET /api/v1/archive/ContactSelection?$select=contactAssociate/assocType,appointment/updatedByFullName,appointment/recurring,appointment/associate/personEmail,document/keywords
