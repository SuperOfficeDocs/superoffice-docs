...
```http!
GET /api/v1/archive/ContactSelection?$select=sale/associate/contactName,sale/associate/personEmail,lastName,personSourceRelation/personDeletedDate,personTargetRelation/personCategoryRank
