...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionV2?$select=PriceUnitSubscriptionQuantityUnit,updatedDate,alternative/extraField5,alternative/alternativeOrdering,alternative/subTotal
