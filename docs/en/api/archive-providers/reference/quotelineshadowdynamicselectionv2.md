...
```http!
GET /api/v1/archive/QuoteLineShadowDynamicSelectionV2?$select=getNoRows,alternative/version/deliveryType,alternative/version/quote/sale/projectId,alternative/version/quote/sale/person/personSource,alternative/version/quote/sale/contact/contactExtra/x_contact_boolean
