...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=registeredDate,recordTypeText,person/personPager/description,person/personExtra/x_person_shorttext_list,person/correspondingAssociate/contactId
