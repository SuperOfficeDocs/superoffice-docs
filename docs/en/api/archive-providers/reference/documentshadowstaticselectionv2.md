...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/email/emailId,person/email/emailLastBounce,person/personUrl/URLAddress,contact/streetAddress/wgs84longitude,project/NumberOfSalesInPeriod
