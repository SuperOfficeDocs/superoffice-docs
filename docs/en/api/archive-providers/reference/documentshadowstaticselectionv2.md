...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/supportAssociate,contact/contactId,project/nextMilestone,project/NumberOfActivitiesInPeriod,associate/middleName
