...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/supportAssociate,person/supportAssociateFullName,contact/updatedBy,contact/contactExtra/x_contact_datetime,project/NumberOfActivities
