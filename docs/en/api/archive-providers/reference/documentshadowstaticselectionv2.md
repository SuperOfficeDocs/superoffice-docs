...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personPager/description,person/personExtra/y_rental/x_contact,contact/postAddress/line3,sale/updatedDate,sale/salePublish/publishedTo
