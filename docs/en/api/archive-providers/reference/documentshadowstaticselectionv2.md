...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=registeredBy,person/createdByForm,person/personAssociate/assocTooltip,contact/SaintStatus2,project/NumberOfActivitiesInPeriod
