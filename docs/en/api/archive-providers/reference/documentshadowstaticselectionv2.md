...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personInfo/textId,contact/activeErpLinks,contact/contactInterestIds,project/NumberOfNotCompletedSalesInPeriod,sale/nextDueDate
