...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=recordTypeText,person/personBusiness,person/personPager/description,person/personAssociate/credentialType,person/correspondingAssociate/title
