...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personExtra/x_person_contact_relation,contact/streetAddress/zip,project/projectAssociate/isActive,sale/associate/fullName
