...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=getNoRows,contact/contactExtra/x_contact_integer,associate/title,associate/role,sale/associate/contactCategory
