...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/ticketPriority,person/personUdef/SuperOffice:11,person/personAssociate/ejStatus,person/legalBaseStore,person/consentSourceEmarketing
