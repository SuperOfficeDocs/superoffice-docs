...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=documentPublish/publishedBy,contact/streetAddress/city,contact/streetAddress/wgs84longitude,project/projectUdef/SuperOffice:4
