...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=saleId,documentPublish/publishedBy,person/portraitThumbnail,person/personExtra/y_rental/id,person/personExtra/y_rental/y_equipment/x_name
