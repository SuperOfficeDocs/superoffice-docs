...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personUpdatedDate,person/personAddress/line1,contact/registeredDate,contact/contactAssociate/usergroup,contact/LastTicket
