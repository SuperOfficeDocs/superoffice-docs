...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=contact/registeredDate,contact/contactAssociate/credentialType,contact/contactAssociate/locationAddress,project/type,associate/fullName
