...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=getAllRows,person/personPrivate/formattedNumber,person/personAddress/zip,contact/postAddress/line2,contact/saintTicketStatus
