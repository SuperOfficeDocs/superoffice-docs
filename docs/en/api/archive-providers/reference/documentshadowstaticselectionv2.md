...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/supportAssociateFullName,contact/contactExtra/x_contact_boolean,associate/assocTooltip,sale/stage
