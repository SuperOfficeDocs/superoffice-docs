...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=getAllRows,contact/postAddress/line3,contact/NumberOfNotCompletedActivitiesInPeriod,project/projectAssociate/isLocation
