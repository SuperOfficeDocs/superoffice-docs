...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personAddress/city,person/legalBaseStore,contact/business,contact/phone/formattedNumber,project/projectUdef/SuperOffice:2
