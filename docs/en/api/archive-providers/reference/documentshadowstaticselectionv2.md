---
uid: DocumentShadowStaticSelectionV2
title: DocumentShadowStaticSelectionV2
description: Shadow contact provider for the static Document provider.
keywords: DocumentShadowStaticSelectionV2 archive provider
generated: true
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionStaticProviderV2">SuperOffice.CRM.ArchiveLists.Archive.DocumentShadowSelectionStaticProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/restrictionAddress/line2,contact/companyCategoryRank,contact/email/emailLastBounce,contact/contactUdef/SuperOffice:1,contact/contactExtra/x_contact_integer
