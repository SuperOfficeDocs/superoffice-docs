...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=documentPublish/publishedBy,person/personHasInterests,person/personDirectFax/description,person/personUdef/SuperOffice:5,person/personExtra/x_person_shorttext
