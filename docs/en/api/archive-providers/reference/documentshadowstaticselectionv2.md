...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personExtra/y_rental/x_amount,person/personAssociate/ejDisplayName,contact/contactExtra/x_contact_datetime,contact/LastDoByTicket,project/updatedBy
