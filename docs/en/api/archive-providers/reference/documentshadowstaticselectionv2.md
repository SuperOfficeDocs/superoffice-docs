...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personUdef/SuperOffice:5,contact/department,contact/contactAssociate/firstName,project/name,project/saintDirection
