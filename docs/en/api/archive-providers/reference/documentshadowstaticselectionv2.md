...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/personExtra/y_rental/x_amount,contact/contactAssociate/contactName,contact/contactAssociate/ejUserId,project/updatedBy
