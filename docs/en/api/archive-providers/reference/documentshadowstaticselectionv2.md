...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/correspondingAssociate/userName,person/legalBaseEmarketing,associate/contactCategory,sale/associate/personEmail
