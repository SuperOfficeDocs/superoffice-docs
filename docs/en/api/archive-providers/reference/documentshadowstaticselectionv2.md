...
```http!
GET /api/v1/archive/DocumentShadowStaticSelectionV2?$select=person/hasInterests,person/email/emailLastBounce,contact/contactAssociate/assocTooltip,project/icon,project/projectAssociate/credentialType
