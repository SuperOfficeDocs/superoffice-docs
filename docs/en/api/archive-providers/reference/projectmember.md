...
```http!
GET /api/v1/archive/ProjectMember?$select=project/description,person/personRegisteredBy,person/personAssociate/isActiveText,person/personAssociate/otherGroups,person/correspondingAssociate/role
