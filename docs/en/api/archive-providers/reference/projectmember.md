...
```http!
GET /api/v1/archive/ProjectMember?$select=project/projectEvent/hasSignOn,project/NumberOfNotCompletedSalesInPeriod,person/birthdate,person/personPager/formattedNumber,contact/searchPhone/description
