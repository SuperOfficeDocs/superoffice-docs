...
```http!
GET /api/v1/archive/ProjectMember?$select=updated,project/projectPublish/publishedTo,project/projectAssociate/personId,person/personAddress/state,contact/contactFax/description
