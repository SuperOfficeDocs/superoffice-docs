...
```http!
GET /api/v1/archive/ProjectMember?$select=project/number,project/projectAssociate/usergroup,person/personExtra/x_person_date,person/personAssociate/personId,person/correspondingAssociate/usergroupId
