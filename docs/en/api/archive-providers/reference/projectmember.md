...
```http!
GET /api/v1/archive/ProjectMember?$select=personId,project/updatedDate,project/projectUdef/SuperOffice:3,project/NumberOfNotCompletedSalesInPeriod,person/firstName
