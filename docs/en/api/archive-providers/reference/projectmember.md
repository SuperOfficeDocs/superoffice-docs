...
|projectMemberId|int|Project member ID: Database ID of project member record| x |
...
```http!
GET /api/v1/archive/ProjectMember?$select=project/projectUdef/SuperOffice:8,person/personUdef/SuperOffice:1,person/correspondingAssociate/usergroupId,person/correspondingAssociate/ejDisplayName,contact/streetAddress/formattedMultiLineAddress
