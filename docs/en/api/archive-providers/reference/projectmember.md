...
```http!
GET /api/v1/archive/ProjectMember?$select=person/restrictionAddress/line2,person/restrictionAddress/line3,contact/contactAssociate/credentialType,contact/NumberOfNotCompletedActivitiesInPeriod
