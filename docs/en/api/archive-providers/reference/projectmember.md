...
```http!
GET /api/v1/archive/ProjectMember?$select=person/personAssociate/usergroup,contact/postAddress/city,contact/postAddress/wgs84latitude,contact/contactAssociate/otherGroups
