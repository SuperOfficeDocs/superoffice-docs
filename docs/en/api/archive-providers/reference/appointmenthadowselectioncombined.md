...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=registeredBy,person/title,person/personDirectPhone/formattedNumber,person/withdrawnStoreConsent,appointmentUdef/SuperOffice:4
