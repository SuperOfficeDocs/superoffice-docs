...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/contactAssociate/isLocation,contact/saintIntention,person/email/emailAddress,person/email/emailId,sale/description
