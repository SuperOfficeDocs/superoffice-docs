...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/SaintStatus1,person/correspondingAssociate/otherGroups,sale/associate/contactDepartment,associate/ejDisplayName
