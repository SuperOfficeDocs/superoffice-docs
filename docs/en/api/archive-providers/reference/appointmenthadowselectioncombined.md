...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/email/emailHasBounced,contact/restrictionAddress/formattedAddress,contact/contactAssociate/lastName,contact/contactAssociate/fullName,person/personExtra/y_rental/id
