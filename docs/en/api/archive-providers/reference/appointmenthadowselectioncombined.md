...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=updatedByFullName,suggestedAppointmentId,project/projectAssociate/middleName,project/projectAssociate/associateDbId
