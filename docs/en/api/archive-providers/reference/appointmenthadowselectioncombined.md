...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=type,contact/contactUdef/SuperOffice:8,contact/contactExtra/x_contact_boolean,person/kanaLastName,person/supportLanguage
