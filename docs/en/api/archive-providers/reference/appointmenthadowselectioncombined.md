...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=saleId,contact/contactAssociate/isActive,person/email/emailLastSent,person/personAddress/state,project/projectAssociate/firstName
