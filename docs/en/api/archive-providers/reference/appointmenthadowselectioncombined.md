...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/email/emailLastBounce,contact/contactInterestIds,contact/saintDirection,person/birthdate,person/restrictionAddress/formattedAddress
