...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=updatedDate,location,contact/streetAddress/wgs84longitude,contact/restrictionAddress/city,person/personHasInterests
