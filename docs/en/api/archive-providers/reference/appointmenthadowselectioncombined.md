...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=recordType,contact/country,contact/contactExtra/y_organization/x_name,person/hasInfoText,person/correspondingAssociate/fullName
