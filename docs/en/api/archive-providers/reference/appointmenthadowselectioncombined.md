...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=project/projectAssociate/credentialType,sale/saleType,sale/associate/lastName,appointment/title
