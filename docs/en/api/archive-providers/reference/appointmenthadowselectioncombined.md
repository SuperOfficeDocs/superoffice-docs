...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=getNoRows,userGroup,appointmentPublish/isPublished,contact/NumberOfActivitiesInPeriod,project/projectPublish/publishedFrom
