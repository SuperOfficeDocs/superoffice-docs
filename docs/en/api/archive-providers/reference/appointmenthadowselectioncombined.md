...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=getNoRows,contact/hasInfoText,person/personAddress/wgs84longitude,person/personAssociate/contactId,person/personAssociate/usergroup
