...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/contactExtra/y_organization/x_name,contact/LastCompletedSale,person/personAssociateId,person/personUdef/SuperOffice:9,associate/lastName
