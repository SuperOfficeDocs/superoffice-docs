...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=booking,person/personCategory,person/searchPhone/formattedNumber,person/correspondingAssociate/personId,appointmentUdef/SuperOffice:4
