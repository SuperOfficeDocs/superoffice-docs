...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contactId,person/lastName,person/personPager/description,person/email/emailDescription,person/personAssociate/credentialDisplayValue
