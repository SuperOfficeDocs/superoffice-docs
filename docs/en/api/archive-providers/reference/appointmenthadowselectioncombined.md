...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/streetAddress/line1,person/lastName,person/middleName,person/supportAssociate,project/NumberOfActivitiesInPeriod
