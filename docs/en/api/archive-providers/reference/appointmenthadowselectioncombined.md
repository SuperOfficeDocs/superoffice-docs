...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/SaintStatus2,contact/saintAmountClass,person/personAssociate/isLocation,project/projectPublish/publishedTo,project/projectUrl/URLAddress
