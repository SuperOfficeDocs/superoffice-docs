...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=person/restrictionAddress/wgs84longitude,person/correspondingAssociate/contactFullName,sale/registeredBy,sale/registeredByFullName,selectionMemberId
