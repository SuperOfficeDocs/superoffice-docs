...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/SaintStatus1,person/personNumber,person/birthdate,project/text,project/projectAssociate/role
