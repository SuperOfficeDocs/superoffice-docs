...
```http!
GET /api/v1/archive/AppointmenthadowSelectionCombined?$select=contact/NumberOfNotCompletedTicketsInPeriod,person/personAssociateId,person/personAssociate/usergroup,person/correspondingAssociate/firstName,associate/title
