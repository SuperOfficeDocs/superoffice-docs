...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/personSource,person/restrictionAddress/formattedMultiLineAddress,person/personUdef/SuperOffice:8,contact/business
