...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=formSubmissionEmail,contactId,recordTypeText,person/lastName,contact/email/emailBounceCount
