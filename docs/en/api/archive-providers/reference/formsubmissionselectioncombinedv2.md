...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/personAssociate/title,person/correspondingAssociate/title,contact/NumberOfActivitiesInPeriod
