...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=updatedBy,person/mrMrs,person/useAsMailingAddress,contact/contactAssociate/simultaneousEjUser,contact/contactExtra/x_contact_date
