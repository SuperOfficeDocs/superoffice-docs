...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=associate/personEmail,person/firstName,person/personActiveErpLinks,person/personAddress/wgs84longitude,person/personExtra/x_person_time
