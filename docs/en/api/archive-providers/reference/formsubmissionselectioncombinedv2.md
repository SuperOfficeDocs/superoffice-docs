...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/restrictionAddress/formattedMultiLineAddress,person/personAssociate/title,person/restrictionAddress/zip
