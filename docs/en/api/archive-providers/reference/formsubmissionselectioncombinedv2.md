...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/middleName,person/personAddress/line2,contact/email/emailLastSent,contact/contactAssociate/isActiveText,contact/saintTicketCategory
