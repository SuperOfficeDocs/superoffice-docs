...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=associate/firstName,person/restrictionAddress/line2,person/correspondingAssociate/assocName,person/consentSourceStore,contact/contactNoMail
