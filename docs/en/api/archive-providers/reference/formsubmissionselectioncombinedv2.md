...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/personDirectPhone/formattedNumber,person/personExtra/y_rental/y_equipment/x_name,person/restrictionAddress/state
