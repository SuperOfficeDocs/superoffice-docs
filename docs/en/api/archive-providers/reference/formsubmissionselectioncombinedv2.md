...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/correspondingAssociate/isLocation,contact/saintTicketStatus,person/restrictionAddress/zip
