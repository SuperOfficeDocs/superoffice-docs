...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/personUdef/SuperOffice:7,contact/contactFax/description,person/restrictionAddress/zip
