...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/associateType,person/personAddress/formattedMultiLineAddress,contact/NumberOfNotCompletedActivitiesInPeriod
