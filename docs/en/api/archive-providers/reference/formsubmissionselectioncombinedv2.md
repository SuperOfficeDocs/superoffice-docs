...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=person/personAssociate/assocType,person/correspondingAssociate/contactCategory,person/restrictionAddress/zip
