...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=getNoRows,associate/personId,associate/ejDisplayName,person/personCountryId,person/phone/formattedNumber
