...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=associate/usergroup,person/birthDay,person/personExtra/y_rental/x_contact,contact/contactAssociate/ejDisplayName
