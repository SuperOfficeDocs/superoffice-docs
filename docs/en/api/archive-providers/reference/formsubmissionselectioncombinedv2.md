...
```http!
GET /api/v1/archive/FormSubmissionSelectionCombinedV2?$select=formSubmissionStatus,person/personExtra/x_person_boolean,person/personExtra/y_rental/x_start,contact/department,contact/streetAddress/county
