...
```http!
GET /api/v1/archive/FreetextAppointment?$select=intention,contact/email/emailLastSent,person/restrictionAddress/wgs84latitude,person/correspondingAssociate/ejUserId,appointmentUdef/SuperOffice:8
