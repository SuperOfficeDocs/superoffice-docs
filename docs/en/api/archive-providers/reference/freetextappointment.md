...
```http!
GET /api/v1/archive/FreetextAppointment?$select=getNoRows,contact/postAddress/zip,person/restrictionAddress/line2,person/personExtra/y_rental/x_start,sale/salePublish/publishedTo
