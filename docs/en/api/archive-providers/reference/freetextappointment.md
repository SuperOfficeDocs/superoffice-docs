...
```http!
GET /api/v1/archive/FreetextAppointment?$select=isFree,contact/streetAddress/county,person/personUdef/SuperOffice:3,person/personAssociate/ejUserId,sale/associate/contactFullName
