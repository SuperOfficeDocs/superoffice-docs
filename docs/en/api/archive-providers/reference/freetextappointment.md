...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/postAddress/line1,contact/postAddress/wgs84longitude,person/personExtra/y_rental/x_contact,project/projectAssociate/associateDbId,sale/associate/contactFullName
