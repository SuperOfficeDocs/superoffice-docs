...
| Name | Description |
| ---- | ----- |
|"appointment"|[[SR_SINGULAR_ACTIVITY]]|
...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/contactAssociate/contactDepartment,person/personUpdatedBy,project/registeredByFullName,project/hasGuide,sale/stalledComment
