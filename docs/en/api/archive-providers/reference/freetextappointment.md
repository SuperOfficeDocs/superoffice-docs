...
```http!
GET /api/v1/archive/FreetextAppointment?$select=type,contact/streetAddress/line3,contact/contactUdef/SuperOffice:9,contact/contactExtra/x_contact_longtext,contact/NumberOfNotCompletedActivitiesInPeriod
