...
```http!
GET /api/v1/archive/FreetextAppointment?$select=person/personId,person/hasInterests,person/personPrivate/description,person/personExtra/x_person_datetime,person/personAssociate/usergroup
