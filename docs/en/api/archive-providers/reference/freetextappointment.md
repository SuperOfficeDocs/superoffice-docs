...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/contactAssociate/isActiveText,contact/saintActivityType,person/personCountryId,person/personUrl/URLDescription,person/personExtra/x_person_user_relation
