...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/restrictionAddress/county,person/legalBaseEmarketing,project/completed,project/projectAssociate/associateDbId,sale/associate/contactId
