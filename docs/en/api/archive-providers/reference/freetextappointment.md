...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/activeErpLinks,person/position,person/email/emailBounceCount,project/projectAssociate/locationAddress
