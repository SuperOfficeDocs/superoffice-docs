...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/registeredBy,contact/contactInterestIds,person/kanaLastName,project/projectAssociate/title,project/projectUdef/SuperOffice:4
