...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/number,contact/email/emailAddress,person/contactId,person/personSource,person/supportAssociateFullName
