...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/contactUdef/SuperOffice:5,contact/contactUdef/SuperOffice:12,appointmentUdef/SuperOffice:4,project/saintTicketCategory,sale/activeErpLinks
