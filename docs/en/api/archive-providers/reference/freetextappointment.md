...
```http!
GET /api/v1/archive/FreetextAppointment?$select=time,contact/contactExtra/x_contact_date,contact/NumberOfTickets,person/personExtra/x_person_datetime,project/description
