...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/contactAssociate/locationAddress,contact/contactExtra/x_contact_contact,contact/SaintStatus2,person/associateType,person/isStakeholder
