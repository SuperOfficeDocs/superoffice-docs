...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/postAddress/wgs84longitude,person/personAddress/line2,person/personUdef/SuperOffice:6,project/registeredBy,sale/associate/credentialDisplayValue
