...
```http!
GET /api/v1/archive/FreetextAppointment?$select=contact/contactId,person/personUpdatedDate,appointmentUdef/SuperOffice:6,project/nextMilestone,project/endDate
