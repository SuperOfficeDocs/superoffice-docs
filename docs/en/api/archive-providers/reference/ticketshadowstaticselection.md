...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=createdBy/isActiveText,createdBy/locationAddress,contact/postAddress/line1,contact/contactExtra/x_contact_float,extra/x_ticket_boolean
