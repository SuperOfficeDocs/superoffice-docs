...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=realTimeSpentInternally,person/birthDay,contact/updatedDate,contact/searchPhone/formattedNumber,contact/postAddress/city
