...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=createdBy/personId,person/hasCompany,contact/postAddress/formattedMultiLineAddress,contact/streetAddress/line2,contact/saintTicketCategory
