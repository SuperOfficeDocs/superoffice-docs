...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=ownedBy/associateDbId,person/birthdate,person/correspondingAssociate/credentialDisplayValue,sale/type,sale/salePublish/publishedFrom
