...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=person/birthDay,person/correspondingAssociate/assocTooltip,extra/x_ticket_timespan,project/projectAssociate/contactId,project/NumberOfNotCompletedSales
