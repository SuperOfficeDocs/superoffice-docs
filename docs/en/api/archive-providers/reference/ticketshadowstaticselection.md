...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=person/personExtra/x_person_appointment_relation,extra/x_ticket_time,project/projectUdef/SuperOffice:4
