...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=person/personId,person/personDirectFax/formattedNumber,person/personUdef/SuperOffice:3,contact/orgnr,contact/contactAssociate/otherGroups
