...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=ownedBy/assocType,person/personUdef/SuperOffice:2,contact/associateId,contact/contactAssociate/middleName,contact/contactUdef/SuperOffice:10
