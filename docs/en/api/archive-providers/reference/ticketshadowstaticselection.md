...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=readStatus,person/firstName,person/personUdef/SuperOffice:9,person/correspondingAssociate/usergroup,contact/postAddress/zip
