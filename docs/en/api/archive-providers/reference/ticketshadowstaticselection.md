...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=firstReadByUser,person/kanaLastName,person/email/emailLastSent,person/personAddress/formattedMultiLineAddress,person/legalBaseEmarketing
