...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=createdBy/usergroupId,person/supportAssociate,person/personAssociateId,extra/y_equipment/x_name,sale/stageRank
