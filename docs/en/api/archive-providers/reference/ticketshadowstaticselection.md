...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=createdBy/lastName,createdBy/personEmail,ownedBy/contactCategory,person/personUpdatedDate,person/personExtra/x_person_priority_relation
