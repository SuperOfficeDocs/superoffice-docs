...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=personId,createdBy/credentialType,createdBy/isActiveText,person/email/emailBounceCount,person/personAddress/wgs84latitude
