...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=contact/postAddress/wgs84longitude,contact/restrictionAddress/wgs84latitude,sale/daysInStage,sale/associate/isActiveText,project/associateId
