...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=readStatus,ownedBy/personId,person/personPager/description,person/personAddress/formattedMultiLineAddress,person/personExtra/x_person_priority_relation
