...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=priorityName,person/personUdef/SuperOffice:2,person/correspondingAssociate/associateDbId,contact/contactFax/formattedNumber
