...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=repliedAt,createdBy/assocName,createdBy/credentialType,person/consentSourceEmarketing,contact/contactAssociate/otherGroups
