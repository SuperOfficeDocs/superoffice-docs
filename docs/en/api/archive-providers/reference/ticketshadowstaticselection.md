...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=person/searchPhone/description,person/personUdef/SuperOffice:1,person/consentSourceEmarketing,sale/time,project/updatedByFullName
