...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=ownedBy,timeToClose,person/personExtra/x_person_appointment_relation,person/isMailingRecipient,contact/postAddress/wgs84longitude
