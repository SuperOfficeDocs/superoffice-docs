...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=createdBy/title,createdBy/userName,ownedBy/assocTooltip,person/personExtra/y_rental/y_equipment/x_name,contact/contactInterestIds
