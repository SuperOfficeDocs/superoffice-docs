...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=categoryFullName,person/ticketPriority,person/personExtra/y_rental/x_contact,person/personAssociate/firstName,person/correspondingAssociate/role
