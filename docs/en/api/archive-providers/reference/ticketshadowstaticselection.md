...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=createdBy/assocTooltip,person/personSource,person/supportAssociateFullName,person/personUrl/URLAddress,contact/activeErpLinks
