...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=timeToClose,createdBy/associateDbId,person/lastName,person/searchPhone/formattedNumber,person/personAssociate/simultaneousEjUser
