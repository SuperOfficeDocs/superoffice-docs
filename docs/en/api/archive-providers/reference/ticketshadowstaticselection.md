...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=createdBy/lastName,person/personMobilePhone/description,person/personExtra/x_person_category_relation,extra/x_ticket_timespan,extra/x_ticket_timestamp
