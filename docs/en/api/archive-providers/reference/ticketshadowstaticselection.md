...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=person/personExtra/x_person_appointment_relation,contact/email/emailId,contact/saintActivityType,project/projectPublish/publishedBy
