...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=readByCustomer,contact/registeredByFullName,contact/contactAssociate/associateDbId,project/NumberOfSalesInPeriod
