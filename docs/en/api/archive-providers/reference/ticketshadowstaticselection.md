...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=ticketPriority/name,contact/phone/formattedNumber,contact/url/URLAddress,project/projectEvent/hasSignOn,project/projectAssociate/middleName
