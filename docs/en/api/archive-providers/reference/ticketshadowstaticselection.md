...
```http!
GET /api/v1/archive/TicketShadowStaticSelection?$select=ownedBy/contactFullName,person/correspondingAssociate/usergroupId,person/correspondingAssociate/userName,sale/type,project/updatedDate
