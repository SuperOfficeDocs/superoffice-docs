...
|contactIsSatellite| *None* |SR\_ADMIN\_SYSTEM\_COMPANIES\_ACTIVE\_SATELLITES|  |
|numberOfAssociates| *None* |SR\_ADMIN\_SYSTEM\_COMPANIES\_ASSOCIATES|  |
...
```http!
GET /api/v1/archive/OwnerContacts?$select=contactAssociate/contactName,contactSupportPerson/supportAssociate,contactSupportPerson/subscription
