...
```http!
GET /api/v1/archive/OwnerContacts?$select=getAllRows,contactSupportPerson/birthMonth,contactSupportPerson/supportAssociateFullName,contactSupportPerson/createdByForm
