...
```http!
GET /api/v1/archive/OwnerContacts?$select=code,contactSupportPerson/personNumber,contactSupportPerson/hasCompany,contactSupportPerson/whenUpdatedByWorkflow
