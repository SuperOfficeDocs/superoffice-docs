...
```http!
GET /api/v1/archive/OwnerContacts?$select=contactAssociate/assocName,contactSupportAssociate/isActive,contactUdef/SuperOffice:4,LastDoByActivity,NumberOfTicketsInPeriod
