...
```http!
GET /api/v1/archive/OwnerContacts?$select=streetAddress/line3,restrictionAddress/wgs84longitude,contactSupportAssociate/assocType,contactSupportAssociate/credentialDisplayValue
