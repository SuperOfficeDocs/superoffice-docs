...
```http!
GET /api/v1/archive/OwnerContacts?$select=contactSupportPerson/supportAssociateFullName,contactSupportPerson/personCategoryGroup,contactSupportPerson/leadstatusRank,NumberOfNotCompletedTicketsInPeriod
