...
```http!
GET /api/v1/archive/ProjectGuide?$select=projectId,appointmentInstance/sale/saleUdef/SuperOffice:3,documentInstance/documentUdef/SuperOffice:4,documentInstance/sale/currency
