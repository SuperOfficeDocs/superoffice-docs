...
```http!
GET /api/v1/archive/ProjectGuide?$select=appointmentInstance/person/restrictionAddress/formattedMultiLineAddress,appointmentInstance/person/personExtra/x_person_timespan,appointmentInstance/person/personAssociate/contactFullName,appointmentInstance/person/correspondingAssociate/fullName,appointmentInstance/sale/completed
