...
```http!
GET /api/v1/archive/ProjectGuide?$select=appointmentInstance/appointmentPublish/publishedTo,appointmentInstance/contact/updatedByFullName,appointmentInstance/contact/contactSource,appointmentInstance/contact/contactExtra/x_contact_date,appointmentInstance/person/personAddress/county
