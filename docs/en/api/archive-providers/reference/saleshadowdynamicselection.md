...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=soldReason,person/correspondingAssociate/middleName,project/text,project/LastCompletedSale,saleStakeholder/person/personUdef/SuperOffice:10
