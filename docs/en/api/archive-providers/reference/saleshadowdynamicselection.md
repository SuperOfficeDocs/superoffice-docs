...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=saleNumber,person/personExtra/y_car/id,contact/email/emailLastBounce,contact/contactAssociate/middleName,contact/contactUdef/SuperOffice:4
