...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/personAddress/city,person/personExtra/y_rental/x_contact,contact/categoryGroup,contact/postAddress/zip,appointment/priority
