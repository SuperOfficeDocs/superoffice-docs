...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=salePublish/publishedBy,person/hasInterests,person/personNoMail,person/searchPhone/description,person/email/emailLastBounce
