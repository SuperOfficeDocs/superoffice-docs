...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=contact/contactAssociate/usergroup,contact/contactUdef/SuperOffice:11,associate/assocType,appointment/endDate,appointment/associate/personId
