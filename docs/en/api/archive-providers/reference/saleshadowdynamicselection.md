...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/personAddress/zip,person/correspondingAssociate/middleName,person/correspondingAssociate/assocName,person/consentSourceStore,appointment/priority
