...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=saleTypeCategory,person/personNumber,person/email/emailLastSent,person/personAddress/county,person/personAssociate/personId
