...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/hasCompany,person/personExtra/x_person_shorttext,contact/registeredByFullName,contact/contactUdef/SuperOffice:10,document/registeredBy
