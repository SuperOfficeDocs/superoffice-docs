...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/email/emailLastSent,document/associate/middleName,document/associate/assocType,project/startDate,saleStakeholder/person/legalBaseEmarketing
