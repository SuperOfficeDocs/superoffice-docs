...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/firstName,contact/registeredBy,contact/contactAssociate/fullName,contact/contactUdef/SuperOffice:12,associate/fullName
