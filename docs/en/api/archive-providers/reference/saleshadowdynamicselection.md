...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/personInfo/textId,person/isMailingRecipient,contact/hasInfoText,contact/updatedDate,appointment/appointmentUdef/SuperOffice:3
