...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/isStakeholder,person/personPager/formattedNumber,contact/contactAssociate/contactFullName,saleUdef/SuperOffice:2,project/eventId
