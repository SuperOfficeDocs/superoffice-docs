...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/position,person/personExtra/x_person_integer,contact/LastTicket,contact/saintActivityType,appointment/registeredDate
