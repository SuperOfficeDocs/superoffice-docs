...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=source,person/isStakeholder,person/correspondingAssociate/ejDisplayName,contact/postAddress/line2,appointment/suggestedAppointmentId
