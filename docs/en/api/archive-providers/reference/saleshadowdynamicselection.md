...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=rowKind,person/kanaLastName,person/correspondingAssociate/contactId,appointment/text,appointment/associate/contactName
