...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=getNoRows,person/fullName,person/personUdef/SuperOffice:7,person/correspondingAssociate/portraitThumbnail,appointment/priority
