...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/correspondingAssociate/lastName,contact/hasInterests,contact/streetAddress/formattedAddress,contact/contactAssociate/otherGroups,document/associate/contactFullName
