...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=selectionId,person/email/emailProtocol,person/restrictionAddress/line3,person/legalBaseEmarketing,contact/contactAssociate/assocType
