...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=credited,person/correspondingAssociate/assocName,contact/restrictionAddress/wgs84longitude,contact/contactUdef/SuperOffice:10,associate/title
