...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=person/personDeletedDate,contact/streetAddress/county,contact/contactAssociate/title,associate/personId,appointment/associate/contactDepartment
