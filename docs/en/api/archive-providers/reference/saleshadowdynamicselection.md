...
```http!
GET /api/v1/archive/SaleShadowDynamicSelection?$select=updatedDate,earning,person/supportAssociate,person/personExtra/x_person_boolean,person/personExtra/x_person_priority_relation
