...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/version/quote/sale/probPercent,alternative/version/number,alternative/version/quote/sale/userGroup
