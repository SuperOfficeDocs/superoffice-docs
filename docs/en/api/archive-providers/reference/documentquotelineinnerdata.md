...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/quoteVersionId,alternative/version/quote/sale/registeredByFullName,alternative/version/quote/sale/associate/userName
