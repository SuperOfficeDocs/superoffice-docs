...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/version/extraField2,alternative/version/quote/sale/associate/personId,alternative/version/number
