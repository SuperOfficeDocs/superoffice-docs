...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/version/quote/sale/visibleFor,alternative/version/expiration,alternative/version/quote/sale/updatedByFullName
