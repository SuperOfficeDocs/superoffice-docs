...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=unitListPrice,alternative/version/quote/sale/associate/isActiveText,alternative/version/expiration
