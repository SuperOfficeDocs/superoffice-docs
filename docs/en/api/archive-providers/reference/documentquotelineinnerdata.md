...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/erpDiscountPercent,alternative/version/quote/orderComment,alternative/version/quote/sale/associate/fullName
