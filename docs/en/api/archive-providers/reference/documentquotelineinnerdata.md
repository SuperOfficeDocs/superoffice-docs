...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/version/quote/sale/associate/contactName,alternative/version/number,alternative/version/quote/sale/userGroup
