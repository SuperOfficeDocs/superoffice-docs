...
```http!
GET /api/v1/archive/DocumentQuoteLineInnerData?$select=alternative/version/deliveryType,alternative/version/quote/sale/currencyId,alternative/version/quote/sale/hasStakeholders
