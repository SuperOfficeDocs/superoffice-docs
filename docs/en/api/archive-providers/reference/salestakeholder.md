...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personUdef/SuperOffice:1,person/personExtra/x_person_user_relation,person/correspondingAssociate/simultaneousEjUser
