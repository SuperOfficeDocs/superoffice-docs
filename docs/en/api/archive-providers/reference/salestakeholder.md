...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personAddress/formattedMultiLineAddress,contact/contactId,contact/restrictionAddress/wgs84longitude,contact/contactUdef/SuperOffice:7
