...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/restrictionAddress/wgs84longitude,contact/deletedDate,contact/contactPhone/formattedNumber,contact/contactAssociate/contactCategory
