...
```http!
GET /api/v1/archive/SaleStakeholder?$select=contact/restrictionAddress/formattedAddress,person/personExtra/x_person_category_relation,person/correspondingAssociate/ejDisplayName
