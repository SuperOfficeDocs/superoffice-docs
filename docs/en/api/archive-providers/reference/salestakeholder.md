...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personMobilePhone/formattedNumber,person/restrictionAddress/formattedMultiLineAddress,contact/contactExtra/x_contact_contact_relation
