...
|saleStakeholderId|int|SR\_STAKEHOLDER\_ID: SR\_STAKEHOLDER\_ID\_TOOLTIP| x |
|saleId|int|SR\_SALE\_ID: SR\_SALE\_ID\_TOOLTIP| x |
|comment|string|SR\_STAKEHOLDERS\_ROLE\_COMMENT\_TEXT: SR\_STAKEHOLDERS\_ROLE\_COMMENT\_TEXT| x |
|salesRoleId|listAny|SR\_STAKEHOLDERS\_ROLE: SR\_STAKEHOLDERS\_ROLE| x |
|hasInfoText|bool|SR\_STAKEHOLDERS\_ROLE\_COMMENT: SR\_STAKEHOLDERS\_ROLE\_COMMENT| x |
...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/isStakeholder,contact/contactUdef/SuperOffice:8,person/personExtra/x_person_user_relation
