...
```http!
GET /api/v1/archive/SaleStakeholder?$select=comment,person/firstName,person/personRegisteredDate,person/personPrivate/description,person/personUdef/SuperOffice:7
