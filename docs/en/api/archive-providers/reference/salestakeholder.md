...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/portraitThumbnail,person/whenUpdatedByWorkflow,person/email/emailProtocol,person/correspondingAssociate/assocType,contact/contactUdef/SuperOffice:3
