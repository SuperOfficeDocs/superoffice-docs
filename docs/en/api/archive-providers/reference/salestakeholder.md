...
```http!
GET /api/v1/archive/SaleStakeholder?$select=saleId,person/personBusiness,person/correspondingAssociate/assocType,contact/email/emailAddress,contact/postAddress/line2
