...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personCategory,person/restrictionAddress/line1,person/personExtra/x_person_integer,contact/LastDoByTicket
