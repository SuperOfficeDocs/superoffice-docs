...
```http!
GET /api/v1/archive/SaleStakeholder?$select=contact/contactUdef/SuperOffice:8,contact/contactUdef/SuperOffice:12,person/personExtra/x_person_user_relation
