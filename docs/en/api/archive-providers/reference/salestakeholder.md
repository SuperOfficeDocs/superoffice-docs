...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personUpdatedDate,person/email/emailLastSent,person/personExtra/x_person_float,person/personAssociate/isActive,contact/restrictionAddress/zip
