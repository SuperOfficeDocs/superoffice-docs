...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personExtra/x_person_float,person/personAssociate/credentialType,contact/contactAssociate/otherGroups
