...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/restrictionAddress/wgs84longitude,person/withdrawnStoreConsent,contact/stop,contact/deletedDate,contact/contactPhone/formattedNumber
