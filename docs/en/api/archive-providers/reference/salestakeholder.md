...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personDirectPhone/formattedNumber,person/personAddress/state,person/personAssociate/portraitThumbnail,contact/country,contact/activeErpLinks
