...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/kanaFirstName,person/personExtra/x_person_user_relation,person/correspondingAssociate/simultaneousEjUser
