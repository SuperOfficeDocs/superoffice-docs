...
```http!
GET /api/v1/archive/SaleStakeholder?$select=person/personExtra/x_person_request_relation,contact/contactAssociate/firstName,contact/contactAssociate/role,contact/contactExtra/x_contact_integer
