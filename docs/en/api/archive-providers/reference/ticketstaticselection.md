...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=createdAt,ownedBy/fullName,person/personDeletedDate,contact/country,contact/contactAssociate/ejDisplayName
