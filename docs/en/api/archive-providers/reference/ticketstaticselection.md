...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/personUdef/SuperOffice:5,person/correspondingAssociate/isActiveText,person/correspondingAssociate/userName,contact/email/emailId,contact/streetAddress/city
