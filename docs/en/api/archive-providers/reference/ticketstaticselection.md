...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=priorityName,createdBy,person/birthMonth,person/personAssociate/personId,person/personAssociate/ejDisplayName
