...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=timeToReply,person/personRegisteredByFullName,contact/contactNoMail,contact/contactAssociate/usergroupId,contact/contactAssociate/isActive
