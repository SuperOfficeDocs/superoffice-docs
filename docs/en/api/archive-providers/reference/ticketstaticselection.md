...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=createdBy/personId,person/updatedByWorkflow,person/restrictionAddress/county,person/personUdef/SuperOffice:1,contact/contactUdef/SuperOffice:4
