...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=createdBy/credentialDisplayValue,contact/registeredByFullName,contact/contactUdef/SuperOffice:8,contact/contactExtra/x_contact_float,contact/saintTicketStatus
