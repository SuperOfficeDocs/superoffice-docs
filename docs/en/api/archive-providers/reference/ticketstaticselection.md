...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/hasInfoText,contact/postAddress/county,contact/contactAssociate/assocTooltip,extra/x_ticket_timespan,sale/saleUdef/SuperOffice:3
