...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=ticketPriority/rank,person/title,contact/postAddress/city,project/updatedBy,project/projectAssociate/mrMrs
