...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=ownedBy/ejDisplayName,person/personUrl/URLDescription,sale/stalledComment,project/projectAssociate/credentialDisplayValue
