...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=contactId,saleId,person/email/emailProtocol,person/personAssociate/isActive,person/correspondingAssociate/otherGroups
