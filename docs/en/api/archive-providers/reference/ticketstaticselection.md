...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=status,sentimentScore,contact/restrictionAddress/addressId,contact/contactAssociate/contactCategory,contact/contactAssociate/assocName
