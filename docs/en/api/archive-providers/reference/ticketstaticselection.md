...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=getAllRows,ownedBy/contactId,ownedBy/personId,person/personInfo/infoText,person/personAssociate/ejUserId
