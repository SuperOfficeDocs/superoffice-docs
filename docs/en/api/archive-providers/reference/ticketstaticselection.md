...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=categoryId,ownedBy/title,person/personRegisteredDate,person/personExtra/y_rental/x_contact,person/personAssociate/assocTooltip
