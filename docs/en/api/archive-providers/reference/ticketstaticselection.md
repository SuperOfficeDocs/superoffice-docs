...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=createdBy/role,person/title,person/personUpdatedBy,person/supportAssociateFullName,person/email/emailProtocol
