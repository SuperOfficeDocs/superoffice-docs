...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/firstName,person/personAssociateFullName,contact/postAddress/zip,sale/saleUdef/SuperOffice:3,project/projectAssociate/title
