...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=timeSpentInternally,person/firstName,person/personDirectPhone/description,contact/contactUdef/SuperOffice:13,sale/heading
