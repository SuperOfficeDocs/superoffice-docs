...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=createdBy/middleName,person/isStakeholder,person/personExtra/x_person_float,person/correspondingAssociate/firstName,contact/postAddress/wgs84longitude
