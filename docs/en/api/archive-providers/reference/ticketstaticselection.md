...
keywords: TicketStaticSelection archive provider
so.generated: true
so.topic: reference
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionStaticProvider">SuperOffice.CRM.ArchiveLists.Archive.TicketSelectionStaticProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/personAddress/wgs84longitude,person/restrictionAddress/line3,person/correspondingAssociate/middleName,person/correspondingAssociate/userName,contact/contactExtra/x_contact_time
