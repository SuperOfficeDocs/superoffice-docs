...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=getNoRows,person/personInfo/infoText,person/email/emailDescription,person/personAssociate/associateDbId,person/correspondingAssociate/isActiveText
