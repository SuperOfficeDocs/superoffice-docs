...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/correspondingAssociate/contactName,person/correspondingAssociate/assocType,contact/contactAssociate/personEmail,sale/nextDueDate
