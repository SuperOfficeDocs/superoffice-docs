...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=numberOfReplies,createdBy/isLocation,ownedBy/isActiveText,project/projectId,project/projectAssociate/contactDepartment
