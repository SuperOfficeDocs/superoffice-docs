...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=repliedAt,ownedBy/simultaneousEjUser,contact/restrictionAddress/addressId,contact/contactAssociate/middleName,contact/contactUdef/SuperOffice:6
