...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=sentimentScore,createdBy/firstName,person/email/emailBounceCount,person/personAddress/formattedAddress,person/consentSourceStore
