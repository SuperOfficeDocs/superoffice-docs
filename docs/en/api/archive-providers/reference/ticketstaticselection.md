...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=ownedBy/ejStatus,person/personSource,person/email/emailLastSent,sale/nextDueDate,sale/salePublish/publishedBy
