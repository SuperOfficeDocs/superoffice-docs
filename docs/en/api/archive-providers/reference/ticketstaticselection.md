...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=activated,createdBy/contactDepartment,person/firstName,person/personAddress/line1,person/personUdef/SuperOffice:6
