...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=createdBy/role,person/hasInterests,person/restrictionAddress/state,person/personExtra/x_person_date,person/personAssociate/fullName
