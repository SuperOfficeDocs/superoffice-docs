...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/personId,person/personInfo/textId,person/personUdef/SuperOffice:4,person/personExtra/y_rental/x_contact,person/legalBaseStore
