...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=person/restrictionAddress/county,person/personExtra/y_rental/x_end,contact/updatedDate,contact/contactUdef/SuperOffice:6,sale/currencyId
