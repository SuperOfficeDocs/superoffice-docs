...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=ownedBy/assocTooltip,ownedBy/portraitThumbnail,person/personAddress/formattedAddress,contact/email/emailProtocol,contact/contactAssociate/assocName
