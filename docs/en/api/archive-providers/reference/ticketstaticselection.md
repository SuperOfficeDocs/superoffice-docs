...
```http!
GET /api/v1/archive/TicketStaticSelection?$select=contact/associateId,contact/contactUdef/SuperOffice:3,contact/contactExtra/x_contact_integer,contact/NumberOfNotCompletedActivities,sale/icon
