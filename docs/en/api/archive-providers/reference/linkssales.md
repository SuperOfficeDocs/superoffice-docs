...
```http!
GET /api/v1/archive/LinksSales?$select=person/personExtra/x_person_time,person/personExtra/x_person_contact_relation,person/personAssociate/isActive,contact/name,contact/postAddress/wgs84latitude
