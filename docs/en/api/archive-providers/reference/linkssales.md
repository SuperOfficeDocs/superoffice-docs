...
```http!
GET /api/v1/archive/LinksSales?$select=person/personPager/formattedNumber,person/personAddress/line2,contact/restrictionAddress/county,contact/LastActivity,project/icon
