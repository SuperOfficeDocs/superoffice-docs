...
```http!
GET /api/v1/archive/LinksSales?$select=sourceSelectionRestrictionId,contact/restrictionAddress/line3,contact/restrictionAddress/city,contact/contactAssociate/contactCategory,associate/isActiveText
