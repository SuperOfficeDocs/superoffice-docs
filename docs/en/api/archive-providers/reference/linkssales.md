...
```http!
GET /api/v1/archive/LinksSales?$select=person/personUpdatedBy,person/personExtra/x_person_time,contact/contactExtra/x_contact_date,associate/contactDepartment,project/updatedByFullName
