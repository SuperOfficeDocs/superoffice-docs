...
```http!
GET /api/v1/archive/LinksSales?$select=person/contactId,contact/business,contact/contactPhone/formattedNumber,contact/email/emailLastBounce,contact/NumberOfActivities
