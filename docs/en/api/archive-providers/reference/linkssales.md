...
```http!
GET /api/v1/archive/LinksSales?$select=contactId,source,person/personCategory,person/personInfo/infoText,contact/restrictionAddress/formattedMultiLineAddress
