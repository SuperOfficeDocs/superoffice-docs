...
```http!
GET /api/v1/archive/LinksSales?$select=person/personBusiness,person/correspondingAssociate/contactId,project/nextMilestone,project/NumberOfSales,saleStakeholder/person/personRegisteredBy
