...
```http!
GET /api/v1/archive/LinksSales?$select=contact/contactNoMail,contact/contactAssociate/contactCategory,contact/NumberOfNotCompletedActivities,saleUdef/SuperOffice:1,project/projectAssociate/isActiveText
