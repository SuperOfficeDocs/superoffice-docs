...
```http!
GET /api/v1/archive/LinksSales?$select=contact/orgnr,contact/stop,contact/contactAssociate/usergroup,associate/personId,saleStakeholder/person/personNoMail
