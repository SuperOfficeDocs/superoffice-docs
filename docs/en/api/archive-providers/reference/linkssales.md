...
```http!
GET /api/v1/archive/LinksSales?$select=linkId,person/personNumber,project/projectEvent/hasSignOn,project/project/textId,saleStakeholder/contact/updatedByFullName
