...
```http!
GET /api/v1/archive/Links?$select=contact/url/URLDescription,contact/contactUdef/SuperOffice:1,person/personAddress/line1,person/personAssociate/associateDbId,project/registeredBy
