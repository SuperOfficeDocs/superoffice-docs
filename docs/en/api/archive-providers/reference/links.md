...
```http!
GET /api/v1/archive/Links?$select=personId,contact/contactAssociate/assocType,person/supportAssociateFullName,person/restrictionAddress/line2,person/restrictionAddress/state
