...
```http!
GET /api/v1/archive/Links?$select=person/personAssociate/role,person/correspondingAssociate/mrMrs,project/projectUrl/URLAddress,project/LastSale,sale/saleType
