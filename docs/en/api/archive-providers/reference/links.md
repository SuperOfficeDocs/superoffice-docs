...
```http!
GET /api/v1/archive/Links?$select=sourceSaleRestrictionId,contact/email/emailLastBounce,person/birthdate,person/supportAssociate,person/restrictionAddress/line3
