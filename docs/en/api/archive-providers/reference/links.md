...
```http!
GET /api/v1/archive/Links?$select=suggestedAppointmentId,contact/registeredDate,contact/contactAssociate/contactDepartment,contact/contactAssociate/assocName,project/projectEvent/hasSignOn
