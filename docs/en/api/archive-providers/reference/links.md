...
```http!
GET /api/v1/archive/Links?$select=contact/contactAssociate/credentialDisplayValue,contact/contactExtra/x_contact_boolean,person/correspondingAssociate/isActive,project/projectAssociate/portraitThumbnail,sale/associate/contactDepartment
