...
```http!
GET /api/v1/archive/Links?$select=appointmentId,contact/postAddress/county,contact/contactUdef/SuperOffice:8,contact/contactExtra/x_contact_longtext,person/personExtra/x_person_appointment_relation
