...
```http!
GET /api/v1/archive/Links?$select=person/correspondingAssociate/usergroup,person/correspondingAssociate/assocTooltip,project/LastDoByActivity,sale/saleUdef/SuperOffice:2,saleUdef/SuperOffice:7
