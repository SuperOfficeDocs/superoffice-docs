...
```http!
GET /api/v1/archive/Links?$select=contact/registeredBy,contact/streetAddress/line3,contact/contactExtra/x_contact_boolean,contact/NumberOfNotCompletedTicketsInPeriod,person/personUdef/SuperOffice:1
