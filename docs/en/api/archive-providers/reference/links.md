...
```http!
GET /api/v1/archive/Links?$select=contact/postAddress/wgs84longitude,contact/contactAssociate/personEmail,contact/NumberOfSales,person/phone/formattedNumber,person/personDirectFax/formattedNumber
