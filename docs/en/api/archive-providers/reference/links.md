...
```http!
GET /api/v1/archive/Links?$select=person/personNoMail,person/personRegisteredByFullName,person/supportLanguage,person/isStakeholder,person/correspondingAssociate/personEmail
