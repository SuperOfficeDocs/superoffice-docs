...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personExtra/x_person_contact_relation,person/restrictionAddress/line3,person/personAssociate/userName
