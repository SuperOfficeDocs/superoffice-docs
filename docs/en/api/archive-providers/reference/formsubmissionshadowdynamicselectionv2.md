...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/associateType,person/searchPhone/formattedNumber,contact/number,contact/postAddress/line2
