...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/rank,person/personMobilePhone/formattedNumber,contact/searchPhone/formattedNumber
