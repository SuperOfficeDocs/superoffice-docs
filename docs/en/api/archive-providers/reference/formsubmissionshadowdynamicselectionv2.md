...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=associate/ejUserId,person/ticketPriority,person/personAddress/county,contact/orgnr,contact/streetAddress/addressId
