...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/position,person/kanaLastName,person/whenUpdatedByWorkflow,person/personPrivate/description,contact/deletedDate
