...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=contact/contactAssociate/isActiveText,contact/contactAssociate/personEmail,person/restrictionAddress/city
