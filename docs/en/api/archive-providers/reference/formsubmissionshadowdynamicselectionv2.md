...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=contact/streetAddress/wgs84latitude,person/restrictionAddress/county,person/personAssociate/personEmail
