...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personMobilePhone/description,person/email/emailBounceCount,person/correspondingAssociate/userName
