...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/hasEmarketingConsent,contact/email/emailHasBounced,contact/postAddress/city,contact/contactAssociate/associateDbId
