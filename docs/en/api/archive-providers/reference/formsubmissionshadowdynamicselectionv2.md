...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/kanaFirstName,person/correspondingAssociate/title,contact/contactPhone/formattedNumber
