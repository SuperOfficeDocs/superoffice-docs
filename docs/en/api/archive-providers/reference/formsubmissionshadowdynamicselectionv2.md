...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=personId,person/personUdef/SuperOffice:1,person/personExtra/y_car/id,contact/number,contact/streetAddress/line2
