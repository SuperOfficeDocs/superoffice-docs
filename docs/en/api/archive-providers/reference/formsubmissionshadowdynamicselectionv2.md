...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=associate/middleName,contact/streetAddress/line2,contact/NumberOfNotCompletedActivitiesInPeriod,contact/saintTicketStatus
