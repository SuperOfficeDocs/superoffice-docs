...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=contact/categoryGroup,contact/postAddress/wgs84longitude,person/restrictionAddress/line3
