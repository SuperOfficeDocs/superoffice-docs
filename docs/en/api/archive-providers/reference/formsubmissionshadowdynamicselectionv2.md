...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personDirectFax/formattedNumber,person/searchPhone/description,person/personAssociate/role,contact/updatedBy,contact/NumberOfSalesInPeriod
