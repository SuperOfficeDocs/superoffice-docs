...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=icon,person/personAssociate/usergroup,contact/contactAssociate/contactId,contact/contactAssociate/contactFullName
