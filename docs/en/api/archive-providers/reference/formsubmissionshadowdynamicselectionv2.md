...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/position,person/personCountry,person/personRegisteredBy,person/personExtra/y_rental/id,contact/contactAssociate/fullName
