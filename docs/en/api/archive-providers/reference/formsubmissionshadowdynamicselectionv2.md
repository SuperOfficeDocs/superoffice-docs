---
uid: FormSubmissionShadowDynamicSelectionV2
...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=associate/personEmail,person/personSource,person/personExtra/x_person_appointment_relation,person/correspondingAssociate/credentialType,person/correspondingAssociate/locationAddress
