...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=registeredBy,associate/credentialDisplayValue,associate/personEmail,associate/locationAddress
