...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/correspondingAssociate/lastName,contact/contactAssociate/ejUserId,person/restrictionAddress/city
