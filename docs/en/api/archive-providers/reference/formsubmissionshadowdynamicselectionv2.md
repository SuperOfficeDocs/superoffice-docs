...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personAddress/wgs84longitude,contact/business,contact/contactAssociate/lastName
