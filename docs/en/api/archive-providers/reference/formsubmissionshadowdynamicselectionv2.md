...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=formSubmissionId,person/personUrl/URLAddress,person/restrictionAddress/county,person/personAssociate/assocName,person/correspondingAssociate/ejDisplayName
