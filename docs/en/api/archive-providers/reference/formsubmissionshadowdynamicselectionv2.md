...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=contact/postAddress/line2,contact/contactAssociate/portraitThumbnail,contact/contactAssociate/userName,contact/LastCompletedSale
