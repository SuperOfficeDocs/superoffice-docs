...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personAssociate/simultaneousEjUser,person/hasStoreConsent,contact/streetAddress/county,contact/contactUdef/SuperOffice:8,contact/contactExtra/x_contact_hidden_integer
