...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/retired,person/personAssociate/ejUserId,contact/NumberOfNotCompletedTicketsInPeriod
