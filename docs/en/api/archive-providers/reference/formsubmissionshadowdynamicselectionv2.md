...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personCountryId,person/personExtra/x_person_longtext,contact/email/emailAddress,contact/streetAddress/formattedMultiLineAddress
