...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=updatedBy,associate/portraitThumbnail,person/personExtra/y_car/id,person/personAssociate/assocName
