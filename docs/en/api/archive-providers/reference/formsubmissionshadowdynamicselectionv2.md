...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=associate/contactDepartment,associate/credentialType,person/firstName,person/personNumber,contact/contactAssociate/assocName
