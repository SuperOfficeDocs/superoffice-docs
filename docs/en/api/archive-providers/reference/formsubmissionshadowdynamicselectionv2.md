...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personUdef/SuperOffice:3,person/personExtra/x_person_boolean,contact/contactUdef/SuperOffice:7,contact/LastTicket
