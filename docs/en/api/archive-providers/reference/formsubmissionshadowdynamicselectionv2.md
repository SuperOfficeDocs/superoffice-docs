...
```http!
GET /api/v1/archive/FormSubmissionShadowDynamicSelectionV2?$select=person/personDirectPhone/formattedNumber,person/personMobilePhone/formattedNumber,person/restrictionAddress/city
