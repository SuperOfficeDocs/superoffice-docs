...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personAddress/zip,contact/contactFax/description,contact/contactAssociate/portraitThumbnail
