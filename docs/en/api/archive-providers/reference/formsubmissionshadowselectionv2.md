...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personAssociate/fullName,person/correspondingAssociate/middleName,contact/email/emailProtocol,contact/LastSale,contact/LastDoBySale
