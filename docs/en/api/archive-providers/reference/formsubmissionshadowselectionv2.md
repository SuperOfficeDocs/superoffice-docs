...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personAddress/formattedMultiLineAddress,contact/restrictionAddress/wgs84latitude,contact/url/URLDescription
