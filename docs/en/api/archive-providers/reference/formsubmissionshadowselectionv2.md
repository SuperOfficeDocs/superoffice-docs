...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/correspondingAssociate/ejUserId,contact/contactAssociate/contactName,person/restrictionAddress/wgs84longitude
