...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=registeredDate,associate/assocType,person/personExtra/x_person_hidden_integer,contact/contactExtra/x_contact_hidden_integer
