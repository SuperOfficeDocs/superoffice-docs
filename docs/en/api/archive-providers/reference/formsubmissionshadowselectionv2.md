...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=associate/assocType,person/firstName,contact/contactAssociate/userName,contact/NumberOfSalesInPeriod
