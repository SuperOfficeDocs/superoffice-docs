...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/title,person/isProjectMember,contact/country,contact/postAddress/zip,contact/url/URLDescription
