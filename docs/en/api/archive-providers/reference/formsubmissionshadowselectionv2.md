...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/restrictionAddress/line1,person/correspondingAssociate/credentialDisplayValue,contact/saintTicketCategory
