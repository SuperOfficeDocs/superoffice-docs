...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personAssociate/contactCategory,contact/contactAssociate/isActiveText,contact/LastSale
