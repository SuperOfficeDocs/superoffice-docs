...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personUpdatedDate,person/personExtra/x_person_timespan,contact/name,contact/streetAddress/line2,contact/LastSale
