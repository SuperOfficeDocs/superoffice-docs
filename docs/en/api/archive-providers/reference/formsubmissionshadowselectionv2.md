...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/restrictionAddress/city,person/correspondingAssociate/userName,contact/contactExtra/x_contact_contact
