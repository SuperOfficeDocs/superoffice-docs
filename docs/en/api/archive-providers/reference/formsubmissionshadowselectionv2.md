...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=associate/associateDbId,associate/isLocation,person/position,person/personExtra/x_person_longtext,person/personAssociate/locationAddress
