...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=associate/personEmail,person/personExtra/y_rental/id,contact/contactPhone/description,contact/postAddress/county
