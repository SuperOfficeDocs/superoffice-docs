...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/hasInterests,person/restrictionAddress/county,contact/contactAssociate/ejStatus,contact/LastDoBySale
