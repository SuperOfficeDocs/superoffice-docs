...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionShadowSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.FormSubmissionShadowSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personAssociate/isActive,person/personAssociate/portraitThumbnail,person/correspondingAssociate/isActive,contact/restrictionAddress/formattedAddress,contact/contactAssociate/assocTooltip
