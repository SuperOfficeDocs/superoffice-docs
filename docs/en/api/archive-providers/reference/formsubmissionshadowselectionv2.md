...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=icon,associate/ejDisplayName,person/restrictionAddress/line1,contact/contactId,contact/streetAddress/line2
