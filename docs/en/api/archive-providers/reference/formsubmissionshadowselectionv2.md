...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personDirectFax/description,contact/contactAssociate/firstName,contact/LastDoByActivity,selectionId
