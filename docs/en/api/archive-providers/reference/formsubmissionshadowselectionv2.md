...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/personHasInterests,person/personPager/description,person/restrictionAddress/wgs84latitude
