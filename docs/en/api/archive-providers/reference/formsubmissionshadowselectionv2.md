...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=updatedBy,person/personCategory,contact/categoryGroup,contact/registeredBy,contact/contactExtra/x_contact_shorttext
