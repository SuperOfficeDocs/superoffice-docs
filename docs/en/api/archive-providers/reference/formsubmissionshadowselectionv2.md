...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=person/title,person/personAssociate/contactCategory,person/personAssociate/isActive,person/personAssociate/isLocation,person/correspondingAssociate/associateDbId
