...
```http!
GET /api/v1/archive/FormSubmissionShadowSelectionV2?$select=associate/credentialType,person/personExtra/x_person_shorttext,contact/contactExtra/x_contact_timespan
