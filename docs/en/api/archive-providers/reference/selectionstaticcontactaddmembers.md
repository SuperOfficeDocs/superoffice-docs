...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=registeredDate,document/subject,document/associate/otherGroups,updatedByWorkflow,personPrivate/description
