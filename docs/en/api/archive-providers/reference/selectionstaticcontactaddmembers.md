...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=sourceRelation/department,targetRelation/hasInfoText,appointment/appointmentUdef/SuperOffice:6,appointment/associate/contactId,portraitThumbnail
