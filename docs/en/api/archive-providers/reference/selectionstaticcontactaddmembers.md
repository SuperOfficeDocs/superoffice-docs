...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=contactAssociate/middleName,contactUdef/SuperOffice:3,sourceRelation/updatedByFullName,sale/earning,appointment/visibleInDiary
