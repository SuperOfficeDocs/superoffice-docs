...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=LastDoByTicket,sourceRelation/csRelation,sale/associate/credentialDisplayValue,personExtra/x_person_hidden_integer,personSourceRelation/personNumber
