...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=associateId,email/emailDescription,contactUdef/SuperOffice:9,sourceRelation/countryId,targetRelation/contactId
