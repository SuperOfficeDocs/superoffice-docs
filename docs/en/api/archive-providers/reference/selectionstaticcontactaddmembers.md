...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=hasInfoText,registeredBy,sale/associate/middleName,document/associate/credentialType,birthdate
