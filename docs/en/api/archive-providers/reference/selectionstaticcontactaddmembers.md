...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=number,restrictionAddress/wgs84longitude,contactAssociate/personId,sale/salePublish/publishedFrom,personAssociateFullName
