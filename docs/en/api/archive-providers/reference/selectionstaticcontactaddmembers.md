...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=contactExtra/y_organization/x_name,sale/saleNumber,appointment/associate/ejStatus,document/associate/ejUserId,includePersonRestriction
