...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=targetRelation/stop,sale/registeredDate,sale/soldReason,appointment/personId,document/isReport
