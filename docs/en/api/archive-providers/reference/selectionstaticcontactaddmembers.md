...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=sourceRelation/nameDepartment,sale/amount,sale/associate/contactFullName,personAssociateId,personSourceRelation/personNoMail
