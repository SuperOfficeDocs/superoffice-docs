...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=category,sourceRelation/registeredDate,targetRelation/department,sale/credited,appointment/duration
