...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=postAddress/line1,sourceRelation/hasInfoText,targetRelation/csRelation,personUdef/SuperOffice:1,personTargetRelation/contactId
