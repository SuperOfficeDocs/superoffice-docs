...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=code,sale/associate/firstName,appointment/appointmentUdef/SuperOffice:2,document/icon,document/time
