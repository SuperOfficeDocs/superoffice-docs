...
```http!
GET /api/v1/archive/SelectionStaticContactAddMembers?$select=contactUdef/SuperOffice:11,document/suggestedDocumentId,personDirectFax/description,personUrl/URLDescription,personSourceRelation/isStakeholder
