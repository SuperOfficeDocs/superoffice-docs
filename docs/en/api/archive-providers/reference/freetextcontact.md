...
```http!
GET /api/v1/archive/FreetextContact?$select=contactAssociate/assocTooltip,contactSupportPerson/personUpdatedDate,contactSupportPerson/updatedByWorkflow,contactUdef/SuperOffice:6,saintTicketCategory
