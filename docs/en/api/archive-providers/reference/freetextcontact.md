...
```http!
GET /api/v1/archive/FreetextContact?$select=streetAddress/county,contactSupportPerson/birthYear,contactSupportPerson/personCategory,contactSupportPerson/personUdef/SuperOffice:1
