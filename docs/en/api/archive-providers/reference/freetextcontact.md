...
```http!
GET /api/v1/archive/FreetextContact?$select=contactSupportAssociate/ejDisplayName,contactSupportPerson/personUdef/SuperOffice:2,LastActivity,NumberOfSalesInPeriod
