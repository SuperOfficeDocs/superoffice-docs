...
```http!
GET /api/v1/archive/FreetextContact?$select=contactNoMail,contactPhone/description,contactFax/description,contactSupportPerson/personInfo/textId,contactSupportPerson/consentSourceStore
