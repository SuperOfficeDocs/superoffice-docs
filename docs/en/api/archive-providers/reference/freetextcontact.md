...
```http!
GET /api/v1/archive/FreetextContact?$select=registeredByFullName,contactAssociate/middleName,contactSupportAssociate/contactDepartment,contactSupportAssociate/contactCategory,contactSupportPerson/personUpdatedBy
