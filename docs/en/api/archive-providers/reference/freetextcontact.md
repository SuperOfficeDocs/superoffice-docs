...
```http!
GET /api/v1/archive/FreetextContact?$select=contactSupportPerson/personUdef/SuperOffice:1,contactExtra/x_contact_integer,contactAssociate/contactDepartment
