...
```http!
GET /api/v1/archive/FreetextContact?$select=contactSupportAssociate/firstName,contactSupportPerson/personExtra/x_person_request_relation,contactAssociate/usergroup
