...
```http!
GET /api/v1/archive/QuoteLineStaticSelection?$select=selectionMemberId,alternative/version/quote/sale/project/status,alternative/version/quote/sale/project/projectAssociate/isActive
