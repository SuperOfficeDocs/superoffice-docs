...
```http!
GET /api/v1/archive/QuoteLineStaticSelection?$select=unitCost,status,selectionId,alternative/version/approvedText,alternative/version/quote/sale/person/personCategoryRank
