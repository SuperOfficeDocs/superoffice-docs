...
```http!
GET /api/v1/archive/QuoteLineStaticSelection?$select=getNoRows,subscriptionUnit,alternative/version/status,alternative/version/quote/quoteId,alternative/version/quote/sale/saleTypeCategory
