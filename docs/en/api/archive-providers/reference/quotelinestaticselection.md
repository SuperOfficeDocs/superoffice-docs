...
```http!
GET /api/v1/archive/QuoteLineStaticSelection?$select=unitListPrice,earningAmount,totalPriceIncVAT,alternative/extraField5,alternative/version/quote/sale/text
