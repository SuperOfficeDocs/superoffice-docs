...
```http!
GET /api/v1/archive/FindChatSession?$select=person/searchPhone/description,person/personExtra/x_person_longtext,person/personAssociate/personId,person/personAssociate/userName,contact/registeredDate
