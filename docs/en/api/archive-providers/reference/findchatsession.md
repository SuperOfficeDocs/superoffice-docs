...
```http!
GET /api/v1/archive/FindChatSession?$select=person/correspondingAssociate/assocName,person/personAddress/formattedMultiLineAddress,person/personAssociate/portraitThumbnail
