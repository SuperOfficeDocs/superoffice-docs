...
```http!
GET /api/v1/archive/FindChatSession?$select=person/personId,person/supportAssociateFullName,person/hasCompany,person/email/emailId,person/personExtra/x_person_datetime
