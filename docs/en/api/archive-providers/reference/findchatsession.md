...
```http!
GET /api/v1/archive/FindChatSession?$select=contact/contactExtra/x_contact_hidden_integer,contact/contactExtra/x_contact_contact_relation,person/restrictionAddress/line1
