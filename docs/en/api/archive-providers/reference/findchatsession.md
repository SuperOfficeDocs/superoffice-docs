...
```http!
GET /api/v1/archive/FindChatSession?$select=person/personAssociate/isActiveText,person/correspondingAssociate/assocTooltip,person/restrictionAddress/addressId
