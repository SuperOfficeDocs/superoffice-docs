...
```http!
GET /api/v1/archive/FindChatSession?$select=contact/contactExtra/y_organization/x_name,contact/LastDoByTicket,person/personAddress/formattedMultiLineAddress
