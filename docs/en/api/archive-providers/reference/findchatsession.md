...
```http!
GET /api/v1/archive/FindChatSession?$select=chatSessionId,associate/credentialType,person/correspondingAssociate/contactName,contact/streetAddress/wgs84latitude,contact/contactAssociate/contactId
