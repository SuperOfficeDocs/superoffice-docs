...
```http!
GET /api/v1/archive/FindChatSession?$select=contact/registeredByFullName,contact/searchPhone/formattedNumber,contact/searchPhone/description,contact/postAddress/wgs84latitude,contact/contactInterestIds
