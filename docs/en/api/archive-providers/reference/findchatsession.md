...
| Name | Description |
| ---- | ----- |
|"chatsession"|[[SR_SINGULAR_CHATSESSION]]|
...
```http!
GET /api/v1/archive/FindChatSession?$select=associate/assocName,person/retired,person/correspondingAssociate/credentialType,person/correspondingAssociate/userName,contact/code
