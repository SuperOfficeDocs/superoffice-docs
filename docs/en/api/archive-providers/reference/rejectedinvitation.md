...
```http!
GET /api/v1/archive/RejectedInvitation?$select=person/leadStatus,person/restrictionAddress/state,person/legalBaseEmarketing,project/projectAssociate/personEmail,sale/source
