...
```http!
GET /api/v1/archive/RejectedInvitation?$select=appointmentPublish/publishedFrom,appointmentPublish/publishedBy,contact/updatedDate,contact/restrictionAddress/state,contact/contactAssociate/usergroupId
