...
```http!
GET /api/v1/archive/RejectedInvitation?$select=recordType,contact/NumberOfActivitiesInPeriod,person/contactId,person/subscription,appointmentUdef/SuperOffice:8
