...
```http!
GET /api/v1/archive/RejectedInvitation?$select=contact/contactAssociate/role,contact/contactInterestIds,contact/contactExtra/x_contact_dropdown,contact/LastTicket,person/personAssociate/userName
