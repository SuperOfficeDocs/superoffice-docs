...
```http!
GET /api/v1/archive/RejectedInvitation?$select=completedDate,contact/contactAssociate/mrMrs,person/personAssociate/mrMrs,sale/reopenDate,associate/userName
