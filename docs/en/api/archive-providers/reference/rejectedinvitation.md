...
```http!
GET /api/v1/archive/RejectedInvitation?$select=invitationStatusIcon,contact/contactAssociate/simultaneousEjUser,contact/contactAssociate/credentialDisplayValue,contact/contactUdef/SuperOffice:13,person/personAssociate/ejUserId
