...
```http!
GET /api/v1/archive/RejectedInvitation?$select=time,contact/country,contact/contactAssociate/firstName,person/personUpdatedDate,person/personExtra/x_person_appointment_relation
