...
```http!
GET /api/v1/archive/RejectedInvitation?$select=contact/streetAddress/city,contact/contactExtra/x_contact_dropdown,person/kanaFirstName,person/personPager/formattedNumber,sale/probPercent
