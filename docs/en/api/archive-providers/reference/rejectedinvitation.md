...
```http!
GET /api/v1/archive/RejectedInvitation?$select=contact/contactAssociate/assocTooltip,contact/contactAssociate/userName,person/personDirectPhone/description,person/personAssociate/portraitThumbnail,person/correspondingAssociate/isActiveText
