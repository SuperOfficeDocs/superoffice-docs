...
```http!
GET /api/v1/archive/RejectedInvitation?$select=cautionWarning,contact/restrictionAddress/county,contact/LastActivity,person/kanaLastName,person/correspondingAssociate/isLocation
