...
```http!
GET /api/v1/archive/RejectedInvitation?$select=cautionWarning,contact/searchPhone/description,contact/restrictionAddress/line3,person/personDeletedDate,person/correspondingAssociate/fullName
