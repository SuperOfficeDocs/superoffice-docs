...
```http!
GET /api/v1/archive/RejectedInvitation?$select=contact/updatedByFullName,contact/email/emailDescription,person/personCountryId,person/restrictionAddress/county,project/projectPublish/publishedTo
