...
```http!
GET /api/v1/archive/RejectedInvitation?$select=invitedPersonId,contact/postAddress/line3,contact/restrictionAddress/formattedAddress,contact/contactUdef/SuperOffice:4,person/personDirectFax/formattedNumber
