...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=hasInterests,postAddress/line1,sourceRelation/registeredBy,sale/time,sale/associate/contactId
