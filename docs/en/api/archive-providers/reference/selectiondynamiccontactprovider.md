...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=targetRelation/countryId,targetRelation/csRelation,sale/amount,personSourceRelation/isProjectMember,hasStoreConsent
