...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=orgnr,postAddress/line1,contactAssociate/isLocation,appointment/appointmentUdef/SuperOffice:4,document/updatedDate
