...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=targetRelation/hasInterests,targetRelation/country,appointment/date,appointment/appointmentId,appointment/duration
