...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=postAddress/formattedMultiLineAddress,contactAssociate/role,saintIntention,sourceRelation/contactId,appointment/associate/usergroup
