...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=getNoRows,streetAddress/county,restrictionAddress/line2,contactUdef/SuperOffice:3,sourceRelation/hasInfoText
