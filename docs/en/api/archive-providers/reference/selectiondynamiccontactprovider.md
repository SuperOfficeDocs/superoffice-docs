...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=sourceRelation/updatedBy,targetRelation/registeredBy,appointment/associate/isActiveText,lastName,personUpdatedByFullName
