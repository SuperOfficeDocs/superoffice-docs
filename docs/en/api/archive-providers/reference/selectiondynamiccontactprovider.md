...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=hasInfoText,countryId,targetRelation/deletedDate,sale/associate/credentialDisplayValue,document/associate/lastName
