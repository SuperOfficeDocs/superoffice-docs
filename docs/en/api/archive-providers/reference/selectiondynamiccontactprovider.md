...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=orgnr,contactExtra/x_contact_default_integer,sale/associate/credentialType,appointment/intention,personTargetRelation/portraitThumbnail
