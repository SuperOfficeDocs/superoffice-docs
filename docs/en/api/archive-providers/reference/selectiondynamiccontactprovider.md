...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=url/URLAddress,contactExtra/x_contact_timespan,sourceRelation/orgnr,sale/soldReason,sale/associate/usergroupId
