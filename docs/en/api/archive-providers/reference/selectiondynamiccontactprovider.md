...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=sale/icon,sale/credited,sale/saleType,personUdef/SuperOffice:7,personTargetRelation/position
