...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactUdef/SuperOffice:1,sourceRelation/updatedByFullName,appointment/visibleFor,appointment/associate/userName,personAddress/wgs84longitude
