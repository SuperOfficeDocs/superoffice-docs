...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=sale/who,sale/updatedBy,birthMonth,personAddress/wgs84latitude,personTargetRelation/restrictionContactId
