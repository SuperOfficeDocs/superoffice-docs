...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactAssociate/personId,sourceRelation/nameDepartment,targetRelation/country,sale/createdByWorkflow,sale/associate/isActive
