...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactUdef/SuperOffice:2,sale/salePublish/publishedTo,sale/associate/fullName,appointment/projectId,document/documentPublish/publishedFrom
