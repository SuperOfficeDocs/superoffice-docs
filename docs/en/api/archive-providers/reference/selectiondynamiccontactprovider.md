...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=postAddress/line2,contactExtra/x_contact_time,targetRelation/hasInfoText,targetRelation/deletedDate,personBusiness
