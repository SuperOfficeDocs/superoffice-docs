...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=categoryGroup,contactUdef/SuperOffice:6,sourceRelation/hasInterests,appointment/completedDate,document/associate/contactFullName
