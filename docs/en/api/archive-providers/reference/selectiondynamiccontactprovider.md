...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=associateId,postAddress/addressId,appointment/userGroup,appointment/recurring,includePersonWithNoDMRestriction
