...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=sourceRelation/forceCompany,sale/credited,sale/saleTypeCategory,sale/associate/contactId,document/registeredByFullName
