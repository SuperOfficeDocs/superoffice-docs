...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=email/emailAddress,contactAssociate/mrMrs,contactAssociate/personEmail,sale/recordType,personAssociateFullName
