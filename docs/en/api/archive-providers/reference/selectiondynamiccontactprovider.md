...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactInterestIds,contactExtra/x_contact_shorttext,saintSaleStatus,targetRelation/updatedByFullName,sale/saleId
