...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=saintActivityType,sale/currency,appointment/personId,personUdef/SuperOffice:4,personSourceRelation/personDeletedDate
