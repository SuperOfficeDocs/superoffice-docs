...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactFax/description,LastCompletedSale,NumberOfTicketsInPeriod,sourceRelation/name,sale/hasGuide
