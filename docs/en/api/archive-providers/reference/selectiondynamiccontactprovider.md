...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=postAddress/formattedAddress,streetAddress/wgs84latitude,sale/text,sale/associate/role,appointment/visibleInDiary
