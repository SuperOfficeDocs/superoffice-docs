...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=orgnr,contactSource,restrictionAddress/line2,contactAssociate/ejStatus,sale/associate/assocType
