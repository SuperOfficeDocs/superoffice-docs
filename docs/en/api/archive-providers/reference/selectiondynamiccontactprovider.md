...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactExtra/x_contact_longtext,targetRelation/updatedBy,sale/associate/personEmail,appointment/alarm,retired
