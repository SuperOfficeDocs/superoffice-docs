...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactSource,sale/date,appointment/duration,appointment/associate/isActive,personExtra/x_person_contact_relation
