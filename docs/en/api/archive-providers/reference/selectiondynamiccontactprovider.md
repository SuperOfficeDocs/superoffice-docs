...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=countryId,sourceRelation/code,sale/description,personEmail/emailProtocol,personSourceRelation/birthYear
