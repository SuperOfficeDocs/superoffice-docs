...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=sale/hasQuote,sale/associate/personId,document/associate/isActiveText,personAddress/line3,personTargetRelation/birthMonth
