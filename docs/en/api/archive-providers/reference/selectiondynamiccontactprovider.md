...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=streetAddress/county,contactUdef/SuperOffice:3,contactExtra/x_contact_short_dropdown,sale/amountWeighted,personMobilePhone/description
