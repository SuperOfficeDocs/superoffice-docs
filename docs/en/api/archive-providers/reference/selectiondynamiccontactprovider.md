...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=contactExtra/x_contact_contact_relation,sale/hasQuote,sale/associate/fullName,appointment/completedDate,appointment/associate/personId
