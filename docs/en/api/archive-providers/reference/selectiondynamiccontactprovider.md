...
```http!
GET /api/v1/archive/SelectionDynamicContactProvider?$select=sale/recordType,appointment/recurrenceRuleId,ticketPriority,personAddress/line3,personAddress/wgs84latitude
