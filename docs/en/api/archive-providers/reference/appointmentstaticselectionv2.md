...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/restrictionAddress/city,person/personAddress/wgs84latitude,person/personExtra/x_person_shorttext,person/personAssociate/contactName,sale/associate/credentialType
