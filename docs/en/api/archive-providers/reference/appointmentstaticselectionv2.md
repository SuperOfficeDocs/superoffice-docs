...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=projectId,contact/contactSource,contact/postAddress/addressId,person/personAssociate/ejUserId,person/hasEmarketingConsent
