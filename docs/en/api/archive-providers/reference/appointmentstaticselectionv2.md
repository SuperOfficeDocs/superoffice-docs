...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=userGroup,contact/contactPhone/formattedNumber,contact/postAddress/wgs84latitude,contact/streetAddress/wgs84longitude,contact/NumberOfTickets
