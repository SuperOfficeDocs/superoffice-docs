...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/registeredBy,person/birthdate,person/personMobilePhone/description,person/personExtra/x_person_integer,sale/probPercent
