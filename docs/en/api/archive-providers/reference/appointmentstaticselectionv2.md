---
uid: AppointmentStaticSelectionV2
title: AppointmentStaticSelectionV2
description: 
keywords: AppointmentStaticSelectionV2 archive provider
generated: true
...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionStaticProviderV2">SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionStaticProviderV2</see> inside NetServer's SODatabase assembly.

## Supported Entities
| Name | Description |
| ---- | ----- |
|"appointment"|[[SR_COMMON_APPOINTMENT]]|
...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/restrictionAddress/line3,contact/contactAssociate/credentialType,contact/contactAssociate/personEmail,person/personAssociateFullName,associate/contactFullName
