...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/country,contact/postAddress/county,contact/restrictionAddress/line2,contact/contactInterestIds,contact/contactUdef/SuperOffice:1
