...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=recordTypeText,person/email/emailId,person/hasStoreConsent,project/projectUdef/SuperOffice:1,project/NumberOfNotCompletedSalesInPeriod
