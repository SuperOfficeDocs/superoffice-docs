...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/contactExtra/x_contact_datetime,person/personExtra/x_person_shorttext_list,project/type,associate/credentialDisplayValue
