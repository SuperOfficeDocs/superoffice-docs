...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/contactNoMail,contact/contactPhone/description,contact/contactExtra/x_contact_dropdown,contact/saintDirection,person/personDirectPhone/description
