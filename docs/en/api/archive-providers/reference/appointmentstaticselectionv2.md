...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/category,contact/streetAddress/addressId,contact/NumberOfActivities,contact/LastCompletedTicket,person/personActiveErpLinks
