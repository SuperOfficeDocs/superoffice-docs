...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contactId,projectId,contact/name,contact/searchPhone/formattedNumber,contact/email/emailLastSent
