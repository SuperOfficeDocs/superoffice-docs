...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=person/restrictionAddress/city,person/correspondingAssociate/assocTooltip,project/number,project/endDate
