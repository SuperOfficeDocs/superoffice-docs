...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=person/personNoMail,person/personAssociate/assocName,project/projectEvent/eventDate,associate/simultaneousEjUser
