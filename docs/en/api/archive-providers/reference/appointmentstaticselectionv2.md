...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=associateId,contact/contactNoMail,contact/url/URLDescription,project/NumberOfNotCompletedSales,sale/associate/contactName
