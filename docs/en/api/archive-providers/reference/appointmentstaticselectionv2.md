...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/stop,person/personCategory,project/registeredByFullName,project/projectUdef/SuperOffice:7,sale/personId
