...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/streetAddress/county,contact/NumberOfNotCompletedActivitiesInPeriod,person/firstName,person/personAssociate/assocType,sale/heading
