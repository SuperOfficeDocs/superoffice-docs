...
```http!
GET /api/v1/archive/AppointmentStaticSelectionV2?$select=contact/streetAddress/addressId,contact/contactAssociate/usergroup,person/email/emailLastBounce,person/personExtra/x_person_datetime,project/hasInfoText
