...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=sale/userGroup,document/keywords,projectMember/hasCompany,projectMember/personAddress/city,projectMember/postAddress/city
