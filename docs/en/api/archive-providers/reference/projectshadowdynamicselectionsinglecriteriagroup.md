...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=endDate,appointment/appointment/agendaHtml,projectMember/personCategoryRank,projectMember/personAssociate/contactDepartment,projectMember/associateId
