...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=name,sale/stageRank,sale/associate/locationAddress,document/updatedByFullName,projectMember/registered
