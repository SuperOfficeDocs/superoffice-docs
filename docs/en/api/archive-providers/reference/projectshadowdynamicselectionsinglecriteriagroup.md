...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectEvent/isExternalEvent,projectUdef/SuperOffice:8,sale/associate/otherGroups,document/associate/associateDbId,projectMember/phone/formattedNumber
