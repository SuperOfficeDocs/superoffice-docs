...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectId,registeredBy,projectAssociate/simultaneousEjUser,sale/sale/textId,sale/associate/ejStatus
