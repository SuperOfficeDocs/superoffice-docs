...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/middleName,appointment/invitedPersonId,document/associate/usergroupId,projectMember/email/emailBounceCount,projectMember/contactUdef/SuperOffice:11
