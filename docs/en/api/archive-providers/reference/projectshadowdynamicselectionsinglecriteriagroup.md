...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/personEmail,sale/stageRank,sale/associate/contactId,document/date,document/isMail
