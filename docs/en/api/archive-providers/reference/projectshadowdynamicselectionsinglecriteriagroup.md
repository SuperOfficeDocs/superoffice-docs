...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=activeErpLinks,projectUrl/URLDescription,document/associate/lastName,projectMember/email/emailAddress,projectMember/contactAssociate/ejDisplayName
