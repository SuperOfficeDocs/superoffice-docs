...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=appointment/associateId,document/registeredDate,document/documentUdef/SuperOffice:3,projectMember/streetAddress/zip
