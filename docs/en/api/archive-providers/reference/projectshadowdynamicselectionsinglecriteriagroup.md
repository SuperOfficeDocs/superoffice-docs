...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=sale/type,sale/stageRank,appointment/associate/associateDbId,document/contactId,projectMember/personPrivate/formattedNumber
