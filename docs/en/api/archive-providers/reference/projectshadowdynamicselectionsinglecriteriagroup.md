...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/portraitThumbnail,appointment/appointmentUdef/SuperOffice:8,projectMember/hasInfoText,projectMember/email/emailAddress,projectMember/personInterestIds
