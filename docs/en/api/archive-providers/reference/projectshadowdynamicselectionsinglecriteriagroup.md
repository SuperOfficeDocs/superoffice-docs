...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectAssociate/fullName,projectUdef/SuperOffice:2,appointment/suggestedAppointmentId,projectMember/personExtra/x_person_category_relation,projectMember/correspondingAssociate/assocTooltip
