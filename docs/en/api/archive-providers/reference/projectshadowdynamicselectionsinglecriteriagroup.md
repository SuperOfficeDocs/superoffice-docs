...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=sale/credited,sale/associate/contactFullName,document/text,projectMember/personNoMail,projectMember/personAddress/formattedMultiLineAddress
