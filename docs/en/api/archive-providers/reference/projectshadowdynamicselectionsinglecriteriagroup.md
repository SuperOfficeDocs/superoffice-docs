...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=registeredDate,saintTicketStatus,sale/date,sale/salePublish/publishedBy,sale/associate/title
