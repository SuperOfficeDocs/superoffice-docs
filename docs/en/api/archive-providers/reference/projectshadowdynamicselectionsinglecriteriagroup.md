...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=projectUdef/SuperOffice:3,appointment/associate/portraitThumbnail,document/who,projectMember/personCountry
