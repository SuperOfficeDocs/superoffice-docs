...
```http!
GET /api/v1/archive/ProjectShadowDynamicSelectionSingleCriteriaGroup?$select=sale/associate/otherGroups,appointment/appointmentId,projectMember/restrictionAddress/addressId,projectMember/correspondingAssociate/contactCategory
