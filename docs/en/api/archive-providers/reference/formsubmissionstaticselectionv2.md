...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=formSubmissionEmail,associate/title,person/personUdef/SuperOffice:4,person/personExtra/x_person_datetime,contact/contactAssociate/credentialType
