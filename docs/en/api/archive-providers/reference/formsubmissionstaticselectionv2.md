...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=contact/updatedDate,person/restrictionAddress/wgs84latitude,person/correspondingAssociate/middleName
