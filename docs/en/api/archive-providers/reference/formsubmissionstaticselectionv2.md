...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=contact/contactAssociate/personId,contact/contactAssociate/ejUserId,contact/contactAssociate/ejStatus
