...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=person/hasInfoText,person/restrictionAddress/line3,person/consentSourceStore,contact/hasInfoText,contact/streetAddress/wgs84latitude
