...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=contact/contactAssociate/personEmail,person/restrictionAddress/wgs84latitude,person/correspondingAssociate/middleName
