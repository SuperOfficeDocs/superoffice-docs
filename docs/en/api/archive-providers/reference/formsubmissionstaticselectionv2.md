...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=person/hasInterests,person/personCountryId,person/restrictionAddress/city,person/correspondingAssociate/personEmail,contact/updatedDate
