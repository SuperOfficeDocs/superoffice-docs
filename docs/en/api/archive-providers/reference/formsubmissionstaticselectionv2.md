...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=person/hasInterests,person/personPager/description,person/correspondingAssociate/locationAddress
