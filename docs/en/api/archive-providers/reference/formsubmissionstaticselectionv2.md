...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=associate/portraitThumbnail,associate/userName,person/personAssociate/lastName,contact/contactExtra/x_contact_datetime
