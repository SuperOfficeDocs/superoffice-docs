...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=person/personCategory,person/personDirectFax/formattedNumber,person/personUrl/URLDescription,contact/restrictionAddress/state
