...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=associate/assocType,associate/simultaneousEjUser,person/personAssociateFullName,contact/country,contact/code
