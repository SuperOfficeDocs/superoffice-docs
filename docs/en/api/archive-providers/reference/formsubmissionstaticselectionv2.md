...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=updatedBy,associate/contactName,person/personDeletedDate,person/personUdef/SuperOffice:5,person/withdrawnStoreConsent
