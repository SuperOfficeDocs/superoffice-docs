...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=person/hasInterests,person/personNoMail,contact/contactId,contact/postAddress/line2,contact/contactUdef/SuperOffice:11
