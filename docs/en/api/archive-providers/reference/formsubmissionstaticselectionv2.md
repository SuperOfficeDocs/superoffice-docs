...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=person/hasInterests,person/kanaFirstName,person/restrictionAddress/formattedMultiLineAddress,person/personExtra/x_person_contact_relation,contact/number
