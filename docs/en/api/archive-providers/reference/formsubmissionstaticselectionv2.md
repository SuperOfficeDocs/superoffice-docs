...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=type,person/personAddress/county,person/personAddress/city,person/restrictionAddress/zip,person/restrictionAddress/wgs84longitude
