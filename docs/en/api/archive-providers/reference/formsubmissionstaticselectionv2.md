...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=contact/postAddress/line2,contact/contactExtra/y_organization/x_name,person/restrictionAddress/zip
