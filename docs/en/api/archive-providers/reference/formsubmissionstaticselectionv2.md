...
```http!
GET /api/v1/archive/FormSubmissionStaticSelectionV2?$select=person/email/emailAddress,contact/contactExtra/x_contact_timespan,person/restrictionAddress/wgs84latitude
