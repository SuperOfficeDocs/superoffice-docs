...
```http!
GET /api/v1/archive/FindContact?$select=sourceRelation/country,sourceRelation/restrictionContactId,targetRelation/department,targetRelation/updatedDate,appointment/saleId
