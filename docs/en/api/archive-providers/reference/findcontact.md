...
```http!
GET /api/v1/archive/FindContact?$select=email/emailLastSent,targetRelation/contactId,appointment/suggestedAppointmentId,isStakeholder,personAssociate/portraitThumbnail
