...
```http!
GET /api/v1/archive/FindContact?$select=registeredByFullName,restrictionAddress/wgs84latitude,contactAssociate/userName,appointment/appointmentPublish/publishedFrom,appointment/associate/usergroup
