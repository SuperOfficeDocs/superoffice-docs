...
```http!
GET /api/v1/archive/FindContact?$select=targetRelation/department,personExtra/x_person_time,correspondingAssociate/firstName,correspondingAssociate/contactName,correspondingAssociate/assocName
