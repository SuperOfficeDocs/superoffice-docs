...
```http!
GET /api/v1/archive/FindContact?$select=streetAddress/city,document/documentUdef/SuperOffice:7,personDirectFax/description,personExtra/x_person_longtext,personAssociate/role
