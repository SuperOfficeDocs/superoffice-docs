...
```http!
GET /api/v1/archive/FindContact?$select=contactAssociate/mrMrs,targetRelation/registeredByFullName,targetRelation/who,appointment/registeredDate,document/documentUdef/SuperOffice:7
