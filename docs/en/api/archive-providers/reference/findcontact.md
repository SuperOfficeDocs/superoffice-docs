...
```http!
GET /api/v1/archive/FindContact?$select=contactAssociate/personEmail,LastCompletedSale,sourceRelation/registeredByFullName,sale/salePublish/publishedFrom,appointment/suggestedAppointmentId
