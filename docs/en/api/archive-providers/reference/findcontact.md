...
```http!
GET /api/v1/archive/FindContact?$select=contactAssociate/mrMrs,NumberOfNotCompletedTicketsInPeriod,sale/associate/ejStatus,personHasInterests,personUdef/SuperOffice:4
