...
```http!
GET /api/v1/archive/FindContact?$select=contactUdef/SuperOffice:2,NumberOfNotCompletedSales,sale/stage,sale/associate/contactId,appointment/associate/contactName
