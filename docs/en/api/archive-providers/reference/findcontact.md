...
```http!
GET /api/v1/archive/FindContact?$select=searchPhone/description,sale/saleUdef/SuperOffice:3,document/documentUdef/SuperOffice:2,personEmail/emailHasBounced
