...
```http!
GET /api/v1/archive/FindContact?$select=hasInfoText,appointment/appointmentPublish/publishedTo,mrMrs,correspondingAssociate/usergroup,isMailingRecipient
