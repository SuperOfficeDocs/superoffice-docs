...
```http!
GET /api/v1/archive/FindContact?$select=contactExtra/x_contact_timespan,sourceRelation/stop,document/associate/otherGroups,birthDay,correspondingAssociate/assocTooltip
