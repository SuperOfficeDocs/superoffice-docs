...
```http!
GET /api/v1/archive/FindContact?$select=contactAssociate/assocType,sourceRelation/name,appointment/recurrenceRuleId,appointment/isMilestone,personUdef/SuperOffice:3
