...
```http!
GET /api/v1/archive/FindContact?$select=getAllRows,targetRelation/contactId,targetRelation/countryId,appointment/appointment/internalNotes,personExtra/y_rental/x_end
