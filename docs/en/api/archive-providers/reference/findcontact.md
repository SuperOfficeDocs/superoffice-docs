...
```http!
GET /api/v1/archive/FindContact?$select=updatedByFullName,url/URLAddress,contactUdef/SuperOffice:5,LastCompletedActivity,sourceRelation/updatedByFullName
