...
```http!
GET /api/v1/archive/FindContact?$select=targetRelation/restrictionContactId,document/completed,document/associate/contactName,document/associate/assocType,personAddress/addressId
