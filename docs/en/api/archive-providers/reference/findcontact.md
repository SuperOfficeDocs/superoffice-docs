...
```http!
GET /api/v1/archive/FindContact?$select=contactExtra/x_contact_timespan,sourceRelation/country,sale/daysInStage,appointment/recurrenceRuleId,appointment/endTime
