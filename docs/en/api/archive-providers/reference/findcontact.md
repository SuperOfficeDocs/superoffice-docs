...
```http!
GET /api/v1/archive/FindContact?$select=email/emailHasBounced,postAddress/formattedAddress,document/registeredBy,document/associate/usergroup,personEmail/emailHasBounced
