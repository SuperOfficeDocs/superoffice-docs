...
```http!
GET /api/v1/archive/FindContact?$select=contactPhone/description,restrictionAddress/line3,appointment/associate/role,appointment/appointment/isConverted,document/text
