...
```http!
GET /api/v1/archive/FindContact?$select=NumberOfNotCompletedSalesInPeriod,targetRelation/hasInterests,targetRelation/contactNoMail,sale/sale/description,appointment/associate/usergroupId
