...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/personUdef/SuperOffice:7,person/personExtra/y_rental/x_amount,contact/code,contact/postAddress/wgs84longitude,project/projectAssociate/role
