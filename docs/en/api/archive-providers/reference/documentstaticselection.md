...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=subject,person/hasInfoText,person/personInfo/infoText,contact/contactAssociate/personEmail,contact/SaintStatus2
