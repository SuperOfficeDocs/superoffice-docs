...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/personHasInterests,person/email/emailLastSent,person/personAssociate/associateDbId,contact/contactId,contact/phone/formattedNumber
