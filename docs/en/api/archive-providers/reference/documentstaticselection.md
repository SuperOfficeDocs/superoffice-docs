...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=getNoRows,person/personAddress/wgs84longitude,person/personExtra/x_person_timespan,project/completed,sale/associateId
