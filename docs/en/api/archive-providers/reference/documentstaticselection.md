...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=date,person/correspondingAssociate/otherGroups,contact/contactSource,contact/contactExtra/x_contact_default_integer,project/number
