...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/personRegisteredDate,contact/searchPhone/description,project/projectAssociate/assocType,sale/associate/firstName
