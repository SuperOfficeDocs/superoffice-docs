...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/position,person/title,person/personExtra/x_person_request_relation,contact/streetAddress/wgs84latitude,contact/saintSaleStatus
