...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=icon,subject,person/personDirectFax/formattedNumber,person/personAssociate/ejUserId,contact/registeredByFullName
