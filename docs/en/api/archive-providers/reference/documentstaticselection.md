...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=snum,person/rank,person/personPager/formattedNumber,person/personAssociate/contactCategory,person/personAssociate/credentialDisplayValue
