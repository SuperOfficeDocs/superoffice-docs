...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=snum,contact/contactAssociate/userName,contact/contactAssociate/isLocation,project/LastActivity,associate/otherGroups
