...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/personHasInterests,person/personAssociate/contactCategory,contact/LastTicket,project/projectUdef/SuperOffice:7,sale/updatedDate
