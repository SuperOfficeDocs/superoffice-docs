...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=keywords,documentPublish/publishedTo,person/lastName,person/personCountry,person/personAddress/formattedMultiLineAddress
