...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/mrMrs,person/personAddress/zip,contact/NumberOfNotCompletedActivities,project/projectId,project/projectUdef/SuperOffice:1
