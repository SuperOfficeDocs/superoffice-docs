...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/personAssociate/isActiveText,project/startDate,project/projectAssociate/assocType,project/projectAssociate/otherGroups,associate/contactId
