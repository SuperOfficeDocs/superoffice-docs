...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/firstName,person/hasInterests,person/personExtra/y_rental/id,person/personAssociate/title,person/personAssociate/assocType
