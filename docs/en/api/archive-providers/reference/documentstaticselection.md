...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/useAsMailingAddress,contact/registeredByFullName,contact/restrictionAddress/addressId,sale/registeredByFullName
