...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/personExtra/x_person_date,contact/contactUdef/SuperOffice:1,project/saintTicketCategory,sale/saleUdef/SuperOffice:8
