...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=yourref,person/personBusiness,person/personPager/description,person/personAssociate/title,person/correspondingAssociate/isActiveText
