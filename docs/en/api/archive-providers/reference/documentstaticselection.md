...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/personExtra/x_person_date,person/personAssociate/fullName,contact/streetAddress/city,contact/LastTicket,project/projectPublish/isPublished
