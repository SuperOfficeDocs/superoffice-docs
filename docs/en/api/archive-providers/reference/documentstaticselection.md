...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=keywords,person/personPrivate/formattedNumber,contact/orgnr,contact/postAddress/county,contact/contactExtra/x_contact_shorttext
