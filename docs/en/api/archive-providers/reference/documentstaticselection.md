...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/associateType,person/personUpdatedByFullName,person/personAddress/addressId,contact/contactAssociate/otherGroups,contact/NumberOfTickets
