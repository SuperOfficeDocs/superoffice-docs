...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=visibleFor,person/personAddress/city,person/personExtra/y_rental/x_contact,person/correspondingAssociate/mrMrs,person/correspondingAssociate/assocName
