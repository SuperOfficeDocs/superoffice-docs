...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=registeredDate,person/personRegisteredByFullName,contact/contactAssociate/firstName,sale/associate/ejDisplayName,sale/saleUdef/SuperOffice:7
