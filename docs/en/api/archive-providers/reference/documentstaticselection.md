...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionStaticProvider">SuperOffice.CRM.ArchiveLists.Archive.DocumentSelectionStaticProvider</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=contact/contactAssociate/credentialType,project/projectAssociate/contactFullName,project/saintIntention,sale/projectId,sale/amount
