...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/useAsMailingAddress,person/correspondingAssociate/portraitThumbnail,contact/number,contact/stop,contact/registeredDate
