...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=saleId,attention,person/restrictionAddress/wgs84longitude,person/correspondingAssociate/isActiveText,person/isMailingRecipient
