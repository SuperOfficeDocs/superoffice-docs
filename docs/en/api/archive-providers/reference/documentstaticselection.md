...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/firstName,contact/registeredByFullName,project/name,project/projectAssociate/associateDbId,project/projectAssociate/ejDisplayName
