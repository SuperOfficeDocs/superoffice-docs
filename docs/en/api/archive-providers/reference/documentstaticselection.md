...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=person/email/emailId,person/correspondingAssociate/associateDbId,project/projectUdef/SuperOffice:5,sale/saleUdef/SuperOffice:1,selectionId
