...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=userGroup,person/personExtra/y_rental/y_equipment/x_name,contact/countryId,documentUdef/SuperOffice:4,sale/description
