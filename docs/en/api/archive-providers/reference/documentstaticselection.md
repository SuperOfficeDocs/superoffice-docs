...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=getAllRows,name,person/personAddress/line2,person/personAssociate/firstName,person/personAssociate/assocType
