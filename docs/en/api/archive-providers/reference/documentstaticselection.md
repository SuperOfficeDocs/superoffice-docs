...
```http!
GET /api/v1/archive/DocumentStaticSelection?$select=documentPublish/publishedBy,person/personMobilePhone/formattedNumber,contact/contactAssociate/associateDbId
