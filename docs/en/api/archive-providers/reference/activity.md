...
```http!
GET /api/v1/archive/Activity?$select=ourref,person/personUdef/SuperOffice:6,contact/registeredBy,contact/contactAssociate/role,contact/contactExtra/x_contact_time
