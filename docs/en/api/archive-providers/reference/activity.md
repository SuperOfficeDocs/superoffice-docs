...
```http!
GET /api/v1/archive/Activity?$select=person/email/emailProtocol,person/personAddress/line2,person/correspondingAssociate/personId,contact/restrictionAddress/city,contact/contactUdef/SuperOffice:7
