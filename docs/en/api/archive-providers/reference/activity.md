...
```http!
GET /api/v1/archive/Activity?$select=icon,person/email/emailLastSent,person/personExtra/x_person_timespan,contact/email/emailId,contact/postAddress/wgs84latitude
