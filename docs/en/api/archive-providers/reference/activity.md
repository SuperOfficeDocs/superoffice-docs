...
```http!
GET /api/v1/archive/Activity?$select=person/birthYear,person/email/emailId,contact/contactAssociate/ejStatus,contact/contactExtra/x_contact_request_relation,associate/mrMrs
