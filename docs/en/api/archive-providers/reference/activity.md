...
```http!
GET /api/v1/archive/Activity?$select=person/kanaLastName,person/personDirectFax/description,person/withdrawnStoreConsent,sale/associate/contactFullName,sale/associate/ejStatus
