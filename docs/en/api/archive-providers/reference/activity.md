...
```http!
GET /api/v1/archive/Activity?$select=person/personUrl/URLAddress,person/correspondingAssociate/isActiveText,contact/orgnr,contact/contactUdef/SuperOffice:8,project/projectEvent/eventDate
