...
```http!
GET /api/v1/archive/Activity?$select=name,contact/business,contact/contactUdef/SuperOffice:11,contact/contactExtra/x_contact_boolean,project/projectUdef/SuperOffice:6
