...
```http!
GET /api/v1/archive/Activity?$select=icon,userGroup,person/personDirectFax/formattedNumber,person/personAssociate/assocType,person/correspondingAssociate/contactName
