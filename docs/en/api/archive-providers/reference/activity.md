...
```http!
GET /api/v1/archive/Activity?$select=updatedDate,person/personExtra/x_person_shorttext,person/hasEmarketingConsent,contact/companyCategoryRank,contact/postAddress/formattedAddress
