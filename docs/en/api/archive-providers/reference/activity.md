...
```http!
GET /api/v1/archive/Activity?$select=person/personAssociate/role,person/subscription,contact/contactAssociate/contactFullName,contact/contactExtra/x_contact_short_dropdown,project/statusRank
