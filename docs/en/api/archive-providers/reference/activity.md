...
```http!
GET /api/v1/archive/Activity?$select=person/consentSourceEmarketing,project/projectAssociate/otherGroups,associate/contactFullName,associate/isActiveText,sale/associate/contactCategory
