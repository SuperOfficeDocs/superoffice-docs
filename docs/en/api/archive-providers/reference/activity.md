...
```http!
GET /api/v1/archive/Activity?$select=person/personCountry,person/personActiveErpLinks,person/personAssociate/contactDepartment,contact/contactAssociate/middleName,associate/credentialType
