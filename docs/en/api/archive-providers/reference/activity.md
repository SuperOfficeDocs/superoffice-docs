...
```http!
GET /api/v1/archive/Activity?$select=person/correspondingAssociate/isActive,contact/registeredByFullName,contact/postAddress/line1,contact/url/URLAddress,project/saintTicketCategory
