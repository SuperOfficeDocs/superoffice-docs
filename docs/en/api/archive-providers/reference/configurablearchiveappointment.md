...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=appointmentPublish/isPublished,person/personCountryId,person/personNoMail,project/projectAssociate/credentialDisplayValue,sale/associate/credentialDisplayValue
