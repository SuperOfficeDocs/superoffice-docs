...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=getNoRows,updatedDate,contact/postAddress/formattedAddress,contact/contactUdef/SuperOffice:10,project/projectEvent/hasSignOff
