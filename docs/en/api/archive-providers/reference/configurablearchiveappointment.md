...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/countryId,contact/postAddress/line2,person/personAssociate/simultaneousEjUser,person/legalBaseStore,appointmentUdef/SuperOffice:1
