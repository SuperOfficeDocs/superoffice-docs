...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=appointmentPublish/publishedFrom,contact/associateId,contact/countryId,contact/url/URLAddress,person/personAddress/wgs84longitude
