...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/contactExtra/x_contact_contact_relation,contact/NumberOfNotCompletedActivitiesInPeriod,person/personCountryId,person/personExtra/y_rental/x_start,person/personAssociate/role
