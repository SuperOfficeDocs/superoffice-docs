...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/name,contact/deletedDate,contact/streetAddress/state,contact/contactAssociate/contactName,contact/contactAssociate/usergroupId
