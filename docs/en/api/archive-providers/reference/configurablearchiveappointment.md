...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/registeredDate,person/contactId,appointmentUdef/SuperOffice:5,appointmentUdef/SuperOffice:7,sale/associate/assocType
