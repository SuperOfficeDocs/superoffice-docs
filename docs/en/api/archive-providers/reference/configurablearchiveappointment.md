...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=recordTypeText,contact/contactUdef/SuperOffice:13,contact/NumberOfNotCompletedSales,person/birthYear,person/kanaFirstName
