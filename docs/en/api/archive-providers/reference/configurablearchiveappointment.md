...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=person/email/emailAddress,person/personExtra/x_person_integer,person/personAssociate/locationAddress,project/nextMilestone,sale/createdByWorkflow
