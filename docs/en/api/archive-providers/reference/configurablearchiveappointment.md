...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/business,contact/saintIntention,project/projectAssociate/fullName,sale/associate/simultaneousEjUser
