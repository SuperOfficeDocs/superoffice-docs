...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/searchPhone/description,contact/LastDoBySale,project/registeredBy,sale/reopenDate,sale/saleUdef/SuperOffice:6
