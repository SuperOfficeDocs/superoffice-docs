...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=duration,person/restrictionAddress/formattedAddress,project/registeredDate,project/projectAssociate/contactId,project/NumberOfActivities
