...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/countryId,contact/orgnr,contact/restrictionAddress/line2,contact/contactAssociate/fullName,contact/contactExtra/x_contact_shorttext
