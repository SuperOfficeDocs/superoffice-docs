...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/activeErpLinks,contact/restrictionAddress/formattedAddress,person/fullName,project/LastCompletedActivity,sale/amountWeighted
