...
```http!
GET /api/v1/archive/ConfigurableArchiveAppointment?$select=contact/postAddress/formattedMultiLineAddress,contact/contactAssociate/contactName,contact/contactAssociate/usergroup,person/position,person/restrictionAddress/line3
