...
```http!
GET /api/v1/archive/QuoteLineShadowSelectionCombinedV2?$select=priceUnit,targetTableNumber,alternative/description,alternative/extraField1,alternative/version/quote/sale/person/consentSourceStore
