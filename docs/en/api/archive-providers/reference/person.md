...
```http!
GET /api/v1/archive/Person?$select=correspondingAssociate/isActiveText,request/realTimeToClose,request/createdBy/credentialType,request/createdBy/personEmail,projectMembers/projectAssociate/title
