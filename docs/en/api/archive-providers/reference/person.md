...
```http!
GET /api/v1/archive/Person?$select=birthdate,personAddress/city,personSourceRelation/personCategory,personContact/restrictionAddress/wgs84longitude,personAppointment/associate/contactName
