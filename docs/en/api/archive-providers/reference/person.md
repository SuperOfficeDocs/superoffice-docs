...
```http!
GET /api/v1/archive/Person?$select=personSourceRelation/supportAssociateFullName,personAssociate/isLocation,request/sentimentScore,request/ownedBy/usergroup,request/extra/x_ticket_timespan
