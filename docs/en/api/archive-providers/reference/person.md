...
```http!
GET /api/v1/archive/Person?$select=contactId,personUpdatedByFullName,personSourceRelation/personCountry,personSourceRelation/rank,personTargetRelation/middleName
