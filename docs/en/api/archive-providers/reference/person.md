...
```http!
GET /api/v1/archive/Person?$select=mrMrs,personUdef/SuperOffice:4,personTargetRelation/kanaLastName,personTargetRelation/personBusiness,personAssociate/associateDbId
