...
```http!
GET /api/v1/archive/Person?$select=restrictionAddress/line3,personTargetRelation/title,personAssociate/assocName,personContact/deletedDate,request/timeSpentInternally
