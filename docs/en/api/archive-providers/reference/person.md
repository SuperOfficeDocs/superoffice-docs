...
```http!
GET /api/v1/archive/Person?$select=personExtra/y_rental/x_contact,personSourceRelation/personCountryId,personSourceRelation/personUpdatedByFullName,request/ownedBy/firstName,request/ownedBy/fullName
