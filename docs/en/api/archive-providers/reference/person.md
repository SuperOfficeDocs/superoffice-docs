...
```http!
GET /api/v1/archive/Person?$select=personRegisteredDate,isProjectMember,personInfo/infoText,personTargetRelation/hasInterests,personContact/streetAddress/formattedAddress
