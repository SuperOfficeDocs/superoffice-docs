...
```http!
GET /api/v1/archive/Person?$select=firstName,personExtra/y_rental/x_amount,personTargetRelation/personAssociateFullName,request/ownedBy/assocTooltip,projectMembers/projectUdef/SuperOffice:10
