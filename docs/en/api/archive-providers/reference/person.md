...
|"retiredPerson"|[[SR_PA_RETIRED_PERSONS]]|
...
```http!
GET /api/v1/archive/Person?$select=personExtra/y_rental/x_end,personSourceRelation/kanaLastName,personContact/restrictionAddress/county,personContact/contactAssociate/simultaneousEjUser,projectMembers/updatedBy
