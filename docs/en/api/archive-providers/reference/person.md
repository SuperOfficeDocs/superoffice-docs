...
```http!
GET /api/v1/archive/Person?$select=personUpdatedByFullName,personSourceRelation/leadStatus,personAssociate/lastName,personAssociate/ejStatus,correspondingAssociate/contactDepartment
