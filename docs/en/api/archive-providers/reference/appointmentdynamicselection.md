...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/streetAddress/zip,contact/url/URLDescription,person/personNumber,person/personSource,person/restrictionAddress/addressId
