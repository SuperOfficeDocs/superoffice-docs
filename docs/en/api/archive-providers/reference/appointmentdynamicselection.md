...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=person/correspondingAssociate/credentialType,project/projectAssociate/ejUserId,project/NumberOfSales,sale/saleId,sale/hasStakeholders
