...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=time,contact/postAddress/county,contact/streetAddress/wgs84latitude,contact/contactInterestIds,contact/NumberOfSales
