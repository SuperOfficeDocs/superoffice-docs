...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=recurrenceRuleId,visibleInDiary,contact/searchPhone/description,contact/streetAddress/line3,person/personPrivate/formattedNumber
