...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/department,contact/countryId,contact/email/emailDescription,contact/LastTicket,person/birthDay
