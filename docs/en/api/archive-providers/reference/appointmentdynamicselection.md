...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=completedDate,contact/contactAssociate/portraitThumbnail,person/correspondingAssociate/assocName,person/correspondingAssociate/assocType,sale/competitor
