...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=rowKind,appointmentPublish/publishedTo,contact/orgnr,contact/postAddress/line1,contact/streetAddress/line3
