...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/deletedDate,person/kanaFirstName,person/portraitThumbnail,person/restrictionAddress/formattedAddress,project/projectAssociate/assocTooltip
