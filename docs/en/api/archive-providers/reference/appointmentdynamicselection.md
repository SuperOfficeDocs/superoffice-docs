...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=recurring,contact/contactPhone/formattedNumber,person/hasInterests,person/restrictionAddress/line2,person/consentSourceEmarketing
