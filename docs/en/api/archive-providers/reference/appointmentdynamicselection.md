...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/email/emailProtocol,contact/saintAmountClass,person/lastName,person/personActiveErpLinks,person/email/emailDescription
