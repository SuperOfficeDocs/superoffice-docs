...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/NumberOfNotCompletedSales,person/personExtra/x_person_longtext,project/updatedBy,project/SaintStatus3
