...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/contactExtra/x_contact_contact_relation,person/personUrl/URLAddress,person/restrictionAddress/line2,associate/credentialType
