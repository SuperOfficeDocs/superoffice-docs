...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=getNoRows,registeredBy,alarm,contact/contactExtra/x_contact_contact,person/personAssociate/credentialType
