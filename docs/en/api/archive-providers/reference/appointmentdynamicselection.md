...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=visibleFor,person/searchPhone/description,project/LastActivity,sale/date,sale/registeredByFullName
