...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=getAllRows,contact/postAddress/city,contact/contactUdef/SuperOffice:6,project/projectAssociate/contactCategory,project/project/textId
