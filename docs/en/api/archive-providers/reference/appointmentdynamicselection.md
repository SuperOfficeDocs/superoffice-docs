...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/postAddress/line3,person/personCountryId,person/ticketPriority,person/restrictionAddress/city,person/personExtra/y_rental/id
