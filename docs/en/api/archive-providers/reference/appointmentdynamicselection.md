...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=registeredByFullName,endDate,contact/postAddress/zip,person/personAddress/formattedAddress,person/personAssociate/contactId
