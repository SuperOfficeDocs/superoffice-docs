...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=contact/updatedDate,contact/streetAddress/zip,contact/restrictionAddress/line1,contact/NumberOfNotCompletedTickets,person/personAddress/line2
