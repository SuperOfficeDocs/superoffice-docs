...
```http!
GET /api/v1/archive/AppointmentDynamicSelection?$select=appointmentPublish/publishedBy,contact/restrictionAddress/state,project/project/textId,sale/associate/title,sale/associate/ejUserId
