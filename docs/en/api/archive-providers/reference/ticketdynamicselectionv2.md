...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/usergroup,person/personCountry,person/personAssociate/isActiveText,contact/contactAssociate/ejStatus,contact/NumberOfSalesInPeriod
