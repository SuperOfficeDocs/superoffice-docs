...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=person/restrictionAddress/state,contact/mainContact,contact/contactAssociate/assocTooltip,project/projectAssociate/ejUserId
