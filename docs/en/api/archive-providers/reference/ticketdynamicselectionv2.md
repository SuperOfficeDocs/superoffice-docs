...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=sentimentScore,person/restrictionAddress/formattedAddress,person/hasEmarketingConsent,contact/hasInterests,contact/contactAssociate/simultaneousEjUser
