...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ticketId,person/personUrl/URLDescription,contact/NumberOfSales,sale/saleUdef/SuperOffice:6,project/projectUrl/URLDescription
