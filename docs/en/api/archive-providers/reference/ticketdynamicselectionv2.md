...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/contactDepartment,person/associateType,person/email/emailAddress,person/personUdef/SuperOffice:9
