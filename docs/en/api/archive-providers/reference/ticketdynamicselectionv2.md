...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=person/personRegisteredBy,person/personActiveErpLinks,person/personMobilePhone/formattedNumber,contact/contactExtra/x_contact_request_relation,contact/saintAmountClass
