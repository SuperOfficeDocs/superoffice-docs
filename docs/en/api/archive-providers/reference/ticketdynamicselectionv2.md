...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=getNoRows,person/correspondingAssociate/isLocation,contact/email/emailLastSent,contact/streetAddress/addressId,contact/contactAssociate/credentialType
