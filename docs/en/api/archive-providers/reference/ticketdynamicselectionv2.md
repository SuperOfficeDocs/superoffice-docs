...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/mrMrs,person/personHasInterests,person/personExtra/x_person_shorttext_list,contact/updatedDate,contact/searchPhone/description
