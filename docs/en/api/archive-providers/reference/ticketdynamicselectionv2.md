...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=createdByWorkflow,createdBy/usergroup,ownedBy/ejStatus,person/isStakeholder,person/personExtra/x_person_integer
