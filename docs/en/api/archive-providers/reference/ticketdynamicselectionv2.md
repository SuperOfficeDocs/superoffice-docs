...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/assocType,person/personUdef/SuperOffice:4,person/personAssociate/userName,person/correspondingAssociate/contactFullName,contact/contactExtra/x_contact_short_dropdown
