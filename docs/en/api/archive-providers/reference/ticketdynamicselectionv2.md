...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ticketTypeName,person/personAssociate/contactDepartment,person/personAssociate/credentialType,project/saintTicketCategory
