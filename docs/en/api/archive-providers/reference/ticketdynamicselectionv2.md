...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=categoryFullName,numberOfMessages,person/contactId,person/personAssociate/lastName,person/correspondingAssociate/associateDbId
