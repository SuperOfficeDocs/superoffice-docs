...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/isActive,contact/SaintStatus1,extra/x_ticket_faq,sale/stakeholdersEnabled,project/projectAssociate/contactCategory
