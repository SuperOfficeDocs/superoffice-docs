...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=person/middleName,person/personAssociateFullName,person/personExtra/x_person_priority_relation,sale/registeredDate,sale/associate/otherGroups
