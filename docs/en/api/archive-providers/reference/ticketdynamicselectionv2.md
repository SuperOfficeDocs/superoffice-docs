...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=person/restrictionAddress/addressId,contact/postAddress/formattedMultiLineAddress,contact/contactExtra/x_contact_integer,contact/LastDoBySale
