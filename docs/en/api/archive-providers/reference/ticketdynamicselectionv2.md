...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=closedAt,createdBy/portraitThumbnail,person/correspondingAssociate/assocTooltip,person/withdrawnStoreConsent,project/activeErpLinks
