...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/simultaneousEjUser,person/personExtra/x_person_contact_relation,person/personAssociate/contactId,contact/postAddress/state,sale/registeredDate
