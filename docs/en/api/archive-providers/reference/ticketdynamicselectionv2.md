...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=status,slevel,person/personAssociate/lastName,contact/postAddress/zip,contact/contactUdef/SuperOffice:1
