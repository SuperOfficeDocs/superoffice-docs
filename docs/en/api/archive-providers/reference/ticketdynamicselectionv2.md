...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=tags,createdBy/usergroup,person/personAddress/formattedMultiLineAddress,person/personExtra/x_person_appointment_relation,contact/contactAssociate/contactCategory
