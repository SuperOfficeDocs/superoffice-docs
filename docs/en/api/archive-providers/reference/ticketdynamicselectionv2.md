...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=firstReadByOwner,ownedBy/role,person/personUdef/SuperOffice:2,person/personExtra/x_person_category_relation,contact/contactAssociate/fullName
