...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=createdBy/title,person/personPager/description,person/personAssociate/personId,contact/contactAssociate/portraitThumbnail,contact/NumberOfActivitiesInPeriod
