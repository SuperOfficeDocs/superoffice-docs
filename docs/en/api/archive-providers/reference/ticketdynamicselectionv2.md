...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=createdBy/assocType,ownedBy/contactDepartment,ticketPriority/rank,contact/restrictionAddress/formattedAddress,contact/contactAssociate/userName
