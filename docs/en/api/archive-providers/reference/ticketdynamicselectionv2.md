...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=realTimeSpentInternally,createdBy/credentialDisplayValue,ownedBy/personId,person/personCountryId,person/isStakeholder
