...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/title,ownedBy/portraitThumbnail,person/personAddress/wgs84longitude,person/personAssociate/credentialType,contact/country
