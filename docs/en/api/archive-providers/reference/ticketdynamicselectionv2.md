...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=createdBy/contactId,person/restrictionAddress/line2,contact/registeredBy,contact/contactExtra/x_contact_float,contact/NumberOfSales
