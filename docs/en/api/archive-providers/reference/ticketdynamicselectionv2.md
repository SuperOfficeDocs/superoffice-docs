...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=person/personDeletedDate,contact/contactNoMail,contact/contactAssociate/isActive,extra/x_ticket_time,project/projectUrl/URLAddress
