...
```http!
GET /api/v1/archive/TicketDynamicSelectionV2?$select=ownedBy/otherGroups,person/personInfo/textId,contact/email/emailDescription,sale/saleStatus,project/projectAssociate/lastName
