...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/country,contact/contactAssociate/contactFullName,person/legalBaseEmarketing,project/projectAssociate/lastName
