...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/contactExtra/x_contact_contact,contact/LastDoByTicket,project/projectAssociate/portraitThumbnail,project/projectUdef/SuperOffice:6,sale/text
