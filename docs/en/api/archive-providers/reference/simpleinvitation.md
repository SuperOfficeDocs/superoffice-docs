...
```http!
GET /api/v1/archive/SimpleInvitation?$select=getAllRows,contact/contactExtra/y_organization/x_name,person/personAssociate/isActive,project/projectAssociate/credentialType
