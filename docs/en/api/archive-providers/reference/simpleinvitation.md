...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/contactAssociate/lastName,contact/contactAssociate/fullName,project/projectAssociate/userName,sale/associate/portraitThumbnail
