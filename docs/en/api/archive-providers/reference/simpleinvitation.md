...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/business,contact/streetAddress/city,contact/NumberOfActivitiesInPeriod,contact/LastCompletedSale,person/withdrawnEmarketingConsent
