...
```http!
GET /api/v1/archive/SimpleInvitation?$select=cautionWarning,contact/forceCompany,contact/contactUdef/SuperOffice:12,person/personAssociate/contactName,person/personAssociate/isActive
