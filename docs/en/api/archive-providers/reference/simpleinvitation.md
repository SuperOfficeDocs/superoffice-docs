...
```http!
GET /api/v1/archive/SimpleInvitation?$select=time,contact/contactUdef/SuperOffice:9,person/phone/formattedNumber,person/personMobilePhone/description,person/restrictionAddress/wgs84latitude
