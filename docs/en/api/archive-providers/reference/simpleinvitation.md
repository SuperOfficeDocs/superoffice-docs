...
```http!
GET /api/v1/archive/SimpleInvitation?$select=registeredBy,person/personAssociate/personId,project/projectAssociate/locationAddress,sale/saleNumber,sale/associate/assocName
