...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/contactAssociate/mrMrs,person/correspondingAssociate/portraitThumbnail,project/projectId,project/projectAssociate/contactFullName
