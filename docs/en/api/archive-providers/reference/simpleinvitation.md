...
```http!
GET /api/v1/archive/SimpleInvitation?$select=saleId,contact/LastCompletedActivity,person/supportLanguage,person/withdrawnStoreConsent,person/hasEmarketingConsent
