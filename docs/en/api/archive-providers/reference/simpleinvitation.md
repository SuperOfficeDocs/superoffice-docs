...
```http!
GET /api/v1/archive/SimpleInvitation?$select=userGroup,createdByWorkflow,contact/postAddress/line1,contact/restrictionAddress/county,person/personMobilePhone/formattedNumber
