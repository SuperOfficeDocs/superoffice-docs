...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/contactAssociate/usergroup,contact/contactUdef/SuperOffice:1,person/personId,person/supportAssociate,person/personExtra/x_person_boolean
