...
```http!
GET /api/v1/archive/SimpleInvitation?$select=updatedBy,contact/contactExtra/x_contact_datetime,contact/NumberOfNotCompletedTicketsInPeriod,person/hasInterests,person/isProjectMember
