...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/number,person/kanaLastName,person/restrictionAddress/county,person/personExtra/x_person_shorttext,project/completed
