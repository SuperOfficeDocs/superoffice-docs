...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/contactAssociate/mrMrs,contact/contactAssociate/assocName,contact/LastCompletedTicket,person/personCategory,person/personUdef/SuperOffice:4
