...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/registeredByFullName,person/useAsMailingAddress,person/personUpdatedBy,person/email/emailLastBounce,person/personAddress/formattedMultiLineAddress
