...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/business,contact/restrictionAddress/addressId,contact/LastCompletedActivity,contact/LastDoBySale,person/portraitThumbnail
