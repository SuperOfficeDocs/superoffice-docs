...
```http!
GET /api/v1/archive/SimpleInvitation?$select=isMilestone,contact/NumberOfNotCompletedTickets,person/contactId,person/updatedByWorkflow,person/personPrivate/description
