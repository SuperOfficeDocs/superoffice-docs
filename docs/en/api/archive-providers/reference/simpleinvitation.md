...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/contactNoMail,contact/streetAddress/state,contact/contactAssociate/credentialType,person/personAssociate/ejStatus,project/projectAssociate/role
