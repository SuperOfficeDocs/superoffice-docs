...
```http!
GET /api/v1/archive/SimpleInvitation?$select=contact/email/emailAddress,contact/streetAddress/line1,contact/url/URLDescription,project/updatedDate,sale/date
