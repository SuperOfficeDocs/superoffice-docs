...
```http!
GET /api/v1/archive/SimpleInvitation?$select=date,contact/restrictionAddress/county,contact/contactExtra/x_contact_boolean,person/hasInterests,person/supportAssociateFullName
