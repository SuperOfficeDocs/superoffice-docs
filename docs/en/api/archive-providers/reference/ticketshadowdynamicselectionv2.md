...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=contact/postAddress/county,contact/contactUdef/SuperOffice:4,sale/saleUdef/SuperOffice:7,project/projectPublish/publishedBy,project/projectUdef/SuperOffice:8
