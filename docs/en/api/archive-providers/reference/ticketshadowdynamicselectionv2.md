...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=ownedBy/simultaneousEjUser,person/personExtra/x_person_date,person/personExtra/x_person_shorttext,person/isMailingRecipient,sale/associateId
