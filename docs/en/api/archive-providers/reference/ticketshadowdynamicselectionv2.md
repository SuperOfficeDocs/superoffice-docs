...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=priorityName,ownedBy/contactCategory,person/birthMonth,person/personUdef/SuperOffice:8,person/personExtra/y_car/id
