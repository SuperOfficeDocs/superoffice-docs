...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=realTimeToClose,createdBy/isActiveText,person/personExtra/x_person_date,person/personExtra/y_rental/id,person/correspondingAssociate/userName
