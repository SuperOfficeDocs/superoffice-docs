...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=createdBy/lastName,person/personBusiness,person/personPager/formattedNumber,project/projectAssociate/contactId
