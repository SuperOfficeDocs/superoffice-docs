...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=person/personCategoryGroup,person/personAssociate/simultaneousEjUser,sale/associate/isActiveText
