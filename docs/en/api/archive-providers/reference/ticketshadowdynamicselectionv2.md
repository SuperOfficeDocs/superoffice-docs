...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=person/firstName,person/personAssociate/userName,contact/contactPhone/description,extra/x_ticket_timespan,sale/associate/contactFullName
