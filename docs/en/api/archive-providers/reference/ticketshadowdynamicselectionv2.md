...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=createdBy/locationAddress,person/personCategory,person/correspondingAssociate/associateDbId,person/hasEmarketingConsent,contact/number
