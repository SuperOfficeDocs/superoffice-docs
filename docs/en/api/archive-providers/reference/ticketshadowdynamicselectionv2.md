...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=createdBy/middleName,ownedBy/assocName,person/personAssociate/associateDbId,person/withdrawnStoreConsent,person/hasEmarketingConsent
