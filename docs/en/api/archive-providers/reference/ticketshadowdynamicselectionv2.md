...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=timeToClose,person/contactId,person/position,person/personInfo/infoText,person/correspondingAssociate/firstName
