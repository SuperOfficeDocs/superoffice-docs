...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=ownedBy,createdBy/userName,contact/email/emailLastSent,contact/contactAssociate/contactCategory,contact/SaintStatus1
