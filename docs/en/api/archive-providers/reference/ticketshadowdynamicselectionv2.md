...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=createdBy/role,person/personExtra/x_person_date,person/correspondingAssociate/contactFullName,person/legalBaseEmarketing,contact/number
