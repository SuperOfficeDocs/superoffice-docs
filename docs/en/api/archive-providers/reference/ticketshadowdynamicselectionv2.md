...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=sentimentScore,person/personAddress/line3,person/correspondingAssociate/fullName,contact/updatedByFullName,contact/postAddress/wgs84longitude
