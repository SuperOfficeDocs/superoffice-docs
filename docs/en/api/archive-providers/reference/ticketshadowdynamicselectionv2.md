...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=person/leadstatusRank,person/hasEmarketingConsent,contact/department,contact/postAddress/wgs84latitude,contact/contactUdef/SuperOffice:11
