...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=ticketId,person/personCountry,person/restrictionAddress/state,contact/phone/formattedNumber,sale/updatedDate
