...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=createdBy/firstName,createdBy/credentialDisplayValue,ownedBy/associateDbId,person/restrictionAddress/county,contact/SaintStatus2
