...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=ownedBy/assocType,ownedBy/isActiveText,person/restrictionAddress/line1,person/personUdef/SuperOffice:1,contact/postAddress/formattedAddress
