...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=person/correspondingAssociate/personEmail,person/withdrawnEmarketingConsent,contact/email/emailHasBounced,sale/userGroup,sale/hasGuide
