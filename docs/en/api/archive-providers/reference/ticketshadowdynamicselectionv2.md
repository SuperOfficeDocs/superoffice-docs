...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=createdBy/assocType,person/rank,person/personUrl/URLDescription,person/personAssociate/lastName,person/correspondingAssociate/otherGroups
