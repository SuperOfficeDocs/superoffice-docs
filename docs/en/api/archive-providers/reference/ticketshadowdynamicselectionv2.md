...
```http!
GET /api/v1/archive/TicketShadowDynamicSelectionV2?$select=priorityId,contact/searchPhone/description,contact/NumberOfNotCompletedTicketsInPeriod,contact/LastDoByTicket,sale/completed
