...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=isMilestone,contact/updatedDate,contact/contactAssociate/fullName,contact/NumberOfNotCompletedActivities,person/correspondingAssociate/fullName
