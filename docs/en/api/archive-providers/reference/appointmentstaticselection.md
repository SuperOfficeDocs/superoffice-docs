...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/country,contact/contactSource,person/personPrivate/description,person/personAssociate/simultaneousEjUser,project/projectAssociate/role
