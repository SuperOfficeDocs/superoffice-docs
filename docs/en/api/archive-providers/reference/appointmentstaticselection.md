...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=date,who,contact/contactUdef/SuperOffice:4,person/personAssociate/portraitThumbnail,appointmentUdef/SuperOffice:3
