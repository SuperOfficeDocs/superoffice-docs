...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/email/emailHasBounced,contact/contactExtra/x_contact_float,contact/LastDoBySale,person/personUdef/SuperOffice:3,person/personUdef/SuperOffice:6
