...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=recurring,contact/contactExtra/x_contact_date,person/correspondingAssociate/ejStatus,sale/personId,sale/associate/mrMrs
