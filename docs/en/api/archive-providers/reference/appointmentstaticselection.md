...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=location,contact/registeredByFullName,contact/postAddress/state,person/personId,person/restrictionAddress/formattedMultiLineAddress
