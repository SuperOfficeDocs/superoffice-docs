...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=recurrenceRuleId,contact/contactId,contact/registeredDate,contact/contactExtra/x_contact_hidden_integer,person/lastName
