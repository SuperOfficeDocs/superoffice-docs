...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=person/personUdef/SuperOffice:8,person/correspondingAssociate/title,project/projectAssociate/assocTooltip,appointment/titleHtml
