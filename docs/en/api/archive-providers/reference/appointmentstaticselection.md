...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=person/personNoMail,person/personAssociate/assocName,project/projectEvent/eventDate,associate/simultaneousEjUser
