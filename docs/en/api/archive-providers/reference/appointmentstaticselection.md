...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=recordType,suggestedAppointmentId,contact/contactExtra/x_contact_contact,person/correspondingAssociate/mrMrs,appointmentUdef/SuperOffice:1
