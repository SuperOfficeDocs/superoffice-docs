...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=recurring,visibleInDiary,contact/restrictionAddress/city,contact/contactAssociate/personEmail,contact/NumberOfNotCompletedTickets
