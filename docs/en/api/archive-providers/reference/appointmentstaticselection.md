...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/restrictionAddress/addressId,contact/restrictionAddress/formattedMultiLineAddress,person/personHasInterests
