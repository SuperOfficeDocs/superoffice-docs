...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=person/personExtra/y_rental/y_equipment/x_name,person/correspondingAssociate/isActive,sale/saleStatus,sale/soldReason
