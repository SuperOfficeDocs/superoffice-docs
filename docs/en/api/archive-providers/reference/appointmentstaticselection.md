...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=visibleInDiary,person/personUdef/SuperOffice:4,person/correspondingAssociate/mrMrs,selectionMemberId
