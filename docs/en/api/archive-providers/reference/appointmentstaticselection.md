...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=location,contact/url/URLDescription,contact/contactAssociate/middleName,contact/saintDirection,person/personId
