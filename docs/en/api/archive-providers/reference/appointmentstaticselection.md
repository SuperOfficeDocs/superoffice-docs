...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/contactAssociate/credentialType,person/personUrl/URLAddress,person/personAssociate/otherGroups,associate/associateDbId
