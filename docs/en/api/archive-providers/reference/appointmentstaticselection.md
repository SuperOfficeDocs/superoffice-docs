...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=cautionWarning,contact/hasInfoText,contact/LastDoBySale,person/lastName,person/restrictionAddress/city
