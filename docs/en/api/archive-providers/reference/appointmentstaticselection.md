...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=suggestedAppointmentId,person/birthDay,person/personExtra/x_person_longtext,project/projectAssociate/simultaneousEjUser,associate/fullName
