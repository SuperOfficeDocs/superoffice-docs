...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/streetAddress/line2,contact/contactAssociate/portraitThumbnail,contact/contactExtra/x_contact_shorttext,person/legalBaseEmarketing,project/saintTicketCategory
