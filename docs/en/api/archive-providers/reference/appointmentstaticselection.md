...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/email/emailDescription,person/correspondingAssociate/ejUserId,project/text,project/projectUrl/URLDescription,sale/stalledComment
