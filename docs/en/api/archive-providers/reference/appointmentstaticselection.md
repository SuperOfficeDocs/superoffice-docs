...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=visibleFor,person/birthdate,person/correspondingAssociate/firstName,project/completed,project/projectAssociate/isActiveText
