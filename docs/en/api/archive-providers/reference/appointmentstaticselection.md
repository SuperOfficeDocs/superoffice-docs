...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/postAddress/wgs84longitude,contact/contactExtra/x_contact_hidden_integer,contact/contactExtra/x_contact_contact,person/middleName,person/isStakeholder
