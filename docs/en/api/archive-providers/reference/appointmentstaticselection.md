...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=location,contact/postAddress/state,person/personUdef/SuperOffice:7,person/personAssociate/assocType
