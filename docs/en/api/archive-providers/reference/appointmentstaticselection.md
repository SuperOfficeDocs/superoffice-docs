...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=updatedBy,contact/contactUdef/SuperOffice:5,contact/contactUdef/SuperOffice:9,person/ticketPriority,person/personExtra/x_person_category_relation
