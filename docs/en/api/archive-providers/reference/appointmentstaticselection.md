...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=endDate,contact/streetAddress/formattedAddress,person/personAssociate/credentialDisplayValue,sale/lossReason,sale/associate/otherGroups
