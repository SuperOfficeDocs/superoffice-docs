...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/email/emailId,person/restrictionAddress/county,person/restrictionAddress/formattedAddress,person/personExtra/y_rental/x_contact,person/consentSourceEmarketing
