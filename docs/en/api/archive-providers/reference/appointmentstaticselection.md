...
```http!
GET /api/v1/archive/AppointmentStaticSelection?$select=contact/contactAssociate/contactFullName,person/personId,person/contactId,person/hasInterests,person/personUdef/SuperOffice:9
