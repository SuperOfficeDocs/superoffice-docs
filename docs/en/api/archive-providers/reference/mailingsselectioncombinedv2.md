...
```http!
GET /api/v1/archive/MailingsSelectionCombinedV2?$select=mailingId,mailingEndDate,mailingAddr/contact/contactExtra/x_contact_default_integer,mailingAddr/contact/contactExtra/x_contact_request_relation
