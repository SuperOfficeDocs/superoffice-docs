...
```http!
GET /api/v1/archive/MailingsSelectionCombinedV2?$select=registeredDate,mailingAddr/contact/restrictionAddress/zip,mailingAddr/person/supportAssociateFullName,mailingAddr/person/restrictionAddress/addressId,mailingAddr/person/personExtra/y_rental/x_amount
