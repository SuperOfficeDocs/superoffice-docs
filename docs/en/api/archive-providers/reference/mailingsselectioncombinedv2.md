...
```http!
GET /api/v1/archive/MailingsSelectionCombinedV2?$select=mailingAddr/contact/streetAddress/state,associate/simultaneousEjUser,mailingAddr/contact/LastCompletedActivity
