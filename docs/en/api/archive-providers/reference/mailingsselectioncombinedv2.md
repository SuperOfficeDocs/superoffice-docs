...
```http!
GET /api/v1/archive/MailingsSelectionCombinedV2?$select=mailingDeleted,mailingAddr/contact/contactAssociate/credentialType,mailingAddr/person/hasCompany,project/activeErpLinks,project/projectAssociate/assocTooltip
