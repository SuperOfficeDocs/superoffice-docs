...
```http!
GET /api/v1/archive/recipientfavourites?$select=personAddress/wgs84latitude,personUdef/SuperOffice:7,correspondingAssociate/contactCategory,contactPhone/description,postAddress/addressId
