...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=contactSource,sale/associate/credentialDisplayValue,appointment/recordTypeText,document/yourref,retired
