...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=streetAddress/line1,sourceRelation/registeredByFullName,birthMonth,withdrawnStoreConsent,personTargetRelation/hasInterests
