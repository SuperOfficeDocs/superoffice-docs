...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=postAddress/line3,appointment/recordTypeText,appointment/associate/userName,document/suggestedDocumentId,document/associate/simultaneousEjUser
