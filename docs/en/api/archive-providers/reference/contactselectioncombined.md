...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=contactUdef/SuperOffice:10,sale/who,appointment/associate/isLocation,document/associate/portraitThumbnail,document/associate/locationAddress
