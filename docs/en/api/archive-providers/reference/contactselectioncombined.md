...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=sourceRelation/number,sourceRelation/contactDeleted,sourceRelation/forceCompany,targetRelation/country,targetRelation/registeredDate
