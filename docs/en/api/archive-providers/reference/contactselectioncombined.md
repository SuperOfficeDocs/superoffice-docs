...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=countryId,searchPhone/formattedNumber,restrictionAddress/state,contactAssociate/personId,saintIntention
