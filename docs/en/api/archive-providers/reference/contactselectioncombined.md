...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=contactUdef/SuperOffice:2,sale/hasStakeholders,supportAssociate,personAssociate/personEmail,request/ownedBy/title
