...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=email/emailHasBounced,contactAssociate/contactFullName,saintTicketStatus,sourceRelation/registeredBy,appointment/recurring
