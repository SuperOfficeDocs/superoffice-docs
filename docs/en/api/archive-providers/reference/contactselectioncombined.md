...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=streetAddress/zip,contactExtra/x_contact_short_dropdown,saintActivityType,sourceRelation/contactDeleted,sale/saleUdef/SuperOffice:7
