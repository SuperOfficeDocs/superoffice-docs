...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=category,sourceRelation/updatedDate,sourceRelation/contactSource,sourceRelation/deletedDate,sale/associate/assocType
