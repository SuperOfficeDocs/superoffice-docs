...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=contactId,contactAssociate/contactDepartment,contactAssociate/locationAddress,contactUdef/SuperOffice:7,sale/projectId
