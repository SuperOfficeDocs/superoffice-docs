...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=restrictionAddress/line1,contactUdef/SuperOffice:12,document/associate/personId,document/associate/assocTooltip,ticketPriority
