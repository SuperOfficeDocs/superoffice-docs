...
```http!
GET /api/v1/archive/ContactSelectionCombined?$select=streetAddress/zip,sale/saleType,appointment/associate/credentialType,appointment/associate/credentialDisplayValue,document/saleId
