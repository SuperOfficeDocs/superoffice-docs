...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=getNoRows,contact/contactUdef/SuperOffice:2,contact/contactUdef/SuperOffice:5,person/email/emailHasBounced,person/personAddress/zip
