...
This provider name is implemented by the class <see cref="T:SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionProviderV2">SuperOffice.CRM.ArchiveLists.Archive.AppointmentSelectionProviderV2</see> inside NetServer's SODatabase assembly.
...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/postAddress/formattedMultiLineAddress,contact/restrictionAddress/county,contact/contactExtra/x_contact_timespan,person/personRegisteredDate,person/personUrl/URLAddress
