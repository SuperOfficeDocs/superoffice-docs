...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/postAddress/line3,person/personInterestIds,person/personExtra/y_rental/x_start,project/projectUrl/URLDescription
