...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=time,projectId,contact/category,contact/postAddress/formattedAddress,contact/contactAssociate/userName
