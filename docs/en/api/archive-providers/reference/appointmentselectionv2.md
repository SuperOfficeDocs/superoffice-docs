...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=person/correspondingAssociate/firstName,sale/associate/firstName,sale/associate/contactFullName,associate/assocTooltip,associate/simultaneousEjUser
