...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=recordType,contact/contactAssociate/isActiveText,contact/contactExtra/x_contact_request_relation,person/email/emailDescription
