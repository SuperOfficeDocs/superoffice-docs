...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=alarm,contact/hasInfoText,person/legalBaseEmarketing,project/projectPublish/isPublished,project/projectAssociate/associateDbId
