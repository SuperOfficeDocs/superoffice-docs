...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/orgnr,contact/postAddress/line1,contact/contactExtra/x_contact_integer,person/personAddress/state
