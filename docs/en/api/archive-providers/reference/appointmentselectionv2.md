...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/postAddress/line2,person/personAssociate/ejStatus,project/projectUdef/SuperOffice:3,project/LastActivity,sale/stage
