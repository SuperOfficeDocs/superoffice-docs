...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/name,contact/streetAddress/addressId,person/portraitThumbnail,person/restrictionAddress/addressId,person/personUdef/SuperOffice:2
