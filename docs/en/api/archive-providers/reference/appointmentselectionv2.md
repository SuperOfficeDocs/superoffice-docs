...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/postAddress/wgs84latitude,contact/contactExtra/x_contact_float,project/projectEvent/hasSignOff
