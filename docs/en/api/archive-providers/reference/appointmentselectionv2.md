...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/restrictionAddress/state,person/mrMrs,appointmentUdef/SuperOffice:8,project/projectPublish/isPublished,project/projectUdef/SuperOffice:10
