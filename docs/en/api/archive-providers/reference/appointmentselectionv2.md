...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=registeredBy,contact/contactUdef/SuperOffice:4,appointmentUdef/SuperOffice:6,appointmentUdef/SuperOffice:8,sale/associate/simultaneousEjUser
