...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=updatedBy,contact/contactId,person/birthMonth,person/correspondingAssociate/portraitThumbnail,project/projectAssociate/contactDepartment
