...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=recordType,contact/postAddress/addressId,person/mrMrs,person/personUdef/SuperOffice:8,person/personAssociate/isActive
