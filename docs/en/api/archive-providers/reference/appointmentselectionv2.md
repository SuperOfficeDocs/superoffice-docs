...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=booking,contact/country,contact/email/emailLastSent,contact/contactUdef/SuperOffice:8,contact/contactUdef/SuperOffice:13
