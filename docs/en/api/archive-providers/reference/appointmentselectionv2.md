...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/registeredByFullName,contact/contactAssociate/isLocation,person/isStakeholder,person/restrictionAddress/addressId,person/personExtra/x_person_timespan
