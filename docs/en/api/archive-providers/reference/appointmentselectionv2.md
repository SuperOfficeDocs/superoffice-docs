...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/contactAssociate/contactName,person/birthdate,person/personRegisteredBy,person/personAddress/zip,person/correspondingAssociate/personId
