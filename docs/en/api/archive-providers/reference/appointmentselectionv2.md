...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=visibleInDiary,visibleFor,contact/streetAddress/line3,contact/contactInterestIds,contact/contactExtra/x_contact_integer
