...
```http!
GET /api/v1/archive/AppointmentSelectionV2?$select=contact/forceCompany,contact/email/emailId,contact/contactAssociate/contactName,contact/contactAssociate/credentialType,contact/contactExtra/x_contact_timespan
