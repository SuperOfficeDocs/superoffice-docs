...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/category,emailFlow/thumbnail,emailFlow/workflowAssociate/isActive,project/activeErpLinks,project/projectAssociate/ejUserId
