...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=associateId,mailingAddr/contact/postAddress/city,associate/portraitThumbnail
