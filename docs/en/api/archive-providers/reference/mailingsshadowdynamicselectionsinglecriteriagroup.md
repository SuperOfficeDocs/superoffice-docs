...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/person/personUdef/SuperOffice:6,emailFlow/hierarchyName,mailingAddr/contact/saintDirection
