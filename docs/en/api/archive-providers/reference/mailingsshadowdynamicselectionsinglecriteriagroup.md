...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/contactExtra/x_contact_boolean,mailingAddr/contact/NumberOfSalesInPeriod,mailingAddr/person/personUrl/URLAddress,mailingAddr/person/personAddress/wgs84latitude,mailingAddr/person/personExtra/x_person_boolean
