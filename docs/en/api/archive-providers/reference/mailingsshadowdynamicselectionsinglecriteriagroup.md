...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/NumberOfNotCompletedTickets,mailingAddr/person/personRegisteredBy,mailingAddr/person/personPrivate/description,mailingAddr/person/personAddress/wgs84longitude,mailingAddr/person/restrictionAddress/formattedAddress
