...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/contactAssociate/assocType,associate/otherGroups,emailFlow/workflowSuccessRate,project/projectUrl/URLAddress
