...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/country,mailingAddr/contact/contactPhone/description,mailingAddr/contact/saintActivityType
