...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=project/updatedDate,project/projectEvent/hasSignOff,project/projectAssociate/personEmail,project/projectUdef/SuperOffice:9
