...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=recordTypeText,mailingAddr/contact/email/emailProtocol,mailingAddr/contact/postAddress/line2,mailingAddr/contact/NumberOfTickets,mailingAddr/person/personRegisteredBy
