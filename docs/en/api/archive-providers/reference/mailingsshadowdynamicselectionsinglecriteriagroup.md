...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/orgnr,mailingAddr/contact/forceCompany,mailingAddr/contact/postAddress/addressId,mailingAddr/contact/postAddress/county,mailingAddr/contact/streetAddress/wgs84latitude
