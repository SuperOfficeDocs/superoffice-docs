...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=recipientStatus,mailingAddr/contact/streetAddress/county,mailingAddr/person/personHasInterests,mailingAddr/person/restrictionAddress/city
