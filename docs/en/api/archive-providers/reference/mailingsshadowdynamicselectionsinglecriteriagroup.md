...
```http!
GET /api/v1/archive/MailingsShadowDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/postAddress/zip,mailingAddr/contact/streetAddress/line3,mailingAddr/contact/contactExtra/x_contact_integer,mailingAddr/person/isProjectMember,mailingAddr/person/personExtra/x_person_user_relation
