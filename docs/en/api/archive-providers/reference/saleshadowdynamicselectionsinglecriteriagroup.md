...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/assocName,contact/email/emailLastSent,contact/NumberOfActivities,associate/middleName,appointment/associate/personId
