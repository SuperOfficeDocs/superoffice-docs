...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=description,contact/activeErpLinks,associate/role,associate/locationAddress,appointment/rawType
