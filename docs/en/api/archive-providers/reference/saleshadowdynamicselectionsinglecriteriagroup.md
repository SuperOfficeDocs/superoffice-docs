...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=hasQuote,person/firstName,person/retired,person/personExtra/x_person_contact_relation,person/personAssociate/isActive
