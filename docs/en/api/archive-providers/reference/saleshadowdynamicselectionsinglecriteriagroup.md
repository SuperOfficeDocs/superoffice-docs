...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=soldReason,person/portraitThumbnail,person/personInfo/textId,person/personUdef/SuperOffice:1,person/personUdef/SuperOffice:4
