...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=contact/searchPhone/formattedNumber,associate/isActiveText,appointment/associate/simultaneousEjUser,project/projectAssociate/usergroup,saleStakeholder/person/personInterestIds
