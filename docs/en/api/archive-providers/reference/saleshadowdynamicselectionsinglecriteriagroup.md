...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=lossReason,salePublish/publishedFrom,person/personUdef/SuperOffice:11,contact/postAddress/line1,contact/postAddress/line3
