...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=lossReason,amountWeightedInBaseCurrency,person/personRegisteredByFullName,person/email/emailLastSent,person/correspondingAssociate/credentialDisplayValue
