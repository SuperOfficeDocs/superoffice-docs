...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/birthdate,contact/saintDirection,saleUdef/SuperOffice:3,project/completed,project/NumberOfNotCompletedSalesInPeriod
