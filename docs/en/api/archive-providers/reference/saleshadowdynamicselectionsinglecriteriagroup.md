...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=heading,saleType,person/withdrawnEmarketingConsent,contact/code,appointment/associate/role
