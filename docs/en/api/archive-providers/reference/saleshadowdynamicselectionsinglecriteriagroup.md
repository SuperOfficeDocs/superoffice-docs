...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=competitor,person/rank,person/leadstatusRank,contact/contactUdef/SuperOffice:7,saleUdef/SuperOffice:2
