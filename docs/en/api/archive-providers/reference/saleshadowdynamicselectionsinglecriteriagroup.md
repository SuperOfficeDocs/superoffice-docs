...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=sale/description,person/isProjectMember,person/email/emailDescription,contact/stop,contact/NumberOfNotCompletedTickets
