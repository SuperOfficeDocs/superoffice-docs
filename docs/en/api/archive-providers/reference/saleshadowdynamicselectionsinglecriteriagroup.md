...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=salePublish/isPublished,person/supportAssociate,person/personPager/description,person/personExtra/x_person_user_relation,appointment/recordType
