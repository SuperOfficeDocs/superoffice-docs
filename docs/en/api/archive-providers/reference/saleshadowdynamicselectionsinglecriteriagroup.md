...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=contact/contactUdef/SuperOffice:2,contact/contactExtra/x_contact_default_integer,appointment/associate/usergroupId,appointment/associate/credentialDisplayValue,document/isMail
