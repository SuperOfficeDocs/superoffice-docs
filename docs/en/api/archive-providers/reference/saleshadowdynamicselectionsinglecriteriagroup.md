...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=amountWeightedInBaseCurrency,sale/textId,person/hasInfoText,person/useAsMailingAddress,person/personUpdatedBy
