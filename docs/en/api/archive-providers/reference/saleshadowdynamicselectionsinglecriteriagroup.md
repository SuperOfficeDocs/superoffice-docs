...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/personId,person/personExtra/y_rental/x_start,person/personAssociate/firstName,person/personAssociate/ejUserId,contact/business
