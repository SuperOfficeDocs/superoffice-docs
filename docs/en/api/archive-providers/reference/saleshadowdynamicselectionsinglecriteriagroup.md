...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/userName,appointment/appointmentUdef/SuperOffice:4,document/associate/role,saleStakeholder/person/personUdef/SuperOffice:5,saleStakeholder/contact/contactAssociate/assocName
