...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=hasQuote,person/birthMonth,contact/category,appointment/completed,saleStakeholder/contact/hasInterests
