...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=recordType,person/firstName,person/restrictionAddress/formattedAddress,person/personExtra/y_rental/x_end,contact/name
