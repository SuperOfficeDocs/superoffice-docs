...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/lastName,person/retired,contact/hasInfoText,contact/contactFax/description,contact/contactUdef/SuperOffice:11
