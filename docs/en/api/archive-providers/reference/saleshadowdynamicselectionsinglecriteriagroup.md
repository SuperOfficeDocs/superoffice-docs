...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=stage,hasStakeholders,contact/updatedByFullName,contact/email/emailId,contact/postAddress/city
