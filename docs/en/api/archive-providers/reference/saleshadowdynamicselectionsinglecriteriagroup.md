...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=updatedBy,person/title,person/birthdate,person/restrictionAddress/wgs84longitude,contact/searchPhone/description
