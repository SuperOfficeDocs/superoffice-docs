...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=soldReason,person/rank,person/personUrl/URLAddress,person/restrictionAddress/state,person/personExtra/y_rental/x_start
