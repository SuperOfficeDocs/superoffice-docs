...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/personDeletedDate,person/personUrl/URLDescription,person/restrictionAddress/addressId,person/personExtra/y_rental/x_contact,person/personAssociate/assocTooltip
