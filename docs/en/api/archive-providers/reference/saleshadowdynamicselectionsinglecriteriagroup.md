...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/restrictionAddress/wgs84latitude,person/correspondingAssociate/title,document/document/description,saleStakeholder/person/correspondingAssociate/ejStatus,saleStakeholder/contact/contactExtra/x_contact_request_relation
