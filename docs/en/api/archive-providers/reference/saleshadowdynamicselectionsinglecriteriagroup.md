...
```http!
GET /api/v1/archive/SaleShadowDynamicSelectionSingleCriteriaGroup?$select=person/personAssociate/ejDisplayName,contact/streetAddress/line3,saleUdef/SuperOffice:4,appointment/type,appointment/associateId
