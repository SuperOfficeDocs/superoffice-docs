...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingType,mailingAddr/contact/email/emailBounceCount,associate/associateDbId,project/activeErpLinks
