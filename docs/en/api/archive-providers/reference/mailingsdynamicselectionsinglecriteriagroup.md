...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/contactUdef/SuperOffice:11,mailingAddr/person/birthYear,project/NumberOfNotCompletedActivitiesInPeriod
