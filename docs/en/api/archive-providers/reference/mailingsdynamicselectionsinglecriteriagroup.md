...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/streetAddress/addressId,associate/contactName,emailFlow/updatedBy,project/projectAssociate/contactId
