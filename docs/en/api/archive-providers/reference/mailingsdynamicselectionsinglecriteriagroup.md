...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/contactId,mailingAddr/contact/updatedDate,mailingAddr/person/personUrl/URLAddress
