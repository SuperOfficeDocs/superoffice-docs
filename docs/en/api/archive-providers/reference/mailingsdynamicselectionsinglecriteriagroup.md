...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingSelectionId,projectId,mailingAddr/contact/restrictionAddress/city,mailingAddr/contact/NumberOfNotCompletedActivitiesInPeriod,mailingAddr/person/restrictionAddress/line3
