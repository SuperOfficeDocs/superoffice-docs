...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/contact/postAddress/line3,mailingAddr/contact/url/URLAddress,mailingAddr/contact/contactAssociate/contactCategory,mailingAddr/contact/contactAssociate/ejUserId,mailingAddr/contact/contactAssociate/simultaneousEjUser
