...
```http!
GET /api/v1/archive/MailingsDynamicSelectionSingleCriteriaGroup?$select=mailingAddr/person/rank,mailingAddr/person/kanaFirstName,mailingAddr/contact/saintActivityType
