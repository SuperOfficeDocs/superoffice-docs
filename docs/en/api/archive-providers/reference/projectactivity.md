...
```http!
GET /api/v1/archive/ProjectActivity?$select=projectId,contact/contactNoMail,contact/saintTicketStatus,project/projectEvent/hasSignOn,project/projectAssociate/firstName
