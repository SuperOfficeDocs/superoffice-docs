...
```http!
GET /api/v1/archive/ProjectActivity?$select=saleId,person/contactId,person/personAssociate/role,contact/postAddress/county,contact/streetAddress/formattedMultiLineAddress
