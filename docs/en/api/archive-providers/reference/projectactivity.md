...
```http!
GET /api/v1/archive/ProjectActivity?$select=mailingAddr/contact/contactAssociate/associateDbId,mailingAddr/person/email/emailAddress,project/status,project/statusRank,project/projectPublish/publishedFrom
