...
```http!
GET /api/v1/archive/ProjectActivity?$select=mailingAddr/contact/name,mailingAddr/contact/contactSource,mailingAddr/contact/postAddress/wgs84longitude,mailingAddr/contact/LastDoBySale,mailingAddr/person/phone/formattedNumber
