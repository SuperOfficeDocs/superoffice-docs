...
```http!
GET /api/v1/archive/ProjectActivity?$select=type,mailingAddr/contact/streetAddress/line1,mailingAddr/person/rank,mailingAddr/person/personAssociate/mrMrs,mailingAddr/person/personAssociate/contactFullName
