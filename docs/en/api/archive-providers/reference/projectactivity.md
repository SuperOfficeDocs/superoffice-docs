...
```http!
GET /api/v1/archive/ProjectActivity?$select=mailingSent,recordTypeText,mailingAddr/person/personUdef/SuperOffice:3,project/projectAssociate/ejStatus,person/personAddress/wgs84longitude
