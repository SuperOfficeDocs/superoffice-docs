...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/isActive,sale/source,appointment/who,appointment/associate/personId,document/document/description
