...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/role,sale/icon,document/updatedByFullName,document/associate/assocTooltip,document/associate/otherGroups
