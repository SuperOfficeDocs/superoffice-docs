...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=document/attention,projectMember/personUpdatedDate,projectMember/personPager/formattedNumber,projectMember/personExtra/x_person_shorttext_list,projectMember/NumberOfTickets
