...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=sale/salePublish/isPublished,document/mailMergeDraft,projectMember/personExtra/x_person_contact_relation,projectMember/streetAddress/city
