...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectUrl/URLAddress,appointment/associate/role,appointment/appointment/isConverted,document/associate/assocTooltip,projectMember/middleName
