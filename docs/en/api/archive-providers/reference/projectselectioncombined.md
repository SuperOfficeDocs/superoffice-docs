...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=hasGuide,NumberOfSales,appointment/isFree,appointment/intention,document/documentPublish/isPublished
