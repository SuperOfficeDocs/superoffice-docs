...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/lastName,sale/time,projectMember/contactId,projectMember/hasInterests,projectMember/phone/formattedNumber
