...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/simultaneousEjUser,sale/stageRank,appointment/alarm,projectMember/projectMemberId,projectMember/associateType
