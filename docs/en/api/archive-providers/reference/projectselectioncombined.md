...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=appointment/associate/simultaneousEjUser,document/associate/simultaneousEjUser,projectMember/personUdef/SuperOffice:11,projectMember/personAssociate/locationAddress,projectMember/mainContact
