...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=status,appointment/registeredByFullName,projectMember/personExtra/x_person_request_relation,projectMember/hasEmarketingConsent
