...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectEvent/hasSignOff,appointment/text,appointment/registeredByFullName,appointment/completedDate,document/associate/assocTooltip
