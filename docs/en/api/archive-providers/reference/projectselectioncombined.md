...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=sale/associate/assocName,appointment/updatedByFullName,appointment/completedDate,document/associate/role,projectMember/updated
