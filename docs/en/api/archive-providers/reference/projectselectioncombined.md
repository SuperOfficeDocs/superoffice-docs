...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectPublish/publishedBy,projectAssociate/associateDbId,saintTicketStatus,sale/saleUdef/SuperOffice:3,appointment/suggestedAppointmentId
