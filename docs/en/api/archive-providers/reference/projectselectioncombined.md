...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectMember/contactAssociate/assocType,projectMember/contactExtra/x_contact_short_dropdown,appointment/appointmentUdef/SuperOffice:3
