...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=getAllRows,sale/associate/usergroup,appointment/associate/middleName,document/text,projectMember/personAddress/wgs84longitude
