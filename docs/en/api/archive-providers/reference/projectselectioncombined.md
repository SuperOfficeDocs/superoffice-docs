...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=saintAmountClass,sale/registeredBy,sale/associate/usergroup,appointment/appointment/isConverted,projectMember/hasEmarketingConsent
