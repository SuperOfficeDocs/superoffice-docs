...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectEvent/eventDate,sale/amountInBaseCurrency,sale/associate/ejDisplayName,document/yourref,document/suggestedDocumentId
