...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=number,projectAssociate/lastName,sale/associate/isLocation,projectMember/birthDay,projectMember/business
