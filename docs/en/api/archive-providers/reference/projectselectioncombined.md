...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectUrl/URLAddress,sale/personId,appointment/userGroup,appointment/associate/usergroupId,appointment/associate/personEmail
