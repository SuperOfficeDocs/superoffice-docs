...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectMember/personAssociateFullName,projectMember/streetAddress/wgs84longitude,projectMember/contactAssociate/ejStatus
