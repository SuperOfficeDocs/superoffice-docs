...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=appointment/recordTypeText,appointment/duration,appointment/appointmentPublish/publishedBy,document/time,projectMember/correspondingAssociate/isActive
