...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=LastDoBySale,appointment/type,appointment/appointmentUdef/SuperOffice:1,document/associate/personId,document/associate/ejUserId
