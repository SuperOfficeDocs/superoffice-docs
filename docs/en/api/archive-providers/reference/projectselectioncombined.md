...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/assocTooltip,document/documentId,projectMember/projectId,projectMember/personExtra/x_person_time
