...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectAssociate/lastName,sale/updatedDate,sale/activeErpLinks,sale/saleUdef/SuperOffice:4,appointment/appointmentPublish/publishedBy
