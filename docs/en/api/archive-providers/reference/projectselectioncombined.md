...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectId,projectAssociate/portraitThumbnail,sale/updatedByFullName,appointment/time,projectMember/personAddress/wgs84latitude
