...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=sale/text,sale/personId,sale/source,appointment/updatedByFullName,appointment/associate/contactName
