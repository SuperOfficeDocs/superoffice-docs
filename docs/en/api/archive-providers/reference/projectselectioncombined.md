...
```http!
GET /api/v1/archive/ProjectSelectionCombined?$select=projectEvent/hasSignOn,sale/associate/otherGroups,document/associate/lastName,document/associate/contactName,projectMember/personInfo/textId
