...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=endDate,contact/contactExtra/x_contact_dropdown,person/personUpdatedByFullName,person/personCategoryGroup,person/correspondingAssociate/ejUserId
