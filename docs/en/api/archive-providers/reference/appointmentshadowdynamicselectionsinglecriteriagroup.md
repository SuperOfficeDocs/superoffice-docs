...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=projectId,contact/contactPhone/formattedNumber,person/personUpdatedDate,person/createdByForm,person/correspondingAssociate/title
