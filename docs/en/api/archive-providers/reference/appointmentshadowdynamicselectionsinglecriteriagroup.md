...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=recordType,contact/email/emailLastBounce,contact/contactAssociate/ejStatus,contact/saintIntention,person/birthDay
