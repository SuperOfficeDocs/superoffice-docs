...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=cautionWarning,contact/postAddress/state,contact/NumberOfTickets,person/useAsMailingAddress,person/isProjectMember
