...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=person/personUdef/SuperOffice:5,person/correspondingAssociate/assocTooltip,appointmentUdef/SuperOffice:1,project/status,project/registeredByFullName
