...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=contact/forceCompany,contact/streetAddress/city,contact/contactUdef/SuperOffice:4,person/personAssociate/contactName
