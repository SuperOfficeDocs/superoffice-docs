...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=person/email/emailHasBounced,person/restrictionAddress/line2,person/personUdef/SuperOffice:7,sale/hasStakeholders
