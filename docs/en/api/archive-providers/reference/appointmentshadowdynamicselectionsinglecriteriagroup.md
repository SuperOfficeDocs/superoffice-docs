...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=contact/restrictionAddress/state,project/saintSaleStatus,associate/associateDbId
