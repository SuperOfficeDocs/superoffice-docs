...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=suggestedAppointmentId,contact/updatedDate,contact/registeredByFullName,contact/SaintStatus2,person/hasInfoText
