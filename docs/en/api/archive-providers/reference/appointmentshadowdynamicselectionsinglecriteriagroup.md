...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=updatedDate,contact/contactAssociate/contactFullName,person/personUdef/SuperOffice:2,project/icon,project/updatedDate
