...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=date,contact/postAddress/formattedAddress,person/kanaFirstName,sale/associate/portraitThumbnail
