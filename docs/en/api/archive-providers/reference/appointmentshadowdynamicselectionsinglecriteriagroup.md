...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=recurrenceRuleId,appointmentPublish/publishedFrom,contact/LastActivity,person/hasEmarketingConsent,project/projectAssociate/mrMrs
