...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=userGroup,registeredDate,contact/restrictionAddress/wgs84longitude,contact/SaintStatus2,project/registeredBy
