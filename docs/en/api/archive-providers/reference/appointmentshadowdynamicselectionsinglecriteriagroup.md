...
```http!
GET /api/v1/archive/AppointmentShadowDynamicSelectionSingleCriteriaGroup?$select=appointmentId,contact/email/emailAddress,contact/contactAssociate/ejUserId,person/personAssociate/assocType,person/personAssociate/simultaneousEjUser
