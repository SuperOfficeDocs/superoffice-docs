...
keywords: mdoprovider mdo provider relationssearchlistproviderappointmentdocumentpassive
...
## Sample Code
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("relationssearchlistproviderappointmentdocumentpassive", forceFlatList: true);
