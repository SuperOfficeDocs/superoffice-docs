...
keywords: mdoprovider mdo provider relationssearchlistprovidercontactpassive
...
## Sample Code
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("relationssearchlistprovidercontactpassive", forceFlatList: true);
