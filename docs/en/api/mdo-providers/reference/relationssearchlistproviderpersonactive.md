...
keywords: mdoprovider mdo provider relationssearchlistproviderpersonactive
...
## Sample Code
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("relationssearchlistproviderpersonactive", forceFlatList: true);
