...
keywords: mdoprovider mdo provider relationssearchlistprovidersaleappointmentpassive
...
## Sample Code
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("relationssearchlistprovidersaleappointmentpassive", forceFlatList: true);
