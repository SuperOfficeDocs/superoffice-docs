...
keywords: mdoprovider mdo provider relationssearchlistproviderdocumentdocumentpassive
...
## Sample Code
```cs
var listProvider = ClassFactory.CreateRequired<SuperOffice.CRM.Lists.ISoListProviderFactory>().Create("relationssearchlistproviderdocumentdocumentpassive", forceFlatList: true);
