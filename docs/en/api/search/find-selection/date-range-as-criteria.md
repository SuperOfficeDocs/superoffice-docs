---
uid: selection-dynamic-date-range-options
...
platform: web
redirect_from: 
  - /en/api/netserver/search/find-selection/date-range-as-criteria
  - /en/api/netserver/search/find-selection/convert-to-new-date-range-operators
  - /en/api/search/find-selection/convert-to-new-date-range-operators
---

# Dynamic date range as criteria

This section introduces and explains the **new** date range operators and [how to convert from legacy operators to new ones](#convert). You might also be interested in [referencing all criteria operators][1].
...
For example, if a user selects **This and next** 10 days and today is 15/10/2025, the date range will be 15/10/2025 – 25/10/2025. The selection includes all records that contains today's date or any date within the next 10 days.
...
For example, if a user selects **This and next** 2 weeks and today is 15/10/2025, the date range will be 14/10/2025 – 03/11/2025. The selection includes all records that contains dates from the current week or any date within the next 2 weeks.
...
For example, Iif a user selects **This and next** 2 months and today is 15/10/2025, the date range will be 01/10/2025 – 31/12/2025. The selection includes all records that contain dates from the current month or any date within the next 2 months.
...
For example, if a user selects **This and next** 1 quarter and today is 15/10/2025, the date range will be 01/10/2025 – 31/03/2026. The selection includes records with dates from the current quarter or any date within the next quarter.
...
For example, if the user selects **This and next** 2 years and today is 15/10/2025, the date range will be 01/01/2025 – 31/12/2027. The selection includes all records with dates the current year or any date within the next 2 years.
...
For example, if the user selects **This and previous** 5 days, and today is 15/10/2025, the date range is 10/10/2025 – 15/10/2025. The selection includes all records with dates from the previous 5 days until and including today (15/10/2025).
...
For example, if a user selects **This and previous** 3 weeks and today is 15/10/2025, the date range is 23/09/2025 – 20/10/2025. The selection includes all records with dates from the previous 3 weeks + the current week.
...
For example, if a user selects **This and previous** 4 months and today is 15/10/2025, the date range is 01/06/2025 – 31/10/2025. The selection includes all records with dates from the previous 4 months + the current month.
...
For example, Iif a user selects **This and previous** 2 quarters and today is 15/10/2025, the date range is 01/04/2025 – 31/12/2025. The selection includes all record with dates from the previous 2 quarters + the current quarter.
...
For example, if the user selects **This and Previous** 2 years and today is 15/10/2025, the date range is 01/01/2023 – 31/12/2025. The selection includes all records with dates from the 2 previous years, which is 2023 and 2024, it also includes all days of 2025.
...
For example, if a user selects **Previous period** 14 days and todays date is 15/10/2025, the date range will be 01/10/2025 – 14/10/2025. Meaning, the selection includes all records from the last 14 days, but not include the records from today
...
For example, if a user selects **Previous period** 2 weeks and todays date is 15/10/2025, the date range will be 30/09/2025 – 13/10/2025. Meaning, the selection includes all records from the last 2 weeks, but not include records from the current week.
...
For example, if a user selects **Previous period** 6 months and todays date is 15/10/2025, the date range is: 01/04/2025 – 30/09/2025. Meaning, the selection includes all records from the last six months, but not include records from the current month.
...
For example, if a user selects **Previous period** 1 quarter and todays date is 15/10/2025, the date range is 01/06/2025 – 30/09/2025. Meaning, the selection includes all records from the last quarter.
...
For example, if a user selects **Previous period** 2 years and todays date is 15/10/2025, the date range will be 01/01/2023 – 31/12/2024. Meaning, the selection includes all records from the previous 2 years, which are 2023 and 2024, it does not include the current year.
...
For example, if a user selects **This week** and todays date is 15/10/2025, the date range will be 14/10/2025 – 20/10/2025 (which is week 42). Meaning, the selection includes all records from the current week.
...
For example, if a user selects **This month** and todays date is 15/10/2025, the date range will be 01/10/2025 – 31/10/2025 (which is October). Meaning, the selection is only to include records from the current month.
...
For example, if a user selects **This quarter** and todays date is 15/10/2025, the date range will be 01/10/2025 – 31/12/2025. Meaning, the selection is only to include records from the current quarter.
...
For example, if a user selects **This year** and todays date is 15/10/2025, the date range will be 01/01/2025 – 31/12/2025. Meaning, the selection is only to include records from the current year, which in this case is 2025.
...
For example, if the user selects **Next period** 3 days and the current date is 15/10/2025, the date range will be the 16/10/2025 – 18/10/2025. Meaning, the selection is only to include records with dates in the next 3 days, and not include the current date.
...
For example, if the user selects **Next period** 4 weeks and the current date is 15/10/2025 (week 42), the date range is 21/10/2025 – 17/11/2025. Meaning, the selection is only to include records with dates in the next 4 weeks (week 43, 44, 45 and 46), and not the current week.
...
For example, if the user selects **Next period** 1 month and the current date is 15/10/2025, the date range is 01/11/2025 – 30/11/2025. Meaning, the selection will only include the next month and not the current month.
...
For example, if the user selects the **Next period** 2 quarters and the current date is 15/10/2025, the date range is 01/01/2026 – 30/06/2026. Meaning, the selection includes the next 2 quarters (Q1 and Q2) and not the current quarter.
...
For example, if a user selects **Next period** 3 years and the current date is 15/10/2025, the date range is 01/01/2026 – 31/12/2028. Meaning, the selection will include the next 3 years and not any dates of the current year.
...
For example, if a user selects **This, Previous and Next** days and todays date is 15/10/2025, the date range is 14/10/2025 – 16/10/2025. Meaning, the selection will include records from yesterday, today and tomorrow.
...
For example, if a user selects **This, Previous and Next** week and todays date is 15/10/2025, the date range is 07/10/2025 – 27/10/2025. Meaning, the result will include all records from the last week, the current week and the next week.
...
For example, if a user selects **This, Previous and Next** and todays date is 15/10/2025, the date range is 01/09/2025 – 30/11/2025. Meaning, the selection will include all records from the last month, the current month and the following month.
...
For example, if a user selects **This, Previous and Next** and todays date is 15/10/2025, the date range is 01/06/2025 – 30/03/2026. Meaning, the selection will include records from the last quarter, the current quarter and the next quarter.
...
For example, if a user selects **This, Previous and Next** and todays date is 15/10/2025, the date range is 01/01/2024 – 31/12/2026. Meaning, the selection will include records from last year, the current year and the next year.

## <a id="convert"></a>Converting to new dynamic date ranges
...
> [!NOTE]
> The examples assume that today is 18.03.2025.

| Old criteria | Examples | New criteria |
|---|---|---|
| Last week | Monday 09.03.2025 - Sunday 15.03.2025 | Previous period 1 week |
| This week | Monday 16.03.2025 - Sunday 22.03.2025 | This period week |
| Next week | Monday 23.03.2025 - Sunday 29.03.202 | Next period 1 week |
| Last month | 01.02.2025 - 29.02.2025 | Previous period 1 month |
| This month | 01.03.2025 - 31.03.2025 | This period month |
| Next month | 01.04.2025 - 30.04.2025 | Next period 1 month |
| Last Quarter | 01.10.2025 - 31.12.2025 | Previous period 1 quarter |
| This Quarter | 01.01.2025 - 31.03.2025 | This period quarter |
| Next Quarter | 01.04.2025 - 30.06.2025 | Next period 1 quarter |
| This half | 01.01.2025 - 30.06.2025 | This period 6 months |
| This year | 01.01.2025 - 31.12.2025 | This period year |
