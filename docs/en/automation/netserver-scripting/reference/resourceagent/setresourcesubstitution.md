...
Scripting events called on the <see cref='M:IResourceAgent.SetResourceSubstitution'>SetResourceSubstitution</see> method on the <see cref='IResourceAgent'>IResourceAgent</see>  service agent.
