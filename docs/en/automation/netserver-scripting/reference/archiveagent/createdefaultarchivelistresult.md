...
Scripting events called on the <see cref='M:IArchiveAgent.CreateDefaultArchiveListResult'>CreateDefaultArchiveListResult</see> method on the <see cref='IArchiveAgent'>IArchiveAgent</see>  service agent.
