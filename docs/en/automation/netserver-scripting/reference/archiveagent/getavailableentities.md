...
Scripting events called on the <see cref='M:IArchiveAgent.GetAvailableEntities'>GetAvailableEntities</see> method on the <see cref='IArchiveAgent'>IArchiveAgent</see>  service agent.
