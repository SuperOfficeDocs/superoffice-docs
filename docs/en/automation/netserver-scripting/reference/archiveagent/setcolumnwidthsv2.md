...
Scripting events called on the <see cref='M:IArchiveAgent.SetColumnWidthsV2'>SetColumnWidthsV2</see> method on the <see cref='IArchiveAgent'>IArchiveAgent</see>  service agent.
