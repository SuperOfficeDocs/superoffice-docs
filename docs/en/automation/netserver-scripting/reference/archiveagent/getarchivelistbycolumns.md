...
Scripting events called on the <see cref='M:IArchiveAgent.GetArchiveListByColumns'>GetArchiveListByColumns</see> method on the <see cref='IArchiveAgent'>IArchiveAgent</see>  service agent.
