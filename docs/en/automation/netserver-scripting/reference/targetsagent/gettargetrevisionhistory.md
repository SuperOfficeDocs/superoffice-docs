...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.ITargetsAgent.GetTargetRevisionHistory'>GetTargetRevisionHistory</see> method on the <see cref='ITargetsAgent'>ITargetsAgent</see>  service agent.
