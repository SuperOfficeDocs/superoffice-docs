...
Scripting events called on the <see cref='M:IBatchAgent.GetBatchTaskInfosByState'>GetBatchTaskInfosByState</see> method on the <see cref='IBatchAgent'>IBatchAgent</see>  service agent.
