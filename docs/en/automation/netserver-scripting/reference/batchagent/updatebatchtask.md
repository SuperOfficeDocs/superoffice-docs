...
Scripting events called on the <see cref='M:IBatchAgent.UpdateBatchTask'>UpdateBatchTask</see> method on the <see cref='IBatchAgent'>IBatchAgent</see>  service agent.
