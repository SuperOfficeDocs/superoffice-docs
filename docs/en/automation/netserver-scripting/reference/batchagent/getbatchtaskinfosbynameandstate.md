...
Scripting events called on the <see cref='M:IBatchAgent.GetBatchTaskInfosByNameAndState'>GetBatchTaskInfosByNameAndState</see> method on the <see cref='IBatchAgent'>IBatchAgent</see>  service agent.
