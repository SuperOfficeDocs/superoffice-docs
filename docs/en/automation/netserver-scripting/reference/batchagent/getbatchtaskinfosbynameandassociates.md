...
Scripting events called on the <see cref='M:IBatchAgent.GetBatchTaskInfosByNameAndAssociates'>GetBatchTaskInfosByNameAndAssociates</see> method on the <see cref='IBatchAgent'>IBatchAgent</see>  service agent.
