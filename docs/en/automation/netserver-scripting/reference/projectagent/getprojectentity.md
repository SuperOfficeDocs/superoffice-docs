...
Scripting events called on the <see cref='M:IProjectAgent.GetProjectEntity'>GetProjectEntity</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
