...
Scripting events called on the <see cref='M:IProjectAgent.GetMyMemberProjects'>GetMyMemberProjects</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
