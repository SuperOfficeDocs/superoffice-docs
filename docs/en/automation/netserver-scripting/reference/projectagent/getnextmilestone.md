---
uid: projectagent-getnextmilestone
title: ProjectAgent.GetNextMilestone event method
description: Scripting events called on the GetNextMilestone method on the ProjectAgent service agent.
so.generated: true
