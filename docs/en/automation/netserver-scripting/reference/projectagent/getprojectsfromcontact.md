...
Scripting events called on the <see cref='M:IProjectAgent.GetProjectsFromContact'>GetProjectsFromContact</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
