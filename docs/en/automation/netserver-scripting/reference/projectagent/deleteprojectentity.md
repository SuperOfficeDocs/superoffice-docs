...
Scripting events called on the <see cref='M:IProjectAgent.DeleteProjectEntity'>DeleteProjectEntity</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
