...
Scripting events called on the <see cref='M:IProjectAgent.GetProjectMembers'>GetProjectMembers</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
