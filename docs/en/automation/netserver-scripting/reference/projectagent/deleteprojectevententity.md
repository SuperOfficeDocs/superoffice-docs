...
Scripting events called on the <see cref='M:IProjectAgent.DeleteProjectEventEntity'>DeleteProjectEventEntity</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
