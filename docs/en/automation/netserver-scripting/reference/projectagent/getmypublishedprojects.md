...
Scripting events called on the <see cref='M:IProjectAgent.GetMyPublishedProjects'>GetMyPublishedProjects</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
