...
Scripting events called on the <see cref='M:IProjectAgent.SaveProjectEventEntity'>SaveProjectEventEntity</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
