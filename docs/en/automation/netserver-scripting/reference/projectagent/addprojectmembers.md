...
Scripting events called on the <see cref='M:IProjectAgent.AddProjectMembers'>AddProjectMembers</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
