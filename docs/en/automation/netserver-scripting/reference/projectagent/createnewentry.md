...
Scripting events called on the <see cref='M:IProjectAgent.CreateNewEntry'>CreateNewEntry</see> method on the <see cref='IProjectAgent'>IProjectAgent</see>  service agent.
