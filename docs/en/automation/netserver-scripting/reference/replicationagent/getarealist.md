...
Scripting events called on the <see cref='M:IReplicationAgent.GetAreaList'>GetAreaList</see> method on the <see cref='IReplicationAgent'>IReplicationAgent</see>  service agent.
