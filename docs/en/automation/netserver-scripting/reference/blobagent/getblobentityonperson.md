...
Scripting events called on the <see cref='M:IBLOBAgent.GetBlobEntityOnPerson'>GetBlobEntityOnPerson</see> method on the <see cref='IBLOBAgent'>IBLOBAgent</see>  service agent.
