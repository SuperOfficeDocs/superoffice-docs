---
uid: blobagent-getprojectimagewithsize
title: BLOBAgent.GetProjectImageWithSize event method
description: Scripting events called on the GetProjectImageWithSize method on the BLOBAgent service agent.
so.generated: true
