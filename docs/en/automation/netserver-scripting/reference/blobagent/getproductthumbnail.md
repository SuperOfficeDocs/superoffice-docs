...
Scripting events called on the <see cref='M:IBLOBAgent.GetProductThumbnail'>GetProductThumbnail</see> method on the <see cref='IBLOBAgent'>IBLOBAgent</see>  service agent.
