...
Scripting events called on the <see cref='M:IBLOBAgent.ChangeProductImage'>ChangeProductImage</see> method on the <see cref='IBLOBAgent'>IBLOBAgent</see>  service agent.
