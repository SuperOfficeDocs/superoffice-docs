...
Scripting events called on the <see cref='M:IBLOBAgent.SaveImageStream'>SaveImageStream</see> method on the <see cref='IBLOBAgent'>IBLOBAgent</see>  service agent.
