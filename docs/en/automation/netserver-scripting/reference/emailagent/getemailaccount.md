...
Scripting events called on the <see cref='M:IEMailAgent.GetEMailAccount'>GetEMailAccount</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
