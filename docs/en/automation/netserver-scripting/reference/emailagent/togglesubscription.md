...
Scripting events called on the <see cref='M:IEMailAgent.ToggleSubscription'>ToggleSubscription</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
