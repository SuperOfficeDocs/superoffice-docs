...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IEMailAgent.GetReadySyncEmailAccounts'>GetReadySyncEmailAccounts</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
