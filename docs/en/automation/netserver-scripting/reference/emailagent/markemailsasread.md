...
Scripting events called on the <see cref='M:IEMailAgent.MarkEmailsAsRead'>MarkEmailsAsRead</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
