...
Scripting events called on the <see cref='M:IEMailAgent.RefreshFolder'>RefreshFolder</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
