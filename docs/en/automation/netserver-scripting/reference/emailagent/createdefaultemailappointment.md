...
Scripting events called on the <see cref='M:IEMailAgent.CreateDefaultEMailAppointment'>CreateDefaultEMailAppointment</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
