...
Scripting events called on the <see cref='M:IEMailAgent.GetEMailAddresses'>GetEMailAddresses</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
