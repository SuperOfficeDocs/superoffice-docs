...
Scripting events called on the <see cref='M:IEMailAgent.GetEMailFromAttachmentId'>GetEMailFromAttachmentId</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
