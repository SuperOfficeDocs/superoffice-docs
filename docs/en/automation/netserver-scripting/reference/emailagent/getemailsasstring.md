...
Scripting events called on the <see cref='M:IEMailAgent.GetEmailsAsString'>GetEmailsAsString</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
