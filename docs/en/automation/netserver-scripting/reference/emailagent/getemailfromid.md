...
Scripting events called on the <see cref='M:IEMailAgent.GetEMailFromId'>GetEMailFromId</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
