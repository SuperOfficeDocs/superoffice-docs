...
Scripting events called on the <see cref='M:IEMailAgent.CreateDefaultEMailAccount'>CreateDefaultEMailAccount</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
