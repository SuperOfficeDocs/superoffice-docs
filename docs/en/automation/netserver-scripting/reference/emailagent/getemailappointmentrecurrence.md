...
Scripting events called on the <see cref='M:IEMailAgent.GetEmailAppointmentRecurrence'>GetEmailAppointmentRecurrence</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
