...
Scripting events called on the <see cref='M:IEMailAgent.CreateEMailFromDocumentEntity'>CreateEMailFromDocumentEntity</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
