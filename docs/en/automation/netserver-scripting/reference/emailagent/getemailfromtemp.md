...
Scripting events called on the <see cref='M:IEMailAgent.GetEMailFromTemp'>GetEMailFromTemp</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
