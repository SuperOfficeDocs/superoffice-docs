...
Scripting events called on the <see cref='M:IEMailAgent.GetPersonsFromEmailAddress'>GetPersonsFromEmailAddress</see> method on the <see cref='IEMailAgent'>IEMailAgent</see>  service agent.
