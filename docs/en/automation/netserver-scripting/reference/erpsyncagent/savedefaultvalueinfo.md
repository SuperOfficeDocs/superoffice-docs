...
Scripting events called on the <see cref='M:IErpSyncAgent.SaveDefaultValueInfo'>SaveDefaultValueInfo</see> method on the <see cref='IErpSyncAgent'>IErpSyncAgent</see>  service agent.
