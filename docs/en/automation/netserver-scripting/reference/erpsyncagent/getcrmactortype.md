...
Scripting events called on the <see cref='M:IErpSyncAgent.GetCrmActorType'>GetCrmActorType</see> method on the <see cref='IErpSyncAgent'>IErpSyncAgent</see>  service agent.
