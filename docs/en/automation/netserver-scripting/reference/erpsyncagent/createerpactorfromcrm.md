---
uid: erpsyncagent-createerpactorfromcrm
title: ErpSyncAgent.CreateErpActorFromCrm event method
description: Scripting events called on the CreateErpActorFromCrm method on the ErpSyncAgent service agent.
so.generated: true
