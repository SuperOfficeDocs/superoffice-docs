...
Scripting events called on the <see cref='M:IErpSyncAgent.GetConnectionListMappings'>GetConnectionListMappings</see> method on the <see cref='IErpSyncAgent'>IErpSyncAgent</see>  service agent.
