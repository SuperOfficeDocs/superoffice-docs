...
Scripting events called on the <see cref='M:IPhoneListAgent.GetContactPhones'>GetContactPhones</see> method on the <see cref='IPhoneListAgent'>IPhoneListAgent</see>  service agent.
