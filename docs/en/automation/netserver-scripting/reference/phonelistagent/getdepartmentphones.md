...
Scripting events called on the <see cref='M:IPhoneListAgent.GetDepartmentPhones'>GetDepartmentPhones</see> method on the <see cref='IPhoneListAgent'>IPhoneListAgent</see>  service agent.
