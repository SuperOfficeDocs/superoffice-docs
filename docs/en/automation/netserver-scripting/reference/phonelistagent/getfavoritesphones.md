...
Scripting events called on the <see cref='M:IPhoneListAgent.GetFavoritesPhones'>GetFavoritesPhones</see> method on the <see cref='IPhoneListAgent'>IPhoneListAgent</see>  service agent.
