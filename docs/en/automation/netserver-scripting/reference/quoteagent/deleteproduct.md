...
Scripting events called on the <see cref='M:IQuoteAgent.DeleteProduct'>DeleteProduct</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
