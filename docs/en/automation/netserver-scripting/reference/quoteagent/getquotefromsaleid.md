...
Scripting events called on the <see cref='M:IQuoteAgent.GetQuoteFromSaleId'>GetQuoteFromSaleId</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
