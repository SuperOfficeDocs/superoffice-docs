...
Scripting events called on the <see cref='M:IQuoteAgent.RequestApproval'>RequestApproval</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
