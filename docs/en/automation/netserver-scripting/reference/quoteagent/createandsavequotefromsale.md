...
Scripting events called on the <see cref='M:IQuoteAgent.CreateAndSaveQuoteFromSale'>CreateAndSaveQuoteFromSale</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
