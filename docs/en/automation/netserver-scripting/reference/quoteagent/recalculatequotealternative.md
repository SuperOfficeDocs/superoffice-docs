...
Scripting events called on the <see cref='M:IQuoteAgent.RecalculateQuoteAlternative'>RecalculateQuoteAlternative</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
