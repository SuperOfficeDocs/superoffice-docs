...
Scripting events called on the <see cref='M:IQuoteAgent.GetAllAvailableQuoteConnections'>GetAllAvailableQuoteConnections</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
