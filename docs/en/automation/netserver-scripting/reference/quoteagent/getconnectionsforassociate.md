...
Scripting events called on the <see cref='M:IQuoteAgent.GetConnectionsForAssociate'>GetConnectionsForAssociate</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
