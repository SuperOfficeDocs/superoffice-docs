...
Scripting events called on the <see cref='M:IQuoteAgent.GetQuoteVersionWorkflowState'>GetQuoteVersionWorkflowState</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
