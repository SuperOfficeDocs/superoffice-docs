...
Scripting events called on the <see cref='M:IQuoteAgent.GetActivePriceListsByCurrencyId'>GetActivePriceListsByCurrencyId</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
