...
Scripting events called on the <see cref='M:IQuoteAgent.DeleteConnection'>DeleteConnection</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
