...
Scripting events called on the <see cref='M:IAppointmentAgent.GetContactAppointmentsByTasks'>GetContactAppointmentsByTasks</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
