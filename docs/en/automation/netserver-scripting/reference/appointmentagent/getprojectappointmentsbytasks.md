...
Scripting events called on the <see cref='M:IAppointmentAgent.GetProjectAppointmentsByTasks'>GetProjectAppointmentsByTasks</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
