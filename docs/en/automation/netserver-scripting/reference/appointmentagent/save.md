...
Scripting events called on the <see cref='M:IAppointmentAgent.Save'>Save</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
