...
Scripting events called on the <see cref='M:IAppointmentAgent.CreateDefaultReOpenAppointment'>CreateDefaultReOpenAppointment</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
