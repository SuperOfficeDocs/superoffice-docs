...
Scripting events called on the <see cref='M:IAppointmentAgent.CleanUpRecurringBookingDeleted'>CleanUpRecurringBookingDeleted</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
