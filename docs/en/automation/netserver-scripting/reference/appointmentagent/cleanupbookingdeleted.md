...
Scripting events called on the <see cref='M:IAppointmentAgent.CleanUpBookingDeleted'>CleanUpBookingDeleted</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
