...
Scripting events called on the <see cref='M:IAppointmentAgent.SaveSuggestedAppointmentEntity'>SaveSuggestedAppointmentEntity</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
