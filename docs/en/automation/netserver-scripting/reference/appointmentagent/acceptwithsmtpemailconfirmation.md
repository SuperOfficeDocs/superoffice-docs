...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IAppointmentAgent.AcceptWithSmtpEmailConfirmation'>AcceptWithSmtpEmailConfirmation</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
