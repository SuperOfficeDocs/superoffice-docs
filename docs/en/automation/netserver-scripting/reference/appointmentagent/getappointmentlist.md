...
Scripting events called on the <see cref='M:IAppointmentAgent.GetAppointmentList'>GetAppointmentList</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
