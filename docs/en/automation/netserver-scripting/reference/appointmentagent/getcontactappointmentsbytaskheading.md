...
Scripting events called on the <see cref='M:IAppointmentAgent.GetContactAppointmentsByTaskHeading'>GetContactAppointmentsByTaskHeading</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
