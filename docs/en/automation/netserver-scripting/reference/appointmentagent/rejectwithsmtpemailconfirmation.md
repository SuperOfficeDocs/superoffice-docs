...
Scripting events called on the <see cref='M:IAppointmentAgent.RejectWithSmtpEmailConfirmation'>RejectWithSmtpEmailConfirmation</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
