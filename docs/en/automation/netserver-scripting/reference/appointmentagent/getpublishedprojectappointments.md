...
Scripting events called on the <see cref='M:IAppointmentAgent.GetPublishedProjectAppointments'>GetPublishedProjectAppointments</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
