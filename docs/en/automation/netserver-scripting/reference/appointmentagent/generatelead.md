...
Scripting events called on the <see cref='M:IAppointmentAgent.GenerateLead'>GenerateLead</see> method on the <see cref='IAppointmentAgent'>IAppointmentAgent</see>  service agent.
