...
Scripting events called on the <see cref='M:IUserDefinedFieldInfoAgent.SaveUserDefinedFieldInfo'>SaveUserDefinedFieldInfo</see> method on the <see cref='IUserDefinedFieldInfoAgent'>IUserDefinedFieldInfoAgent</see>  service agent.
