...
Scripting events called on the <see cref='M:IAudienceAgent.GetConfigParametersOnPerson'>GetConfigParametersOnPerson</see> method on the <see cref='IAudienceAgent'>IAudienceAgent</see>  service agent.
