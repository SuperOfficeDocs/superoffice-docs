...
Scripting events called on the <see cref='M:IAudienceAgent.GetAudienceLayoutByName'>GetAudienceLayoutByName</see> method on the <see cref='IAudienceAgent'>IAudienceAgent</see>  service agent.
