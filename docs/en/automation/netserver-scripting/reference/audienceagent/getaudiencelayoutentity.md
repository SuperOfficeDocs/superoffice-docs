...
Scripting events called on the <see cref='M:IAudienceAgent.GetAudienceLayoutEntity'>GetAudienceLayoutEntity</see> method on the <see cref='IAudienceAgent'>IAudienceAgent</see>  service agent.
