...
Scripting events called on the <see cref='M:ILicenseAgent.GetLicenseStatusFromLicenseServer'>GetLicenseStatusFromLicenseServer</see> method on the <see cref='ILicenseAgent'>ILicenseAgent</see>  service agent.
