...
Scripting events called on the <see cref='M:ILicenseAgent.GetUserLicenses'>GetUserLicenses</see> method on the <see cref='ILicenseAgent'>ILicenseAgent</see>  service agent.
