...
Scripting events called on the <see cref='M:ILicenseAgent.AddLicenseFromFile'>AddLicenseFromFile</see> method on the <see cref='ILicenseAgent'>ILicenseAgent</see>  service agent.
