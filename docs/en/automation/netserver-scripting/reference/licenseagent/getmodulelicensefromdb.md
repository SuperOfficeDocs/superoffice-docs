...
Scripting events called on the <see cref='M:ILicenseAgent.GetModuleLicenseFromDB'>GetModuleLicenseFromDB</see> method on the <see cref='ILicenseAgent'>ILicenseAgent</see>  service agent.
