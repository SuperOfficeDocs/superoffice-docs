...
Scripting events called on the <see cref='M:ILicenseAgent.GetThirdPartyLicenseAssignments'>GetThirdPartyLicenseAssignments</see> method on the <see cref='ILicenseAgent'>ILicenseAgent</see>  service agent.
