...
Scripting events called on the <see cref='M:ILicenseAgent.GetLicenseFromFile'>GetLicenseFromFile</see> method on the <see cref='ILicenseAgent'>ILicenseAgent</see>  service agent.
