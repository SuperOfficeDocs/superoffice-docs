...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.ILicenseAgent.GetUserLicensesMDOList'>GetUserLicensesMDOList</see> method on the <see cref='ILicenseAgent'>ILicenseAgent</see>  service agent.
