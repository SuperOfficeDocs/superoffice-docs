...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IPersonAgent.CreateDefaultFromCredential'>CreateDefaultFromCredential</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
