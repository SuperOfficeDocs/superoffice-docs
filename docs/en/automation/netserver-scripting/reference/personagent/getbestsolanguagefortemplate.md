...
Scripting events called on the <see cref='M:IPersonAgent.GetBestSoLanguageForTemplate'>GetBestSoLanguageForTemplate</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
