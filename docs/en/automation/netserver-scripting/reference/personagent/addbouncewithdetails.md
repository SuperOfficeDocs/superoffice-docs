...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IPersonAgent.AddBounceWithDetails'>AddBounceWithDetails</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
