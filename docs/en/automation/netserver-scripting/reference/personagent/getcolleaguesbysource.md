...
Scripting events called on the <see cref='M:IPersonAgent.GetColleaguesBySource'>GetColleaguesBySource</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
