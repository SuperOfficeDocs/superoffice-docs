...
Scripting events called on the <see cref='M:IPersonAgent.RemoveConsent'>RemoveConsent</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
