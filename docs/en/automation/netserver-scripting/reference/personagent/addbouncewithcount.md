...
Scripting events called on the <see cref='M:IPersonAgent.AddBounceWithCount'>AddBounceWithCount</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
