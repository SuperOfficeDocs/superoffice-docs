...
Scripting events called on the <see cref='M:IPersonAgent.DeletePersonEntity'>DeletePersonEntity</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
