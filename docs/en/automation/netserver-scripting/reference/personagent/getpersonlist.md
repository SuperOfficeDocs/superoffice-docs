...
Scripting events called on the <see cref='M:IPersonAgent.GetPersonList'>GetPersonList</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
