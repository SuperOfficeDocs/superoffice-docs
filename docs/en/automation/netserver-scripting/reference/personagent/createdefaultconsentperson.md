...
Scripting events called on the <see cref='M:IPersonAgent.CreateDefaultConsentPerson'>CreateDefaultConsentPerson</see> method on the <see cref='IPersonAgent'>IPersonAgent</see>  service agent.
