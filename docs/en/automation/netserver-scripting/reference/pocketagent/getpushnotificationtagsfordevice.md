...
Scripting events called on the <see cref='M:IPocketAgent.GetPushNotificationTagsForDevice'>GetPushNotificationTagsForDevice</see> method on the <see cref='IPocketAgent'>IPocketAgent</see>  service agent.
