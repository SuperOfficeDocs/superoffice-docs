...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IPocketAgent.NotificationsHandled'>NotificationsHandled</see> method on the <see cref='IPocketAgent'>IPocketAgent</see>  service agent.
