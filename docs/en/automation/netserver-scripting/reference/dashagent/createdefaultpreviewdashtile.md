...
Scripting events called on the <see cref='M:IDashAgent.CreateDefaultPreviewDashTile'>CreateDefaultPreviewDashTile</see> method on the <see cref='IDashAgent'>IDashAgent</see>  service agent.
