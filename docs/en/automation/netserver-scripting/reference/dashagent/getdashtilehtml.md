...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IDashAgent.GetDashTileHtml'>GetDashTileHtml</see> method on the <see cref='IDashAgent'>IDashAgent</see>  service agent.
