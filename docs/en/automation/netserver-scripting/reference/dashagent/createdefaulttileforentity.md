...
Scripting events called on the <see cref='M:IDashAgent.CreateDefaultTileForEntity'>CreateDefaultTileForEntity</see> method on the <see cref='IDashAgent'>IDashAgent</see>  service agent.
