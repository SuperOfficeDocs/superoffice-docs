...
Scripting events called on the <see cref='M:IDashAgent.CreateDefaultDashTheme'>CreateDefaultDashTheme</see> method on the <see cref='IDashAgent'>IDashAgent</see>  service agent.
