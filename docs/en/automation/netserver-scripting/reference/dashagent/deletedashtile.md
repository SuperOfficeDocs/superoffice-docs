...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IDashAgent.DeleteDashTile'>DeleteDashTile</see> method on the <see cref='IDashAgent'>IDashAgent</see>  service agent.
