...
Scripting events called on the <see cref='M:IDashAgent.CreateDefaultDashCollection'>CreateDefaultDashCollection</see> method on the <see cref='IDashAgent'>IDashAgent</see>  service agent.
