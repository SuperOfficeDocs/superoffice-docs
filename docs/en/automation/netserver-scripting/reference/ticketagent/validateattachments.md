...
Scripting events called on the <see cref='M:ITicketAgent.ValidateAttachments'>ValidateAttachments</see> method on the <see cref='ITicketAgent'>ITicketAgent</see>  service agent.
