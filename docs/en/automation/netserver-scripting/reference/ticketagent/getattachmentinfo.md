...
Scripting events called on the <see cref='M:ITicketAgent.GetAttachmentInfo'>GetAttachmentInfo</see> method on the <see cref='ITicketAgent'>ITicketAgent</see>  service agent.
