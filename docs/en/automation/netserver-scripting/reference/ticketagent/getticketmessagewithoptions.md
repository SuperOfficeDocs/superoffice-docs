...
Scripting events called on the <see cref='M:ITicketAgent.GetTicketMessageWithOptions'>GetTicketMessageWithOptions</see> method on the <see cref='ITicketAgent'>ITicketAgent</see>  service agent.
