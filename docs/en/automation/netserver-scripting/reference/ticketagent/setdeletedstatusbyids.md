...
Scripting events called on the <see cref='M:ITicketAgent.SetDeletedStatusByIds'>SetDeletedStatusByIds</see> method on the <see cref='ITicketAgent'>ITicketAgent</see>  service agent.
