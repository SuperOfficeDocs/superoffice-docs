...
Scripting events called on the <see cref='M:ITicketAgent.SendTicketMessageSms'>SendTicketMessageSms</see> method on the <see cref='ITicketAgent'>ITicketAgent</see>  service agent.
