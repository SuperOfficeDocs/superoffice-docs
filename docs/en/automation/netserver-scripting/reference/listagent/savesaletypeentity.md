...
Scripting events called on the <see cref='M:IListAgent.SaveSaleTypeEntity'>SaveSaleTypeEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
