...
Scripting events called on the <see cref='M:IListAgent.SetVisibleForUserGroups'>SetVisibleForUserGroups</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
