...
Scripting events called on the <see cref='M:IListAgent.DeleteListEntity'>DeleteListEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
