...
Scripting events called on the <see cref='M:IListAgent.GetDocumentTemplates'>GetDocumentTemplates</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
