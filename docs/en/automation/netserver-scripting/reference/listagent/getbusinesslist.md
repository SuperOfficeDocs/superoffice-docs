...
Scripting events called on the <see cref='M:IListAgent.GetBusinessList'>GetBusinessList</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
