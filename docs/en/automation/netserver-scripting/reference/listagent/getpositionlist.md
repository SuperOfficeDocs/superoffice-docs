...
Scripting events called on the <see cref='M:IListAgent.GetPositionList'>GetPositionList</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
