...
Scripting events called on the <see cref='M:IListAgent.GetRelationDefinitionEntity'>GetRelationDefinitionEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
