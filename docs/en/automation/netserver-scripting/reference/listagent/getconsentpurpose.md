...
Scripting events called on the <see cref='M:IListAgent.GetConsentPurpose'>GetConsentPurpose</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
