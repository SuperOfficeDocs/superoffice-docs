...
Scripting events called on the <see cref='M:IListAgent.GetDocumentTemplateUrl'>GetDocumentTemplateUrl</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
