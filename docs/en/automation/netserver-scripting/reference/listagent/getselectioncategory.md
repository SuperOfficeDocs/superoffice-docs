...
Scripting events called on the <see cref='M:IListAgent.GetSelectionCategory'>GetSelectionCategory</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
