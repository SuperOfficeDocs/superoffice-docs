...
Scripting events called on the <see cref='M:IListAgent.GetSaleTypeEntity'>GetSaleTypeEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
