...
Scripting events called on the <see cref='M:IListAgent.SaveSaleStageEntity'>SaveSaleStageEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
