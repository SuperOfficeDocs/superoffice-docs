---
uid: listagent-getcurrencies
title: ListAgent.GetCurrencies event method
description: Scripting events called on the GetCurrencies method on the ListAgent service agent.
so.generated: true
