...
Scripting events called on the <see cref='M:IListAgent.GetConsentPurposeList'>GetConsentPurposeList</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
