...
Scripting events called on the <see cref='M:IListAgent.GetTicketStatusList'>GetTicketStatusList</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
