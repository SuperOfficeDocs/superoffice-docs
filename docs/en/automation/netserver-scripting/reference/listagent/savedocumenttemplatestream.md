...
Scripting events called on the <see cref='M:IListAgent.SaveDocumentTemplateStream'>SaveDocumentTemplateStream</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
