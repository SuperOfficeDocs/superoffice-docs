...
Scripting events called on the <see cref='M:IListAgent.SetListItemsForHeadingFromListName'>SetListItemsForHeadingFromListName</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
