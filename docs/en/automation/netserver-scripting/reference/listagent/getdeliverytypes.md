...
Scripting events called on the <see cref='M:IListAgent.GetDeliveryTypes'>GetDeliveryTypes</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
