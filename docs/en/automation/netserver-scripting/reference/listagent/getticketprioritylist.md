...
Scripting events called on the <see cref='M:IListAgent.GetTicketPriorityList'>GetTicketPriorityList</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
