...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IListAgent.GetDocumentTemplateTask'>GetDocumentTemplateTask</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
