...
Scripting events called on the <see cref='M:IListAgent.GetProjectTypeEntity'>GetProjectTypeEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
