...
Scripting events called on the <see cref='M:IListAgent.SaveHeadingFromListDefinition'>SaveHeadingFromListDefinition</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
