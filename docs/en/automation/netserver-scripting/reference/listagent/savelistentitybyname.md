...
Scripting events called on the <see cref='M:IListAgent.SaveListEntityByName'>SaveListEntityByName</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
