...
Scripting events called on the <see cref='M:IListAgent.GetLocalizedTextByType'>GetLocalizedTextByType</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
