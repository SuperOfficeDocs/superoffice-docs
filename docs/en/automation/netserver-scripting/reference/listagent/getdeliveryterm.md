...
Scripting events called on the <see cref='M:IListAgent.GetDeliveryTerm'>GetDeliveryTerm</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
