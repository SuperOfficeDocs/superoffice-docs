...
Scripting events called on the <see cref='M:IListAgent.GetDocumentTemplatesTasks'>GetDocumentTemplatesTasks</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
