...
Scripting events called on the <see cref='M:IListAgent.DeleteTicketStatusEntity'>DeleteTicketStatusEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
