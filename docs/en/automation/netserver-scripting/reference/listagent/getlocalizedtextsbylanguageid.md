...
Scripting events called on the <see cref='M:IListAgent.GetLocalizedTextsByLanguageId'>GetLocalizedTextsByLanguageId</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
