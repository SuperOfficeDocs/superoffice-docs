...
Scripting events called on the <see cref='M:IListAgent.GetDeliveryType'>GetDeliveryType</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
