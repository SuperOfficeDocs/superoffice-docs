...
Scripting events called on the <see cref='M:IListAgent.GetCurrencyEntity'>GetCurrencyEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
