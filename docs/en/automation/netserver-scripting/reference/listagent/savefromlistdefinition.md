...
Scripting events called on the <see cref='M:IListAgent.SaveFromListDefinition'>SaveFromListDefinition</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
