...
Scripting events called on the <see cref='M:IListAgent.SetDocumentPluginForAllDocumentTemplates'>SetDocumentPluginForAllDocumentTemplates</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
