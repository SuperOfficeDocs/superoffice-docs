...
Scripting events called on the <see cref='M:IListAgent.GetAllSaleStages'>GetAllSaleStages</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
