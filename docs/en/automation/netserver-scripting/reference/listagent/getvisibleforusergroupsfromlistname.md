...
Scripting events called on the <see cref='M:IListAgent.GetVisibleForUserGroupsFromListName'>GetVisibleForUserGroupsFromListName</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
