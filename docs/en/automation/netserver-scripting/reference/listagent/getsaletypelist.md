...
Scripting events called on the <see cref='M:IListAgent.GetSaleTypeList'>GetSaleTypeList</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
