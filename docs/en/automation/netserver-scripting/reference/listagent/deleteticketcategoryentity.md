...
Scripting events called on the <see cref='M:IListAgent.DeleteTicketCategoryEntity'>DeleteTicketCategoryEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
