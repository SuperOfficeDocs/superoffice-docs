...
Scripting events called on the <see cref='M:IListAgent.CreateDefaultHeadingEntity'>CreateDefaultHeadingEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
