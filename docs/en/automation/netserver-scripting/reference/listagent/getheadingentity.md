...
Scripting events called on the <see cref='M:IListAgent.GetHeadingEntity'>GetHeadingEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
