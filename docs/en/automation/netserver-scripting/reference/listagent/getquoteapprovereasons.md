...
Scripting events called on the <see cref='M:IListAgent.GetQuoteApproveReasons'>GetQuoteApproveReasons</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
