...
Scripting events called on the <see cref='M:IListAgent.GetTicketStatusEntity'>GetTicketStatusEntity</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
