...
Scripting events called on the <see cref='M:IListAgent.SetRankOnProjectDocument'>SetRankOnProjectDocument</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
