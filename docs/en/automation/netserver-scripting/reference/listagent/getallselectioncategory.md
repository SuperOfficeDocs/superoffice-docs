...
Scripting events called on the <see cref='M:IListAgent.GetAllSelectionCategory'>GetAllSelectionCategory</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
