...
Scripting events called on the <see cref='M:IListAgent.DeleteAppWebPanels'>DeleteAppWebPanels</see> method on the <see cref='IListAgent'>IListAgent</see>  service agent.
