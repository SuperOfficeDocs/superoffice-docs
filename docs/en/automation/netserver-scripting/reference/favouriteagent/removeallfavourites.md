...
Scripting events called on the <see cref='M:IFavouriteAgent.RemoveAllFavourites'>RemoveAllFavourites</see> method on the <see cref='IFavouriteAgent'>IFavouriteAgent</see>  service agent.
