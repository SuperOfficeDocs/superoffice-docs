...
Scripting events called on the <see cref='M:IDocumentAgent.SetDocumentStreamFromId'>SetDocumentStreamFromId</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
