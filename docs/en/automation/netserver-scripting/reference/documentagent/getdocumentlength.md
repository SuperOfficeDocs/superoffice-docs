...
Scripting events called on the <see cref='M:IDocumentAgent.GetDocumentLength'>GetDocumentLength</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
