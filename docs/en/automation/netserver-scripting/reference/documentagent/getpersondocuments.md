...
Scripting events called on the <see cref='M:IDocumentAgent.GetPersonDocuments'>GetPersonDocuments</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
