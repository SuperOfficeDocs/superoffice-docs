...
Scripting events called on the <see cref='M:IDocumentAgent.GetDocument'>GetDocument</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
