...
Scripting events called on the <see cref='M:IDocumentAgent.DeletePhysicalDocument'>DeletePhysicalDocument</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
