---
uid: documentagent-getpublisheddocument
title: DocumentAgent.GetPublishedDocument event method
description: Scripting events called on the GetPublishedDocument method on the DocumentAgent service agent.
so.generated: true
