...
Scripting events called on the <see cref='M:IDocumentAgent.GetPersonDocumentsByTemplateTypes'>GetPersonDocumentsByTemplateTypes</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
