...
Scripting events called on the <see cref='M:IDocumentAgent.SaveDocumentEntity'>SaveDocumentEntity</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
