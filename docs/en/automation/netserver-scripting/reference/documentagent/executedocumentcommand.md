...
Scripting events called on the <see cref='M:IDocumentAgent.ExecuteDocumentCommand'>ExecuteDocumentCommand</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
