...
Scripting events called on the <see cref='M:IDocumentAgent.GetDocumentsByTemplateHeading'>GetDocumentsByTemplateHeading</see> method on the <see cref='IDocumentAgent'>IDocumentAgent</see>  service agent.
