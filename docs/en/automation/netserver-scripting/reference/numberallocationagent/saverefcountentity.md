...
Scripting events called on the <see cref='M:INumberAllocationAgent.SaveRefCountEntity'>SaveRefCountEntity</see> method on the <see cref='INumberAllocationAgent'>INumberAllocationAgent</see>  service agent.
