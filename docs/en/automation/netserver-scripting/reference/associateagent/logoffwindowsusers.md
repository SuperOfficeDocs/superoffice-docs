---
uid: associateagent-logoffwindowsusers
title: AssociateAgent.LogOffWindowsUsers event method
description: Scripting events called on the LogOffWindowsUsers method on the AssociateAgent service agent.
so.generated: true
