...
Scripting events called on the <see cref='M:IAssociateAgent.GetAssociateByPersonId'>GetAssociateByPersonId</see> method on the <see cref='IAssociateAgent'>IAssociateAgent</see>  service agent.
