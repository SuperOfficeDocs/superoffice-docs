...
Scripting events called on the <see cref='M:IAssociateAgent.GetNote'>GetNote</see> method on the <see cref='IAssociateAgent'>IAssociateAgent</see>  service agent.
