...
Scripting events called on the <see cref='M:IAssociateAgent.GetAssociate'>GetAssociate</see> method on the <see cref='IAssociateAgent'>IAssociateAgent</see>  service agent.
