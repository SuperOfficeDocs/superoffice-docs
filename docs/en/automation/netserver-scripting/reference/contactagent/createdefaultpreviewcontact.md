...
Scripting events called on the <see cref='M:IContactAgent.CreateDefaultPreviewContact'>CreateDefaultPreviewContact</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
