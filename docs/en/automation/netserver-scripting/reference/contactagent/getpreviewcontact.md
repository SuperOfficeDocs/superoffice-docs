...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IContactAgent.GetPreviewContact'>GetPreviewContact</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
