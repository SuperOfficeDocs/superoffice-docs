...
Scripting events called on the <see cref='M:IContactAgent.GetQuoteVersionAddresses'>GetQuoteVersionAddresses</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
