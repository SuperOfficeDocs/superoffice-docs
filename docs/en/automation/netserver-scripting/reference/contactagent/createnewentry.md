...
Scripting events called on the <see cref='M:IContactAgent.CreateNewEntry'>CreateNewEntry</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
