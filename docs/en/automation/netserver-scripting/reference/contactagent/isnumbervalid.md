...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IContactAgent.IsNumberValid'>IsNumberValid</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
