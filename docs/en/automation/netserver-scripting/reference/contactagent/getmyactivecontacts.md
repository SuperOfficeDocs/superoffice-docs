...
Scripting events called on the <see cref='M:IContactAgent.GetMyActiveContacts'>GetMyActiveContacts</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
