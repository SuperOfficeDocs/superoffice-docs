...
Scripting events called on the <see cref='M:IContactAgent.GetContactWithPersons'>GetContactWithPersons</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
