...
Scripting events called on the <see cref='M:IContactAgent.DeleteContactEntity'>DeleteContactEntity</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
