...
Scripting events called on the <see cref='M:IContactAgent.GetContactEntity'>GetContactEntity</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
