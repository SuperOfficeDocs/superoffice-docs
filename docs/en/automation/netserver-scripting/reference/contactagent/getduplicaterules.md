...
Scripting events called on the <see cref='M:IContactAgent.GetDuplicateRules'>GetDuplicateRules</see> method on the <see cref='IContactAgent'>IContactAgent</see>  service agent.
