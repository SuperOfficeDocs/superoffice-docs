...
Scripting events called on the <see cref='M:IFindAgent.SaveRestrictions'>SaveRestrictions</see> method on the <see cref='IFindAgent'>IFindAgent</see>  service agent.
