...
Scripting events called on the <see cref='M:IFindAgent.GetDefaultDesiredColumns'>GetDefaultDesiredColumns</see> method on the <see cref='IFindAgent'>IFindAgent</see>  service agent.
