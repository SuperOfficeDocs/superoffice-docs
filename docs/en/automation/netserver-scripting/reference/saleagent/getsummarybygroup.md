...
Scripting events called on the <see cref='M:ISaleAgent.GetSummaryByGroup'>GetSummaryByGroup</see> method on the <see cref='ISaleAgent'>ISaleAgent</see>  service agent.
