---
uid: saleagent-isnumbervalid
title: SaleAgent.IsNumberValid event method
description: Scripting events called on the IsNumberValid method on the SaleAgent service agent.
so.generated: true
