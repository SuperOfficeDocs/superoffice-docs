...
Scripting events called on the <see cref='M:ISaleAgent.GetSaleStakeholders'>GetSaleStakeholders</see> method on the <see cref='ISaleAgent'>ISaleAgent</see>  service agent.
