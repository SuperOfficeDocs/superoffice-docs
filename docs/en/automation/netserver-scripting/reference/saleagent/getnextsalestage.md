---
uid: saleagent-getnextsalestage
title: SaleAgent.GetNextSaleStage event method
description: Scripting events called on the GetNextSaleStage method on the SaleAgent service agent.
so.generated: true
