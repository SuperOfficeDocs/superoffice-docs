...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.ISaleAgent.HasGuide'>HasGuide</see> method on the <see cref='ISaleAgent'>ISaleAgent</see>  service agent.
