...
Scripting events called on the <see cref='M:ISaleAgent.GetSalesFromContact'>GetSalesFromContact</see> method on the <see cref='ISaleAgent'>ISaleAgent</see>  service agent.
