...
Scripting events called on the <see cref='M:ISaleAgent.UpdateSaleStakeholders'>UpdateSaleStakeholders</see> method on the <see cref='ISaleAgent'>ISaleAgent</see>  service agent.
