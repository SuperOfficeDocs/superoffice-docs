...
```cs
    static void BeforeBatchUpdateNextDueDate(
...
## AfterBatchUpdateNextDueDate
```cs
    static void AfterBatchUpdateNextDueDate(
       ref object  eventState
      );
```
...
## AfterBatchUpdateNextDueDateAsync
```cs
    static void AfterBatchUpdateNextDueDateAsync(
       ref object  eventState
      );
```
