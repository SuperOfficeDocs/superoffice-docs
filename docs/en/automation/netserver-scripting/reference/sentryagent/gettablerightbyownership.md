...
Scripting events called on the <see cref='M:ISentryAgent.GetTableRightByOwnership'>GetTableRightByOwnership</see> method on the <see cref='ISentryAgent'>ISentryAgent</see>  service agent.
