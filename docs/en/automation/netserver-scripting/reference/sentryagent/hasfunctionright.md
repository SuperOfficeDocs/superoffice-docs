...
Scripting events called on the <see cref='M:ISentryAgent.HasFunctionRight'>HasFunctionRight</see> method on the <see cref='ISentryAgent'>ISentryAgent</see>  service agent.
