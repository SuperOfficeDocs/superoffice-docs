...
Scripting events called on the <see cref='M:IChatAgent.ChatSessionsForUser'>ChatSessionsForUser</see> method on the <see cref='IChatAgent'>IChatAgent</see>  service agent.
