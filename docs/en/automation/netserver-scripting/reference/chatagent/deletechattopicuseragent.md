...
Scripting events called on the <see cref='M:IChatAgent.DeleteChatTopicUserAgent'>DeleteChatTopicUserAgent</see> method on the <see cref='IChatAgent'>IChatAgent</see>  service agent.
