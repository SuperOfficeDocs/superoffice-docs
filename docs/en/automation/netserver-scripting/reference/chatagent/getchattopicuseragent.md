...
Scripting events called on the <see cref='M:IChatAgent.GetChatTopicUserAgent'>GetChatTopicUserAgent</see> method on the <see cref='IChatAgent'>IChatAgent</see>  service agent.
