...
Scripting events called on the <see cref='M:IMDOAgent.GetSelectableList'>GetSelectableList</see> method on the <see cref='IMDOAgent'>IMDOAgent</see>  service agent.
