...
Scripting events called on the <see cref='M:IPreferenceAgent.GetTabOrders'>GetTabOrders</see> method on the <see cref='IPreferenceAgent'>IPreferenceAgent</see>  service agent.
