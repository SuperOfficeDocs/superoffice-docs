...
Scripting events called on the <see cref='M:IPreferenceAgent.GetPreferences'>GetPreferences</see> method on the <see cref='IPreferenceAgent'>IPreferenceAgent</see>  service agent.
