...
Scripting events called on the <see cref='M:IPreferenceAgent.GetPreferenceByNameAndId'>GetPreferenceByNameAndId</see> method on the <see cref='IPreferenceAgent'>IPreferenceAgent</see>  service agent.
