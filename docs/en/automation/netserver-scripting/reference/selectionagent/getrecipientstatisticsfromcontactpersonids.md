...
Scripting events called on the <see cref='M:ISelectionAgent.GetRecipientStatisticsFromContactPersonIds'>GetRecipientStatisticsFromContactPersonIds</see> method on the <see cref='ISelectionAgent'>ISelectionAgent</see>  service agent.
