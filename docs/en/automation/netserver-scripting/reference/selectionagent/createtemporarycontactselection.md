...
Scripting events called on the <see cref='M:ISelectionAgent.CreateTemporaryContactSelection'>CreateTemporaryContactSelection</see> method on the <see cref='ISelectionAgent'>ISelectionAgent</see>  service agent.
