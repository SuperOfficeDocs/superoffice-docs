...
Scripting events called on the <see cref='M:ISelectionAgent.SetDynamicSelectionCriteria2'>SetDynamicSelectionCriteria2</see> method on the <see cref='ISelectionAgent'>ISelectionAgent</see>  service agent.
