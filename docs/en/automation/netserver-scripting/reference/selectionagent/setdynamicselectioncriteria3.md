---
uid: selectionagent-setdynamicselectioncriteria3
...
```cs
    static void BeforeSetDynamicSelectionCriteria3(
       Int32  selectionId,
...
## AfterSetDynamicSelectionCriteria3
```cs
    static void AfterSetDynamicSelectionCriteria3(
       Int32  selectionId,
       ArchiveRestrictionInfo[]  criteria,
       String  filter,
...
## AfterSetDynamicSelectionCriteria3Async
```cs
    static void AfterSetDynamicSelectionCriteria3Async(
       Int32  selectionId,
       ArchiveRestrictionInfo[]  criteria,
       String  filter,
       ref ArchiveRestrictionInfo[]  returnValue,
