...
Scripting events called on the <see cref='M:ISelectionAgent.AddSelectionMembers'>AddSelectionMembers</see> method on the <see cref='ISelectionAgent'>ISelectionAgent</see>  service agent.
