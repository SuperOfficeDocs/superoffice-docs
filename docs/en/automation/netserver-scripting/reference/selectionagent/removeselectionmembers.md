...
Scripting events called on the <see cref='M:ISelectionAgent.RemoveSelectionMembers'>RemoveSelectionMembers</see> method on the <see cref='ISelectionAgent'>ISelectionAgent</see>  service agent.
