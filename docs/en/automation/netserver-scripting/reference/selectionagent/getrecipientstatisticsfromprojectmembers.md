...
Scripting events called on the <see cref='M:ISelectionAgent.GetRecipientStatisticsFromProjectMembers'>GetRecipientStatisticsFromProjectMembers</see> method on the <see cref='ISelectionAgent'>ISelectionAgent</see>  service agent.
