...
Scripting events called on the <see cref='M:ISelectionAgent.CreateSelectionEntity'>CreateSelectionEntity</see> method on the <see cref='ISelectionAgent'>ISelectionAgent</see>  service agent.
