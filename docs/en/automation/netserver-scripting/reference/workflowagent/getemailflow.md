...
Scripting events called on the <see cref='M:IWorkflowAgent.GetEmailFlow'>GetEmailFlow</see> method on the <see cref='IWorkflowAgent'>IWorkflowAgent</see>  service agent.
