...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IWorkflowAgent.GetWorkflowTrigger'>GetWorkflowTrigger</see> method on the <see cref='IWorkflowAgent'>IWorkflowAgent</see>  service agent.
