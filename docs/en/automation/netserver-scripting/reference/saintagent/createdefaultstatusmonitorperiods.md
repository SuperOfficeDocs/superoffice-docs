...
Scripting events called on the <see cref='M:ISaintAgent.CreateDefaultStatusMonitorPeriods'>CreateDefaultStatusMonitorPeriods</see> method on the <see cref='ISaintAgent'>ISaintAgent</see>  service agent.
