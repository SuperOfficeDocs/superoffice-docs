...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.ISaintAgent.SaveStatusMonitorPeriods'>SaveStatusMonitorPeriods</see> method on the <see cref='ISaintAgent'>ISaintAgent</see>  service agent.
