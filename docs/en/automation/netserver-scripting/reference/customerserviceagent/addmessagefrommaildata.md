...
Scripting events called on the <see cref='M:ICustomerServiceAgent.AddMessageFromMailData'>AddMessageFromMailData</see> method on the <see cref='ICustomerServiceAgent'>ICustomerServiceAgent</see>  service agent.
