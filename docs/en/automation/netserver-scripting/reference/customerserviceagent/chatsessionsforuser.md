...
Scripting events called on the <see cref='M:ICustomerServiceAgent.ChatSessionsForUser'>ChatSessionsForUser</see> method on the <see cref='ICustomerServiceAgent'>ICustomerServiceAgent</see>  service agent.
