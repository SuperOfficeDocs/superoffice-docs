...
Scripting events called on the <see cref='M:ICustomerServiceAgent.TestSmtpServer'>TestSmtpServer</see> method on the <see cref='ICustomerServiceAgent'>ICustomerServiceAgent</see>  service agent.
