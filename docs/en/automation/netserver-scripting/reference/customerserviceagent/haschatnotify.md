...
Scripting events called on the <see cref='M:ICustomerServiceAgent.HasChatNotify'>HasChatNotify</see> method on the <see cref='ICustomerServiceAgent'>ICustomerServiceAgent</see>  service agent.
