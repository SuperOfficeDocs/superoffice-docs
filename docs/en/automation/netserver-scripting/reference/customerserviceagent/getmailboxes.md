...
Scripting events called on the <see cref='M:ICustomerServiceAgent.GetMailboxes'>GetMailboxes</see> method on the <see cref='ICustomerServiceAgent'>ICustomerServiceAgent</see>  service agent.
