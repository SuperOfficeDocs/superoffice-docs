---
uid: customerserviceagent-savemailboxentity
title: CustomerServiceAgent.SaveMailboxEntity event method
description: Scripting events called on the SaveMailboxEntity method on the CustomerServiceAgent service agent.
so.generated: true
