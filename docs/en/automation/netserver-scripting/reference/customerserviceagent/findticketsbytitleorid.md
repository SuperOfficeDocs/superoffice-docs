...
Scripting events called on the <see cref='M:ICustomerServiceAgent.FindTicketsByTitleOrId'>FindTicketsByTitleOrId</see> method on the <see cref='ICustomerServiceAgent'>ICustomerServiceAgent</see>  service agent.
