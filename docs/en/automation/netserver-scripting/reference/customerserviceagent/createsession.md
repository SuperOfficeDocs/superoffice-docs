...
Scripting events called on the <see cref='M:ICustomerServiceAgent.CreateSession'>CreateSession</see> method on the <see cref='ICustomerServiceAgent'>ICustomerServiceAgent</see>  service agent.
