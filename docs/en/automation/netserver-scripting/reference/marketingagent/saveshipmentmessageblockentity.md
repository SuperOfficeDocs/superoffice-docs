---
uid: marketingagent-saveshipmentmessageblockentity
title: MarketingAgent.SaveShipmentMessageBlockEntity event method
description: Scripting events called on the SaveShipmentMessageBlockEntity method on the MarketingAgent service agent.
so.generated: true
...
```cs
    static void BeforeSaveShipmentMessageBlockEntity(
...
## AfterSaveShipmentMessageBlockEntity
```cs
    static void AfterSaveShipmentMessageBlockEntity(
       ShipmentMessageBlockEntity  shipmentMessageBlockEntity,
