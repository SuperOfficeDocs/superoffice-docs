...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IUserAgent.CreateExternalUser'>CreateExternalUser</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
