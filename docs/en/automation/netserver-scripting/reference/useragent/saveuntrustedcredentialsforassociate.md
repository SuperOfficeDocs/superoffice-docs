...
Scripting events called on the <see cref='M:IUserAgent.SaveUntrustedCredentialsForAssociate'>SaveUntrustedCredentialsForAssociate</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
