...
Scripting events called on the <see cref='M:IUserAgent.GetUserFromEjUserId'>GetUserFromEjUserId</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
