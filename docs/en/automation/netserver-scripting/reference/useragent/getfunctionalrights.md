...
Scripting events called on the <see cref='M:IUserAgent.GetFunctionalRights'>GetFunctionalRights</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
