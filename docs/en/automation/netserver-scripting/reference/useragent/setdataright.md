---
uid: useragent-setdataright
title: UserAgent.SetDataRight event method
description: Scripting events called on the SetDataRight method on the UserAgent service agent.
so.generated: true
