...
Scripting events called on the <see cref='M:IUserAgent.CreateDefaultRoleEntity'>CreateDefaultRoleEntity</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
