...
Scripting events called on the <see cref='M:IUserAgent.DeleteUserFromName'>DeleteUserFromName</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
