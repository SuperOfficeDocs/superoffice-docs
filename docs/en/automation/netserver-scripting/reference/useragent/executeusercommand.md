...
Scripting events called on the <see cref='M:IUserAgent.ExecuteUserCommand'>ExecuteUserCommand</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
