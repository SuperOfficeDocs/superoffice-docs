...
Scripting events called on the <see cref='M:IUserAgent.DecryptAndSaveExternalTokens'>DecryptAndSaveExternalTokens</see> method on the <see cref='IUserAgent'>IUserAgent</see>  service agent.
