...
Scripting events called on the <see cref='M:IForeignSystemAgent.GetAppByName'>GetAppByName</see> method on the <see cref='IForeignSystemAgent'>IForeignSystemAgent</see>  service agent.
