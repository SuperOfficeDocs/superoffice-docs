...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IForeignSystemAgent.SaveForeignKey'>SaveForeignKey</see> method on the <see cref='IForeignSystemAgent'>IForeignSystemAgent</see>  service agent.

## BeforeSaveForeignKey
```cs
    static void BeforeSaveForeignKey(
...
## AfterSaveForeignKey
```cs
    static void AfterSaveForeignKey(
       ForeignKey  foreignKey,
       String  applicationName,
       String  deviceName,
       String  deviceIdentifier,
