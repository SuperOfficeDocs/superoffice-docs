...
Scripting events called on the <see cref='M:IForeignSystemAgent.SaveForeignKey'>SaveForeignKey</see> method on the <see cref='IForeignSystemAgent'>IForeignSystemAgent</see>  service agent.
