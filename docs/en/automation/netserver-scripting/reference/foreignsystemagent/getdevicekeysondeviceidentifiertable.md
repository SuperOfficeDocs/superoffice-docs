...
Scripting events called on the <see cref='M:IForeignSystemAgent.GetDeviceKeysOnDeviceIdentifierTable'>GetDeviceKeysOnDeviceIdentifierTable</see> method on the <see cref='IForeignSystemAgent'>IForeignSystemAgent</see>  service agent.
