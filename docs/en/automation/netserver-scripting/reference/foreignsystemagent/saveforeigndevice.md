...
Scripting events called on the <see cref='M:IForeignSystemAgent.SaveForeignDevice'>SaveForeignDevice</see> method on the <see cref='IForeignSystemAgent'>IForeignSystemAgent</see>  service agent.
