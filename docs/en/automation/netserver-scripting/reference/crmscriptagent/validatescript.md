...
Scripting events called on the <see cref='M:ICRMScriptAgent.ValidateScript'>ValidateScript</see> method on the <see cref='ICRMScriptAgent'>ICRMScriptAgent</see>  service agent.
