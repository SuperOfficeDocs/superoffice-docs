---
uid: webhook-crmscript-handlers
title: CRMScript event handlers
description: How to create CRMScript webhook event handlers that respond to SuperOffice events.
keywords: automation, webhook, CRMScript, event handler
author: digitaldiina
date: 06.15.2026
version: 9.2.7648
...
redirect_from: /en/automation/webhook/crmscript-handlers
language: en
---
...
for(Integer i = 0; i < webhooks.length(); i++) {
  ...
  printLine("ErrorsEmail: " + webhooks[i].GetErrorsEmail());
  printLine("Events:");
...
<!-- Referenced images -->
[img1]: ../../../../media/loc/en/automation/webhook-include-name.png
