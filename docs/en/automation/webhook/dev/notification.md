---
uid: webhook-api-notification
title: Receiving notifications
description: Webhook notifications and payload structure sent by SuperOffice when an event occurs.
keywords: automation, webhook, notification, payload
author: AnthonyYates
date: 04.06.2018
content_type: reference
audience: api
audience_tooltip: SuperOffice APIs and database
redirect_from: /en/automation/webhook/notification
language: en
---
