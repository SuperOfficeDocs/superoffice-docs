...
* **Mailing:** A link to the form response mailing used in by this form. Click the link to [view information and statistics about the form response][2].
...
Use the [filter options][1] at the bottom of the list to [view only submissions with specific statuses][3].

## Use dashboards to get an overview of form submission

Having a dashboard for form submission makes it easy to measure and visualize their data. The dashboard allows you to keep track on performance, trends and productivity.
