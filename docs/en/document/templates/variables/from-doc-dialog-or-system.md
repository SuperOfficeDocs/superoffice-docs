...
keywords: template variable, document
...
>
> For the web client, it's the web server's setting based on the Local settings that appear on the button next to Help where you choose Active Language, Number and Date format, and Email client.
