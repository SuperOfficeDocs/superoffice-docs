...
keywords: template variable, follow-up, appointment, meeting, local time
...
| blab | Date or deadline. Translated name of a follow-up or task |
...
| brph | Changes in the recurrence rule and/or participants for follow-ups. Used when sending email to participants to notify them of changes to a follow-up they are invited to |
