...
* Allows you to [create email templates][11] that can be used from SuperOffice CRM.
...
* Enables the use of [SoProtocol][10]. Opens a context-specific SuperOffice CRM website when an SoProtocol (`superoffice://…`) link is clicked.
...
* [Documents – safer collaboration, easier uploading][9]
