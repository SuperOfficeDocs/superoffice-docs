...
| Create follow-up | Click here to create a new follow-up for the company, contact or project. The type of follow-up created by default is defined in SuperOffice Settings and maintenance. |
