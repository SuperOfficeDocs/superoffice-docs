...
| Element | Description |
|---|---|
| Name | The name of the status, defined in SuperOffice Settings and maintenance. |
| Description | A description of the status, defined in SuperOffice Settings and maintenance. |
...
| Create follow-up | Click here to create a new follow-up for the company, contact or project. The type of follow-up created by default is defined in SuperOffice Settings and maintenance. [!include[See Appointment dialog](../../../includes/see-apt-dialog.md)] |
