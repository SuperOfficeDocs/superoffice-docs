...
All users, who get their sales performance measured, can access the status and progress of their sales target by setting up corresponding [tiles in the dashboard][2]. This will give an instant, live view of their sales performance against the set sales targets, and help them focus on individual and common goals.
