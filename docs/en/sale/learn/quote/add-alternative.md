...
> [!NOTE]
> [Alternatives must be enabled][3] for the sale type in Settings and maintenance. If the **+** tab is not visible, choose a different sale type or enable the setting.
...
1. In the **Name** field, enter a name for the new alternative.
