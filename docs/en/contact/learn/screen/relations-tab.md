...
* A paperclip symbol (<i class="ph ph-paperclip" aria-hidden="true"></i>) indicates that there is a more detailed description of the relation in the **Relation** dialog. Hold the mouse-pointer over the symbol to display the description.
