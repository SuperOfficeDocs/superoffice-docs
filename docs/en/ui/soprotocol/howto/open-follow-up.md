...
The following example shows how to open an Follow-up dialog in the current context based on a given appointment\_id, "appointment\_id = 124". If the current context is displaying the company page, the follow-up dialog will appear over the company page.
