...
1. Select the desired list from the dropdown menu in the upper-left corner of the screen.
...
1. In the dialog, enter the required name of the item in the **Name** field. *(Mandatory)*
