...
title: SuperOffice CRM Suite plans
description: Overview of the five SuperOffice CRM Suite plans, seat management, plan limits, and pricing model.
keywords: CRM Suite, plan, Starter, Core, Growth, Plus, Super, plan limits, fencing, scaling, seat, subscription
author: digitaldiina
date: 06.10.2026
version: 12.0
...
* To free up a seat without removing the user's data and history, disable **Can log in** instead of deleting the user. Deleting a user is permanent.
...
* **Plan limits (fencing):** Fixed tier-based limits that differentiate plans. Exceeding a plan limit blocks the related feature until you free up capacity or upgrade your plan.
...
Plan limits are fixed per tier. When a limit is reached, the related feature is blocked until you reduce usage or upgrade.
...
Organizations migrating from **SuperOffice CRM Online** (the module-based subscription) are placed on the CRM Suite plan that matches their current license.
...
If you held multiple licenses, migration follows your current license.
