...
index: true
redirect_from: 
  - /en/admin/learn/index
  - /en/admin/learn/onboard-users
  - /en/admin/getting-started/index
  - /en/admin/getting-started/onboard-users
---
...
[WebTools must be installed][12] for all users to ensure the integration between SuperOffice and MS Office Outlook and documents. Every user will receive an email with instructions when they start with SuperOffice, but as an administrator, it is important to make sure it is done.
...
* [Read more about email and document integration][13]
