...
1. If more than one owner company is available in your SuperOffice tenant, you can select the owner below the **Email** field.
...
1. In the list of users, select the user who cannot log in.
...
1. Make sure that the user has received the activation email, and that the activation link has been clicked within 48 hours.
