...
language: en
index: true
redirect_from: /en/admin/learn/onboard-users
---
...
[WebTools must be installed][2] for all users to ensure the integration between SuperOffice and MS Office Outlook and documents. Every user will receive an email with instructions when they start with SuperOffice, but as an administrator, it is important to make sure it is done.
