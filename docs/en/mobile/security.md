...
Mobile CRM will delegate authentication to SuperID. SuperID has [standard support for Google and Microsoft][8] and can offer custom implementations if needed.
