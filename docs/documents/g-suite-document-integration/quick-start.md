...
This article explains in short terms how you can get G Suite document integration up and running in no-time, in a step-by-step walk-through. It is an alternative to the [full set-up guide][5].
