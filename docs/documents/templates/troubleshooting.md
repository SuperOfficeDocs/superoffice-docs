...
# Mandatory fields.
title: troubleshooting_document_templates       # (Required) Very important for SEO. Intent in a unique string of 43-59 chars including spaces.
description: Document templates troubleshooting # (Required) Important for SEO. Recommended character length is 115-145 characters including spaces.
