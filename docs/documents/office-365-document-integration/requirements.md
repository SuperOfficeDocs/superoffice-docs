...
* Read more about 'How to configure IDP for SuperID [here][1]
...
<!-- Referenced links -->
[1]: https://community.superoffice.com/en/technical/documentation/identity-management/how-to/federated-sign-in-guide/
