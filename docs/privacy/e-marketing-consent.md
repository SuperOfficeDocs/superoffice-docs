...
# Mandatory fields.
title: gdpr_emarketing_consent       # (Required) Very important for SEO. Intent in a unique string of 43-59 chars including spaces.
description: GDRP consent for e-marketing # (Required) Important for SEO. Recommended character length is 115-145 characters including spaces.
...
The GDPR regulation states that an individual has the right to object to receiving marketing materials.
