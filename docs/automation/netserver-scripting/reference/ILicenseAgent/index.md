---
uid: ilicenseagent-script-events
title: ILicenseAgent script event methods
...
# ILicenseAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ILicenseAgent'>ILicenseAgent</see> that can trigger server-side event scripts.
