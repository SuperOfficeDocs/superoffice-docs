---
uid: IListAgent-GetWebPanelList
title: IListAgent.GetWebPanelList event method
description: Scripting events called on the GetWebPanelList method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
