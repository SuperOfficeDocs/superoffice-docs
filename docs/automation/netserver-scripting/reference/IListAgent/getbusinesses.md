---
uid: IListAgent-GetBusinesses
title: IListAgent.GetBusinesses event method
description: Scripting events called on the GetBusinesses method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
