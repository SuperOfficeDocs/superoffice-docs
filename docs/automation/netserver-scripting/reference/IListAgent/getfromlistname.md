---
uid: IListAgent-GetFromListName
title: IListAgent.GetFromListName event method
description: Scripting events called on the GetFromListName method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
