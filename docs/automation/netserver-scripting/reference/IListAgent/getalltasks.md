---
uid: IListAgent-GetAllTasks
title: IListAgent.GetAllTasks event method
description: Scripting events called on the GetAllTasks method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
