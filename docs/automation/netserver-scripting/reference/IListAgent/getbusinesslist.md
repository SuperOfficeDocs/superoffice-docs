---
uid: IListAgent-GetBusinessList
title: IListAgent.GetBusinessList event method
description: Scripting events called on the GetBusinessList method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
