---
uid: IListAgent-GetRatings
title: IListAgent.GetRatings event method
description: Scripting events called on the GetRatings method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
