---
uid: IListAgent-GetHeadingEntity
title: IListAgent.GetHeadingEntity event method
description: Scripting events called on the GetHeadingEntity method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
