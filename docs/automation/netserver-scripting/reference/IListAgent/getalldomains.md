---
uid: IListAgent-GetAllDomains
title: IListAgent.GetAllDomains event method
description: Scripting events called on the GetAllDomains method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
