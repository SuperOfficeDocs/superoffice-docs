---
uid: IListAgent-GetConsentSources
title: IListAgent.GetConsentSources event method
description: Scripting events called on the GetConsentSources method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
