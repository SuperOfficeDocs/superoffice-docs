---
uid: IListAgent-GetConsentPurpose
title: IListAgent.GetConsentPurpose event method
description: Scripting events called on the GetConsentPurpose method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
