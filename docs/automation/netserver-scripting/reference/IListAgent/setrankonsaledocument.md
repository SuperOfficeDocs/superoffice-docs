---
uid: IListAgent-SetRankOnSaleDocument
title: IListAgent.SetRankOnSaleDocument event method
description: Scripting events called on the SetRankOnSaleDocument method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
...
so.envir:
  - "onsite"
---
# IListAgent.SetRankOnSaleDocument
