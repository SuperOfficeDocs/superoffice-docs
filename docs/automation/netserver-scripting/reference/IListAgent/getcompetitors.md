---
uid: IListAgent-GetCompetitors
title: IListAgent.GetCompetitors event method
description: Scripting events called on the GetCompetitors method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
...
```cs
    static void BeforeGetCompetitors(
...
## AfterGetCompetitors
```cs
    static void AfterGetCompetitors(
