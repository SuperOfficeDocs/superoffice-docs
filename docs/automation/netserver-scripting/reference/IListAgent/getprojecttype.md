---
uid: IListAgent-GetProjectType
title: IListAgent.GetProjectType event method
description: Scripting events called on the GetProjectType method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
