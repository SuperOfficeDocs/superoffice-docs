---
uid: IListAgent-SaveFromListName
title: IListAgent.SaveFromListName event method
description: Scripting events called on the SaveFromListName method on the IListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
