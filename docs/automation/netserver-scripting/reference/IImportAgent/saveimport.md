---
uid: IImportAgent-SaveImport
title: IImportAgent.SaveImport event method
description: Scripting events called on the SaveImport method on the IImportAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
