---
uid: isentryagent-script-events
title: ISentryAgent script event methods
...
# ISentryAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ISentryAgent'>ISentryAgent</see> that can trigger server-side event scripts.
