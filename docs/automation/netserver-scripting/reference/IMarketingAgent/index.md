---
uid: imarketingagent-script-events
title: IMarketingAgent script event methods
...
# IMarketingAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IMarketingAgent'>IMarketingAgent</see> that can trigger server-side event scripts.
