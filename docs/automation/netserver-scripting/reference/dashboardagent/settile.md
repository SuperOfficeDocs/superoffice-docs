---
uid: dashboardagent-settile
title: DashboardAgent.SetTile event method
description: Scripting events called on the SetTile method on the DashboardAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
