---
uid: IUserAgent-GetValidUserName
title: IUserAgent.GetValidUserName event method
description: Scripting events called on the GetValidUserName method on the IUserAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
