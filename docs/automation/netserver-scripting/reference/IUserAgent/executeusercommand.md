---
uid: IUserAgent-ExecuteUserCommand
title: IUserAgent.ExecuteUserCommand event method
description: Scripting events called on the ExecuteUserCommand method on the IUserAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
