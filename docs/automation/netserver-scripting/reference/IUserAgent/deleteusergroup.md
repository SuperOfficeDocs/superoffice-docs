---
uid: IUserAgent-DeleteUserGroup
title: IUserAgent.DeleteUserGroup event method
description: Scripting events called on the DeleteUserGroup method on the IUserAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
