...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IViewStateAgent.GetHistory'>GetHistory</see> method on the <see cref='IViewStateAgent'>IViewStateAgent</see>  service agent.
