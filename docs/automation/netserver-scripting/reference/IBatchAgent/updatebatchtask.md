---
uid: IBatchAgent-UpdateBatchTask
title: IBatchAgent.UpdateBatchTask event method
description: Scripting events called on the UpdateBatchTask method on the IBatchAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
