---
uid: ibatchagent-script-events
title: IBatchAgent script event methods
...
# IBatchAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IBatchAgent'>IBatchAgent</see> that can trigger server-side event scripts.
