...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IAIAgent.TranslateEntity'>TranslateEntity</see> method on the <see cref='IAIAgent'>IAIAgent</see>  service agent.
