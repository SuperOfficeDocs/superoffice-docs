---
uid: icontactagent-script-events
title: IContactAgent script event methods
...
# IContactAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IContactAgent'>IContactAgent</see> that can trigger server-side event scripts.
