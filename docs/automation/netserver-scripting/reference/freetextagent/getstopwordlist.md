---
uid: freetextagent-getstopwordlist
title: FreeTextAgent.GetStopWordList event method
description: Scripting events called on the GetStopWordList method on the FreeTextAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
