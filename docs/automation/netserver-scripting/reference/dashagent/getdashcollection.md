...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IDashAgent.GetDashCollection'>GetDashCollection</see> method on the <see cref='IDashAgent'>IDashAgent</see>  service agent.
