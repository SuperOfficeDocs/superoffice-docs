---
uid: IDashboardAgent-GetData
title: IDashboardAgent.GetData event method
description: Scripting events called on the GetData method on the IDashboardAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
