---
uid: idashboardagent-script-events
title: IDashboardAgent script event methods
...
# IDashboardAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IDashboardAgent'>IDashboardAgent</see> that can trigger server-side event scripts.
