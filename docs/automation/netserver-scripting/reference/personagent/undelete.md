---
uid: personagent-undelete
title: PersonAgent.Undelete event method
description: Scripting events called on the Undelete method on the PersonAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
