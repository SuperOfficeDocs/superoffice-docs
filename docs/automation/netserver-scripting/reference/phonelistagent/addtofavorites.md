---
uid: phonelistagent-addtofavorites
title: PhoneListAgent.AddToFavorites event method
description: Scripting events called on the AddToFavorites method on the PhoneListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
