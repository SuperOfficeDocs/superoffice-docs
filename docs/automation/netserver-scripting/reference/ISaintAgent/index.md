---
uid: isaintagent-script-events
title: ISaintAgent script event methods
...
# ISaintAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ISaintAgent'>ISaintAgent</see> that can trigger server-side event scripts.
