---
uid: ISaintAgent-GetStatusMonitors
title: ISaintAgent.GetStatusMonitors event method
description: Scripting events called on the GetStatusMonitors method on the ISaintAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
