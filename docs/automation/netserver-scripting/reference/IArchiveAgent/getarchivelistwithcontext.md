---
uid: IArchiveAgent-GetArchiveListWithContext
title: IArchiveAgent.GetArchiveListWithContext event method
description: Scripting events called on the GetArchiveListWithContext method on the IArchiveAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
...
so.envir:
  - "onsite"
---
# IArchiveAgent.GetArchiveListWithContext
...
## AfterGetArchiveListWithContext
```cs
...
## AfterGetArchiveListWithContextAsync
```cs
