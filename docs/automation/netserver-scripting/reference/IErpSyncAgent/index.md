---
uid: ierpsyncagent-script-events
title: IErpSyncAgent script event methods
...
# IErpSyncAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IErpSyncAgent'>IErpSyncAgent</see> that can trigger server-side event scripts.
