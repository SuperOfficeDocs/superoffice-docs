---
uid: IEMailAgent-GetCurrentAccount
title: IEMailAgent.GetCurrentAccount event method
description: Scripting events called on the GetCurrentAccount method on the IEMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
