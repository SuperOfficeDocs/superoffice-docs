---
uid: IEMailAgent-RelayMessage
title: IEMailAgent.RelayMessage event method
description: Scripting events called on the RelayMessage method on the IEMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
...
```cs
    static void BeforeRelayMessage(
