---
uid: IEMailAgent-MarkEmailsAsRead
title: IEMailAgent.MarkEmailsAsRead event method
description: Scripting events called on the MarkEmailsAsRead method on the IEMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
