---
uid: icustomerserviceagent-script-events
title: ICustomerServiceAgent script event methods
...
# ICustomerServiceAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ICustomerServiceAgent'>ICustomerServiceAgent</see> that can trigger server-side event scripts.
