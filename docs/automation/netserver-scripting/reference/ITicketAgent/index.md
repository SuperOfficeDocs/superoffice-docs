---
uid: iticketagent-script-events
title: ITicketAgent script event methods
...
# ITicketAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ITicketAgent'>ITicketAgent</see> that can trigger server-side event scripts.
