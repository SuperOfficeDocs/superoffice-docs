...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.ICRMScriptAgent.DeleteTriggerScriptEntity'>DeleteTriggerScriptEntity</see> method on the <see cref='ICRMScriptAgent'>ICRMScriptAgent</see>  service agent.
