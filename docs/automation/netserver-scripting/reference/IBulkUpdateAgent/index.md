---
uid: ibulkupdateagent-script-events
title: IBulkUpdateAgent script event methods
...
# IBulkUpdateAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IBulkUpdateAgent'>IBulkUpdateAgent</see> that can trigger server-side event scripts.
