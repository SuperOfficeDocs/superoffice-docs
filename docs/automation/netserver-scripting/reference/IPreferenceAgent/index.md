---
uid: ipreferenceagent-script-events
title: IPreferenceAgent script event methods
...
# IPreferenceAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IPreferenceAgent'>IPreferenceAgent</see> that can trigger server-side event scripts.
