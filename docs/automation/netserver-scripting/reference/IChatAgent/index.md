---
uid: ichatagent-script-events
title: IChatAgent script event methods
...
# IChatAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IChatAgent'>IChatAgent</see> that can trigger server-side event scripts.
