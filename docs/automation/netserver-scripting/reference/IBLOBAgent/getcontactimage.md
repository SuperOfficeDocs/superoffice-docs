---
uid: IBLOBAgent-GetContactImage
title: IBLOBAgent.GetContactImage event method
description: Scripting events called on the GetContactImage method on the IBLOBAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
