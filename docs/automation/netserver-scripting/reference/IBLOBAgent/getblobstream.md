---
uid: IBLOBAgent-GetBlobStream
title: IBLOBAgent.GetBlobStream event method
description: Scripting events called on the GetBlobStream method on the IBLOBAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
