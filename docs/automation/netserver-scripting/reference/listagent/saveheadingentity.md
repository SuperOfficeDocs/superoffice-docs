---
uid: listagent-saveheadingentity
title: ListAgent.SaveHeadingEntity event method
description: Scripting events called on the SaveHeadingEntity method on the ListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
