---
uid: listagent-getratinglist
title: ListAgent.GetRatingList event method
description: Scripting events called on the GetRatingList method on the ListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
