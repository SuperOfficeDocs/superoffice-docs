---
uid: listagent-getpositions
title: ListAgent.GetPositions event method
description: Scripting events called on the GetPositions method on the ListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
