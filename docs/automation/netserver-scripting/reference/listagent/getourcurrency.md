---
uid: listagent-getourcurrency
title: ListAgent.GetOurCurrency event method
description: Scripting events called on the GetOurCurrency method on the ListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
