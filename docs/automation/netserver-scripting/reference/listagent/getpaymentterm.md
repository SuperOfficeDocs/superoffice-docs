---
uid: listagent-getpaymentterm
title: ListAgent.GetPaymentTerm event method
description: Scripting events called on the GetPaymentTerm method on the ListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
