---
uid: listagent-savelegalbase
title: ListAgent.SaveLegalBase event method
description: Scripting events called on the SaveLegalBase method on the ListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
