---
uid: listagent-getcompetitors
title: ListAgent.GetCompetitors event method
description: Scripting events called on the GetCompetitors method on the ListAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
