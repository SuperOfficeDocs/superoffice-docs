---
uid: audienceagent-setdefaultcountryflag
title: AudienceAgent.SetDefaultCountryFlag event method
description: Scripting events called on the SetDefaultCountryFlag method on the AudienceAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
