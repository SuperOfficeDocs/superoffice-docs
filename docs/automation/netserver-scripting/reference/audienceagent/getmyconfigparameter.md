...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IAudienceAgent.GetMyConfigParameter'>GetMyConfigParameter</see> method on the <see cref='IAudienceAgent'>IAudienceAgent</see>  service agent.
