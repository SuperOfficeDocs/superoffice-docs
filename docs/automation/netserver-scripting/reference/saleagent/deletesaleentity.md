---
uid: saleagent-deletesaleentity
title: SaleAgent.DeleteSaleEntity event method
description: Scripting events called on the DeleteSaleEntity method on the SaleAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
