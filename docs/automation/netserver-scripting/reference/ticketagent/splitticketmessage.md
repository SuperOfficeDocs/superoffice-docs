...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.ITicketAgent.SplitTicketMessage'>SplitTicketMessage</see> method on the <see cref='ITicketAgent'>ITicketAgent</see>  service agent.
