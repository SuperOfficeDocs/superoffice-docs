---
uid: erpsyncagent-tryconnectactor
title: ErpSyncAgent.TryConnectActor event method
description: Scripting events called on the TryConnectActor method on the ErpSyncAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
...
```cs
    static void BeforeTryConnectActor(
...
## AfterTryConnectActor
```cs
    static void AfterTryConnectActor(
       Int32  erpConnectionId,
       Int32  crmRecordId,
       CrmActorType  crmActorType,
       String  erpKey,
...
## AfterTryConnectActorAsync
```cs
    static void AfterTryConnectActorAsync(
       Int32  erpConnectionId,
       Int32  crmRecordId,
       CrmActorType  crmActorType,
       String  erpKey,
