---
uid: blobagent-changepersonimage
title: BLOBAgent.ChangePersonImage event method
description: Scripting events called on the ChangePersonImage method on the BLOBAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
