---
uid: iprojectagent-script-events
title: IProjectAgent script event methods
...
# IProjectAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IProjectAgent'>IProjectAgent</see> that can trigger server-side event scripts.
