---
uid: isaleagent-script-events
title: ISaleAgent script event methods
...
# ISaleAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ISaleAgent'>ISaleAgent</see> that can trigger server-side event scripts.
