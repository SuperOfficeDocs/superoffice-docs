---
uid: ISaleAgent-SetAsLost
title: ISaleAgent.SetAsLost event method
description: Scripting events called on the SetAsLost method on the ISaleAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
