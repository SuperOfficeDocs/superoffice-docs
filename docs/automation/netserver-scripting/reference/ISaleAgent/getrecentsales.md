---
uid: ISaleAgent-GetRecentSales
title: ISaleAgent.GetRecentSales event method
description: Scripting events called on the GetRecentSales method on the ISaleAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
