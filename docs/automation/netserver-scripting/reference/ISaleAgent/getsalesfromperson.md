---
uid: ISaleAgent-GetSalesFromPerson
title: ISaleAgent.GetSalesFromPerson event method
description: Scripting events called on the GetSalesFromPerson method on the ISaleAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
