---
uid: iviewstateagent-script-events
title: IViewStateAgent script event methods
...
# IViewStateAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IViewStateAgent'>IViewStateAgent</see> that can trigger server-side event scripts.
