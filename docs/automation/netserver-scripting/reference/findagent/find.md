...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IFindAgent.Find'>Find</see> method on the <see cref='IFindAgent'>IFindAgent</see>  service agent.
