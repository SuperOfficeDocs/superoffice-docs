...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IFindAgent.GetDefaultDesiredColumnsFromRestrictions2'>GetDefaultDesiredColumnsFromRestrictions2</see> method on the <see cref='IFindAgent'>IFindAgent</see>  service agent.
