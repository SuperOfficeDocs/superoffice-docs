---
uid: projectagent-validateprojectentity
title: ProjectAgent.ValidateProjectEntity event method
description: Scripting events called on the ValidateProjectEntity method on the ProjectAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
