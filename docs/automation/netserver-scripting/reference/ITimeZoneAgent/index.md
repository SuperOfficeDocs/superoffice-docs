---
uid: itimezoneagent-script-events
title: ITimeZoneAgent script event methods
...
# ITimeZoneAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.ITimeZoneAgent'>ITimeZoneAgent</see> that can trigger server-side event scripts.
