...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IPreferenceAgent.SetXsrfPaths'>SetXsrfPaths</see> method on the <see cref='IPreferenceAgent'>IPreferenceAgent</see>  service agent.
