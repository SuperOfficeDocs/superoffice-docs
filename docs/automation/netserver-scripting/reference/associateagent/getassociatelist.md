---
uid: associateagent-getassociatelist
title: AssociateAgent.GetAssociateList event method
description: Scripting events called on the GetAssociateList method on the AssociateAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
