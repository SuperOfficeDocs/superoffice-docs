---
uid: quoteagent-createquoteline
title: QuoteAgent.CreateQuoteLine event method
description: Scripting events called on the CreateQuoteLine method on the QuoteAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
