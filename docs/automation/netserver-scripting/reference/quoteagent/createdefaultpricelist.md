...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IQuoteAgent.CreateDefaultPriceList'>CreateDefaultPriceList</see> method on the <see cref='IQuoteAgent'>IQuoteAgent</see>  service agent.
