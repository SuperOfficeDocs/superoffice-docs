...
Scripting events called on the <see cref='M:SuperOffice.CRM.Services.IChatAgent.AcceptChatSessionTransfer'>AcceptChatSessionTransfer</see> method on the <see cref='IChatAgent'>IChatAgent</see>  service agent.
