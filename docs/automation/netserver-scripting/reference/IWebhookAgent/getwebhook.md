---
uid: IWebhookAgent-GetWebhook
title: IWebhookAgent.GetWebhook event method
description: Scripting events called on the GetWebhook method on the IWebhookAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
