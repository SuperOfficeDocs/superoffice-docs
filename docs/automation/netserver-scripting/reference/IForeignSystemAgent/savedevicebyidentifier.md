---
uid: IForeignSystemAgent-SaveDeviceByIdentifier
title: IForeignSystemAgent.SaveDeviceByIdentifier event method
description: Scripting events called on the SaveDeviceByIdentifier method on the IForeignSystemAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
...
so.envir:
  - "onsite"
---
# IForeignSystemAgent.SaveDeviceByIdentifier
...
```cs
    static void BeforeSaveDeviceByIdentifier(
...
## AfterSaveDeviceByIdentifier
```cs
    static void AfterSaveDeviceByIdentifier(
       String  applicationName,
       String  deviceName,
       String  deviceIdentifier,
       ForeignDevice  foreignDevice,
