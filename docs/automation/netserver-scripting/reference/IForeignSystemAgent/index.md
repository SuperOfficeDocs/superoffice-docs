---
uid: iforeignsystemagent-script-events
title: IForeignSystemAgent script event methods
...
# IForeignSystemAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IForeignSystemAgent'>IForeignSystemAgent</see> that can trigger server-side event scripts.
