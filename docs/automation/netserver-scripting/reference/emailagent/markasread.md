---
uid: emailagent-markasread
title: EMailAgent.MarkAsRead event method
description: Scripting events called on the MarkAsRead method on the EMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
