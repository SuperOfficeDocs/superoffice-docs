---
uid: emailagent-getattachmentfromid
title: EMailAgent.GetAttachmentFromId event method
description: Scripting events called on the GetAttachmentFromId method on the EMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
