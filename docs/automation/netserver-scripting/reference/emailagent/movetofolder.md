---
uid: emailagent-movetofolder
title: EMailAgent.MoveToFolder event method
description: Scripting events called on the MoveToFolder method on the EMailAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
