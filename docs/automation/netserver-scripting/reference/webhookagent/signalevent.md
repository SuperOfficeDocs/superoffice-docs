---
uid: webhookagent-signalevent
title: WebhookAgent.SignalEvent event method
description: Scripting events called on the SignalEvent method on the WebhookAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
