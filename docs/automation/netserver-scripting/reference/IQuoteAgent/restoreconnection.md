---
uid: IQuoteAgent-RestoreConnection
title: IQuoteAgent.RestoreConnection event method
description: Scripting events called on the RestoreConnection method on the IQuoteAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
