---
uid: IQuoteAgent-GetQuoteLine
title: IQuoteAgent.GetQuoteLine event method
description: Scripting events called on the GetQuoteLine method on the IQuoteAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
