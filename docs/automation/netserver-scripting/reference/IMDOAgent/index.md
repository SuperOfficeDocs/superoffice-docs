---
uid: imdoagent-script-events
title: IMDOAgent script event methods
...
# IMDOAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IMDOAgent'>IMDOAgent</see> that can trigger server-side event scripts.
