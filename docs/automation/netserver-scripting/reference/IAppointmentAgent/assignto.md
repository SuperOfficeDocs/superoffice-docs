---
uid: IAppointmentAgent-AssignTo
title: IAppointmentAgent.AssignTo event method
description: Scripting events called on the AssignTo method on the IAppointmentAgent service agent.
so.generated: true
keywords:
  - "netserver"
  - "scripting"
