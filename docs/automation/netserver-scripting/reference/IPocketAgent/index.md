---
uid: ipocketagent-script-events
title: IPocketAgent script event methods
...
# IPocketAgent method listing

Service methods defined on <see cref='T:SuperOffice.CRM.Services.IPocketAgent'>IPocketAgent</see> that can trigger server-side event scripts.
