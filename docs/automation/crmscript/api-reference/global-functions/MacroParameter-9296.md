---
description: MacroParameter MacroParameter(String p0, String p1, Map p2, String p3, String p4, Bool p5, String p6, Bool p7)
...
## Parameters
 ...
 - p6: DefaultValue
 - p7: DefaultValueIsFixed, whether or not the default value of the parameter is fixed
