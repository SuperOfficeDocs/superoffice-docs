---
title: crmscript_ref_Message_send_Vector_to_Vector_cc_Vector_bcc_String_subject_String_bodyHeading
description: Message.send(Vector to, Vector cc, Vector bcc, String subject, String bodyHeading)
