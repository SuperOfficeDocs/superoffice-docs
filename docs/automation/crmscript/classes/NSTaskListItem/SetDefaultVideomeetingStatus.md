---
title: crmscript_ref_NSTaskListItem_SetDefaultVideomeetingStatus
description: NSTaskListItem.SetDefaultVideomeetingStatus(Integer defaultVideomeetingStatus)
