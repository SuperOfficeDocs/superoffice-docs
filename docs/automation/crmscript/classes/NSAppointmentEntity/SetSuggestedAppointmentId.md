---
title: crmscript_ref_NSAppointmentEntity_SetSuggestedAppointmentId
description: NSAppointmentEntity.SetSuggestedAppointmentId(Integer suggestedAppointmentId)
