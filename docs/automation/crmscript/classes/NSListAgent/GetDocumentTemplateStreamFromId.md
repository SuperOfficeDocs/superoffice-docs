---
title: crmscript_ref_NSListAgent_GetDocumentTemplateStreamFromId
description: Stream GetDocumentTemplateStreamFromId(Integer documentTemplateId, String languageCode)
