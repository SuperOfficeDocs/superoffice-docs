---
title: crmscript_ref_NSListAgent_SaveAllFromListDefinition
description: ListItemEntityArray SaveAllFromListDefinition(Integer udListDefinitionId, ListItemEntityArray items)
