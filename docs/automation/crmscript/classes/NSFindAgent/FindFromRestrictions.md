---
title: crmscript_ref_NSFindAgent_FindFromRestrictions
description: FindResults FindFromRestrictions(ArchiveRestrictionInfoArray restrictions, String providerName, Integer pageSize, Integer pageNumber)
