---
title: crmscript_ref_NSPocketAgent_SendPushNotification
description: Void SendPushNotification(IntegerArray associateIds, PocketNotificationMessage message)
