---
title: crmscript_ref_NSPreferenceAgent_GetPreferenceDescriptionLine
description: NSPreferenceDescriptionLine GetPreferenceDescriptionLine(Integer preferenceDescriptionLineId);
