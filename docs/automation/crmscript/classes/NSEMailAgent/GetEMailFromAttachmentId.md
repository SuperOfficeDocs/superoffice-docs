---
title: crmscript_ref_NSEMailAgent_GetEMailFromAttachmentId
description: EMailEntity GetEMailFromAttachmentId(Integer emailId, StringArray attachmentIds, Bool includeAttachments)
