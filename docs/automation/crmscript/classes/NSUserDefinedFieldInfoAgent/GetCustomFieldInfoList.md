---
title: crmscript_ref_NSUserDefinedFieldInfoAgent_GetCustomFieldInfoList
description: FieldInfoBaseArray GetCustomFieldInfoList(String tableName, Bool includeStandard)
