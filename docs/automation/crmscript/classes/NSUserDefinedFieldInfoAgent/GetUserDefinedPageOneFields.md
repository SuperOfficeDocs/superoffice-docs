---
title: crmscript_ref_NSUserDefinedFieldInfoAgent_GetUserDefinedPageOneFields
description: UserDefinedFieldInfoArray GetUserDefinedPageOneFields(Integer ownerType, Integer userGroupId)
