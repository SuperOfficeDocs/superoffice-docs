---
title: crmscript_ref_NSTicketCategoryEntity_SetClosingStatus
description: NSTicketCategoryEntity.SetClosingStatus(TicketCategoryClosingStatus closingStatus)
