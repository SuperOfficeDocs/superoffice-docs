---
title: crmscript_ref_NSTicketCategoryEntity_SetMsgClosingStatus
description: NSTicketCategoryEntity.SetMsgClosingStatus(TicketCategoryClosingStatus msgClosingStatus)
