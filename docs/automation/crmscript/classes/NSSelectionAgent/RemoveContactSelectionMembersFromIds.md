...
path: /EJScript/Classes/NSSelectionAgent/Member functions/Void RemoveContactSelectionMembersFromIds(Integer p_0, Integer[] p_1)
intellisense: 1
classref: 1
keywords: RemoveContactSelectionMembersFromIds(Integer,Integer[])
---
