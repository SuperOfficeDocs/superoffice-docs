---
title: crmscript_ref_NSSelectionAgent_RemoveContactSelectionMembersFromIds
description: Void RemoveContactSelectionMembersFromIds(Integer selectionId, IntegerArray selectionMembersIds)
