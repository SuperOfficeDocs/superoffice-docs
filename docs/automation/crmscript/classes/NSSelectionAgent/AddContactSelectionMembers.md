---
title: crmscript_ref_NSSelectionAgent_AddContactSelectionMembers
description: Void AddContactSelectionMembers(Integer selectionId, ContactPersonIdArray contactPersonIds)
