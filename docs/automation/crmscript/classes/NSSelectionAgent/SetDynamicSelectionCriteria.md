---
title: crmscript_ref_NSSelectionAgent_SetDynamicSelectionCriteria
description: ArchiveRestrictionInfoArray SetDynamicSelectionCriteria(Integer selectionId, ArchiveRestrictionInfoArray criteria)
