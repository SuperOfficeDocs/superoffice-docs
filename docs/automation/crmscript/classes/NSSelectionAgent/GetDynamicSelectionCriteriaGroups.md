---
title: crmscript_ref_NSSelectionAgent_GetDynamicSelectionCriteriaGroups
description: ArchiveRestrictionGroupArray GetDynamicSelectionCriteriaGroups(Integer selectionId)
