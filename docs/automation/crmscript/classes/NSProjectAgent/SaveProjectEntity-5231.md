---
title: Void SaveProjectEntity(NSProjectEntity projectEntity)
path: /EJScript/Classes/NSProjectAgent/Member functions/Void SaveProjectEntity(NSProjectEntity p_0)
intellisense: 1
classref: 1
