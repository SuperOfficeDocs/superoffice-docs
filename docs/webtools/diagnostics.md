...
WebTools consist of Tray App Web Extention and Mail Link.
...
The value name of the new string value is LogFile and value data is the full path to a logfile where it should write diagnostics, note that the user needs writepermission to the file.
