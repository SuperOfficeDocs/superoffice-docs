...
But let’s say there is a problem/bug that is fixed in the 8.3 release. The customer can then install the latest WebTools (without NetServer) through manual download from the Download Service. When this is done a few things changes:
