...
description: Standardalternativer
...
# Alternativer for arkivering

Alternativer i ruten **Arkiveringsalternativer** i dialogboksen til **SuperOffice CRM-alternativer**. Du kan overstyre standardalternativene ved å bruke [knappene i e-postklienten][2].

| Alternativ | Beskrivelse |
|---|---|
| Arkiver e-post som standard når | For hvert valgte alternativ er **Arkivering er på** angitt som standard for situasjonen alternativet refererer til. Hvis du fjerner avmerkingen for et alternativ, er **Arkivering er AV** angitt som standard. |
| Opprettet fra SuperOffice CRM | Når du sender en e-post, arkiveres den som standard i SuperOffice CRM. |
| Skrevet til medarbeidere fra SuperOffice CRM | Hvis valgt, arkiveres *alle* utgående e-poster skrevet til medarbeidere. Ellers arkiveres *ikke* e-poster til personer registrert som medarbeidere i SuperOffice CRM som standard. Dette alternativet gjelder bare for [e-postmeldinger som er komponert i SuperOffice CRM][4], og hvis **opprettet fra SuperOffice CRM** er valgt.
