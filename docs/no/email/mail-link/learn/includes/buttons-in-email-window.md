...
| ![icon][img3] | Legg til mottaker | Åpner dialogboksen **Velg mottakere**. | [Velge mottakere][4] |
| ![icon][img4] | Legg ved dokument | Åpner dialogboksen **Inkluder vedlegg**. | [Legg til SuperOffice-dokumenter som vedlegg][5] |
| ![icon][img5] | | Klikk på pilen til høyre for **SuperOffice**-knappen for å åpne dialogboksen **SuperOffice CRM-alternativer**. | [Dialogboksen SuperOffice CRM-alternativer][6] |
