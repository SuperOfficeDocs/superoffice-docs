...
I fanen **Blokkert e-post** finner du en liste over innkommende e-poster blokkert av et e-postfilter. Klikk på en e-post for å vise innholdet. Hvis det ikke er nok plass til alle e-postene på én side, kan du klikke ![icon][img1] for å navigere til neste side. Denne listen inneholder følgende kolonner:
...
Følgende alternativer er også tilgjengelige fra **Handlinger**-knappen (![icon][img2]):
