...
3. Klikk på pilen på vedlegget du vil lagre eller åpne.
4. Velg ett av følgende alternativer:
    * **Åpne**: Den vedlagte filen vises i nettleseren din. Klikk på vedlegget for å åpne eller lagre det. Hvordan dette fungerer, er avhengig av nettleseren.
    * **Arkiver**: Dialogboksen [**Dokument** åpnes][1].
