...
description: "Det er flere måter å invitere personer til en avtale på, avhengig av om det er en intern eller ekstern person, eller en ressurs, for eksempel et møterom eller spesialutstyr. Denne guiden viser hvordan du legger til deltakere i en avtale."
