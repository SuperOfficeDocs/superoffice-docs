...
1. Gå til firmakortet for firmaet du vil administrere eksterne brukere for.
...
1. Velg ønsket person i listen, og klikk på **Rediger**.
2. I dialogboksen som vises, angir du ønsket bruker-ID, passord og rolle. Du kan også spesifisere om påloggingen skal aktiveres:
...
3. Klikk på **Lagre** for å lagre innstillingene og lukke dialogboksen, eller på **Avbryt** for å lukke dialogboksen uten å lagre innstillingene.
