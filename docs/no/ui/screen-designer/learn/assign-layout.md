...
title: Tilordne layout til gruppe eller type
...
# Tilordne layout til gruppe eller type
...
1. Øverst velger du en skjerm eller dialog du vil tilpasse.

1. Velg tilordningsmetode (hvis ikke satt): Klikk på teksten ved siden av **Tilordne layout til**, og velg gruppe eller type.

    * Firma og person: kun brukergruppe
    * Salg: brukergruppe eller salgstype
...
Klikk på feltet **Tilordne til**, og velg en gruppe eller type. Dine alternativer avhenger av den valgte skjermen.

## Begrensninger

* Standardlayouten kan ikke tilordnes.
