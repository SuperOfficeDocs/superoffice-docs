...
1. Gjør ønskede endringer i de ulike feltene (under [Legge til felt][1] finner du en oversikt over hva du skal angi her).

    > [!NOTE]
    > Listeboksen **Type** inneholder bare valgene du kan endre. Altså der eksisterende data kan konverteres for å passe den nye felttypen.
