...
description: Oversikt over de fem SuperOffice CRM Suite-planene, administrasjon av plasser, plangrenser og prismodell.
...
Du kan se plassforbruk i **Innstillinger og vedlikehold** > **Lisenser** > **SuperOffice-fanen**.
...
* **Plangrenser (fencing):** Faste nivåbaserte grenser som skiller planene. Overskridelse av en plangrense blokkerer den tilknyttede funksjonen til du frigjør kapasitet eller oppgraderer planen.
...
Plangrenser er faste per nivå. Når en grense nås, blokkeres den relaterte funksjonen til du reduserer forbruket eller oppgraderer.
...
Indikatoren **Begrensninger** i **Innstillinger og vedlikehold** > **Lisenser** > **Status-fanen** > **Database** viser gjeldende forbruk opp mot hver plangrense.
...
| 100 % | <i class="ph ph-prohibit" aria-label="Limit reached"></i> Antall vises i rødt | Grensen nådd – funksjonen er blokkert |
...
Organisasjoner som migrerer fra **SuperOffice CRM Online** (det modulbaserte abonnementet), plasseres i CRM Suite-planen som samsvarer med gjeldende lisens.
...
Hvis du hadde flere lisenser, følger migreringen gjeldende lisens.
