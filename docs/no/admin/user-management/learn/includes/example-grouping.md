...
Jon Jonsen jobber i salgsavdelingen i et stort selskap. Primærgruppen settes til "Salg", slik at Jon har tilgangsrettigheter til data som brukere i salgsavdelingen har opprettet. Tilgangsrettighetene til primærgruppen er definert i rollen som Jon tilhører. Denne rollen bestemmer om Jon kan redigere eller slette data som er opprettet av de andre brukerne i salgsavdelingen (se [Angi datarettigheter for rolle][1]).
