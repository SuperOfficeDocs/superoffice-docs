...
> [!NOTE]
> Navnet på elementet endres hvis det allerede er i bruk i SuperOffice CRM. For å unngå dette kan du i stedet [slette det gamle elementet][1] og opprette et nytt.
...
4. Skriv inn et nytt navn og en beskrivelse i dialogboksen.
