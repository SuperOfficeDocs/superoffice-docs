...
Hvis SuperOffice CRM for Web er installert på et HTTPS-område, fungerer ikke webpaneler som bruker URL-adresser med HTTP. Du må bruke URL-adresser med HTTPS.
