...
Du kan ha snarveier til eksterne applikasjoner i SuperOffice CRM, slik at du kan åpne dem direkte fra SuperOffice CRM for Windows.

Du definerer hvilke URL-adresser som skal være tilgjengelige for brukerne i **Lister**-bildet i Innstillinger og vedlikehold.
...
* [Legge til forekomster på listen GUI - Applikasjon][3]
