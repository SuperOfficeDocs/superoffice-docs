...
> [!NOTE]
> Navnet på elementet endres hvis det allerede er i bruk i SuperOffice CRM. For å unngå dette kan du i stedet [slette det gamle elementet](#delete) og opprette et nytt.
