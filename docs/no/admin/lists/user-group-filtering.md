...
4. Merk ønsket forekomst i listen **Forekomster**.
...
4. Gå til fanen **Brukergrupper**.

5. Velg en brukergruppe i listen.

6. I listen **Forekomster tilgjengelig for denne brukergruppen** klikker du i boksen ved siden av hver forekomst som skal være synlig for denne gruppen.

7. Gjenta trinn 5 og 6 for hver brukergruppe.
