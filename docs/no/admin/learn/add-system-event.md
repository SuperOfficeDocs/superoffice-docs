...
Noen [systemoperasjoner][1] kan du sette i gang fra fanen **Systemmeldinger** på fanen **Status**.
...
4. I dialogboksen **Legg til operasjon** velger du en [systemoperasjonstype][1] fra listeboksen **Operasjonstype**.
