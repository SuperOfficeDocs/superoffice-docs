...
1. Klikk på en rad i meldingen.
2. Rull ned til **Radegenskaper** og **Bakgrunnsbilde** i sidepanelet.
3. Klikk på **Last opp bilde**.
4. I vinduet **Bildebibliotek** følger du én av prosedyrene nedenfor.

## Bruke et bilde fra SuperOffice-databasen
...
5. Klikk på **Last opp bilde** i sidepanelet.

6. I **Bildebibliotek**-vinduet velger du ett av de tilgjengelige bildene eller trykker på **Legg til** for [å velge en bildefil på PC-en din][1].
...
8. (valgfritt) [Legg til en sporet kobling][2] til bildet. Hvis du for eksempel skal sette inn et bilde av et produkt du skal lansere, kan du legge til en kobling til produktets informasjonsside. Du kan opprette en ny kobling eller legge til en eksisterende kobling.
    ...
    Slik legger du til en vanlig kobling (ikke sporet): Velg bildet og skriv inn koblingen i **URL-feltet**.

## Bruke et bilde i det elektroniske bildebiblioteket (royalty-fritt)

> [!NOTE]
> **Hvis området Bilder** (![ikon][img2]) ikke er synlig, kan denne innstillingen ha blitt deaktivert på grunn av organisatoriske personvernregler.
...
3. Skriv inn søkeord i søkefeltet og trykk på **ENTER**. Bilder som samsvarer med søket ditt vises.

4. Klikk og dra bildet til det aktuelle området i meldingen.
