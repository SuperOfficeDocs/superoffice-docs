...
Det er enkelt å opprette et skjema og legge det ut på en hvilken som helst nettside hvor du vil at det skal vises. Eksempler på skjemaer: start gratis prøveperiode, [kontakt oss][1], oppdater data, behandling av samtykke.
...
* **Fanen Skjemamaler:** inneholder alle tilgjengelige [skjemamaler][7]. Når du åpner denne fanen for første gang, vil du se maler fra malbiblioteket på nett. Du kan importere disse for bruk eller inspirasjon. For å laste ned en mal, klikk på den og trykk på **Importer mal**.
...
* **Publiser:** viser kobling og skriptet for [publisering av skjemaet][3] på en nettside eller i en utsendelse.
