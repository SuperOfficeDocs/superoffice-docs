...
Statuser og tellere kan brukes i søk og til å opprette dynamiske utvalg. Du kan for eksempel søke etter firmaer, personer eller prosjekter som oppfyller en status eller en teller. [!include[Define counter](../../../learn/includes/def-counter.md)]
