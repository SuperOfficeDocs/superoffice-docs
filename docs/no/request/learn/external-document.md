...
# Arbeide med eksterne dokumenter (kunnskapsbase)
...
1. Klikk på knappen **Nytt dokument**. Du kommer til bildet **Egenskaper for dokument**.
...
1. Hvis du vil bruke dokumentet i et webbasert kundesenter, kan du legge til en unik ID-streng i feltet **ID-streng**.

1. I feltet **Beskrivelse** kan du skrive inn en kort beskrivelse av hva dokumentet inneholder.

1. Klikk på **Velg fil**-knappen ved siden av **Fil**, og velg det nye dokumentet i dialogboksen som vises.
...
1. Klikk på **OK** for å laste opp dokumentet.
...
> [!TIP]
> Hvis du vil flytte dokumentet til en annen mappe, velger du den nye mappen i feltet **I mappe**.
