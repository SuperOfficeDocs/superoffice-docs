...
language: no
redirect_from: /no/request/learn/type/index
index: true
---
...
> [!NOTE]
> Denne funksjonen krever en **Service Premium**-lisens eller **Growth**-planen. For å definere layouter basert på sakstyper i Screen Designer trenger du også **Development Tools**-lisensen.
