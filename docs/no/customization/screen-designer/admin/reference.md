...
language: no
index: true
redirect_from: /no/customization/screen-designer/reference
---
...
| Felt | Type | Kommentar |
|---|---|---|
| [Adresse][20] | Adresse | Vises i utvidet modus |
| Bransje | Tekst | |
| [Kategori][18] | Tekst | |
| Kode | Tekst | |
| Firmanavn | Tekst | |
...
| Nummer | Tekst | |
| Vår kontakt | Tekst | |
| Vår servicekontakt | Tekst | |
| Telefon | Tekst | |
| Prioritet | Tekst | |
| Registreringsdato | Dato | |
| Enkeltinteresse | Avmerkingsboks | Velg interesse fra listen |
| Stopp | Avmerkingsboks | |
| MVA-nummer | Tekst | |
| Nettside | Tekst | |
...
| Abonnement | | |
| Tittel | Tekst | |
| Bruk som postadresse | Avmerkingsboks | |
| Nettside | Tekst | |
| Tilpassede felt | | Både brukerdefinerte og ekstra |
...
| Nummer | Tekst | |
| Eier | Nedtrekk | |
| Sannsynlighet | Tekst | Høyrejustert prosent |
| Fortjeneste | Nummer | Prosent og beløp |
| Prosjekt | Nedtrekk | |
| Registreringsdato | Dato | |
| Salgsdato | Dato-velger | |
| Salgstype | Nedtrekk | |
| Salg | Tekst | |
| Kilde | Nedtrekk | |
| Fase | Nedtrekk | |
| Fase - arbeidsflyt | Flerlinjet tekst | Ingen alternativer |
| Totalkostnad | Nummer | Høyrejustert beløp |
| Synlig for | Tekst | |
| Tilpassede felt | | Både brukerdefinerte og ekstra |
...
| Opprettet av | Tekst | |
| Frist | Dato | |
| Først lest av eier | Dato | |
| Først lest av bruker | Dato | |
| Har vedlegg | Avmerkingsboks | |
| ID | Tekst | |
| Intern status | Tekst | |
| Språk | Tekst | |
| Sist endret | Dato | |
...
| Reell tid i kø | Tid | |
| Reell tid til lukking | Tid | |
| Reell tid til svar | Tid | |
| Svar ved | Dato | |
| [Forespørselstype][13] | Nedtrekk | |
| Salg | Nedtrekk | |
| Stemning | Tekst | |
| Selvtillit om stemning | Tekst | |
| Status | Nedtrekk | |
| Koder | Nedtrekk | Ingen alternativer |
| Brukt tid | Tid | |
| Brukt tid eksternt | Tid | |
| Brukt tid i kø | Tid | |
| Tid til lukking | Tid | |
| Tid til svar | Tid | |
| Tittel | Tekst | |
...
| Prosjekt | Nedtrekk | |
| Salg | Nedtrekk | |
| [Foreslåtte tidspunkter][15] | | Ingen alternativer |
| Tittel | Tekst | Låst plassering. |
| Type | Nedtrekk | Låst plassering |
| Videolenke | Tekst | Ingen alternativer |
| Synlig for | Nedtrekk | Ingen alternativer |
| Tilpassede felt | | Både brukerdefinerte og ekstra |

* Obligatoriske felt kan ikke flyttes eller fjernes. Dette gjelder for: tittel, type, tid, firma/kontakt, deltakere, steder og ressurser.
