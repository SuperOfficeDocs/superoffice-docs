...
1. Klikk på **Oppgave**-knappen, og velg **Kombiner utvalg med**. Et nytt skjermbilde for utvalg åpnes.
...
Når du har lagret utvalget, kan du [redigere det](../update/index.md) for å endre både kombinasjonstypen og hvilke utvalg som kombineres. Men det er ikke mulig å endre feltet **Utvalg av**.
