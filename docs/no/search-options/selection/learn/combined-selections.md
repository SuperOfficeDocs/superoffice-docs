...
title: Kombinasjonsutvalg
description: Kombinasjonsutvalg
...
Kombinasjonsutvalget kan inneholde oppføringer som er felles for de to eksisterende utvalgene, oppføringer som er forskjellige, oppføringer som bare finnes i ett av utvalgene, og alle oppføringer i de to utvalgene.
...
De to utvalgene som kombineres, kan være statiske eller dynamiske. Når du har opprettet et kombinasjonsutvalg, kan du velge å gjøre det om til et statisk utvalg.
