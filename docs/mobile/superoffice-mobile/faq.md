...
so.client: mobile             # online, web, win, pocket, or mobile
---
...
If not set, they still needs to first be able to unlock the phone to start Mobile CRM. The user must change their SuperOffice CRM Online password to ensure to avoid possible data theft.
