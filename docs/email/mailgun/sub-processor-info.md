...
# Mandatory fields.
title: mailgun_sub_processor_info       # (Required) Very important for SEO. Intent in a unique string of 43-59 chars including spaces.
description: Mailgun sub-processor information # (Required) Important for SEO. Recommended character length is 115-145 characters including spaces.
...
| Company website | [www.mailgun.com](http://www.mailgun.com/) |
| Entity Country | US |
