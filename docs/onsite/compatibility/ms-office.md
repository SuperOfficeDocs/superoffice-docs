...
Tested Microsoft Office version on both win and web applications.

Want to know if a newly released Office version is compatible? Check your [compatibility reports][4].

| Microsoft Office version    | 8.0 SR1 - SR2 | 8.0 SR3 - SR6|  8.1 | 8.2 | 8.3 | 8.4 | 8.5 | 9.1 |
|-----------------------------|:--:|:--:|:--:|:--:|:--:|:--:|:--:|:--:|
| Microsoft Office 2019       | ![i][img3] | ![i][img3] | ![i][img3] | ![i][img3] | ![i][img3] | ![i][img1] | ![i][img1] | ![i][img1] |
...
| Microsoft Office 2010 32bit | ![i][img1] | ![i][img1] | ![i][img1] | ![i][img1] | ![i][img1] | ![i][img1] | ![i][img1] | ![i][img1] |
