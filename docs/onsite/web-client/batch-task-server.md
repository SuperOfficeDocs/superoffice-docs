...
> [!NOTE]
> If you are running SuperOffice Sales & Markting Web with remote Netserver WebServices, this must be set up on the server running Netserver WebServices.
...
On [DevNet - Developers Club][2] you'll find an article which will also drill down into how built-in tasks get started and demonstrate how this extensibility point can be leveraged for other applications.
...
* Publishing new userdefined fields (from version 7.5)
