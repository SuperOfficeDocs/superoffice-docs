...
Run **ServerSetup.exe** from **SnMWin_ADMIN** installation file to upgrade the database and the server files. The installation wizard will guide you through the process and will ask you for SuperOffice administrator's credentials as well as for the system user's credentials. 
...
## 4. Uninstall SuperOffice 8 Win clients (optional)
...
Alternatively you can install **SuperOffice Win Admin, Reporter Studio and Travel Gateway** by running **SuperOffice9.exe** file form the **Client** folder on the SuperOffice Server.
