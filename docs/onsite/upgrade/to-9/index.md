...
Alternatively you can install **SuperOffice Win Admin, Reporter Studio and Travel Gateway** by running **SuperOffice9.exe** file from the **Client** folder on the SuperOffice Server.
