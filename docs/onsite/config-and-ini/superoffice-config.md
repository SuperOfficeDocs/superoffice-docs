...
> [!NOTE]
> We do not allow the previous default naming of the standard user, like 'CRM7' and password any similar to the CRM 7 default password. You will be promted on upgrade to change the system user if you do.
...
[3]: https://community.superoffice.com/en/technical/documentation/administration/config-ini/debugwin/
[4]: https://community.superoffice.com/en/technical/documentation/administration/config-ini/command-line-switches/
