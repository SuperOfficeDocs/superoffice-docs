...
1. Klicka på <i class="ph ph-dots-three-circle-vertical" aria-label="Uppgiftsmeny"></i> och välj **Byt**.
1. Här har du följande alternativ:
    ...
    * **Bilaga**: Om meddelandet innehåller bilagor visas de i denna tabell. Du kan ta bort befintliga bilagor, men du kan inte lägga till nya.
