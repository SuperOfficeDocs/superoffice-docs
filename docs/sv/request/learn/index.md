...
**Ärenden** är en av huvudfunktionerna i SuperOffice. Här hanterar du ärenden och förfrågningar i systemet. Du kan skapa interna och externa ärenden, svara på inkommande frågor och få en översikt över alla ärenden i systemet. Klicka på knappen **Ärenden** (<i class="ph ph-ticket" aria-hidden="true"></i>) för att öppna ärendelistan eller klicka på texten **Ärenden** för att visa navigatoralternativ som sökning, historik och favoriter.
...
![Dashboard för ärenden med listor över egna öppna ärenden och en kö för otilldelade ärenden -screenshot][img3]
...
1. Kunden får en [automatisk bekräftelse][23] på att ärendet mottagits.
1. Förfrågan registreras automatiskt som ett ärende i SuperOffice CRM.
...
1. Ärendehandläggaren kan inte lösa ärendet själv och gör något av följande:
    * [Frågar en kollega][7].
    * [Ber om extern hjälp][8].
1. Ärendehandläggaren [skickar ett svar till kunden][2].
1. Ärendehandläggaren [avslutar ärendet][3] och går vidare till nästa ärende.

### Scenario 2: Kunden ringer supporten

1. Kunden har ett problem och ringer supporten.
1. Ärendehandläggaren som svarar [registrerar ärendet][4].
1. Ärendehandläggaren kan inte lösa ärendet själv och gör något av följande:
    * [Frågar en kollega][7].
    * [Ber om extern hjälp][8].
1. Ärendehandläggaren [skickar ett svar till kunden][2].
