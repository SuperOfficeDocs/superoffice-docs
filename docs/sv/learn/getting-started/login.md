...
> [!NOTE]
> Flera autentiseringsmetoder är tillgängliga, så det beror på vilken autentiseringsmetod användaren är konfigurerad med och om du kan ändra lösenordet här. Läs våra FAQ om du har [glömt lösenordet][5].
