...
language: sv
redirect_from:
  - /sv/marketing/learn/add-fav
  - /sv/request/learn/howto/fav
---
...
1. Klicka på chevron-ikonen bredvid sidopanelens namn för att öppna listan.

1. Välj **Mina favoriter**.
...
## Ta bort post från Favoriter-listan
...
* **Lägg till flera poster som favoriter:** Du kan välja flera objekt i en lista genom att hålla ner Ctrl (Cmd på Mac) och klicka på varje objekt, sedan högerklicka och välja **Lägg till i mina favoriter**.

* **Använda favoriter för snabb navigering:** Favoriter är särskilt användbara för att snabbt få tillgång till ofta använda poster utan att behöva söka efter dem varje gång.
