...
redirect_from:
  ...
  - /sv/contact/learn/screen/relations-tab
---
...
1. Gå till relevant skärm, antingen Företag eller Kontakt.

1. Klicka på detaljkortet **Relationer** för att se alla relationer som är kopplade till enheten.

1. Dubbelklicka på en relationsrad för att öppna **Relation**-dialogen och visa detaljerad information.

## Lägg till eller ta bort en relation

För detaljerade steg om hur du lägger till eller tar bort en relation, se [relationsguiden][1].
