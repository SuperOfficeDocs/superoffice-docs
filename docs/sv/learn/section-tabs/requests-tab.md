...
language: sv
redirect_from:
  - /sv/company/learn/screen/requests-tab
  - /sv/contact/learn/screen/requests-tab
---
...
1. Klicka på detaljkortet **Ärenden** för att se alla ärenden kopplade till enheten.

1. Dubbelklicka på ett ärende i listan för att öppna det i ett separat fönster och få åtkomst till fullständiga detaljer.
...
* [Hur man skapar ett ärende][2]
* [Hantera kundärenden i SuperOffice CRM][3]
