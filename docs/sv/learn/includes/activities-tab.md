...
* Visar aktivitetstypen, som motsvarar ovanstående typikoner.
* En eventuell beskrivning av aktiviteten.
* Eventuell kontakt som är kopplad till aktiviteten.
* Om det finns ett projekt som aktiviteten är kopplad till.
* ID för den som har skapat aktiviteten.
