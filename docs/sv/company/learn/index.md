...
All information som hör samman med ett företag – oavsett om det är din kund, partner eller leverantör – lagras på företagskortet. På det här kortet får du en överblick över hela företaget på en och samma skärmbild.

![Fönstret Företag -screenshot][img3]

[!include[Intro](includes/company-screen-intro.md)]

I fönstret **Företag** visas varje post i databasen som ett indexkort med all information om företaget.

Om du vill flytta mellan olika företag klickar du på knapparna föregående/nästa (![ikon][img2] ![ikon][img1]) längst ned till höger på korten.
