...
Ett kombinationsurval är en kombination av två befintliga urval.

Kombinationsurvalet kan innehålla poster som är gemensamma för de två befintliga urvalen, poster som skiljer sig åt, poster som bara finns med i ett av urvalen samt alla poster i de två urvalen.

Det finns vissa emellertid begränsningar för vad som kan kombineras:
...
De två urvalen som kombineras kan vara statiska eller dynamiska. När du har skapat ett kombinationsurval, kan du välja att göra om det till ett statiskt urval.
