...
Automatisering av företagskategori-uppdateringar hjälper till att minska manuellt arbete och säkerställer att dina data förblir korrekta. När statusen för en försäljning ändras eller en lead-status uppdateras kan det relaterade företaget automatiskt uppdateras med rätt kategori.
...
* Du måste ha administratörsbehörighet för att få åtkomst till **Inställningar och underhåll**.
...
|---|---|
| Uppdatera kategori när en försäljning är vunnen | Uppdaterar automatiskt företagskategorin när en försäljning markeras som **Vunnen**. |
...
| Uppdatera kategori när en försäljning registreras hos företaget | Uppdaterar automatiskt företagskategorin när en ny försäljning skapas och kopplas till företaget. |
...
1. Välj fliken **Lead-kategorisering**. Den här skärmen visar automatiseringsalternativ.
...
* **Helt automatisk:** Bäst för enkla lead-till-kund-arbetsflöden där kategoriändringar är förutsägbara och konsekventa. Till exempel automatisk flyttning av en lead till kategorin *Kund* när en försäljning markeras som vunnen.
...
Ett vanligt användningsfall är att automatiskt uppdatera en lead till en kundkategori när en försäljning är vunnen:

1. Aktivera **Uppdatera kategori när en försäljning är vunnen**.
...
Nu, när en försäljning kopplad till ett företag i gruppen *Potentiell kund* markeras som vunnen, kommer företagskategorin automatiskt att ändras till *Kund*.
