...
Du kan initiera vissa [systemhändelser][1] från listan **Systemmeddelanden** på **Status**-fliken.
...
4. Välj en [systemhändelse][1] från listrutan **Händelsetyp** i dialogrutan **Lägg till händelse**.
