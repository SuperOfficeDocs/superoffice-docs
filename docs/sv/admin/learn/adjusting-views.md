...
# Så anpassar du olika vyer i Inställningar och underhåll

## Flytta flikar

Många skärmbilder under Inställningar och underhåll består av olika flikar (till exempel **Alternativ** och **Användare**). Du kan byta ordning på dessa flikar:

1. Klicka och dra fliken till önskad position.
2. Släpp fliken.

> [!NOTE]
> I den här hjälpen beskrivs flikarna i deras standardordning.

## Sortera listor

* Klicka på rubriken för den kolumn du vill sortera efter eller högerklicka på en kolumnrubrik och välj **Sortera**.
* Klicka på kolumnrubriken en gång till om du vill sortera i omvänd ordning.
* Högerklicka på en kolumnrubrik och välj **Konfigurera sortering**. I dialogrutan som visas kan du välja fler sorteringskolumner.
...
## Ändra kolumnvisningen

Du kan välja vilka kolumner som ska visas i listorna samt deras ordning.

1. Högerklicka på en kolumnrubrik och välj **Konfigurera kolumner**. Fliken **Kolumner** i dialogrutan **Anpassa** visas.
