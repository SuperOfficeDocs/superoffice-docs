...
2. Du kan också ange landets engelska namn i fältet **Engelskt namn**.

3. Ange vilken landskod som ska användas i internetadresser för det aktuella landet i fältet **Toppdomän**, till exempel *NO* för Norge eller *DE* för Tyskland.
...
8. I fältet **Det här landets prefix** anger du det nummer som ska användas när man ringer till det valda landet från ett annat land, till exempel *47* för Sverige.

9. I fältet **Utlandsprefix** anger du prefixet för internationella samtal för landet du befinner dig i. Oftast är det *00*.

10. Om du vill kan du skriva en beskrivning av landet i fältet **Beskrivning**.

11. Klicka på **Spara**. Landet läggs till som en egen post i listan **Poster**. Upprepa proceduren om du vill lägga till fler länder.
