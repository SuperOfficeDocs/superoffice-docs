...
index: true
redirect_from: /sv/admin/lists/learn/organize/user-group-filtering
language: sv
---

# Användargruppfiltrering

SuperOffice CRM-användarna tillhör olika användargrupper beroende på vilken typ av behörigheter de har. Detta definieras i fönstret [Användare][2].
