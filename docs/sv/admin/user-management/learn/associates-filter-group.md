...
# Filtrera och gruppera användare

Om listan över **Medarbetare** innehåller många användare kan du filtrera och gruppera listan så att den blir mer hanterbar.

De olika alternativen beskrivs nedan.

## Sök efter användare

Använd den här dynamiska sökfunktionen för att snabbt hitta specifika användare efter namn eller användar-ID, eller för att hitta alla användare som tillhör specifika roller, grupper eller användarplaner. Skriv bara in text i sökfältet för att uppdatera listan med matchande användare.

## Visa endast användare som kan logga in
