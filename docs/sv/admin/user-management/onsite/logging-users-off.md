...
3. Välj önskat företag i listrutan **Företag**.
...
> [!NOTE]
> Om användaren inte är inloggad eller om något annat än **Inloggad på Windowsklient** är markerat i listrutan **Visa** inaktiveras den här knappen.
