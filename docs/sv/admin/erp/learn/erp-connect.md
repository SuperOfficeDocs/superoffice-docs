...
1. Skriv in söktext i sökfältet i dialogrutan **Koppla till ERP** och klicka på **Sök**. Du kan också klicka på ![sökikonen][img1] för att starta en avancerad sökning (se [Använda fönstret Sök][1]).
