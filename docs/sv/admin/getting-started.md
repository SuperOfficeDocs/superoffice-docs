...
För att integrationen mellan SuperOffice och MS Office Outlook och dokument ska fungera korrekt måste [WebTools vara installerat][12] för alla användare. Varje användare får ett e-postmeddelande med instruktioner när de börjar med SuperOffice, men som administratör är det viktigt att du ser till att det blir gjort.
...
* [Läs mer om integration av e-post och dokument][13]
