...
I den här listan visas statusmeddelanden från systemet och skapade [händelser][1]. Aviseringar om aktiva importer, SAINT eller fritext-indexering etc. Välj en avisering i listan för att visa en beskrivning. Du kan hålla koll på händelser som är aktiva i systemet.
