...
![Fliken Dashboard -screenshot][img1]

## Fliken Chattsamtal

Använd fliken **Chattsamtal** för att svara på inkommande chattsamtal från kunder.

![Fliken Chattsamtal -screenshot][img5] Siffran på fliken **Chattsamtal** visar hur många chattsamtal du hanterar just nu.
...
Här kan du [chatta med kunden][6].

Åtgärder:

* [Skapa ärende i chatt][1]
* [Överföra ett chattsamtal till en annan agent][2]
* [Skicka FAQ:er, svarsmallar och snabbsvar i en chatt][3]
* [Skicka filer i chatt][4]
* [Skapa ett snabbsvar][5]
