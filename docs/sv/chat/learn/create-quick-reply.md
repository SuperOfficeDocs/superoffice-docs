...
Ett snabbsvar är en fördefinierad text som du kan använda i en chatt med en kund. Snabbsvar sparar tid eftersom du inte behöver skriva vanliga svar som "Jag ska kolla det, återkommer strax" eller "Jag behöver ditt kund-ID för att hantera ditt ärende". Snabbsvaren du skapar är bara tillgängliga för dig.
...
6. Klicka på **Spara**. Fönstret stängs och det nya snabbsvaret sparas. Nu kan du [välja snabbsvaret när du chattar med en kund][1].
