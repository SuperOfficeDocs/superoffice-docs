...
1. Klicka på knappen **Skriv** i verktygsfältet längst ner i SuperOffice CRM-fönstret.
2. Välj en e-postmall i fältet **Typ** högst upp i dialogrutan **Dokument**.
...
## Skapa e-postmeddelande med en fördefinierad e-postmall

När du skapar ett e-postmeddelande från SuperOffice CRM kan du också använda fördefinierade SuperOffice-mallar specifikt för brödtexten.

1. Kontrollera att det finns en tillgänglig e-postmall och att alternativet **Använd e-postmall från SuperOffice** i dialogrutan **Alternativ för SuperOffice CRM** är markerat.
...
5. Lägg till eventuella bilagor som du vill inkludera. Du kan också [lägga till dokument från SuperOffice CRM][5].

6. Klicka på **Skicka** om du vill skicka meddelandet till den eller de angivna mottagarna.

## Relaterat innehåll

* [Skapa e-postmallar][6]
* [Allmänna inställningar][7]
