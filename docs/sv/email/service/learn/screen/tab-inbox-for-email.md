...
På fliken **Inkorg för e-post** finns en lista med alla e-postmeddelanden i inläsningskön. Följande alternativ är också tillgängliga via knappen **Åtgärder** (![ikon][img1]):
