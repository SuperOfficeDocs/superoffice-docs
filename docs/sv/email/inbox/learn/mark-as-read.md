...
# Markera e-postmeddelanden som lästa/olästa

Ett e-postmeddelande markeras automatiskt som läst (inte fetstil) när du markerar det i inkorgen.

## Markera ett e-postmeddelande som läst/oläst
