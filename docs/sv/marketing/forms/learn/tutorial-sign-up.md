...
title: Guide - så här skapar du ett formulär för anmälning till nyhetsbrev
...
# Så här skapar du ett formulär för anmälning till nyhetsbrev
...
1. Ställ in formuläret som **Aktivt** ![ikon][img4] i rubriken.
