...
3. Klicka på ![ikon][img2] **Lägg till formulär**. Skärmen **Redigera formulär** visas.
...
2. Klicka på ![ikonen][img1] menyknappen bredvid det formulär som du vill använda som utgångspunkt för mallen.
