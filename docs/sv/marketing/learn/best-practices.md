...
Du kan klicka på ![ikon][img1] **Mobil** på den globala menyn för att se hur utskicket ser ut på en smarttelefon. Du kan också klicka på ett avsnitt i meddelandet och klicka på **Mobil** under **Innehåll** i sidopanelen.
