...
1. Klicka på en rad i meddelandet.
2. I sidopanelen rullar du nedåt till **Radegenskaper** och **Bakgrundsbild**.
3. Klicka på **Ladda upp bild**.
4. I fönstret **Bildbibliotek** följer du någon av procedurerna nedan.

## Använda en bild från SuperOffice-databasen
...
5. Klicka på **Ladda upp bild** i sidopanelen.

6. I fönstret **Bildbibliotek** väljer du en av de tillgängliga bilderna eller klickar på **Lägg till** för att [välja en bildfil på din dator][1].
...
8. (valfritt) [Lägg till en spårad länk][2] till bilden. Om du t.ex. ska lägga in en bild av en produkt som du lanserar kan du lägga till en länk till en informationssida för produkten. Du kan skapa en ny länk eller lägga till en befintlig länk.
    ...
    Gör så här för att lägga till en vanlig länk (ospårad): Välj bilden, och ange länken i **URL**-fältet.
...
4. Klicka och dra bilden till det relevanta avsnittet i meddelandet.
