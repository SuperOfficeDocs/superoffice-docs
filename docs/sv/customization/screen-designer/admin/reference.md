...
| Fält | Typ | Kommentar |
|---|---|---|
| [Adress][20] | Adress | Visas i utökat läge |
| Bransch | Text | |
| [Kategori][18] | Text | |
| Kod | Text | |
| Företagsnamn | Text | |
...
| Nummer | Text | |
| Vår kontakt | Text | |
| Vår servicekontakt | Text | |
| Telefon | Text | |
| Prioritet | Text | |
| Registreringsdatum | Datum | |
| Enkel intresse | Kryssruta | Välj intresse från lista |
| Stoppa | Kryssruta | |
| Momsnummer | Text | |
| Webbplats | Text | |
...
| Vår servicekontakt | Text | |
| Titel | Text | |
| Föredraget språk | Urval | |
| Privat | Text | |
| Registreringsdatum | Datum | |
| Serviceprioritet | Text | |
| Enkel intresse | Kryssruta | Välj intresse från lista |
| Prenumeration | | |
| Titel | Text | |
| Använd som postadress | Kryssruta | |
| Webbplats | Text | |
| Anpassade fält | | Både användardefinierade och extra |
...
| Skapad av | Text | |
| Deadline | Datum | |
| Först läst av ägare | Datum | |
| Först läst av användare | Datum | |
| Har bilaga | Kryssruta | |
| ID | Text | |
| Intern status | Text | |
| Språk | Text | |
| Uppdaterad | Datum | |
...
[11]: https://docs.superoffice.com/en/sale/dev/index.html
[10]: https://docs.superoffice.com/en/project/dev/index.html
[13]: ../../../request/admin/type/index.md
[14]: https://docs.superoffice.com/en/request/dev/index.html
[15]: ../../../diary/learn/invitation/add-attendee.md#availability
[16]: ../../../diary/learn/follow-ups.md
[17]: https://docs.superoffice.com/en/company/dev/index.html#interests
[18]: https://docs.superoffice.com/en/company/dev/index.html#categorylist
[20]: https://docs.superoffice.com/en/api/localization/address/index.html
