...
1. Gör nödvändiga ändringar i de olika fälten (under [Lägg till fält][1] hittar du en översikt över vad du ska ange här).

    > [!NOTE]
    > Listrutan **Typ** innehåller bara de alternativ som du kan ändra. Det vill säga där befintliga data kan ändras för att passa den nya fälttypen.
