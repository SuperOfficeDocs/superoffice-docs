...
3. Klicka på en språkflik. HTML-koden för sidan visas i ett enkelt textredigeringsprogram.

    > [!NOTE]
    > Om sidan är tom kopierar du html-koden från en annan språkflik.

4. Gör de ändringar som behövs.
