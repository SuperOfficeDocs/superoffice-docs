...
1. Öppna företagskortet för företaget där du vill hantera externa användare.
...
1. Välj önskad kontakt i listan och klicka på **Redigera**.
2. I dialogrutan som visas anger du användar-ID, lösenord och roll. Du kan också ange om inloggningen ska aktiveras:
...
3. Klicka på **Spara** om du vill spara inställningarna och stänga dialogrutan, eller på **Avbryt** om du vill stänga dialogrutan utan att spara.
