...
keywords: tidszoner, land, lokalisering, flagga
author: digitaldiina
date: 10.09.2025
version: 11.5
...
redirect_from: /sv/globalization-and-localization/learn/time-zones
language: sv
---
...
Tidszoner visas i form av en listruta i [kalenderen][1] och för [händelser][3]. Tidszonen som är standard för din SuperOffice-databas visas överst.
