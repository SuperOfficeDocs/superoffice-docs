...
# Duplicera en dashboard

Du kan skapa en kopia av en befintlig dashboard. Till exempel för att skapa en egen version av en fastnålad dashboard med vissa egna ändringar.
